        ...
        public readonly partial struct RoutesEntity
        {
            ...
            public readonly partial struct RequiredSrc
            {
                ...
                public readonly partial struct LocaleEntity
                {
                    ...
                    public readonly partial struct RedirectEntity
#if NET8_0_OR_GREATER
                        : IJsonElement<RedirectEntity>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="RedirectEntity"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal RedirectEntity(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static RedirectEntity DefaultInstance { get; }
                        ...
                        public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity value)
                        {
                            CheckValidInstance();
                        ...
                        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity value)
                        {
                            CheckValidInstance();
                            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                        }
                        ...
                        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                        public bool TryGetProperty(string propertyName, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity value)
                        {
                            CheckValidInstance();
                            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                        }
                        ...
                        /// <summary>
                        /// Determines if a property name matches '^.{1,256}$'
                        /// for the pattern property producing the type
                        /// <see cref="Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity"/>.
                        /// </summary>
                        ...
                        public static bool MatchesPatternType1256Entity(ReadOnlySpan<byte> propertyName)
                        {
                            return JsonSchemaEvaluation.MatchRangeRegularExpression(propertyName, 1, 256);
                        }

                        /// <summary>
                        /// Gets an instance of the type
                        /// <see cref="Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity"/>
                        /// if the property name matches '^.{1,256}$'.
                        /// </summary>
                        /// <param name="propertyName">The unescaped UTF-8 property name.</param>
                        /// <param name="value">The property value.</param>
                        /// <param name="result">The typed property value, if the name matches.</param>
                        /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
                        public static bool TryAsPatternType1256Entity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity result)
                        {
                            if (MatchesPatternType1256Entity(propertyName))
                            {
                                result = Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity.From(value);
                                return true;
                            }
                        ...
                        {
                            /// <summary>
                            /// Visits a property matching '^.{1,256}$'.
                            /// </summary>
                            bool VisitPatternType1256Entity(ReadOnlySpan<byte> name, in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity value, ref TState state);
                            ...
                            where TVisitor : IPatternPropertyVisitor<TState>
                        {
                            ...
                            foreach (var property in EnumerateObject())
                            {
                                ...
                                {
                                    matched = true;
                                    Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity typedValue = Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity.From(property.Value);
                                    if (!visitor.VisitPatternType1256Entity(propertyName, in typedValue, ref state))
                                    {
                                        return false;
                                    }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                        public ObjectEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity> EnumerateObject()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateObjectEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity>(_parent, _idx);
                        }
                        ...
                        /// </returns>
                        public static bool operator ==(in RedirectEntity left, in RedirectEntity right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in RedirectEntity left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(RedirectEntity instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RedirectEntity(JsonElement instance)
                        {
                            return RedirectEntity.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RedirectEntity From<T>(in T instance)
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RedirectEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            #pragma warning disable CS0618 // Type or member is obsolete
                            return JsonElementHelpers.ParseValue<RedirectEntity>(utf8Json, options);
                        ...
                        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RedirectEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            #pragma warning disable CS0618 // Type or member is obsolete
                            return JsonElementHelpers.ParseValue<RedirectEntity>(json, options);
                            #pragma warning restore CS0618
                        }
                        ...
                        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RedirectEntity ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            #pragma warning disable CS0618 // Type or member is obsolete
                            return JsonElementHelpers.ParseValue<RedirectEntity>(json, options);
                            #pragma warning restore CS0618
                        ...
                        /// </exception>
                        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                        public static RedirectEntity ParseValue(ref Utf8JsonReader reader)
                        {
                            #pragma warning disable CS0618 // Type or member is obsolete
                            return JsonElementHelpers.ParseValue<RedirectEntity>(ref reader);
                            #pragma warning restore CS0618
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out RedirectEntity? result)
                        {
                            return JsonElementHelpers.TryParseValue<RedirectEntity>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RedirectEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static RedirectEntity IJsonElement<RedirectEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RedirectEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RedirectEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RedirectEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public RedirectEntity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RedirectEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RedirectEntity"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public RedirectEntity Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<RedirectEntity>(_idx);
                            }
