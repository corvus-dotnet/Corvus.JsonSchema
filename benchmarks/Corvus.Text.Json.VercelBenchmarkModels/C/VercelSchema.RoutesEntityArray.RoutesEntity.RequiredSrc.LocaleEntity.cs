        ...
        public readonly partial struct RoutesEntity
        {
            ...
            public readonly partial struct RequiredSrc
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="LocaleEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal LocaleEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static LocaleEntity DefaultInstance { get; }

                    /// <summary>
                    /// Gets the (optional) <c>cookie</c> property.
                    /// </summary>
                    public Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.CookieEntity Cookie
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CookieUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.CookieEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.DefaultEntity Default
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.DefaultEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.PathEntity Path
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.PathEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity Redirect
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RedirectUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.ValueEntity Value
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.ValueEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in LocaleEntity left, in LocaleEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in LocaleEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(LocaleEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator LocaleEntity(JsonElement instance)
                    {
                        return LocaleEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static LocaleEntity From<T>(in T instance)
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out LocaleEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<LocaleEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new LocaleEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static LocaleEntity IJsonElement<LocaleEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"LocaleEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="LocaleEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="LocaleEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public LocaleEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<LocaleEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="LocaleEntity"/> that lives for the lifetime of its
                    ...
                    {
                        /// <summary>
                        /// Gets the JSON property name for <see cref="Cookie"/>.
                        /// </summary>
                    ...
                    {
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="Cookie"/>.
                        /// </summary>
                    ...
                    {
                        /// <summary>
                        /// Gets the pre-baked property name blob for <see cref="Cookie"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> Cookie => [0x85, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x6F, 0x6B, 0x69, 0x65, 0x22];
                        ...
                        /// <summary>
                        /// Gets the pre-baked property name blob for <see cref="Redirect"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> Redirect => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x22];
