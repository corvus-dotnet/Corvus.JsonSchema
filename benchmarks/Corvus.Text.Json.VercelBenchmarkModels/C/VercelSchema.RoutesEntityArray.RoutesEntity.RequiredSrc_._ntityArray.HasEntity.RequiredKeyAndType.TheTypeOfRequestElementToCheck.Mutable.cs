                        ...
                        public readonly partial struct RequiredKeyAndType
                        {
                            ...
                            public readonly partial struct TheTypeOfRequestElementToCheck
                            {
...
#endif
                                {
                                    ...
                                    public static explicit operator Mutable(TheTypeOfRequestElementToCheck instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="TheTypeOfRequestElementToCheck"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator TheTypeOfRequestElementToCheck(Mutable instance)
                                    {
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"TheTypeOfRequestElementToCheck.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly TheTypeOfRequestElementToCheck Clone()
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly TheTypeOfRequestElementToCheck Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<TheTypeOfRequestElementToCheck>(_idx);
                                    }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    public static implicit operator Source(TheTypeOfRequestElementToCheck instance) => new(JsonElement.From(instance));
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator Source(KnownValues value) => (TheTypeOfRequestElementToCheck)value;
                                ...
                                {
                                    return workspace.CreateBuilder<TheTypeOfRequestElementToCheck, Mutable>(this);
                                }
                                ...
                                public static ParsedJsonDocument<TheTypeOfRequestElementToCheck> Create(
                                    scoped in Source value, int initialCapacity = 1)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<TheTypeOfRequestElementToCheck>();
                                    }
                                    finally
                                    {
