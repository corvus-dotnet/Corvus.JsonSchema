...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RoutesEntityArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc(RoutesEntity value)
            {
                return Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator RoutesEntity(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle(RoutesEntity value)
            {
                return Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            ...
            public bool TryGetAsRequiredSrc(out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc result)
            {
                ...
                {
                    result = Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.From(this);
                    return true;
                }
            ...
            public bool TryGetAsRequiredHandle(out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle result)
            {
                ...
                {
                    result = Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.From(this);
                    return true;
                }
            ...
            /// <param name="matchRequiredSrc">Match a <see cref="Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc"/>.</param>
            /// <param name="matchRequiredHandle">Match a <see cref="Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc, TContext, TResult> matchRequiredSrc,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle, TContext, TResult> matchRequiredHandle,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredSrc(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.From(this), context);
                }

                if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredHandle(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc, TResult> matchRequiredSrc,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle, TResult> matchRequiredHandle,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity, TResult> defaultMatch)
            {
                if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredSrc(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.From(this));
                }

                if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredHandle(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc, TAccumulator, TAccumulator> matchRequiredSrc,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle, TAccumulator, TAccumulator> matchRequiredHandle,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchRequiredSrc(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.From(this), accumulator);
                }

                if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchRequiredHandle(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.From(this), accumulator);
                }
