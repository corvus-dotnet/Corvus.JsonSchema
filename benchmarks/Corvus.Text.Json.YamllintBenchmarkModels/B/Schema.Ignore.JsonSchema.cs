        ...
        : IJsonElement<Ignore>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchIgnoreValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                Corvus.YamllintBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            [NotNullWhen(true)]
#endif
            out Corvus.YamllintBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? matcher)
            {
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.YamllintBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? validator))
                        {
