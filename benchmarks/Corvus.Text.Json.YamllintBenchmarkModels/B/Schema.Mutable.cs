...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.YamllintBenchmark.Baseline.Schema.Ignore"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Corvus.YamllintBenchmark.Baseline.Schema.Ignore.Mutable(Mutable value)
        {
            return Corvus.YamllintBenchmark.Baseline.Schema.Ignore.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.YamllintBenchmark.Baseline.Schema.Ignore"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Corvus.YamllintBenchmark.Baseline.Schema.Ignore.Mutable value)
        {
            return From(value);
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.YamllintBenchmark.Baseline.JsonString.Mutable IgnoreValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreValueUtf8, out Corvus.YamllintBenchmark.Baseline.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetIgnoreValue(in Corvus.YamllintBenchmark.Baseline.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        public void Apply(in Corvus.YamllintBenchmark.Baseline.Schema.Ignore value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.YamllintBenchmark.Baseline.Schema.Ignore" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsIgnore(out Corvus.YamllintBenchmark.Baseline.Schema.Ignore result)
        {
            if (Corvus.YamllintBenchmark.Baseline.Schema.Ignore.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.YamllintBenchmark.Baseline.Schema.Ignore.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.YamllintBenchmark.Baseline.Schema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.YamllintBenchmark.Baseline.Schema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.YamllintBenchmark.Baseline.JsonString.Source ignore = default)
        {
        ...
        /// Creates an instance of a <see cref="Schema"/>.
        /// </summary>
        public void Create(in Corvus.YamllintBenchmark.Baseline.JsonString.Source ignore = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.YamllintBenchmark.Baseline.JsonString.Source ignore = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
