...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.YamllintBenchmark.Baseline.JsonString IgnoreValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreValueUtf8, out Corvus.YamllintBenchmark.Baseline.JsonString value))
            {
                return value;
            }
    ...
    public static implicit operator Corvus.YamllintBenchmark.Baseline.Schema.Ignore(Schema value)
    {
        return Corvus.YamllintBenchmark.Baseline.Schema.Ignore.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Schema(Corvus.YamllintBenchmark.Baseline.Schema.Ignore value)
    {
        return From(value);
    }
    ...
    public bool TryGetAsIgnore(out Corvus.YamllintBenchmark.Baseline.Schema.Ignore result)
    {
        ...
        {
            result = Corvus.YamllintBenchmark.Baseline.Schema.Ignore.From(this);
            return true;
        }
