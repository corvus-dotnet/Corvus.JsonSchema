...
public readonly partial struct YamllintSchema
{
        ...
        : IJsonElement<Ignore>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/ignore"u8, buffer, out written);
            ...
            /// </remarks>
            public const string SchemaDocument = "yamllint-schema.json";

            /// <summary>
            /// Gets the schema document from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaDocumentUtf8 => "yamllint-schema.json"u8;

            private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.YamllintBenchmark.Current.CorvusJsonSchemaProgram.Entry(2);
