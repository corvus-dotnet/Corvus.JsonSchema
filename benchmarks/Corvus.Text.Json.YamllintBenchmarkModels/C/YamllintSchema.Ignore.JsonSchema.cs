...
public readonly partial struct YamllintSchema
{
        ...
        : IJsonElement<Ignore>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider IgnoreValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/ignore"u8, buffer, out written);

            private static void MatchIgnoreValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.YamllintBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.IgnoreValueUtf8,
                        evaluationPath: IgnoreValueSchemaEvaluationPath);

                Corvus.YamllintBenchmark.Current.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            [NotNullWhen(true)]
#endif
            out Corvus.YamllintBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? matcher)
            {
                if (span.SequenceEqual(JsonPropertyNames.IgnoreValueUtf8))
                {
                    matcher = MatchIgnoreValue;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/yamllint.json#/definitions/ignore"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/yamllint.json#/definitions/ignore";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/yamllint.json#/definitions/ignore"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.YamllintBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? validator))
                        {
