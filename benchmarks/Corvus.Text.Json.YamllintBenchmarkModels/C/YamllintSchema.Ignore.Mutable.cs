...
public readonly partial struct YamllintSchema
{
    ...
    public readonly partial struct Ignore
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Ignore instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Ignore"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Ignore(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Ignore.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Ignore Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Ignore>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(Ignore instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Ignore"/>.
            /// </summary>
        ...
        {
            return workspace.CreateBuilder<Ignore, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Ignore> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Ignore>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Ignore> Create<TContext>(
        ...
        public static ParsedJsonDocument<Ignore> Create(in Corvus.YamllintBenchmark.Current.JsonString.Source ignore = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
