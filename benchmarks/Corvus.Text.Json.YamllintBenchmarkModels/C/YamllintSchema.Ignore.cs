...
public readonly partial struct YamllintSchema
{
    ...
    public readonly partial struct Ignore
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Ignore"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Ignore(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Ignore DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.YamllintBenchmark.Current.JsonString IgnoreValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreValueUtf8, out Corvus.YamllintBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Ignore left, in Ignore right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Ignore left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Ignore instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Ignore(JsonElement instance)
        {
            return Ignore.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ignore From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ignore ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Ignore>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ignore ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Ignore>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ignore ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Ignore>(json, options);
        }
        ...
        /// </exception>
        public static Ignore ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Ignore>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Ignore? result)
        {
            return JsonElementHelpers.TryParseValue<Ignore>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Ignore(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Ignore IJsonElement<Ignore>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Ignore: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Ignore"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Ignore"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Ignore>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Ignore"/> that lives for the lifetime of its
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="IgnoreValue"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="IgnoreValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> IgnoreValueUtf8 => "ignore"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="IgnoreValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> IgnoreValue => "ignore"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="IgnoreValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> IgnoreValue => [0x85, 0x00, 0x00, 0x00, 0x22, 0x69, 0x67, 0x6E, 0x6F, 0x72, 0x65, 0x22];
        }
    }
}
