...
public readonly partial struct YamllintSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.Mutable(Mutable value)
        {
            return Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(YamllintSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="YamllintSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator YamllintSchema(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.YamllintBenchmark.Current.JsonString.Mutable IgnoreValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreValueUtf8, out Corvus.YamllintBenchmark.Current.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new YamllintSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetIgnoreValue(scoped in Corvus.YamllintBenchmark.Current.JsonString.Source value)
        {
            ...
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IgnoreValueUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IgnoreValue, ref cvb);
        ...
        public bool RemoveIgnoreValue()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IgnoreValueUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </remarks>
        public void Apply(in Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"YamllintSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="YamllintSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="YamllintSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly YamllintSchema Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<YamllintSchema>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="YamllintSchema"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly YamllintSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<YamllintSchema>(_idx);
        }

        /// <summary>
        /// Gets the value as a <see cref="Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsIgnore(out Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.Mutable result)
        {
            if (Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.YamllintBenchmark.Current.JsonString.Source _createArg1;
        ...
        public static implicit operator Source(YamllintSchema instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.YamllintBenchmark.Current.YamllintSchema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="YamllintSchema"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.YamllintBenchmark.Current.JsonString.Source ignore = default)
        {
            ignore.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IgnoreValue, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="YamllintSchema"/>.
        /// </summary>
        public void Create(in Corvus.YamllintBenchmark.Current.JsonString.Source ignore = default)
        {
            Create(ref _builder, ignore);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.YamllintBenchmark.Current.JsonString.Source ignore = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<YamllintSchema, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<YamllintSchema> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<YamllintSchema>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<YamllintSchema> Create<TContext>(
    ...
    public static ParsedJsonDocument<YamllintSchema> Create(in Corvus.YamllintBenchmark.Current.JsonString.Source ignore = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
