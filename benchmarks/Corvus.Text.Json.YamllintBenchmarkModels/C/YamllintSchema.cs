...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="YamllintSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal YamllintSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static YamllintSchema DefaultInstance { get; }
    ...
    public static implicit operator Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore(YamllintSchema value)
    {
        return Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator YamllintSchema(Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore value)
    {
        return From(value);
    }
    ...
    /// </returns>
    public static bool operator ==(in YamllintSchema left, in YamllintSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in YamllintSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(YamllintSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator YamllintSchema(JsonElement instance)
    {
        return YamllintSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static YamllintSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static YamllintSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<YamllintSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static YamllintSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<YamllintSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static YamllintSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<YamllintSchema>(json, options);
    }
    ...
    /// </exception>
    public static YamllintSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<YamllintSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out YamllintSchema? result)
    {
        return JsonElementHelpers.TryParseValue<YamllintSchema>(ref reader, out result);
    }
...
#if NET
    static YamllintSchema IJsonElement<YamllintSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"YamllintSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public YamllintSchema Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<YamllintSchema>(_idx);
        }
    ...
    public bool TryGetAsIgnore(out Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore result)
    {
        ...
        {
            result = Corvus.YamllintBenchmark.Current.YamllintSchema.Ignore.From(this);
            return true;
        }
