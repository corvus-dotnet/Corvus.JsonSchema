...
/// </summary>
public readonly partial struct PersonCommonSchema : IJsonObject<PersonCommonSchema>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "PersonCommonSchema"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public PersonCommonSchema(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator PersonCommonSchema(JsonObject value)
    {
    ...
    public static PersonCommonSchema FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static PersonCommonSchema FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static PersonCommonSchema FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public PersonCommonSchema SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public PersonCommonSchema RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public PersonCommonSchema RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public PersonCommonSchema RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public PersonCommonSchema RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
