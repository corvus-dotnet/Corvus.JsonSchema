...
[CollectionBuilder(typeof(ThirdRank), "Create")]
public readonly partial struct ThirdRank : IJsonArray<ThirdRank>, IReadOnlyCollection<Corvus.Json.JsonDouble>
#else
    public readonly partial struct ThirdRank : IJsonArray<ThirdRank>, IReadOnlyCollection<Corvus.Json.JsonDouble>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly ThirdRank EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ThirdRank"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ThirdRank(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ThirdRank(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<ThirdRank>.this[int index]
        {
            get
            {
        ...
        public static implicit operator ImmutableList<JsonAny>(ThirdRank value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ThirdRank(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ThirdRank(JsonArray value)
        {
        ...
        public static ThirdRank From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static ThirdRank Create(ReadOnlySpan<Corvus.Json.JsonDouble> items)
        {
            return new([..items]);
        }
    ...
    /// </remarks>
    static ThirdRank IJsonArray<ThirdRank>.FromRange(IEnumerable<JsonAny> items)
    {
        ...
        return new ThirdRank(builder.ToImmutable());
    }
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    static ThirdRank IJsonArray<ThirdRank>.FromRange<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <remarks>
        /// The values should be of length 4.
        /// </remarks>
        public static ThirdRank FromValues(ReadOnlySpan<double> values)
        {
            if (values.Length != 4)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ThirdRank>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        public bool TryGetNumericValues(Span<double> items, out int written)
        {
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                if (items.Length < ThirdRank.ValueBufferSize)
                {
                    written = 0;
                    return false;
                }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ThirdRank>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
