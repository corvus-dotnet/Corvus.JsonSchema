...
/// </summary>
public readonly partial struct CompositeType : IJsonObject<CompositeType>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "CompositeType"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public CompositeType(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator CompositeType(JsonObject value)
    {
    ...
    public static CompositeType FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static CompositeType FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static CompositeType FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public CompositeType SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public CompositeType RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public CompositeType RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public CompositeType RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public CompositeType RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
