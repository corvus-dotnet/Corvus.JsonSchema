...
public readonly partial struct CompositeType
{
    private ValidationContext ValidateAllOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext allOfResult0 = this.As<JsonSchemaSample.Api.Countable>().Validate(childContext0.CreateChildContext(), level);
        ...
        ValidationContext allOfResult1 = this.As<JsonSchemaSample.Api.Documentation>().Validate(childContext1.CreateChildContext(), level);
