...
[CollectionBuilder(typeof(DiscriminatedUnionByType), "Create")]
public readonly partial struct DiscriminatedUnionByType : IJsonArray<DiscriminatedUnionByType>, IReadOnlyCollection<JsonAny>
#else
public readonly partial struct DiscriminatedUnionByType : IJsonArray<DiscriminatedUnionByType>, IReadOnlyCollection<JsonAny>
#endif
{
    ...
    /// Gets an empty array.
    /// </summary>
    public static readonly DiscriminatedUnionByType EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    /// Initializes a new instance of the <see cref = "DiscriminatedUnionByType"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public DiscriminatedUnionByType(ImmutableList<JsonAny> value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public DiscriminatedUnionByType(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
        this.stringBacking = string.Empty;
    ...
    public static implicit operator ImmutableList<JsonAny>(DiscriminatedUnionByType value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator DiscriminatedUnionByType(ImmutableList<JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator DiscriminatedUnionByType(JsonArray value)
    {
    ...
    public static DiscriminatedUnionByType From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }
    ...
    public static DiscriminatedUnionByType Create(ReadOnlySpan<JsonAny> items)
    {
        return new([..items]);
    }
    ...
    public static DiscriminatedUnionByType FromItems(params JsonAny[] value)
    {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A DiscriminatedUnionByType instantiated from the given items.</returns>
    public static DiscriminatedUnionByType FromItems<TItem>(params TItem[] value)
    ...
    /// <returns>A DiscriminatedUnionByType instantiated from the given items.</returns>
    public static DiscriminatedUnionByType FromItems<TItem1>(in TItem1 value1)
    ...
    /// <returns>A DiscriminatedUnionByType instantiated from the given items.</returns>
    public static DiscriminatedUnionByType FromItems<TItem1, TItem2>(in TItem1 value1, in TItem2 value2)
    ...
    /// <returns>A DiscriminatedUnionByType instantiated from the given items.</returns>
    public static DiscriminatedUnionByType FromItems<TItem1, TItem2, TItem3>(in TItem1 value1, in TItem2 value2, in TItem3 value3)
    ...
    /// </remarks>
    public static DiscriminatedUnionByType From<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        return new DiscriminatedUnionByType(builder.ToImmutable());
    }
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static DiscriminatedUnionByType FromRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static DiscriminatedUnionByType FromRange<T>(IEnumerable<T> items)
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static DiscriminatedUnionByType FromRange(IEnumerable<string> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static DiscriminatedUnionByType FromRange(IEnumerable<double> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static DiscriminatedUnionByType FromRange(IEnumerable<float> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static DiscriminatedUnionByType FromRange(IEnumerable<int> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static DiscriminatedUnionByType FromRange(IEnumerable<long> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "items">The items from which to create the array.</param>
    /// <returns>The new array created from the items.</returns>
    public static DiscriminatedUnionByType FromRange(IEnumerable<bool> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// <param name = "value1">The first value from which to construct the instance.</param>
    /// <returns>A DiscriminatedUnionByType instantiated from the given items.</returns>
    public static DiscriminatedUnionByType FromItems(in JsonAny value1)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1);
        return new(builder.ToImmutable());
    ...
    /// <param name = "value2">The second value from which to construct the instance.</param>
    /// <returns>A DiscriminatedUnionByType instantiated from the given items.</returns>
    public static DiscriminatedUnionByType FromItems(in JsonAny value1, in JsonAny value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1);
        builder.Add(value2);
    ...
    /// <param name = "value3">The thirdvalue from which to construct the instance.</param>
    /// <returns>A DiscriminatedUnionByType instantiated from the given items.</returns>
    public static DiscriminatedUnionByType FromItems(in JsonAny value1, in JsonAny value2, in JsonAny value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1);
        builder.Add(value2);
