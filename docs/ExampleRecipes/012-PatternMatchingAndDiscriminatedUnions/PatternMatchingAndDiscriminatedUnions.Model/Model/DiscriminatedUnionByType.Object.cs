...
/// </summary>
public readonly partial struct DiscriminatedUnionByType : IJsonObject<DiscriminatedUnionByType>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "DiscriminatedUnionByType"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public DiscriminatedUnionByType(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator DiscriminatedUnionByType(JsonObject value)
    {
    ...
    public static DiscriminatedUnionByType FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static DiscriminatedUnionByType FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static DiscriminatedUnionByType FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public DiscriminatedUnionByType SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public DiscriminatedUnionByType RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public DiscriminatedUnionByType RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public DiscriminatedUnionByType RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public DiscriminatedUnionByType RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
