...
public readonly partial struct PatchOperation
{
    ...
    public readonly partial struct AddOperation
    {
        ...
        public static implicit operator JsonSchemaSample.Api.PatchOperation.PatchOperationCommon(AddOperation value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator AddOperation(JsonSchemaSample.Api.PatchOperation.PatchOperationCommon value)
        {
