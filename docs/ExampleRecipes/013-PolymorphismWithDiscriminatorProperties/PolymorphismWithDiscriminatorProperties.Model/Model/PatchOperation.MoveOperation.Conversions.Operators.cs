...
public readonly partial struct PatchOperation
{
    ...
    public readonly partial struct MoveOperation
    {
        ...
        public static implicit operator JsonSchemaSample.Api.PatchOperation.PatchOperationCommon(MoveOperation value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator MoveOperation(JsonSchemaSample.Api.PatchOperation.PatchOperationCommon value)
        {
