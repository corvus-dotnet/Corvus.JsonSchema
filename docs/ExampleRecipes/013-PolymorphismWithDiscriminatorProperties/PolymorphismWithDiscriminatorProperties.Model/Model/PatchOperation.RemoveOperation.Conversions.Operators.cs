...
public readonly partial struct PatchOperation
{
    ...
    public readonly partial struct RemoveOperation
    {
        ...
        public static implicit operator JsonSchemaSample.Api.PatchOperation.PatchOperationCommon(RemoveOperation value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator RemoveOperation(JsonSchemaSample.Api.PatchOperation.PatchOperationCommon value)
        {
