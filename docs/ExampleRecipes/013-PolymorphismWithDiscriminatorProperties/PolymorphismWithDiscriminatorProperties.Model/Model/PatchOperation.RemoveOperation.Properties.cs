...
public readonly partial struct PatchOperation
{
    ...
    public readonly partial struct RemoveOperation
    {
        ...
        /// </summary>
        public JsonSchemaSample.Api.PatchOperation.RemoveOperation.OpEntity Op
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new JsonSchemaSample.Api.PatchOperation.RemoveOperation.OpEntity(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<JsonSchemaSample.Api.PatchOperation.RemoveOperation.OpEntity>();
                    }
                }
        ...
        /// </summary>
        public static RemoveOperation Create(Corvus.Json.JsonPointer path)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            builder.Add(JsonPropertyNames.Op, new JsonSchemaSample.Api.PatchOperation.RemoveOperation.OpEntity().AsAny);
        ...
        {
            return property.ValueAs<JsonSchemaSample.Api.PatchOperation.RemoveOperation.OpEntity>().Validate(validationContext, level);
        }
