...
public readonly partial struct PatchOperation
{
    ...
    public readonly partial struct TestOperation
    {
        ...
        public static implicit operator JsonSchemaSample.Api.PatchOperation.PatchOperationCommon(TestOperation value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator TestOperation(JsonSchemaSample.Api.PatchOperation.PatchOperationCommon value)
        {
