...
: IJsonNumber<Baz>,
  IAdditionOperators<Baz, Baz, Baz>,
  ISubtractionOperators<Baz, Baz, Baz>,
  IMultiplyOperators<Baz, Baz, Baz>,
  IDivisionOperators<Baz, Baz, Baz>,
  IIncrementOperators<Baz>,
  IDecrementOperators<Baz>
#else
    : IJsonNumber<Baz>
#endif
    {
        ...
        public Baz(in BinaryJsonNumber value)
        {
        ...
        public Baz(double value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static implicit operator Baz(JsonNumber value)
        {
        ...
        public static explicit operator byte (Baz value)
        {
        ...
        public static explicit operator decimal (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator double (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator short (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator int (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator long (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(Baz value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        public static explicit operator sbyte (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator Half(Baz value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
        /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
        public static explicit operator float (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ushort (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator uint (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ulong (Baz value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(Baz value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(decimal value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator Baz(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(byte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator Baz(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator Baz(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator Baz(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
        ...
        public static bool operator <(in Baz left, in Baz right)
        {
        ...
        public static Baz operator +(Baz left, Baz right)
        {
        ...
        /// <returns>The resulting value.</returns>
        public static Baz operator ++(Baz value)
        {
        ...
        public static int Compare(in Baz lhs, in Baz rhs)
        {
