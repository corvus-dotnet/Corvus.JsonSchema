...
public readonly partial struct NumericOptions
{
    private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext oneOfResult0 = this.As<JsonSchemaSample.Api.NumericOptions.Foo>().Validate(childContext0.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult1 = this.As<JsonSchemaSample.Api.NumericOptions.Bar>().Validate(childContext1.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult2 = this.As<JsonSchemaSample.Api.NumericOptions.Baz>().Validate(childContext2.CreateChildContext(), level);
