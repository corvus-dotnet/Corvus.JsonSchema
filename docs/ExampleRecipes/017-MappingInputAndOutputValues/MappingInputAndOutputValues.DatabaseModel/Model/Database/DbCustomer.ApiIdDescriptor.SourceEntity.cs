...
public readonly partial struct DbCustomer
{
    public readonly partial struct ApiIdDescriptor
    {
        ...
        public readonly partial struct SourceEntity
        {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "db-customer.json#/$defs/apiIdDescriptor/properties/source";
            /// <summary>
            ...
            public static implicit operator SourceEntity(in JsonAny value)
            {
            ...
            /// <param name = "value">The value from which to convert.</param>
            /// <exception cref = "InvalidOperationException">The value was not compatible with this type.</exception>
            public static implicit operator JsonAny(in SourceEntity value)
            {
                return value.AsAny;
            }
    ...
    /// <remarks>This will be SourceEntity.Undefined if the type is not compatible.</remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    static SourceEntity IJsonValue<SourceEntity>.FromObject<TValue>(in TValue value)
    {
        ...
        return Undefined;
...
#endif
            /// <summary>
            /// Parses a JSON string into a SourceEntity.
            /// </summary>
            /// <param name = "json">The json string to parse.</param>
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "SourceEntity"/> instance built from the JSON string.</returns>
            public static SourceEntity Parse(string json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(json, options);
                return new SourceEntity(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "SourceEntity"/> instance built from the JSON string.</returns>
            public static SourceEntity Parse(Stream utf8Json, JsonDocumentOptions options = default)
            {
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "SourceEntity"/> instance built from the JSON string.</returns>
            public static SourceEntity Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(utf8Json, options);
                return new SourceEntity(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "SourceEntity"/> instance built from the JSON string.</returns>
            public static SourceEntity Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(json, options);
                return new SourceEntity(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "SourceEntity"/> instance built from the JSON string.</returns>
            public static SourceEntity Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(utf8Json, options);
                return new SourceEntity(jsonDocument.RootElement.Clone());
            }
            ...
            static SourceEntity ParseValue(ReadOnlySpan<char> buffer)
            {
#if NET8_0_OR_GREATER
        return IJsonValue<SourceEntity>.ParseValue(buffer);
#else
                return JsonValueHelpers.ParseValue<SourceEntity>(buffer);
#endif
            }
            ...
            /// <param name = "buffer">The buffer from which to parse the value.</param>
            /// <returns>The parsed value.</returns>
            static SourceEntity ParseValue(ReadOnlySpan<byte> buffer)
            {
#if NET8_0_OR_GREATER
        return IJsonValue<SourceEntity>.ParseValue(buffer);
#else
            ...
            /// <returns>The parsed value.</returns>
            static SourceEntity ParseValue(ref Utf8JsonReader reader)
            {
#if NET8_0_OR_GREATER
        return IJsonValue<SourceEntity>.ParseValue(ref reader);
#else
                return JsonValueHelpers.ParseValue<SourceEntity>(ref reader);
#endif
            }
