...
public readonly partial struct DbCustomer
{
    ...
    public readonly partial struct GenericIdDescriptor
    {
        ...
        /// </summary>
        public JsonSchemaSample.DatabaseApi.DbCustomer.ConstrainedString Id
        {
            get
            {
        ...
        /// </summary>
        public JsonSchemaSample.DatabaseApi.DbCustomer.GenericIdDescriptor.SourceEntity Source
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new JsonSchemaSample.DatabaseApi.DbCustomer.GenericIdDescriptor.SourceEntity(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<JsonSchemaSample.DatabaseApi.DbCustomer.GenericIdDescriptor.SourceEntity>();
                    }
                }
        ...
        /// <summary>
        /// Creates an instance of a <see cref = "GenericIdDescriptor"/>.
        /// </summary>
        public static GenericIdDescriptor Create(JsonSchemaSample.DatabaseApi.DbCustomer.ConstrainedString id)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            builder.Add(JsonPropertyNames.Id, id.AsAny);
            builder.Add(JsonPropertyNames.Source, new JsonSchemaSample.DatabaseApi.DbCustomer.GenericIdDescriptor.SourceEntity().AsAny);
        ...
        public GenericIdDescriptor WithId(in JsonSchemaSample.DatabaseApi.DbCustomer.ConstrainedString value)
        {
        ...
        {
            return property.ValueAs<JsonSchemaSample.DatabaseApi.DbCustomer.GenericIdDescriptor.SourceEntity>().Validate(validationContext, level);
        }
