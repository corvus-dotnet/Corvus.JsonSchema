...
/// </summary>
public readonly partial struct DbCustomer : IJsonObject<DbCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "DbCustomer"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public DbCustomer(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator DbCustomer(JsonObject value)
    {
    ...
    public static DbCustomer FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static DbCustomer FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static DbCustomer FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public DbCustomer SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public DbCustomer RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public DbCustomer RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public DbCustomer RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public DbCustomer RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
