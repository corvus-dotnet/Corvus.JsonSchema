...
public readonly partial struct Error
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.Client.Models.JsonInt32.Mutable Code
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out Petstore.Client.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Client.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Petstore.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCode(scoped in Petstore.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(scoped in Petstore.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Client.Models.JsonInt32.Source arg1, scoped in Petstore.Client.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Client.Models.Error.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Client.Models.JsonInt32.Source code,
            in Petstore.Client.Models.JsonString.Source message)
        {
        ...
        /// Creates an instance of a <see cref="Error"/>.
        /// </summary>
        public void Create(in Petstore.Client.Models.JsonInt32.Source code, in Petstore.Client.Models.JsonString.Source message)
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.Client.Models.JsonInt32.Source arg1, scoped in Petstore.Client.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.Client.Models.JsonInt32.Source code, scoped in Petstore.Client.Models.JsonString.Source message)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Client.Models.JsonInt32.Source code, in Petstore.Client.Models.JsonString.Source message, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<Error> Create(in Petstore.Client.Models.JsonInt32.Source code, in Petstore.Client.Models.JsonString.Source message, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
