...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.Client.JsonInt32 Code
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out Petstore.Client.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.Client.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Petstore.Client.JsonString value))
            {
                return value;
            }
