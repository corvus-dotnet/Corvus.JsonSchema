...
public readonly partial struct NewPet
{
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.Client.NewPet.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Client.NewPet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// Creates an instance of a <see cref="NewPet"/>.
        /// </summary>
        public void Create(in Petstore.Client.JsonString.Source name, in Petstore.Client.JsonString.Source tag = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Client.JsonString.Source name, in Petstore.Client.JsonString.Source tag = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
