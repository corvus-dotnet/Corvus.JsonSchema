...
public readonly partial struct Pet
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.Client.Models.JsonInt64.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Petstore.Client.Models.JsonInt64.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Client.Models.JsonString.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Petstore.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Client.Models.JsonString.Mutable Tag
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagUtf8, out Petstore.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetId(scoped in Petstore.Client.Models.JsonInt64.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Client.Models.JsonInt64.Source arg1, scoped in Petstore.Client.Models.JsonString.Source arg2, scoped in Petstore.Client.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Client.Models.Pet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Client.Models.JsonInt64.Source id,
            in Petstore.Client.Models.JsonString.Source name,
            in Petstore.Client.Models.JsonString.Source tag = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.Client.Models.JsonInt64.Source arg1, scoped in Petstore.Client.Models.JsonString.Source arg2, scoped in Petstore.Client.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.Client.Models.JsonInt64.Source id, scoped in Petstore.Client.Models.JsonString.Source name, scoped in Petstore.Client.Models.JsonString.Source tag = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Client.Models.JsonInt64.Source id, in Petstore.Client.Models.JsonString.Source name, in Petstore.Client.Models.JsonString.Source tag = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<Pet> Create(in Petstore.Client.Models.JsonInt64.Source id, in Petstore.Client.Models.JsonString.Source name, in Petstore.Client.Models.JsonString.Source tag = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
