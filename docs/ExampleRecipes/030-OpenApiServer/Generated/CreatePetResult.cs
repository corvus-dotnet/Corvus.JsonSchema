...
public readonly struct CreatePetResult
{
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CreatePetResult"/> with status 201.</returns>
    public static CreatePetResult Created<TContext>(Petstore.Server.Models.Pet.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(201, Petstore.Server.Models.Pet.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CreatePetResult"/> with status default.</returns>
    public static CreatePetResult Default<TContext>(int statusCode, Petstore.Server.Models.Error.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
