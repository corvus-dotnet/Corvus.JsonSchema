...
public readonly partial struct NewPet
{
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Server.Models.JsonString.Source arg1, scoped in Petstore.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Server.Models.NewPet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// Creates an instance of a <see cref="NewPet"/>.
        /// </summary>
        public void Create(in Petstore.Server.Models.JsonString.Source name, in Petstore.Server.Models.JsonString.Source tag = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.Server.Models.JsonString.Source arg1, scoped in Petstore.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.Server.Models.JsonString.Source name, scoped in Petstore.Server.Models.JsonString.Source tag = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Server.Models.JsonString.Source name, in Petstore.Server.Models.JsonString.Source tag = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<NewPet> Create(in Petstore.Server.Models.JsonString.Source name, in Petstore.Server.Models.JsonString.Source tag = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
