...
public readonly partial struct Pet
{
...
#endif
    {
        ...
        public void SetId(scoped in Petstore.Server.Models.JsonInt64.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetName(scoped in Petstore.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTag(scoped in Petstore.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Server.Models.JsonInt64.Source arg1, scoped in Petstore.Server.Models.JsonString.Source arg2, scoped in Petstore.Server.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(scoped in Petstore.Server.Models.JsonInt64.Source arg1, scoped in Petstore.Server.Models.JsonString.Source arg2, scoped in Petstore.Server.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.Server.Models.JsonInt64.Source id, scoped in Petstore.Server.Models.JsonString.Source name, scoped in Petstore.Server.Models.JsonString.Source tag = default)
    {
    ...
    public static ParsedJsonDocument<Pet> Create(in Petstore.Server.Models.JsonInt64.Source id, in Petstore.Server.Models.JsonString.Source name, in Petstore.Server.Models.JsonString.Source tag = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
