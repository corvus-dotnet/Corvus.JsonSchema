            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = Petstore.Server.Pet.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    Petstore.Server.Pet.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
