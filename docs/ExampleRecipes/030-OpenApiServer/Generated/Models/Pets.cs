...
#endif
{
    ...
    public Petstore.Server.Models.Pet this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Petstore.Server.Models.Pet>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Petstore.Server.Models.Pet> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Petstore.Server.Models.Pet>(_parent, _idx);
    }
