...
public struct CreatePetResponse : IApiResponse<CreatePetResponse>
{
    ...
    /// </summary>
    public Petstore.Extended.Pet CreatedBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Petstore.Extended.Pet>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Petstore.Extended.Pet result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Petstore.Extended.Pet, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Petstore.Extended.Pet, TContext, TResult> matchCreated,
