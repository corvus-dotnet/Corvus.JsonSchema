...
public struct CreatePetResponse : IApiResponse<CreatePetResponse>
{
    ...
    /// </summary>
    public Petstore.Extended.Models.Pet CreatedBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Petstore.Extended.Models.Pet>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Petstore.Extended.Models.Pet result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Petstore.Extended.Models.Pet, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Petstore.Extended.Models.Pet, TContext, TResult> matchCreated,
