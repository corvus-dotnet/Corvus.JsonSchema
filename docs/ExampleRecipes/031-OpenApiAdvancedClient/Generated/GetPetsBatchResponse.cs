...
/// <summary>
/// Response type for the GetPetsBatch operation.
/// </summary>
public struct GetPetsBatchResponse : IApiResponse<GetPetsBatchResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetPetsBatchResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetPetsBatchResponse response = default;
