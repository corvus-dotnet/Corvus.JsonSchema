...
public readonly partial struct ActivityEvent
{
...
#endif
    {
        ...
        /// <param name="matchFeeding">Match 1st item.</param>
        /// <param name="matchWalk">Match 2nd item.</param>
        /// <param name="matchVetVisit">Match 3rd item.</param>
        /// <param name="matchPhotoAdded">Match 4th item.</param>
        /// <param name="matchAdoptionInquiry">Match 5th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchFeeding,
            Func<TContext, TResult> matchWalk,
            Func<TContext, TResult> matchVetVisit,
            Func<TContext, TResult> matchPhotoAdded,
            Func<TContext, TResult> matchAdoptionInquiry,
...
#endif
        {
            ...
            {
                return matchFeeding(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchWalk(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchVetVisit(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchPhotoAdded(context);
            }

            if (this.ValueEquals(Constants.Enum5))
            {
                return matchAdoptionInquiry(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchFeeding,
            Func<TResult> matchWalk,
            Func<TResult> matchVetVisit,
            Func<TResult> matchPhotoAdded,
            Func<TResult> matchAdoptionInquiry,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum3))
            {
                return matchVetVisit();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchPhotoAdded();
            }

            if (this.ValueEquals(Constants.Enum5))
            {
                return matchAdoptionInquiry();
            }
