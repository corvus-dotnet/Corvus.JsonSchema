...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ActivityEvent"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ActivityEvent(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ActivityEvent DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in ActivityEvent left, in ActivityEvent right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ActivityEvent left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ActivityEvent instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ActivityEvent(JsonElement instance)
    {
        return ActivityEvent.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ActivityEvent From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ActivityEvent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ActivityEvent>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ActivityEvent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ActivityEvent>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ActivityEvent ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ActivityEvent>(json, options);
    }
    ...
    /// </exception>
    public static ActivityEvent ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<ActivityEvent>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ActivityEvent? result)
    {
        return JsonElementHelpers.TryParseValue<ActivityEvent>(ref reader, out result);
    }
...
#if NET
    static ActivityEvent IJsonElement<ActivityEvent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ActivityEvent: ValueKind = {ValueKind} : \"{ToString()}\"";
