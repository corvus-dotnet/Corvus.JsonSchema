...
public readonly partial struct ChatChunk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ChatChunk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ChatChunk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ChatChunk(Mutable instance)
        {
        ...
        /// </summary>
        public Petstore.Extended.Models.JsonString.Mutable Delta
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeltaUtf8, out Petstore.Extended.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Models.JsonBoolean.Mutable Done
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DoneUtf8, out Petstore.Extended.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Models.JsonString.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Petstore.Extended.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ChatChunk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDelta(scoped in Petstore.Extended.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDone(scoped in Petstore.Extended.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DoneUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DoneUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Done, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>done</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveDone()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DoneUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetId(scoped in Petstore.Extended.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ChatChunk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ChatChunk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ChatChunk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ChatChunk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ChatChunk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ChatChunk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ChatChunk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ChatChunk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.JsonString.Source arg2, scoped in Petstore.Extended.Models.JsonBoolean.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Models.ChatChunk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ChatChunk"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Petstore.Extended.Models.JsonString.Source id,
            in Petstore.Extended.Models.JsonString.Source delta = default,
            in Petstore.Extended.Models.JsonBoolean.Source done = default)
        {
            ...
            done.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Done, ref builder);
        }
        ...
        public void Create(
            ...
            in Petstore.Extended.Models.JsonBoolean.Source done = default)
        {
            Create(ref _builder, id, delta, done);
        }
        ...
        internal static void BuildCreateValue(scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.JsonString.Source arg2, scoped in Petstore.Extended.Models.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.Extended.Models.JsonString.Source id, scoped in Petstore.Extended.Models.JsonString.Source delta = default, scoped in Petstore.Extended.Models.JsonBoolean.Source done = default)
    {
    ...
    /// <param name="done">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Models.JsonString.Source id, in Petstore.Extended.Models.JsonString.Source delta = default, in Petstore.Extended.Models.JsonBoolean.Source done = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(id, delta, done);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ChatChunk, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ChatChunk> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ChatChunk>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ChatChunk> Create<TContext>(
    ...
    public static ParsedJsonDocument<ChatChunk> Create(in Petstore.Extended.Models.JsonString.Source id, in Petstore.Extended.Models.JsonString.Source delta = default, in Petstore.Extended.Models.JsonBoolean.Source done = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
