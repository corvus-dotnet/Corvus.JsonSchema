    ...
    : IJsonElement<GetPetsFilter>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchMinAge(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            Petstore.Extended.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext3 =
                Petstore.Extended.GetPetsFilter.StatusEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Petstore.Extended.GetPetsFilter.StatusEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            context.CommitChildContext(childContext3.IsMatch, ref childContext3);
        }

        private static PropertySchemaMatchers<Petstore.Extended.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Petstore.Extended.PropertiesValidationHandler_NamedPropertyValidator1>([
        ...
        private static PropertySchemaMatchers<Petstore.Extended.PropertiesValidationHandler_NamedPropertyValidator1> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out Petstore.Extended.PropertiesValidationHandler_NamedPropertyValidator1? matcher)
        {
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Petstore.Extended.PropertiesValidationHandler_NamedPropertyValidator1? validator))
                    {
