...
public readonly partial struct GetPetsFilter
#if NET8_0_OR_GREATER
    : IJsonElement<GetPetsFilter>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetPetsFilter"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetPetsFilter(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetPetsFilter DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetPetsFilter left, in GetPetsFilter right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetPetsFilter left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetPetsFilter instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetPetsFilter(JsonElement instance)
    {
        return GetPetsFilter.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsFilter From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsFilter ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetPetsFilter>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsFilter ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetPetsFilter>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsFilter ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetPetsFilter>(json, options);
    }
    ...
    /// </exception>
    public static GetPetsFilter ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetPetsFilter>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetPetsFilter? result)
    {
        return JsonElementHelpers.TryParseValue<GetPetsFilter>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetPetsFilter(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetPetsFilter IJsonElement<GetPetsFilter>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetPetsFilter: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetPetsFilter"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetPetsFilter"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetPetsFilter Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetPetsFilter>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetPetsFilter"/> that lives for the lifetime of its
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="MinAge"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="MinAge"/>.
        /// </summary>
        public static ReadOnlySpan<byte> MinAgeUtf8 => "minAge"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="MinAge"/>.
        /// </summary>
        public static ReadOnlySpan<byte> MinAge => "minAge"u8;
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="MinAge"/>.
        /// </summary>
        public static ReadOnlySpan<byte> MinAge => [0x85, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x69, 0x6E, 0x41, 0x67, 0x65, 0x22];
