...
public readonly partial struct GetPetsLimit
#if NET8_0_OR_GREATER
    : IJsonElement<GetPetsLimit>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetPetsLimit"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetPetsLimit(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetPetsLimit DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator System.Numerics.BigInteger(GetPetsLimit value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in GetPetsLimit left, in GetPetsLimit right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetPetsLimit left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(GetPetsLimit instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetPetsLimit(JsonElement instance)
    {
        return GetPetsLimit.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsLimit From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsLimit ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetPetsLimit>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsLimit ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetPetsLimit>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsLimit ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetPetsLimit>(json, options);
    }
    ...
    /// </exception>
    public static GetPetsLimit ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetPetsLimit>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetPetsLimit? result)
    {
        return JsonElementHelpers.TryParseValue<GetPetsLimit>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetPetsLimit(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetPetsLimit IJsonElement<GetPetsLimit>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetPetsLimit: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetPetsLimit"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetPetsLimit"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetPetsLimit Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetPetsLimit>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetPetsLimit"/> that lives for the lifetime of its
