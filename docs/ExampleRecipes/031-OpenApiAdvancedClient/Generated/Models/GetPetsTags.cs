...
#endif
{
    ...
    public Petstore.Extended.JsonString this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Petstore.Extended.JsonString>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Petstore.Extended.JsonString> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Petstore.Extended.JsonString>(_parent, _idx);
    }
