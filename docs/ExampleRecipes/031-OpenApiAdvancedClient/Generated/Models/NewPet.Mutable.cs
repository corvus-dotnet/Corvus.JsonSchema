...
public readonly partial struct NewPet
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Models.NewPet.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Models.NewPet.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Models.NewPet.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Petstore.Extended.Models.NewPet.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Petstore.Extended.Models.NewPet.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(scoped in Petstore.Extended.Models.NewPet.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in Petstore.Extended.Models.NewPet.JsonStringArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.NewPet.StatusEntity.Source arg2, scoped in Petstore.Extended.Models.JsonInteger.Source arg3, scoped in Petstore.Extended.Models.JsonString.Source arg4, scoped in Petstore.Extended.Models.NewPet.JsonStringArray.Source arg5)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.NewPet.StatusEntity.Source arg2, scoped in Petstore.Extended.Models.JsonInteger.Source arg3, scoped in Petstore.Extended.Models.JsonString.Source arg4, scoped in Petstore.Extended.Models.NewPet.JsonStringArray.Source<TContext> arg5)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Models.NewPet.StatusEntity.Source status,
            in Petstore.Extended.Models.JsonInteger.Source age = default,
            in Petstore.Extended.Models.JsonString.Source breed = default,
            in Petstore.Extended.Models.NewPet.JsonStringArray.Source tags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Petstore.Extended.Models.JsonInteger.Source age = default,
            in Petstore.Extended.Models.JsonString.Source breed = default,
            in Petstore.Extended.Models.NewPet.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.NewPet.StatusEntity.Source arg2, scoped in Petstore.Extended.Models.JsonInteger.Source arg3, scoped in Petstore.Extended.Models.JsonString.Source arg4, scoped in Petstore.Extended.Models.NewPet.JsonStringArray.Source arg5, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg5">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.NewPet.StatusEntity.Source arg2, scoped in Petstore.Extended.Models.JsonInteger.Source arg3, scoped in Petstore.Extended.Models.JsonString.Source arg4, scoped in Petstore.Extended.Models.NewPet.JsonStringArray.Source<TContext> arg5, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.Extended.Models.JsonString.Source name, scoped in Petstore.Extended.Models.NewPet.StatusEntity.Source status, scoped in Petstore.Extended.Models.JsonInteger.Source age = default, scoped in Petstore.Extended.Models.JsonString.Source breed = default, scoped in Petstore.Extended.Models.NewPet.JsonStringArray.Source tags = default)
    {
    ...
    /// <param name="tags">The value of the <c>"tags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Petstore.Extended.Models.JsonString.Source name, scoped in Petstore.Extended.Models.NewPet.StatusEntity.Source status, scoped in Petstore.Extended.Models.JsonInteger.Source age = default, scoped in Petstore.Extended.Models.JsonString.Source breed = default, scoped in Petstore.Extended.Models.NewPet.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Models.JsonString.Source name, in Petstore.Extended.Models.NewPet.StatusEntity.Source status, in Petstore.Extended.Models.JsonInteger.Source age = default, in Petstore.Extended.Models.JsonString.Source breed = default, in Petstore.Extended.Models.NewPet.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Petstore.Extended.Models.JsonString.Source name, in Petstore.Extended.Models.NewPet.StatusEntity.Source status, in Petstore.Extended.Models.JsonInteger.Source age = default, in Petstore.Extended.Models.JsonString.Source breed = default, in Petstore.Extended.Models.NewPet.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static ParsedJsonDocument<NewPet> Create(in Petstore.Extended.Models.JsonString.Source name, in Petstore.Extended.Models.NewPet.StatusEntity.Source status, in Petstore.Extended.Models.JsonInteger.Source age = default, in Petstore.Extended.Models.JsonString.Source breed = default, in Petstore.Extended.Models.NewPet.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<NewPet> Create<TContext>(in TContext context, in Petstore.Extended.Models.JsonString.Source name, in Petstore.Extended.Models.NewPet.StatusEntity.Source status, in Petstore.Extended.Models.JsonInteger.Source age = default, in Petstore.Extended.Models.JsonString.Source breed = default, in Petstore.Extended.Models.NewPet.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
