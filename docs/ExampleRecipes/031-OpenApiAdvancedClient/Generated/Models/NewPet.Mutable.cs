...
public readonly partial struct NewPet
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.NewPet.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.NewPet.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.NewPet.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Petstore.Extended.NewPet.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in Petstore.Extended.NewPet.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in Petstore.Extended.NewPet.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in Petstore.Extended.NewPet.JsonStringArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.Extended.NewPet.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.NewPet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.NewPet.StatusEntity.Source status,
            in Petstore.Extended.JsonInteger.Source age = default,
            in Petstore.Extended.JsonString.Source breed = default,
            in Petstore.Extended.NewPet.JsonStringArray.Source tags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Petstore.Extended.JsonInteger.Source age = default,
            in Petstore.Extended.JsonString.Source breed = default,
            in Petstore.Extended.NewPet.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.JsonString.Source name, in Petstore.Extended.NewPet.StatusEntity.Source status, in Petstore.Extended.JsonInteger.Source age = default, in Petstore.Extended.JsonString.Source breed = default, in Petstore.Extended.NewPet.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Petstore.Extended.JsonString.Source name, in Petstore.Extended.NewPet.StatusEntity.Source status, in Petstore.Extended.JsonInteger.Source age = default, in Petstore.Extended.JsonString.Source breed = default, in Petstore.Extended.NewPet.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
