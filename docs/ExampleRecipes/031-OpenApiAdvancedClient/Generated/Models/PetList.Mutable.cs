...
public readonly partial struct PetList
{
...
#endif
    {
        ...
        public Petstore.Extended.Models.Pet.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Petstore.Extended.Models.Pet.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Petstore.Extended.Models.Pet.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Petstore.Extended.Models.Pet.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Petstore.Extended.Models.Pet.Source value)
        {
            CheckValidInstance();
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Petstore.Extended.Models.Pet item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Petstore.Extended.Models.Pet>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Petstore.Extended.Models.Pet> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Petstore.Extended.Models.Pet>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in Petstore.Extended.Models.Pet oldItem, in Petstore.Extended.Models.Pet.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Petstore.Extended.Models.Pet>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                Petstore.Extended.Models.Pet current = enumerator.Current;
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.Extended.Models.PetList.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Models.PetList.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// Add an item to the array.
        /// </summary>
        public void AddItem<TContext>(in Petstore.Extended.Models.Pet.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
