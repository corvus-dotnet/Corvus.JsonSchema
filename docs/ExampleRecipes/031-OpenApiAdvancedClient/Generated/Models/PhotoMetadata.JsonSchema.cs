    ...
    : IJsonElement<PhotoMetadata>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForPetId = 0b00000000000000000000000000000001;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPhotoIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("photoId"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPhotoIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("photoId"u8, buffer, out written);

        private const int RequiredOffsetForPhotoId = 0;
        private const uint RequiredBitForPhotoId = 0b00000000000000000000000000000010;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUploadedAtPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("uploadedAt"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUploadedAtNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("uploadedAt"u8, buffer, out written);

        private const int RequiredOffsetForUploadedAt = 0;
        private const uint RequiredBitForUploadedAt = 0b00000000000000000000000000000100;

        private const uint RequiredBitMask0 =
            RequiredBitForPetId | RequiredBitForPhotoId | RequiredBitForUploadedAt;
        private static readonly JsonSchemaPathProvider CaptionSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/caption"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider IsPrimarySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/isPrimary"u8, buffer, out written);
        ...
        private static readonly JsonSchemaPathProvider PhotoIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/photoId"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider UploadedAtSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/uploadedAt"u8, buffer, out written);

        private static void MatchCaption(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
        ...
        private static void MatchIsPrimary(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            ...
            Petstore.Extended.Models.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchPhotoId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            ...
            Petstore.Extended.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            requiredBitBuffer[RequiredOffsetForPhotoId] |= RequiredBitForPhotoId;
        }

        private static void MatchUploadedAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext4 =
                Petstore.Extended.Models.JsonDateTime.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Petstore.Extended.Models.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
        ...
        private static PropertySchemaMatchers<Petstore.Extended.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Petstore.Extended.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.PhotoIdUtf8, MatchPhotoId),
                (static () => JsonPropertyNames.UploadedAtUtf8, MatchUploadedAt),
            ]);
        }
        ...
        /// </summary>
        public const string SchemaLocation = "/components/schemas/PhotoMetadata";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/PhotoMetadata"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPetIdPresent, "petId"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPhotoIdPresent, "photoId"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyUploadedAtPresent, "uploadedAt"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyPetIdNotPresent, "petId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPetIdPresent, "petId"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForPhotoId] & RequiredBitForPhotoId) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyPhotoIdNotPresent, "photoId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPhotoIdPresent, "photoId"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForUploadedAt] & RequiredBitForUploadedAt) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyUploadedAtNotPresent, "uploadedAt"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyUploadedAtPresent, "uploadedAt"u8, "required"u8);
