...
#endif
{
    ...
    /// </summary>
    public static PhotoMetadata DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PhotoMetadata left, in PhotoMetadata right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PhotoMetadata left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PhotoMetadata instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PhotoMetadata(JsonElement instance)
    {
        return PhotoMetadata.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PhotoMetadata From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PhotoMetadata ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PhotoMetadata>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PhotoMetadata ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PhotoMetadata>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PhotoMetadata ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PhotoMetadata>(json, options);
    }
    ...
    /// </exception>
    public static PhotoMetadata ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PhotoMetadata>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PhotoMetadata? result)
    {
        return JsonElementHelpers.TryParseValue<PhotoMetadata>(ref reader, out result);
    }
...
#if NET
    static PhotoMetadata IJsonElement<PhotoMetadata>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PhotoMetadata: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Caption"/>.
        /// </summary>
        public const string Caption = "caption";

        /// <summary>
        /// Gets the JSON property name for <see cref="IsPrimary"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="PhotoId"/>.
        /// </summary>
        public const string PhotoId = "photoId";

        /// <summary>
        /// Gets the JSON property name for <see cref="UploadedAt"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Caption"/>.
        /// </summary>
        public static ReadOnlySpan<byte> CaptionUtf8 => "caption"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="IsPrimary"/>.
        /// </summary>
        public static ReadOnlySpan<byte> IsPrimaryUtf8 => "isPrimary"u8;
        ...
        /// Gets the JSON property name for <see cref="PhotoId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PhotoIdUtf8 => "photoId"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Caption"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Caption => "caption"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="IsPrimary"/>.
        /// </summary>
        public static ReadOnlySpan<byte> IsPrimary => "isPrimary"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="PhotoId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PhotoId => "photoId"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="UploadedAt"/>.
        /// </summary>
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Caption"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Caption => [0x95, 0x00, 0x00, 0x00, 0x22, 0x63, 0x61, 0x70, 0x74, 0x69, 0x6F, 0x6E, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="IsPrimary"/>.
        /// </summary>
        public static ReadOnlySpan<byte> IsPrimary => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x69, 0x73, 0x50, 0x72, 0x69, 0x6D, 0x61, 0x72, 0x79, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="PhotoId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PhotoId => [0x95, 0x00, 0x00, 0x00, 0x22, 0x70, 0x68, 0x6F, 0x74, 0x6F, 0x49, 0x64, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="UploadedAt"/>.
        /// </summary>
        public static ReadOnlySpan<byte> UploadedAt => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x75, 0x70, 0x6C, 0x6F, 0x61, 0x64, 0x65, 0x64, 0x41, 0x74, 0x22];
    }
}
