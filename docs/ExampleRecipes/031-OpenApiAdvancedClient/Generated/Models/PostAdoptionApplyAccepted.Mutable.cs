...
public readonly partial struct PostAdoptionApplyAccepted
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Models.JsonString.Mutable ApplicationId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ApplicationIdUtf8, out Petstore.Extended.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Models.JsonInteger.Mutable EstimatedReviewDays
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EstimatedReviewDaysUtf8, out Petstore.Extended.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Models.PostAdoptionApplyAccepted.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Models.PostAdoptionApplyAccepted.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetApplicationId(scoped in Petstore.Extended.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEstimatedReviewDays(scoped in Petstore.Extended.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Petstore.Extended.Models.PostAdoptionApplyAccepted.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.PostAdoptionApplyAccepted.StatusEntity.Source arg2, scoped in Petstore.Extended.Models.JsonInteger.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Models.PostAdoptionApplyAccepted.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Models.JsonString.Source applicationId,
            in Petstore.Extended.Models.PostAdoptionApplyAccepted.StatusEntity.Source status,
            in Petstore.Extended.Models.JsonInteger.Source estimatedReviewDays = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.PostAdoptionApplyAccepted.StatusEntity.Source arg2, scoped in Petstore.Extended.Models.JsonInteger.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.Extended.Models.JsonString.Source applicationId, scoped in Petstore.Extended.Models.PostAdoptionApplyAccepted.StatusEntity.Source status, scoped in Petstore.Extended.Models.JsonInteger.Source estimatedReviewDays = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Models.JsonString.Source applicationId, in Petstore.Extended.Models.PostAdoptionApplyAccepted.StatusEntity.Source status, in Petstore.Extended.Models.JsonInteger.Source estimatedReviewDays = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<PostAdoptionApplyAccepted> Create(in Petstore.Extended.Models.JsonString.Source applicationId, in Petstore.Extended.Models.PostAdoptionApplyAccepted.StatusEntity.Source status, in Petstore.Extended.Models.JsonInteger.Source estimatedReviewDays = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
