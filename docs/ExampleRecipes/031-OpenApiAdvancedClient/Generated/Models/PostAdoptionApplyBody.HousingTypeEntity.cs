...
public readonly partial struct PostAdoptionApplyBody
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HousingTypeEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal HousingTypeEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static HousingTypeEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(HousingTypeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in HousingTypeEntity left, in HousingTypeEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in HousingTypeEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(HousingTypeEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator HousingTypeEntity(JsonElement instance)
        {
            return HousingTypeEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HousingTypeEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HousingTypeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<HousingTypeEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HousingTypeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<HousingTypeEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HousingTypeEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<HousingTypeEntity>(json, options);
        }
        ...
        /// </exception>
        public static HousingTypeEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<HousingTypeEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out HousingTypeEntity? result)
        {
            return JsonElementHelpers.TryParseValue<HousingTypeEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new HousingTypeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static HousingTypeEntity IJsonElement<HousingTypeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"HousingTypeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="HousingTypeEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="HousingTypeEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public HousingTypeEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<HousingTypeEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="HousingTypeEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public HousingTypeEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<HousingTypeEntity>(_idx);
            }
        ...
        /// <param name="matchHouse">Match 1st item.</param>
        /// <param name="matchApartment">Match 2nd item.</param>
        /// <param name="matchFarm">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchHouse,
            Func<TContext, TResult> matchApartment,
            Func<TContext, TResult> matchFarm,
...
#endif
        {
            ...
            {
                return matchHouse(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchApartment(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchFarm(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchHouse,
            Func<TResult> matchApartment,
            Func<TResult> matchFarm,
