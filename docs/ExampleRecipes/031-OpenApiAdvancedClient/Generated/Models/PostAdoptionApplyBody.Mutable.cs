...
public readonly partial struct PostAdoptionApplyBody
{
    ...
    public static ParsedJsonDocument<PostAdoptionApplyBody> Create(in Petstore.Extended.Models.JsonString.Source applicantName, in Petstore.Extended.Models.JsonEmail.Source email, in Petstore.Extended.Models.PostAdoptionApplyBody.HousingTypeEntity.Source housingType, in Petstore.Extended.Models.JsonString.Source petId, in Petstore.Extended.Models.JsonString.Source experience = default, in Petstore.Extended.Models.JsonBoolean.Source hasGarden = default, in Petstore.Extended.Models.JsonString.Source phone = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
