...
public readonly partial struct PostPetsByPetIdChatBody
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Mutable History
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HistoryUtf8, out Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Petstore.Extended.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetHistory<TContext>(in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> value)
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Models.JsonString.Source message,
            in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
        {
        ...
        /// Creates an instance of a <see cref="PostPetsByPetIdChatBody"/>.
        /// </summary>
        public void Create(in Petstore.Extended.Models.JsonString.Source message, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Petstore.Extended.Models.JsonString.Source message,
            in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Models.JsonString.Source message, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Petstore.Extended.Models.JsonString.Source message, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static ParsedJsonDocument<PostPetsByPetIdChatBody> Create(in Petstore.Extended.Models.JsonString.Source message, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostPetsByPetIdChatBody> Create<TContext>(in TContext context, in Petstore.Extended.Models.JsonString.Source message, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
