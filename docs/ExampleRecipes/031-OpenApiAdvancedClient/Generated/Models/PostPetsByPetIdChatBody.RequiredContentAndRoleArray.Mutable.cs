...
public readonly partial struct PostPetsByPetIdChatBody
{
    ...
    public readonly partial struct RequiredContentAndRoleArray
    {
...
#endif
        {
            ...
            public Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Source value)
            {
                CheckValidInstance();
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole oldItem, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
