    ...
    public readonly partial struct RequiredContentAndRoleArray
    {
        ...
        public readonly partial struct RequiredContentAndRole
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Petstore.Extended.Models.JsonString.Mutable Content
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Petstore.Extended.Models.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Mutable Role
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetContent(scoped in Petstore.Extended.Models.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetRole(scoped in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Petstore.Extended.Models.JsonString.Source content,
                    in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role)
                {
                ...
                /// Creates an instance of a <see cref="RequiredContentAndRole"/>.
                /// </summary>
                public void Create(in Petstore.Extended.Models.JsonString.Source content, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role)
                {
                ...
                internal static void BuildCreateValue(scoped in Petstore.Extended.Models.JsonString.Source arg1, scoped in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Petstore.Extended.Models.JsonString.Source content, scoped in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Models.JsonString.Source content, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<RequiredContentAndRole> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredContentAndRole>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredContentAndRole> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredContentAndRole> Create(in Petstore.Extended.Models.JsonString.Source content, in Petstore.Extended.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
