...
public readonly partial struct PostPetsByPetIdPhotosBody
{
    ...
    public static ParsedJsonDocument<PostPetsByPetIdPhotosBody> Create(in Petstore.Extended.Models.JsonBinary.Source file, in Petstore.Extended.Models.JsonString.Source caption = default, in Petstore.Extended.Models.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
