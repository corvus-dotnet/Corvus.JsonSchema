...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Models.JsonBinary File
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Petstore.Extended.Models.JsonBinary value))
            {
                return value;
            }
