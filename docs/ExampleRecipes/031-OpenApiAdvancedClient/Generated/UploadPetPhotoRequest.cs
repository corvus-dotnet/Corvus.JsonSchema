...
/// <summary>
/// Request type for the UploadPetPhoto operation.
/// </summary>
/// <remarks>Upload a photo for a pet (multipart with metadata)</remarks>
public readonly struct UploadPetPhotoRequest : IApiRequest<UploadPetPhotoRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UploadPetPhotoRequest"/> struct.
    /// </summary>
    /// <param name="petId">The petId parameter.</param>
    /// <param name="session_token">The session_token parameter.</param>
    public UploadPetPhotoRequest(Petstore.Extended.Models.JsonString petId, Petstore.Extended.Models.JsonString session_token)
    {
        this.PetId = petId;
    ...
    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/pets/{petId}/photos"u8;
