...
public readonly partial struct ActivityEvent
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.Extended.Server.Models.JsonString.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Petstore.Extended.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.Models.JsonString.Mutable EventId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventIdUtf8, out Petstore.Extended.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.Models.JsonDateTime.Mutable Timestamp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimestampUtf8, out Petstore.Extended.Server.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.Models.ActivityEvent.TypeEntity.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Petstore.Extended.Server.Models.ActivityEvent.TypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDescription(scoped in Petstore.Extended.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEventId(scoped in Petstore.Extended.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTimestamp(scoped in Petstore.Extended.Server.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(scoped in Petstore.Extended.Server.Models.ActivityEvent.TypeEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Extended.Server.Models.JsonString.Source arg1, scoped in Petstore.Extended.Server.Models.JsonDateTime.Source arg2, scoped in Petstore.Extended.Server.Models.ActivityEvent.TypeEntity.Source arg3, scoped in Petstore.Extended.Server.Models.JsonString.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Server.Models.ActivityEvent.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.Models.JsonString.Source eventId,
            in Petstore.Extended.Server.Models.JsonDateTime.Source timestamp,
            in Petstore.Extended.Server.Models.ActivityEvent.TypeEntity.Source type,
            in Petstore.Extended.Server.Models.JsonString.Source description = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.Extended.Server.Models.JsonString.Source eventId, scoped in Petstore.Extended.Server.Models.JsonDateTime.Source timestamp, scoped in Petstore.Extended.Server.Models.ActivityEvent.TypeEntity.Source type, scoped in Petstore.Extended.Server.Models.JsonString.Source description = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Server.Models.JsonString.Source eventId, in Petstore.Extended.Server.Models.JsonDateTime.Source timestamp, in Petstore.Extended.Server.Models.ActivityEvent.TypeEntity.Source type, in Petstore.Extended.Server.Models.JsonString.Source description = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<ActivityEvent> Create(in Petstore.Extended.Server.Models.JsonString.Source eventId, in Petstore.Extended.Server.Models.JsonDateTime.Source timestamp, in Petstore.Extended.Server.Models.ActivityEvent.TypeEntity.Source type, in Petstore.Extended.Server.Models.JsonString.Source description = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
