...
public readonly partial struct ChatChunk
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.Extended.Server.Models.JsonString.Mutable Delta
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeltaUtf8, out Petstore.Extended.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Server.Models.JsonBoolean.Mutable Done
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DoneUtf8, out Petstore.Extended.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.Models.JsonString.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Petstore.Extended.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Server.Models.ChatChunk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.Models.JsonString.Source id,
            in Petstore.Extended.Server.Models.JsonString.Source delta = default,
            in Petstore.Extended.Server.Models.JsonBoolean.Source done = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Server.Models.JsonString.Source id, in Petstore.Extended.Server.Models.JsonString.Source delta = default, in Petstore.Extended.Server.Models.JsonBoolean.Source done = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<ChatChunk> Create(in Petstore.Extended.Server.Models.JsonString.Source id, in Petstore.Extended.Server.Models.JsonString.Source delta = default, in Petstore.Extended.Server.Models.JsonBoolean.Source done = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
