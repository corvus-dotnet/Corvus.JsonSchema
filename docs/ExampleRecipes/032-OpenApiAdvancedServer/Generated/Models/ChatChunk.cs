...
#endif
{
    ...
    /// </summary>
    public Petstore.Extended.Server.JsonString Delta
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeltaUtf8, out Petstore.Extended.Server.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.JsonBoolean Done
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DoneUtf8, out Petstore.Extended.Server.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.JsonString Id
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Petstore.Extended.Server.JsonString value))
            {
                return value;
            }
