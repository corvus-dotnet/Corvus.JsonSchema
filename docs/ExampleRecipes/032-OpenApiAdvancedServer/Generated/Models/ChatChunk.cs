...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ChatChunk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ChatChunk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ChatChunk DefaultInstance { get; }
    ...
    /// </summary>
    public Petstore.Extended.Server.Models.JsonString Delta
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeltaUtf8, out Petstore.Extended.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.Models.JsonBoolean Done
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DoneUtf8, out Petstore.Extended.Server.Models.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.Models.JsonString Id
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Petstore.Extended.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in ChatChunk left, in ChatChunk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ChatChunk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ChatChunk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ChatChunk(JsonElement instance)
    {
        return ChatChunk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ChatChunk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ChatChunk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ChatChunk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ChatChunk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ChatChunk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ChatChunk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ChatChunk>(json, options);
    }
    ...
    /// </exception>
    public static ChatChunk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<ChatChunk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ChatChunk? result)
    {
        return JsonElementHelpers.TryParseValue<ChatChunk>(ref reader, out result);
    }
...
#if NET
    static ChatChunk IJsonElement<ChatChunk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ChatChunk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Done"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Done"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DoneUtf8 => "done"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Done"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Done => "done"u8;
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Done"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Done => [0x65, 0x00, 0x00, 0x00, 0x22, 0x64, 0x6F, 0x6E, 0x65, 0x22];
