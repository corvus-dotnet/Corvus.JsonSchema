...
public readonly partial struct Error
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.JsonInt32.Mutable Code
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out Petstore.Extended.Server.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCode(in Petstore.Extended.Server.JsonInt32.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.Extended.Server.Error.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Server.Error.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.JsonInt32.Source code,
        ...
        /// Creates an instance of a <see cref="Error"/>.
        /// </summary>
        public void Create(in Petstore.Extended.Server.JsonInt32.Source code, in Petstore.Extended.Server.JsonString.Source message)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Server.JsonInt32.Source code, in Petstore.Extended.Server.JsonString.Source message, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
