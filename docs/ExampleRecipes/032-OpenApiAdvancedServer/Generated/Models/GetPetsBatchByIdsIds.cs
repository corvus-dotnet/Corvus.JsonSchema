...
public readonly partial struct GetPetsBatchByIdsIds
#if NET8_0_OR_GREATER
    : IJsonElement<GetPetsBatchByIdsIds>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetPetsBatchByIdsIds"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetPetsBatchByIdsIds(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetPetsBatchByIdsIds DefaultInstance { get; }
    ...
    public bool TryGetNumericValues(Span<long> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (Petstore.Extended.Server.Models.JsonInt64 item in EnumerateArray())
        {
    ...
    public Petstore.Extended.Server.Models.JsonInt64 this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Petstore.Extended.Server.Models.JsonInt64>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Petstore.Extended.Server.Models.JsonInt64> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Petstore.Extended.Server.Models.JsonInt64>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetPetsBatchByIdsIds left, in GetPetsBatchByIdsIds right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetPetsBatchByIdsIds left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetPetsBatchByIdsIds instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetPetsBatchByIdsIds(JsonElement instance)
    {
        return GetPetsBatchByIdsIds.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsBatchByIdsIds From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsBatchByIdsIds ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetPetsBatchByIdsIds>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsBatchByIdsIds ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetPetsBatchByIdsIds>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetPetsBatchByIdsIds ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetPetsBatchByIdsIds>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetPetsBatchByIdsIds ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetPetsBatchByIdsIds>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetPetsBatchByIdsIds? result)
    {
        return JsonElementHelpers.TryParseValue<GetPetsBatchByIdsIds>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetPetsBatchByIdsIds(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetPetsBatchByIdsIds IJsonElement<GetPetsBatchByIdsIds>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetPetsBatchByIdsIds: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetPetsBatchByIdsIds"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetPetsBatchByIdsIds"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetPetsBatchByIdsIds Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetPetsBatchByIdsIds>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetPetsBatchByIdsIds"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetPetsBatchByIdsIds Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetPetsBatchByIdsIds>(_idx);
        }
