...
public readonly partial struct GetPetsFilter
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.Extended.Server.Models.JsonInteger.Mutable MaxAge
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Petstore.Extended.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Server.Models.JsonInteger.Mutable MinAge
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinAgeUtf8, out Petstore.Extended.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Server.Models.GetPetsFilter.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Server.Models.GetPetsFilter.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMaxAge(scoped in Petstore.Extended.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMinAge(scoped in Petstore.Extended.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Petstore.Extended.Server.Models.GetPetsFilter.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Extended.Server.Models.JsonString.Source arg1, scoped in Petstore.Extended.Server.Models.JsonInteger.Source arg2, scoped in Petstore.Extended.Server.Models.JsonInteger.Source arg3, scoped in Petstore.Extended.Server.Models.GetPetsFilter.StatusEntity.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Server.Models.GetPetsFilter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.Models.JsonInteger.Source maxAge = default,
            in Petstore.Extended.Server.Models.JsonInteger.Source minAge = default,
            in Petstore.Extended.Server.Models.GetPetsFilter.StatusEntity.Source status = default)
        {
    ...
    public static ParsedJsonDocument<GetPetsFilter> Create(in Petstore.Extended.Server.Models.JsonString.Source breed = default, in Petstore.Extended.Server.Models.JsonInteger.Source maxAge = default, in Petstore.Extended.Server.Models.JsonInteger.Source minAge = default, in Petstore.Extended.Server.Models.GetPetsFilter.StatusEntity.Source status = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
