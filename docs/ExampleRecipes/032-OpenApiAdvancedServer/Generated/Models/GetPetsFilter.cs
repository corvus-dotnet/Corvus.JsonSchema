...
#endif
{
    ...
    /// </summary>
    public Petstore.Extended.Server.JsonInteger MaxAge
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Petstore.Extended.Server.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.JsonInteger MinAge
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinAgeUtf8, out Petstore.Extended.Server.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.GetPetsFilter.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Server.GetPetsFilter.StatusEntity value))
            {
                return value;
            }
