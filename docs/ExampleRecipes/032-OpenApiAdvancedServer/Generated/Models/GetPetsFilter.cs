...
#endif
{
    ...
    /// </summary>
    public Petstore.Extended.Server.Models.JsonInteger MaxAge
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Petstore.Extended.Server.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.Models.JsonInteger MinAge
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinAgeUtf8, out Petstore.Extended.Server.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.Models.GetPetsFilter.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Server.Models.GetPetsFilter.StatusEntity value))
            {
                return value;
            }
