...
public readonly partial struct GetPetsLimit
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetPetsLimit instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetPetsLimit"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetPetsLimit(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetPetsLimit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetPetsLimit Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetPetsLimit Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetPetsLimit>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetPetsLimit instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetPetsLimit, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetPetsLimit> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetPetsLimit>();
        }
        finally
        {
