...
public readonly partial struct GetPetsTags
{
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.Extended.Server.GetPetsTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Server.GetPetsTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
