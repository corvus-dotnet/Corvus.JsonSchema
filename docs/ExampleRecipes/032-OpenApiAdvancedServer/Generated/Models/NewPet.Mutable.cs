...
public readonly partial struct NewPet
{
...
#endif
    {
        ...
        public static explicit operator Mutable(NewPet instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NewPet"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NewPet(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.Models.NewPet.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Server.Models.NewPet.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Server.Models.NewPet.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Petstore.Extended.Server.Models.NewPet.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NewPet(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Petstore.Extended.Server.Models.NewPet.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(scoped in Petstore.Extended.Server.Models.NewPet.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in Petstore.Extended.Server.Models.NewPet.JsonStringArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NewPet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="NewPet"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="NewPet"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly NewPet Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<NewPet>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="NewPet"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly NewPet Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<NewPet>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Extended.Server.Models.JsonString.Source arg1, scoped in Petstore.Extended.Server.Models.NewPet.StatusEntity.Source arg2, scoped in Petstore.Extended.Server.Models.JsonInteger.Source arg3, scoped in Petstore.Extended.Server.Models.JsonString.Source arg4, scoped in Petstore.Extended.Server.Models.NewPet.JsonStringArray.Source arg5)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.Models.NewPet.StatusEntity.Source status,
            ...
            in Petstore.Extended.Server.Models.NewPet.JsonStringArray.Source tags = default)
        {
        ...
        public void Create(
            ...
            in Petstore.Extended.Server.Models.NewPet.JsonStringArray.Source tags = default)
        {
            Create(ref _builder, name, status, age, breed, tags);
        }
        ...
        internal static void Create<TContext>(
            ...
            in Petstore.Extended.Server.Models.JsonInteger.Source age = default,
            in Petstore.Extended.Server.Models.JsonString.Source breed = default,
            in Petstore.Extended.Server.Models.NewPet.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, name, status, age, breed, tags);
        }
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Petstore.Extended.Server.Models.JsonString.Source name, in Petstore.Extended.Server.Models.NewPet.StatusEntity.Source status, in Petstore.Extended.Server.Models.JsonInteger.Source age = default, in Petstore.Extended.Server.Models.JsonString.Source breed = default, in Petstore.Extended.Server.Models.NewPet.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, name, status, age, breed, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<NewPet, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<NewPet> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<NewPet>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<NewPet> Create<TContext>(
    ...
    public static ParsedJsonDocument<NewPet> Create(in Petstore.Extended.Server.Models.JsonString.Source name, in Petstore.Extended.Server.Models.NewPet.StatusEntity.Source status, in Petstore.Extended.Server.Models.JsonInteger.Source age = default, in Petstore.Extended.Server.Models.JsonString.Source breed = default, in Petstore.Extended.Server.Models.NewPet.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<NewPet> Create<TContext>(in TContext context, in Petstore.Extended.Server.Models.JsonString.Source name, in Petstore.Extended.Server.Models.NewPet.StatusEntity.Source status, in Petstore.Extended.Server.Models.JsonInteger.Source age = default, in Petstore.Extended.Server.Models.JsonString.Source breed = default, in Petstore.Extended.Server.Models.NewPet.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
