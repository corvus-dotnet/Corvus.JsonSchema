...
public readonly partial struct NewPet
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.NewPet.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Server.NewPet.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Server.NewPet.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Petstore.Extended.Server.NewPet.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in Petstore.Extended.Server.NewPet.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in Petstore.Extended.Server.NewPet.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in Petstore.Extended.Server.NewPet.JsonStringArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.Extended.Server.NewPet.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Server.NewPet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.NewPet.StatusEntity.Source status,
            in Petstore.Extended.Server.JsonInteger.Source age = default,
            in Petstore.Extended.Server.JsonString.Source breed = default,
            in Petstore.Extended.Server.NewPet.JsonStringArray.Source tags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Petstore.Extended.Server.JsonInteger.Source age = default,
            in Petstore.Extended.Server.JsonString.Source breed = default,
            in Petstore.Extended.Server.NewPet.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
