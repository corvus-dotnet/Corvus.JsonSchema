...
#endif
{
    ...
    /// </summary>
    public static Pet DefaultInstance { get; }
    ...
    /// </summary>
    public Petstore.Extended.Server.Models.JsonInteger Age
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AgeUtf8, out Petstore.Extended.Server.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.Models.JsonString Breed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BreedUtf8, out Petstore.Extended.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.Models.JsonInt64 Id
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Petstore.Extended.Server.Models.JsonInt64 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.Models.JsonString Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Petstore.Extended.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.Models.Pet.JsonStringArray PhotoIds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhotoIdsUtf8, out Petstore.Extended.Server.Models.Pet.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.Models.Pet.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Server.Models.Pet.StatusEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.Models.Pet.TagsJsonStArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Petstore.Extended.Server.Models.Pet.TagsJsonStArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in Pet left, in Pet right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in Pet left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(Pet instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Pet(JsonElement instance)
    {
        return Pet.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Pet From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Pet ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Pet>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Pet ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Pet>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Pet ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Pet>(json, options);
    }
    ...
    /// </exception>
    public static Pet ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<Pet>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out Pet? result)
    {
        return JsonElementHelpers.TryParseValue<Pet>(ref reader, out result);
    }
...
#if NET
    static Pet IJsonElement<Pet>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"Pet: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public Pet Freeze()
    {
        ...
        {
            return mutable.FreezeElement<Pet>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Breed"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="PhotoIds"/>.
        /// </summary>
        public const string PhotoIds = "photoIds";
        ...
        /// Gets the JSON property name for <see cref="Breed"/>.
        /// </summary>
        public static ReadOnlySpan<byte> BreedUtf8 => "breed"u8;
        ...
        /// Gets the JSON property name for <see cref="PhotoIds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PhotoIdsUtf8 => "photoIds"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Age"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Age => "age"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Breed"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Breed => "breed"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="PhotoIds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PhotoIds => "photoIds"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Age"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Age => [0x55, 0x00, 0x00, 0x00, 0x22, 0x61, 0x67, 0x65, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Breed"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Breed => [0x75, 0x00, 0x00, 0x00, 0x22, 0x62, 0x72, 0x65, 0x65, 0x64, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="PhotoIds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PhotoIds => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x68, 0x6F, 0x74, 0x6F, 0x49, 0x64, 0x73, 0x22];
