...
#endif
{
    ...
    /// </summary>
    public Petstore.Extended.Server.JsonInteger Age
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AgeUtf8, out Petstore.Extended.Server.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.JsonString Breed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BreedUtf8, out Petstore.Extended.Server.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.JsonInt64 Id
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Petstore.Extended.Server.JsonInt64 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.JsonString Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Petstore.Extended.Server.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.Pet.JsonStringArray PhotoIds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhotoIdsUtf8, out Petstore.Extended.Server.Pet.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.Pet.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Server.Pet.StatusEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.Extended.Server.Pet.TagsJsonStArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Petstore.Extended.Server.Pet.TagsJsonStArray value))
            {
                return value;
            }
