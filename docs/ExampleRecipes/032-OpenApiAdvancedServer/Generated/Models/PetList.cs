...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PetList"/> struct.
    /// </summary>
    ...
    public Petstore.Extended.Server.Models.Pet this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Petstore.Extended.Server.Models.Pet>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Petstore.Extended.Server.Models.Pet> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Petstore.Extended.Server.Models.Pet>(_parent, _idx);
    }
    ...
    /// <summary>
    /// Gets a <see cref="PetList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PetList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PetList"/> that lives for the lifetime of its
