...
public readonly partial struct PhotoMetadata
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.Extended.Server.JsonString.Mutable Caption
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaptionUtf8, out Petstore.Extended.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Server.JsonBoolean.Mutable IsPrimary
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsPrimaryUtf8, out Petstore.Extended.Server.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.JsonString.Mutable PhotoId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhotoIdUtf8, out Petstore.Extended.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.JsonDateTime.Mutable UploadedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedAtUtf8, out Petstore.Extended.Server.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCaption(in Petstore.Extended.Server.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetIsPrimary(in Petstore.Extended.Server.JsonBoolean.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPhotoId(in Petstore.Extended.Server.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUploadedAt(in Petstore.Extended.Server.JsonDateTime.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.Extended.Server.PhotoMetadata.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Server.PhotoMetadata.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.JsonString.Source photoId,
            in Petstore.Extended.Server.JsonDateTime.Source uploadedAt,
            in Petstore.Extended.Server.JsonString.Source caption = default,
            in Petstore.Extended.Server.JsonBoolean.Source isPrimary = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Server.JsonString.Source petId, in Petstore.Extended.Server.JsonString.Source photoId, in Petstore.Extended.Server.JsonDateTime.Source uploadedAt, in Petstore.Extended.Server.JsonString.Source caption = default, in Petstore.Extended.Server.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
