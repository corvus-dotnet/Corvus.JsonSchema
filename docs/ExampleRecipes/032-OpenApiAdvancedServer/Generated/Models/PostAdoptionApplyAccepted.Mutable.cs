...
public readonly partial struct PostAdoptionApplyAccepted
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.JsonString.Mutable ApplicationId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ApplicationIdUtf8, out Petstore.Extended.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.Extended.Server.JsonInteger.Mutable EstimatedReviewDays
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EstimatedReviewDaysUtf8, out Petstore.Extended.Server.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.PostAdoptionApplyAccepted.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.Extended.Server.PostAdoptionApplyAccepted.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetApplicationId(in Petstore.Extended.Server.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEstimatedReviewDays(in Petstore.Extended.Server.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in Petstore.Extended.Server.PostAdoptionApplyAccepted.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.Extended.Server.PostAdoptionApplyAccepted.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Server.PostAdoptionApplyAccepted.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.JsonString.Source applicationId,
            in Petstore.Extended.Server.PostAdoptionApplyAccepted.StatusEntity.Source status,
            in Petstore.Extended.Server.JsonInteger.Source estimatedReviewDays = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Server.JsonString.Source applicationId, in Petstore.Extended.Server.PostAdoptionApplyAccepted.StatusEntity.Source status, in Petstore.Extended.Server.JsonInteger.Source estimatedReviewDays = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
