...
public readonly partial struct PostAdoptionApplyAccepted
{
    ...
    public readonly partial struct StatusEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StatusEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StatusEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StatusEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StatusEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly StatusEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly StatusEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StatusEntity>(_idx);
            }
            ...
            /// <param name="matchReceived">Match 1st item.</param>
            /// <param name="matchReviewing">Match 2nd item.</param>
            /// <param name="matchApproved">Match 3rd item.</param>
            /// <param name="matchRejected">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchReceived,
                Func<TContext, TResult> matchReviewing,
...
#endif
            {
                ...
                {
                    return matchReceived(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchReviewing(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchReceived,
                Func<TResult> matchReviewing,
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(StatusEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (StatusEntity)value;
        ...
        {
            return workspace.CreateBuilder<StatusEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<StatusEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<StatusEntity>();
            }
            finally
            {
