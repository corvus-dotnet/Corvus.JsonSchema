...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostAdoptionApplyAccepted"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostAdoptionApplyAccepted(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostAdoptionApplyAccepted DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PostAdoptionApplyAccepted left, in PostAdoptionApplyAccepted right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostAdoptionApplyAccepted left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostAdoptionApplyAccepted instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostAdoptionApplyAccepted(JsonElement instance)
    {
        return PostAdoptionApplyAccepted.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostAdoptionApplyAccepted From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostAdoptionApplyAccepted ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostAdoptionApplyAccepted>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostAdoptionApplyAccepted ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostAdoptionApplyAccepted>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostAdoptionApplyAccepted ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostAdoptionApplyAccepted>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static PostAdoptionApplyAccepted ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostAdoptionApplyAccepted>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostAdoptionApplyAccepted? result)
    {
        return JsonElementHelpers.TryParseValue<PostAdoptionApplyAccepted>(ref reader, out result);
    }
...
#if NET
    static PostAdoptionApplyAccepted IJsonElement<PostAdoptionApplyAccepted>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostAdoptionApplyAccepted: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostAdoptionApplyAccepted Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostAdoptionApplyAccepted Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostAdoptionApplyAccepted>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="EstimatedReviewDays"/>.
        /// </summary>
        public const string EstimatedReviewDays = "estimatedReviewDays";
        ...
        /// Gets the JSON property name for <see cref="ApplicationId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ApplicationIdUtf8 => "applicationId"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="EstimatedReviewDays"/>.
        /// </summary>
        public static ReadOnlySpan<byte> EstimatedReviewDaysUtf8 => "estimatedReviewDays"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// </summary>
        public static ReadOnlySpan<byte> ApplicationId => "applicationId"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="EstimatedReviewDays"/>.
        /// </summary>
        public static ReadOnlySpan<byte> EstimatedReviewDays => "estimatedReviewDays"u8;
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="EstimatedReviewDays"/>.
        /// </summary>
        public static ReadOnlySpan<byte> EstimatedReviewDays => [0x55, 0x01, 0x00, 0x00, 0x22, 0x65, 0x73, 0x74, 0x69, 0x6D, 0x61, 0x74, 0x65, 0x64, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x44, 0x61, 0x79, 0x73, 0x22];
