        ...
        public static partial class JsonSchema
        {
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("house"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("apartment"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("farm"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
