...
public readonly partial struct PostAdoptionApplyBody
{
    ...
    public readonly partial struct HousingTypeEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(HousingTypeEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="HousingTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HousingTypeEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HousingTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly HousingTypeEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly HousingTypeEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<HousingTypeEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(HousingTypeEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (HousingTypeEntity)value;
        ...
        {
            return workspace.CreateBuilder<HousingTypeEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<HousingTypeEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<HousingTypeEntity>();
            }
            finally
            {
