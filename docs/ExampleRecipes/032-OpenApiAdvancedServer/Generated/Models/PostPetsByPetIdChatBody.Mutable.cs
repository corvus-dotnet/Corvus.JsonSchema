...
public readonly partial struct PostPetsByPetIdChatBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostPetsByPetIdChatBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostPetsByPetIdChatBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostPetsByPetIdChatBody(Mutable instance)
        {
        ...
        /// </summary>
        public Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Mutable History
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HistoryUtf8, out Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Petstore.Extended.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostPetsByPetIdChatBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetHistory(scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.HistoryUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HistoryUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.History, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetHistory<TContext>(in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> value)
        ...
        /// <summary>
        /// Remove the <c>history</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveHistory()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.HistoryUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostPetsByPetIdChatBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostPetsByPetIdChatBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostPetsByPetIdChatBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostPetsByPetIdChatBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostPetsByPetIdChatBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostPetsByPetIdChatBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostPetsByPetIdChatBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostPetsByPetIdChatBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.Extended.Server.Models.JsonString.Source arg1, scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, scoped in Petstore.Extended.Server.Models.JsonString.Source arg1, scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.Models.JsonString.Source message,
            in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
        {
        ...
        /// Creates an instance of a <see cref="PostPetsByPetIdChatBody"/>.
        /// </summary>
        public void Create(in Petstore.Extended.Server.Models.JsonString.Source message, in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Petstore.Extended.Server.Models.JsonString.Source message,
            in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, message, history);
        }
        ...
        internal static void BuildCreateValue(scoped in Petstore.Extended.Server.Models.JsonString.Source arg1, scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Petstore.Extended.Server.Models.JsonString.Source arg1, scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.Extended.Server.Models.JsonString.Source message, scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
    {
    ...
    /// <param name="history">The value of the <c>"history"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Petstore.Extended.Server.Models.JsonString.Source message, scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Server.Models.JsonString.Source message, in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(message, history);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, message, history);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostPetsByPetIdChatBody, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<PostPetsByPetIdChatBody> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PostPetsByPetIdChatBody>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostPetsByPetIdChatBody> Create<TContext>(
    ...
    public static ParsedJsonDocument<PostPetsByPetIdChatBody> Create(in Petstore.Extended.Server.Models.JsonString.Source message, in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostPetsByPetIdChatBody> Create<TContext>(in TContext context, in Petstore.Extended.Server.Models.JsonString.Source message, in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
