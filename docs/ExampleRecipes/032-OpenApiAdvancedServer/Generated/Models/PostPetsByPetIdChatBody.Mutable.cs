...
public readonly partial struct PostPetsByPetIdChatBody
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.Extended.Server.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Mutable History
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HistoryUtf8, out Petstore.Extended.Server.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.Extended.Server.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Petstore.Extended.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetHistory(in Petstore.Extended.Server.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetHistory<TContext>(in Petstore.Extended.Server.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(in Petstore.Extended.Server.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.Extended.Server.PostPetsByPetIdChatBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.Extended.Server.PostPetsByPetIdChatBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.Extended.Server.JsonString.Source message,
            in Petstore.Extended.Server.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
        {
        ...
        /// Creates an instance of a <see cref="PostPetsByPetIdChatBody"/>.
        /// </summary>
        public void Create(in Petstore.Extended.Server.JsonString.Source message, in Petstore.Extended.Server.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Petstore.Extended.Server.JsonString.Source message,
            in Petstore.Extended.Server.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.Extended.Server.JsonString.Source message, in Petstore.Extended.Server.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Petstore.Extended.Server.JsonString.Source message, in Petstore.Extended.Server.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
