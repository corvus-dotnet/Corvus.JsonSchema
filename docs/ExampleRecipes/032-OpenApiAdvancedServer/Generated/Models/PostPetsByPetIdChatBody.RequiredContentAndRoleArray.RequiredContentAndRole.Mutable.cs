    ...
    public readonly partial struct RequiredContentAndRoleArray
    {
        ...
        public readonly partial struct RequiredContentAndRole
        {
...
#endif
            {
                ...
                public void SetContent(scoped in Petstore.Extended.Server.Models.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetRole(scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(scoped in Petstore.Extended.Server.Models.JsonString.Source arg1, scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Petstore.Extended.Server.Models.JsonString.Source content, scoped in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role)
            {
            ...
            public static ParsedJsonDocument<RequiredContentAndRole> Create(in Petstore.Extended.Server.Models.JsonString.Source content, in Petstore.Extended.Server.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
