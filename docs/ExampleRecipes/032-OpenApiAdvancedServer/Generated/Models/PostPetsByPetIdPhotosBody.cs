...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.JsonBinary File
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Petstore.Extended.Server.JsonBinary value))
            {
                return value;
            }
