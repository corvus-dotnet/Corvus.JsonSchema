...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.Extended.Server.Models.JsonBinary File
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Petstore.Extended.Server.Models.JsonBinary value))
            {
                return value;
            }
