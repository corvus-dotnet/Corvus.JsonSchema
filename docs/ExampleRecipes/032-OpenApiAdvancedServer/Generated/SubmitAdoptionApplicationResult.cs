...
public readonly struct SubmitAdoptionApplicationResult
{
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="SubmitAdoptionApplicationResult"/> with status 202.</returns>
    public static SubmitAdoptionApplicationResult Accepted<TContext>(Petstore.Extended.Server.Models.PostAdoptionApplyAccepted.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(202, Petstore.Extended.Server.Models.PostAdoptionApplyAccepted.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="SubmitAdoptionApplicationResult"/> with status default.</returns>
    public static SubmitAdoptionApplicationResult Default<TContext>(int statusCode, Petstore.Extended.Server.Models.Error.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
