...
public sealed class ApiAdoptionClient : IApiAdoptionClient
{
    ...
    {
        JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
        Petstore.EndToEnd.Client.Models.PostAdoptionApplyBody bodyValue = Petstore.EndToEnd.Client.Models.PostAdoptionApplyBody.CreateBuilder(workspace, in body, 30).RootElement;
        SubmitAdoptionApplicationRequest request = new();
