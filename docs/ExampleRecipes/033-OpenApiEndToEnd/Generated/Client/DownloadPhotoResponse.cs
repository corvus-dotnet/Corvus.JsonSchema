...
/// <summary>
/// Response type for the DownloadPhoto operation.
/// </summary>
public struct DownloadPhotoResponse : IApiResponse<DownloadPhotoResponse>
{
    ...
    {
        DownloadPhotoResponse response = default;
