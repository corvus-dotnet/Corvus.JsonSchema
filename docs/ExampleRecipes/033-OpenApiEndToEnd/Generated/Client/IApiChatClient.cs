...
public interface IApiChatClient : IAsyncDisposable
{
    ...
    /// <param name="validationMode">The validation mode applied to the request before it is sent.</param>
    /// <param name="responseValidationMode">The validation mode applied to the response body.</param>
    ValueTask<StartVetChatResponse> StartVetChatAsync<TContext>(Petstore.EndToEnd.Client.Models.JsonString.Source petId, Petstore.EndToEnd.Client.Models.JsonString.Source session_token, Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.Source<TContext> body, CancellationToken cancellationToken = default, ValidationMode validationMode = ValidationMode.Basic, ValidationMode responseValidationMode = ValidationMode.None)
