...
public interface IApiPhotosClient : IAsyncDisposable
{
    ...
    /// <param name="file">Binary data for the 'file' part.</param>
    /// <param name="cancellationToken">A cancellation token.</param>
    ValueTask<UploadPetPhotoResponse> UploadPetPhotoAsync<TContext>(Petstore.EndToEnd.Client.Models.JsonString.Source petId, Petstore.EndToEnd.Client.Models.JsonString.Source session_token, Petstore.EndToEnd.Client.Models.PostPetsByPetIdPhotosBody.Source<TContext> body, BinaryPartData file, CancellationToken cancellationToken = default, ValidationMode validationMode = ValidationMode.Basic, ValidationMode responseValidationMode = ValidationMode.None)
