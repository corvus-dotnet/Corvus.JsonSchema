...
public readonly partial struct ActivityEvent
{
    ...
    public static ParsedJsonDocument<ActivityEvent> Create(in Petstore.EndToEnd.Client.Models.JsonString.Source eventId, in Petstore.EndToEnd.Client.Models.JsonDateTime.Source timestamp, in Petstore.EndToEnd.Client.Models.ActivityEvent.TypeEntity.Source type, in Petstore.EndToEnd.Client.Models.JsonString.Source description = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
