...
public readonly partial struct ChatChunk
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.EndToEnd.Client.Models.JsonString.Mutable Delta
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeltaUtf8, out Petstore.EndToEnd.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Client.Models.JsonBoolean.Mutable Done
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DoneUtf8, out Petstore.EndToEnd.Client.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Client.Models.JsonString.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Petstore.EndToEnd.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDelta(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDone(scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetId(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Client.Models.ChatChunk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Client.Models.JsonString.Source id,
            in Petstore.EndToEnd.Client.Models.JsonString.Source delta = default,
            in Petstore.EndToEnd.Client.Models.JsonBoolean.Source done = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source id, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source delta = default, scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source done = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Client.Models.JsonString.Source id, in Petstore.EndToEnd.Client.Models.JsonString.Source delta = default, in Petstore.EndToEnd.Client.Models.JsonBoolean.Source done = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<ChatChunk> Create(in Petstore.EndToEnd.Client.Models.JsonString.Source id, in Petstore.EndToEnd.Client.Models.JsonString.Source delta = default, in Petstore.EndToEnd.Client.Models.JsonBoolean.Source done = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
