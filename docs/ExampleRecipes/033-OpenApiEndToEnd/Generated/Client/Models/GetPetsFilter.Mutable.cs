...
public readonly partial struct GetPetsFilter
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetPetsFilter instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetPetsFilter"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetPetsFilter(Mutable instance)
        {
        ...
        /// </summary>
        public Petstore.EndToEnd.Client.Models.JsonInteger.Mutable MaxAge
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Petstore.EndToEnd.Client.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Client.Models.JsonInteger.Mutable MinAge
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinAgeUtf8, out Petstore.EndToEnd.Client.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Client.Models.GetPetsFilter.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Client.Models.GetPetsFilter.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMinAge(scoped in Petstore.EndToEnd.Client.Models.JsonInteger.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MinAgeUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinAgeUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MinAge, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>minAge</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveMinAge()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MinAgeUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetPetsFilter.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetPetsFilter Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetPetsFilter Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetPetsFilter>(_idx);
        }
    }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Client.Models.GetPetsFilter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Client.Models.JsonInteger.Source maxAge = default,
            in Petstore.EndToEnd.Client.Models.JsonInteger.Source minAge = default,
            in Petstore.EndToEnd.Client.Models.GetPetsFilter.StatusEntity.Source status = default)
        {
            ...
            minAge.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MinAge, ref builder);
    ...
    /// <param name="minAge">The value of the property.</param>
    /// <param name="status">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Client.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Client.Models.JsonInteger.Source maxAge = default, in Petstore.EndToEnd.Client.Models.JsonInteger.Source minAge = default, in Petstore.EndToEnd.Client.Models.GetPetsFilter.StatusEntity.Source status = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(breed, maxAge, minAge, status);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<GetPetsFilter, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetPetsFilter> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetPetsFilter>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetPetsFilter> Create<TContext>(
    ...
    public static ParsedJsonDocument<GetPetsFilter> Create(in Petstore.EndToEnd.Client.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Client.Models.JsonInteger.Source maxAge = default, in Petstore.EndToEnd.Client.Models.JsonInteger.Source minAge = default, in Petstore.EndToEnd.Client.Models.GetPetsFilter.StatusEntity.Source status = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
