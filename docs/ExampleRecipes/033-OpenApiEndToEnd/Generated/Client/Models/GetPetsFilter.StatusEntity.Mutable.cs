...
public readonly partial struct GetPetsFilter
{
    ...
    public readonly partial struct StatusEntity
    {
...
#endif
        {
            ...
            /// <param name="matchAvailable">Match 1st item.</param>
            /// <param name="matchAdopted">Match 2nd item.</param>
            /// <param name="matchPending">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchAvailable,
                Func<TContext, TResult> matchAdopted,
...
#endif
            {
                ...
                {
                    return matchAvailable(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchAdopted(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchAvailable,
                Func<TResult> matchAdopted,
