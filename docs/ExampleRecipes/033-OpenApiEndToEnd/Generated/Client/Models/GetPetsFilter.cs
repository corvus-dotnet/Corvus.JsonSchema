...
#endif
{
    ...
    /// </summary>
    public Petstore.EndToEnd.Client.JsonInteger MaxAge
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Petstore.EndToEnd.Client.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.EndToEnd.Client.JsonInteger MinAge
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinAgeUtf8, out Petstore.EndToEnd.Client.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.EndToEnd.Client.GetPetsFilter.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Client.GetPetsFilter.StatusEntity value))
            {
                return value;
            }
