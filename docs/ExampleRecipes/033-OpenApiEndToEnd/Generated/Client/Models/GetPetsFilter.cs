...
#endif
{
    ...
    /// </summary>
    public Petstore.EndToEnd.Client.Models.JsonInteger MaxAge
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Petstore.EndToEnd.Client.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.EndToEnd.Client.Models.JsonInteger MinAge
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinAgeUtf8, out Petstore.EndToEnd.Client.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.EndToEnd.Client.Models.GetPetsFilter.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Client.Models.GetPetsFilter.StatusEntity value))
            {
                return value;
            }
