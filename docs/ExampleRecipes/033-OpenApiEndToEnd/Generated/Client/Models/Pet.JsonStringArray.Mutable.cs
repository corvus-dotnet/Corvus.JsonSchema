...
public readonly partial struct Pet
{
    ...
    public readonly partial struct JsonStringArray
    {
...
#endif
        {
            ...
            public Petstore.EndToEnd.Client.JsonString.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Petstore.EndToEnd.Client.JsonString.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Petstore.EndToEnd.Client.JsonString.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Petstore.EndToEnd.Client.JsonString.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Petstore.EndToEnd.Client.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Petstore.EndToEnd.Client.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Petstore.EndToEnd.Client.JsonString.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Petstore.EndToEnd.Client.JsonString item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Petstore.EndToEnd.Client.JsonString>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Petstore.EndToEnd.Client.JsonString> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Petstore.EndToEnd.Client.JsonString>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Petstore.EndToEnd.Client.JsonString oldItem, in Petstore.EndToEnd.Client.JsonString.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Petstore.EndToEnd.Client.JsonString>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Petstore.EndToEnd.Client.JsonString current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Petstore.EndToEnd.Client.Pet.JsonStringArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Petstore.EndToEnd.Client.Pet.JsonStringArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
