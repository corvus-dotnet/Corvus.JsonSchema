...
public readonly partial struct PhotoMetadata
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PhotoMetadata instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PhotoMetadata"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PhotoMetadata(Mutable instance)
        {
        ...
        /// </summary>
        public Petstore.EndToEnd.Client.Models.JsonString.Mutable Caption
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaptionUtf8, out Petstore.EndToEnd.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Client.Models.JsonBoolean.Mutable IsPrimary
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsPrimaryUtf8, out Petstore.EndToEnd.Client.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Client.Models.JsonString.Mutable PetId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PetIdUtf8, out Petstore.EndToEnd.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Client.Models.JsonString.Mutable PhotoId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhotoIdUtf8, out Petstore.EndToEnd.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>uploadedAt</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Client.Models.JsonDateTime.Mutable UploadedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedAtUtf8, out Petstore.EndToEnd.Client.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PhotoMetadata(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCaption(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CaptionUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaptionUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Caption, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>caption</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveCaption()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CaptionUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetIsPrimary(scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IsPrimaryUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsPrimaryUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IsPrimary, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>isPrimary</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveIsPrimary()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IsPrimaryUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPetId(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPhotoId(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("photoId");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhotoIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PhotoId, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUploadedAt(scoped in Petstore.EndToEnd.Client.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("uploadedAt");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedAtUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UploadedAt, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PhotoMetadata.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PhotoMetadata"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PhotoMetadata"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PhotoMetadata Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PhotoMetadata>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PhotoMetadata"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PhotoMetadata Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PhotoMetadata>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Client.Models.JsonDateTime.Source arg3, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg4, scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source arg5)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Client.Models.PhotoMetadata.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Client.Models.JsonString.Source petId,
            in Petstore.EndToEnd.Client.Models.JsonString.Source photoId,
            in Petstore.EndToEnd.Client.Models.JsonDateTime.Source uploadedAt,
            in Petstore.EndToEnd.Client.Models.JsonString.Source caption = default,
            in Petstore.EndToEnd.Client.Models.JsonBoolean.Source isPrimary = default)
        {
            ...
            uploadedAt.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UploadedAt, ref builder);
            caption.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Caption, ref builder);
            isPrimary.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IsPrimary, ref builder);
        }
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Client.Models.JsonDateTime.Source arg3, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg4, scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source arg5, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source petId, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source photoId, scoped in Petstore.EndToEnd.Client.Models.JsonDateTime.Source uploadedAt, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source caption = default, scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source isPrimary = default)
    {
    ...
    /// <param name="photoId">The value of the property.</param>
    /// <param name="uploadedAt">The value of the property.</param>
    /// <param name="caption">The value of the property.</param>
    /// <param name="isPrimary">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Client.Models.JsonString.Source petId, in Petstore.EndToEnd.Client.Models.JsonString.Source photoId, in Petstore.EndToEnd.Client.Models.JsonDateTime.Source uploadedAt, in Petstore.EndToEnd.Client.Models.JsonString.Source caption = default, in Petstore.EndToEnd.Client.Models.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(petId, photoId, uploadedAt, caption, isPrimary);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PhotoMetadata, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<PhotoMetadata> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PhotoMetadata>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PhotoMetadata> Create<TContext>(
    ...
    public static ParsedJsonDocument<PhotoMetadata> Create(in Petstore.EndToEnd.Client.Models.JsonString.Source petId, in Petstore.EndToEnd.Client.Models.JsonString.Source photoId, in Petstore.EndToEnd.Client.Models.JsonDateTime.Source uploadedAt, in Petstore.EndToEnd.Client.Models.JsonString.Source caption = default, in Petstore.EndToEnd.Client.Models.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
