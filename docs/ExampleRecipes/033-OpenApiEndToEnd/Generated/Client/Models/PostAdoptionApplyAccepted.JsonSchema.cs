    ...
    : IJsonElement<PostAdoptionApplyAccepted>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1adoption~1apply/post/responses/202/content/application~1json/schema"u8, buffer, out written);
