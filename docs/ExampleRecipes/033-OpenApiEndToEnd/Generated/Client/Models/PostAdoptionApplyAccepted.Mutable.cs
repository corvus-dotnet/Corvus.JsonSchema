...
public readonly partial struct PostAdoptionApplyAccepted
{
...
#endif
    {
        ...
        public void SetApplicationId(in Petstore.EndToEnd.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEstimatedReviewDays(in Petstore.EndToEnd.Client.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Source value)
        {
            CheckValidInstance();
