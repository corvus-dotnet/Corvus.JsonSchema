...
public readonly partial struct PostAdoptionApplyAccepted
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostAdoptionApplyAccepted instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostAdoptionApplyAccepted"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostAdoptionApplyAccepted(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Client.Models.JsonString.Mutable ApplicationId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ApplicationIdUtf8, out Petstore.EndToEnd.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Client.Models.JsonInteger.Mutable EstimatedReviewDays
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EstimatedReviewDaysUtf8, out Petstore.EndToEnd.Client.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostAdoptionApplyAccepted(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetApplicationId(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEstimatedReviewDays(scoped in Petstore.EndToEnd.Client.Models.JsonInteger.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EstimatedReviewDaysUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EstimatedReviewDaysUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EstimatedReviewDays, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>estimatedReviewDays</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveEstimatedReviewDays()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EstimatedReviewDaysUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostAdoptionApplyAccepted.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostAdoptionApplyAccepted"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostAdoptionApplyAccepted"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostAdoptionApplyAccepted Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostAdoptionApplyAccepted>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostAdoptionApplyAccepted"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostAdoptionApplyAccepted Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostAdoptionApplyAccepted>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Source arg2, scoped in Petstore.EndToEnd.Client.Models.JsonInteger.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Client.Models.JsonString.Source applicationId,
            in Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Source status,
            in Petstore.EndToEnd.Client.Models.JsonInteger.Source estimatedReviewDays = default)
        {
            ...
            estimatedReviewDays.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EstimatedReviewDays, ref builder);
        }
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Source arg2, scoped in Petstore.EndToEnd.Client.Models.JsonInteger.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source applicationId, scoped in Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Source status, scoped in Petstore.EndToEnd.Client.Models.JsonInteger.Source estimatedReviewDays = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Client.Models.JsonString.Source applicationId, in Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Source status, in Petstore.EndToEnd.Client.Models.JsonInteger.Source estimatedReviewDays = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(applicationId, status, estimatedReviewDays);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostAdoptionApplyAccepted, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<PostAdoptionApplyAccepted> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PostAdoptionApplyAccepted>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostAdoptionApplyAccepted> Create<TContext>(
    ...
    public static ParsedJsonDocument<PostAdoptionApplyAccepted> Create(in Petstore.EndToEnd.Client.Models.JsonString.Source applicationId, in Petstore.EndToEnd.Client.Models.PostAdoptionApplyAccepted.StatusEntity.Source status, in Petstore.EndToEnd.Client.Models.JsonInteger.Source estimatedReviewDays = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
