...
public readonly partial struct PostPetsByPetIdChatBody
{
...
#endif
    {
        ...
        public void SetHistory(in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(in Petstore.EndToEnd.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
