...
public readonly partial struct PostPetsByPetIdChatBody
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Mutable History
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HistoryUtf8, out Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Client.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Petstore.EndToEnd.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetHistory(scoped in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetHistory<TContext>(in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Client.Models.JsonString.Source message,
            in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
        {
        ...
        /// Creates an instance of a <see cref="PostPetsByPetIdChatBody"/>.
        /// </summary>
        public void Create(in Petstore.EndToEnd.Client.Models.JsonString.Source message, in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Petstore.EndToEnd.Client.Models.JsonString.Source message,
            in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Client.Models.JsonString.Source message, scoped in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default)
    {
    ...
    /// <param name="history">The value of the <c>"history"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source message, scoped in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Client.Models.JsonString.Source message, in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Petstore.EndToEnd.Client.Models.JsonString.Source message, in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static ParsedJsonDocument<PostPetsByPetIdChatBody> Create(in Petstore.EndToEnd.Client.Models.JsonString.Source message, in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source history = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostPetsByPetIdChatBody> Create<TContext>(in TContext context, in Petstore.EndToEnd.Client.Models.JsonString.Source message, in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.Source<TContext> history = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
