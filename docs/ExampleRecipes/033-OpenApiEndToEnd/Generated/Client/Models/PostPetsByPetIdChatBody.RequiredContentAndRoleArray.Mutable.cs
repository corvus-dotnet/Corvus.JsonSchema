...
public readonly partial struct PostPetsByPetIdChatBody
{
    ...
    public readonly partial struct RequiredContentAndRoleArray
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Source value)
            {
                CheckValidInstance();
