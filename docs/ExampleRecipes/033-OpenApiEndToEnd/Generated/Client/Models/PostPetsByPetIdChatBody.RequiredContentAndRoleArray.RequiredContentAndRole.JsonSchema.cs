...
public readonly partial struct PostPetsByPetIdChatBody
{
    ...
    public readonly partial struct RequiredContentAndRoleArray
    {
        ...
        public readonly partial struct RequiredContentAndRole
            : IJsonElement<RequiredContentAndRole>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitForContent = 0b00000000000000000000000000000001;

                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRolePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("role"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRoleNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("role"u8, buffer, out written);

                private const int RequiredOffsetForRole = 0;
                private const uint RequiredBitForRole = 0b00000000000000000000000000000010;

                private const uint RequiredBitMask0 =
                    RequiredBitForContent | RequiredBitForRole;
                ...
                private static void MatchRole(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Petstore.EndToEnd.Client.Models.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1pets~1{petId}~1chat/post/requestBody/content/application~1json/schema/properties/history/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/paths/~1pets~1{petId}~1chat/post/requestBody/content/application~1json/schema/properties/history/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1pets~1{petId}~1chat/post/requestBody/content/application~1json/schema/properties/history/items"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyContentPresent, "content"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRolePresent, "role"u8, "required"u8);
                        }
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyContentNotPresent, "content"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyContentPresent, "content"u8, "required"u8);
                            ...
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForRole] & RequiredBitForRole) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyRoleNotPresent, "role"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRolePresent, "role"u8, "required"u8);
