    ...
    public readonly partial struct RequiredContentAndRoleArray
    {
            ...
            : IJsonElement<RequiredContentAndRole>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchRole(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/paths/~1pets~1{petId}~1chat/post/requestBody/content/application~1json/schema/properties/history/items"u8, buffer, out written);
