    ...
    public readonly partial struct RequiredContentAndRoleArray
    {
        ...
        public readonly partial struct RequiredContentAndRole
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Petstore.EndToEnd.Client.JsonString.Mutable Content
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Petstore.EndToEnd.Client.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Petstore.EndToEnd.Client.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Mutable Role
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out Petstore.EndToEnd.Client.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetContent(in Petstore.EndToEnd.Client.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetRole(in Petstore.EndToEnd.Client.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Petstore.EndToEnd.Client.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Petstore.EndToEnd.Client.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Petstore.EndToEnd.Client.JsonString.Source content,
                    in Petstore.EndToEnd.Client.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role)
                {
                ...
                /// Creates an instance of a <see cref="RequiredContentAndRole"/>.
                /// </summary>
                public void Create(in Petstore.EndToEnd.Client.JsonString.Source content, in Petstore.EndToEnd.Client.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Client.JsonString.Source content, in Petstore.EndToEnd.Client.PostPetsByPetIdChatBody.RequiredContentAndRoleArray.RequiredContentAndRole.RoleEntity.Source role, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
