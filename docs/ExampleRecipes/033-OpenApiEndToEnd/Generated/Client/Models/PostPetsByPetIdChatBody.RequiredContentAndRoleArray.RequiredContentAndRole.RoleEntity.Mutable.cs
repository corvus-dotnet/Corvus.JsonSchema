        ...
        public readonly partial struct RequiredContentAndRole
        {
            ...
            public readonly partial struct RoleEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RoleEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RoleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RoleEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RoleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RoleEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RoleEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RoleEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(RoleEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (RoleEntity)value;
                ...
                {
                    return workspace.CreateBuilder<RoleEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RoleEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RoleEntity>();
                    }
                    finally
                    {
