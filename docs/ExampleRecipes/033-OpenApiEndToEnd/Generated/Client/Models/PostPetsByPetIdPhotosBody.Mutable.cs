...
public readonly partial struct PostPetsByPetIdPhotosBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostPetsByPetIdPhotosBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostPetsByPetIdPhotosBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostPetsByPetIdPhotosBody(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Client.Models.JsonBinary.Mutable File
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Petstore.EndToEnd.Client.Models.JsonBinary.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostPetsByPetIdPhotosBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFile(scoped in Petstore.EndToEnd.Client.Models.JsonBinary.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("file");
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostPetsByPetIdPhotosBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostPetsByPetIdPhotosBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostPetsByPetIdPhotosBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostPetsByPetIdPhotosBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostPetsByPetIdPhotosBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostPetsByPetIdPhotosBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostPetsByPetIdPhotosBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostPetsByPetIdPhotosBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Client.Models.JsonBinary.Source arg1, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Client.Models.PostPetsByPetIdPhotosBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Client.Models.JsonBinary.Source file,
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Client.Models.JsonBinary.Source arg1, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Client.Models.JsonBinary.Source file, scoped in Petstore.EndToEnd.Client.Models.JsonString.Source caption = default, scoped in Petstore.EndToEnd.Client.Models.JsonBoolean.Source isPrimary = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Client.Models.JsonBinary.Source file, in Petstore.EndToEnd.Client.Models.JsonString.Source caption = default, in Petstore.EndToEnd.Client.Models.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(file, caption, isPrimary);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostPetsByPetIdPhotosBody, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<PostPetsByPetIdPhotosBody> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PostPetsByPetIdPhotosBody>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostPetsByPetIdPhotosBody> Create<TContext>(
    ...
    public static ParsedJsonDocument<PostPetsByPetIdPhotosBody> Create(in Petstore.EndToEnd.Client.Models.JsonBinary.Source file, in Petstore.EndToEnd.Client.Models.JsonString.Source caption = default, in Petstore.EndToEnd.Client.Models.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
