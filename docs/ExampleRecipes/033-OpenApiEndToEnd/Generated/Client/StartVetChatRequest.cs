...
/// <summary>
/// Request type for the StartVetChat operation.
/// </summary>
/// <remarks>Start a vet support chat session (SSE streaming response)</remarks>
public readonly struct StartVetChatRequest : IApiRequest<StartVetChatRequest>
{
    ...
    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/pets/{petId}/chat"u8;
    ...
    {
        callback("Accept"u8, "application/json, text/event-stream"u8, state);
