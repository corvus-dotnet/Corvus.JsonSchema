...
public struct StartVetChatResponse : IApiResponse<StartVetChatResponse>
{
    ...
    /// <returns>An async enumerable of parsed documents containing <see cref="Petstore.EndToEnd.Client.Models.ChatChunk"/> items. Each document must be disposed by the caller.</returns>
    /// <remarks>
    ...
    /// </remarks>
    public IAsyncEnumerable<ParsedJsonDocument<Petstore.EndToEnd.Client.Models.ChatChunk>> EnumerateOkItems(CancellationToken cancellationToken = default)
    {
        ...
        return JsonStreamReader.ReadItemsAsync<Petstore.EndToEnd.Client.Models.ChatChunk>(this.itemStream, cancellationToken: cancellationToken);
    }
    ...
    /// </summary>
    /// <param name="cancellationToken">A cancellation token.</param>
    /// <returns>An async enumerable of SSE events wrapping <see cref="Petstore.EndToEnd.Client.Models.ChatChunk"/> items. Each event must be disposed by the caller.</returns>
    /// <remarks>
    ...
    /// </remarks>
    public IAsyncEnumerable<SseEvent<Petstore.EndToEnd.Client.Models.ChatChunk>> EnumerateOkSseItems(CancellationToken cancellationToken = default)
    {
        if (this.itemStream is null)
        {
            throw new InvalidOperationException("No streaming content is available.");
        ...
        return JsonStreamReader.ReadSseItemsAsync<Petstore.EndToEnd.Client.Models.ChatChunk>(this.itemStream, cancellationToken: cancellationToken);
    }
