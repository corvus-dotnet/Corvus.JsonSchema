...
public struct SubmitAdoptionApplicationResponse : IApiResponse<SubmitAdoptionApplicationResponse>
{
    ...
    /// </summary>
    public Petstore.EndToEnd.Client.PostAdoptionApplyAccepted AcceptedBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 202)
        {
            var acceptedDoc = await ParsedJsonDocument<Petstore.EndToEnd.Client.PostAdoptionApplyAccepted>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetAccepted(out Petstore.EndToEnd.Client.PostAdoptionApplyAccepted result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Petstore.EndToEnd.Client.PostAdoptionApplyAccepted, TResult> matchAccepted,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Petstore.EndToEnd.Client.PostAdoptionApplyAccepted, TContext, TResult> matchAccepted,
