...
public static class ApiEndpointRegistration
{
    ...
    public static IEndpointRouteBuilder MapApiEndpoints(this IEndpointRouteBuilder app, IApiPetsHandler petsHandler, IApiPhotosHandler photosHandler, IApiChatHandler chatHandler, IApiAdoptionHandler adoptionHandler, ConfigureEndpoint? configureEndpoint, ApiServerOptions? serverOptions = null)
    {
        ...
        IEndpointConventionBuilder __UploadPetPhotoEndpoint = app.MapPost("/pets/{petId}/photos", async (HttpContext context) =>
        {
            ...
            OwnedMultipartBody<Petstore.EndToEnd.Server.Models.PostPetsByPetIdPhotosBody>? __bodyOwner = null;
            try
            {
                Petstore.EndToEnd.Server.Models.JsonString PetIdValue = default;
                if (context.Request.RouteValues.TryGetValue("petId", out object? PetIdRouteVal) && PetIdRouteVal is string PetIdRaw)
                ...
                try
                {
                    __bodyOwner = await MultipartFormDataSerializer.DeserializeOwnedAsync<Petstore.EndToEnd.Server.Models.PostPetsByPetIdPhotosBody>(context.Request.Body, context.Request.ContentType, binaryPartCallback: part =>
                    {
