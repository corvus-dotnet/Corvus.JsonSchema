...
{
    private ListPetsResult(int statusCode, JsonElement body, string? contentType, Petstore.EndToEnd.Server.JsonInteger xTotalCount = default, Petstore.EndToEnd.Server.JsonString xNext = default)
    {
    ...
    /// </summary>
    public Petstore.EndToEnd.Server.JsonInteger XTotalCount { get; }

    /// <summary>
    /// Gets the value of the <c>x-next</c> response header.
    /// </summary>
    public Petstore.EndToEnd.Server.JsonString XNext { get; }
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Petstore.EndToEnd.Server.PetList.From(this.Body).EvaluateSchema(),
            _ => true,
        };
    }
