    ...
    : IJsonElement<ActivityEvent>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForEventId = 0b00000000000000000000000000000001;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTimestampPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("timestamp"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTimestampNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("timestamp"u8, buffer, out written);

        private const int RequiredOffsetForTimestamp = 0;
        private const uint RequiredBitForTimestamp = 0b00000000000000000000000000000010;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForEventId | RequiredBitForTimestamp | RequiredBitForType;
        ...
        private static readonly JsonSchemaPathProvider EventIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/eventId"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider TimestampSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/timestamp"u8, buffer, out written);
        ...
        private static void MatchDescription(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Petstore.EndToEnd.Server.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Petstore.EndToEnd.Server.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            context.CommitChildContext(childContext.IsMatch, ref childContext);
        }

        private static void MatchEventId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            ...
            Petstore.EndToEnd.Server.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchTimestamp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                Petstore.EndToEnd.Server.Models.JsonDateTime.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.TimestampUtf8,
                    evaluationPath: TimestampSchemaEvaluationPath);

            Petstore.EndToEnd.Server.Models.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            requiredBitBuffer[RequiredOffsetForTimestamp] |= RequiredBitForTimestamp;
        }
        ...
        private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext3 =
                Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        private static PropertySchemaMatchers<Petstore.EndToEnd.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Petstore.EndToEnd.Server.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.DescriptionUtf8, MatchDescription),
                (static () => JsonPropertyNames.EventIdUtf8, MatchEventId),
                (static () => JsonPropertyNames.TimestampUtf8, MatchTimestamp),
                (static () => JsonPropertyNames.TypeUtf8, MatchType),
            ]);
        }

        private static PropertySchemaMatchers<Petstore.EndToEnd.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out Petstore.EndToEnd.Server.Models.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/components/schemas/ActivityEvent"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/ActivityEvent";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/ActivityEvent"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Petstore.EndToEnd.Server.Models.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEventIdPresent, "eventId"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyTimestampPresent, "timestamp"u8, "required"u8);
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyEventIdNotPresent, "eventId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEventIdPresent, "eventId"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForTimestamp] & RequiredBitForTimestamp) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyTimestampNotPresent, "timestamp"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyTimestampPresent, "timestamp"u8, "required"u8);
