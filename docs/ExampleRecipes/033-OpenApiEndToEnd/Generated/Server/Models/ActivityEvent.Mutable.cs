...
public readonly partial struct ActivityEvent
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.JsonString.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Petstore.EndToEnd.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.JsonString.Mutable EventId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventIdUtf8, out Petstore.EndToEnd.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.JsonDateTime.Mutable Timestamp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimestampUtf8, out Petstore.EndToEnd.Server.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.ActivityEvent.TypeEntity.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Petstore.EndToEnd.Server.ActivityEvent.TypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDescription(in Petstore.EndToEnd.Server.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEventId(in Petstore.EndToEnd.Server.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTimestamp(in Petstore.EndToEnd.Server.JsonDateTime.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(in Petstore.EndToEnd.Server.ActivityEvent.TypeEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.EndToEnd.Server.ActivityEvent.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Server.ActivityEvent.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Server.JsonString.Source eventId,
            in Petstore.EndToEnd.Server.JsonDateTime.Source timestamp,
            in Petstore.EndToEnd.Server.ActivityEvent.TypeEntity.Source type,
            in Petstore.EndToEnd.Server.JsonString.Source description = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Server.JsonString.Source eventId, in Petstore.EndToEnd.Server.JsonDateTime.Source timestamp, in Petstore.EndToEnd.Server.ActivityEvent.TypeEntity.Source type, in Petstore.EndToEnd.Server.JsonString.Source description = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
