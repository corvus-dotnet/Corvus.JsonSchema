...
public readonly partial struct ActivityEvent
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ActivityEvent instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ActivityEvent"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ActivityEvent(Mutable instance)
        {
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.Models.JsonString.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Petstore.EndToEnd.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.Models.JsonString.Mutable EventId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventIdUtf8, out Petstore.EndToEnd.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.Models.JsonDateTime.Mutable Timestamp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimestampUtf8, out Petstore.EndToEnd.Server.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ActivityEvent(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDescription(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEventId(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("eventId");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EventId, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTimestamp(scoped in Petstore.EndToEnd.Server.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("timestamp");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(scoped in Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ActivityEvent.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ActivityEvent"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ActivityEvent"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ActivityEvent Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ActivityEvent>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ActivityEvent"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ActivityEvent Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ActivityEvent>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonDateTime.Source arg2, scoped in Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.Source arg3, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Server.Models.ActivityEvent.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Server.Models.JsonString.Source eventId,
            in Petstore.EndToEnd.Server.Models.JsonDateTime.Source timestamp,
            in Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.Source type,
            in Petstore.EndToEnd.Server.Models.JsonString.Source description = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonDateTime.Source arg2, scoped in Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.Source arg3, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source eventId, scoped in Petstore.EndToEnd.Server.Models.JsonDateTime.Source timestamp, scoped in Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.Source type, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source description = default)
    {
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="eventId">The value of the property.</param>
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Server.Models.JsonString.Source eventId, in Petstore.EndToEnd.Server.Models.JsonDateTime.Source timestamp, in Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.Source type, in Petstore.EndToEnd.Server.Models.JsonString.Source description = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(eventId, timestamp, type, description);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ActivityEvent, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ActivityEvent> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ActivityEvent>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ActivityEvent> Create<TContext>(
    ...
    public static ParsedJsonDocument<ActivityEvent> Create(in Petstore.EndToEnd.Server.Models.JsonString.Source eventId, in Petstore.EndToEnd.Server.Models.JsonDateTime.Source timestamp, in Petstore.EndToEnd.Server.Models.ActivityEvent.TypeEntity.Source type, in Petstore.EndToEnd.Server.Models.JsonString.Source description = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
