...
public readonly partial struct Error
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Error instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Error"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Error(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.Models.JsonInt32.Mutable Code
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out Petstore.EndToEnd.Server.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Error(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCode(scoped in Petstore.EndToEnd.Server.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Error.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Error"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Error"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Error Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Error>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Error"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Error Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Error>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Server.Models.JsonInt32.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Server.Models.Error.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Error"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Petstore.EndToEnd.Server.Models.JsonInt32.Source code,
        ...
        /// Creates an instance of a <see cref="Error"/>.
        /// </summary>
        public void Create(in Petstore.EndToEnd.Server.Models.JsonInt32.Source code, in Petstore.EndToEnd.Server.Models.JsonString.Source message)
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Server.Models.JsonInt32.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Server.Models.JsonInt32.Source code, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source message)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Server.Models.JsonInt32.Source code, in Petstore.EndToEnd.Server.Models.JsonString.Source message, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<Error, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<Error> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<Error>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Error> Create<TContext>(
    ...
    public static ParsedJsonDocument<Error> Create(in Petstore.EndToEnd.Server.Models.JsonInt32.Source code, in Petstore.EndToEnd.Server.Models.JsonString.Source message, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
