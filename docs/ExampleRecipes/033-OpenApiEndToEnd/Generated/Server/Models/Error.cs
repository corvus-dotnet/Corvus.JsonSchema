...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.EndToEnd.Server.Models.JsonInt32 Code
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out Petstore.EndToEnd.Server.Models.JsonInt32 value))
            {
                return value;
            }
