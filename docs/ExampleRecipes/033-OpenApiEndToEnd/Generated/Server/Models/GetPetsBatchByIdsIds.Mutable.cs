...
public readonly partial struct GetPetsBatchByIdsIds
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetPetsBatchByIdsIds instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetPetsBatchByIdsIds"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetPetsBatchByIdsIds(Mutable instance)
        {
        ...
        public Petstore.EndToEnd.Server.Models.JsonInt64.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Petstore.EndToEnd.Server.Models.JsonInt64.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Petstore.EndToEnd.Server.Models.JsonInt64.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Petstore.EndToEnd.Server.Models.JsonInt64.Mutable>(_parent, _idx);
        }
        ...
        public bool TryGetNumericValues(Span<long> items, out int written)
        {
            CheckValidInstance();
            written = 0;
            foreach (Petstore.EndToEnd.Server.Models.JsonInt64.Mutable item in EnumerateArray())
            {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetPetsBatchByIdsIds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Petstore.EndToEnd.Server.Models.JsonInt64.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, scoped in Petstore.EndToEnd.Server.Models.JsonInt64.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(scoped in Petstore.EndToEnd.Server.Models.JsonInt64.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Petstore.EndToEnd.Server.Models.JsonInt64 item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Petstore.EndToEnd.Server.Models.JsonInt64>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Petstore.EndToEnd.Server.Models.JsonInt64> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Petstore.EndToEnd.Server.Models.JsonInt64>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in Petstore.EndToEnd.Server.Models.JsonInt64 oldItem, in Petstore.EndToEnd.Server.Models.JsonInt64.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Petstore.EndToEnd.Server.Models.JsonInt64>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                Petstore.EndToEnd.Server.Models.JsonInt64 current = enumerator.Current;
        ...
        /// </para>
        /// </remarks>
        public readonly GetPetsBatchByIdsIds Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetPetsBatchByIdsIds Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetPetsBatchByIdsIds>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.EndToEnd.Server.Models.GetPetsBatchByIdsIds.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetPetsBatchByIdsIds instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Server.Models.GetPetsBatchByIdsIds.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void AddItem(in Petstore.EndToEnd.Server.Models.JsonInt64.Source value)
        {
    ...
    {
        return workspace.CreateBuilder<GetPetsBatchByIdsIds, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetPetsBatchByIdsIds> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetPetsBatchByIdsIds>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetPetsBatchByIdsIds> Create<TContext>(
