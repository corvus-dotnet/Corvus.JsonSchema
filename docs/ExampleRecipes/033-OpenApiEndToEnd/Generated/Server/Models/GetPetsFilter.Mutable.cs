...
public readonly partial struct GetPetsFilter
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.JsonInteger.Mutable MaxAge
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Petstore.EndToEnd.Server.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.JsonInteger.Mutable MinAge
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinAgeUtf8, out Petstore.EndToEnd.Server.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.GetPetsFilter.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Server.GetPetsFilter.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMaxAge(in Petstore.EndToEnd.Server.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMinAge(in Petstore.EndToEnd.Server.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in Petstore.EndToEnd.Server.GetPetsFilter.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.EndToEnd.Server.GetPetsFilter.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Server.GetPetsFilter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Server.JsonInteger.Source maxAge = default,
            in Petstore.EndToEnd.Server.JsonInteger.Source minAge = default,
            in Petstore.EndToEnd.Server.GetPetsFilter.StatusEntity.Source status = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Server.JsonString.Source breed = default, in Petstore.EndToEnd.Server.JsonInteger.Source maxAge = default, in Petstore.EndToEnd.Server.JsonInteger.Source minAge = default, in Petstore.EndToEnd.Server.GetPetsFilter.StatusEntity.Source status = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
