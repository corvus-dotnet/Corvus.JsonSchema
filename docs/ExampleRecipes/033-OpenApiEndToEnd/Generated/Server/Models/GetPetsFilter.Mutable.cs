...
public readonly partial struct GetPetsFilter
{
...
#endif
    {
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.Models.JsonInteger.Mutable MaxAge
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Petstore.EndToEnd.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.Models.JsonInteger.Mutable MinAge
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinAgeUtf8, out Petstore.EndToEnd.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.Models.GetPetsFilter.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Server.Models.GetPetsFilter.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMaxAge(scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMinAge(scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Petstore.EndToEnd.Server.Models.GetPetsFilter.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source arg2, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source arg3, scoped in Petstore.EndToEnd.Server.Models.GetPetsFilter.StatusEntity.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Server.Models.GetPetsFilter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Server.Models.JsonInteger.Source maxAge = default,
            in Petstore.EndToEnd.Server.Models.JsonInteger.Source minAge = default,
            in Petstore.EndToEnd.Server.Models.GetPetsFilter.StatusEntity.Source status = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source arg2, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source arg3, scoped in Petstore.EndToEnd.Server.Models.GetPetsFilter.StatusEntity.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source maxAge = default, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source minAge = default, scoped in Petstore.EndToEnd.Server.Models.GetPetsFilter.StatusEntity.Source status = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Server.Models.JsonInteger.Source maxAge = default, in Petstore.EndToEnd.Server.Models.JsonInteger.Source minAge = default, in Petstore.EndToEnd.Server.Models.GetPetsFilter.StatusEntity.Source status = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<GetPetsFilter> Create(in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Server.Models.JsonInteger.Source maxAge = default, in Petstore.EndToEnd.Server.Models.JsonInteger.Source minAge = default, in Petstore.EndToEnd.Server.Models.GetPetsFilter.StatusEntity.Source status = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
