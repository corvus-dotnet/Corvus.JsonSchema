...
public readonly partial struct NewPet
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.NewPet.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Server.NewPet.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.NewPet.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Petstore.EndToEnd.Server.NewPet.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in Petstore.EndToEnd.Server.NewPet.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in Petstore.EndToEnd.Server.NewPet.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in Petstore.EndToEnd.Server.NewPet.JsonStringArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.EndToEnd.Server.NewPet.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Server.NewPet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Server.NewPet.StatusEntity.Source status,
            in Petstore.EndToEnd.Server.JsonInteger.Source age = default,
            in Petstore.EndToEnd.Server.JsonString.Source breed = default,
            in Petstore.EndToEnd.Server.NewPet.JsonStringArray.Source tags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Petstore.EndToEnd.Server.JsonInteger.Source age = default,
            in Petstore.EndToEnd.Server.JsonString.Source breed = default,
            in Petstore.EndToEnd.Server.NewPet.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Server.JsonString.Source name, in Petstore.EndToEnd.Server.NewPet.StatusEntity.Source status, in Petstore.EndToEnd.Server.JsonInteger.Source age = default, in Petstore.EndToEnd.Server.JsonString.Source breed = default, in Petstore.EndToEnd.Server.NewPet.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Petstore.EndToEnd.Server.JsonString.Source name, in Petstore.EndToEnd.Server.NewPet.StatusEntity.Source status, in Petstore.EndToEnd.Server.JsonInteger.Source age = default, in Petstore.EndToEnd.Server.JsonString.Source breed = default, in Petstore.EndToEnd.Server.NewPet.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
