...
public readonly partial struct NewPet
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.Models.NewPet.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Server.Models.NewPet.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Petstore.EndToEnd.Server.Models.NewPet.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Petstore.EndToEnd.Server.Models.NewPet.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in Petstore.EndToEnd.Server.Models.NewPet.JsonStringArray.Source<TContext> value)
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Server.Models.NewPet.StatusEntity.Source status,
            ...
            in Petstore.EndToEnd.Server.Models.NewPet.JsonStringArray.Source tags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Petstore.EndToEnd.Server.Models.JsonInteger.Source age = default,
            in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default,
            in Petstore.EndToEnd.Server.Models.NewPet.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Server.Models.JsonString.Source name, in Petstore.EndToEnd.Server.Models.NewPet.StatusEntity.Source status, in Petstore.EndToEnd.Server.Models.JsonInteger.Source age = default, in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Server.Models.NewPet.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Petstore.EndToEnd.Server.Models.JsonString.Source name, in Petstore.EndToEnd.Server.Models.NewPet.StatusEntity.Source status, in Petstore.EndToEnd.Server.Models.JsonInteger.Source age = default, in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Server.Models.NewPet.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static ParsedJsonDocument<NewPet> Create(in Petstore.EndToEnd.Server.Models.JsonString.Source name, in Petstore.EndToEnd.Server.Models.NewPet.StatusEntity.Source status, in Petstore.EndToEnd.Server.Models.JsonInteger.Source age = default, in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Server.Models.NewPet.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<NewPet> Create<TContext>(in TContext context, in Petstore.EndToEnd.Server.Models.JsonString.Source name, in Petstore.EndToEnd.Server.Models.NewPet.StatusEntity.Source status, in Petstore.EndToEnd.Server.Models.JsonInteger.Source age = default, in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Server.Models.NewPet.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
