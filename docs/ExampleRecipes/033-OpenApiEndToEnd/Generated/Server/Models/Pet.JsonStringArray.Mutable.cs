...
public readonly partial struct Pet
{
    ...
    public readonly partial struct JsonStringArray
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source value)
            {
        ...
        public ref struct Source
        {
            ...
            internal Source(Petstore.EndToEnd.Server.Models.Pet.JsonStringArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Petstore.EndToEnd.Server.Models.Pet.JsonStringArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
