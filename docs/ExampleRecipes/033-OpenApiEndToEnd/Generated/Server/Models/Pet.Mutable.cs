...
public readonly partial struct Pet
{
...
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetId(scoped in Petstore.EndToEnd.Server.Models.JsonInt64.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPhotoIds(scoped in Petstore.EndToEnd.Server.Models.Pet.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Petstore.EndToEnd.Server.Models.Pet.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(scoped in Petstore.EndToEnd.Server.Models.Pet.TagsJsonStArray.Source value)
        {
            CheckValidInstance();
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, scoped in Petstore.EndToEnd.Server.Models.JsonInt64.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Server.Models.Pet.StatusEntity.Source arg3, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source arg4, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg5, scoped in Petstore.EndToEnd.Server.Models.Pet.JsonStringArray.Source<TContext> arg6, scoped in Petstore.EndToEnd.Server.Models.Pet.TagsJsonStArray.Source<TContext> arg7)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Server.Models.JsonInt64.Source id, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source name, scoped in Petstore.EndToEnd.Server.Models.Pet.StatusEntity.Source status, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source age = default, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, scoped in Petstore.EndToEnd.Server.Models.Pet.JsonStringArray.Source photoIds = default, scoped in Petstore.EndToEnd.Server.Models.Pet.TagsJsonStArray.Source tags = default)
    {
    ...
    /// <param name="tags">The value of the <c>"tags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Petstore.EndToEnd.Server.Models.JsonInt64.Source id, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source name, scoped in Petstore.EndToEnd.Server.Models.Pet.StatusEntity.Source status, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source age = default, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, scoped in Petstore.EndToEnd.Server.Models.Pet.JsonStringArray.Source<TContext> photoIds = default, scoped in Petstore.EndToEnd.Server.Models.Pet.TagsJsonStArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static ParsedJsonDocument<Pet> Create(in Petstore.EndToEnd.Server.Models.JsonInt64.Source id, in Petstore.EndToEnd.Server.Models.JsonString.Source name, in Petstore.EndToEnd.Server.Models.Pet.StatusEntity.Source status, in Petstore.EndToEnd.Server.Models.JsonInteger.Source age = default, in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Server.Models.Pet.JsonStringArray.Source photoIds = default, in Petstore.EndToEnd.Server.Models.Pet.TagsJsonStArray.Source tags = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Pet> Create<TContext>(in TContext context, in Petstore.EndToEnd.Server.Models.JsonInt64.Source id, in Petstore.EndToEnd.Server.Models.JsonString.Source name, in Petstore.EndToEnd.Server.Models.Pet.StatusEntity.Source status, in Petstore.EndToEnd.Server.Models.JsonInteger.Source age = default, in Petstore.EndToEnd.Server.Models.JsonString.Source breed = default, in Petstore.EndToEnd.Server.Models.Pet.JsonStringArray.Source<TContext> photoIds = default, in Petstore.EndToEnd.Server.Models.Pet.TagsJsonStArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
