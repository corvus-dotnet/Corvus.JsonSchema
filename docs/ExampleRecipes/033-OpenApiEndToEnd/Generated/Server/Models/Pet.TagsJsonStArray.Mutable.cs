...
public readonly partial struct Pet
{
    ...
    public readonly partial struct TagsJsonStArray
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(Petstore.EndToEnd.Server.Models.Pet.TagsJsonStArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Petstore.EndToEnd.Server.Models.Pet.TagsJsonStArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
