            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = Petstore.EndToEnd.Server.Pet.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    Petstore.EndToEnd.Server.Pet.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
