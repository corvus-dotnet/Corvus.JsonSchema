...
public readonly partial struct PhotoMetadata
{
...
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPhotoId(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUploadedAt(scoped in Petstore.EndToEnd.Server.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Server.Models.JsonDateTime.Source arg3, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg4, scoped in Petstore.EndToEnd.Server.Models.JsonBoolean.Source arg5)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Server.Models.JsonDateTime.Source arg3, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg4, scoped in Petstore.EndToEnd.Server.Models.JsonBoolean.Source arg5, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source petId, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source photoId, scoped in Petstore.EndToEnd.Server.Models.JsonDateTime.Source uploadedAt, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source caption = default, scoped in Petstore.EndToEnd.Server.Models.JsonBoolean.Source isPrimary = default)
    {
    ...
    public static ParsedJsonDocument<PhotoMetadata> Create(in Petstore.EndToEnd.Server.Models.JsonString.Source petId, in Petstore.EndToEnd.Server.Models.JsonString.Source photoId, in Petstore.EndToEnd.Server.Models.JsonDateTime.Source uploadedAt, in Petstore.EndToEnd.Server.Models.JsonString.Source caption = default, in Petstore.EndToEnd.Server.Models.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
