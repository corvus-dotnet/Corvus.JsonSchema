...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.EndToEnd.Server.Models.JsonString PhotoId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhotoIdUtf8, out Petstore.EndToEnd.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.EndToEnd.Server.Models.JsonDateTime UploadedAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedAtUtf8, out Petstore.EndToEnd.Server.Models.JsonDateTime value))
            {
                return value;
            }
