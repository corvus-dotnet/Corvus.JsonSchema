...
public readonly partial struct PostAdoptionApplyAccepted
{
...
#endif
    {
        ...
        public void SetApplicationId(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEstimatedReviewDays(scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Petstore.EndToEnd.Server.Models.PostAdoptionApplyAccepted.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Server.Models.PostAdoptionApplyAccepted.StatusEntity.Source arg2, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg1, scoped in Petstore.EndToEnd.Server.Models.PostAdoptionApplyAccepted.StatusEntity.Source arg2, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source applicationId, scoped in Petstore.EndToEnd.Server.Models.PostAdoptionApplyAccepted.StatusEntity.Source status, scoped in Petstore.EndToEnd.Server.Models.JsonInteger.Source estimatedReviewDays = default)
    {
    ...
    public static ParsedJsonDocument<PostAdoptionApplyAccepted> Create(in Petstore.EndToEnd.Server.Models.JsonString.Source applicationId, in Petstore.EndToEnd.Server.Models.PostAdoptionApplyAccepted.StatusEntity.Source status, in Petstore.EndToEnd.Server.Models.JsonInteger.Source estimatedReviewDays = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
