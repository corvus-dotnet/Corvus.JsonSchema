...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.EndToEnd.Server.JsonString ApplicationId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ApplicationIdUtf8, out Petstore.EndToEnd.Server.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.EndToEnd.Server.JsonInteger EstimatedReviewDays
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EstimatedReviewDaysUtf8, out Petstore.EndToEnd.Server.JsonInteger value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.EndToEnd.Server.PostAdoptionApplyAccepted.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Server.PostAdoptionApplyAccepted.StatusEntity value))
            {
                return value;
            }
