...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.EndToEnd.Server.Models.JsonString ApplicationId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ApplicationIdUtf8, out Petstore.EndToEnd.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.EndToEnd.Server.Models.JsonInteger EstimatedReviewDays
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EstimatedReviewDaysUtf8, out Petstore.EndToEnd.Server.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.EndToEnd.Server.Models.PostAdoptionApplyAccepted.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.EndToEnd.Server.Models.PostAdoptionApplyAccepted.StatusEntity value))
            {
                return value;
            }
