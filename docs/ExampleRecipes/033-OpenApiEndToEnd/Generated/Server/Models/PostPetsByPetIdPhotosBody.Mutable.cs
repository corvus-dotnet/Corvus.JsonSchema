...
public readonly partial struct PostPetsByPetIdPhotosBody
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.Models.JsonBinary.Mutable File
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Petstore.EndToEnd.Server.Models.JsonBinary.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCaption(scoped in Petstore.EndToEnd.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFile(scoped in Petstore.EndToEnd.Server.Models.JsonBinary.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetIsPrimary(scoped in Petstore.EndToEnd.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Petstore.EndToEnd.Server.Models.JsonBinary.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Server.Models.JsonBoolean.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Server.Models.PostPetsByPetIdPhotosBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Server.Models.JsonBinary.Source file,
        ...
        internal static void BuildCreateValue(scoped in Petstore.EndToEnd.Server.Models.JsonBinary.Source arg1, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source arg2, scoped in Petstore.EndToEnd.Server.Models.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Petstore.EndToEnd.Server.Models.JsonBinary.Source file, scoped in Petstore.EndToEnd.Server.Models.JsonString.Source caption = default, scoped in Petstore.EndToEnd.Server.Models.JsonBoolean.Source isPrimary = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Server.Models.JsonBinary.Source file, in Petstore.EndToEnd.Server.Models.JsonString.Source caption = default, in Petstore.EndToEnd.Server.Models.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<PostPetsByPetIdPhotosBody> Create(in Petstore.EndToEnd.Server.Models.JsonBinary.Source file, in Petstore.EndToEnd.Server.Models.JsonString.Source caption = default, in Petstore.EndToEnd.Server.Models.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
