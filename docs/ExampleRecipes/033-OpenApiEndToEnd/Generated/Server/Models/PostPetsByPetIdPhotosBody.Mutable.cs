...
public readonly partial struct PostPetsByPetIdPhotosBody
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Petstore.EndToEnd.Server.JsonBinary.Mutable File
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Petstore.EndToEnd.Server.JsonBinary.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFile(in Petstore.EndToEnd.Server.JsonBinary.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Petstore.EndToEnd.Server.PostPetsByPetIdPhotosBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Petstore.EndToEnd.Server.PostPetsByPetIdPhotosBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Petstore.EndToEnd.Server.JsonBinary.Source file,
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Petstore.EndToEnd.Server.JsonBinary.Source file, in Petstore.EndToEnd.Server.JsonString.Source caption = default, in Petstore.EndToEnd.Server.JsonBoolean.Source isPrimary = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
