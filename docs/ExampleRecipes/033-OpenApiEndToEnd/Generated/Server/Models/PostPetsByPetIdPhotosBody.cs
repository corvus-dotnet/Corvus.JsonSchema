...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostPetsByPetIdPhotosBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostPetsByPetIdPhotosBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostPetsByPetIdPhotosBody DefaultInstance { get; }
    ...
    /// </summary>
    public Petstore.EndToEnd.Server.Models.JsonString Caption
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaptionUtf8, out Petstore.EndToEnd.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.EndToEnd.Server.Models.JsonBinary File
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Petstore.EndToEnd.Server.Models.JsonBinary value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.EndToEnd.Server.Models.JsonBoolean IsPrimary
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsPrimaryUtf8, out Petstore.EndToEnd.Server.Models.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostPetsByPetIdPhotosBody left, in PostPetsByPetIdPhotosBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostPetsByPetIdPhotosBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostPetsByPetIdPhotosBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostPetsByPetIdPhotosBody(JsonElement instance)
    {
        return PostPetsByPetIdPhotosBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostPetsByPetIdPhotosBody From<T>(in T instance)
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostPetsByPetIdPhotosBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostPetsByPetIdPhotosBody>(ref reader, out result);
    }
...
#if NET
    static PostPetsByPetIdPhotosBody IJsonElement<PostPetsByPetIdPhotosBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostPetsByPetIdPhotosBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostPetsByPetIdPhotosBody Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostPetsByPetIdPhotosBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostPetsByPetIdPhotosBody>(_idx);
        }
