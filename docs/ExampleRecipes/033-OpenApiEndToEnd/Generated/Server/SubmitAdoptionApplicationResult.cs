...
/// <summary>
/// Result type for the SubmitAdoptionApplication operation.
/// </summary>
public readonly struct SubmitAdoptionApplicationResult
{
    private SubmitAdoptionApplicationResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    public bool ValidateBody()
    {
        ...
        {
            202 => Petstore.EndToEnd.Server.Models.PostAdoptionApplyAccepted.From(this.Body).EvaluateSchema(),
            _ => true,
        };
    }
