...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackServer.Models.JsonString.Mutable AlertId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AlertIdUtf8, out EventSubscription.CallbackServer.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackServer.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out EventSubscription.CallbackServer.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Mutable Severity
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SeverityUtf8, out EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Set the <c>alertId</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAlertId(scoped in EventSubscription.CallbackServer.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("alertId");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AlertIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AlertId, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(scoped in EventSubscription.CallbackServer.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSeverity(scoped in EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in EventSubscription.CallbackServer.Models.JsonString.Source arg1, scoped in EventSubscription.CallbackServer.Models.JsonString.Source arg2, scoped in EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, EventSubscription.CallbackServer.Models.Schema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in EventSubscription.CallbackServer.Models.JsonString.Source alertId,
            in EventSubscription.CallbackServer.Models.JsonString.Source message,
            in EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Source severity)
        {
            alertId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AlertId, ref builder);
        ...
        public void Create(
            ...
            in EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Source severity)
        {
            Create(ref _builder, alertId, message, severity);
        }
        ...
        internal static void BuildCreateValue(scoped in EventSubscription.CallbackServer.Models.JsonString.Source arg1, scoped in EventSubscription.CallbackServer.Models.JsonString.Source arg2, scoped in EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in EventSubscription.CallbackServer.Models.JsonString.Source alertId, scoped in EventSubscription.CallbackServer.Models.JsonString.Source message, scoped in EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Source severity)
    {
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="alertId">The value of the property.</param>
    /// <param name="message">The value of the property.</param>
    /// <param name="severity">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in EventSubscription.CallbackServer.Models.JsonString.Source alertId, in EventSubscription.CallbackServer.Models.JsonString.Source message, in EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Source severity, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(alertId, message, severity);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    public static ParsedJsonDocument<Schema> Create(in EventSubscription.CallbackServer.Models.JsonString.Source alertId, in EventSubscription.CallbackServer.Models.JsonString.Source message, in EventSubscription.CallbackServer.Models.Schema.SeverityEntity.Source severity, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
