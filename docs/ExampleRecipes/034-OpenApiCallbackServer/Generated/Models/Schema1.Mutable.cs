...
public readonly partial struct Schema1
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackServer.Models.JsonString.Mutable EventId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventIdUtf8, out EventSubscription.CallbackServer.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackServer.Models.JsonString.Mutable EventType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventTypeUtf8, out EventSubscription.CallbackServer.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public EventSubscription.CallbackServer.Models.JsonObject.Mutable Payload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out EventSubscription.CallbackServer.Models.JsonObject.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackServer.Models.JsonDateTime.Mutable Timestamp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimestampUtf8, out EventSubscription.CallbackServer.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload<TContext>(in EventSubscription.CallbackServer.Models.JsonObject.Source<TContext> value)
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in EventSubscription.CallbackServer.Models.JsonString.Source eventId,
            in EventSubscription.CallbackServer.Models.JsonString.Source eventType,
            in EventSubscription.CallbackServer.Models.JsonDateTime.Source timestamp,
            in EventSubscription.CallbackServer.Models.JsonObject.Source payload = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in EventSubscription.CallbackServer.Models.JsonString.Source eventType,
            in EventSubscription.CallbackServer.Models.JsonDateTime.Source timestamp,
            in EventSubscription.CallbackServer.Models.JsonObject.Source<TContext> payload = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
