...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackClient.Models.JsonString.Mutable AlertId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AlertIdUtf8, out EventSubscription.CallbackClient.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackClient.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out EventSubscription.CallbackClient.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackClient.Models.Schema.SeverityEntity.Mutable Severity
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SeverityUtf8, out EventSubscription.CallbackClient.Models.Schema.SeverityEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetAlertId(scoped in EventSubscription.CallbackClient.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(scoped in EventSubscription.CallbackClient.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSeverity(scoped in EventSubscription.CallbackClient.Models.Schema.SeverityEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in EventSubscription.CallbackClient.Models.JsonString.Source arg1, scoped in EventSubscription.CallbackClient.Models.JsonString.Source arg2, scoped in EventSubscription.CallbackClient.Models.Schema.SeverityEntity.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, EventSubscription.CallbackClient.Models.Schema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in EventSubscription.CallbackClient.Models.JsonString.Source alertId,
            in EventSubscription.CallbackClient.Models.JsonString.Source message,
            in EventSubscription.CallbackClient.Models.Schema.SeverityEntity.Source severity)
        {
        ...
        internal static void BuildCreateValue(scoped in EventSubscription.CallbackClient.Models.JsonString.Source arg1, scoped in EventSubscription.CallbackClient.Models.JsonString.Source arg2, scoped in EventSubscription.CallbackClient.Models.Schema.SeverityEntity.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in EventSubscription.CallbackClient.Models.JsonString.Source alertId, scoped in EventSubscription.CallbackClient.Models.JsonString.Source message, scoped in EventSubscription.CallbackClient.Models.Schema.SeverityEntity.Source severity)
    {
    ...
    public static ParsedJsonDocument<Schema> Create(in EventSubscription.CallbackClient.Models.JsonString.Source alertId, in EventSubscription.CallbackClient.Models.JsonString.Source message, in EventSubscription.CallbackClient.Models.Schema.SeverityEntity.Source severity, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
