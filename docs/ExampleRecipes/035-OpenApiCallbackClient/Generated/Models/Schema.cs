...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public EventSubscription.CallbackClient.Models.JsonString AlertId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AlertIdUtf8, out EventSubscription.CallbackClient.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public EventSubscription.CallbackClient.Models.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out EventSubscription.CallbackClient.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public EventSubscription.CallbackClient.Models.Schema.SeverityEntity Severity
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SeverityUtf8, out EventSubscription.CallbackClient.Models.Schema.SeverityEntity value))
            {
                return value;
            }
