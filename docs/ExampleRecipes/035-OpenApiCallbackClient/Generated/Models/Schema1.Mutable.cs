...
public readonly partial struct Schema1
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackClient.Models.JsonString.Mutable EventId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventIdUtf8, out EventSubscription.CallbackClient.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackClient.Models.JsonString.Mutable EventType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventTypeUtf8, out EventSubscription.CallbackClient.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public EventSubscription.CallbackClient.Models.JsonObject.Mutable Payload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out EventSubscription.CallbackClient.Models.JsonObject.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public EventSubscription.CallbackClient.Models.JsonDateTime.Mutable Timestamp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimestampUtf8, out EventSubscription.CallbackClient.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        public void SetEventId(scoped in EventSubscription.CallbackClient.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEventType(scoped in EventSubscription.CallbackClient.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload(scoped in EventSubscription.CallbackClient.Models.JsonObject.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload<TContext>(in EventSubscription.CallbackClient.Models.JsonObject.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTimestamp(scoped in EventSubscription.CallbackClient.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in EventSubscription.CallbackClient.Models.JsonString.Source eventType,
            in EventSubscription.CallbackClient.Models.JsonDateTime.Source timestamp,
            in EventSubscription.CallbackClient.Models.JsonObject.Source payload = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in EventSubscription.CallbackClient.Models.JsonString.Source eventType,
            in EventSubscription.CallbackClient.Models.JsonDateTime.Source timestamp,
            in EventSubscription.CallbackClient.Models.JsonObject.Source<TContext> payload = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, eventId, eventType, timestamp, payload);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in EventSubscription.CallbackClient.Models.JsonString.Source eventId, in EventSubscription.CallbackClient.Models.JsonString.Source eventType, in EventSubscription.CallbackClient.Models.JsonDateTime.Source timestamp, in EventSubscription.CallbackClient.Models.JsonObject.Source payload = default, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(eventId, eventType, timestamp, payload);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in EventSubscription.CallbackClient.Models.JsonString.Source eventId, in EventSubscription.CallbackClient.Models.JsonString.Source eventType, in EventSubscription.CallbackClient.Models.JsonDateTime.Source timestamp, in EventSubscription.CallbackClient.Models.JsonObject.Source<TContext> payload = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, eventId, eventType, timestamp, payload);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Schema1> Create<TContext>(
    ...
    public static ParsedJsonDocument<Schema1> Create(in EventSubscription.CallbackClient.Models.JsonString.Source eventId, in EventSubscription.CallbackClient.Models.JsonString.Source eventType, in EventSubscription.CallbackClient.Models.JsonDateTime.Source timestamp, in EventSubscription.CallbackClient.Models.JsonObject.Source payload = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Schema1> Create<TContext>(in TContext context, in EventSubscription.CallbackClient.Models.JsonString.Source eventId, in EventSubscription.CallbackClient.Models.JsonString.Source eventType, in EventSubscription.CallbackClient.Models.JsonDateTime.Source timestamp, in EventSubscription.CallbackClient.Models.JsonObject.Source<TContext> payload = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
