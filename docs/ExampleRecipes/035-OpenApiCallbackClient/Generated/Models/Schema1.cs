...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public EventSubscription.CallbackClient.Models.JsonString EventId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventIdUtf8, out EventSubscription.CallbackClient.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public EventSubscription.CallbackClient.Models.JsonString EventType
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventTypeUtf8, out EventSubscription.CallbackClient.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public EventSubscription.CallbackClient.Models.JsonObject Payload
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out EventSubscription.CallbackClient.Models.JsonObject value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public EventSubscription.CallbackClient.Models.JsonDateTime Timestamp
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimestampUtf8, out EventSubscription.CallbackClient.Models.JsonDateTime value))
            {
                return value;
            }
