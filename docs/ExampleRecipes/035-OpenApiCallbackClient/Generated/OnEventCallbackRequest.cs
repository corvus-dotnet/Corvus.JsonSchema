...
/// <summary>
/// Request type for the OnEventCallback operation.
/// </summary>
public readonly struct OnEventCallbackRequest : IApiRequest<OnEventCallbackRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "{$request.body#/callbackUrl}"u8;
