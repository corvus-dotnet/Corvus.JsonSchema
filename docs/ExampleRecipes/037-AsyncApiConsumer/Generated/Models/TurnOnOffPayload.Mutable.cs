...
public readonly partial struct TurnOnOffPayload
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TurnOnOffPayload instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TurnOnOffPayload"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TurnOnOffPayload(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Mutable Command
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CommandUtf8, out Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>sentAt</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TurnOnOffPayload(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCommand(scoped in Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source value)
        {
            CheckValidInstance();
        ...
        public void SetSentAt(scoped in Streetlights.Client.Models.JsonDateTime.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SentAtUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SentAtUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SentAt, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>sentAt</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveSentAt()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SentAtUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TurnOnOffPayload.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TurnOnOffPayload"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TurnOnOffPayload"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly TurnOnOffPayload Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TurnOnOffPayload>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TurnOnOffPayload"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly TurnOnOffPayload Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TurnOnOffPayload>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source _createArg1;
        ...
        internal Source(Streetlights.Client.Models.TurnOnOffPayload.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source arg1, scoped in Streetlights.Client.Models.JsonDateTime.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Streetlights.Client.Models.TurnOnOffPayload.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// Creates an instance of a <see cref="TurnOnOffPayload"/>.
        /// </summary>
        public void Create(in Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source command = default, in Streetlights.Client.Models.JsonDateTime.Source sentAt = default)
        {
            Create(ref _builder, command, sentAt);
        }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source command = default, scoped in Streetlights.Client.Models.JsonDateTime.Source sentAt = default)
    {
        return new Source(command, sentAt);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source command = default, in Streetlights.Client.Models.JsonDateTime.Source sentAt = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(command, sentAt);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<TurnOnOffPayload, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<TurnOnOffPayload> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<TurnOnOffPayload>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<TurnOnOffPayload> Create<TContext>(
    ...
    public static ParsedJsonDocument<TurnOnOffPayload> Create(in Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source command = default, in Streetlights.Client.Models.JsonDateTime.Source sentAt = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
