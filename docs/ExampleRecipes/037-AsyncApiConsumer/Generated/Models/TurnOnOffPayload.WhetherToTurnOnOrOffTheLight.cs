...
public readonly partial struct TurnOnOffPayload
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WhetherToTurnOnOrOffTheLight"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal WhetherToTurnOnOrOffTheLight(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static WhetherToTurnOnOrOffTheLight DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(WhetherToTurnOnOrOffTheLight value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in WhetherToTurnOnOrOffTheLight left, in WhetherToTurnOnOrOffTheLight right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in WhetherToTurnOnOrOffTheLight left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(WhetherToTurnOnOrOffTheLight instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WhetherToTurnOnOrOffTheLight(JsonElement instance)
        {
            return WhetherToTurnOnOrOffTheLight.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhetherToTurnOnOrOffTheLight From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhetherToTurnOnOrOffTheLight ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WhetherToTurnOnOrOffTheLight>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhetherToTurnOnOrOffTheLight ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WhetherToTurnOnOrOffTheLight>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhetherToTurnOnOrOffTheLight ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WhetherToTurnOnOrOffTheLight>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static WhetherToTurnOnOrOffTheLight ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WhetherToTurnOnOrOffTheLight>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out WhetherToTurnOnOrOffTheLight? result)
        {
            return JsonElementHelpers.TryParseValue<WhetherToTurnOnOrOffTheLight>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WhetherToTurnOnOrOffTheLight(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static WhetherToTurnOnOrOffTheLight IJsonElement<WhetherToTurnOnOrOffTheLight>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WhetherToTurnOnOrOffTheLight: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WhetherToTurnOnOrOffTheLight"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WhetherToTurnOnOrOffTheLight"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public WhetherToTurnOnOrOffTheLight Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WhetherToTurnOnOrOffTheLight>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WhetherToTurnOnOrOffTheLight"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public WhetherToTurnOnOrOffTheLight Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<WhetherToTurnOnOrOffTheLight>(_idx);
            }
