...
public readonly partial struct LightMeasuredPayload
{
    ...
    public readonly partial struct LightIntensityMeasuredInLumens
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LightIntensityMeasuredInLumens instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LightIntensityMeasuredInLumens"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LightIntensityMeasuredInLumens(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LightIntensityMeasuredInLumens(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LightIntensityMeasuredInLumens.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LightIntensityMeasuredInLumens"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LightIntensityMeasuredInLumens"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly LightIntensityMeasuredInLumens Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LightIntensityMeasuredInLumens>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LightIntensityMeasuredInLumens"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly LightIntensityMeasuredInLumens Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LightIntensityMeasuredInLumens>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LightIntensityMeasuredInLumens instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LightIntensityMeasuredInLumens, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LightIntensityMeasuredInLumens> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LightIntensityMeasuredInLumens>();
            }
            finally
            {
