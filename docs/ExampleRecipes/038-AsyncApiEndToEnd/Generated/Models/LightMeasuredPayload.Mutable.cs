...
public readonly partial struct LightMeasuredPayload
{
    ...
    public static ParsedJsonDocument<LightMeasuredPayload> Create(in Streetlights.Client.Models.LightMeasuredPayload.LightIntensityMeasuredInLumens.Source lumens = default, in Streetlights.Client.Models.JsonDateTime.Source sentAt = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
