    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchCommand(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext childContext =
                Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Streetlights.Client.Models.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            context.CommitChildContext(childContext.IsMatch, ref childContext);
        }

        private static void MatchSentAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
        ...
        /// </summary>
        public const string SchemaLocation = "/components/schemas/turnOnOffPayload";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/turnOnOffPayload"u8;
