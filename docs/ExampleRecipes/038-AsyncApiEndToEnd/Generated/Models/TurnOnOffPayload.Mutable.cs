...
public readonly partial struct TurnOnOffPayload
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Streetlights.Client.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Mutable Command
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CommandUtf8, out Streetlights.Client.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCommand(in Streetlights.Client.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Streetlights.Client.TurnOnOffPayload.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Streetlights.Client.TurnOnOffPayload.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Streetlights.Client.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source command = default,
        ...
        /// Creates an instance of a <see cref="TurnOnOffPayload"/>.
        /// </summary>
        public void Create(in Streetlights.Client.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source command = default, in Streetlights.Client.JsonDateTime.Source sentAt = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Streetlights.Client.TurnOnOffPayload.WhetherToTurnOnOrOffTheLight.Source command = default, in Streetlights.Client.JsonDateTime.Source sentAt = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
