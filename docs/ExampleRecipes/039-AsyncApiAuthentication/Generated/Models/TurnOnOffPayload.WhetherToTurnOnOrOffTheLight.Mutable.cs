...
public readonly partial struct TurnOnOffPayload
{
    public readonly partial struct WhetherToTurnOnOrOffTheLight
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WhetherToTurnOnOrOffTheLight instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WhetherToTurnOnOrOffTheLight"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WhetherToTurnOnOrOffTheLight(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WhetherToTurnOnOrOffTheLight.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly WhetherToTurnOnOrOffTheLight Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly WhetherToTurnOnOrOffTheLight Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WhetherToTurnOnOrOffTheLight>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(WhetherToTurnOnOrOffTheLight instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (WhetherToTurnOnOrOffTheLight)value;
        ...
        {
            return workspace.CreateBuilder<WhetherToTurnOnOrOffTheLight, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<WhetherToTurnOnOrOffTheLight> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WhetherToTurnOnOrOffTheLight>();
            }
            finally
            {
