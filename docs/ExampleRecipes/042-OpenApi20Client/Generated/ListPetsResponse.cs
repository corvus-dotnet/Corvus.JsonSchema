...
public struct ListPetsResponse : IApiResponse<ListPetsResponse>
{
    ...
    /// </summary>
    public Petstore.V2.Client.Models.Pets OkBody { get; private set; }
    ...
    /// </summary>
    private Petstore.V2.Client.Models.JsonString xNextHeaderValue;
    ...
    /// </summary>
    public Petstore.V2.Client.Models.JsonString XNextHeader
    {
        get
        {
            ...
            {
                this.xNextHeaderValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseString<Petstore.V2.Client.Models.JsonString>(rawValue, this.workspace);
            }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Petstore.V2.Client.Models.Pets>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Petstore.V2.Client.Models.Pets result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Petstore.V2.Client.Models.Pets, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Petstore.V2.Client.Models.Pets, TContext, TResult> matchOk,
