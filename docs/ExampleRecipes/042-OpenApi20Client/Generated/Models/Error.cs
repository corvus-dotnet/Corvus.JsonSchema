...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.V2.Client.Models.JsonInt32 Code
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out Petstore.V2.Client.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Petstore.V2.Client.Models.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Petstore.V2.Client.Models.JsonString value))
            {
                return value;
            }
