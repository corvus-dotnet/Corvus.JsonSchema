...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.V2.Client.Models.JsonString Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Petstore.V2.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Petstore.V2.Client.Models.JsonString Tag
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagUtf8, out Petstore.V2.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Tag"/>.
        /// </summary>
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Tag"/>.
        /// </summary>
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Tag"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Tag => [0x55, 0x00, 0x00, 0x00, 0x22, 0x74, 0x61, 0x67, 0x22];
    }
}
