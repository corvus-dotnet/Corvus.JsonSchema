...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Petstore.V2.Client.Models.JsonInt64 Id
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Petstore.V2.Client.Models.JsonInt64 value))
            {
                return value;
            }
