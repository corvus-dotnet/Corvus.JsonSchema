...
public readonly partial struct Pets
    : IJsonElement<Pets>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/Pets"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
        /// </summary>
        public const string SchemaLocation = "/definitions/Pets";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/Pets"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = Petstore.V2.Client.Models.Pet.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    Petstore.V2.Client.Models.Pet.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
