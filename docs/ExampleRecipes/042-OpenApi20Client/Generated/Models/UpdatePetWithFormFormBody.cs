...
public readonly partial struct UpdatePetWithFormFormBody
    ...
    : IJsonElement<UpdatePetWithFormFormBody>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdatePetWithFormFormBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal UpdatePetWithFormFormBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static UpdatePetWithFormFormBody DefaultInstance { get; }
    ...
    /// </summary>
    public Petstore.V2.Client.Models.UpdatePetWithFormFormBody.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Petstore.V2.Client.Models.UpdatePetWithFormFormBody.StatusEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in UpdatePetWithFormFormBody left, in UpdatePetWithFormFormBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in UpdatePetWithFormFormBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(UpdatePetWithFormFormBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator UpdatePetWithFormFormBody(JsonElement instance)
    {
        return UpdatePetWithFormFormBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UpdatePetWithFormFormBody From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UpdatePetWithFormFormBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UpdatePetWithFormFormBody>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UpdatePetWithFormFormBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UpdatePetWithFormFormBody>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UpdatePetWithFormFormBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UpdatePetWithFormFormBody>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static UpdatePetWithFormFormBody ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UpdatePetWithFormFormBody>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out UpdatePetWithFormFormBody? result)
    {
        return JsonElementHelpers.TryParseValue<UpdatePetWithFormFormBody>(ref reader, out result);
    }
...
#if NET
    static UpdatePetWithFormFormBody IJsonElement<UpdatePetWithFormFormBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"UpdatePetWithFormFormBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public UpdatePetWithFormFormBody Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public UpdatePetWithFormFormBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<UpdatePetWithFormFormBody>(_idx);
        }
