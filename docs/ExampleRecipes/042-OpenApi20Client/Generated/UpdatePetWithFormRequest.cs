...
/// <summary>
/// Request type for the UpdatePetWithForm operation.
/// </summary>
/// <remarks>Update a pet using form data</remarks>
public readonly struct UpdatePetWithFormRequest : IApiRequest<UpdatePetWithFormRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdatePetWithFormRequest"/> struct.
    /// </summary>
    /// <param name="petId">The petId parameter.</param>
    public UpdatePetWithFormRequest(Petstore.V2.Client.Models.JsonString petId)
    {
        this.PetId = petId;
    }
