...
/// <summary>
/// Response type for the UpdatePetWithForm operation.
/// </summary>
public struct UpdatePetWithFormResponse : IApiResponse<UpdatePetWithFormResponse>
{
    ...
    /// </summary>
    public Petstore.V2.Client.Models.Pet OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<UpdatePetWithFormResponse> CreateAsync(
        int statusCode,
    ...
    {
        UpdatePetWithFormResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Petstore.V2.Client.Models.Pet>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Petstore.V2.Client.Models.Pet result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Petstore.V2.Client.Models.Pet, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Petstore.V2.Client.Models.Pet, TContext, TResult> matchOk,
