...
public readonly partial struct PersonConstraints
{
    ...
    /// </summary>
    public JsonSchemaSample.Api.PersonConstraints.FamilyNameEntity FamilyName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new JsonSchemaSample.Api.PersonConstraints.FamilyNameEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<JsonSchemaSample.Api.PersonConstraints.FamilyNameEntity>();
                }
            }
    ...
    /// </summary>
    public JsonSchemaSample.Api.PersonConstraints.GivenNameEntity GivenName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new JsonSchemaSample.Api.PersonConstraints.GivenNameEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<JsonSchemaSample.Api.PersonConstraints.GivenNameEntity>();
                }
            }
    ...
    /// </summary>
    public JsonSchemaSample.Api.PersonConstraints.HeightEntity Height
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new JsonSchemaSample.Api.PersonConstraints.HeightEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<JsonSchemaSample.Api.PersonConstraints.HeightEntity>();
                }
            }
    ...
    /// </summary>
    public JsonSchemaSample.Api.PersonConstraints.OtherNamesEntity OtherNames
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new JsonSchemaSample.Api.PersonConstraints.OtherNamesEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<JsonSchemaSample.Api.PersonConstraints.OtherNamesEntity>();
                }
            }
    ...
    /// <summary>
    /// Creates an instance of a <see cref = "PersonConstraints"/>.
    /// </summary>
    public static PersonConstraints Create(Corvus.Json.JsonDate birthDate, JsonSchemaSample.Api.PersonConstraints.FamilyNameEntity familyName, JsonSchemaSample.Api.PersonConstraints.GivenNameEntity givenName, JsonSchemaSample.Api.PersonConstraints.HeightEntity? height = null, JsonSchemaSample.Api.PersonConstraints.OtherNamesEntity? otherNames = null)
    {
        ...
        if (height is JsonSchemaSample.Api.PersonConstraints.HeightEntity height__)
        {
            builder.Add(JsonPropertyNames.Height, height__.AsAny);
        }

        if (otherNames is JsonSchemaSample.Api.PersonConstraints.OtherNamesEntity otherNames__)
        {
    ...
    public PersonConstraints WithBirthDate(in Corvus.Json.JsonDate value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonConstraints WithFamilyName(in JsonSchemaSample.Api.PersonConstraints.FamilyNameEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonConstraints WithGivenName(in JsonSchemaSample.Api.PersonConstraints.GivenNameEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonConstraints WithHeight(in JsonSchemaSample.Api.PersonConstraints.HeightEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonConstraints WithOtherNames(in JsonSchemaSample.Api.PersonConstraints.OtherNamesEntity value)
    {
    ...
    {
        return property.ValueAs<JsonSchemaSample.Api.PersonConstraints.FamilyNameEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<JsonSchemaSample.Api.PersonConstraints.GivenNameEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<JsonSchemaSample.Api.PersonConstraints.OtherNamesEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<JsonSchemaSample.Api.PersonConstraints.HeightEntity>().Validate(validationContext, level);
    }
