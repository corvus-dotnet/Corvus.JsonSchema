...
/// A wealthy person
/// </summary>
public readonly partial struct PersonWealthy : IJsonObject<PersonWealthy>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "PersonWealthy"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public PersonWealthy(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator PersonWealthy(JsonObject value)
    {
    ...
    public static PersonWealthy FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static PersonWealthy FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static PersonWealthy FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public PersonWealthy SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public PersonWealthy RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public PersonWealthy RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public PersonWealthy RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public PersonWealthy RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
