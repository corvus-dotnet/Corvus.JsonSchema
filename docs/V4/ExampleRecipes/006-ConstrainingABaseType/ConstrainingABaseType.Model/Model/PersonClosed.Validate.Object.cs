    ...
    private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        foreach (JsonObjectProperty property in this.EnumerateObject())
        {
            if (__TryGetCorvusLocalPropertiesValidator(property, this.HasJsonElementBacking, out ObjectPropertyValidator? propertyValidator))
            {
                ...
                if ((this.HasJsonElementBacking && property.NameEquals(JsonPropertyNames.BirthDateUtf8)) || (!this.HasJsonElementBacking && property.NameEquals(JsonPropertyNames.BirthDate)))
                {
                    foundBirthDate = true;
                }
                else if ((this.HasJsonElementBacking && property.NameEquals(JsonPropertyNames.FamilyNameUtf8)) || (!this.HasJsonElementBacking && property.NameEquals(JsonPropertyNames.FamilyName)))
                {
        ...
        if (!foundBirthDate)
        {
            ...
            {
                result = result.WithResult(isValid: false, $"6.5.3. required - required property \"birthDate\" not present.");
            }
