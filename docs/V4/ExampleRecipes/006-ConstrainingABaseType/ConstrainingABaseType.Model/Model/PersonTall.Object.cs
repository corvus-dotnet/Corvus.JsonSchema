...
/// A tall person
/// </summary>
public readonly partial struct PersonTall : IJsonObject<PersonTall>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "PersonTall"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public PersonTall(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator PersonTall(JsonObject value)
    {
    ...
    public static PersonTall FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static PersonTall FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static PersonTall FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public PersonTall SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public PersonTall RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public PersonTall RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public PersonTall RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public PersonTall RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
