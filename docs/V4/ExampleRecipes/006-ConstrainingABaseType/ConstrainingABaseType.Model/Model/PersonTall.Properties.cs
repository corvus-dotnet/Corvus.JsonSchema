...
public readonly partial struct PersonTall
{
    ...
    /// </summary>
    public JsonSchemaSample.Api.PersonTall.HeightEntity Height
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new JsonSchemaSample.Api.PersonTall.HeightEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<JsonSchemaSample.Api.PersonTall.HeightEntity>();
                }
            }
    ...
    /// <summary>
    /// Creates an instance of a <see cref = "PersonTall"/>.
    /// </summary>
    public static PersonTall Create(Corvus.Json.JsonDate birthDate, JsonSchemaSample.Api.PersonClosed.ConstrainedString familyName, JsonSchemaSample.Api.PersonClosed.ConstrainedString givenName, JsonSchemaSample.Api.PersonTall.HeightEntity? height = null, JsonSchemaSample.Api.PersonClosed.ConstrainedString? otherNames = null)
    {
        ...
        if (height is JsonSchemaSample.Api.PersonTall.HeightEntity height__)
        {
    ...
    public PersonTall WithBirthDate(in Corvus.Json.JsonDate value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonTall WithFamilyName(in JsonSchemaSample.Api.PersonClosed.ConstrainedString value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonTall WithGivenName(in JsonSchemaSample.Api.PersonClosed.ConstrainedString value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonTall WithHeight(in JsonSchemaSample.Api.PersonTall.HeightEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonTall WithOtherNames(in JsonSchemaSample.Api.PersonClosed.ConstrainedString value)
    {
    ...
    {
        return property.ValueAs<JsonSchemaSample.Api.PersonTall.HeightEntity>().Validate(validationContext, level);
    }
    ...
    private bool __TryGetCorvusLocalPropertiesValidator(in JsonObjectProperty property, bool hasJsonElementBacking, [NotNullWhen(true)] out ObjectPropertyValidator? propertyValidator)
    {
        ...
        {
            if (property.NameEquals(JsonPropertyNames.HeightUtf8))
            {
        ...
        {
            if (property.NameEquals(JsonPropertyNames.Height))
            {
                propertyValidator = __CorvusValidateHeight;
                return true;
            }
