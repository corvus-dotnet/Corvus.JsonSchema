...
public readonly partial struct TensorRank3
{
    ...
    public readonly partial struct SecondRank
    {
        ...
        SecondRank IJsonArray<SecondRank>.Remove(in JsonAny item1)
        {
        ...
        public SecondRank Remove(in JsonSchemaSample.Api.TensorRank3.ThirdRank item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SecondRank RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SecondRank RemoveRange(int index, int count)
        {
