...
public readonly partial struct TensorRank3
{
    ...
    {
        /// <inheritdoc/>
        ThirdRank IJsonArray<ThirdRank>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        ThirdRank IJsonArray<ThirdRank>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        ...
        /// <inheritdoc/>
        public ThirdRank AddRange<TArray>(in TArray items)
        ...
        /// <inheritdoc/>
        ThirdRank IJsonArray<ThirdRank>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        ...
        /// <inheritdoc/>
        ThirdRank IJsonArray<ThirdRank>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.AddRange(items);
            return new(builder.ToImmutable());
        ...
        /// <inheritdoc/>
        ThirdRank IJsonArray<ThirdRank>.Insert(int index, in JsonAny item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }

        /// <inheritdoc/>
        public ThirdRank InsertRange<TArray>(int index, in TArray items)
            where TArray : struct, IJsonArray<TArray>
        {
        ...
        /// <inheritdoc/>
        ThirdRank IJsonArray<ThirdRank>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        ThirdRank IJsonArray<ThirdRank>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(this.GetImmutableListWith(index, items));
        }

        /// <inheritdoc/>
        ThirdRank IJsonArray<ThirdRank>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
        }

        /// <inheritdoc/>
        ThirdRank IJsonArray<ThirdRank>.SetItem(int index, in JsonAny value)
        {
        ...
        public ThirdRank Add(in Corvus.Json.JsonDouble item1)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.Add(item1);
            return new(builder.ToImmutable());
        ...
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public ThirdRank Add(params Corvus.Json.JsonDouble[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        ...
        /// <returns>An instance of the array with the items added.</returns>
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public ThirdRank AddRange(IEnumerable<Corvus.Json.JsonDouble> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            foreach (Corvus.Json.JsonDouble item in items)
            {
        ...
        /// <returns>An instance of the array with the item added.</returns>
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public ThirdRank Insert(int index, in Corvus.Json.JsonDouble item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }
        ...
        public ThirdRank InsertRange(int index, IEnumerable<Corvus.Json.JsonDouble> items)
        {
            return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
        }
        ...
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public ThirdRank Replace(in Corvus.Json.JsonDouble oldValue, in Corvus.Json.JsonDouble newValue)
        {
            return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
        }
        ...
        public ThirdRank SetItem(int index, in Corvus.Json.JsonDouble value)
        {
            return new(this.GetImmutableListSetting(index, value.AsAny));
        }
    }
