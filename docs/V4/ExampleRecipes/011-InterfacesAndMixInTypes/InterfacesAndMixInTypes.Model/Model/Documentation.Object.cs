...
/// </summary>
public readonly partial struct Documentation : IJsonObject<Documentation>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "Documentation"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public Documentation(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static Documentation FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static Documentation FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public Documentation SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public Documentation RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
