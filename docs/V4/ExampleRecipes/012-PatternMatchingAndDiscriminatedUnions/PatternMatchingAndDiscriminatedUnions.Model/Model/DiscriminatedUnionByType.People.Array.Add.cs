...
public readonly partial struct DiscriminatedUnionByType
{
    ...
    {
        /// <inheritdoc/>
        People IJsonArray<People>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        People IJsonArray<People>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        ...
        /// <inheritdoc/>
        public People AddRange<TArray>(in TArray items)
        ...
        /// <inheritdoc/>
        People IJsonArray<People>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        ...
        /// <inheritdoc/>
        People IJsonArray<People>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.AddRange(items);
            return new(builder.ToImmutable());
        ...
        /// <inheritdoc/>
        People IJsonArray<People>.Insert(int index, in JsonAny item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }

        /// <inheritdoc/>
        public People InsertRange<TArray>(int index, in TArray items)
            where TArray : struct, IJsonArray<TArray>
        {
        ...
        /// <inheritdoc/>
        People IJsonArray<People>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        People IJsonArray<People>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(this.GetImmutableListWith(index, items));
        }

        /// <inheritdoc/>
        People IJsonArray<People>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
        }

        /// <inheritdoc/>
        People IJsonArray<People>.SetItem(int index, in JsonAny value)
        {
        ...
        public People Add(in JsonSchemaSample.Api.PersonOpen item1)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.Add(item1);
            return new(builder.ToImmutable());
        ...
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public People Add(params JsonSchemaSample.Api.PersonOpen[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            foreach (JsonSchemaSample.Api.PersonOpen item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <returns>An instance of the array with the items added.</returns>
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public People AddRange(IEnumerable<JsonSchemaSample.Api.PersonOpen> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            foreach (JsonSchemaSample.Api.PersonOpen item in items)
            {
        ...
        /// <returns>An instance of the array with the item added.</returns>
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public People Insert(int index, in JsonSchemaSample.Api.PersonOpen item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }
        ...
        public People InsertRange(int index, IEnumerable<JsonSchemaSample.Api.PersonOpen> items)
        {
            return new(this.GetImmutableListWith(index, items.Select(item => item.AsAny)));
        }
        ...
        /// <exception cref = "InvalidOperationException">The value was not an array.</exception>
        public People Replace(in JsonSchemaSample.Api.PersonOpen oldValue, in JsonSchemaSample.Api.PersonOpen newValue)
        {
            return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
        }
        ...
        public People SetItem(int index, in JsonSchemaSample.Api.PersonOpen value)
        {
            return new(this.GetImmutableListSetting(index, value.AsAny));
        }
    }
