...
public readonly partial struct DiscriminatedUnionByType
{
    ...
    public readonly partial struct People
    {
        ...
        People IJsonArray<People>.Remove(in JsonAny item1)
        {
        ...
        public People Remove(in JsonSchemaSample.Api.PersonOpen item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public People RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public People RemoveRange(int index, int count)
        {
