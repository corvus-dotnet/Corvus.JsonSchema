...
[CollectionBuilder(typeof(People), "Create")]
public readonly partial struct People : IJsonArray<People>, IReadOnlyCollection<JsonSchemaSample.Api.PersonOpen>
#else
    public readonly partial struct People : IJsonArray<People>, IReadOnlyCollection<JsonSchemaSample.Api.PersonOpen>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly People EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "People"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public People(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public People(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<People>.this[int index]
        {
            get
            {
        ...
        public JsonSchemaSample.Api.PersonOpen this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonSchemaSample.Api.PersonOpen(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<JsonSchemaSample.Api.PersonOpen>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(People value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator People(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator People(JsonArray value)
        {
        ...
        public static People From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static People Create(ReadOnlySpan<JsonSchemaSample.Api.PersonOpen> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A People instantiated from the given items.</returns>
        public static People FromItems(in JsonSchemaSample.Api.PersonOpen value1)
        {
        ...
        /// <returns>A People instantiated from the given items.</returns>
        public static People FromItems(in JsonSchemaSample.Api.PersonOpen value1, in JsonSchemaSample.Api.PersonOpen value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A People instantiated from the given items.</returns>
        public static People FromItems(in JsonSchemaSample.Api.PersonOpen value1, in JsonSchemaSample.Api.PersonOpen value2, in JsonSchemaSample.Api.PersonOpen value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static People FromItems(params JsonSchemaSample.Api.PersonOpen[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (JsonSchemaSample.Api.PersonOpen item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static People FromRange(IEnumerable<JsonSchemaSample.Api.PersonOpen> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (JsonSchemaSample.Api.PersonOpen item in value)
            {
        ...
        /// </remarks>
        public static People From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new People(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static People FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static People FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<JsonSchemaSample.Api.PersonOpen> IEnumerable<JsonSchemaSample.Api.PersonOpen>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<JsonSchemaSample.Api.PersonOpen>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<JsonSchemaSample.Api.PersonOpen> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<JsonSchemaSample.Api.PersonOpen>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<JsonSchemaSample.Api.PersonOpen>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<People>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<People>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
