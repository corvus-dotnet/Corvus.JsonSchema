...
public readonly partial struct DiscriminatedUnionByType
{
    private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext oneOfResult0 = this.As<Corvus.Json.JsonString>().Validate(childContext0.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonInt32>().Validate(childContext1.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult2 = this.As<JsonSchemaSample.Api.PersonOpen>().Validate(childContext2.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult3 = this.As<JsonSchemaSample.Api.DiscriminatedUnionByType.People>().Validate(childContext3.CreateChildContext(), level);
