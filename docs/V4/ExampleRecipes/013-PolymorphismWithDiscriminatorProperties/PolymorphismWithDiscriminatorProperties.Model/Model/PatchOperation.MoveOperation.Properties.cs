...
public readonly partial struct PatchOperation
{
    ...
    public readonly partial struct MoveOperation
    {
        ...
        /// </summary>
        public JsonSchemaSample.Api.PatchOperation.MoveOperation.OpEntity Op
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new JsonSchemaSample.Api.PatchOperation.MoveOperation.OpEntity(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<JsonSchemaSample.Api.PatchOperation.MoveOperation.OpEntity>();
                    }
                }
        ...
        /// </summary>
        public static MoveOperation Create(Corvus.Json.JsonPointer fromValue, Corvus.Json.JsonPointer path)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();
            builder.Add(JsonPropertyNames.FromValue, fromValue.AsAny);
            builder.Add(JsonPropertyNames.Op, new JsonSchemaSample.Api.PatchOperation.MoveOperation.OpEntity().AsAny);
        ...
        public MoveOperation WithFromValue(in Corvus.Json.JsonPointer value)
        {
        ...
        {
            return property.ValueAs<JsonSchemaSample.Api.PatchOperation.MoveOperation.OpEntity>().Validate(validationContext, level);
        }
