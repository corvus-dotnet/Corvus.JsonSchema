...
public readonly partial struct PatchOperation
{
    ...
    public readonly partial struct ReplaceOperation
    {
        ...
        public static implicit operator JsonSchemaSample.Api.PatchOperation.PatchOperationCommon(ReplaceOperation value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static explicit operator ReplaceOperation(JsonSchemaSample.Api.PatchOperation.PatchOperationCommon value)
        {
