...
public readonly partial struct PatchOperation
{
    public readonly partial struct TestOperation
    {
        ...
        public readonly partial struct OpEntity
        {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "patch-operation.json#/$defs/TestOperation/properties/op";
            /// <summary>
            ...
            public static implicit operator OpEntity(in JsonAny value)
            {
            ...
            /// <param name = "value">The value from which to convert.</param>
            /// <exception cref = "InvalidOperationException">The value was not compatible with this type.</exception>
            public static implicit operator JsonAny(in OpEntity value)
            {
                return value.AsAny;
            }
    ...
    static OpEntity IJsonValue<OpEntity>.FromObject<TValue>(in TValue value)
    {
        ...
        return Undefined;
...
#endif
            /// <summary>
            /// Parses a JSON string into a OpEntity.
            /// </summary>
            /// <param name = "json">The json string to parse.</param>
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "OpEntity"/> instance built from the JSON string.</returns>
            public static OpEntity Parse(string json, JsonDocumentOptions options = default)
            {
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "OpEntity"/> instance built from the JSON string.</returns>
            public static OpEntity Parse(Stream utf8Json, JsonDocumentOptions options = default)
            {
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "OpEntity"/> instance built from the JSON string.</returns>
            public static OpEntity Parse(ReadOnlyMemory<byte> utf8Json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(utf8Json, options);
                return new OpEntity(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "OpEntity"/> instance built from the JSON string.</returns>
            public static OpEntity Parse(ReadOnlyMemory<char> json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(json, options);
                return new OpEntity(jsonDocument.RootElement.Clone());
            }
            ...
            /// <param name = "options">The (optional) JsonDocumentOptions.</param>
            /// <returns>A <see cref = "OpEntity"/> instance built from the JSON string.</returns>
            public static OpEntity Parse(ReadOnlySequence<byte> utf8Json, JsonDocumentOptions options = default)
            {
                using var jsonDocument = JsonDocument.Parse(utf8Json, options);
                return new OpEntity(jsonDocument.RootElement.Clone());
            }
...
#else
                return JsonValueHelpers.ParseValue<OpEntity>(buffer);
#endif
            }
...
#else
                return JsonValueHelpers.ParseValue<OpEntity>(ref reader);
#endif
            }
