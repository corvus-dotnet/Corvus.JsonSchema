...
public readonly partial struct PatchOperation
{
    private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
    {
        ...
        ValidationContext oneOfResult0 = this.As<JsonSchemaSample.Api.PatchOperation.AddOperation>().Validate(childContext0.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult1 = this.As<JsonSchemaSample.Api.PatchOperation.RemoveOperation>().Validate(childContext1.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult2 = this.As<JsonSchemaSample.Api.PatchOperation.ReplaceOperation>().Validate(childContext2.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult3 = this.As<JsonSchemaSample.Api.PatchOperation.MoveOperation>().Validate(childContext3.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult4 = this.As<JsonSchemaSample.Api.PatchOperation.CopyOperation>().Validate(childContext4.CreateChildContext(), level);
        ...
        ValidationContext oneOfResult5 = this.As<JsonSchemaSample.Api.PatchOperation.TestOperation>().Validate(childContext5.CreateChildContext(), level);
