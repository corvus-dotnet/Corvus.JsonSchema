...
/// </para>
/// </remarks>
public readonly partial struct CurrencyValue : IJsonObject<CurrencyValue>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "CurrencyValue"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public CurrencyValue(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator CurrencyValue(JsonObject value)
    {
    ...
    public static CurrencyValue FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static CurrencyValue FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static CurrencyValue FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public CurrencyValue SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public CurrencyValue RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public CurrencyValue RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public CurrencyValue RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public CurrencyValue RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
