...
public readonly partial struct PersonClosed
{
    ...
    /// </summary>
    public JsonSchemaSample.Api.PersonClosed.ConstrainedString FamilyName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new JsonSchemaSample.Api.PersonClosed.ConstrainedString(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<JsonSchemaSample.Api.PersonClosed.ConstrainedString>();
                }
            }
    ...
    /// </summary>
    public JsonSchemaSample.Api.PersonClosed.ConstrainedString GivenName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
    ...
    /// </summary>
    public JsonSchemaSample.Api.PersonClosed.HeightEntity Height
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new JsonSchemaSample.Api.PersonClosed.HeightEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<JsonSchemaSample.Api.PersonClosed.HeightEntity>();
                }
            }
    ...
    /// </summary>
    public JsonSchemaSample.Api.PersonClosed.ConstrainedString OtherNames
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
    ...
    /// <summary>
    /// Creates an instance of a <see cref = "PersonClosed"/>.
    /// </summary>
    public static PersonClosed Create(Corvus.Json.JsonDate birthDate, JsonSchemaSample.Api.PersonClosed.ConstrainedString familyName, JsonSchemaSample.Api.PersonClosed.ConstrainedString givenName, JsonSchemaSample.Api.PersonClosed.HeightEntity? height = null, JsonSchemaSample.Api.PersonClosed.ConstrainedString? otherNames = null)
    {
        ...
        if (height is JsonSchemaSample.Api.PersonClosed.HeightEntity height__)
        {
            builder.Add(JsonPropertyNames.Height, height__.AsAny);
        }

        if (otherNames is JsonSchemaSample.Api.PersonClosed.ConstrainedString otherNames__)
        {
    ...
    public PersonClosed WithBirthDate(in Corvus.Json.JsonDate value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonClosed WithFamilyName(in JsonSchemaSample.Api.PersonClosed.ConstrainedString value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonClosed WithGivenName(in JsonSchemaSample.Api.PersonClosed.ConstrainedString value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonClosed WithHeight(in JsonSchemaSample.Api.PersonClosed.HeightEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public PersonClosed WithOtherNames(in JsonSchemaSample.Api.PersonClosed.ConstrainedString value)
    {
    ...
    {
        return property.ValueAs<JsonSchemaSample.Api.PersonClosed.ConstrainedString>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<JsonSchemaSample.Api.PersonClosed.HeightEntity>().Validate(validationContext, level);
    }
