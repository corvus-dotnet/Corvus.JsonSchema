...
/// </summary>
public readonly partial struct ApiCustomer : IJsonObject<ApiCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "ApiCustomer"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public ApiCustomer(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator ApiCustomer(JsonObject value)
    {
    ...
    public static ApiCustomer FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static ApiCustomer FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static ApiCustomer FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public ApiCustomer SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public ApiCustomer RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public ApiCustomer RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public ApiCustomer RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public ApiCustomer RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
