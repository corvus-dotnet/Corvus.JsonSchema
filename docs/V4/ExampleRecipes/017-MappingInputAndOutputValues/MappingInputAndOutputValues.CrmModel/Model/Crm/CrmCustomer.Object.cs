...
/// </summary>
public readonly partial struct CrmCustomer : IJsonObject<CrmCustomer>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "CrmCustomer"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public CrmCustomer(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator CrmCustomer(JsonObject value)
    {
    ...
    public static CrmCustomer FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static CrmCustomer FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static CrmCustomer FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public CrmCustomer SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public CrmCustomer RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public CrmCustomer RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public CrmCustomer RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public CrmCustomer RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
