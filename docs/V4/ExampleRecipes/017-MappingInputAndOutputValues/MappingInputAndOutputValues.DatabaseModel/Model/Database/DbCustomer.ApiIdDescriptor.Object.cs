...
public readonly partial struct DbCustomer
{
    ...
    /// </summary>
    public readonly partial struct ApiIdDescriptor : IJsonObject<ApiIdDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ApiIdDescriptor"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ApiIdDescriptor(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator ApiIdDescriptor(JsonObject value)
        {
        ...
        public static ApiIdDescriptor FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ApiIdDescriptor FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ApiIdDescriptor FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ApiIdDescriptor SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ApiIdDescriptor RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ApiIdDescriptor RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ApiIdDescriptor RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ApiIdDescriptor RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
