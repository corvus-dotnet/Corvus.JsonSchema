...
public readonly partial struct DbCustomer
{
    ...
    /// </summary>
    public readonly partial struct CrmIdDescriptor : IJsonObject<CrmIdDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "CrmIdDescriptor"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public CrmIdDescriptor(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator CrmIdDescriptor(JsonObject value)
        {
        ...
        public static CrmIdDescriptor FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static CrmIdDescriptor FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static CrmIdDescriptor FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public CrmIdDescriptor SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public CrmIdDescriptor RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public CrmIdDescriptor RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public CrmIdDescriptor RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public CrmIdDescriptor RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
