...
public readonly partial struct DbCustomer
{
    ...
    /// </summary>
    public readonly partial struct GenericIdDescriptor : IJsonObject<GenericIdDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "GenericIdDescriptor"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public GenericIdDescriptor(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator GenericIdDescriptor(JsonObject value)
        {
        ...
        public static GenericIdDescriptor FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static GenericIdDescriptor FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static GenericIdDescriptor FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public GenericIdDescriptor SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public GenericIdDescriptor RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public GenericIdDescriptor RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public GenericIdDescriptor RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public GenericIdDescriptor RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
