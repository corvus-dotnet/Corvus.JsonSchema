...
public readonly partial struct DbCustomer
{
    ...
    /// </summary>
    public readonly partial struct IdDescriptor : IJsonObject<IdDescriptor>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "IdDescriptor"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public IdDescriptor(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator IdDescriptor(JsonObject value)
        {
        ...
        public static IdDescriptor FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static IdDescriptor FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static IdDescriptor FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public IdDescriptor SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public IdDescriptor RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public IdDescriptor RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public IdDescriptor RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public IdDescriptor RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
