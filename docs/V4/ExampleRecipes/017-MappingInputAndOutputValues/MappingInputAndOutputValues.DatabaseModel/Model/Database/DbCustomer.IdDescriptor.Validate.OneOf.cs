...
public readonly partial struct DbCustomer
{
    ...
    public readonly partial struct IdDescriptor
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<JsonSchemaSample.DatabaseApi.DbCustomer.ApiIdDescriptor>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<JsonSchemaSample.DatabaseApi.DbCustomer.CrmIdDescriptor>().Validate(childContext1.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult2 = this.As<JsonSchemaSample.DatabaseApi.DbCustomer.GenericIdDescriptor>().Validate(childContext2.CreateChildContext(), level);
