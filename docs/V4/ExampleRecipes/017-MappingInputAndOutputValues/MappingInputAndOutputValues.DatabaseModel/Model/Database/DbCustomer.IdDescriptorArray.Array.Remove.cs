...
public readonly partial struct DbCustomer
{
    ...
    /// </summary>
    public readonly partial struct IdDescriptorArray
    {
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        IdDescriptorArray IJsonArray<IdDescriptorArray>.Remove(in JsonAny item1)
        {
        ...
        public IdDescriptorArray Remove(in JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor item)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IdDescriptorArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IdDescriptorArray RemoveRange(int index, int count)
        {
