...
[CollectionBuilder(typeof(IdDescriptorArray), "Create")]
public readonly partial struct IdDescriptorArray : IJsonArray<IdDescriptorArray>, IReadOnlyCollection<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor>
#else
    public readonly partial struct IdDescriptorArray : IJsonArray<IdDescriptorArray>, IReadOnlyCollection<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor>
#endif
    {
        ...
        /// Gets an empty array.
        /// </summary>
        public static readonly IdDescriptorArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "IdDescriptorArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public IdDescriptorArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public IdDescriptorArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<IdDescriptorArray>.this[int index]
        {
            get
            {
        ...
        public JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(IdDescriptorArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator IdDescriptorArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator IdDescriptorArray(JsonArray value)
        {
        ...
        public static IdDescriptorArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        public static IdDescriptorArray Create(ReadOnlySpan<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor> items)
        {
            return new([..items]);
        }
        ...
        /// <returns>A IdDescriptorArray instantiated from the given items.</returns>
        public static IdDescriptorArray FromItems(in JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor value1)
        {
        ...
        /// <returns>A IdDescriptorArray instantiated from the given items.</returns>
        public static IdDescriptorArray FromItems(in JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor value1, in JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A IdDescriptorArray instantiated from the given items.</returns>
        public static IdDescriptorArray FromItems(in JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor value1, in JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor value2, in JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static IdDescriptorArray FromItems(params JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static IdDescriptorArray FromRange(IEnumerable<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor item in value)
            {
        ...
        /// </remarks>
        public static IdDescriptorArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new IdDescriptorArray(builder.ToImmutable());
        }
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static IdDescriptorArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "items">The items from which to create the array.</param>
        /// <returns>The new array created from the items.</returns>
        public static IdDescriptorArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        IEnumerator<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor> IEnumerable<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor>.GetEnumerator()
        {
        ...
        /// <inheritdoc/>
        int IReadOnlyCollection<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<JsonSchemaSample.DatabaseApi.DbCustomer.IdDescriptor>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<IdDescriptorArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<IdDescriptorArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
