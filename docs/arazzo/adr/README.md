...
| [0061](0061-azure-functions-serverless-target-native-aot-isolated-worker.md) | The Azure Functions serverless target is a Native-AOT isolated worker | Accepted |
