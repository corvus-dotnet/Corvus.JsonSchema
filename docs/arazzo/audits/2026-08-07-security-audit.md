...
> ADR 0067. Implementation begun: the read record is a kind of the audit chain, and the control plane's payload disclosures are on it (step journal, debug run trace, credential detail, checkpoint).
