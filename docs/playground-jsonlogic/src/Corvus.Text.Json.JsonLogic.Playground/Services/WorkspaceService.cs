...
/// Lazy-initialized: assemblies are only fetched when first needed (i.e. when the user
/// opens the Operators tab and triggers a compilation).
/// </summary>
public sealed class WorkspaceService
{
    ...
    [
        ...
        // Corvus runtime (what custom operators reference)
        "Corvus.Text.Json",
        "Corvus.Text.Json.JsonLogic",

        // Playground assembly (for CustomOperatorDefinition type)
        "Corvus.Text.Json.JsonLogic.Playground",
    ];

    /// <summary>
    /// Global usings prepended to every compilation.
    /// </summary>
    public const string GlobalUsings =
        ...
        global using Corvus.Text.Json.JsonLogic;
        global using Corvus.Text.Json.JsonLogic.Playground.Models;
        """;
    ...
    /// <summary>
    /// Creates a CSharpCompilation for the given user code that produces a class library.
    /// </summary>
    public CSharpCompilation CreateCompilation(string userCode)
    {
        ...
        var syntaxTrees = new List<SyntaxTree>
        {
            ...
            CSharpSyntaxTree.ParseText(userCode, parseOptions, path: "CustomOperators.cs"),
        };

        return CSharpCompilation.Create(
            $"CustomOperators_{Guid.NewGuid():N}",
            syntaxTrees,
            this.references,
