...
/// <summary>
/// Result of a TypeScript code generation operation.
/// </summary>
public class GenerationResult
{
    ...
    /// <summary>
    /// Gets or sets the generated code files (generated.ts + the shared corvus-runtime.ts).
    /// </summary>
    public IReadOnlyCollection<GeneratedCodeFile> GeneratedFiles { get; set; } = [];

    /// <summary>
    /// Gets or sets the generated TypeScript module source (generated.ts, with the evaluateRoot entry point).
    /// </summary>
    public string GeneratedTypeScript { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the shared runtime module source (corvus-runtime.ts) emitted alongside the module.
    /// </summary>
    public string RuntimeTypeScript { get; set; } = string.Empty;
