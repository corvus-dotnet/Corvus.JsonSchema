...
public class SchemaFile
{
    ...
    /// <summary>
    /// Gets or sets the explicit type name to use for this schema (overrides the derived name).
    /// </summary>
    ...
    /// </summary>
    public bool IsDirty => this.Content != this.CleanContent;

    /// <summary>
    /// Marks the current content as clean (e.g. after load or save).
    /// </summary>
    public void MarkClean() => this.CleanContent = this.Content;
