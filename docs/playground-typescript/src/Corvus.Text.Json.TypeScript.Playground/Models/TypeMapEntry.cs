...
/// </summary>
/// <param name="TypeName">Generated TypeScript type name (e.g. "Person").</param>
/// <param name="FullTypeName">Fully qualified type name (same as <paramref name="TypeName"/> for TS).</param>
...
/// <param name="MemberName">Generated TypeScript member name (e.g. "firstName").</param>
/// <param name="TypeName">Property type short name.</param>
/// <param name="FullTypeName">Property type fully qualified name.</param>
