...
/// <summary>
/// Loads JSON Schema metaschema documents from embedded resources into a document resolver. WASM-safe
/// (no file I/O) — all metaschemas are embedded in the assembly (see the csproj metaschema EmbeddedResource).
/// </summary>
