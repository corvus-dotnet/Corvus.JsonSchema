...
const bytes = Account.build({
  id: Id.as("6f9619ff-8b86-d011-b42d-00cf4fc964ff"),
  website: Website.as("https://example.com"),
  created: Created.as("2026-06-26T10:00:00Z"),
});
console.log("valid:    ", Account.evaluate(JSON.parse(dec.decode(bytes)))); // true
try { Id.as("nope"); } catch (e) { console.log("Id.as threw:", (e as Error).message); }
