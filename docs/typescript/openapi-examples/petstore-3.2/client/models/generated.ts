...
function evaluateSchema(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(__isObj(value))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1avatar/post/requestBody/content/multipart~1form-data/schema/type"); ok = false; }
  if (__isObj(value)) {
    const o = value as Record<string, unknown>;
    let i = -1;
    for (const k in o) {
...
function evaluateFile(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1avatar/post/requestBody/content/multipart~1form-data/schema/properties/file/type"); ok = false; }
  if (typeof value === "string" && !__fmt("binary", value)) { if (r === null) return false; r.fail(kl + "/format", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1avatar/post/requestBody/content/multipart~1form-data/schema/properties/file/format"); ok = false; }
  if (r !== null && r.verbose && ok) { r.annotate("format", "binary", kl + "/format", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1avatar/post/requestBody/content/multipart~1form-data/schema/properties/file/format"); }
  return ok;
}

function evaluateId2(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1avatar/post/requestBody/content/multipart~1form-data/schema/properties/id/type"); ok = false; }
  return ok;
}
...
function evaluateTags(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(Array.isArray(value))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1avatar/post/requestBody/content/multipart~1form-data/schema/properties/tags/type"); ok = false; }
...
function evaluateItems(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1avatar/post/requestBody/content/multipart~1form-data/schema/properties/tags/items/type"); ok = false; }
  return ok;
}

export type Schema2 = readonly PetUpdate[];
function evaluateSchema2(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(Array.isArray(value))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1batch/post/requestBody/content/multipart~1mixed/schema/type"); ok = false; }
  if (Array.isArray(value)) { for (let i = 0; i < value.length; i++) { if (!evaluatePetUpdate(value[i], NOEV, (r === null ? il : il + "/" + i), (r === null ? kl : kl + "/items/$ref"), r)) { if (r === null) return false; ok = false; } ev.markItem(i); } }
  return ok;
}
...
function patchSchema3(source: Uint8Array, changes: Partial<Schema3>, removals?: ReadonlyArray<"count" | "name" | "tags">, arrays?: Schema3ArrayOps): Uint8Array {
  const enc = new TextEncoder();
  const targets: RmwTarget[] = [];
...
export interface Schema3ArrayOps {
  readonly tags?: ListOps<string>;
}

function buildSchema3(props: Schema3): Uint8Array {
  return new TextEncoder().encode(JSON.stringify(props));
}

function buildCanonicalSchema3(props: Schema3): Uint8Array {
  return canonicalize(props);
}

function produceSchema3(source: Uint8Array, recipe: (draft: Draft<Schema3>) => void): Uint8Array {
  return produce<Schema3>(source, recipe);
}

function evaluateSchema3(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(__isObj(value))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1form/post/requestBody/content/application~1x-www-form-urlencoded/schema/type"); ok = false; }
  if (__isObj(value)) {
    const o = value as Record<string, unknown>;
    let i = -1;
    for (const k in o) {
...
function evaluateCount(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!((__isNum(value) && __isInt(String(value))))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1form/post/requestBody/content/application~1x-www-form-urlencoded/schema/properties/count/type"); ok = false; }
  return ok;
}

function evaluateName3(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1form/post/requestBody/content/application~1x-www-form-urlencoded/schema/properties/name/type"); ok = false; }
  return ok;
}
...
function evaluateTags2(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(Array.isArray(value))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1form/post/requestBody/content/application~1x-www-form-urlencoded/schema/properties/tags/type"); ok = false; }
...
function evaluateItems2(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1form/post/requestBody/content/application~1x-www-form-urlencoded/schema/properties/tags/items/type"); ok = false; }
  return ok;
}

export type Schema4 = Brand<string, "date-time">;
function fromSchema4(value: string): Schema4 { if (!__fmt("date-time", value)) { throw new FormatError("date-time"); } return value as Schema4; }
function schema4ToTemporal(value: Schema4): Temporal.Instant { return toInstant(value); }

function evaluateSchema4(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Expires-At/schema/type"); ok = false; }
  if (typeof value === "string" && !__fmt("date-time", value)) { if (r === null) return false; r.fail(kl + "/format", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Expires-At/schema/format"); ok = false; }
  if (r !== null && r.verbose && ok) { r.annotate("format", "date-time", kl + "/format", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Expires-At/schema/format"); }
  return ok;
}

function evaluateSchema5(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!((__isNum(value) && __isInt(String(value))))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Rate-Limit/schema/type"); ok = false; }
  return ok;
}

function evaluateSchema6(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Request-Id/schema/type"); ok = false; }
  return ok;
}
...
function evaluateSchema7(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(__isObj(value))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Scope/schema/type"); ok = false; }
  if (__isObj(value)) {
    const o = value as Record<string, unknown>;
    let i = -1;
    for (const k in o) {
...
function evaluateKind(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Scope/schema/properties/kind/type"); ok = false; }
  return ok;
}

function evaluateRegion(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Scope/schema/properties/region/type"); ok = false; }
  return ok;
}

export type Schema8 = readonly string[];
function evaluateSchema8(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(Array.isArray(value))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Tags/schema/type"); ok = false; }
...
function evaluateItems3(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1limits/get/responses/200/headers/X-Tags/schema/items/type"); ok = false; }
  return ok;
}

export type Schema9 = readonly Pet[];
function evaluateSchema9(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(Array.isArray(value))) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1pets/get/responses/200/content/application~1json/schema/type"); ok = false; }
...
function evaluateSchema10(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
  if (!(typeof value === "string")) { if (r === null) return false; r.fail(kl + "/type", il, "/home/mwa/src/Corvus.JsonSchema/.claude/worktrees/ts-codegen-design/docs/typescript/openapi-examples/petstore-3.2/openapi.json#/paths/~1pets~1{petId}/get/parameters/0/schema/type"); ok = false; }
  return ok;
}
...
export type Schema12 = readonly string[];
...
function patchSchema15(source: Uint8Array, changes: Partial<Schema15>, removals?: ReadonlyArray<"kind" | "region">): Uint8Array {
  const enc = new TextEncoder();
  const targets: RmwTarget[] = [];
  if (changes["kind"] !== undefined) { targets.push({ name: enc.encode("kind"), content: enc.encode(JSON.stringify(changes["kind"])), vbs: -1, vbe: -1 }); }
  if (changes["region"] !== undefined) { targets.push({ name: enc.encode("region"), content: enc.encode(JSON.stringify(changes["region"])), vbs: -1, vbe: -1 }); }
...
export type Schema17 = readonly string[];
...
function patchSchema18(source: Uint8Array, changes: Partial<Schema18>, removals?: ReadonlyArray<"max" | "min">): Uint8Array {
  const enc = new TextEncoder();
  const targets: RmwTarget[] = [];
...
export type Schema19 = readonly string[];
...
function patchSchema20(source: Uint8Array, changes: Partial<Schema20>, removals?: ReadonlyArray<"dir" | "sort">): Uint8Array {
  const enc = new TextEncoder();
  const targets: RmwTarget[] = [];
...
function buildSchema20(props: Schema20): Uint8Array {
  return new TextEncoder().encode(JSON.stringify(props));
}

function buildCanonicalSchema20(props: Schema20): Uint8Array {
  return canonicalize(props);
}

function produceSchema20(source: Uint8Array, recipe: (draft: Draft<Schema20>) => void): Uint8Array {
  return produce<Schema20>(source, recipe);
}
...
export type Schema22 = readonly string[];
function evaluateSchema22(value: unknown, ev: Ev, il: string = "", kl: string = "", r: Results | null = null): boolean {
  let ok = true;
...
export const Schema3 = {
  ...
  build: buildSchema3,
  buildCanonical: buildCanonicalSchema3,
  patch: patchSchema3,
  produce: produceSchema3,
  applyPatch: (doc: Uint8Array | Schema3, patch: JsonPatch): Uint8Array => canonicalize(applyPatch(doc instanceof Uint8Array ? decodeAndParse(doc) : doc, patch)),
  applyMergePatch: (doc: Uint8Array | Schema3, mergePatch: unknown): Uint8Array => canonicalize(applyMergePatch(doc instanceof Uint8Array ? decodeAndParse(doc) : doc, mergePatch)),
  createPatch: (source: Uint8Array | Schema3, target: Uint8Array | Schema3): JsonPatchOp[] => createPatch(source instanceof Uint8Array ? decodeAndParse(source) : source, target instanceof Uint8Array ? decodeAndParse(target) : target),
  createMergePatch: (source: Uint8Array | Schema3, target: Uint8Array | Schema3): unknown => createMergePatch(source instanceof Uint8Array ? decodeAndParse(source) : source, target instanceof Uint8Array ? decodeAndParse(target) : target),
};
export const Count = {
...
export const Schema4 = {
  ...
  parse: (v: Uint8Array | string): Schema4 => (v instanceof Uint8Array ? decodeAndParse(v) : JSON.parse(v)) as Schema4,
  from: fromSchema4,
  toTemporal: schema4ToTemporal,
};
...
export const Schema20 = {
  ...
  parse: (v: Uint8Array | string): Schema20 => (v instanceof Uint8Array ? decodeAndParse(v) : JSON.parse(v)) as Schema20,
  build: buildSchema20,
  buildCanonical: buildCanonicalSchema20,
  patch: patchSchema20,
  produce: produceSchema20,
  applyPatch: (doc: Uint8Array | Schema20, patch: JsonPatch): Uint8Array => canonicalize(applyPatch(doc instanceof Uint8Array ? decodeAndParse(doc) : doc, patch)),
  applyMergePatch: (doc: Uint8Array | Schema20, mergePatch: unknown): Uint8Array => canonicalize(applyMergePatch(doc instanceof Uint8Array ? decodeAndParse(doc) : doc, mergePatch)),
  createPatch: (source: Uint8Array | Schema20, target: Uint8Array | Schema20): JsonPatchOp[] => createPatch(source instanceof Uint8Array ? decodeAndParse(source) : source, target instanceof Uint8Array ? decodeAndParse(target) : target),
  createMergePatch: (source: Uint8Array | Schema20, target: Uint8Array | Schema20): unknown => createMergePatch(source instanceof Uint8Array ? decodeAndParse(source) : source, target instanceof Uint8Array ? decodeAndParse(target) : target),
};
export const Dir = {
...
export const Schema22 = {
  evaluate: (v: unknown, results?: Results): boolean => evaluateSchema22(v instanceof Uint8Array ? decodeAndParse(v) : v, fresh(), "", "", results ?? null),
  parse: (v: Uint8Array | string): Schema22 => (v instanceof Uint8Array ? decodeAndParse(v) : JSON.parse(v)) as Schema22,
};
export const Items8 = {
