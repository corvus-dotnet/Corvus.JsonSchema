...
function patchSchema12(source: Uint8Array, changes: Partial<Schema12>, removals?: ReadonlyArray<"kind" | "region">): Uint8Array {
  const enc = new TextEncoder();
  const targets: RmwTarget[] = [];
...
function patchSchema15(source: Uint8Array, changes: Partial<Schema15>, removals?: ReadonlyArray<"max" | "min">): Uint8Array {
  const enc = new TextEncoder();
  const targets: RmwTarget[] = [];
...
function patchSchema17(source: Uint8Array, changes: Partial<Schema17>, removals?: ReadonlyArray<"dir" | "sort">): Uint8Array {
  const enc = new TextEncoder();
  const targets: RmwTarget[] = [];
