...
(function () {
  ...
  async function ensureIndex() {
    ...
    try {
      ...
      var searchUrl = '/Corvus.JsonSchema/pr-preview/pr-786/search-index.json';
      var loc = window.location.pathname;
      if (loc.indexOf('/Corvus.JsonSchema/pr-preview/pr-786/api/v5/') === 0) searchUrl = '/Corvus.JsonSchema/pr-preview/pr-786/api/v5/search-index.json';
      else if (loc.indexOf('/Corvus.JsonSchema/pr-preview/pr-786/api/v4/') === 0) searchUrl = '/Corvus.JsonSchema/pr-preview/pr-786/api/v4/search-index.json';
      ...
      apiEntries = data
        ...
        .filter(function (d) { return d.url && d.url.startsWith('/Corvus.JsonSchema/pr-preview/pr-786/api/'); });
    } catch (e) {
