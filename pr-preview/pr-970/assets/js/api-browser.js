...
(function () {
  ...
  async function ensureIndex() {
    ...
    try {
      ...
      if (!searchIndexUrl) searchIndexUrl = '/Corvus.JsonSchema/pr-preview/pr-970/search-index.json';
      ...
      apiEntries = data
        ...
        .filter(function (d) { return d.url && d.url.startsWith('/Corvus.JsonSchema/pr-preview/pr-970/api/'); });
    } catch (e) {
