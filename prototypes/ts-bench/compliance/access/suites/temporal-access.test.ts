...
import { AtTime, Day, OccurredAt, Span } from "./out-temporal/generated.js";
...
const d = Day.toTemporal(Day.from("2020-01-02"));
...
const inst = OccurredAt.toTemporal(OccurredAt.from("2020-01-02T03:04:05Z"));
...
const t = AtTime.toTemporal(AtTime.from("13:14:15+02:00"));
...
const tz = AtTime.toTemporal(AtTime.from("13:14:15Z"));
...
const dur = Span.toTemporal(Span.from("P1Y2M3DT4H5M6S"));
