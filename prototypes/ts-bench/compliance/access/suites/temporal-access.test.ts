...
const d = Day.asTemporal(Day.as("2020-01-02"));
...
const inst = OccurredAt.asTemporal(OccurredAt.as("2020-01-02T03:04:05Z"));
...
const t = AtTime.asTemporal(AtTime.as("13:14:15+02:00"));
...
const tz = AtTime.asTemporal(AtTime.as("13:14:15Z"));
...
const dur = Span.asTemporal(Span.as("P1Y2M3DT4H5M6S"));
