...
public static class ApiEndpointRegistration
{
    ...
    public static IEndpointRouteBuilder MapApiEndpoints(this IEndpointRouteBuilder app, IApiDefaultHandler defaultHandler, ConfigureEndpoint? configureEndpoint)
    {
        ...
        IEndpointConventionBuilder __LoadLedgerEndpoint = app.MapGet("/ledger", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {

                LoadLedgerParams parameters = new();

                LoadLedgerResult result = await defaultHandler.HandleLoadLedgerAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                methodName: "LoadLedger",
                httpMethod: "GET",
                routeTemplate: "/ledger",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
            __LoadLedgerEndpoint);

        IEndpointConventionBuilder __FetchTransactionsEndpoint = app.MapGet("/transactions", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {

                FetchTransactionsParams parameters = new();

                FetchTransactionsResult result = await defaultHandler.HandleFetchTransactionsAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
            __FetchTransactionsEndpoint);

        IEndpointConventionBuilder __MatchEntriesEndpoint = app.MapPost("/match", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {

                MatchEntriesParams parameters = new();

                MatchEntriesResult result = await defaultHandler.HandleMatchEntriesAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                methodName: "MatchEntries",
                httpMethod: "POST",
                routeTemplate: "/match",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
            __MatchEntriesEndpoint);

        IEndpointConventionBuilder __FlagDiscrepanciesEndpoint = app.MapPost("/discrepancies", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {

                FlagDiscrepanciesParams parameters = new();

                FlagDiscrepanciesResult result = await defaultHandler.HandleFlagDiscrepanciesAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                methodName: "FlagDiscrepancies",
                httpMethod: "POST",
                routeTemplate: "/discrepancies",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
            __FlagDiscrepanciesEndpoint);

        IEndpointConventionBuilder __PostCorrectionsEndpoint = app.MapPost("/corrections", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {

                PostCorrectionsParams parameters = new();

                PostCorrectionsResult result = await defaultHandler.HandlePostCorrectionsAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                methodName: "PostCorrections",
                httpMethod: "POST",
                routeTemplate: "/corrections",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
            __PostCorrectionsEndpoint);

        IEndpointConventionBuilder __PublishReportEndpoint = app.MapPost("/report", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {

                PublishReportParams parameters = new();

                PublishReportResult result = await defaultHandler.HandlePublishReportAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                httpMethod: "POST",
                routeTemplate: "/report",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
            __PublishReportEndpoint);
