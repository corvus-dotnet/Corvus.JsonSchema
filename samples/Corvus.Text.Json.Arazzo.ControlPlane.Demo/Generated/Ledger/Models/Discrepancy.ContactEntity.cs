...
public readonly partial struct Discrepancy
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonEmail Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonEmail value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonUri Runbook
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RunbookUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonUri value))
                {
                    return value;
                }
