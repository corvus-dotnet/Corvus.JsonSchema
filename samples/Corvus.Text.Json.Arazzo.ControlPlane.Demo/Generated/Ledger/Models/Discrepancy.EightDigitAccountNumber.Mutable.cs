...
public readonly partial struct Discrepancy
{
    ...
    public readonly partial struct EightDigitAccountNumber
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EightDigitAccountNumber instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EightDigitAccountNumber"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EightDigitAccountNumber(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EightDigitAccountNumber.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EightDigitAccountNumber Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EightDigitAccountNumber Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EightDigitAccountNumber>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EightDigitAccountNumber instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EightDigitAccountNumber, Mutable>(this);
        }
    }
}
