                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        switch (arrayValidation_itemCount)
                        {
                            case 0:
                            {
                                JsonSchemaContext childContext = Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.JsonSchema.PushChildContext(
                                    parentDocument,
                                ...
                                Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
                            ...
                            case 1:
                            {
                                JsonSchemaContext childContext1 = Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.JsonSchema.PushChildContext(
                                    parentDocument,
                                    arrayValidation_currentIndex,
                                    ref context,
                                    itemIndex: arrayValidation_itemCount,
                                ...
                                Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext1);
