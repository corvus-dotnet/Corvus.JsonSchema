    ...
    : IJsonElement<GetLedgerOk>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchEntries(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
