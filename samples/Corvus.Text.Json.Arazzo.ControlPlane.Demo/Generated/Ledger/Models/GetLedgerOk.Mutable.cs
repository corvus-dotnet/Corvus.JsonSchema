...
public readonly partial struct GetLedgerOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetLedgerOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetLedgerOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetLedgerOk(Mutable instance)
        {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable Entries
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntriesUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetLedgerOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetEntries(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetLedgerOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetLedgerOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetLedgerOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetLedgerOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetLedgerOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetLedgerOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetLedgerOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetLedgerOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.GetLedgerOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetLedgerOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.GetLedgerOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetLedgerOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source entries = default)
        {
        ...
        /// Creates an instance of a <see cref="GetLedgerOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source entries = default)
        {
            Create(ref _builder, entries);
        }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source entries = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source entries = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetLedgerOk, Mutable>(this);
    }
}
