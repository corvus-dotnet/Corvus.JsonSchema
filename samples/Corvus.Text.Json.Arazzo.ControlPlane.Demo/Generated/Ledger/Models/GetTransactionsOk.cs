...
#endif
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger Count
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger value))
            {
                return value;
            }
