    ...
    : IJsonElement<PostCorrectionsOk>
{
    ...
    {
        private static readonly JsonSchemaPathProvider PostedSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/posted"u8, buffer, out written);

        private static void MatchPosted(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.PostedUtf8,
                    evaluationPath: PostedSchemaEvaluationPath);
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.PostedUtf8))
            {
                matcher = MatchPosted;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1corrections/post/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1corrections/post/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1corrections/post/responses/200/content/application~1json/schema"u8;
