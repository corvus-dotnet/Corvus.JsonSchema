...
public readonly partial struct PostMatchOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostMatchOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostMatchOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostMatchOk(Mutable instance)
        {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable Matched
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MatchedUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable Unmatched
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UnmatchedUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMatched(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MatchedUtf8);
        ...
        /// <summary>
        /// Remove the <c>matched</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveMatched()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MatchedUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUnmatched(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UnmatchedUtf8);
                _documentVersion = _parent.Version;
                return;
            }
        ...
        /// <summary>
        /// Remove the <c>unmatched</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveUnmatched()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UnmatchedUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostMatchOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostMatchOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostMatchOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostMatchOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.PostMatchOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(PostMatchOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.PostMatchOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostMatchOk"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source matched = default,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source unmatched = default)
        {
        ...
        /// Creates an instance of a <see cref="PostMatchOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source matched = default, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source unmatched = default)
        {
            Create(ref _builder, matched, unmatched);
        }
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source matched = default, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source unmatched = default)
    {
        return new Source(matched, unmatched);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source matched = default, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source unmatched = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(matched, unmatched);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostMatchOk, Mutable>(this);
    }
}
