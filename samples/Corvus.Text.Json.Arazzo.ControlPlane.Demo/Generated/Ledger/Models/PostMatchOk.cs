...
#endif
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger Matched
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MatchedUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger Unmatched
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UnmatchedUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger value))
            {
                return value;
            }
