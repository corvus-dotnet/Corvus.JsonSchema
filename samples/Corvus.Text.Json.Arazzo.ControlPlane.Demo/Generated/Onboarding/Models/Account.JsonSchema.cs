    ...
    : IJsonElement<Account>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchAccountId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        [NotNullWhen(true)]
#endif
        out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
            if (span.SequenceEqual(JsonPropertyNames.AccountIdUtf8))
            {
                matcher = MatchAccountId;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/Account"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/Account";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/Account"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
