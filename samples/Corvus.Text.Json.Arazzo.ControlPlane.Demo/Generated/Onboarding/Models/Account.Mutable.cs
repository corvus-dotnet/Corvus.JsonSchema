...
public readonly partial struct Account
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Account instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Account"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Account(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Mutable AccountId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccountIdUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Account(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetAccountId(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Account.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Account"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Account"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Account Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Account>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Account"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Account Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Account>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Account.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(Account instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Account.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Account"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Source accountId)
        {
        ...
        /// Creates an instance of a <see cref="Account"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Source accountId)
        {
            Create(ref _builder, accountId);
        }
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Source accountId)
    {
        return new Source(accountId);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUuid.Source accountId, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(accountId);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<Account, Mutable>(this);
    }
}
