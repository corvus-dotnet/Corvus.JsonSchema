...
public readonly partial struct Applicant
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Applicant instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Applicant"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Applicant(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Iso31661Alpha2.Mutable Country
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountryUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Iso31661Alpha2.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Mutable DateOfBirth
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateOfBirthUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Mutable Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.FullNameEntity.Mutable FullName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FullNameUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.FullNameEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Set the <c>country</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCountry(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Iso31661Alpha2.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CountryUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountryUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Country, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>country</c> property, if present.
        /// </summary>
        ...
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CountryUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDateOfBirth(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DateOfBirthUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateOfBirthUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DateOfBirth, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>dateOfBirth</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveDateOfBirth()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DateOfBirthUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEmail(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>fullName</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFullName(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.FullNameEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("fullName");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FullNameUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FullName, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Applicant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Applicant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Applicant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Applicant Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Applicant"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Applicant Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Applicant>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.FullNameEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Iso31661Alpha2.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Source _createArg4;
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.FullNameEntity.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Iso31661Alpha2.Source arg2, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source arg3, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(Applicant instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Applicant"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.FullNameEntity.Source fullName,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Iso31661Alpha2.Source country = default,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source dateOfBirth = default,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Source email = default)
        {
            fullName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FullName, ref builder);
            country.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Country, ref builder);
            dateOfBirth.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DateOfBirth, ref builder);
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Source email = default)
        {
            Create(ref _builder, fullName, country, dateOfBirth, email);
        }
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.FullNameEntity.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Iso31661Alpha2.Source arg2, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source arg3, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="fullName">The value of the <c>"fullName"</c> property.</param>
    /// <param name="country">The value of the <c>"country"</c> property.</param>
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.FullNameEntity.Source fullName, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Iso31661Alpha2.Source country = default, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source dateOfBirth = default, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Source email = default)
    {
        return new Source(fullName, country, dateOfBirth, email);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="fullName">The value of the property.</param>
    /// <param name="country">The value of the property.</param>
    /// <param name="dateOfBirth">The value of the property.</param>
    /// <param name="email">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.FullNameEntity.Source fullName, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Applicant.Iso31661Alpha2.Source country = default, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source dateOfBirth = default, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonIdnEmail.Source email = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(fullName, country, dateOfBirth, email);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<Applicant, Mutable>(this);
    }
}
