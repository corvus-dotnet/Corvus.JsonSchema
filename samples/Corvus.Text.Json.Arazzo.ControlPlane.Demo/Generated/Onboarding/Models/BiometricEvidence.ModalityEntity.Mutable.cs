...
public readonly partial struct BiometricEvidence
{
    ...
    public readonly partial struct ModalityEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ModalityEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ModalityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ModalityEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ModalityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ModalityEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ModalityEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ModalityEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ModalityEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ModalityEntity, Mutable>(this);
        }
    }
}
