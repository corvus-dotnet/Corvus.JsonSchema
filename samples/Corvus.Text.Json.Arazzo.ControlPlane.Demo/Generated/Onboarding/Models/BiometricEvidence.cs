...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity Confidence
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfidenceUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.KindEntity Kind
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.KindEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity Modality
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModalityUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity value))
            {
                return value;
            }
