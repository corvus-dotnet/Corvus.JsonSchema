...
public readonly partial struct IdentityRequest
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Mutable DocumentNumber
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentNumberUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Mutable FullName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FullNameUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDocumentNumber(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFullName(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Source fullName,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Source documentNumber = default)
        {
        ...
        /// Creates an instance of a <see cref="IdentityRequest"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Source fullName, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Source documentNumber = default)
        {
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Source fullName, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Source documentNumber = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity.Source fullName, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity.Source documentNumber = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
