...
public readonly partial struct JsonUuid
{
...
#endif
    {
        ...
        public static implicit operator Guid(Mutable value) => value._parent.TryGetValue(value._idx, out Guid result) ? result : throw new FormatException();
        ...
        public static explicit operator Mutable(JsonUuid instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonUuid"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonUuid(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonUuid.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUuid Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUuid Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonUuid>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private Source(Guid value) { SimpleTypesBacking.Initialize(ref _simpleTypeBacking, value, static (v, buffer, out written) => Utf8Formatter.TryFormat(v, buffer, out written)); _kind = Kind.StringSimpleType; }

        public static implicit operator Source(JsonUuid instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Guid value) => new (value);
    ...
    {
        return workspace.CreateBuilder<JsonUuid, Mutable>(this);
    }
}
