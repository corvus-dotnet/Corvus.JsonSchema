...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.KnowledgeEvidence.KindEntity Kind
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.KnowledgeEvidence.KindEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity QuestionsPassed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuestionsPassedUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity value))
            {
                return value;
            }
