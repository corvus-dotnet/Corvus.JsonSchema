...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Provisioning"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal Provisioning(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static Provisioning DefaultInstance { get; }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUri AccountUrl
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccountUrlUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonUri value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Provisioning.QuotaGbEntity QuotaGb
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuotaGbUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Provisioning.QuotaGbEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Provisioning.ResourceArray Resources
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResourcesUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Provisioning.ResourceArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Provisioning.ArbitraryResourceTagsKeyValue Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.Provisioning.ArbitraryResourceTagsKeyValue value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in Provisioning left, in Provisioning right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in Provisioning left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(Provisioning instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Provisioning(JsonElement instance)
    {
        return Provisioning.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Provisioning From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Provisioning ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<Provisioning>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Provisioning ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<Provisioning>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Provisioning ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<Provisioning>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static Provisioning ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<Provisioning>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out Provisioning? result)
    {
        return JsonElementHelpers.TryParseValue<Provisioning>(ref reader, out result);
    }
...
#if NET
    static Provisioning IJsonElement<Provisioning>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"Provisioning: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="AccountUrl"/>.
        /// </summary>
        public const string AccountUrl = "accountUrl";

        /// <summary>
        /// Gets the JSON property name for <see cref="QuotaGb"/>.
        /// </summary>
        public const string QuotaGb = "quotaGb";
        ...
        /// Gets the JSON property name for <see cref="AccountUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AccountUrlUtf8 => "accountUrl"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="QuotaGb"/>.
        /// </summary>
        public static ReadOnlySpan<byte> QuotaGbUtf8 => "quotaGb"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="AccountUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AccountUrl => "accountUrl"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="QuotaGb"/>.
        /// </summary>
        public static ReadOnlySpan<byte> QuotaGb => "quotaGb"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="AccountUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AccountUrl => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x63, 0x63, 0x6F, 0x75, 0x6E, 0x74, 0x55, 0x72, 0x6C, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="QuotaGb"/>.
        /// </summary>
        public static ReadOnlySpan<byte> QuotaGb => [0x95, 0x00, 0x00, 0x00, 0x22, 0x71, 0x75, 0x6F, 0x74, 0x61, 0x47, 0x62, 0x22];
