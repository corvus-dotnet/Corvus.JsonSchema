...
public readonly partial struct DiscrepancyReport
{
    ...
    public readonly partial struct TheFromToTransactionSequenceNumbersScanned
    {
...
#endif
        {
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.Mutable Item1
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.Mutable>(_idx, 0);
                }
            }
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.Mutable Item2
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.Mutable>(_idx, 1);
                }
            }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            public void CreateTuple(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.Source item1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.Source item2)
            {
