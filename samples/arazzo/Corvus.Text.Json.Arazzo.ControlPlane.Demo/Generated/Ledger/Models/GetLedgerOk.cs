...
#endif
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger Entries
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntriesUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger value))
            {
                return value;
            }
