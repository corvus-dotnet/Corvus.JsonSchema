...
public readonly partial struct GetTransactionsOk
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable Count
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCount(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.GetTransactionsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.GetTransactionsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source count = default)
        {
        ...
        /// Creates an instance of a <see cref="GetTransactionsOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source count = default)
        {
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source count = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source count = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
