...
public readonly partial struct PostCorrectionsOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostCorrectionsOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostCorrectionsOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostCorrectionsOk(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>posted</c> property.
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable Posted
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PostedUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostCorrectionsOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>posted</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPosted(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PostedUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PostedUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Posted, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>posted</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemovePosted()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PostedUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostCorrectionsOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostCorrectionsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostCorrectionsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostCorrectionsOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostCorrectionsOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostCorrectionsOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostCorrectionsOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostCorrectionsOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.PostCorrectionsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(PostCorrectionsOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.PostCorrectionsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostCorrectionsOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source posted = default)
        {
            posted.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Posted, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="PostCorrectionsOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source posted = default)
        {
            Create(ref _builder, posted);
        }
    ...
    /// </summary>
    /// <param name="posted">The value of the <c>"posted"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source posted = default)
    {
        return new Source(posted);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="posted">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger.Source posted = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PostCorrectionsOk, Mutable>(this);
    }
}
