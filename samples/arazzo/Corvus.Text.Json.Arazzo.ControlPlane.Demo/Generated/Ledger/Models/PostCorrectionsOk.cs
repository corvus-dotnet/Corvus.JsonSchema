...
#endif
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger Posted
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PostedUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonInteger value))
            {
                return value;
            }
