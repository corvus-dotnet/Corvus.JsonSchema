...
public readonly partial struct PostReportOk
{
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonUri.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.PostReportOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonUri.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.PostReportOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonUri.Source reportUrl = default)
        {
        ...
        /// Creates an instance of a <see cref="PostReportOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonUri.Source reportUrl = default)
        {
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonUri.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonUri.Source reportUrl = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Ledger.Models.JsonUri.Source reportUrl = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
