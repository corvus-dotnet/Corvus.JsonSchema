...
public readonly partial struct BiometricEvidence
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BiometricEvidence instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BiometricEvidence"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BiometricEvidence(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>confidence</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Mutable Confidence
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfidenceUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.KindEntity.Mutable Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.KindEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>modality</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Mutable Modality
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModalityUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BiometricEvidence(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>confidence</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetConfidence(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("confidence");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfidenceUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Confidence, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetKind(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.KindEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>modality</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetModality(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("modality");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModalityUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Modality, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BiometricEvidence.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BiometricEvidence"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BiometricEvidence"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly BiometricEvidence Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BiometricEvidence>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BiometricEvidence"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly BiometricEvidence Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BiometricEvidence>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(BiometricEvidence instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="BiometricEvidence"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source confidence,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Source modality)
        {
            confidence.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Confidence, ref builder);
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Kind, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.KindEntity.ConstInstance);
            modality.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Modality, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="BiometricEvidence"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source confidence, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Source modality)
        {
            Create(ref _builder, confidence, modality);
        }
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="confidence">The value of the <c>"confidence"</c> property.</param>
    /// <param name="modality">The value of the <c>"modality"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source confidence, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Source modality)
    {
        return new Source(confidence, modality);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="confidence">The value of the property.</param>
    /// <param name="modality">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source confidence, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.BiometricEvidence.ModalityEntity.Source modality, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(confidence, modality);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<BiometricEvidence, Mutable>(this);
    }
}
