...
public readonly partial struct DocumentEvidence
{
    ...
    public readonly partial struct DocumentTypeEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DocumentTypeEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DocumentTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DocumentTypeEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DocumentTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DocumentTypeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DocumentTypeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DocumentTypeEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DocumentTypeEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DocumentTypeEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DocumentTypeEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DocumentTypeEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DocumentTypeEntity, Mutable>(this);
        }
    }
}
