...
public readonly partial struct DocumentEvidence
{
...
#endif
    {
        ...
        public static explicit operator Mutable(DocumentEvidence instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="DocumentEvidence"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DocumentEvidence(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>documentNumber</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentNumberEntity.Mutable DocumentNumber
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentNumberUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentNumberEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>documentType</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentTypeEntity.Mutable DocumentType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentTypeUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentTypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Mutable Expiry
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpiryUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.KindEntity.Mutable Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.KindEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DocumentEvidence(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>documentNumber</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDocumentNumber(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentNumberEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("documentNumber");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentNumberUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DocumentNumber, ref cvb);
        ...
        /// <summary>
        /// Set the <c>documentType</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDocumentType(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentTypeEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("documentType");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentTypeUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DocumentType, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetExpiry(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetKind(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.KindEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DocumentEvidence.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DocumentEvidence"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DocumentEvidence"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly DocumentEvidence Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DocumentEvidence>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DocumentEvidence"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly DocumentEvidence Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<DocumentEvidence>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentNumberEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentTypeEntity.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentNumberEntity.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentTypeEntity.Source arg2, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(DocumentEvidence instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="DocumentEvidence"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentNumberEntity.Source documentNumber,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentTypeEntity.Source documentType,
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source expiry = default)
        {
            documentNumber.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DocumentNumber, ref builder);
            documentType.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DocumentType, ref builder);
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Kind, Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.KindEntity.ConstInstance);
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source expiry = default)
        {
            Create(ref _builder, documentNumber, documentType, expiry);
        }
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentNumberEntity.Source arg1, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentTypeEntity.Source arg2, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="documentNumber">The value of the <c>"documentNumber"</c> property.</param>
    /// <param name="documentType">The value of the <c>"documentType"</c> property.</param>
    /// <param name="expiry">The value of the <c>"expiry"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentNumberEntity.Source documentNumber, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentTypeEntity.Source documentType, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source expiry = default)
    {
        return new Source(documentNumber, documentType, expiry);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="documentNumber">The value of the property.</param>
    /// <param name="documentType">The value of the property.</param>
    /// <param name="expiry">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentNumberEntity.Source documentNumber, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.DocumentEvidence.DocumentTypeEntity.Source documentType, in Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.JsonDate.Source expiry = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(documentNumber, documentType, expiry);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<DocumentEvidence, Mutable>(this);
    }
}
