...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="IdentityRequest"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal IdentityRequest(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static IdentityRequest DefaultInstance { get; }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity DocumentNumber
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentNumberUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.DocumentNumberEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity FullName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FullNameUtf8, out Corvus.Text.Json.Arazzo.ControlPlane.Demo.Onboarding.Models.IdentityRequest.FullNameEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in IdentityRequest left, in IdentityRequest right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in IdentityRequest left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(IdentityRequest instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator IdentityRequest(JsonElement instance)
    {
        return IdentityRequest.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IdentityRequest From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IdentityRequest ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<IdentityRequest>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IdentityRequest ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<IdentityRequest>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IdentityRequest ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<IdentityRequest>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static IdentityRequest ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<IdentityRequest>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out IdentityRequest? result)
    {
        return JsonElementHelpers.TryParseValue<IdentityRequest>(ref reader, out result);
    }
...
#if NET
    static IdentityRequest IJsonElement<IdentityRequest>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"IdentityRequest: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public IdentityRequest Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<IdentityRequest>(_idx);
        }
