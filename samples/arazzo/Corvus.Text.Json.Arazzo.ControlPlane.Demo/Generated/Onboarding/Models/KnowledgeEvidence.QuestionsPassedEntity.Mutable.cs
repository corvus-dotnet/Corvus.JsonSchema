...
public readonly partial struct KnowledgeEvidence
{
    ...
    public readonly partial struct QuestionsPassedEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(QuestionsPassedEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="QuestionsPassedEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator QuestionsPassedEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"QuestionsPassedEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly QuestionsPassedEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly QuestionsPassedEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<QuestionsPassedEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(QuestionsPassedEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<QuestionsPassedEntity, Mutable>(this);
        }
    }
}
