...
public readonly partial struct Resource
{
    ...
    public readonly partial struct KindEntity
    {
...
#endif
        {
            ...
            /// <param name="matchDatabase">Match 1st item.</param>
            /// <param name="matchBucket">Match 2nd item.</param>
            /// <param name="matchQueue">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchDatabase,
                Func<TContext, TResult> matchBucket,
...
#endif
            {
                ...
                {
                    return matchDatabase(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchBucket(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchDatabase,
                Func<TResult> matchBucket,
