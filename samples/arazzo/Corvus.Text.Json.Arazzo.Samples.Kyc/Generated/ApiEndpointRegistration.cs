...
public static class ApiEndpointRegistration
{
    ...
    public static IEndpointRouteBuilder MapApiEndpoints(this IEndpointRouteBuilder app, IApiDefaultHandler defaultHandler, ConfigureEndpoint? configureEndpoint)
    {
        ...
        IEndpointConventionBuilder __VerifyIdentityEndpoint = app.MapPost("/accounts/{accountId}/identity", async (HttpContext context) =>
        {
            ...
            ParsedJsonDocument<Corvus.Text.Json.Arazzo.Samples.Kyc.Models.IdentityRequest>? bodyDoc = null;
            try
            {
                ...
                if ((context.Request.ContentLength ?? 0) > 0 || context.Request.Headers.ContainsKey("Transfer-Encoding"))
                {
                    try
                    {
                        bodyDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Samples.Kyc.Models.IdentityRequest>.ParseAsync(context.Request.Body, default, context.RequestAborted).ConfigureAwait(false);
                    }
                    catch
                    {
                        context.Response.StatusCode = 400;
        ...
        IEndpointConventionBuilder __ListVerificationsEndpoint = app.MapGet("/verifications", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.GetVerificationsLimit LimitValue = default;
                if (context.Request.Query.TryGetValue("limit", out var LimitQueryVal) && LimitQueryVal.Count > 0)
                {
                    string LimitRaw = LimitQueryVal[0]!;
                    LimitValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseNumber<Corvus.Text.Json.Arazzo.Samples.Kyc.Models.GetVerificationsLimit>(LimitRaw, workspace);
                }
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString PageTokenValue = default;
                if (context.Request.Query.TryGetValue("pageToken", out var PageTokenQueryVal) && PageTokenQueryVal.Count > 0)
                {
                    ...
                    PageTokenValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseString<Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString>(PageTokenRaw, workspace);
                }
                ...
                ListVerificationsParams parameters = new()
                {
                    Limit = LimitValue,
                ...
                ListVerificationsResult result = await defaultHandler.HandleListVerificationsAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                httpMethod: "GET",
                routeTemplate: "/verifications",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
            __ListVerificationsEndpoint);

        IEndpointConventionBuilder __GetVerificationEndpoint = app.MapGet("/accounts/{accountId}/verification", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {
                ...
                GetVerificationParams parameters = new()
                {
                    AccountId = AccountIdValue,
                }
                ;

                GetVerificationResult result = await defaultHandler.HandleGetVerificationAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                httpMethod: "GET",
                routeTemplate: "/accounts/{accountId}/verification",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
