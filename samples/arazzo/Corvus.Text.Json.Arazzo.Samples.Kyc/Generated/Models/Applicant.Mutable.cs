...
public readonly partial struct Applicant
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Mutable Country
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountryUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Mutable DateOfBirth
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateOfBirthUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Mutable Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Mutable FullName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FullNameUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCountry(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDateOfBirth(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEmail(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFullName(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Source _createArg4;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Source arg2, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source arg3, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Source fullName,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Source country = default,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source dateOfBirth = default,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Source email = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Source arg2, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source arg3, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Source fullName, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Source country = default, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source dateOfBirth = default, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Source email = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Source fullName, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Source country = default, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source dateOfBirth = default, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Source email = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<Applicant> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<Applicant>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Applicant> Create<TContext>(
    ...
    public static ParsedJsonDocument<Applicant> Create(in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.FullNameEntity.Source fullName, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.Applicant.Iso31661Alpha2.Source country = default, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source dateOfBirth = default, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonIdnEmail.Source email = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
