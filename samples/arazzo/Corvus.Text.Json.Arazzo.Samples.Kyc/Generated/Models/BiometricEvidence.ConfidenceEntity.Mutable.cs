...
public readonly partial struct BiometricEvidence
{
    ...
    public readonly partial struct ConfidenceEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ConfidenceEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfidenceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfidenceEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfidenceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ConfidenceEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ConfidenceEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfidenceEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ConfidenceEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ConfidenceEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ConfidenceEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ConfidenceEntity>();
            }
            finally
            {
