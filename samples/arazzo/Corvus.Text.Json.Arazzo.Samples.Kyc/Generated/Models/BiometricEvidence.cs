...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BiometricEvidence"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal BiometricEvidence(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static BiometricEvidence DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.ConfidenceEntity Confidence
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfidenceUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.ConfidenceEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.KindEntity Kind
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.KindEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.ModalityEntity Modality
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModalityUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.ModalityEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in BiometricEvidence left, in BiometricEvidence right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in BiometricEvidence left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(BiometricEvidence instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator BiometricEvidence(JsonElement instance)
    {
        return BiometricEvidence.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BiometricEvidence From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BiometricEvidence ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BiometricEvidence>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BiometricEvidence ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BiometricEvidence>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BiometricEvidence ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BiometricEvidence>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static BiometricEvidence ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BiometricEvidence>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out BiometricEvidence? result)
    {
        return JsonElementHelpers.TryParseValue<BiometricEvidence>(ref reader, out result);
    }
...
#if NET
    static BiometricEvidence IJsonElement<BiometricEvidence>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"BiometricEvidence: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public BiometricEvidence Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public BiometricEvidence Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<BiometricEvidence>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Confidence"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Modality"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Confidence"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ConfidenceUtf8 => "confidence"u8;
        ...
        /// Gets the JSON property name for <see cref="Modality"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ModalityUtf8 => "modality"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Confidence"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Confidence => "confidence"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Modality"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Modality => "modality"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Confidence"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Confidence => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x6E, 0x66, 0x69, 0x64, 0x65, 0x6E, 0x63, 0x65, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Modality"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Modality => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x6F, 0x64, 0x61, 0x6C, 0x69, 0x74, 0x79, 0x22];
    }
}
