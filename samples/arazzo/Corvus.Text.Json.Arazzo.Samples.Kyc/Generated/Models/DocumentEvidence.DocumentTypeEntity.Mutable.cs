...
public readonly partial struct DocumentEvidence
{
    public readonly partial struct DocumentTypeEntity
    {
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (DocumentTypeEntity)value;
        ...
        public static ParsedJsonDocument<DocumentTypeEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DocumentTypeEntity>();
            }
            finally
            {
