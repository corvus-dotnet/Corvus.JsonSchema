...
public readonly partial struct DocumentEvidence
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Mutable DocumentNumber
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentNumberUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Mutable DocumentType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentTypeUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Mutable Expiry
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpiryUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.KindEntity.Mutable Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.KindEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDocumentNumber(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDocumentType(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetExpiry(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetKind(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.KindEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Source arg2, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Source documentNumber,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Source documentType,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source expiry = default)
        {
            ...
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Kind, Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.KindEntity.ConstInstance);
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Source arg2, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Source documentNumber, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Source documentType, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source expiry = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Source documentNumber, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Source documentType, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source expiry = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<DocumentEvidence> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<DocumentEvidence>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<DocumentEvidence> Create<TContext>(
    ...
    public static ParsedJsonDocument<DocumentEvidence> Create(in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity.Source documentNumber, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity.Source documentType, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate.Source expiry = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
