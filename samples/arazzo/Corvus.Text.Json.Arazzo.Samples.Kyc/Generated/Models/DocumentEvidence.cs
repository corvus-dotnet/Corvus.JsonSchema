...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity DocumentNumber
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentNumberUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentNumberEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity DocumentType
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentTypeUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.DocumentTypeEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate Expiry
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpiryUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDate value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.KindEntity Kind
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.KindEntity value))
            {
                return value;
            }
