    ...
    : IJsonElement<Evidence>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/Evidence"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/Evidence";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/Evidence"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            if (!context.HasCollector)
            {
                ...
                {
                    if (parentDocument.TryGetNamedPropertyValue(parentIndex, "kind"u8, out IJsonDocument? oneOfDiscriminator_doc, out int oneOfDiscriminator_idx))
                    {
                        if (oneOfDiscriminator_doc.GetJsonTokenType(oneOfDiscriminator_idx) == JsonTokenType.String)
                        {
                            ...
                            if (discriminatorValue.Span.SequenceEqual("document"u8))
                            {
                                oneOfDiscriminatorBranch = 0;
                            }
                            else if (discriminatorValue.Span.SequenceEqual("biometric"u8))
                            {
                                oneOfDiscriminatorBranch = 1;
                            }
                            else if (discriminatorValue.Span.SequenceEqual("knowledge-based"u8))
                            {
                ...
                switch (oneOfDiscriminatorBranch)
                {
                    case 0:
                    {
                        JsonSchemaContext discriminatorContext0 =
                            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                        Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                    ...
                    case 1:
                    {
                        JsonSchemaContext discriminatorContext1 =
                            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                        Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                    ...
                    case 2:
                    {
                        JsonSchemaContext discriminatorContext2 =
                            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                        Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext2);
            ...
            JsonSchemaContext oneOfContext0 =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.DocumentEvidence.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
            ...
            JsonSchemaContext oneOfContext1 =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.BiometricEvidence.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
            ...
            JsonSchemaContext oneOfContext2 =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
