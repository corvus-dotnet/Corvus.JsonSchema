...
public readonly partial struct GetVerificationsLimit
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetVerificationsLimit instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetVerificationsLimit"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetVerificationsLimit(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetVerificationsLimit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetVerificationsLimit Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetVerificationsLimit Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetVerificationsLimit>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetVerificationsLimit instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetVerificationsLimit, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetVerificationsLimit> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetVerificationsLimit>();
        }
        finally
        {
