...
public readonly partial struct IdentityRequest
{
    ...
    public readonly partial struct DocumentNumberEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DocumentNumberEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DocumentNumberEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DocumentNumberEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DocumentNumberEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DocumentNumberEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DocumentNumberEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DocumentNumberEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DocumentNumberEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DocumentNumberEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DocumentNumberEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DocumentNumberEntity>();
            }
            finally
            {
