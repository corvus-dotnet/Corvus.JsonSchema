    ...
    public readonly partial struct FlagsEntityArray
    {
        public readonly partial struct FlagsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FlagsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FlagsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FlagsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FlagsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public readonly FlagsEntity Clone()
                {
                    CheckValidInstance();
                ...
                public readonly FlagsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FlagsEntity>(_idx);
                }
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        result = KnownValues.Pep;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.Sanctions;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        result = KnownValues.AdverseMedia;
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FlagsEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (FlagsEntity)value;
            ...
            {
                return workspace.CreateBuilder<FlagsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FlagsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FlagsEntity>();
                }
                finally
                {
