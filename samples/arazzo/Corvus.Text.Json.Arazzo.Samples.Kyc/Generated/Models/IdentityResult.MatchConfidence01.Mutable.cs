...
public readonly partial struct IdentityResult
{
    ...
    public readonly partial struct MatchConfidence01
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MatchConfidence01 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MatchConfidence01"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MatchConfidence01(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MatchConfidence01.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MatchConfidence01 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MatchConfidence01 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MatchConfidence01>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MatchConfidence01 instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MatchConfidence01, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MatchConfidence01> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MatchConfidence01>();
            }
            finally
            {
