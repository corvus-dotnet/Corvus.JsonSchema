...
public readonly partial struct IdentityResult
{
        ...
        : IJsonElement<MethodEntity>
    {
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/IdentityResult/properties/method"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("document"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("biometric"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("knowledge-based"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
