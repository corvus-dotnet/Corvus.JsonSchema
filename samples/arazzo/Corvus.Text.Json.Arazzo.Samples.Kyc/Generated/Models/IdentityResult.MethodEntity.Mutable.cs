...
public readonly partial struct IdentityResult
{
    public readonly partial struct MethodEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MethodEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MethodEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MethodEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MethodEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly MethodEntity Clone()
            {
                CheckValidInstance();
            ...
            public readonly MethodEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MethodEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MethodEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (MethodEntity)value;
        ...
        {
            return workspace.CreateBuilder<MethodEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MethodEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MethodEntity>();
            }
            finally
            {
