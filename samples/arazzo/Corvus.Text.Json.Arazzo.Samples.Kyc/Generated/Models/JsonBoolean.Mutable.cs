...
public readonly partial struct JsonBoolean
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonBoolean instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonBoolean"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonBoolean(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonBoolean.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonBoolean Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonBoolean Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonBoolean>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonBoolean instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonBoolean, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonBoolean> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonBoolean>();
        }
        finally
        {
