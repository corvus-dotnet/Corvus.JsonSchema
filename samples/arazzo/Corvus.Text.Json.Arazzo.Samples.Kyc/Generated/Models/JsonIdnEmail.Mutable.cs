...
public readonly partial struct JsonIdnEmail
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonIdnEmail instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonIdnEmail"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonIdnEmail(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonIdnEmail(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonIdnEmail.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonIdnEmail"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonIdnEmail"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonIdnEmail Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonIdnEmail>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonIdnEmail"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonIdnEmail Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonIdnEmail>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonIdnEmail instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonIdnEmail, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonIdnEmail> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonIdnEmail>();
        }
        finally
        {
