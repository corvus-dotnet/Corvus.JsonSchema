...
public readonly partial struct KnowledgeEvidence
{
...
#endif
    {
        ...
        public static explicit operator Mutable(KnowledgeEvidence instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="KnowledgeEvidence"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator KnowledgeEvidence(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.KindEntity.Mutable Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.KindEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Mutable QuestionsPassed
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuestionsPassedUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetKind(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.KindEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>questionsPassed</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetQuestionsPassed(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("questionsPassed");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuestionsPassedUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.QuestionsPassed, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"KnowledgeEvidence.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly KnowledgeEvidence Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly KnowledgeEvidence Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<KnowledgeEvidence>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(KnowledgeEvidence instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="KnowledgeEvidence"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Source questionsPassed)
        {
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Kind, Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.KindEntity.ConstInstance);
            questionsPassed.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.QuestionsPassed, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="KnowledgeEvidence"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Source questionsPassed)
        {
            Create(ref _builder, questionsPassed);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// </summary>
    /// <param name="questionsPassed">The value of the <c>"questionsPassed"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Source questionsPassed)
    {
        return new Source(questionsPassed);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="questionsPassed">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Source questionsPassed, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(questionsPassed);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<KnowledgeEvidence, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<KnowledgeEvidence> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<KnowledgeEvidence>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<KnowledgeEvidence> Create<TContext>(
    ...
    public static ParsedJsonDocument<KnowledgeEvidence> Create(in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity.Source questionsPassed, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
