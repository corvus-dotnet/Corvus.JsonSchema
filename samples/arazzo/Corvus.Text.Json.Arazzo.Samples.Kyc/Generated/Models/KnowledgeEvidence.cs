...
public readonly partial struct KnowledgeEvidence
#if NET8_0_OR_GREATER
    : IJsonElement<KnowledgeEvidence>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KnowledgeEvidence"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal KnowledgeEvidence(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static KnowledgeEvidence DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.KindEntity Kind
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.KindEntity value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets the <c>questionsPassed</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity QuestionsPassed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuestionsPassedUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.KnowledgeEvidence.QuestionsPassedEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in KnowledgeEvidence left, in KnowledgeEvidence right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in KnowledgeEvidence left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(KnowledgeEvidence instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator KnowledgeEvidence(JsonElement instance)
    {
        return KnowledgeEvidence.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static KnowledgeEvidence From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static KnowledgeEvidence ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<KnowledgeEvidence>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static KnowledgeEvidence ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<KnowledgeEvidence>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static KnowledgeEvidence ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<KnowledgeEvidence>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static KnowledgeEvidence ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<KnowledgeEvidence>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out KnowledgeEvidence? result)
    {
        return JsonElementHelpers.TryParseValue<KnowledgeEvidence>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new KnowledgeEvidence(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static KnowledgeEvidence IJsonElement<KnowledgeEvidence>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"KnowledgeEvidence: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="KnowledgeEvidence"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="KnowledgeEvidence"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public KnowledgeEvidence Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<KnowledgeEvidence>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="KnowledgeEvidence"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public KnowledgeEvidence Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<KnowledgeEvidence>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="QuestionsPassed"/>.
        /// </summary>
        public const string QuestionsPassed = "questionsPassed";
        ...
        /// Gets the JSON property name for <see cref="QuestionsPassed"/>.
        /// </summary>
        public static ReadOnlySpan<byte> QuestionsPassedUtf8 => "questionsPassed"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="QuestionsPassed"/>.
        /// </summary>
        public static ReadOnlySpan<byte> QuestionsPassed => "questionsPassed"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="QuestionsPassed"/>.
        /// </summary>
        public static ReadOnlySpan<byte> QuestionsPassed => [0x15, 0x01, 0x00, 0x00, 0x22, 0x71, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6F, 0x6E, 0x73, 0x50, 0x61, 0x73, 0x73, 0x65, 0x64, 0x22];
    }
}
