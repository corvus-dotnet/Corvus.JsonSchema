...
public readonly partial struct VerdictRequest
{
...
#endif
    {
        ...
        public static explicit operator Mutable(VerdictRequest instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="VerdictRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator VerdictRequest(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Mutable FullName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FullNameUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Mutable Score
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScoreUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new VerdictRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetFullName(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FullNameUtf8);
        ...
        /// <summary>
        /// Remove the <c>fullName</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveFullName()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FullNameUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScore(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"VerdictRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="VerdictRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="VerdictRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly VerdictRequest Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<VerdictRequest>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="VerdictRequest"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly VerdictRequest Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<VerdictRequest>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonBoolean.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Source _createArg3;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonBoolean.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Source arg2, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(VerdictRequest instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="VerdictRequest"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonBoolean.Source verified,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Source fullName = default,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Source score = default)
        {
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Source score = default)
        {
            Create(ref _builder, verified, fullName, score);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonBoolean.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Source arg2, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonBoolean.Source verified, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Source fullName = default, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Source score = default)
    {
        return new Source(verified, fullName, score);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonBoolean.Source verified, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Source fullName = default, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Source score = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(verified, fullName, score);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<VerdictRequest, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<VerdictRequest> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<VerdictRequest>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<VerdictRequest> Create<TContext>(
    ...
    public static ParsedJsonDocument<VerdictRequest> Create(in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonBoolean.Source verified, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.TheResolvedApplicantName.Source fullName = default, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerdictRequest.MatchConfidence01.Source score = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
