...
public readonly partial struct VerdictRequest
{
    ...
    public readonly partial struct TheResolvedApplicantName
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheResolvedApplicantName instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheResolvedApplicantName"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheResolvedApplicantName(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheResolvedApplicantName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheResolvedApplicantName Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheResolvedApplicantName Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheResolvedApplicantName>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheResolvedApplicantName instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheResolvedApplicantName, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheResolvedApplicantName> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheResolvedApplicantName>();
            }
            finally
            {
