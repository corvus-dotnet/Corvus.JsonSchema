...
public readonly partial struct VerificationPage
    : IJsonElement<VerificationPage>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyVerificationsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("verifications"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyVerificationsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("verifications"u8, buffer, out written);

        private const int RequiredOffsetForVerifications = 0;
        private const uint RequiredBitForVerifications = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForVerifications;
        ...
        private static readonly JsonSchemaPathProvider VerificationsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/verifications"u8, buffer, out written);
        ...
        private static void MatchVerifications(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.VerificationsUtf8,
                    evaluationPath: VerificationsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForVerifications] |= RequiredBitForVerifications;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Kyc.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Kyc.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.VerificationsUtf8, MatchVerifications),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/VerificationPage"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/VerificationPage";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/VerificationPage"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyVerificationsPresent, "verifications"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForVerifications] & RequiredBitForVerifications) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyVerificationsNotPresent, "verifications"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyVerificationsPresent, "verifications"u8, "required"u8);
