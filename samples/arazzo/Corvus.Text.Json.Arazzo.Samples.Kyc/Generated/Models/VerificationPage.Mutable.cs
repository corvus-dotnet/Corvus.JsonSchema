...
/// <remarks>
/// <para>
/// A page of KYC verification records, newest first, with an opaque continuation token.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct VerificationPage
{
...
#endif
    {
        ...
        public static explicit operator Mutable(VerificationPage instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="VerificationPage"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator VerificationPage(Mutable instance)
        {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Mutable NextPageToken
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NextPageTokenUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>verifications</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Mutable Verifications
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerificationsUtf8, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new VerificationPage(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetNextPageToken(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>verifications</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetVerifications(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("verifications");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerificationsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Verifications, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetVerifications<TContext>(in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"VerificationPage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="VerificationPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="VerificationPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly VerificationPage Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<VerificationPage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="VerificationPage"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly VerificationPage Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<VerificationPage>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(VerificationPage instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="VerificationPage"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source verifications,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source nextPageToken = default)
        {
            verifications.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Verifications, ref builder);
        ...
        /// Creates an instance of a <see cref="VerificationPage"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source verifications, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source nextPageToken = default)
        {
            Create(ref _builder, verifications, nextPageToken);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source<TContext> verifications,
            in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, verifications, nextPageToken);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// </summary>
    /// <param name="verifications">The value of the <c>"verifications"</c> property.</param>
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source verifications, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source nextPageToken = default)
    {
        return new Source(verifications, nextPageToken);
    }
    ...
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source<TContext> verifications, scoped in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, verifications, nextPageToken);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="verifications">The value of the property.</param>
    /// <param name="nextPageToken">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source verifications, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(verifications, nextPageToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source<TContext> verifications, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, verifications, nextPageToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<VerificationPage, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<VerificationPage> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<VerificationPage>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<VerificationPage> Create<TContext>(
    ...
    public static ParsedJsonDocument<VerificationPage> Create(in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source verifications, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<VerificationPage> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationPage.VerificationViewArray.Source<TContext> verifications, in Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
