...
public readonly partial struct VerificationView
{
        ...
        : IJsonElement<ChannelEntity>
    {
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/VerificationView/properties/channel"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("synchronous"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("manual"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
