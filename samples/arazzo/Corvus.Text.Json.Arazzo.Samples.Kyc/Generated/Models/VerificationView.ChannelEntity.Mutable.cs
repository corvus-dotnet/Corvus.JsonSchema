...
public readonly partial struct VerificationView
{
    ...
    public readonly partial struct ChannelEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ChannelEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ChannelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ChannelEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ChannelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ChannelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ChannelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ChannelEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ChannelEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ChannelEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ChannelEntity>(_idx);
            }
...
#endif
            {
                ...
                {
                    return matchSynchronous(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchSynchronous,
                Func<TResult> matchManual,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchSynchronous();
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ChannelEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ChannelEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ChannelEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ChannelEntity>();
            }
            finally
            {
