    ...
    : IJsonElement<VerificationView>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForStatus = 0b00000000000000000000000000000010;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySubmittedAtPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("submittedAt"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySubmittedAtNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("submittedAt"u8, buffer, out written);

        private const int RequiredOffsetForSubmittedAt = 0;
        private const uint RequiredBitForSubmittedAt = 0b00000000000000000000000000000100;
        ...
        private static readonly JsonSchemaPathProvider FullNameSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/fullName"u8, buffer, out written);
        ...
        private static void MatchAccountId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchChannel(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationView.ChannelEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationView.ChannelEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            context.CommitChildContext(childContext1.IsMatch, ref childContext1);
        }

        private static void MatchFullName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.FullNameUtf8,
                    evaluationPath: FullNameSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchIdentity(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext3 =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.IdentityResult.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.IdentityResult.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext4 =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationView.StatusEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.VerificationView.StatusEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
        ...
        private static void MatchSubmittedAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext5 =
                Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDateTime.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.SubmittedAtUtf8,
                    evaluationPath: SubmittedAtSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext5);
        ...
        private static void MatchVerifiedAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            Corvus.Text.Json.Arazzo.Samples.Kyc.Models.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext6);
            context.CommitChildContext(childContext6.IsMatch, ref childContext6);
        }

        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Kyc.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Kyc.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.AccountIdUtf8, MatchAccountId),
                (static () => JsonPropertyNames.ChannelUtf8, MatchChannel),
                (static () => JsonPropertyNames.FullNameUtf8, MatchFullName),
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Kyc.Models.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/VerificationView"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/VerificationView";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/VerificationView"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.Text.Json.Arazzo.Samples.Kyc.Models.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyStatusPresent, "status"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySubmittedAtPresent, "submittedAt"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyStatusNotPresent, "status"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyStatusPresent, "status"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSubmittedAt] & RequiredBitForSubmittedAt) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertySubmittedAtNotPresent, "submittedAt"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySubmittedAtPresent, "submittedAt"u8, "required"u8);
