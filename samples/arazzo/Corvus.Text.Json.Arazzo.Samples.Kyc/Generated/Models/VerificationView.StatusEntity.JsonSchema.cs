...
public readonly partial struct VerificationView
{
        ...
        : IJsonElement<StatusEntity>
    {
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Enum1 = "verified"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly StatusEntity EnumJson1 = ParsedJsonDocument<StatusEntity>.StringConstant([.."\"verified\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum2 = "blocked"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly StatusEntity EnumJson2 = ParsedJsonDocument<StatusEntity>.StringConstant([.."\"blocked\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
        ...
        public static class EnumValues
        {
            ...
            /// </summary>
            public static StatusEntity Verified { get; } = Constants.EnumJson1;
            /// <summary>
            /// Gets the string "verified"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> VerifiedUtf8 => Constants.Enum1;

            /// <summary>
            /// Gets the string "blocked"
            /// as a <see cref="StatusEntity"/>.
            /// </summary>
            public static StatusEntity Blocked { get; } = Constants.EnumJson2;
            /// <summary>
            /// Gets the string "blocked"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> BlockedUtf8 => Constants.Enum2;
        ...
        {
            /// <summary>
            /// Corresponds to the JSON string "verified".
            /// </summary>
            Verified = 0,
            /// <summary>
            /// Corresponds to the JSON string "blocked".
            /// </summary>
            Blocked = 1,
            /// <summary>
        ...
        public static implicit operator StatusEntity(KnownValues value)
        {
            return value switch
            {
                KnownValues.Verified => Constants.EnumJson1,
                KnownValues.Blocked => Constants.EnumJson2,
        ...
        public bool TryGetKnownValue(out KnownValues result)
        {
            ...
            {
                result = KnownValues.Verified;
                return true;
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                result = KnownValues.Blocked;
                return true;
            }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/components/schemas/VerificationView/properties/status"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/VerificationView/properties/status";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/VerificationView/properties/status"u8;
            ...
            private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.Arazzo.Samples.Kyc.Models.CorvusJsonSchemaProgram.Entry(35);
