...
/// <summary>
/// Result type for the SubmitVerdict operation.
/// </summary>
public readonly struct SubmitVerdictResult
{
    private SubmitVerdictResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="SubmitVerdictResult"/> with status 202.</returns>
    public static SubmitVerdictResult Accepted() => new(202, default, null);
