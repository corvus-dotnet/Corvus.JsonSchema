...
public static class ApiEndpointRegistration
{
    ...
    public static IEndpointRouteBuilder MapApiEndpoints(this IEndpointRouteBuilder app, IApiDefaultHandler defaultHandler, ConfigureEndpoint? configureEndpoint)
    {
        ...
        IEndpointConventionBuilder __ListReconciliationsEndpoint = app.MapGet("/reconciliations", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {
                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.GetReconciliationsLimit LimitValue = default;
                if (context.Request.Query.TryGetValue("limit", out var LimitQueryVal) && LimitQueryVal.Count > 0)
                {
                    string LimitRaw = LimitQueryVal[0]!;
                    LimitValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseNumber<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.GetReconciliationsLimit>(LimitRaw, workspace);
                }
                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString PageTokenValue = default;
                if (context.Request.Query.TryGetValue("pageToken", out var PageTokenQueryVal) && PageTokenQueryVal.Count > 0)
                {
                    ...
                    PageTokenValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseString<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString>(PageTokenRaw, workspace);
                }
                ...
                ListReconciliationsParams parameters = new()
                {
                    Limit = LimitValue,
                ...
                ListReconciliationsResult result = await defaultHandler.HandleListReconciliationsAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                methodName: "ListReconciliations",
                httpMethod: "GET",
                routeTemplate: "/reconciliations",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
            __ListReconciliationsEndpoint);

        IEndpointConventionBuilder __GetReconciliationEndpoint = app.MapGet("/reconciliations/{runId}", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {
                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString RunIdValue = default;
                if (context.Request.RouteValues.TryGetValue("runId", out object? RunIdRouteVal) && RunIdRouteVal is string RunIdRaw)
                {
                    RunIdValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseString<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString>(RunIdRaw, workspace);
                }
                ...
                GetReconciliationParams parameters = new()
                {
                    RunId = RunIdValue,
                }
                ;

                GetReconciliationResult result = await defaultHandler.HandleGetReconciliationAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                httpMethod: "GET",
                routeTemplate: "/reconciliations/{runId}",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
            __GetReconciliationEndpoint);

        IEndpointConventionBuilder __ListLedgerAccountsEndpoint = app.MapGet("/accounts", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {
                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.GetAccountsLimit LimitValue = default;
                if (context.Request.Query.TryGetValue("limit", out var LimitQueryVal) && LimitQueryVal.Count > 0)
                {
                    string LimitRaw = LimitQueryVal[0]!;
                    LimitValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseNumber<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.GetAccountsLimit>(LimitRaw, workspace);
                }
                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString PageTokenValue = default;
                if (context.Request.Query.TryGetValue("pageToken", out var PageTokenQueryVal) && PageTokenQueryVal.Count > 0)
                {
                ...
                ListLedgerAccountsParams parameters = new()
                {
                    Limit = LimitValue,
                    PageToken = PageTokenValue,
                }
                ...
                ListLedgerAccountsResult result = await defaultHandler.HandleListLedgerAccountsAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
