...
public readonly partial struct Discrepancy
{
        ...
        : IJsonElement<ContactEntity>
    {
        public static partial class JsonSchema
        {
            ...
            private static readonly JsonSchemaPathProvider RunbookSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/runbook"u8, buffer, out written);
            ...
            private static void MatchEmail(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchRunbook(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.RunbookUtf8,
                        evaluationPath: RunbookSchemaEvaluationPath);

                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                context.CommitChildContext(childContext1.IsMatch, ref childContext1);
            }

            private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                    (static () => JsonPropertyNames.EmailUtf8, MatchEmail),
                    (static () => JsonPropertyNames.RunbookUtf8, MatchRunbook),
                ]);
            }

            private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PropertiesValidationHandler_NamedPropertyValidator1> Matchers { get; } = MatchersBuilder();
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/Discrepancy/properties/contact"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/Discrepancy/properties/contact";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/Discrepancy/properties/contact"u8;
