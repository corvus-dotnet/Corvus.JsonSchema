...
public readonly partial struct Discrepancy
{
    ...
    public readonly partial struct ContactEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContactEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContactEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContactEntity(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Mutable Email
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Mutable Runbook
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RunbookUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetEmail(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Set the <c>runbook</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRunbook(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RunbookUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RunbookUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Runbook, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>runbook</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveRunbook()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RunbookUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContactEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ContactEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ContactEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContactEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Source _createArg1;
            private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source _createArg2;
            ...
            internal Source(Corvus.Text.Json.Arazzo.Samples.Ledger.Models.Discrepancy.ContactEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(ContactEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Ledger.Models.Discrepancy.ContactEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ContactEntity"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Source email = default,
                in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source runbook = default)
            {
                email.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Email, ref builder);
                runbook.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Runbook, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="ContactEntity"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Source email = default, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source runbook = default)
            {
                Create(ref _builder, email, runbook);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <param name="runbook">The value of the <c>"runbook"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Source email = default, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source runbook = default)
        {
            return new Source(email, runbook);
        }
        ...
        /// <param name="runbook">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Source email = default, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source runbook = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(email, runbook);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ContactEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ContactEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ContactEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ContactEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<ContactEntity> Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonEmail.Source email = default, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source runbook = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
