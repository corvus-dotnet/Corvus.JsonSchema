...
public readonly partial struct Discrepancy
{
    ...
    public readonly partial struct CurrencyEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CurrencyEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CurrencyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CurrencyEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CurrencyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CurrencyEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CurrencyEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CurrencyEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CurrencyEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CurrencyEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CurrencyEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CurrencyEntity>();
            }
            finally
            {
