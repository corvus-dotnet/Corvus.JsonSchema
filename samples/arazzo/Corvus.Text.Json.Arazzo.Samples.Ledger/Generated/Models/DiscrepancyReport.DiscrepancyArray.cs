...
public readonly partial struct DiscrepancyReport
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.Discrepancy this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.Discrepancy>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.Discrepancy> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.Discrepancy>(_parent, _idx);
        }
