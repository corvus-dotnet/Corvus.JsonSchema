...
public readonly partial struct DiscrepancyReport
{
    ...
    public readonly partial struct TheFromToTransactionSequenceNumbersScanned
    {
        ...
        public readonly partial struct FromEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FromEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FromEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FromEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FromEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FromEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FromEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FromEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly FromEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FromEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FromEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly FromEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FromEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FromEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FromEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FromEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FromEntity>();
                }
                finally
                {
