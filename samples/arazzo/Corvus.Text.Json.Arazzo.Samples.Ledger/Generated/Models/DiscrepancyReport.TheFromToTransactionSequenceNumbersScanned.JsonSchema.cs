...
public readonly partial struct DiscrepancyReport
{
    ...
    public readonly partial struct TheFromToTransactionSequenceNumbersScanned
        : IJsonElement<TheFromToTransactionSequenceNumbersScanned>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/DiscrepancyReport/properties/range"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/DiscrepancyReport/properties/range";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/DiscrepancyReport/properties/range"u8;
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        switch (arrayValidation_itemCount)
                        {
                            case 0:
                            {
                                JsonSchemaContext childContext = Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.JsonSchema.PushChildContext(
                                    parentDocument,
                                ...
                                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
                            ...
                            case 1:
                            {
                                JsonSchemaContext childContext1 = Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.JsonSchema.PushChildContext(
                                    parentDocument,
                                    arrayValidation_currentIndex,
                                    ref context,
                                    itemIndex: arrayValidation_itemCount,
                                ...
                                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext1);
