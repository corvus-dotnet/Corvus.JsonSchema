...
public readonly partial struct DiscrepancyReport
{
    ...
    public readonly partial struct TheFromToTransactionSequenceNumbersScanned
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheFromToTransactionSequenceNumbersScanned instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheFromToTransactionSequenceNumbersScanned"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheFromToTransactionSequenceNumbersScanned(Mutable instance)
            {
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.Mutable Item1
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.Mutable>(_idx, 0);
                }
            }
            ...
            /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.Mutable Item2
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.Mutable>(_idx, 1);
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheFromToTransactionSequenceNumbersScanned(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheFromToTransactionSequenceNumbersScanned.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="TheFromToTransactionSequenceNumbersScanned"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheFromToTransactionSequenceNumbersScanned"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TheFromToTransactionSequenceNumbersScanned Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheFromToTransactionSequenceNumbersScanned>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheFromToTransactionSequenceNumbersScanned"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TheFromToTransactionSequenceNumbersScanned Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheFromToTransactionSequenceNumbersScanned>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(TheFromToTransactionSequenceNumbersScanned instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            public void CreateTuple(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.FromEntity.Source item1, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.DiscrepancyReport.TheFromToTransactionSequenceNumbersScanned.To.Source item2)
            {
        ...
        {
            return workspace.CreateBuilder<TheFromToTransactionSequenceNumbersScanned, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheFromToTransactionSequenceNumbersScanned> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheFromToTransactionSequenceNumbersScanned>();
            }
            finally
            {
