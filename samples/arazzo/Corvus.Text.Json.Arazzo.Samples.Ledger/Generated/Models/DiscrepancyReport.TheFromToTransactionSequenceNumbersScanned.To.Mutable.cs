    ...
    public readonly partial struct TheFromToTransactionSequenceNumbersScanned
    {
        ...
        public readonly partial struct To
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(To instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="To"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator To(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"To.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="To"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="To"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="To"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly To Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<To>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(To instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<To, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<To> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<To>();
                }
                finally
                {
