...
public readonly partial struct GetLedgerOk
    : IJsonElement<GetLedgerOk>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchEntries(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
        {
        ...
        [NotNullWhen(true)]
#endif
        out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PropertiesValidationHandler_NamedPropertyValidator1? matcher)
        {
            if (span.SequenceEqual(JsonPropertyNames.EntriesUtf8))
            {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1ledger/get/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1ledger/get/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1ledger/get/responses/200/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PropertiesValidationHandler_NamedPropertyValidator1? validator))
                    {
