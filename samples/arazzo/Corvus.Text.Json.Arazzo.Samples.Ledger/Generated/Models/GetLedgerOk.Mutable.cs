...
public readonly partial struct GetLedgerOk
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Mutable Entries
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntriesUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        public void SetEntries(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Ledger.Models.GetLedgerOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Ledger.Models.GetLedgerOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source entries = default)
        {
        ...
        /// Creates an instance of a <see cref="GetLedgerOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source entries = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source entries = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source entries = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<GetLedgerOk> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetLedgerOk>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetLedgerOk> Create<TContext>(
    ...
    public static ParsedJsonDocument<GetLedgerOk> Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source entries = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
