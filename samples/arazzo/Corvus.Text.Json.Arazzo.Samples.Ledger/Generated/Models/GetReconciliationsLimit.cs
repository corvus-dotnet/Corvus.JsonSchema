...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetReconciliationsLimit"/> struct.
    /// </summary>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator long(GetReconciliationsLimit value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator double(GetReconciliationsLimit value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();
    ...
    /// <summary>
    /// Gets a <see cref="GetReconciliationsLimit"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetReconciliationsLimit"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetReconciliationsLimit"/> that lives for the lifetime of its
