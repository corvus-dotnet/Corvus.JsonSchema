...
public readonly partial struct GetTransactionsOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetTransactionsOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetTransactionsOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetTransactionsOk(Mutable instance)
        {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Mutable Count
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetTransactionsOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCount(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CountUtf8);
        ...
        /// <summary>
        /// Remove the <c>count</c> property, if present.
        /// </summary>
        ...
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CountUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetTransactionsOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetTransactionsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetTransactionsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetTransactionsOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetTransactionsOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetTransactionsOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetTransactionsOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetTransactionsOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Ledger.Models.GetTransactionsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(GetTransactionsOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Ledger.Models.GetTransactionsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetTransactionsOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source count = default)
        {
        ...
        /// Creates an instance of a <see cref="GetTransactionsOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source count = default)
        {
            Create(ref _builder, count);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source count = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source count = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetTransactionsOk, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetTransactionsOk> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetTransactionsOk>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetTransactionsOk> Create<TContext>(
    ...
    public static ParsedJsonDocument<GetTransactionsOk> Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source count = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
