...
public readonly partial struct JsonNumber
{
...
#endif
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonNumber.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonNumber Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonNumber Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonNumber>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonNumber instance) => new(JsonElement.From(instance));
