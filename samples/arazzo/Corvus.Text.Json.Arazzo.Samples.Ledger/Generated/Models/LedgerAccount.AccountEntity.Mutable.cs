...
public readonly partial struct LedgerAccount
{
    ...
    public readonly partial struct AccountEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AccountEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AccountEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AccountEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AccountEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AccountEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AccountEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AccountEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AccountEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AccountEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AccountEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AccountEntity>();
            }
            finally
            {
