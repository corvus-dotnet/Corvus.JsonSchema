...
public readonly partial struct LedgerAccountPage
{
...
#endif
    {
        ...
        public static explicit operator Mutable(LedgerAccountPage instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="LedgerAccountPage"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LedgerAccountPage(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Mutable Accounts
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccountsUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Mutable NextPageToken
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NextPageTokenUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetAccounts(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAccounts<TContext>(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetNextPageToken(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LedgerAccountPage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly LedgerAccountPage Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly LedgerAccountPage Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<LedgerAccountPage>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(LedgerAccountPage instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="LedgerAccountPage"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source accounts,
            in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
        {
        ...
        /// Creates an instance of a <see cref="LedgerAccountPage"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source accounts, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source<TContext> accounts,
            in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source accounts, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
    {
    ...
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source<TContext> accounts, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source accounts, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source<TContext> accounts, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<LedgerAccountPage, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<LedgerAccountPage> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<LedgerAccountPage>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<LedgerAccountPage> Create<TContext>(
    ...
    public static ParsedJsonDocument<LedgerAccountPage> Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source accounts, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<LedgerAccountPage> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray.Source<TContext> accounts, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
