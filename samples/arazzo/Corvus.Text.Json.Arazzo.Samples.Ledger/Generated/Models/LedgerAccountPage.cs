...
public readonly partial struct LedgerAccountPage
    ...
    : IJsonElement<LedgerAccountPage>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LedgerAccountPage"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal LedgerAccountPage(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static LedgerAccountPage DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray Accounts
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccountsUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.LedgerAccountPage.LedgerAccountArray value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString NextPageToken
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NextPageTokenUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in LedgerAccountPage left, in LedgerAccountPage right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in LedgerAccountPage left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(LedgerAccountPage instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator LedgerAccountPage(JsonElement instance)
    {
        return LedgerAccountPage.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LedgerAccountPage From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LedgerAccountPage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<LedgerAccountPage>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LedgerAccountPage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<LedgerAccountPage>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LedgerAccountPage ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<LedgerAccountPage>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static LedgerAccountPage ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<LedgerAccountPage>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out LedgerAccountPage? result)
    {
        return JsonElementHelpers.TryParseValue<LedgerAccountPage>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new LedgerAccountPage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static LedgerAccountPage IJsonElement<LedgerAccountPage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"LedgerAccountPage: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="LedgerAccountPage"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="LedgerAccountPage"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public LedgerAccountPage Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<LedgerAccountPage>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="LedgerAccountPage"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public LedgerAccountPage Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<LedgerAccountPage>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Accounts"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Accounts"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AccountsUtf8 => "accounts"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Accounts"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Accounts => "accounts"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Accounts"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Accounts => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x63, 0x63, 0x6F, 0x75, 0x6E, 0x74, 0x73, 0x22];
