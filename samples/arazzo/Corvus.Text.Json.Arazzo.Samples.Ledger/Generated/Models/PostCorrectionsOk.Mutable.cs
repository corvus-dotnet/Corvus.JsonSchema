...
public readonly partial struct PostCorrectionsOk
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Mutable Posted
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PostedUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        public void SetPosted(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PostCorrectionsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PostCorrectionsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source posted = default)
        {
        ...
        /// Creates an instance of a <see cref="PostCorrectionsOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source posted = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source posted = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source posted = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<PostCorrectionsOk> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PostCorrectionsOk>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostCorrectionsOk> Create<TContext>(
    ...
    public static ParsedJsonDocument<PostCorrectionsOk> Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonInteger.Source posted = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
