...
public readonly partial struct PostReportOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostReportOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostReportOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostReportOk(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostReportOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostReportOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostReportOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostReportOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostReportOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostReportOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostReportOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostReportOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostReportOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PostReportOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(PostReportOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PostReportOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostReportOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source reportUrl = default)
        {
        ...
        /// Creates an instance of a <see cref="PostReportOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source reportUrl = default)
        {
            Create(ref _builder, reportUrl);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source reportUrl = default)
    {
        return new Source(reportUrl);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source reportUrl = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(reportUrl);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostReportOk, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<PostReportOk> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PostReportOk>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostReportOk> Create<TContext>(
    ...
    public static ParsedJsonDocument<PostReportOk> Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonUri.Source reportUrl = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
