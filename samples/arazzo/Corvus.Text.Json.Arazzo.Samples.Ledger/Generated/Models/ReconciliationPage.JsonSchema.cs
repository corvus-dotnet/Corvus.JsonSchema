    ...
    : IJsonElement<ReconciliationPage>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReconciliationsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("reconciliations"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReconciliationsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("reconciliations"u8, buffer, out written);

        private const int RequiredOffsetForReconciliations = 0;
        private const uint RequiredBitForReconciliations = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForReconciliations;
        ...
        private static readonly JsonSchemaPathProvider ReconciliationsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/reconciliations"u8, buffer, out written);
        ...
        private static void MatchNextPageToken(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            context.CommitChildContext(childContext.IsMatch, ref childContext);
        }

        private static void MatchReconciliations(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ReconciliationsUtf8,
                    evaluationPath: ReconciliationsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForReconciliations] |= RequiredBitForReconciliations;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Ledger.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.ReconciliationsUtf8, MatchReconciliations),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/ReconciliationPage"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/ReconciliationPage";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/ReconciliationPage"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReconciliationsPresent, "reconciliations"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForReconciliations] & RequiredBitForReconciliations) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyReconciliationsNotPresent, "reconciliations"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReconciliationsPresent, "reconciliations"u8, "required"u8);
