...
public readonly partial struct ReconciliationPage
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ReconciliationPage instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ReconciliationPage"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ReconciliationPage(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Mutable Reconciliations
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReconciliationsUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Set the <c>reconciliations</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetReconciliations(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("reconciliations");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReconciliationsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Reconciliations, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetReconciliations<TContext>(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ReconciliationPage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly ReconciliationPage Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly ReconciliationPage Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ReconciliationPage>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(ReconciliationPage instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ReconciliationPage"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source reconciliations,
            in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
        {
            reconciliations.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Reconciliations, ref builder);
        ...
        /// Creates an instance of a <see cref="ReconciliationPage"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source reconciliations, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
        {
            Create(ref _builder, reconciliations, nextPageToken);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source<TContext> reconciliations,
            in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, reconciliations, nextPageToken);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// </summary>
    /// <param name="reconciliations">The value of the <c>"reconciliations"</c> property.</param>
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source reconciliations, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
    {
        return new Source(reconciliations, nextPageToken);
    }
    ...
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source<TContext> reconciliations, scoped in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, reconciliations, nextPageToken);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="reconciliations">The value of the property.</param>
    /// <param name="nextPageToken">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source reconciliations, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(reconciliations, nextPageToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source<TContext> reconciliations, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, reconciliations, nextPageToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ReconciliationPage, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ReconciliationPage> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ReconciliationPage>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ReconciliationPage> Create<TContext>(
    ...
    public static ParsedJsonDocument<ReconciliationPage> Create(in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source reconciliations, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ReconciliationPage> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray.Source<TContext> reconciliations, in Corvus.Text.Json.Arazzo.Samples.Ledger.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
