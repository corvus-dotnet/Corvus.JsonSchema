...
public readonly partial struct ReconciliationPage
    ...
    : IJsonElement<ReconciliationPage>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReconciliationPage"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ReconciliationPage(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ReconciliationPage DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the <c>reconciliations</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray Reconciliations
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReconciliationsUtf8, out Corvus.Text.Json.Arazzo.Samples.Ledger.Models.ReconciliationPage.ReconciliationViewArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in ReconciliationPage left, in ReconciliationPage right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ReconciliationPage left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ReconciliationPage instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ReconciliationPage(JsonElement instance)
    {
        return ReconciliationPage.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReconciliationPage From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReconciliationPage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ReconciliationPage>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReconciliationPage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ReconciliationPage>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReconciliationPage ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ReconciliationPage>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static ReconciliationPage ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ReconciliationPage>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ReconciliationPage? result)
    {
        return JsonElementHelpers.TryParseValue<ReconciliationPage>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ReconciliationPage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ReconciliationPage IJsonElement<ReconciliationPage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ReconciliationPage: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="ReconciliationPage"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="ReconciliationPage"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public ReconciliationPage Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<ReconciliationPage>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="ReconciliationPage"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public ReconciliationPage Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<ReconciliationPage>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Reconciliations"/>.
        /// </summary>
        public const string Reconciliations = "reconciliations";
        ...
        /// Gets the JSON property name for <see cref="Reconciliations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ReconciliationsUtf8 => "reconciliations"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Reconciliations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Reconciliations => "reconciliations"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Reconciliations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Reconciliations => [0x15, 0x01, 0x00, 0x00, 0x22, 0x72, 0x65, 0x63, 0x6F, 0x6E, 0x63, 0x69, 0x6C, 0x69, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x73, 0x22];
    }
}
