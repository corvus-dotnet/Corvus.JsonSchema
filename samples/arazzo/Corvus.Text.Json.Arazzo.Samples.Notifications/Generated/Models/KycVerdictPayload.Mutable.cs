...
public readonly partial struct KycVerdictPayload
{
...
#endif
    {
        ...
        public static explicit operator Mutable(KycVerdictPayload instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="KycVerdictPayload"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator KycVerdictPayload(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Mutable AccountId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccountIdUtf8, out Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Mutable Score
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScoreUtf8, out Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>verified</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Mutable Verified
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerifiedUtf8, out Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new KycVerdictPayload(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>accountId</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAccountId(scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("accountId");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccountIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AccountId, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScore(scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("score");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetVerified(scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("verified");
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"KycVerdictPayload.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="KycVerdictPayload"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="KycVerdictPayload"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly KycVerdictPayload Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<KycVerdictPayload>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="KycVerdictPayload"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly KycVerdictPayload Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<KycVerdictPayload>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Source _createArg3;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Source arg2, scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(KycVerdictPayload instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="KycVerdictPayload"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Source accountId,
            in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Source score,
            in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Source verified)
        {
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Source verified)
        {
            Create(ref _builder, accountId, score, verified);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Source arg2, scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Source accountId, scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Source score, scoped in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Source verified)
    {
        return new Source(accountId, score, verified);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Source accountId, in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Source score, in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Source verified, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(accountId, score, verified);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<KycVerdictPayload, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<KycVerdictPayload> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<KycVerdictPayload>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<KycVerdictPayload> Create<TContext>(
    ...
    public static ParsedJsonDocument<KycVerdictPayload> Create(in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonString.Source accountId, in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload.ScoreEntity.Source score, in Corvus.Text.Json.Arazzo.Samples.Notifications.Models.JsonBoolean.Source verified, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
