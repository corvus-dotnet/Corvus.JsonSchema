...
public readonly partial struct KycVerdictPayload
{
    ...
    public readonly partial struct ScoreEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ScoreEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ScoreEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ScoreEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ScoreEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ScoreEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ScoreEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ScoreEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ScoreEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ScoreEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ScoreEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ScoreEntity>();
            }
            finally
            {
