...
/// <summary>
/// Producer for the <c>publishKycReview</c> operation on channel <c>kyc.requests</c>.
/// </summary>
public sealed class PublishKycReviewProducer
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PublishKycReviewProducer"/> class.
    /// </summary>
    ...
    public PublishKycReviewProducer(IMessageTransport transport, ValidationMode validationMode = ValidationMode.Basic, IMessageAuthenticationProvider? authProvider = null)
    {
    ...
    /// <summary>
    /// Publishes a <c>kycReviewRequest</c> message.
    /// </summary>
    /// <param name="payload">The message payload.</param>
    /// <param name="cancellationToken">A cancellation token.</param>
    public ValueTask PublishKycReviewRequestAsync(Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycReviewRequestPayload.Source payload, CancellationToken cancellationToken = default)
    {
        JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
        Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycReviewRequestPayload payloadValue = Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycReviewRequestPayload.CreateBuilder(workspace, payload, 30).RootElement;
