...
public sealed class ReceiveKycReviewConsumer : IAsyncDisposable
{
    ...
    public async ValueTask StartAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            await this.transport.SubscribeAsync<Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycReviewRequestPayload>(ChannelAddressUtf8, this.HandleMessageAsync, cancellationToken).ConfigureAwait(false);
        }
        catch
        {
