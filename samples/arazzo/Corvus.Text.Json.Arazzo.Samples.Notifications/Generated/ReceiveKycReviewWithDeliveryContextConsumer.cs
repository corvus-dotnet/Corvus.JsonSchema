...
/// </summary>
public sealed class ReceiveKycReviewWithDeliveryContextConsumer : IAsyncDisposable
{
    private readonly IMessageDeliveryContextTransport transport;
    private readonly IReceiveKycReviewWithDeliveryContextHandler handler;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReceiveKycReviewWithDeliveryContextConsumer"/> class.
    /// </summary>
    ...
    public ReceiveKycReviewWithDeliveryContextConsumer(IMessageDeliveryContextTransport transport, IReceiveKycReviewWithDeliveryContextHandler handler, ValidationMode validationMode = ValidationMode.Basic, IMessageErrorPolicy? errorPolicy = null, IMessageAuthenticationProvider? authProvider = null)
    {
    ...
    public async ValueTask StartAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            await this.transport.SubscribeWithDeliveryContextAsync<Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycReviewRequestPayload>(ChannelAddressUtf8, this.HandleMessageAsync, cancellationToken).ConfigureAwait(false);
        }
        catch
        {
    ...
    private async ValueTask HandleMessageAsync(Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycReviewRequestPayload payload, MessageDeliveryContext deliveryContext, CancellationToken cancellationToken)
    {
        ...
        if (failure is null)
        {
            try
            {
                await this.handler.HandleKycReviewRequestAsync(payload, deliveryContext, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception ex)
            {
                failure = ex;
