...
public sealed class ReceiveKycVerdictConsumer : IAsyncDisposable
{
    ...
    {
        return this.transport.SubscribeAsync<Corvus.Text.Json.Arazzo.Samples.Notifications.Models.KycVerdictPayload>(ChannelAddressUtf8, this.HandleMessageAsync, cancellationToken);
    }
