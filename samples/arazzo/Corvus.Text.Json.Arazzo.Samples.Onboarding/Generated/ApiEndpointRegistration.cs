...
public static class ApiEndpointRegistration
{
    ...
    public static IEndpointRouteBuilder MapApiEndpoints(this IEndpointRouteBuilder app, IApiDefaultHandler defaultHandler, ApiServerOptions? serverOptions = null)
    {
        return MapApiEndpoints(app, defaultHandler, configureEndpoint: null, serverOptions: serverOptions);
    }
    ...
    /// <param name="serverOptions">Optional registration-time server options (request body limits, etc.). When <see langword="null"/>, defaults are used.</param>
    /// <returns>The endpoint route builder for chaining.</returns>
    public static IEndpointRouteBuilder MapApiEndpoints(this IEndpointRouteBuilder app, IApiDefaultHandler defaultHandler, ConfigureEndpoint? configureEndpoint, ApiServerOptions? serverOptions = null)
    {
        serverOptions ??= new ApiServerOptions();

        IEndpointConventionBuilder __ListAccountsEndpoint = app.MapGet("/accounts", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {
                Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.GetAccountsLimit LimitValue = default;
                if (context.Request.Query.TryGetValue("limit", out var LimitQueryVal) && LimitQueryVal.Count > 0)
                {
                    string LimitRaw = LimitQueryVal[0]!;
                    LimitValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseNumber<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.GetAccountsLimit>(LimitRaw, workspace);
                }
                Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString PageTokenValue = default;
                if (context.Request.Query.TryGetValue("pageToken", out var PageTokenQueryVal) && PageTokenQueryVal.Count > 0)
                {
                    ...
                    PageTokenValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseString<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString>(PageTokenRaw, workspace);
                }
                ...
                ListAccountsParams parameters = new()
                {
                    Limit = LimitValue,
                ...
                ListAccountsResult result = await defaultHandler.HandleListAccountsAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        IEndpointConventionBuilder __GetAccountEndpoint = app.MapGet("/accounts/{accountId}", async (HttpContext context) =>
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            try
            {
                ...
                GetAccountParams parameters = new()
                {
                    AccountId = AccountIdValue,
                }
                ;

                GetAccountResult result = await defaultHandler.HandleGetAccountAsync(parameters, workspace, context.RequestAborted).ConfigureAwait(false);
        ...
        configureEndpoint?.Invoke(
            new EndpointDescriptor(
                ...
                httpMethod: "GET",
                routeTemplate: "/accounts/{accountId}",
                tags: System.Array.Empty<string>(),
                isCallback: false,
                securityRequirements: System.Array.Empty<EndpointSecurityRequirementSet>()),
