...
public readonly partial struct AccountPage
    : IJsonElement<AccountPage>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAccountsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("accounts"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAccountsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("accounts"u8, buffer, out written);

        private const int RequiredOffsetForAccounts = 0;
        private const uint RequiredBitForAccounts = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForAccounts;
        private static readonly JsonSchemaPathProvider AccountsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/accounts"u8, buffer, out written);
        ...
        private static void MatchAccounts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.AccountsUtf8,
                    evaluationPath: AccountsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForAccounts] |= RequiredBitForAccounts;
        }
        ...
        private static void MatchNextPageToken(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.AccountsUtf8, MatchAccounts),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/AccountPage"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/AccountPage";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/AccountPage"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAccountsPresent, "accounts"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAccounts] & RequiredBitForAccounts) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAccountsNotPresent, "accounts"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAccountsPresent, "accounts"u8, "required"u8);
