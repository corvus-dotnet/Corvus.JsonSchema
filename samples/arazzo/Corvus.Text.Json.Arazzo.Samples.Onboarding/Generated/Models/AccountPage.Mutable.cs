...
/// <remarks>
/// <para>
/// A page of onboarding accounts, newest first, with an opaque continuation token.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct AccountPage
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AccountPage instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AccountPage"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AccountPage(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>accounts</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Mutable Accounts
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccountsUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Mutable value))
                {
                    return value;
                }
        ...
        /// <remarks>
        /// <para>
        /// Pass as pageToken to fetch the next page; absent on the last page.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Mutable NextPageToken
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NextPageTokenUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AccountPage(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>accounts</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAccounts(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("accounts");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccountsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Accounts, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAccounts<TContext>(in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetNextPageToken(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AccountPage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AccountPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AccountPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AccountPage Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AccountPage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AccountPage"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AccountPage Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AccountPage>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(AccountPage instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AccountPage"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source accounts,
            in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source nextPageToken = default)
        {
            accounts.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Accounts, ref builder);
        ...
        /// Creates an instance of a <see cref="AccountPage"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source accounts, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source nextPageToken = default)
        {
            Create(ref _builder, accounts, nextPageToken);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source<TContext> accounts,
            in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, accounts, nextPageToken);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// </summary>
    /// <param name="accounts">The value of the <c>"accounts"</c> property.</param>
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source accounts, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source nextPageToken = default)
    {
        return new Source(accounts, nextPageToken);
    }
    ...
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source<TContext> accounts, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, accounts, nextPageToken);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="accounts">The value of the property.</param>
    /// <param name="nextPageToken">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source accounts, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(accounts, nextPageToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source<TContext> accounts, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, accounts, nextPageToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<AccountPage, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AccountPage> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AccountPage>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccountPage> Create<TContext>(
    ...
    public static ParsedJsonDocument<AccountPage> Create(in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source accounts, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccountPage> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountPage.AccountViewArray.Source<TContext> accounts, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
