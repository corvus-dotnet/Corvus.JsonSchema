...
public readonly partial struct AccountView
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AccountView instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AccountView"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AccountView(Mutable instance)
        {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Mutable ProvisionedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvisionedAtUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.Mutable Provisioning
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvisioningUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountView.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountView.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Mutable SubmittedAt
        {
            get
            {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Mutable WelcomedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WelcomedAtUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Set the <c>provisionedAt</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetProvisionedAt(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProvisionedAtUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvisionedAtUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ProvisionedAt, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>provisionedAt</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveProvisionedAt()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProvisionedAtUtf8);
            _documentVersion = _parent.Version;
            return result;
        }

        /// <summary>
        /// Set the <c>provisioning</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetProvisioning(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProvisioningUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvisioningUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Provisioning, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetProvisioning<TContext>(in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.Source<TContext> value)
        ...
        /// <summary>
        /// Remove the <c>provisioning</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveProvisioning()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProvisioningUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountView.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSubmittedAt(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>welcomedAt</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWelcomedAt(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WelcomedAtUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WelcomedAtUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.WelcomedAt, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>welcomedAt</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveWelcomedAt()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WelcomedAtUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AccountView.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly AccountView Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly AccountView Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AccountView>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(AccountView instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AccountView"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<AccountView, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AccountView> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AccountView>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccountView> Create<TContext>(
    ...
    public static ParsedJsonDocument<AccountView> Create(in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonUuid.Source accountId, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountView.StatusEntity.Source status, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Source submittedAt, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source email = default, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountView.PlanEntity.Source plan = default, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Source provisionedAt = default, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.Source provisioning = default, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Source welcomedAt = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccountView> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonUuid.Source accountId, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountView.StatusEntity.Source status, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Source submittedAt, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source email = default, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.AccountView.PlanEntity.Source plan = default, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Source provisionedAt = default, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.Source<TContext> provisioning = default, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime.Source welcomedAt = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
