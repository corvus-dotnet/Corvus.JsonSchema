...
public readonly partial struct AccountView
{
    ...
    public readonly partial struct PlanEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PlanEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PlanEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PlanEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PlanEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PlanEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PlanEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PlanEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PlanEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PlanEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PlanEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PlanEntity>();
            }
            finally
            {
