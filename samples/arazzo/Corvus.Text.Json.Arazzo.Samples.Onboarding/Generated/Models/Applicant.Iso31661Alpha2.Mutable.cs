...
public readonly partial struct Applicant
{
    ...
    public readonly partial struct Iso31661Alpha2
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Iso31661Alpha2 instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Iso31661Alpha2"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Iso31661Alpha2(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Iso31661Alpha2.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Iso31661Alpha2 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Iso31661Alpha2 Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Iso31661Alpha2>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Iso31661Alpha2 instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Iso31661Alpha2, Mutable>(this);
        }
    }
}
