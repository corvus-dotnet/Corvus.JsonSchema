...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Applicant.Iso31661Alpha2 Country
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountryUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Applicant.Iso31661Alpha2 value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDate DateOfBirth
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateOfBirthUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDate value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Applicant.FullNameEntity FullName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FullNameUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Applicant.FullNameEntity value))
            {
                return value;
            }
