...
public readonly partial struct BiometricEvidence
{
        ...
        : IJsonElement<KindEntity>
    {
        ...
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Const = "biometric"u8.ToArray();
            /// <summary>
            /// A constant for the <c>const</c> keyword.
            /// </summary>
            public static readonly KindEntity ConstJson = ParsedJsonDocument<KindEntity>.StringConstant([.."\"biometric\""u8]);
        }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/BiometricEvidence/properties/kind"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/BiometricEvidence/properties/kind";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/BiometricEvidence/properties/kind"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "biometric"u8, "biometric", "const"u8, ref context);
                }
                else
                {
                    context.EvaluatedKeyword(false, "biometric", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                }
            }
