...
public readonly partial struct BiometricEvidence
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Mutable Confidence
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfidenceUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.KindEntity.Mutable Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.KindEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Mutable Modality
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModalityUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetConfidence(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetKind(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.KindEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetModality(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source confidence,
            in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Source modality)
        {
            confidence.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Confidence, ref builder);
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Kind, Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.KindEntity.ConstInstance);
        ...
        /// Creates an instance of a <see cref="BiometricEvidence"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source confidence, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Source modality)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source confidence, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Source modality)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ConfidenceEntity.Source confidence, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.BiometricEvidence.ModalityEntity.Source modality, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
