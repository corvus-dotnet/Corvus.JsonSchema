...
/// <remarks>
/// <para>
/// The signup facts the onboarding service owns: who the account is for and the plan they chose. Identity verification is a separate concern owned by the KYC service.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct CreateAccountRequest
{
...
#endif
    {
        ...
        public static explicit operator Mutable(CreateAccountRequest instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="CreateAccountRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CreateAccountRequest(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Mutable Plan
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PlanUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new CreateAccountRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPlan(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CreateAccountRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="CreateAccountRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="CreateAccountRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly CreateAccountRequest Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<CreateAccountRequest>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="CreateAccountRequest"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly CreateAccountRequest Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<CreateAccountRequest>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(CreateAccountRequest instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="CreateAccountRequest"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source email,
            in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Source plan = default)
        {
        ...
        /// Creates an instance of a <see cref="CreateAccountRequest"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source email, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Source plan = default)
        {
            Create(ref _builder, email, plan);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source arg1, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source email, scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Source plan = default)
    {
        return new Source(email, plan);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source email, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Source plan = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(email, plan);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<CreateAccountRequest, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<CreateAccountRequest> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<CreateAccountRequest>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<CreateAccountRequest> Create<TContext>(
    ...
    public static ParsedJsonDocument<CreateAccountRequest> Create(in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonIdnEmail.Source email, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.CreateAccountRequest.TheChosenPlan.Source plan = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
