...
public readonly partial struct CreateAccountRequest
{
    public readonly partial struct TheChosenPlan
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheChosenPlan instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheChosenPlan"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheChosenPlan(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheChosenPlan.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly TheChosenPlan Clone()
            {
                CheckValidInstance();
            ...
            public readonly TheChosenPlan Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheChosenPlan>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheChosenPlan instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (TheChosenPlan)value;
        ...
        {
            return workspace.CreateBuilder<TheChosenPlan, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheChosenPlan> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheChosenPlan>();
            }
            finally
            {
