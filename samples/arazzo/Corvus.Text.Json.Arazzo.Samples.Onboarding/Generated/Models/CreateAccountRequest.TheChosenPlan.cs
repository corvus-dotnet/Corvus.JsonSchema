...
public readonly partial struct CreateAccountRequest
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheChosenPlan"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheChosenPlan(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheChosenPlan DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheChosenPlan value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheChosenPlan left, in TheChosenPlan right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheChosenPlan left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheChosenPlan instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheChosenPlan(JsonElement instance)
        {
            return TheChosenPlan.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheChosenPlan From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheChosenPlan ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheChosenPlan>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheChosenPlan ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheChosenPlan>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheChosenPlan ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheChosenPlan>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static TheChosenPlan ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheChosenPlan>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheChosenPlan? result)
        {
            return JsonElementHelpers.TryParseValue<TheChosenPlan>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheChosenPlan(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheChosenPlan IJsonElement<TheChosenPlan>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheChosenPlan: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheChosenPlan"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheChosenPlan"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheChosenPlan Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheChosenPlan>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheChosenPlan"/> that lives for the lifetime of its
        ...
        /// <param name="matchFree">Match 1st item.</param>
        /// <param name="matchPro">Match 2nd item.</param>
        /// <param name="matchEnterprise">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchFree,
            Func<TContext, TResult> matchPro,
            Func<TContext, TResult> matchEnterprise,
...
#endif
        {
            ...
            {
                return matchFree(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchPro(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchEnterprise(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchFree,
            Func<TResult> matchPro,
            Func<TResult> matchEnterprise,
