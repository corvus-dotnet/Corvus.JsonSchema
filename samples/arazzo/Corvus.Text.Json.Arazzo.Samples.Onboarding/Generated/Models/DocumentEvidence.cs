...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DocumentEvidence"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal DocumentEvidence(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static DocumentEvidence DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.DocumentEvidence.DocumentNumberEntity DocumentNumber
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentNumberUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.DocumentEvidence.DocumentNumberEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.DocumentEvidence.DocumentTypeEntity DocumentType
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentTypeUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.DocumentEvidence.DocumentTypeEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDate Expiry
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpiryUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDate value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.DocumentEvidence.KindEntity Kind
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.DocumentEvidence.KindEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in DocumentEvidence left, in DocumentEvidence right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in DocumentEvidence left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(DocumentEvidence instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator DocumentEvidence(JsonElement instance)
    {
        return DocumentEvidence.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DocumentEvidence From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DocumentEvidence ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DocumentEvidence>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DocumentEvidence ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DocumentEvidence>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DocumentEvidence ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DocumentEvidence>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static DocumentEvidence ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DocumentEvidence>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out DocumentEvidence? result)
    {
        return JsonElementHelpers.TryParseValue<DocumentEvidence>(ref reader, out result);
    }
...
#if NET
    static DocumentEvidence IJsonElement<DocumentEvidence>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"DocumentEvidence: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public DocumentEvidence Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<DocumentEvidence>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="DocumentNumber"/>.
        /// </summary>
        public const string DocumentNumber = "documentNumber";

        /// <summary>
        /// Gets the JSON property name for <see cref="DocumentType"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="DocumentNumber"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DocumentNumberUtf8 => "documentNumber"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="DocumentType"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DocumentTypeUtf8 => "documentType"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="DocumentNumber"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DocumentNumber => "documentNumber"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="DocumentType"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DocumentType => "documentType"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="DocumentNumber"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DocumentNumber => [0x05, 0x01, 0x00, 0x00, 0x22, 0x64, 0x6F, 0x63, 0x75, 0x6D, 0x65, 0x6E, 0x74, 0x4E, 0x75, 0x6D, 0x62, 0x65, 0x72, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="DocumentType"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DocumentType => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x64, 0x6F, 0x63, 0x75, 0x6D, 0x65, 0x6E, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22];
