    ...
    : IJsonElement<GetAccountsLimit>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1accounts/get/parameters/0/schema"u8, buffer, out written);
            ...
            ref JsonSchemaContext context)
        {
            ...
            {
                JsonSchemaEvaluation.MatchLessThanOrEquals(isNegative, integral, fractional, exponent, false, "2"u8, ""u8, 2, "200", "maximum"u8, ref context);
