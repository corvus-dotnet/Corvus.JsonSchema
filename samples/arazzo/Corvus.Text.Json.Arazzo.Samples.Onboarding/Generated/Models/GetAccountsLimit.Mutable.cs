...
public readonly partial struct GetAccountsLimit
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAccountsLimit instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAccountsLimit"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAccountsLimit(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAccountsLimit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetAccountsLimit Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetAccountsLimit Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAccountsLimit>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetAccountsLimit instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetAccountsLimit, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetAccountsLimit> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetAccountsLimit>();
        }
        finally
        {
