...
public readonly partial struct IdentityRequest
{
    ...
    public readonly partial struct FullNameEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(FullNameEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FullNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FullNameEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FullNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly FullNameEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly FullNameEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FullNameEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(FullNameEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<FullNameEntity, Mutable>(this);
        }
    }
}
