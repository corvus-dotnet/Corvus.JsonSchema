...
#endif
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityRequest.DocumentNumberEntity DocumentNumber
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentNumberUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityRequest.DocumentNumberEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityRequest.FullNameEntity FullName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FullNameUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityRequest.FullNameEntity value))
            {
                return value;
            }
