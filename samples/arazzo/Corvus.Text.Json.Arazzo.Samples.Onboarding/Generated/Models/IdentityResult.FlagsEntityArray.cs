...
public readonly partial struct IdentityResult
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.FlagsEntityArray.FlagsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.FlagsEntityArray.FlagsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.FlagsEntityArray.FlagsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.FlagsEntityArray.FlagsEntity>(_parent, _idx);
        }
