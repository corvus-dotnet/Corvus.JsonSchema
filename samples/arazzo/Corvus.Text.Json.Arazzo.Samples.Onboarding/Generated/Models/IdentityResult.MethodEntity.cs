...
public readonly partial struct IdentityResult
{
...
#endif
    {
        ...
        /// <param name="matchDocument">Match 1st item.</param>
        /// <param name="matchBiometric">Match 2nd item.</param>
        /// <param name="matchKnowledgeBased">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchDocument,
            Func<TContext, TResult> matchBiometric,
            Func<TContext, TResult> matchKnowledgeBased,
...
#endif
        {
            ...
            {
                return matchDocument(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchBiometric(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchKnowledgeBased(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchDocument,
            Func<TResult> matchBiometric,
            Func<TResult> matchKnowledgeBased,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum2))
            {
                return matchBiometric();
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchKnowledgeBased();
            }
