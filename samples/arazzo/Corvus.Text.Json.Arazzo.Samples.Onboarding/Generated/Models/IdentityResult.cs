...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Evidence Evidence
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EvidenceUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Evidence value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.FlagsEntityArray Flags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlagsUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.FlagsEntityArray value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.MethodEntity Method
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.MethodEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime ReviewedAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReviewedAtUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.MatchConfidence01 Score
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScoreUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.IdentityResult.MatchConfidence01 value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonBoolean Verified
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerifiedUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonBoolean value))
            {
                return value;
            }
