...
public readonly partial struct JsonDateTime
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonDateTime instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonDateTime"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonDateTime(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonDateTime.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonDateTime"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonDateTime"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonDateTime Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonDateTime"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonDateTime Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonDateTime>(_idx);
        }
    }
    ...
    {
        return workspace.CreateBuilder<JsonDateTime, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonDateTime> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonDateTime>();
        }
        finally
        {
