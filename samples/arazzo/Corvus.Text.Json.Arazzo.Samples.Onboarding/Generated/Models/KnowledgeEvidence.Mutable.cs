...
public readonly partial struct KnowledgeEvidence
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.KindEntity.Mutable Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.KindEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Mutable QuestionsPassed
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuestionsPassedUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetKind(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.KindEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetQuestionsPassed(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Source questionsPassed)
        {
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Kind, Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.KindEntity.ConstInstance);
        ...
        /// Creates an instance of a <see cref="KnowledgeEvidence"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Source questionsPassed)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Source questionsPassed)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.KnowledgeEvidence.QuestionsPassedEntity.Source questionsPassed, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
