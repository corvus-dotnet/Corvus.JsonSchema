...
public readonly partial struct Provisioning
{
    ...
    public readonly partial struct ArbitraryResourceTagsKeyValue
#if NET8_0_OR_GREATER
        : IJsonElement<ArbitraryResourceTagsKeyValue>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArbitraryResourceTagsKeyValue"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ArbitraryResourceTagsKeyValue(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ArbitraryResourceTagsKeyValue DefaultInstance { get; }
        ...
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString this[ReadOnlySpan<byte> propertyName]
        {
            get
            {
                CheckValidInstance();
                if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString value))
                {
                    return default;
                }
        ...
        /// <returns>The value of the property with the given name.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString this[ReadOnlySpan<char> propertyName]
        {
            get
            {
                CheckValidInstance();
        ...
        /// <returns>The value of the property with the given name.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString this[string propertyName]
        {
            get
            {
                CheckValidInstance();
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString value)
        {
            CheckValidInstance();
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(string propertyName, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public ObjectEnumerator<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString> EnumerateObject()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateObjectEnumerator<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ArbitraryResourceTagsKeyValue left, in ArbitraryResourceTagsKeyValue right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ArbitraryResourceTagsKeyValue left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ArbitraryResourceTagsKeyValue instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ArbitraryResourceTagsKeyValue(JsonElement instance)
        {
            return ArbitraryResourceTagsKeyValue.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArbitraryResourceTagsKeyValue From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArbitraryResourceTagsKeyValue ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ArbitraryResourceTagsKeyValue>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArbitraryResourceTagsKeyValue ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ArbitraryResourceTagsKeyValue>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ArbitraryResourceTagsKeyValue ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ArbitraryResourceTagsKeyValue>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ArbitraryResourceTagsKeyValue ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ArbitraryResourceTagsKeyValue>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ArbitraryResourceTagsKeyValue? result)
        {
            return JsonElementHelpers.TryParseValue<ArbitraryResourceTagsKeyValue>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ArbitraryResourceTagsKeyValue(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ArbitraryResourceTagsKeyValue IJsonElement<ArbitraryResourceTagsKeyValue>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ArbitraryResourceTagsKeyValue: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ArbitraryResourceTagsKeyValue"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ArbitraryResourceTagsKeyValue"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ArbitraryResourceTagsKeyValue Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ArbitraryResourceTagsKeyValue>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ArbitraryResourceTagsKeyValue"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ArbitraryResourceTagsKeyValue Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ArbitraryResourceTagsKeyValue>(_idx);
            }
