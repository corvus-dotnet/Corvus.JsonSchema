...
public readonly partial struct Provisioning
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Resource this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Resource>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Resource> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Resource>(_parent, _idx);
        }
