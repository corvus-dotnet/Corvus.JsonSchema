...
#endif
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonUri AccountUrl
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccountUrlUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonUri value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.QuotaGbEntity QuotaGb
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuotaGbUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.QuotaGbEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.ResourceArray Resources
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResourcesUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.ResourceArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.ArbitraryResourceTagsKeyValue Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Provisioning.ArbitraryResourceTagsKeyValue value))
            {
                return value;
            }
