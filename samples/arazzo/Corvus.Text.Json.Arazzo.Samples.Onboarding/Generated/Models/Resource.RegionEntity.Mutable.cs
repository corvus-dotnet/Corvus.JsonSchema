...
public readonly partial struct Resource
{
    public readonly partial struct RegionEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RegionEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RegionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RegionEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RegionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly RegionEntity Clone()
            {
                CheckValidInstance();
            ...
            public readonly RegionEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RegionEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RegionEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (RegionEntity)value;
        ...
        {
            return workspace.CreateBuilder<RegionEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RegionEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RegionEntity>();
            }
            finally
            {
