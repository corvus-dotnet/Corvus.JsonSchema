...
#endif
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonUri Endpoint
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EndpointUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonUri value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Resource.KindEntity Kind
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Resource.KindEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Resource.RegionEntity Region
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegionUtf8, out Corvus.Text.Json.Arazzo.Samples.Onboarding.Models.Resource.RegionEntity value))
            {
                return value;
            }
