// <copyright file="OnboardingPageToken.cs" company="Endjin Limited">
...
/// <summary>
/// The opaque keyset continuation token for <see cref="OnboardingAccountStore.ListAsync"/>: the (SubmittedAt,
/// AccountId) of the last row on a page, base64url-encoded so the client treats it as opaque.
/// </summary>
public static class OnboardingPageToken
{
