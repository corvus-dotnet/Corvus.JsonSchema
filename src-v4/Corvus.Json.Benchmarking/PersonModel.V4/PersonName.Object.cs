...
public readonly partial struct PersonName
    : IJsonObject<Corvus.Json.Benchmarking.Models.V4.PersonName>
{
    /// <summary>
    ...
    public Corvus.Json.Benchmarking.Models.V4.PersonNameElement FamilyName
    {
        get
        {
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Corvus.Json.Benchmarking.Models.V4.PersonNameElement>();
                }
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Json.Benchmarking.Models.V4.OtherNames OtherNames
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Corvus.Json.Benchmarking.Models.V4.OtherNames>();
                }
            }
    ...
    public static PersonName Create(
        in Corvus.Json.Benchmarking.Models.V4.PersonNameElement familyName,
        in Corvus.Json.Benchmarking.Models.V4.PersonNameElement? givenName = null,
        in Corvus.Json.Benchmarking.Models.V4.OtherNames? otherNames = null)
    {
