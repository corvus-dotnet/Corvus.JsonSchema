...
/// <summary>
/// A validation handler for <see cref="ISingleConstantValidationKeyword"/> capability.
/// </summary>
public sealed class ConstValidationHandler : KeywordValidationHandlerBase
{
    ...
    /// </summary>
    public static ConstValidationHandler Instance { get; } = new();
    ...
    {
        return generator
            .AppendConstValidation(generator.ValidationHandlerMethodName(this), typeDeclaration, this.ChildHandlers, this.ValidationHandlerPriority);
    }
