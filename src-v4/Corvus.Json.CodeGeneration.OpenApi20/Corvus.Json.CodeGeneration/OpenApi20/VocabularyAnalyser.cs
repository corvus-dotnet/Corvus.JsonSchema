...
/// <summary>
/// A vocabulary analyser for OpenApi20 (Swagger).
/// </summary>
/// <remarks>
/// Like the OpenApi30 analyser, this claims the draft-04
/// <c>$schema</c> URI; the Draft4 analyser is registered before it at every
/// registration site and wins first-match analysis, so the OpenApi20 vocabulary
/// is only ever selected explicitly (as a default/fallback vocabulary).
/// </remarks>
