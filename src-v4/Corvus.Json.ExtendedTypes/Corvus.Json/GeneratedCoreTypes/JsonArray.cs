...

{
    ...
    /// </summary>
    public static string SchemaLocation { get; } = "#/$defs/JsonArray";
    ...
    /// <summary>
    /// Parses the JsonArray.
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonArray Parse(string source, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonArray Parse(Stream source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonArray Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonArray Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonArray Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonArray ParseValue(string source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonArray>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<JsonArray>(source.AsSpan());
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonArray ParseValue(ReadOnlySpan<char> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonArray>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<JsonArray>(source);
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonArray ParseValue(ReadOnlySpan<byte> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonArray>.ParseValue(source);
#else
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonArray ParseValue(ref Utf8JsonReader source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonArray>.ParseValue(ref source);
#else
        return JsonValueHelpers.ParseValue<JsonArray>(ref source);
#endif
    }
    ...
    {
        return
            (obj is IJsonValue jv && this.Equals(jv.As<JsonArray>())) ||
    ...
    {
        return this.Equals(other.As<JsonArray>());
    }
