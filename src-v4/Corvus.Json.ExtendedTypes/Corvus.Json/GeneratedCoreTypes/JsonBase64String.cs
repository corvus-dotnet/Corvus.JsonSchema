...

{
    ...
    /// </summary>
    public static string SchemaLocation { get; } = "#/$defs/JsonBase64String";
    ...
    /// <summary>
    /// Parses the JsonBase64String.
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonBase64String Parse(string source, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonBase64String Parse(Stream source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonBase64String Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonBase64String Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static JsonBase64String Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonBase64String ParseValue(string source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonBase64String>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<JsonBase64String>(source.AsSpan());
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonBase64String ParseValue(ReadOnlySpan<char> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonBase64String>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<JsonBase64String>(source);
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonBase64String ParseValue(ReadOnlySpan<byte> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonBase64String>.ParseValue(source);
#else
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static JsonBase64String ParseValue(ref Utf8JsonReader source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<JsonBase64String>.ParseValue(ref source);
#else
        return JsonValueHelpers.ParseValue<JsonBase64String>(ref source);
#endif
    }
    ...
    {
        return
            (obj is IJsonValue jv && this.Equals(jv.As<JsonBase64String>())) ||
    ...
    {
        return this.Equals(other.As<JsonBase64String>());
    }
