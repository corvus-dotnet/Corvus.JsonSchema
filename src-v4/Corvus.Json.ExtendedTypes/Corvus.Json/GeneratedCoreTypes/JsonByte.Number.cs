...
#if NET8_0_OR_GREATER
    : IJsonNumber<Corvus.Json.JsonByte>,
      IAdditionOperators<Corvus.Json.JsonByte, Corvus.Json.JsonByte, Corvus.Json.JsonByte>,
      ISubtractionOperators<Corvus.Json.JsonByte, Corvus.Json.JsonByte, Corvus.Json.JsonByte>,
      IMultiplyOperators<Corvus.Json.JsonByte, Corvus.Json.JsonByte, Corvus.Json.JsonByte>,
      IDivisionOperators<Corvus.Json.JsonByte, Corvus.Json.JsonByte, Corvus.Json.JsonByte>,
      IIncrementOperators<Corvus.Json.JsonByte>,
      IDecrementOperators<Corvus.Json.JsonByte>
#else
    : IJsonNumber<Corvus.Json.JsonByte>
#endif
{
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonInteger(JsonByte value)
    {
        return
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(decimal value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(double value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(short value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(int value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(long value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(sbyte value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(float value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(ushort value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(uint value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(ulong value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="JsonByte"/>.</returns>
    public static explicit operator JsonByte(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    /// </returns>
    public static bool operator <(JsonByte left, JsonByte right)
    {
    ...
    public BinaryJsonNumber AsBinaryJsonNumber
    {
        get
        {
            ...
            {
                return BinaryJsonNumber.FromJson(this.jsonElementBacking, BinaryJsonNumber.Kind.Byte);
            }
    ...
    /// Equality comparison.
    /// </summary>
    /// <param name="other">The <c>byte</c> with which to compare.</param>
