...
public readonly partial struct Core
{
    ...
    public readonly partial struct AnchorEntity
        ...
        : IJsonString<Corvus.Json.JsonSchema.Draft201909.Core.AnchorEntity>,
          ISpanFormattable
#else
        : IJsonString<Corvus.Json.JsonSchema.Draft201909.Core.AnchorEntity>
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        public AnchorEntity(in ReadOnlySpan<byte> value)
        {
            this.backing = Backing.String;
            this.jsonElementBacking = default;
        ...
        /// <summary>
        /// Concatenate 2 JSON values, producing an instance of the string type AnchorEntity.
        /// </summary>
        ...
        public static AnchorEntity Concatenate<T1, T2>(Span<byte> buffer, in T1 value1, in T2 value2)
        ...
        /// <summary>
        /// Concatenate 3 JSON values, producing an instance of the string type AnchorEntity.
        /// </summary>
        /// <typeparam name="T1">The type of the 1st value.</typeparam>
        /// <typeparam name="T2">The type of the 2nd value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static AnchorEntity Concatenate<T1, T2, T3>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3)
            where T1 : struct, IJsonValue<T1>
            where T2 : struct, IJsonValue<T2>
        ...
        /// <summary>
        /// Concatenate 4 JSON values, producing an instance of the string type AnchorEntity.
        /// </summary>
        /// <typeparam name="T1">The type of the 1st value.</typeparam>
        /// <typeparam name="T2">The type of the 2nd value.</typeparam>
        /// <typeparam name="T3">The type of the 3rd value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static AnchorEntity Concatenate<T1, T2, T3, T4>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4)
            where T1 : struct, IJsonValue<T1>
            where T2 : struct, IJsonValue<T2>
            where T3 : struct, IJsonValue<T3>
        ...
        /// <summary>
        /// Concatenate 5 JSON values, producing an instance of the string type AnchorEntity.
        /// </summary>
        /// <typeparam name="T1">The type of the 1st value.</typeparam>
        /// <typeparam name="T2">The type of the 2nd value.</typeparam>
        /// <typeparam name="T3">The type of the 3rd value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static AnchorEntity Concatenate<T1, T2, T3, T4, T5>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5)
            where T1 : struct, IJsonValue<T1>
            where T2 : struct, IJsonValue<T2>
            where T3 : struct, IJsonValue<T3>
            where T4 : struct, IJsonValue<T4>
        ...
        /// <summary>
        /// Concatenate 6 JSON values, producing an instance of the string type AnchorEntity.
        /// </summary>
        /// <typeparam name="T1">The type of the 1st value.</typeparam>
        /// <typeparam name="T2">The type of the 2nd value.</typeparam>
        /// <typeparam name="T3">The type of the 3rd value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static AnchorEntity Concatenate<T1, T2, T3, T4, T5, T6>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6)
            where T1 : struct, IJsonValue<T1>
            where T2 : struct, IJsonValue<T2>
            where T3 : struct, IJsonValue<T3>
            where T4 : struct, IJsonValue<T4>
        ...
        /// <summary>
        /// Concatenate 7 JSON values, producing an instance of the string type AnchorEntity.
        /// </summary>
        /// <typeparam name="T1">The type of the 1st value.</typeparam>
        /// <typeparam name="T2">The type of the 2nd value.</typeparam>
        /// <typeparam name="T3">The type of the 3rd value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static AnchorEntity Concatenate<T1, T2, T3, T4, T5, T6, T7>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7)
            where T1 : struct, IJsonValue<T1>
            where T2 : struct, IJsonValue<T2>
            where T3 : struct, IJsonValue<T3>
            where T4 : struct, IJsonValue<T4>
        ...
        /// <summary>
        /// Concatenate 8 JSON values, producing an instance of the string type AnchorEntity.
        /// </summary>
        /// <typeparam name="T1">The type of the 1st value.</typeparam>
        /// <typeparam name="T2">The type of the 2nd value.</typeparam>
        /// <typeparam name="T3">The type of the 3rd value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static AnchorEntity Concatenate<T1, T2, T3, T4, T5, T6, T7, T8>(Span<byte> buffer, in T1 value1, in T2 value2, in T3 value3, in T4 value4, in T5 value5, in T6 value6, in T7 value7, in T8 value8)
            where T1 : struct, IJsonValue<T1>
            where T2 : struct, IJsonValue<T2>
            where T3 : struct, IJsonValue<T3>
            where T4 : struct, IJsonValue<T4>
