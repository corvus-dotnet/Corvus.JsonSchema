...
public readonly partial struct Validation
{
...

    {
        ...
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        public StringArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        public static string SchemaLocation { get; } = "https://json-schema.org/draft/2019-09/meta/validation#/$defs/stringArray";
        ...
        public static implicit operator StringArray(JsonAny value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonAny(StringArray value)
        {
            return value.AsAny;
        }
        ...
        /// <summary>
        /// Parses the StringArray.
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static StringArray Parse(string source, JsonDocumentOptions options = default)
        {
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static StringArray Parse(Stream source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static StringArray Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static StringArray Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// <param name="source">The source of the JSON string to parse.</param>
        /// <param name="options">The (optional) JsonDocumentOptions.</param>
        public static StringArray Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
        {
            using var jsonDocument = JsonDocument.Parse(source, options);
            return new(jsonDocument.RootElement.Clone());
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static StringArray ParseValue(string source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<StringArray>.ParseValue(source);
#else
            return JsonValueHelpers.ParseValue<StringArray>(source.AsSpan());
#endif
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static StringArray ParseValue(ReadOnlySpan<char> source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<StringArray>.ParseValue(source);
#else
            return JsonValueHelpers.ParseValue<StringArray>(source);
#endif
        }
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static StringArray ParseValue(ReadOnlySpan<byte> source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<StringArray>.ParseValue(source);
#else
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static StringArray ParseValue(ref Utf8JsonReader source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<StringArray>.ParseValue(ref source);
#else
            return JsonValueHelpers.ParseValue<StringArray>(ref source);
#endif
        }
        ...
        {
            return
                (obj is IJsonValue jv && this.Equals(jv.As<StringArray>())) ||
        ...
        {
            return this.Equals(other.As<StringArray>());
        }
