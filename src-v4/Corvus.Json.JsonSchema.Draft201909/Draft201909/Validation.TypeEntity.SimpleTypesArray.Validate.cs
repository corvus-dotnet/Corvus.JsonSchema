        ...
        public readonly partial struct SimpleTypesArray
        {
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level)
                {
                    ...
                    int length = 0;
                    using JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes> arrayEnumerator = value.EnumerateArray();
                    while (arrayEnumerator.MoveNext())
                    {
                        ...
                        using JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft201909.Validation.SimpleTypes> innerEnumerator = value.EnumerateArray();
                        int innerIndex = -1;
