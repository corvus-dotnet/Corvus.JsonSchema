...

{
    ...
    /// </summary>
    public static string SchemaLocation { get; } = "https://json-schema.org/draft/2020-12/meta/applicator";
    ...
    /// </summary>
    public static Applicator Undefined { get; }

    /// <summary>
    /// Gets the default instance.
    /// </summary>
    public static Applicator DefaultInstance { get; }
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Applicator IJsonValue<Applicator>.FromString<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Applicator IJsonValue<Applicator>.FromNumber<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <returns>An instance of this type, initialized from the provided value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    static Applicator IJsonValue<Applicator>.FromArray<TValue>(in TValue value)
    {
        if (value.HasJsonElementBacking)
        {
            return new(value.AsJsonElement);
    ...
    /// <summary>
    /// Parses the Applicator.
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static Applicator Parse(string source, JsonDocumentOptions options = default)
    {
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static Applicator Parse(Stream source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static Applicator Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static Applicator Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// <param name="source">The source of the JSON string to parse.</param>
    /// <param name="options">The (optional) JsonDocumentOptions.</param>
    public static Applicator Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
    {
        using var jsonDocument = JsonDocument.Parse(source, options);
        return new(jsonDocument.RootElement.Clone());
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static Applicator ParseValue(string source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<Applicator>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<Applicator>(source.AsSpan());
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static Applicator ParseValue(ReadOnlySpan<char> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<Applicator>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<Applicator>(source);
#endif
    }
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static Applicator ParseValue(ReadOnlySpan<byte> source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<Applicator>.ParseValue(source);
#else
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static Applicator ParseValue(ref Utf8JsonReader source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<Applicator>.ParseValue(ref source);
#else
        return JsonValueHelpers.ParseValue<Applicator>(ref source);
#endif
    }
...
#else
        return this.As<Applicator, TTarget>();
#endif
    }
    ...
    {
        return
            (obj is IJsonValue jv && this.Equals(jv.As<Applicator>())) ||
    ...
    {
        return this.Equals(other.As<Applicator>());
    }
