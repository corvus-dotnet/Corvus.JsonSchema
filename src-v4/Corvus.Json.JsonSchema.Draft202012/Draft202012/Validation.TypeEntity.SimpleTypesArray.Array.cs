...
public readonly partial struct Validation
{
    ...
    public readonly partial struct TypeEntity
    {
        ...
        public readonly partial struct SimpleTypesArray
            : IJsonArray<Corvus.Json.JsonSchema.Draft202012.Validation.TypeEntity.SimpleTypesArray>,
              IReadOnlyCollection<Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static SimpleTypesArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
            ...
            /// <inheritdoc/>
            Corvus.Json.JsonAny IJsonArray<SimpleTypesArray>.this[int index]
            {
                get
                {
            ...
            public Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    ...
                    if ((this.backing & Backing.Array) != 0)
                    {
                        try
                        {
                            return this.arrayBacking[index].As<Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes>();
                        }
                        catch (ArgumentOutOfRangeException ex)
                        {
                            throw new IndexOutOfRangeException(ex.Message, ex);
            ...
            /// <summary>
            /// Create an new instance of the <see cref="SimpleTypesArray"/>" struct from a span of items.
            /// </summary>
            ...
            public static SimpleTypesArray FromItems(params Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes[] items)
            {
                return new([..items]);
            }
            ...
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item1)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item1, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item2)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item1, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item2, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item3)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item1, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item2, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item3, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item4)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item1, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item2, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item3, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item4, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item5)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item1, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item2, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item3, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item4, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item5, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item6)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item1, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item2, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item3, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item4, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item5, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item6, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item7)
            {
            ...
            public static SimpleTypesArray FromRange(IEnumerable<Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items .</returns>
            static SimpleTypesArray IJsonArray<SimpleTypesArray>.FromRange(IEnumerable<JsonAny> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items.</returns>
            static SimpleTypesArray IJsonArray<SimpleTypesArray>.FromRange<T>(IEnumerable<T> items)
            {
            ...
            /// <inheritdoc/>
            IEnumerator<Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes> IEnumerable<Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes>.GetEnumerator() => this.EnumerateArray();
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            SimpleTypesArray IJsonArray<SimpleTypesArray>.AddRange<TArray>(in TArray items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            SimpleTypesArray IJsonArray<SimpleTypesArray>.InsertRange<TArray>(int index, in TArray items)
            {
            ...
            /// <inheritdoc/>
            public SimpleTypesArray Add(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item1)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public SimpleTypesArray Add(params Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                foreach (Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item in items)
                {
                    builder.Add(item.AsAny);
                }
            ...
            /// <inheritdoc/>
            public SimpleTypesArray AddRange(IEnumerable<Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                foreach (Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item in items)
                {
            ...
            /// <inheritdoc/>
            public SimpleTypesArray Insert(int index, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            public SimpleTypesArray InsertRange(int index, IEnumerable<Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            public SimpleTypesArray Replace(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes oldValue, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            public SimpleTypesArray SetItem(int index, in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            SimpleTypesArray IJsonArray<SimpleTypesArray>.Remove(in JsonAny oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }

            /// <inheritdoc/>
            SimpleTypesArray IJsonArray<SimpleTypesArray>.RemoveAt(int index)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
            }

            /// <inheritdoc/>
            SimpleTypesArray IJsonArray<SimpleTypesArray>.RemoveRange(int index, int count)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
            }

            /// <inheritdoc/>
            public SimpleTypesArray Remove(in Corvus.Json.JsonSchema.Draft202012.Validation.SimpleTypes oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }
            ...
            private static class __CorvusArrayHelpers
            {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableList(in SimpleTypesArray arrayInstance)
                {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in SimpleTypesArray arrayInstance)
                {
                ...
                public static ImmutableList<JsonAny> GetImmutableListSetting(in SimpleTypesArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListReplacing(in SimpleTypesArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithout(in SimpleTypesArray arrayInstance, in JsonAny item)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in SimpleTypesArray arrayInstance, int index, int count)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith(in SimpleTypesArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in SimpleTypesArray arrayInstance, int index, TEnumerable values)
