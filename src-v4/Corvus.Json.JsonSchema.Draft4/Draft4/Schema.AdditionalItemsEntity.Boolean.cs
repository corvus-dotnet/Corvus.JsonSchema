...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AdditionalItemsEntity
        : IJsonBoolean<Corvus.Json.JsonSchema.Draft4.Schema.AdditionalItemsEntity>
    {
        /// <summary>
        /// Conversion from <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalItemsEntity(bool value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AdditionalItemsEntity(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(AdditionalItemsEntity value)
        {
            return
                value.AsBoolean;
        }
        ...
        public static implicit operator bool(AdditionalItemsEntity value)
        {
