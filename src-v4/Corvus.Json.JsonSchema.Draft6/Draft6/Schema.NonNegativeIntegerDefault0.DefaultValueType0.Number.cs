...
#if NET8_0_OR_GREATER
            : IJsonNumber<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0>,
              IAdditionOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0>,
              ISubtractionOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0>,
              IMultiplyOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0>,
              IDivisionOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0, Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0>,
              IIncrementOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0>,
              IDecrementOperators<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0>
#else
            : IJsonNumber<Corvus.Json.JsonSchema.Draft6.Schema.NonNegativeIntegerDefault0.DefaultValueType0>
#endif
        {
            ...
            public DefaultValueType0(double value)
            ...
            public static implicit operator DefaultValueType0(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(DefaultValueType0 value)
            {
                return
                    value.AsNumber;
            }
            ...
            public static explicit operator byte(DefaultValueType0 value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(byte value)
            {
            ...
            public static explicit operator decimal(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator double(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static implicit operator DefaultValueType0(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator long(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(DefaultValueType0 value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="DefaultValueType0"/>.</returns>
            public static explicit operator DefaultValueType0(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(DefaultValueType0 left, DefaultValueType0 right)
            {
            ...
            public static DefaultValueType0 operator +(DefaultValueType0 left, DefaultValueType0 right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static DefaultValueType0 operator ++(DefaultValueType0 value)
            {
            ...
            /// </returns>
            public static int Compare(in DefaultValueType0 lhs, in DefaultValueType0 rhs)
            {
