    ...
    public readonly partial struct PatternPropertiesEntity
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("http://json-schema.org/draft-06/schema#/properties/patternProperties");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty<Corvus.Json.JsonSchema.Draft6.Schema> property in value.EnumerateObject())
                {
                    ...
                    result = new Corvus.Json.JsonSchema.Draft6.Schema.PatternPropertiesEntity.PropertyNamesEntity(propertyNameAsString ??= property.Name.GetString()).Validate(result, level);
                    if (level == ValidationLevel.Flag && !result.IsValid)
                    {
                        return result;
                    }
