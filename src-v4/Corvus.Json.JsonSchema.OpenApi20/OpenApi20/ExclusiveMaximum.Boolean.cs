...
/// </para>
/// </remarks>
public readonly partial struct ExclusiveMaximum
    : IJsonBoolean<Corvus.Json.JsonSchema.OpenApi20.ExclusiveMaximum>
{
    /// <summary>
    /// Conversion from <see cref="bool"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ExclusiveMaximum(bool value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ExclusiveMaximum(JsonBoolean value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonBoolean(ExclusiveMaximum value)
    {
        return
            value.AsBoolean;
    }
    ...
    public static implicit operator bool(ExclusiveMaximum value)
    {
