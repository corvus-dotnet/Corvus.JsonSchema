...
public readonly partial struct ExclusiveMinimum
    : IJsonBoolean<Corvus.Json.JsonSchema.OpenApi20.ExclusiveMinimum>
{
    /// <summary>
    /// Conversion from <see cref="bool"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ExclusiveMinimum(bool value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ExclusiveMinimum(JsonBoolean value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonBoolean(ExclusiveMinimum value)
    {
        return
            value.AsBoolean;
    }
    ...
    public static implicit operator bool(ExclusiveMinimum value)
    {
