...
#if NET8_0_OR_GREATER
    : IJsonNumber<Corvus.Json.JsonSchema.OpenApi20.MultipleOf>,
      IAdditionOperators<Corvus.Json.JsonSchema.OpenApi20.MultipleOf, Corvus.Json.JsonSchema.OpenApi20.MultipleOf, Corvus.Json.JsonSchema.OpenApi20.MultipleOf>,
      ISubtractionOperators<Corvus.Json.JsonSchema.OpenApi20.MultipleOf, Corvus.Json.JsonSchema.OpenApi20.MultipleOf, Corvus.Json.JsonSchema.OpenApi20.MultipleOf>,
      IMultiplyOperators<Corvus.Json.JsonSchema.OpenApi20.MultipleOf, Corvus.Json.JsonSchema.OpenApi20.MultipleOf, Corvus.Json.JsonSchema.OpenApi20.MultipleOf>,
      IDivisionOperators<Corvus.Json.JsonSchema.OpenApi20.MultipleOf, Corvus.Json.JsonSchema.OpenApi20.MultipleOf, Corvus.Json.JsonSchema.OpenApi20.MultipleOf>,
      IIncrementOperators<Corvus.Json.JsonSchema.OpenApi20.MultipleOf>,
      IDecrementOperators<Corvus.Json.JsonSchema.OpenApi20.MultipleOf>
#else
    : IJsonNumber<Corvus.Json.JsonSchema.OpenApi20.MultipleOf>
#endif
{
    ...
    public MultipleOf(double value)
    ...
    public static implicit operator MultipleOf(JsonNumber value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonNumber(MultipleOf value)
    {
        return
            value.AsNumber;
    }
    ...
    public static explicit operator byte(MultipleOf value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(byte value)
    {
    ...
    public static explicit operator decimal(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(decimal value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static implicit operator double(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static implicit operator MultipleOf(double value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator short(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(short value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator int(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(int value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator long(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(long value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator Int128(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    public static explicit operator sbyte(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(sbyte value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator Half(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    public static explicit operator float(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(float value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator ushort(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(ushort value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator uint(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(uint value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator ulong(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(ulong value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    public static explicit operator UInt128(MultipleOf value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <param name="value">The value from which to convert.</param>
    /// <returns>An instance of the <see cref="MultipleOf"/>.</returns>
    public static explicit operator MultipleOf(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
    ...
    /// </returns>
    public static bool operator <(MultipleOf left, MultipleOf right)
    {
    ...
    public static MultipleOf operator +(MultipleOf left, MultipleOf right)
    {
    ...
    /// <returns>The result of the operation.</returns>
    public static MultipleOf operator ++(MultipleOf value)
    {
    ...
    /// </returns>
    public static int Compare(in MultipleOf lhs, in MultipleOf rhs)
    {
