...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct ApiKeySecurity
        : IJsonObject<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ApiKeySecurity>
    {
        /// <summary>
        ...
        public static implicit operator ApiKeySecurity(ImmutableList<JsonObjectProperty> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonObjectProperty>(ApiKeySecurity value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ApiKeySecurity(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(ApiKeySecurity value)
        {
            return
                value.AsObject;
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ApiKeySecurity.InEntity In
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ApiKeySecurity.InEntity>();
                    }
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ApiKeySecurity.TypeEntity Type
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ApiKeySecurity.TypeEntity>();
                    }
                }
        ...
        /// <inheritdoc/>
        public static ApiKeySecurity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }

        /// <inheritdoc/>
        public static ApiKeySecurity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        public static ApiKeySecurity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }

        /// <summary>
        /// Creates an instance of a <see cref="ApiKeySecurity"/>.
        /// </summary>
        public static ApiKeySecurity Create(
            in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ApiKeySecurity.InEntity inValue,
            in Corvus.Json.JsonString name,
            in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ApiKeySecurity.TypeEntity type,
        ...
        public ApiKeySecurity WithDescription(in Corvus.Json.JsonString value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public ApiKeySecurity WithIn(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ApiKeySecurity.InEntity value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public ApiKeySecurity WithName(in Corvus.Json.JsonString value)
        {
        ...
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public ApiKeySecurity WithType(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ApiKeySecurity.TypeEntity value)
        {
        ...
        /// <inheritdoc />
        public ApiKeySecurity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc />
        public ApiKeySecurity RemoveProperty(in JsonPropertyName name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public ApiKeySecurity RemoveProperty(string name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public ApiKeySecurity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public ApiKeySecurity RemoveProperty(ReadOnlySpan<byte> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }
        ...
        private static class __CorvusObjectHelpers
        {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in ApiKeySecurity that)
            {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ApiKeySecurity that, in JsonPropertyName name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ApiKeySecurity that, ReadOnlySpan<char> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ApiKeySecurity that, ReadOnlySpan<byte> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ApiKeySecurity that, string name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty>.Builder GetPropertyBackingBuilder(in ApiKeySecurity that)
            {
                if ((that.backing & Backing.Object) != 0)
                {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in ApiKeySecurity that, in JsonPropertyName name, in JsonAny value)
            {
                if ((that.backing & Backing.Object) != 0)
                {
