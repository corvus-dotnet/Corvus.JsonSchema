    ...
    public readonly partial struct Oauth2ApplicationSecurity
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("http://swagger.io/v2/schema.json#/definitions/oauth2ApplicationSecurity");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in Oauth2ApplicationSecurity value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.FlowUtf8, JsonPropertyNames.Flow))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.Oauth2ApplicationSecurity.FlowEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
                    ...
                    else if (property.NameEquals(JsonPropertyNames.TypeUtf8, JsonPropertyNames.Type))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.Oauth2ApplicationSecurity.TypeEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
