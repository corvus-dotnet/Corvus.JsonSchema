    ...
    public readonly partial struct ParametersList
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("http://swagger.io/v2/schema.json#/definitions/parametersList");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ParametersList.ParametersListEntity> arrayEnumerator = value.EnumerateArray();
                while (arrayEnumerator.MoveNext())
                {
                    ...
                    using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.ParametersList.ParametersListEntity> innerEnumerator = value.EnumerateArray();
                    int innerIndex = -1;
