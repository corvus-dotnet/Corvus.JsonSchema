...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct Paths
        : IJsonObject<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.Paths>,
...
Paths IJsonObject<Paths>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        private static class __CorvusObjectHelpers
        {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty>.Builder GetPropertyBackingBuilder(in Paths that)
            {
                if ((that.backing & Backing.Object) != 0)
                {
