...
public readonly partial struct OpenApiDocument
{
    ...
    public readonly partial struct QueryParameterSubSchema
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct AllowsSendingAParameterByNameOnlyOrWithAnEmptyValue
            : IJsonBoolean<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.QueryParameterSubSchema.AllowsSendingAParameterByNameOnlyOrWithAnEmptyValue>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AllowsSendingAParameterByNameOnlyOrWithAnEmptyValue(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AllowsSendingAParameterByNameOnlyOrWithAnEmptyValue(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(AllowsSendingAParameterByNameOnlyOrWithAnEmptyValue value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(AllowsSendingAParameterByNameOnlyOrWithAnEmptyValue value)
            {
