        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("http://swagger.io/v2/schema.json#/definitions/schema/properties/additionalProperties");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    ValidationContext anyOfResult1 = value.As<Corvus.Json.JsonBoolean>().Validate(anyOfChildContext1, level);
