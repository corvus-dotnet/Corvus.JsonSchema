    ...
    public readonly partial struct SchemesList
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("http://swagger.io/v2/schema.json#/definitions/schemesList");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SchemesList.SchemesListEntity> arrayEnumerator = value.EnumerateArray();
                while (arrayEnumerator.MoveNext())
                {
                    ...
                    using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SchemesList.SchemesListEntity> innerEnumerator = value.EnumerateArray();
                    int innerIndex = -1;
