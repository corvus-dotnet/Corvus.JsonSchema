...
public readonly partial struct OpenApiDocument
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(Security), "Create")]
#endif
    public readonly partial struct Security
        : IJsonArray<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.Security>,
          IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static Security EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonAny IJsonArray<Security>.this[int index]
        {
            get
            {
        ...
        public Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator Security(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(Security value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Security(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(Security value)
        {
            return
                value.AsArray;
        }
        ...
        public static Security From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="Security"/>" struct from a span of items.
        /// </summary>
        ...
        public static Security Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement> items)
        {
            return new([..items]);
        }
        ...
        public static Security FromItems(params Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement[] items)
        {
            return new([..items]);
        }
        ...
        public static Security FromItems(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static Security FromItems(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item1, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static Security FromItems(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item1, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item2, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static Security FromItems(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item1, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item2, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item3, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static Security FromItems(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item1, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item2, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item3, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item4, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static Security FromItems(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item1, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item2, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item3, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item4, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item5, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static Security FromItems(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item1, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item2, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item3, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item4, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item5, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item6, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item7)
        {
        ...
        public static Security FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items .</returns>
        static Security IJsonArray<Security>.FromRange(IEnumerable<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        static Security IJsonArray<Security>.FromRange<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        IEnumerator<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement> IEnumerable<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<Security>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<Security>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        Security IJsonArray<Security>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        Security IJsonArray<Security>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        Security IJsonArray<Security>.AddRange<TArray>(in TArray items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        Security IJsonArray<Security>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        Security IJsonArray<Security>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        Security IJsonArray<Security>.Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        Security IJsonArray<Security>.InsertRange<TArray>(int index, in TArray items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
        }

        /// <inheritdoc/>
        Security IJsonArray<Security>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        Security IJsonArray<Security>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
        }

        /// <inheritdoc/>
        Security IJsonArray<Security>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        Security IJsonArray<Security>.SetItem(int index, in JsonAny value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        public Security Add(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public Security Add(params Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public Security AddRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item in items)
            {
        ...
        /// <inheritdoc/>
        public Security Insert(int index, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public Security InsertRange(int index, IEnumerable<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public Security Replace(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement oldValue, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public Security SetItem(int index, in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        Security IJsonArray<Security>.Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        public Security RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        public Security RemoveRange(int index, int count)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
        }

        /// <inheritdoc/>
        public Security Remove(in Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableList(in Security arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in Security arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in Security arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in Security arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in Security arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in Security arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in Security arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in Security arrayInstance, int index, TEnumerable values)
