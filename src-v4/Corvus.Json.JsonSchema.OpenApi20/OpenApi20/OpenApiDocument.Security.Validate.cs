...
public readonly partial struct OpenApiDocument
{
    ...
    /// </summary>
    public readonly partial struct Security
    {
        /// <inheritdoc/>
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("http://swagger.io/v2/schema.json#/definitions/security");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement> arrayEnumerator = value.EnumerateArray();
                while (arrayEnumerator.MoveNext())
                {
                    ...
                    using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi20.OpenApiDocument.SecurityRequirement> innerEnumerator = value.EnumerateArray();
                    int innerIndex = -1;
