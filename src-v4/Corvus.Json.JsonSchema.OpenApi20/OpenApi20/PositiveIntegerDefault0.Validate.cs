...
public readonly partial struct PositiveIntegerDefault0
{
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            allOfResult0 = value.As<Corvus.Json.JsonSchema.OpenApi20.PositiveInteger>().Validate(allOfResult0, level);
            ...
            allOfResult1 = value.As<Corvus.Json.JsonSchema.OpenApi20.PositiveIntegerDefault0.DefaultValueType0>().Validate(allOfResult1, level);
