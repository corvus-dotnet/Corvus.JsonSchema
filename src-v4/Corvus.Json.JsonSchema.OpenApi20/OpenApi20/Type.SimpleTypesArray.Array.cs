...
public readonly partial struct Type
{
    ...
    public readonly partial struct SimpleTypesArray
        : IJsonArray<Corvus.Json.JsonSchema.OpenApi20.Type.SimpleTypesArray>,
          IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        ...
        public Corvus.Json.JsonSchema.OpenApi20.SimpleTypes this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static SimpleTypesArray Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes> items)
        {
            return new([..items]);
        }
        ...
        public static SimpleTypesArray FromItems(params Corvus.Json.JsonSchema.OpenApi20.SimpleTypes[] items)
        {
            return new([..items]);
        }
        ...
        public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item1, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item1, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item2, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item1, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item2, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item3, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item1, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item2, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item3, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item4, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item1, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item2, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item3, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item4, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item5, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static SimpleTypesArray FromItems(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item1, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item2, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item3, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item4, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item5, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item6, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item7)
        {
        ...
        public static SimpleTypesArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes> items)
        {
            return new([..items]);
        }
        ...
        /// <inheritdoc/>
        IEnumerator<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes> IEnumerable<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        public SimpleTypesArray Add(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public SimpleTypesArray Add(params Corvus.Json.JsonSchema.OpenApi20.SimpleTypes[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public SimpleTypesArray AddRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item in items)
            {
        ...
        /// <inheritdoc/>
        public SimpleTypesArray Insert(int index, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public SimpleTypesArray InsertRange(int index, IEnumerable<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public SimpleTypesArray Replace(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes oldValue, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public SimpleTypesArray SetItem(int index, in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }
        ...
        /// <inheritdoc/>
        public SimpleTypesArray Remove(in Corvus.Json.JsonSchema.OpenApi20.SimpleTypes oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
