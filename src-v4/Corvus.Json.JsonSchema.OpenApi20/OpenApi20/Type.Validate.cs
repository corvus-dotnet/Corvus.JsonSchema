...
public readonly partial struct Type
{
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            ValidationContext anyOfResult0 = value.As<Corvus.Json.JsonSchema.OpenApi20.SimpleTypes>().Validate(anyOfChildContext0, level);
            ...
            ValidationContext anyOfResult1 = value.As<Corvus.Json.JsonSchema.OpenApi20.Type.SimpleTypesArray>().Validate(anyOfChildContext1, level);
