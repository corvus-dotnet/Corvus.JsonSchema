...
public readonly partial struct UniqueItems
    : IJsonBoolean<Corvus.Json.JsonSchema.OpenApi20.UniqueItems>
{
    /// <summary>
    /// Conversion from <see cref="bool"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator UniqueItems(bool value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator UniqueItems(JsonBoolean value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonBoolean(UniqueItems value)
    {
        return
            value.AsBoolean;
    }
    ...
    public static implicit operator bool(UniqueItems value)
    {
