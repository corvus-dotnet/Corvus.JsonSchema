        ...
        public readonly partial struct EncodingEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.0/schema/2021-09-28#/definitions/MediaType/properties/encoding");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    int propertyCount = 0;
                    foreach (JsonObjectProperty<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Encoding> property in value.EnumerateObject())
                    {
