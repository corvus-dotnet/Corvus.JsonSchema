...
#if NET8_0_OR_GREATER
            : IJsonNumber<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity>,
              IAdditionOperators<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity>,
              ISubtractionOperators<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity>,
              IMultiplyOperators<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity>,
              IDivisionOperators<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity, Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity>,
              IIncrementOperators<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity>,
              IDecrementOperators<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity>
#else
            : IJsonNumber<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Schema.MinLengthEntity>
#endif
        {
            ...
            public MinLengthEntity(long value)
            ...
            public static implicit operator MinLengthEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(MinLengthEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonInteger(MinLengthEntity value)
            {
                return
            ...
            public static explicit operator byte(MinLengthEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(byte value)
            {
            ...
            public static explicit operator decimal(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator double(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator long(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static implicit operator MinLengthEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(MinLengthEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MinLengthEntity"/>.</returns>
            public static explicit operator MinLengthEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(MinLengthEntity left, MinLengthEntity right)
            {
            ...
            public static MinLengthEntity operator +(MinLengthEntity left, MinLengthEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static MinLengthEntity operator ++(MinLengthEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in MinLengthEntity lhs, in MinLengthEntity rhs)
            {
