    ...
    public readonly partial struct TagArray
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.0/schema/2021-09-28#/properties/tags");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> arrayEnumerator = value.EnumerateArray();
                while (arrayEnumerator.MoveNext())
                {
                    ...
                    using JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi30.OpenApiDocument.Tag> innerEnumerator = value.EnumerateArray();
                    int innerIndex = -1;
