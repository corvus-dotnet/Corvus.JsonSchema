        ...
        public readonly partial struct ExplodeDefaultEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/encoding/$defs/explode-default");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    ValidationContext ifResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Encoding.ExplodeDefaultEntity.RequiredStyle>().Validate(validationContext.CreateChildContext(), level);
                    ...
                    if (ifResult.IsValid)
                    {
                        ...
                        ValidationContext thenResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Encoding.ExplodeDefaultEntity.ThenEntity>().Validate(validationContext.CreateChildContext(), level);
                    ...
                    if (!ifResult.IsValid)
                    {
                        ...
                        ValidationContext elseResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Encoding.ExplodeDefaultEntity.ElseEntity>().Validate(validationContext.CreateChildContext(), level);
