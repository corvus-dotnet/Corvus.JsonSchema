...
public readonly partial struct OpenApiDocument
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(OpenApiDocumentParametersParameterOrReferenceArray), "Create")]
#endif
    public readonly partial struct OpenApiDocumentParametersParameterOrReferenceArray
        : IJsonArray<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.OpenApiDocumentParametersParameterOrReferenceArray>,
          IReadOnlyCollection<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static OpenApiDocumentParametersParameterOrReferenceArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonAny IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.this[int index]
        {
            get
            {
        ...
        public static implicit operator OpenApiDocumentParametersParameterOrReferenceArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(OpenApiDocumentParametersParameterOrReferenceArray value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator OpenApiDocumentParametersParameterOrReferenceArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(OpenApiDocumentParametersParameterOrReferenceArray value)
        {
            return
                value.AsArray;
        }
        ...
        public static OpenApiDocumentParametersParameterOrReferenceArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="OpenApiDocumentParametersParameterOrReferenceArray"/>" struct from a span of items.
        /// </summary>
        ...
        public static OpenApiDocumentParametersParameterOrReferenceArray Create(ReadOnlySpan<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)
        {
            return new([..items]);
        }
        ...
        public static OpenApiDocumentParametersParameterOrReferenceArray FromItems(params Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference[] items)
        {
            return new([..items]);
        }
        ...
        public static OpenApiDocumentParametersParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static OpenApiDocumentParametersParameterOrReferenceArray FromItems(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item1, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item2)
        {
        ...
        public static OpenApiDocumentParametersParameterOrReferenceArray FromRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items .</returns>
        static OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.FromRange(IEnumerable<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        static OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.FromRange<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.AddRange<TArray>(in TArray items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.InsertRange<TArray>(int index, in TArray items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
        }

        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
        }

        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.SetItem(int index, in JsonAny value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        public OpenApiDocumentParametersParameterOrReferenceArray Add(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public OpenApiDocumentParametersParameterOrReferenceArray Add(params Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public OpenApiDocumentParametersParameterOrReferenceArray AddRange(IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item in items)
            {
        ...
        /// <inheritdoc/>
        public OpenApiDocumentParametersParameterOrReferenceArray Insert(int index, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public OpenApiDocumentParametersParameterOrReferenceArray InsertRange(int index, IEnumerable<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public OpenApiDocumentParametersParameterOrReferenceArray Replace(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference oldValue, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public OpenApiDocumentParametersParameterOrReferenceArray SetItem(int index, in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        OpenApiDocumentParametersParameterOrReferenceArray IJsonArray<OpenApiDocumentParametersParameterOrReferenceArray>.RemoveRange(int index, int count)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
        }

        /// <inheritdoc/>
        public OpenApiDocumentParametersParameterOrReferenceArray Remove(in Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.ParameterOrReference oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableList(in OpenApiDocumentParametersParameterOrReferenceArray arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in OpenApiDocumentParametersParameterOrReferenceArray arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in OpenApiDocumentParametersParameterOrReferenceArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in OpenApiDocumentParametersParameterOrReferenceArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in OpenApiDocumentParametersParameterOrReferenceArray arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in OpenApiDocumentParametersParameterOrReferenceArray arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in OpenApiDocumentParametersParameterOrReferenceArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in OpenApiDocumentParametersParameterOrReferenceArray arrayInstance, int index, TEnumerable values)
