    ...
    public readonly partial struct Operation
    {
...

        {
            ...
            public bool Equals(in SecurityRequirementArray other)
            {
                ...
                {
                    JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement> lhs = this.EnumerateArray();
                    JsonArrayEnumerator<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityRequirement> rhs = other.EnumerateArray();
                    while (lhs.MoveNext())
                    {
                        if (!rhs.MoveNext())
                        {
