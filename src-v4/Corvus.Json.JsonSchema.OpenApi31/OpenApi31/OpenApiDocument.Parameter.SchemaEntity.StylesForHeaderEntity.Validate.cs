            ...
            public readonly partial struct StylesForHeaderEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/parameter/dependentSchemas/schema/$defs/styles-for-header");
                    }
                ...
                public static partial class CorvusValidation
                {
                    ...
                    internal static ValidationContext TernaryIfValidationHandler(
                        in StylesForHeaderEntity value,
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        ValidationContext ifResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn>().Validate(validationContext.CreateChildContext(), level);
                        ...
                        if (ifResult.IsValid)
                        {
                            ...
                            ValidationContext thenResult = value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple>().Validate(validationContext.CreateChildContext(), level);
