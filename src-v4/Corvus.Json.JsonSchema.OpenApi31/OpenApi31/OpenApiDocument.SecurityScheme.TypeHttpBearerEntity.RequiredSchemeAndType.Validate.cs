            ...
            public readonly partial struct RequiredSchemeAndType
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-scheme/$defs/type-http-bearer/if");
                    }
                ...
                public static partial class CorvusValidation
                {
                    ...
                    internal static ValidationContext ObjectValidationHandler(
                        in RequiredSchemeAndType value,
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        foreach (JsonObjectProperty property in value.EnumerateObject())
                        {
                            if (property.NameEquals(JsonPropertyNames.SchemeUtf8, JsonPropertyNames.Scheme))
                            {
                                ...
                                ValidationContext propertyResult = property.Value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity>().Validate(result.CreateChildContext(), level);
                            ...
                            else if (property.NameEquals(JsonPropertyNames.TypeUtf8, JsonPropertyNames.Type))
                            {
                                ...
                                ValidationContext propertyResult = property.Value.As<Corvus.Json.JsonSchema.OpenApi31.OpenApiDocument.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity>().Validate(result.CreateChildContext(), level);
                                if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                                {
                                    return propertyResult;
                                }
