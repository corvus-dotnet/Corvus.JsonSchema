    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOidcEntity
        {
...

            {
                ...
                /// </summary>
                /// <param name="source">The source of the JSON string to parse.</param>
                public static RequiredOpenIdConnectUrl ParseValue(string source)
                {
#if NET8_0_OR_GREATER
                    return IJsonValue<RequiredOpenIdConnectUrl>.ParseValue(source);
#else
                    return JsonValueHelpers.ParseValue<RequiredOpenIdConnectUrl>(source.AsSpan());
#endif
                }
                ...
                {
                    return
                        (obj is IJsonValue jv && this.Equals(jv.As<RequiredOpenIdConnectUrl>())) ||
                ...
                {
                    return this.Equals(other.As<RequiredOpenIdConnectUrl>());
                }
