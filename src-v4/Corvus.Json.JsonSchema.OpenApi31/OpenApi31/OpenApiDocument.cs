...

{
    ...
    /// </summary>
    public static string SchemaLocation { get; } = "OpenApi31.json";
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static OpenApiDocument ParseValue(string source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<OpenApiDocument>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<OpenApiDocument>(source.AsSpan());
#endif
    }
...
#else
        return this.As<OpenApiDocument, TTarget>();
#endif
    }
    ...
    {
        return
            (obj is IJsonValue jv && this.Equals(jv.As<OpenApiDocument>())) ||
    ...
    {
        return this.Equals(other.As<OpenApiDocument>());
    }
