...

{
    ...
    /// </summary>
    /// <param name="source">The source of the JSON string to parse.</param>
    public static DisabledScenario ParseValue(string source)
    {
#if NET8_0_OR_GREATER
        return IJsonValue<DisabledScenario>.ParseValue(source);
#else
        return JsonValueHelpers.ParseValue<DisabledScenario>(source.AsSpan());
#endif
    }
...
#else
        return this.As<DisabledScenario, TTarget>();
#endif
    }
    ...
    {
        return
            (obj is IJsonValue jv && this.Equals(jv.As<DisabledScenario>())) ||
    ...
    {
        return this.Equals(other.As<DisabledScenario>());
    }
