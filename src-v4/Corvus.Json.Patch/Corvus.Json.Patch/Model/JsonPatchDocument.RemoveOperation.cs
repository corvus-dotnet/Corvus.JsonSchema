...
public readonly partial struct JsonPatchDocument
{
...

    {
        ...
        /// </summary>
        /// <param name="source">The source of the JSON string to parse.</param>
        public static RemoveOperation ParseValue(string source)
        {
#if NET8_0_OR_GREATER
            return IJsonValue<RemoveOperation>.ParseValue(source);
#else
            return JsonValueHelpers.ParseValue<RemoveOperation>(source.AsSpan());
#endif
        }
        ...
        {
            return
                (obj is IJsonValue jv && this.Equals(jv.As<RemoveOperation>())) ||
        ...
        {
            return this.Equals(other.As<RemoveOperation>());
        }
