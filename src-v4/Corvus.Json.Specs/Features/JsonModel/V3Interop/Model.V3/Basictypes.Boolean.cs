...
/// </summary>
public readonly partial struct Basictypes : IJsonBoolean<Basictypes>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "Basictypes"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public Basictypes(bool value)
    {
    ...
    public static implicit operator Basictypes(JsonBoolean value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator Basictypes(bool value)
    {
        return new(value);
    }
    ...
    public static implicit operator bool (Basictypes value)
    {
