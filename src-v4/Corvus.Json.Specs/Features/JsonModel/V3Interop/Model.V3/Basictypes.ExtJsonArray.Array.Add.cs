...
public readonly partial struct Basictypes
{
    ...
    {
        /// <inheritdoc/>
        public ExtJsonArray Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        public ExtJsonArray Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
        ...
        /// <inheritdoc/>
        public ExtJsonArray AddRange<TArray>(in TArray items)
        ...
        /// <inheritdoc/>
        public ExtJsonArray AddRange<TItem>(IEnumerable<TItem> items)
        ...
        /// <inheritdoc/>
        public ExtJsonArray AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = this.GetImmutableListBuilder();
            builder.AddRange(items);
            return new(builder.ToImmutable());
        ...
        /// <inheritdoc/>
        public ExtJsonArray Insert(int index, in JsonAny item1)
        {
            return new(this.GetImmutableListWith(index, item1));
        }

        /// <inheritdoc/>
        public ExtJsonArray InsertRange<TArray>(int index, in TArray items)
            where TArray : struct, IJsonArray<TArray>
        {
        ...
        /// <inheritdoc/>
        public ExtJsonArray InsertRange<TItem>(int index, IEnumerable<TItem> items)
            where TItem : struct, IJsonValue<TItem>
        {
        ...
        /// <inheritdoc/>
        public ExtJsonArray InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(this.GetImmutableListWith(index, items));
        }

        /// <inheritdoc/>
        public ExtJsonArray Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(this.GetImmutableListReplacing(oldValue.AsAny, newValue.AsAny));
        }

        /// <inheritdoc/>
        public ExtJsonArray SetItem(int index, in JsonAny value)
        {
