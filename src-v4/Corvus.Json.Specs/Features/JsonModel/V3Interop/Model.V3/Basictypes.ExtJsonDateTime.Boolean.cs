...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonDateTime : IJsonBoolean<ExtJsonDateTime>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonDateTime"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonDateTime(bool value)
        {
        ...
        public static implicit operator ExtJsonDateTime(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonDateTime(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonDateTime value)
        {
