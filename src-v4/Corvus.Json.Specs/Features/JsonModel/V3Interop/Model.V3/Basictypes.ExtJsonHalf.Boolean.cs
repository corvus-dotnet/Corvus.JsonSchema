...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonHalf : IJsonBoolean<ExtJsonHalf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonHalf"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonHalf(bool value)
        {
        ...
        public static implicit operator ExtJsonHalf(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonHalf(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonHalf value)
        {
