...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonRegex : IJsonBoolean<ExtJsonRegex>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonRegex"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonRegex(bool value)
        {
        ...
        public static implicit operator ExtJsonRegex(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonRegex(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonRegex value)
        {
