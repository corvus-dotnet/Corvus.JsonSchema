...
public readonly partial struct Basictypes
{
    ...
    public readonly partial struct ExtJsonString3
    {
        ...
        public TOut Match<TIn, TOut>(in TIn context, Func<TIn, TOut> matchType1, Func<TIn, TOut> matchType2, Func<TIn, TOut> defaultMatch)
        {
        ...
        /// <param name = "matchType2">The function to call if the value matches the JSON value "\"2\"".</param>
        /// <param name = "defaultMatch">The fallback match.</param>
        public TOut Match<TOut>(Func<TOut> matchType1, Func<TOut> matchType2, Func<TOut> defaultMatch)
        {
            if (this.ValueKind == JsonValueKind.String)
            {
                if (this.HasJsonElementBacking)
        ...
        public static class EnumValues
        {
            ...
            /// </summary>
            public static readonly ExtJsonString3 Type1 = ExtJsonString3.Parse("\"1\"");
            /// <summary>
            ...
            /// </summary>
            public static readonly ExtJsonString3 Type2 = ExtJsonString3.Parse("\"2\"");
            /// <summary>
            ...
            /// Gets "1" as a JSON value.
            /// </summary>
            internal static readonly ExtJsonString3 Item0 = ExtJsonString3.Parse("\"1\"");
            /// <summary>
            /// Gets "2" as a JSON value.
            /// </summary>
            internal static readonly ExtJsonString3 Item1 = ExtJsonString3.Parse("\"2\"");
        }
    }
}