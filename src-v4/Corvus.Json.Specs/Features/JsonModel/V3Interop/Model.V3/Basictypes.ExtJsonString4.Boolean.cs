...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString4 : IJsonBoolean<ExtJsonString4>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString4"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString4(bool value)
        {
        ...
        public static implicit operator ExtJsonString4(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString4(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString4 value)
        {
