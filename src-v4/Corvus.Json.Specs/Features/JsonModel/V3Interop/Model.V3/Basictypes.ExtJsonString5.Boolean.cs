...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString5 : IJsonBoolean<ExtJsonString5>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString5"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString5(bool value)
        {
        ...
        public static implicit operator ExtJsonString5(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString5(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString5 value)
        {
