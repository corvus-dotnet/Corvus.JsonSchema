...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonUriReference : IJsonBoolean<ExtJsonUriReference>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonUriReference"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonUriReference(bool value)
        {
        ...
        public static implicit operator ExtJsonUriReference(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonUriReference(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonUriReference value)
        {
