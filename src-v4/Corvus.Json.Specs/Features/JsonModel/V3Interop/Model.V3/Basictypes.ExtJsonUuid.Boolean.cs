...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonUuid : IJsonBoolean<ExtJsonUuid>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonUuid"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonUuid(bool value)
        {
        ...
        public static implicit operator ExtJsonUuid(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonUuid(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonUuid value)
        {
