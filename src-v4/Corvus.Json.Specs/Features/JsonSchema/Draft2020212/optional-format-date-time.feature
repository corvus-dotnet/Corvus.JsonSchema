...
*/
    ...
    Examples:
        ...
        | #/000/tests/018/data | false | an invalid hour in date-time string                                              |
        # 1990-12-31T15:60:00Z
        | #/000/tests/019/data | false | an invalid minute in date-time string                                            |
        # 1990-12-31T10:00:00+10:60
        | #/000/tests/020/data | false | an invalid offset minute in date-time string                                     |
