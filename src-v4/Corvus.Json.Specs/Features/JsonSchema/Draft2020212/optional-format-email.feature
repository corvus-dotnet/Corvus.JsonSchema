...
*/
    ...
    Examples:
        ...
        # @example.com
        | #/000/tests/024/data | false | local part is required                                                           |
        # joe.bloggs@
        | #/000/tests/025/data | false | domain is required                                                               |
        # joe bloggs@example.com
        | #/000/tests/026/data | false | unquoted space in local part is invalid                                          |
