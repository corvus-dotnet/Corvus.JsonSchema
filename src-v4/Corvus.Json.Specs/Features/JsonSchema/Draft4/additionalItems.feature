...
*/
    ...
    Examples:
        | inputDataReference   | valid | description                                                                      |
        # [ 1, "hello" ]
        | #/005/tests/000/data | false | items defined in allOf are not examined                                          |
...
*/
    ...
    Examples:
        | inputDataReference   | valid | description                                                                      |
        # [ "x", 2, 3 ]
        | #/006/tests/000/data | true  | valid items                                                                      |
        # [ "x", "y" ]
        | #/006/tests/001/data | false | wrong type of second item                                                        |
...
*/
    ...
    Examples:
        | inputDataReference   | valid | description                                                                      |
        # [ "foo", "bar", 37 ]
        | #/007/tests/000/data | false | heterogeneous invalid instance                                                   |
        # [ null ]
        | #/007/tests/001/data | true  | valid instance                                                                   |
