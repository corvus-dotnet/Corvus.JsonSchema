// <copyright file="GeneratedBenchmark11.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// spec_tests - A.16. Adding an Array Value.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark11 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"add\",\"path\":\"/foo/-\",\"value\":[\"abc\",\"def\"]}]");
