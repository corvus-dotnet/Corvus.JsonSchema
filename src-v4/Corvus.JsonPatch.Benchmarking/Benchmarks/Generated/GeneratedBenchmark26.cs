// <copyright file="GeneratedBenchmark26.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - Add, /foo/ deep target (trailing slash).
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark26 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"add\",\"path\":\"/foo/\",\"value\":1}]");
