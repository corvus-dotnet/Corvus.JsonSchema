// <copyright file="GeneratedBenchmark30.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark30 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"add\",\"path\":\"/bar\",\"value\":false}]");
