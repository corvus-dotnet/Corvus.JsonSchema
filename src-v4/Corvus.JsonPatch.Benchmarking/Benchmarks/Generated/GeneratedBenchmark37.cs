// <copyright file="GeneratedBenchmark37.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - test against implementation-specific numeric parsing.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark37 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"test\",\"path\":\"/1e0\",\"value\":\"foo\"}]");
