// <copyright file="GeneratedBenchmark55.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - null value should be valid obj property to be removed.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark55 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"remove\",\"path\":\"/foo\"}]");
