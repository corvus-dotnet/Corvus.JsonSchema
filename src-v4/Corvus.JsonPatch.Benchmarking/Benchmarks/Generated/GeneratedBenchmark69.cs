// <copyright file="GeneratedBenchmark69.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - test remove on array.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark69 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"remove\",\"path\":\"/0\"}]");
