// <copyright file="GeneratedBenchmark70.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - test repeated removes.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark70 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"remove\",\"path\":\"/1\"},{\"op\":\"remove\",\"path\":\"/2\"}]");
