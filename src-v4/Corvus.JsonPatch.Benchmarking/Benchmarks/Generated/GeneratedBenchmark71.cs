// <copyright file="GeneratedBenchmark71.cs" company="Endjin Limited">
...
namespace Benchmarks
{
    ...
    /// <summary>
    /// tests - Patch with different capitalisation than doc.
    /// </summary>
    [MemoryDiagnoser]
    public class GeneratedBenchmark71 : BenchmarkBase
    {
        ...
        {
            this.jePatch = BuildJEPatch("[{\"op\":\"add\",\"path\":\"/FOO\",\"value\":\"BAR\"}]");
