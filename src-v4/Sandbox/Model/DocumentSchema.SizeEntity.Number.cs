...
#if NET8_0_OR_GREATER
        : IJsonNumber<Feature408.DocumentSchema.SizeEntity>,
          IAdditionOperators<Feature408.DocumentSchema.SizeEntity, Feature408.DocumentSchema.SizeEntity, Feature408.DocumentSchema.SizeEntity>,
          ISubtractionOperators<Feature408.DocumentSchema.SizeEntity, Feature408.DocumentSchema.SizeEntity, Feature408.DocumentSchema.SizeEntity>,
          IMultiplyOperators<Feature408.DocumentSchema.SizeEntity, Feature408.DocumentSchema.SizeEntity, Feature408.DocumentSchema.SizeEntity>,
          IDivisionOperators<Feature408.DocumentSchema.SizeEntity, Feature408.DocumentSchema.SizeEntity, Feature408.DocumentSchema.SizeEntity>,
          IIncrementOperators<Feature408.DocumentSchema.SizeEntity>,
          IDecrementOperators<Feature408.DocumentSchema.SizeEntity>
#else
        : IJsonNumber<Feature408.DocumentSchema.SizeEntity>
#endif
    {
        ...
        public static implicit operator SizeEntity(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(SizeEntity value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(SizeEntity value)
        {
            return
        ...
        public static explicit operator byte(SizeEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(byte value)
        {
        ...
        public static explicit operator decimal(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator int(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator long(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static implicit operator SizeEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(SizeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="SizeEntity"/>.</returns>
        public static explicit operator SizeEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(SizeEntity left, SizeEntity right)
        {
        ...
        public static SizeEntity operator +(SizeEntity left, SizeEntity right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static SizeEntity operator ++(SizeEntity value)
        {
        ...
        /// </returns>
        public static int Compare(in SizeEntity lhs, in SizeEntity rhs)
        {
