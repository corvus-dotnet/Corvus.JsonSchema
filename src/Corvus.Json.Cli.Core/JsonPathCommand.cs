// <copyright file="JsonPathCommand.cs" company="Endjin Limited">
...
/// <summary>
/// Spectre.Console.Cli command for generating optimized C# evaluator classes from JSONPath expressions.
/// </summary>
internal class JsonPathCommand : Command<JsonPathCommand.Settings>
{
    /// <summary>
    /// Settings for the jsonpath command.
    /// </summary>
    public sealed class Settings : CommandSettings
    {
        [Description("The path to the file containing the JSONPath expression.")]
    ...
    protected override int Execute(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        try
        {
            string generatedCode = JsonPathCodeGenerator.Generate(expression, settings.ClassName, settings.Namespace);
