// <copyright file="JsonataCommand.cs" company="Endjin Limited">
...
/// <summary>
/// Spectre.Console.Cli command for generating optimized C# evaluator classes from JSONata expressions.
/// </summary>
internal class JsonataCommand : Command<JsonataCommand.Settings>
{
    /// <summary>
    /// Settings for the jsonata command.
    /// </summary>
    public sealed class Settings : CommandSettings
    {
        [Description("The path to the file containing the JSONata expression.")]
    ...
    protected override int Execute(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        try
        {
            string generatedCode = JsonataCodeGenerator.Generate(expression, settings.ClassName, settings.Namespace);
