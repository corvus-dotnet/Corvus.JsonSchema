// <copyright file="GeneratorConfig.GenerationSpecification.RebaseToRootPathEntity.Boolean.cs" company="Endjin Limited">
...
public readonly partial struct GeneratorConfig
{
    ...
    public readonly partial struct GenerationSpecification
    {
        ...
        public readonly partial struct RebaseToRootPathEntity
            : IJsonBoolean<Corvus.Json.CodeGenerator.GeneratorConfig.GenerationSpecification.RebaseToRootPathEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator RebaseToRootPathEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator RebaseToRootPathEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(RebaseToRootPathEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(RebaseToRootPathEntity value)
            {
