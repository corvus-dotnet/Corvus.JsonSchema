// <copyright file="OpenApiCallbackClientCommand.cs" company="Endjin Limited">
...
/// <summary>
/// Spectre.Console.Cli command for generating an API client for OpenAPI webhooks and callbacks.
/// </summary>
/// <remarks>
/// <para>
/// This generates the same output as <c>openapi-client</c> (client class, request/response types,
/// <c>SendAsyncCore</c>) but walks webhook and callback path-items instead of the main
/// <c>paths</c> object.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
internal sealed class OpenApiCallbackClientCommand : AsyncCommand<OpenApiGenerateSettings>
{
    /// <inheritdoc/>
    protected override async Task<int> ExecuteAsync(CommandContext context, OpenApiGenerateSettings settings, CancellationToken cancellationToken)
    {
        ...
        if (specVersion is "3.2")
        {
            ...
            files = generator.GenerateCallbackClient(specRoot, filter, referenceResolver);
        }
        ...
        AnsiConsole.MarkupLine($"[green]Callback client files:[/] {files.Count}");
