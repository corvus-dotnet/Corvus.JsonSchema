// <copyright file="GeneratorConfig.FileList.Validate.cs" company="Endjin Limited">
...
public readonly partial struct GeneratorConfig
{
    ...
    /// </summary>
    public readonly partial struct FileList
    {
        /// <inheritdoc/>
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("#/$defs/fileList");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<Corvus.Json.CodeGenerator.GeneratorConfig.FileSpecification> arrayEnumerator = value.EnumerateArray();
