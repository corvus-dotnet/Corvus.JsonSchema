// <copyright file="GeneratorConfig.NamespaceMap.Object.cs" company="Endjin Limited">
...
public readonly partial struct GeneratorConfig
{
    ...
    public readonly partial struct NamespaceMap
        : IJsonObject<Corvus.Json.CodeGenerator.GeneratorConfig.NamespaceMap>,
          IReadOnlyDictionary<JsonPropertyName, Corvus.Json.JsonString>
    {
        ...
        public static implicit operator NamespaceMap(ImmutableList<JsonObjectProperty> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonObjectProperty>(NamespaceMap value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator NamespaceMap(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(NamespaceMap value)
        {
            return
                value.AsObject;
        }
        ...
        /// <inheritdoc/>
        JsonAny IJsonObject<NamespaceMap>.this[in JsonPropertyName name]
        {
            get
            {
        ...
        /// <inheritdoc/>
        static NamespaceMap IJsonObject<NamespaceMap>.FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }

        /// <inheritdoc/>
        static NamespaceMap IJsonObject<NamespaceMap>.FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        public static NamespaceMap FromProperties(IDictionary<JsonPropertyName, Corvus.Json.JsonString> source)
        {
        ...
        public static NamespaceMap FromProperties(params (JsonPropertyName Name, Corvus.Json.JsonString Value)[] source)
        {
        ...
        public static NamespaceMap FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <inheritdoc/>
        JsonObjectEnumerator IJsonObject<NamespaceMap>.EnumerateObject()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc />
        bool IJsonObject<NamespaceMap>.TryGetProperty(in JsonPropertyName name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc />
        bool IJsonObject<NamespaceMap>.TryGetProperty(string name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<NamespaceMap>.TryGetProperty(ReadOnlySpan<char> name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<NamespaceMap>.TryGetProperty(ReadOnlySpan<byte> name, out JsonAny value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<NamespaceMap>.TryGetProperty<TValue>(in JsonPropertyName name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<NamespaceMap>.TryGetProperty<TValue>(string name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<NamespaceMap>.TryGetProperty<TValue>(ReadOnlySpan<char> name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
        bool IJsonObject<NamespaceMap>.TryGetProperty<TValue>(ReadOnlySpan<byte> name, out TValue value)
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                if (this.jsonElementBacking.ValueKind != JsonValueKind.Object)
        ...
        /// <inheritdoc />
NamespaceMap IJsonObject<NamespaceMap>.SetProperty<TValue>(in JsonPropertyName name, TValue value)
        {
        ...
        public NamespaceMap SetProperty(in JsonPropertyName name, Corvus.Json.JsonString value)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWith(this, name, value.AsAny));
        }

        /// <inheritdoc />
        public NamespaceMap RemoveProperty(in JsonPropertyName name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public NamespaceMap RemoveProperty(string name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public NamespaceMap RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public NamespaceMap RemoveProperty(ReadOnlySpan<byte> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }
        ...
        private static class __CorvusObjectHelpers
        {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in NamespaceMap that)
            {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in NamespaceMap that, in JsonPropertyName name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in NamespaceMap that, ReadOnlySpan<char> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in NamespaceMap that, ReadOnlySpan<byte> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in NamespaceMap that, string name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in NamespaceMap that, in JsonPropertyName name, in JsonAny value)
            {
                if ((that.backing & Backing.Object) != 0)
                {
