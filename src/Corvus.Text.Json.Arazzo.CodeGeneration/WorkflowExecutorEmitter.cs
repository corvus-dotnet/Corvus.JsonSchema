...
public static class WorkflowExecutorEmitter
{
        ...
        JsonElement components = default)
    {
        ...
        return Compose(options, workflowId, fields.ToString(), bodyText, auxiliaryTypes.ToString(), needsContext, ReadWorkflowDependsOn(workflow));
    }
    ...
    private static string Compose(in WorkflowExecutorOptions options, string workflowId, string fields, string body, string auxiliaryTypes, bool needsContext, IReadOnlyList<string> workflowDependsOn)
    {
