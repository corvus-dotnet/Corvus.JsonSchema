...
/// <summary>
/// Response type for the AddAdministrator operation.
/// </summary>
public struct AddAdministratorResponse : IApiResponse<AddAdministratorResponse>
{
    ...
    {
        AddAdministratorResponse response = default;
