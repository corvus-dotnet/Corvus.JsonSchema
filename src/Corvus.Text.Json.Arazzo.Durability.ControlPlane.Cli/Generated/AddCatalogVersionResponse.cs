...
/// <summary>
/// Response type for the AddCatalogVersion operation.
/// </summary>
public struct AddCatalogVersionResponse : IApiResponse<AddCatalogVersionResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<AddCatalogVersionResponse> CreateAsync(
        int statusCode,
    ...
    {
        AddCatalogVersionResponse response = default;
    ...
    /// </summary>
    public AddCatalogVersionResponseLinksAccessor Links => new(this);

    /// <summary>
    /// Provides navigable link methods for the <see cref="AddCatalogVersionResponse"/>.
    /// </summary>
    public readonly struct AddCatalogVersionResponseLinksAccessor
    {
        private readonly AddCatalogVersionResponse response;

        internal AddCatalogVersionResponseLinksAccessor(AddCatalogVersionResponse response)
        {
        ...
        public ValueTask<GetCatalogPackageResponse> PackageAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                BaseWorkflowId = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.From(this.response.CreatedBody.BaseWorkflowId),
                VersionNumber = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.VersionNumber.From(this.response.CreatedBody.VersionNumber),
            };
