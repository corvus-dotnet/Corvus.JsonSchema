...
/// <summary>
/// Response type for the AddEnvironmentAdministrator operation.
/// </summary>
public struct AddEnvironmentAdministratorResponse : IApiResponse<AddEnvironmentAdministratorResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<AddEnvironmentAdministratorResponse> CreateAsync(
        int statusCode,
    ...
    {
        AddEnvironmentAdministratorResponse response = default;
