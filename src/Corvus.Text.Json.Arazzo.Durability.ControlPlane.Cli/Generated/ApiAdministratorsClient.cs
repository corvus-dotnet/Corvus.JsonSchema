...
public sealed class ApiAdministratorsClient : IApiAdministratorsClient
{
    ...
    public ValueTask<AddAdministratorResponse> AddAdministratorAsync(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source baseWorkflowId, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GranteeReference.Source body, CancellationToken cancellationToken = default, ValidationMode validationMode = ValidationMode.Basic, ValidationMode responseValidationMode = ValidationMode.None)
    {
        ...
        return SendWithBodyAsyncCore<AddAdministratorRequest, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GranteeReference, AddAdministratorResponse>(workspace, request, bodyValue, responseValidationMode, cancellationToken);
    }
