...
public readonly struct ApproveAccessRequestAsEligibleRequest : IApiRequest<ApproveAccessRequestAsEligibleRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ApproveAccessRequestAsEligibleRequest"/> struct.
    /// </summary>
    /// <param name="requestId">The requestId parameter.</param>
    public ApproveAccessRequestAsEligibleRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString requestId)
    {
