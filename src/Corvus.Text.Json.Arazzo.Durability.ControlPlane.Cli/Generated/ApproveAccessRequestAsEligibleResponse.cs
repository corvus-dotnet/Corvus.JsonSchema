...
/// <summary>
/// Response type for the ApproveAccessRequestAsEligible operation.
/// </summary>
public struct ApproveAccessRequestAsEligibleResponse : IApiResponse<ApproveAccessRequestAsEligibleResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ApproveAccessRequestAsEligibleResponse> CreateAsync(
        int statusCode,
    ...
    {
        ApproveAccessRequestAsEligibleResponse response = default;
