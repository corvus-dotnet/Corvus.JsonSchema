...
/// <summary>
/// Response type for the ApproveAccessRequest operation.
/// </summary>
public struct ApproveAccessRequestResponse : IApiResponse<ApproveAccessRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ApproveAccessRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        ApproveAccessRequestResponse response = default;
