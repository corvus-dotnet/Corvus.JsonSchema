...
public readonly struct ApproveAvailabilityRequestRequest : IApiRequest<ApproveAvailabilityRequestRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ApproveAvailabilityRequestRequest"/> struct.
    /// </summary>
    /// <param name="requestId">The requestId parameter.</param>
    public ApproveAvailabilityRequestRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString requestId)
    {
        this.RequestId = requestId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/availabilityRequests/{requestId}/approve"u8;
