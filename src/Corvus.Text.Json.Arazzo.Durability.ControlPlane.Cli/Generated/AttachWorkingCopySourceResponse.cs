...
/// <summary>
/// Response type for the AttachWorkingCopySource operation.
/// </summary>
public struct AttachWorkingCopySourceResponse : IApiResponse<AttachWorkingCopySourceResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSource OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<AttachWorkingCopySourceResponse> CreateAsync(
        int statusCode,
    ...
    {
        AttachWorkingCopySourceResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSource>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSource result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSource, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSource, TContext, TResult> matchOk,
