...
/// <summary>
/// Response type for the AuthorizeRunner operation.
/// </summary>
public struct AuthorizeRunnerResponse : IApiResponse<AuthorizeRunnerResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<AuthorizeRunnerResponse> CreateAsync(
        int statusCode,
    ...
    {
        AuthorizeRunnerResponse response = default;
