...
/// <summary>
/// Response type for the BeginGitHubAuth operation.
/// </summary>
public struct BeginGitHubAuthResponse : IApiResponse<BeginGitHubAuthResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubAuthStart OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<BeginGitHubAuthResponse> CreateAsync(
        int statusCode,
    ...
    {
        BeginGitHubAuthResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubAuthStart>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubAuthStart result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubAuthStart, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubAuthStart, TContext, TResult> matchOk,
