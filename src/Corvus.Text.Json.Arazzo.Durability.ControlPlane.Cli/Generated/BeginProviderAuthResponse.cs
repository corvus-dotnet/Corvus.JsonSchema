...
/// <summary>
/// Response type for the BeginProviderAuth operation.
/// </summary>
public struct BeginProviderAuthResponse : IApiResponse<BeginProviderAuthResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ProviderAuthStart OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<BeginProviderAuthResponse> CreateAsync(
        int statusCode,
    ...
    {
        BeginProviderAuthResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ProviderAuthStart>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ProviderAuthStart result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ProviderAuthStart, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ProviderAuthStart, TContext, TResult> matchOk,
