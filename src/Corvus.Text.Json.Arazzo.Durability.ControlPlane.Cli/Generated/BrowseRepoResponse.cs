...
/// <summary>
/// Response type for the BrowseRepo operation.
/// </summary>
public struct BrowseRepoResponse : IApiResponse<BrowseRepoResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBrowseResult OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<BrowseRepoResponse> CreateAsync(
        int statusCode,
    ...
    {
        BrowseRepoResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBrowseResult>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBrowseResult result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBrowseResult, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBrowseResult, TContext, TResult> matchOk,
