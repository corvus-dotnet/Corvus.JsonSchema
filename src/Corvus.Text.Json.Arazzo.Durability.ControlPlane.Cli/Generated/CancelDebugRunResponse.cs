...
/// <summary>
/// Response type for the CancelDebugRun operation.
/// </summary>
public struct CancelDebugRunResponse : IApiResponse<CancelDebugRunResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<CancelDebugRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        CancelDebugRunResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun, TContext, TResult> matchOk,
