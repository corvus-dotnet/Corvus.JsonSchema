...
/// <summary>
/// Request type for the CancelRun operation.
/// </summary>
...
public readonly struct CancelRunRequest : IApiRequest<CancelRunRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CancelRunRequest"/> struct.
    /// </summary>
    /// <param name="runId">The runId parameter.</param>
    public CancelRunRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString runId)
    {
        this.RunId = runId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/runs/{runId}/cancel"u8;
