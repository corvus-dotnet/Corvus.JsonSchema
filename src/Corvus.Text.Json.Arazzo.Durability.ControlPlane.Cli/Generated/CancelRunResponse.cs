...
/// <summary>
/// Response type for the CancelRun operation.
/// </summary>
public struct CancelRunResponse : IApiResponse<CancelRunResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CancelRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        CancelRunResponse response = default;
