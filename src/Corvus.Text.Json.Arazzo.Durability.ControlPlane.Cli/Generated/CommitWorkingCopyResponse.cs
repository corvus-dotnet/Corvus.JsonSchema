...
/// <summary>
/// Response type for the CommitWorkingCopy operation.
/// </summary>
public struct CommitWorkingCopyResponse : IApiResponse<CommitWorkingCopyResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitCommitResult OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<CommitWorkingCopyResponse> CreateAsync(
        int statusCode,
    ...
    {
        CommitWorkingCopyResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitCommitResult>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitCommitResult result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitCommitResult, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitCommitResult, TContext, TResult> matchOk,
