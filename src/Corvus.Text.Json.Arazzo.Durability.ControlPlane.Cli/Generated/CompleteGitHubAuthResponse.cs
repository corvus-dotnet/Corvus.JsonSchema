...
/// <summary>
/// Response type for the CompleteGitHubAuth operation.
/// </summary>
public struct CompleteGitHubAuthResponse : IApiResponse<CompleteGitHubAuthResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CompleteGitHubAuthResponse> CreateAsync(
        int statusCode,
    ...
    {
        CompleteGitHubAuthResponse response = default;
