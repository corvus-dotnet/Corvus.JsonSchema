...
/// <summary>
/// Response type for the CompleteProviderAuth operation.
/// </summary>
public struct CompleteProviderAuthResponse : IApiResponse<CompleteProviderAuthResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CompleteProviderAuthResponse> CreateAsync(
        int statusCode,
    ...
    {
        CompleteProviderAuthResponse response = default;
