...
/// <summary>
/// Response type for the CountAccessRequests operation.
/// </summary>
public struct CountAccessRequestsResponse : IApiResponse<CountAccessRequestsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountAccessRequestsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountAccessRequestsResponse response = default;
