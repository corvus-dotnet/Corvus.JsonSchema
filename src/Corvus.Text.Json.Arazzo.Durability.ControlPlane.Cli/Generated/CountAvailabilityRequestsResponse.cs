...
/// <summary>
/// Response type for the CountAvailabilityRequests operation.
/// </summary>
public struct CountAvailabilityRequestsResponse : IApiResponse<CountAvailabilityRequestsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountAvailabilityRequestsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountAvailabilityRequestsResponse response = default;
