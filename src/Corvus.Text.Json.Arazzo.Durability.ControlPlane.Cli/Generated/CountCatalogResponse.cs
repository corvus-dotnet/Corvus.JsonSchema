...
/// <summary>
/// Response type for the CountCatalog operation.
/// </summary>
public struct CountCatalogResponse : IApiResponse<CountCatalogResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountCatalogResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountCatalogResponse response = default;
