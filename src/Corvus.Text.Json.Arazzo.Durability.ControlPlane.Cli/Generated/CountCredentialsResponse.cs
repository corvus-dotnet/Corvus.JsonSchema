...
/// <summary>
/// Response type for the CountCredentials operation.
/// </summary>
public struct CountCredentialsResponse : IApiResponse<CountCredentialsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountCredentialsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountCredentialsResponse response = default;
