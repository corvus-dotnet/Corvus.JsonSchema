...
/// <summary>
/// Response type for the CountDeployments operation.
/// </summary>
public struct CountDeploymentsResponse : IApiResponse<CountDeploymentsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountDeploymentsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountDeploymentsResponse response = default;
