...
/// <summary>
/// Response type for the CountEnvironmentAvailability operation.
/// </summary>
public struct CountEnvironmentAvailabilityResponse : IApiResponse<CountEnvironmentAvailabilityResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CountResult OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountEnvironmentAvailabilityResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountEnvironmentAvailabilityResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CountResult>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CountResult result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CountResult, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CountResult, TContext, TResult> matchOk,
