...
/// <summary>
/// Response type for the CountEnvironmentRunnerAuthorizations operation.
/// </summary>
public struct CountEnvironmentRunnerAuthorizationsResponse : IApiResponse<CountEnvironmentRunnerAuthorizationsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountEnvironmentRunnerAuthorizationsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountEnvironmentRunnerAuthorizationsResponse response = default;
