...
/// <summary>
/// Response type for the CountEnvironments operation.
/// </summary>
public struct CountEnvironmentsResponse : IApiResponse<CountEnvironmentsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountEnvironmentsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountEnvironmentsResponse response = default;
