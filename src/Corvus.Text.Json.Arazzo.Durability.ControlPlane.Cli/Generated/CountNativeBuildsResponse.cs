...
/// <summary>
/// Response type for the CountNativeBuilds operation.
/// </summary>
public struct CountNativeBuildsResponse : IApiResponse<CountNativeBuildsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountNativeBuildsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountNativeBuildsResponse response = default;
