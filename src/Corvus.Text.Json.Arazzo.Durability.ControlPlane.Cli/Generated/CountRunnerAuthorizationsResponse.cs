...
/// <summary>
/// Response type for the CountRunnerAuthorizations operation.
/// </summary>
public struct CountRunnerAuthorizationsResponse : IApiResponse<CountRunnerAuthorizationsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountRunnerAuthorizationsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountRunnerAuthorizationsResponse response = default;
