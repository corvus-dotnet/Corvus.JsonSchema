...
/// <summary>
/// Response type for the CountRunners operation.
/// </summary>
public struct CountRunnersResponse : IApiResponse<CountRunnersResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountRunnersResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountRunnersResponse response = default;
