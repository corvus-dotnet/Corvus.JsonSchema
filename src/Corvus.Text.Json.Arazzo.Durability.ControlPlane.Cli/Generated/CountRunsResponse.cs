...
/// <summary>
/// Response type for the CountRuns operation.
/// </summary>
public struct CountRunsResponse : IApiResponse<CountRunsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountRunsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountRunsResponse response = default;
