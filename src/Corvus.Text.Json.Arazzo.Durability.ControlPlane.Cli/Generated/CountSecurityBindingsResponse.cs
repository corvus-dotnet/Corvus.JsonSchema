...
/// <summary>
/// Response type for the CountSecurityBindings operation.
/// </summary>
public struct CountSecurityBindingsResponse : IApiResponse<CountSecurityBindingsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountSecurityBindingsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountSecurityBindingsResponse response = default;
