...
/// <summary>
/// Response type for the CountSecurityRules operation.
/// </summary>
public struct CountSecurityRulesResponse : IApiResponse<CountSecurityRulesResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountSecurityRulesResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountSecurityRulesResponse response = default;
