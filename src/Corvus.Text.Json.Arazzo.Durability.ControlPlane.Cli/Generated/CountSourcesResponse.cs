...
/// <summary>
/// Response type for the CountSources operation.
/// </summary>
public struct CountSourcesResponse : IApiResponse<CountSourcesResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountSourcesResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountSourcesResponse response = default;
