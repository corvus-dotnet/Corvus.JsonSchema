...
/// <summary>
/// Response type for the CountVersionAvailability operation.
/// </summary>
public struct CountVersionAvailabilityResponse : IApiResponse<CountVersionAvailabilityResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountVersionAvailabilityResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountVersionAvailabilityResponse response = default;
