...
/// <summary>
/// Response type for the CountWorkspaceWorkflows operation.
/// </summary>
public struct CountWorkspaceWorkflowsResponse : IApiResponse<CountWorkspaceWorkflowsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CountWorkspaceWorkflowsResponse> CreateAsync(
        int statusCode,
    ...
    {
        CountWorkspaceWorkflowsResponse response = default;
