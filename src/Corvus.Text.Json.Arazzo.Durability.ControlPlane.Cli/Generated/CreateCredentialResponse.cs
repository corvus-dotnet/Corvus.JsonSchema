...
/// <summary>
/// Response type for the CreateCredential operation.
/// </summary>
public struct CreateCredentialResponse : IApiResponse<CreateCredentialResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CredentialBindingSummary CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<CreateCredentialResponse> CreateAsync(
        int statusCode,
    ...
    {
        CreateCredentialResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CredentialBindingSummary>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CredentialBindingSummary result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CredentialBindingSummary, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CredentialBindingSummary, TContext, TResult> matchCreated,
