...
/// <summary>
/// Response type for the CreateRepoBranch operation.
/// </summary>
public struct CreateRepoBranchResponse : IApiResponse<CreateRepoBranchResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBranch CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<CreateRepoBranchResponse> CreateAsync(
        int statusCode,
    ...
    {
        CreateRepoBranchResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBranch>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBranch result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBranch, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubBranch, TContext, TResult> matchCreated,
