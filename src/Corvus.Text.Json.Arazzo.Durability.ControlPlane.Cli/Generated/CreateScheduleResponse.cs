...
/// <summary>
/// Response type for the CreateSchedule operation.
/// </summary>
public struct CreateScheduleResponse : IApiResponse<CreateScheduleResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Schedule CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<CreateScheduleResponse> CreateAsync(
        int statusCode,
    ...
    {
        CreateScheduleResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Schedule>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Schedule result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Schedule, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Schedule, TContext, TResult> matchCreated,
