...
/// <summary>
/// Response type for the CreateSecurityRule operation.
/// </summary>
public struct CreateSecurityRuleResponse : IApiResponse<CreateSecurityRuleResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityRuleSummary CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<CreateSecurityRuleResponse> CreateAsync(
        int statusCode,
    ...
    {
        CreateSecurityRuleResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityRuleSummary>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityRuleSummary result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityRuleSummary, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityRuleSummary, TContext, TResult> matchCreated,
