...
/// <summary>
/// Response type for the CreateSource operation.
/// </summary>
public struct CreateSourceResponse : IApiResponse<CreateSourceResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceEntity CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<CreateSourceResponse> CreateAsync(
        int statusCode,
    ...
    {
        CreateSourceResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceEntity>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceEntity result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceEntity, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceEntity, TContext, TResult> matchCreated,
