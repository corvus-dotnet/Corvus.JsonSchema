...
/// <summary>
/// Response type for the CreateWorkspaceWorkflow operation.
/// </summary>
public struct CreateWorkspaceWorkflowResponse : IApiResponse<CreateWorkspaceWorkflowResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<CreateWorkspaceWorkflowResponse> CreateAsync(
        int statusCode,
    ...
    {
        CreateWorkspaceWorkflowResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy, TContext, TResult> matchCreated,
