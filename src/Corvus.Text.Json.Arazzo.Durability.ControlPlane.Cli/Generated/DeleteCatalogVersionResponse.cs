...
/// <summary>
/// Response type for the DeleteCatalogVersion operation.
/// </summary>
public struct DeleteCatalogVersionResponse : IApiResponse<DeleteCatalogVersionResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteCatalogVersionResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteCatalogVersionResponse response = default;
