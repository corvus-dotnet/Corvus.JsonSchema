...
/// <summary>
/// Response type for the DeleteCredential operation.
/// </summary>
public struct DeleteCredentialResponse : IApiResponse<DeleteCredentialResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteCredentialResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteCredentialResponse response = default;
