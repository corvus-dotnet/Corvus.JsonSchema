...
/// <summary>
/// Response type for the DeleteDebugRun operation.
/// </summary>
public struct DeleteDebugRunResponse : IApiResponse<DeleteDebugRunResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteDebugRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteDebugRunResponse response = default;
