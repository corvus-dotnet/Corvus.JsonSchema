...
/// <summary>
/// Response type for the DeleteEnvironment operation.
/// </summary>
public struct DeleteEnvironmentResponse : IApiResponse<DeleteEnvironmentResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteEnvironmentResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteEnvironmentResponse response = default;
