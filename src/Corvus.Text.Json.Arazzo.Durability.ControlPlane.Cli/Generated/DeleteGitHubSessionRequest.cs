...
/// <summary>
/// Request type for the DeleteGitHubSession operation.
/// </summary>
/// <remarks>Drops the calling principal's brokered GitHub token. Idempotent.</remarks>
public readonly struct DeleteGitHubSessionRequest : IApiRequest<DeleteGitHubSessionRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/github/session"u8;
