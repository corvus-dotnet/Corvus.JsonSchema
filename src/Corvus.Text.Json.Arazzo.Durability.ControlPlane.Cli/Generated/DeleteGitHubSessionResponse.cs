...
/// <summary>
/// Response type for the DeleteGitHubSession operation.
/// </summary>
public struct DeleteGitHubSessionResponse : IApiResponse<DeleteGitHubSessionResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteGitHubSessionResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteGitHubSessionResponse response = default;
