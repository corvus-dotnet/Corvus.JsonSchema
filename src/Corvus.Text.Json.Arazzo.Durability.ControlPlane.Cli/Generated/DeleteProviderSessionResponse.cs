...
/// <summary>
/// Response type for the DeleteProviderSession operation.
/// </summary>
public struct DeleteProviderSessionResponse : IApiResponse<DeleteProviderSessionResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteProviderSessionResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteProviderSessionResponse response = default;
