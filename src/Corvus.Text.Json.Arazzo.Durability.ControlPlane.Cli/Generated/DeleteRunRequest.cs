...
/// <summary>
/// Request type for the DeleteRun operation.
/// </summary>
...
public readonly struct DeleteRunRequest : IApiRequest<DeleteRunRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DeleteRunRequest"/> struct.
    /// </summary>
    /// <param name="runId">The runId parameter.</param>
    public DeleteRunRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString runId)
    {
        this.RunId = runId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/runs/{runId}"u8;
