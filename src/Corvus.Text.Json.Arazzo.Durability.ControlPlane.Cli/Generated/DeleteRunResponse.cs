...
/// <summary>
/// Response type for the DeleteRun operation.
/// </summary>
public struct DeleteRunResponse : IApiResponse<DeleteRunResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteRunResponse response = default;
