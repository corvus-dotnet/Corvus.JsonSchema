...
/// <summary>
/// Response type for the DeleteScenario operation.
/// </summary>
public struct DeleteScenarioResponse : IApiResponse<DeleteScenarioResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteScenarioResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteScenarioResponse response = default;
