...
/// <summary>
/// Response type for the DeleteSchedule operation.
/// </summary>
public struct DeleteScheduleResponse : IApiResponse<DeleteScheduleResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteScheduleResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteScheduleResponse response = default;
