...
/// <summary>
/// Response type for the DeleteSecurityBinding operation.
/// </summary>
public struct DeleteSecurityBindingResponse : IApiResponse<DeleteSecurityBindingResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteSecurityBindingResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteSecurityBindingResponse response = default;
