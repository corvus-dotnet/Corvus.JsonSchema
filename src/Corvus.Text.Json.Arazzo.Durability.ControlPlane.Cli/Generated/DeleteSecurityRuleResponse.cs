...
/// <summary>
/// Response type for the DeleteSecurityRule operation.
/// </summary>
public struct DeleteSecurityRuleResponse : IApiResponse<DeleteSecurityRuleResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteSecurityRuleResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteSecurityRuleResponse response = default;
