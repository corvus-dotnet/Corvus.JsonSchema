...
/// <summary>
/// Response type for the DeleteSource operation.
/// </summary>
public struct DeleteSourceResponse : IApiResponse<DeleteSourceResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteSourceResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteSourceResponse response = default;
