...
/// <summary>
/// Response type for the DeleteWorkspaceWorkflow operation.
/// </summary>
public struct DeleteWorkspaceWorkflowResponse : IApiResponse<DeleteWorkspaceWorkflowResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DeleteWorkspaceWorkflowResponse> CreateAsync(
        int statusCode,
    ...
    {
        DeleteWorkspaceWorkflowResponse response = default;
