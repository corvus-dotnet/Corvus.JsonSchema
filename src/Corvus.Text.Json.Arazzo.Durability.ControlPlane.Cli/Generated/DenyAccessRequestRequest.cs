...
/// <summary>
/// Request type for the DenyAccessRequest operation.
/// </summary>
/// <remarks>Denies a pending request. The caller must be an administrator of the target workflow (403 otherwise). A request that is not pending conflicts (409).</remarks>
public readonly struct DenyAccessRequestRequest : IApiRequest<DenyAccessRequestRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DenyAccessRequestRequest"/> struct.
    /// </summary>
    /// <param name="requestId">The requestId parameter.</param>
    public DenyAccessRequestRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString requestId)
    {
        this.RequestId = requestId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/accessRequests/{requestId}/deny"u8;
