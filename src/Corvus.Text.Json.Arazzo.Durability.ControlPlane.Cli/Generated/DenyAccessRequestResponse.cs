...
/// <summary>
/// Response type for the DenyAccessRequest operation.
/// </summary>
public struct DenyAccessRequestResponse : IApiResponse<DenyAccessRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DenyAccessRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        DenyAccessRequestResponse response = default;
