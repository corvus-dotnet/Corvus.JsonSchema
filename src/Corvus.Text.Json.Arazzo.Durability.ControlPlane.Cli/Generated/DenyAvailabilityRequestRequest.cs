...
/// <summary>
/// Request type for the DenyAvailabilityRequest operation.
/// </summary>
...
public readonly struct DenyAvailabilityRequestRequest : IApiRequest<DenyAvailabilityRequestRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DenyAvailabilityRequestRequest"/> struct.
    /// </summary>
    /// <param name="requestId">The requestId parameter.</param>
    public DenyAvailabilityRequestRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString requestId)
    {
        this.RequestId = requestId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/availabilityRequests/{requestId}/deny"u8;
