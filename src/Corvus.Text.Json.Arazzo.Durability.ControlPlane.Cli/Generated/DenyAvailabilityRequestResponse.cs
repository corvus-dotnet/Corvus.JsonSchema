...
/// <summary>
/// Response type for the DenyAvailabilityRequest operation.
/// </summary>
public struct DenyAvailabilityRequestResponse : IApiResponse<DenyAvailabilityRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DenyAvailabilityRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        DenyAvailabilityRequestResponse response = default;
