...
/// <summary>
/// Response type for the DetachWorkingCopySource operation.
/// </summary>
public struct DetachWorkingCopySourceResponse : IApiResponse<DetachWorkingCopySourceResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<DetachWorkingCopySourceResponse> CreateAsync(
        int statusCode,
    ...
    {
        DetachWorkingCopySourceResponse response = default;
