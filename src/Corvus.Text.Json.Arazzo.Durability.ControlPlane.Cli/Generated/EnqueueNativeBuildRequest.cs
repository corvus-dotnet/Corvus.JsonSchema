...
/// <summary>
/// Request type for the EnqueueNativeBuild operation.
/// </summary>
...
public readonly struct EnqueueNativeBuildRequest : IApiRequest<EnqueueNativeBuildRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EnqueueNativeBuildRequest"/> struct.
    /// </summary>
    /// <param name="baseWorkflowId">The baseWorkflowId parameter.</param>
    /// <param name="versionNumber">The versionNumber parameter.</param>
    public EnqueueNativeBuildRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString baseWorkflowId, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.VersionNumber versionNumber)
    {
