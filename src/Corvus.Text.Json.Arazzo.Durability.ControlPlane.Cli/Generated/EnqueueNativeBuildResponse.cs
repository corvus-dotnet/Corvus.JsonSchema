...
/// <summary>
/// Response type for the EnqueueNativeBuild operation.
/// </summary>
public struct EnqueueNativeBuildResponse : IApiResponse<EnqueueNativeBuildResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView AcceptedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<EnqueueNativeBuildResponse> CreateAsync(
        int statusCode,
    ...
    {
        EnqueueNativeBuildResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 202)
        {
            var acceptedDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetAccepted(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView, TResult> matchAccepted,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView, TContext, TResult> matchAccepted,
