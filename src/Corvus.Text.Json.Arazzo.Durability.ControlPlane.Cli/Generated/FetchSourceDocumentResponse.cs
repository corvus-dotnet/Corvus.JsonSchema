...
/// <summary>
/// Response type for the FetchSourceDocument operation.
/// </summary>
public struct FetchSourceDocumentResponse : IApiResponse<FetchSourceDocumentResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.FetchedSourceDocument OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<FetchSourceDocumentResponse> CreateAsync(
        int statusCode,
    ...
    {
        FetchSourceDocumentResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.FetchedSourceDocument>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.FetchedSourceDocument result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.FetchedSourceDocument, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.FetchedSourceDocument, TContext, TResult> matchOk,
