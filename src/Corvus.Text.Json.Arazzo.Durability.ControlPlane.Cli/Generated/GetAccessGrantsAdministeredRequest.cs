...
/// <summary>
/// Request type for the GetAccessGrantsAdministered operation.
/// </summary>
...
public readonly struct GetAccessGrantsAdministeredRequest : IApiRequest<GetAccessGrantsAdministeredRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAccessGrantsAdministeredRequest"/> struct.
    /// </summary>
    /// <param name="grantee">The grantee parameter.</param>
    public GetAccessGrantsAdministeredRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString grantee)
    {
        this.Grantee = grantee;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/access/grants/administered"u8;
