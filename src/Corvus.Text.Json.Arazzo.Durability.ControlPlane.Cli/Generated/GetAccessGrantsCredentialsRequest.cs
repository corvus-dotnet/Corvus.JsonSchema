...
/// <summary>
/// Request type for the GetAccessGrantsCredentials operation.
/// </summary>
...
public readonly struct GetAccessGrantsCredentialsRequest : IApiRequest<GetAccessGrantsCredentialsRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAccessGrantsCredentialsRequest"/> struct.
    /// </summary>
    /// <param name="grantee">The grantee parameter.</param>
    public GetAccessGrantsCredentialsRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString grantee)
    {
        this.Grantee = grantee;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/access/grants/credentials"u8;
