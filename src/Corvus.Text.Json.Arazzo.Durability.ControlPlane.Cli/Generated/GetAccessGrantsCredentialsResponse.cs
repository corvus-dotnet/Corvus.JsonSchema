...
/// <summary>
/// Response type for the GetAccessGrantsCredentials operation.
/// </summary>
public struct GetAccessGrantsCredentialsResponse : IApiResponse<GetAccessGrantsCredentialsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsCredentialsPage OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetAccessGrantsCredentialsResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetAccessGrantsCredentialsResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsCredentialsPage>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsCredentialsPage result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsCredentialsPage, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsCredentialsPage, TContext, TResult> matchOk,
