...
/// <summary>
/// Request type for the GetAccessGrantsReach operation.
/// </summary>
...
public readonly struct GetAccessGrantsReachRequest : IApiRequest<GetAccessGrantsReachRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAccessGrantsReachRequest"/> struct.
    /// </summary>
    /// <param name="grantee">The grantee parameter.</param>
    public GetAccessGrantsReachRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString grantee)
    {
        this.Grantee = grantee;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/access/grants/reach"u8;
