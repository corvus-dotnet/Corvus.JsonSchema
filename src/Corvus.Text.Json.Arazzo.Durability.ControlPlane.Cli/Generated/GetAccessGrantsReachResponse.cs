...
/// <summary>
/// Response type for the GetAccessGrantsReach operation.
/// </summary>
public struct GetAccessGrantsReachResponse : IApiResponse<GetAccessGrantsReachResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsReachPage OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetAccessGrantsReachResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetAccessGrantsReachResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsReachPage>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsReachPage result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsReachPage, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsReachPage, TContext, TResult> matchOk,
