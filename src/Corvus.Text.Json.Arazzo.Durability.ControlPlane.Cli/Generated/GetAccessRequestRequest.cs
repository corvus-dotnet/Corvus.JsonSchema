...
/// <summary>
/// Request type for the GetAccessRequest operation.
/// </summary>
...
public readonly struct GetAccessRequestRequest : IApiRequest<GetAccessRequestRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAccessRequestRequest"/> struct.
    /// </summary>
    /// <param name="requestId">The requestId parameter.</param>
    public GetAccessRequestRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString requestId)
    {
        this.RequestId = requestId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/accessRequests/{requestId}"u8;
