...
/// <summary>
/// Response type for the GetAccessRequest operation.
/// </summary>
public struct GetAccessRequestResponse : IApiResponse<GetAccessRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetAccessRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetAccessRequestResponse response = default;
