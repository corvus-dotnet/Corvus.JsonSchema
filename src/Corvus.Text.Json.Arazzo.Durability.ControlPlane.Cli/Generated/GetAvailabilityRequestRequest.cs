...
/// <summary>
/// Request type for the GetAvailabilityRequest operation.
/// </summary>
...
public readonly struct GetAvailabilityRequestRequest : IApiRequest<GetAvailabilityRequestRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAvailabilityRequestRequest"/> struct.
    /// </summary>
    /// <param name="requestId">The requestId parameter.</param>
    public GetAvailabilityRequestRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString requestId)
    {
        this.RequestId = requestId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/availabilityRequests/{requestId}"u8;
