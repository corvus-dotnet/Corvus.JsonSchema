...
/// <summary>
/// Response type for the GetAvailabilityRequest operation.
/// </summary>
public struct GetAvailabilityRequestResponse : IApiResponse<GetAvailabilityRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetAvailabilityRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetAvailabilityRequestResponse response = default;
