...
/// <summary>
/// Response type for the GetCatalogEvidence operation.
/// </summary>
public struct GetCatalogEvidenceResponse : IApiResponse<GetCatalogEvidenceResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PublishEvidence OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetCatalogEvidenceResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetCatalogEvidenceResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PublishEvidence>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PublishEvidence result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PublishEvidence, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PublishEvidence, TContext, TResult> matchOk,
