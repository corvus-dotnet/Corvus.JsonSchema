...
/// <summary>
/// Response type for the GetCatalogExecutorManifest operation.
/// </summary>
public struct GetCatalogExecutorManifestResponse : IApiResponse<GetCatalogExecutorManifestResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonObject OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetCatalogExecutorManifestResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetCatalogExecutorManifestResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonObject>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonObject result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonObject, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonObject, TContext, TResult> matchOk,
