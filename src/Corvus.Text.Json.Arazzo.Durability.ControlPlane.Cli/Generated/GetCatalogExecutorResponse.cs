...
/// <summary>
/// Response type for the GetCatalogExecutor operation.
/// </summary>
public struct GetCatalogExecutorResponse : IApiResponse<GetCatalogExecutorResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetCatalogExecutorResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetCatalogExecutorResponse response = default;
