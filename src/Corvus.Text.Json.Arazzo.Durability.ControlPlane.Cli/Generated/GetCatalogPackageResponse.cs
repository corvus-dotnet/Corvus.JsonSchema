...
/// <summary>
/// Response type for the GetCatalogPackage operation.
/// </summary>
public struct GetCatalogPackageResponse : IApiResponse<GetCatalogPackageResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetCatalogPackageResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetCatalogPackageResponse response = default;
