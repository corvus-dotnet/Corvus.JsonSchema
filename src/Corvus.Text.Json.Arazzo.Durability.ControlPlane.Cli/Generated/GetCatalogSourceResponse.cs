...
/// <summary>
/// Response type for the GetCatalogSource operation.
/// </summary>
public struct GetCatalogSourceResponse : IApiResponse<GetCatalogSourceResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetCatalogSourceResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetCatalogSourceResponse response = default;
