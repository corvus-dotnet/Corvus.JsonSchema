...
/// <summary>
/// Request type for the GetCatalogVersion operation.
/// </summary>
...
public readonly struct GetCatalogVersionRequest : IApiRequest<GetCatalogVersionRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetCatalogVersionRequest"/> struct.
    /// </summary>
    /// <param name="baseWorkflowId">The baseWorkflowId parameter.</param>
    /// <param name="versionNumber">The versionNumber parameter.</param>
    public GetCatalogVersionRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString baseWorkflowId, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.VersionNumber versionNumber)
    {
