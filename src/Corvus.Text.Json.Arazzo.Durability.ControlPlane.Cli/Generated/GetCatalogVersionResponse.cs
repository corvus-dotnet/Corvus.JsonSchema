...
/// <summary>
/// Response type for the GetCatalogVersion operation.
/// </summary>
public struct GetCatalogVersionResponse : IApiResponse<GetCatalogVersionResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetCatalogVersionResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetCatalogVersionResponse response = default;
    ...
    /// </summary>
    public GetCatalogVersionResponseLinksAccessor Links => new(this);

    /// <summary>
    /// Provides navigable link methods for the <see cref="GetCatalogVersionResponse"/>.
    /// </summary>
    public readonly struct GetCatalogVersionResponseLinksAccessor
    {
        private readonly GetCatalogVersionResponse response;

        internal GetCatalogVersionResponseLinksAccessor(GetCatalogVersionResponse response)
        {
