...
/// <summary>
/// Response type for the GetCatalogWorkflow operation.
/// </summary>
public struct GetCatalogWorkflowResponse : IApiResponse<GetCatalogWorkflowResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetCatalogWorkflowResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetCatalogWorkflowResponse response = default;
