...
/// <summary>
/// Request type for the GetCatalogWorkflowSchemas operation.
/// </summary>
...
public readonly struct GetCatalogWorkflowSchemasRequest : IApiRequest<GetCatalogWorkflowSchemasRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetCatalogWorkflowSchemasRequest"/> struct.
    /// </summary>
    /// <param name="baseWorkflowId">The baseWorkflowId parameter.</param>
    /// <param name="versionNumber">The versionNumber parameter.</param>
    public GetCatalogWorkflowSchemasRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString baseWorkflowId, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.VersionNumber versionNumber)
    {
    ...
    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/catalog/{baseWorkflowId}/versions/{versionNumber}/schemas"u8;
