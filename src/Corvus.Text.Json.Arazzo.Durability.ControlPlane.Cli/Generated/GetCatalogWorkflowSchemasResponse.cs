...
/// <summary>
/// Response type for the GetCatalogWorkflowSchemas operation.
/// </summary>
public struct GetCatalogWorkflowSchemasResponse : IApiResponse<GetCatalogWorkflowSchemasResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetCatalogWorkflowSchemasResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetCatalogWorkflowSchemasResponse response = default;
