...
/// <summary>
/// Response type for the GetCredential operation.
/// </summary>
public struct GetCredentialResponse : IApiResponse<GetCredentialResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetCredentialResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetCredentialResponse response = default;
