...
/// <summary>
/// Response type for the GetDebugRun operation.
/// </summary>
public struct GetDebugRunResponse : IApiResponse<GetDebugRunResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetDebugRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetDebugRunResponse response = default;
