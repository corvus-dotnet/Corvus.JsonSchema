...
/// <summary>
/// Response type for the GetDeployment operation.
/// </summary>
public struct GetDeploymentResponse : IApiResponse<GetDeploymentResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetDeploymentResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetDeploymentResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView, TContext, TResult> matchOk,
