...
/// <summary>
/// Response type for the GetEnvironmentExecutionBudget operation.
/// </summary>
public struct GetEnvironmentExecutionBudgetResponse : IApiResponse<GetEnvironmentExecutionBudgetResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentExecutionBudget OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetEnvironmentExecutionBudgetResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetEnvironmentExecutionBudgetResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentExecutionBudget>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentExecutionBudget result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentExecutionBudget, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentExecutionBudget, TContext, TResult> matchOk,
