...
/// <summary>
/// Response type for the GetGitHubStatus operation.
/// </summary>
public struct GetGitHubStatusResponse : IApiResponse<GetGitHubStatusResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubStatus OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetGitHubStatusResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetGitHubStatusResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubStatus>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubStatus result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubStatus, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubStatus, TContext, TResult> matchOk,
