...
/// <summary>
/// Response type for the GetIdentityCapabilities operation.
/// </summary>
public struct GetIdentityCapabilitiesResponse : IApiResponse<GetIdentityCapabilitiesResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.IdentityCapabilities OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<GetIdentityCapabilitiesResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetIdentityCapabilitiesResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.IdentityCapabilities>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.IdentityCapabilities result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.IdentityCapabilities, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.IdentityCapabilities, TContext, TResult> matchOk,
