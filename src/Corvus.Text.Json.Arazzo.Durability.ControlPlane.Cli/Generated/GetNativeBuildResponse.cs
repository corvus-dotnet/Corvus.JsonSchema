...
/// <summary>
/// Response type for the GetNativeBuild operation.
/// </summary>
public struct GetNativeBuildResponse : IApiResponse<GetNativeBuildResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetNativeBuildResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetNativeBuildResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildView, TContext, TResult> matchOk,
