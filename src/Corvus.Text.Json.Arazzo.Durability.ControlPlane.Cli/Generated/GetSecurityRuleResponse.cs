...
/// <summary>
/// Response type for the GetSecurityRule operation.
/// </summary>
public struct GetSecurityRuleResponse : IApiResponse<GetSecurityRuleResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetSecurityRuleResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetSecurityRuleResponse response = default;
