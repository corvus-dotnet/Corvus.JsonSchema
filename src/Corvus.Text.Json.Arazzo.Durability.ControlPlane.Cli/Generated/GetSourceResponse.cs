...
/// <summary>
/// Response type for the GetSource operation.
/// </summary>
public struct GetSourceResponse : IApiResponse<GetSourceResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetSourceResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetSourceResponse response = default;
