...
/// <summary>
/// Response type for the GetWhoami operation.
/// </summary>
public struct GetWhoamiResponse : IApiResponse<GetWhoamiResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<GetWhoamiResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetWhoamiResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI, TContext, TResult> matchOk,
