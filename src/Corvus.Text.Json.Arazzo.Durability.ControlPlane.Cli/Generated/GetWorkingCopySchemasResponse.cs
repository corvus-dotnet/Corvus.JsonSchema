...
/// <summary>
/// Response type for the GetWorkingCopySchemas operation.
/// </summary>
public struct GetWorkingCopySchemasResponse : IApiResponse<GetWorkingCopySchemasResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetWorkingCopySchemasResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetWorkingCopySchemasResponse response = default;
