...
/// <summary>
/// Response type for the GetWorkingCopySource operation.
/// </summary>
public struct GetWorkingCopySourceResponse : IApiResponse<GetWorkingCopySourceResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdSourcesByNameOk OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetWorkingCopySourceResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetWorkingCopySourceResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdSourcesByNameOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdSourcesByNameOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdSourcesByNameOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdSourcesByNameOk, TContext, TResult> matchOk,
