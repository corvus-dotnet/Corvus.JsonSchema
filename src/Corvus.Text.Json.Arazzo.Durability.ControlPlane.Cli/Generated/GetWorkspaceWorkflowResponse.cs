...
/// <summary>
/// Response type for the GetWorkspaceWorkflow operation.
/// </summary>
public struct GetWorkspaceWorkflowResponse : IApiResponse<GetWorkspaceWorkflowResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetWorkspaceWorkflowResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetWorkspaceWorkflowResponse response = default;
