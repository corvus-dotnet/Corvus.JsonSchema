...
/// <summary>
/// Response type for the GrantAccessRequest operation.
/// </summary>
public struct GrantAccessRequestResponse : IApiResponse<GrantAccessRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GrantAccessRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        GrantAccessRequestResponse response = default;
