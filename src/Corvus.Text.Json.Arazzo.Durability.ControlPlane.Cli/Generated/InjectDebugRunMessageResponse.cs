...
/// <summary>
/// Response type for the InjectDebugRunMessage operation.
/// </summary>
public struct InjectDebugRunMessageResponse : IApiResponse<InjectDebugRunMessageResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<InjectDebugRunMessageResponse> CreateAsync(
        int statusCode,
    ...
    {
        InjectDebugRunMessageResponse response = default;
