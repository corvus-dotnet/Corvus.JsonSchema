...
/// <summary>
/// Response type for the ListAdministrators operation.
/// </summary>
public struct ListAdministratorsResponse : IApiResponse<ListAdministratorsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListAdministratorsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListAdministratorsResponse response = default;
