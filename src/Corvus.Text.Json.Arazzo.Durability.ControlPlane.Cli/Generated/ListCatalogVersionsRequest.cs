...
/// <summary>
/// Request type for the ListCatalogVersions operation.
/// </summary>
/// <remarks>List the versions of a workflow</remarks>
public readonly struct ListCatalogVersionsRequest : IApiRequest<ListCatalogVersionsRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ListCatalogVersionsRequest"/> struct.
    /// </summary>
    /// <param name="baseWorkflowId">The baseWorkflowId parameter.</param>
    public ListCatalogVersionsRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString baseWorkflowId)
    {
        this.BaseWorkflowId = baseWorkflowId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/catalog/{baseWorkflowId}"u8;
