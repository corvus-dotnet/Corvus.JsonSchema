...
/// <summary>
/// Response type for the ListCatalogVersions operation.
/// </summary>
public struct ListCatalogVersionsResponse : IApiResponse<ListCatalogVersionsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListCatalogVersionsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListCatalogVersionsResponse response = default;
