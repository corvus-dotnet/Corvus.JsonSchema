...
/// <summary>
/// Request type for the ListDeployments operation.
/// </summary>
...
public readonly struct ListDeploymentsRequest : IApiRequest<ListDeploymentsRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ListDeploymentsRequest"/> struct.
    /// </summary>
    /// <param name="baseWorkflowId">The baseWorkflowId parameter.</param>
    /// <param name="versionNumber">The versionNumber parameter.</param>
    public ListDeploymentsRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString baseWorkflowId, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.VersionNumber versionNumber)
    {
    ...
    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/catalog/{baseWorkflowId}/versions/{versionNumber}/deployments"u8;
