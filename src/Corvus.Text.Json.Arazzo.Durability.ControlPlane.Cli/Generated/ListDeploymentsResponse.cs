...
/// <summary>
/// Response type for the ListDeployments operation.
/// </summary>
public struct ListDeploymentsResponse : IApiResponse<ListDeploymentsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentList OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListDeploymentsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListDeploymentsResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentList, TContext, TResult> matchOk,
