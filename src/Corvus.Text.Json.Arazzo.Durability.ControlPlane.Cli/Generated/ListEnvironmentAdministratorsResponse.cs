...
/// <summary>
/// Response type for the ListEnvironmentAdministrators operation.
/// </summary>
public struct ListEnvironmentAdministratorsResponse : IApiResponse<ListEnvironmentAdministratorsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListEnvironmentAdministratorsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListEnvironmentAdministratorsResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList, TContext, TResult> matchOk,
