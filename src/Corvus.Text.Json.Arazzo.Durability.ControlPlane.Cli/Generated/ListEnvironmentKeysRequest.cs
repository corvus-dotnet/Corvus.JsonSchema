...
/// <summary>
/// Request type for the ListEnvironmentKeys operation.
/// </summary>
...
public readonly struct ListEnvironmentKeysRequest : IApiRequest<ListEnvironmentKeysRequest>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetEnvironmentsByNameKeysState State { get; init; }
    ...
    public void Validate(ValidationMode mode = ValidationMode.Basic)
    {
        ...
        else
        {
            ...
            if (this.State.IsNotUndefined() && !this.State.EvaluateSchema())
            {
