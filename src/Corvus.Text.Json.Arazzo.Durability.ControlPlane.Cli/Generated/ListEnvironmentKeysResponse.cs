...
/// <summary>
/// Response type for the ListEnvironmentKeys operation.
/// </summary>
public struct ListEnvironmentKeysResponse : IApiResponse<ListEnvironmentKeysResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentKeyList OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListEnvironmentKeysResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListEnvironmentKeysResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentKeyList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentKeyList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentKeyList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentKeyList, TContext, TResult> matchOk,
