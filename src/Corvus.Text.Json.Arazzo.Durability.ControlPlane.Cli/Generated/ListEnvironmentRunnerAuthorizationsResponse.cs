...
/// <summary>
/// Response type for the ListEnvironmentRunnerAuthorizations operation.
/// </summary>
public struct ListEnvironmentRunnerAuthorizationsResponse : IApiResponse<ListEnvironmentRunnerAuthorizationsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentRunnerAuthorizationList OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListEnvironmentRunnerAuthorizationsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListEnvironmentRunnerAuthorizationsResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentRunnerAuthorizationList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentRunnerAuthorizationList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentRunnerAuthorizationList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentRunnerAuthorizationList, TContext, TResult> matchOk,
