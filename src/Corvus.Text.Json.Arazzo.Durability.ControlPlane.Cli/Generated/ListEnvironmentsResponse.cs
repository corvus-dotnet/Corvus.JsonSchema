...
/// <summary>
/// Response type for the ListEnvironments operation.
/// </summary>
public struct ListEnvironmentsResponse : IApiResponse<ListEnvironmentsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentList OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<ListEnvironmentsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListEnvironmentsResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentList, TContext, TResult> matchOk,
