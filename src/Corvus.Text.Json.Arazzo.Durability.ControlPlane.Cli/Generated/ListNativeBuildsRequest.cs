...
/// <summary>
/// Request type for the ListNativeBuilds operation.
/// </summary>
...
public readonly struct ListNativeBuildsRequest : IApiRequest<ListNativeBuildsRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ListNativeBuildsRequest"/> struct.
    /// </summary>
    /// <param name="baseWorkflowId">The baseWorkflowId parameter.</param>
    /// <param name="versionNumber">The versionNumber parameter.</param>
    public ListNativeBuildsRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString baseWorkflowId, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.VersionNumber versionNumber)
    {
    ...
    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/catalog/{baseWorkflowId}/versions/{versionNumber}/nativeBuilds"u8;
