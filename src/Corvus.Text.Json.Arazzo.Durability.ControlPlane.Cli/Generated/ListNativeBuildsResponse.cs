...
/// <summary>
/// Response type for the ListNativeBuilds operation.
/// </summary>
public struct ListNativeBuildsResponse : IApiResponse<ListNativeBuildsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildList OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListNativeBuildsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListNativeBuildsResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildList, TContext, TResult> matchOk,
