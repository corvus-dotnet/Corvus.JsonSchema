...
/// <summary>
/// Response type for the ListRegisteredSourceOperations operation.
/// </summary>
public struct ListRegisteredSourceOperationsResponse : IApiResponse<ListRegisteredSourceOperationsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListRegisteredSourceOperationsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListRegisteredSourceOperationsResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface, TContext, TResult> matchOk,
