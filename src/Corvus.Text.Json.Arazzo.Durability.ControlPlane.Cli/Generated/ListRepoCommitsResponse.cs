...
/// <summary>
/// Response type for the ListRepoCommits operation.
/// </summary>
public struct ListRepoCommitsResponse : IApiResponse<ListRepoCommitsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubCommitList OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListRepoCommitsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListRepoCommitsResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubCommitList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubCommitList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubCommitList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubCommitList, TContext, TResult> matchOk,
