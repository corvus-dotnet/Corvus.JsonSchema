...
/// <summary>
/// Response type for the ListRunnerAuthorizations operation.
/// </summary>
public struct ListRunnerAuthorizationsResponse : IApiResponse<ListRunnerAuthorizationsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListRunnerAuthorizationsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListRunnerAuthorizationsResponse response = default;
