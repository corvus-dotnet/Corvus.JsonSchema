...
/// <summary>
/// Response type for the ListScenarios operation.
/// </summary>
public struct ListScenariosResponse : IApiResponse<ListScenariosResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListScenariosResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListScenariosResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk, TContext, TResult> matchOk,
