...
/// <summary>
/// Response type for the ListSecurityBindings operation.
/// </summary>
public struct ListSecurityBindingsResponse : IApiResponse<ListSecurityBindingsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListSecurityBindingsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListSecurityBindingsResponse response = default;
