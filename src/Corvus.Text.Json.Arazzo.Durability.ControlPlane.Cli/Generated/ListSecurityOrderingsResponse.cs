...
/// <summary>
/// Response type for the ListSecurityOrderings operation.
/// </summary>
public struct ListSecurityOrderingsResponse : IApiResponse<ListSecurityOrderingsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrderingList OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<ListSecurityOrderingsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListSecurityOrderingsResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrderingList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrderingList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrderingList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrderingList, TContext, TResult> matchOk,
