...
/// <summary>
/// Response type for the ListSecurityRules operation.
/// </summary>
public struct ListSecurityRulesResponse : IApiResponse<ListSecurityRulesResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListSecurityRulesResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListSecurityRulesResponse response = default;
