...
/// <summary>
/// Response type for the ListVersionAvailability operation.
/// </summary>
public struct ListVersionAvailabilityResponse : IApiResponse<ListVersionAvailabilityResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListVersionAvailabilityResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListVersionAvailabilityResponse response = default;
