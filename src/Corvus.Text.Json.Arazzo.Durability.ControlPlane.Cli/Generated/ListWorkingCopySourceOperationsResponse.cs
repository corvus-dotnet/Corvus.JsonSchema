...
/// <summary>
/// Response type for the ListWorkingCopySourceOperations operation.
/// </summary>
public struct ListWorkingCopySourceOperationsResponse : IApiResponse<ListWorkingCopySourceOperationsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListWorkingCopySourceOperationsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListWorkingCopySourceOperationsResponse response = default;
