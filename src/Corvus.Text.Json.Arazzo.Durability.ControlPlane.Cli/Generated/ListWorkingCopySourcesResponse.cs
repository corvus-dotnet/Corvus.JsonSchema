...
/// <summary>
/// Response type for the ListWorkingCopySources operation.
/// </summary>
public struct ListWorkingCopySourcesResponse : IApiResponse<ListWorkingCopySourcesResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSourceList OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListWorkingCopySourcesResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListWorkingCopySourcesResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSourceList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSourceList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSourceList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSourceList, TContext, TResult> matchOk,
