...
/// <summary>
/// Response type for the MakeVersionAvailable operation.
/// </summary>
public struct MakeVersionAvailableResponse : IApiResponse<MakeVersionAvailableResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry OkBody { get; private set; }

    /// <summary>
    /// Gets the 201 response body.
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<MakeVersionAvailableResponse> CreateAsync(
        int statusCode,
    ...
    {
        MakeVersionAvailableResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
        ...
        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry result)
    {
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry, TResult> matchOk,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry, TContext, TResult> matchOk,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityEntry, TContext, TResult> matchCreated,
