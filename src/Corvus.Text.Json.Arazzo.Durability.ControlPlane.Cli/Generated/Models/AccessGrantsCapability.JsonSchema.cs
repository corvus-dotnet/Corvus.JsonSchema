    ...
    : IJsonElement<AccessGrantsCapability>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEligiblePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("eligible"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEligibleNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("eligible"u8, buffer, out written);

        private const int RequiredOffsetForEligible = 0;
        private const uint RequiredBitForEligible = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForEligible | RequiredBitForScope;
        private static readonly JsonSchemaPathProvider EligibleSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/eligible"u8, buffer, out written);
        ...
        private static void MatchEligible(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.EligibleUtf8,
                    evaluationPath: EligibleSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForEligible] |= RequiredBitForEligible;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.EligibleUtf8, MatchEligible),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/AccessGrantsCapability"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/AccessGrantsCapability";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/AccessGrantsCapability"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEligiblePresent, "eligible"u8, "required"u8);
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForEligible] & RequiredBitForEligible) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyEligibleNotPresent, "eligible"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEligiblePresent, "eligible"u8, "required"u8);
