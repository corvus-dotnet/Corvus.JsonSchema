...
public readonly partial struct AccessGrantsCredentialsPage
{
    ...
    public readonly partial struct AccessGrantsCredentialUsageArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AccessGrantsCredentialUsageArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AccessGrantsCredentialUsageArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AccessGrantsCredentialUsageArray(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AccessGrantsCredentialUsageArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly AccessGrantsCredentialUsageArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AccessGrantsCredentialUsageArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AccessGrantsCredentialUsageArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<AccessGrantsCredentialUsageArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AccessGrantsCredentialUsageArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AccessGrantsCredentialUsageArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AccessGrantsCredentialUsageArray> Create<TContext>(
