...
public readonly partial struct AccessGrantsOverview
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessGrantsAdministeredEnvironmentArray"/> struct.
        /// </summary>
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsAdministeredEnvironment this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsAdministeredEnvironment>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsAdministeredEnvironment> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsAdministeredEnvironment>(_parent, _idx);
        }
