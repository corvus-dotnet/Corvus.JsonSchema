...
public readonly partial struct AccessGrantsOverview
    ...
    : IJsonElement<AccessGrantsOverview>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AccessGrantsOverview"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AccessGrantsOverview(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AccessGrantsOverview DefaultInstance { get; }
    ...
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsOverview.AccessGrantsAdministeredEnvironmentArray AdministersEnvironments
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdministersEnvironmentsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsOverview.AccessGrantsAdministeredEnvironmentArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ResolvedGrantee Grantee
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GranteeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ResolvedGrantee value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in AccessGrantsOverview left, in AccessGrantsOverview right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AccessGrantsOverview left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AccessGrantsOverview instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AccessGrantsOverview(JsonElement instance)
    {
        return AccessGrantsOverview.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessGrantsOverview From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessGrantsOverview ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessGrantsOverview>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessGrantsOverview ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessGrantsOverview>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessGrantsOverview ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessGrantsOverview>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AccessGrantsOverview ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessGrantsOverview>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AccessGrantsOverview? result)
    {
        return JsonElementHelpers.TryParseValue<AccessGrantsOverview>(ref reader, out result);
    }
...
#if NET
    static AccessGrantsOverview IJsonElement<AccessGrantsOverview>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AccessGrantsOverview: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public AccessGrantsOverview Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public AccessGrantsOverview Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AccessGrantsOverview>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// Gets the JSON property name for <see cref="Grantee"/>.
        /// </summary>
        public static ReadOnlySpan<byte> GranteeUtf8 => "grantee"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// </summary>
        public static ReadOnlySpan<byte> Grantee => "grantee"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// </summary>
        public static ReadOnlySpan<byte> Grantee => [0x95, 0x00, 0x00, 0x00, 0x22, 0x67, 0x72, 0x61, 0x6E, 0x74, 0x65, 0x65, 0x22];
    }
}
