    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchBindings(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsReachPage.SecurityBindingSummaryArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessGrantsReachPage.SecurityBindingSummaryArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
