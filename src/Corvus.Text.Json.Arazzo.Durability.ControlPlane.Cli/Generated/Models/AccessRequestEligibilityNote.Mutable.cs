...
public readonly partial struct AccessRequestEligibilityNote
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AccessRequestEligibilityNote instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AccessRequestEligibilityNote"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AccessRequestEligibilityNote(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.Mutable EligibilityWindowSeconds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EligibilityWindowSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetEligibilityWindowSeconds(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EligibilityWindowSecondsUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EligibilityWindowSecondsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EligibilityWindowSeconds, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>eligibilityWindowSeconds</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveEligibilityWindowSeconds()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EligibilityWindowSecondsUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AccessRequestEligibilityNote.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly AccessRequestEligibilityNote Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly AccessRequestEligibilityNote Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AccessRequestEligibilityNote>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.Source arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(AccessRequestEligibilityNote instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AccessRequestEligibilityNote"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.Source eligibilityWindowSeconds = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default)
        {
            eligibilityWindowSeconds.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EligibilityWindowSeconds, ref builder);
        ...
        /// Creates an instance of a <see cref="AccessRequestEligibilityNote"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.Source eligibilityWindowSeconds = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default)
        {
            Create(ref _builder, eligibilityWindowSeconds, reason);
        }
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.Source arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.Source eligibilityWindowSeconds = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default)
    {
    ...
    {
        return workspace.CreateBuilder<AccessRequestEligibilityNote, Mutable>(this);
    }
}
