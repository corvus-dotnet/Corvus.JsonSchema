    ...
    : IJsonElement<AccessRequestList>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAccessRequestsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("accessRequests"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAccessRequestsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("accessRequests"u8, buffer, out written);

        private const int RequiredOffsetForAccessRequests = 0;
        private const uint RequiredBitForAccessRequests = 0b00000000000000000000000000000001;
        ...
        private static void MatchAccessRequests(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.AccessRequestsUtf8,
                    evaluationPath: AccessRequestsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/AccessRequestList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/AccessRequestList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/AccessRequestList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAccessRequestsPresent, "accessRequests"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAccessRequests] & RequiredBitForAccessRequests) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAccessRequestsNotPresent, "accessRequests"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAccessRequestsPresent, "accessRequests"u8, "required"u8);
