...
public readonly partial struct AccessRequestList
{
...
#endif
    {
        ...
        public void SetAccessRequests(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.Source accessRequests,
        ...
        /// Creates an instance of a <see cref="AccessRequestList"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.Source accessRequests, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source nextPageToken = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.Source accessRequests, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source nextPageToken = default)
    {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestList.AccessRequestViewArray.Source<TContext> accessRequests, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
