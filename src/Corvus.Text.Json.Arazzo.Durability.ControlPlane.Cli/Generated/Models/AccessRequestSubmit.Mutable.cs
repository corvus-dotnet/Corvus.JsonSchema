...
public readonly partial struct AccessRequestSubmit
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AccessRequestSubmit instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AccessRequestSubmit"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AccessRequestSubmit(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Mutable RequestedDurationSeconds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequestedDurationSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Mutable RequestedScopes
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequestedScopesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRequestedScopes<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AccessRequestSubmit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AccessRequestSubmit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AccessRequestSubmit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AccessRequestSubmit Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AccessRequestSubmit"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AccessRequestSubmit Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AccessRequestSubmit>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Source _createArg4;
        ...
        public static implicit operator Source(AccessRequestSubmit instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Source<TContext> _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Source _createArg4;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AccessRequestSubmit"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source baseWorkflowId,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Source requestedScopes,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Source requestedDurationSeconds = default)
        {
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Source requestedDurationSeconds = default)
        {
            Create(ref _builder, baseWorkflowId, requestedScopes, reason, requestedDurationSeconds);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source baseWorkflowId,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Source<TContext> requestedScopes,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Source requestedDurationSeconds = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        ...
        #endif
        {
            Create(context, ref _builder, baseWorkflowId, requestedScopes, reason, requestedDurationSeconds);
        }
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source baseWorkflowId, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Source<TContext> requestedScopes, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Source requestedDurationSeconds = default)
        ...
        #endif
    {
        return new Source<TContext>(context, baseWorkflowId, requestedScopes, reason, requestedDurationSeconds);
    }
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, baseWorkflowId, requestedScopes, reason, requestedDurationSeconds);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<AccessRequestSubmit, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AccessRequestSubmit> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AccessRequestSubmit>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccessRequestSubmit> Create<TContext>(
    ...
    public static ParsedJsonDocument<AccessRequestSubmit> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source baseWorkflowId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Source requestedScopes, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Source requestedDurationSeconds = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccessRequestSubmit> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source baseWorkflowId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.JsonStringArray.Source<TContext> requestedScopes, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Source requestedDurationSeconds = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
