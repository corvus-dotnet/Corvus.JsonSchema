...
public readonly partial struct AccessRequestSubmit
{
    ...
    public readonly partial struct RequestedDurationSecondsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequestedDurationSecondsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequestedDurationSecondsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequestedDurationSecondsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequestedDurationSecondsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RequestedDurationSecondsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RequestedDurationSecondsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequestedDurationSecondsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RequestedDurationSecondsEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RequestedDurationSecondsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RequestedDurationSecondsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RequestedDurationSecondsEntity>();
            }
            finally
            {
