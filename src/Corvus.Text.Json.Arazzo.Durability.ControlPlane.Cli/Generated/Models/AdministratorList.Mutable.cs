...
public readonly partial struct AdministratorList
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AdministratorList instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AdministratorList"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AdministratorList(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Mutable BroadeningAdvisory
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BroadeningAdvisoryUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AdministratorList(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetAdministrators(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList.AdministratorGrantArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("administrators");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdministratorsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Administrators, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetBroadeningAdvisory(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetBroadeningAdvisory<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AdministratorList.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AdministratorList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AdministratorList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AdministratorList Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AdministratorList>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AdministratorList"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AdministratorList Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AdministratorList>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source _createArg2;
        ...
        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList.AdministratorGrantArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(AdministratorList instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source<TContext> _createArg2;
        ...
        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList.AdministratorGrantArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList.AdministratorGrantArray.Source administrators,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source broadeningAdvisory = default)
        {
        ...
        /// Creates an instance of a <see cref="AdministratorList"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList.AdministratorGrantArray.Source administrators, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source broadeningAdvisory = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source<TContext> broadeningAdvisory = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList.AdministratorGrantArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorList.AdministratorGrantArray.Source administrators, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.Source broadeningAdvisory = default)
    {
