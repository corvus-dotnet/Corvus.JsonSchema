...
public readonly partial struct AdministratorMemberWrite
{
...
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetIdentity(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AdministratorMemberWrite.AdministratorIdentityArray.Source value)
        {
            CheckValidInstance();
