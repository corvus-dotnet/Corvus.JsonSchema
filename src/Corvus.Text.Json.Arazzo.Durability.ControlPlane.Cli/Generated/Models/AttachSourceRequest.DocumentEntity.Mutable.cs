...
public readonly partial struct AttachSourceRequest
{
    ...
    public readonly partial struct DocumentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DocumentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DocumentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DocumentEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DocumentEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DocumentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DocumentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DocumentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DocumentEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DocumentEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DocumentEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DocumentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DocumentEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachSourceRequest.DocumentEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(DocumentEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachSourceRequest.DocumentEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<DocumentEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DocumentEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DocumentEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<DocumentEntity> Create<TContext>(
