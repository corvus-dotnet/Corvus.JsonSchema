    ...
    : IJsonElement<AttachedSource>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAttachedAtPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("attachedAt"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAttachedAtNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("attachedAt"u8, buffer, out written);

        private const int RequiredOffsetForAttachedAt = 0;
        private const uint RequiredBitForAttachedAt = 0b00000000000000000000000000000001;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAttachedByPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("attachedBy"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAttachedByNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("attachedBy"u8, buffer, out written);

        private const int RequiredOffsetForAttachedBy = 0;
        private const uint RequiredBitForAttachedBy = 0b00000000000000000000000000000010;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForAttachedAt | RequiredBitForAttachedBy | RequiredBitForKind | RequiredBitForName;
        private static readonly JsonSchemaPathProvider AttachedAtSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/attachedAt"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider AttachedBySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/attachedBy"u8, buffer, out written);
        ...
        private static void MatchAttachedAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.AttachedAtUtf8,
                    evaluationPath: AttachedAtSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForAttachedAt] |= RequiredBitForAttachedAt;
        }

        private static void MatchAttachedBy(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.AttachedByUtf8,
                    evaluationPath: AttachedBySchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForAttachedBy] |= RequiredBitForAttachedBy;
        }
        ...
        private static void MatchKind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AttachedSource.KindEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.AttachedAtUtf8, MatchAttachedAt),
                (static () => JsonPropertyNames.AttachedByUtf8, MatchAttachedBy),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/AttachedSource"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/AttachedSource";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/AttachedSource"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAttachedAtPresent, "attachedAt"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyAttachedByPresent, "attachedBy"u8, "required"u8);
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAttachedAt] & RequiredBitForAttachedAt) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAttachedAtNotPresent, "attachedAt"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAttachedAtPresent, "attachedAt"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAttachedBy] & RequiredBitForAttachedBy) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyAttachedByNotPresent, "attachedBy"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyAttachedByPresent, "attachedBy"u8, "required"u8);
