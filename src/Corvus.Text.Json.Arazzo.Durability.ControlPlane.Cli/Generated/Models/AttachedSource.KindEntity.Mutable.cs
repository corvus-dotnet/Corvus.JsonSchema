...
public readonly partial struct AttachedSource
{
    ...
    public readonly partial struct KindEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(KindEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="KindEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator KindEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"KindEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly KindEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly KindEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<KindEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(KindEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<KindEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<KindEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<KindEntity>();
            }
            finally
            {
