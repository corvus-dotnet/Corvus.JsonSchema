    ...
    : IJsonElement<AvailabilityRequestList>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAvailabilityRequestsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("availabilityRequests"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAvailabilityRequestsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("availabilityRequests"u8, buffer, out written);

        private const int RequiredOffsetForAvailabilityRequests = 0;
        private const uint RequiredBitForAvailabilityRequests = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForAvailabilityRequests;
        private static readonly JsonSchemaPathProvider AvailabilityRequestsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/availabilityRequests"u8, buffer, out written);
        ...
        private static void MatchAvailabilityRequests(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestList.AvailabilityRequestViewArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.AvailabilityRequestsUtf8,
                    evaluationPath: AvailabilityRequestsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestList.AvailabilityRequestViewArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForAvailabilityRequests] |= RequiredBitForAvailabilityRequests;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                (static () => JsonPropertyNames.AvailabilityRequestsUtf8, MatchAvailabilityRequests),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/AvailabilityRequestList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/AvailabilityRequestList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/AvailabilityRequestList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAvailabilityRequestsPresent, "availabilityRequests"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAvailabilityRequests] & RequiredBitForAvailabilityRequests) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAvailabilityRequestsNotPresent, "availabilityRequests"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAvailabilityRequestsPresent, "availabilityRequests"u8, "required"u8);
