    ...
    : IJsonElement<AvailabilityRequestList>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchAvailabilityRequests(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
