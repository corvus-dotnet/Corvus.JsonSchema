...
public readonly partial struct AvailabilityRequestList
    ...
    : IJsonElement<AvailabilityRequestList>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AvailabilityRequestList"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AvailabilityRequestList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AvailabilityRequestList DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the <c>availabilityRequests</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestList.AvailabilityRequestViewArray AvailabilityRequests
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AvailabilityRequestsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestList.AvailabilityRequestViewArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in AvailabilityRequestList left, in AvailabilityRequestList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AvailabilityRequestList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AvailabilityRequestList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AvailabilityRequestList(JsonElement instance)
    {
        return AvailabilityRequestList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AvailabilityRequestList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AvailabilityRequestList? result)
    {
        return JsonElementHelpers.TryParseValue<AvailabilityRequestList>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new AvailabilityRequestList(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static AvailabilityRequestList IJsonElement<AvailabilityRequestList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AvailabilityRequestList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="AvailabilityRequestList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="AvailabilityRequestList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public AvailabilityRequestList Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<AvailabilityRequestList>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="AvailabilityRequestList"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public AvailabilityRequestList Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AvailabilityRequestList>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="AvailabilityRequests"/>.
        /// </summary>
        public const string AvailabilityRequests = "availabilityRequests";
        ...
        /// Gets the JSON property name for <see cref="AvailabilityRequests"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AvailabilityRequestsUtf8 => "availabilityRequests"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="AvailabilityRequests"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AvailabilityRequests => "availabilityRequests"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="AvailabilityRequests"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AvailabilityRequests => [0x65, 0x01, 0x00, 0x00, 0x22, 0x61, 0x76, 0x61, 0x69, 0x6C, 0x61, 0x62, 0x69, 0x6C, 0x69, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22];
