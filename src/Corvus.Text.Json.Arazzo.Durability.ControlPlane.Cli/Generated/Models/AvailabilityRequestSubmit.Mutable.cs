...
public readonly partial struct AvailabilityRequestSubmit
{
...
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetVersionNumber(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestSubmit.TheVersionNumberToMakeAvailable.Source value)
        {
            CheckValidInstance();
