...
public readonly partial struct AvailabilityRequestSubmit
{
    ...
    public readonly partial struct TheVersionNumberToMakeAvailable
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheVersionNumberToMakeAvailable instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheVersionNumberToMakeAvailable"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheVersionNumberToMakeAvailable(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheVersionNumberToMakeAvailable(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheVersionNumberToMakeAvailable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheVersionNumberToMakeAvailable"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheVersionNumberToMakeAvailable"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TheVersionNumberToMakeAvailable Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheVersionNumberToMakeAvailable>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheVersionNumberToMakeAvailable"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TheVersionNumberToMakeAvailable Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheVersionNumberToMakeAvailable>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheVersionNumberToMakeAvailable instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheVersionNumberToMakeAvailable, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheVersionNumberToMakeAvailable> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheVersionNumberToMakeAvailable>();
            }
            finally
            {
