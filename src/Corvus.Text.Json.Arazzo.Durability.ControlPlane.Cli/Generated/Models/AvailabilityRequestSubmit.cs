...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AvailabilityRequestSubmit"/> struct.
    /// </summary>
    ...
    internal AvailabilityRequestSubmit(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AvailabilityRequestSubmit DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestSubmit.TheVersionNumberToMakeAvailable VersionNumber
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionNumberUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestSubmit.TheVersionNumberToMakeAvailable value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in AvailabilityRequestSubmit left, in AvailabilityRequestSubmit right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AvailabilityRequestSubmit left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AvailabilityRequestSubmit instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AvailabilityRequestSubmit(JsonElement instance)
    {
        return AvailabilityRequestSubmit.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestSubmit From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestSubmit ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestSubmit>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestSubmit ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestSubmit>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestSubmit ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestSubmit>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AvailabilityRequestSubmit ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestSubmit>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AvailabilityRequestSubmit? result)
    {
        return JsonElementHelpers.TryParseValue<AvailabilityRequestSubmit>(ref reader, out result);
    }
...
#if NET
    static AvailabilityRequestSubmit IJsonElement<AvailabilityRequestSubmit>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AvailabilityRequestSubmit: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public AvailabilityRequestSubmit Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public AvailabilityRequestSubmit Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AvailabilityRequestSubmit>(_idx);
        }
