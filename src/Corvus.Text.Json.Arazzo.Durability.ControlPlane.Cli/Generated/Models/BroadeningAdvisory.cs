...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.BroadeningOverlapGranteeArray SubsumesGrantees
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubsumesGranteesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BroadeningAdvisory.BroadeningOverlapGranteeArray value))
            {
                return value;
            }
