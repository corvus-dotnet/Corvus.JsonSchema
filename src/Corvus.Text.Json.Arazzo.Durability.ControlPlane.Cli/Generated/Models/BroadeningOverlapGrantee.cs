...
/// <remarks>
/// <para>
/// An existing grantee whose resolved identity the just-granted (narrower) identity STRICTLY contains (&#167;16.5.4 membership) — the grant broadens administration to also admit this grantee, and everyone whose identity contains the grant. Reach-filtered to grantees the caller may see.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct BroadeningOverlapGrantee
#if NET8_0_OR_GREATER
    : IJsonElement<BroadeningOverlapGrantee>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BroadeningOverlapGrantee"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal BroadeningOverlapGrantee(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static BroadeningOverlapGrantee DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GranteeKind Kind
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GranteeKind value))
            {
                return value;
            }
    ...
    /// <remarks>
    /// <para>
    /// An optional human-friendly display label for the grantee.
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString Label
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// <para>
    /// The grantee&#39;s subject value (e.g. the person/team/role name).
    /// </para>
    /// </remarks>
    ...
    /// </returns>
    public static bool operator ==(in BroadeningOverlapGrantee left, in BroadeningOverlapGrantee right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in BroadeningOverlapGrantee left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(BroadeningOverlapGrantee instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator BroadeningOverlapGrantee(JsonElement instance)
    {
        return BroadeningOverlapGrantee.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BroadeningOverlapGrantee From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BroadeningOverlapGrantee ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BroadeningOverlapGrantee>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BroadeningOverlapGrantee ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BroadeningOverlapGrantee>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BroadeningOverlapGrantee ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BroadeningOverlapGrantee>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static BroadeningOverlapGrantee ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BroadeningOverlapGrantee>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out BroadeningOverlapGrantee? result)
    {
        return JsonElementHelpers.TryParseValue<BroadeningOverlapGrantee>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new BroadeningOverlapGrantee(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static BroadeningOverlapGrantee IJsonElement<BroadeningOverlapGrantee>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"BroadeningOverlapGrantee: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="BroadeningOverlapGrantee"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="BroadeningOverlapGrantee"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public BroadeningOverlapGrantee Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<BroadeningOverlapGrantee>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="BroadeningOverlapGrantee"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public BroadeningOverlapGrantee Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<BroadeningOverlapGrantee>(_idx);
        }
