...
/// <remarks>
/// <para>
/// A reference to one source document within a version&#39;s package, as projected into the metadata.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct CatalogSourceRef
{
...
#endif
    {
        ...
        public static explicit operator Mutable(CatalogSourceRef instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="CatalogSourceRef"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CatalogSourceRef(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// The source name (the workflow&#39;s sourceDescriptions name), used to address the document.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// The source document kind (e.g. `openapi`, `asyncapi`), if declared by the workflow.
        /// </para>
        /// </remarks>
        ...
        {
            return
                (obj is IJsonElement value && Equals(new CatalogSourceRef(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CatalogSourceRef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="CatalogSourceRef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="CatalogSourceRef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly CatalogSourceRef Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<CatalogSourceRef>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="CatalogSourceRef"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly CatalogSourceRef Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<CatalogSourceRef>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CatalogSourceRef.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(CatalogSourceRef instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CatalogSourceRef.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="CatalogSourceRef"/>.
        /// </summary>
        ...
        /// Creates an instance of a <see cref="CatalogSourceRef"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source name, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source type = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source name, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source type = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source name, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source type = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<CatalogSourceRef, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<CatalogSourceRef> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<CatalogSourceRef>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<CatalogSourceRef> Create<TContext>(
    ...
    public static ParsedJsonDocument<CatalogSourceRef> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source name, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source type = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
