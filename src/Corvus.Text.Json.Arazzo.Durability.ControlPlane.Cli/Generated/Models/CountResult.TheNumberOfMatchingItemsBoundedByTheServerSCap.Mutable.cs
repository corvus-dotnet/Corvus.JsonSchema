...
public readonly partial struct CountResult
{
    ...
    public readonly partial struct TheNumberOfMatchingItemsBoundedByTheServerSCap
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheNumberOfMatchingItemsBoundedByTheServerSCap instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheNumberOfMatchingItemsBoundedByTheServerSCap"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheNumberOfMatchingItemsBoundedByTheServerSCap(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheNumberOfMatchingItemsBoundedByTheServerSCap.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheNumberOfMatchingItemsBoundedByTheServerSCap Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheNumberOfMatchingItemsBoundedByTheServerSCap Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheNumberOfMatchingItemsBoundedByTheServerSCap>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheNumberOfMatchingItemsBoundedByTheServerSCap instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheNumberOfMatchingItemsBoundedByTheServerSCap, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheNumberOfMatchingItemsBoundedByTheServerSCap> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheNumberOfMatchingItemsBoundedByTheServerSCap>();
            }
            finally
            {
