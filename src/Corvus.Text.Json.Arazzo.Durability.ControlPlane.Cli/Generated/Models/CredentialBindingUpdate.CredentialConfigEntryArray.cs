...
public readonly partial struct CredentialBindingUpdate
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CredentialConfigEntryArray"/> struct.
        /// </summary>
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CredentialConfigEntry this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CredentialConfigEntry>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CredentialConfigEntry> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CredentialConfigEntry>(_parent, _idx);
        }
