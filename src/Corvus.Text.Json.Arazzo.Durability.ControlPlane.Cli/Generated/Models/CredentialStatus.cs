...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CredentialStatus"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal CredentialStatus(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static CredentialStatus DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(CredentialStatus value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in CredentialStatus left, in CredentialStatus right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in CredentialStatus left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(CredentialStatus instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator CredentialStatus(JsonElement instance)
    {
        return CredentialStatus.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CredentialStatus From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CredentialStatus ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<CredentialStatus>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CredentialStatus ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<CredentialStatus>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CredentialStatus ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<CredentialStatus>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static CredentialStatus ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<CredentialStatus>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out CredentialStatus? result)
    {
        return JsonElementHelpers.TryParseValue<CredentialStatus>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new CredentialStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static CredentialStatus IJsonElement<CredentialStatus>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"CredentialStatus: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="CredentialStatus"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="CredentialStatus"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public CredentialStatus Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<CredentialStatus>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="CredentialStatus"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public CredentialStatus Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<CredentialStatus>(_idx);
        }
    ...
    /// <param name="matchValid">Match 1st item.</param>
    /// <param name="matchExpiringSoon">Match 2nd item.</param>
    /// <param name="matchExpired">Match 3rd item.</param>
    /// <param name="defaultMatch">Match any other value.</param>
    /// <returns>An instance of the value returned by the match function.</returns>
    public TResult Match<TContext, TResult>(
        in TContext context,
        Func<TContext, TResult> matchValid,
        Func<TContext, TResult> matchExpiringSoon,
        Func<TContext, TResult> matchExpired,
...
#endif
    {
        ...
        {
            return matchValid(context);
        }

        if (this.ValueEquals(Constants.Enum2))
        {
            return matchExpiringSoon(context);
        }

        if (this.ValueEquals(Constants.Enum3))
        {
            return matchExpired(context);
        }
    ...
    public TResult Match<TResult>(
        Func<TResult> matchValid,
        Func<TResult> matchExpiringSoon,
        Func<TResult> matchExpired,
