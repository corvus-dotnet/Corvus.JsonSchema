    ...
    : IJsonElement<DebugRun>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDebugRunIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("debugRunId"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDebugRunIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("debugRunId"u8, buffer, out written);

        private const int RequiredOffsetForDebugRunId = 0;
        private const uint RequiredBitForDebugRunId = 0b00000000000000000000000000000001;
        ...
        private static readonly JsonSchemaPathProvider StartedBySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/startedBy"u8, buffer, out written);
        ...
        private static void MatchCursor(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt32.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            context.CommitChildContext(childContext.IsMatch, ref childContext);
        }

        private static void MatchDebugRunId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunId.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForDebugRunId] |= RequiredBitForDebugRunId;
        }

        private static void MatchDocumentEtag(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.DocumentEtagUtf8,
                    evaluationPath: DocumentEtagSchemaEvaluationPath);
        ...
        private static void MatchStartedBy(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext5 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.StartedByUtf8,
                    evaluationPath: StartedBySchemaEvaluationPath);
        ...
        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext6 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun.StatusEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun.StatusEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext6);
        ...
        private static void MatchTrace(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext7 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext7);
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.DebugRunIdUtf8, MatchDebugRunId),
                (static () => JsonPropertyNames.DocumentEtagUtf8, MatchDocumentEtag),
                (static () => JsonPropertyNames.EnvironmentUtf8, MatchEnvironment),
                (static () => JsonPropertyNames.StartedAtUtf8, MatchStartedAt),
                (static () => JsonPropertyNames.StartedByUtf8, MatchStartedBy),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/DebugRun"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/DebugRun";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/DebugRun"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDebugRunIdPresent, "debugRunId"u8, "required"u8);
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDebugRunId] & RequiredBitForDebugRunId) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDebugRunIdNotPresent, "debugRunId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDebugRunIdPresent, "debugRunId"u8, "required"u8);
