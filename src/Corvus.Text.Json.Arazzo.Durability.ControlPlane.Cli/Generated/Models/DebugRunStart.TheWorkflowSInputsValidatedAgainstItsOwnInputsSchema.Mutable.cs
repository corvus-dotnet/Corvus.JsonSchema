...
public readonly partial struct DebugRunStart
{
    ...
    public readonly partial struct TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRunStart.TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRunStart.TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema> Create<TContext>(
