...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DebugRunStart"/> struct.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRunStart.TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema Inputs
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InputsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRunStart.TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema value))
            {
                return value;
            }
