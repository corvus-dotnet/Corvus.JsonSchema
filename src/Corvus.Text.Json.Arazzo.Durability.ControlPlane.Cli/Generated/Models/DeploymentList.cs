...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DeploymentList"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal DeploymentList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static DeploymentList DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the <c>deployments</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentList.DeploymentViewArray Deployments
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeploymentsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentList.DeploymentViewArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in DeploymentList left, in DeploymentList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in DeploymentList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(DeploymentList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator DeploymentList(JsonElement instance)
    {
        return DeploymentList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static DeploymentList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out DeploymentList? result)
    {
        return JsonElementHelpers.TryParseValue<DeploymentList>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new DeploymentList(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static DeploymentList IJsonElement<DeploymentList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"DeploymentList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="DeploymentList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="DeploymentList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<DeploymentList>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="DeploymentList"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public DeploymentList Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<DeploymentList>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Deployments"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Deployments"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DeploymentsUtf8 => "deployments"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Deployments"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Deployments => "deployments"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Deployments"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Deployments => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x64, 0x65, 0x70, 0x6C, 0x6F, 0x79, 0x6D, 0x65, 0x6E, 0x74, 0x73, 0x22];
