...
public readonly partial struct DeploymentStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(DeploymentStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="DeploymentStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DeploymentStatus(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DeploymentStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly DeploymentStatus Clone()
        {
            CheckValidInstance();
        ...
        public readonly DeploymentStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<DeploymentStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(DeploymentStatus instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (DeploymentStatus)value;
    ...
    {
        return workspace.CreateBuilder<DeploymentStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<DeploymentStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<DeploymentStatus>();
        }
        finally
        {
