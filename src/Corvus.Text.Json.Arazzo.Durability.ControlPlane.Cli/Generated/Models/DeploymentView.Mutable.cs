...
public readonly partial struct DeploymentView
{
...
#endif
    {
        ...
        public static explicit operator Mutable(DeploymentView instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="DeploymentView"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DeploymentView(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// The base workflow id whose version is being deployed.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// The worker that claimed the deployment; absent if unclaimed.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// When the deployment completed; absent if not completed.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// When the deployment was enqueued.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// Why the deployment failed; present only for a failed deployment.
        /// </para>
        /// </remarks>
        ...
        /// <summary>
        /// Gets the (optional) <c>functionUrl</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// The deployed function&#39;s invoke URL; present only once the deployment reaches Deployed.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Mutable FunctionUrl
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FunctionUrlUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// The deployment&#39;s stable id, derived from its target tuple.
        /// </para>
        /// </remarks>
        ...
        /// <summary>
        /// Gets the (optional) <c>leaseExpiresAt</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// When the claiming worker&#39;s advisory lease expires (ADR 0056); present only while Deploying.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Mutable LeaseExpiresAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseExpiresAtUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// <remarks>
        /// <para>
        /// When a worker started deploying; absent if not started.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentStatus.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentStatus.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView.The1BasedVersionNumberBeingDeployed.Mutable VersionNumber
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionNumberUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView.The1BasedVersionNumberBeingDeployed.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DeploymentView(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>functionUrl</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFunctionUrl(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FunctionUrlUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FunctionUrlUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FunctionUrl, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>functionUrl</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveFunctionUrl()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FunctionUrlUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// <summary>
        /// Set the <c>leaseExpiresAt</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetLeaseExpiresAt(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LeaseExpiresAtUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseExpiresAtUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LeaseExpiresAt, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>leaseExpiresAt</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveLeaseExpiresAt()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LeaseExpiresAtUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentStatus.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetVersionNumber(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView.The1BasedVersionNumberBeingDeployed.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DeploymentView.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DeploymentView"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DeploymentView"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly DeploymentView Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DeploymentView>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DeploymentView"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly DeploymentView Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<DeploymentView>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentStatus.Source _createArg7;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView.The1BasedVersionNumberBeingDeployed.Source _createArg8;
        ...
        public static implicit operator Source(DeploymentView instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="DeploymentView"/>.
        /// </summary>
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentStatus.Source status,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView.The1BasedVersionNumberBeingDeployed.Source versionNumber,
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source functionUrl = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Source leaseExpiresAt = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Source startedAt = default)
        {
            ...
            functionUrl.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FunctionUrl, ref builder);
            leaseExpiresAt.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LeaseExpiresAt, ref builder);
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Source startedAt = default)
        {
            Create(ref _builder, baseWorkflowId, createdAt, environment, etag, id, runtimeIdentifier, status, versionNumber, claimedBy, completedAt, failureReason, functionUrl, leaseExpiresAt, startedAt);
        }
    ...
    {
        return workspace.CreateBuilder<DeploymentView, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<DeploymentView> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<DeploymentView>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<DeploymentView> Create<TContext>(
    ...
    public static ParsedJsonDocument<DeploymentView> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source baseWorkflowId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Source createdAt, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source etag, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source id, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source runtimeIdentifier, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentStatus.Source status, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DeploymentView.The1BasedVersionNumberBeingDeployed.Source versionNumber, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source claimedBy = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Source completedAt = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source failureReason = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source functionUrl = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Source leaseExpiresAt = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonDateTime.Source startedAt = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
