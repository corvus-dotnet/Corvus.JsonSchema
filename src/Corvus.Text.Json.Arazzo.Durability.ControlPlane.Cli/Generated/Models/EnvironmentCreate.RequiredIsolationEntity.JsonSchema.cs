...
public readonly partial struct EnvironmentCreate
{
        ...
        : IJsonElement<RequiredIsolationEntity>
    {
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Enum1 = "InProcess"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly RequiredIsolationEntity EnumJson1 = ParsedJsonDocument<RequiredIsolationEntity>.StringConstant([.."\"InProcess\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum2 = "Isolated"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly RequiredIsolationEntity EnumJson2 = ParsedJsonDocument<RequiredIsolationEntity>.StringConstant([.."\"Isolated\""u8]);
        }
        ...
        {
            /// <summary>
            /// Gets the string "InProcess"
            /// as a <see cref="RequiredIsolationEntity"/>.
            /// </summary>
            public static RequiredIsolationEntity InProcess { get; } = Constants.EnumJson1;
            /// <summary>
            /// Gets the string "InProcess"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> InProcessUtf8 => Constants.Enum1;

            /// <summary>
            /// Gets the string "Isolated"
            /// as a <see cref="RequiredIsolationEntity"/>.
            /// </summary>
            public static RequiredIsolationEntity Isolated { get; } = Constants.EnumJson2;
            /// <summary>
            /// Gets the string "Isolated"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> IsolatedUtf8 => Constants.Enum2;
        }
        ...
        {
            /// <summary>
            /// Corresponds to the JSON string "InProcess".
            /// </summary>
            InProcess = 0,
            /// <summary>
            /// Corresponds to the JSON string "Isolated".
            /// </summary>
            Isolated = 1,
        }
        ...
        public static implicit operator RequiredIsolationEntity(KnownValues value)
        {
            return value switch
            {
                KnownValues.InProcess => Constants.EnumJson1,
                KnownValues.Isolated => Constants.EnumJson2,
        ...
        public static implicit operator KnownValues(RequiredIsolationEntity value)
        {
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/components/schemas/EnvironmentCreate/properties/requiredIsolation"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/EnvironmentCreate/properties/requiredIsolation";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/EnvironmentCreate/properties/requiredIsolation"u8;
            ...
            private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CorvusJsonSchemaProgram.Entry(119);
