...
public readonly partial struct EnvironmentKeyRegistration
{
    ...
    public readonly partial struct AlgorithmEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AlgorithmEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AlgorithmEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AlgorithmEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AlgorithmEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AlgorithmEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AlgorithmEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AlgorithmEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AlgorithmEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AlgorithmEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AlgorithmEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AlgorithmEntity>();
            }
            finally
            {
