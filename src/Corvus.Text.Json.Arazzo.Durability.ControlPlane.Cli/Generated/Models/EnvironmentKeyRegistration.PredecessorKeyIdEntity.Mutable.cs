...
public readonly partial struct EnvironmentKeyRegistration
{
    public readonly partial struct PredecessorKeyIdEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PredecessorKeyIdEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PredecessorKeyIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PredecessorKeyIdEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PredecessorKeyIdEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PredecessorKeyIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly PredecessorKeyIdEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PredecessorKeyIdEntity>(_idx);
            }

            /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
            public readonly PredecessorKeyIdEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PredecessorKeyIdEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PredecessorKeyIdEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PredecessorKeyIdEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PredecessorKeyIdEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PredecessorKeyIdEntity>();
            }
            finally
            {
