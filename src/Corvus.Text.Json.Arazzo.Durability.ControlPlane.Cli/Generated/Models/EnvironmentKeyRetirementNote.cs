...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EnvironmentKeyRetirementNote"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal EnvironmentKeyRetirementNote(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static EnvironmentKeyRetirementNote DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentKeyRetirementNote.WhyTheGenerationWasRetired Reason
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReasonUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentKeyRetirementNote.WhyTheGenerationWasRetired value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in EnvironmentKeyRetirementNote left, in EnvironmentKeyRetirementNote right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in EnvironmentKeyRetirementNote left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(EnvironmentKeyRetirementNote instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator EnvironmentKeyRetirementNote(JsonElement instance)
    {
        return EnvironmentKeyRetirementNote.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentKeyRetirementNote From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentKeyRetirementNote ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentKeyRetirementNote>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentKeyRetirementNote ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentKeyRetirementNote>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentKeyRetirementNote ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentKeyRetirementNote>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static EnvironmentKeyRetirementNote ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentKeyRetirementNote>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentKeyRetirementNote? result)
    {
        return JsonElementHelpers.TryParseValue<EnvironmentKeyRetirementNote>(ref reader, out result);
    }
...
#if NET
    static EnvironmentKeyRetirementNote IJsonElement<EnvironmentKeyRetirementNote>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"EnvironmentKeyRetirementNote: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public EnvironmentKeyRetirementNote Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public EnvironmentKeyRetirementNote Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<EnvironmentKeyRetirementNote>(_idx);
        }
