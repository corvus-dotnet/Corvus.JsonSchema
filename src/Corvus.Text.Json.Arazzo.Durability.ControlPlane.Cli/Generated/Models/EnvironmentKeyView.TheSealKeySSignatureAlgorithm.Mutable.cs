...
public readonly partial struct EnvironmentKeyView
{
    ...
    public readonly partial struct TheSealKeySSignatureAlgorithm
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheSealKeySSignatureAlgorithm instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheSealKeySSignatureAlgorithm"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheSealKeySSignatureAlgorithm(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheSealKeySSignatureAlgorithm.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheSealKeySSignatureAlgorithm Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheSealKeySSignatureAlgorithm Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheSealKeySSignatureAlgorithm>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheSealKeySSignatureAlgorithm instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheSealKeySSignatureAlgorithm, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheSealKeySSignatureAlgorithm> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheSealKeySSignatureAlgorithm>();
            }
            finally
            {
