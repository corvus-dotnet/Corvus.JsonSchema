    ...
    : IJsonElement<EnvironmentList>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchEnvironments(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
