...
public readonly partial struct EnvironmentRunnerAuthorizationList
{
    ...
    public readonly partial struct EnvironmentRunnerAuthorizationViewArray
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentRunnerAuthorizationView.Source value)
            {
                CheckValidInstance();
