...
public readonly partial struct EnvironmentRunnerAuthorizationList
    ...
    : IJsonElement<EnvironmentRunnerAuthorizationList>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EnvironmentRunnerAuthorizationList"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal EnvironmentRunnerAuthorizationList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static EnvironmentRunnerAuthorizationList DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the <c>authorizations</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentRunnerAuthorizationList.EnvironmentRunnerAuthorizationViewArray Authorizations
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorizationsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentRunnerAuthorizationList.EnvironmentRunnerAuthorizationViewArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in EnvironmentRunnerAuthorizationList left, in EnvironmentRunnerAuthorizationList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in EnvironmentRunnerAuthorizationList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(EnvironmentRunnerAuthorizationList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator EnvironmentRunnerAuthorizationList(JsonElement instance)
    {
        return EnvironmentRunnerAuthorizationList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentRunnerAuthorizationList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentRunnerAuthorizationList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentRunnerAuthorizationList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentRunnerAuthorizationList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentRunnerAuthorizationList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentRunnerAuthorizationList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentRunnerAuthorizationList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static EnvironmentRunnerAuthorizationList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentRunnerAuthorizationList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentRunnerAuthorizationList? result)
    {
        return JsonElementHelpers.TryParseValue<EnvironmentRunnerAuthorizationList>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new EnvironmentRunnerAuthorizationList(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static EnvironmentRunnerAuthorizationList IJsonElement<EnvironmentRunnerAuthorizationList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"EnvironmentRunnerAuthorizationList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="EnvironmentRunnerAuthorizationList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="EnvironmentRunnerAuthorizationList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public EnvironmentRunnerAuthorizationList Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<EnvironmentRunnerAuthorizationList>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="EnvironmentRunnerAuthorizationList"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public EnvironmentRunnerAuthorizationList Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<EnvironmentRunnerAuthorizationList>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Authorizations"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Authorizations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AuthorizationsUtf8 => "authorizations"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Authorizations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Authorizations => "authorizations"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Authorizations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Authorizations => [0x05, 0x01, 0x00, 0x00, 0x22, 0x61, 0x75, 0x74, 0x68, 0x6F, 0x72, 0x69, 0x7A, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x73, 0x22];
