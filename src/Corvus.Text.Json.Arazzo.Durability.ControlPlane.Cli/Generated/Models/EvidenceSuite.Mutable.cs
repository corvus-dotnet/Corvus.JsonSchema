...
public readonly partial struct EvidenceSuite
{
...
#endif
    {
        ...
        public static explicit operator Mutable(EvidenceSuite instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="EvidenceSuite"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EvidenceSuite(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EvidenceSuite.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly EvidenceSuite Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly EvidenceSuite Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<EvidenceSuite>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(EvidenceSuite instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EvidenceSuite.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="EvidenceSuite"/>.
        /// </summary>
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInteger.Source total)
        {
            Create(ref _builder, failed, passed, total);
        }
    ...
    {
        return new Source(failed, passed, total);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInteger.Source failed, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInteger.Source passed, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInteger.Source total, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(failed, passed, total);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<EvidenceSuite, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<EvidenceSuite> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<EvidenceSuite>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<EvidenceSuite> Create<TContext>(
