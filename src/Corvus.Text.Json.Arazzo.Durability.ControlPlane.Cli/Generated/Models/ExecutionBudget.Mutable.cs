...
public readonly partial struct ExecutionBudget
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ExecutionBudget instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ExecutionBudget"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ExecutionBudget(Mutable instance)
        {
        ...
        public void SetMaxSubWorkflowDepth(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MaxSubWorkflowDepthUtf8);
                _documentVersion = _parent.Version;
                return;
            }
        ...
        /// <summary>
        /// Remove the <c>maxSubWorkflowDepth</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveMaxSubWorkflowDepth()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MaxSubWorkflowDepthUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        public void SetRetryAfterCeilingSeconds(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RetryAfterCeilingSecondsUtf8);
                _documentVersion = _parent.Version;
                return;
            }
        ...
        /// <summary>
        /// Remove the <c>retryAfterCeilingSeconds</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveRetryAfterCeilingSeconds()
        {
            CheckValidInstance();
        ...
        public void SetWallClockSeconds(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WallClockSecondsUtf8);
                _documentVersion = _parent.Version;
                return;
            }
        ...
        /// <summary>
        /// Remove the <c>wallClockSeconds</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveWallClockSeconds()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WallClockSecondsUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ExecutionBudget.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly ExecutionBudget Clone()
        {
            CheckValidInstance();
        ...
        public readonly ExecutionBudget Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ExecutionBudget>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(ExecutionBudget instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ExecutionBudget.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source maxResponseBytes = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source maxSteps = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source maxSubWorkflowDepth = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source retryAfterCeilingSeconds = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source stepTimeoutSeconds = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source wallClockSeconds = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source maxResponseBytes = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source maxSteps = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source maxSubWorkflowDepth = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source retryAfterCeilingSeconds = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source stepTimeoutSeconds = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source wallClockSeconds = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source maxResponseBytes = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source maxSteps = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source maxSubWorkflowDepth = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source retryAfterCeilingSeconds = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source stepTimeoutSeconds = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source wallClockSeconds = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<ExecutionBudget, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ExecutionBudget> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ExecutionBudget>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ExecutionBudget> Create<TContext>(
