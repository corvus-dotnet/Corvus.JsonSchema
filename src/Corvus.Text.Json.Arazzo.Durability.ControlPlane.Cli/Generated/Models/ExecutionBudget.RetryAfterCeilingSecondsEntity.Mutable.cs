...
public readonly partial struct ExecutionBudget
{
    ...
    public readonly partial struct RetryAfterCeilingSecondsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RetryAfterCeilingSecondsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RetryAfterCeilingSecondsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RetryAfterCeilingSecondsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RetryAfterCeilingSecondsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RetryAfterCeilingSecondsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RetryAfterCeilingSecondsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RetryAfterCeilingSecondsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RetryAfterCeilingSecondsEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RetryAfterCeilingSecondsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RetryAfterCeilingSecondsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RetryAfterCeilingSecondsEntity>();
            }
            finally
            {
