...
public readonly partial struct ExecutionBudget
{
    public readonly partial struct StepTimeoutSecondsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StepTimeoutSecondsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StepTimeoutSecondsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StepTimeoutSecondsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StepTimeoutSecondsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly StepTimeoutSecondsEntity Clone()
            {
                CheckValidInstance();
            ...
            public readonly StepTimeoutSecondsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StepTimeoutSecondsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(StepTimeoutSecondsEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<StepTimeoutSecondsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<StepTimeoutSecondsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<StepTimeoutSecondsEntity>();
            }
            finally
            {
