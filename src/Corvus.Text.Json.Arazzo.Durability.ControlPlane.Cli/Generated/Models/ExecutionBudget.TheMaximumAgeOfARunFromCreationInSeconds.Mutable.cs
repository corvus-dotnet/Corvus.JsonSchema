...
public readonly partial struct ExecutionBudget
{
    ...
    public readonly partial struct TheMaximumAgeOfARunFromCreationInSeconds
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheMaximumAgeOfARunFromCreationInSeconds instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheMaximumAgeOfARunFromCreationInSeconds"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheMaximumAgeOfARunFromCreationInSeconds(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheMaximumAgeOfARunFromCreationInSeconds(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheMaximumAgeOfARunFromCreationInSeconds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheMaximumAgeOfARunFromCreationInSeconds"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheMaximumAgeOfARunFromCreationInSeconds"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TheMaximumAgeOfARunFromCreationInSeconds Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheMaximumAgeOfARunFromCreationInSeconds>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheMaximumAgeOfARunFromCreationInSeconds"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TheMaximumAgeOfARunFromCreationInSeconds Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheMaximumAgeOfARunFromCreationInSeconds>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheMaximumAgeOfARunFromCreationInSeconds instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheMaximumAgeOfARunFromCreationInSeconds, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheMaximumAgeOfARunFromCreationInSeconds> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheMaximumAgeOfARunFromCreationInSeconds>();
            }
            finally
            {
