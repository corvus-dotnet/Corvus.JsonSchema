        ...
        public readonly partial struct FetchOneShotSecret
        {
            ...
            public readonly partial struct HowTheSecretIsAppliedDefaultsToBearer
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(HowTheSecretIsAppliedDefaultsToBearer instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="HowTheSecretIsAppliedDefaultsToBearer"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator HowTheSecretIsAppliedDefaultsToBearer(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"HowTheSecretIsAppliedDefaultsToBearer.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="HowTheSecretIsAppliedDefaultsToBearer"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="HowTheSecretIsAppliedDefaultsToBearer"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HowTheSecretIsAppliedDefaultsToBearer Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="HowTheSecretIsAppliedDefaultsToBearer"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HowTheSecretIsAppliedDefaultsToBearer Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<HowTheSecretIsAppliedDefaultsToBearer>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(HowTheSecretIsAppliedDefaultsToBearer instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<HowTheSecretIsAppliedDefaultsToBearer, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<HowTheSecretIsAppliedDefaultsToBearer> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<HowTheSecretIsAppliedDefaultsToBearer>();
                    }
                    finally
                    {
