...
public readonly partial struct FetchedSourceDocument
{
    public readonly partial struct DetectedFromTheDocumentSOwnTopLevelField
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DetectedFromTheDocumentSOwnTopLevelField instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DetectedFromTheDocumentSOwnTopLevelField"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DetectedFromTheDocumentSOwnTopLevelField(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DetectedFromTheDocumentSOwnTopLevelField.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly DetectedFromTheDocumentSOwnTopLevelField Clone()
            {
                CheckValidInstance();
            ...
            public readonly DetectedFromTheDocumentSOwnTopLevelField Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DetectedFromTheDocumentSOwnTopLevelField>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DetectedFromTheDocumentSOwnTopLevelField instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (DetectedFromTheDocumentSOwnTopLevelField)value;
        ...
        {
            return workspace.CreateBuilder<DetectedFromTheDocumentSOwnTopLevelField, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DetectedFromTheDocumentSOwnTopLevelField> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DetectedFromTheDocumentSOwnTopLevelField>();
            }
            finally
            {
