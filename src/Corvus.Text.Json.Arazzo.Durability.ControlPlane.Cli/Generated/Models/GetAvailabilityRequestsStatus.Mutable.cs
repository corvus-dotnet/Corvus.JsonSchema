...
public readonly partial struct GetAvailabilityRequestsStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAvailabilityRequestsStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAvailabilityRequestsStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAvailabilityRequestsStatus(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetAvailabilityRequestsStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAvailabilityRequestsStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetAvailabilityRequestsStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetAvailabilityRequestsStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetAvailabilityRequestsStatus Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetAvailabilityRequestsStatus>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetAvailabilityRequestsStatus"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetAvailabilityRequestsStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAvailabilityRequestsStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetAvailabilityRequestsStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetAvailabilityRequestsStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetAvailabilityRequestsStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetAvailabilityRequestsStatus>();
        }
        finally
        {
