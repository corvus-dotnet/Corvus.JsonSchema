    ...
    : IJsonElement<GetEnvironmentsByNameKeysState>
{
    ...
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1environments~1{name}~1keys/get/parameters/1/schema"u8, buffer, out written);
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if (unescapedUtf8JsonString.Span.SequenceEqual("Active"u8))
                {
                    goto enumShortCircuitSuccess;
                }

                if (unescapedUtf8JsonString.Span.SequenceEqual("Retired"u8))
                {
                    goto enumShortCircuitSuccess;
                }
