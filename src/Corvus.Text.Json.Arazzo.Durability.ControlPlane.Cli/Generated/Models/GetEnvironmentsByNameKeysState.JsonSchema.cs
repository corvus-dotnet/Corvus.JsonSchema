    ...
    : IJsonElement<GetEnvironmentsByNameKeysState>
{
    private static class Constants
    {
        ...
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly GetEnvironmentsByNameKeysState EnumJson1 = ParsedJsonDocument<GetEnvironmentsByNameKeysState>.StringConstant([.."\"Active\""u8]);
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly byte[] Enum2 = "Retired"u8.ToArray();
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly GetEnvironmentsByNameKeysState EnumJson2 = ParsedJsonDocument<GetEnvironmentsByNameKeysState>.StringConstant([.."\"Retired\""u8]);
    }
    ...
    public static class EnumValues
    {
        ...
        /// as a <see cref="GetEnvironmentsByNameKeysState"/>.
        /// </summary>
        public static GetEnvironmentsByNameKeysState Active { get; } = Constants.EnumJson1;
        /// <summary>
        /// Gets the string "Active"
        ...
        /// <summary>
        /// Gets the string "Retired"
        /// as a <see cref="GetEnvironmentsByNameKeysState"/>.
        /// </summary>
        public static GetEnvironmentsByNameKeysState Retired { get; } = Constants.EnumJson2;
        /// <summary>
        /// Gets the string "Retired"
        /// as a UTF8 byte array.
        /// </summary>
        public static ReadOnlySpan<byte> RetiredUtf8 => Constants.Enum2;
    }
    ...
    public enum KnownValues
    {
        ...
        Active = 0,
        /// <summary>
        /// Corresponds to the JSON string "Retired".
        /// </summary>
        Retired = 1,
    }
    ...
    public static implicit operator GetEnvironmentsByNameKeysState(KnownValues value)
    {
        return value switch
        {
            KnownValues.Active => Constants.EnumJson1,
            KnownValues.Retired => Constants.EnumJson2,
    ...
    public static implicit operator KnownValues(GetEnvironmentsByNameKeysState value)
    {
    ...
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/paths/~1environments~1{name}~1keys/get/parameters/1/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
        /// </summary>
        public const string SchemaLocation = "/paths/~1environments~1{name}~1keys/get/parameters/1/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1environments~1{name}~1keys/get/parameters/1/schema"u8;
        ...
        private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CorvusJsonSchemaProgram.Entry(397);
