...
public readonly partial struct GetEnvironmentsByNameRunnersCountStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetEnvironmentsByNameRunnersCountStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetEnvironmentsByNameRunnersCountStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetEnvironmentsByNameRunnersCountStatus(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetEnvironmentsByNameRunnersCountStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetEnvironmentsByNameRunnersCountStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetEnvironmentsByNameRunnersCountStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetEnvironmentsByNameRunnersCountStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetEnvironmentsByNameRunnersCountStatus Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetEnvironmentsByNameRunnersCountStatus>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetEnvironmentsByNameRunnersCountStatus"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetEnvironmentsByNameRunnersCountStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetEnvironmentsByNameRunnersCountStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetEnvironmentsByNameRunnersCountStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetEnvironmentsByNameRunnersCountStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetEnvironmentsByNameRunnersCountStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetEnvironmentsByNameRunnersCountStatus>();
        }
        finally
        {
