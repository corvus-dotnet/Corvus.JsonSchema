...
public readonly partial struct GetGithubReposByOwnerByRepoCommitsPage
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetGithubReposByOwnerByRepoCommitsPage instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetGithubReposByOwnerByRepoCommitsPage"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetGithubReposByOwnerByRepoCommitsPage(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetGithubReposByOwnerByRepoCommitsPage(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetGithubReposByOwnerByRepoCommitsPage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetGithubReposByOwnerByRepoCommitsPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetGithubReposByOwnerByRepoCommitsPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetGithubReposByOwnerByRepoCommitsPage Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetGithubReposByOwnerByRepoCommitsPage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetGithubReposByOwnerByRepoCommitsPage"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetGithubReposByOwnerByRepoCommitsPage Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetGithubReposByOwnerByRepoCommitsPage>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetGithubReposByOwnerByRepoCommitsPage instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetGithubReposByOwnerByRepoCommitsPage, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetGithubReposByOwnerByRepoCommitsPage> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetGithubReposByOwnerByRepoCommitsPage>();
        }
        finally
        {
