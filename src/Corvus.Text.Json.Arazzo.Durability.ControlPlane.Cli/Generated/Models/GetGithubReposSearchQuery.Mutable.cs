...
public readonly partial struct GetGithubReposSearchQuery
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetGithubReposSearchQuery instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetGithubReposSearchQuery"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetGithubReposSearchQuery(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetGithubReposSearchQuery.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetGithubReposSearchQuery Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetGithubReposSearchQuery Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetGithubReposSearchQuery>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetGithubReposSearchQuery instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetGithubReposSearchQuery, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetGithubReposSearchQuery> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetGithubReposSearchQuery>();
        }
        finally
        {
