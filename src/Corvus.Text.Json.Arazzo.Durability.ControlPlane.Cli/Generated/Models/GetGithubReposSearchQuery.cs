...
public readonly partial struct GetGithubReposSearchQuery
#if NET8_0_OR_GREATER
    : IJsonElement<GetGithubReposSearchQuery>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetGithubReposSearchQuery"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetGithubReposSearchQuery(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetGithubReposSearchQuery DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(GetGithubReposSearchQuery value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in GetGithubReposSearchQuery left, in GetGithubReposSearchQuery right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetGithubReposSearchQuery left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(GetGithubReposSearchQuery instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetGithubReposSearchQuery(JsonElement instance)
    {
        return GetGithubReposSearchQuery.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetGithubReposSearchQuery From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetGithubReposSearchQuery ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetGithubReposSearchQuery>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetGithubReposSearchQuery ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetGithubReposSearchQuery>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetGithubReposSearchQuery ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetGithubReposSearchQuery>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetGithubReposSearchQuery ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetGithubReposSearchQuery>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetGithubReposSearchQuery? result)
    {
        return JsonElementHelpers.TryParseValue<GetGithubReposSearchQuery>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetGithubReposSearchQuery(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetGithubReposSearchQuery IJsonElement<GetGithubReposSearchQuery>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetGithubReposSearchQuery: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetGithubReposSearchQuery"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetGithubReposSearchQuery"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetGithubReposSearchQuery Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetGithubReposSearchQuery>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetGithubReposSearchQuery"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetGithubReposSearchQuery Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetGithubReposSearchQuery>(_idx);
        }
