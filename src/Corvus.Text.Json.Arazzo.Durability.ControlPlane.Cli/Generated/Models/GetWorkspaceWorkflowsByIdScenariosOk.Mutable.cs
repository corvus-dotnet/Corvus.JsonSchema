...
public readonly partial struct GetWorkspaceWorkflowsByIdScenariosOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetWorkspaceWorkflowsByIdScenariosOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetWorkspaceWorkflowsByIdScenariosOk(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Mutable Scenarios
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScenariosUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetWorkspaceWorkflowsByIdScenariosOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetScenarios(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScenarios<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetWorkspaceWorkflowsByIdScenariosOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetWorkspaceWorkflowsByIdScenariosOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetWorkspaceWorkflowsByIdScenariosOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetWorkspaceWorkflowsByIdScenariosOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetWorkspaceWorkflowsByIdScenariosOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(GetWorkspaceWorkflowsByIdScenariosOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios)
        {
        ...
        /// Creates an instance of a <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios)
        {
            Create(ref _builder, scenarios);
        }
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
            Create(context, ref _builder, scenarios);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios)
    {
        return new Source(scenarios);
    }
    ...
    /// <param name="scenarios">The value of the <c>"scenarios"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, scenarios);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(scenarios);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<GetWorkspaceWorkflowsByIdScenariosOk, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetWorkspaceWorkflowsByIdScenariosOk> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetWorkspaceWorkflowsByIdScenariosOk>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetWorkspaceWorkflowsByIdScenariosOk> Create<TContext>(
    ...
    public static ParsedJsonDocument<GetWorkspaceWorkflowsByIdScenariosOk> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetWorkspaceWorkflowsByIdScenariosOk> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
