...
public readonly partial struct GetWorkspaceWorkflowsByIdScenariosOk
{
        ...
        : IJsonElement<ScenarioArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1workspace~1workflows~1{id}~1scenarios/get/responses/200/content/application~1json/schema/properties/scenarios"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/paths/~1workspace~1workflows~1{id}~1scenarios/get/responses/200/content/application~1json/schema/properties/scenarios";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1workspace~1workflows~1{id}~1scenarios/get/responses/200/content/application~1json/schema/properties/scenarios"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
