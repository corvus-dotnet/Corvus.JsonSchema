...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetWorkspaceWorkflowsByIdScenariosOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetWorkspaceWorkflowsByIdScenariosOk DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray Scenarios
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScenariosUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetWorkspaceWorkflowsByIdScenariosOk left, in GetWorkspaceWorkflowsByIdScenariosOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetWorkspaceWorkflowsByIdScenariosOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetWorkspaceWorkflowsByIdScenariosOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetWorkspaceWorkflowsByIdScenariosOk(JsonElement instance)
    {
        return GetWorkspaceWorkflowsByIdScenariosOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetWorkspaceWorkflowsByIdScenariosOk From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetWorkspaceWorkflowsByIdScenariosOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetWorkspaceWorkflowsByIdScenariosOk>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetWorkspaceWorkflowsByIdScenariosOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetWorkspaceWorkflowsByIdScenariosOk>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetWorkspaceWorkflowsByIdScenariosOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetWorkspaceWorkflowsByIdScenariosOk>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetWorkspaceWorkflowsByIdScenariosOk ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetWorkspaceWorkflowsByIdScenariosOk>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetWorkspaceWorkflowsByIdScenariosOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetWorkspaceWorkflowsByIdScenariosOk>(ref reader, out result);
    }
...
#if NET
    static GetWorkspaceWorkflowsByIdScenariosOk IJsonElement<GetWorkspaceWorkflowsByIdScenariosOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetWorkspaceWorkflowsByIdScenariosOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetWorkspaceWorkflowsByIdScenariosOk Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetWorkspaceWorkflowsByIdScenariosOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetWorkspaceWorkflowsByIdScenariosOk>(_idx);
        }
