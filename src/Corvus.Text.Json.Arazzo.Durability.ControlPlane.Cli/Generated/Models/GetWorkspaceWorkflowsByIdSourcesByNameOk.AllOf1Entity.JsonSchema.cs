...
public readonly partial struct GetWorkspaceWorkflowsByIdSourcesByNameOk
{
        ...
        : IJsonElement<AllOf1Entity>
    {
        public static partial class JsonSchema
        {
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.DocumentUtf8))
                {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1workspace~1workflows~1{id}~1sources~1{name}/get/responses/200/content/application~1json/schema/allOf/1"u8, buffer, out written);
