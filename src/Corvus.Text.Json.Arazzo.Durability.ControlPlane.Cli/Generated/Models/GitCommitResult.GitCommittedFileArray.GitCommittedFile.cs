...
public readonly partial struct GitCommitResult
{
    ...
    /// </summary>
    public readonly partial struct GitCommittedFileArray
    {
        /// <summary>
        /// GitCommittedFile
        /// </summary>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct GitCommittedFile
#if NET8_0_OR_GREATER
            : IJsonElement<GitCommittedFile>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GitCommittedFile"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal GitCommittedFile(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static GitCommittedFile DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in GitCommittedFile left, in GitCommittedFile right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in GitCommittedFile left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(GitCommittedFile instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GitCommittedFile(JsonElement instance)
            {
                return GitCommittedFile.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GitCommittedFile From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GitCommittedFile ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GitCommittedFile>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GitCommittedFile ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GitCommittedFile>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GitCommittedFile ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GitCommittedFile>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static GitCommittedFile ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GitCommittedFile>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out GitCommittedFile? result)
            {
                return JsonElementHelpers.TryParseValue<GitCommittedFile>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GitCommittedFile(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static GitCommittedFile IJsonElement<GitCommittedFile>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GitCommittedFile: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GitCommittedFile"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GitCommittedFile"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public GitCommittedFile Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GitCommittedFile>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GitCommittedFile"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public GitCommittedFile Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<GitCommittedFile>(_idx);
                }
