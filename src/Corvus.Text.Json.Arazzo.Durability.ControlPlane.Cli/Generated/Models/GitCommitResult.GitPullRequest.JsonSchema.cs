...
public readonly partial struct GitCommitResult
{
        ...
        : IJsonElement<GitPullRequest>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyNumberPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("number"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyNumberNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("number"u8, buffer, out written);

            private const int RequiredOffsetForNumber = 0;
            private const uint RequiredBitForNumber = 0b00000000000000000000000000000001;
            ...
            private const uint RequiredBitMask0 =
                RequiredBitForNumber | RequiredBitForUrl;
            ...
            private static void MatchNumber(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                ...
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForNumber] |= RequiredBitForNumber;
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/GitCommitResult/properties/pullRequest"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/GitCommitResult/properties/pullRequest";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/GitCommitResult/properties/pullRequest"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyNumberPresent, "number"u8, "required"u8);
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForNumber] & RequiredBitForNumber) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyNumberNotPresent, "number"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyNumberPresent, "number"u8, "required"u8);
