...
/// <remarks>
/// <para>
/// What a commit wrote: one entry per file, plus the pull request when one was opened. The commits are authored as the signed-in user&#39;s GitHub-held git identity — the control plane composes no author/committer (&#167;4.7).
/// </para>
/// </remarks>
public readonly partial struct GitCommitResult
{
    /// <summary>
    /// GitPullRequest
    /// </summary>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly partial struct GitPullRequest
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GitPullRequest instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GitPullRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GitPullRequest(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Mutable Number
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NumberUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Mutable Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GitPullRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetNumber(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("number");
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUrl(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GitPullRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GitPullRequest"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GitPullRequest"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly GitPullRequest Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GitPullRequest>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GitPullRequest"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly GitPullRequest Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GitPullRequest>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Source _createArg1;
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitCommitResult.GitPullRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(GitPullRequest instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitCommitResult.GitPullRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="GitPullRequest"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Source number,
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source url)
            {
            ...
            /// Creates an instance of a <see cref="GitPullRequest"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Source number, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source url)
            {
                Create(ref _builder, number, url);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Source number, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source url)
        {
            return new Source(number, url);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Source number, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source url, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(number, url);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<GitPullRequest, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<GitPullRequest> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<GitPullRequest>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<GitPullRequest> Create<TContext>(
        ...
        public static ParsedJsonDocument<GitPullRequest> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt64.Source number, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source url, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
