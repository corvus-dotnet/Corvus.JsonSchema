...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GitHubAuthStart"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GitHubAuthStart(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GitHubAuthStart DefaultInstance { get; }
    ...
    /// </para>
    /// <para>
    /// The GitHub App authorize URL to navigate to.
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString AuthorizeUrl
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorizeUrlUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString State
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StateUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GitHubAuthStart left, in GitHubAuthStart right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GitHubAuthStart left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GitHubAuthStart instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GitHubAuthStart(JsonElement instance)
    {
        return GitHubAuthStart.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitHubAuthStart From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitHubAuthStart ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitHubAuthStart>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitHubAuthStart ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitHubAuthStart>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitHubAuthStart ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitHubAuthStart>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GitHubAuthStart ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitHubAuthStart>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GitHubAuthStart? result)
    {
        return JsonElementHelpers.TryParseValue<GitHubAuthStart>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GitHubAuthStart(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GitHubAuthStart IJsonElement<GitHubAuthStart>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GitHubAuthStart: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GitHubAuthStart"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GitHubAuthStart"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GitHubAuthStart Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GitHubAuthStart>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GitHubAuthStart"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GitHubAuthStart Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GitHubAuthStart>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="AuthorizeUrl"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="AuthorizeUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AuthorizeUrlUtf8 => "authorizeUrl"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="AuthorizeUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AuthorizeUrl => "authorizeUrl"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="AuthorizeUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AuthorizeUrl => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x75, 0x74, 0x68, 0x6F, 0x72, 0x69, 0x7A, 0x65, 0x55, 0x72, 0x6C, 0x22];
