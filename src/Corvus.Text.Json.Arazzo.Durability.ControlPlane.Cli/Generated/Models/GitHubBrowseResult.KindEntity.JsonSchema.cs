...
public readonly partial struct GitHubBrowseResult
{
        ...
        : IJsonElement<KindEntity>
    {
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/GitHubBrowseResult/properties/kind"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("dir"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("file"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
