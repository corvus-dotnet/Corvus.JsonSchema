    ...
    : IJsonElement<GitHubRepositoryList>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRepositoriesPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("repositories"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRepositoriesNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("repositories"u8, buffer, out written);

        private const int RequiredOffsetForRepositories = 0;
        private const uint RequiredBitForRepositories = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForRepositories;
        ...
        private static void MatchRepositories(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubRepositoryList.GitHubRepositoryArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubRepositoryList.GitHubRepositoryArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForRepositories] |= RequiredBitForRepositories;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.RepositoriesUtf8))
            {
                matcher = MatchRepositories;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/GitHubRepositoryList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/GitHubRepositoryList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/GitHubRepositoryList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRepositoriesPresent, "repositories"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForRepositories] & RequiredBitForRepositories) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyRepositoriesNotPresent, "repositories"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRepositoriesPresent, "repositories"u8, "required"u8);
