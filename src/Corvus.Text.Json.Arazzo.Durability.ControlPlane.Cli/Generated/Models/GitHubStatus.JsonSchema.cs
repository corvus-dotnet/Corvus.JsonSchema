    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchRepositories(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext4 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubStatus.GitHubRepositoryArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubStatus.GitHubRepositoryArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
