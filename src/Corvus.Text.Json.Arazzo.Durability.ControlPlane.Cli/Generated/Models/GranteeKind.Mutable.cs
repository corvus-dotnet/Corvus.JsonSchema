...
public readonly partial struct GranteeKind
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GranteeKind instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GranteeKind"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GranteeKind(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GranteeKind.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly GranteeKind Clone()
        {
            CheckValidInstance();
        ...
        public readonly GranteeKind Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GranteeKind>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GranteeKind instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (GranteeKind)value;
    ...
    {
        return workspace.CreateBuilder<GranteeKind, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GranteeKind> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GranteeKind>();
        }
        finally
        {
