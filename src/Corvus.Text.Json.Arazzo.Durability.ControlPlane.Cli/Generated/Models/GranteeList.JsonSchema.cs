    ...
    : IJsonElement<GranteeList>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchGrantees(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
