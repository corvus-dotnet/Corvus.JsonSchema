    ...
    : IJsonElement<GranteeList>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyGranteesPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("grantees"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyGranteesNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("grantees"u8, buffer, out written);

        private const int RequiredOffsetForGrantees = 0;
        private const uint RequiredBitForGrantees = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForGrantees;
        private static readonly JsonSchemaPathProvider GranteesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/grantees"u8, buffer, out written);
        ...
        private static void MatchGrantees(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GranteeList.ResolvedGranteeArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.GranteesUtf8,
                    evaluationPath: GranteesSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GranteeList.ResolvedGranteeArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForGrantees] |= RequiredBitForGrantees;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                (static () => JsonPropertyNames.GranteesUtf8, MatchGrantees),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/GranteeList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/GranteeList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/GranteeList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyGranteesPresent, "grantees"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForGrantees] & RequiredBitForGrantees) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyGranteesNotPresent, "grantees"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyGranteesPresent, "grantees"u8, "required"u8);
