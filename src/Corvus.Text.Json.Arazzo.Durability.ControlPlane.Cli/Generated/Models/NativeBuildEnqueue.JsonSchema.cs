    ...
    : IJsonElement<NativeBuildEnqueue>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForRuntimeIdentifier = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForEnvironment | RequiredBitForRuntimeIdentifier;
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/NativeBuildEnqueue"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/NativeBuildEnqueue";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/NativeBuildEnqueue"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    ...
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRuntimeIdentifierPresent, "runtimeIdentifier"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyRuntimeIdentifierNotPresent, "runtimeIdentifier"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRuntimeIdentifierPresent, "runtimeIdentifier"u8, "required"u8);
