    ...
    : IJsonElement<NativeBuildList>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyNativeBuildsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("nativeBuilds"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyNativeBuildsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("nativeBuilds"u8, buffer, out written);

        private const int RequiredOffsetForNativeBuilds = 0;
        private const uint RequiredBitForNativeBuilds = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForNativeBuilds;
        private static readonly JsonSchemaPathProvider NativeBuildsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/nativeBuilds"u8, buffer, out written);
        ...
        private static void MatchNativeBuilds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildList.NativeBuildViewArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.NativeBuildsUtf8,
                    evaluationPath: NativeBuildsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.NativeBuildList.NativeBuildViewArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForNativeBuilds] |= RequiredBitForNativeBuilds;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.NativeBuildsUtf8, MatchNativeBuilds),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/NativeBuildList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/NativeBuildList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/NativeBuildList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyNativeBuildsPresent, "nativeBuilds"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForNativeBuilds] & RequiredBitForNativeBuilds) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyNativeBuildsNotPresent, "nativeBuilds"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyNativeBuildsPresent, "nativeBuilds"u8, "required"u8);
