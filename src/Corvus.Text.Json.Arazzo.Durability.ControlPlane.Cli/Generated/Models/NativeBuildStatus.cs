...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NativeBuildStatus"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NativeBuildStatus(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NativeBuildStatus DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(NativeBuildStatus value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in NativeBuildStatus left, in NativeBuildStatus right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NativeBuildStatus left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(NativeBuildStatus instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator NativeBuildStatus(JsonElement instance)
    {
        return NativeBuildStatus.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NativeBuildStatus From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NativeBuildStatus ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<NativeBuildStatus>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NativeBuildStatus ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<NativeBuildStatus>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NativeBuildStatus ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<NativeBuildStatus>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static NativeBuildStatus ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<NativeBuildStatus>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out NativeBuildStatus? result)
    {
        return JsonElementHelpers.TryParseValue<NativeBuildStatus>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NativeBuildStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NativeBuildStatus IJsonElement<NativeBuildStatus>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NativeBuildStatus: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="NativeBuildStatus"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="NativeBuildStatus"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public NativeBuildStatus Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<NativeBuildStatus>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="NativeBuildStatus"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public NativeBuildStatus Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<NativeBuildStatus>(_idx);
        }
    ...
    /// <param name="matchBuilding">Match 2nd item.</param>
    /// <param name="matchReady">Match 3rd item.</param>
    ...
    public TResult Match<TContext, TResult>(
        ...
        Func<TContext, TResult> matchBuilding,
        Func<TContext, TResult> matchReady,
...
#endif
    {
        ...
        {
            return matchBuilding(context);
        }

        if (this.ValueEquals(Constants.Enum3))
        {
            return matchReady(context);
        }
    ...
    public TResult Match<TResult>(
        ...
        Func<TResult> matchBuilding,
        Func<TResult> matchReady,
