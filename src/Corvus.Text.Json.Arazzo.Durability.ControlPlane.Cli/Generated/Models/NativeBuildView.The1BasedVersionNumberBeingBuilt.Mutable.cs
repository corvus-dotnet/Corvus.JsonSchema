...
public readonly partial struct NativeBuildView
{
    ...
    public readonly partial struct The1BasedVersionNumberBeingBuilt
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(The1BasedVersionNumberBeingBuilt instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="The1BasedVersionNumberBeingBuilt"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator The1BasedVersionNumberBeingBuilt(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"The1BasedVersionNumberBeingBuilt.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly The1BasedVersionNumberBeingBuilt Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly The1BasedVersionNumberBeingBuilt Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<The1BasedVersionNumberBeingBuilt>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(The1BasedVersionNumberBeingBuilt instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<The1BasedVersionNumberBeingBuilt, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<The1BasedVersionNumberBeingBuilt> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<The1BasedVersionNumberBeingBuilt>();
            }
            finally
            {
