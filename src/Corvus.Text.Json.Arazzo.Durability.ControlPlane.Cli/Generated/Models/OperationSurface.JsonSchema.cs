...
public readonly partial struct OperationSurface
    : IJsonElement<OperationSurface>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOperationsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("operations"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOperationsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("operations"u8, buffer, out written);

        private const int RequiredOffsetForOperations = 0;
        private const uint RequiredBitForOperations = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForOperations;
        ...
        private static void MatchOperations(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForOperations] |= RequiredBitForOperations;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.OperationsUtf8))
            {
                matcher = MatchOperations;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/OperationSurface"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/OperationSurface";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/OperationSurface"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOperationsPresent, "operations"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForOperations] & RequiredBitForOperations) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyOperationsNotPresent, "operations"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOperationsPresent, "operations"u8, "required"u8);
