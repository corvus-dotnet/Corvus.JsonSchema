...
/// <remarks>
/// <para>
/// A source document&#39;s full operation surface, in document order.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct OperationSurface
{
...
#endif
    {
        ...
        public static explicit operator Mutable(OperationSurface instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="OperationSurface"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OperationSurface(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>operations</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Mutable Operations
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OperationsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OperationSurface(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetOperations(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("operations");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOperations<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OperationSurface.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OperationSurface"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OperationSurface"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly OperationSurface Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OperationSurface>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OperationSurface"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly OperationSurface Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<OperationSurface>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(OperationSurface instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="OperationSurface"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source operations)
        {
        ...
        /// Creates an instance of a <see cref="OperationSurface"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source operations)
        {
            Create(ref _builder, operations);
        }
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source<TContext> operations)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="OperationSurface"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source<TContext> operations)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
            Create(context, ref _builder, operations);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source operations)
    {
        return new Source(operations);
    }
    ...
    /// <param name="operations">The value of the <c>"operations"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source<TContext> operations)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, operations);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source operations, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(operations);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source<TContext> operations, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<OperationSurface, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<OperationSurface> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<OperationSurface>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<OperationSurface> Create<TContext>(
    ...
    public static ParsedJsonDocument<OperationSurface> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source operations, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<OperationSurface> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.OperationSurface.SourceOperationDescriptorArray.Source<TContext> operations, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
