...
public readonly partial struct OutputsSensitivity
{
...
#endif
    {
        ...
        public static explicit operator Mutable(OutputsSensitivity instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="OutputsSensitivity"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OutputsSensitivity(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OutputsSensitivity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly OutputsSensitivity Clone()
        {
            CheckValidInstance();
        ...
        public readonly OutputsSensitivity Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<OutputsSensitivity>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(OutputsSensitivity instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (OutputsSensitivity)value;
    ...
    {
        return workspace.CreateBuilder<OutputsSensitivity, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<OutputsSensitivity> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<OutputsSensitivity>();
        }
        finally
        {
