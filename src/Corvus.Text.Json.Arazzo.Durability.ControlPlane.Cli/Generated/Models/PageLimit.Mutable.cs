...
public readonly partial struct PageLimit
{
...
#endif
    {
        ...
        /// </remarks>
        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PageLimit, Mutable>(PageLimit.DefaultInstance);
        ...
        public static explicit operator Mutable(PageLimit instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PageLimit"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PageLimit(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PageLimit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PageLimit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PageLimit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PageLimit Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PageLimit"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PageLimit Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PageLimit>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(PageLimit instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<PageLimit, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<PageLimit> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PageLimit>();
        }
        finally
        {
