...
public readonly partial struct PostCatalogBody
{
        ...
        : IJsonElement<CatalogSecurityTagArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/paths/~1catalog/post/requestBody/content/multipart~1form-data/schema/properties/securityTags"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
            /// </summary>
            public const string SchemaLocation = "/paths/~1catalog/post/requestBody/content/multipart~1form-data/schema/properties/securityTags";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1catalog/post/requestBody/content/multipart~1form-data/schema/properties/securityTags"u8;
