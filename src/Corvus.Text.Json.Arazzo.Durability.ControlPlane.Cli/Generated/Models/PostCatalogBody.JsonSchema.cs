    ...
    : IJsonElement<PostCatalogBody>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/paths/~1catalog/post/requestBody/content/multipart~1form-data/schema"u8, buffer, out written);
