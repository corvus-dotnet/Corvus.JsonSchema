    ...
    : IJsonElement<PostWorkspaceWorkflowsByIdGitPullBody>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/paths/~1workspace~1workflows~1{id}~1git~1pull/post/requestBody/content/application~1json/schema"u8, buffer, out written);
