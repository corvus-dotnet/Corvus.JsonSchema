...
public readonly partial struct PostWorkspaceWorkflowsByIdPublishBody
{
    ...
    public readonly partial struct RequireScenariosEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RequireScenariosEntity, Mutable>(RequireScenariosEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(RequireScenariosEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequireScenariosEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequireScenariosEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequireScenariosEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RequireScenariosEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RequireScenariosEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequireScenariosEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RequireScenariosEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RequireScenariosEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RequireScenariosEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RequireScenariosEntity>();
            }
            finally
            {
