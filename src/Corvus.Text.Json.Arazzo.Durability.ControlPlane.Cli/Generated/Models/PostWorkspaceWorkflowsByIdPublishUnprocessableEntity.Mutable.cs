...
public readonly partial struct PostWorkspaceWorkflowsByIdPublishUnprocessableEntity
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostWorkspaceWorkflowsByIdPublishUnprocessableEntity instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostWorkspaceWorkflowsByIdPublishUnprocessableEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostWorkspaceWorkflowsByIdPublishUnprocessableEntity(Mutable instance)
        {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Mutable Diagnostics
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DiagnosticsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Mutable Reason
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReasonUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>suite</c> property.
        /// </summary>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Mutable Suite
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SuiteUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostWorkspaceWorkflowsByIdPublishUnprocessableEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDiagnostics(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source value)
        {
            CheckValidInstance();
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Diagnostics, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDiagnostics<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetReason(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("reason");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSuite(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SuiteUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SuiteUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Suite, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSuite<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// <summary>
        /// Remove the <c>suite</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveSuite()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SuiteUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostWorkspaceWorkflowsByIdPublishUnprocessableEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostWorkspaceWorkflowsByIdPublishUnprocessableEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostWorkspaceWorkflowsByIdPublishUnprocessableEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostWorkspaceWorkflowsByIdPublishUnprocessableEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostWorkspaceWorkflowsByIdPublishUnprocessableEntity Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source _createArg3;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(PostWorkspaceWorkflowsByIdPublishUnprocessableEntity instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source<TContext> _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source<TContext> _createArg3;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source<TContext> arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source<TContext> arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostWorkspaceWorkflowsByIdPublishUnprocessableEntity"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source reason,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source diagnostics = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source suite = default)
        {
            reason.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Reason, ref builder);
            diagnostics.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Diagnostics, ref builder);
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source suite = default)
        {
            Create(ref _builder, reason, diagnostics, suite);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source reason,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source<TContext> diagnostics = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source<TContext> suite = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, reason, diagnostics, suite);
        }
    ...
    /// <param name="diagnostics">The value of the <c>"diagnostics"</c> property.</param>
    /// <param name="suite">The value of the <c>"suite"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source reason, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source diagnostics = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source suite = default)
    {
        return new Source(reason, diagnostics, suite);
    }
    ...
    /// <param name="suite">The value of the <c>"suite"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source reason, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source<TContext> diagnostics = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source<TContext> suite = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, reason, diagnostics, suite);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source reason, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source diagnostics = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source suite = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(reason, diagnostics, suite);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source reason, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source<TContext> diagnostics = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source<TContext> suite = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, reason, diagnostics, suite);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity> Create<TContext>(
    ...
    public static ParsedJsonDocument<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source reason, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source diagnostics = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source suite = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.Source reason, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.Source<TContext> diagnostics = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.Source<TContext> suite = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
