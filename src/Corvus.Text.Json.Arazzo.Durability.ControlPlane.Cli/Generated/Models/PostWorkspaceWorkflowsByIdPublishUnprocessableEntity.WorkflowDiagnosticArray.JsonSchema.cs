...
public readonly partial struct PostWorkspaceWorkflowsByIdPublishUnprocessableEntity
{
    ...
    public readonly partial struct WorkflowDiagnosticArray
        : IJsonElement<WorkflowDiagnosticArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1workspace~1workflows~1{id}~1publish/post/responses/422/content/application~1json/schema/properties/diagnostics"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/paths/~1workspace~1workflows~1{id}~1publish/post/responses/422/content/application~1json/schema/properties/diagnostics";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1workspace~1workflows~1{id}~1publish/post/responses/422/content/application~1json/schema/properties/diagnostics"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
