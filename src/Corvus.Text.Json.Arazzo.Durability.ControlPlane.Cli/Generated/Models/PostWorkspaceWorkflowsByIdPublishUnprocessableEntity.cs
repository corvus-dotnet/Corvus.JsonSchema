...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostWorkspaceWorkflowsByIdPublishUnprocessableEntity"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostWorkspaceWorkflowsByIdPublishUnprocessableEntity(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostWorkspaceWorkflowsByIdPublishUnprocessableEntity DefaultInstance { get; }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray Diagnostics
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DiagnosticsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity Reason
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReasonUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport Suite
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SuiteUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostWorkspaceWorkflowsByIdPublishUnprocessableEntity left, in PostWorkspaceWorkflowsByIdPublishUnprocessableEntity right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostWorkspaceWorkflowsByIdPublishUnprocessableEntity left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostWorkspaceWorkflowsByIdPublishUnprocessableEntity instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostWorkspaceWorkflowsByIdPublishUnprocessableEntity(JsonElement instance)
    {
        return PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdPublishUnprocessableEntity From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdPublishUnprocessableEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdPublishUnprocessableEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdPublishUnprocessableEntity ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static PostWorkspaceWorkflowsByIdPublishUnprocessableEntity ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostWorkspaceWorkflowsByIdPublishUnprocessableEntity? result)
    {
        return JsonElementHelpers.TryParseValue<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>(ref reader, out result);
    }
...
#if NET
    static PostWorkspaceWorkflowsByIdPublishUnprocessableEntity IJsonElement<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostWorkspaceWorkflowsByIdPublishUnprocessableEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostWorkspaceWorkflowsByIdPublishUnprocessableEntity Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostWorkspaceWorkflowsByIdPublishUnprocessableEntity Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>(_idx);
        }
