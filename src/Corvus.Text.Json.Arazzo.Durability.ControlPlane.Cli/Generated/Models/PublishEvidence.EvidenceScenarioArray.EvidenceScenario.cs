...
public readonly partial struct PublishEvidence
{
    ...
    public readonly partial struct EvidenceScenarioArray
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString PathSummary
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathSummaryUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString value))
                    {
                        return value;
                    }
