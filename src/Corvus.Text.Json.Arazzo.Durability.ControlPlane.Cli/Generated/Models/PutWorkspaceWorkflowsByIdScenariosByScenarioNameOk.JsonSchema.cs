    ...
    : IJsonElement<PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForEtag = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitForScenario = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForEtag | RequiredBitForScenario;
        ...
        private static readonly JsonSchemaPathProvider ScenarioSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/scenario/$ref"u8, buffer, out written);
        ...
        private static void MatchScenario(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1workspace~1workflows~1{id}~1scenarios~1{scenarioName}/put/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1workspace~1workflows~1{id}~1scenarios~1{scenarioName}/put/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1workspace~1workflows~1{id}~1scenarios~1{scenarioName}/put/responses/200/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEtagPresent, "etag"u8, "required"u8);
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyScenarioPresent, "scenario"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyEtagNotPresent, "etag"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEtagPresent, "etag"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyScenarioNotPresent, "scenario"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyScenarioPresent, "scenario"u8, "required"u8);
