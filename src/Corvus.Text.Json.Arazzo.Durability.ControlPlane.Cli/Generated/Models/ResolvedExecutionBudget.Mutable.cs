...
public readonly partial struct ResolvedExecutionBudget
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ResolvedExecutionBudget instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ResolvedExecutionBudget"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ResolvedExecutionBudget(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Mutable MaxResponseBytes
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxResponseBytesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Mutable MaxSteps
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxStepsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Mutable MaxSubWorkflowDepth
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxSubWorkflowDepthUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Mutable RetryAfterCeilingSeconds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetryAfterCeilingSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Mutable StepTimeoutSeconds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StepTimeoutSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Mutable WallClockSeconds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WallClockSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMaxResponseBytes(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("maxResponseBytes");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMaxSteps(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("maxSteps");
            }
        ...
        /// <summary>
        /// Set the <c>maxSubWorkflowDepth</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMaxSubWorkflowDepth(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("maxSubWorkflowDepth");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxSubWorkflowDepthUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MaxSubWorkflowDepth, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Set the <c>retryAfterCeilingSeconds</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRetryAfterCeilingSeconds(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("retryAfterCeilingSeconds");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetryAfterCeilingSecondsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RetryAfterCeilingSeconds, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStepTimeoutSeconds(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("stepTimeoutSeconds");
            }
        ...
        /// <summary>
        /// Set the <c>wallClockSeconds</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWallClockSeconds(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("wallClockSeconds");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WallClockSecondsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.WallClockSeconds, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ResolvedExecutionBudget.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly ResolvedExecutionBudget Clone()
        {
            CheckValidInstance();
        ...
        public readonly ResolvedExecutionBudget Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ResolvedExecutionBudget>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source _createArg4;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source _createArg5;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source _createArg6;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ResolvedExecutionBudget.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source arg3, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source arg4, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source arg5, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source arg6)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(ResolvedExecutionBudget instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ResolvedExecutionBudget.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source maxResponseBytes,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source maxSteps,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source maxSubWorkflowDepth,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source retryAfterCeilingSeconds,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source stepTimeoutSeconds,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source wallClockSeconds)
        {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ResolvedExecutionBudget"/>.
        /// </summary>
        public void Create(
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source maxResponseBytes,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source maxSteps,
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source maxResponseBytes, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source maxSteps, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source maxSubWorkflowDepth, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source retryAfterCeilingSeconds, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source stepTimeoutSeconds, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source wallClockSeconds)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source maxResponseBytes, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source maxSteps, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source maxSubWorkflowDepth, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source retryAfterCeilingSeconds, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source stepTimeoutSeconds, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source wallClockSeconds, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<ResolvedExecutionBudget, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ResolvedExecutionBudget> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ResolvedExecutionBudget>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ResolvedExecutionBudget> Create<TContext>(
    ...
    public static ParsedJsonDocument<ResolvedExecutionBudget> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxResponseBytes.Source maxResponseBytes, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSteps.Source maxSteps, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetMaxSubWorkflowDepth.Source maxSubWorkflowDepth, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetRetryAfterCeilingSeconds.Source retryAfterCeilingSeconds, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetStepTimeoutSeconds.Source stepTimeoutSeconds, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.BudgetWallClockSeconds.Source wallClockSeconds, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
