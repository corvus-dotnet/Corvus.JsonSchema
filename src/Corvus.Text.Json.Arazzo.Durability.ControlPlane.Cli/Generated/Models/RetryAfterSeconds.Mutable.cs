...
public readonly partial struct RetryAfterSeconds
{
...
#endif
    {
        ...
        public static explicit operator Mutable(RetryAfterSeconds instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="RetryAfterSeconds"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RetryAfterSeconds(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RetryAfterSeconds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly RetryAfterSeconds Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly RetryAfterSeconds Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<RetryAfterSeconds>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(RetryAfterSeconds instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<RetryAfterSeconds, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<RetryAfterSeconds> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<RetryAfterSeconds>();
        }
        finally
        {
