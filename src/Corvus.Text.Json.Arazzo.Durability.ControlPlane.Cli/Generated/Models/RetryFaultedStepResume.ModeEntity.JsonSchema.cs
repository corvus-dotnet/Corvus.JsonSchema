...
public readonly partial struct RetryFaultedStepResume
{
        ...
        : IJsonElement<ModeEntity>
    {
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/RetryFaultedStepResume/properties/mode"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "RetryFaultedStep"u8, "RetryFaultedStep", "const"u8, ref context);
                }
                else
                {
                    context.EvaluatedKeyword(false, "RetryFaultedStep", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                }
            }
