...
public readonly partial struct RetryFaultedStepResume
{
...
#endif
    {
        ...
        public static explicit operator Mutable(RetryFaultedStepResume instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="RetryFaultedStepResume"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RetryFaultedStepResume(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RetryFaultedStepResume.ModeEntity.Mutable Mode
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RetryFaultedStepResume.ModeEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMode(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RetryFaultedStepResume.ModeEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RetryFaultedStepResume.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly RetryFaultedStepResume Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly RetryFaultedStepResume Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<RetryFaultedStepResume>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RetryFaultedStepResume.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(RetryFaultedStepResume instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RetryFaultedStepResume.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="RetryFaultedStepResume"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder)
        {
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Mode, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RetryFaultedStepResume.ModeEntity.ConstInstance);
        }
    ...
    {
        return workspace.CreateBuilder<RetryFaultedStepResume, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<RetryFaultedStepResume> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<RetryFaultedStepResume>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<RetryFaultedStepResume> Create<TContext>(
