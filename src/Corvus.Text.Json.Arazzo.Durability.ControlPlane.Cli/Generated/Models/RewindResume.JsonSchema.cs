    ...
    : IJsonElement<RewindResume>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForMode = 0b00000000000000000000000000000001;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTargetCursorPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("targetCursor"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTargetCursorNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("targetCursor"u8, buffer, out written);

        private const int RequiredOffsetForTargetCursor = 0;
        private const uint RequiredBitForTargetCursor = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForMode | RequiredBitForTargetCursor;
        ...
        private static readonly JsonSchemaPathProvider TargetCursorSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/targetCursor"u8, buffer, out written);
        ...
        private static void MatchMode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RewindResume.ModeEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RewindResume.ModeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchTargetCursor(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt32.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.TargetCursorUtf8,
                    evaluationPath: TargetCursorSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInt32.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForTargetCursor] |= RequiredBitForTargetCursor;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.TargetCursorUtf8, MatchTargetCursor),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/RewindResume"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/RewindResume";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/RewindResume"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyModePresent, "mode"u8, "required"u8);
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyTargetCursorPresent, "targetCursor"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyModeNotPresent, "mode"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyModePresent, "mode"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForTargetCursor] & RequiredBitForTargetCursor) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyTargetCursorNotPresent, "targetCursor"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyTargetCursorPresent, "targetCursor"u8, "required"u8);
