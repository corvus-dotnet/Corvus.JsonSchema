...
public readonly partial struct RunnerAuthorizationDecisionNote
    ...
    : IJsonElement<RunnerAuthorizationDecisionNote>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RunnerAuthorizationDecisionNote"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal RunnerAuthorizationDecisionNote(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static RunnerAuthorizationDecisionNote DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in RunnerAuthorizationDecisionNote left, in RunnerAuthorizationDecisionNote right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in RunnerAuthorizationDecisionNote left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(RunnerAuthorizationDecisionNote instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator RunnerAuthorizationDecisionNote(JsonElement instance)
    {
        return RunnerAuthorizationDecisionNote.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RunnerAuthorizationDecisionNote From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RunnerAuthorizationDecisionNote ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<RunnerAuthorizationDecisionNote>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RunnerAuthorizationDecisionNote ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<RunnerAuthorizationDecisionNote>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static RunnerAuthorizationDecisionNote ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<RunnerAuthorizationDecisionNote>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static RunnerAuthorizationDecisionNote ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<RunnerAuthorizationDecisionNote>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out RunnerAuthorizationDecisionNote? result)
    {
        return JsonElementHelpers.TryParseValue<RunnerAuthorizationDecisionNote>(ref reader, out result);
    }
...
#if NET
    static RunnerAuthorizationDecisionNote IJsonElement<RunnerAuthorizationDecisionNote>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"RunnerAuthorizationDecisionNote: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public RunnerAuthorizationDecisionNote Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public RunnerAuthorizationDecisionNote Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<RunnerAuthorizationDecisionNote>(_idx);
        }
