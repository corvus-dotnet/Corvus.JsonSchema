...
public readonly partial struct RunnerAuthorizationGrant
{
...
#endif
    {
        ...
        public static explicit operator Mutable(RunnerAuthorizationGrant instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="RunnerAuthorizationGrant"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RunnerAuthorizationGrant(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Mutable ExpectedPrincipal
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpectedPrincipalUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Set the <c>expectedPrincipal</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetExpectedPrincipal(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExpectedPrincipalUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpectedPrincipalUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExpectedPrincipal, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>expectedPrincipal</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveExpectedPrincipal()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExpectedPrincipalUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RunnerAuthorizationGrant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly RunnerAuthorizationGrant Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly RunnerAuthorizationGrant Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<RunnerAuthorizationGrant>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(RunnerAuthorizationGrant instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="RunnerAuthorizationGrant"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source expectedPrincipal = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default)
        {
            expectedPrincipal.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExpectedPrincipal, ref builder);
        ...
        /// Creates an instance of a <see cref="RunnerAuthorizationGrant"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source expectedPrincipal = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default)
        {
            Create(ref _builder, expectedPrincipal, reason);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="expectedPrincipal">The value of the <c>"expectedPrincipal"</c> property.</param>
    /// <param name="reason">The value of the <c>"reason"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source expectedPrincipal = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default)
    {
        return new Source(expectedPrincipal, reason);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="expectedPrincipal">The value of the property.</param>
    /// <param name="reason">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source expectedPrincipal = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(expectedPrincipal, reason);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<RunnerAuthorizationGrant, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<RunnerAuthorizationGrant> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<RunnerAuthorizationGrant>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<RunnerAuthorizationGrant> Create<TContext>(
    ...
    public static ParsedJsonDocument<RunnerAuthorizationGrant> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source expectedPrincipal = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source reason = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
