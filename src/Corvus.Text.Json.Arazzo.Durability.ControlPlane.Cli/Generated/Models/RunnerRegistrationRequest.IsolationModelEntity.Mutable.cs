...
public readonly partial struct RunnerRegistrationRequest
{
    ...
    public readonly partial struct IsolationModelEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IsolationModelEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IsolationModelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IsolationModelEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IsolationModelEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IsolationModelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IsolationModelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IsolationModelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly IsolationModelEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IsolationModelEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IsolationModelEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly IsolationModelEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IsolationModelEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IsolationModelEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<IsolationModelEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<IsolationModelEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IsolationModelEntity>();
            }
            finally
            {
