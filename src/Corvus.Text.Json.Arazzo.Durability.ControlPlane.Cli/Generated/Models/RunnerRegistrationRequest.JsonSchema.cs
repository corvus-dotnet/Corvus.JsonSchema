    ...
    : IJsonElement<RunnerRegistrationRequest>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForMaxConcurrency = 0b00000000000000000000000000000010;
        ...
        private const uint RequiredBitForRunnerId = 0b00000000000000000000000000000100;
        ...
        private const uint RequiredBitForTransports = 0b00000000000000000000000000010000;

        private const uint RequiredBitMask0 =
            RequiredBitForHostedVersions | RequiredBitForMaxConcurrency | RequiredBitForRunnerId | RequiredBitForStartedAt |
            RequiredBitForTransports;
        ...
        private static readonly JsonSchemaPathProvider EnrolmentTokenSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/enrolmentToken"u8, buffer, out written);
        ...
        private static readonly JsonSchemaPathProvider IsolationModelSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/isolationModel"u8, buffer, out written);
        ...
        private static void MatchEnrolmentToken(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.EnrolmentTokenUtf8,
                    evaluationPath: EnrolmentTokenSchemaEvaluationPath);
        ...
        private static void MatchHostedVersions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerRegistrationRequest.RunnerHostedVersionArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerRegistrationRequest.RunnerHostedVersionArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchHostsDraftRuns(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext3 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.HostsDraftRunsUtf8,
                    evaluationPath: HostsDraftRunsSchemaEvaluationPath);
        ...
        private static void MatchIsolationModel(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext4 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerRegistrationRequest.IsolationModelEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.IsolationModelUtf8,
                    evaluationPath: IsolationModelSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerRegistrationRequest.IsolationModelEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
        ...
        private static void MatchServesSchedules(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext7);
        ...
        private static void MatchTransports(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext9 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerRegistrationRequest.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerRegistrationRequest.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext9);
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.EnrolmentTokenUtf8, MatchEnrolmentToken),
                ...
                (static () => JsonPropertyNames.IsolationModelUtf8, MatchIsolationModel),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/RunnerRegistrationRequest"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/RunnerRegistrationRequest";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/RunnerRegistrationRequest"u8;
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyMaxConcurrencyPresent, "maxConcurrency"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyRunnerIdPresent, "runnerId"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyStartedAtPresent, "startedAt"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 4, RequiredPropertyTransportsPresent, "transports"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyMaxConcurrencyNotPresent, "maxConcurrency"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyMaxConcurrencyPresent, "maxConcurrency"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyRunnerIdNotPresent, "runnerId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyRunnerIdPresent, "runnerId"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 4, RequiredPropertyTransportsNotPresent, "transports"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 4, RequiredPropertyTransportsPresent, "transports"u8, "required"u8);
