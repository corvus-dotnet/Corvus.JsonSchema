...
public readonly partial struct RunnerRegistrationRequest
{
        ...
        : IJsonElement<RunnerHostedVersionArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/RunnerRegistrationRequest/properties/hostedVersions"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerHostedVersion.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunnerHostedVersion.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
