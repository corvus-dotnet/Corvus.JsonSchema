...
public readonly partial struct Scenario
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioClock"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ScenarioClock(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ScenarioClock DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.ScenarioClock.AutoAdvanceEntity AutoAdvance
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAdvanceUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.ScenarioClock.AutoAdvanceEntity value))
                {
                    return value;
                }

                return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.ScenarioClock.AutoAdvanceEntity.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in ScenarioClock left, in ScenarioClock right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ScenarioClock left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ScenarioClock instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ScenarioClock(JsonElement instance)
        {
            return ScenarioClock.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScenarioClock From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScenarioClock ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ScenarioClock>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScenarioClock ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ScenarioClock>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScenarioClock ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ScenarioClock>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ScenarioClock ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ScenarioClock>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ScenarioClock? result)
        {
            return JsonElementHelpers.TryParseValue<ScenarioClock>(ref reader, out result);
        }
...
#if NET
        static ScenarioClock IJsonElement<ScenarioClock>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ScenarioClock: ValueKind = {ValueKind} : \"{ToString()}\"";
