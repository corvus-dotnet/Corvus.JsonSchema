...
public readonly partial struct Scenario
{
    ...
    public readonly partial struct ScenarioExpectations
    {
...
#endif
        {
            ...
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.ScenarioExpectations.OutputExpectationArray.OutputExpectation this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.ScenarioExpectations.OutputExpectationArray.OutputExpectation>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.ScenarioExpectations.OutputExpectationArray.OutputExpectation> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.ScenarioExpectations.OutputExpectationArray.OutputExpectation>(_parent, _idx);
            }
