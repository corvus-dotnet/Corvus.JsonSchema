    ...
    public readonly partial struct ScenarioExpectations
    {
            ...
            : IJsonElement<PathModeEntity>
        {
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "exact"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly PathModeEntity EnumJson1 = ParsedJsonDocument<PathModeEntity>.StringConstant([.."\"exact\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "subsequence"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly PathModeEntity EnumJson2 = ParsedJsonDocument<PathModeEntity>.StringConstant([.."\"subsequence\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "exact"
                /// as a <see cref="PathModeEntity"/>.
                /// </summary>
                public static PathModeEntity Exact { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "exact"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ExactUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "subsequence"
                /// as a <see cref="PathModeEntity"/>.
                /// </summary>
                public static PathModeEntity Subsequence { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "subsequence"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> SubsequenceUtf8 => Constants.Enum2;
            }
            ...
            {
                /// <summary>
                /// Corresponds to the JSON string "exact".
                /// </summary>
                Exact = 0,
                /// <summary>
                /// Corresponds to the JSON string "subsequence".
                /// </summary>
                Subsequence = 1,
            }
            ...
            public static implicit operator PathModeEntity(KnownValues value)
            {
                return value switch
                {
                    KnownValues.Exact => Constants.EnumJson1,
                    KnownValues.Subsequence => Constants.EnumJson2,
            ...
            public static implicit operator KnownValues(PathModeEntity value)
            {
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                ...
                {
                    result = KnownValues.Exact;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    result = KnownValues.Subsequence;
                    return true;
                }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/components/schemas/Scenario/properties/expect/properties/pathMode"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/components/schemas/Scenario/properties/expect/properties/pathMode";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/Scenario/properties/expect/properties/pathMode"u8;
                ...
                private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CorvusJsonSchemaProgram.Entry(244);
