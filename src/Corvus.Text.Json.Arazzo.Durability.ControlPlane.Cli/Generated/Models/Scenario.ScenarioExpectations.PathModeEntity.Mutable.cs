    ...
    public readonly partial struct ScenarioExpectations
    {
        ...
        public readonly partial struct PathModeEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PathModeEntity, Mutable>(PathModeEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(PathModeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PathModeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PathModeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PathModeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PathModeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PathModeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PathModeEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PathModeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PathModeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PathModeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PathModeEntity>();
                }
                finally
                {
