...
public readonly partial struct Scenario
{
    ...
    public readonly partial struct ScenarioExpectations
    {
        ...
        public readonly partial struct StepExpectations
        {
            ...
            public readonly partial struct StepExpectation
                : IJsonElement<StepExpectation>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaPathProvider AttemptsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/attempts"u8, buffer, out written);
                    private static readonly JsonSchemaPathProvider ReachedSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/reached"u8, buffer, out written);

                    private static void MatchAttempts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInteger.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.AttemptsUtf8,
                                evaluationPath: AttemptsSchemaEvaluationPath);
                    ...
                    private static void MatchReached(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext1 =
                            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.ReachedUtf8,
                                evaluationPath: ReachedSchemaEvaluationPath);
                    ...
                    private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                            (static () => JsonPropertyNames.AttemptsUtf8, MatchAttempts),
                            (static () => JsonPropertyNames.ReachedUtf8, MatchReached),
                        ]);
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/Scenario/properties/expect/properties/steps/additionalProperties"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/components/schemas/Scenario/properties/expect/properties/steps/additionalProperties";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/Scenario/properties/expect/properties/steps/additionalProperties"u8;
