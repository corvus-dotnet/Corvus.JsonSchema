    ...
    public readonly partial struct ScenarioExpectations
    {
        ...
        public readonly partial struct StepExpectations
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="StepExpectation"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal StepExpectation(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static StepExpectation DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInteger Attempts
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AttemptsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInteger value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonBoolean Reached
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReachedUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonBoolean value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in StepExpectation left, in StepExpectation right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in StepExpectation left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(StepExpectation instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StepExpectation(JsonElement instance)
                {
                    return StepExpectation.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StepExpectation From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StepExpectation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StepExpectation>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StepExpectation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StepExpectation>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StepExpectation ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StepExpectation>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static StepExpectation ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<StepExpectation>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out StepExpectation? result)
                {
                    return JsonElementHelpers.TryParseValue<StepExpectation>(ref reader, out result);
                }
...
#if NET
                static StepExpectation IJsonElement<StepExpectation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StepExpectation: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public StepExpectation Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<StepExpectation>(_idx);
                    }
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="Reached"/>.
                    /// </summary>
                    ...
                    /// Gets the JSON property name for <see cref="Reached"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> ReachedUtf8 => "reached"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Attempts"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Attempts => "attempts"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Reached"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Reached => "reached"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Attempts"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Attempts => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x74, 0x74, 0x65, 0x6D, 0x70, 0x74, 0x73, 0x22];

                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Reached"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Reached => [0x95, 0x00, 0x00, 0x00, 0x22, 0x72, 0x65, 0x61, 0x63, 0x68, 0x65, 0x64, 0x22];
                }
            }
        }
    }
