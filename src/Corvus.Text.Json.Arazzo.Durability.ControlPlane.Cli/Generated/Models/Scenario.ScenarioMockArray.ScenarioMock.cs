...
public readonly partial struct Scenario
{
    ...
    public readonly partial struct ScenarioMockArray
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.ScenarioMockArray.ScenarioMock.ScenarioMockResponseArray Responses
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResponsesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.Scenario.ScenarioMockArray.ScenarioMock.ScenarioMockResponseArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString SourceValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SourceValueUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString value))
                    {
                        return value;
                    }
