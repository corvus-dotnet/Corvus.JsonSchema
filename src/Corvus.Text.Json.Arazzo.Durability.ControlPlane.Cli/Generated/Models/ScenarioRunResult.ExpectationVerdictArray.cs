...
public readonly partial struct ScenarioRunResult
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict>(_parent, _idx);
        }
