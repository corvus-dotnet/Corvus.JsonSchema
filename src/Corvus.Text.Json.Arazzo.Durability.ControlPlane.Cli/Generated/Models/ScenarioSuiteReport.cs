...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.ScenarioRunResultArray Results
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResultsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport.ScenarioRunResultArray value))
            {
                return value;
            }
