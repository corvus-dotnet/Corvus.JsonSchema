...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ScheduleList"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ScheduleList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ScheduleList DefaultInstance { get; }
    ...
    /// <remarks>
    /// <para>
    /// An opaque continuation token for the next page, absent on the last page.
    /// </para>
    /// </remarks>
    ...
    /// <summary>
    /// Gets the <c>schedules</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScheduleList.ScheduleArray Schedules
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchedulesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScheduleList.ScheduleArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in ScheduleList left, in ScheduleList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ScheduleList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ScheduleList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ScheduleList(JsonElement instance)
    {
        return ScheduleList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ScheduleList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ScheduleList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ScheduleList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ScheduleList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ScheduleList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ScheduleList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ScheduleList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static ScheduleList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ScheduleList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ScheduleList? result)
    {
        return JsonElementHelpers.TryParseValue<ScheduleList>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ScheduleList(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ScheduleList IJsonElement<ScheduleList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ScheduleList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="ScheduleList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="ScheduleList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<ScheduleList>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="ScheduleList"/> that lives for the lifetime of its
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Schedules"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Schedules"/>.
        /// </summary>
        public static ReadOnlySpan<byte> SchedulesUtf8 => "schedules"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Schedules"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Schedules => "schedules"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Schedules"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Schedules => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6C, 0x65, 0x73, 0x22];
    }
}
