...
public readonly partial struct SecurityOrdering
{
...
#endif
    {
        ...
        public void SetDimensionValue(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetLabels(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrdering.JsonStringArray.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrdering.JsonStringArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrdering.JsonStringArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrdering.JsonStringArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source dimension, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrdering.JsonStringArray.Source labels)
    {
    ...
    /// <param name="labels">The value of the <c>"labels"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source dimension, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrdering.JsonStringArray.Source<TContext> labels)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
