    ...
    : IJsonElement<SecurityOrderingList>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOrderingsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("orderings"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOrderingsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("orderings"u8, buffer, out written);

        private const int RequiredOffsetForOrderings = 0;
        private const uint RequiredBitForOrderings = 0b00000000000000000000000000000001;
        ...
        private static void MatchOrderings(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrderingList.SecurityOrderingArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.OrderingsUtf8,
                    evaluationPath: OrderingsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrderingList.SecurityOrderingArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForOrderings] |= RequiredBitForOrderings;
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/SecurityOrderingList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/SecurityOrderingList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/SecurityOrderingList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOrderingsPresent, "orderings"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForOrderings] & RequiredBitForOrderings) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyOrderingsNotPresent, "orderings"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOrderingsPresent, "orderings"u8, "required"u8);
