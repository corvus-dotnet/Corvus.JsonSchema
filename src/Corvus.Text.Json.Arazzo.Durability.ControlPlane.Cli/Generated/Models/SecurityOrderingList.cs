...
public readonly partial struct SecurityOrderingList
    ...
    : IJsonElement<SecurityOrderingList>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SecurityOrderingList"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal SecurityOrderingList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static SecurityOrderingList DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrderingList.SecurityOrderingArray Orderings
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderingsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityOrderingList.SecurityOrderingArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in SecurityOrderingList left, in SecurityOrderingList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in SecurityOrderingList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(SecurityOrderingList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator SecurityOrderingList(JsonElement instance)
    {
        return SecurityOrderingList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityOrderingList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityOrderingList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityOrderingList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityOrderingList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityOrderingList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityOrderingList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityOrderingList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static SecurityOrderingList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityOrderingList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out SecurityOrderingList? result)
    {
        return JsonElementHelpers.TryParseValue<SecurityOrderingList>(ref reader, out result);
    }
...
#if NET
    static SecurityOrderingList IJsonElement<SecurityOrderingList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"SecurityOrderingList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public SecurityOrderingList Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public SecurityOrderingList Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<SecurityOrderingList>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Orderings"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Orderings"/>.
        /// </summary>
        public static ReadOnlySpan<byte> OrderingsUtf8 => "orderings"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Orderings"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Orderings => "orderings"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Orderings"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Orderings => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x72, 0x64, 0x65, 0x72, 0x69, 0x6E, 0x67, 0x73, 0x22];
    }
}
