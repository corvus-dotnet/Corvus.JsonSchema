...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityRuleList.SecurityRuleSummaryArray Rules
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RulesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SecurityRuleList.SecurityRuleSummaryArray value))
            {
                return value;
            }
