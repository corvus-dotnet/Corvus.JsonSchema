...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SecurityRuleSummary"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal SecurityRuleSummary(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static SecurityRuleSummary DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString Expression
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpressionUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in SecurityRuleSummary left, in SecurityRuleSummary right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in SecurityRuleSummary left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(SecurityRuleSummary instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator SecurityRuleSummary(JsonElement instance)
    {
        return SecurityRuleSummary.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityRuleSummary From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityRuleSummary ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityRuleSummary>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityRuleSummary ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityRuleSummary>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityRuleSummary ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityRuleSummary>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static SecurityRuleSummary ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityRuleSummary>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out SecurityRuleSummary? result)
    {
        return JsonElementHelpers.TryParseValue<SecurityRuleSummary>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new SecurityRuleSummary(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static SecurityRuleSummary IJsonElement<SecurityRuleSummary>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"SecurityRuleSummary: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="SecurityRuleSummary"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="SecurityRuleSummary"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public SecurityRuleSummary Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<SecurityRuleSummary>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="SecurityRuleSummary"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public SecurityRuleSummary Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<SecurityRuleSummary>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Expression"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Expression"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ExpressionUtf8 => "expression"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Expression"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Expression => "expression"u8;
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Expression"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Expression => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6F, 0x6E, 0x22];
