...
public readonly partial struct SimulateRequest
{
    ...
    public readonly partial struct InlineScenario
    {
        ...
        public readonly partial struct ClockPolicy
        {
            ...
            public readonly partial struct AutoAdvanceEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AutoAdvanceEntity, Mutable>(AutoAdvanceEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(AutoAdvanceEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AutoAdvanceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AutoAdvanceEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AutoAdvanceEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AutoAdvanceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AutoAdvanceEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AutoAdvanceEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AutoAdvanceEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AutoAdvanceEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AutoAdvanceEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AutoAdvanceEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AutoAdvanceEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AutoAdvanceEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AutoAdvanceEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AutoAdvanceEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AutoAdvanceEntity>();
                    }
                    finally
                    {
