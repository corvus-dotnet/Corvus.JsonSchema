    ...
    public readonly partial struct InlineScenario
    {
        ...
        public readonly partial struct ClockPolicy
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClockPolicy instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClockPolicy"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClockPolicy(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Mutable AutoAdvance
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAdvanceUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Mutable.DefaultInstance;
                    }
                }
                ...
                public void SetAutoAdvance(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClockPolicy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ClockPolicy"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ClockPolicy"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ClockPolicy Clone()
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ClockPolicy"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ClockPolicy Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClockPolicy>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Source _createArg1;
                ...
                internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(ClockPolicy instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ClockPolicy"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Source autoAdvance = default)
                {
                ...
                /// Creates an instance of a <see cref="ClockPolicy"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Source autoAdvance = default)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Source autoAdvance = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Source autoAdvance = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<ClockPolicy, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ClockPolicy> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClockPolicy>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ClockPolicy> Create<TContext>(
            ...
            public static ParsedJsonDocument<ClockPolicy> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulateRequest.InlineScenario.ClockPolicy.AutoAdvanceEntity.Source autoAdvance = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
