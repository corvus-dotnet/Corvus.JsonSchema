...
public readonly partial struct SimulateRequest
{
    ...
    public readonly partial struct StopCondition
    {
        ...
        public readonly partial struct OccurrenceEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OccurrenceEntity, Mutable>(OccurrenceEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(OccurrenceEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OccurrenceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OccurrenceEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OccurrenceEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OccurrenceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="OccurrenceEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OccurrenceEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OccurrenceEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OccurrenceEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OccurrenceEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OccurrenceEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OccurrenceEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OccurrenceEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OccurrenceEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OccurrenceEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OccurrenceEntity>();
                }
                finally
                {
