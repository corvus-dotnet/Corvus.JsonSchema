...
public readonly partial struct SimulationTrace
{
    ...
    public readonly partial struct SimulatedStepArray
    {
        ...
        public readonly partial struct SimulatedStep
        {
            ...
            /// </para>
            /// </remarks>
            public readonly partial struct SimulatedExchangeArray
            {
                /// <summary>
                /// SimulatedExchange
                /// </summary>
                [DebuggerDisplay("{DebuggerDisplay,nq}")]
                public readonly partial struct SimulatedExchange
                    : IJsonElement<SimulatedExchange>
                {
                    public static partial class JsonSchema
                    {
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyMethodPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("method"u8, buffer, out written);
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyMethodNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("method"u8, buffer, out written);

                        private const int RequiredOffsetForMethod = 0;
                        private const uint RequiredBitForMethod = 0b00000000000000000000000000000001;
                        ...
                        private const uint RequiredBitForPath = 0b00000000000000000000000000000010;
                        ...
                        private const uint RequiredBitMask0 =
                            RequiredBitForMethod | RequiredBitForPath | RequiredBitForStatus;
                        ...
                        private static readonly JsonSchemaPathProvider ResponseBodySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/responseBody"u8, buffer, out written);
                        ...
                        private static void MatchMethod(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                        {
                            ...
                            requiredBitBuffer[RequiredOffsetForMethod] |= RequiredBitForMethod;
                        }
                        ...
                        private static void MatchRequestBody(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                        ...
                        private static void MatchResponseBody(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext3 =
                                Corvus.Text.Json.JsonElement.JsonSchema.PushChildContextUnescaped(
                                    ...
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.ResponseBodyUtf8,
                                    evaluationPath: ResponseBodySchemaEvaluationPath);
                        ...
                        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                        {
                            ...
                            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
                        ...
                        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                        {
                            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                                ...
                                (static () => JsonPropertyNames.ResponseBodyUtf8, MatchResponseBody),
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/SimulationTrace/properties/steps/items/properties/requests/items"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/components/schemas/SimulationTrace/properties/steps/items/properties/requests/items";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/SimulationTrace/properties/steps/items/properties/requests/items"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            else
                            {
                                ...
                                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                                {
                                    if (context.HasCollector)
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyMethodPresent, "method"u8, "required"u8);
                                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPathPresent, "path"u8, "required"u8);
                                ...
                                {
                                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForMethod] & RequiredBitForMethod) == 0)
                                    {
                                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyMethodNotPresent, "method"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyMethodPresent, "method"u8, "required"u8);
                                    ...
                                    {
                                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyPathNotPresent, "path"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPathPresent, "path"u8, "required"u8);
