    ...
    public readonly partial struct SimulatedStepArray
    {
        ...
        public readonly partial struct SimulatedStep
        {
...
#endif
            {
                ...
                public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.SimulatedStepArray.SimulatedStep.SimulatedExchangeArray.SimulatedExchange this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.SimulatedStepArray.SimulatedStep.SimulatedExchangeArray.SimulatedExchange>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.SimulatedStepArray.SimulatedStep.SimulatedExchangeArray.SimulatedExchange> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.SimulatedStepArray.SimulatedStep.SimulatedExchangeArray.SimulatedExchange>(_parent, _idx);
                }
