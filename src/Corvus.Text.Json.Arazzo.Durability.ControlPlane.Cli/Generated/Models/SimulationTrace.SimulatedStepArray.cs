...
public readonly partial struct SimulationTrace
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.SimulatedStepArray.SimulatedStep this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.SimulatedStepArray.SimulatedStep>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.SimulatedStepArray.SimulatedStep> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SimulationTrace.SimulatedStepArray.SimulatedStep>(_parent, _idx);
        }
