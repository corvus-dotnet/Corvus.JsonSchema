...
public readonly partial struct SourceCredentialKind
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SourceCredentialKind instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SourceCredentialKind"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SourceCredentialKind(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SourceCredentialKind.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly SourceCredentialKind Clone()
        {
            CheckValidInstance();
        ...
        public readonly SourceCredentialKind Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SourceCredentialKind>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(SourceCredentialKind instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (SourceCredentialKind)value;
    ...
    {
        return workspace.CreateBuilder<SourceCredentialKind, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SourceCredentialKind> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SourceCredentialKind>();
        }
        finally
        {
