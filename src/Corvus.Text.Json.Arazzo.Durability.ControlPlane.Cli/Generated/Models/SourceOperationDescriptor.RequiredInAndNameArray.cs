...
public readonly partial struct SourceOperationDescriptor
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.RequiredInAndNameArray.RequiredInAndName this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.RequiredInAndNameArray.RequiredInAndName>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.RequiredInAndNameArray.RequiredInAndName> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.RequiredInAndNameArray.RequiredInAndName>(_parent, _idx);
        }
