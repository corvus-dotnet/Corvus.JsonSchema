...
public readonly partial struct SourceOperationDescriptor
{
    ...
    public readonly partial struct ResponsesEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.ResponsesEntity.AdditionalPropertiesEntity.SchemaEntity Schema
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.ResponsesEntity.AdditionalPropertiesEntity.SchemaEntity value))
                    {
                        return value;
                    }
