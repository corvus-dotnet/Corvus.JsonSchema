...
public readonly partial struct SourceOperationDescriptor
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.SourceOperationRequestDescriptor.RawSchema Schema
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.SourceOperationRequestDescriptor.RawSchema value))
                {
                    return value;
                }
