...
public readonly partial struct SourceOperationDescriptor
{
    ...
    public readonly partial struct SourceOperationResponses
    {
...
#endif
        {
            ...
            /// RawSchema
            /// </summary>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.SourceOperationResponses.SourceOperationResponseDescriptor.RawSchema Schema
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceOperationDescriptor.SourceOperationResponses.SourceOperationResponseDescriptor.RawSchema value))
                    {
                        return value;
                    }
