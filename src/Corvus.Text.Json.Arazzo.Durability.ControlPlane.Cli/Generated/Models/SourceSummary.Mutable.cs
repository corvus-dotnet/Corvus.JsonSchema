...
public readonly partial struct SourceSummary
{
...
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetManagementTags(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.SourceSummary.SourceSecurityTagArray.Source value)
        {
            CheckValidInstance();
