    ...
    : IJsonElement<SourceType>
{
    private static class Constants
    {
        ...
        /// </summary>
        public static readonly byte[] Enum1 = "openapi"u8.ToArray();
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly SourceType EnumJson1 = ParsedJsonDocument<SourceType>.StringConstant([.."\"openapi\""u8]);
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly byte[] Enum2 = "asyncapi"u8.ToArray();
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
    ...
    {
        /// <summary>
        /// Gets the string "openapi"
        /// as a <see cref="SourceType"/>.
        /// </summary>
        public static SourceType Openapi { get; } = Constants.EnumJson1;
        /// <summary>
        /// Gets the string "openapi"
        /// as a UTF8 byte array.
        /// </summary>
        public static ReadOnlySpan<byte> OpenapiUtf8 => Constants.Enum1;

        /// <summary>
        /// Gets the string "asyncapi"
        /// as a <see cref="SourceType"/>.
        /// </summary>
        public static SourceType Asyncapi { get; } = Constants.EnumJson2;
        /// <summary>
        /// Gets the string "asyncapi"
        /// as a UTF8 byte array.
        /// </summary>
    ...
    {
        /// <summary>
        /// Corresponds to the JSON string "openapi".
        /// </summary>
        Openapi = 0,
        /// <summary>
        /// Corresponds to the JSON string "asyncapi".
        /// </summary>
        Asyncapi = 1,
        /// <summary>
        /// Corresponds to the JSON string "jsonschema".
        /// </summary>
        Jsonschema = 2,
    }
    ...
    public static implicit operator SourceType(KnownValues value)
    {
        return value switch
        {
            KnownValues.Openapi => Constants.EnumJson1,
            KnownValues.Asyncapi => Constants.EnumJson2,
            KnownValues.Jsonschema => Constants.EnumJson3,
    ...
    public static implicit operator KnownValues(SourceType value)
    {
    ...
    public bool TryGetKnownValue(out KnownValues result)
    {
        ...
        {
            result = KnownValues.Openapi;
            return true;
        }

        if (this.ValueEquals(Constants.Enum2))
        {
            result = KnownValues.Asyncapi;
            return true;
        }

        if (this.ValueEquals(Constants.Enum3))
        {
            result = KnownValues.Jsonschema;
            return true;
        }
    ...
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/components/schemas/SourceType"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/SourceType";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/SourceType"u8;
        ...
        private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.CorvusJsonSchemaProgram.Entry(342);
