...
public readonly partial struct SourceType
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SourceType instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SourceType"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SourceType(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SourceType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly SourceType Clone()
        {
            CheckValidInstance();
        ...
        public readonly SourceType Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SourceType>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(SourceType instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (SourceType)value;
    ...
    {
        return workspace.CreateBuilder<SourceType, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SourceType> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SourceType>();
        }
        finally
        {
