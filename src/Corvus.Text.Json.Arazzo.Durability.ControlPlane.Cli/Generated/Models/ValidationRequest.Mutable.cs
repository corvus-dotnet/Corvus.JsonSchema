...
public readonly partial struct ValidationRequest
{
...
#endif
    {
        ...
        public void SetTarget(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationTarget.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationTarget.Source arg1, in Corvus.Text.Json.JsonElement.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationTarget.Source<TContext> arg1, in Corvus.Text.Json.JsonElement.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationTarget.Source arg1, in Corvus.Text.Json.JsonElement.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationTarget.Source<TContext> arg1, in Corvus.Text.Json.JsonElement.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationTarget.Source target, in Corvus.Text.Json.JsonElement.Source value)
    {
    ...
    /// <param name="value">The value of the <c>"value"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationTarget.Source<TContext> target, in Corvus.Text.Json.JsonElement.Source<TContext> value)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
