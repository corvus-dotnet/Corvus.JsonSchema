...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationResult.ValidationErrorArray Errors
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationResult.ValidationErrorArray value))
            {
                return value;
            }
