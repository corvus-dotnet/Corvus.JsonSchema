        ...
        public static partial class JsonSchema
        {
            private static EnumStringSet BuildEnumStringSet()
            {
                return new EnumStringSet([
                    static () => "inputs"u8,
                    static () => "requestBody"u8,
                    static () => "responseBody"u8,
                    static () => "stepOutputs"u8,
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/ValidationTarget/properties/kind"u8, buffer, out written);
