...
public readonly partial struct ValidationTarget
{
...
#endif
    {
        ...
        /// <param name="matchInputs">Match 1st item.</param>
        /// <param name="matchRequestBody">Match 2nd item.</param>
        /// <param name="matchResponseBody">Match 3rd item.</param>
        /// <param name="matchStepOutputs">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchInputs,
            Func<TContext, TResult> matchRequestBody,
            Func<TContext, TResult> matchResponseBody,
            Func<TContext, TResult> matchStepOutputs,
...
#endif
        {
            ...
            {
                return matchInputs(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchRequestBody(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchResponseBody(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchStepOutputs(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchInputs,
            Func<TResult> matchRequestBody,
            Func<TResult> matchResponseBody,
            Func<TResult> matchStepOutputs,
