...
public readonly partial struct VersionNumber
{
...
#endif
    {
        ...
        public static explicit operator Mutable(VersionNumber instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="VersionNumber"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator VersionNumber(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"VersionNumber.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly VersionNumber Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly VersionNumber Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<VersionNumber>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(VersionNumber instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<VersionNumber, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<VersionNumber> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<VersionNumber>();
        }
        finally
        {
