    ...
    : IJsonElement<WhoAmI>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForIdentity = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForIdentity;
        ...
        private static void MatchIdentity(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.IdentityUtf8))
            {
                matcher = MatchIdentity;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/WhoAmI"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/WhoAmI";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/WhoAmI"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyIdentityPresent, "identity"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyIdentityNotPresent, "identity"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyIdentityPresent, "identity"u8, "required"u8);
