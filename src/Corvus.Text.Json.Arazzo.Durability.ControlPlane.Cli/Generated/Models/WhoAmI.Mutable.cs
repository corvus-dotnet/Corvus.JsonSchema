...
/// <remarks>
/// <para>
/// The caller&#39;s own deployment-stamped identity as {dimension,value} grants (design &#167;16.5.4); empty when unscoped.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct WhoAmI
{
...
#endif
    {
        ...
        public static explicit operator Mutable(WhoAmI instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="WhoAmI"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WhoAmI(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Mutable Identity
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdentityUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WhoAmI(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetIdentity(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetIdentity<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WhoAmI.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WhoAmI"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WhoAmI"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly WhoAmI Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WhoAmI>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WhoAmI"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly WhoAmI Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<WhoAmI>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(WhoAmI instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="WhoAmI"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source identity)
        {
        ...
        /// Creates an instance of a <see cref="WhoAmI"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source identity)
        {
            Create(ref _builder, identity);
        }
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source<TContext> identity)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="WhoAmI"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source<TContext> identity)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
            Create(context, ref _builder, identity);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source identity)
    {
        return new Source(identity);
    }
    ...
    /// <param name="identity">The value of the <c>"identity"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source<TContext> identity)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, identity);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source identity, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source<TContext> identity, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<WhoAmI, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<WhoAmI> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<WhoAmI>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<WhoAmI> Create<TContext>(
    ...
    public static ParsedJsonDocument<WhoAmI> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source identity, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<WhoAmI> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WhoAmI.AdministratorIdentityArray.Source<TContext> identity, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
