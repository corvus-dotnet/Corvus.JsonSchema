...
public readonly partial struct WorkflowDiagnostic
{
    public readonly partial struct SeverityEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SeverityEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SeverityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SeverityEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SeverityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly SeverityEntity Clone()
            {
                CheckValidInstance();
            ...
            public readonly SeverityEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SeverityEntity>(_idx);
            }
            ...
            /// <param name="matchInfo">Match 3rd item.</param>
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SeverityEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (SeverityEntity)value;
        ...
        {
            return workspace.CreateBuilder<SeverityEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SeverityEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SeverityEntity>();
            }
            finally
            {
