    ...
    : IJsonElement<WorkflowFault>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForAttempt = 0b00000000000000000000000000000010;
        ...
        private const uint RequiredBitForError = 0b00000000000000000000000000000100;
        ...
        private const uint RequiredBitForStepId = 0b00000000000000000000000000001000;

        private const uint RequiredBitMask0 =
            RequiredBitForAt | RequiredBitForAttempt | RequiredBitForError | RequiredBitForStepId;
        ...
        private static void MatchAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
        ...
        private static void MatchAttempt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
        ...
        private static void MatchStepId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/WorkflowFault"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/WorkflowFault";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/WorkflowFault"u8;
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyAttemptPresent, "attempt"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyErrorPresent, "error"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyStepIdPresent, "stepId"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyAttemptNotPresent, "attempt"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyAttemptPresent, "attempt"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyErrorNotPresent, "error"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyErrorPresent, "error"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 3, RequiredPropertyStepIdNotPresent, "stepId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyStepIdPresent, "stepId"u8, "required"u8);
