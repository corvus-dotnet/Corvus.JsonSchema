...
/// <remarks>
/// <para>
/// Acknowledges a triggered run that will execute asynchronously and durably on a hosting runner.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct WorkflowRunAccepted
    : IJsonElement<WorkflowRunAccepted>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForRunId = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitForWorkflowId = 0b00000000000000000000000000000100;

        private const uint RequiredBitMask0 =
            RequiredBitForRunId | RequiredBitForStatus | RequiredBitForWorkflowId;
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/WorkflowRunAccepted"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/WorkflowRunAccepted";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/WorkflowRunAccepted"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRunIdPresent, "runId"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyStatusPresent, "status"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyWorkflowIdPresent, "workflowId"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyRunIdNotPresent, "runId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRunIdPresent, "runId"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyWorkflowIdNotPresent, "workflowId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyWorkflowIdPresent, "workflowId"u8, "required"u8);
