...
public readonly partial struct WorkflowRunAccepted
{
...
#endif
    {
        ...
        public static explicit operator Mutable(WorkflowRunAccepted instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="WorkflowRunAccepted"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WorkflowRunAccepted(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// The run&#39;s initial status (always &#39;Pending&#39;).
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// The versioned workflow id the run executes.
        /// </para>
        /// </remarks>
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WorkflowRunAccepted(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WorkflowRunAccepted.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WorkflowRunAccepted"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WorkflowRunAccepted"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly WorkflowRunAccepted Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WorkflowRunAccepted>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WorkflowRunAccepted"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly WorkflowRunAccepted Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<WorkflowRunAccepted>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowRunAccepted.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(WorkflowRunAccepted instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowRunAccepted.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source status,
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source workflowId)
        {
            Create(ref _builder, runId, status, workflowId);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.RunId.Source runId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source status, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString.Source workflowId, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(runId, status, workflowId);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<WorkflowRunAccepted, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<WorkflowRunAccepted> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<WorkflowRunAccepted>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<WorkflowRunAccepted> Create<TContext>(
