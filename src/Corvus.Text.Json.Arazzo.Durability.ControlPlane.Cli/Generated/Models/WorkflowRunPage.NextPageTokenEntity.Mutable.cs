...
public readonly partial struct WorkflowRunPage
{
    ...
    public readonly partial struct NextPageTokenEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NextPageTokenEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NextPageTokenEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NextPageTokenEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NextPageTokenEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly NextPageTokenEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly NextPageTokenEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NextPageTokenEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(NextPageTokenEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<NextPageTokenEntity, Mutable>(this);
        }
    }
}
