...
public readonly partial struct WorkflowRunStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(WorkflowRunStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="WorkflowRunStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WorkflowRunStatus(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WorkflowRunStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WorkflowRunStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WorkflowRunStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WorkflowRunStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly WorkflowRunStatus Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WorkflowRunStatus>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WorkflowRunStatus"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly WorkflowRunStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<WorkflowRunStatus>(_idx);
        }
        ...
        /// <param name="matchRunning">Match 2nd item.</param>
        /// <param name="matchSuspended">Match 3rd item.</param>
        /// <param name="matchCompleted">Match 4th item.</param>
        /// <param name="matchCancelled">Match 5th item.</param>
        /// <param name="matchFaulted">Match 6th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchPending,
            Func<TContext, TResult> matchRunning,
            Func<TContext, TResult> matchSuspended,
            Func<TContext, TResult> matchCompleted,
            Func<TContext, TResult> matchCancelled,
...
#endif
        {
            ...
            {
                return matchCompleted(context);
            }

            if (this.ValueEquals(Constants.Enum5))
            {
                return matchCancelled(context);
            }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(WorkflowRunStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<WorkflowRunStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<WorkflowRunStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<WorkflowRunStatus>();
        }
        finally
        {
