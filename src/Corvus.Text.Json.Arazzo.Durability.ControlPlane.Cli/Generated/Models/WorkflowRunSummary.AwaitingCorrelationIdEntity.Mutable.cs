...
public readonly partial struct WorkflowRunSummary
{
    ...
    public readonly partial struct AwaitingCorrelationIdEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AwaitingCorrelationIdEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AwaitingCorrelationIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AwaitingCorrelationIdEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AwaitingCorrelationIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AwaitingCorrelationIdEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AwaitingCorrelationIdEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AwaitingCorrelationIdEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AwaitingCorrelationIdEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AwaitingCorrelationIdEntity, Mutable>(this);
        }
    }
}
