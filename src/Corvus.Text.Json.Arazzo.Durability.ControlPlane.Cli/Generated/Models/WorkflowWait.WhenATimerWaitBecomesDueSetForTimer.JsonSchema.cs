...
public readonly partial struct WorkflowWait
{
        ...
        : IJsonElement<WhenATimerWaitBecomesDueSetForTimer>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/WorkflowWait/properties/dueAt"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/WorkflowWait/properties/dueAt";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/WorkflowWait/properties/dueAt"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.Null)
                {
                    ...
                    context.IgnoredKeyword(JsonSchemaEvaluation.IgnoredNotTypeString, "format"u8);
                }
                else if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchDateTime(unescapedUtf8JsonString.Span, "format"u8, ref context);
