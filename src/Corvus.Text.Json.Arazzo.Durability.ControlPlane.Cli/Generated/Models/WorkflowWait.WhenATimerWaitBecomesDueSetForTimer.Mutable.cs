...
public readonly partial struct WorkflowWait
{
    ...
    public readonly partial struct WhenATimerWaitBecomesDueSetForTimer
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WhenATimerWaitBecomesDueSetForTimer instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WhenATimerWaitBecomesDueSetForTimer"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WhenATimerWaitBecomesDueSetForTimer(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WhenATimerWaitBecomesDueSetForTimer.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly WhenATimerWaitBecomesDueSetForTimer Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly WhenATimerWaitBecomesDueSetForTimer Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WhenATimerWaitBecomesDueSetForTimer>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(WhenATimerWaitBecomesDueSetForTimer instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<WhenATimerWaitBecomesDueSetForTimer, Mutable>(this);
        }
    }
}
