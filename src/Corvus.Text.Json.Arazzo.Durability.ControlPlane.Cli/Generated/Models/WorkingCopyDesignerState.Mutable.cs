...
public readonly partial struct WorkingCopyDesignerState
{
...
#endif
    {
        ...
        public static explicit operator Mutable(WorkingCopyDesignerState instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="WorkingCopyDesignerState"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WorkingCopyDesignerState(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WorkingCopyDesignerState.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly WorkingCopyDesignerState Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly WorkingCopyDesignerState Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<WorkingCopyDesignerState>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDesignerState.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(WorkingCopyDesignerState instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDesignerState.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<WorkingCopyDesignerState, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<WorkingCopyDesignerState> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<WorkingCopyDesignerState>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<WorkingCopyDesignerState> Create<TContext>(
