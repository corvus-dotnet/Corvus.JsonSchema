...
public readonly partial struct WorkingCopyDesignerState
#if NET8_0_OR_GREATER
    : IJsonElement<WorkingCopyDesignerState>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WorkingCopyDesignerState"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal WorkingCopyDesignerState(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static WorkingCopyDesignerState DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in WorkingCopyDesignerState left, in WorkingCopyDesignerState right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in WorkingCopyDesignerState left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(WorkingCopyDesignerState instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator WorkingCopyDesignerState(JsonElement instance)
    {
        return WorkingCopyDesignerState.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkingCopyDesignerState From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkingCopyDesignerState ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkingCopyDesignerState>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkingCopyDesignerState ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkingCopyDesignerState>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkingCopyDesignerState ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkingCopyDesignerState>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static WorkingCopyDesignerState ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkingCopyDesignerState>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out WorkingCopyDesignerState? result)
    {
        return JsonElementHelpers.TryParseValue<WorkingCopyDesignerState>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new WorkingCopyDesignerState(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static WorkingCopyDesignerState IJsonElement<WorkingCopyDesignerState>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"WorkingCopyDesignerState: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="WorkingCopyDesignerState"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="WorkingCopyDesignerState"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public WorkingCopyDesignerState Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<WorkingCopyDesignerState>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="WorkingCopyDesignerState"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public WorkingCopyDesignerState Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<WorkingCopyDesignerState>(_idx);
        }
