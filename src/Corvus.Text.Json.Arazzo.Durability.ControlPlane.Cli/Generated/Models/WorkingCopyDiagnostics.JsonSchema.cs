...
public readonly partial struct WorkingCopyDiagnostics
    : IJsonElement<WorkingCopyDiagnostics>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDiagnosticsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("diagnostics"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDiagnosticsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("diagnostics"u8, buffer, out written);

        private const int RequiredOffsetForDiagnostics = 0;
        private const uint RequiredBitForDiagnostics = 0b00000000000000000000000000000001;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyValidPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("valid"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyValidNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("valid"u8, buffer, out written);

        private const int RequiredOffsetForValid = 0;
        private const uint RequiredBitForValid = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForDiagnostics | RequiredBitForValid;
        ...
        private static readonly JsonSchemaPathProvider ValidSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/valid"u8, buffer, out written);

        private static void MatchDiagnostics(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDiagnostics.WorkflowDiagnosticArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDiagnostics.WorkflowDiagnosticArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForDiagnostics] |= RequiredBitForDiagnostics;
        }

        private static void MatchValid(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ValidUtf8,
                    evaluationPath: ValidSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForValid] |= RequiredBitForValid;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.ValidUtf8, MatchValid),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/WorkingCopyDiagnostics"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/WorkingCopyDiagnostics";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/WorkingCopyDiagnostics"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDiagnosticsPresent, "diagnostics"u8, "required"u8);
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyValidPresent, "valid"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDiagnostics] & RequiredBitForDiagnostics) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDiagnosticsNotPresent, "diagnostics"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDiagnosticsPresent, "diagnostics"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForValid] & RequiredBitForValid) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyValidNotPresent, "valid"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyValidPresent, "valid"u8, "required"u8);
