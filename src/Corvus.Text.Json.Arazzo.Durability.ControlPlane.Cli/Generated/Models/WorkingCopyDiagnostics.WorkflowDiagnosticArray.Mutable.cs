...
/// <remarks>
/// <para>
/// The outcome of validating a working copy&#39;s Arazzo document: JSON-Schema conformance against the Arazzo schema for the document&#39;s declared version, plus document-local semantic checks (goto/retry targets, dependsOn references, criterion syntax via the runtime&#39;s own compiler, runtime-expression syntax, reusable component references, duplicate ids, reachability). Source-dependent checks (unresolved operationId/operationPath/channelPath) arrive with attached sources. Warnings do not fail validation — valid means no errors.
/// </para>
/// </remarks>
public readonly partial struct WorkingCopyDiagnostics
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Every finding, in document order (empty when clean).
    /// </para>
    /// </remarks>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly partial struct WorkflowDiagnosticArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WorkflowDiagnosticArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WorkflowDiagnosticArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WorkflowDiagnosticArray(Mutable instance)
            {
            ...
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WorkflowDiagnosticArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WorkflowDiagnosticArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic oldItem, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="WorkflowDiagnosticArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WorkflowDiagnosticArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly WorkflowDiagnosticArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WorkflowDiagnosticArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WorkflowDiagnosticArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly WorkflowDiagnosticArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WorkflowDiagnosticArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDiagnostics.WorkflowDiagnosticArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(WorkflowDiagnosticArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDiagnostics.WorkflowDiagnosticArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkflowDiagnostic.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<WorkflowDiagnosticArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<WorkflowDiagnosticArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WorkflowDiagnosticArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<WorkflowDiagnosticArray> Create<TContext>(
