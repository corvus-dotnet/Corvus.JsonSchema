    ...
    : IJsonElement<WorkingCopyUpdate>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForDocument = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitForExpectedEtag = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForDocument | RequiredBitForExpectedEtag;
        ...
        private static void MatchDocument(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/WorkingCopyUpdate"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/WorkingCopyUpdate";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/WorkingCopyUpdate"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDocumentPresent, "document"u8, "required"u8);
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyExpectedEtagPresent, "expectedEtag"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDocumentNotPresent, "document"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDocumentPresent, "document"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyExpectedEtagNotPresent, "expectedEtag"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyExpectedEtagPresent, "expectedEtag"u8, "required"u8);
