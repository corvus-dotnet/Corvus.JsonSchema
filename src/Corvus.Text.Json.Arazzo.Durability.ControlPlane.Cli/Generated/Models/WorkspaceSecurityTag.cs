...
/// <remarks>
/// <para>
/// A security label (KVP) scoping a working copy for row authorization (&#167;14.2).
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct WorkspaceSecurityTag
#if NET8_0_OR_GREATER
    : IJsonElement<WorkspaceSecurityTag>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WorkspaceSecurityTag"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal WorkspaceSecurityTag(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static WorkspaceSecurityTag DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in WorkspaceSecurityTag left, in WorkspaceSecurityTag right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in WorkspaceSecurityTag left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(WorkspaceSecurityTag instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator WorkspaceSecurityTag(JsonElement instance)
    {
        return WorkspaceSecurityTag.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkspaceSecurityTag From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkspaceSecurityTag ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkspaceSecurityTag>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkspaceSecurityTag ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkspaceSecurityTag>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkspaceSecurityTag ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkspaceSecurityTag>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static WorkspaceSecurityTag ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkspaceSecurityTag>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out WorkspaceSecurityTag? result)
    {
        return JsonElementHelpers.TryParseValue<WorkspaceSecurityTag>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new WorkspaceSecurityTag(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static WorkspaceSecurityTag IJsonElement<WorkspaceSecurityTag>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"WorkspaceSecurityTag: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="WorkspaceSecurityTag"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="WorkspaceSecurityTag"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public WorkspaceSecurityTag Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<WorkspaceSecurityTag>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="WorkspaceSecurityTag"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public WorkspaceSecurityTag Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<WorkspaceSecurityTag>(_idx);
        }
