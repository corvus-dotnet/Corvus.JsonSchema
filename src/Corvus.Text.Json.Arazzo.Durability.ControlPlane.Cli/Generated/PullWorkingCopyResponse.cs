...
/// <summary>
/// Response type for the PullWorkingCopy operation.
/// </summary>
public struct PullWorkingCopyResponse : IApiResponse<PullWorkingCopyResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<PullWorkingCopyResponse> CreateAsync(
        int statusCode,
    ...
    {
        PullWorkingCopyResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopy, TContext, TResult> matchOk,
