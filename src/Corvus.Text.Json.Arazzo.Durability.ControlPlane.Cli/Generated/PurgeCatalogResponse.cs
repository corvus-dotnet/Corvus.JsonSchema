...
/// <summary>
/// Response type for the PurgeCatalog operation.
/// </summary>
public struct PurgeCatalogResponse : IApiResponse<PurgeCatalogResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PurgeResult OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<PurgeCatalogResponse> CreateAsync(
        int statusCode,
    ...
    {
        PurgeCatalogResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PurgeResult>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PurgeResult result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PurgeResult, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PurgeResult, TContext, TResult> matchOk,
