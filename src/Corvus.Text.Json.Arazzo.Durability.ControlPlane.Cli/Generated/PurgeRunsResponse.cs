...
/// <summary>
/// Response type for the PurgeRuns operation.
/// </summary>
public struct PurgeRunsResponse : IApiResponse<PurgeRunsResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PurgeRunsResponse> CreateAsync(
        int statusCode,
    ...
    {
        PurgeRunsResponse response = default;
