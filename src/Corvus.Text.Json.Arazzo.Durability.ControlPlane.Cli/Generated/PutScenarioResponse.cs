...
/// <summary>
/// Response type for the PutScenario operation.
/// </summary>
public struct PutScenarioResponse : IApiResponse<PutScenarioResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<PutScenarioResponse> CreateAsync(
        int statusCode,
    ...
    {
        PutScenarioResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk, TContext, TResult> matchOk,
