...
/// <summary>
/// Response type for the QuarantineRunner operation.
/// </summary>
public struct QuarantineRunnerResponse : IApiResponse<QuarantineRunnerResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<QuarantineRunnerResponse> CreateAsync(
        int statusCode,
    ...
    {
        QuarantineRunnerResponse response = default;
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentRunnerAuthorizationView result)
    {
