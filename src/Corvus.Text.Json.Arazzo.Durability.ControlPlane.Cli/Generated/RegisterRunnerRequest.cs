...
/// <summary>
/// Request type for the RegisterRunner operation.
/// </summary>
...
public readonly struct RegisterRunnerRequest : IApiRequest<RegisterRunnerRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RegisterRunnerRequest"/> struct.
    /// </summary>
    /// <param name="name">The name parameter.</param>
    public RegisterRunnerRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.EnvironmentName name)
    {
        this.Name = name;
    }
