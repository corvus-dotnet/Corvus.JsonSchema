...
/// <summary>
/// Response type for the RegisterSource operation.
/// </summary>
public struct RegisterSourceResponse : IApiResponse<RegisterSourceResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<RegisterSourceResponse> CreateAsync(
        int statusCode,
    ...
    {
        RegisterSourceResponse response = default;
