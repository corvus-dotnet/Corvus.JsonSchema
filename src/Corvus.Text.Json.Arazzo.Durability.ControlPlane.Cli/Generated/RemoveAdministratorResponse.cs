...
/// <summary>
/// Response type for the RemoveAdministrator operation.
/// </summary>
public struct RemoveAdministratorResponse : IApiResponse<RemoveAdministratorResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<RemoveAdministratorResponse> CreateAsync(
        int statusCode,
    ...
    {
        RemoveAdministratorResponse response = default;
