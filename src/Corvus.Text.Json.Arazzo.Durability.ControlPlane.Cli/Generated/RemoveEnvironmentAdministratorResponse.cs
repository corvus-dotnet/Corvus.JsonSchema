...
/// <summary>
/// Response type for the RemoveEnvironmentAdministrator operation.
/// </summary>
public struct RemoveEnvironmentAdministratorResponse : IApiResponse<RemoveEnvironmentAdministratorResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<RemoveEnvironmentAdministratorResponse> CreateAsync(
        int statusCode,
    ...
    {
        RemoveEnvironmentAdministratorResponse response = default;
