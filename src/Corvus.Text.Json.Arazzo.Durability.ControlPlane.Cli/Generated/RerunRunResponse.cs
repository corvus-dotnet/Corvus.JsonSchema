...
/// <summary>
/// Response type for the RerunRun operation.
/// </summary>
public struct RerunRunResponse : IApiResponse<RerunRunResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<RerunRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        RerunRunResponse response = default;
