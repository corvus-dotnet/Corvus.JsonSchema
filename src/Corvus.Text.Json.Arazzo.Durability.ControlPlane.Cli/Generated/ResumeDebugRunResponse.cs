...
/// <summary>
/// Response type for the ResumeDebugRun operation.
/// </summary>
public struct ResumeDebugRunResponse : IApiResponse<ResumeDebugRunResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ResumeDebugRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        ResumeDebugRunResponse response = default;
