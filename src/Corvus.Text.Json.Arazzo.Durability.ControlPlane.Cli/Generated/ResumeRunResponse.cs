...
/// <summary>
/// Response type for the ResumeRun operation.
/// </summary>
public struct ResumeRunResponse : IApiResponse<ResumeRunResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ResumeRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        ResumeRunResponse response = default;
