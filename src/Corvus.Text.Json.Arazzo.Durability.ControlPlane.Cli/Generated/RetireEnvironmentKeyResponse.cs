...
/// <summary>
/// Response type for the RetireEnvironmentKey operation.
/// </summary>
public struct RetireEnvironmentKeyResponse : IApiResponse<RetireEnvironmentKeyResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<RetireEnvironmentKeyResponse> CreateAsync(
        int statusCode,
    ...
    {
        RetireEnvironmentKeyResponse response = default;
