...
/// <summary>
/// Request type for the RevokeAccessRequest operation.
/// </summary>
...
public readonly struct RevokeAccessRequestRequest : IApiRequest<RevokeAccessRequestRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RevokeAccessRequestRequest"/> struct.
    /// </summary>
    /// <param name="requestId">The requestId parameter.</param>
    public RevokeAccessRequestRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString requestId)
    {
        this.RequestId = requestId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/accessRequests/{requestId}/revoke"u8;
