...
/// <summary>
/// Response type for the RevokeAccessRequest operation.
/// </summary>
public struct RevokeAccessRequestResponse : IApiResponse<RevokeAccessRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<RevokeAccessRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        RevokeAccessRequestResponse response = default;
