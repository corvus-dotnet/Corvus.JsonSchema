...
/// <summary>
/// Response type for the RevokeRunner operation.
/// </summary>
public struct RevokeRunnerResponse : IApiResponse<RevokeRunnerResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<RevokeRunnerResponse> CreateAsync(
        int statusCode,
    ...
    {
        RevokeRunnerResponse response = default;
