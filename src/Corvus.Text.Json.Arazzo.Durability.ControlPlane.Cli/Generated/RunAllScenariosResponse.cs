...
/// <summary>
/// Response type for the RunAllScenarios operation.
/// </summary>
public struct RunAllScenariosResponse : IApiResponse<RunAllScenariosResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<RunAllScenariosResponse> CreateAsync(
        int statusCode,
    ...
    {
        RunAllScenariosResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioSuiteReport, TContext, TResult> matchOk,
