...
/// <summary>
/// Response type for the RunScenario operation.
/// </summary>
public struct RunScenarioResponse : IApiResponse<RunScenarioResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioRunResult OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<RunScenarioResponse> CreateAsync(
        int statusCode,
    ...
    {
        RunScenarioResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioRunResult>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioRunResult result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioRunResult, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ScenarioRunResult, TContext, TResult> matchOk,
