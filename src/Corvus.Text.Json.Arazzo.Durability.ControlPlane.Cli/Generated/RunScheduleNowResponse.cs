...
/// <summary>
/// Response type for the RunScheduleNow operation.
/// </summary>
public struct RunScheduleNowResponse : IApiResponse<RunScheduleNowResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<RunScheduleNowResponse> CreateAsync(
        int statusCode,
    ...
    {
        RunScheduleNowResponse response = default;
