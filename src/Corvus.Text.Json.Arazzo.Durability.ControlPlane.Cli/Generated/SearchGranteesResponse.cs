...
/// <summary>
/// Response type for the SearchGrantees operation.
/// </summary>
public struct SearchGranteesResponse : IApiResponse<SearchGranteesResponse>
{
    ...
    {
        SearchGranteesResponse response = default;
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GranteeList result)
    {
