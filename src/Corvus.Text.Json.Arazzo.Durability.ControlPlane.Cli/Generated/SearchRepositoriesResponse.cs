...
/// <summary>
/// Response type for the SearchRepositories operation.
/// </summary>
public struct SearchRepositoriesResponse : IApiResponse<SearchRepositoriesResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubRepositoryList OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<SearchRepositoriesResponse> CreateAsync(
        int statusCode,
    ...
    {
        SearchRepositoriesResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubRepositoryList>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubRepositoryList result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubRepositoryList, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.GitHubRepositoryList, TContext, TResult> matchOk,
