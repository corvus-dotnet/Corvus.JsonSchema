...
/// <summary>
/// Request type for the SettleAccessRequest operation.
/// </summary>
...
public readonly struct SettleAccessRequestRequest : IApiRequest<SettleAccessRequestRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SettleAccessRequestRequest"/> struct.
    /// </summary>
    /// <param name="requestId">The requestId parameter.</param>
    public SettleAccessRequestRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString requestId)
    {
        this.RequestId = requestId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/accessRequests/{requestId}/settle"u8;
