...
/// <summary>
/// Response type for the SettleAccessRequest operation.
/// </summary>
public struct SettleAccessRequestResponse : IApiResponse<SettleAccessRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<SettleAccessRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        SettleAccessRequestResponse response = default;
