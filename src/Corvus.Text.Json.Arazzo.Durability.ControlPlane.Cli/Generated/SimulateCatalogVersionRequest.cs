...
/// <summary>
/// Request type for the SimulateCatalogVersion operation.
/// </summary>
...
public readonly struct SimulateCatalogVersionRequest : IApiRequest<SimulateCatalogVersionRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SimulateCatalogVersionRequest"/> struct.
    /// </summary>
    /// <param name="baseWorkflowId">The baseWorkflowId parameter.</param>
    /// <param name="versionNumber">The versionNumber parameter.</param>
    public SimulateCatalogVersionRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString baseWorkflowId, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.VersionNumber versionNumber)
    {
    ...
    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/catalog/{baseWorkflowId}/versions/{versionNumber}/simulate"u8;
