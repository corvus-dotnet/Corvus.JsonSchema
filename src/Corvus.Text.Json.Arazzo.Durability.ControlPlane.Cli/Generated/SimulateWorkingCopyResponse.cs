...
/// <summary>
/// Response type for the SimulateWorkingCopy operation.
/// </summary>
public struct SimulateWorkingCopyResponse : IApiResponse<SimulateWorkingCopyResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<SimulateWorkingCopyResponse> CreateAsync(
        int statusCode,
    ...
    {
        SimulateWorkingCopyResponse response = default;
