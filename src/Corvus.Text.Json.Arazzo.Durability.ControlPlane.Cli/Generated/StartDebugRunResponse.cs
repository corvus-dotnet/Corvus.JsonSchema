...
/// <summary>
/// Response type for the StartDebugRun operation.
/// </summary>
public struct StartDebugRunResponse : IApiResponse<StartDebugRunResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<StartDebugRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        StartDebugRunResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.DebugRun, TContext, TResult> matchCreated,
