...
/// <summary>
/// Response type for the StartSealedCatalogWorkflowRun operation.
/// </summary>
public struct StartSealedCatalogWorkflowRunResponse : IApiResponse<StartSealedCatalogWorkflowRunResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<StartSealedCatalogWorkflowRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        StartSealedCatalogWorkflowRunResponse response = default;
