...
/// <summary>
/// Response type for the SubmitAccessRequest operation.
/// </summary>
public struct SubmitAccessRequestResponse : IApiResponse<SubmitAccessRequestResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestView CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<SubmitAccessRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        SubmitAccessRequestResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestView>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestView result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestView, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AccessRequestView, TContext, TResult> matchCreated,
