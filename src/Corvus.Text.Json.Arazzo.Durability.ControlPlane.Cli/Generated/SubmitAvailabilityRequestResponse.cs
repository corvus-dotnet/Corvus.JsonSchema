...
/// <summary>
/// Response type for the SubmitAvailabilityRequest operation.
/// </summary>
public struct SubmitAvailabilityRequestResponse : IApiResponse<SubmitAvailabilityRequestResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestView CreatedBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<SubmitAvailabilityRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        SubmitAvailabilityRequestResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestView>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestView result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestView, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.AvailabilityRequestView, TContext, TResult> matchCreated,
