...
/// <summary>
/// Response type for the TransferAdministration operation.
/// </summary>
public struct TransferAdministrationResponse : IApiResponse<TransferAdministrationResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<TransferAdministrationResponse> CreateAsync(
        int statusCode,
    ...
    {
        TransferAdministrationResponse response = default;
