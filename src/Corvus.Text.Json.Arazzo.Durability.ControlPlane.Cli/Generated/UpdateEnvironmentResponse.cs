...
/// <summary>
/// Response type for the UpdateEnvironment operation.
/// </summary>
public struct UpdateEnvironmentResponse : IApiResponse<UpdateEnvironmentResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<UpdateEnvironmentResponse> CreateAsync(
        int statusCode,
    ...
    {
        UpdateEnvironmentResponse response = default;
