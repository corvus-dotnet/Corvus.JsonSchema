...
/// <summary>
/// Response type for the UpdateSecurityBinding operation.
/// </summary>
public struct UpdateSecurityBindingResponse : IApiResponse<UpdateSecurityBindingResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<UpdateSecurityBindingResponse> CreateAsync(
        int statusCode,
    ...
    {
        UpdateSecurityBindingResponse response = default;
