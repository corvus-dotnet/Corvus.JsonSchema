...
/// <summary>
/// Response type for the UpdateWorkspaceWorkflow operation.
/// </summary>
public struct UpdateWorkspaceWorkflowResponse : IApiResponse<UpdateWorkspaceWorkflowResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<UpdateWorkspaceWorkflowResponse> CreateAsync(
        int statusCode,
    ...
    {
        UpdateWorkspaceWorkflowResponse response = default;
