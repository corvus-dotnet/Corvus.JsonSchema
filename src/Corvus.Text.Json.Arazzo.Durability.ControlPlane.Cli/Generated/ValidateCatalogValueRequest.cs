...
/// <summary>
/// Request type for the ValidateCatalogValue operation.
/// </summary>
...
public readonly struct ValidateCatalogValueRequest : IApiRequest<ValidateCatalogValueRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ValidateCatalogValueRequest"/> struct.
    /// </summary>
    /// <param name="baseWorkflowId">The baseWorkflowId parameter.</param>
    /// <param name="versionNumber">The versionNumber parameter.</param>
    public ValidateCatalogValueRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString baseWorkflowId, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.VersionNumber versionNumber)
    {
    ...
    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/catalog/{baseWorkflowId}/versions/{versionNumber}/validate"u8;
