...
/// <summary>
/// Response type for the ValidateCatalogValue operation.
/// </summary>
public struct ValidateCatalogValueResponse : IApiResponse<ValidateCatalogValueResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationResult OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ValidateCatalogValueResponse> CreateAsync(
        int statusCode,
    ...
    {
        ValidateCatalogValueResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationResult>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationResult result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationResult, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.ValidationResult, TContext, TResult> matchOk,
