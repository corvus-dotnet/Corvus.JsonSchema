...
/// <summary>
/// Response type for the ValidateWorkspaceWorkflow operation.
/// </summary>
public struct ValidateWorkspaceWorkflowResponse : IApiResponse<ValidateWorkspaceWorkflowResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDiagnostics OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ValidateWorkspaceWorkflowResponse> CreateAsync(
        int statusCode,
    ...
    {
        ValidateWorkspaceWorkflowResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDiagnostics>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDiagnostics result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDiagnostics, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.WorkingCopyDiagnostics, TContext, TResult> matchOk,
