...
/// <summary>
/// Request type for the WithdrawAccessRequest operation.
/// </summary>
...
public readonly struct WithdrawAccessRequestRequest : IApiRequest<WithdrawAccessRequestRequest>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WithdrawAccessRequestRequest"/> struct.
    /// </summary>
    /// <param name="requestId">The requestId parameter.</param>
    public WithdrawAccessRequestRequest(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Cli.Client.Models.JsonString requestId)
    {
        this.RequestId = requestId;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/accessRequests/{requestId}/withdraw"u8;
