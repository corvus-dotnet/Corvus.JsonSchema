...
/// <summary>
/// Response type for the WithdrawAccessRequest operation.
/// </summary>
public struct WithdrawAccessRequestResponse : IApiResponse<WithdrawAccessRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<WithdrawAccessRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        WithdrawAccessRequestResponse response = default;
