...
/// <summary>
/// Response type for the WithdrawAvailabilityRequest operation.
/// </summary>
public struct WithdrawAvailabilityRequestResponse : IApiResponse<WithdrawAvailabilityRequestResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<WithdrawAvailabilityRequestResponse> CreateAsync(
        int statusCode,
    ...
    {
        WithdrawAvailabilityRequestResponse response = default;
