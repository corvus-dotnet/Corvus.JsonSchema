...
/// <summary>
/// Response type for the WithdrawRunnerPreAuthorization operation.
/// </summary>
public struct WithdrawRunnerPreAuthorizationResponse : IApiResponse<WithdrawRunnerPreAuthorizationResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<WithdrawRunnerPreAuthorizationResponse> CreateAsync(
        int statusCode,
    ...
    {
        WithdrawRunnerPreAuthorizationResponse response = default;
