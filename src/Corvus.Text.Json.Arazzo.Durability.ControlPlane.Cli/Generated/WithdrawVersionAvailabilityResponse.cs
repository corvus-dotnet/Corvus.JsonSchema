...
/// <summary>
/// Response type for the WithdrawVersionAvailability operation.
/// </summary>
public struct WithdrawVersionAvailabilityResponse : IApiResponse<WithdrawVersionAvailabilityResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<WithdrawVersionAvailabilityResponse> CreateAsync(
        int statusCode,
    ...
    {
        WithdrawVersionAvailabilityResponse response = default;
