...
/// <summary>
/// Result type for the AddEnvironmentAdministrator operation.
/// </summary>
public readonly struct AddEnvironmentAdministratorResult
{
    private AddEnvironmentAdministratorResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 200.</returns>
    public static AddEnvironmentAdministratorResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorList.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 400.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 400.</returns>
    public static AddEnvironmentAdministratorResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 403.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 403.</returns>
    public static AddEnvironmentAdministratorResult Forbidden<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 404.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 404.</returns>
    public static AddEnvironmentAdministratorResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 409.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 409.</returns>
    public static AddEnvironmentAdministratorResult Conflict<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 502.</returns>
    public static AddEnvironmentAdministratorResult BadGateway(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(502, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/problem+json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AddEnvironmentAdministratorResult"/> with status 502.</returns>
    public static AddEnvironmentAdministratorResult BadGateway<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
