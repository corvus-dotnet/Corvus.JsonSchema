...
/// <summary>
/// Result type for the AttachWorkingCopySource operation.
/// </summary>
public readonly struct AttachWorkingCopySourceResult
{
    private AttachWorkingCopySourceResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="AttachWorkingCopySourceResult"/> with status 200.</returns>
    public static AttachWorkingCopySourceResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AttachedSource.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AttachedSource.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AttachWorkingCopySourceResult"/> with status 200.</returns>
    public static AttachWorkingCopySourceResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AttachedSource.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AttachedSource.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AttachWorkingCopySourceResult"/> with status 400.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AttachWorkingCopySourceResult"/> with status 400.</returns>
    public static AttachWorkingCopySourceResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AttachWorkingCopySourceResult"/> with status 404.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AttachWorkingCopySourceResult"/> with status 404.</returns>
    public static AttachWorkingCopySourceResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AttachWorkingCopySourceResult"/> with status 409.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="AttachWorkingCopySourceResult"/> with status 409.</returns>
    public static AttachWorkingCopySourceResult Conflict<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AttachedSource.From(this.Body).EvaluateSchema(),
