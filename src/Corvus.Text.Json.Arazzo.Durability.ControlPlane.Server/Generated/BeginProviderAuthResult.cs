...
/// <summary>
/// Result type for the BeginProviderAuth operation.
/// </summary>
public readonly struct BeginProviderAuthResult
{
    private BeginProviderAuthResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="BeginProviderAuthResult"/> with status 200.</returns>
    public static BeginProviderAuthResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProviderAuthStart.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProviderAuthStart.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="BeginProviderAuthResult"/> with status 200.</returns>
    public static BeginProviderAuthResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProviderAuthStart.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProviderAuthStart.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="BeginProviderAuthResult"/> with status 400.</returns>
    public static BeginProviderAuthResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProviderAuthStart.From(this.Body).EvaluateSchema(),
