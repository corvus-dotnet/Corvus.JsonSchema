...
/// <summary>
/// Result type for the CompleteGitHubAuth operation.
/// </summary>
public readonly struct CompleteGitHubAuthResult
{
    private CompleteGitHubAuthResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="CompleteGitHubAuthResult"/> with status 200.</returns>
    public static CompleteGitHubAuthResult Ok() => new(200, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CompleteGitHubAuthResult"/> with status 400.</returns>
    public static CompleteGitHubAuthResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
