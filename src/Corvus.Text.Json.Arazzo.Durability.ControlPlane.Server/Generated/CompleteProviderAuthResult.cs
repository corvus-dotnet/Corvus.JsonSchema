...
/// <summary>
/// Result type for the CompleteProviderAuth operation.
/// </summary>
public readonly struct CompleteProviderAuthResult
{
    private CompleteProviderAuthResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="CompleteProviderAuthResult"/> with status 200.</returns>
    public static CompleteProviderAuthResult Ok() => new(200, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CompleteProviderAuthResult"/> with status 400.</returns>
    public static CompleteProviderAuthResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
