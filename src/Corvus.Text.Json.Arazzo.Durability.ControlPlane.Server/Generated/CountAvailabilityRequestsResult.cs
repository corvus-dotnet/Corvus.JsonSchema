...
/// <summary>
/// Result type for the CountAvailabilityRequests operation.
/// </summary>
public readonly struct CountAvailabilityRequestsResult
{
    private CountAvailabilityRequestsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CountAvailabilityRequestsResult"/> with status 200.</returns>
    public static CountAvailabilityRequestsResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CountAvailabilityRequestsResult"/> with status 403.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CountAvailabilityRequestsResult"/> with status 403.</returns>
    public static CountAvailabilityRequestsResult Forbidden<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
