...
/// <summary>
/// Result type for the CountEnvironmentRunnerAuthorizations operation.
/// </summary>
public readonly struct CountEnvironmentRunnerAuthorizationsResult
{
    private CountEnvironmentRunnerAuthorizationsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="CountEnvironmentRunnerAuthorizationsResult"/> with status 200.</returns>
    public static CountEnvironmentRunnerAuthorizationsResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CountEnvironmentRunnerAuthorizationsResult"/> with status 200.</returns>
    public static CountEnvironmentRunnerAuthorizationsResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CountEnvironmentRunnerAuthorizationsResult"/> with status 403.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CountEnvironmentRunnerAuthorizationsResult"/> with status 403.</returns>
    public static CountEnvironmentRunnerAuthorizationsResult Forbidden<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CountEnvironmentRunnerAuthorizationsResult"/> with status 404.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CountEnvironmentRunnerAuthorizationsResult"/> with status 404.</returns>
    public static CountEnvironmentRunnerAuthorizationsResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.From(this.Body).EvaluateSchema(),
