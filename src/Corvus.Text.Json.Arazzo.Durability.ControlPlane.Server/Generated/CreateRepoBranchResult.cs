...
/// <summary>
/// Result type for the CreateRepoBranch operation.
/// </summary>
public readonly struct CreateRepoBranchResult
{
    private CreateRepoBranchResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="CreateRepoBranchResult"/> with status 201.</returns>
    public static CreateRepoBranchResult Created(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranch.Source body, JsonWorkspace workspace) => new(201, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranch.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CreateRepoBranchResult"/> with status 201.</returns>
    public static CreateRepoBranchResult Created<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranch.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(201, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranch.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CreateRepoBranchResult"/> with status 400.</returns>
    public static CreateRepoBranchResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CreateRepoBranchResult"/> with status 404.</returns>
    public static CreateRepoBranchResult NotFound(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(404, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CreateRepoBranchResult"/> with status 404.</returns>
    public static CreateRepoBranchResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CreateRepoBranchResult"/> with status 409.</returns>
    public static CreateRepoBranchResult Conflict(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(409, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="CreateRepoBranchResult"/> with status 409.</returns>
    public static CreateRepoBranchResult Conflict<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            201 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranch.From(this.Body).EvaluateSchema(),
