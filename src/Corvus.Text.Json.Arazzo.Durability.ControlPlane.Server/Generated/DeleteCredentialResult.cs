...
/// <summary>
/// Result type for the DeleteCredential operation.
/// </summary>
public readonly struct DeleteCredentialResult
{
    private DeleteCredentialResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="DeleteCredentialResult"/> with status 204.</returns>
    public static DeleteCredentialResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="DeleteCredentialResult"/> with status 404.</returns>
    public static DeleteCredentialResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
