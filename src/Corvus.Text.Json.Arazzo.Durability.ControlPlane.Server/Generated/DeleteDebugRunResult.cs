...
/// <summary>
/// Result type for the DeleteDebugRun operation.
/// </summary>
public readonly struct DeleteDebugRunResult
{
    private DeleteDebugRunResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="DeleteDebugRunResult"/> with status 204.</returns>
    public static DeleteDebugRunResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="DeleteDebugRunResult"/> with status 404.</returns>
    public static DeleteDebugRunResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
