...
/// <summary>
/// Result type for the DeleteGitHubSession operation.
/// </summary>
public readonly struct DeleteGitHubSessionResult
{
    private DeleteGitHubSessionResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="DeleteGitHubSessionResult"/> with status 204.</returns>
    public static DeleteGitHubSessionResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="DeleteGitHubSessionResult"/> with status 400.</returns>
    public static DeleteGitHubSessionResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
