...
/// <summary>
/// Result type for the DeleteProviderSession operation.
/// </summary>
public readonly struct DeleteProviderSessionResult
{
    private DeleteProviderSessionResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="DeleteProviderSessionResult"/> with status 204.</returns>
    public static DeleteProviderSessionResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="DeleteProviderSessionResult"/> with status 400.</returns>
    public static DeleteProviderSessionResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
