...
/// <summary>
/// Result type for the DeleteScenario operation.
/// </summary>
public readonly struct DeleteScenarioResult
{
    private DeleteScenarioResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="DeleteScenarioResult"/> with status 204.</returns>
    public static DeleteScenarioResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="DeleteScenarioResult"/> with status 404.</returns>
    public static DeleteScenarioResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
