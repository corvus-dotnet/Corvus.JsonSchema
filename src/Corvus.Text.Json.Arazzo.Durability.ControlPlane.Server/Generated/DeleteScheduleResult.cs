...
/// <summary>
/// Result type for the DeleteSchedule operation.
/// </summary>
public readonly struct DeleteScheduleResult
{
    private DeleteScheduleResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="DeleteScheduleResult"/> with status 204.</returns>
    public static DeleteScheduleResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="DeleteScheduleResult"/> with status 404.</returns>
    public static DeleteScheduleResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
