...
/// <summary>
/// Result type for the DeleteSecurityBinding operation.
/// </summary>
public readonly struct DeleteSecurityBindingResult
{
    private DeleteSecurityBindingResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="DeleteSecurityBindingResult"/> with status 204.</returns>
    public static DeleteSecurityBindingResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="DeleteSecurityBindingResult"/> with status 404.</returns>
    public static DeleteSecurityBindingResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
