...
/// <summary>
/// Result type for the DeleteWorkspaceWorkflow operation.
/// </summary>
public readonly struct DeleteWorkspaceWorkflowResult
{
    private DeleteWorkspaceWorkflowResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="DeleteWorkspaceWorkflowResult"/> with status 204.</returns>
    public static DeleteWorkspaceWorkflowResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="DeleteWorkspaceWorkflowResult"/> with status 404.</returns>
    public static DeleteWorkspaceWorkflowResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
