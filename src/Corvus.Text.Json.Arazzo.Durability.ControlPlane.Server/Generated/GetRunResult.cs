...
/// <summary>
/// Result type for the GetRun operation.
/// </summary>
public readonly struct GetRunResult
{
    private GetRunResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="GetRunResult"/> with status 200.</returns>
    public static GetRunResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunDetail.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunDetail.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="GetRunResult"/> with status 200.</returns>
    public static GetRunResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunDetail.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="GetRunResult"/> with status 404.</returns>
    public static GetRunResult NotFound(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(404, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="GetRunResult"/> with status 404.</returns>
    public static GetRunResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
