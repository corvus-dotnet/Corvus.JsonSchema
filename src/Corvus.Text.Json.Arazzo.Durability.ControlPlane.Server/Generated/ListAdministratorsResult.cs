...
/// <summary>
/// Result type for the ListAdministrators operation.
/// </summary>
public readonly struct ListAdministratorsResult
{
    private ListAdministratorsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListAdministratorsResult"/> with status 200.</returns>
    public static ListAdministratorsResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorList.Source<TContext> body, JsonWorkspace workspace)
