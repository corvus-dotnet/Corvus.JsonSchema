...
/// <summary>
/// Result type for the ListEnvironmentAdministrators operation.
/// </summary>
public readonly struct ListEnvironmentAdministratorsResult
{
    private ListEnvironmentAdministratorsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="ListEnvironmentAdministratorsResult"/> with status 200.</returns>
    public static ListEnvironmentAdministratorsResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorList.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorList.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListEnvironmentAdministratorsResult"/> with status 200.</returns>
    public static ListEnvironmentAdministratorsResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorList.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListEnvironmentAdministratorsResult"/> with status 404.</returns>
    public static ListEnvironmentAdministratorsResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
