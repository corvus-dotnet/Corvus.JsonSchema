...
/// <summary>
/// Result type for the ListEnvironmentAvailability operation.
/// </summary>
public readonly struct ListEnvironmentAvailabilityResult
{
    private ListEnvironmentAvailabilityResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListEnvironmentAvailabilityResult"/> with status 200.</returns>
    public static ListEnvironmentAvailabilityResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityList.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListEnvironmentAvailabilityResult"/> with status 404.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListEnvironmentAvailabilityResult"/> with status 404.</returns>
    public static ListEnvironmentAvailabilityResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
