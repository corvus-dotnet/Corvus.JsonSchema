...
/// <summary>
/// Result type for the ListRepoCommits operation.
/// </summary>
public readonly struct ListRepoCommitsResult
{
    private ListRepoCommitsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="ListRepoCommitsResult"/> with status 200.</returns>
    public static ListRepoCommitsResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubCommitList.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubCommitList.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListRepoCommitsResult"/> with status 200.</returns>
    public static ListRepoCommitsResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubCommitList.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubCommitList.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListRepoCommitsResult"/> with status 400.</returns>
    public static ListRepoCommitsResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListRepoCommitsResult"/> with status 404.</returns>
    public static ListRepoCommitsResult NotFound(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(404, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListRepoCommitsResult"/> with status 404.</returns>
    public static ListRepoCommitsResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListRepoCommitsResult"/> with status 409.</returns>
    public static ListRepoCommitsResult Conflict(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(409, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListRepoCommitsResult"/> with status 409.</returns>
    public static ListRepoCommitsResult Conflict<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubCommitList.From(this.Body).EvaluateSchema(),
