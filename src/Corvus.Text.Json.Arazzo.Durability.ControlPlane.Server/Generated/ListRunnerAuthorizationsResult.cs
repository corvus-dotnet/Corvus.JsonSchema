...
/// <summary>
/// Result type for the ListRunnerAuthorizations operation.
/// </summary>
public readonly struct ListRunnerAuthorizationsResult
{
    private ListRunnerAuthorizationsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListRunnerAuthorizationsResult"/> with status 200.</returns>
    public static ListRunnerAuthorizationsResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.EnvironmentRunnerAuthorizationList.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.EnvironmentRunnerAuthorizationList.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListRunnerAuthorizationsResult"/> with status 403.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListRunnerAuthorizationsResult"/> with status 403.</returns>
    public static ListRunnerAuthorizationsResult Forbidden<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.EnvironmentRunnerAuthorizationList.From(this.Body).EvaluateSchema(),
