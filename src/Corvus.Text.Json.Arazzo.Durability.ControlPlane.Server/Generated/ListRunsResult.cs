...
/// <summary>
/// Result type for the ListRuns operation.
/// </summary>
public readonly struct ListRunsResult
{
    private ListRunsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.From(this.Body).EvaluateSchema(),
