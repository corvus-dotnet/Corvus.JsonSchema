...
/// <summary>
/// Result type for the ListSecurityBindings operation.
/// </summary>
public readonly struct ListSecurityBindingsResult
{
    private ListSecurityBindingsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
