...
public readonly struct ListSecurityRulesResult
{
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListSecurityRulesResult"/> with status 200.</returns>
    public static ListSecurityRulesResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
