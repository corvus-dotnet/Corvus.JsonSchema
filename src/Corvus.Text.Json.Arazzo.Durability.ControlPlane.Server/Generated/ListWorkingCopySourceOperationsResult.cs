...
/// <summary>
/// Result type for the ListWorkingCopySourceOperations operation.
/// </summary>
public readonly struct ListWorkingCopySourceOperationsResult
{
    private ListWorkingCopySourceOperationsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="ListWorkingCopySourceOperationsResult"/> with status 200.</returns>
    public static ListWorkingCopySourceOperationsResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.OperationSurface.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.OperationSurface.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListWorkingCopySourceOperationsResult"/> with status 200.</returns>
    public static ListWorkingCopySourceOperationsResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.OperationSurface.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.OperationSurface.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListWorkingCopySourceOperationsResult"/> with status 404.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ListWorkingCopySourceOperationsResult"/> with status 404.</returns>
    public static ListWorkingCopySourceOperationsResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.OperationSurface.From(this.Body).EvaluateSchema(),
