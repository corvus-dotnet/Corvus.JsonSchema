...
/// <summary>
/// Result type for the MakeVersionAvailable operation.
/// </summary>
public readonly struct MakeVersionAvailableResult
{
    private MakeVersionAvailableResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="MakeVersionAvailableResult"/> with status 200.</returns>
    public static MakeVersionAvailableResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="MakeVersionAvailableResult"/> with status 200.</returns>
    public static MakeVersionAvailableResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="MakeVersionAvailableResult"/> with status 201.</returns>
    public static MakeVersionAvailableResult Created(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.Source body, JsonWorkspace workspace) => new(201, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="MakeVersionAvailableResult"/> with status 201.</returns>
    public static MakeVersionAvailableResult Created<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(201, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="MakeVersionAvailableResult"/> with status 403.</returns>
    public static MakeVersionAvailableResult Forbidden<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="MakeVersionAvailableResult"/> with status 404.</returns>
    public static MakeVersionAvailableResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="MakeVersionAvailableResult"/> with status 409.</returns>
    public static MakeVersionAvailableResult Conflict<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.From(this.Body).EvaluateSchema(),
            201 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.From(this.Body).EvaluateSchema(),
