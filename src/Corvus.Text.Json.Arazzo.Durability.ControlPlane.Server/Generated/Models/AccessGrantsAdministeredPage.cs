...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsAdministeredPage.AccessGrantsAdministeredWorkflowArray Administers
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdministersUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsAdministeredPage.AccessGrantsAdministeredWorkflowArray value))
            {
                return value;
            }
