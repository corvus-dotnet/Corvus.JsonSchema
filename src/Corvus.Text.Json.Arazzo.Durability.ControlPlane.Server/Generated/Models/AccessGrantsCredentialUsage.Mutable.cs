...
public readonly partial struct AccessGrantsCredentialUsage
{
...
#endif
    {
        ...
        /// </para>
        /// <para>
        /// The environment the binding is scoped to.
        /// </para>
        /// </remarks>
    ...
    public static ParsedJsonDocument<AccessGrantsCredentialUsage> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source environment, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source sourceName, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
