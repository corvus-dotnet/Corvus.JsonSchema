...
public readonly partial struct AccessGrantsCredentialsPage
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AccessGrantsCredentialsPage instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AccessGrantsCredentialsPage"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AccessGrantsCredentialsPage(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Mutable CredentialUsage
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CredentialUsageUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AccessGrantsCredentialsPage(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCredentialUsage(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCredentialUsage<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AccessGrantsCredentialsPage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AccessGrantsCredentialsPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AccessGrantsCredentialsPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AccessGrantsCredentialsPage Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AccessGrantsCredentialsPage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AccessGrantsCredentialsPage"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AccessGrantsCredentialsPage Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AccessGrantsCredentialsPage>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(AccessGrantsCredentialsPage instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AccessGrantsCredentialsPage"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source credentialUsage,
        ...
        /// Creates an instance of a <see cref="AccessGrantsCredentialsPage"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source credentialUsage, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
        {
            Create(ref _builder, credentialUsage, nextPageToken);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source<TContext> credentialUsage,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, credentialUsage, nextPageToken);
        }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source credentialUsage, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
    {
        return new Source(credentialUsage, nextPageToken);
    }
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source<TContext> credentialUsage, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
        ...
        #endif
    {
        return new Source<TContext>(context, credentialUsage, nextPageToken);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source credentialUsage, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(credentialUsage, nextPageToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, credentialUsage, nextPageToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<AccessGrantsCredentialsPage, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AccessGrantsCredentialsPage> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AccessGrantsCredentialsPage>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccessGrantsCredentialsPage> Create<TContext>(
    ...
    public static ParsedJsonDocument<AccessGrantsCredentialsPage> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source credentialUsage, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccessGrantsCredentialsPage> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray.Source<TContext> credentialUsage, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
