...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AccessGrantsCredentialsPage"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AccessGrantsCredentialsPage(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AccessGrantsCredentialsPage DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray CredentialUsage
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CredentialUsageUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessGrantsCredentialsPage.AccessGrantsCredentialUsageArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in AccessGrantsCredentialsPage left, in AccessGrantsCredentialsPage right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AccessGrantsCredentialsPage left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AccessGrantsCredentialsPage instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AccessGrantsCredentialsPage(JsonElement instance)
    {
        return AccessGrantsCredentialsPage.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessGrantsCredentialsPage From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessGrantsCredentialsPage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessGrantsCredentialsPage>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessGrantsCredentialsPage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessGrantsCredentialsPage>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessGrantsCredentialsPage ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessGrantsCredentialsPage>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AccessGrantsCredentialsPage ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessGrantsCredentialsPage>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AccessGrantsCredentialsPage? result)
    {
        return JsonElementHelpers.TryParseValue<AccessGrantsCredentialsPage>(ref reader, out result);
    }
...
#if NET
    static AccessGrantsCredentialsPage IJsonElement<AccessGrantsCredentialsPage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AccessGrantsCredentialsPage: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public AccessGrantsCredentialsPage Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public AccessGrantsCredentialsPage Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AccessGrantsCredentialsPage>(_idx);
        }
