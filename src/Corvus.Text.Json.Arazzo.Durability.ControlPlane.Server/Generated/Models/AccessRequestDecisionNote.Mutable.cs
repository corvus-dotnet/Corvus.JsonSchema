...
/// <remarks>
/// <para>
/// An optional note recorded with an approve/deny/withdraw/revoke decision (design &#167;16.5).
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct AccessRequestDecisionNote
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AccessRequestDecisionNote instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AccessRequestDecisionNote"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AccessRequestDecisionNote(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AccessRequestDecisionNote(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AccessRequestDecisionNote.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AccessRequestDecisionNote"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AccessRequestDecisionNote"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AccessRequestDecisionNote Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AccessRequestDecisionNote>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AccessRequestDecisionNote"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AccessRequestDecisionNote Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AccessRequestDecisionNote>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestDecisionNote.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(AccessRequestDecisionNote instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestDecisionNote.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AccessRequestDecisionNote"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<AccessRequestDecisionNote, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AccessRequestDecisionNote> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AccessRequestDecisionNote>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccessRequestDecisionNote> Create<TContext>(
    ...
    public static ParsedJsonDocument<AccessRequestDecisionNote> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
