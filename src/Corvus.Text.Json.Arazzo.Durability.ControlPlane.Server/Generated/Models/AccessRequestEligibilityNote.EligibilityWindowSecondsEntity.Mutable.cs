...
public readonly partial struct AccessRequestEligibilityNote
{
    ...
    public readonly partial struct EligibilityWindowSecondsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EligibilityWindowSecondsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EligibilityWindowSecondsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EligibilityWindowSecondsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EligibilityWindowSecondsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EligibilityWindowSecondsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EligibilityWindowSecondsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EligibilityWindowSecondsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EligibilityWindowSecondsEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EligibilityWindowSecondsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EligibilityWindowSecondsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EligibilityWindowSecondsEntity>();
            }
            finally
            {
