    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchEligibilityWindowSeconds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.EligibilityWindowSecondsUtf8,
                    evaluationPath: EligibilityWindowSecondsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/AccessRequestEligibilityNote"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/AccessRequestEligibilityNote";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/AccessRequestEligibilityNote"u8;
