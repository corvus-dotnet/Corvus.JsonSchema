...
/// <remarks>
/// <para>
/// Options for approving a request as durable eligibility (design &#167;16.5.3).
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct AccessRequestEligibilityNote
#if NET8_0_OR_GREATER
    : IJsonElement<AccessRequestEligibilityNote>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AccessRequestEligibilityNote"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AccessRequestEligibilityNote(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AccessRequestEligibilityNote DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the (optional) <c>eligibilityWindowSeconds</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// How long the eligibility itself lasts, in seconds; absent means standing eligibility. Each activation is independently capped at the deployment maximum TTL.
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity EligibilityWindowSeconds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EligibilityWindowSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestEligibilityNote.EligibilityWindowSecondsEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in AccessRequestEligibilityNote left, in AccessRequestEligibilityNote right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AccessRequestEligibilityNote left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AccessRequestEligibilityNote instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AccessRequestEligibilityNote(JsonElement instance)
    {
        return AccessRequestEligibilityNote.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessRequestEligibilityNote From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessRequestEligibilityNote ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessRequestEligibilityNote>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessRequestEligibilityNote ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessRequestEligibilityNote>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessRequestEligibilityNote ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessRequestEligibilityNote>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AccessRequestEligibilityNote ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessRequestEligibilityNote>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AccessRequestEligibilityNote? result)
    {
        return JsonElementHelpers.TryParseValue<AccessRequestEligibilityNote>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new AccessRequestEligibilityNote(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static AccessRequestEligibilityNote IJsonElement<AccessRequestEligibilityNote>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AccessRequestEligibilityNote: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="AccessRequestEligibilityNote"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="AccessRequestEligibilityNote"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public AccessRequestEligibilityNote Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<AccessRequestEligibilityNote>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="AccessRequestEligibilityNote"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public AccessRequestEligibilityNote Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AccessRequestEligibilityNote>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="EligibilityWindowSeconds"/>.
        /// </summary>
        public const string EligibilityWindowSeconds = "eligibilityWindowSeconds";
        ...
        /// Gets the JSON property name for <see cref="EligibilityWindowSeconds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> EligibilityWindowSecondsUtf8 => "eligibilityWindowSeconds"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="EligibilityWindowSeconds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> EligibilityWindowSeconds => "eligibilityWindowSeconds"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="EligibilityWindowSeconds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> EligibilityWindowSeconds => [0xA5, 0x01, 0x00, 0x00, 0x22, 0x65, 0x6C, 0x69, 0x67, 0x69, 0x62, 0x69, 0x6C, 0x69, 0x74, 0x79, 0x57, 0x69, 0x6E, 0x64, 0x6F, 0x77, 0x53, 0x65, 0x63, 0x6F, 0x6E, 0x64, 0x73, 0x22];
