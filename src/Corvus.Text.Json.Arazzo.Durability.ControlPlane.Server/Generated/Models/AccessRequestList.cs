...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestList.AccessRequestViewArray AccessRequests
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccessRequestsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestList.AccessRequestViewArray value))
            {
                return value;
            }
