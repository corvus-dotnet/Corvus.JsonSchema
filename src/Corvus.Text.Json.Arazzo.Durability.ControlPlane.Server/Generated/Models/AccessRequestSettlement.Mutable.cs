...
public readonly partial struct AccessRequestSettlement
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.OutcomeEntity.Mutable Outcome
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutcomeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.OutcomeEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetOutcome(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.OutcomeEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.OutcomeEntity.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.OutcomeEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.OutcomeEntity.Source outcome,
        ...
        /// Creates an instance of a <see cref="AccessRequestSettlement"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.OutcomeEntity.Source outcome, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.OutcomeEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSettlement.OutcomeEntity.Source outcome, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default)
    {
