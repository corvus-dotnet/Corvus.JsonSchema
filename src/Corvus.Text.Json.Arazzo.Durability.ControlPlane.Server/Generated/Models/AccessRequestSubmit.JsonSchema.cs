    ...
    : IJsonElement<AccessRequestSubmit>
{
    public static partial class JsonSchema
    {
        ...
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRequestedScopesPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("requestedScopes"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRequestedScopesNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("requestedScopes"u8, buffer, out written);

        private const int RequiredOffsetForRequestedScopes = 0;
        private const uint RequiredBitForRequestedScopes = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForBaseWorkflowId | RequiredBitForRequestedScopes;
        ...
        private static readonly JsonSchemaPathProvider RequestedDurationSecondsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/requestedDurationSeconds"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider RequestedScopesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/requestedScopes"u8, buffer, out written);
        ...
        private static void MatchRequestedDurationSeconds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.RequestedDurationSecondsUtf8,
                    evaluationPath: RequestedDurationSecondsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            context.CommitChildContext(childContext2.IsMatch, ref childContext2);
        }

        private static void MatchRequestedScopes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext3 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSubmit.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.RequestedScopesUtf8,
                    evaluationPath: RequestedScopesSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSubmit.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            requiredBitBuffer[RequiredOffsetForRequestedScopes] |= RequiredBitForRequestedScopes;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                ...
                (static () => JsonPropertyNames.RequestedDurationSecondsUtf8, MatchRequestedDurationSeconds),
                (static () => JsonPropertyNames.RequestedScopesUtf8, MatchRequestedScopes),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/AccessRequestSubmit"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/AccessRequestSubmit";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/AccessRequestSubmit"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    ...
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRequestedScopesPresent, "requestedScopes"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForRequestedScopes] & RequiredBitForRequestedScopes) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyRequestedScopesNotPresent, "requestedScopes"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRequestedScopesPresent, "requestedScopes"u8, "required"u8);
