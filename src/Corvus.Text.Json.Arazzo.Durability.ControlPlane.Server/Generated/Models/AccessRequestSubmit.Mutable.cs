...
public readonly partial struct AccessRequestSubmit
{
...
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRequestedDurationSeconds(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSubmit.RequestedDurationSecondsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRequestedScopes(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AccessRequestSubmit.JsonStringArray.Source value)
        {
            CheckValidInstance();
