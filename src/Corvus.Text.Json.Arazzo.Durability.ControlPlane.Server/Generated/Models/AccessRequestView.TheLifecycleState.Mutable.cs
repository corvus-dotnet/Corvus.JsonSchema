...
public readonly partial struct AccessRequestView
{
    ...
    public readonly partial struct TheLifecycleState
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheLifecycleState instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheLifecycleState"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheLifecycleState(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheLifecycleState.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheLifecycleState Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheLifecycleState Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheLifecycleState>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheLifecycleState instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheLifecycleState, Mutable>(this);
        }
    }
}
