...
public readonly partial struct AdministratorGrant
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AdministratorGrant instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AdministratorGrant"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AdministratorGrant(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// A stable opaque digest of this administrator&#39;s identity — the key for DELETE /administrators/{baseWorkflowId}/members/{digest}.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Mutable Identity
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdentityUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AdministratorGrant(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetIdentity(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetIdentity<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AdministratorGrant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AdministratorGrant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AdministratorGrant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AdministratorGrant Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AdministratorGrant>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AdministratorGrant"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AdministratorGrant Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AdministratorGrant>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source _createArg3;
        ...
        public static implicit operator Source(AdministratorGrant instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source<TContext> _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg4;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source<TContext> arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source arg3, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg4)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AdministratorGrant"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source digest,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source identity,
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default)
        {
            Create(ref _builder, digest, identity, kind, label);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source digest,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source<TContext> identity,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        ...
        #endif
        {
            Create(context, ref _builder, digest, identity, kind, label);
        }
    ...
    /// <param name="label">The value of the <c>"label"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source digest, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source<TContext> identity, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, digest, identity, kind, label);
    }
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source digest, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source<TContext> identity, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, digest, identity, kind, label);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<AdministratorGrant, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AdministratorGrant> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AdministratorGrant>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AdministratorGrant> Create<TContext>(
    ...
    public static ParsedJsonDocument<AdministratorGrant> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source digest, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source identity, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AdministratorGrant> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source digest, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorGrant.AdministratorIdentityArray.Source<TContext> identity, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
