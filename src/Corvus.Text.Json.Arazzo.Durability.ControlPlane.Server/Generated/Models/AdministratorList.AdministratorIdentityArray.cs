...
public readonly partial struct AdministratorList
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdministratorIdentityArray"/> struct.
        /// </summary>
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorIdentity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorIdentity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorIdentity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorIdentity>(_parent, _idx);
        }
