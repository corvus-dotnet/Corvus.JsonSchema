...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AdministratorSetWrite"/> struct.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorSetWrite.AdministratorIdentityArray Administrators
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdministratorsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AdministratorSetWrite.AdministratorIdentityArray value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets a <see cref="AdministratorSetWrite"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="AdministratorSetWrite"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="AdministratorSetWrite"/> that lives for the lifetime of its
