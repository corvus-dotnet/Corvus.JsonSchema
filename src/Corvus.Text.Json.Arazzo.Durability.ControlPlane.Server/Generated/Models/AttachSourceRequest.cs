...
/// <remarks>
/// <para>
/// Attach (or replace) the source for a sourceDescriptions name: EXACTLY ONE of sourceName (a registry reference) or document (an inline upload/fetch result) — both or neither is rejected (400).
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct AttachSourceRequest
#if NET8_0_OR_GREATER
    : IJsonElement<AttachSourceRequest>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AttachSourceRequest"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AttachSourceRequest(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AttachSourceRequest DefaultInstance { get; }
    ...
    /// <remarks>
    /// <para>
    /// Attach this document inline (stored on the working copy verbatim).
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AttachSourceRequest.DocumentEntity Document
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AttachSourceRequest.DocumentEntity value))
            {
                return value;
            }
    ...
    /// <remarks>
    /// <para>
    /// Attach the registered source with this name (resolved at read time, reach-checked).
    /// </para>
    /// </remarks>
    ...
    /// </returns>
    public static bool operator ==(in AttachSourceRequest left, in AttachSourceRequest right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AttachSourceRequest left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AttachSourceRequest instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AttachSourceRequest(JsonElement instance)
    {
        return AttachSourceRequest.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AttachSourceRequest From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AttachSourceRequest ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AttachSourceRequest>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AttachSourceRequest ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AttachSourceRequest>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AttachSourceRequest ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AttachSourceRequest>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AttachSourceRequest ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AttachSourceRequest>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AttachSourceRequest? result)
    {
        return JsonElementHelpers.TryParseValue<AttachSourceRequest>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new AttachSourceRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static AttachSourceRequest IJsonElement<AttachSourceRequest>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AttachSourceRequest: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="AttachSourceRequest"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="AttachSourceRequest"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public AttachSourceRequest Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<AttachSourceRequest>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="AttachSourceRequest"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public AttachSourceRequest Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AttachSourceRequest>(_idx);
        }
