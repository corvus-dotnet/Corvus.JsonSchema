...
public readonly partial struct AttachedSourceList
    ...
    : IJsonElement<AttachedSourceList>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AttachedSourceList"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AttachedSourceList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AttachedSourceList DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AttachedSourceList.AttachedSourceArray Sources
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SourcesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AttachedSourceList.AttachedSourceArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in AttachedSourceList left, in AttachedSourceList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AttachedSourceList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AttachedSourceList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AttachedSourceList(JsonElement instance)
    {
        return AttachedSourceList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AttachedSourceList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AttachedSourceList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AttachedSourceList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AttachedSourceList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AttachedSourceList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AttachedSourceList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AttachedSourceList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AttachedSourceList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AttachedSourceList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AttachedSourceList? result)
    {
        return JsonElementHelpers.TryParseValue<AttachedSourceList>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new AttachedSourceList(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static AttachedSourceList IJsonElement<AttachedSourceList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AttachedSourceList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="AttachedSourceList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="AttachedSourceList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public AttachedSourceList Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<AttachedSourceList>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="AttachedSourceList"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public AttachedSourceList Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AttachedSourceList>(_idx);
        }
