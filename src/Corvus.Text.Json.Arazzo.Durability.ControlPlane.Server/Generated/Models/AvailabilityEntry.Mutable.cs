...
public readonly partial struct AvailabilityEntry
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AvailabilityEntry instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AvailabilityEntry"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AvailabilityEntry(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// The base workflow id the version belongs to.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// When the version was made available.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// The actor that made the version available.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// The 1-based version number made available.
        /// </para>
        /// </remarks>
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AvailabilityEntry(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AvailabilityEntry.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AvailabilityEntry"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AvailabilityEntry"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AvailabilityEntry Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AvailabilityEntry>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AvailabilityEntry"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AvailabilityEntry Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AvailabilityEntry>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.EnvironmentName.Source _createArg4;
        ...
        public static implicit operator Source(AvailabilityEntry instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityEntry.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AvailabilityEntry"/>.
        /// </summary>
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInt32.Source versionNumber)
        {
            Create(ref _builder, baseWorkflowId, createdAt, createdBy, environment, etag, versionNumber);
        }
    ...
    {
        return new Source(baseWorkflowId, createdAt, createdBy, environment, etag, versionNumber);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source baseWorkflowId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonDateTime.Source createdAt, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source createdBy, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source etag, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInt32.Source versionNumber, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(baseWorkflowId, createdAt, createdBy, environment, etag, versionNumber);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<AvailabilityEntry, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AvailabilityEntry> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AvailabilityEntry>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AvailabilityEntry> Create<TContext>(
