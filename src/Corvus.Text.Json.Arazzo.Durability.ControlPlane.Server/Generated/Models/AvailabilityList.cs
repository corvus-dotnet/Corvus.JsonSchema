...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityList.AvailabilityEntryArray Availability
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AvailabilityUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityList.AvailabilityEntryArray value))
            {
                return value;
            }
