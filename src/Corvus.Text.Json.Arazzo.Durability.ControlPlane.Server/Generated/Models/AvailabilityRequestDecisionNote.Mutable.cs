...
/// <remarks>
/// <para>
/// An optional note recorded with an approve/deny/withdraw decision (design &#167;7.8).
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct AvailabilityRequestDecisionNote
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AvailabilityRequestDecisionNote instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AvailabilityRequestDecisionNote"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AvailabilityRequestDecisionNote(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AvailabilityRequestDecisionNote(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AvailabilityRequestDecisionNote.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AvailabilityRequestDecisionNote"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AvailabilityRequestDecisionNote"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AvailabilityRequestDecisionNote Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AvailabilityRequestDecisionNote>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AvailabilityRequestDecisionNote"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AvailabilityRequestDecisionNote Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AvailabilityRequestDecisionNote>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestDecisionNote.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(AvailabilityRequestDecisionNote instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestDecisionNote.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AvailabilityRequestDecisionNote"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default)
        {
        ...
        /// Creates an instance of a <see cref="AvailabilityRequestDecisionNote"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<AvailabilityRequestDecisionNote, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AvailabilityRequestDecisionNote> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AvailabilityRequestDecisionNote>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AvailabilityRequestDecisionNote> Create<TContext>(
    ...
    public static ParsedJsonDocument<AvailabilityRequestDecisionNote> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
