...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AvailabilityRequestDecisionNote"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AvailabilityRequestDecisionNote(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AvailabilityRequestDecisionNote DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in AvailabilityRequestDecisionNote left, in AvailabilityRequestDecisionNote right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AvailabilityRequestDecisionNote left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AvailabilityRequestDecisionNote instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AvailabilityRequestDecisionNote(JsonElement instance)
    {
        return AvailabilityRequestDecisionNote.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestDecisionNote From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestDecisionNote ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestDecisionNote>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestDecisionNote ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestDecisionNote>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AvailabilityRequestDecisionNote ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestDecisionNote>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AvailabilityRequestDecisionNote ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AvailabilityRequestDecisionNote>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AvailabilityRequestDecisionNote? result)
    {
        return JsonElementHelpers.TryParseValue<AvailabilityRequestDecisionNote>(ref reader, out result);
    }
...
#if NET
    static AvailabilityRequestDecisionNote IJsonElement<AvailabilityRequestDecisionNote>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AvailabilityRequestDecisionNote: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public AvailabilityRequestDecisionNote Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public AvailabilityRequestDecisionNote Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AvailabilityRequestDecisionNote>(_idx);
        }
