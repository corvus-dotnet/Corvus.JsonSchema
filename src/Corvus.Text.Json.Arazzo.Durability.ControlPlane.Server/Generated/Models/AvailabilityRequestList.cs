...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestList.AvailabilityRequestViewArray AvailabilityRequests
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AvailabilityRequestsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestList.AvailabilityRequestViewArray value))
            {
                return value;
            }
