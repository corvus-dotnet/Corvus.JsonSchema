...
public readonly partial struct AvailabilityRequestSubmit
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AvailabilityRequestSubmit instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AvailabilityRequestSubmit"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AvailabilityRequestSubmit(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// The base workflow id whose version to make available.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// The target environment to make the version available in.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// The version number to make available.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestSubmit.TheVersionNumberToMakeAvailable.Mutable VersionNumber
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionNumberUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestSubmit.TheVersionNumberToMakeAvailable.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AvailabilityRequestSubmit(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AvailabilityRequestSubmit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AvailabilityRequestSubmit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AvailabilityRequestSubmit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AvailabilityRequestSubmit Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AvailabilityRequestSubmit>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AvailabilityRequestSubmit"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AvailabilityRequestSubmit Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AvailabilityRequestSubmit>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestSubmit.TheVersionNumberToMakeAvailable.Source _createArg3;
        ...
        public static implicit operator Source(AvailabilityRequestSubmit instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestSubmit.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AvailabilityRequestSubmit"/>.
        /// </summary>
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestSubmit.TheVersionNumberToMakeAvailable.Source versionNumber,
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default)
        {
            Create(ref _builder, baseWorkflowId, environment, versionNumber, reason);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source baseWorkflowId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source environment, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestSubmit.TheVersionNumberToMakeAvailable.Source versionNumber, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(baseWorkflowId, environment, versionNumber, reason);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<AvailabilityRequestSubmit, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AvailabilityRequestSubmit> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AvailabilityRequestSubmit>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AvailabilityRequestSubmit> Create<TContext>(
    ...
    public static ParsedJsonDocument<AvailabilityRequestSubmit> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source baseWorkflowId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source environment, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.AvailabilityRequestSubmit.TheVersionNumberToMakeAvailable.Source versionNumber, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
