...
public readonly partial struct BroadeningAdvisory
    : IJsonElement<BroadeningAdvisory>
{
    public static partial class JsonSchema
    {
        ...
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySubsumesGranteesPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("subsumesGrantees"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySubsumesGranteesNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("subsumesGrantees"u8, buffer, out written);

        private const int RequiredOffsetForSubsumesGrantees = 0;
        private const uint RequiredBitForSubsumesGrantees = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForMessage | RequiredBitForSubsumesGrantees;
        ...
        private static readonly JsonSchemaPathProvider SubsumesGranteesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/subsumesGrantees"u8, buffer, out written);
        ...
        private static void MatchSubsumesGrantees(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.BroadeningAdvisory.BroadeningOverlapGranteeArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.SubsumesGranteesUtf8,
                    evaluationPath: SubsumesGranteesSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.BroadeningAdvisory.BroadeningOverlapGranteeArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForSubsumesGrantees] |= RequiredBitForSubsumesGrantees;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.SubsumesGranteesUtf8, MatchSubsumesGrantees),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/BroadeningAdvisory"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/BroadeningAdvisory";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/BroadeningAdvisory"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    ...
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertySubsumesGranteesPresent, "subsumesGrantees"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSubsumesGrantees] & RequiredBitForSubsumesGrantees) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertySubsumesGranteesNotPresent, "subsumesGrantees"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertySubsumesGranteesPresent, "subsumesGrantees"u8, "required"u8);
