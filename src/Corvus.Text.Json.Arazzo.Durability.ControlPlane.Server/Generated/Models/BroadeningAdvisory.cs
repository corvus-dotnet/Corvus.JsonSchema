...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BroadeningAdvisory"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal BroadeningAdvisory(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static BroadeningAdvisory DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.BroadeningAdvisory.BroadeningOverlapGranteeArray SubsumesGrantees
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubsumesGranteesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.BroadeningAdvisory.BroadeningOverlapGranteeArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in BroadeningAdvisory left, in BroadeningAdvisory right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in BroadeningAdvisory left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(BroadeningAdvisory instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator BroadeningAdvisory(JsonElement instance)
    {
        return BroadeningAdvisory.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BroadeningAdvisory From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BroadeningAdvisory ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BroadeningAdvisory>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BroadeningAdvisory ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BroadeningAdvisory>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BroadeningAdvisory ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BroadeningAdvisory>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static BroadeningAdvisory ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<BroadeningAdvisory>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out BroadeningAdvisory? result)
    {
        return JsonElementHelpers.TryParseValue<BroadeningAdvisory>(ref reader, out result);
    }
...
#if NET
    static BroadeningAdvisory IJsonElement<BroadeningAdvisory>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"BroadeningAdvisory: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public BroadeningAdvisory Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public BroadeningAdvisory Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<BroadeningAdvisory>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="SubsumesGrantees"/>.
        /// </summary>
        public const string SubsumesGrantees = "subsumesGrantees";
        ...
        /// Gets the JSON property name for <see cref="SubsumesGrantees"/>.
        /// </summary>
        public static ReadOnlySpan<byte> SubsumesGranteesUtf8 => "subsumesGrantees"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="SubsumesGrantees"/>.
        /// </summary>
        public static ReadOnlySpan<byte> SubsumesGrantees => "subsumesGrantees"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="SubsumesGrantees"/>.
        /// </summary>
        public static ReadOnlySpan<byte> SubsumesGrantees => [0x25, 0x01, 0x00, 0x00, 0x22, 0x73, 0x75, 0x62, 0x73, 0x75, 0x6D, 0x65, 0x73, 0x47, 0x72, 0x61, 0x6E, 0x74, 0x65, 0x65, 0x73, 0x22];
    }
}
