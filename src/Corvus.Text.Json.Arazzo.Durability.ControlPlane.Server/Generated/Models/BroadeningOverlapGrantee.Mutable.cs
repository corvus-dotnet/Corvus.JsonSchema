...
public readonly partial struct BroadeningOverlapGrantee
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BroadeningOverlapGrantee instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BroadeningOverlapGrantee"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BroadeningOverlapGrantee(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BroadeningOverlapGrantee.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly BroadeningOverlapGrantee Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly BroadeningOverlapGrantee Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BroadeningOverlapGrantee>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.BroadeningOverlapGrantee.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(BroadeningOverlapGrantee instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.BroadeningOverlapGrantee.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="BroadeningOverlapGrantee"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind,
    ...
    {
        return workspace.CreateBuilder<BroadeningOverlapGrantee, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<BroadeningOverlapGrantee> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<BroadeningOverlapGrantee>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<BroadeningOverlapGrantee> Create<TContext>(
    ...
    public static ParsedJsonDocument<BroadeningOverlapGrantee> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
