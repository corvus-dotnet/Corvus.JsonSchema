...
public readonly partial struct BudgetMaxResponseBytes
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BudgetMaxResponseBytes instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BudgetMaxResponseBytes"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BudgetMaxResponseBytes(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BudgetMaxResponseBytes(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BudgetMaxResponseBytes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly BudgetMaxResponseBytes Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BudgetMaxResponseBytes>(_idx);
        }

        /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
        public readonly BudgetMaxResponseBytes Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BudgetMaxResponseBytes>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(BudgetMaxResponseBytes instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<BudgetMaxResponseBytes, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<BudgetMaxResponseBytes> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<BudgetMaxResponseBytes>();
        }
        finally
        {
