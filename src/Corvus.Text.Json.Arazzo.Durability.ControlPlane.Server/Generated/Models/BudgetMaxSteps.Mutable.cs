...
public readonly partial struct BudgetMaxSteps
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BudgetMaxSteps instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BudgetMaxSteps"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BudgetMaxSteps(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BudgetMaxSteps.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly BudgetMaxSteps Clone()
        {
            CheckValidInstance();
        ...
        public readonly BudgetMaxSteps Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BudgetMaxSteps>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(BudgetMaxSteps instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<BudgetMaxSteps, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<BudgetMaxSteps> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<BudgetMaxSteps>();
        }
        finally
        {
