...
public readonly partial struct BudgetMaxSubWorkflowDepth
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BudgetMaxSubWorkflowDepth instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BudgetMaxSubWorkflowDepth"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BudgetMaxSubWorkflowDepth(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BudgetMaxSubWorkflowDepth.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly BudgetMaxSubWorkflowDepth Clone()
        {
            CheckValidInstance();
        ...
        public readonly BudgetMaxSubWorkflowDepth Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BudgetMaxSubWorkflowDepth>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(BudgetMaxSubWorkflowDepth instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<BudgetMaxSubWorkflowDepth, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<BudgetMaxSubWorkflowDepth> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<BudgetMaxSubWorkflowDepth>();
        }
        finally
        {
