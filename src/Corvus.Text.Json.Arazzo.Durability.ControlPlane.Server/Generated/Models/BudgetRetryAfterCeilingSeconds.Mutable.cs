...
public readonly partial struct BudgetRetryAfterCeilingSeconds
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BudgetRetryAfterCeilingSeconds instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BudgetRetryAfterCeilingSeconds"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BudgetRetryAfterCeilingSeconds(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BudgetRetryAfterCeilingSeconds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly BudgetRetryAfterCeilingSeconds Clone()
        {
            CheckValidInstance();
        ...
        public readonly BudgetRetryAfterCeilingSeconds Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BudgetRetryAfterCeilingSeconds>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(BudgetRetryAfterCeilingSeconds instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<BudgetRetryAfterCeilingSeconds, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<BudgetRetryAfterCeilingSeconds> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<BudgetRetryAfterCeilingSeconds>();
        }
        finally
        {
