...
public readonly partial struct BudgetStepTimeoutSeconds
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BudgetStepTimeoutSeconds instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BudgetStepTimeoutSeconds"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BudgetStepTimeoutSeconds(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BudgetStepTimeoutSeconds(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BudgetStepTimeoutSeconds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly BudgetStepTimeoutSeconds Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BudgetStepTimeoutSeconds>(_idx);
        }

        /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
        public readonly BudgetStepTimeoutSeconds Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BudgetStepTimeoutSeconds>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(BudgetStepTimeoutSeconds instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<BudgetStepTimeoutSeconds, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<BudgetStepTimeoutSeconds> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<BudgetStepTimeoutSeconds>();
        }
        finally
        {
