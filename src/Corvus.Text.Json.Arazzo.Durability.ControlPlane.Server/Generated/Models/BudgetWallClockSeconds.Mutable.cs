...
public readonly partial struct BudgetWallClockSeconds
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BudgetWallClockSeconds instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BudgetWallClockSeconds"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BudgetWallClockSeconds(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BudgetWallClockSeconds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly BudgetWallClockSeconds Clone()
        {
            CheckValidInstance();
        ...
        public readonly BudgetWallClockSeconds Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BudgetWallClockSeconds>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(BudgetWallClockSeconds instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<BudgetWallClockSeconds, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<BudgetWallClockSeconds> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<BudgetWallClockSeconds>();
        }
        finally
        {
