...
public readonly partial struct CatalogStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(CatalogStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="CatalogStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CatalogStatus(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CatalogStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly CatalogStatus Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly CatalogStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<CatalogStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(CatalogStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<CatalogStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<CatalogStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<CatalogStatus>();
        }
        finally
        {
