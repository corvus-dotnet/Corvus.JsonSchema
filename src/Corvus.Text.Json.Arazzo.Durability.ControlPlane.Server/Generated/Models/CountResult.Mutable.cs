...
public readonly partial struct CountResult
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Mutable Capped
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CappedUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.TheNumberOfMatchingItemsBoundedByTheServerSCap.Mutable Count
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.TheNumberOfMatchingItemsBoundedByTheServerSCap.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCapped(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCount(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.TheNumberOfMatchingItemsBoundedByTheServerSCap.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.TheNumberOfMatchingItemsBoundedByTheServerSCap.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.TheNumberOfMatchingItemsBoundedByTheServerSCap.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source capped,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.TheNumberOfMatchingItemsBoundedByTheServerSCap.Source count)
        {
        ...
        /// Creates an instance of a <see cref="CountResult"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source capped, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.TheNumberOfMatchingItemsBoundedByTheServerSCap.Source count)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source capped, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CountResult.TheNumberOfMatchingItemsBoundedByTheServerSCap.Source count)
    {
