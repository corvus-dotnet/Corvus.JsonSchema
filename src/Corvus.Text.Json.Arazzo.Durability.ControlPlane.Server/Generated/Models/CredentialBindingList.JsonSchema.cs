...
public readonly partial struct CredentialBindingList
    : IJsonElement<CredentialBindingList>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCredentialsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("credentials"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCredentialsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("credentials"u8, buffer, out written);

        private const int RequiredOffsetForCredentials = 0;
        private const uint RequiredBitForCredentials = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForCredentials;
        private static readonly JsonSchemaPathProvider CredentialsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/credentials"u8, buffer, out written);

        private static void MatchCredentials(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CredentialBindingList.CredentialBindingSummaryArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.CredentialsUtf8,
                    evaluationPath: CredentialsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CredentialBindingList.CredentialBindingSummaryArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForCredentials] |= RequiredBitForCredentials;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.CredentialsUtf8))
            {
                matcher = MatchCredentials;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/CredentialBindingList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/CredentialBindingList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/CredentialBindingList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCredentialsPresent, "credentials"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCredentials] & RequiredBitForCredentials) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyCredentialsNotPresent, "credentials"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCredentialsPresent, "credentials"u8, "required"u8);
