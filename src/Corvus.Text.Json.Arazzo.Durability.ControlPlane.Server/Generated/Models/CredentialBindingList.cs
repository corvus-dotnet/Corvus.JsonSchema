...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CredentialBindingList"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal CredentialBindingList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static CredentialBindingList DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the <c>credentials</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CredentialBindingList.CredentialBindingSummaryArray Credentials
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CredentialsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CredentialBindingList.CredentialBindingSummaryArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in CredentialBindingList left, in CredentialBindingList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in CredentialBindingList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(CredentialBindingList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator CredentialBindingList(JsonElement instance)
    {
        return CredentialBindingList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CredentialBindingList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CredentialBindingList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<CredentialBindingList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CredentialBindingList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<CredentialBindingList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CredentialBindingList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<CredentialBindingList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static CredentialBindingList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<CredentialBindingList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out CredentialBindingList? result)
    {
        return JsonElementHelpers.TryParseValue<CredentialBindingList>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new CredentialBindingList(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static CredentialBindingList IJsonElement<CredentialBindingList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"CredentialBindingList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="CredentialBindingList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="CredentialBindingList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public CredentialBindingList Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<CredentialBindingList>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="CredentialBindingList"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public CredentialBindingList Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<CredentialBindingList>(_idx);
        }
