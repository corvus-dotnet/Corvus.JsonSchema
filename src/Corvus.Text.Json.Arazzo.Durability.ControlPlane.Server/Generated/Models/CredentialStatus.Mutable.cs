...
public readonly partial struct CredentialStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(CredentialStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="CredentialStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CredentialStatus(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CredentialStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly CredentialStatus Clone()
        {
            CheckValidInstance();
        ...
        public readonly CredentialStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<CredentialStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(CredentialStatus instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (CredentialStatus)value;
    ...
    {
        return workspace.CreateBuilder<CredentialStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<CredentialStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<CredentialStatus>();
        }
        finally
        {
