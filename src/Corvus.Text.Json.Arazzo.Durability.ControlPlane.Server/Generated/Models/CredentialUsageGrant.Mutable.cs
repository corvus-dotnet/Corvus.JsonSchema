...
public readonly partial struct CredentialUsageGrant
{
...
#endif
    {
        ...
        public static explicit operator Mutable(CredentialUsageGrant instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="CredentialUsageGrant"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CredentialUsageGrant(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CredentialUsageGrant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly CredentialUsageGrant Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly CredentialUsageGrant Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<CredentialUsageGrant>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CredentialUsageGrant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(CredentialUsageGrant instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.CredentialUsageGrant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="CredentialUsageGrant"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<CredentialUsageGrant, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<CredentialUsageGrant> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<CredentialUsageGrant>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<CredentialUsageGrant> Create<TContext>(
    ...
    public static ParsedJsonDocument<CredentialUsageGrant> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source dimension, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
