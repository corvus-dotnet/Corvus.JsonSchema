...
public readonly partial struct DebugRunPause
{
...
#endif
    {
        ...
        public static explicit operator Mutable(DebugRunPause instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="DebugRunPause"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DebugRunPause(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>afterEachStep</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Pause after every executed step — the dock&#39;s single-step.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Mutable AfterEachStep
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AfterEachStepUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>beforeSteps</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Mutable BeforeSteps
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BeforeStepsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DebugRunPause(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>afterEachStep</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAfterEachStep(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AfterEachStepUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AfterEachStepUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AfterEachStep, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>afterEachStep</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveAfterEachStep()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AfterEachStepUtf8);
            _documentVersion = _parent.Version;
            return result;
        }

        /// <summary>
        /// Set the <c>beforeSteps</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetBeforeSteps(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BeforeStepsUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BeforeStepsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BeforeSteps, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetBeforeSteps<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source<TContext> value)
        ...
        /// <summary>
        /// Remove the <c>beforeSteps</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveBeforeSteps()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BeforeStepsUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DebugRunPause.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DebugRunPause"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DebugRunPause"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly DebugRunPause Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DebugRunPause>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DebugRunPause"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly DebugRunPause Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<DebugRunPause>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(DebugRunPause instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source<TContext> _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="DebugRunPause"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source afterEachStep = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source beforeSteps = default)
        {
            afterEachStep.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AfterEachStep, ref builder);
            beforeSteps.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BeforeSteps, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="DebugRunPause"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source afterEachStep = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source beforeSteps = default)
        {
            Create(ref _builder, afterEachStep, beforeSteps);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source afterEachStep = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source<TContext> beforeSteps = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, afterEachStep, beforeSteps);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="afterEachStep">The value of the <c>"afterEachStep"</c> property.</param>
    /// <param name="beforeSteps">The value of the <c>"beforeSteps"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source afterEachStep = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source beforeSteps = default)
    {
        return new Source(afterEachStep, beforeSteps);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="afterEachStep">The value of the property.</param>
    /// <param name="beforeSteps">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source afterEachStep = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source beforeSteps = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(afterEachStep, beforeSteps);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, afterEachStep, beforeSteps);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<DebugRunPause, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<DebugRunPause> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<DebugRunPause>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<DebugRunPause> Create<TContext>(
    ...
    public static ParsedJsonDocument<DebugRunPause> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source afterEachStep = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source beforeSteps = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<DebugRunPause> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source afterEachStep = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray.Source<TContext> beforeSteps = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
