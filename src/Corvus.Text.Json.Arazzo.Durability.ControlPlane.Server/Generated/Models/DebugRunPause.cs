...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DebugRunPause"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal DebugRunPause(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static DebugRunPause DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean AfterEachStep
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AfterEachStepUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray BeforeSteps
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BeforeStepsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in DebugRunPause left, in DebugRunPause right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in DebugRunPause left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(DebugRunPause instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator DebugRunPause(JsonElement instance)
    {
        return DebugRunPause.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DebugRunPause From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DebugRunPause ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DebugRunPause>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DebugRunPause ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DebugRunPause>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DebugRunPause ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DebugRunPause>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static DebugRunPause ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DebugRunPause>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out DebugRunPause? result)
    {
        return JsonElementHelpers.TryParseValue<DebugRunPause>(ref reader, out result);
    }
...
#if NET
    static DebugRunPause IJsonElement<DebugRunPause>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"DebugRunPause: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="AfterEachStep"/>.
        /// </summary>
        public const string AfterEachStep = "afterEachStep";

        /// <summary>
        /// Gets the JSON property name for <see cref="BeforeSteps"/>.
        /// </summary>
        public const string BeforeSteps = "beforeSteps";

        /// <summary>
        /// Gets the JSON property name for <see cref="AfterEachStep"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AfterEachStepUtf8 => "afterEachStep"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="BeforeSteps"/>.
        /// </summary>
        public static ReadOnlySpan<byte> BeforeStepsUtf8 => "beforeSteps"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="AfterEachStep"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AfterEachStep => "afterEachStep"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="BeforeSteps"/>.
        /// </summary>
        public static ReadOnlySpan<byte> BeforeSteps => "beforeSteps"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="AfterEachStep"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AfterEachStep => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x66, 0x74, 0x65, 0x72, 0x45, 0x61, 0x63, 0x68, 0x53, 0x74, 0x65, 0x70, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="BeforeSteps"/>.
        /// </summary>
        public static ReadOnlySpan<byte> BeforeSteps => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x62, 0x65, 0x66, 0x6F, 0x72, 0x65, 0x53, 0x74, 0x65, 0x70, 0x73, 0x22];
    }
}
