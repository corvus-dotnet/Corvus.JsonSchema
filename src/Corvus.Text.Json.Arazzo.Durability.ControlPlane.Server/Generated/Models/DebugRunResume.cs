...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DebugRunResume"/> struct.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResumeRequest Action
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActionUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResumeRequest value))
            {
                return value;
            }
