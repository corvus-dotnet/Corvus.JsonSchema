    ...
    : IJsonElement<DebugRunStart>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForWorkflowId = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForEnvironment | RequiredBitForWorkflowId;
        ...
        private static void MatchInputs(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunStart.TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunStart.TheWorkflowSInputsValidatedAgainstItsOwnInputsSchema.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            context.CommitChildContext(childContext1.IsMatch, ref childContext1);
        }

        private static void MatchPause(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DebugRunPause.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/DebugRunStart"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/DebugRunStart";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/DebugRunStart"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    ...
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyWorkflowIdPresent, "workflowId"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyWorkflowIdNotPresent, "workflowId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyWorkflowIdPresent, "workflowId"u8, "required"u8);
