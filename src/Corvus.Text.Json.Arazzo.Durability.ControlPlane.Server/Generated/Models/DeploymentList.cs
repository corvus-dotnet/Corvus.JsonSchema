...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DeploymentList.DeploymentViewArray Deployments
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeploymentsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DeploymentList.DeploymentViewArray value))
            {
                return value;
            }
