...
/// <remarks>
/// <para>
/// The lifecycle state of a serverless deployment (ADR 0055).
/// </para>
/// </remarks>
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DeploymentStatus"/> struct.
    /// </summary>
    ...
    internal DeploymentStatus(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static DeploymentStatus DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(DeploymentStatus value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in DeploymentStatus left, in DeploymentStatus right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in DeploymentStatus left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(DeploymentStatus instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator DeploymentStatus(JsonElement instance)
    {
        return DeploymentStatus.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentStatus From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentStatus ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentStatus>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentStatus ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentStatus>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentStatus ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentStatus>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static DeploymentStatus ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentStatus>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out DeploymentStatus? result)
    {
        return JsonElementHelpers.TryParseValue<DeploymentStatus>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new DeploymentStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static DeploymentStatus IJsonElement<DeploymentStatus>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"DeploymentStatus: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="DeploymentStatus"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="DeploymentStatus"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<DeploymentStatus>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="DeploymentStatus"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public DeploymentStatus Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<DeploymentStatus>(_idx);
        }
    ...
    /// <param name="matchQueued">Match 1st item.</param>
    /// <param name="matchDeploying">Match 2nd item.</param>
    /// <param name="matchDeployed">Match 3rd item.</param>
    /// <param name="matchFailed">Match 4th item.</param>
    /// <param name="defaultMatch">Match any other value.</param>
    /// <returns>An instance of the value returned by the match function.</returns>
    public TResult Match<TContext, TResult>(
        in TContext context,
        Func<TContext, TResult> matchQueued,
        Func<TContext, TResult> matchDeploying,
        Func<TContext, TResult> matchDeployed,
        Func<TContext, TResult> matchFailed,
...
#endif
    {
        ...
        {
            return matchQueued(context);
        }

        if (this.ValueEquals(Constants.Enum2))
        {
            return matchDeploying(context);
        }

        if (this.ValueEquals(Constants.Enum3))
        {
            return matchDeployed(context);
        }

        if (this.ValueEquals(Constants.Enum4))
        {
            return matchFailed(context);
        }
    ...
    public TResult Match<TResult>(
        Func<TResult> matchQueued,
        Func<TResult> matchDeploying,
        Func<TResult> matchDeployed,
        Func<TResult> matchFailed,
        Func<TResult> defaultMatch)
    {
        ...
        if (this.ValueEquals(Constants.Enum2))
        {
            return matchDeploying();
        }

        if (this.ValueEquals(Constants.Enum3))
        {
            return matchDeployed();
        }
