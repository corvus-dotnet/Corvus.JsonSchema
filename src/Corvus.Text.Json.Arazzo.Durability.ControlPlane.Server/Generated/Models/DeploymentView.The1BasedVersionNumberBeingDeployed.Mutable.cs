...
public readonly partial struct DeploymentView
{
    ...
    public readonly partial struct The1BasedVersionNumberBeingDeployed
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(The1BasedVersionNumberBeingDeployed instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="The1BasedVersionNumberBeingDeployed"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator The1BasedVersionNumberBeingDeployed(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"The1BasedVersionNumberBeingDeployed.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly The1BasedVersionNumberBeingDeployed Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly The1BasedVersionNumberBeingDeployed Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<The1BasedVersionNumberBeingDeployed>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(The1BasedVersionNumberBeingDeployed instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<The1BasedVersionNumberBeingDeployed, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<The1BasedVersionNumberBeingDeployed> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<The1BasedVersionNumberBeingDeployed>();
            }
            finally
            {
