...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DeploymentView"/> struct.
    /// </summary>
    ...
    internal DeploymentView(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static DeploymentView DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString FunctionUrl
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FunctionUrlUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonDateTime LeaseExpiresAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseExpiresAtUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DeploymentStatus Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DeploymentStatus value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DeploymentView.The1BasedVersionNumberBeingDeployed VersionNumber
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionNumberUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.DeploymentView.The1BasedVersionNumberBeingDeployed value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in DeploymentView left, in DeploymentView right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in DeploymentView left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(DeploymentView instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator DeploymentView(JsonElement instance)
    {
        return DeploymentView.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentView From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentView ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentView>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentView ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentView>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeploymentView ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentView>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static DeploymentView ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeploymentView>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out DeploymentView? result)
    {
        return JsonElementHelpers.TryParseValue<DeploymentView>(ref reader, out result);
    }
...
#if NET
    static DeploymentView IJsonElement<DeploymentView>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"DeploymentView: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public DeploymentView Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<DeploymentView>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="FunctionUrl"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="LeaseExpiresAt"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="FunctionUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> FunctionUrlUtf8 => "functionUrl"u8;
        ...
        /// Gets the JSON property name for <see cref="LeaseExpiresAt"/>.
        /// </summary>
        public static ReadOnlySpan<byte> LeaseExpiresAtUtf8 => "leaseExpiresAt"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="FunctionUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> FunctionUrl => "functionUrl"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="LeaseExpiresAt"/>.
        /// </summary>
        public static ReadOnlySpan<byte> LeaseExpiresAt => "leaseExpiresAt"u8;
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="FunctionUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> FunctionUrl => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x66, 0x75, 0x6E, 0x63, 0x74, 0x69, 0x6F, 0x6E, 0x55, 0x72, 0x6C, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="LeaseExpiresAt"/>.
        /// </summary>
        public static ReadOnlySpan<byte> LeaseExpiresAt => [0x05, 0x01, 0x00, 0x00, 0x22, 0x6C, 0x65, 0x61, 0x73, 0x65, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x22];
