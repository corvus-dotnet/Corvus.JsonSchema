...
public readonly partial struct EnvironmentCreate
{
    ...
    public readonly partial struct RequiredIsolationEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiredIsolationEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiredIsolationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredIsolationEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredIsolationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredIsolationEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredIsolationEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiredIsolationEntity>(_idx);
            }
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    result = KnownValues.InProcess;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    result = KnownValues.Isolated;
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RequiredIsolationEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (RequiredIsolationEntity)value;
        ...
        {
            return workspace.CreateBuilder<RequiredIsolationEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RequiredIsolationEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RequiredIsolationEntity>();
            }
            finally
            {
