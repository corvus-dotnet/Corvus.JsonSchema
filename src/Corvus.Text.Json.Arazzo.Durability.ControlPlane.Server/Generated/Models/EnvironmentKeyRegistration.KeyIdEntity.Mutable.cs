...
public readonly partial struct EnvironmentKeyRegistration
{
    ...
    public readonly partial struct KeyIdEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(KeyIdEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="KeyIdEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator KeyIdEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"KeyIdEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="KeyIdEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="KeyIdEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly KeyIdEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="KeyIdEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly KeyIdEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<KeyIdEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(KeyIdEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<KeyIdEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<KeyIdEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<KeyIdEntity>();
            }
            finally
            {
