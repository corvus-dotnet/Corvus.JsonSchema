...
public readonly partial struct EnvironmentKeyRegistration
{
    ...
    public readonly partial struct SealPublicKeyEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SealPublicKeyEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SealPublicKeyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SealPublicKeyEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SealPublicKeyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SealPublicKeyEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SealPublicKeyEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SealPublicKeyEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SealPublicKeyEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SealPublicKeyEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SealPublicKeyEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SealPublicKeyEntity>();
            }
            finally
            {
