...
public readonly partial struct EnvironmentKeyRegistration
{
    ...
    public readonly partial struct SignatureEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SignatureEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SignatureEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SignatureEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SignatureEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SignatureEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SignatureEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SignatureEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SignatureEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SignatureEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SignatureEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SignatureEntity>();
            }
            finally
            {
