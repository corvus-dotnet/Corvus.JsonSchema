...
/// <remarks>
/// <para>
/// An optional note recorded with a key retirement.
/// </para>
/// </remarks>
public readonly partial struct EnvironmentKeyRetirementNote
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Why the generation was retired.
    /// </para>
    /// </remarks>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly partial struct WhyTheGenerationWasRetired
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WhyTheGenerationWasRetired instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WhyTheGenerationWasRetired"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WhyTheGenerationWasRetired(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WhyTheGenerationWasRetired(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WhyTheGenerationWasRetired.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WhyTheGenerationWasRetired"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WhyTheGenerationWasRetired"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly WhyTheGenerationWasRetired Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WhyTheGenerationWasRetired>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WhyTheGenerationWasRetired"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly WhyTheGenerationWasRetired Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WhyTheGenerationWasRetired>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(WhyTheGenerationWasRetired instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<WhyTheGenerationWasRetired, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<WhyTheGenerationWasRetired> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WhyTheGenerationWasRetired>();
            }
            finally
            {
