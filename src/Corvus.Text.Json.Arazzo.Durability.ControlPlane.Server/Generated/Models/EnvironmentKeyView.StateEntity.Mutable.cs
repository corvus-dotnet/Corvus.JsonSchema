...
public readonly partial struct EnvironmentKeyView
{
    ...
    public readonly partial struct StateEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StateEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StateEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StateEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StateEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly StateEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly StateEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StateEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(StateEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<StateEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<StateEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<StateEntity>();
            }
            finally
            {
