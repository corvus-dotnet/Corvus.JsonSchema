...
public readonly partial struct EnvironmentKeyView
{
    ...
    public readonly partial struct ThePublicSealKeyBase64SpkiNotASecret
    {
...
#endif
        {
            ...
            public static implicit operator byte(Mutable value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();
            ...
            public static explicit operator Mutable(ThePublicSealKeyBase64SpkiNotASecret instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ThePublicSealKeyBase64SpkiNotASecret"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ThePublicSealKeyBase64SpkiNotASecret(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ThePublicSealKeyBase64SpkiNotASecret(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ThePublicSealKeyBase64SpkiNotASecret.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ThePublicSealKeyBase64SpkiNotASecret"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ThePublicSealKeyBase64SpkiNotASecret"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ThePublicSealKeyBase64SpkiNotASecret Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ThePublicSealKeyBase64SpkiNotASecret>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ThePublicSealKeyBase64SpkiNotASecret"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ThePublicSealKeyBase64SpkiNotASecret Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ThePublicSealKeyBase64SpkiNotASecret>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ThePublicSealKeyBase64SpkiNotASecret instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ThePublicSealKeyBase64SpkiNotASecret, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ThePublicSealKeyBase64SpkiNotASecret> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ThePublicSealKeyBase64SpkiNotASecret>();
            }
            finally
            {
