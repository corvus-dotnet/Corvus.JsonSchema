...
public readonly partial struct EnvironmentKeyView
{
    ...
    public readonly partial struct ThePublicSealKeyBase64urlSpkiNotASecret
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ThePublicSealKeyBase64urlSpkiNotASecret instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ThePublicSealKeyBase64urlSpkiNotASecret"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ThePublicSealKeyBase64urlSpkiNotASecret(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ThePublicSealKeyBase64urlSpkiNotASecret.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ThePublicSealKeyBase64urlSpkiNotASecret Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ThePublicSealKeyBase64urlSpkiNotASecret Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ThePublicSealKeyBase64urlSpkiNotASecret>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ThePublicSealKeyBase64urlSpkiNotASecret instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ThePublicSealKeyBase64urlSpkiNotASecret, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ThePublicSealKeyBase64urlSpkiNotASecret> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ThePublicSealKeyBase64urlSpkiNotASecret>();
            }
            finally
            {
