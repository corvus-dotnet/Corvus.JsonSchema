...
public readonly partial struct EnvironmentKeyView
{
    ...
    public readonly partial struct TheSealKeySSignatureAlgorithm
#if NET8_0_OR_GREATER
        : IJsonElement<TheSealKeySSignatureAlgorithm>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheSealKeySSignatureAlgorithm"/> struct.
        /// </summary>
        ...
        internal TheSealKeySSignatureAlgorithm(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheSealKeySSignatureAlgorithm DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheSealKeySSignatureAlgorithm value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheSealKeySSignatureAlgorithm left, in TheSealKeySSignatureAlgorithm right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheSealKeySSignatureAlgorithm left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheSealKeySSignatureAlgorithm instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheSealKeySSignatureAlgorithm(JsonElement instance)
        {
            return TheSealKeySSignatureAlgorithm.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheSealKeySSignatureAlgorithm From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheSealKeySSignatureAlgorithm ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheSealKeySSignatureAlgorithm>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheSealKeySSignatureAlgorithm ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheSealKeySSignatureAlgorithm>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheSealKeySSignatureAlgorithm ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheSealKeySSignatureAlgorithm>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static TheSealKeySSignatureAlgorithm ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheSealKeySSignatureAlgorithm>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheSealKeySSignatureAlgorithm? result)
        {
            return JsonElementHelpers.TryParseValue<TheSealKeySSignatureAlgorithm>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheSealKeySSignatureAlgorithm(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheSealKeySSignatureAlgorithm IJsonElement<TheSealKeySSignatureAlgorithm>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheSealKeySSignatureAlgorithm: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheSealKeySSignatureAlgorithm"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheSealKeySSignatureAlgorithm"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheSealKeySSignatureAlgorithm Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheSealKeySSignatureAlgorithm>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheSealKeySSignatureAlgorithm"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheSealKeySSignatureAlgorithm Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheSealKeySSignatureAlgorithm>(_idx);
            }
