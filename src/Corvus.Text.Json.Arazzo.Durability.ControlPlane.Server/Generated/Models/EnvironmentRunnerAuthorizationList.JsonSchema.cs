    ...
    : IJsonElement<EnvironmentRunnerAuthorizationList>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchAuthorizations(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
