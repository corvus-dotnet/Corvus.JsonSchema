...
public readonly partial struct ExecutionBudget
{
    public readonly partial struct MaxResponseBytesEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MaxResponseBytesEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MaxResponseBytesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaxResponseBytesEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MaxResponseBytesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaxResponseBytesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly MaxResponseBytesEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MaxResponseBytesEntity>(_idx);
            }

            /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
            public readonly MaxResponseBytesEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MaxResponseBytesEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MaxResponseBytesEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MaxResponseBytesEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MaxResponseBytesEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxResponseBytesEntity>();
            }
            finally
            {
