...
public readonly partial struct ExecutionBudget
{
    ...
    public readonly partial struct MaxStepsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MaxStepsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MaxStepsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MaxStepsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MaxStepsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MaxStepsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MaxStepsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MaxStepsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MaxStepsEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MaxStepsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MaxStepsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MaxStepsEntity>();
            }
            finally
            {
