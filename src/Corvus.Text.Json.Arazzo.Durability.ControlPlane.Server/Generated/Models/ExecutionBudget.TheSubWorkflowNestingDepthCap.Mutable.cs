...
public readonly partial struct ExecutionBudget
{
    ...
    public readonly partial struct TheSubWorkflowNestingDepthCap
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheSubWorkflowNestingDepthCap instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheSubWorkflowNestingDepthCap"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheSubWorkflowNestingDepthCap(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheSubWorkflowNestingDepthCap.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheSubWorkflowNestingDepthCap"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheSubWorkflowNestingDepthCap"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TheSubWorkflowNestingDepthCap Clone()
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheSubWorkflowNestingDepthCap"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TheSubWorkflowNestingDepthCap Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheSubWorkflowNestingDepthCap>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheSubWorkflowNestingDepthCap instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheSubWorkflowNestingDepthCap, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheSubWorkflowNestingDepthCap> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheSubWorkflowNestingDepthCap>();
            }
            finally
            {
