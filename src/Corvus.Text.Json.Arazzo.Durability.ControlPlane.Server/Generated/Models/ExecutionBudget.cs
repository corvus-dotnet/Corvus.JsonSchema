...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ExecutionBudget"/> struct.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ExecutionBudget.MaxStepsEntity MaxSteps
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxStepsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ExecutionBudget.MaxStepsEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ExecutionBudget.TheSubWorkflowNestingDepthCap MaxSubWorkflowDepth
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxSubWorkflowDepthUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ExecutionBudget.TheSubWorkflowNestingDepthCap value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ExecutionBudget.RetryAfterCeilingSecondsEntity RetryAfterCeilingSeconds
    {
        get
        {
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ExecutionBudget.TheMaximumAgeOfARunFromCreationInSeconds WallClockSeconds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WallClockSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ExecutionBudget.TheMaximumAgeOfARunFromCreationInSeconds value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets a <see cref="ExecutionBudget"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="ExecutionBudget"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="ExecutionBudget"/> that lives for the lifetime of its
