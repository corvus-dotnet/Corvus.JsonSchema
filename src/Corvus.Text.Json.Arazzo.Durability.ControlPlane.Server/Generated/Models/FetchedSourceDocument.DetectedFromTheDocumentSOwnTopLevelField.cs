...
public readonly partial struct FetchedSourceDocument
{
    ...
    public readonly partial struct DetectedFromTheDocumentSOwnTopLevelField
#if NET8_0_OR_GREATER
        : IJsonElement<DetectedFromTheDocumentSOwnTopLevelField>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectedFromTheDocumentSOwnTopLevelField"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DetectedFromTheDocumentSOwnTopLevelField(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DetectedFromTheDocumentSOwnTopLevelField DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(DetectedFromTheDocumentSOwnTopLevelField value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in DetectedFromTheDocumentSOwnTopLevelField left, in DetectedFromTheDocumentSOwnTopLevelField right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DetectedFromTheDocumentSOwnTopLevelField left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DetectedFromTheDocumentSOwnTopLevelField instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DetectedFromTheDocumentSOwnTopLevelField(JsonElement instance)
        {
            return DetectedFromTheDocumentSOwnTopLevelField.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DetectedFromTheDocumentSOwnTopLevelField From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DetectedFromTheDocumentSOwnTopLevelField ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DetectedFromTheDocumentSOwnTopLevelField>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DetectedFromTheDocumentSOwnTopLevelField ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DetectedFromTheDocumentSOwnTopLevelField>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DetectedFromTheDocumentSOwnTopLevelField ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DetectedFromTheDocumentSOwnTopLevelField>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static DetectedFromTheDocumentSOwnTopLevelField ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DetectedFromTheDocumentSOwnTopLevelField>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DetectedFromTheDocumentSOwnTopLevelField? result)
        {
            return JsonElementHelpers.TryParseValue<DetectedFromTheDocumentSOwnTopLevelField>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DetectedFromTheDocumentSOwnTopLevelField(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DetectedFromTheDocumentSOwnTopLevelField IJsonElement<DetectedFromTheDocumentSOwnTopLevelField>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DetectedFromTheDocumentSOwnTopLevelField: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DetectedFromTheDocumentSOwnTopLevelField"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DetectedFromTheDocumentSOwnTopLevelField"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DetectedFromTheDocumentSOwnTopLevelField Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DetectedFromTheDocumentSOwnTopLevelField>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DetectedFromTheDocumentSOwnTopLevelField"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DetectedFromTheDocumentSOwnTopLevelField Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DetectedFromTheDocumentSOwnTopLevelField>(_idx);
            }
        ...
        /// <param name="matchArazzo">Match 3rd item.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Func<TContext, TResult> matchArazzo,
