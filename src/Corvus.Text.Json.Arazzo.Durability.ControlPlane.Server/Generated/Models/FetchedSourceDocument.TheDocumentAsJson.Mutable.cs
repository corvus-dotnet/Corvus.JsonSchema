...
public readonly partial struct FetchedSourceDocument
{
    ...
    public readonly partial struct TheDocumentAsJson
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheDocumentAsJson instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheDocumentAsJson"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheDocumentAsJson(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheDocumentAsJson(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheDocumentAsJson.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheDocumentAsJson"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheDocumentAsJson"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TheDocumentAsJson Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheDocumentAsJson>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheDocumentAsJson"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TheDocumentAsJson Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheDocumentAsJson>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.FetchedSourceDocument.TheDocumentAsJson.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(TheDocumentAsJson instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.FetchedSourceDocument.TheDocumentAsJson.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<TheDocumentAsJson, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheDocumentAsJson> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheDocumentAsJson>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<TheDocumentAsJson> Create<TContext>(
