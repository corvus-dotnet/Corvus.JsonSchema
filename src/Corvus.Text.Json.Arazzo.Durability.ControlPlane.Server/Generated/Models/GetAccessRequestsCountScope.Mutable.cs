...
public readonly partial struct GetAccessRequestsCountScope
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAccessRequestsCountScope instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAccessRequestsCountScope"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAccessRequestsCountScope(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetAccessRequestsCountScope(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAccessRequestsCountScope.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetAccessRequestsCountScope"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetAccessRequestsCountScope"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetAccessRequestsCountScope Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetAccessRequestsCountScope>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetAccessRequestsCountScope"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetAccessRequestsCountScope Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAccessRequestsCountScope>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetAccessRequestsCountScope instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetAccessRequestsCountScope, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetAccessRequestsCountScope> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetAccessRequestsCountScope>();
        }
        finally
        {
