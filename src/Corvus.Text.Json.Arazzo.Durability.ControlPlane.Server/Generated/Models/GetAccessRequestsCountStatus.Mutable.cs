...
public readonly partial struct GetAccessRequestsCountStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAccessRequestsCountStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAccessRequestsCountStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAccessRequestsCountStatus(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetAccessRequestsCountStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAccessRequestsCountStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetAccessRequestsCountStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetAccessRequestsCountStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetAccessRequestsCountStatus Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetAccessRequestsCountStatus>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetAccessRequestsCountStatus"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetAccessRequestsCountStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAccessRequestsCountStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetAccessRequestsCountStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetAccessRequestsCountStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetAccessRequestsCountStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetAccessRequestsCountStatus>();
        }
        finally
        {
