...
public readonly partial struct GetAccessRequestsScope
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAccessRequestsScope instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAccessRequestsScope"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAccessRequestsScope(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAccessRequestsScope.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly GetAccessRequestsScope Clone()
        {
            CheckValidInstance();
        ...
        public readonly GetAccessRequestsScope Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAccessRequestsScope>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetAccessRequestsScope instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (GetAccessRequestsScope)value;
    ...
    {
        return workspace.CreateBuilder<GetAccessRequestsScope, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetAccessRequestsScope> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetAccessRequestsScope>();
        }
        finally
        {
