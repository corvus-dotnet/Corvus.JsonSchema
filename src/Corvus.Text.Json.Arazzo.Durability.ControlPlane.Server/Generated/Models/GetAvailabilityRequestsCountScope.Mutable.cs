...
public readonly partial struct GetAvailabilityRequestsCountScope
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAvailabilityRequestsCountScope instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAvailabilityRequestsCountScope"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAvailabilityRequestsCountScope(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetAvailabilityRequestsCountScope(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAvailabilityRequestsCountScope.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetAvailabilityRequestsCountScope"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetAvailabilityRequestsCountScope"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetAvailabilityRequestsCountScope Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetAvailabilityRequestsCountScope>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetAvailabilityRequestsCountScope"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetAvailabilityRequestsCountScope Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAvailabilityRequestsCountScope>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetAvailabilityRequestsCountScope instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetAvailabilityRequestsCountScope, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetAvailabilityRequestsCountScope> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetAvailabilityRequestsCountScope>();
        }
        finally
        {
