...
public readonly partial struct GetAvailabilityRequestsCountStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAvailabilityRequestsCountStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAvailabilityRequestsCountStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAvailabilityRequestsCountStatus(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAvailabilityRequestsCountStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetAvailabilityRequestsCountStatus Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetAvailabilityRequestsCountStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAvailabilityRequestsCountStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetAvailabilityRequestsCountStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetAvailabilityRequestsCountStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetAvailabilityRequestsCountStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetAvailabilityRequestsCountStatus>();
        }
        finally
        {
