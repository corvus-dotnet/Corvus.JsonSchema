...
public readonly partial struct GetAvailabilityRequestsScope
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAvailabilityRequestsScope instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAvailabilityRequestsScope"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAvailabilityRequestsScope(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAvailabilityRequestsScope.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly GetAvailabilityRequestsScope Clone()
        {
            CheckValidInstance();
        ...
        public readonly GetAvailabilityRequestsScope Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAvailabilityRequestsScope>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetAvailabilityRequestsScope instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (GetAvailabilityRequestsScope)value;
    ...
    {
        return workspace.CreateBuilder<GetAvailabilityRequestsScope, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetAvailabilityRequestsScope> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetAvailabilityRequestsScope>();
        }
        finally
        {
