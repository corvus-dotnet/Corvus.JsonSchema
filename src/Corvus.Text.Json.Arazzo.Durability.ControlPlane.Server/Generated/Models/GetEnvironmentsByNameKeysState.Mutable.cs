...
public readonly partial struct GetEnvironmentsByNameKeysState
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetEnvironmentsByNameKeysState instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetEnvironmentsByNameKeysState"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetEnvironmentsByNameKeysState(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetEnvironmentsByNameKeysState.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly GetEnvironmentsByNameKeysState Clone()
        {
            CheckValidInstance();
        ...
        public readonly GetEnvironmentsByNameKeysState Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetEnvironmentsByNameKeysState>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetEnvironmentsByNameKeysState instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (GetEnvironmentsByNameKeysState)value;
    ...
    {
        return workspace.CreateBuilder<GetEnvironmentsByNameKeysState, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetEnvironmentsByNameKeysState> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetEnvironmentsByNameKeysState>();
        }
        finally
        {
