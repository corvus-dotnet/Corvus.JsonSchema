...
public readonly partial struct GetEnvironmentsByNameKeysState
#if NET8_0_OR_GREATER
    : IJsonElement<GetEnvironmentsByNameKeysState>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetEnvironmentsByNameKeysState"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetEnvironmentsByNameKeysState(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetEnvironmentsByNameKeysState DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(GetEnvironmentsByNameKeysState value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in GetEnvironmentsByNameKeysState left, in GetEnvironmentsByNameKeysState right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetEnvironmentsByNameKeysState left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(GetEnvironmentsByNameKeysState instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetEnvironmentsByNameKeysState(JsonElement instance)
    {
        return GetEnvironmentsByNameKeysState.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEnvironmentsByNameKeysState From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEnvironmentsByNameKeysState ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetEnvironmentsByNameKeysState>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEnvironmentsByNameKeysState ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetEnvironmentsByNameKeysState>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEnvironmentsByNameKeysState ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetEnvironmentsByNameKeysState>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetEnvironmentsByNameKeysState ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetEnvironmentsByNameKeysState>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetEnvironmentsByNameKeysState? result)
    {
        return JsonElementHelpers.TryParseValue<GetEnvironmentsByNameKeysState>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetEnvironmentsByNameKeysState(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetEnvironmentsByNameKeysState IJsonElement<GetEnvironmentsByNameKeysState>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetEnvironmentsByNameKeysState: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetEnvironmentsByNameKeysState"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetEnvironmentsByNameKeysState"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetEnvironmentsByNameKeysState Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetEnvironmentsByNameKeysState>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetEnvironmentsByNameKeysState"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetEnvironmentsByNameKeysState Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetEnvironmentsByNameKeysState>(_idx);
        }
