...
public readonly partial struct GetEnvironmentsByNameRunnersStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetEnvironmentsByNameRunnersStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetEnvironmentsByNameRunnersStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetEnvironmentsByNameRunnersStatus(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetEnvironmentsByNameRunnersStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetEnvironmentsByNameRunnersStatus Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetEnvironmentsByNameRunnersStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetEnvironmentsByNameRunnersStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetEnvironmentsByNameRunnersStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetEnvironmentsByNameRunnersStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetEnvironmentsByNameRunnersStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetEnvironmentsByNameRunnersStatus>();
        }
        finally
        {
