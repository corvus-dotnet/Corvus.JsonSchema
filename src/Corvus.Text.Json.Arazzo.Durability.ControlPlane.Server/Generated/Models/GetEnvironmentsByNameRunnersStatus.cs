...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetEnvironmentsByNameRunnersStatus"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetEnvironmentsByNameRunnersStatus(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetEnvironmentsByNameRunnersStatus DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(GetEnvironmentsByNameRunnersStatus value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in GetEnvironmentsByNameRunnersStatus left, in GetEnvironmentsByNameRunnersStatus right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetEnvironmentsByNameRunnersStatus left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(GetEnvironmentsByNameRunnersStatus instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetEnvironmentsByNameRunnersStatus(JsonElement instance)
    {
        return GetEnvironmentsByNameRunnersStatus.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEnvironmentsByNameRunnersStatus From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEnvironmentsByNameRunnersStatus ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetEnvironmentsByNameRunnersStatus>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEnvironmentsByNameRunnersStatus ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetEnvironmentsByNameRunnersStatus>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEnvironmentsByNameRunnersStatus ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetEnvironmentsByNameRunnersStatus>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetEnvironmentsByNameRunnersStatus ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetEnvironmentsByNameRunnersStatus>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetEnvironmentsByNameRunnersStatus? result)
    {
        return JsonElementHelpers.TryParseValue<GetEnvironmentsByNameRunnersStatus>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetEnvironmentsByNameRunnersStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetEnvironmentsByNameRunnersStatus IJsonElement<GetEnvironmentsByNameRunnersStatus>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetEnvironmentsByNameRunnersStatus: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetEnvironmentsByNameRunnersStatus"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetEnvironmentsByNameRunnersStatus"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetEnvironmentsByNameRunnersStatus Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetEnvironmentsByNameRunnersStatus>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetEnvironmentsByNameRunnersStatus"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetEnvironmentsByNameRunnersStatus Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetEnvironmentsByNameRunnersStatus>(_idx);
        }
