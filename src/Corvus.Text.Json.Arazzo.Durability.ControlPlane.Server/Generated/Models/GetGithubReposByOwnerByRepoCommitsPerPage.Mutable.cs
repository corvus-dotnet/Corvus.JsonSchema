...
public readonly partial struct GetGithubReposByOwnerByRepoCommitsPerPage
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetGithubReposByOwnerByRepoCommitsPerPage instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetGithubReposByOwnerByRepoCommitsPerPage"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetGithubReposByOwnerByRepoCommitsPerPage(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetGithubReposByOwnerByRepoCommitsPerPage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetGithubReposByOwnerByRepoCommitsPerPage Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetGithubReposByOwnerByRepoCommitsPerPage Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetGithubReposByOwnerByRepoCommitsPerPage>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetGithubReposByOwnerByRepoCommitsPerPage instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetGithubReposByOwnerByRepoCommitsPerPage, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetGithubReposByOwnerByRepoCommitsPerPage> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetGithubReposByOwnerByRepoCommitsPerPage>();
        }
        finally
        {
