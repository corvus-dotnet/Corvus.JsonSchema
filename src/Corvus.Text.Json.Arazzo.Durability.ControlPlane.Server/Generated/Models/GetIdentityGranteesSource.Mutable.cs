...
public readonly partial struct GetIdentityGranteesSource
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetIdentityGranteesSource instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetIdentityGranteesSource"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetIdentityGranteesSource(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetIdentityGranteesSource(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetIdentityGranteesSource.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetIdentityGranteesSource"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetIdentityGranteesSource"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetIdentityGranteesSource Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetIdentityGranteesSource>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetIdentityGranteesSource"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetIdentityGranteesSource Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetIdentityGranteesSource>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetIdentityGranteesSource instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetIdentityGranteesSource, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetIdentityGranteesSource> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetIdentityGranteesSource>();
        }
        finally
        {
