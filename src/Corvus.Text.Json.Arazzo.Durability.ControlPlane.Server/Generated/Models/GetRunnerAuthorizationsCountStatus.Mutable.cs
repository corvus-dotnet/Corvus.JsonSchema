...
public readonly partial struct GetRunnerAuthorizationsCountStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetRunnerAuthorizationsCountStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetRunnerAuthorizationsCountStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetRunnerAuthorizationsCountStatus(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetRunnerAuthorizationsCountStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetRunnerAuthorizationsCountStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetRunnerAuthorizationsCountStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetRunnerAuthorizationsCountStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetRunnerAuthorizationsCountStatus Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetRunnerAuthorizationsCountStatus>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetRunnerAuthorizationsCountStatus"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetRunnerAuthorizationsCountStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetRunnerAuthorizationsCountStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetRunnerAuthorizationsCountStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetRunnerAuthorizationsCountStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetRunnerAuthorizationsCountStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetRunnerAuthorizationsCountStatus>();
        }
        finally
        {
