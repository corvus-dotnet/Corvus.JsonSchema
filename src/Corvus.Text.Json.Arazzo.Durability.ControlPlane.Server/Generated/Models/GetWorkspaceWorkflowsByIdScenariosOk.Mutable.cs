...
public readonly partial struct GetWorkspaceWorkflowsByIdScenariosOk
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Mutable Scenarios
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScenariosUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetScenarios(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScenarios<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios)
        {
        ...
        /// Creates an instance of a <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="GetWorkspaceWorkflowsByIdScenariosOk"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios)
    {
    ...
    /// <param name="scenarios">The value of the <c>"scenarios"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static ParsedJsonDocument<GetWorkspaceWorkflowsByIdScenariosOk> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source scenarios, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetWorkspaceWorkflowsByIdScenariosOk> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray.Source<TContext> scenarios, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
