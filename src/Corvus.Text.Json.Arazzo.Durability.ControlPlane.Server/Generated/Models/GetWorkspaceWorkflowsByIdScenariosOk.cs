...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray Scenarios
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScenariosUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GetWorkspaceWorkflowsByIdScenariosOk.ScenarioArray value))
            {
                return value;
            }
