...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GitCommitResult"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GitCommitResult(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GitCommitResult DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitCommitResult.GitCommittedFileArray Files
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FilesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitCommitResult.GitCommittedFileArray value))
            {
                return value;
            }
    ...
    /// GitPullRequest
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitCommitResult.GitPullRequest PullRequest
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PullRequestUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitCommitResult.GitPullRequest value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GitCommitResult left, in GitCommitResult right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GitCommitResult left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GitCommitResult instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GitCommitResult(JsonElement instance)
    {
        return GitCommitResult.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitCommitResult From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitCommitResult ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitCommitResult>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitCommitResult ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitCommitResult>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitCommitResult ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitCommitResult>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GitCommitResult ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitCommitResult>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GitCommitResult? result)
    {
        return JsonElementHelpers.TryParseValue<GitCommitResult>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GitCommitResult(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GitCommitResult IJsonElement<GitCommitResult>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GitCommitResult: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GitCommitResult"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GitCommitResult"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GitCommitResult Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GitCommitResult>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GitCommitResult"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GitCommitResult Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GitCommitResult>(_idx);
        }
