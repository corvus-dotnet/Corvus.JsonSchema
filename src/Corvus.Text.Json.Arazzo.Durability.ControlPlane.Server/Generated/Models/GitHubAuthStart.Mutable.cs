...
public readonly partial struct GitHubAuthStart
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GitHubAuthStart instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GitHubAuthStart"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GitHubAuthStart(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GitHubAuthStart.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GitHubAuthStart Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GitHubAuthStart Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GitHubAuthStart>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubAuthStart.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GitHubAuthStart instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubAuthStart.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GitHubAuthStart"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<GitHubAuthStart, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GitHubAuthStart> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GitHubAuthStart>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GitHubAuthStart> Create<TContext>(
    ...
    public static ParsedJsonDocument<GitHubAuthStart> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source authorizeUrl, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source state, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
