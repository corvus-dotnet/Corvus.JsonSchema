...
public readonly partial struct GitHubBranchList
    : IJsonElement<GitHubBranchList>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBranchesPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("branches"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBranchesNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("branches"u8, buffer, out written);

        private const int RequiredOffsetForBranches = 0;
        private const uint RequiredBitForBranches = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForBranches;
        ...
        private static void MatchBranches(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForBranches] |= RequiredBitForBranches;
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/GitHubBranchList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/GitHubBranchList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/GitHubBranchList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBranchesPresent, "branches"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForBranches] & RequiredBitForBranches) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyBranchesNotPresent, "branches"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBranchesPresent, "branches"u8, "required"u8);
