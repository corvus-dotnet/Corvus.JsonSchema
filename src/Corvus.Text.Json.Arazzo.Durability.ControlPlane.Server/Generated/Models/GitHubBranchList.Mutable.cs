...
/// <remarks>
/// <para>
/// A repository&#39;s branches plus its default branch — the Git dialog&#39;s branch picker.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct GitHubBranchList
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GitHubBranchList instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GitHubBranchList"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GitHubBranchList(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>branches</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Mutable Branches
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BranchesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>defaultBranch</c> property.
        /// </summary>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable DefaultBranch
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultBranchUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GitHubBranchList(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetBranches(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("branches");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BranchesUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetBranches<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source<TContext> value)
        ...
        /// <summary>
        /// Set the <c>defaultBranch</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDefaultBranch(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DefaultBranchUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultBranchUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DefaultBranch, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>defaultBranch</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveDefaultBranch()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DefaultBranchUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GitHubBranchList.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GitHubBranchList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GitHubBranchList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GitHubBranchList Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GitHubBranchList>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GitHubBranchList"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GitHubBranchList Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GitHubBranchList>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(GitHubBranchList instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GitHubBranchList"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source branches,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source defaultBranch = default)
        {
            branches.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Branches, ref builder);
            defaultBranch.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DefaultBranch, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="GitHubBranchList"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source branches, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source defaultBranch = default)
        {
            Create(ref _builder, branches, defaultBranch);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source<TContext> branches,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source defaultBranch = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, branches, defaultBranch);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <param name="defaultBranch">The value of the <c>"defaultBranch"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source branches, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source defaultBranch = default)
    {
        return new Source(branches, defaultBranch);
    }
    ...
    /// <param name="defaultBranch">The value of the <c>"defaultBranch"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source<TContext> branches, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source defaultBranch = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, branches, defaultBranch);
    }
    ...
    /// <param name="defaultBranch">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source branches, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source defaultBranch = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(branches, defaultBranch);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, branches, defaultBranch);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<GitHubBranchList, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GitHubBranchList> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GitHubBranchList>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GitHubBranchList> Create<TContext>(
    ...
    public static ParsedJsonDocument<GitHubBranchList> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBranchList.GitHubBranchArray.Source branches, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source defaultBranch = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
