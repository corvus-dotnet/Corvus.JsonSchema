...
/// <remarks>
/// <para>
/// A proxied contents read: a directory lists its entries; a file carries its content.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct GitHubBrowseResult
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GitHubBrowseResult instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GitHubBrowseResult"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GitHubBrowseResult(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>entries</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// The directory&#39;s entries (kind: dir).
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Mutable Entries
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntriesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// A file&#39;s content, base64-encoded (the GitHub contents shape).
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Mutable File
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Mutable Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GitHubBrowseResult(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>entries</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntries(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EntriesUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntriesUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Entries, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntries<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source<TContext> value)
        ...
        /// <summary>
        /// Remove the <c>entries</c> property, if present.
        /// </summary>
        ...
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EntriesUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFile(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FileUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.File, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFile<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// <summary>
        /// Remove the <c>file</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveFile()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FileUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetKind(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GitHubBrowseResult.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GitHubBrowseResult"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GitHubBrowseResult"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GitHubBrowseResult Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GitHubBrowseResult>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GitHubBrowseResult"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GitHubBrowseResult Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GitHubBrowseResult>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source _createArg3;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(GitHubBrowseResult instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source<TContext> _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source<TContext> _createArg3;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source<TContext> arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source<TContext> arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GitHubBrowseResult"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source kind,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source entries = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source file = default)
        {
            kind.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Kind, ref builder);
            entries.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Entries, ref builder);
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source file = default)
        {
            Create(ref _builder, kind, entries, file);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source kind,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source<TContext> entries = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source<TContext> file = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, kind, entries, file);
        }
    ...
    /// <param name="entries">The value of the <c>"entries"</c> property.</param>
    /// <param name="file">The value of the <c>"file"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source kind, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source entries = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source file = default)
    {
        return new Source(kind, entries, file);
    }
    ...
    /// <param name="entries">The value of the property.</param>
    /// <param name="file">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source kind, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source entries = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source file = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(kind, entries, file);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, kind, entries, file);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<GitHubBrowseResult, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GitHubBrowseResult> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GitHubBrowseResult>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GitHubBrowseResult> Create<TContext>(
    ...
    public static ParsedJsonDocument<GitHubBrowseResult> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source kind, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source entries = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source file = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GitHubBrowseResult> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.KindEntity.Source kind, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubBrowseResult.GitHubContentEntryArray.Source<TContext> entries = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubFile.Source<TContext> file = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
