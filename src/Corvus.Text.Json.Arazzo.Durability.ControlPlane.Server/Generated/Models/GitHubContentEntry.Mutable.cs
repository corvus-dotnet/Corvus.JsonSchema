...
public readonly partial struct GitHubContentEntry
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GitHubContentEntry instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GitHubContentEntry"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GitHubContentEntry(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubContentEntry.TypeEntity.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubContentEntry.TypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubContentEntry.TypeEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GitHubContentEntry.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GitHubContentEntry Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GitHubContentEntry Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GitHubContentEntry>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubContentEntry.TypeEntity.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg4;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInt64.Source _createArg5;
        ...
        public static implicit operator Source(GitHubContentEntry instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubContentEntry.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GitHubContentEntry"/>.
        /// </summary>
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubContentEntry.TypeEntity.Source type,
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInt64.Source size = default)
        {
            Create(ref _builder, name, path, type, sha, size);
        }
    ...
    {
        return workspace.CreateBuilder<GitHubContentEntry, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GitHubContentEntry> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GitHubContentEntry>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GitHubContentEntry> Create<TContext>(
    ...
    public static ParsedJsonDocument<GitHubContentEntry> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source name, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source path, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubContentEntry.TypeEntity.Source type, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source sha = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInt64.Source size = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
