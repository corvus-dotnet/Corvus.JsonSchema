...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubContentEntry.TypeEntity Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubContentEntry.TypeEntity value))
            {
                return value;
            }
