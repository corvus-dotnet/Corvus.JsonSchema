...
/// <remarks>
/// <para>
/// A repository reachable through the brokered session.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct GitHubRepository
#if NET8_0_OR_GREATER
    : IJsonElement<GitHubRepository>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GitHubRepository"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GitHubRepository(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GitHubRepository DefaultInstance { get; }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString DefaultBranch
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultBranchUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString FullName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FullNameUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString Owner
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OwnerUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets the (optional) <c>private</c> property.
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean Private
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrivateUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GitHubRepository left, in GitHubRepository right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GitHubRepository left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GitHubRepository instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GitHubRepository(JsonElement instance)
    {
        return GitHubRepository.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitHubRepository From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitHubRepository ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitHubRepository>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitHubRepository ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitHubRepository>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GitHubRepository ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitHubRepository>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GitHubRepository ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GitHubRepository>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GitHubRepository? result)
    {
        return JsonElementHelpers.TryParseValue<GitHubRepository>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GitHubRepository(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GitHubRepository IJsonElement<GitHubRepository>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GitHubRepository: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GitHubRepository"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GitHubRepository"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<GitHubRepository>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GitHubRepository"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GitHubRepository Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GitHubRepository>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="DefaultBranch"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Private"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="DefaultBranch"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DefaultBranchUtf8 => "defaultBranch"u8;
        ...
        /// Gets the JSON property name for <see cref="Private"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PrivateUtf8 => "private"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="DefaultBranch"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DefaultBranch => "defaultBranch"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Private"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Private => "private"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="DefaultBranch"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DefaultBranch => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6C, 0x74, 0x42, 0x72, 0x61, 0x6E, 0x63, 0x68, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Private"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Private => [0x95, 0x00, 0x00, 0x00, 0x22, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x22];
    }
}
