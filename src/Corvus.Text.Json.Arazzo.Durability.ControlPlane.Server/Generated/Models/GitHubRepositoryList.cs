...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubRepositoryList.GitHubRepositoryArray Repositories
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RepositoriesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitHubRepositoryList.GitHubRepositoryArray value))
            {
                return value;
            }
