...
public readonly partial struct GranteeList
{
...
#endif
    {
        ...
        public void SetGrantees(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeList.ResolvedGranteeArray.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeList.ResolvedGranteeArray.Source arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeList.ResolvedGranteeArray.Source<TContext> arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeList.ResolvedGranteeArray.Source arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeList.ResolvedGranteeArray.Source grantees, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
    {
    ...
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeList.ResolvedGranteeArray.Source<TContext> grantees, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
