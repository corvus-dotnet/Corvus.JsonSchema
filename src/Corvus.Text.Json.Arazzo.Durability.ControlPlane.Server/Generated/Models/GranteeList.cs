...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeList.ResolvedGranteeArray Grantees
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GranteesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeList.ResolvedGranteeArray value))
            {
                return value;
            }
