    ...
    : IJsonElement<IdentityCapabilities>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDirectorySearchPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("directorySearch"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDirectorySearchNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("directorySearch"u8, buffer, out written);

        private const int RequiredOffsetForDirectorySearch = 0;
        private const uint RequiredBitForDirectorySearch = 0b00000000000000000000000000000001;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyGranteeKindsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("granteeKinds"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyGranteeKindsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("granteeKinds"u8, buffer, out written);

        private const int RequiredOffsetForGranteeKinds = 0;
        private const uint RequiredBitForGranteeKinds = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForDirectorySearch | RequiredBitForGranteeKinds;
        private static readonly JsonSchemaPathProvider DirectorySearchSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/directorySearch"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider GranteeKindsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/granteeKinds"u8, buffer, out written);

        private static void MatchDirectorySearch(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.DirectorySearchUtf8,
                    evaluationPath: DirectorySearchSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForDirectorySearch] |= RequiredBitForDirectorySearch;
        }

        private static void MatchGranteeKinds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.IdentityCapabilities.GranteeKindArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.GranteeKindsUtf8,
                    evaluationPath: GranteeKindsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.IdentityCapabilities.GranteeKindArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForGranteeKinds] |= RequiredBitForGranteeKinds;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                (static () => JsonPropertyNames.DirectorySearchUtf8, MatchDirectorySearch),
                (static () => JsonPropertyNames.GranteeKindsUtf8, MatchGranteeKinds),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/IdentityCapabilities"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/IdentityCapabilities";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/IdentityCapabilities"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDirectorySearchPresent, "directorySearch"u8, "required"u8);
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyGranteeKindsPresent, "granteeKinds"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDirectorySearch] & RequiredBitForDirectorySearch) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDirectorySearchNotPresent, "directorySearch"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDirectorySearchPresent, "directorySearch"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForGranteeKinds] & RequiredBitForGranteeKinds) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyGranteeKindsNotPresent, "granteeKinds"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyGranteeKindsPresent, "granteeKinds"u8, "required"u8);
