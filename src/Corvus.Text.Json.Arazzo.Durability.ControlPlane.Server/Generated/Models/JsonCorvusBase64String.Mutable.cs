...
public readonly partial struct JsonCorvusBase64String
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonCorvusBase64String instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonCorvusBase64String"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonCorvusBase64String(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonCorvusBase64String.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonCorvusBase64String Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonCorvusBase64String Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonCorvusBase64String>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonCorvusBase64String instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonCorvusBase64String, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonCorvusBase64String> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonCorvusBase64String>();
        }
        finally
        {
