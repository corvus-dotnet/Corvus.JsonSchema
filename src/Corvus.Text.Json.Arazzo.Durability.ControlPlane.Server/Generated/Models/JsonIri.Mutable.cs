...
public readonly partial struct JsonIri
{
...
#endif
    {
        ...
        public static explicit operator Utf8IriValue(Mutable value) => Utf8IriValue.TryGetValue(value._parent, value._idx, out Utf8IriValue result) ? result : throw new FormatException();
        ...
        public static explicit operator Mutable(JsonIri instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonIri"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonIri(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonIri.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonIri Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonIri>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonIri instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonIri, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonIri> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonIri>();
        }
        finally
        {
