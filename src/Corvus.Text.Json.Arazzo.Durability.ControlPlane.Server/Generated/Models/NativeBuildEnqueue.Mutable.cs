...
/// <remarks>
/// <para>
/// A request to build (or rebuild) a workflow version&#39;s native serverless binary for one runtime target in one environment (ADR 0055). Idempotent per target: re-requesting the same (environment, runtimeIdentifier) resets its build to queued.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct NativeBuildEnqueue
{
...
#endif
    {
        ...
        public static explicit operator Mutable(NativeBuildEnqueue instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NativeBuildEnqueue"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NativeBuildEnqueue(Mutable instance)
        {
        ...
        /// <remarks>
        /// <para>
        /// An optional human-friendly label for the build.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// The .NET runtime identifier (RID) the native binary targets, e.g. &#39;linux-x64&#39;.
        /// </para>
        /// </remarks>
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NativeBuildEnqueue(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NativeBuildEnqueue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="NativeBuildEnqueue"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="NativeBuildEnqueue"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly NativeBuildEnqueue Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<NativeBuildEnqueue>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="NativeBuildEnqueue"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly NativeBuildEnqueue Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<NativeBuildEnqueue>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.NativeBuildEnqueue.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(NativeBuildEnqueue instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.NativeBuildEnqueue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="NativeBuildEnqueue"/>.
        /// </summary>
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source buildLabel = default)
        {
            Create(ref _builder, environment, runtimeIdentifier, buildLabel);
        }
    ...
    {
        return workspace.CreateBuilder<NativeBuildEnqueue, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<NativeBuildEnqueue> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<NativeBuildEnqueue>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<NativeBuildEnqueue> Create<TContext>(
    ...
    public static ParsedJsonDocument<NativeBuildEnqueue> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source environment, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source runtimeIdentifier, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source buildLabel = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
