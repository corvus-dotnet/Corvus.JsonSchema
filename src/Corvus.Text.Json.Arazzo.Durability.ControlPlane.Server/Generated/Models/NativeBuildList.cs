...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NativeBuildList"/> struct.
    /// </summary>
    ...
    internal NativeBuildList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NativeBuildList DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.NativeBuildList.NativeBuildViewArray NativeBuilds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NativeBuildsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.NativeBuildList.NativeBuildViewArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in NativeBuildList left, in NativeBuildList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NativeBuildList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NativeBuildList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator NativeBuildList(JsonElement instance)
    {
        return NativeBuildList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NativeBuildList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NativeBuildList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<NativeBuildList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NativeBuildList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<NativeBuildList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NativeBuildList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<NativeBuildList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static NativeBuildList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<NativeBuildList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out NativeBuildList? result)
    {
        return JsonElementHelpers.TryParseValue<NativeBuildList>(ref reader, out result);
    }
...
#if NET
    static NativeBuildList IJsonElement<NativeBuildList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NativeBuildList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public NativeBuildList Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<NativeBuildList>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="NativeBuilds"/>.
        /// </summary>
        public const string NativeBuilds = "nativeBuilds";
        ...
        /// Gets the JSON property name for <see cref="NativeBuilds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> NativeBuildsUtf8 => "nativeBuilds"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="NativeBuilds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> NativeBuilds => "nativeBuilds"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="NativeBuilds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> NativeBuilds => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x6E, 0x61, 0x74, 0x69, 0x76, 0x65, 0x42, 0x75, 0x69, 0x6C, 0x64, 0x73, 0x22];
