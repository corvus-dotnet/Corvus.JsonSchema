...
public readonly partial struct NativeBuildStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(NativeBuildStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NativeBuildStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NativeBuildStatus(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NativeBuildStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly NativeBuildStatus Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly NativeBuildStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<NativeBuildStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NativeBuildStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<NativeBuildStatus, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<NativeBuildStatus> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<NativeBuildStatus>();
        }
        finally
        {
