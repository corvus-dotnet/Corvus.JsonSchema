...
public readonly partial struct PostWorkspaceWorkflowsByIdGitCommitBody
{
        ...
        : IJsonElement<GitCommitPullRequest>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBasePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("base"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBaseNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("base"u8, buffer, out written);

            private const int RequiredOffsetForBase = 0;
            private const uint RequiredBitForBase = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForBase;
            private static readonly JsonSchemaPathProvider BaseSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/base"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider DraftSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/draft"u8, buffer, out written);
            ...
            private static void MatchBase(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.BaseUtf8,
                        evaluationPath: BaseSchemaEvaluationPath);
                ...
                requiredBitBuffer[RequiredOffsetForBase] |= RequiredBitForBase;
            }

            private static void MatchDraft(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.DraftUtf8,
                        evaluationPath: DraftSchemaEvaluationPath);
            ...
            private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.BaseUtf8, MatchBase),
                    (static () => JsonPropertyNames.DraftUtf8, MatchDraft),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1workspace~1workflows~1{id}~1git~1commit/post/requestBody/content/application~1json/schema/properties/pullRequest"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/paths/~1workspace~1workflows~1{id}~1git~1commit/post/requestBody/content/application~1json/schema/properties/pullRequest";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1workspace~1workflows~1{id}~1git~1commit/post/requestBody/content/application~1json/schema/properties/pullRequest"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBasePresent, "base"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForBase] & RequiredBitForBase) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyBaseNotPresent, "base"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBasePresent, "base"u8, "required"u8);
