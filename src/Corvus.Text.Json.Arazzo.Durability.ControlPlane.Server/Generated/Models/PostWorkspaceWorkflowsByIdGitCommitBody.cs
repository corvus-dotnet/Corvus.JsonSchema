...
public readonly partial struct PostWorkspaceWorkflowsByIdGitCommitBody
    ...
    : IJsonElement<PostWorkspaceWorkflowsByIdGitCommitBody>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostWorkspaceWorkflowsByIdGitCommitBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostWorkspaceWorkflowsByIdGitCommitBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostWorkspaceWorkflowsByIdGitCommitBody DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdGitCommitBody.GitCommitPullRequest PullRequest
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PullRequestUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdGitCommitBody.GitCommitPullRequest value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostWorkspaceWorkflowsByIdGitCommitBody left, in PostWorkspaceWorkflowsByIdGitCommitBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostWorkspaceWorkflowsByIdGitCommitBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostWorkspaceWorkflowsByIdGitCommitBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostWorkspaceWorkflowsByIdGitCommitBody(JsonElement instance)
    {
        return PostWorkspaceWorkflowsByIdGitCommitBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdGitCommitBody From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdGitCommitBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdGitCommitBody>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdGitCommitBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdGitCommitBody>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdGitCommitBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdGitCommitBody>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static PostWorkspaceWorkflowsByIdGitCommitBody ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdGitCommitBody>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostWorkspaceWorkflowsByIdGitCommitBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostWorkspaceWorkflowsByIdGitCommitBody>(ref reader, out result);
    }
...
#if NET
    static PostWorkspaceWorkflowsByIdGitCommitBody IJsonElement<PostWorkspaceWorkflowsByIdGitCommitBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostWorkspaceWorkflowsByIdGitCommitBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostWorkspaceWorkflowsByIdGitCommitBody Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostWorkspaceWorkflowsByIdGitCommitBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostWorkspaceWorkflowsByIdGitCommitBody>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="PullRequest"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="PullRequest"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PullRequestUtf8 => "pullRequest"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="PullRequest"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PullRequest => "pullRequest"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="PullRequest"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PullRequest => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x75, 0x6C, 0x6C, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22];
    }
}
