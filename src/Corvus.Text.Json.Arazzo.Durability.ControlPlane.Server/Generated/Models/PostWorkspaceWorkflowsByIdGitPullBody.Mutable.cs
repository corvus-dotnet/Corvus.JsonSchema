...
public readonly partial struct PostWorkspaceWorkflowsByIdGitPullBody
{
    ...
    public static ParsedJsonDocument<PostWorkspaceWorkflowsByIdGitPullBody> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source expectedEtag, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source refValue = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
