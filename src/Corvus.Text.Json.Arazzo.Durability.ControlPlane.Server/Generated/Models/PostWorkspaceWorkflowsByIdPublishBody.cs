...
public readonly partial struct PostWorkspaceWorkflowsByIdPublishBody
#if NET8_0_OR_GREATER
    : IJsonElement<PostWorkspaceWorkflowsByIdPublishBody>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostWorkspaceWorkflowsByIdPublishBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostWorkspaceWorkflowsByIdPublishBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostWorkspaceWorkflowsByIdPublishBody DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the (optional) <c>requireScenarios</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Refuse to publish when any scenario fails (or when validation reports errors).
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdPublishBody.RequireScenariosEntity RequireScenarios
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequireScenariosUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdPublishBody.RequireScenariosEntity value))
            {
                return value;
            }

            return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdPublishBody.RequireScenariosEntity.DefaultInstance;
        }
    }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdPublishBody.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdPublishBody.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostWorkspaceWorkflowsByIdPublishBody left, in PostWorkspaceWorkflowsByIdPublishBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostWorkspaceWorkflowsByIdPublishBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostWorkspaceWorkflowsByIdPublishBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostWorkspaceWorkflowsByIdPublishBody(JsonElement instance)
    {
        return PostWorkspaceWorkflowsByIdPublishBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdPublishBody From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdPublishBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdPublishBody>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdPublishBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdPublishBody>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostWorkspaceWorkflowsByIdPublishBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdPublishBody>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static PostWorkspaceWorkflowsByIdPublishBody ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostWorkspaceWorkflowsByIdPublishBody>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostWorkspaceWorkflowsByIdPublishBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostWorkspaceWorkflowsByIdPublishBody>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PostWorkspaceWorkflowsByIdPublishBody(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PostWorkspaceWorkflowsByIdPublishBody IJsonElement<PostWorkspaceWorkflowsByIdPublishBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostWorkspaceWorkflowsByIdPublishBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PostWorkspaceWorkflowsByIdPublishBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PostWorkspaceWorkflowsByIdPublishBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PostWorkspaceWorkflowsByIdPublishBody Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PostWorkspaceWorkflowsByIdPublishBody>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PostWorkspaceWorkflowsByIdPublishBody"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PostWorkspaceWorkflowsByIdPublishBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostWorkspaceWorkflowsByIdPublishBody>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="RequireScenarios"/>.
        /// </summary>
        public const string RequireScenarios = "requireScenarios";
        ...
        /// Gets the JSON property name for <see cref="RequireScenarios"/>.
        /// </summary>
        public static ReadOnlySpan<byte> RequireScenariosUtf8 => "requireScenarios"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="RequireScenarios"/>.
        /// </summary>
        public static ReadOnlySpan<byte> RequireScenarios => "requireScenarios"u8;
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="RequireScenarios"/>.
        /// </summary>
        public static ReadOnlySpan<byte> RequireScenarios => [0x25, 0x01, 0x00, 0x00, 0x22, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x53, 0x63, 0x65, 0x6E, 0x61, 0x72, 0x69, 0x6F, 0x73, 0x22];
