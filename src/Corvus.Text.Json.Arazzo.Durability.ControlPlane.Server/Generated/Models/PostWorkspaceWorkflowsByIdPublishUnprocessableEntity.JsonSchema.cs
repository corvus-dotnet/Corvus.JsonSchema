...
public readonly partial struct PostWorkspaceWorkflowsByIdPublishUnprocessableEntity
    : IJsonElement<PostWorkspaceWorkflowsByIdPublishUnprocessableEntity>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReasonPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("reason"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReasonNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("reason"u8, buffer, out written);

        private const int RequiredOffsetForReason = 0;
        private const uint RequiredBitForReason = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForReason;
        ...
        private static void MatchDiagnostics(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.WorkflowDiagnosticArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchReason(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PostWorkspaceWorkflowsByIdPublishUnprocessableEntity.ReasonEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForReason] |= RequiredBitForReason;
        }
        ...
        private static void MatchSuite(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioSuiteReport.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioSuiteReport.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1workspace~1workflows~1{id}~1publish/post/responses/422/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1workspace~1workflows~1{id}~1publish/post/responses/422/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1workspace~1workflows~1{id}~1publish/post/responses/422/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReasonPresent, "reason"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForReason] & RequiredBitForReason) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyReasonNotPresent, "reason"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReasonPresent, "reason"u8, "required"u8);
