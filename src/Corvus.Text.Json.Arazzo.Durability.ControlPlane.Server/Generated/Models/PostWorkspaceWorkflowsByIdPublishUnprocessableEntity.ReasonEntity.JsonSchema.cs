...
public readonly partial struct PostWorkspaceWorkflowsByIdPublishUnprocessableEntity
{
        ...
        : IJsonElement<ReasonEntity>
    {
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1workspace~1workflows~1{id}~1publish/post/responses/422/content/application~1json/schema/properties/reason"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("validation"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("scenarios"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
