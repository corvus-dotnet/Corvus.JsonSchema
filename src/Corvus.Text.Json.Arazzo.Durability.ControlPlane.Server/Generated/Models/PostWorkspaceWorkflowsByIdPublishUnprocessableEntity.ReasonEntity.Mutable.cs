...
public readonly partial struct PostWorkspaceWorkflowsByIdPublishUnprocessableEntity
{
    ...
    public readonly partial struct ReasonEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ReasonEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ReasonEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReasonEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ReasonEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReasonEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ReasonEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ReasonEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ReasonEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ReasonEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ReasonEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ReasonEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ReasonEntity>(_idx);
            }
            ...
            /// <param name="matchValidation">Match 1st item.</param>
            /// <param name="matchScenarios">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchValidation,
                Func<TContext, TResult> matchScenarios,
...
#endif
            {
                ...
                {
                    return matchValidation(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchScenarios(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchValidation,
                Func<TResult> matchScenarios,
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ReasonEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ReasonEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ReasonEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ReasonEntity>();
            }
            finally
            {
