...
/// <remarks>
/// <para>
/// The begin-auth handshake for a connected provider (ADR 0052): navigate the browser to authorizeUrl; the state round-trips through the provider to the callback, where it identifies the principal.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct ProviderAuthStart
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ProviderAuthStart instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ProviderAuthStart"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProviderAuthStart(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>authorizeUrl</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// The provider authorize URL to navigate to.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable AuthorizeUrl
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorizeUrlUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// The single-use, principal-bound state embedded in authorizeUrl.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable State
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StateUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ProviderAuthStart(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>authorizeUrl</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAuthorizeUrl(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("authorizeUrl");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorizeUrlUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AuthorizeUrl, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetState(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProviderAuthStart.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ProviderAuthStart"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ProviderAuthStart"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ProviderAuthStart Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ProviderAuthStart>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ProviderAuthStart"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ProviderAuthStart Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ProviderAuthStart>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProviderAuthStart.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(ProviderAuthStart instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProviderAuthStart.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ProviderAuthStart"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source authorizeUrl,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source state)
        {
            authorizeUrl.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AuthorizeUrl, ref builder);
        ...
        /// Creates an instance of a <see cref="ProviderAuthStart"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source authorizeUrl, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source state)
        {
            Create(ref _builder, authorizeUrl, state);
        }
    ...
    /// </summary>
    /// <param name="authorizeUrl">The value of the <c>"authorizeUrl"</c> property.</param>
    /// <param name="state">The value of the <c>"state"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source authorizeUrl, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source state)
    {
        return new Source(authorizeUrl, state);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="authorizeUrl">The value of the property.</param>
    /// <param name="state">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source authorizeUrl, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source state, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(authorizeUrl, state);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ProviderAuthStart, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ProviderAuthStart> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ProviderAuthStart>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ProviderAuthStart> Create<TContext>(
    ...
    public static ParsedJsonDocument<ProviderAuthStart> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source authorizeUrl, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source state, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
