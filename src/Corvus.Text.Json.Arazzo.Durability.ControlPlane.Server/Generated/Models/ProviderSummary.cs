...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProviderSummary.JsonStringArray Hosts
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HostsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProviderSummary.JsonStringArray value))
            {
                return value;
            }
