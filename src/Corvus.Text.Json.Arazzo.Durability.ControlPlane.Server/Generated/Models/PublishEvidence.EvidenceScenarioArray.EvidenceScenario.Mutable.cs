...
public readonly partial struct PublishEvidence
{
    ...
    public readonly partial struct EvidenceScenarioArray
    {
        ...
        public readonly partial struct EvidenceScenario
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EvidenceScenario instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EvidenceScenario"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EvidenceScenario(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>pathSummary</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable PathSummary
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathSummaryUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EvidenceScenario(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>pathSummary</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPathSummary(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PathSummaryUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathSummaryUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PathSummary, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>pathSummary</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemovePathSummary()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PathSummaryUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EvidenceScenario.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EvidenceScenario"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EvidenceScenario"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EvidenceScenario Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EvidenceScenario>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EvidenceScenario"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EvidenceScenario Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EvidenceScenario>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PublishEvidence.EvidenceScenarioArray.EvidenceScenario.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(EvidenceScenario instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PublishEvidence.EvidenceScenarioArray.EvidenceScenario.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="EvidenceScenario"/>.
                /// </summary>
                internal static void Create(
                    ...
                    in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source pathSummary = default)
                {
                    ...
                    pathSummary.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PathSummary, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source pathSummary = default)
                {
                    Create(ref _builder, name, outcome, passed, pathSummary);
                }
            ...
            /// <param name="pathSummary">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source name, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source outcome, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source pathSummary = default, int initialCapacity = 30)
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(name, outcome, passed, pathSummary);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<EvidenceScenario, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EvidenceScenario> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EvidenceScenario>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<EvidenceScenario> Create<TContext>(
            ...
            public static ParsedJsonDocument<EvidenceScenario> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source name, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source outcome, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source pathSummary = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
