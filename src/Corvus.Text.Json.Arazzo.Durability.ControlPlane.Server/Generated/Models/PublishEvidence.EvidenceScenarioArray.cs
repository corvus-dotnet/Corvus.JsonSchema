...
public readonly partial struct PublishEvidence
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PublishEvidence.EvidenceScenarioArray.EvidenceScenario this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PublishEvidence.EvidenceScenarioArray.EvidenceScenario>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PublishEvidence.EvidenceScenarioArray.EvidenceScenario> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PublishEvidence.EvidenceScenarioArray.EvidenceScenario>(_parent, _idx);
        }
