...
public readonly partial struct PurgeResult
    : IJsonElement<PurgeResult>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPurgedCountPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("purgedCount"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPurgedCountNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("purgedCount"u8, buffer, out written);

        private const int RequiredOffsetForPurgedCount = 0;
        private const uint RequiredBitForPurgedCount = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForPurgedCount;
        private static readonly JsonSchemaPathProvider PurgedCountSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/purgedCount"u8, buffer, out written);

        private static void MatchPurgedCount(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.PurgedCountUtf8,
                    evaluationPath: PurgedCountSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForPurgedCount] |= RequiredBitForPurgedCount;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.PurgedCountUtf8))
            {
                matcher = MatchPurgedCount;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/PurgeResult"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/PurgeResult";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/PurgeResult"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPurgedCountPresent, "purgedCount"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForPurgedCount] & RequiredBitForPurgedCount) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyPurgedCountNotPresent, "purgedCount"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPurgedCountPresent, "purgedCount"u8, "required"u8);
