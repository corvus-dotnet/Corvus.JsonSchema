...
public readonly partial struct PurgeResult
{
...
#endif
    {
        ...
        public void SetPurgedCount(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source purgedCount)
    {
