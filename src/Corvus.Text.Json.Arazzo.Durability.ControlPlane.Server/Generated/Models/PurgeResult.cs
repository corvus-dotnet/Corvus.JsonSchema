...
#endif
{
    ...
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger PurgedCount
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PurgedCountUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger value))
            {
                return value;
            }
