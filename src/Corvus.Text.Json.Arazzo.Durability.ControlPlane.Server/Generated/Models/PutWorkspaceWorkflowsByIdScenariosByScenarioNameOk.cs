...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk"/> struct.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario Scenario
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScenarioUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets a <see cref="PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PutWorkspaceWorkflowsByIdScenariosByScenarioNameOk"/> that lives for the lifetime of its
