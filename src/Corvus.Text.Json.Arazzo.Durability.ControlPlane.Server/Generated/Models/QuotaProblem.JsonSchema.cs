...
/// <remarks>
/// <para>
/// A capacity rejection, naming the limit and the counter it was measured against so a caller can act on the right dimension rather than guessing. Shaped identically to the runner API&#39;s QuotaProblem so one client shape reads both surfaces.
/// </para>
/// </remarks>
    ...
    : IJsonElement<QuotaProblem>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
        {
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
        ...
        private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
        {
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonUri.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext6);
