...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QuotaProblem"/> struct.
    /// </summary>
    ...
    internal QuotaProblem(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static QuotaProblem DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString Counter
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CounterUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString Instance
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InstanceUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString Quota
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuotaUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonUri Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonUri value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in QuotaProblem left, in QuotaProblem right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in QuotaProblem left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(QuotaProblem instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator QuotaProblem(JsonElement instance)
    {
        return QuotaProblem.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static QuotaProblem From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static QuotaProblem ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<QuotaProblem>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static QuotaProblem ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<QuotaProblem>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static QuotaProblem ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<QuotaProblem>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static QuotaProblem ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<QuotaProblem>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out QuotaProblem? result)
    {
        return JsonElementHelpers.TryParseValue<QuotaProblem>(ref reader, out result);
    }
...
#if NET
    static QuotaProblem IJsonElement<QuotaProblem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"QuotaProblem: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Counter"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Counter"/>.
        /// </summary>
        public static ReadOnlySpan<byte> CounterUtf8 => "counter"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Counter"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Counter => "counter"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Quota"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Quota => "quota"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Counter"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Counter => [0x95, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x75, 0x6E, 0x74, 0x65, 0x72, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Quota"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Quota => [0x75, 0x00, 0x00, 0x00, 0x22, 0x71, 0x75, 0x6F, 0x74, 0x61, 0x22];
