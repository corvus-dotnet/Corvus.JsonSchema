...
public readonly partial struct ResolvedExecutionBudget
#if NET8_0_OR_GREATER
    : IJsonElement<ResolvedExecutionBudget>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    internal ResolvedExecutionBudget(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ResolvedExecutionBudget DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the <c>maxResponseBytes</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// The largest response body a single step may read, in bytes.
    /// </para>
    /// <para>
    ...
    /// <summary>
    /// Gets the <c>maxSteps</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
    /// </para>
    /// <para>
    /// Fuel: the maximum number of step executions, retries and revisits counted.
    /// </para>
    /// <para>
    ...
    /// <summary>
    /// Gets the <c>maxSubWorkflowDepth</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
    ...
    /// <summary>
    /// Gets the <c>retryAfterCeilingSeconds</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
    ...
    /// <summary>
    /// Gets the <c>stepTimeoutSeconds</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
    /// </para>
    /// <para>
    /// The longest a single step&#39;s request may take, in seconds.
    /// </para>
    /// <para>
    ...
    /// <summary>
    /// Gets the <c>wallClockSeconds</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
    ...
    public static bool operator ==(in ResolvedExecutionBudget left, in ResolvedExecutionBudget right)
    {
    ...
    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.operator ==(JsonElement, JsonElement)"/>
    public static bool operator ==(in ResolvedExecutionBudget left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ResolvedExecutionBudget instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ResolvedExecutionBudget(JsonElement instance)
    {
        return ResolvedExecutionBudget.From(instance);
    }

    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.From{T}(in T)"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ResolvedExecutionBudget From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ResolvedExecutionBudget ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ResolvedExecutionBudget>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ResolvedExecutionBudget ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ResolvedExecutionBudget>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ResolvedExecutionBudget ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ResolvedExecutionBudget>(json, options);
        #pragma warning restore CS0618
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static ResolvedExecutionBudget ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ResolvedExecutionBudget>(ref reader);
        #pragma warning restore CS0618
    }

    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.TryParseValue(ref Utf8JsonReader, out JsonElement?)"/>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ResolvedExecutionBudget? result)
    {
        return JsonElementHelpers.TryParseValue<ResolvedExecutionBudget>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ResolvedExecutionBudget(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ResolvedExecutionBudget IJsonElement<ResolvedExecutionBudget>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ResolvedExecutionBudget: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ResolvedExecutionBudget Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<ResolvedExecutionBudget>(_idx);
    }

    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Freeze()"/>
    public ResolvedExecutionBudget Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<ResolvedExecutionBudget>(_idx);
        }
