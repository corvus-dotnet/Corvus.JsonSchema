...
public readonly partial struct ResolvedGrantee
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ResolvedGrantee instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ResolvedGrantee"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ResolvedGrantee(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Mutable Identity
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdentityUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Mutable SourceValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SourceValueUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetComplete(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("complete");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetIdentity<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ResolvedGrantee.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly ResolvedGrantee Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly ResolvedGrantee Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ResolvedGrantee>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Source _createArg4;
        ...
        public static implicit operator Source(ResolvedGrantee instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Source<TContext> _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Source _createArg4;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg5;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg6;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ResolvedGrantee"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source complete,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Source identity,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Source source,
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default)
        {
            Create(ref _builder, complete, identity, kind, source, value, label);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source complete,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Source<TContext> identity,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Source source,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default)
        ...
        #endif
        {
            Create(context, ref _builder, complete, identity, kind, source, value, label);
        }
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source complete, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Source<TContext> identity, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Source source, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default)
        ...
        #endif
    {
        return new Source<TContext>(context, complete, identity, kind, source, value, label);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source complete, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Source identity, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Source source, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(complete, identity, kind, source, value, label);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, complete, identity, kind, source, value, label);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ResolvedGrantee, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ResolvedGrantee> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ResolvedGrantee>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ResolvedGrantee> Create<TContext>(
    ...
    public static ParsedJsonDocument<ResolvedGrantee> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source complete, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Source identity, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Source source, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ResolvedGrantee> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source complete, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.AdministratorIdentityArray.Source<TContext> identity, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GranteeKind.Source kind, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedGrantee.SourceEntity.Source source, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source label = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
