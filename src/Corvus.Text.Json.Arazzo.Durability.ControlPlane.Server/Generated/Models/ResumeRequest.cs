...
public readonly partial struct ResumeRequest : ResumeRequest.IUnionMembers
{
    ...
    {
        /// <summary>Creates an instance of the union from a <see cref="Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume"/>.</summary>
        /// <param name="value">The value.</param>
        /// <returns>The value as a <see cref="ResumeRequest"/>.</returns>
        static ResumeRequest Create(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume value) => From(value);
        /// <summary>Creates an instance of the union from a <see cref="Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume"/>.</summary>
        /// <param name="value">The value.</param>
        /// <returns>The value as a <see cref="ResumeRequest"/>.</returns>
        static ResumeRequest Create(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume value) => From(value);
        /// <summary>Creates an instance of the union from a <see cref="Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume"/>.</summary>
        /// <param name="value">The value.</param>
        /// <returns>The value as a <see cref="ResumeRequest"/>.</returns>
        static ResumeRequest Create(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume value) => From(value);
        /// <summary>Creates an instance of the union from a <see cref="Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume"/>.</summary>
        /// <param name="value">The value.</param>
        /// <returns>The value as a <see cref="ResumeRequest"/>.</returns>
        static ResumeRequest Create(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume value) => From(value);
        ...
        /// <summary>Gets the value as a <see cref="Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume"/> if it matches that case.</summary>
        ...
        bool TryGetValue(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume value);

        /// <summary>Gets the value as a <see cref="Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume"/> if it matches that case.</summary>
        /// <param name="value">The value as the case type, if it matches.</param>
        /// <returns><see langword="true"/> if the value matches the case.</returns>
        bool TryGetValue(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume value);

        /// <summary>Gets the value as a <see cref="Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume"/> if it matches that case.</summary>
        /// <param name="value">The value as the case type, if it matches.</param>
        /// <returns><see langword="true"/> if the value matches the case.</returns>
        bool TryGetValue(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume value);

        /// <summary>Gets the value as a <see cref="Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume"/> if it matches that case.</summary>
        /// <param name="value">The value as the case type, if it matches.</param>
        /// <returns><see langword="true"/> if the value matches the case.</returns>
        bool TryGetValue(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume value);
    }
    ...
    object? IUnionMembers.Value
    {
        get
        {
            if (Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume.JsonSchema.Evaluate(_parent, _idx))
            {
                return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume.From(this);
            }

            if (Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume.JsonSchema.Evaluate(_parent, _idx))
            {
                return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume.From(this);
            }

            if (Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume.JsonSchema.Evaluate(_parent, _idx))
            {
                return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume.From(this);
            }

            if (Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume.JsonSchema.Evaluate(_parent, _idx))
            {
                return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume.From(this);
            }
    ...
    bool IUnionMembers.HasValue =>
        Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume.JsonSchema.Evaluate(_parent, _idx) ||
        Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume.JsonSchema.Evaluate(_parent, _idx) ||
        Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume.JsonSchema.Evaluate(_parent, _idx) ||
        Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume.JsonSchema.Evaluate(_parent, _idx);

    /// <inheritdoc/>
    bool IUnionMembers.TryGetValue(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume value)
    {
        if (Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume.JsonSchema.Evaluate(_parent, _idx))
        {
            value = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryFaultedStepResume.From(this);
            return true;
        }
    ...
    /// <inheritdoc/>
    bool IUnionMembers.TryGetValue(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume value)
    {
        if (Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume.JsonSchema.Evaluate(_parent, _idx))
        {
            value = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RewindResume.From(this);
            return true;
        }
    ...
    /// <inheritdoc/>
    bool IUnionMembers.TryGetValue(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume value)
    {
        if (Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume.JsonSchema.Evaluate(_parent, _idx))
        {
            value = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SkipResume.From(this);
            return true;
        }
    ...
    /// <inheritdoc/>
    bool IUnionMembers.TryGetValue(out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume value)
    {
        if (Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume.JsonSchema.Evaluate(_parent, _idx))
        {
            value = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.StatePatchResume.From(this);
            return true;
        }
