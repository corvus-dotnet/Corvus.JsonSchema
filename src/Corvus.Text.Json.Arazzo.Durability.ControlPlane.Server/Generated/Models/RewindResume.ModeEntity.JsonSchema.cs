...
public readonly partial struct RewindResume
{
        ...
        : IJsonElement<ModeEntity>
    {
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/RewindResume/properties/mode"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "Rewind"u8, "Rewind", "const"u8, ref context);
                }
                else
                {
                    context.EvaluatedKeyword(false, "Rewind", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                }
            }
