...
public readonly partial struct Runner
{
        ...
        : IJsonElement<RunnerSecurityTagArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/Runner/properties/reachTags"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/Runner/properties/reachTags";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/Runner/properties/reachTags"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerSecurityTag.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerSecurityTag.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
