...
public readonly partial struct Runner
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RunnerSecurityTagArray"/> struct.
        /// </summary>
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerSecurityTag this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerSecurityTag>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerSecurityTag> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerSecurityTag>(_parent, _idx);
        }
