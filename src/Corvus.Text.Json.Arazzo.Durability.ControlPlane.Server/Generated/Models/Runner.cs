...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Runner.IsolationModelEntity IsolationModel
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsolationModelUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Runner.IsolationModelEntity value))
            {
                return value;
            }
