...
public readonly partial struct RunnerAuthorizationGrant
{
    ...
    public readonly partial struct ExpectedPrincipalEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ExpectedPrincipalEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExpectedPrincipalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExpectedPrincipalEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExpectedPrincipalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ExpectedPrincipalEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ExpectedPrincipalEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExpectedPrincipalEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ExpectedPrincipalEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ExpectedPrincipalEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ExpectedPrincipalEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ExpectedPrincipalEntity>();
            }
            finally
            {
