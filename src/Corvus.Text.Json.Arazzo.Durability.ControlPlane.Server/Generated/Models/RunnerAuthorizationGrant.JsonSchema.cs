    ...
    : IJsonElement<RunnerAuthorizationGrant>
{
    ...
    {
        private static readonly JsonSchemaPathProvider ExpectedPrincipalSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/expectedPrincipal"u8, buffer, out written);
        ...
        private static void MatchExpectedPrincipal(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ExpectedPrincipalUtf8,
                    evaluationPath: ExpectedPrincipalSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                (static () => JsonPropertyNames.ExpectedPrincipalUtf8, MatchExpectedPrincipal),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/RunnerAuthorizationGrant"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/RunnerAuthorizationGrant";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/RunnerAuthorizationGrant"u8;
