...
public readonly partial struct RunnerAuthorizationGrant
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Mutable ExpectedPrincipal
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpectedPrincipalUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetExpectedPrincipal(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source expectedPrincipal = default,
        ...
        /// Creates an instance of a <see cref="RunnerAuthorizationGrant"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source expectedPrincipal = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source expectedPrincipal = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerAuthorizationGrant.ExpectedPrincipalEntity.Source expectedPrincipal = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source reason = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
