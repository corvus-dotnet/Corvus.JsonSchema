    ...
    : IJsonElement<RunnerHostedVersion>
{
    public static partial class JsonSchema
    {
        ...
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLoadedPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("loaded"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLoadedNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("loaded"u8, buffer, out written);

        private const int RequiredOffsetForLoaded = 0;
        private const uint RequiredBitForLoaded = 0b00000000000000000000000000000100;
        ...
        private const uint RequiredBitForVersionNumber = 0b00000000000000000000000000001000;

        private const uint RequiredBitMask0 =
            RequiredBitForBaseWorkflowId | RequiredBitForHash | RequiredBitForLoaded | RequiredBitForVersionNumber;
        ...
        private static readonly JsonSchemaPathProvider LoadedSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/loaded"u8, buffer, out written);
        ...
        private static void MatchLoaded(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.LoadedUtf8,
                    evaluationPath: LoadedSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForLoaded] |= RequiredBitForLoaded;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.LoadedUtf8, MatchLoaded),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/RunnerHostedVersion"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/RunnerHostedVersion";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/RunnerHostedVersion"u8;
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyLoadedPresent, "loaded"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyVersionNumberPresent, "versionNumber"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForLoaded] & RequiredBitForLoaded) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyLoadedNotPresent, "loaded"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyLoadedPresent, "loaded"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 3, RequiredPropertyVersionNumberNotPresent, "versionNumber"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyVersionNumberPresent, "versionNumber"u8, "required"u8);
