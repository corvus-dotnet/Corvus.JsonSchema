...
public readonly partial struct RunnerSecurityTag
{
...
#endif
    {
        ...
        public static explicit operator Mutable(RunnerSecurityTag instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="RunnerSecurityTag"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RunnerSecurityTag(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RunnerSecurityTag.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly RunnerSecurityTag Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly RunnerSecurityTag Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<RunnerSecurityTag>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerSecurityTag.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(RunnerSecurityTag instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunnerSecurityTag.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="RunnerSecurityTag"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<RunnerSecurityTag, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<RunnerSecurityTag> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<RunnerSecurityTag>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<RunnerSecurityTag> Create<TContext>(
    ...
    public static ParsedJsonDocument<RunnerSecurityTag> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source key, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
