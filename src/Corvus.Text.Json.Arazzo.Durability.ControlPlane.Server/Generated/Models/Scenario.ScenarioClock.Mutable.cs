...
public readonly partial struct Scenario
{
    ...
    public readonly partial struct ScenarioClock
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ScenarioClock instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ScenarioClock"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ScenarioClock(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Mutable AutoAdvance
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAdvanceUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ScenarioClock(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>autoAdvance</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetAutoAdvance(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AutoAdvanceUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAdvanceUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AutoAdvance, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>autoAdvance</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveAutoAdvance()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AutoAdvanceUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ScenarioClock.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ScenarioClock"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ScenarioClock"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ScenarioClock Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ScenarioClock>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ScenarioClock"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ScenarioClock Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ScenarioClock>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Source _createArg1;
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(ScenarioClock instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ScenarioClock"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Source autoAdvance = default)
            {
                autoAdvance.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AutoAdvance, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="ScenarioClock"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Source autoAdvance = default)
            {
                Create(ref _builder, autoAdvance);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// </summary>
        /// <param name="autoAdvance">The value of the <c>"autoAdvance"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Source autoAdvance = default)
        {
            return new Source(autoAdvance);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="autoAdvance">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Source autoAdvance = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(autoAdvance);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ScenarioClock, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ScenarioClock> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ScenarioClock>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ScenarioClock> Create<TContext>(
        ...
        public static ParsedJsonDocument<ScenarioClock> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.Source autoAdvance = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
