...
public readonly partial struct Scenario
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity AutoAdvance
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAdvanceUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity value))
                {
                    return value;
                }

                return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock.AutoAdvanceEntity.DefaultInstance;
            }
        }
