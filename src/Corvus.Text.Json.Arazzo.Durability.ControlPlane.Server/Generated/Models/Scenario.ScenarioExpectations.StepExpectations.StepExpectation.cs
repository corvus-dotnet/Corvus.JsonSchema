    ...
    public readonly partial struct ScenarioExpectations
    {
        ...
        public readonly partial struct StepExpectations
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger Attempts
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AttemptsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean Reached
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReachedUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean value))
                        {
                            return value;
                        }
