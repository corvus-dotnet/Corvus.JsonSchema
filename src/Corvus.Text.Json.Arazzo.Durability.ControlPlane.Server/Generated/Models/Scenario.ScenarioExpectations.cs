...
public readonly partial struct Scenario
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioExpectations"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ScenarioExpectations(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ScenarioExpectations DefaultInstance { get; }
        ...
        /// <summary>
        /// Gets the (optional) <c>outcome</c> property.
        /// </summary>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.OutcomeEntity Outcome
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutcomeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.OutcomeEntity value))
                {
                    return value;
                }
        ...
        /// <remarks>
        /// <para>
        /// Criteria evaluated against the completed run&#39;s workflow outputs ($outputs).
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.OutputExpectationArray Outputs
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutputsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.OutputExpectationArray value))
                {
                    return value;
                }
        ...
        /// <remarks>
        /// <para>
        /// Expected step visits, in order.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.JsonStringArray Path
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.JsonStringArray value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>pathMode</c> property.
        /// </summary>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.PathModeEntity PathMode
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathModeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.PathModeEntity value))
                {
                    return value;
                }

                return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.PathModeEntity.DefaultInstance;
            }
        }

        /// <summary>
        /// Gets the (optional) <c>steps</c> property.
        /// StepExpectations
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.StepExpectations Steps
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StepsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations.StepExpectations value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ScenarioExpectations left, in ScenarioExpectations right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ScenarioExpectations left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ScenarioExpectations instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ScenarioExpectations(JsonElement instance)
        {
            return ScenarioExpectations.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScenarioExpectations From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScenarioExpectations ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ScenarioExpectations>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScenarioExpectations ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ScenarioExpectations>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ScenarioExpectations ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ScenarioExpectations>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ScenarioExpectations ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ScenarioExpectations>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ScenarioExpectations? result)
        {
            return JsonElementHelpers.TryParseValue<ScenarioExpectations>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ScenarioExpectations(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ScenarioExpectations IJsonElement<ScenarioExpectations>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ScenarioExpectations: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ScenarioExpectations"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ScenarioExpectations"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ScenarioExpectations Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ScenarioExpectations>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ScenarioExpectations"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ScenarioExpectations Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ScenarioExpectations>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="PathMode"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="PathMode"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PathModeUtf8 => "pathMode"u8;
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="PathMode"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PathMode => "pathMode"u8;
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="PathMode"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PathMode => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x61, 0x74, 0x68, 0x4D, 0x6F, 0x64, 0x65, 0x22];
