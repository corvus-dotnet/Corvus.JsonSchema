    ...
    public readonly partial struct ScenarioTriggerArray
    {
        ...
        public readonly partial struct ScenarioTrigger
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ScenarioTrigger instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ScenarioTrigger"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ScenarioTrigger(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ScenarioTrigger.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ScenarioTrigger"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ScenarioTrigger"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ScenarioTrigger Clone()
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ScenarioTrigger"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ScenarioTrigger Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ScenarioTrigger>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioTriggerArray.ScenarioTrigger.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(ScenarioTrigger instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioTriggerArray.ScenarioTrigger.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ScenarioTrigger"/>.
                /// </summary>
            ...
            {
                return workspace.CreateBuilder<ScenarioTrigger, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ScenarioTrigger> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ScenarioTrigger>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ScenarioTrigger> Create<TContext>(
