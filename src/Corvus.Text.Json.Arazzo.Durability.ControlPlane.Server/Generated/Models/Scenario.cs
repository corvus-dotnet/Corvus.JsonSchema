...
#endif
{
    ...
    /// ScenarioClock
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock Clock
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ClockUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioClock value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations Expect
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpectUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioExpectations value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioMockArray Mocks
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MocksUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioMockArray value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioTriggerArray Triggers
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TriggersUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.Scenario.ScenarioTriggerArray value))
            {
                return value;
            }
