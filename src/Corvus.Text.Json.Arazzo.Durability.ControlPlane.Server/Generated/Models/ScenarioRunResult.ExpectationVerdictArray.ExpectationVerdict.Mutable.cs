...
public readonly partial struct ScenarioRunResult
{
    ...
    /// </summary>
    public readonly partial struct ExpectationVerdictArray
    {
        /// <summary>
        /// ExpectationVerdict
        /// </summary>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct ExpectationVerdict
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExpectationVerdict instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExpectationVerdict"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExpectationVerdict(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable Detail
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DetailUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// <para>
                /// outcome | path | output | step
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable Kind
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExpectationVerdict(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetDetail(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetKind(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExpectationVerdict.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExpectationVerdict"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExpectationVerdict"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExpectationVerdict Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExpectationVerdict>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExpectationVerdict"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExpectationVerdict Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExpectationVerdict>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(ExpectationVerdict instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ExpectationVerdict"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source kind,
                    in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed,
                    in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source detail = default)
                {
                ...
                public void Create(
                    ...
                    in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source detail = default)
                {
                    Create(ref _builder, kind, passed, detail);
                }
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source kind, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source detail = default)
            {
                return new Source(kind, passed, detail);
            }
            ...
            {
                return workspace.CreateBuilder<ExpectationVerdict, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExpectationVerdict> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExpectationVerdict>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ExpectationVerdict> Create<TContext>(
            ...
            public static ParsedJsonDocument<ExpectationVerdict> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source kind, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source detail = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
