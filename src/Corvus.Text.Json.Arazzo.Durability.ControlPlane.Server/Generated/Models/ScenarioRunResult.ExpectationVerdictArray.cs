...
public readonly partial struct ScenarioRunResult
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpectationVerdictArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ExpectationVerdictArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ExpectationVerdictArray DefaultInstance { get; }
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.ExpectationVerdict>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ExpectationVerdictArray left, in ExpectationVerdictArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ExpectationVerdictArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ExpectationVerdictArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ExpectationVerdictArray(JsonElement instance)
        {
            return ExpectationVerdictArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExpectationVerdictArray From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExpectationVerdictArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ExpectationVerdictArray>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExpectationVerdictArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ExpectationVerdictArray>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExpectationVerdictArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ExpectationVerdictArray>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ExpectationVerdictArray ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ExpectationVerdictArray>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ExpectationVerdictArray? result)
        {
            return JsonElementHelpers.TryParseValue<ExpectationVerdictArray>(ref reader, out result);
        }
...
#if NET
        static ExpectationVerdictArray IJsonElement<ExpectationVerdictArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ExpectationVerdictArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ExpectationVerdictArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ExpectationVerdictArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ExpectationVerdictArray>(_idx);
            }
