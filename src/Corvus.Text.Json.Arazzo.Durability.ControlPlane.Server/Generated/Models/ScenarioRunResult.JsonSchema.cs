    ...
    : IJsonElement<ScenarioRunResult>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyExpectationsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("expectations"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyExpectationsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("expectations"u8, buffer, out written);

        private const int RequiredOffsetForExpectations = 0;
        private const uint RequiredBitForExpectations = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitForPassed = 0b00000000000000000000000000000100;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyScenarioPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("scenario"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyScenarioNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("scenario"u8, buffer, out written);

        private const int RequiredOffsetForScenario = 0;
        private const uint RequiredBitForScenario = 0b00000000000000000000000000001000;

        private const uint RequiredBitMask0 =
            RequiredBitForExpectations | RequiredBitForOutcome | RequiredBitForPassed | RequiredBitForScenario;
        private static readonly JsonSchemaPathProvider ExpectationsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/expectations"u8, buffer, out written);
        ...
        private static readonly JsonSchemaPathProvider ScenarioSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/scenario"u8, buffer, out written);
        ...
        private static void MatchExpectations(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ExpectationsUtf8,
                    evaluationPath: ExpectationsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForExpectations] |= RequiredBitForExpectations;
        }
        ...
        private static void MatchScenario(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext3 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ScenarioUtf8,
                    evaluationPath: ScenarioSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForScenario] |= RequiredBitForScenario;
        }

        private static void MatchTrace(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.ExpectationsUtf8, MatchExpectations),
                (static () => JsonPropertyNames.OutcomeUtf8, MatchOutcome),
                (static () => JsonPropertyNames.PassedUtf8, MatchPassed),
                (static () => JsonPropertyNames.ScenarioUtf8, MatchScenario),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/ScenarioRunResult"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/ScenarioRunResult";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/ScenarioRunResult"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyExpectationsPresent, "expectations"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyOutcomePresent, "outcome"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyPassedPresent, "passed"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyScenarioPresent, "scenario"u8, "required"u8);
                    }
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForExpectations] & RequiredBitForExpectations) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyExpectationsNotPresent, "expectations"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyExpectationsPresent, "expectations"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyPassedNotPresent, "passed"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyPassedPresent, "passed"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForScenario] & RequiredBitForScenario) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 3, RequiredPropertyScenarioNotPresent, "scenario"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyScenarioPresent, "scenario"u8, "required"u8);
