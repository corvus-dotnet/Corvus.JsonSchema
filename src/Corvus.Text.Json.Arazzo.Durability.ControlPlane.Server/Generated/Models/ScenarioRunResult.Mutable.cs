...
public readonly partial struct ScenarioRunResult
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ScenarioRunResult instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ScenarioRunResult"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ScenarioRunResult(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Mutable Expectations
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpectationsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable Outcome
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutcomeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Mutable Passed
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PassedUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable Scenario
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScenarioUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Set the <c>expectations</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetExpectations(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("expectations");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpectationsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Expectations, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetExpectations<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOutcome(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>passed</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPassed(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("passed");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PassedUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Passed, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Set the <c>scenario</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScenario(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("scenario");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScenarioUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Scenario, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ScenarioRunResult.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ScenarioRunResult"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ScenarioRunResult"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ScenarioRunResult Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ScenarioRunResult"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ScenarioRunResult Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ScenarioRunResult>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source _createArg1;
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.Source _createArg5;
        ...
        public static implicit operator Source(ScenarioRunResult instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg4;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.Source<TContext> _createArg5;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source arg3, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg4, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.Source<TContext> arg5)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ScenarioRunResult"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source expectations,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source outcome,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source scenario,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.Source trace = default)
        {
            expectations.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Expectations, ref builder);
            outcome.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Outcome, ref builder);
            passed.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Passed, ref builder);
            scenario.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Scenario, ref builder);
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.Source trace = default)
        {
            Create(ref _builder, expectations, outcome, passed, scenario, trace);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source<TContext> expectations,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source outcome,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source scenario,
        ...
        #endif
        {
            Create(context, ref _builder, expectations, outcome, passed, scenario, trace);
        }
    ...
    /// </summary>
    /// <param name="expectations">The value of the <c>"expectations"</c> property.</param>
    /// <param name="outcome">The value of the <c>"outcome"</c> property.</param>
    /// <param name="passed">The value of the <c>"passed"</c> property.</param>
    /// <param name="scenario">The value of the <c>"scenario"</c> property.</param>
    /// <param name="trace">The value of the <c>"trace"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source expectations, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source outcome, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source scenario, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.Source trace = default)
    {
        return new Source(expectations, outcome, passed, scenario, trace);
    }
    ...
    /// <param name="trace">The value of the <c>"trace"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source<TContext> expectations, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source outcome, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source scenario, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.Source<TContext> trace = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, expectations, outcome, passed, scenario, trace);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="expectations">The value of the property.</param>
    /// <param name="outcome">The value of the property.</param>
    /// <param name="passed">The value of the property.</param>
    /// <param name="scenario">The value of the property.</param>
    /// <param name="trace">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source expectations, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source outcome, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source scenario, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.Source trace = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(expectations, outcome, passed, scenario, trace);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioRunResult.ExpectationVerdictArray.Source<TContext> expectations, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source outcome, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source passed, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source scenario, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.Source<TContext> trace = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, expectations, outcome, passed, scenario, trace);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ScenarioRunResult, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ScenarioRunResult> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ScenarioRunResult>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ScenarioRunResult> Create<TContext>(
