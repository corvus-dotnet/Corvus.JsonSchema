...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScheduleList.ScheduleArray Schedules
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchedulesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScheduleList.ScheduleArray value))
            {
                return value;
            }
