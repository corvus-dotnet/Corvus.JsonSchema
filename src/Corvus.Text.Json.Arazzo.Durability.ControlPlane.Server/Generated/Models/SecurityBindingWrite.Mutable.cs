...
public readonly partial struct SecurityBindingWrite
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SecurityBindingWrite instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SecurityBindingWrite"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SecurityBindingWrite(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingWrite.ResolutionOrderAscending.Mutable Order
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingWrite.ResolutionOrderAscending.Mutable value))
                {
                    return value;
                }

                return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingWrite.ResolutionOrderAscending.Mutable.DefaultInstance;
            }
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetClaimType(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetClaimValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrder(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingWrite.ResolutionOrderAscending.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPurge(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PurgeUtf8);
                _documentVersion = _parent.Version;
                return;
            }
        ...
        /// <summary>
        /// Remove the <c>purge</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemovePurge()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PurgeUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRead(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ReadUtf8);
                _documentVersion = _parent.Version;
                return;
            }
        ...
        /// <summary>
        /// Remove the <c>read</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveRead()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ReadUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWrite(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WriteUtf8);
                _documentVersion = _parent.Version;
                return;
            }
        ...
        /// <summary>
        /// Remove the <c>write</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveWrite()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WriteUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SecurityBindingWrite.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly SecurityBindingWrite Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly SecurityBindingWrite Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SecurityBindingWrite>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(SecurityBindingWrite instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="SecurityBindingWrite"/>.
        /// </summary>
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source purge = default,
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source description = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingWrite.ResolutionOrderAscending.Source order = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source<TContext> purge = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source<TContext> read = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source<TContext> write = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    {
        return workspace.CreateBuilder<SecurityBindingWrite, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SecurityBindingWrite> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SecurityBindingWrite>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SecurityBindingWrite> Create<TContext>(
    ...
    public static ParsedJsonDocument<SecurityBindingWrite> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source claimType, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingWrite.SecurityBindingClauseArray.Source additionalClauses = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source claimValue = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source description = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingWrite.ResolutionOrderAscending.Source order = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source purge = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source read = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source write = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SecurityBindingWrite> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source claimType, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingWrite.SecurityBindingClauseArray.Source<TContext> additionalClauses = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source claimValue = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source description = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingWrite.ResolutionOrderAscending.Source order = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source<TContext> purge = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source<TContext> read = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.Source<TContext> write = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
