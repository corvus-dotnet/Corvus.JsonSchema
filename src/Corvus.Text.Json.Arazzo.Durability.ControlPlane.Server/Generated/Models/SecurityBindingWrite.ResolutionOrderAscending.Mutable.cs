...
public readonly partial struct SecurityBindingWrite
{
    ...
    public readonly partial struct ResolutionOrderAscending
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ResolutionOrderAscending, Mutable>(ResolutionOrderAscending.DefaultInstance);
            ...
            public static explicit operator Mutable(ResolutionOrderAscending instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ResolutionOrderAscending"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ResolutionOrderAscending(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ResolutionOrderAscending.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ResolutionOrderAscending Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ResolutionOrderAscending Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ResolutionOrderAscending>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ResolutionOrderAscending instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ResolutionOrderAscending, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ResolutionOrderAscending> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ResolutionOrderAscending>();
            }
            finally
            {
