...
public readonly partial struct SecurityOrdering
    : IJsonElement<SecurityOrdering>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDimensionPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("dimension"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDimensionNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("dimension"u8, buffer, out written);

        private const int RequiredOffsetForDimension = 0;
        private const uint RequiredBitForDimension = 0b00000000000000000000000000000001;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLabelsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("labels"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLabelsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("labels"u8, buffer, out written);

        private const int RequiredOffsetForLabels = 0;
        private const uint RequiredBitForLabels = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForDimension | RequiredBitForLabels;
        ...
        private static void MatchDimensionValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            requiredBitBuffer[RequiredOffsetForDimension] |= RequiredBitForDimension;
        }

        private static void MatchLabels(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForLabels] |= RequiredBitForLabels;
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/SecurityOrdering"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/SecurityOrdering";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/SecurityOrdering"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDimensionPresent, "dimension"u8, "required"u8);
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLabelsPresent, "labels"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDimension] & RequiredBitForDimension) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDimensionNotPresent, "dimension"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDimensionPresent, "dimension"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForLabels] & RequiredBitForLabels) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyLabelsNotPresent, "labels"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLabelsPresent, "labels"u8, "required"u8);
