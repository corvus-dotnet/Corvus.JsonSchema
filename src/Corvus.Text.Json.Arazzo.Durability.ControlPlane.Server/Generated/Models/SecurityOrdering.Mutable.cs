...
/// <remarks>
/// <para>
/// An ordered tag dimension: one dimension&#39;s labels in ascending order, the ranking an ordered rule comparison (&lt;, &lt;=, &gt;, &gt;=) uses.
/// </para>
/// </remarks>
...
public readonly partial struct SecurityOrdering
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SecurityOrdering instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SecurityOrdering"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SecurityOrdering(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// The security-tag key (dimension), e.g. &#39;classification&#39;.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Mutable Labels
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SecurityOrdering(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDimensionValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("dimension");
            }
        ...
        public void SetLabels(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("labels");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetLabels<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SecurityOrdering.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SecurityOrdering"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SecurityOrdering"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly SecurityOrdering Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SecurityOrdering>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SecurityOrdering"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly SecurityOrdering Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SecurityOrdering>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source _createArg2;
        ...
        public static implicit operator Source(SecurityOrdering instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source<TContext> _createArg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="SecurityOrdering"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source dimension,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source labels)
        {
        ...
        /// Creates an instance of a <see cref="SecurityOrdering"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source dimension, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source labels)
        {
            Create(ref _builder, dimension, labels);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source dimension,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source<TContext> labels)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, dimension, labels);
        }
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source dimension, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source<TContext> labels)
        ...
        #endif
    {
        return new Source<TContext>(context, dimension, labels);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source dimension, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source labels, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(dimension, labels);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, dimension, labels);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<SecurityOrdering, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SecurityOrdering> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SecurityOrdering>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SecurityOrdering> Create<TContext>(
    ...
    public static ParsedJsonDocument<SecurityOrdering> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source dimension, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source labels, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SecurityOrdering> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source dimension, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray.Source<TContext> labels, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
