...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray Labels
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering.JsonStringArray value))
            {
                return value;
            }
