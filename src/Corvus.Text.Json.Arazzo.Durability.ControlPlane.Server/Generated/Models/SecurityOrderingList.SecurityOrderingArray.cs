...
public readonly partial struct SecurityOrderingList
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrdering>(_parent, _idx);
        }
