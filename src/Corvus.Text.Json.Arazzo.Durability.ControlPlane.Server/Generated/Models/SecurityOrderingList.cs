...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrderingList.SecurityOrderingArray Orderings
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderingsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityOrderingList.SecurityOrderingArray value))
            {
                return value;
            }
