...
public readonly partial struct SecurityRuleCreate
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SecurityRuleCreate instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SecurityRuleCreate"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SecurityRuleCreate(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SecurityRuleCreate(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SecurityRuleCreate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SecurityRuleCreate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SecurityRuleCreate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly SecurityRuleCreate Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SecurityRuleCreate>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SecurityRuleCreate"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly SecurityRuleCreate Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SecurityRuleCreate>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleCreate.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(SecurityRuleCreate instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleCreate.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="SecurityRuleCreate"/>.
        /// </summary>
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source description = default)
        {
            Create(ref _builder, expression, name, description);
        }
    ...
    {
        return workspace.CreateBuilder<SecurityRuleCreate, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SecurityRuleCreate> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SecurityRuleCreate>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SecurityRuleCreate> Create<TContext>(
    ...
    public static ParsedJsonDocument<SecurityRuleCreate> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source expression, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source name, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source description = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
