...
public readonly partial struct SecurityRuleList
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SecurityRuleList instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SecurityRuleList"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SecurityRuleList(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Mutable Rules
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RulesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Set the <c>rules</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRules(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("rules");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RulesUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Rules, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRules<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SecurityRuleList.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly SecurityRuleList Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly SecurityRuleList Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SecurityRuleList>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(SecurityRuleList instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Source rules, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
    {
    ...
    {
        return workspace.CreateBuilder<SecurityRuleList, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SecurityRuleList> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SecurityRuleList>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SecurityRuleList> Create<TContext>(
    ...
    public static ParsedJsonDocument<SecurityRuleList> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Source rules, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SecurityRuleList> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray.Source<TContext> rules, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
