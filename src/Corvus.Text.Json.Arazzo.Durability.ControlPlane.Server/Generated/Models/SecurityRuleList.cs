...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SecurityRuleList"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal SecurityRuleList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static SecurityRuleList DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray Rules
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RulesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.SecurityRuleSummaryArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in SecurityRuleList left, in SecurityRuleList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in SecurityRuleList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(SecurityRuleList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator SecurityRuleList(JsonElement instance)
    {
        return SecurityRuleList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityRuleList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityRuleList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityRuleList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityRuleList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityRuleList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SecurityRuleList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityRuleList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static SecurityRuleList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<SecurityRuleList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out SecurityRuleList? result)
    {
        return JsonElementHelpers.TryParseValue<SecurityRuleList>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new SecurityRuleList(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static SecurityRuleList IJsonElement<SecurityRuleList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"SecurityRuleList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="SecurityRuleList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="SecurityRuleList"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public SecurityRuleList Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<SecurityRuleList>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="SecurityRuleList"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public SecurityRuleList Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<SecurityRuleList>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// Gets the JSON property name for <see cref="Rules"/>.
        /// </summary>
        public static ReadOnlySpan<byte> RulesUtf8 => "rules"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// </summary>
        public static ReadOnlySpan<byte> Rules => [0x75, 0x00, 0x00, 0x00, 0x22, 0x72, 0x75, 0x6C, 0x65, 0x73, 0x22];
    }
}
