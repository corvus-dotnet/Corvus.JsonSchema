...
public readonly partial struct SecurityRuleUpdate
    : IJsonElement<SecurityRuleUpdate>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForExpression = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForExpression;
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/SecurityRuleUpdate"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/SecurityRuleUpdate";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/SecurityRuleUpdate"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyExpressionPresent, "expression"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyExpressionNotPresent, "expression"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyExpressionPresent, "expression"u8, "required"u8);
