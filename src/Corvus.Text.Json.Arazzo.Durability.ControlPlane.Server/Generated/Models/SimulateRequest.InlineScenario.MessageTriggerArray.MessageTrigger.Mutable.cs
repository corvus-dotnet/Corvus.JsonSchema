...
public readonly partial struct SimulateRequest
{
    ...
    public readonly partial struct InlineScenario
    {
        ...
        /// <remarks>
        /// <para>
        /// Messages delivered when the run suspends waiting on a channel, in order.
        /// </para>
        /// </remarks>
        public readonly partial struct MessageTriggerArray
        {
            /// <summary>
            /// MessageTrigger
            /// </summary>
            [DebuggerDisplay("{DebuggerDisplay,nq}")]
            public readonly partial struct MessageTrigger
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MessageTrigger instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MessageTrigger"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MessageTrigger(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// <para>
                    /// The channel the waiting step listens on.
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable Channel
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChannelUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// <remarks>
                    /// <para>
                    /// The correlation id, when the wait is correlated.
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable CorrelationId
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CorrelationIdUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement.Mutable Payload
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new MessageTrigger(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetChannel(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetCorrelationId(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPayload(scoped in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPayload<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MessageTrigger.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="MessageTrigger"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="MessageTrigger"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MessageTrigger Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<MessageTrigger>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="MessageTrigger"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MessageTrigger Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MessageTrigger>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.MessageTriggerArray.MessageTrigger.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.JsonElement.Source arg3)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _createArg3 = arg3;
                    ...
                    public static implicit operator Source(MessageTrigger instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.MessageTriggerArray.MessageTrigger.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg3)
                    {
                        _context = context;
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="MessageTrigger"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source channel,
                        in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source correlationId = default,
                        in Corvus.Text.Json.JsonElement.Source payload = default)
                    {
                    ...
                    public void Create(
                        ...
                        in Corvus.Text.Json.JsonElement.Source payload = default)
                    {
                        Create(ref _builder, channel, correlationId, payload);
                    }
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source channel,
                        in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source correlationId = default,
                        in Corvus.Text.Json.JsonElement.Source<TContext> payload = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    #endif
                    {
                        Create(context, ref _builder, channel, correlationId, payload);
                    }
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source channel, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source correlationId = default, scoped in Corvus.Text.Json.JsonElement.Source payload = default)
                {
                    return new Source(channel, correlationId, payload);
                }
                ...
                /// <param name="payload">The value of the <c>"payload"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source channel, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source correlationId = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> payload = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, channel, correlationId, payload);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source channel, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source correlationId = default, in Corvus.Text.Json.JsonElement.Source payload = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(channel, correlationId, payload);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source channel, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source correlationId = default, in Corvus.Text.Json.JsonElement.Source<TContext> payload = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, channel, correlationId, payload);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<MessageTrigger, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MessageTrigger> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MessageTrigger>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<MessageTrigger> Create<TContext>(
                ...
                public static ParsedJsonDocument<MessageTrigger> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source channel, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source correlationId = default, in Corvus.Text.Json.JsonElement.Source payload = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<MessageTrigger> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source channel, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source correlationId = default, in Corvus.Text.Json.JsonElement.Source<TContext> payload = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
