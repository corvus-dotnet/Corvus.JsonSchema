...
public readonly partial struct SimulateRequest
{
    ...
    public readonly partial struct InlineScenario
    {
...
#endif
        {
            ...
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.MessageTriggerArray.MessageTrigger this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.MessageTriggerArray.MessageTrigger>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.MessageTriggerArray.MessageTrigger> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.MessageTriggerArray.MessageTrigger>(_parent, _idx);
            }
