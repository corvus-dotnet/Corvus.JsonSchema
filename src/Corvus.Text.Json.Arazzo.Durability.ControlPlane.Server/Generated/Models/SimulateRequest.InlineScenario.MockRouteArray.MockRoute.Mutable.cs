        ...
        public readonly partial struct MockRouteArray
        {
            ...
            public readonly partial struct MockRoute
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MockRoute instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MockRoute"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MockRoute(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MockRoute.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MockRoute Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MockRoute Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MockRoute>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.MockRouteArray.MockRoute.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg3, scoped in Corvus.Text.Json.JsonElement.Source arg4)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _createArg3 = arg3;
                    ...
                    public static implicit operator Source(MockRoute instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.MockRouteArray.MockRoute.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg3, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg4)
                    {
                        _context = context;
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="MockRoute"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source method,
                    ...
                    public void Create(
                        ...
                        in Corvus.Text.Json.JsonElement.Source body = default)
                    {
                        Create(ref _builder, method, path, status, body);
                    }
                    ...
                    #endif
                    {
                        Create(context, ref _builder, method, path, status, body);
                    }
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source method, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source path, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source status, scoped in Corvus.Text.Json.JsonElement.Source body = default)
                {
                    return new Source(method, path, status, body);
                }
                ...
                /// <param name="body">The value of the <c>"body"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source method, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source path, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source status, scoped in Corvus.Text.Json.JsonElement.Source<TContext> body = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, method, path, status, body);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source method, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source path, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source status, in Corvus.Text.Json.JsonElement.Source body = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(method, path, status, body);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source method, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source path, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source status, in Corvus.Text.Json.JsonElement.Source<TContext> body = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, method, path, status, body);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<MockRoute, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MockRoute> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MockRoute>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<MockRoute> Create<TContext>(
                ...
                public static ParsedJsonDocument<MockRoute> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source method, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source path, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source status, in Corvus.Text.Json.JsonElement.Source body = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<MockRoute> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source method, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source path, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source status, in Corvus.Text.Json.JsonElement.Source<TContext> body = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
