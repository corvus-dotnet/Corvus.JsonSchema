...
public readonly partial struct SimulateRequest
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SimulateRequest instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SimulateRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SimulateRequest(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Mutable Budget
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BudgetUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Mutable Scenario
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScenarioUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Mutable Until
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UntilUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Mutable value))
                {
                    return value;
                }
        ...
        public void SetBudget(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetBudget<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScenario(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ScenarioUtf8);
                _documentVersion = _parent.Version;
                return;
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetScenario<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// <summary>
        /// Remove the <c>scenario</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveScenario()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ScenarioUtf8);
            _documentVersion = _parent.Version;
            return result;
        }

        /// <summary>
        /// Set the <c>until</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUntil(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UntilUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UntilUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Until, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUntil<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// <summary>
        /// Remove the <c>until</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveUntil()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UntilUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SimulateRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly SimulateRequest Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly SimulateRequest Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SimulateRequest>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source _createArg3;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source arg3, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(SimulateRequest instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source<TContext> _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source<TContext> _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg4;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source<TContext> arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source<TContext> arg3, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg4)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="SimulateRequest"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source budget = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source scenario = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source until = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId = default)
        {
            ...
            until.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Until, ref builder);
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId = default)
        {
            Create(ref _builder, budget, scenario, until, workflowId);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source<TContext> budget = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source<TContext> scenario = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source<TContext> until = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, budget, scenario, until, workflowId);
        }
    ...
    /// <param name="until">The value of the <c>"until"</c> property.</param>
    /// <param name="workflowId">The value of the <c>"workflowId"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source budget = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source scenario = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source until = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId = default)
    {
        return new Source(budget, scenario, until, workflowId);
    }
    ...
    /// <param name="workflowId">The value of the <c>"workflowId"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source<TContext> budget = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source<TContext> scenario = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source<TContext> until = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, budget, scenario, until, workflowId);
    }
    ...
    /// <param name="until">The value of the property.</param>
    /// <param name="workflowId">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source budget = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source scenario = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source until = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(budget, scenario, until, workflowId);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source<TContext> budget = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source<TContext> scenario = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source<TContext> until = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, budget, scenario, until, workflowId);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<SimulateRequest, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SimulateRequest> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SimulateRequest>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SimulateRequest> Create<TContext>(
    ...
    public static ParsedJsonDocument<SimulateRequest> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source budget = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source scenario = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source until = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SimulateRequest> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Source<TContext> budget = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.InlineScenario.Source<TContext> scenario = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Source<TContext> until = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
