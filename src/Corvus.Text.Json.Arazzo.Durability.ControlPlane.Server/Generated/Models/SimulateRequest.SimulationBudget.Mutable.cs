...
public readonly partial struct SimulateRequest
{
    ...
    public readonly partial struct SimulationBudget
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Mutable MaxSteps
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxStepsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Mutable WallClockMs
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WallClockMsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetMaxSteps(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetWallClockMs(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.SimulationBudget.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source maxSteps = default,
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source wallClockMs = default)
            {
            ...
            /// Creates an instance of a <see cref="SimulationBudget"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source maxSteps = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source wallClockMs = default)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source maxSteps = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source wallClockMs = default)
        {
        ...
        public static ParsedJsonDocument<SimulationBudget> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source maxSteps = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source wallClockMs = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
