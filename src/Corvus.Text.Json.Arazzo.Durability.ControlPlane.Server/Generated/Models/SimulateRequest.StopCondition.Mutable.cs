...
public readonly partial struct SimulateRequest
{
    ...
    public readonly partial struct StopCondition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StopCondition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StopCondition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StopCondition(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable BeforeStepId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BeforeStepIdUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Mutable Breakpoints
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BreakpointsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Mutable Occurrence
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OccurrenceUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Mutable.DefaultInstance;
                }
            }
            ...
            /// <summary>
            /// Set the <c>beforeStepId</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBeforeStepId(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BeforeStepIdUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BeforeStepIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BeforeStepId, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>beforeStepId</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveBeforeStepId()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BeforeStepIdUtf8);
                _documentVersion = _parent.Version;
                return result;
            }

            /// <summary>
            /// Set the <c>breakpoints</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBreakpoints(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BreakpointsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BreakpointsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Breakpoints, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBreakpoints<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>breakpoints</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveBreakpoints()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BreakpointsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }

            /// <summary>
            /// Set the <c>occurrence</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOccurrence(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OccurrenceUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OccurrenceUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Occurrence, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>occurrence</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveOccurrence()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OccurrenceUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StopCondition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="StopCondition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StopCondition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly StopCondition Clone()
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StopCondition"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly StopCondition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StopCondition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source _createArg2;
            private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source _createArg3;
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(StopCondition instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg1;
            private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source<TContext> _createArg2;
            private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source _createArg3;
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source<TContext> arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="StopCondition"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source beforeStepId = default,
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source breakpoints = default,
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source occurrence = default)
            {
                beforeStepId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BeforeStepId, ref builder);
                breakpoints.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Breakpoints, ref builder);
                occurrence.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Occurrence, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source occurrence = default)
            {
                Create(ref _builder, beforeStepId, breakpoints, occurrence);
            }
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source beforeStepId = default,
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source<TContext> breakpoints = default,
                in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source occurrence = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            ...
            #endif
            {
                Create(context, ref _builder, beforeStepId, breakpoints, occurrence);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// </summary>
        /// <param name="beforeStepId">The value of the <c>"beforeStepId"</c> property.</param>
        /// <param name="breakpoints">The value of the <c>"breakpoints"</c> property.</param>
        /// <param name="occurrence">The value of the <c>"occurrence"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source beforeStepId = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source breakpoints = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source occurrence = default)
        {
            return new Source(beforeStepId, breakpoints, occurrence);
        }
        ...
        /// <param name="occurrence">The value of the <c>"occurrence"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source beforeStepId = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source<TContext> breakpoints = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source occurrence = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, beforeStepId, breakpoints, occurrence);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="beforeStepId">The value of the property.</param>
        /// <param name="breakpoints">The value of the property.</param>
        /// <param name="occurrence">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source beforeStepId = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source breakpoints = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source occurrence = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(beforeStepId, breakpoints, occurrence);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source beforeStepId = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.JsonStringArray.Source<TContext> breakpoints = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulateRequest.StopCondition.OccurrenceEntity.Source occurrence = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, beforeStepId, breakpoints, occurrence);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<StopCondition, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<StopCondition> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<StopCondition>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<StopCondition> Create<TContext>(
