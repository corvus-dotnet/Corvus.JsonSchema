            ...
            public readonly partial struct ActionTaken
            {
                ...
                public readonly partial struct TypeEntity
                {
...
#endif
                    {
                        ...
                        /// <param name="matchEnd">Match 1st item.</param>
                        /// <param name="matchGoto">Match 2nd item.</param>
                        /// <param name="matchRetry">Match 3rd item.</param>
                        /// <param name="matchFallThrough">Match 4th item.</param>
                        /// <param name="matchFault">Match 5th item.</param>
                        /// <param name="defaultMatch">Match any other value.</param>
                        /// <returns>An instance of the value returned by the match function.</returns>
                        public TResult Match<TContext, TResult>(
                            in TContext context,
                            Func<TContext, TResult> matchEnd,
                            Func<TContext, TResult> matchGoto,
                            Func<TContext, TResult> matchRetry,
                            Func<TContext, TResult> matchFallThrough,
                            Func<TContext, TResult> matchFault,
...
#endif
                        {
                            ...
                            {
                                return matchGoto(context);
                            }

                            if (this.ValueEquals(Constants.Enum3))
                            {
                                return matchRetry(context);
                            }

                            if (this.ValueEquals(Constants.Enum4))
                            {
                                return matchFallThrough(context);
                            }

                            if (this.ValueEquals(Constants.Enum5))
                            {
                                return matchFault(context);
                            }
                        ...
                        public TResult Match<TResult>(
                            ...
                            Func<TResult> matchGoto,
                            Func<TResult> matchRetry,
                            Func<TResult> matchFallThrough,
                            Func<TResult> matchFault,
