            ...
            public readonly partial struct SimulatedExchangeArray
            {
                ...
                public readonly partial struct SimulatedExchange
                {
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.SimulatedStepArray.SimulatedStep.SimulatedExchangeArray.SimulatedExchange.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SimulationTrace.SimulatedStepArray.SimulatedStep.SimulatedExchangeArray.SimulatedExchange.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg3, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg4, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg5)
                        {
                            _context = context;
                            _createArg1 = arg1;
                            _createArg2 = arg2;
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <param name="arg5">The value of the property.</param>
                        /// <param name="o">The complex value builder into which to write the object.</param>
                        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source arg3, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg4, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg5, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                        {
                    ...
                    /// <param name="responseBody">The value of the <c>"responseBody"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source method, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source path, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source status, scoped in Corvus.Text.Json.JsonElement.Source<TContext> requestBody = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> responseBody = default)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source method, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source path, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source status, in Corvus.Text.Json.JsonElement.Source<TContext> requestBody = default, in Corvus.Text.Json.JsonElement.Source<TContext> responseBody = default, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
