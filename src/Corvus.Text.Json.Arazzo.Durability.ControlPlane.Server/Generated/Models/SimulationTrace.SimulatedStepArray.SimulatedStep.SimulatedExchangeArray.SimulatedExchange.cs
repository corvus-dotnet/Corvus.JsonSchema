        ...
        public readonly partial struct SimulatedStep
        {
            ...
            public readonly partial struct SimulatedExchangeArray
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="SimulatedExchange"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal SimulatedExchange(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static SimulatedExchange DefaultInstance { get; }
                    ...
                    /// </para>
                    /// <para>
                    /// The resolved path (parameters substituted, query included).
                    /// </para>
                    /// </remarks>
                    ...
                    /// <remarks>
                    /// <para>
                    /// The request payload value, if one was sent.
                    /// </para>
                    /// </remarks>
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>responseBody</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    /// The mock&#39;s response body value, if any.
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement ResponseBody
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResponseBodyUtf8, out Corvus.Text.Json.JsonElement value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in SimulatedExchange left, in SimulatedExchange right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in SimulatedExchange left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(SimulatedExchange instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SimulatedExchange(JsonElement instance)
                    {
                        return SimulatedExchange.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SimulatedExchange From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SimulatedExchange ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<SimulatedExchange>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SimulatedExchange ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<SimulatedExchange>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SimulatedExchange ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<SimulatedExchange>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static SimulatedExchange ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<SimulatedExchange>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out SimulatedExchange? result)
                    {
                        return JsonElementHelpers.TryParseValue<SimulatedExchange>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SimulatedExchange(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static SimulatedExchange IJsonElement<SimulatedExchange>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SimulatedExchange: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SimulatedExchange"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SimulatedExchange"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public SimulatedExchange Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SimulatedExchange>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SimulatedExchange"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public SimulatedExchange Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<SimulatedExchange>(_idx);
                        }
                    ...
                    public static class JsonPropertyNames
                    {
                        ...
                        /// <summary>
                        /// Gets the JSON property name for <see cref="ResponseBody"/>.
                        /// </summary>
                        ...
                        /// Gets the JSON property name for <see cref="ResponseBody"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> ResponseBodyUtf8 => "responseBody"u8;
                    ...
                    private static class JsonPropertyNamesEscaped
                    {
                        ...
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="ResponseBody"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> ResponseBody => "responseBody"u8;
                    ...
                    private static class JsonPropertyNamesPrebaked
                    {
                        ...
                        /// <summary>
                        /// Gets the pre-baked property name blob for <see cref="ResponseBody"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> ResponseBody => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x72, 0x65, 0x73, 0x70, 0x6F, 0x6E, 0x73, 0x65, 0x42, 0x6F, 0x64, 0x79, 0x22];
