...
public readonly partial struct SourceOperationDescriptor
{
...
#endif
    {
        ...
        /// <param name="matchSend">Match 1st item.</param>
        /// <param name="matchReceive">Match 2nd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchSend,
            Func<TContext, TResult> matchReceive,
...
#endif
        {
            ...
            {
                return matchSend(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchReceive(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchSend,
            Func<TResult> matchReceive,
