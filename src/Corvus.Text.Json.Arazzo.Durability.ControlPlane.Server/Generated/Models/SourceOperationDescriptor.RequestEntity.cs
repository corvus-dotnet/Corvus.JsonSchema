...
public readonly partial struct SourceOperationDescriptor
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString ContentType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentTypeUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceOperationDescriptor.RequestEntity.RawJsonSchemaLocalRefsInlinedToABoundedDepth Schema
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceOperationDescriptor.RequestEntity.RawJsonSchemaLocalRefsInlinedToABoundedDepth value))
                {
                    return value;
                }
