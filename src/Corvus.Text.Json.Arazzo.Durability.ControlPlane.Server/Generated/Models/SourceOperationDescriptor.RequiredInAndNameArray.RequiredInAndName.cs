...
public readonly partial struct SourceOperationDescriptor
{
    ...
    public readonly partial struct RequiredInAndNameArray
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceOperationDescriptor.RequiredInAndNameArray.RequiredInAndName.SchemaEntity Schema
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceOperationDescriptor.RequiredInAndNameArray.RequiredInAndName.SchemaEntity value))
                    {
                        return value;
                    }
