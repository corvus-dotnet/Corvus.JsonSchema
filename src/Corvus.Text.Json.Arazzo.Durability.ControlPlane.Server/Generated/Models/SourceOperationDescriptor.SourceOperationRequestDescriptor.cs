...
public readonly partial struct SourceOperationDescriptor
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceOperationRequestDescriptor"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SourceOperationRequestDescriptor(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SourceOperationRequestDescriptor DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceOperationDescriptor.SourceOperationRequestDescriptor.RawSchema Schema
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceOperationDescriptor.SourceOperationRequestDescriptor.RawSchema value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in SourceOperationRequestDescriptor left, in SourceOperationRequestDescriptor right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SourceOperationRequestDescriptor left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SourceOperationRequestDescriptor instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SourceOperationRequestDescriptor(JsonElement instance)
        {
            return SourceOperationRequestDescriptor.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SourceOperationRequestDescriptor From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SourceOperationRequestDescriptor ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SourceOperationRequestDescriptor>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SourceOperationRequestDescriptor ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SourceOperationRequestDescriptor>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SourceOperationRequestDescriptor ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SourceOperationRequestDescriptor>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static SourceOperationRequestDescriptor ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SourceOperationRequestDescriptor>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SourceOperationRequestDescriptor? result)
        {
            return JsonElementHelpers.TryParseValue<SourceOperationRequestDescriptor>(ref reader, out result);
        }
...
#if NET
        static SourceOperationRequestDescriptor IJsonElement<SourceOperationRequestDescriptor>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SourceOperationRequestDescriptor: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public SourceOperationRequestDescriptor Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public SourceOperationRequestDescriptor Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SourceOperationRequestDescriptor>(_idx);
            }
