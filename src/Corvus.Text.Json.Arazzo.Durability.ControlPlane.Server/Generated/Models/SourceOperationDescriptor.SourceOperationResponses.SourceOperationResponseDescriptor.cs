...
public readonly partial struct SourceOperationDescriptor
{
    ...
    {
        /// <summary>
        /// SourceOperationResponseDescriptor
        /// </summary>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct SourceOperationResponseDescriptor
#if NET8_0_OR_GREATER
            : IJsonElement<SourceOperationResponseDescriptor>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SourceOperationResponseDescriptor"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SourceOperationResponseDescriptor(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SourceOperationResponseDescriptor DefaultInstance { get; }
            ...
            /// RawSchema
            /// </summary>
            public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceOperationDescriptor.SourceOperationResponses.SourceOperationResponseDescriptor.RawSchema Schema
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceOperationDescriptor.SourceOperationResponses.SourceOperationResponseDescriptor.RawSchema value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in SourceOperationResponseDescriptor left, in SourceOperationResponseDescriptor right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SourceOperationResponseDescriptor left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(SourceOperationResponseDescriptor instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SourceOperationResponseDescriptor(JsonElement instance)
            {
                return SourceOperationResponseDescriptor.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceOperationResponseDescriptor From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceOperationResponseDescriptor ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<SourceOperationResponseDescriptor>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceOperationResponseDescriptor ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<SourceOperationResponseDescriptor>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SourceOperationResponseDescriptor ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<SourceOperationResponseDescriptor>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static SourceOperationResponseDescriptor ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<SourceOperationResponseDescriptor>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SourceOperationResponseDescriptor? result)
            {
                return JsonElementHelpers.TryParseValue<SourceOperationResponseDescriptor>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SourceOperationResponseDescriptor(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SourceOperationResponseDescriptor IJsonElement<SourceOperationResponseDescriptor>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SourceOperationResponseDescriptor: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SourceOperationResponseDescriptor"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SourceOperationResponseDescriptor"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SourceOperationResponseDescriptor Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SourceOperationResponseDescriptor>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SourceOperationResponseDescriptor"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SourceOperationResponseDescriptor Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SourceOperationResponseDescriptor>(_idx);
                }
