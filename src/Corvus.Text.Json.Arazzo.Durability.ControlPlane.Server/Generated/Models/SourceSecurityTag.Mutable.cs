...
public readonly partial struct SourceSecurityTag
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SourceSecurityTag instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SourceSecurityTag"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SourceSecurityTag(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SourceSecurityTag.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SourceSecurityTag"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SourceSecurityTag"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly SourceSecurityTag Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SourceSecurityTag"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly SourceSecurityTag Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SourceSecurityTag>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceSecurityTag.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(SourceSecurityTag instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceSecurityTag.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="SourceSecurityTag"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<SourceSecurityTag, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SourceSecurityTag> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SourceSecurityTag>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SourceSecurityTag> Create<TContext>(
    ...
    public static ParsedJsonDocument<SourceSecurityTag> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source key, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source value, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
