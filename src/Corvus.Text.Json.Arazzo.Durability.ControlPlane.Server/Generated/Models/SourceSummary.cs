...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SourceSummary"/> struct.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceSummary.SourceSecurityTagArray ManagementTags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ManagementTagsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceSummary.SourceSecurityTagArray value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets a <see cref="SourceSummary"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="SourceSummary"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="SourceSummary"/> that lives for the lifetime of its
