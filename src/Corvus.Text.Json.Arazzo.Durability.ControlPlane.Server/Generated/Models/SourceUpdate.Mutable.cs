...
public readonly partial struct SourceUpdate
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SourceUpdate instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SourceUpdate"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SourceUpdate(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Mutable ManagementTags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ManagementTagsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetManagementTags(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetManagementTags<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SourceUpdate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly SourceUpdate Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly SourceUpdate Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SourceUpdate>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Source _createArg4;
        ...
        public static implicit operator Source(SourceUpdate instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Source<TContext> _createArg4;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceDocument.Source<TContext> arg3, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Source<TContext> arg4)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="SourceUpdate"/>.
        /// </summary>
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceDocument.Source document = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Source managementTags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source description = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source displayName = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceDocument.Source<TContext> document = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Source<TContext> managementTags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    /// <param name="managementTags">The value of the <c>"managementTags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source description = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source displayName = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceDocument.Source<TContext> document = default, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Source<TContext> managementTags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source description = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source displayName = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceDocument.Source<TContext> document = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceUpdate.SourceSecurityTagArray.Source<TContext> managementTags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<SourceUpdate, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SourceUpdate> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SourceUpdate>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<SourceUpdate> Create<TContext>(
