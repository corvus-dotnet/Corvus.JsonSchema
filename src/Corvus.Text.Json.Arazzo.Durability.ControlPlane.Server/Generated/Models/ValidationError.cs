...
public readonly partial struct ValidationError
#if NET8_0_OR_GREATER
    : IJsonElement<ValidationError>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    internal ValidationError(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ValidationError DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the (optional) <c>instancePath</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// A JSON Pointer to the failing location within the posted value.
    /// </para>
    /// </remarks>
    ...
    /// <summary>
    /// Gets the (optional) <c>keyword</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// The JSON Schema keyword that failed, when known.
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString Keyword
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeywordUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// <remarks>
    /// <para>
    /// The evaluation location within the schema that produced the failure, when known.
    /// </para>
    /// </remarks>
    ...
    /// </returns>
    public static bool operator ==(in ValidationError left, in ValidationError right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ValidationError left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ValidationError instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ValidationError(JsonElement instance)
    {
        return ValidationError.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationError From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationError ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ValidationError>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationError ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ValidationError>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationError ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ValidationError>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static ValidationError ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ValidationError>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ValidationError? result)
    {
        return JsonElementHelpers.TryParseValue<ValidationError>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ValidationError(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ValidationError IJsonElement<ValidationError>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ValidationError: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="ValidationError"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="ValidationError"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<ValidationError>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="ValidationError"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public ValidationError Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<ValidationError>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Keyword"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Keyword"/>.
        /// </summary>
        public static ReadOnlySpan<byte> KeywordUtf8 => "keyword"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Keyword"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Keyword => "keyword"u8;
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Keyword"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Keyword => [0x95, 0x00, 0x00, 0x00, 0x22, 0x6B, 0x65, 0x79, 0x77, 0x6F, 0x72, 0x64, 0x22];
