...
public readonly partial struct VerbGrant
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray.Mutable RuleNames
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RuleNamesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.Mutable Unrestricted
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UnrestrictedUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.Mutable value))
                {
                    return value;
                }

                return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.Mutable.DefaultInstance;
            }
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRuleNames<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.Source _createArg2;
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.Source _createArg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray.Source ruleNames = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.Source unrestricted = default)
        {
        ...
        /// Creates an instance of a <see cref="VerbGrant"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray.Source ruleNames = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.Source unrestricted = default)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray.Source<TContext> ruleNames = default,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.Source unrestricted = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray.Source ruleNames = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.Source unrestricted = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
