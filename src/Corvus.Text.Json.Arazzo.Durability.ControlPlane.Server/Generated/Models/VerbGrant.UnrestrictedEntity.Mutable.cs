...
public readonly partial struct VerbGrant
{
    ...
    public readonly partial struct UnrestrictedEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UnrestrictedEntity, Mutable>(UnrestrictedEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(UnrestrictedEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="UnrestrictedEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UnrestrictedEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new UnrestrictedEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UnrestrictedEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="UnrestrictedEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UnrestrictedEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly UnrestrictedEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UnrestrictedEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UnrestrictedEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly UnrestrictedEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<UnrestrictedEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(UnrestrictedEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<UnrestrictedEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<UnrestrictedEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<UnrestrictedEntity>();
            }
            finally
            {
