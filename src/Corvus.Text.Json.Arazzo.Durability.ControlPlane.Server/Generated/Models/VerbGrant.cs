...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray RuleNames
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RuleNamesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity Unrestricted
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UnrestrictedUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity value))
            {
                return value;
            }

            return Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.VerbGrant.UnrestrictedEntity.DefaultInstance;
        }
    }
