...
public readonly partial struct WorkflowRunDetail
{
    ...
    public ref struct Builder
    {
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowWait.Source wait = default)
        {
            Create(ref _builder, createdAt, cursor, etag, id, status, workflowId, budget, correlationId, environment, fault, rebudget, rerunOf, sealedStart, tags, updatedAt, wait);
        }
        ...
        #endif
        {
            Create(context, ref _builder, createdAt, cursor, etag, id, status, workflowId, budget, correlationId, environment, fault, rebudget, rerunOf, sealedStart, tags, updatedAt, wait);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonDateTime.Source createdAt, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonInteger.Source cursor, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source etag, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunId.Source id, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunStatus.Source status, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source workflowId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ResolvedExecutionBudget.Source budget = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source correlationId = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.EnvironmentName.Source environment = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowFault.Source fault = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunRebudget.Source rebudget = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RunId.Source rerunOf = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonBoolean.Source sealedStart = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunDetail.JsonStringArray.Source tags = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonDateTime.Source updatedAt = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowWait.Source wait = default, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(createdAt, cursor, etag, id, status, workflowId, budget, correlationId, environment, fault, rebudget, rerunOf, sealedStart, tags, updatedAt, wait);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, createdAt, cursor, etag, id, status, workflowId, budget, correlationId, environment, fault, rebudget, rerunOf, sealedStart, tags, updatedAt, wait);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
