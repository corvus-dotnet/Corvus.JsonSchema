...
public readonly partial struct WorkflowRunPage
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Mutable NextPageToken
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NextPageTokenUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Mutable Runs
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RunsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetNextPageToken(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRuns(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRuns<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source<TContext> arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source runs,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source nextPageToken = default)
        {
        ...
        /// Creates an instance of a <see cref="WorkflowRunPage"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source runs, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source nextPageToken = default)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source<TContext> runs,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        internal static void BuildCreateValue(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source<TContext> arg1, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source runs, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source nextPageToken = default)
    {
    ...
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source<TContext> runs, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray.Source runs, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.NextPageTokenEntity.Source nextPageToken = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
