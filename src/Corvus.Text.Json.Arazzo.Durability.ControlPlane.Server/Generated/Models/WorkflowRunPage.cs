...
/// <remarks>
/// <para>
/// A page of runs matching a visibility query.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct WorkflowRunPage
#if NET8_0_OR_GREATER
    : IJsonElement<WorkflowRunPage>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WorkflowRunPage"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal WorkflowRunPage(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static WorkflowRunPage DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray Runs
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RunsUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunPage.WorkflowRunSummaryArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in WorkflowRunPage left, in WorkflowRunPage right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in WorkflowRunPage left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(WorkflowRunPage instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator WorkflowRunPage(JsonElement instance)
    {
        return WorkflowRunPage.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkflowRunPage From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkflowRunPage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkflowRunPage>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkflowRunPage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkflowRunPage>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WorkflowRunPage ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkflowRunPage>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static WorkflowRunPage ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WorkflowRunPage>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out WorkflowRunPage? result)
    {
        return JsonElementHelpers.TryParseValue<WorkflowRunPage>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new WorkflowRunPage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static WorkflowRunPage IJsonElement<WorkflowRunPage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"WorkflowRunPage: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="WorkflowRunPage"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="WorkflowRunPage"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public WorkflowRunPage Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<WorkflowRunPage>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="WorkflowRunPage"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public WorkflowRunPage Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<WorkflowRunPage>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Runs"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Runs"/>.
        /// </summary>
        public static ReadOnlySpan<byte> RunsUtf8 => "runs"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Runs"/>.
        /// </summary>
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Runs"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Runs => [0x65, 0x00, 0x00, 0x00, 0x22, 0x72, 0x75, 0x6E, 0x73, 0x22];
    }
}
