...
public readonly partial struct WorkflowRunSteps
{
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunSteps.WorkflowRunStepRecordArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunSteps.WorkflowRunStepRecordArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// Creates an instance of a <see cref="WorkflowRunSteps"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source runId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunSteps.WorkflowRunStepRecordArray.Source steps)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunSteps.WorkflowRunStepRecordArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source runId, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunSteps.WorkflowRunStepRecordArray.Source steps)
    {
    ...
    public static ParsedJsonDocument<WorkflowRunSteps> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source runId, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunSteps.WorkflowRunStepRecordArray.Source steps, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
