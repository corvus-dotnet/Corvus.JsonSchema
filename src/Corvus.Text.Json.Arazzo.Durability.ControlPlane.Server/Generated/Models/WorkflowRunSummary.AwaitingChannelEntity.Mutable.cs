...
public readonly partial struct WorkflowRunSummary
{
    ...
    public readonly partial struct AwaitingChannelEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AwaitingChannelEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AwaitingChannelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AwaitingChannelEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AwaitingChannelEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AwaitingChannelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AwaitingChannelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AwaitingChannelEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly AwaitingChannelEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AwaitingChannelEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AwaitingChannelEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly AwaitingChannelEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AwaitingChannelEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AwaitingChannelEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AwaitingChannelEntity, Mutable>(this);
        }
    }
}
