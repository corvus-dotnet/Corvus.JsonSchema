...
public readonly partial struct WorkflowRunSummary
{
    ...
    public readonly partial struct DueAtEntity
    {
...
#endif
        {
            ...
            public static implicit operator NodaTime.OffsetDateTime(Mutable value) => value._parent.TryGetValue(value._idx, out NodaTime.OffsetDateTime result) ? result : throw new FormatException();
            ...
            public static explicit operator Mutable(DueAtEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DueAtEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DueAtEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DueAtEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DueAtEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DueAtEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DueAtEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DueAtEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DueAtEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DueAtEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DueAtEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DueAtEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DueAtEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DueAtEntity, Mutable>(this);
        }
    }
}
