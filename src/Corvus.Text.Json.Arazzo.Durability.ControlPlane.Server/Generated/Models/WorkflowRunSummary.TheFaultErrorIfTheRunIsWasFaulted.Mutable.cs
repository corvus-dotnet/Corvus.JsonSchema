...
public readonly partial struct WorkflowRunSummary
{
    ...
    public readonly partial struct TheFaultErrorIfTheRunIsWasFaulted
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheFaultErrorIfTheRunIsWasFaulted instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheFaultErrorIfTheRunIsWasFaulted"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheFaultErrorIfTheRunIsWasFaulted(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheFaultErrorIfTheRunIsWasFaulted.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheFaultErrorIfTheRunIsWasFaulted Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheFaultErrorIfTheRunIsWasFaulted Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheFaultErrorIfTheRunIsWasFaulted>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheFaultErrorIfTheRunIsWasFaulted instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheFaultErrorIfTheRunIsWasFaulted, Mutable>(this);
        }
    }
}
