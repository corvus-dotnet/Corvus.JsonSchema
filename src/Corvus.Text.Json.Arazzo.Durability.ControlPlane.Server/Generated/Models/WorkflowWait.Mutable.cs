...
public readonly partial struct WorkflowWait
{
...
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetKind(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowWaitKind.Source value)
        {
            CheckValidInstance();
