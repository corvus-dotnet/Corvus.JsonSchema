...
/// </para>
/// </remarks>
public readonly partial struct WorkflowWait
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
    ...
    public readonly partial struct TheChannelAMessageWaitListensOnSetForMessage
#if NET8_0_OR_GREATER
        : IJsonElement<TheChannelAMessageWaitListensOnSetForMessage>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheChannelAMessageWaitListensOnSetForMessage"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheChannelAMessageWaitListensOnSetForMessage(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheChannelAMessageWaitListensOnSetForMessage DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheChannelAMessageWaitListensOnSetForMessage value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheChannelAMessageWaitListensOnSetForMessage left, in TheChannelAMessageWaitListensOnSetForMessage right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheChannelAMessageWaitListensOnSetForMessage left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheChannelAMessageWaitListensOnSetForMessage instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheChannelAMessageWaitListensOnSetForMessage(JsonElement instance)
        {
            return TheChannelAMessageWaitListensOnSetForMessage.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheChannelAMessageWaitListensOnSetForMessage From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheChannelAMessageWaitListensOnSetForMessage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheChannelAMessageWaitListensOnSetForMessage>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheChannelAMessageWaitListensOnSetForMessage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheChannelAMessageWaitListensOnSetForMessage>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheChannelAMessageWaitListensOnSetForMessage ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheChannelAMessageWaitListensOnSetForMessage>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static TheChannelAMessageWaitListensOnSetForMessage ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheChannelAMessageWaitListensOnSetForMessage>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheChannelAMessageWaitListensOnSetForMessage? result)
        {
            return JsonElementHelpers.TryParseValue<TheChannelAMessageWaitListensOnSetForMessage>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheChannelAMessageWaitListensOnSetForMessage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheChannelAMessageWaitListensOnSetForMessage IJsonElement<TheChannelAMessageWaitListensOnSetForMessage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheChannelAMessageWaitListensOnSetForMessage: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheChannelAMessageWaitListensOnSetForMessage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheChannelAMessageWaitListensOnSetForMessage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheChannelAMessageWaitListensOnSetForMessage Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheChannelAMessageWaitListensOnSetForMessage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheChannelAMessageWaitListensOnSetForMessage"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheChannelAMessageWaitListensOnSetForMessage Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheChannelAMessageWaitListensOnSetForMessage>(_idx);
            }
