...
public readonly partial struct WorkflowWait
{
    ...
    public readonly partial struct TheCorrelationIdAMessageWaitMatchesIfAny
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheCorrelationIdAMessageWaitMatchesIfAny instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheCorrelationIdAMessageWaitMatchesIfAny"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheCorrelationIdAMessageWaitMatchesIfAny(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheCorrelationIdAMessageWaitMatchesIfAny.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheCorrelationIdAMessageWaitMatchesIfAny Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheCorrelationIdAMessageWaitMatchesIfAny Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheCorrelationIdAMessageWaitMatchesIfAny>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheCorrelationIdAMessageWaitMatchesIfAny instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheCorrelationIdAMessageWaitMatchesIfAny, Mutable>(this);
        }
    }
}
