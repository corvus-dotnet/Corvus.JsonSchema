...
public readonly partial struct WorkflowWait
{
    ...
    public readonly partial struct TheCorrelationIdAMessageWaitMatchesIfAny
#if NET8_0_OR_GREATER
        : IJsonElement<TheCorrelationIdAMessageWaitMatchesIfAny>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheCorrelationIdAMessageWaitMatchesIfAny"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheCorrelationIdAMessageWaitMatchesIfAny(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheCorrelationIdAMessageWaitMatchesIfAny DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheCorrelationIdAMessageWaitMatchesIfAny value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheCorrelationIdAMessageWaitMatchesIfAny left, in TheCorrelationIdAMessageWaitMatchesIfAny right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheCorrelationIdAMessageWaitMatchesIfAny left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheCorrelationIdAMessageWaitMatchesIfAny instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheCorrelationIdAMessageWaitMatchesIfAny(JsonElement instance)
        {
            return TheCorrelationIdAMessageWaitMatchesIfAny.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheCorrelationIdAMessageWaitMatchesIfAny From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheCorrelationIdAMessageWaitMatchesIfAny ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheCorrelationIdAMessageWaitMatchesIfAny>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheCorrelationIdAMessageWaitMatchesIfAny ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheCorrelationIdAMessageWaitMatchesIfAny>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheCorrelationIdAMessageWaitMatchesIfAny ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheCorrelationIdAMessageWaitMatchesIfAny>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static TheCorrelationIdAMessageWaitMatchesIfAny ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheCorrelationIdAMessageWaitMatchesIfAny>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheCorrelationIdAMessageWaitMatchesIfAny? result)
        {
            return JsonElementHelpers.TryParseValue<TheCorrelationIdAMessageWaitMatchesIfAny>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheCorrelationIdAMessageWaitMatchesIfAny(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheCorrelationIdAMessageWaitMatchesIfAny IJsonElement<TheCorrelationIdAMessageWaitMatchesIfAny>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheCorrelationIdAMessageWaitMatchesIfAny: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheCorrelationIdAMessageWaitMatchesIfAny"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheCorrelationIdAMessageWaitMatchesIfAny"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheCorrelationIdAMessageWaitMatchesIfAny Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheCorrelationIdAMessageWaitMatchesIfAny>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheCorrelationIdAMessageWaitMatchesIfAny"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheCorrelationIdAMessageWaitMatchesIfAny Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheCorrelationIdAMessageWaitMatchesIfAny>(_idx);
            }
