...
public readonly partial struct WorkflowWait
{
    ...
    public readonly partial struct WhenATimerWaitBecomesDueSetForTimer
#if NET8_0_OR_GREATER
        : IJsonElement<WhenATimerWaitBecomesDueSetForTimer>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WhenATimerWaitBecomesDueSetForTimer"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal WhenATimerWaitBecomesDueSetForTimer(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static WhenATimerWaitBecomesDueSetForTimer DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NodaTime.OffsetDateTime(WhenATimerWaitBecomesDueSetForTimer value) => value._parent.TryGetValue(value._idx, out NodaTime.OffsetDateTime result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(WhenATimerWaitBecomesDueSetForTimer value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in WhenATimerWaitBecomesDueSetForTimer left, in WhenATimerWaitBecomesDueSetForTimer right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in WhenATimerWaitBecomesDueSetForTimer left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(WhenATimerWaitBecomesDueSetForTimer instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WhenATimerWaitBecomesDueSetForTimer(JsonElement instance)
        {
            return WhenATimerWaitBecomesDueSetForTimer.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhenATimerWaitBecomesDueSetForTimer From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhenATimerWaitBecomesDueSetForTimer ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WhenATimerWaitBecomesDueSetForTimer>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhenATimerWaitBecomesDueSetForTimer ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WhenATimerWaitBecomesDueSetForTimer>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static WhenATimerWaitBecomesDueSetForTimer ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WhenATimerWaitBecomesDueSetForTimer>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static WhenATimerWaitBecomesDueSetForTimer ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<WhenATimerWaitBecomesDueSetForTimer>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out WhenATimerWaitBecomesDueSetForTimer? result)
        {
            return JsonElementHelpers.TryParseValue<WhenATimerWaitBecomesDueSetForTimer>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WhenATimerWaitBecomesDueSetForTimer(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static WhenATimerWaitBecomesDueSetForTimer IJsonElement<WhenATimerWaitBecomesDueSetForTimer>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WhenATimerWaitBecomesDueSetForTimer: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WhenATimerWaitBecomesDueSetForTimer"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WhenATimerWaitBecomesDueSetForTimer"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public WhenATimerWaitBecomesDueSetForTimer Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WhenATimerWaitBecomesDueSetForTimer>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WhenATimerWaitBecomesDueSetForTimer"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public WhenATimerWaitBecomesDueSetForTimer Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<WhenATimerWaitBecomesDueSetForTimer>(_idx);
            }
