...
public readonly partial struct WorkflowWaitKind
{
...
#endif
    {
        ...
        public static explicit operator Mutable(WorkflowWaitKind instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="WorkflowWaitKind"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WorkflowWaitKind(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WorkflowWaitKind(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WorkflowWaitKind.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WorkflowWaitKind"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WorkflowWaitKind"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly WorkflowWaitKind Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WorkflowWaitKind>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WorkflowWaitKind"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly WorkflowWaitKind Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<WorkflowWaitKind>(_idx);
        }
        ...
        /// <param name="matchTimer">Match 1st item.</param>
        /// <param name="matchMessage">Match 2nd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchTimer,
            Func<TContext, TResult> matchMessage,
...
#endif
        {
            ...
            {
                return matchTimer(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchMessage(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchTimer,
            Func<TResult> matchMessage,
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(WorkflowWaitKind instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<WorkflowWaitKind, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<WorkflowWaitKind> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<WorkflowWaitKind>();
        }
        finally
        {
