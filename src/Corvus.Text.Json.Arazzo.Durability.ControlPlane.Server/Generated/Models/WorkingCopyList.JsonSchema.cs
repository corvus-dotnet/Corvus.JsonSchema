...
public readonly partial struct WorkingCopyList
    : IJsonElement<WorkingCopyList>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyWorkingCopiesPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("workingCopies"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyWorkingCopiesNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("workingCopies"u8, buffer, out written);

        private const int RequiredOffsetForWorkingCopies = 0;
        private const uint RequiredBitForWorkingCopies = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForWorkingCopies;
        ...
        private static readonly JsonSchemaPathProvider WorkingCopiesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/workingCopies"u8, buffer, out written);
        ...
        private static void MatchWorkingCopies(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.WorkingCopiesUtf8,
                    evaluationPath: WorkingCopiesSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForWorkingCopies] |= RequiredBitForWorkingCopies;
        }
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.WorkingCopiesUtf8, MatchWorkingCopies),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/WorkingCopyList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/WorkingCopyList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/WorkingCopyList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyWorkingCopiesPresent, "workingCopies"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForWorkingCopies] & RequiredBitForWorkingCopies) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyWorkingCopiesNotPresent, "workingCopies"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyWorkingCopiesPresent, "workingCopies"u8, "required"u8);
