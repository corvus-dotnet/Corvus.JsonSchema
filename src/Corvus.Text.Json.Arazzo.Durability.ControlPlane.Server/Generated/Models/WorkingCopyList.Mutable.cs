...
/// <remarks>
/// <para>
/// A page of working copies, ordered by id. Entries omit the document and designer state.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct WorkingCopyList
{
...
#endif
    {
        ...
        public static explicit operator Mutable(WorkingCopyList instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="WorkingCopyList"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WorkingCopyList(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>workingCopies</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Mutable WorkingCopies
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WorkingCopiesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WorkingCopyList(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>workingCopies</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWorkingCopies(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("workingCopies");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WorkingCopiesUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.WorkingCopies, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWorkingCopies<TContext>(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WorkingCopyList.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WorkingCopyList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WorkingCopyList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly WorkingCopyList Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WorkingCopyList>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WorkingCopyList"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly WorkingCopyList Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<WorkingCopyList>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(WorkingCopyList instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="WorkingCopyList"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source workingCopies,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
        {
            workingCopies.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.WorkingCopies, ref builder);
        ...
        /// Creates an instance of a <see cref="WorkingCopyList"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source workingCopies, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
        {
            Create(ref _builder, workingCopies, nextPageToken);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source<TContext> workingCopies,
            in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, workingCopies, nextPageToken);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="workingCopies">The value of the <c>"workingCopies"</c> property.</param>
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source workingCopies, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
    {
        return new Source(workingCopies, nextPageToken);
    }
    ...
    /// <param name="nextPageToken">The value of the <c>"nextPageToken"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source<TContext> workingCopies, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, workingCopies, nextPageToken);
    }
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray.Source<TContext> workingCopies, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source nextPageToken = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, workingCopies, nextPageToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<WorkingCopyList, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<WorkingCopyList> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<WorkingCopyList>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<WorkingCopyList> Create<TContext>(
