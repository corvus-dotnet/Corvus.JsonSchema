...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray WorkingCopies
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WorkingCopiesUtf8, out Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyList.WorkingCopySummaryArray value))
            {
                return value;
            }
