...
public readonly partial struct WorkingCopyUpdate
{
...
#endif
    {
        ...
        public static explicit operator Mutable(WorkingCopyUpdate instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="WorkingCopyUpdate"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WorkingCopyUpdate(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WorkingCopyUpdate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WorkingCopyUpdate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WorkingCopyUpdate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly WorkingCopyUpdate Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WorkingCopyUpdate"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly WorkingCopyUpdate Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<WorkingCopyUpdate>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDocument.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDesignerState.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitBinding.Source _createArg4;
        ...
        public static implicit operator Source(WorkingCopyUpdate instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDocument.Source<TContext> _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDesignerState.Source<TContext> _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitBinding.Source<TContext> _createArg4;
        private readonly Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source _createArg5;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyUpdate.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDocument.Source<TContext> arg1, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDesignerState.Source<TContext> arg3, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitBinding.Source<TContext> arg4, scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source arg5)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="WorkingCopyUpdate"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<WorkingCopyUpdate, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<WorkingCopyUpdate> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<WorkingCopyUpdate>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<WorkingCopyUpdate> Create<TContext>(
    ...
    public static ParsedJsonDocument<WorkingCopyUpdate> Create(in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDocument.Source document, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source expectedEtag, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDesignerState.Source designerState = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitBinding.Source gitBinding = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source name = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<WorkingCopyUpdate> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDocument.Source<TContext> document, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source expectedEtag, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopyDesignerState.Source<TContext> designerState = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.GitBinding.Source<TContext> gitBinding = default, in Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.JsonString.Source name = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
