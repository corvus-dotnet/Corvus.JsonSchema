...
/// <summary>
/// Result type for the RegisterSource operation.
/// </summary>
public readonly struct RegisterSourceResult
{
    private RegisterSourceResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="RegisterSourceResult"/> with status 201.</returns>
    public static RegisterSourceResult Created(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceEntity.Source body, JsonWorkspace workspace) => new(201, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceEntity.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RegisterSourceResult"/> with status 201.</returns>
    public static RegisterSourceResult Created<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SourceEntity.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RegisterSourceResult"/> with status 400.</returns>
    public static RegisterSourceResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RegisterSourceResult"/> with status 409.</returns>
    public static RegisterSourceResult Conflict(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(409, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RegisterSourceResult"/> with status 409.</returns>
    public static RegisterSourceResult Conflict<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
