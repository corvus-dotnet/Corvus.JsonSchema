...
/// <summary>
/// Result type for the RerunRun operation.
/// </summary>
public readonly struct RerunRunResult
{
    private RerunRunResult(int statusCode, JsonElement body, string? contentType, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryAfterSeconds retryAfter = default)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RerunRunResult"/> with status 202.</returns>
    public static RerunRunResult Accepted<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkflowRunAccepted.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RerunRunResult"/> with status 404.</returns>
    public static RerunRunResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RerunRunResult"/> with status 409.</returns>
    public static RerunRunResult Conflict(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(409, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/problem+json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RerunRunResult"/> with status 409.</returns>
    public static RerunRunResult Conflict<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="retryAfter">The value for the <c>Retry-After</c> response header.</param>
    /// <returns>A <see cref="RerunRunResult"/> with status 429.</returns>
    public static RerunRunResult TooManyRequests<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.QuotaProblem.Source<TContext> body, JsonWorkspace workspace, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.RetryAfterSeconds.Source retryAfter = default)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RerunRunResult"/> with status 422.</returns>
    public static RerunRunResult UnprocessableEntity<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ValidationResult.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
