...
/// <summary>
/// Result type for the RevokeRunner operation.
/// </summary>
public readonly struct RevokeRunnerResult
{
    private RevokeRunnerResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RevokeRunnerResult"/> with status 200.</returns>
    public static RevokeRunnerResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.EnvironmentRunnerAuthorizationView.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RevokeRunnerResult"/> with status 403.</returns>
    public static RevokeRunnerResult Forbidden<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RevokeRunnerResult"/> with status 404.</returns>
    public static RevokeRunnerResult NotFound(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(404, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RevokeRunnerResult"/> with status 404.</returns>
    public static RevokeRunnerResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
