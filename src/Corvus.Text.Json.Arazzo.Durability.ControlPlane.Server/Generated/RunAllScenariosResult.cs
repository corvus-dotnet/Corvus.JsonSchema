...
/// <summary>
/// Result type for the RunAllScenarios operation.
/// </summary>
public readonly struct RunAllScenariosResult
{
    private RunAllScenariosResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="RunAllScenariosResult"/> with status 200.</returns>
    public static RunAllScenariosResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioSuiteReport.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioSuiteReport.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RunAllScenariosResult"/> with status 200.</returns>
    public static RunAllScenariosResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioSuiteReport.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioSuiteReport.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RunAllScenariosResult"/> with status 400.</returns>
    public static RunAllScenariosResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RunAllScenariosResult"/> with status 404.</returns>
    public static RunAllScenariosResult NotFound(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(404, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="RunAllScenariosResult"/> with status 404.</returns>
    public static RunAllScenariosResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ScenarioSuiteReport.From(this.Body).EvaluateSchema(),
