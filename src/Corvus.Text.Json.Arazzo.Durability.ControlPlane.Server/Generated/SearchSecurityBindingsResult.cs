...
/// <summary>
/// Result type for the SearchSecurityBindings operation.
/// </summary>
public readonly struct SearchSecurityBindingsResult
{
    private SearchSecurityBindingsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="SearchSecurityBindingsResult"/> with status 200.</returns>
    public static SearchSecurityBindingsResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingList.Source<TContext> body, JsonWorkspace workspace)
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingList.From(this.Body).EvaluateSchema(),
            _ => true,
        };
    }
