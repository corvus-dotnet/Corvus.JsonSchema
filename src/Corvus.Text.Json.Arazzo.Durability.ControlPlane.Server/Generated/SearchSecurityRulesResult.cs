...
/// <summary>
/// Result type for the SearchSecurityRules operation.
/// </summary>
public readonly struct SearchSecurityRulesResult
{
    private SearchSecurityRulesResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="SearchSecurityRulesResult"/> with status 200.</returns>
    public static SearchSecurityRulesResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityRuleList.Source<TContext> body, JsonWorkspace workspace)
