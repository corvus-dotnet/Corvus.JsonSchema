...
/// <summary>
/// Result type for the UpdateSecurityBinding operation.
/// </summary>
public readonly struct UpdateSecurityBindingResult
{
    private UpdateSecurityBindingResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="UpdateSecurityBindingResult"/> with status 200.</returns>
    public static UpdateSecurityBindingResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingSummary.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingSummary.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="UpdateSecurityBindingResult"/> with status 200.</returns>
    public static UpdateSecurityBindingResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.SecurityBindingSummary.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="UpdateSecurityBindingResult"/> with status 400.</returns>
    public static UpdateSecurityBindingResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="UpdateSecurityBindingResult"/> with status 403.</returns>
    public static UpdateSecurityBindingResult Forbidden<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="UpdateSecurityBindingResult"/> with status 404.</returns>
    public static UpdateSecurityBindingResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
