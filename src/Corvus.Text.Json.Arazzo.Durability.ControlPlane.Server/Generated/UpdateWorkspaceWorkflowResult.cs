...
/// <summary>
/// Result type for the UpdateWorkspaceWorkflow operation.
/// </summary>
public readonly struct UpdateWorkspaceWorkflowResult
{
    private UpdateWorkspaceWorkflowResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <returns>A <see cref="UpdateWorkspaceWorkflowResult"/> with status 200.</returns>
    public static UpdateWorkspaceWorkflowResult Ok(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopy.Source body, JsonWorkspace workspace) => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopy.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="UpdateWorkspaceWorkflowResult"/> with status 200.</returns>
    public static UpdateWorkspaceWorkflowResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.WorkingCopy.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="UpdateWorkspaceWorkflowResult"/> with status 400.</returns>
    public static UpdateWorkspaceWorkflowResult BadRequest<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="UpdateWorkspaceWorkflowResult"/> with status 404.</returns>
    public static UpdateWorkspaceWorkflowResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="UpdateWorkspaceWorkflowResult"/> with status 409.</returns>
    public static UpdateWorkspaceWorkflowResult Conflict(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(409, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="UpdateWorkspaceWorkflowResult"/> with status 409.</returns>
    public static UpdateWorkspaceWorkflowResult Conflict<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
