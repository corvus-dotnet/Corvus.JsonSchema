...
/// <summary>
/// Result type for the ValidateCatalogValue operation.
/// </summary>
public readonly struct ValidateCatalogValueResult
{
    private ValidateCatalogValueResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ValidateCatalogValueResult"/> with status 200.</returns>
    public static ValidateCatalogValueResult Ok<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ValidationResult.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
        => new(200, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ValidationResult.CreateBuilder(workspace, in body, 30).RootElement, "application/json");
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ValidateCatalogValueResult"/> with status 404.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="ValidateCatalogValueResult"/> with status 404.</returns>
    public static ValidateCatalogValueResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ValidationResult.From(this.Body).EvaluateSchema(),
