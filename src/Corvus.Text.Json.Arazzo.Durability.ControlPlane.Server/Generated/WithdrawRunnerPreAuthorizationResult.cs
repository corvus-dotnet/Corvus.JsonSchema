...
/// <summary>
/// Result type for the WithdrawRunnerPreAuthorization operation.
/// </summary>
public readonly struct WithdrawRunnerPreAuthorizationResult
{
    private WithdrawRunnerPreAuthorizationResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="WithdrawRunnerPreAuthorizationResult"/> with status 204.</returns>
    public static WithdrawRunnerPreAuthorizationResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="WithdrawRunnerPreAuthorizationResult"/> with status 403.</returns>
    public static WithdrawRunnerPreAuthorizationResult Forbidden<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="WithdrawRunnerPreAuthorizationResult"/> with status 404.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="WithdrawRunnerPreAuthorizationResult"/> with status 404.</returns>
    public static WithdrawRunnerPreAuthorizationResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="WithdrawRunnerPreAuthorizationResult"/> with status 409.</returns>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="WithdrawRunnerPreAuthorizationResult"/> with status 409.</returns>
    public static WithdrawRunnerPreAuthorizationResult Conflict<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
