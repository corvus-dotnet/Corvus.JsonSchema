...
/// <summary>
/// Result type for the WithdrawVersionAvailability operation.
/// </summary>
public readonly struct WithdrawVersionAvailabilityResult
{
    private WithdrawVersionAvailabilityResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="WithdrawVersionAvailabilityResult"/> with status 204.</returns>
    public static WithdrawVersionAvailabilityResult NoContent() => new(204, default, null);
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="WithdrawVersionAvailabilityResult"/> with status 403.</returns>
    public static WithdrawVersionAvailabilityResult Forbidden<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    ...
    /// <param name="body">The response body.</param>
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="WithdrawVersionAvailabilityResult"/> with status 404.</returns>
    public static WithdrawVersionAvailabilityResult NotFound(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source body, JsonWorkspace workspace) => new(404, Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.CreateBuilder(workspace, body, 30).RootElement, "application/json");
    /// <summary>
    ...
    /// <param name="workspace">The workspace for building the response value.</param>
    /// <returns>A <see cref="WithdrawVersionAvailabilityResult"/> with status 404.</returns>
    public static WithdrawVersionAvailabilityResult NotFound<TContext>(Corvus.Text.Json.Arazzo.Durability.ControlPlane.Server.Models.ProblemDetails.Source<TContext> body, JsonWorkspace workspace)
    #if NET9_0_OR_GREATER
        where TContext : allows ref struct
    #endif
