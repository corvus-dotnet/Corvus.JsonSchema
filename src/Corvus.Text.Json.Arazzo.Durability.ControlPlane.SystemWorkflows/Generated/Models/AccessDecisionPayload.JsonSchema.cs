...
public readonly partial struct AccessDecisionPayload
    : IJsonElement<AccessDecisionPayload>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchReason(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/accessDecisionPayload"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/accessDecisionPayload";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/accessDecisionPayload"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyRequestIdNotPresent, "requestId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyRequestIdPresent, "requestId"u8, "required"u8);
