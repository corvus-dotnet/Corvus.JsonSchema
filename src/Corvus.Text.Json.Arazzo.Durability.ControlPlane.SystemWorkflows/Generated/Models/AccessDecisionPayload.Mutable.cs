...
public readonly partial struct AccessDecisionPayload
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AccessDecisionPayload instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AccessDecisionPayload"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AccessDecisionPayload(Mutable instance)
        {
        ...
        public void SetDecidedBy(scoped in Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.JsonString.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("decidedBy");
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AccessDecisionPayload.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly AccessDecisionPayload Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly AccessDecisionPayload Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AccessDecisionPayload>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(AccessDecisionPayload instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.AccessDecisionPayload.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<AccessDecisionPayload, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<AccessDecisionPayload> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<AccessDecisionPayload>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<AccessDecisionPayload> Create<TContext>(
