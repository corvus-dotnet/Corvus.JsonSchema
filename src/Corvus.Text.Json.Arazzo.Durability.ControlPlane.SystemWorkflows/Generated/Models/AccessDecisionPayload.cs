...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AccessDecisionPayload"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AccessDecisionPayload(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AccessDecisionPayload DefaultInstance { get; }
    ...
    /// </para>
    /// <para>
    /// The access request the decision concerns (the correlation token).
    /// </para>
    /// </remarks>
    ...
    /// </returns>
    public static bool operator ==(in AccessDecisionPayload left, in AccessDecisionPayload right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AccessDecisionPayload left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AccessDecisionPayload instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AccessDecisionPayload(JsonElement instance)
    {
        return AccessDecisionPayload.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessDecisionPayload From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessDecisionPayload ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessDecisionPayload>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessDecisionPayload ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessDecisionPayload>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AccessDecisionPayload ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessDecisionPayload>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AccessDecisionPayload ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AccessDecisionPayload>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AccessDecisionPayload? result)
    {
        return JsonElementHelpers.TryParseValue<AccessDecisionPayload>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new AccessDecisionPayload(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static AccessDecisionPayload IJsonElement<AccessDecisionPayload>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AccessDecisionPayload: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="AccessDecisionPayload"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="AccessDecisionPayload"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public AccessDecisionPayload Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<AccessDecisionPayload>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="AccessDecisionPayload"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public AccessDecisionPayload Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AccessDecisionPayload>(_idx);
        }
