...
/// <summary>
/// Producer for the <c>publishAccessDecision</c> operation on channel <c>access.decision</c>.
/// </summary>
public sealed class PublishAccessDecisionProducer
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PublishAccessDecisionProducer"/> class.
    /// </summary>
    ...
    public PublishAccessDecisionProducer(IMessageTransport transport, ValidationMode validationMode = ValidationMode.Basic, IMessageAuthenticationProvider? authProvider = null)
    {
    ...
    /// <summary>
    /// Publishes a <c>accessDecision</c> message.
    /// </summary>
    /// <param name="payload">The message payload.</param>
    /// <param name="cancellationToken">A cancellation token.</param>
    public ValueTask PublishAccessDecisionAsync(Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.AccessDecisionPayload.Source payload, CancellationToken cancellationToken = default)
    {
        JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
        Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.AccessDecisionPayload payloadValue = Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.AccessDecisionPayload.CreateBuilder(workspace, payload, 30).RootElement;
