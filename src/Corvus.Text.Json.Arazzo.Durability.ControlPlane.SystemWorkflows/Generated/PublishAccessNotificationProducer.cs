...
/// <summary>
/// Producer for the <c>publishAccessNotification</c> operation on channel <c>access.notify</c>.
/// </summary>
public sealed class PublishAccessNotificationProducer
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PublishAccessNotificationProducer"/> class.
    /// </summary>
    ...
    public PublishAccessNotificationProducer(IMessageTransport transport, ValidationMode validationMode = ValidationMode.Basic, IMessageAuthenticationProvider? authProvider = null)
    {
    ...
    /// <summary>
    /// Publishes a <c>accessNotification</c> message.
    /// </summary>
    /// <param name="payload">The message payload.</param>
    /// <param name="cancellationToken">A cancellation token.</param>
    public ValueTask PublishAccessNotificationAsync(Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.AccessNotificationPayload.Source payload, CancellationToken cancellationToken = default)
    {
        JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
        Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.AccessNotificationPayload payloadValue = Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.AccessNotificationPayload.CreateBuilder(workspace, payload, 30).RootElement;
