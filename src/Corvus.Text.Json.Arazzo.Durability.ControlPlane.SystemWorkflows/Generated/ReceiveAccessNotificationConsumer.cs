...
public sealed class ReceiveAccessNotificationConsumer : IAsyncDisposable
{
    ...
    {
        return this.transport.SubscribeAsync<Corvus.Text.Json.Arazzo.Durability.ControlPlane.SystemWorkflows.Models.AccessNotificationPayload>(ChannelAddressUtf8, this.HandleMessageAsync, cancellationToken);
    }
