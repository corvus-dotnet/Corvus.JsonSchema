...
public sealed class MySqlSecurityPolicyStore : ISecurityPolicyStore, IAsyncDisposable
{
    ...
    private static async ValueTask<List<ParsedJsonDocument<SecurityRuleDocument>>> ReadRulesAsync(MySqlConnection connection, CancellationToken cancellationToken)
    {
    ...
    private static async ValueTask<List<ParsedJsonDocument<SecurityBindingDocument>>> ReadBindingsAsync(MySqlConnection connection, CancellationToken cancellationToken)
    {
