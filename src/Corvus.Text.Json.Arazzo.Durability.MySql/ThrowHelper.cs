...
/// <summary>
/// Centralized exception-throwing helpers for the MySQL durability backend.
/// </summary>
/// <remarks>
/// <para>
...
internal static class ThrowHelper
{
    ...
    /// <summary>Throws when the MySqlDataSource is not configured with UseAffectedRows=true.</summary>
    /// <param name="paramName">The name of the offending argument.</param>
    [DoesNotReturn]
    [StackTraceHidden]
    public static void ThrowDataSourceRequiresAffectedRows(string paramName)
        => throw new ArgumentException(SR.DataSourceRequiresAffectedRows, paramName);
