...
public sealed class PostgresSecurityPolicyStore : ISecurityPolicyStore, IAsyncDisposable
{
    ...
    private static async ValueTask<IReadOnlyList<SecurityRuleRecord>> ReadRulesAsync(NpgsqlConnection connection, CancellationToken cancellationToken)
    {
    ...
    private static async ValueTask<IReadOnlyList<SecurityBinding>> ReadBindingsAsync(NpgsqlConnection connection, CancellationToken cancellationToken)
    {
