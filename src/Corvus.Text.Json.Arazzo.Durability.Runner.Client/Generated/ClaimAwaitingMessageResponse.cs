...
/// <summary>
/// Response type for the ClaimAwaitingMessage operation.
/// </summary>
public struct ClaimAwaitingMessageResponse : IApiResponse<ClaimAwaitingMessageResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRuns OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ClaimAwaitingMessageResponse> CreateAsync(
        int statusCode,
    ...
    {
        ClaimAwaitingMessageResponse response = default;
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRuns>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRuns result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRuns, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRuns, TContext, TResult> matchOk,
