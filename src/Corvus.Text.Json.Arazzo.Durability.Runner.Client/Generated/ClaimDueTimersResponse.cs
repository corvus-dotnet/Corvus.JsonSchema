...
/// <summary>
/// Response type for the ClaimDueTimers operation.
/// </summary>
public struct ClaimDueTimersResponse : IApiResponse<ClaimDueTimersResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ClaimDueTimersResponse> CreateAsync(
        int statusCode,
    ...
    {
        ClaimDueTimersResponse response = default;
