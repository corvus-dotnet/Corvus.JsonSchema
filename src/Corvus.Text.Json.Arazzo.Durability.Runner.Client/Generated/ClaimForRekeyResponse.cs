...
/// <summary>
/// Response type for the ClaimForRekey operation.
/// </summary>
public struct ClaimForRekeyResponse : IApiResponse<ClaimForRekeyResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RekeyClaims OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ClaimForRekeyResponse> CreateAsync(
        int statusCode,
    ...
    {
        ClaimForRekeyResponse response = default;
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RekeyClaims>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RekeyClaims result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RekeyClaims, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RekeyClaims, TContext, TResult> matchOk,
