...
/// <summary>
/// Response type for the ClaimRun operation.
/// </summary>
public struct ClaimRunResponse : IApiResponse<ClaimRunResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRun OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ClaimRunResponse> CreateAsync(
        int statusCode,
    ...
    {
        ClaimRunResponse response = default;
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRun>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRun result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRun, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRun, TContext, TResult> matchOk,
