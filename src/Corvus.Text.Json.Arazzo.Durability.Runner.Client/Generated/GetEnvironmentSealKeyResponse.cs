...
/// <summary>
/// Response type for the GetEnvironmentSealKey operation.
/// </summary>
public struct GetEnvironmentSealKeyResponse : IApiResponse<GetEnvironmentSealKeyResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetEnvironmentSealKeyResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetEnvironmentSealKeyResponse response = default;
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys, TContext, TResult> matchOk,
