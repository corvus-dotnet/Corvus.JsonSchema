...
/// <summary>
/// Response type for the GetHostedVersion operation.
/// </summary>
public struct GetHostedVersionResponse : IApiResponse<GetHostedVersionResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetHostedVersionResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetHostedVersionResponse response = default;
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion, TContext, TResult> matchOk,
