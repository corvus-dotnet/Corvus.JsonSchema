...
/// <summary>
/// Response type for the GetVersionDocument operation.
/// </summary>
public struct GetVersionDocumentResponse : IApiResponse<GetVersionDocumentResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetVersionDocumentResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetVersionDocumentResponse response = default;
