...
/// <summary>
/// Request type for the ListHostedVersions operation.
/// </summary>
...
public readonly struct ListHostedVersionsRequest : IApiRequest<ListHostedVersionsRequest>
{

    /// <summary>
    /// Gets the pageToken parameter.
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.GetHostedVersionsPageToken PageToken { get; init; }

    /// <summary>
    /// Gets the limit parameter.
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.GetHostedVersionsLimit Limit { get; init; }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/hostedVersions"u8;
