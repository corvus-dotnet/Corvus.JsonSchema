...
/// <summary>
/// Response type for the ListHostedVersions operation.
/// </summary>
public struct ListHostedVersionsResponse : IApiResponse<ListHostedVersionsResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersions OkBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<ListHostedVersionsResponse> CreateAsync(
        int statusCode,
    ...
    {
        ListHostedVersionsResponse response = default;
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersions>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersions result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersions, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersions, TContext, TResult> matchOk,
