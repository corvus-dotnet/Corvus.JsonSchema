...
public readonly partial struct CheckpointSequence
{
...
#endif
    {
        ...
        public static explicit operator Mutable(CheckpointSequence instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="CheckpointSequence"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator CheckpointSequence(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CheckpointSequence.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly CheckpointSequence Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly CheckpointSequence Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<CheckpointSequence>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(CheckpointSequence instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<CheckpointSequence, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<CheckpointSequence> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<CheckpointSequence>();
        }
        finally
        {
