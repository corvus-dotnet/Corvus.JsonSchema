...
public readonly partial struct CheckpointWriteProblem
{
    ...
    public readonly partial struct AcceptedSequenceEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AcceptedSequenceEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AcceptedSequenceEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AcceptedSequenceEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AcceptedSequenceEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly AcceptedSequenceEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AcceptedSequenceEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AcceptedSequenceEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AcceptedSequenceEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AcceptedSequenceEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AcceptedSequenceEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AcceptedSequenceEntity>();
            }
            finally
            {
