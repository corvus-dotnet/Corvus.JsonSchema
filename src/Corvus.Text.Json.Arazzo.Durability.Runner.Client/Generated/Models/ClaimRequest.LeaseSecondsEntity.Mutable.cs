...
public readonly partial struct ClaimRequest
{
    ...
    public readonly partial struct LeaseSecondsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LeaseSecondsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LeaseSecondsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LeaseSecondsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LeaseSecondsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LeaseSecondsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LeaseSecondsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly LeaseSecondsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LeaseSecondsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly LeaseSecondsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LeaseSecondsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LeaseSecondsEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LeaseSecondsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LeaseSecondsEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LeaseSecondsEntity>();
            }
            finally
            {
