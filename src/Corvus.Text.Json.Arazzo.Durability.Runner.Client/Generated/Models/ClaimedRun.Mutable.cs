...
public readonly partial struct ClaimedRun
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ClaimedRun instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ClaimedRun"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClaimedRun(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Mutable Environment
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnvironmentUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Mutable Lease
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable WorkflowId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WorkflowIdUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetEnvironment(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>lease</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetLease(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("lease");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Lease, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetLease<TContext>(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWorkflowId(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClaimedRun.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClaimedRun"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClaimedRun"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ClaimedRun Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClaimedRun"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ClaimedRun Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ClaimedRun>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source _createArg1;
        ...
        public static implicit operator Source(ClaimedRun instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ClaimedRun"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source environment,
            ...
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source workflowId)
        {
            ...
            lease.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Lease, ref builder);
        ...
        #endif
        {
            Create(context, ref _builder, environment, lease, runId, workflowId);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RunId.Source arg3, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg4">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Source<TContext> arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RunId.Source arg3, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg4, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <param name="lease">The value of the <c>"lease"</c> property.</param>
    ...
    /// <param name="workflowId">The value of the <c>"workflowId"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source environment, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Source<TContext> lease, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RunId.Source runId, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source workflowId)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, environment, lease, runId, workflowId);
    }
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, environment, lease, runId, workflowId);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ClaimedRun, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ClaimedRun> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ClaimedRun>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ClaimedRun> Create<TContext>(
    ...
    public static ParsedJsonDocument<ClaimedRun> Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Source lease, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RunId.Source runId, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source workflowId, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ClaimedRun> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Source<TContext> lease, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.RunId.Source runId, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source workflowId, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
