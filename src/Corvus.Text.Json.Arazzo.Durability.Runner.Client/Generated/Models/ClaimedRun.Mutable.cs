...
public readonly partial struct ClaimedRun
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable Environment
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnvironmentUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetEnvironment(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
