...
/// <remarks>
/// <para>
/// The runs claimed by a sweep, each already leased to this runner. Unlike claiming a single run, an empty result is answered as an empty array rather than a 204. A sweep asks about a set, and an empty set has the same shape as a populated one, so the array already says &#39;none&#39; without the client having to branch on the status code to learn it.
/// </para>
/// </remarks>
public readonly partial struct ClaimedRuns
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
    ...
    public readonly partial struct ClaimedRunArray
#if NET8_0_OR_GREATER
        : IJsonElement<ClaimedRunArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClaimedRunArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ClaimedRunArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ClaimedRunArray DefaultInstance { get; }
        ...
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRun this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRun>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRun> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ClaimedRun>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ClaimedRunArray left, in ClaimedRunArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ClaimedRunArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ClaimedRunArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ClaimedRunArray(JsonElement instance)
        {
            return ClaimedRunArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClaimedRunArray From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClaimedRunArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ClaimedRunArray>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClaimedRunArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ClaimedRunArray>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ClaimedRunArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ClaimedRunArray>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ClaimedRunArray ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ClaimedRunArray>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ClaimedRunArray? result)
        {
            return JsonElementHelpers.TryParseValue<ClaimedRunArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ClaimedRunArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ClaimedRunArray IJsonElement<ClaimedRunArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ClaimedRunArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ClaimedRunArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ClaimedRunArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ClaimedRunArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ClaimedRunArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ClaimedRunArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ClaimedRunArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ClaimedRunArray>(_idx);
            }
