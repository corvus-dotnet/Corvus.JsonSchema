    ...
    : IJsonElement<EnvironmentName>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/EnvironmentName"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/EnvironmentName";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/EnvironmentName"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                JsonSchemaEvaluation.MatchLengthLessThanOrEquals(63,stringLength, "maxLength"u8, ref context);
                ...
                JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?$", "pattern"u8, ref context);
            }
        }
...
#else
        private static Regex CreatePattern() => new("^[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?$", RegexOptions.Compiled);
#endif
