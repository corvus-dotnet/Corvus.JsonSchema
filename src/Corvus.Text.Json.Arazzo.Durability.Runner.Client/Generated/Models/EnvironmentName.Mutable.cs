...
public readonly partial struct EnvironmentName
{
...
#endif
    {
        ...
        public static explicit operator Mutable(EnvironmentName instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="EnvironmentName"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentName(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnvironmentName(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EnvironmentName"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EnvironmentName"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly EnvironmentName Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnvironmentName>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EnvironmentName"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly EnvironmentName Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<EnvironmentName>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(EnvironmentName instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<EnvironmentName, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<EnvironmentName> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<EnvironmentName>();
        }
        finally
        {
