...
public readonly partial struct EnvironmentSealKeyGeneration
{
...
#endif
    {
        ...
        public static explicit operator Mutable(EnvironmentSealKeyGeneration instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="EnvironmentSealKeyGeneration"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentSealKeyGeneration(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// The generation&#39;s id, which a runner&#39;s allowlist entry names.
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable KeyId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyIdUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable PredecessorKeyId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PredecessorKeyIdUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Mutable RotationSignature
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RotationSignatureUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Mutable SealPublicKey
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SealPublicKeyUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Mutable State
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StateUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnvironmentSealKeyGeneration(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetKeyId(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPredecessorKeyId(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRotationSignature(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSealPublicKey(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetState(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentSealKeyGeneration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly EnvironmentSealKeyGeneration Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnvironmentSealKeyGeneration>(_idx);
        }

        /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
        public readonly EnvironmentSealKeyGeneration Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<EnvironmentSealKeyGeneration>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source _createArg2;
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Source _createArg3;
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source _createArg4;
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source _createArg5;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Source arg3, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg4, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source arg5)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(EnvironmentSealKeyGeneration instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source keyId,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source sealPublicKey,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Source state,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source predecessorKeyId = default,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source rotationSignature = default)
        {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="EnvironmentSealKeyGeneration"/>.
        /// </summary>
        public void Create(
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source keyId,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source sealPublicKey,
            ...
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source rotationSignature = default)
        {
            Create(ref _builder, keyId, sealPublicKey, state, predecessorKeyId, rotationSignature);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Source arg3, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg4, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source arg5, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source keyId, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source sealPublicKey, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Source state, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source predecessorKeyId = default, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source rotationSignature = default)
    {
        return new Source(keyId, sealPublicKey, state, predecessorKeyId, rotationSignature);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source keyId, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source sealPublicKey, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Source state, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source predecessorKeyId = default, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source rotationSignature = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(keyId, sealPublicKey, state, predecessorKeyId, rotationSignature);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<EnvironmentSealKeyGeneration, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<EnvironmentSealKeyGeneration> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<EnvironmentSealKeyGeneration>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<EnvironmentSealKeyGeneration> Create<TContext>(
    ...
    public static ParsedJsonDocument<EnvironmentSealKeyGeneration> Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source keyId, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source sealPublicKey, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState.Source state, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source predecessorKeyId = default, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String.Source rotationSignature = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
