...
/// <remarks>
/// <para>
/// One registered seal key generation of an environment.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct EnvironmentSealKeyGeneration
#if NET8_0_OR_GREATER
    : IJsonElement<EnvironmentSealKeyGeneration>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    internal EnvironmentSealKeyGeneration(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static EnvironmentSealKeyGeneration DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString KeyId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyIdUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String SealPublicKey
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SealPublicKeyUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonCorvusBase64String value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState State
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StateUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration.EnvironmentSealKeyState value))
            {
                return value;
            }
    ...
    public static bool operator ==(in EnvironmentSealKeyGeneration left, in EnvironmentSealKeyGeneration right)
    {
    ...
    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.operator ==(JsonElement, JsonElement)"/>
    public static bool operator ==(in EnvironmentSealKeyGeneration left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(EnvironmentSealKeyGeneration instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator EnvironmentSealKeyGeneration(JsonElement instance)
    {
        return EnvironmentSealKeyGeneration.From(instance);
    }

    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.From{T}(in T)"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentSealKeyGeneration From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentSealKeyGeneration ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentSealKeyGeneration>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentSealKeyGeneration ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentSealKeyGeneration>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentSealKeyGeneration ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentSealKeyGeneration>(json, options);
        #pragma warning restore CS0618
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static EnvironmentSealKeyGeneration ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentSealKeyGeneration>(ref reader);
        #pragma warning restore CS0618
    }

    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.TryParseValue(ref Utf8JsonReader, out JsonElement?)"/>
    public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentSealKeyGeneration? result)
    {
        return JsonElementHelpers.TryParseValue<EnvironmentSealKeyGeneration>(ref reader, out result);
    }
...
#if NET
    static EnvironmentSealKeyGeneration IJsonElement<EnvironmentSealKeyGeneration>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"EnvironmentSealKeyGeneration: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public EnvironmentSealKeyGeneration Clone()
    {
        CheckValidInstance();
    ...
    public EnvironmentSealKeyGeneration Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<EnvironmentSealKeyGeneration>(_idx);
        }
