...
public readonly partial struct EnvironmentSealKeys
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration>(_idx, index);
            }
        }
        ...
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeyGeneration>(_parent, _idx);
        }
