...
public readonly partial struct EnvironmentSealKeys
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Mutable Generations
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GenerationsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetGenerations(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetGenerations<TContext>(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source generations)
        {
        ...
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source generations)
        {
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source environment,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> generations)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source environment, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source generations)
    {
    ...
    public static ParsedJsonDocument<EnvironmentSealKeys> Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source generations, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<EnvironmentSealKeys> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> generations, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
