...
#endif
{
    ...
    internal EnvironmentSealKeys(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static EnvironmentSealKeys DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray Generations
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GenerationsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray value))
            {
                return value;
            }
    ...
    public static bool operator ==(in EnvironmentSealKeys left, in EnvironmentSealKeys right)
    {
    ...
    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.operator ==(JsonElement, JsonElement)"/>
    public static bool operator ==(in EnvironmentSealKeys left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(EnvironmentSealKeys instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator EnvironmentSealKeys(JsonElement instance)
    {
        return EnvironmentSealKeys.From(instance);
    }

    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.From{T}(in T)"/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentSealKeys From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentSealKeys ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentSealKeys>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentSealKeys ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentSealKeys>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static EnvironmentSealKeys ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentSealKeys>(json, options);
        #pragma warning restore CS0618
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static EnvironmentSealKeys ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<EnvironmentSealKeys>(ref reader);
        #pragma warning restore CS0618
    }

    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.TryParseValue(ref Utf8JsonReader, out JsonElement?)"/>
    public static bool TryParseValue(ref Utf8JsonReader reader, out EnvironmentSealKeys? result)
    {
        return JsonElementHelpers.TryParseValue<EnvironmentSealKeys>(ref reader, out result);
    }
...
#if NET
    static EnvironmentSealKeys IJsonElement<EnvironmentSealKeys>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"EnvironmentSealKeys: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public EnvironmentSealKeys Clone()
    {
        CheckValidInstance();
    ...
    public EnvironmentSealKeys Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<EnvironmentSealKeys>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Generations"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Generations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> GenerationsUtf8 => "generations"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Generations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Generations => "generations"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Generations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Generations => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x67, 0x65, 0x6E, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x73, 0x22];
    }
}
