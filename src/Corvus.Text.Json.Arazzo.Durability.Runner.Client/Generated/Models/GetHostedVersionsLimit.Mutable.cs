...
public readonly partial struct GetHostedVersionsLimit
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetHostedVersionsLimit instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetHostedVersionsLimit"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetHostedVersionsLimit(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetHostedVersionsLimit(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetHostedVersionsLimit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetHostedVersionsLimit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetHostedVersionsLimit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetHostedVersionsLimit Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetHostedVersionsLimit>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetHostedVersionsLimit"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetHostedVersionsLimit Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetHostedVersionsLimit>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetHostedVersionsLimit instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetHostedVersionsLimit, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetHostedVersionsLimit> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetHostedVersionsLimit>();
        }
        finally
        {
