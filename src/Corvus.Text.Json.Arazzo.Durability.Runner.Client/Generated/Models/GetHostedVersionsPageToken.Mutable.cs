...
public readonly partial struct GetHostedVersionsPageToken
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetHostedVersionsPageToken instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetHostedVersionsPageToken"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetHostedVersionsPageToken(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetHostedVersionsPageToken(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetHostedVersionsPageToken.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetHostedVersionsPageToken"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetHostedVersionsPageToken"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetHostedVersionsPageToken Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetHostedVersionsPageToken>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetHostedVersionsPageToken"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetHostedVersionsPageToken Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetHostedVersionsPageToken>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetHostedVersionsPageToken instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetHostedVersionsPageToken, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetHostedVersionsPageToken> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetHostedVersionsPageToken>();
        }
        finally
        {
