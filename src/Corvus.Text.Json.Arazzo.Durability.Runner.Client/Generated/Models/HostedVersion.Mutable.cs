...
public readonly partial struct HostedVersion
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable BaseWorkflowId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BaseWorkflowIdUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable Hash
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HashUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Mutable VersionNumber
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionNumberUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Mutable value))
                {
                    return value;
                }
        ...
        public void SetBaseWorkflowId(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetHash(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetVersionNumber(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Source _createArg3;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source baseWorkflowId,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source hash,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Source versionNumber)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source baseWorkflowId, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source hash, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Source versionNumber)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source baseWorkflowId, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source hash, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Source versionNumber, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<HostedVersion> Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source baseWorkflowId, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source hash, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.Source versionNumber, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
