...
public readonly partial struct HostedVersion
{
    ...
    public readonly partial struct TheVersionNumberWithinTheBaseWorkflow
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheVersionNumberWithinTheBaseWorkflow instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheVersionNumberWithinTheBaseWorkflow"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheVersionNumberWithinTheBaseWorkflow(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheVersionNumberWithinTheBaseWorkflow(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheVersionNumberWithinTheBaseWorkflow.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheVersionNumberWithinTheBaseWorkflow"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheVersionNumberWithinTheBaseWorkflow"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly TheVersionNumberWithinTheBaseWorkflow Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheVersionNumberWithinTheBaseWorkflow>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheVersionNumberWithinTheBaseWorkflow"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly TheVersionNumberWithinTheBaseWorkflow Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheVersionNumberWithinTheBaseWorkflow>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheVersionNumberWithinTheBaseWorkflow instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheVersionNumberWithinTheBaseWorkflow, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheVersionNumberWithinTheBaseWorkflow> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheVersionNumberWithinTheBaseWorkflow>();
            }
            finally
            {
