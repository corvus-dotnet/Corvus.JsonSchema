...
public readonly partial struct HostedVersions
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersion>(_parent, _idx);
        }
