    ...
    : IJsonElement<HostedVersions>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyVersionsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("versions"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyVersionsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("versions"u8, buffer, out written);

        private const int RequiredOffsetForVersions = 0;
        private const uint RequiredBitForVersions = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForVersions;
        ...
        private static void MatchVersions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersions.HostedVersionArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.HostedVersions.HostedVersionArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForVersions] |= RequiredBitForVersions;
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/HostedVersions"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/HostedVersions";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/HostedVersions"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyVersionsPresent, "versions"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForVersions] & RequiredBitForVersions) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyVersionsNotPresent, "versions"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyVersionsPresent, "versions"u8, "required"u8);
