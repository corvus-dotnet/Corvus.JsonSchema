...
public readonly partial struct LeaseGrant
{
    ...
    public readonly partial struct EpochEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EpochEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EpochEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EpochEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EpochEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EpochEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EpochEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EpochEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EpochEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EpochEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EpochEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EpochEntity>();
            }
            finally
            {
