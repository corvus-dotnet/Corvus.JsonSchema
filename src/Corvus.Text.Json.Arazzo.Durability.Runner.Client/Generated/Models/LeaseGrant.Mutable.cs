...
public readonly partial struct LeaseGrant
{
...
#endif
    {
        ...
        public static explicit operator Mutable(LeaseGrant instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="LeaseGrant"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LeaseGrant(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Mutable Epoch
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EpochUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Mutable ExpiresAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpiresAtUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable Token
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Set the <c>epoch</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEpoch(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("epoch");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EpochUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Epoch, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetExpiresAt(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>token</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetToken(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("token");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Token, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LeaseGrant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="LeaseGrant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="LeaseGrant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly LeaseGrant Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="LeaseGrant"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly LeaseGrant Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<LeaseGrant>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(LeaseGrant instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="LeaseGrant"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Source epoch,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Source expiresAt,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source token)
        {
            epoch.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Epoch, ref builder);
            expiresAt.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExpiresAt, ref builder);
            token.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Token, ref builder);
        }
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source token)
        {
            Create(ref _builder, epoch, expiresAt, token);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="epoch">The value of the <c>"epoch"</c> property.</param>
    /// <param name="expiresAt">The value of the <c>"expiresAt"</c> property.</param>
    /// <param name="token">The value of the <c>"token"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Source epoch, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Source expiresAt, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source token)
    {
        return new Source(epoch, expiresAt, token);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="epoch">The value of the property.</param>
    /// <param name="expiresAt">The value of the property.</param>
    /// <param name="token">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Source epoch, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Source expiresAt, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source token, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(epoch, expiresAt, token);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<LeaseGrant, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<LeaseGrant> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<LeaseGrant>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<LeaseGrant> Create<TContext>(
    ...
    public static ParsedJsonDocument<LeaseGrant> Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant.EpochEntity.Source epoch, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonDateTime.Source expiresAt, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString.Source token, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
