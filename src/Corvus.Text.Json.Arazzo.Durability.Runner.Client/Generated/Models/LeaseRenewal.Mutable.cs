...
public readonly partial struct LeaseRenewal
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Mutable LeaseSeconds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetLeaseSeconds(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default)
        {
        ...
        /// Creates an instance of a <see cref="LeaseRenewal"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<LeaseRenewal> Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
