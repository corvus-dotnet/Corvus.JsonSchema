...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity LeaseSeconds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseRenewal.LeaseSecondsEntity value))
            {
                return value;
            }
