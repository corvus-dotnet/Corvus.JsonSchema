...
public readonly partial struct LeaseToken
{
...
#endif
    {
        ...
        public static explicit operator Mutable(LeaseToken instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="LeaseToken"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LeaseToken(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LeaseToken.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly LeaseToken Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly LeaseToken Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<LeaseToken>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(LeaseToken instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<LeaseToken, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<LeaseToken> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<LeaseToken>();
        }
        finally
        {
