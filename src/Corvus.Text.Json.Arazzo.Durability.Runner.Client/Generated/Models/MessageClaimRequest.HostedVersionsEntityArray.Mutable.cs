...
public readonly partial struct MessageClaimRequest
{
    ...
    public readonly partial struct HostedVersionsEntityArray
    {
...
#endif
        {
            ...
            public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity oldItem, in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.MessageClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity.Source value)
            {
