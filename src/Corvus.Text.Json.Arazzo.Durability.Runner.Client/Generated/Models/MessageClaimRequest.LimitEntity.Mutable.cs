...
public readonly partial struct MessageClaimRequest
{
    ...
    public readonly partial struct LimitEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LimitEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LimitEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LimitEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LimitEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LimitEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LimitEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LimitEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LimitEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LimitEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LimitEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LimitEntity>();
            }
            finally
            {
