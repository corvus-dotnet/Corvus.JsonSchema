...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ProblemDetails"/> struct.
    /// </summary>
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString Detail
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DetailUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString Instance
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InstanceUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonInteger Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString Title
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonUri Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonUri value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets a <see cref="ProblemDetails"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="ProblemDetails"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="ProblemDetails"/> that lives for the lifetime of its
