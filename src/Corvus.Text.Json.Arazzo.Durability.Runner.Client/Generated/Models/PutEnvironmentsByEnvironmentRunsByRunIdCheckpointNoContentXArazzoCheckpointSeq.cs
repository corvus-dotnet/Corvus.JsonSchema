...
#endif
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator sbyte(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out sbyte result) ? result : throw new FormatException();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator byte(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator short(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out short result) ? result : throw new FormatException();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator ushort(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out ushort result) ? result : throw new FormatException();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator int(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator uint(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out uint result) ? result : throw new FormatException();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator ulong(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out ulong result) ? result : throw new FormatException();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator float(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();

#if NET
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator Int128(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out Int128 result) ? result : throw new FormatException();
#endif

#if NET
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator UInt128(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out UInt128 result) ? result : throw new FormatException();
#endif

#if NET
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator Half(PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq value) => value._parent.TryGetValue(value._idx, out Half result) ? result : throw new FormatException();
#endif
