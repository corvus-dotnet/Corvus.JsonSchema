...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString Counter
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CounterUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString Quota
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuotaUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.JsonString value))
            {
                return value;
            }
