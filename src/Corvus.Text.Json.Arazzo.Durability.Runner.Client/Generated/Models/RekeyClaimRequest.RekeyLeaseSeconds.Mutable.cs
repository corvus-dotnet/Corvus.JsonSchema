...
{
    public readonly partial struct RekeyLeaseSeconds
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RekeyLeaseSeconds instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RekeyLeaseSeconds"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RekeyLeaseSeconds(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RekeyLeaseSeconds(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RekeyLeaseSeconds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly RekeyLeaseSeconds Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RekeyLeaseSeconds>(_idx);
            }

            /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
            public readonly RekeyLeaseSeconds Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RekeyLeaseSeconds>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RekeyLeaseSeconds instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RekeyLeaseSeconds, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RekeyLeaseSeconds> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RekeyLeaseSeconds>();
            }
            finally
            {
