...
public readonly partial struct Schema3
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Schema3 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Schema3"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Schema3(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public readonly Schema3 Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Schema3>(_idx);
        }
    }
    ...
    {
        return workspace.CreateBuilder<Schema3, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<Schema3> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<Schema3>();
        }
        finally
        {
