...
public readonly partial struct TimerClaimRequest
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity>(_parent, _idx);
        }
