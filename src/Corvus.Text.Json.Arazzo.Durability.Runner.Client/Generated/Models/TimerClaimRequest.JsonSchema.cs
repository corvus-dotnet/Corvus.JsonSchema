    ...
    : IJsonElement<TimerClaimRequest>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForHostedVersions = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForHostedVersions;
        ...
        private static void MatchHostedVersions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.HostedVersionsEntityArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.HostedVersionsEntityArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchLeaseSeconds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.LeaseSecondsEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.LeaseSecondsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchLimit(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.LimitEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.LimitEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/TimerClaimRequest"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/TimerClaimRequest";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/TimerClaimRequest"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyHostedVersionsPresent, "hostedVersions"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyHostedVersionsNotPresent, "hostedVersions"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyHostedVersionsPresent, "hostedVersions"u8, "required"u8);
