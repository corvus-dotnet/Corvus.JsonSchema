...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TimerClaimRequest"/> struct.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.HostedVersionsEntityArray HostedVersions
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HostedVersionsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.HostedVersionsEntityArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.LeaseSecondsEntity LeaseSeconds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.LeaseSecondsEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.LimitEntity Limit
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LimitUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.TimerClaimRequest.LimitEntity value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets a <see cref="TimerClaimRequest"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="TimerClaimRequest"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="TimerClaimRequest"/> that lives for the lifetime of its
