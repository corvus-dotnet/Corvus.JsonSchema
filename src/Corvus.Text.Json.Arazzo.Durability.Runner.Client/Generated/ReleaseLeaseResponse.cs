...
/// <summary>
/// Response type for the ReleaseLease operation.
/// </summary>
public struct ReleaseLeaseResponse : IApiResponse<ReleaseLeaseResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<ReleaseLeaseResponse> CreateAsync(
        int statusCode,
    ...
    {
        ReleaseLeaseResponse response = default;
