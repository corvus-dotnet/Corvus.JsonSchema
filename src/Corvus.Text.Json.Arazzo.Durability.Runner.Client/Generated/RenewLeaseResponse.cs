...
/// <summary>
/// Response type for the RenewLease operation.
/// </summary>
public struct RenewLeaseResponse : IApiResponse<RenewLeaseResponse>
{
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant OkBody { get; private set; }
    ...
    /// </summary>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ProblemDetails ConflictBody { get; private set; }
    ...
    /// <inheritdoc/>
    public static async ValueTask<RenewLeaseResponse> CreateAsync(
        int statusCode,
    ...
    {
        RenewLeaseResponse response = default;
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
        ...
        if (statusCode == 409)
        {
            var conflictDoc = await ParsedJsonDocument<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ProblemDetails>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant result)
    {
    ...
    public bool TryGetConflict(out Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ProblemDetails result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant, TResult> matchOk,
        ...
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ProblemDetails, TResult> matchConflict,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.LeaseGrant, TContext, TResult> matchOk,
        ...
        ResponseMatcher<Corvus.Text.Json.Arazzo.Durability.Runner.Client.Models.ProblemDetails, TContext, TResult> matchConflict,
