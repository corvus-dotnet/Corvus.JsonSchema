    ...
    public readonly partial struct HostedVersionsEntityArray
    {
        ...
        public readonly partial struct HostedVersionsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HostedVersionsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HostedVersionsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HostedVersionsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HostedVersionsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HostedVersionsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HostedVersionsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HostedVersionsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HostedVersionsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HostedVersionsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HostedVersionsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HostedVersionsEntity>();
                }
                finally
                {
