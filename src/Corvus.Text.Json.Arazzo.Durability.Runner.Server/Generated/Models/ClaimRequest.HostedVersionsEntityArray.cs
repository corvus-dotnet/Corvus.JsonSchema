...
public readonly partial struct ClaimRequest
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimRequest.HostedVersionsEntityArray.HostedVersionsEntity>(_parent, _idx);
        }
