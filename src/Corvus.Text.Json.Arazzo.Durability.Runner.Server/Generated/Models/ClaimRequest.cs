...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimRequest.HostedVersionsEntityArray HostedVersions
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HostedVersionsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimRequest.HostedVersionsEntityArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimRequest.LeaseSecondsEntity LeaseSeconds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimRequest.LeaseSecondsEntity value))
            {
                return value;
            }
