    ...
    : IJsonElement<ClaimedRun>
{
    public static partial class JsonSchema
    {
        ...
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLeasePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("lease"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLeaseNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("lease"u8, buffer, out written);

        private const int RequiredOffsetForLease = 0;
        private const uint RequiredBitForLease = 0b00000000000000000000000000000010;
        ...
        private const uint RequiredBitForWorkflowId = 0b00000000000000000000000000001000;
        ...
        private static void MatchLease(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.LeaseUtf8,
                    evaluationPath: LeaseSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForLease] |= RequiredBitForLease;
        }
        ...
        private static void MatchRunId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.RunId.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.RunId.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchWorkflowId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        private static PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                ...
                (static () => JsonPropertyNames.LeaseUtf8, MatchLease),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/ClaimedRun"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/ClaimedRun";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/ClaimedRun"u8;
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLeasePresent, "lease"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyRunIdPresent, "runId"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyWorkflowIdPresent, "workflowId"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForLease] & RequiredBitForLease) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyLeaseNotPresent, "lease"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLeasePresent, "lease"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 3, RequiredPropertyWorkflowIdNotPresent, "workflowId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyWorkflowIdPresent, "workflowId"u8, "required"u8);
