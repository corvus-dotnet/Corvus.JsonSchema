...
public readonly partial struct ClaimedRuns
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimedRun this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimedRun>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimedRun> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimedRun>(_parent, _idx);
        }
