    ...
    : IJsonElement<ClaimedRuns>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyClaimsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("claims"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyClaimsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("claims"u8, buffer, out written);

        private const int RequiredOffsetForClaims = 0;
        private const uint RequiredBitForClaims = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForClaims;
        private static readonly JsonSchemaPathProvider ClaimsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/claims"u8, buffer, out written);

        private static void MatchClaims(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimedRuns.ClaimedRunArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ClaimsUtf8,
                    evaluationPath: ClaimsSchemaEvaluationPath);

            Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimedRuns.ClaimedRunArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForClaims] |= RequiredBitForClaims;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.ClaimsUtf8))
            {
                matcher = MatchClaims;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/ClaimedRuns"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/ClaimedRuns";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/ClaimedRuns"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyClaimsPresent, "claims"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForClaims] & RequiredBitForClaims) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyClaimsNotPresent, "claims"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyClaimsPresent, "claims"u8, "required"u8);
