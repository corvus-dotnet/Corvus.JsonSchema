...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimedRuns.ClaimedRunArray Claims
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ClaimsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.ClaimedRuns.ClaimedRunArray value))
            {
                return value;
            }
