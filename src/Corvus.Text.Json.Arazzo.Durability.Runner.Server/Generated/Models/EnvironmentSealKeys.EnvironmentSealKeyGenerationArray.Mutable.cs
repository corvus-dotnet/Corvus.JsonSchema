...
public readonly partial struct EnvironmentSealKeys
{
    public readonly partial struct EnvironmentSealKeyGenerationArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EnvironmentSealKeyGenerationArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnvironmentSealKeyGenerationArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnvironmentSealKeyGenerationArray(Mutable instance)
            {
            ...
            public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Mutable>(_idx, index);
                }
            }
            ...
            public ArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Mutable>(_parent, _idx);
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnvironmentSealKeyGenerationArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration oldItem, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration current = enumerator.Current;
            ...
            public readonly EnvironmentSealKeyGenerationArray Clone()
            {
                CheckValidInstance();
            ...
            public readonly EnvironmentSealKeyGenerationArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnvironmentSealKeyGenerationArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(EnvironmentSealKeyGenerationArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeyGeneration.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<EnvironmentSealKeyGenerationArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnvironmentSealKeyGenerationArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnvironmentSealKeyGenerationArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<EnvironmentSealKeyGenerationArray> Create<TContext>(
