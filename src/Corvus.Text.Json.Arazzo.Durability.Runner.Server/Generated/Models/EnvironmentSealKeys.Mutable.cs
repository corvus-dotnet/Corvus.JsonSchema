...
public readonly partial struct EnvironmentSealKeys
{
...
#endif
    {
        ...
        public static explicit operator Mutable(EnvironmentSealKeys instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="EnvironmentSealKeys"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnvironmentSealKeys(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Mutable Environment
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnvironmentUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>generations</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Mutable Generations
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GenerationsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnvironmentSealKeys(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetEnvironment(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>generations</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetGenerations(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("generations");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GenerationsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Generations, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetGenerations<TContext>(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnvironmentSealKeys.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public readonly EnvironmentSealKeys Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnvironmentSealKeys>(_idx);
        }

        /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
        public readonly EnvironmentSealKeys Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<EnvironmentSealKeys>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(EnvironmentSealKeys instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> _createArg2;
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source environment,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source generations)
        {
            environment.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Environment, ref builder);
            generations.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Generations, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="EnvironmentSealKeys"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source generations)
        {
            Create(ref _builder, environment, generations);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source environment,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> generations)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, environment, generations);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <param name="generations">The value of the <c>"generations"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source environment, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source generations)
    {
        return new Source(environment, generations);
    }
    ...
    /// <param name="generations">The value of the <c>"generations"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source environment, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> generations)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, environment, generations);
    }
    ...
    /// <param name="generations">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source generations, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(environment, generations);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> generations, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, environment, generations);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<EnvironmentSealKeys, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<EnvironmentSealKeys> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<EnvironmentSealKeys>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<EnvironmentSealKeys> Create<TContext>(
    ...
    public static ParsedJsonDocument<EnvironmentSealKeys> Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source generations, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<EnvironmentSealKeys> Create<TContext>(in TContext context, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentName.Source environment, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray.Source<TContext> generations, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
