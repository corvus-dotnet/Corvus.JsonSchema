...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray Generations
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GenerationsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.EnvironmentSealKeys.EnvironmentSealKeyGenerationArray value))
            {
                return value;
            }
