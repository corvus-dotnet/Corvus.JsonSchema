    ...
    : IJsonElement<HostedVersion>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForHash = 0b00000000000000000000000000000010;
        ...
        private const uint RequiredBitForVersionNumber = 0b00000000000000000000000000000100;

        private const uint RequiredBitMask0 =
            RequiredBitForBaseWorkflowId | RequiredBitForHash | RequiredBitForVersionNumber;
        ...
        private static void MatchHash(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchVersionNumber(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/HostedVersion"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/HostedVersion";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/HostedVersion"u8;
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyHashPresent, "hash"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyVersionNumberPresent, "versionNumber"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyHashNotPresent, "hash"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyHashPresent, "hash"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyVersionNumberNotPresent, "versionNumber"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyVersionNumberPresent, "versionNumber"u8, "required"u8);
