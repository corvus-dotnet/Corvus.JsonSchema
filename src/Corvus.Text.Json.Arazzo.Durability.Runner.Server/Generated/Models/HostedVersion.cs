...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="HostedVersion"/> struct.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString BaseWorkflowId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BaseWorkflowIdUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString Hash
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HashUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow VersionNumber
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionNumberUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.HostedVersion.TheVersionNumberWithinTheBaseWorkflow value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets a <see cref="HostedVersion"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="HostedVersion"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="HostedVersion"/> that lives for the lifetime of its
