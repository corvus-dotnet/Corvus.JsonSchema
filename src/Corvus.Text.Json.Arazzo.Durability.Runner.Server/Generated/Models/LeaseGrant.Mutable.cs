...
public readonly partial struct LeaseGrant
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Mutable Epoch
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EpochUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Mutable ExpiresAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpiresAtUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.Mutable Token
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetEpoch(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetExpiresAt(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetToken(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Source _createArg1;
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Source _createArg2;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Source epoch,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Source expiresAt,
            in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.Source token)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Source arg1, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Source arg2, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Source epoch, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Source expiresAt, scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.Source token)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Source epoch, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Source expiresAt, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.Source token, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<LeaseGrant> Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity.Source epoch, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime.Source expiresAt, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString.Source token, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
