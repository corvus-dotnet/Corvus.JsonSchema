...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity Epoch
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EpochUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseGrant.EpochEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime ExpiresAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExpiresAtUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString Token
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.JsonString value))
            {
                return value;
            }
