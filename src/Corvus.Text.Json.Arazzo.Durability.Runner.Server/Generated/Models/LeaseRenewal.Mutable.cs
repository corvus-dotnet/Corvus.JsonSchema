...
public readonly partial struct LeaseRenewal
{
...
#endif
    {
        ...
        public static explicit operator Mutable(LeaseRenewal instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="LeaseRenewal"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LeaseRenewal(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Mutable LeaseSeconds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetLeaseSeconds(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LeaseRenewal.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="LeaseRenewal"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="LeaseRenewal"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly LeaseRenewal Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="LeaseRenewal"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly LeaseRenewal Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<LeaseRenewal>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Source _createArg1;
        ...
        internal Source(Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(LeaseRenewal instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="LeaseRenewal"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default)
        {
        ...
        /// Creates an instance of a <see cref="LeaseRenewal"/>.
        /// </summary>
        public void Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default)
        {
            Create(ref _builder, leaseSeconds);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default)
    {
        return new Source(leaseSeconds);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(leaseSeconds);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<LeaseRenewal, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<LeaseRenewal> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<LeaseRenewal>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<LeaseRenewal> Create<TContext>(
    ...
    public static ParsedJsonDocument<LeaseRenewal> Create(in Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.LeaseRenewal.LeaseSecondsEntity.Source leaseSeconds = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
