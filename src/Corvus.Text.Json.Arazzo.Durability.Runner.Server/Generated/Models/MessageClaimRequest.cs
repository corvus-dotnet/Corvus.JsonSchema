...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.MessageClaimRequest.CorrelationIdEntity CorrelationId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CorrelationIdUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.MessageClaimRequest.CorrelationIdEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.MessageClaimRequest.HostedVersionsEntityArray HostedVersions
    {
        get
        {
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.MessageClaimRequest.LeaseSecondsEntity LeaseSeconds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LeaseSecondsUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.MessageClaimRequest.LeaseSecondsEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.MessageClaimRequest.LimitEntity Limit
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LimitUtf8, out Corvus.Text.Json.Arazzo.Durability.Runner.Server.Models.MessageClaimRequest.LimitEntity value))
            {
                return value;
            }
