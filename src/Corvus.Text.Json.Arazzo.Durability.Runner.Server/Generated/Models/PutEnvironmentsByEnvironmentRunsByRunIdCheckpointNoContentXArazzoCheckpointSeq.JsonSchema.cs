    ...
    : IJsonElement<PutEnvironmentsByEnvironmentRunsByRunIdCheckpointNoContentXArazzoCheckpointSeq>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1environments~1{environment}~1runs~1{runId}~1checkpoint/put/responses/204/headers/X-Arazzo-Checkpoint-Seq/schema"u8, buffer, out written);
