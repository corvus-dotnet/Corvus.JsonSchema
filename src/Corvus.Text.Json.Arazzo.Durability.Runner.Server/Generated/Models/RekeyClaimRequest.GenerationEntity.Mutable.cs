...
public readonly partial struct RekeyClaimRequest
{
    public readonly partial struct GenerationEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GenerationEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GenerationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GenerationEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GenerationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly GenerationEntity Clone()
            {
                CheckValidInstance();
            ...
            public readonly GenerationEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GenerationEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(GenerationEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<GenerationEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<GenerationEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<GenerationEntity>();
            }
            finally
            {
