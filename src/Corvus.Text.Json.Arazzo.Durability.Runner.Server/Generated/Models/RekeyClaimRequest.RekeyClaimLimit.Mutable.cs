...
{
    public readonly partial struct RekeyClaimLimit
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RekeyClaimLimit instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RekeyClaimLimit"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RekeyClaimLimit(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RekeyClaimLimit(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RekeyClaimLimit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly RekeyClaimLimit Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RekeyClaimLimit>(_idx);
            }

            /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
            public readonly RekeyClaimLimit Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RekeyClaimLimit>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RekeyClaimLimit instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RekeyClaimLimit, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RekeyClaimLimit> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RekeyClaimLimit>();
            }
            finally
            {
