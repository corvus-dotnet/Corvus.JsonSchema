    ...
    : IJsonElement<Schema>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/responses/QuotaExceeded/headers/Retry-After/schema"u8, buffer, out written);
