...
/// Either way <see cref="HostedWorkflowExecution.RunAsync(IHostedWorkflow, WorkflowTransportBinder, WorkflowRun, CancellationToken)"/> runs what is resolved (ADR 0055), so the resolution
