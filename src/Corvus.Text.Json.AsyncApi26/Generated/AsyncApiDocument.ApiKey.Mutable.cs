...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct ApiKey
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ApiKey instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ApiKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ApiKey(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Mutable In
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetIn(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ApiKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ApiKey Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ApiKey>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Source _createArg1;
            private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Source _createArg2;
            ...
            internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Source arg2, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(ApiKey instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ApiKey"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Source inValue,
                in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Source type,
            ...
            public void Create(
                ...
                in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default)
            {
                Create(ref _builder, inValue, type, description);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Source arg2, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Source inValue, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Source type, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default)
        {
            return new Source(inValue, type, description);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Source inValue, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Source type, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(inValue, type, description);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ApiKey, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ApiKey> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ApiKey>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ApiKey> Create<TContext>(
        ...
        public static ParsedJsonDocument<ApiKey> Create(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Source inValue, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Source type, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
