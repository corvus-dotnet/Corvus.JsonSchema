...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct ApiKey
    {
...
#endif
        {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetIn(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheLocationOfTheApiKey.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ApiKey.TheTypeOfTheSecurityScheme.Source value)
            {
                CheckValidInstance();
