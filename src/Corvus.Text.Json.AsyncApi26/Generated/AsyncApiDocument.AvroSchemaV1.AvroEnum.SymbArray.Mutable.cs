...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct AvroEnum
        {
            ...
            public readonly partial struct SymbArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SymbArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SymbArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SymbArray(Mutable instance)
                    {
                    ...
                    public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SymbArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SymbArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name oldItem, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="SymbArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SymbArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SymbArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SymbArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SymbArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SymbArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SymbArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroEnum.SymbArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(SymbArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroEnum.SymbArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    public void AddItem(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name.Source value)
                    {
                ...
                {
                    return workspace.CreateBuilder<SymbArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SymbArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SymbArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<SymbArray> Create<TContext>(
