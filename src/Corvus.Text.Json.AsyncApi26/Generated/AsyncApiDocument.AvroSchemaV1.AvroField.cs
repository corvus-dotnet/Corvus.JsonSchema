...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AvroField"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AvroField(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AvroField DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroField.NameArray Aliases
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AliasesUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroField.NameArray value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroField.OrderEntity Order
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroField.OrderEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Types Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Types value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in AvroField left, in AvroField right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AvroField left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AvroField instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AvroField(JsonElement instance)
            {
                return AvroField.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroField From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroField ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroField>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroField ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroField>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroField ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroField>(json, options);
            }
            ...
            /// </exception>
            public static AvroField ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AvroField>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AvroField? result)
            {
                return JsonElementHelpers.TryParseValue<AvroField>(ref reader, out result);
            }
...
#if NET
            static AvroField IJsonElement<AvroField>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AvroField: ValueKind = {ValueKind} : \"{ToString()}\"";
