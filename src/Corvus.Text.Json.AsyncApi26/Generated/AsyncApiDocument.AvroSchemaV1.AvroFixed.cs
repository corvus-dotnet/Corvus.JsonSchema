...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AvroFixed"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AvroFixed(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AvroFixed DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroFixed.NameArray Aliases
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AliasesUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroFixed.NameArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.JsonNumber Size
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SizeUtf8, out Corvus.Text.Json.AsyncApi26.JsonNumber value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroFixed.TypeEntity Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroFixed.TypeEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in AvroFixed left, in AvroFixed right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AvroFixed left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AvroFixed instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AvroFixed(JsonElement instance)
            {
                return AvroFixed.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroFixed From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroFixed ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroFixed>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroFixed ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroFixed>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroFixed ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroFixed>(json, options);
            }
            ...
            /// </exception>
            public static AvroFixed ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AvroFixed>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AvroFixed? result)
            {
                return JsonElementHelpers.TryParseValue<AvroFixed>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AvroFixed(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AvroFixed IJsonElement<AvroFixed>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AvroFixed: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AvroFixed"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AvroFixed"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AvroFixed Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AvroFixed>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AvroFixed"/> that lives for the lifetime of its
