    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct AvroMap
        {
...
#endif
            {
                ...
                public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.Name>(_parent, _idx);
                }
