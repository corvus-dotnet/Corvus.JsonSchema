    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct AvroRecord
        {
...
#endif
            {
                ...
                public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroField this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroField>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroField> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroField>(_parent, _idx);
                }
