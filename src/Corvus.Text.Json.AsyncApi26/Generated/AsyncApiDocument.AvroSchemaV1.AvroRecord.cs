...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroRecord.NameArray Aliases
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AliasesUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroRecord.NameArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroRecord.AvroFieldArray Fields
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FieldsUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroRecord.AvroFieldArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroRecord.TypeEntity Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroRecord.TypeEntity value))
                    {
                        return value;
                    }
