    ...
    public readonly partial struct AvroSchemaV1
    {
            ...
            : IJsonElement<AvroUnion>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1avroSchema_v1.json/definitions/avroUnion"u8, buffer, out written);
