...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroSchema this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroSchema>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroSchema> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.AvroSchema>(_parent, _idx);
            }
