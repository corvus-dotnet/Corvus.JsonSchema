    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct CustomTypeReference
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CustomTypeReference instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CustomTypeReference"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CustomTypeReference(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CustomTypeReference.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CustomTypeReference Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CustomTypeReference Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CustomTypeReference>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CustomTypeReference instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CustomTypeReference, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CustomTypeReference> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CustomTypeReference>();
                }
                finally
                {
