    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct PrimitiveType
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PrimitiveType instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PrimitiveType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PrimitiveType(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PrimitiveType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PrimitiveType Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PrimitiveType Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PrimitiveType>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PrimitiveType instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (PrimitiveType)value;
            ...
            {
                return workspace.CreateBuilder<PrimitiveType, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PrimitiveType> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PrimitiveType>();
                }
                finally
                {
