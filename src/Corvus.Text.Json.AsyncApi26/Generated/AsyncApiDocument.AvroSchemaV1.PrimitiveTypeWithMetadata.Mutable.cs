...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct PrimitiveTypeWithMetadata
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PrimitiveTypeWithMetadata instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PrimitiveTypeWithMetadata"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PrimitiveTypeWithMetadata(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PrimitiveTypeWithMetadata(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetType(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PrimitiveTypeWithMetadata.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PrimitiveTypeWithMetadata"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PrimitiveTypeWithMetadata"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PrimitiveTypeWithMetadata Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PrimitiveTypeWithMetadata>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PrimitiveTypeWithMetadata"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PrimitiveTypeWithMetadata Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PrimitiveTypeWithMetadata>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source _createArg1;
                ...
                internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveTypeWithMetadata.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(PrimitiveTypeWithMetadata instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveTypeWithMetadata.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="PrimitiveTypeWithMetadata"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type)
                {
                ...
                /// Creates an instance of a <see cref="PrimitiveTypeWithMetadata"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<PrimitiveTypeWithMetadata, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PrimitiveTypeWithMetadata> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PrimitiveTypeWithMetadata>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PrimitiveTypeWithMetadata> Create<TContext>(
            ...
            public static ParsedJsonDocument<PrimitiveTypeWithMetadata> Create(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
