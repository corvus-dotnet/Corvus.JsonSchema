...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1.PrimitiveType value))
                    {
                        return value;
                    }
