...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct BearerHttpSecurityScheme
    {
...
#endif
        {
            ...
            public void SetBearerFormat(in Corvus.Text.Json.AsyncApi26.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetScheme(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.BearerHttpSecurityScheme.SchemeEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.BearerHttpSecurityScheme.TheTypeOfTheSecurityScheme.Source value)
            {
                CheckValidInstance();
