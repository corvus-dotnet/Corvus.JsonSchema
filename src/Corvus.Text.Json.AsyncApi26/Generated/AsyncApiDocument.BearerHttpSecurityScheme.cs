...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct BearerHttpSecurityScheme
#if NET8_0_OR_GREATER
        : IJsonElement<BearerHttpSecurityScheme>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BearerHttpSecurityScheme"/> struct.
        /// </summary>
        ...
        internal BearerHttpSecurityScheme(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BearerHttpSecurityScheme DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi26.JsonString BearerFormat
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BearerFormatUtf8, out Corvus.Text.Json.AsyncApi26.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.BearerHttpSecurityScheme.SchemeEntity Scheme
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.BearerHttpSecurityScheme.SchemeEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.BearerHttpSecurityScheme.TheTypeOfTheSecurityScheme Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.BearerHttpSecurityScheme.TheTypeOfTheSecurityScheme value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in BearerHttpSecurityScheme left, in BearerHttpSecurityScheme right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BearerHttpSecurityScheme left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BearerHttpSecurityScheme instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BearerHttpSecurityScheme(JsonElement instance)
        {
            return BearerHttpSecurityScheme.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BearerHttpSecurityScheme From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BearerHttpSecurityScheme ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BearerHttpSecurityScheme>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BearerHttpSecurityScheme ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BearerHttpSecurityScheme>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BearerHttpSecurityScheme ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BearerHttpSecurityScheme>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static BearerHttpSecurityScheme ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BearerHttpSecurityScheme>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BearerHttpSecurityScheme? result)
        {
            return JsonElementHelpers.TryParseValue<BearerHttpSecurityScheme>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BearerHttpSecurityScheme(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BearerHttpSecurityScheme IJsonElement<BearerHttpSecurityScheme>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BearerHttpSecurityScheme: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BearerHttpSecurityScheme"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BearerHttpSecurityScheme"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BearerHttpSecurityScheme Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BearerHttpSecurityScheme>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BearerHttpSecurityScheme"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BearerHttpSecurityScheme Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BearerHttpSecurityScheme>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="BearerFormat"/>.
            /// </summary>
            public static ReadOnlySpan<byte> BearerFormat => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x62, 0x65, 0x61, 0x72, 0x65, 0x72, 0x46, 0x6F, 0x72, 0x6D, 0x61, 0x74, 0x22];
