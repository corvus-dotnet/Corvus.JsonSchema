...
public readonly partial struct AsyncApiDocument
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelItem"/> struct.
        /// </summary>
        ...
        internal ChannelItem(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ChannelItem DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ChannelItem.DeprecatedEntity Deprecated
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeprecatedUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ChannelItem.DeprecatedEntity value))
                {
                    return value;
                }

                return Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ChannelItem.DeprecatedEntity.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Operation Publish
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PublishUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Operation value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ChannelItem.JsonStringArray Servers
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ServersUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ChannelItem.JsonStringArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Operation Subscribe
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubscribeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Operation value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ChannelItem left, in ChannelItem right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ChannelItem left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ChannelItem instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ChannelItem(JsonElement instance)
        {
            return ChannelItem.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ChannelItem From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ChannelItem ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ChannelItem>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ChannelItem ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ChannelItem>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ChannelItem ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ChannelItem>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ChannelItem ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ChannelItem>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ChannelItem? result)
        {
            return JsonElementHelpers.TryParseValue<ChannelItem>(ref reader, out result);
        }
...
#if NET
        static ChannelItem IJsonElement<ChannelItem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ChannelItem: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="Subscribe"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="Subscribe"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SubscribeUtf8 => "subscribe"u8;
        }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Subscribe"/>.
            /// </summary>
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Subscribe"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Subscribe => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x22];
        }
    }
}
