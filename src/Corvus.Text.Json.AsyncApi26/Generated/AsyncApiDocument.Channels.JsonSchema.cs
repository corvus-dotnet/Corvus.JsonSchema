...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Channels>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1channels.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
            /// </summary>
            public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1channels.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1channels.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        using (var fixedJsonString = FixedStringJsonDocument<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Channels.PropertyNamesEntity>.Parse(parentDocument.GetPropertyNameRaw(objectValidation_currentIndex, true), parentDocument.ValueIsEscaped(objectValidation_currentIndex, true)))
                        {
                            JsonSchemaContext childContext =
                                Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Channels.PropertyNamesEntity.JsonSchema.PushChildContext(
                                    fixedJsonString,
                                    0,
                                    ref context,
                                    schemaEvaluationPath: PropertyNamesSchemaEvaluationPath);

                            Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Channels.PropertyNamesEntity.JsonSchema.Evaluate(fixedJsonString, 0, ref childContext);
                        ...
                        {
                            JsonSchemaContext childContext1 = Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ChannelItem.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                            ...
                            Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ChannelItem.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext1);
