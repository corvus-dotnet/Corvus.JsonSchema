...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct OperationTraitsEntity
            ...
            : IJsonElement<OperationTraitsEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OperationTraitsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OperationTraitsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OperationTraitsEntity DefaultInstance { get; }
            ...
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OperationTrait this[ReadOnlySpan<byte> propertyName]
            {
                get
                {
                    CheckValidInstance();
                    if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OperationTrait value))
                    {
                        return default;
                    }
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OperationTrait this[ReadOnlySpan<char> propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OperationTrait this[string propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OperationTrait value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OperationTrait value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OperationTrait value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OperationTrait> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OperationTrait>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in OperationTraitsEntity left, in OperationTraitsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OperationTraitsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OperationTraitsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OperationTraitsEntity(JsonElement instance)
            {
                return OperationTraitsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OperationTraitsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OperationTraitsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OperationTraitsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OperationTraitsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OperationTraitsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OperationTraitsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OperationTraitsEntity>(json, options);
            }
            ...
            /// </exception>
            public static OperationTraitsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OperationTraitsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OperationTraitsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<OperationTraitsEntity>(ref reader, out result);
            }
...
#if NET
            static OperationTraitsEntity IJsonElement<OperationTraitsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OperationTraitsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public OperationTraitsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public OperationTraitsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OperationTraitsEntity>(_idx);
                }
