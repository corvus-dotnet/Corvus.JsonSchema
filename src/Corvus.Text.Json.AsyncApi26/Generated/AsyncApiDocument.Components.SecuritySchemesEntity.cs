...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
...
#endif
        {
            ...
            /// <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Components.SecuritySchemesEntity.WDEntity"/>.
            /// </summary>
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternWdEntity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Components.SecuritySchemesEntity.WDEntity result)
            {
                if (MatchesPatternWdEntity(propertyName))
                {
                    result = Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Components.SecuritySchemesEntity.WDEntity.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternWdEntity(ReadOnlySpan<byte> name, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Components.SecuritySchemesEntity.WDEntity value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Components.SecuritySchemesEntity.WDEntity typedValue = Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Components.SecuritySchemesEntity.WDEntity.From(property.Value);
