...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ServerBindingsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ServerBindingsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ServerBindingsEntity DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in ServerBindingsEntity left, in ServerBindingsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ServerBindingsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ServerBindingsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ServerBindingsEntity(JsonElement instance)
            {
                return ServerBindingsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServerBindingsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServerBindingsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ServerBindingsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServerBindingsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ServerBindingsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ServerBindingsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ServerBindingsEntity>(json, options);
            }
            ...
            /// </exception>
            public static ServerBindingsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ServerBindingsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ServerBindingsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ServerBindingsEntity>(ref reader, out result);
            }
...
#if NET
            static ServerBindingsEntity IJsonElement<ServerBindingsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ServerBindingsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ServerBindingsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ServerBindingsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ServerBindingsEntity>(_idx);
                }
