...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Contact>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchEmail(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1contact.json"u8, buffer, out written);
