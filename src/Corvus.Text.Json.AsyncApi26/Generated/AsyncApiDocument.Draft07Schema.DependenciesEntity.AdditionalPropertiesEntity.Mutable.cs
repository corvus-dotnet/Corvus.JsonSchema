        ...
        public readonly partial struct DependenciesEntity
        {
            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.StringArray" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsStringArray(out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.StringArray result)
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                        {
