...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Draft07Schema
    {
...
#endif
        {
            ...
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.DependenciesEntity.AdditionalPropertiesEntity this[ReadOnlySpan<byte> propertyName]
            {
                get
                {
                    CheckValidInstance();
                    if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.DependenciesEntity.AdditionalPropertiesEntity value))
                    {
                        return default;
                    }
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.DependenciesEntity.AdditionalPropertiesEntity this[ReadOnlySpan<char> propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.DependenciesEntity.AdditionalPropertiesEntity this[string propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.DependenciesEntity.AdditionalPropertiesEntity value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.DependenciesEntity.AdditionalPropertiesEntity value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.DependenciesEntity.AdditionalPropertiesEntity value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.DependenciesEntity.AdditionalPropertiesEntity> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.DependenciesEntity.AdditionalPropertiesEntity>(_parent, _idx);
            }
