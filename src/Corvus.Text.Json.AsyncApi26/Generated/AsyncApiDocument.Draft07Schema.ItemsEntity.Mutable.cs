    ...
    public readonly partial struct Draft07Schema
    {
        ...
        public readonly partial struct ItemsEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.SchemaArray" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsSchemaArray(out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.SchemaArray result)
                {
                    if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                    {
