                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            using (var fixedJsonString = FixedStringJsonDocument<Corvus.Text.Json.AsyncApi26.JsonRegex>.Parse(parentDocument.GetPropertyNameRaw(objectValidation_currentIndex, true), parentDocument.ValueIsEscaped(objectValidation_currentIndex, true)))
                            {
                                JsonSchemaContext childContext =
                                    Corvus.Text.Json.AsyncApi26.JsonRegex.JsonSchema.PushChildContext(
                                        fixedJsonString,
                                        0,
                                        ref context,
                                        schemaEvaluationPath: PropertyNamesSchemaEvaluationPath);

                                Corvus.Text.Json.AsyncApi26.JsonRegex.JsonSchema.Evaluate(fixedJsonString, 0, ref childContext);
                            ...
                            {
                                JsonSchemaContext childContext1 = Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                ...
                                Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext1);
