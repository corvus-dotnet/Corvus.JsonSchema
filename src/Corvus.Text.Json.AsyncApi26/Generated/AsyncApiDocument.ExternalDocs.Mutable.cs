...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct ExternalDocs
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ExternalDocs instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExternalDocs"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExternalDocs(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.JsonUri.Mutable Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.Text.Json.AsyncApi26.JsonUri.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ExternalDocs(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUrl(scoped in Corvus.Text.Json.AsyncApi26.JsonUri.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExternalDocs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ExternalDocs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ExternalDocs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ExternalDocs Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ExternalDocs>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ExternalDocs"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ExternalDocs Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExternalDocs>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi26.JsonUri.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(ExternalDocs instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ExternalDocs"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi26.JsonUri.Source url,
            ...
            /// Creates an instance of a <see cref="ExternalDocs"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.AsyncApi26.JsonUri.Source url, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default)
            {
                Create(ref _builder, url, description);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi26.JsonUri.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi26.JsonUri.Source url, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default)
        {
            return new Source(url, description);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi26.JsonUri.Source url, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(url, description);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ExternalDocs, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ExternalDocs> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ExternalDocs>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ExternalDocs> Create<TContext>(
        ...
        public static ParsedJsonDocument<ExternalDocs> Create(in Corvus.Text.Json.AsyncApi26.JsonUri.Source url, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
