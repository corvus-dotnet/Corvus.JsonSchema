...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct License
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(License instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="License"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator License(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.JsonString.Mutable Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Text.Json.AsyncApi26.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new License(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetName(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"License.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="License"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="License"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly License Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<License>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="License"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly License Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<License>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.License.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.JsonUri.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(License instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.License.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Text.Json.AsyncApi26.JsonString.Source name,
                in Corvus.Text.Json.AsyncApi26.JsonUri.Source url = default)
            {
            ...
            /// Creates an instance of a <see cref="License"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.AsyncApi26.JsonString.Source name, in Corvus.Text.Json.AsyncApi26.JsonUri.Source url = default)
            {
                Create(ref _builder, name, url);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.JsonUri.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source name, scoped in Corvus.Text.Json.AsyncApi26.JsonUri.Source url = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi26.JsonString.Source name, in Corvus.Text.Json.AsyncApi26.JsonUri.Source url = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<License, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<License> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<License>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<License> Create<TContext>(
        ...
        public static ParsedJsonDocument<License> Create(in Corvus.Text.Json.AsyncApi26.JsonString.Source name, in Corvus.Text.Json.AsyncApi26.JsonUri.Source url = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
