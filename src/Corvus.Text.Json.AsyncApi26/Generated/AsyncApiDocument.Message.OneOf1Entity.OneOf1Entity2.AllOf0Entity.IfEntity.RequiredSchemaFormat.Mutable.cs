                    ...
                    public readonly partial struct IfEntity
                    {
                        ...
                        public readonly partial struct RequiredSchemaFormat
                        {
...
#endif
                            {
                                ...
                                public void SetSchemaFormat(scoped in Corvus.Text.Json.JsonElement.Source value)
                                {
                                    CheckValidInstance();
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf0Entity.IfEntity.RequiredSchemaFormat.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf0Entity.IfEntity.RequiredSchemaFormat.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            /// <returns>The source from which to build the value.</returns>
                            public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source schemaFormat)
                            {
                            ...
                            /// <param name="schemaFormat">The value of the <c>"schemaFormat"</c> property.</param>
                            /// <returns>The source from which to build the value.</returns>
                            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> schemaFormat)
                                #if NET9_0_OR_GREATER
                                where TContext : allows ref struct
                                #endif
                            {
                                return new Source<TContext>(context, schemaFormat);
                            }
                            ...
                            public static ParsedJsonDocument<RequiredSchemaFormat> Create(in Corvus.Text.Json.JsonElement.Source schemaFormat, int initialCapacity = 30)
                            {
                                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                try
                                {
                            ...
                            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                            public static ParsedJsonDocument<RequiredSchemaFormat> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> schemaFormat, int initialCapacity = 30)
                                #if NET9_0_OR_GREATER
                                where TContext : allows ref struct
                                #endif
                            {
