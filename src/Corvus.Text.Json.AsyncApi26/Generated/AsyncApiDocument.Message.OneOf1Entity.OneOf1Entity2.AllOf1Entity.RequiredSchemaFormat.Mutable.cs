                ...
                public readonly partial struct AllOf1Entity
                {
                    ...
                    public readonly partial struct RequiredSchemaFormat
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(RequiredSchemaFormat instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="RequiredSchemaFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredSchemaFormat(Mutable instance)
                            {
                            ...
                            /// <summary>
                            /// Gets the <c>schemaFormat</c> property.
                            /// </summary>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Mutable SchemaFormat
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaFormatUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new RequiredSchemaFormat(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            public void SetSchemaFormat(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Source value)
                            {
                                CheckValidInstance();

                                if (value.IsUndefined)
                                {
                                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("schemaFormat");
                                }
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredSchemaFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="RequiredSchemaFormat"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="RequiredSchemaFormat"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredSchemaFormat Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<RequiredSchemaFormat>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="RequiredSchemaFormat"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredSchemaFormat Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<RequiredSchemaFormat>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Source _createArg1;
                            ...
                            internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                            internal Source(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Source arg1)
                            {
                                _createArg1 = arg1;
                                _kind = Kind.Create;
                            }

                            public static implicit operator Source(RequiredSchemaFormat instance) => new(JsonElement.From(instance));
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// <summary>
                            /// Creates an instance of a <see cref="RequiredSchemaFormat"/>.
                            /// </summary>
                            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Source schemaFormat)
                            {
                            ...
                            /// Creates an instance of a <see cref="RequiredSchemaFormat"/>.
                            /// </summary>
                            public void Create(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Source schemaFormat)
                            {
                                Create(ref _builder, schemaFormat);
                            }
                            ...
                            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Source arg1, ref ComplexValueBuilder o)
                            {
                                o.StartObject();
                                Create(ref o, arg1);
                                o.EndObject();
                        ...
                        /// </summary>
                        /// <param name="schemaFormat">The value of the <c>"schemaFormat"</c> property.</param>
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Source schemaFormat)
                        {
                            return new Source(schemaFormat);
                        }
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Source schemaFormat, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(schemaFormat);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        {
                            return workspace.CreateBuilder<RequiredSchemaFormat, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<RequiredSchemaFormat> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RequiredSchemaFormat>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredSchemaFormat> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<RequiredSchemaFormat> Create(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf1Entity.RequiredSchemaFormat.SchemaFormatEntity.Source schemaFormat, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
