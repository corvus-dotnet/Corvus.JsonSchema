                            ...
                            public static partial class JsonSchema
                            {
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    if (tokenType == JsonTokenType.String)
                                    {
                                        ...
                                        if (unescapedUtf8JsonString.Span.SequenceEqual("application/schema+json;version=draft-07"u8))
                                        {
                                            goto enumShortCircuitSuccess;
                                        }

                                        if (unescapedUtf8JsonString.Span.SequenceEqual("application/schema+yaml;version=draft-07"u8))
                                        {
                                            goto enumShortCircuitSuccess;
                                        }
                                    }
