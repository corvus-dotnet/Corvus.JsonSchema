                    ...
                    public readonly partial struct RequiredSchemaFormat
                    {
                        ...
                        public readonly partial struct SchemaFormatEntity
                        {
...
#endif
                            {
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"SchemaFormatEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly SchemaFormatEntity Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly SchemaFormatEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<SchemaFormatEntity>(_idx);
                                }
                                ...
                                /// <param name="matchApplicationVndOaiOpenapiVersion300">Match 1st item.</param>
                                /// <param name="matchApplicationVndOaiOpenapiJsonVersion300">Match 2nd item.</param>
                                /// <param name="matchApplicationVndOaiOpenapiYamlVersion300">Match 3rd item.</param>
                                /// <param name="defaultMatch">Match any other value.</param>
                                /// <returns>An instance of the value returned by the match function.</returns>
                                public TResult Match<TContext, TResult>(
                                    in TContext context,
                                    Func<TContext, TResult> matchApplicationVndOaiOpenapiVersion300,
                                    Func<TContext, TResult> matchApplicationVndOaiOpenapiJsonVersion300,
                                    Func<TContext, TResult> matchApplicationVndOaiOpenapiYamlVersion300,
...
#endif
                                {
                                    ...
                                    {
                                        return matchApplicationVndOaiOpenapiVersion300(context);
                                    }

                                    if (this.ValueEquals(Constants.Enum2))
                                    {
                                        return matchApplicationVndOaiOpenapiJsonVersion300(context);
                                    }

                                    if (this.ValueEquals(Constants.Enum3))
                                    {
                                        return matchApplicationVndOaiOpenapiYamlVersion300(context);
                                    }
                                ...
                                public TResult Match<TResult>(
                                    Func<TResult> matchApplicationVndOaiOpenapiVersion300,
                                    Func<TResult> matchApplicationVndOaiOpenapiJsonVersion300,
                                    Func<TResult> matchApplicationVndOaiOpenapiYamlVersion300,
                                    Func<TResult> defaultMatch)
                                {
                                    if (this.ValueEquals(Constants.Enum1))
                                    {
                                        return matchApplicationVndOaiOpenapiVersion300();
                                    }

                                    if (this.ValueEquals(Constants.Enum2))
                                    {
                                        return matchApplicationVndOaiOpenapiJsonVersion300();
                                    }

                                    if (this.ValueEquals(Constants.Enum3))
                                    {
                                        return matchApplicationVndOaiOpenapiYamlVersion300();
                                    }
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(SchemaFormatEntity instance) => new(JsonElement.From(instance));
