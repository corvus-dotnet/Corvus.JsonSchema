        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct OneOf1Entity2
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="AllOf4Entity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal AllOf4Entity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static AllOf4Entity DefaultInstance { get; }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1 Payload
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.AvroSchemaV1 value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in AllOf4Entity left, in AllOf4Entity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in AllOf4Entity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(AllOf4Entity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AllOf4Entity(JsonElement instance)
                    {
                        return AllOf4Entity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AllOf4Entity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AllOf4Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AllOf4Entity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AllOf4Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AllOf4Entity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AllOf4Entity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AllOf4Entity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static AllOf4Entity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<AllOf4Entity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out AllOf4Entity? result)
                    {
                        return JsonElementHelpers.TryParseValue<AllOf4Entity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AllOf4Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static AllOf4Entity IJsonElement<AllOf4Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AllOf4Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AllOf4Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AllOf4Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public AllOf4Entity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AllOf4Entity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AllOf4Entity"/> that lives for the lifetime of its
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.RequiredSchemaFormat" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredSchemaFormat(out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.RequiredSchemaFormat result)
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.RequiredSchemaFormat.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.RequiredSchemaFormat.From(this);
                            return true;
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.ThenEntity" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsThenEntity(out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.ThenEntity result)
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.ThenEntity.From(this);
                            return true;
                        }
                    ...
                    /// <param name="matchCorvusTextJsonAsyncApi26AsyncApiDocumentMessageOneOf1EntityOneOf1Entity2AllOf4EntityThenEntity">Match a <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.ThenEntity"/>.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.ThenEntity, TContext, TResult> matchCorvusTextJsonAsyncApi26AsyncApiDocumentMessageOneOf1EntityOneOf1Entity2AllOf4EntityThenEntity,
                        Matcher<AllOf4Entity, TContext, TResult> defaultMatch)
...
#endif
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.RequiredSchemaFormat.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusTextJsonAsyncApi26AsyncApiDocumentMessageOneOf1EntityOneOf1Entity2AllOf4EntityThenEntity(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.ThenEntity.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.ThenEntity, TResult> matchCorvusTextJsonAsyncApi26AsyncApiDocumentMessageOneOf1EntityOneOf1Entity2AllOf4EntityThenEntity,
                        Matcher<AllOf4Entity, TResult> defaultMatch)
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.RequiredSchemaFormat.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusTextJsonAsyncApi26AsyncApiDocumentMessageOneOf1EntityOneOf1Entity2AllOf4EntityThenEntity(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.AllOf4Entity.ThenEntity.From(this));
                        }
