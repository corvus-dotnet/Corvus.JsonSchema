                    ...
                    public readonly partial struct WithTypeObjectEntity
                    {
                            ...
                            : IJsonElement<TypeEntity>
                        {
                            ...
                            private static class Constants
                            {
                                ...
                                /// </summary>
                                public static readonly byte[] Const = "object"u8.ToArray();
                                /// <summary>
                                /// A constant for the <c>const</c> keyword.
                                /// </summary>
                                public static readonly TypeEntity ConstJson = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"object\""u8]);
                            }
                            ...
                            public static partial class JsonSchema
                            {
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1message.json/oneOf/1/oneOf/1/properties/headers/allOf/1/properties/type"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                                /// </summary>
                                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1message.json/oneOf/1/oneOf/1/properties/headers/allOf/1/properties/type";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1message.json/oneOf/1/oneOf/1/properties/headers/allOf/1/properties/type"u8;
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    if (tokenType == JsonTokenType.String)
                                    {
                                        ...
                                        JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "object"u8, "object", "const"u8, ref context);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeyword(false, "object", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                                    }
                                }
