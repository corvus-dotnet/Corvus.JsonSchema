            ...
            public readonly partial struct OneOf1Entity2
            {
                    ...
                    : IJsonElement<TraitsEntityArray>
                {
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1message.json/oneOf/1/oneOf/1/properties/traits"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                        /// </summary>
                        public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1message.json/oneOf/1/oneOf/1/properties/traits";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1message.json/oneOf/1/oneOf/1/properties/traits"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            else
                            {
                                ...
                                while (arrayValidation_enumerator.MoveNext())
                                {
                                    ...
                                    JsonSchemaContext childContext = Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.TraitsEntityArray.TraitsEntity.JsonSchema.PushChildContext(
                                        parentDocument,
                                    ...
                                    Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.TraitsEntityArray.TraitsEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
