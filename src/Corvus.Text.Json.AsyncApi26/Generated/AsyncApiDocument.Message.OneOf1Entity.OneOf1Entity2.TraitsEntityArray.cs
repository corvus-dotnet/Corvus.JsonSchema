        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct OneOf1Entity2
            {
                ...
                public readonly partial struct TraitsEntityArray
                    ...
                    : IJsonElement<TraitsEntityArray>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="TraitsEntityArray"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal TraitsEntityArray(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static TraitsEntityArray DefaultInstance { get; }
                    ...
                    public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.TraitsEntityArray.TraitsEntity this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.TraitsEntityArray.TraitsEntity>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.TraitsEntityArray.TraitsEntity> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.OneOf1Entity2.TraitsEntityArray.TraitsEntity>(_parent, _idx);
                    }
                    ...
                    /// </returns>
                    public static bool operator ==(in TraitsEntityArray left, in TraitsEntityArray right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in TraitsEntityArray left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(TraitsEntityArray instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TraitsEntityArray(JsonElement instance)
                    {
                        return TraitsEntityArray.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TraitsEntityArray From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TraitsEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TraitsEntityArray>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TraitsEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TraitsEntityArray>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static TraitsEntityArray ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<TraitsEntityArray>(json, options);
                    }
                    ...
                    /// </exception>
                    public static TraitsEntityArray ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<TraitsEntityArray>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out TraitsEntityArray? result)
                    {
                        return JsonElementHelpers.TryParseValue<TraitsEntityArray>(ref reader, out result);
                    }
...
#if NET
                    static TraitsEntityArray IJsonElement<TraitsEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TraitsEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public TraitsEntityArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public TraitsEntityArray Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<TraitsEntityArray>(_idx);
                        }
