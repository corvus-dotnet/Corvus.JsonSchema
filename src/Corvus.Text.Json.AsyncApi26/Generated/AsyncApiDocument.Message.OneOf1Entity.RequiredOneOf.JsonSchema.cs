    ...
    public readonly partial struct Message
    {
        ...
        public readonly partial struct OneOf1Entity
        {
                ...
                : IJsonElement<RequiredOneOf>
            {
                ...
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOneOfPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("oneOf"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOneOfNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("oneOf"u8, buffer, out written);

                    private const int RequiredOffsetForOneOf = 0;
                    private const uint RequiredBitForOneOf = 0b00000000000000000000000000000001;
                    ...
                    private static void MatchOneOf(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        ...
                        requiredBitBuffer[RequiredOffsetForOneOf] |= RequiredBitForOneOf;
                    }
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.OneOfUtf8))
                        {
                            matcher = MatchOneOf;
                            return true;
                        }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1message.json/oneOf/1/oneOf/0"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1message.json/oneOf/1/oneOf/0";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1message.json/oneOf/1/oneOf/0"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOneOfPresent, "oneOf"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForOneOf] & RequiredBitForOneOf) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyOneOfNotPresent, "oneOf"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOneOfPresent, "oneOf"u8, "required"u8);
