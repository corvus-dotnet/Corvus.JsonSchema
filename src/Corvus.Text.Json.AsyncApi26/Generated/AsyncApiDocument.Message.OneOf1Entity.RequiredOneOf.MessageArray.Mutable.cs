    ...
    public readonly partial struct Message
    {
        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct RequiredOneOf
            {
                ...
                public readonly partial struct MessageArray
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(MessageArray instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="MessageArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator MessageArray(Mutable instance)
                        {
                        ...
                        public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Mutable this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Mutable>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Mutable> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Mutable>(_parent, _idx);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new MessageArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"MessageArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        /// <summary>
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void SetItem(int itemIndex, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void AddItem(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Source value)
                        {
                        ...
                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                        /// </exception>
                        public bool Remove(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message item)
                        {
                            CheckValidInstance();
                            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message>(this, in item))
                            {
                                return false;
                            }
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void RemoveWhere(JsonPredicate<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message> predicate)
                        {
                            CheckValidInstance();
                            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message>(this, predicate);
                            _documentVersion = _parent.Version;
                        }
                        ...
                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                        /// </exception>
                        public bool Replace(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message oldItem, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Source newItem)
                        {
                            CheckValidInstance();
                            ...
                            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message>(_parent, _idx);

                            while (enumerator.MoveNext())
                            {
                                Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message current = enumerator.Current;
                        ...
                        /// <summary>
                        /// Gets a <see cref="MessageArray"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="MessageArray"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly MessageArray Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<MessageArray>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="MessageArray"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly MessageArray Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<MessageArray>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(MessageArray instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// </summary>
                        public void AddItem(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Source value)
                        {
                        ...
                        /// Add an item to the array.
                        /// </summary>
                        public void AddItem<TContext>(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.Source<TContext> value)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                        {
                    ...
                    {
                        return workspace.CreateBuilder<MessageArray, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<MessageArray> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<MessageArray>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<MessageArray> Create<TContext>(
