        ...
        public readonly partial struct OneOf1Entity
        {
            ...
            public readonly partial struct RequiredOneOf
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredOneOf instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredOneOf"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredOneOf(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Mutable OneOf
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OneOfUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetOneOf(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("oneOf");
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetOneOf<TContext>(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source<TContext> value)
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredOneOf.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredOneOf Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredOneOf Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredOneOf>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source _createArg1;
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }

                    public static implicit operator Source(RequiredOneOf instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source<TContext> _createArg1;
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source<TContext> arg1)
                    {
                        _context = context;
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredOneOf"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source oneOf)
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredOneOf"/>.
                    /// </summary>
                    public void Create(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source oneOf)
                    {
                        Create(ref _builder, oneOf);
                    }
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source<TContext> oneOf)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredOneOf"/>.
                    /// </summary>
                    public void Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source<TContext> oneOf)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                        Create(context, ref _builder, oneOf);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                    ...
                    /// <param name="arg1">The value of the property.</param>
                    /// <param name="o">The complex value builder into which to write the object.</param>
                    internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source oneOf)
                {
                    return new Source(oneOf);
                }
                ...
                /// <param name="oneOf">The value of the <c>"oneOf"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source<TContext> oneOf)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, oneOf);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source oneOf, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source<TContext> oneOf, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                {
                    return workspace.CreateBuilder<RequiredOneOf, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredOneOf> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredOneOf>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredOneOf> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredOneOf> Create(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source oneOf, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredOneOf> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Message.OneOf1Entity.RequiredOneOf.MessageArray.Source<TContext> oneOf, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
