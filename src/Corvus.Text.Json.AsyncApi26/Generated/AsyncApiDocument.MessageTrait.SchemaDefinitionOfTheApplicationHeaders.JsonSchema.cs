    ...
    public readonly partial struct MessageTrait
    {
            ...
            : IJsonElement<SchemaDefinitionOfTheApplicationHeaders>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1messageTrait.json/properties/headers"u8, buffer, out written);
