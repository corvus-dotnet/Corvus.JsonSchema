    ...
    public readonly partial struct MessageTrait
    {
        ...
        public readonly partial struct SchemaDefinitionOfTheApplicationHeaders
        {
            ...
            public readonly partial struct WithTypeObjectEntity
                ...
                : IJsonElement<WithTypeObjectEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="WithTypeObjectEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal WithTypeObjectEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static WithTypeObjectEntity DefaultInstance { get; }
                ...
                /// </summary>
                public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.MessageTrait.SchemaDefinitionOfTheApplicationHeaders.WithTypeObjectEntity.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.MessageTrait.SchemaDefinitionOfTheApplicationHeaders.WithTypeObjectEntity.TypeEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in WithTypeObjectEntity left, in WithTypeObjectEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in WithTypeObjectEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(WithTypeObjectEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WithTypeObjectEntity(JsonElement instance)
                {
                    return WithTypeObjectEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeObjectEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeObjectEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithTypeObjectEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeObjectEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithTypeObjectEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeObjectEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithTypeObjectEntity>(json, options);
                }
                ...
                /// </exception>
                public static WithTypeObjectEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<WithTypeObjectEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out WithTypeObjectEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<WithTypeObjectEntity>(ref reader, out result);
                }
...
#if NET
                static WithTypeObjectEntity IJsonElement<WithTypeObjectEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WithTypeObjectEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public WithTypeObjectEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public WithTypeObjectEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<WithTypeObjectEntity>(_idx);
                    }
