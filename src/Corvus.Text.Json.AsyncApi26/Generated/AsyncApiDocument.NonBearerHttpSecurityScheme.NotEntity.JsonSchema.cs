    ...
    public readonly partial struct NonBearerHttpSecurityScheme
    {
            ...
            : IJsonElement<NotEntity>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchScheme(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1NonBearerHTTPSecurityScheme.json/not"u8, buffer, out written);
