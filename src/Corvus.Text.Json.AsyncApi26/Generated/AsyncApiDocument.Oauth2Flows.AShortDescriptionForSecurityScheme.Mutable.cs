    ...
    public readonly partial struct Oauth2Flows
    {
        ...
        public readonly partial struct AShortDescriptionForSecurityScheme
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AShortDescriptionForSecurityScheme instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AShortDescriptionForSecurityScheme"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AShortDescriptionForSecurityScheme(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AShortDescriptionForSecurityScheme.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AShortDescriptionForSecurityScheme Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AShortDescriptionForSecurityScheme Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AShortDescriptionForSecurityScheme>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AShortDescriptionForSecurityScheme instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AShortDescriptionForSecurityScheme, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AShortDescriptionForSecurityScheme> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AShortDescriptionForSecurityScheme>();
                }
                finally
                {
