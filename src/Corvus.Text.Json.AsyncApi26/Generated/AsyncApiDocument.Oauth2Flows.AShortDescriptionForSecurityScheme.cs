...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Oauth2Flows
    {
        ...
        public readonly partial struct AShortDescriptionForSecurityScheme
#if NET8_0_OR_GREATER
            : IJsonElement<AShortDescriptionForSecurityScheme>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AShortDescriptionForSecurityScheme"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AShortDescriptionForSecurityScheme(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AShortDescriptionForSecurityScheme DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(AShortDescriptionForSecurityScheme value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in AShortDescriptionForSecurityScheme left, in AShortDescriptionForSecurityScheme right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AShortDescriptionForSecurityScheme left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AShortDescriptionForSecurityScheme instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AShortDescriptionForSecurityScheme(JsonElement instance)
            {
                return AShortDescriptionForSecurityScheme.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AShortDescriptionForSecurityScheme From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AShortDescriptionForSecurityScheme ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AShortDescriptionForSecurityScheme>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AShortDescriptionForSecurityScheme ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AShortDescriptionForSecurityScheme>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AShortDescriptionForSecurityScheme ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AShortDescriptionForSecurityScheme>(json, options);
            }
            ...
            /// </exception>
            public static AShortDescriptionForSecurityScheme ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AShortDescriptionForSecurityScheme>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AShortDescriptionForSecurityScheme? result)
            {
                return JsonElementHelpers.TryParseValue<AShortDescriptionForSecurityScheme>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AShortDescriptionForSecurityScheme(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AShortDescriptionForSecurityScheme IJsonElement<AShortDescriptionForSecurityScheme>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AShortDescriptionForSecurityScheme: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AShortDescriptionForSecurityScheme"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AShortDescriptionForSecurityScheme"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AShortDescriptionForSecurityScheme Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AShortDescriptionForSecurityScheme>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AShortDescriptionForSecurityScheme"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AShortDescriptionForSecurityScheme Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AShortDescriptionForSecurityScheme>(_idx);
                }
