        ...
        public readonly partial struct FlowsEntity
        {
            ...
            public readonly partial struct ConfigurationForTheOAuthAuthorizationCodeFlow
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RequiredAuthorizationUrlAndScopesAndTokenUrl"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RequiredAuthorizationUrlAndScopesAndTokenUrl(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RequiredAuthorizationUrlAndScopesAndTokenUrl DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in RequiredAuthorizationUrlAndScopesAndTokenUrl left, in RequiredAuthorizationUrlAndScopesAndTokenUrl right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredAuthorizationUrlAndScopesAndTokenUrl left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredAuthorizationUrlAndScopesAndTokenUrl instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredAuthorizationUrlAndScopesAndTokenUrl(JsonElement instance)
                    {
                        return RequiredAuthorizationUrlAndScopesAndTokenUrl.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndScopesAndTokenUrl From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndScopesAndTokenUrl ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndScopesAndTokenUrl>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndScopesAndTokenUrl ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndScopesAndTokenUrl>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndScopesAndTokenUrl ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndScopesAndTokenUrl>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RequiredAuthorizationUrlAndScopesAndTokenUrl ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndScopesAndTokenUrl>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAuthorizationUrlAndScopesAndTokenUrl? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredAuthorizationUrlAndScopesAndTokenUrl>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredAuthorizationUrlAndScopesAndTokenUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RequiredAuthorizationUrlAndScopesAndTokenUrl IJsonElement<RequiredAuthorizationUrlAndScopesAndTokenUrl>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredAuthorizationUrlAndScopesAndTokenUrl: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredAuthorizationUrlAndScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredAuthorizationUrlAndScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAuthorizationUrlAndScopesAndTokenUrl Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredAuthorizationUrlAndScopesAndTokenUrl>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredAuthorizationUrlAndScopesAndTokenUrl"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAuthorizationUrlAndScopesAndTokenUrl Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredAuthorizationUrlAndScopesAndTokenUrl>(_idx);
                        }
