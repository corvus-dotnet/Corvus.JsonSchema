                ...
                public readonly partial struct AllOf2Entity
                {
                        ...
                        : IJsonElement<RequiredTokenUrl>
                    {
                        public static partial class JsonSchema
                        {
                            ...
                            private const uint RequiredBitForTokenUrl = 0b00000000000000000000000000000001;

                            private const uint RequiredBitMask0 =
                                RequiredBitForTokenUrl;
                            ...
                            {
                                if (span.SequenceEqual(JsonPropertyNames.TokenUrlUtf8))
                                {
                                    matcher = MatchTokenUrl;
                                    return true;
                                }
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1oauth2Flows.json/properties/flows/properties/implicit/allOf/2/not"u8, buffer, out written);

                            /// <summary>
                            /// Gets the schema location from which this type was generated.
                            /// </summary>
                            public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1oauth2Flows.json/properties/flows/properties/implicit/allOf/2/not";

                            /// <summary>
                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                            /// </summary>
                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1oauth2Flows.json/properties/flows/properties/implicit/allOf/2/not"u8;
                                ...
                                ref JsonSchemaContext context)
                            {
                                ...
                                if (tokenType == JsonTokenType.StartObject)
                                {
                                    ...
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyTokenUrlPresent, "tokenUrl"u8, "required"u8);
                                    }
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyTokenUrlNotPresent, "tokenUrl"u8, "required"u8);
                                        }
                                        else
                                        {
                                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyTokenUrlPresent, "tokenUrl"u8, "required"u8);
