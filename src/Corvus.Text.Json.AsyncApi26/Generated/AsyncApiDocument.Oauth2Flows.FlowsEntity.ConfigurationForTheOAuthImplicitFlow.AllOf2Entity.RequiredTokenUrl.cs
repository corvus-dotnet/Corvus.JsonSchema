            ...
            public readonly partial struct ConfigurationForTheOAuthImplicitFlow
            {
                ...
                public readonly partial struct AllOf2Entity
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="RequiredTokenUrl"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal RequiredTokenUrl(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static RequiredTokenUrl DefaultInstance { get; }
                        ...
                        /// </returns>
                        public static bool operator ==(in RequiredTokenUrl left, in RequiredTokenUrl right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in RequiredTokenUrl left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(RequiredTokenUrl instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredTokenUrl(JsonElement instance)
                        {
                            return RequiredTokenUrl.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredTokenUrl From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredTokenUrl ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredTokenUrl>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredTokenUrl ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredTokenUrl>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredTokenUrl ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredTokenUrl>(json, options);
                        }
                        ...
                        /// </exception>
                        public static RequiredTokenUrl ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<RequiredTokenUrl>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredTokenUrl? result)
                        {
                            return JsonElementHelpers.TryParseValue<RequiredTokenUrl>(ref reader, out result);
                        }
...
#if NET
                        static RequiredTokenUrl IJsonElement<RequiredTokenUrl>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredTokenUrl: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public RequiredTokenUrl Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<RequiredTokenUrl>(_idx);
                            }
