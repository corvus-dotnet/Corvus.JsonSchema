            ...
            public readonly partial struct ConfigurationForTheOAuthImplicitFlow
            {
                ...
                public readonly partial struct RequiredAuthorizationUrlAndScopes
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredAuthorizationUrlAndScopes instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredAuthorizationUrlAndScopes"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredAuthorizationUrlAndScopes(Mutable instance)
                        {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.JsonElement.Mutable AuthorizationUrl
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorizationUrlUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredAuthorizationUrlAndScopes(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetAuthorizationUrl(scoped in Corvus.Text.Json.JsonElement.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("authorizationUrl");
                            }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetAuthorizationUrl<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredAuthorizationUrlAndScopes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredAuthorizationUrlAndScopes"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredAuthorizationUrlAndScopes"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAuthorizationUrlAndScopes Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredAuthorizationUrlAndScopes>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredAuthorizationUrlAndScopes"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAuthorizationUrlAndScopes Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredAuthorizationUrlAndScopes>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthImplicitFlow.RequiredAuthorizationUrlAndScopes.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public static implicit operator Source(RequiredAuthorizationUrlAndScopes instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthImplicitFlow.RequiredAuthorizationUrlAndScopes.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredAuthorizationUrlAndScopes"/>.
                        /// </summary>
                        internal static void Create(
                            ref ComplexValueBuilder builder,
                            in Corvus.Text.Json.JsonElement.Source authorizationUrl,
                        ...
                        /// Creates an instance of a <see cref="RequiredAuthorizationUrlAndScopes"/>.
                        /// </summary>
                        public void Create(in Corvus.Text.Json.JsonElement.Source authorizationUrl, in Corvus.Text.Json.JsonElement.Source scopes)
                        {
                            Create(ref _builder, authorizationUrl, scopes);
                        }
                        ...
                        internal static void Create<TContext>(
                            in TContext context,
                            ref ComplexValueBuilder builder,
                            in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl,
                        ...
                        #endif
                        {
                            Create(context, ref _builder, authorizationUrl, scopes);
                        }
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source authorizationUrl, scoped in Corvus.Text.Json.JsonElement.Source scopes)
                    {
                        return new Source(authorizationUrl, scopes);
                    }
                    ...
                    /// <param name="scopes">The value of the <c>"scopes"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, scoped in Corvus.Text.Json.JsonElement.Source<TContext> scopes)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        return new Source<TContext>(context, authorizationUrl, scopes);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source authorizationUrl, in Corvus.Text.Json.JsonElement.Source scopes, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(authorizationUrl, scopes);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, in Corvus.Text.Json.JsonElement.Source<TContext> scopes, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, authorizationUrl, scopes);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredAuthorizationUrlAndScopes, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndScopes> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredAuthorizationUrlAndScopes>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndScopes> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndScopes> Create(in Corvus.Text.Json.JsonElement.Source authorizationUrl, in Corvus.Text.Json.JsonElement.Source scopes, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndScopes> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, in Corvus.Text.Json.JsonElement.Source<TContext> scopes, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
