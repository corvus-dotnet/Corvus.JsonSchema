        ...
        public readonly partial struct FlowsEntity
        {
            ...
            public readonly partial struct ConfigurationForTheOAuthImplicitFlow
            {
...
#endif
                {
                    ...
                    internal RequiredAuthorizationUrlAndScopes(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredAuthorizationUrlAndScopes left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredAuthorizationUrlAndScopes instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredAuthorizationUrlAndScopes(JsonElement instance)
                    {
                        return RequiredAuthorizationUrlAndScopes.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndScopes From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndScopes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndScopes>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndScopes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndScopes>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndScopes ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndScopes>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RequiredAuthorizationUrlAndScopes ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndScopes>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAuthorizationUrlAndScopes? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredAuthorizationUrlAndScopes>(ref reader, out result);
                    }
...
#if NET
                    static RequiredAuthorizationUrlAndScopes IJsonElement<RequiredAuthorizationUrlAndScopes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredAuthorizationUrlAndScopes: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAuthorizationUrlAndScopes Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAuthorizationUrlAndScopes Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredAuthorizationUrlAndScopes>(_idx);
                        }
