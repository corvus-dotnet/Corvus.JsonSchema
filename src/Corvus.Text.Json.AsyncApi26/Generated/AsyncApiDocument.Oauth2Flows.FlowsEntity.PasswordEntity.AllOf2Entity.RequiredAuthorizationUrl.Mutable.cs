        ...
        public readonly partial struct FlowsEntity
        {
            ...
            public readonly partial struct PasswordEntity
            {
                ...
                public readonly partial struct AllOf2Entity
                {
                    ...
                    public readonly partial struct RequiredAuthorizationUrl
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(RequiredAuthorizationUrl instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="RequiredAuthorizationUrl"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredAuthorizationUrl(Mutable instance)
                            {
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new RequiredAuthorizationUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredAuthorizationUrl.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="RequiredAuthorizationUrl"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="RequiredAuthorizationUrl"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredAuthorizationUrl Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<RequiredAuthorizationUrl>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="RequiredAuthorizationUrl"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredAuthorizationUrl Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<RequiredAuthorizationUrl>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Oauth2Flows.FlowsEntity.PasswordEntity.AllOf2Entity.RequiredAuthorizationUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public static implicit operator Source(RequiredAuthorizationUrl instance) => new(JsonElement.From(instance));
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Oauth2Flows.FlowsEntity.PasswordEntity.AllOf2Entity.RequiredAuthorizationUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// <summary>
                            /// Creates an instance of a <see cref="RequiredAuthorizationUrl"/>.
                            /// </summary>
                            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.JsonElement.Source authorizationUrl)
                            {
                            ...
                            /// Creates an instance of a <see cref="RequiredAuthorizationUrl"/>.
                            /// </summary>
                            public void Create(in Corvus.Text.Json.JsonElement.Source authorizationUrl)
                            {
                                Create(ref _builder, authorizationUrl);
                            }
                            ...
                            /// Creates an instance of a <see cref="RequiredAuthorizationUrl"/>.
                            /// </summary>
                            public void Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                            {
                                Create(context, ref _builder, authorizationUrl);
                            }
                        ...
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source authorizationUrl)
                        {
                            return new Source(authorizationUrl);
                        }
                        ...
                        /// <param name="authorizationUrl">The value of the <c>"authorizationUrl"</c> property.</param>
                        /// <returns>The source from which to build the value.</returns>
                        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
                            return new Source<TContext>(context, authorizationUrl);
                        }
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source authorizationUrl, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(authorizationUrl);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
                            ...
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(context, authorizationUrl);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        {
                            return workspace.CreateBuilder<RequiredAuthorizationUrl, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<RequiredAuthorizationUrl> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RequiredAuthorizationUrl>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredAuthorizationUrl> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<RequiredAuthorizationUrl> Create(in Corvus.Text.Json.JsonElement.Source authorizationUrl, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredAuthorizationUrl> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
