            ...
            public readonly partial struct PasswordEntity
            {
                ...
                public readonly partial struct RequiredScopesAndTokenUrl
                {
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Oauth2Flows.FlowsEntity.PasswordEntity.RequiredScopesAndTokenUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Oauth2Flows.FlowsEntity.PasswordEntity.RequiredScopesAndTokenUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// Creates an instance of a <see cref="RequiredScopesAndTokenUrl"/>.
                        /// </summary>
                        public void Create(in Corvus.Text.Json.JsonElement.Source scopes, in Corvus.Text.Json.JsonElement.Source tokenUrl)
                        {
                            Create(ref _builder, scopes, tokenUrl);
                        }
                        ...
                        #endif
                        {
                            Create(context, ref _builder, scopes, tokenUrl);
                        }
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source scopes, scoped in Corvus.Text.Json.JsonElement.Source tokenUrl)
                    {
                        return new Source(scopes, tokenUrl);
                    }
                    ...
                    /// <param name="tokenUrl">The value of the <c>"tokenUrl"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> scopes, scoped in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        return new Source<TContext>(context, scopes, tokenUrl);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source scopes, in Corvus.Text.Json.JsonElement.Source tokenUrl, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(scopes, tokenUrl);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> scopes, in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, scopes, tokenUrl);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    public static ParsedJsonDocument<RequiredScopesAndTokenUrl> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredScopesAndTokenUrl>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredScopesAndTokenUrl> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredScopesAndTokenUrl> Create(in Corvus.Text.Json.JsonElement.Source scopes, in Corvus.Text.Json.JsonElement.Source tokenUrl, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredScopesAndTokenUrl> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> scopes, in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
