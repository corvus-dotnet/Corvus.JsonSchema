...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Oauth2Flows>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchFlows(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1oauth2Flows.json"u8, buffer, out written);
