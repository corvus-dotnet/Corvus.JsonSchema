...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OpenIdConnect
    {
...
#endif
        {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOpenIdConnectUrl(in Corvus.Text.Json.AsyncApi26.JsonUri.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenIdConnect.TypeEntity.Source value)
            {
                CheckValidInstance();
