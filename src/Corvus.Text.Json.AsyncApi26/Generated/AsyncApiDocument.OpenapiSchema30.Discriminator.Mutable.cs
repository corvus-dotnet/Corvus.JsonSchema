    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct Discriminator
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Discriminator instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Discriminator"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Discriminator(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Mutable Mapping
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MappingUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi26.JsonString.Mutable PropertyName
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyNameUtf8, out Corvus.Text.Json.AsyncApi26.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Discriminator(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetMapping(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MappingUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MappingUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Mapping, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetMapping<TContext>(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source<TContext> value)
                ...
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MappingUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }

                /// <summary>
                /// Set the <c>propertyName</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPropertyName(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("propertyName");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyNameUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PropertyName, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Discriminator.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Discriminator"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Discriminator"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Discriminator Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Discriminator>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Discriminator"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Discriminator Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Discriminator>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source _createArg2;
                ...
                internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                public static implicit operator Source(Discriminator instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi26.JsonString.Source _createArg1;
                private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source<TContext> _createArg2;
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source<TContext> arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Text.Json.AsyncApi26.JsonString.Source propertyName,
                    in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source mapping = default)
                {
                    propertyName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PropertyName, ref builder);
                    mapping.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Mapping, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="Discriminator"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.AsyncApi26.JsonString.Source propertyName, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source mapping = default)
                {
                    Create(ref _builder, propertyName, mapping);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.AsyncApi26.JsonString.Source propertyName,
                    in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source<TContext> mapping = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, propertyName, mapping);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// </summary>
            /// <param name="propertyName">The value of the <c>"propertyName"</c> property.</param>
            /// <param name="mapping">The value of the <c>"mapping"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source propertyName, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source mapping = default)
            {
                return new Source(propertyName, mapping);
            }
            ...
            /// <param name="mapping">The value of the <c>"mapping"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source propertyName, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source<TContext> mapping = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, propertyName, mapping);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="propertyName">The value of the property.</param>
            /// <param name="mapping">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi26.JsonString.Source propertyName, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source mapping = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(propertyName, mapping);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.AsyncApi26.JsonString.Source propertyName, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source<TContext> mapping = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, propertyName, mapping);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<Discriminator, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Discriminator> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Discriminator>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Discriminator> Create<TContext>(
            ...
            public static ParsedJsonDocument<Discriminator> Create(in Corvus.Text.Json.AsyncApi26.JsonString.Source propertyName, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source mapping = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Discriminator> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi26.JsonString.Source propertyName, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity.Source<TContext> mapping = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
