...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OpenapiSchema30
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity Mapping
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MappingUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.JsonString PropertyName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyNameUtf8, out Corvus.Text.Json.AsyncApi26.JsonString value))
                    {
                        return value;
                    }
