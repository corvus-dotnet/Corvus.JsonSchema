...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct OneOfEntityArray
#if NET8_0_OR_GREATER
            : IJsonElement<OneOfEntityArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OneOfEntityArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OneOfEntityArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OneOfEntityArray DefaultInstance { get; }
            ...
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.OneOfEntityArray.OneOfEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.OneOfEntityArray.OneOfEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.OneOfEntityArray.OneOfEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.OneOfEntityArray.OneOfEntity>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in OneOfEntityArray left, in OneOfEntityArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OneOfEntityArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OneOfEntityArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OneOfEntityArray(JsonElement instance)
            {
                return OneOfEntityArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OneOfEntityArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OneOfEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OneOfEntityArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OneOfEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OneOfEntityArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OneOfEntityArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OneOfEntityArray>(json, options);
            }
            ...
            /// </exception>
            public static OneOfEntityArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OneOfEntityArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OneOfEntityArray? result)
            {
                return JsonElementHelpers.TryParseValue<OneOfEntityArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OneOfEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OneOfEntityArray IJsonElement<OneOfEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OneOfEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OneOfEntityArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OneOfEntityArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OneOfEntityArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OneOfEntityArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OneOfEntityArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OneOfEntityArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OneOfEntityArray>(_idx);
                }
