...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OpenapiSchema30
    {
...
#endif
        {
            ...
            /// <see cref="Corvus.Text.Json.AsyncApi26.JsonUriReference"/>.
            /// </summary>
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternJsonUriReference(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.AsyncApi26.JsonUriReference result)
            {
                if (MatchesPatternJsonUriReference(propertyName))
                {
                    result = Corvus.Text.Json.AsyncApi26.JsonUriReference.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternJsonUriReference(ReadOnlySpan<byte> name, in Corvus.Text.Json.AsyncApi26.JsonUriReference value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.AsyncApi26.JsonUriReference typedValue = Corvus.Text.Json.AsyncApi26.JsonUriReference.From(property.Value);
