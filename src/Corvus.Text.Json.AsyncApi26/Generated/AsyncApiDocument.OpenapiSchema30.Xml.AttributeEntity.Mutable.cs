        ...
        public readonly partial struct Xml
        {
            ...
            public readonly partial struct AttributeEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AttributeEntity, Mutable>(AttributeEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(AttributeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AttributeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AttributeEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AttributeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AttributeEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AttributeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AttributeEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AttributeEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AttributeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AttributeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AttributeEntity>();
                    }
                    finally
                    {
