    ...
    public readonly partial struct OpenapiSchema30
    {
            ...
            : IJsonElement<Xml>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchAttribute(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                private static void MatchWrapped(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1openapiSchema_3_0.json/definitions/XML"u8, buffer, out written);
