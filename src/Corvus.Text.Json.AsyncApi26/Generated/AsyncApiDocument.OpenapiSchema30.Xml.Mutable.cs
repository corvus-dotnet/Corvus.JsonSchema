    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct Xml
        {
...
#endif
            {
                ...
                public void SetAttribute(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Xml.AttributeEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetNamespace(in Corvus.Text.Json.AsyncApi26.JsonUri.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPrefix(in Corvus.Text.Json.AsyncApi26.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetWrapped(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.OpenapiSchema30.Xml.WrappedEntity.Source value)
                {
                    CheckValidInstance();
