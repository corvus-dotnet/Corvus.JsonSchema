...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OperationTrait
    {
        ...
        public readonly partial struct SecurityRequirementArray
            ...
            : IJsonElement<SecurityRequirementArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            internal SecurityRequirementArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SecurityRequirement this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SecurityRequirement>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SecurityRequirement> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SecurityRequirement>(_parent, _idx);
            }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SecurityRequirementArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(SecurityRequirementArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SecurityRequirementArray(JsonElement instance)
            {
                return SecurityRequirementArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SecurityRequirementArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SecurityRequirementArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SecurityRequirementArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SecurityRequirementArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SecurityRequirementArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SecurityRequirementArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SecurityRequirementArray>(json, options);
            }
            ...
            /// </exception>
            public static SecurityRequirementArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SecurityRequirementArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SecurityRequirementArray? result)
            {
                return JsonElementHelpers.TryParseValue<SecurityRequirementArray>(ref reader, out result);
            }
...
#if NET
            static SecurityRequirementArray IJsonElement<SecurityRequirementArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SecurityRequirementArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SecurityRequirementArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public SecurityRequirementArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SecurityRequirementArray>(_idx);
                }
