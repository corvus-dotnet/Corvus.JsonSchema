    ...
    public readonly partial struct Parameters
    {
            ...
            : IJsonElement<AdditionalPropertiesEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1parameters.json/additionalProperties"u8, buffer, out written);
