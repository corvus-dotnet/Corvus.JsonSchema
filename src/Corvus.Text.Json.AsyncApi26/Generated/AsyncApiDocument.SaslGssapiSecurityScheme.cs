...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct SaslGssapiSecurityScheme
#if NET8_0_OR_GREATER
        : IJsonElement<SaslGssapiSecurityScheme>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SaslGssapiSecurityScheme"/> struct.
        /// </summary>
        ...
        internal SaslGssapiSecurityScheme(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SaslGssapiSecurityScheme DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslGssapiSecurityScheme.TheTypeOfTheSecurityScheme Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslGssapiSecurityScheme.TheTypeOfTheSecurityScheme value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in SaslGssapiSecurityScheme left, in SaslGssapiSecurityScheme right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SaslGssapiSecurityScheme left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SaslGssapiSecurityScheme instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SaslGssapiSecurityScheme(JsonElement instance)
        {
            return SaslGssapiSecurityScheme.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SaslGssapiSecurityScheme From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SaslGssapiSecurityScheme ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SaslGssapiSecurityScheme>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SaslGssapiSecurityScheme ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SaslGssapiSecurityScheme>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SaslGssapiSecurityScheme ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SaslGssapiSecurityScheme>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static SaslGssapiSecurityScheme ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SaslGssapiSecurityScheme>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SaslGssapiSecurityScheme? result)
        {
            return JsonElementHelpers.TryParseValue<SaslGssapiSecurityScheme>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SaslGssapiSecurityScheme(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SaslGssapiSecurityScheme IJsonElement<SaslGssapiSecurityScheme>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SaslGssapiSecurityScheme: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SaslGssapiSecurityScheme"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SaslGssapiSecurityScheme"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SaslGssapiSecurityScheme Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SaslGssapiSecurityScheme>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SaslGssapiSecurityScheme"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SaslGssapiSecurityScheme Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SaslGssapiSecurityScheme>(_idx);
            }
