...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct SaslPlainSecurityScheme
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SaslPlainSecurityScheme instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SaslPlainSecurityScheme"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SaslPlainSecurityScheme(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SaslPlainSecurityScheme(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SaslPlainSecurityScheme.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SaslPlainSecurityScheme"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SaslPlainSecurityScheme"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SaslPlainSecurityScheme Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SaslPlainSecurityScheme>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SaslPlainSecurityScheme"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SaslPlainSecurityScheme Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SaslPlainSecurityScheme>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Source _createArg1;
            private readonly Corvus.Text.Json.AsyncApi26.JsonString.Source _createArg2;
            ...
            internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(SaslPlainSecurityScheme instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="SaslPlainSecurityScheme"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Source type,
            ...
            /// Creates an instance of a <see cref="SaslPlainSecurityScheme"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Source type, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default)
            {
                Create(ref _builder, type, description);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Source type, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default)
        {
            return new Source(type, description);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Source type, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(type, description);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<SaslPlainSecurityScheme, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SaslPlainSecurityScheme> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SaslPlainSecurityScheme>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<SaslPlainSecurityScheme> Create<TContext>(
        ...
        public static ParsedJsonDocument<SaslPlainSecurityScheme> Create(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.SaslPlainSecurityScheme.TheTypeOfTheSecuritySchemeValidValues.Source type, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
