    ...
    public readonly partial struct SaslPlainSecurityScheme
    {
        ...
        public readonly partial struct TheTypeOfTheSecuritySchemeValidValues
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheTypeOfTheSecuritySchemeValidValues instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheTypeOfTheSecuritySchemeValidValues"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTypeOfTheSecuritySchemeValidValues(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTypeOfTheSecuritySchemeValidValues.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheSecuritySchemeValidValues Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheSecuritySchemeValidValues Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheTypeOfTheSecuritySchemeValidValues>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheTypeOfTheSecuritySchemeValidValues instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheTypeOfTheSecuritySchemeValidValues, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheTypeOfTheSecuritySchemeValidValues> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheTypeOfTheSecuritySchemeValidValues>();
                }
                finally
                {
