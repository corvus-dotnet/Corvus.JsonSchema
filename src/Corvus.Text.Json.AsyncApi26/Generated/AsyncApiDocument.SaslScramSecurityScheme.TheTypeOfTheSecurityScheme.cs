...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct SaslScramSecurityScheme
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TheTypeOfTheSecurityScheme"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TheTypeOfTheSecurityScheme(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TheTypeOfTheSecurityScheme DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(TheTypeOfTheSecurityScheme value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in TheTypeOfTheSecurityScheme left, in TheTypeOfTheSecurityScheme right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TheTypeOfTheSecurityScheme left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TheTypeOfTheSecurityScheme instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheTypeOfTheSecurityScheme(JsonElement instance)
            {
                return TheTypeOfTheSecurityScheme.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheSecurityScheme From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheSecurityScheme ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheSecurityScheme>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheSecurityScheme ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheSecurityScheme>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheSecurityScheme ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheSecurityScheme>(json, options);
            }
            ...
            /// </exception>
            public static TheTypeOfTheSecurityScheme ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheSecurityScheme>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TheTypeOfTheSecurityScheme? result)
            {
                return JsonElementHelpers.TryParseValue<TheTypeOfTheSecurityScheme>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheTypeOfTheSecurityScheme(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TheTypeOfTheSecurityScheme IJsonElement<TheTypeOfTheSecurityScheme>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheTypeOfTheSecurityScheme: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheTypeOfTheSecurityScheme"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheTypeOfTheSecurityScheme"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TheTypeOfTheSecurityScheme Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheTypeOfTheSecurityScheme>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheTypeOfTheSecurityScheme"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TheTypeOfTheSecurityScheme Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TheTypeOfTheSecurityScheme>(_idx);
                }
            ...
            /// <param name="matchScramSha256">Match 1st item.</param>
            /// <param name="matchScramSha512">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchScramSha256,
                Func<TContext, TResult> matchScramSha512,
...
#endif
            {
                ...
                {
                    return matchScramSha256(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchScramSha512(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchScramSha256,
                Func<TResult> matchScramSha512,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchScramSha256();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchScramSha512();
                }
