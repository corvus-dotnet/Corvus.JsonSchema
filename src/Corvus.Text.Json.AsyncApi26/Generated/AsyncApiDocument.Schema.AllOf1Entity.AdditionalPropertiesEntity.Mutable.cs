        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AdditionalPropertiesEntity, Mutable>(AdditionalPropertiesEntity.DefaultInstance);
                    ...
                    /// <summary>
                    /// Conversion to <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static explicit operator Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable(Mutable value)
                    {
                        return Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable.From(value);
                    }

                    /// <summary>
                    /// Conversion from <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static explicit operator Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Draft07Schema.Mutable(Mutable value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static explicit operator Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.Mutable(Mutable value)
                    {
                    ...
                    /// </remarks>
                    public void Apply(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema value)
                    {
                        CheckValidInstance();
                    ...
                    /// <param name="matchSchema">Match a <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema"/>.</param>
                    /// <param name="matchJsonBoolean">Match a <see cref="Corvus.Text.Json.AsyncApi26.JsonBoolean"/>.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema, TContext, TResult> matchSchema,
                        Matcher<Corvus.Text.Json.AsyncApi26.JsonBoolean, TContext, TResult> matchJsonBoolean,
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.AdditionalPropertiesEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchSchema(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable.From(this), context);
                        }

                        if (Corvus.Text.Json.AsyncApi26.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchJsonBoolean(Corvus.Text.Json.AsyncApi26.JsonBoolean.Mutable.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema, TResult> matchSchema,
                        Matcher<Corvus.Text.Json.AsyncApi26.JsonBoolean, TResult> matchJsonBoolean,
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.AdditionalPropertiesEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchSchema(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable.From(this));
                        }

                        if (Corvus.Text.Json.AsyncApi26.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchJsonBoolean(Corvus.Text.Json.AsyncApi26.JsonBoolean.Mutable.From(this));
                        }
                    ...
                    public TAccumulator MatchEvery<TAccumulator>(
                        ...
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema, TAccumulator, TAccumulator> matchSchema,
                        Matcher<Corvus.Text.Json.AsyncApi26.JsonBoolean, TAccumulator, TAccumulator> matchJsonBoolean,
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.AdditionalPropertiesEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                    {
                        bool matched = false;
                        ...
                        {
                            matched = true;
                            accumulator = matchSchema(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable.From(this), accumulator);
                        }

                        if (Corvus.Text.Json.AsyncApi26.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                        {
                            matched = true;
                            accumulator = matchJsonBoolean(Corvus.Text.Json.AsyncApi26.JsonBoolean.Mutable.From(this), accumulator);
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsSchema(out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable.From(this);
                            return true;
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi26.JsonBoolean.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsJsonBoolean(out Corvus.Text.Json.AsyncApi26.JsonBoolean.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi26.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi26.JsonBoolean.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build? _schemaBuilderInstance;
                    private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source _schemaSourceInstance;
                    ...
                    public Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build value) {_schemaBuilderInstance = value; _kind = Kind.SchemaBuilder; }

                    public Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source value) { _schemaSourceInstance = value; _kind = Kind.SchemaSource; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema instance) => new(JsonElement.From(instance));

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source value) => new(value);

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.Text.Json.AsyncApi26.JsonBoolean instance) => new(JsonElement.From(instance));
                    ...
                    internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.SchemaBuilder:
                                valueBuilder.AddProperty(utf8Name, _schemaBuilderInstance!, static (in b, ref o) => Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                                break;
                    ...
                    internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.False:
                                ...
                                break;
                            case Kind.SchemaBuilder:
                                valueBuilder.AddPrebakedProperty(prebakedPropertyName, _schemaBuilderInstance!, static (in b, ref o) => Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.BuildValue(b, ref o));
                                break;
                            case Kind.SchemaSource:
                    ...
                    internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.False:
                                ...
                                break;
                            case Kind.SchemaBuilder:
                                valueBuilder.AddProperty(name, _schemaBuilderInstance!, static (in b, ref o) => Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.BuildValue(b, ref o));
                                break;
                            case Kind.SchemaSource:
                    ...
                    internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.False:
                                ...
                                break;
                            case Kind.SchemaBuilder:
                                valueBuilder.AddItem(_schemaBuilderInstance!, static (in b, ref o) => Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.BuildValue(b, ref o));
                                break;
                            case Kind.SchemaSource:
                    ...
                    #endif
                {
                    ...
                    TContext _context;
                    Source _source;
                    private readonly Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build<TContext>? _schemaBuilderInstance;
                    ...
                    public Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build<TContext> value) {_context = context; _schemaBuilderInstance = value; _kind = Kind.SchemaBuilder; }
                    ...
                    internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.SchemaBuilder:
                                valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _schemaBuilderInstance!), static (in b, ref o) => Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.SchemaBuilder:
                                valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _schemaBuilderInstance!), static (in b, ref o) => Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.BuildValue(b.Context, b.Build, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.SchemaBuilder:
                                valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _schemaBuilderInstance!), static (in b, ref o) => Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.BuildValue(b.Context, b.Build, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.SchemaBuilder:
                                valueBuilder.AddItem(BuildWithContext.Create(_context, _schemaBuilderInstance!), static (in b, ref o) => Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.BuildValue(b.Context, b.Build, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                ...
                public static Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source Build(
                    scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build buildValue, int initialCapacity = 1)
                {
                    return new Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source(buildValue);
                }
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source<TContext> Build<TContext>(
                    scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source<TContext>(context, buildValue);
                }
                ...
                /// <returns>An instance of a mutable document initialized with the given value.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(
                    JsonWorkspace workspace, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                {
                    // Create the document builder without a MetadataDb
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    var source = new Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source(value);
                ...
                /// <returns>An instance of a mutable document initialized with the given value.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                    JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    var source = new Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source<TContext>(context, value);
                    source.AddAsItem(ref cvb);
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AdditionalPropertiesEntity> Create(
                    scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                    try
                    {
                ...
                public static ParsedJsonDocument<AdditionalPropertiesEntity> Create<TContext>(
                    scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
