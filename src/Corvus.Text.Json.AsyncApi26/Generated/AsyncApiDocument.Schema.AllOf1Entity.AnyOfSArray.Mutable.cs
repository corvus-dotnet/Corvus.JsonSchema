...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Schema
    {
        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct AnyOfSArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AnyOfSArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AnyOfSArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnyOfSArray(Mutable instance)
                    {
                    ...
                    public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AnyOfSArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnyOfSArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema oldItem, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="AnyOfSArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AnyOfSArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnyOfSArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AnyOfSArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AnyOfSArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnyOfSArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AnyOfSArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.AnyOfSArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(AnyOfSArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.AnyOfSArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    public void AddItem(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source value)
                    {
                    ...
                    /// Add an item to the array.
                    /// </summary>
                    public void AddItem<TContext>(in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                {
                    return workspace.CreateBuilder<AnyOfSArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AnyOfSArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AnyOfSArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AnyOfSArray> Create<TContext>(
