        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct ItemsEntity
            {
...
#endif
                {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static explicit operator Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.Mutable(Mutable value)
                    {
                        return Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.Mutable.From(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        ...
                        {
                            return matchSchemaArray(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.Mutable.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.JsonSchema.Evaluate(_parent, _idx))
                        {
                        ...
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchSchemaArray(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.Mutable.From(this));
                        }
                    ...
                    public TAccumulator MatchEvery<TAccumulator>(
                        ...
                        Matcher<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                    {
                        bool matched = false;
                        ...
                        {
                            matched = true;
                            accumulator = matchSchemaArray(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.Mutable.From(this), accumulator);
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsSchemaArray(out Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
