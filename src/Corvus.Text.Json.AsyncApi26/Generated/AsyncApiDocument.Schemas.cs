...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Schemas
#if NET8_0_OR_GREATER
        : IJsonElement<Schemas>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Schemas"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Schemas(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Schemas DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in Schemas left, in Schemas right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Schemas left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Schemas instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Schemas(JsonElement instance)
        {
            return Schemas.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Schemas From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Schemas ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Schemas>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Schemas ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Schemas>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Schemas ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Schemas>(json, options);
        }
        ...
        /// </exception>
        public static Schemas ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Schemas>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Schemas? result)
        {
            return JsonElementHelpers.TryParseValue<Schemas>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Schemas(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Schemas IJsonElement<Schemas>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Schemas: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Schemas"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Schemas"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Schemas>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Schemas"/> that lives for the lifetime of its
