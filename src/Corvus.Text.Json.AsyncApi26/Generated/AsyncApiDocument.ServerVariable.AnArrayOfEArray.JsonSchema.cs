    ...
    public readonly partial struct ServerVariable
    {
            ...
            : IJsonElement<AnArrayOfEArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~12.6.0~1serverVariable.json/properties/examples"u8, buffer, out written);
