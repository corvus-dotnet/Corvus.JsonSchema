...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct ServerVariable
    {
        ...
        public readonly partial struct AnArrayOfEArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AnArrayOfEArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AnArrayOfEArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnArrayOfEArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AnArrayOfEArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnArrayOfEArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="AnArrayOfEArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AnArrayOfEArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AnArrayOfEArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AnArrayOfEArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AnArrayOfEArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AnArrayOfEArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AnArrayOfEArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ServerVariable.AnArrayOfEArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AnArrayOfEArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ServerVariable.AnArrayOfEArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AnArrayOfEArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AnArrayOfEArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AnArrayOfEArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<AnArrayOfEArray> Create<TContext>(
