...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct SpecificationExtension
#if NET8_0_OR_GREATER
        : IJsonElement<SpecificationExtension>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpecificationExtension"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SpecificationExtension(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SpecificationExtension DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in SpecificationExtension left, in SpecificationExtension right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SpecificationExtension left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SpecificationExtension instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SpecificationExtension(JsonElement instance)
        {
            return SpecificationExtension.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecificationExtension From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecificationExtension ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpecificationExtension>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecificationExtension ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpecificationExtension>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecificationExtension ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpecificationExtension>(json, options);
        }
        ...
        /// </exception>
        public static SpecificationExtension ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SpecificationExtension>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SpecificationExtension? result)
        {
            return JsonElementHelpers.TryParseValue<SpecificationExtension>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SpecificationExtension(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SpecificationExtension IJsonElement<SpecificationExtension>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SpecificationExtension: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SpecificationExtension"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SpecificationExtension"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<SpecificationExtension>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SpecificationExtension"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SpecificationExtension Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SpecificationExtension>(_idx);
            }
