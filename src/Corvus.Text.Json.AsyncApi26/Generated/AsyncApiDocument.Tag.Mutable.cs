...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Tag
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Tag.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg2, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Tag.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg2, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source arg2, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source name, scoped in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, scoped in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Source externalDocs = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi26.JsonString.Source name, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Source externalDocs = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.AsyncApi26.JsonString.Source name, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Source<TContext> externalDocs = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<Tag> Create(in Corvus.Text.Json.AsyncApi26.JsonString.Source name, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Source externalDocs = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Tag> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi26.JsonString.Source name, in Corvus.Text.Json.AsyncApi26.JsonString.Source description = default, in Corvus.Text.Json.AsyncApi26.AsyncApiDocument.ExternalDocs.Source<TContext> externalDocs = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
