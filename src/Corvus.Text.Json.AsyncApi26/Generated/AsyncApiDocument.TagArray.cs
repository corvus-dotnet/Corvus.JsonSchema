...
public readonly partial struct AsyncApiDocument
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TagArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TagArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TagArray DefaultInstance { get; }
        ...
        public Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Tag this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Tag>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Tag> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi26.AsyncApiDocument.Tag>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TagArray left, in TagArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TagArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TagArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TagArray(JsonElement instance)
        {
            return TagArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TagArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TagArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TagArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TagArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TagArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TagArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TagArray>(json, options);
        }
        ...
        /// </exception>
        public static TagArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TagArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TagArray? result)
        {
            return JsonElementHelpers.TryParseValue<TagArray>(ref reader, out result);
        }
...
#if NET
        static TagArray IJsonElement<TagArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TagArray: ValueKind = {ValueKind} : \"{ToString()}\"";
