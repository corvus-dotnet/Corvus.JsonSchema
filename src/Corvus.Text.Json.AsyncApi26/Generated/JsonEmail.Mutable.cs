...
public readonly partial struct JsonEmail
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonEmail instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonEmail"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonEmail(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonEmail.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonEmail Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonEmail Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonEmail>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonEmail instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonEmail, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonEmail> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonEmail>();
        }
        finally
        {
