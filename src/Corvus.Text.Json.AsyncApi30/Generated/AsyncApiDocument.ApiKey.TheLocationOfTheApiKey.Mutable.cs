    ...
    public readonly partial struct ApiKey
    {
        ...
        public readonly partial struct TheLocationOfTheApiKey
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheLocationOfTheApiKey instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheLocationOfTheApiKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheLocationOfTheApiKey(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheLocationOfTheApiKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheLocationOfTheApiKey Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheLocationOfTheApiKey Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheLocationOfTheApiKey>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheLocationOfTheApiKey instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (TheLocationOfTheApiKey)value;
            ...
            {
                return workspace.CreateBuilder<TheLocationOfTheApiKey, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheLocationOfTheApiKey> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheLocationOfTheApiKey>();
                }
                finally
                {
