...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct ApiKey
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TheLocationOfTheApiKey"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TheLocationOfTheApiKey(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TheLocationOfTheApiKey DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(TheLocationOfTheApiKey value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in TheLocationOfTheApiKey left, in TheLocationOfTheApiKey right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TheLocationOfTheApiKey left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TheLocationOfTheApiKey instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheLocationOfTheApiKey(JsonElement instance)
            {
                return TheLocationOfTheApiKey.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheLocationOfTheApiKey From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheLocationOfTheApiKey ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheLocationOfTheApiKey>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheLocationOfTheApiKey ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheLocationOfTheApiKey>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheLocationOfTheApiKey ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheLocationOfTheApiKey>(json, options);
            }
            ...
            /// </exception>
            public static TheLocationOfTheApiKey ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TheLocationOfTheApiKey>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TheLocationOfTheApiKey? result)
            {
                return JsonElementHelpers.TryParseValue<TheLocationOfTheApiKey>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheLocationOfTheApiKey(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TheLocationOfTheApiKey IJsonElement<TheLocationOfTheApiKey>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheLocationOfTheApiKey: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheLocationOfTheApiKey"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheLocationOfTheApiKey"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TheLocationOfTheApiKey Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheLocationOfTheApiKey>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheLocationOfTheApiKey"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TheLocationOfTheApiKey Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TheLocationOfTheApiKey>(_idx);
                }
