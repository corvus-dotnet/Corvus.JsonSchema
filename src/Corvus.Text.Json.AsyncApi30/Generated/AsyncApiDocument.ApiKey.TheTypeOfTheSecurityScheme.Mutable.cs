    ...
    public readonly partial struct ApiKey
    {
        ...
        public readonly partial struct TheTypeOfTheSecurityScheme
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheTypeOfTheSecurityScheme instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheTypeOfTheSecurityScheme"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTypeOfTheSecurityScheme(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTypeOfTheSecurityScheme.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheSecurityScheme Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheSecurityScheme Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheTypeOfTheSecurityScheme>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheTypeOfTheSecurityScheme instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheTypeOfTheSecurityScheme, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheTypeOfTheSecurityScheme> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheTypeOfTheSecurityScheme>();
                }
                finally
                {
