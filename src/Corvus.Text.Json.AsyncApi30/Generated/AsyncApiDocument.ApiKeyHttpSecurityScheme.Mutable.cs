...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct ApiKeyHttpSecurityScheme
    {
...
#endif
        {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetIn(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ApiKeyHttpSecurityScheme.TheLocationOfTheApiKey.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ApiKeyHttpSecurityScheme.TheTypeOfTheSecurityScheme.Source value)
            {
                CheckValidInstance();
