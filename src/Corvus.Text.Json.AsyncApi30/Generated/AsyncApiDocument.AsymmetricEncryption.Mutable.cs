...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AsymmetricEncryption
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AsymmetricEncryption instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AsymmetricEncryption"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AsymmetricEncryption(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AsymmetricEncryption(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AsymmetricEncryption.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AsymmetricEncryption"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AsymmetricEncryption"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly AsymmetricEncryption Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AsymmetricEncryption>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AsymmetricEncryption"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly AsymmetricEncryption Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AsymmetricEncryption>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Source _createArg1;
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(AsymmetricEncryption instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="AsymmetricEncryption"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Source type,
            ...
            /// Creates an instance of a <see cref="AsymmetricEncryption"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Source type, in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Source type, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Source type, in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<AsymmetricEncryption, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AsymmetricEncryption> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AsymmetricEncryption>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AsymmetricEncryption> Create<TContext>(
        ...
        public static ParsedJsonDocument<AsymmetricEncryption> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AsymmetricEncryption.TheTypeOfTheSecurityScheme.Source type, in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
