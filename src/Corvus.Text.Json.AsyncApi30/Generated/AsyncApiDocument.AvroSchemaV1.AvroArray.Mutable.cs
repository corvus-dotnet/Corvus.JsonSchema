    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct AvroArray
        {
...
#endif
            {
                ...
                public void SetAliases(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroArray.NameArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetDoc(in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetItems(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetNameValue(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Name.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetNamespaceValue(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Namespace.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetType(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroArray.TypeEntity.Source value)
                {
                    CheckValidInstance();
