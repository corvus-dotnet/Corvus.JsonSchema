...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AvroArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AvroArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AvroArray DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroArray.NameArray Aliases
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AliasesUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroArray.NameArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types Items
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroArray.TypeEntity Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroArray.TypeEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in AvroArray left, in AvroArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AvroArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AvroArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AvroArray(JsonElement instance)
            {
                return AvroArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroArray>(json, options);
            }
            ...
            /// </exception>
            public static AvroArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AvroArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AvroArray? result)
            {
                return JsonElementHelpers.TryParseValue<AvroArray>(ref reader, out result);
            }
...
#if NET
            static AvroArray IJsonElement<AvroArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AvroArray: ValueKind = {ValueKind} : \"{ToString()}\"";
