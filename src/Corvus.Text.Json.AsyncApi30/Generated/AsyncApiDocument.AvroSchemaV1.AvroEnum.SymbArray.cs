    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct AvroEnum
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SymbArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SymbArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SymbArray DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in SymbArray left, in SymbArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SymbArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(SymbArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SymbArray(JsonElement instance)
                {
                    return SymbArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SymbArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SymbArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SymbArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SymbArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SymbArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SymbArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SymbArray>(json, options);
                }
                ...
                /// </exception>
                public static SymbArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SymbArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SymbArray? result)
                {
                    return JsonElementHelpers.TryParseValue<SymbArray>(ref reader, out result);
                }
...
#if NET
                static SymbArray IJsonElement<SymbArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SymbArray: ValueKind = {ValueKind} : \"{ToString()}\"";
