...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct AvroField
        {
            ...
            public readonly partial struct OrderEntity
                : IJsonElement<OrderEntity>
            {
                /// <summary>
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "ascending"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OrderEntity EnumJson1 = ParsedJsonDocument<OrderEntity>.StringConstant([.."\"ascending\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "descending"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OrderEntity EnumJson2 = ParsedJsonDocument<OrderEntity>.StringConstant([.."\"descending\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    ...
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OrderEntity EnumJson3 = ParsedJsonDocument<OrderEntity>.StringConstant([.."\"ignore\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "ascending"
                    /// as a <see cref="OrderEntity"/>.
                    /// </summary>
                    public static OrderEntity Ascending { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "ascending"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> AscendingUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "descending"
                    /// as a <see cref="OrderEntity"/>.
                    /// </summary>
                    public static OrderEntity Descending { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "descending"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> DescendingUtf8 => Constants.Enum2;

                    /// <summary>
                    /// Gets the string "ignore"
                    /// as a <see cref="OrderEntity"/>.
                    /// </summary>
                    public static OrderEntity Ignore { get; } = Constants.EnumJson3;
                    /// <summary>
                    /// Gets the string "ignore"
                    /// as a UTF8 byte array.
                    /// </summary>
                ...
                {
                    /// <summary>
                    /// Corresponds to the JSON string "ascending".
                    /// </summary>
                    Ascending = 0,
                    /// <summary>
                    /// Corresponds to the JSON string "descending".
                    /// </summary>
                    Descending = 1,
                    /// <summary>
                ...
                public static implicit operator OrderEntity(KnownValues value)
                {
                    return value switch
                    {
                        KnownValues.Ascending => Constants.EnumJson1,
                        KnownValues.Descending => Constants.EnumJson2,
                ...
                public static implicit operator KnownValues(OrderEntity value)
                {
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    ...
                    {
                        result = KnownValues.Ascending;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.Descending;
                        return true;
                    }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/avroField/properties/order"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                    /// </summary>
                    public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/avroField/properties/order";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/avroField/properties/order"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("ascending"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("descending"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
