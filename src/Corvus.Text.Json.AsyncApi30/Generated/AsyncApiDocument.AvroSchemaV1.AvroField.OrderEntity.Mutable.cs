        ...
        public readonly partial struct AvroField
        {
            ...
            public readonly partial struct OrderEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OrderEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OrderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OrderEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new OrderEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OrderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="OrderEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="OrderEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OrderEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<OrderEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="OrderEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OrderEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OrderEntity>(_idx);
                    }
                    ...
                    /// <param name="matchAscending">Match 1st item.</param>
                    /// <param name="matchDescending">Match 2nd item.</param>
                    /// <param name="matchIgnore">Match 3rd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchAscending,
                        Func<TContext, TResult> matchDescending,
...
#endif
                    {
                        ...
                        {
                            return matchAscending(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchDescending(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchAscending,
                        Func<TResult> matchDescending,
                        Func<TResult> matchIgnore,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchAscending();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchDescending();
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(OrderEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (OrderEntity)value;
                ...
                {
                    return workspace.CreateBuilder<OrderEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OrderEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OrderEntity>();
                    }
                    finally
                    {
