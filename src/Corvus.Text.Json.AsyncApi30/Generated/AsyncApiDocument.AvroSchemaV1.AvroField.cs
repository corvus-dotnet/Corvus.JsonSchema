...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroField.NameArray Aliases
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AliasesUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroField.NameArray value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroField.OrderEntity Order
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroField.OrderEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types value))
                    {
                        return value;
                    }
