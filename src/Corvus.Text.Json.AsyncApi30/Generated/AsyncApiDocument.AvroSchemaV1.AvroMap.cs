...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AvroMap"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AvroMap(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AvroMap DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroMap.NameArray Aliases
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AliasesUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroMap.NameArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroMap.TypeEntity Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroMap.TypeEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types Values
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValuesUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in AvroMap left, in AvroMap right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AvroMap left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AvroMap instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AvroMap(JsonElement instance)
            {
                return AvroMap.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroMap From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroMap ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroMap>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroMap ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroMap>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroMap ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroMap>(json, options);
            }
            ...
            /// </exception>
            public static AvroMap ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AvroMap>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AvroMap? result)
            {
                return JsonElementHelpers.TryParseValue<AvroMap>(ref reader, out result);
            }
...
#if NET
            static AvroMap IJsonElement<AvroMap>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AvroMap: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Values"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Values => [0x85, 0x00, 0x00, 0x00, 0x22, 0x76, 0x61, 0x6C, 0x75, 0x65, 0x73, 0x22];
            }
        }
    }
}
