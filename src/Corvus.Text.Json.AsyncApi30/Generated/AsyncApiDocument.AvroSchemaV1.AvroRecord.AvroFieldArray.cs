    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct AvroRecord
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AvroFieldArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AvroFieldArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AvroFieldArray DefaultInstance { get; }
                ...
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroField this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroField>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroField> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroField>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in AvroFieldArray left, in AvroFieldArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AvroFieldArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(AvroFieldArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AvroFieldArray(JsonElement instance)
                {
                    return AvroFieldArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AvroFieldArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AvroFieldArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AvroFieldArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AvroFieldArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AvroFieldArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AvroFieldArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AvroFieldArray>(json, options);
                }
                ...
                /// </exception>
                public static AvroFieldArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AvroFieldArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AvroFieldArray? result)
                {
                    return JsonElementHelpers.TryParseValue<AvroFieldArray>(ref reader, out result);
                }
...
#if NET
                static AvroFieldArray IJsonElement<AvroFieldArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AvroFieldArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public AvroFieldArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AvroFieldArray>(_idx);
                    }
