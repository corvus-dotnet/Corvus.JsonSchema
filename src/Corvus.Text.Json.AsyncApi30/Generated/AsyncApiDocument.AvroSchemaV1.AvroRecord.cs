...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AvroRecord"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AvroRecord(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AvroRecord DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroRecord.NameArray Aliases
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AliasesUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroRecord.NameArray value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.JsonString Doc
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocUtf8, out Corvus.Text.Json.AsyncApi30.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroRecord.AvroFieldArray Fields
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FieldsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroRecord.AvroFieldArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Name NameValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Name value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Namespace NamespaceValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NamespaceValueUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Namespace value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroRecord.TypeEntity Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroRecord.TypeEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in AvroRecord left, in AvroRecord right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AvroRecord left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AvroRecord instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AvroRecord(JsonElement instance)
            {
                return AvroRecord.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroRecord From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroRecord ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroRecord>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroRecord ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroRecord>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AvroRecord ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AvroRecord>(json, options);
            }
            ...
            /// </exception>
            public static AvroRecord ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AvroRecord>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AvroRecord? result)
            {
                return JsonElementHelpers.TryParseValue<AvroRecord>(ref reader, out result);
            }
...
#if NET
            static AvroRecord IJsonElement<AvroRecord>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AvroRecord: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="Fields"/>.
                /// </summary>
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Fields"/>.
                /// </summary>
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Fields"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Fields => [0x85, 0x00, 0x00, 0x00, 0x22, 0x66, 0x69, 0x65, 0x6C, 0x64, 0x73, 0x22];
