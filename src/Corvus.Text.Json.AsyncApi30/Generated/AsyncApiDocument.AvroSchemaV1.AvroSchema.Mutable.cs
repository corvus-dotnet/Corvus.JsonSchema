    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct AvroSchema
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AvroSchema instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AvroSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AvroSchema(Mutable instance)
                {
                ...
                /// </remarks>
                public void Apply(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AvroSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly AvroSchema Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AvroSchema Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AvroSchema>(_idx);
                }

                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsTypes(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types.Mutable result)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.Types.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroSchema.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                ...
                public static implicit operator Source(AvroSchema instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroSchema.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
            ...
            {
                return workspace.CreateBuilder<AvroSchema, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AvroSchema> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AvroSchema>();
                }
                finally
                {
            ...
            public static ParsedJsonDocument<AvroSchema> CreateArray(
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>An empty <see cref="ParsedJsonDocument{T}"/>. The caller must dispose it.</returns>
            public static ParsedJsonDocument<AvroSchema> CreateObject(
                int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<AvroSchema> Create<TContext>(
