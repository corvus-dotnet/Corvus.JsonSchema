    ...
    public readonly partial struct AvroSchemaV1
    {
            ...
            : IJsonElement<AvroUnion>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/avroUnion"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/avroUnion";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/avroUnion"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroSchema.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroSchema.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
