...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct CustomTypeReference
            : IJsonElement<CustomTypeReference>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/customTypeReference"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/customTypeReference";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/customTypeReference"u8;
                ...
                private static readonly JsonSchemaPathProvider NotSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/not/$ref"u8, buffer, out written);
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[A-Za-z_][A-Za-z0-9_]*(\\.[A-Za-z_][A-Za-z0-9_]*)*$", "pattern"u8, ref context);
                    }
                    ...
                    JsonSchemaContext notContext =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: NotSchemaEvaluationPath);
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.JsonSchema.Evaluate(parentDocument, parentIndex, ref notContext);
...
#else
                private static Regex CreatePattern() => new("^[A-Za-z_][A-Za-z0-9_]*(\\.[A-Za-z_][A-Za-z0-9_]*)*$", RegexOptions.Compiled);
#endif
