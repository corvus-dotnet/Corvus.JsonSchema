...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CustomTypeReference"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CustomTypeReference(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CustomTypeReference DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(CustomTypeReference value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in CustomTypeReference left, in CustomTypeReference right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CustomTypeReference left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(CustomTypeReference instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CustomTypeReference(JsonElement instance)
            {
                return CustomTypeReference.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomTypeReference From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomTypeReference ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomTypeReference>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomTypeReference ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomTypeReference>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomTypeReference ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomTypeReference>(json, options);
            }
            ...
            /// </exception>
            public static CustomTypeReference ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CustomTypeReference>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CustomTypeReference? result)
            {
                return JsonElementHelpers.TryParseValue<CustomTypeReference>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CustomTypeReference(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CustomTypeReference IJsonElement<CustomTypeReference>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CustomTypeReference: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CustomTypeReference"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CustomTypeReference"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CustomTypeReference Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CustomTypeReference>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CustomTypeReference"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CustomTypeReference Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CustomTypeReference>(_idx);
                }
