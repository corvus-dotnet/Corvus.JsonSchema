...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// </remarks>
            public void Apply(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroSchema value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroSchema.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsAvroSchema(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroSchema.Mutable result)
            {
                if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroSchema.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.AvroSchema.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
