    ...
    public readonly partial struct AvroSchemaV1
    {
            ...
            : IJsonElement<Namespace>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1avroSchema_v1.json/definitions/namespace"u8, buffer, out written);
