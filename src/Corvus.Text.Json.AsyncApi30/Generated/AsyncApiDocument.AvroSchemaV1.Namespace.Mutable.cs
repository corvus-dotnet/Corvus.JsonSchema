...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct Namespace
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Namespace instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Namespace"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Namespace(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Namespace(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Namespace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Namespace"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Namespace"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Namespace Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Namespace>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Namespace"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Namespace Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Namespace>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Namespace instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Namespace, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Namespace> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Namespace>();
                }
                finally
                {
