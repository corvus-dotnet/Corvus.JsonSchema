...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PrimitiveType"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PrimitiveType(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PrimitiveType DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PrimitiveType value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PrimitiveType left, in PrimitiveType right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PrimitiveType left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PrimitiveType instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PrimitiveType(JsonElement instance)
            {
                return PrimitiveType.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrimitiveType From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrimitiveType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrimitiveType>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrimitiveType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrimitiveType>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrimitiveType ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrimitiveType>(json, options);
            }
            ...
            /// </exception>
            public static PrimitiveType ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PrimitiveType>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PrimitiveType? result)
            {
                return JsonElementHelpers.TryParseValue<PrimitiveType>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PrimitiveType(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PrimitiveType IJsonElement<PrimitiveType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PrimitiveType: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PrimitiveType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PrimitiveType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<PrimitiveType>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PrimitiveType"/> that lives for the lifetime of its
            ...
            /// <param name="matchNull">Match 1st item.</param>
            /// <param name="matchBoolean">Match 2nd item.</param>
            /// <param name="matchInt">Match 3rd item.</param>
            /// <param name="matchLong">Match 4th item.</param>
            /// <param name="matchFloat">Match 5th item.</param>
            /// <param name="matchDouble">Match 6th item.</param>
            /// <param name="matchBytes">Match 7th item.</param>
            /// <param name="matchString">Match 8th item.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Func<TContext, TResult> matchInt,
                Func<TContext, TResult> matchLong,
                Func<TContext, TResult> matchFloat,
                Func<TContext, TResult> matchDouble,
                Func<TContext, TResult> matchBytes,
...
#endif
            {
                ...
                {
                    return matchInt(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchLong(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchInt,
                Func<TResult> matchLong,
                Func<TResult> matchFloat,
                Func<TResult> matchDouble,
                Func<TResult> matchBytes,
