    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct PrimitiveTypeWithMetadata
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetType(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source _createArg1;
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveTypeWithMetadata.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveTypeWithMetadata.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type)
                {
                ...
                /// Creates an instance of a <see cref="PrimitiveTypeWithMetadata"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<PrimitiveTypeWithMetadata> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType.Source type, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
