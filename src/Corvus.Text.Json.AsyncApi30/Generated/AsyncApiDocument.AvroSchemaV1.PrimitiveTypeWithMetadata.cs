...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct AvroSchemaV1
    {
        ...
        public readonly partial struct PrimitiveTypeWithMetadata
            ...
            : IJsonElement<PrimitiveTypeWithMetadata>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PrimitiveTypeWithMetadata"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PrimitiveTypeWithMetadata(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PrimitiveTypeWithMetadata DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AvroSchemaV1.PrimitiveType value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in PrimitiveTypeWithMetadata left, in PrimitiveTypeWithMetadata right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PrimitiveTypeWithMetadata left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PrimitiveTypeWithMetadata instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PrimitiveTypeWithMetadata(JsonElement instance)
            {
                return PrimitiveTypeWithMetadata.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrimitiveTypeWithMetadata From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrimitiveTypeWithMetadata ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrimitiveTypeWithMetadata>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrimitiveTypeWithMetadata ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrimitiveTypeWithMetadata>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrimitiveTypeWithMetadata ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrimitiveTypeWithMetadata>(json, options);
            }
            ...
            /// </exception>
            public static PrimitiveTypeWithMetadata ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PrimitiveTypeWithMetadata>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PrimitiveTypeWithMetadata? result)
            {
                return JsonElementHelpers.TryParseValue<PrimitiveTypeWithMetadata>(ref reader, out result);
            }
...
#if NET
            static PrimitiveTypeWithMetadata IJsonElement<PrimitiveTypeWithMetadata>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PrimitiveTypeWithMetadata: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public PrimitiveTypeWithMetadata Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public PrimitiveTypeWithMetadata Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PrimitiveTypeWithMetadata>(_idx);
                }
