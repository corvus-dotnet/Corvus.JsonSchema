...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<BearerHttpSecurityScheme>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchBearerFormat(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1BearerHTTPSecurityScheme.json"u8, buffer, out written);
