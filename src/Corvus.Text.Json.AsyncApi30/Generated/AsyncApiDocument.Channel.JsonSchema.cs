...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Channel>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchAddress(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1channel.json"u8, buffer, out written);
