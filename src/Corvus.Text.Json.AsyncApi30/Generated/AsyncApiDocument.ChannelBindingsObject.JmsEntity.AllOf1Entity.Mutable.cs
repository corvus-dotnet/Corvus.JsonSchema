        ...
        public readonly partial struct JmsEntity
        {
            ...
            public readonly partial struct AllOf1Entity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.JmsEntity.AllOf1Entity.RequiredBindingVersion.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredBindingVersion(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.JmsEntity.AllOf1Entity.RequiredBindingVersion.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.JmsEntity.AllOf1Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.JmsEntity.AllOf1Entity.RequiredBindingVersion.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.JmsEntity.AllOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.JmsEntity.AllOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static ParsedJsonDocument<AllOf1Entity> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Jms001Channel.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source destination = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Jms001Channel.DestinationTypeEntity.Source destinationType = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
