        ...
        public readonly partial struct KafkaEntity
        {
                ...
                : IJsonElement<BindingVersionEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "0.5.0"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly BindingVersionEntity EnumJson1 = ParsedJsonDocument<BindingVersionEntity>.StringConstant([.."\"0.5.0\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "0.4.0"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly BindingVersionEntity EnumJson2 = ParsedJsonDocument<BindingVersionEntity>.StringConstant([.."\"0.4.0\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum3 = "0.3.0"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly BindingVersionEntity EnumJson3 = ParsedJsonDocument<BindingVersionEntity>.StringConstant([.."\"0.3.0\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "0.5.0"
                    /// as a <see cref="BindingVersionEntity"/>.
                    /// </summary>
                    public static BindingVersionEntity Value050 { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "0.5.0"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> Value050Utf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "0.4.0"
                    /// as a <see cref="BindingVersionEntity"/>.
                    /// </summary>
                    public static BindingVersionEntity Value040 { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "0.4.0"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> Value040Utf8 => Constants.Enum2;

                    /// <summary>
                    /// Gets the string "0.3.0"
                    /// as a <see cref="BindingVersionEntity"/>.
                    /// </summary>
                    public static BindingVersionEntity Value030 { get; } = Constants.EnumJson3;
                    /// <summary>
                    /// Gets the string "0.3.0"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> Value030Utf8 => Constants.Enum3;
                }
                ...
                {
                    /// <summary>
                    /// Corresponds to the JSON string "0.5.0".
                    /// </summary>
                    Value050 = 0,
                    /// <summary>
                    /// Corresponds to the JSON string "0.4.0".
                    /// </summary>
                    Value040 = 1,
                    /// <summary>
                ...
                public static implicit operator BindingVersionEntity(KnownValues value)
                {
                    return value switch
                    {
                        KnownValues.Value050 => Constants.EnumJson1,
                        KnownValues.Value040 => Constants.EnumJson2,
                        KnownValues.Value030 => Constants.EnumJson3,
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    ...
                    {
                        result = KnownValues.Value050;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.Value040;
                        return true;
                    }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1channelBindingsObject.json/properties/kafka/properties/bindingVersion"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                    /// </summary>
                    public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1channelBindingsObject.json/properties/kafka/properties/bindingVersion";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1channelBindingsObject.json/properties/kafka/properties/bindingVersion"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("0.5.0"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("0.4.0"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("0.3.0"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
