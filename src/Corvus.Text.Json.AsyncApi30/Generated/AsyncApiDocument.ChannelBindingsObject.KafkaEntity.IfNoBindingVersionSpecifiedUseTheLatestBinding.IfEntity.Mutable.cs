            ...
            public readonly partial struct IfNoBindingVersionSpecifiedUseTheLatestBinding
            {
                ...
                public readonly partial struct IfEntity
                {
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.KafkaEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.KafkaEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.KafkaEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.KafkaEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
