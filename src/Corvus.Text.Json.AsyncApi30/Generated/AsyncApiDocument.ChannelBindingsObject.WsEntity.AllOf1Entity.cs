    ...
    public readonly partial struct ChannelBindingsObject
    {
        ...
        public readonly partial struct WsEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.BindingVersionEntity BindingVersion
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BindingVersionUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.BindingVersionEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.HeadersEntity Headers
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeadersUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.HeadersEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.MethodEntity Method
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.MethodEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.QueryEntity Query
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QueryUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.QueryEntity value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsWebsockets010Channel(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel result)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.WsEntity.AllOf1Entity.RequiredBindingVersion" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredBindingVersion(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.WsEntity.AllOf1Entity.RequiredBindingVersion result)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.WsEntity.AllOf1Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.WsEntity.AllOf1Entity.RequiredBindingVersion.From(this);
                        return true;
                    }
                ...
                /// <param name="matchCorvusTextJsonAsyncApi30AsyncApiDocumentWebsockets010Channel">Match a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel, TContext, TResult> matchCorvusTextJsonAsyncApi30AsyncApiDocumentWebsockets010Channel,
...
#endif
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.WsEntity.AllOf1Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusTextJsonAsyncApi30AsyncApiDocumentWebsockets010Channel(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel, TResult> matchCorvusTextJsonAsyncApi30AsyncApiDocumentWebsockets010Channel,
                    Matcher<AllOf1Entity, TResult> defaultMatch)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ChannelBindingsObject.WsEntity.AllOf1Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusTextJsonAsyncApi30AsyncApiDocumentWebsockets010Channel(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.From(this));
                    }
