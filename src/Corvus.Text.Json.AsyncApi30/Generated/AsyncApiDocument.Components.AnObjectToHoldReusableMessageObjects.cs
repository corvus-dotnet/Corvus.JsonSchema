...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AnObjectToHoldReusableMessageObjects"/> struct.
            /// </summary>
            ...
            internal AnObjectToHoldReusableMessageObjects(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AnObjectToHoldReusableMessageObjects DefaultInstance { get; }
            ...
            /// <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableMessageObjects.WDEntity"/>.
            /// </summary>
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternWdEntity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableMessageObjects.WDEntity result)
            {
                if (MatchesPatternWdEntity(propertyName))
                {
                    result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableMessageObjects.WDEntity.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternWdEntity(ReadOnlySpan<byte> name, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableMessageObjects.WDEntity value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableMessageObjects.WDEntity typedValue = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableMessageObjects.WDEntity.From(property.Value);
            ...
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableMessageObjects left, in AnObjectToHoldReusableMessageObjects right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableMessageObjects left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AnObjectToHoldReusableMessageObjects instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AnObjectToHoldReusableMessageObjects(JsonElement instance)
            {
                return AnObjectToHoldReusableMessageObjects.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableMessageObjects From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableMessageObjects ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableMessageObjects>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableMessageObjects ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableMessageObjects>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableMessageObjects ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableMessageObjects>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static AnObjectToHoldReusableMessageObjects ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableMessageObjects>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AnObjectToHoldReusableMessageObjects? result)
            {
                return JsonElementHelpers.TryParseValue<AnObjectToHoldReusableMessageObjects>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AnObjectToHoldReusableMessageObjects(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AnObjectToHoldReusableMessageObjects IJsonElement<AnObjectToHoldReusableMessageObjects>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AnObjectToHoldReusableMessageObjects: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AnObjectToHoldReusableMessageObjects"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AnObjectToHoldReusableMessageObjects"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableMessageObjects Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AnObjectToHoldReusableMessageObjects>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AnObjectToHoldReusableMessageObjects"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableMessageObjects Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AnObjectToHoldReusableMessageObjects>(_idx);
                }
