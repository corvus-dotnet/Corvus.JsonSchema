    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct AnObjectToHoldReusableOperationBindingsObjects
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AnObjectToHoldReusableOperationBindingsObjects instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AnObjectToHoldReusableOperationBindingsObjects"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnObjectToHoldReusableOperationBindingsObjects(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AnObjectToHoldReusableOperationBindingsObjects(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnObjectToHoldReusableOperationBindingsObjects.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AnObjectToHoldReusableOperationBindingsObjects"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AnObjectToHoldReusableOperationBindingsObjects"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AnObjectToHoldReusableOperationBindingsObjects Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AnObjectToHoldReusableOperationBindingsObjects>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AnObjectToHoldReusableOperationBindingsObjects"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AnObjectToHoldReusableOperationBindingsObjects Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AnObjectToHoldReusableOperationBindingsObjects>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationBindingsObjects.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AnObjectToHoldReusableOperationBindingsObjects instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationBindingsObjects.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AnObjectToHoldReusableOperationBindingsObjects, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AnObjectToHoldReusableOperationBindingsObjects> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AnObjectToHoldReusableOperationBindingsObjects>();
                }
                finally
                {
