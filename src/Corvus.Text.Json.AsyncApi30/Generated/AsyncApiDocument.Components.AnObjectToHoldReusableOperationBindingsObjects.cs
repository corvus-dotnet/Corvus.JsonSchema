...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct AnObjectToHoldReusableOperationBindingsObjects
            ...
            : IJsonElement<AnObjectToHoldReusableOperationBindingsObjects>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AnObjectToHoldReusableOperationBindingsObjects"/> struct.
            /// </summary>
            ...
            internal AnObjectToHoldReusableOperationBindingsObjects(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AnObjectToHoldReusableOperationBindingsObjects DefaultInstance { get; }
            ...
            /// <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationBindingsObjects.WDEntity"/>.
            /// </summary>
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternWdEntity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationBindingsObjects.WDEntity result)
            {
                if (MatchesPatternWdEntity(propertyName))
                {
                    result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationBindingsObjects.WDEntity.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternWdEntity(ReadOnlySpan<byte> name, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationBindingsObjects.WDEntity value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationBindingsObjects.WDEntity typedValue = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationBindingsObjects.WDEntity.From(property.Value);
            ...
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableOperationBindingsObjects left, in AnObjectToHoldReusableOperationBindingsObjects right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableOperationBindingsObjects left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AnObjectToHoldReusableOperationBindingsObjects instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AnObjectToHoldReusableOperationBindingsObjects(JsonElement instance)
            {
                return AnObjectToHoldReusableOperationBindingsObjects.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableOperationBindingsObjects From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableOperationBindingsObjects ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableOperationBindingsObjects>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableOperationBindingsObjects ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableOperationBindingsObjects>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableOperationBindingsObjects ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableOperationBindingsObjects>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static AnObjectToHoldReusableOperationBindingsObjects ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableOperationBindingsObjects>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AnObjectToHoldReusableOperationBindingsObjects? result)
            {
                return JsonElementHelpers.TryParseValue<AnObjectToHoldReusableOperationBindingsObjects>(ref reader, out result);
            }
...
#if NET
            static AnObjectToHoldReusableOperationBindingsObjects IJsonElement<AnObjectToHoldReusableOperationBindingsObjects>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AnObjectToHoldReusableOperationBindingsObjects: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableOperationBindingsObjects Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableOperationBindingsObjects Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AnObjectToHoldReusableOperationBindingsObjects>(_idx);
                }
