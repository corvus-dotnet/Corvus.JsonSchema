...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct AnObjectToHoldReusableOperationReplyAddressObjects
            : IJsonElement<AnObjectToHoldReusableOperationReplyAddressObjects>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1components.json/properties/replyAddresses"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1components.json/properties/replyAddresses";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1components.json/properties/replyAddresses"u8;
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                            {
                                ...
                                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationReplyAddressObjects.WDEntity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
