    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct AnObjectToHoldReusableOperationReplyObjects
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AnObjectToHoldReusableOperationReplyObjects instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AnObjectToHoldReusableOperationReplyObjects"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnObjectToHoldReusableOperationReplyObjects(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AnObjectToHoldReusableOperationReplyObjects(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnObjectToHoldReusableOperationReplyObjects.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AnObjectToHoldReusableOperationReplyObjects"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AnObjectToHoldReusableOperationReplyObjects"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AnObjectToHoldReusableOperationReplyObjects Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AnObjectToHoldReusableOperationReplyObjects>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AnObjectToHoldReusableOperationReplyObjects"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AnObjectToHoldReusableOperationReplyObjects Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AnObjectToHoldReusableOperationReplyObjects>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationReplyObjects.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AnObjectToHoldReusableOperationReplyObjects instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationReplyObjects.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AnObjectToHoldReusableOperationReplyObjects, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AnObjectToHoldReusableOperationReplyObjects> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AnObjectToHoldReusableOperationReplyObjects>();
                }
                finally
                {
