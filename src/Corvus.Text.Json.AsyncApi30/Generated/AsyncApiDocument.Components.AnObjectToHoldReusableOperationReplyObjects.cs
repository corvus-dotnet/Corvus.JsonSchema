...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AnObjectToHoldReusableOperationReplyObjects"/> struct.
            /// </summary>
            ...
            internal AnObjectToHoldReusableOperationReplyObjects(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AnObjectToHoldReusableOperationReplyObjects DefaultInstance { get; }
            ...
            /// <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationReplyObjects.WDEntity"/>.
            /// </summary>
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternWdEntity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationReplyObjects.WDEntity result)
            {
                if (MatchesPatternWdEntity(propertyName))
                {
                    result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationReplyObjects.WDEntity.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternWdEntity(ReadOnlySpan<byte> name, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationReplyObjects.WDEntity value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationReplyObjects.WDEntity typedValue = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableOperationReplyObjects.WDEntity.From(property.Value);
            ...
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableOperationReplyObjects left, in AnObjectToHoldReusableOperationReplyObjects right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableOperationReplyObjects left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AnObjectToHoldReusableOperationReplyObjects instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AnObjectToHoldReusableOperationReplyObjects(JsonElement instance)
            {
                return AnObjectToHoldReusableOperationReplyObjects.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableOperationReplyObjects From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableOperationReplyObjects ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableOperationReplyObjects>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableOperationReplyObjects ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableOperationReplyObjects>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableOperationReplyObjects ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableOperationReplyObjects>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static AnObjectToHoldReusableOperationReplyObjects ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableOperationReplyObjects>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AnObjectToHoldReusableOperationReplyObjects? result)
            {
                return JsonElementHelpers.TryParseValue<AnObjectToHoldReusableOperationReplyObjects>(ref reader, out result);
            }
...
#if NET
            static AnObjectToHoldReusableOperationReplyObjects IJsonElement<AnObjectToHoldReusableOperationReplyObjects>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AnObjectToHoldReusableOperationReplyObjects: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableOperationReplyObjects Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableOperationReplyObjects Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AnObjectToHoldReusableOperationReplyObjects>(_idx);
                }
