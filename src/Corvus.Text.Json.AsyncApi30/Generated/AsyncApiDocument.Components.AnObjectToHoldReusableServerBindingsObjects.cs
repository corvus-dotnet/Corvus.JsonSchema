...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AnObjectToHoldReusableServerBindingsObjects"/> struct.
            /// </summary>
            ...
            internal AnObjectToHoldReusableServerBindingsObjects(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AnObjectToHoldReusableServerBindingsObjects DefaultInstance { get; }
            ...
            /// <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerBindingsObjects.WDEntity"/>.
            /// </summary>
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternWdEntity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerBindingsObjects.WDEntity result)
            {
                if (MatchesPatternWdEntity(propertyName))
                {
                    result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerBindingsObjects.WDEntity.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternWdEntity(ReadOnlySpan<byte> name, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerBindingsObjects.WDEntity value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerBindingsObjects.WDEntity typedValue = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerBindingsObjects.WDEntity.From(property.Value);
            ...
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableServerBindingsObjects left, in AnObjectToHoldReusableServerBindingsObjects right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableServerBindingsObjects left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AnObjectToHoldReusableServerBindingsObjects instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AnObjectToHoldReusableServerBindingsObjects(JsonElement instance)
            {
                return AnObjectToHoldReusableServerBindingsObjects.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableServerBindingsObjects From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableServerBindingsObjects ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableServerBindingsObjects>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableServerBindingsObjects ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableServerBindingsObjects>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableServerBindingsObjects ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableServerBindingsObjects>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static AnObjectToHoldReusableServerBindingsObjects ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableServerBindingsObjects>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AnObjectToHoldReusableServerBindingsObjects? result)
            {
                return JsonElementHelpers.TryParseValue<AnObjectToHoldReusableServerBindingsObjects>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AnObjectToHoldReusableServerBindingsObjects(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AnObjectToHoldReusableServerBindingsObjects IJsonElement<AnObjectToHoldReusableServerBindingsObjects>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AnObjectToHoldReusableServerBindingsObjects: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AnObjectToHoldReusableServerBindingsObjects"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AnObjectToHoldReusableServerBindingsObjects"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableServerBindingsObjects Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AnObjectToHoldReusableServerBindingsObjects>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AnObjectToHoldReusableServerBindingsObjects"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableServerBindingsObjects Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AnObjectToHoldReusableServerBindingsObjects>(_idx);
                }
