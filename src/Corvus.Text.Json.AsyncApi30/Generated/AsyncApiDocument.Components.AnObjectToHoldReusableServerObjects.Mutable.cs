    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct AnObjectToHoldReusableServerObjects
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AnObjectToHoldReusableServerObjects instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AnObjectToHoldReusableServerObjects"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnObjectToHoldReusableServerObjects(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnObjectToHoldReusableServerObjects.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AnObjectToHoldReusableServerObjects Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AnObjectToHoldReusableServerObjects Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AnObjectToHoldReusableServerObjects>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerObjects.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AnObjectToHoldReusableServerObjects instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerObjects.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AnObjectToHoldReusableServerObjects, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AnObjectToHoldReusableServerObjects> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AnObjectToHoldReusableServerObjects>();
                }
                finally
                {
