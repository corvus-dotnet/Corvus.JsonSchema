...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct AnObjectToHoldReusableServerObjects
#if NET8_0_OR_GREATER
            : IJsonElement<AnObjectToHoldReusableServerObjects>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AnObjectToHoldReusableServerObjects"/> struct.
            /// </summary>
            ...
            internal AnObjectToHoldReusableServerObjects(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AnObjectToHoldReusableServerObjects DefaultInstance { get; }
            ...
            /// <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerObjects.WDEntity"/>.
            /// </summary>
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternWdEntity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerObjects.WDEntity result)
            {
                if (MatchesPatternWdEntity(propertyName))
                {
                    result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerObjects.WDEntity.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternWdEntity(ReadOnlySpan<byte> name, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerObjects.WDEntity value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerObjects.WDEntity typedValue = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerObjects.WDEntity.From(property.Value);
            ...
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableServerObjects left, in AnObjectToHoldReusableServerObjects right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AnObjectToHoldReusableServerObjects left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AnObjectToHoldReusableServerObjects instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AnObjectToHoldReusableServerObjects(JsonElement instance)
            {
                return AnObjectToHoldReusableServerObjects.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableServerObjects From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableServerObjects ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableServerObjects>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableServerObjects ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableServerObjects>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnObjectToHoldReusableServerObjects ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableServerObjects>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static AnObjectToHoldReusableServerObjects ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<AnObjectToHoldReusableServerObjects>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AnObjectToHoldReusableServerObjects? result)
            {
                return JsonElementHelpers.TryParseValue<AnObjectToHoldReusableServerObjects>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AnObjectToHoldReusableServerObjects(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AnObjectToHoldReusableServerObjects IJsonElement<AnObjectToHoldReusableServerObjects>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AnObjectToHoldReusableServerObjects: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AnObjectToHoldReusableServerObjects"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AnObjectToHoldReusableServerObjects"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableServerObjects Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AnObjectToHoldReusableServerObjects>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AnObjectToHoldReusableServerObjects"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AnObjectToHoldReusableServerObjects Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AnObjectToHoldReusableServerObjects>(_idx);
                }
