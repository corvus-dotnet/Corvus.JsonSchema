    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct AnObjectToHoldReusableServerVariableObjects
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AnObjectToHoldReusableServerVariableObjects instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AnObjectToHoldReusableServerVariableObjects"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnObjectToHoldReusableServerVariableObjects(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnObjectToHoldReusableServerVariableObjects.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AnObjectToHoldReusableServerVariableObjects Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AnObjectToHoldReusableServerVariableObjects Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AnObjectToHoldReusableServerVariableObjects>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerVariableObjects.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AnObjectToHoldReusableServerVariableObjects instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Components.AnObjectToHoldReusableServerVariableObjects.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AnObjectToHoldReusableServerVariableObjects, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AnObjectToHoldReusableServerVariableObjects> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AnObjectToHoldReusableServerVariableObjects>();
                }
                finally
                {
