...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
...
#endif
        {
            ...
            /// </summary>
            public static OperationsEntity DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in OperationsEntity left, in OperationsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OperationsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            {
                return OperationsEntity.From(instance);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OperationsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<OperationsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OperationsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OperationsEntity IJsonElement<OperationsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OperationsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OperationsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OperationsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OperationsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OperationsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OperationsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OperationsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OperationsEntity>(_idx);
                }
