...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Components
    {
...
#endif
        {
            ...
            /// <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AnySchema"/>.
            /// </summary>
            ...
            public static bool MatchesPatternAnySchema(ReadOnlySpan<byte> propertyName)
            {
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternAnySchema(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AnySchema result)
            {
                if (MatchesPatternAnySchema(propertyName))
                {
                    result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AnySchema.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternAnySchema(ReadOnlySpan<byte> name, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AnySchema value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AnySchema typedValue = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AnySchema.From(property.Value);
                        if (!visitor.VisitPatternAnySchema(propertyName, in typedValue, ref state))
                        {
                            return false;
                        }
