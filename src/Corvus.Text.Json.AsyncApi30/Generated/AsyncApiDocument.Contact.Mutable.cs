...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Contact
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Contact instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Contact"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Contact(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonEmail.Mutable Email
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.Text.Json.AsyncApi30.JsonEmail.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Contact(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetEmail(scoped in Corvus.Text.Json.AsyncApi30.JsonEmail.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Contact.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi30.JsonEmail.Source _createArg1;
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Contact.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi30.JsonEmail.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2, scoped in Corvus.Text.Json.AsyncApi30.JsonUri.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(Contact instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Contact.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Text.Json.AsyncApi30.JsonEmail.Source email = default,
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.JsonEmail.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2, scoped in Corvus.Text.Json.AsyncApi30.JsonUri.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.JsonEmail.Source email = default, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source name = default, scoped in Corvus.Text.Json.AsyncApi30.JsonUri.Source url = default)
        {
            return new Source(email, name, url);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.JsonEmail.Source email = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source name = default, in Corvus.Text.Json.AsyncApi30.JsonUri.Source url = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(email, name, url);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Contact, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Contact> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Contact>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Contact> Create<TContext>(
        ...
        public static ParsedJsonDocument<Contact> Create(in Corvus.Text.Json.AsyncApi30.JsonEmail.Source email = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source name = default, in Corvus.Text.Json.AsyncApi30.JsonUri.Source url = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
