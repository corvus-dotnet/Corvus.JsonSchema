...
public readonly partial struct AsyncApiDocument
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.CorrelationId.LocationEntity Location
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LocationUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.CorrelationId.LocationEntity value))
                {
                    return value;
                }
