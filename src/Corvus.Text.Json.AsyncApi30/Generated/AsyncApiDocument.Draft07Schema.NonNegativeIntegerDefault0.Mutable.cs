    ...
    public readonly partial struct Draft07Schema
    {
        ...
        public readonly partial struct NonNegativeIntegerDefault0
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.NonNegativeInteger" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsNonNegativeInteger(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.NonNegativeInteger result)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.NonNegativeInteger.JsonSchema.Evaluate(_parent, _idx))
                    {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.NonNegativeIntegerDefault0.DefaultValueType0" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsDefaultValueType0(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.NonNegativeIntegerDefault0.DefaultValueType0 result)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.NonNegativeIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
                    {
