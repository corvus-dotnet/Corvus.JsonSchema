    ...
    public readonly partial struct Draft07Schema
    {
            ...
            : IJsonElement<PatternPropertiesEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1json-schema.org~1draft-07~1schema/properties/patternProperties"u8, buffer, out written);
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            using (var fixedJsonString = FixedStringJsonDocument<Corvus.Text.Json.AsyncApi30.JsonRegex>.Parse(parentDocument.GetPropertyNameRaw(objectValidation_currentIndex, true), parentDocument.ValueIsEscaped(objectValidation_currentIndex, true)))
                            {
                                JsonSchemaContext childContext =
                                    Corvus.Text.Json.AsyncApi30.JsonRegex.JsonSchema.PushChildContext(
                                        fixedJsonString,
                                        0,
                                        ref context,
                                        schemaEvaluationPath: PropertyNamesSchemaEvaluationPath);

                                Corvus.Text.Json.AsyncApi30.JsonRegex.JsonSchema.Evaluate(fixedJsonString, 0, ref childContext);
                            ...
                            {
                                JsonSchemaContext childContext1 = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                ...
                                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext1);
