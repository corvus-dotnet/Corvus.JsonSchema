    ...
    public readonly partial struct Draft07Schema
    {
        ...
        public readonly partial struct SchemaArray
        {
...
#endif
            {
                ...
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema oldItem, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.SchemaArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.SchemaArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source value)
                {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public static ParsedJsonDocument<SchemaArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SchemaArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<SchemaArray> Create<TContext>(
