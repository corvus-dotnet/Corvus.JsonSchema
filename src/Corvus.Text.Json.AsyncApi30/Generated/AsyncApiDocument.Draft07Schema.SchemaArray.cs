...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Draft07Schema
    {
...
#endif
        {
            ...
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema>(_parent, _idx);
            }
