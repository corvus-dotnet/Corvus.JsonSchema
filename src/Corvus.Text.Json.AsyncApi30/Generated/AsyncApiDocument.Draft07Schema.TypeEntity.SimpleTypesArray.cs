    ...
    public readonly partial struct Draft07Schema
    {
        ...
        public readonly partial struct TypeEntity
        {
...
#endif
            {
                ...
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.SimpleTypes this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.SimpleTypes>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.SimpleTypes> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.SimpleTypes>(_parent, _idx);
                }
