    ...
    public readonly partial struct Draft07Schema
    {
        ...
        public readonly partial struct WriteOnlyEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WriteOnlyEntity, Mutable>(WriteOnlyEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(WriteOnlyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WriteOnlyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WriteOnlyEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WriteOnlyEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WriteOnlyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WriteOnlyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WriteOnlyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WriteOnlyEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WriteOnlyEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WriteOnlyEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WriteOnlyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WriteOnlyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WriteOnlyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WriteOnlyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WriteOnlyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WriteOnlyEntity>();
                }
                finally
                {
