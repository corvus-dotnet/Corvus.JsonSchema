...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Http020Message
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Http020Message instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Http020Message"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Http020Message(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Http020Message.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Http020Message Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Http020Message Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Http020Message>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Http020Message.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(Http020Message instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Http020Message.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Http020Message"/>.
            /// </summary>
        ...
        {
            return workspace.CreateBuilder<Http020Message, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Http020Message> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Http020Message>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Http020Message> Create<TContext>(
        ...
        public static ParsedJsonDocument<Http020Message> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Http020Message.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source headers = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Http020Message> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Http020Message.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source<TContext> headers = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
