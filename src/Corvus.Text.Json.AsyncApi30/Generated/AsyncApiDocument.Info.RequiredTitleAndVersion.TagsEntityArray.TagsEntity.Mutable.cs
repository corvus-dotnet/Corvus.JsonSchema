...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Info
    {
        ...
        public readonly partial struct RequiredTitleAndVersion
        {
            ...
            /// </para>
            /// </remarks>
            public readonly partial struct TagsEntityArray
            {
                /// <summary>
                /// Generated from JSON Schema.
                /// </summary>
                [DebuggerDisplay("{DebuggerDisplay,nq}")]
                public readonly partial struct TagsEntity
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Conversion to <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag"/>.
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static explicit operator Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Mutable(Mutable value)
                        {
                            return Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Mutable.From(value);
                        }

                        /// <summary>
                        /// Conversion from <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag"/>.
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator Mutable(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Mutable value)
                        {
                            return From(value);
                        }
                        ...
                        public static explicit operator Mutable(TagsEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TagsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TagsEntity(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new TagsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        /// This will add or update any property values provided by the <paramref name="value"/>.
                        /// </remarks>
                        public void Apply(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag value)
                        {
                            CheckValidInstance();
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TagsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="TagsEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="TagsEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TagsEntity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<TagsEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="TagsEntity"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TagsEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TagsEntity>(_idx);
                        }
                        ...
                        /// <param name="matchTag">Match a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag"/>.</param>
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag, TContext, TResult> matchTag,
                            Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Info.RequiredTitleAndVersion.TagsEntityArray.TagsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                        {
                            ...
                            if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.JsonSchema.Evaluate(_parent, _idx))
                            {
                                return matchTag(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Mutable.From(this), context);
                            }
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag, TResult> matchTag,
                            Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Info.RequiredTitleAndVersion.TagsEntityArray.TagsEntity.Mutable, TResult> defaultMatch)
                        {
                            if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Reference.JsonSchema.Evaluate(_parent, _idx))
                            {
                            ...
                            if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.JsonSchema.Evaluate(_parent, _idx))
                            {
                                return matchTag(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Mutable.From(this));
                            }
                        ...
                        /// <summary>
                        /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Mutable" />.
                        /// </summary>
                        /// <param name="result">The result of the conversions.</param>
                        /// <returns><see langword="true" /> if the conversion was valid.</returns>
                        public bool TryGetAsTag(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Mutable result)
                        {
                            if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.JsonSchema.Evaluate(_parent, _idx))
                            {
                                result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Mutable.From(this);
                                return true;
                            }
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build? _tagBuilderInstance;
                        private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Source _tagSourceInstance;
                        ...
                        public Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build value) {_tagBuilderInstance = value; _kind = Kind.TagBuilder; }

                        public Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Source value) { _tagSourceInstance = value; _kind = Kind.TagSource; }

                        public static implicit operator Source(TagsEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag instance) => new(JsonElement.From(instance));

                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Source value) => new(value);
                        ...
                        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                        {
                            switch(_kind)
                            {
                                ...
                                case Kind.ReferenceSource:
                                    ...
                                    break;
                                case Kind.TagBuilder:
                                    valueBuilder.AddProperty(utf8Name, _tagBuilderInstance!, static (in b, ref o) => Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                                    break;
                                case Kind.TagSource:
                                    _tagSourceInstance.AddAsProperty(utf8Name, ref valueBuilder, escapeName, nameRequiresUnescaping);
                                    break;
                                default:
                        ...
                        internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
                        {
                            switch(_kind)
                            {
                                ...
                                case Kind.ReferenceSource:
                                    ...
                                    break;
                                case Kind.TagBuilder:
                                    valueBuilder.AddPrebakedProperty(prebakedPropertyName, _tagBuilderInstance!, static (in b, ref o) => Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.BuildValue(b, ref o));
                                    break;
                                case Kind.TagSource:
                                    _tagSourceInstance.AddAsPrebakedProperty(prebakedPropertyName, ref valueBuilder);
                                    break;
                                default:
                                    Debug.Fail("Unexpected Kind");
                                    break;
                        ...
                        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                        {
                            switch(_kind)
                            {
                                ...
                                case Kind.ReferenceSource:
                                    ...
                                    break;
                                case Kind.TagBuilder:
                                    valueBuilder.AddProperty(name, _tagBuilderInstance!, static (in b, ref o) => Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.BuildValue(b, ref o));
                                    break;
                                case Kind.TagSource:
                                    _tagSourceInstance.AddAsProperty(name, ref valueBuilder);
                                    break;
                                default:
                                    Debug.Fail("Unexpected Kind");
                                    break;
                        ...
                        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                        {
                            switch(_kind)
                            {
                                ...
                                case Kind.ReferenceSource:
                                    ...
                                    break;
                                case Kind.TagBuilder:
                                    valueBuilder.AddItem(_tagBuilderInstance!, static (in b, ref o) => Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.BuildValue(b, ref o));
                                    break;
                                case Kind.TagSource:
                                    _tagSourceInstance.AddAsItem(ref valueBuilder);
                                    break;
                                default:
                                    Debug.Fail("Unexpected Kind");
                                    break;
                        ...
                        #endif
                    {
                        ...
                        private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build<TContext>? _tagBuilderInstance;
                        ...
                        public Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build<TContext> value) {_context = context; _tagBuilderInstance = value; _kind = Kind.TagBuilder; }
                        ...
                        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                        {
                            switch(_kind)
                            {
                                ...
                                case Kind.ReferenceBuilder:
                                    ...
                                    break;
                                case Kind.TagBuilder:
                                    valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _tagBuilderInstance!), static (in b, ref o) => Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                                    break;
                                default:
                                    Debug.Fail("Unexpected Kind");
                                    break;
                        ...
                        internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
                        {
                            switch(_kind)
                            {
                                ...
                                case Kind.ReferenceBuilder:
                                    ...
                                    break;
                                case Kind.TagBuilder:
                                    valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _tagBuilderInstance!), static (in b, ref o) => Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.BuildValue(b.Context, b.Build, ref o));
                                    break;
                                default:
                                    Debug.Fail("Unexpected Kind");
                                    break;
                        ...
                        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                        {
                            switch(_kind)
                            {
                                ...
                                case Kind.ReferenceBuilder:
                                    ...
                                    break;
                                case Kind.TagBuilder:
                                    valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _tagBuilderInstance!), static (in b, ref o) => Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.BuildValue(b.Context, b.Build, ref o));
                                    break;
                                default:
                                    Debug.Fail("Unexpected Kind");
                                    break;
                        ...
                        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                        {
                            switch(_kind)
                            {
                                ...
                                case Kind.ReferenceBuilder:
                                    ...
                                    break;
                                case Kind.TagBuilder:
                                    valueBuilder.AddItem(BuildWithContext.Create(_context, _tagBuilderInstance!), static (in b, ref o) => Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.BuildValue(b.Context, b.Build, ref o));
                                    break;
                                default:
                                    Debug.Fail("Unexpected Kind");
                                    break;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Source Build(
                        scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build buildValue, int initialCapacity = 1)
                    {
                        return new Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Source(buildValue);
                    }
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Source<TContext> Build<TContext>(
                        scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        return new Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Source<TContext>(context, buildValue);
                    }
                    ...
                    /// <returns>An instance of a mutable document initialized with the given value.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(
                        JsonWorkspace workspace, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                    {
                        // Create the document builder without a MetadataDb
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        var source = new Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Source(value);
                        source.AddAsItem(ref cvb);
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <returns>An instance of a mutable document initialized with the given value.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                        JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        var source = new Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Source<TContext>(context, value);
                        source.AddAsItem(ref cvb);
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<TagsEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<TagsEntity> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<TagsEntity>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<TagsEntity> Create<TContext>(
                    ...
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<TagsEntity> Create(
                        scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                        try
                        {
                    ...
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<TagsEntity> Create<TContext>(
                        scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Tag.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
