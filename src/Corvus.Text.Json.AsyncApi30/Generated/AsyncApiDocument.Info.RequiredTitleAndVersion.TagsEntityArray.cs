    ...
    public readonly partial struct Info
    {
        ...
        public readonly partial struct RequiredTitleAndVersion
        {
...
#endif
            {
                ...
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Info.RequiredTitleAndVersion.TagsEntityArray.TagsEntity this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Info.RequiredTitleAndVersion.TagsEntityArray.TagsEntity>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Info.RequiredTitleAndVersion.TagsEntityArray.TagsEntity> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Info.RequiredTitleAndVersion.TagsEntityArray.TagsEntity>(_parent, _idx);
                }
