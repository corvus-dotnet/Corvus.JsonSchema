...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct InfoExtensions
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(InfoExtensions instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="InfoExtensions"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator InfoExtensions(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new InfoExtensions(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"InfoExtensions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="InfoExtensions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="InfoExtensions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly InfoExtensions Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<InfoExtensions>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="InfoExtensions"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly InfoExtensions Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<InfoExtensions>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Schema.Source _createArg1;
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.InfoExtensions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Schema.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(InfoExtensions instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.InfoExtensions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="InfoExtensions"/>.
            /// </summary>
            ...
            /// Creates an instance of a <see cref="InfoExtensions"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Schema.Source xLinkedin = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source xX = default)
            {
                Create(ref _builder, xLinkedin, xX);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Schema.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Schema.Source xLinkedin = default, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source xX = default)
        {
            return new Source(xLinkedin, xX);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Schema.Source xLinkedin = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source xX = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(xLinkedin, xX);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<InfoExtensions, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<InfoExtensions> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<InfoExtensions>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<InfoExtensions> Create<TContext>(
        ...
        public static ParsedJsonDocument<InfoExtensions> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Schema.Source xLinkedin = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source xX = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
