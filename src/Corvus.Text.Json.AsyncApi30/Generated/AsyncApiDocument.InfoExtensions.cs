...
public readonly partial struct AsyncApiDocument
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InfoExtensions"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal InfoExtensions(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static InfoExtensions DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in InfoExtensions left, in InfoExtensions right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in InfoExtensions left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(InfoExtensions instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator InfoExtensions(JsonElement instance)
        {
            return InfoExtensions.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InfoExtensions From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InfoExtensions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InfoExtensions>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InfoExtensions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InfoExtensions>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InfoExtensions ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InfoExtensions>(json, options);
        }
        ...
        /// </exception>
        public static InfoExtensions ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<InfoExtensions>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out InfoExtensions? result)
        {
            return JsonElementHelpers.TryParseValue<InfoExtensions>(ref reader, out result);
        }
...
#if NET
        static InfoExtensions IJsonElement<InfoExtensions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"InfoExtensions: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public InfoExtensions Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<InfoExtensions>(_idx);
            }
