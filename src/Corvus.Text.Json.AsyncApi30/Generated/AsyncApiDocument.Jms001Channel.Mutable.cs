...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Jms001Channel
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Jms001Channel instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Jms001Channel"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Jms001Channel(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Jms001Channel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Jms001Channel Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Jms001Channel Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Jms001Channel>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Jms001Channel.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(Jms001Channel instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Jms001Channel.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Jms001Channel"/>.
            /// </summary>
        ...
        {
            return workspace.CreateBuilder<Jms001Channel, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Jms001Channel> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Jms001Channel>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Jms001Channel> Create<TContext>(
        ...
        public static ParsedJsonDocument<Jms001Channel> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Jms001Channel.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source destination = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Jms001Channel.DestinationTypeEntity.Source destinationType = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
