...
public readonly partial struct AsyncApiDocument
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct Kafka030Channel
    {
        /// <summary>
        ...
        public readonly partial struct NumberOfPartitionsConfiguredOnThisTopic
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NumberOfPartitionsConfiguredOnThisTopic instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NumberOfPartitionsConfiguredOnThisTopic"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NumberOfPartitionsConfiguredOnThisTopic(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NumberOfPartitionsConfiguredOnThisTopic(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NumberOfPartitionsConfiguredOnThisTopic.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NumberOfPartitionsConfiguredOnThisTopic"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NumberOfPartitionsConfiguredOnThisTopic"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly NumberOfPartitionsConfiguredOnThisTopic Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NumberOfPartitionsConfiguredOnThisTopic>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NumberOfPartitionsConfiguredOnThisTopic"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly NumberOfPartitionsConfiguredOnThisTopic Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NumberOfPartitionsConfiguredOnThisTopic>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NumberOfPartitionsConfiguredOnThisTopic instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NumberOfPartitionsConfiguredOnThisTopic, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NumberOfPartitionsConfiguredOnThisTopic> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NumberOfPartitionsConfiguredOnThisTopic>();
                }
                finally
                {
