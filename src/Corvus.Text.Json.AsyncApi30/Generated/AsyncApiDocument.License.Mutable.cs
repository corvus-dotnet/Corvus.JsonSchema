...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct License
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonUri.Mutable Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.Text.Json.AsyncApi30.JsonUri.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUrl(scoped in Corvus.Text.Json.AsyncApi30.JsonUri.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi30.JsonUri.Source _createArg2;
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.License.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonUri.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.License.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Text.Json.AsyncApi30.JsonUri.Source url = default)
            {
            ...
            /// Creates an instance of a <see cref="License"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.AsyncApi30.JsonString.Source name, in Corvus.Text.Json.AsyncApi30.JsonUri.Source url = default)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonUri.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source name, scoped in Corvus.Text.Json.AsyncApi30.JsonUri.Source url = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.JsonString.Source name, in Corvus.Text.Json.AsyncApi30.JsonUri.Source url = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<License> Create(in Corvus.Text.Json.AsyncApi30.JsonString.Source name, in Corvus.Text.Json.AsyncApi30.JsonUri.Source url = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
