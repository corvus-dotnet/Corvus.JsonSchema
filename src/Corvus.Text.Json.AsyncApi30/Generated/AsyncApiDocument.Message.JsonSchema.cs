...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Message>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchMessageType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1amqp~10.3.0~1message.json"u8, buffer, out written);
