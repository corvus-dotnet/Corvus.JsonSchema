        ...
        public readonly partial struct AmqpEntity
        {
            ...
            public readonly partial struct AllOf1Entity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.AmqpEntity.AllOf1Entity.RequiredBindingVersion" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredBindingVersion(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.AmqpEntity.AllOf1Entity.RequiredBindingVersion result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.AmqpEntity.AllOf1Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                        {
