    ...
    public readonly partial struct MessageBindingsObject
    {
        ...
        public readonly partial struct AnypointmqEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.AnypointmqEntity.AllOf1Entity.RequiredBindingVersion" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredBindingVersion(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.AnypointmqEntity.AllOf1Entity.RequiredBindingVersion result)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.AnypointmqEntity.AllOf1Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.AnypointmqEntity.AllOf1Entity.RequiredBindingVersion.From(this);
                        return true;
                    }
