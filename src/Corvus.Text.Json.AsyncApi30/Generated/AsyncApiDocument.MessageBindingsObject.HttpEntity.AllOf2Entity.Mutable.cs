        ...
        public readonly partial struct HttpEntity
        {
            ...
            public readonly partial struct AllOf2Entity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.HttpEntity.AllOf2Entity.RequiredBindingVersion.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredBindingVersion(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.HttpEntity.AllOf2Entity.RequiredBindingVersion.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.HttpEntity.AllOf2Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.HttpEntity.AllOf2Entity.RequiredBindingVersion.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.HttpEntity.AllOf2Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.HttpEntity.AllOf2Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static ParsedJsonDocument<AllOf2Entity> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Message.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source headers = default, in Corvus.Text.Json.AsyncApi30.JsonNumber.Source statusCode = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AllOf2Entity> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Message.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source<TContext> headers = default, in Corvus.Text.Json.AsyncApi30.JsonNumber.Source statusCode = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
