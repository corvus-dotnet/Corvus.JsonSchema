        ...
        public readonly partial struct IbmmqEntity
        {
            ...
            public readonly partial struct IfNoBindingVersionSpecifiedUseTheLatestBinding
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.IbmmqEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsIfEntity(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.IbmmqEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.IbmmqEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
