        ...
        public readonly partial struct KafkaEntity
        {
                ...
                : IJsonElement<IfNoBindingVersionSpecifiedUseTheLatestBinding>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1messageBindingsObject.json/properties/kafka/allOf/0"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                    /// </summary>
                    public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1messageBindingsObject.json/properties/kafka/allOf/0";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1messageBindingsObject.json/properties/kafka/allOf/0"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        JsonSchemaContext ifContext =
                            Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.KafkaEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageBindingsObject.KafkaEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                        ...
                        if (ifContext.IsMatch)
                        {
                            ...
                            JsonSchemaContext thenContext =
                                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type050Message.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ThenSchemaEvaluationPath);
                            Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type050Message.JsonSchema.Evaluate(parentDocument, parentIndex, ref thenContext);
