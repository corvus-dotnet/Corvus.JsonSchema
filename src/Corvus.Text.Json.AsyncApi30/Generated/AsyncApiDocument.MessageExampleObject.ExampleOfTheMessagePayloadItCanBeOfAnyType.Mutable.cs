    ...
    public readonly partial struct MessageExampleObject
    {
        ...
        public readonly partial struct ExampleOfTheMessagePayloadItCanBeOfAnyType
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExampleOfTheMessagePayloadItCanBeOfAnyType instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExampleOfTheMessagePayloadItCanBeOfAnyType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExampleOfTheMessagePayloadItCanBeOfAnyType(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExampleOfTheMessagePayloadItCanBeOfAnyType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly ExampleOfTheMessagePayloadItCanBeOfAnyType Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExampleOfTheMessagePayloadItCanBeOfAnyType Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExampleOfTheMessagePayloadItCanBeOfAnyType>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageExampleObject.ExampleOfTheMessagePayloadItCanBeOfAnyType.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageExampleObject.ExampleOfTheMessagePayloadItCanBeOfAnyType.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                public static implicit operator Source(ExampleOfTheMessagePayloadItCanBeOfAnyType instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageExampleObject.ExampleOfTheMessagePayloadItCanBeOfAnyType.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageExampleObject.ExampleOfTheMessagePayloadItCanBeOfAnyType.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
            ...
            {
                return workspace.CreateBuilder<ExampleOfTheMessagePayloadItCanBeOfAnyType, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExampleOfTheMessagePayloadItCanBeOfAnyType> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExampleOfTheMessagePayloadItCanBeOfAnyType>();
                }
                finally
                {
            ...
            public static ParsedJsonDocument<ExampleOfTheMessagePayloadItCanBeOfAnyType> CreateArray(
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>An empty <see cref="ParsedJsonDocument{T}"/>. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ExampleOfTheMessagePayloadItCanBeOfAnyType> CreateObject(
                int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
