...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct MessageExampleObject
    {
        ...
        public readonly partial struct ExampleOfTheMessagePayloadItCanBeOfAnyType
#if NET8_0_OR_GREATER
            : IJsonElement<ExampleOfTheMessagePayloadItCanBeOfAnyType>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ExampleOfTheMessagePayloadItCanBeOfAnyType"/> struct.
            /// </summary>
            ...
            internal ExampleOfTheMessagePayloadItCanBeOfAnyType(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ExampleOfTheMessagePayloadItCanBeOfAnyType DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator sbyte(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out sbyte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator byte(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator short(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out short result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ushort(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out ushort result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator int(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator uint(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out uint result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ulong(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out ulong result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator float(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Int128(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out Int128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator UInt128(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out UInt128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Half(ExampleOfTheMessagePayloadItCanBeOfAnyType value) => value._parent.TryGetValue(value._idx, out Half result) ? result : throw new FormatException();
#endif

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator bool(ExampleOfTheMessagePayloadItCanBeOfAnyType value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ExampleOfTheMessagePayloadItCanBeOfAnyType left, in ExampleOfTheMessagePayloadItCanBeOfAnyType right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ExampleOfTheMessagePayloadItCanBeOfAnyType left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ExampleOfTheMessagePayloadItCanBeOfAnyType instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExampleOfTheMessagePayloadItCanBeOfAnyType(JsonElement instance)
            {
                return ExampleOfTheMessagePayloadItCanBeOfAnyType.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExampleOfTheMessagePayloadItCanBeOfAnyType From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExampleOfTheMessagePayloadItCanBeOfAnyType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ExampleOfTheMessagePayloadItCanBeOfAnyType>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExampleOfTheMessagePayloadItCanBeOfAnyType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ExampleOfTheMessagePayloadItCanBeOfAnyType>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExampleOfTheMessagePayloadItCanBeOfAnyType ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ExampleOfTheMessagePayloadItCanBeOfAnyType>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static ExampleOfTheMessagePayloadItCanBeOfAnyType ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ExampleOfTheMessagePayloadItCanBeOfAnyType>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ExampleOfTheMessagePayloadItCanBeOfAnyType? result)
            {
                return JsonElementHelpers.TryParseValue<ExampleOfTheMessagePayloadItCanBeOfAnyType>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ExampleOfTheMessagePayloadItCanBeOfAnyType(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ExampleOfTheMessagePayloadItCanBeOfAnyType IJsonElement<ExampleOfTheMessagePayloadItCanBeOfAnyType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExampleOfTheMessagePayloadItCanBeOfAnyType: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ExampleOfTheMessagePayloadItCanBeOfAnyType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ExampleOfTheMessagePayloadItCanBeOfAnyType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ExampleOfTheMessagePayloadItCanBeOfAnyType Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ExampleOfTheMessagePayloadItCanBeOfAnyType>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ExampleOfTheMessagePayloadItCanBeOfAnyType"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ExampleOfTheMessagePayloadItCanBeOfAnyType Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ExampleOfTheMessagePayloadItCanBeOfAnyType>(_idx);
                }
