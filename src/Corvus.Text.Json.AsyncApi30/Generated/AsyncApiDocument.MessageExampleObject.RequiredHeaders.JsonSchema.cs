    ...
    public readonly partial struct MessageExampleObject
    {
            ...
            : IJsonElement<RequiredHeaders>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1messageExampleObject.json/anyOf/1"u8, buffer, out written);
