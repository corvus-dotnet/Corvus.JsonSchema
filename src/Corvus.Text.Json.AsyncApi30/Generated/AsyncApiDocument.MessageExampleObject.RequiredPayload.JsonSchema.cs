    ...
    public readonly partial struct MessageExampleObject
    {
            ...
            : IJsonElement<RequiredPayload>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitForPayload = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForPayload;
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.PayloadUtf8))
                    {
                        matcher = MatchPayload;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1messageExampleObject.json/anyOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1messageExampleObject.json/anyOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1messageExampleObject.json/anyOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPayloadPresent, "payload"u8, "required"u8);
                        }
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyPayloadNotPresent, "payload"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPayloadPresent, "payload"u8, "required"u8);
