...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct MessageObject
    {
...
#endif
        {
            ...
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.TraitsEntityArray.TraitsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.TraitsEntityArray.TraitsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.TraitsEntityArray.TraitsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.TraitsEntityArray.TraitsEntity>(_parent, _idx);
            }
