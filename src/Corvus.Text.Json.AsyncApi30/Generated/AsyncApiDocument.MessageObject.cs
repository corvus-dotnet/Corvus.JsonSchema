...
public readonly partial struct AsyncApiDocument
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageObject"/> struct.
        /// </summary>
        ...
        internal MessageObject(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MessageObject DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.BindingsEntity Bindings
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BindingsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.BindingsEntity value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.CorrelationIdEntity CorrelationId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CorrelationIdUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.CorrelationIdEntity value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.DeprecatedEntity Deprecated
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeprecatedUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.DeprecatedEntity value))
                {
                    return value;
                }

                return Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.DeprecatedEntity.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.MessageExampleObjectArray Examples
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExamplesUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.MessageExampleObjectArray value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.ExternalDocsEntity ExternalDocs
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExternalDocsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.ExternalDocsEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AnySchema Payload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.AnySchema value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.TagsEntityArray Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.TagsEntityArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.TraitsEntityArray Traits
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TraitsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageObject.TraitsEntityArray value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in MessageObject left, in MessageObject right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MessageObject left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(MessageObject instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MessageObject(JsonElement instance)
        {
            return MessageObject.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MessageObject From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MessageObject ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<MessageObject>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MessageObject ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<MessageObject>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MessageObject ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<MessageObject>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static MessageObject ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<MessageObject>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MessageObject? result)
        {
            return JsonElementHelpers.TryParseValue<MessageObject>(ref reader, out result);
        }
...
#if NET
        static MessageObject IJsonElement<MessageObject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MessageObject: ValueKind = {ValueKind} : \"{ToString()}\"";
