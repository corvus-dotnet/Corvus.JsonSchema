    ...
    public readonly partial struct MessageTrait
    {
            ...
            : IJsonElement<MessageExampleObjectArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1messageTrait.json/properties/examples"u8, buffer, out written);
