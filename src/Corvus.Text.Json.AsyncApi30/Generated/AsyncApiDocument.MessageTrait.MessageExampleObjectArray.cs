...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct MessageTrait
    {
        ...
        public readonly partial struct MessageExampleObjectArray
#if NET8_0_OR_GREATER
            : IJsonElement<MessageExampleObjectArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MessageExampleObjectArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MessageExampleObjectArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MessageExampleObjectArray DefaultInstance { get; }
            ...
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageExampleObject this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageExampleObject>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageExampleObject> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MessageExampleObject>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in MessageExampleObjectArray left, in MessageExampleObjectArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MessageExampleObjectArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(MessageExampleObjectArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MessageExampleObjectArray(JsonElement instance)
            {
                return MessageExampleObjectArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MessageExampleObjectArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MessageExampleObjectArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MessageExampleObjectArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MessageExampleObjectArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MessageExampleObjectArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MessageExampleObjectArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MessageExampleObjectArray>(json, options);
            }
            ...
            /// </exception>
            public static MessageExampleObjectArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MessageExampleObjectArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MessageExampleObjectArray? result)
            {
                return JsonElementHelpers.TryParseValue<MessageExampleObjectArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MessageExampleObjectArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MessageExampleObjectArray IJsonElement<MessageExampleObjectArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MessageExampleObjectArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MessageExampleObjectArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MessageExampleObjectArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MessageExampleObjectArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MessageExampleObjectArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MessageExampleObjectArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MessageExampleObjectArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MessageExampleObjectArray>(_idx);
                }
