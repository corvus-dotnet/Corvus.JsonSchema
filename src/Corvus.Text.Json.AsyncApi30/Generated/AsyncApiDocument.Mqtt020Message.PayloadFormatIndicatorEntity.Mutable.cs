    ...
    public readonly partial struct Mqtt020Message
    {
        ...
        public readonly partial struct PayloadFormatIndicatorEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PayloadFormatIndicatorEntity, Mutable>(PayloadFormatIndicatorEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(PayloadFormatIndicatorEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PayloadFormatIndicatorEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PayloadFormatIndicatorEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PayloadFormatIndicatorEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PayloadFormatIndicatorEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PayloadFormatIndicatorEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PayloadFormatIndicatorEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PayloadFormatIndicatorEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PayloadFormatIndicatorEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PayloadFormatIndicatorEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PayloadFormatIndicatorEntity>();
                }
                finally
                {
