...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Mqtt020Operation>
    {
        public static partial class JsonSchema
        {
            ...
            private static readonly JsonSchemaPathProvider MessageExpiryIntervalSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/messageExpiryInterval"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider QosSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/qos"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider RetainSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/retain"u8, buffer, out written);
            ...
            private static void MatchBindingVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Mqtt020Operation.BindingVersionEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Mqtt020Operation.BindingVersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchMessageExpiryInterval(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Mqtt020Operation.LifetimeOfTheMessageInSeconds.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.MessageExpiryIntervalUtf8,
                        evaluationPath: MessageExpiryIntervalSchemaEvaluationPath);

                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Mqtt020Operation.LifetimeOfTheMessageInSeconds.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                context.CommitChildContext(childContext1.IsMatch, ref childContext1);
            }

            private static void MatchQos(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Mqtt020Operation.QosEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.QosUtf8,
                        evaluationPath: QosSchemaEvaluationPath);

                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Mqtt020Operation.QosEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                context.CommitChildContext(childContext2.IsMatch, ref childContext2);
            }

            private static void MatchRetain(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext3 =
                    Corvus.Text.Json.AsyncApi30.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.RetainUtf8,
                        evaluationPath: RetainSchemaEvaluationPath);
            ...
            private static PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator1>([
                    ...
                    (static () => JsonPropertyNames.MessageExpiryIntervalUtf8, MatchMessageExpiryInterval),
                    (static () => JsonPropertyNames.QosUtf8, MatchQos),
                    (static () => JsonPropertyNames.RetainUtf8, MatchRetain),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1mqtt~10.2.0~1operation.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1mqtt~10.2.0~1operation.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1mqtt~10.2.0~1operation.json"u8;
