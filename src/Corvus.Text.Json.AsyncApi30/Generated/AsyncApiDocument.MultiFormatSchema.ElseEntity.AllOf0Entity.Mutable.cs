        ...
        public readonly partial struct ElseEntity
        {
            ...
            public readonly partial struct AllOf0Entity
            {
...
#endif
                {
                    ...
                    /// <param name="matchCorvusTextJsonAsyncApi30AsyncApiDocumentMultiFormatSchemaElseEntityAllOf0EntityThenEntity">Match a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity"/>.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity, TContext, TResult> matchCorvusTextJsonAsyncApi30AsyncApiDocumentMultiFormatSchemaElseEntityAllOf0EntityThenEntity,
                        Matcher<AllOf0Entity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusTextJsonAsyncApi30AsyncApiDocumentMultiFormatSchemaElseEntityAllOf0EntityThenEntity(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity, TResult> matchCorvusTextJsonAsyncApi30AsyncApiDocumentMultiFormatSchemaElseEntityAllOf0EntityThenEntity,
                        Matcher<AllOf0Entity, TResult> defaultMatch)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusTextJsonAsyncApi30AsyncApiDocumentMultiFormatSchemaElseEntityAllOf0EntityThenEntity(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity.From(this));
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.IfEntity.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsIfEntity(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.IfEntity.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.IfEntity.Mutable.From(this);
                            return true;
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsThenEntity(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static ParsedJsonDocument<AllOf0Entity> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source schema = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AllOf0Entity> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source<TContext> schema = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
