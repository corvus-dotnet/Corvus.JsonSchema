            ...
            public readonly partial struct AllOf0Entity
            {
                ...
                public readonly partial struct ThenEntity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Mutable SchemaValue
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaValueUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetSchemaValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetSchemaValue<TContext>(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source<TContext> value)
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf0Entity.ThenEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public static ParsedJsonDocument<ThenEntity> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source schema = default, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<ThenEntity> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.Source<TContext> schema = default, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
