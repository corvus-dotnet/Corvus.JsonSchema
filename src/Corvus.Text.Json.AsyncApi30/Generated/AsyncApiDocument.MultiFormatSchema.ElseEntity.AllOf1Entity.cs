    ...
    public readonly partial struct MultiFormatSchema
    {
        ...
        public readonly partial struct ElseEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema Schema
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema value))
                        {
                            return value;
                        }
                ...
                public bool TryGetAsRequiredSchemaFormat(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf1Entity.RequiredSchemaFormat result)
                {
                    ...
                    {
                        result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf1Entity.RequiredSchemaFormat.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsThenEntity(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf1Entity.ThenEntity result)
                {
                    ...
                    {
                        result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf1Entity.ThenEntity.From(this);
                        return true;
                    }
