            ...
            public readonly partial struct AllOf2Entity
            {
                ...
                public readonly partial struct ThenEntity
                {
...
#endif
                    {
                        ...
                        /// </summary>
                        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Mutable Schema
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemaUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetSchema(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetSchema<TContext>(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> value)
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source _createArg1;
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf2Entity.ThenEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source arg1)
                        {
                            _createArg1 = arg1;
                            _kind = Kind.Create;
                        }
                        ...
                        #endif
                    {
                        ...
                        private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> _createArg1;
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf2Entity.ThenEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                        internal Source(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> arg1)
                        {
                            _context = context;
                            _createArg1 = arg1;
                            _kind = Kind.Create;
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// </summary>
                        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source schema = default)
                        {
                        ...
                        /// Creates an instance of a <see cref="ThenEntity"/>.
                        /// </summary>
                        public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source schema = default)
                        {
                        ...
                        internal static void Create<TContext>(
                            ...
                            in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> schema = default)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        {
                        ...
                        /// Creates an instance of a <see cref="ThenEntity"/>.
                        /// </summary>
                        public void Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> schema = default)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        {
                        ...
                        internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source arg1, ref ComplexValueBuilder o)
                        {
                            o.StartObject();
                            Create(ref o, arg1);
                            o.EndObject();
                        ...
                        /// <param name="arg1">The value of the property.</param>
                        /// <param name="o">The complex value builder into which to write the object.</param>
                        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                        {
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source schema = default)
                    {
                    ...
                    /// <param name="schema">The value of the <c>"schema"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> schema = default)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source schema = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> schema = default, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                    ...
                    public static ParsedJsonDocument<ThenEntity> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source schema = default, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<ThenEntity> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Draft07Schema.Source<TContext> schema = default, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
