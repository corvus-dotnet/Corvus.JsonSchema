        ...
        public readonly partial struct ElseEntity
        {
            ...
            public readonly partial struct AllOf3Entity
            {
                    ...
                    : IJsonElement<RequiredSchemaFormat>
                {
                    ...
                    {
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySchemaFormatPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("schemaFormat"u8, buffer, out written);
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySchemaFormatNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("schemaFormat"u8, buffer, out written);

                        private const int RequiredOffsetForSchemaFormat = 0;
                        private const uint RequiredBitForSchemaFormat = 0b00000000000000000000000000000001;

                        private const uint RequiredBitMask0 =
                            RequiredBitForSchemaFormat;
                        private static readonly JsonSchemaPathProvider SchemaFormatSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/schemaFormat"u8, buffer, out written);

                        private static void MatchSchemaFormat(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext =
                                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf3Entity.RequiredSchemaFormat.SchemaFormatEntity.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.SchemaFormatUtf8,
                                    evaluationPath: SchemaFormatSchemaEvaluationPath);

                            Corvus.Text.Json.AsyncApi30.AsyncApiDocument.MultiFormatSchema.ElseEntity.AllOf3Entity.RequiredSchemaFormat.SchemaFormatEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                            ...
                            requiredBitBuffer[RequiredOffsetForSchemaFormat] |= RequiredBitForSchemaFormat;
                        }
                        ...
                        {
                            if (span.SequenceEqual(JsonPropertyNames.SchemaFormatUtf8))
                            {
                                matcher = MatchSchemaFormat;
                                return true;
                            }
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1multiFormatSchema.json/else/allOf/3/if"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1multiFormatSchema.json/else/allOf/3/if";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1multiFormatSchema.json/else/allOf/3/if"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.StartObject)
                            {
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySchemaFormatPresent, "schemaFormat"u8, "required"u8);
                                }
                                ...
                                {
                                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSchemaFormat] & RequiredBitForSchemaFormat) == 0)
                                    {
                                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertySchemaFormatNotPresent, "schemaFormat"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySchemaFormatPresent, "schemaFormat"u8, "required"u8);
