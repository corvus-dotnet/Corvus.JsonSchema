                ...
                public readonly partial struct RequiredSchemaFormat
                {
                        ...
                        : IJsonElement<SchemaFormatEntity>
                    {
                        ...
                        private static class Constants
                        {
                            ...
                            /// </summary>
                            public static readonly byte[] Enum1 = "application/vnd.apache.avro;version=1.9.0"u8.ToArray();
                            /// <summary>
                            /// A constant for the <c>enum</c> keyword.
                            /// </summary>
                            public static readonly SchemaFormatEntity EnumJson1 = ParsedJsonDocument<SchemaFormatEntity>.StringConstant([.."\"application/vnd.apache.avro;version=1.9.0\""u8]);
                            /// <summary>
                            /// A constant for the <c>enum</c> keyword.
                            /// </summary>
                            public static readonly byte[] Enum2 = "application/vnd.apache.avro+json;version=1.9.0"u8.ToArray();
                            /// <summary>
                            /// A constant for the <c>enum</c> keyword.
                            /// </summary>
                            public static readonly SchemaFormatEntity EnumJson2 = ParsedJsonDocument<SchemaFormatEntity>.StringConstant([.."\"application/vnd.apache.avro+json;version=1.9.0\""u8]);
                            /// <summary>
                            /// A constant for the <c>enum</c> keyword.
                            /// </summary>
                            public static readonly byte[] Enum3 = "application/vnd.apache.avro+yaml;version=1.9.0"u8.ToArray();
                            /// <summary>
                            /// A constant for the <c>enum</c> keyword.
                            /// </summary>
                            public static readonly SchemaFormatEntity EnumJson3 = ParsedJsonDocument<SchemaFormatEntity>.StringConstant([.."\"application/vnd.apache.avro+yaml;version=1.9.0\""u8]);
                        }
                        ...
                        {
                            /// <summary>
                            /// Gets the string "application/vnd.apache.avro;version=1.9.0"
                            /// as a <see cref="SchemaFormatEntity"/>.
                            /// </summary>
                            public static SchemaFormatEntity ApplicationVndApacheAvroVersion190 { get; } = Constants.EnumJson1;
                            /// <summary>
                            /// Gets the string "application/vnd.apache.avro;version=1.9.0"
                            /// as a UTF8 byte array.
                            /// </summary>
                            public static ReadOnlySpan<byte> ApplicationVndApacheAvroVersion190Utf8 => Constants.Enum1;

                            /// <summary>
                            /// Gets the string "application/vnd.apache.avro+json;version=1.9.0"
                            /// as a <see cref="SchemaFormatEntity"/>.
                            /// </summary>
                            public static SchemaFormatEntity ApplicationVndApacheAvroJsonVersion190 { get; } = Constants.EnumJson2;
                            /// <summary>
                            /// Gets the string "application/vnd.apache.avro+json;version=1.9.0"
                            /// as a UTF8 byte array.
                            /// </summary>
                            public static ReadOnlySpan<byte> ApplicationVndApacheAvroJsonVersion190Utf8 => Constants.Enum2;

                            /// <summary>
                            /// Gets the string "application/vnd.apache.avro+yaml;version=1.9.0"
                            /// as a <see cref="SchemaFormatEntity"/>.
                            /// </summary>
                            public static SchemaFormatEntity ApplicationVndApacheAvroYamlVersion190 { get; } = Constants.EnumJson3;
                            /// <summary>
                            /// Gets the string "application/vnd.apache.avro+yaml;version=1.9.0"
                            /// as a UTF8 byte array.
                            /// </summary>
                            public static ReadOnlySpan<byte> ApplicationVndApacheAvroYamlVersion190Utf8 => Constants.Enum3;
                        }
                        ...
                        {
                            /// <summary>
                            /// Corresponds to the JSON string "application/vnd.apache.avro;version=1.9.0".
                            /// </summary>
                            ApplicationVndApacheAvroVersion190 = 0,
                            /// <summary>
                            /// Corresponds to the JSON string "application/vnd.apache.avro+json;version=1.9.0".
                            /// </summary>
                            ApplicationVndApacheAvroJsonVersion190 = 1,
                            /// <summary>
                            /// Corresponds to the JSON string "application/vnd.apache.avro+yaml;version=1.9.0".
                            /// </summary>
                            ApplicationVndApacheAvroYamlVersion190 = 2,
                        }
                        ...
                        public static implicit operator SchemaFormatEntity(KnownValues value)
                        {
                            return value switch
                            {
                                KnownValues.ApplicationVndApacheAvroVersion190 => Constants.EnumJson1,
                                KnownValues.ApplicationVndApacheAvroJsonVersion190 => Constants.EnumJson2,
                                KnownValues.ApplicationVndApacheAvroYamlVersion190 => Constants.EnumJson3,
                        ...
                        public bool TryGetKnownValue(out KnownValues result)
                        {
                            ...
                            {
                                result = KnownValues.ApplicationVndApacheAvroVersion190;
                                return true;
                            }

                            if (this.ValueEquals(Constants.Enum2))
                            {
                                result = KnownValues.ApplicationVndApacheAvroJsonVersion190;
                                return true;
                            }

                            if (this.ValueEquals(Constants.Enum3))
                            {
                                result = KnownValues.ApplicationVndApacheAvroYamlVersion190;
                                return true;
                            }
                        ...
                        public static partial class JsonSchema
                        {
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1multiFormatSchema.json/else/allOf/4/if/properties/schemaFormat"u8, buffer, out written);

                            /// <summary>
                            /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                            /// </summary>
                            public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1multiFormatSchema.json/else/allOf/4/if/properties/schemaFormat";

                            /// <summary>
                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                            /// </summary>
                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1multiFormatSchema.json/else/allOf/4/if/properties/schemaFormat"u8;
                                ...
                                ref JsonSchemaContext context)
                            {
                                ...
                                if (tokenType == JsonTokenType.String)
                                {
                                    ...
                                    if (unescapedUtf8JsonString.Span.SequenceEqual("application/vnd.apache.avro;version=1.9.0"u8))
                                    {
                                        goto enumShortCircuitSuccess;
                                    }

                                    if (unescapedUtf8JsonString.Span.SequenceEqual("application/vnd.apache.avro+json;version=1.9.0"u8))
                                    {
                                        goto enumShortCircuitSuccess;
                                    }

                                    if (unescapedUtf8JsonString.Span.SequenceEqual("application/vnd.apache.avro+yaml;version=1.9.0"u8))
                                    {
                                        goto enumShortCircuitSuccess;
                                    }
                                }
