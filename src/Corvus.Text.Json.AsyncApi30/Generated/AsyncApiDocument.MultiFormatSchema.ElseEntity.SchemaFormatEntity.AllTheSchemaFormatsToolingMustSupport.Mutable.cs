            ...
            public readonly partial struct SchemaFormatEntity
            {
                ...
                public readonly partial struct AllTheSchemaFormatsToolingMustSupport
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(AllTheSchemaFormatsToolingMustSupport instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="AllTheSchemaFormatsToolingMustSupport"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AllTheSchemaFormatsToolingMustSupport(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AllTheSchemaFormatsToolingMustSupport.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AllTheSchemaFormatsToolingMustSupport Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AllTheSchemaFormatsToolingMustSupport Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<AllTheSchemaFormatsToolingMustSupport>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(AllTheSchemaFormatsToolingMustSupport instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (AllTheSchemaFormatsToolingMustSupport)value;
                    ...
                    {
                        return workspace.CreateBuilder<AllTheSchemaFormatsToolingMustSupport, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<AllTheSchemaFormatsToolingMustSupport> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AllTheSchemaFormatsToolingMustSupport>();
                        }
                        finally
                        {
