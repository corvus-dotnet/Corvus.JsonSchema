    ...
    public readonly partial struct MultiFormatSchema
    {
        ...
        public readonly partial struct ElseEntity
        {
            ...
            public readonly partial struct SchemaFormatEntity
            {
                ...
                /// <remarks>
                /// <para>
                /// All the schema formats tooling MUST support
                /// </para>
                /// </remarks>
                [DebuggerDisplay("{DebuggerDisplay,nq}")]
                public readonly partial struct AllTheSchemaFormatsToolingMustSupport
#if NET8_0_OR_GREATER
                    : IJsonElement<AllTheSchemaFormatsToolingMustSupport>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="AllTheSchemaFormatsToolingMustSupport"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal AllTheSchemaFormatsToolingMustSupport(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static AllTheSchemaFormatsToolingMustSupport DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(AllTheSchemaFormatsToolingMustSupport value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in AllTheSchemaFormatsToolingMustSupport left, in AllTheSchemaFormatsToolingMustSupport right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in AllTheSchemaFormatsToolingMustSupport left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(AllTheSchemaFormatsToolingMustSupport instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AllTheSchemaFormatsToolingMustSupport(JsonElement instance)
                    {
                        return AllTheSchemaFormatsToolingMustSupport.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AllTheSchemaFormatsToolingMustSupport From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AllTheSchemaFormatsToolingMustSupport ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AllTheSchemaFormatsToolingMustSupport>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AllTheSchemaFormatsToolingMustSupport ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AllTheSchemaFormatsToolingMustSupport>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AllTheSchemaFormatsToolingMustSupport ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AllTheSchemaFormatsToolingMustSupport>(json, options);
                    }
                    ...
                    /// </exception>
                    public static AllTheSchemaFormatsToolingMustSupport ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<AllTheSchemaFormatsToolingMustSupport>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out AllTheSchemaFormatsToolingMustSupport? result)
                    {
                        return JsonElementHelpers.TryParseValue<AllTheSchemaFormatsToolingMustSupport>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AllTheSchemaFormatsToolingMustSupport(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static AllTheSchemaFormatsToolingMustSupport IJsonElement<AllTheSchemaFormatsToolingMustSupport>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AllTheSchemaFormatsToolingMustSupport: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AllTheSchemaFormatsToolingMustSupport"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AllTheSchemaFormatsToolingMustSupport"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public AllTheSchemaFormatsToolingMustSupport Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AllTheSchemaFormatsToolingMustSupport>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AllTheSchemaFormatsToolingMustSupport"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public AllTheSchemaFormatsToolingMustSupport Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<AllTheSchemaFormatsToolingMustSupport>(_idx);
                        }
                    ...
                    /// <param name="matchApplicationSchemaJsonVersionDraft07">Match 1st item.</param>
                    /// <param name="matchApplicationSchemaYamlVersionDraft07">Match 2nd item.</param>
                    /// <param name="matchApplicationVndAaiAsyncapiVersion300">Match 3rd item.</param>
                    /// <param name="matchApplicationVndAaiAsyncapiJsonVersion300">Match 4th item.</param>
                    /// <param name="matchApplicationVndAaiAsyncapiYamlVersion300">Match 5th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchApplicationSchemaJsonVersionDraft07,
                        Func<TContext, TResult> matchApplicationSchemaYamlVersionDraft07,
...
#endif
                    {
                        ...
                        {
                            return matchApplicationSchemaJsonVersionDraft07(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchApplicationSchemaYamlVersionDraft07(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchApplicationSchemaJsonVersionDraft07,
                        Func<TResult> matchApplicationSchemaYamlVersionDraft07,
                        ...
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchApplicationSchemaJsonVersionDraft07();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchApplicationSchemaYamlVersionDraft07();
                        }
