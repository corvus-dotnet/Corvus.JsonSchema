    ...
    public readonly partial struct MultiFormatSchema
    {
        ...
        public readonly partial struct ElseEntity
        {
            ...
            public readonly partial struct SchemaFormatEntity
            {
                ...
                /// <remarks>
                /// <para>
                /// All the schema formats tools are RECOMMENDED to support
                /// </para>
                /// </remarks>
                [DebuggerDisplay("{DebuggerDisplay,nq}")]
                public readonly partial struct AllTheSchemaFormatsToolsAreRecommendedToSupport
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(AllTheSchemaFormatsToolsAreRecommendedToSupport instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="AllTheSchemaFormatsToolsAreRecommendedToSupport"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AllTheSchemaFormatsToolsAreRecommendedToSupport(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new AllTheSchemaFormatsToolsAreRecommendedToSupport(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AllTheSchemaFormatsToolsAreRecommendedToSupport.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="AllTheSchemaFormatsToolsAreRecommendedToSupport"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="AllTheSchemaFormatsToolsAreRecommendedToSupport"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AllTheSchemaFormatsToolsAreRecommendedToSupport Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<AllTheSchemaFormatsToolsAreRecommendedToSupport>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="AllTheSchemaFormatsToolsAreRecommendedToSupport"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AllTheSchemaFormatsToolsAreRecommendedToSupport Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<AllTheSchemaFormatsToolsAreRecommendedToSupport>(_idx);
                        }
                        ...
                        /// <param name="matchApplicationVndApacheAvroVersion190">Match 4th item.</param>
                        /// <param name="matchApplicationVndApacheAvroJsonVersion190">Match 5th item.</param>
                        /// <param name="matchApplicationVndApacheAvroYamlVersion190">Match 6th item.</param>
                        /// <param name="matchApplicationRamlYamlVersion10">Match 7th item.</param>
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Func<TContext, TResult> matchApplicationVndApacheAvroVersion190,
                            Func<TContext, TResult> matchApplicationVndApacheAvroJsonVersion190,
                            Func<TContext, TResult> matchApplicationVndApacheAvroYamlVersion190,
                            Func<TContext, TResult> matchApplicationRamlYamlVersion10,
...
#endif
                        {
                            ...
                            {
                                return matchApplicationVndApacheAvroVersion190(context);
                            }

                            if (this.ValueEquals(Constants.Enum5))
                            {
                                return matchApplicationVndApacheAvroJsonVersion190(context);
                            }

                            if (this.ValueEquals(Constants.Enum6))
                            {
                                return matchApplicationVndApacheAvroYamlVersion190(context);
                            }

                            if (this.ValueEquals(Constants.Enum7))
                            {
                                return matchApplicationRamlYamlVersion10(context);
                            }
                        ...
                        public TResult Match<TResult>(
                            ...
                            Func<TResult> matchApplicationVndApacheAvroVersion190,
                            Func<TResult> matchApplicationVndApacheAvroJsonVersion190,
                            Func<TResult> matchApplicationVndApacheAvroYamlVersion190,
                            Func<TResult> matchApplicationRamlYamlVersion10,
                            Func<TResult> defaultMatch)
                        {
                            ...
                            if (this.ValueEquals(Constants.Enum4))
                            {
                                return matchApplicationVndApacheAvroVersion190();
                            }

                            if (this.ValueEquals(Constants.Enum5))
                            {
                                return matchApplicationVndApacheAvroJsonVersion190();
                            }

                            if (this.ValueEquals(Constants.Enum6))
                            {
                                return matchApplicationVndApacheAvroYamlVersion190();
                            }

                            if (this.ValueEquals(Constants.Enum7))
                            {
                                return matchApplicationRamlYamlVersion10();
                            }
                        ...
                        public bool TryGetKnownValue(out KnownValues result)
                        {
                            ...
                            if (this.ValueEquals(Constants.Enum7))
                            {
                                result = KnownValues.ApplicationRamlYamlVersion10;
                                return true;
                            }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(AllTheSchemaFormatsToolsAreRecommendedToSupport instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (AllTheSchemaFormatsToolsAreRecommendedToSupport)value;
                    ...
                    {
                        return workspace.CreateBuilder<AllTheSchemaFormatsToolsAreRecommendedToSupport, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<AllTheSchemaFormatsToolsAreRecommendedToSupport> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AllTheSchemaFormatsToolsAreRecommendedToSupport>();
                        }
                        finally
                        {
