...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct NonBearerHttpSecurityScheme
    {
...
#endif
        {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetScheme(in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.NonBearerHttpSecurityScheme.TheTypeOfTheSecurityScheme.Source value)
            {
                CheckValidInstance();
