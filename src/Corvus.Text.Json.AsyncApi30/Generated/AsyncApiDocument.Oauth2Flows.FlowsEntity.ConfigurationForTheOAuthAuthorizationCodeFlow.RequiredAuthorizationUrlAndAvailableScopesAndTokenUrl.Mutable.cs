            ...
            public readonly partial struct ConfigurationForTheOAuthAuthorizationCodeFlow
            {
                ...
                public readonly partial struct RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthAuthorizationCodeFlow.RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public static implicit operator Source(RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthAuthorizationCodeFlow.RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl"/>.
                        /// </summary>
                        ...
                        public void Create(
                            ...
                            in Corvus.Text.Json.JsonElement.Source tokenUrl)
                        {
                            Create(ref _builder, authorizationUrl, availableScopes, tokenUrl);
                        }
                        ...
                        #endif
                        {
                            Create(context, ref _builder, authorizationUrl, availableScopes, tokenUrl);
                        }
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source authorizationUrl, scoped in Corvus.Text.Json.JsonElement.Source availableScopes, scoped in Corvus.Text.Json.JsonElement.Source tokenUrl)
                    {
                        return new Source(authorizationUrl, availableScopes, tokenUrl);
                    }
                    ...
                    /// <param name="tokenUrl">The value of the <c>"tokenUrl"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, scoped in Corvus.Text.Json.JsonElement.Source<TContext> availableScopes, scoped in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        return new Source<TContext>(context, authorizationUrl, availableScopes, tokenUrl);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source authorizationUrl, in Corvus.Text.Json.JsonElement.Source availableScopes, in Corvus.Text.Json.JsonElement.Source tokenUrl, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(authorizationUrl, availableScopes, tokenUrl);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, in Corvus.Text.Json.JsonElement.Source<TContext> availableScopes, in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, authorizationUrl, availableScopes, tokenUrl);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl> Create(in Corvus.Text.Json.JsonElement.Source authorizationUrl, in Corvus.Text.Json.JsonElement.Source availableScopes, in Corvus.Text.Json.JsonElement.Source tokenUrl, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, in Corvus.Text.Json.JsonElement.Source<TContext> availableScopes, in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
