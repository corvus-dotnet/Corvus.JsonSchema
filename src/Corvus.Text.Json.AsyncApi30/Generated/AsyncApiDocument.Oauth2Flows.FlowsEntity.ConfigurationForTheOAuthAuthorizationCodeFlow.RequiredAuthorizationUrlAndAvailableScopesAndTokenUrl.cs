        ...
        public readonly partial struct FlowsEntity
        {
            ...
            public readonly partial struct ConfigurationForTheOAuthAuthorizationCodeFlow
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl left, in RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl(JsonElement instance)
                    {
                        return RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl IJsonElement<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredAuthorizationUrlAndAvailableScopesAndTokenUrl>(_idx);
                        }
