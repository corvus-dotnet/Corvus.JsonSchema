            ...
            public readonly partial struct ConfigurationForTheOAuthClientCredentialsFlow
            {
                ...
                public readonly partial struct AllOf2Entity
                {
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthClientCredentialsFlow.AllOf2Entity.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthClientCredentialsFlow.AllOf2Entity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthClientCredentialsFlow.AllOf2Entity.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthClientCredentialsFlow.AllOf2Entity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                    ...
                    public static ParsedJsonDocument<AllOf2Entity> CreateArray(
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>An empty <see cref="ParsedJsonDocument{T}"/>. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<AllOf2Entity> CreateObject(
                        int initialCapacity = 1, int initialValueBufferSize = 8192)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                        try
