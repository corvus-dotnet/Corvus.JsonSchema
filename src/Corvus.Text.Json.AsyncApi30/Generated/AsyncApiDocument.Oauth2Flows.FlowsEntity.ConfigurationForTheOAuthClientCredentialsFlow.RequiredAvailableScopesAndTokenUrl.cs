    ...
    public readonly partial struct Oauth2Flows
    {
        ...
        public readonly partial struct FlowsEntity
        {
            ...
            public readonly partial struct ConfigurationForTheOAuthClientCredentialsFlow
            {
                ...
                public readonly partial struct RequiredAvailableScopesAndTokenUrl
#if NET8_0_OR_GREATER
                    : IJsonElement<RequiredAvailableScopesAndTokenUrl>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RequiredAvailableScopesAndTokenUrl"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RequiredAvailableScopesAndTokenUrl(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RequiredAvailableScopesAndTokenUrl DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in RequiredAvailableScopesAndTokenUrl left, in RequiredAvailableScopesAndTokenUrl right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredAvailableScopesAndTokenUrl left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredAvailableScopesAndTokenUrl instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredAvailableScopesAndTokenUrl(JsonElement instance)
                    {
                        return RequiredAvailableScopesAndTokenUrl.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAvailableScopesAndTokenUrl From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAvailableScopesAndTokenUrl ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAvailableScopesAndTokenUrl>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAvailableScopesAndTokenUrl ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAvailableScopesAndTokenUrl>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAvailableScopesAndTokenUrl ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAvailableScopesAndTokenUrl>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RequiredAvailableScopesAndTokenUrl ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAvailableScopesAndTokenUrl>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAvailableScopesAndTokenUrl? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredAvailableScopesAndTokenUrl>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredAvailableScopesAndTokenUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RequiredAvailableScopesAndTokenUrl IJsonElement<RequiredAvailableScopesAndTokenUrl>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredAvailableScopesAndTokenUrl: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredAvailableScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredAvailableScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAvailableScopesAndTokenUrl Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredAvailableScopesAndTokenUrl>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredAvailableScopesAndTokenUrl"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAvailableScopesAndTokenUrl Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredAvailableScopesAndTokenUrl>(_idx);
                        }
