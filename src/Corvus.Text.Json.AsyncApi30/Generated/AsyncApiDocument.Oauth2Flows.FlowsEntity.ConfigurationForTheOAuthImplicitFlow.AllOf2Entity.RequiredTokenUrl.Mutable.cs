        ...
        public readonly partial struct FlowsEntity
        {
            ...
            public readonly partial struct ConfigurationForTheOAuthImplicitFlow
            {
                ...
                public readonly partial struct AllOf2Entity
                {
                    ...
                    public readonly partial struct RequiredTokenUrl
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(RequiredTokenUrl instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="RequiredTokenUrl"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredTokenUrl(Mutable instance)
                            {
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new RequiredTokenUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredTokenUrl.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="RequiredTokenUrl"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="RequiredTokenUrl"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredTokenUrl Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<RequiredTokenUrl>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="RequiredTokenUrl"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredTokenUrl Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<RequiredTokenUrl>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthImplicitFlow.AllOf2Entity.RequiredTokenUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public static implicit operator Source(RequiredTokenUrl instance) => new(JsonElement.From(instance));
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthImplicitFlow.AllOf2Entity.RequiredTokenUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// <summary>
                            /// Creates an instance of a <see cref="RequiredTokenUrl"/>.
                            /// </summary>
                            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.JsonElement.Source tokenUrl)
                            {
                            ...
                            /// Creates an instance of a <see cref="RequiredTokenUrl"/>.
                            /// </summary>
                            public void Create(in Corvus.Text.Json.JsonElement.Source tokenUrl)
                            {
                                Create(ref _builder, tokenUrl);
                            }
                            ...
                            /// Creates an instance of a <see cref="RequiredTokenUrl"/>.
                            /// </summary>
                            public void Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                            {
                                Create(context, ref _builder, tokenUrl);
                            }
                        ...
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source tokenUrl)
                        {
                            return new Source(tokenUrl);
                        }
                        ...
                        /// <param name="tokenUrl">The value of the <c>"tokenUrl"</c> property.</param>
                        /// <returns>The source from which to build the value.</returns>
                        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
                            return new Source<TContext>(context, tokenUrl);
                        }
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source tokenUrl, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
                        ...
                        {
                            return workspace.CreateBuilder<RequiredTokenUrl, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<RequiredTokenUrl> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RequiredTokenUrl>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredTokenUrl> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<RequiredTokenUrl> Create(in Corvus.Text.Json.JsonElement.Source tokenUrl, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredTokenUrl> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> tokenUrl, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
