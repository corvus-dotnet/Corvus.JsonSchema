            ...
            public readonly partial struct ConfigurationForTheOAuthImplicitFlow
            {
                ...
                public readonly partial struct RequiredAuthorizationUrlAndAvailableScopes
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredAuthorizationUrlAndAvailableScopes instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredAuthorizationUrlAndAvailableScopes"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredAuthorizationUrlAndAvailableScopes(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredAuthorizationUrlAndAvailableScopes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAuthorizationUrlAndAvailableScopes Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAuthorizationUrlAndAvailableScopes Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredAuthorizationUrlAndAvailableScopes>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthImplicitFlow.RequiredAuthorizationUrlAndAvailableScopes.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public static implicit operator Source(RequiredAuthorizationUrlAndAvailableScopes instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthImplicitFlow.RequiredAuthorizationUrlAndAvailableScopes.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredAuthorizationUrlAndAvailableScopes"/>.
                        /// </summary>
                        ...
                        /// Creates an instance of a <see cref="RequiredAuthorizationUrlAndAvailableScopes"/>.
                        /// </summary>
                        public void Create(in Corvus.Text.Json.JsonElement.Source authorizationUrl, in Corvus.Text.Json.JsonElement.Source availableScopes)
                        {
                            Create(ref _builder, authorizationUrl, availableScopes);
                        }
                        ...
                        #endif
                        {
                            Create(context, ref _builder, authorizationUrl, availableScopes);
                        }
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source authorizationUrl, scoped in Corvus.Text.Json.JsonElement.Source availableScopes)
                    {
                        return new Source(authorizationUrl, availableScopes);
                    }
                    ...
                    /// <param name="availableScopes">The value of the <c>"availableScopes"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, scoped in Corvus.Text.Json.JsonElement.Source<TContext> availableScopes)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        return new Source<TContext>(context, authorizationUrl, availableScopes);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source authorizationUrl, in Corvus.Text.Json.JsonElement.Source availableScopes, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(authorizationUrl, availableScopes);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, in Corvus.Text.Json.JsonElement.Source<TContext> availableScopes, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, authorizationUrl, availableScopes);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredAuthorizationUrlAndAvailableScopes, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopes> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopes>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopes> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopes> Create(in Corvus.Text.Json.JsonElement.Source authorizationUrl, in Corvus.Text.Json.JsonElement.Source availableScopes, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredAuthorizationUrlAndAvailableScopes> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> authorizationUrl, in Corvus.Text.Json.JsonElement.Source<TContext> availableScopes, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
