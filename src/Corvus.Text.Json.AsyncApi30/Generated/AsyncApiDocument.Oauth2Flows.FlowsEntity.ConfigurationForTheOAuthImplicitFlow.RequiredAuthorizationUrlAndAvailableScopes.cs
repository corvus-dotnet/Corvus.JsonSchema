        ...
        public readonly partial struct FlowsEntity
        {
            ...
            public readonly partial struct ConfigurationForTheOAuthImplicitFlow
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RequiredAuthorizationUrlAndAvailableScopes"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RequiredAuthorizationUrlAndAvailableScopes(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RequiredAuthorizationUrlAndAvailableScopes DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in RequiredAuthorizationUrlAndAvailableScopes left, in RequiredAuthorizationUrlAndAvailableScopes right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredAuthorizationUrlAndAvailableScopes left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredAuthorizationUrlAndAvailableScopes instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredAuthorizationUrlAndAvailableScopes(JsonElement instance)
                    {
                        return RequiredAuthorizationUrlAndAvailableScopes.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndAvailableScopes From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndAvailableScopes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndAvailableScopes>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndAvailableScopes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndAvailableScopes>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredAuthorizationUrlAndAvailableScopes ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndAvailableScopes>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RequiredAuthorizationUrlAndAvailableScopes ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RequiredAuthorizationUrlAndAvailableScopes>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAuthorizationUrlAndAvailableScopes? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredAuthorizationUrlAndAvailableScopes>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredAuthorizationUrlAndAvailableScopes(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RequiredAuthorizationUrlAndAvailableScopes IJsonElement<RequiredAuthorizationUrlAndAvailableScopes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredAuthorizationUrlAndAvailableScopes: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredAuthorizationUrlAndAvailableScopes"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredAuthorizationUrlAndAvailableScopes"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAuthorizationUrlAndAvailableScopes Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredAuthorizationUrlAndAvailableScopes>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredAuthorizationUrlAndAvailableScopes"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredAuthorizationUrlAndAvailableScopes Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredAuthorizationUrlAndAvailableScopes>(_idx);
                        }
