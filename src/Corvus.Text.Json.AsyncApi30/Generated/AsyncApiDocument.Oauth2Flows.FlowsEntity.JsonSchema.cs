...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Oauth2Flows
    {
            ...
            : IJsonElement<FlowsEntity>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider AuthorizationCodeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/authorizationCode"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider ClientCredentialsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/clientCredentials"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider ImplicitSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/implicit"u8, buffer, out written);
                ...
                private static void MatchAuthorizationCode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthAuthorizationCodeFlow.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthAuthorizationCodeFlow.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchClientCredentials(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthClientCredentialsFlow.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthClientCredentialsFlow.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static void MatchImplicit(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthImplicitFlow.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.ConfigurationForTheOAuthImplicitFlow.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static void MatchPassword(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext childContext3 =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.PasswordEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Oauth2Flows.FlowsEntity.PasswordEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1oauth2Flows.json/properties/flows"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1oauth2Flows.json/properties/flows";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1oauth2Flows.json/properties/flows"u8;
