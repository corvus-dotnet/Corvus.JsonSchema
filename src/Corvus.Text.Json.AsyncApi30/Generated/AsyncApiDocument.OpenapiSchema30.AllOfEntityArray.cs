...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OpenapiSchema30
    {
...
#endif
        {
            ...
            internal AllOfEntityArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OpenapiSchema30.AllOfEntityArray.AllOfEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OpenapiSchema30.AllOfEntityArray.AllOfEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OpenapiSchema30.AllOfEntityArray.AllOfEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OpenapiSchema30.AllOfEntityArray.AllOfEntity>(_parent, _idx);
            }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllOfEntityArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AllOfEntityArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllOfEntityArray(JsonElement instance)
            {
                return AllOfEntityArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOfEntityArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOfEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllOfEntityArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOfEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllOfEntityArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOfEntityArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllOfEntityArray>(json, options);
            }
            ...
            /// </exception>
            public static AllOfEntityArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllOfEntityArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllOfEntityArray? result)
            {
                return JsonElementHelpers.TryParseValue<AllOfEntityArray>(ref reader, out result);
            }
...
#if NET
            static AllOfEntityArray IJsonElement<AllOfEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllOfEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public AllOfEntityArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AllOfEntityArray>(_idx);
                }
