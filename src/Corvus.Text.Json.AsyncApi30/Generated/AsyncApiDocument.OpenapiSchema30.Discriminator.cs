...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OpenapiSchema30
    {
...
#endif
        {
            ...
            internal Discriminator(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity Mapping
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MappingUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OpenapiSchema30.Discriminator.MappingEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonString PropertyName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyNameUtf8, out Corvus.Text.Json.AsyncApi30.JsonString value))
                    {
                        return value;
                    }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Discriminator left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Discriminator instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Discriminator(JsonElement instance)
            {
                return Discriminator.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Discriminator From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Discriminator ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Discriminator>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Discriminator ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Discriminator>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Discriminator ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Discriminator>(json, options);
            }
            ...
            /// </exception>
            public static Discriminator ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Discriminator>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Discriminator? result)
            {
                return JsonElementHelpers.TryParseValue<Discriminator>(ref reader, out result);
            }
...
#if NET
            static Discriminator IJsonElement<Discriminator>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Discriminator: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="PropertyName"/>.
                /// </summary>
                public static ReadOnlySpan<byte> PropertyName => "propertyName"u8;
            }
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="PropertyName"/>.
                /// </summary>
                public static ReadOnlySpan<byte> PropertyName => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x72, 0x6F, 0x70, 0x65, 0x72, 0x74, 0x79, 0x4E, 0x61, 0x6D, 0x65, 0x22];
            }
        }
    }
}
