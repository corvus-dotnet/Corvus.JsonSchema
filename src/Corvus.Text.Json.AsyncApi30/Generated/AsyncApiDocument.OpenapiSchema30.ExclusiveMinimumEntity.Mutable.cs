    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct ExclusiveMinimumEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExclusiveMinimumEntity, Mutable>(ExclusiveMinimumEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ExclusiveMinimumEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExclusiveMinimumEntity>();
                }
                finally
                {
