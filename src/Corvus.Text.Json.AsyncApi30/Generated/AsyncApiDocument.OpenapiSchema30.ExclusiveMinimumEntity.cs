...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct ExclusiveMinimumEntity
            ...
            : IJsonElement<ExclusiveMinimumEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            internal ExclusiveMinimumEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ExclusiveMinimumEntity DefaultInstance { get; } = ParsedJsonDocument<ExclusiveMinimumEntity>.False;
            ...
            /// </returns>
            public static bool operator ==(in ExclusiveMinimumEntity left, in ExclusiveMinimumEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ExclusiveMinimumEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ExclusiveMinimumEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExclusiveMinimumEntity(JsonElement instance)
            {
                return ExclusiveMinimumEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExclusiveMinimumEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExclusiveMinimumEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExclusiveMinimumEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExclusiveMinimumEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExclusiveMinimumEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExclusiveMinimumEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExclusiveMinimumEntity>(json, options);
            }
            ...
            /// </exception>
            public static ExclusiveMinimumEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ExclusiveMinimumEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ExclusiveMinimumEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ExclusiveMinimumEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ExclusiveMinimumEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ExclusiveMinimumEntity IJsonElement<ExclusiveMinimumEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExclusiveMinimumEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ExclusiveMinimumEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ExclusiveMinimumEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ExclusiveMinimumEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ExclusiveMinimumEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ExclusiveMinimumEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ExclusiveMinimumEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ExclusiveMinimumEntity>(_idx);
                }
