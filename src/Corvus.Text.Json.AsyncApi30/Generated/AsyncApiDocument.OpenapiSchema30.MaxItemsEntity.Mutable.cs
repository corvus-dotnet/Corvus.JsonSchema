    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct MaxItemsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaxItemsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaxItemsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaxItemsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaxItemsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MaxItemsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MaxItemsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MaxItemsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MaxItemsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MaxItemsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaxItemsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaxItemsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaxItemsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaxItemsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaxItemsEntity>();
                }
                finally
                {
