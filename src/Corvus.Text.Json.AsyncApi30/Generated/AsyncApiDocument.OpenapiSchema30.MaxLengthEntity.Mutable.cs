    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct MaxLengthEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaxLengthEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaxLengthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaxLengthEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaxLengthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaxLengthEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaxLengthEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaxLengthEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaxLengthEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaxLengthEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaxLengthEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaxLengthEntity>();
                }
                finally
                {
