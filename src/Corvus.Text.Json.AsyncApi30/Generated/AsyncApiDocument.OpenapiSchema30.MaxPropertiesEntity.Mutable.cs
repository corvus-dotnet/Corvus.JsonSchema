    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct MaxPropertiesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaxPropertiesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaxPropertiesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaxPropertiesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaxPropertiesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaxPropertiesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaxPropertiesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaxPropertiesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaxPropertiesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaxPropertiesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaxPropertiesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaxPropertiesEntity>();
                }
                finally
                {
