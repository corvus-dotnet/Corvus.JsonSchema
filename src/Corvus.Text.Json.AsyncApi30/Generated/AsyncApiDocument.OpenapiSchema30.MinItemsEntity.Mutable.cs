    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct MinItemsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MinItemsEntity, Mutable>(MinItemsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(MinItemsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MinItemsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MinItemsEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MinItemsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MinItemsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MinItemsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MinItemsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MinItemsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MinItemsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MinItemsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MinItemsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MinItemsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MinItemsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MinItemsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MinItemsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MinItemsEntity>();
                }
                finally
                {
