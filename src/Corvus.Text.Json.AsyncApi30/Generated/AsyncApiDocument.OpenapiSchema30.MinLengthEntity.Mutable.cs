    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct MinLengthEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MinLengthEntity, Mutable>(MinLengthEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(MinLengthEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MinLengthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MinLengthEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MinLengthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MinLengthEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MinLengthEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MinLengthEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MinLengthEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MinLengthEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MinLengthEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MinLengthEntity>();
                }
                finally
                {
