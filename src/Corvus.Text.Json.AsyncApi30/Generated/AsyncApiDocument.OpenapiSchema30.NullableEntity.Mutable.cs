    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct NullableEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NullableEntity, Mutable>(NullableEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(NullableEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NullableEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NullableEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NullableEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NullableEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NullableEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NullableEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NullableEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NullableEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NullableEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NullableEntity>();
                }
                finally
                {
