    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct ReadOnlyEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReadOnlyEntity, Mutable>(ReadOnlyEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ReadOnlyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ReadOnlyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReadOnlyEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ReadOnlyEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReadOnlyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ReadOnlyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ReadOnlyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ReadOnlyEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ReadOnlyEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ReadOnlyEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ReadOnlyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ReadOnlyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ReadOnlyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ReadOnlyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ReadOnlyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ReadOnlyEntity>();
                }
                finally
                {
