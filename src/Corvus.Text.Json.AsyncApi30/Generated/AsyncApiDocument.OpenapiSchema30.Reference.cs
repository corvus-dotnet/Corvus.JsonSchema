...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OpenapiSchema30
    {
...
#endif
        {
            ...
            /// <summary>
            /// Determines if a property name matches '^\$ref$'
            /// for the pattern property producing the type
            /// <see cref="Corvus.Text.Json.AsyncApi30.JsonUriReference"/>.
            /// </summary>
            ...
            public static bool MatchesPatternJsonUriReference(ReadOnlySpan<byte> propertyName)
            {
            ...
            /// <see cref="Corvus.Text.Json.AsyncApi30.JsonUriReference"/>
            /// if the property name matches '^\$ref$'.
            /// </summary>
            /// <param name="propertyName">The unescaped UTF-8 property name.</param>
            /// <param name="value">The property value.</param>
            /// <param name="result">The typed property value, if the name matches.</param>
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternJsonUriReference(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.AsyncApi30.JsonUriReference result)
            {
                if (MatchesPatternJsonUriReference(propertyName))
                {
                    result = Corvus.Text.Json.AsyncApi30.JsonUriReference.From(value);
                    return true;
                }
            ...
            {
                /// <summary>
                /// Visits a property matching '^\$ref$'.
                /// </summary>
                bool VisitPatternJsonUriReference(ReadOnlySpan<byte> name, in Corvus.Text.Json.AsyncApi30.JsonUriReference value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.AsyncApi30.JsonUriReference typedValue = Corvus.Text.Json.AsyncApi30.JsonUriReference.From(property.Value);
                        if (!visitor.VisitPatternJsonUriReference(propertyName, in typedValue, ref state))
                        {
                            return false;
                        }
