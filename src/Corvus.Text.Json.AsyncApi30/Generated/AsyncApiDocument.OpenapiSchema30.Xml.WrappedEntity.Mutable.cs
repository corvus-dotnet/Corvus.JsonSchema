...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OpenapiSchema30
    {
        ...
        public readonly partial struct Xml
        {
            ...
            public readonly partial struct WrappedEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WrappedEntity, Mutable>(WrappedEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(WrappedEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WrappedEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WrappedEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new WrappedEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WrappedEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="WrappedEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="WrappedEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WrappedEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<WrappedEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="WrappedEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WrappedEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WrappedEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(WrappedEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<WrappedEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<WrappedEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<WrappedEntity>();
                    }
                    finally
                    {
