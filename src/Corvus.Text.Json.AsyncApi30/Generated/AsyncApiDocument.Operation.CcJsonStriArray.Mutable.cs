...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Operation
    {
        ...
        public readonly partial struct CcJsonStriArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CcJsonStriArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CcJsonStriArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CcJsonStriArray(Mutable instance)
                {
                ...
                public Corvus.Text.Json.AsyncApi30.JsonString.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.JsonString.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.JsonString.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.JsonString.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CcJsonStriArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CcJsonStriArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Text.Json.AsyncApi30.JsonString item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.AsyncApi30.JsonString>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Text.Json.AsyncApi30.JsonString> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.AsyncApi30.JsonString>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Text.Json.AsyncApi30.JsonString oldItem, in Corvus.Text.Json.AsyncApi30.JsonString.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.JsonString>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Text.Json.AsyncApi30.JsonString current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="CcJsonStriArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CcJsonStriArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly CcJsonStriArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CcJsonStriArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CcJsonStriArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly CcJsonStriArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CcJsonStriArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Operation.CcJsonStriArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(CcJsonStriArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Operation.CcJsonStriArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
            ...
            {
                return workspace.CreateBuilder<CcJsonStriArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CcJsonStriArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CcJsonStriArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<CcJsonStriArray> Create<TContext>(
