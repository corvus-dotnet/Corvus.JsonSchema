...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Operation
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CcJsonStriArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CcJsonStriArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CcJsonStriArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in CcJsonStriArray left, in CcJsonStriArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CcJsonStriArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CcJsonStriArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CcJsonStriArray(JsonElement instance)
            {
                return CcJsonStriArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CcJsonStriArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CcJsonStriArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CcJsonStriArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CcJsonStriArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CcJsonStriArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CcJsonStriArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CcJsonStriArray>(json, options);
            }
            ...
            /// </exception>
            public static CcJsonStriArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CcJsonStriArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CcJsonStriArray? result)
            {
                return JsonElementHelpers.TryParseValue<CcJsonStriArray>(ref reader, out result);
            }
...
#if NET
            static CcJsonStriArray IJsonElement<CcJsonStriArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CcJsonStriArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public CcJsonStriArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CcJsonStriArray>(_idx);
                }
