    ...
    public readonly partial struct Operation
    {
        ...
        public readonly partial struct ExpirationEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExpirationEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExpirationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExpirationEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExpirationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExpirationEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExpirationEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExpirationEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExpirationEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExpirationEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExpirationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExpirationEntity>();
                }
                finally
                {
