        ...
        public readonly partial struct HttpEntity
        {
            ...
            public readonly partial struct AllOf1Entity
            {
...
#endif
                {
                    ...
                    public void SetBindingVersion(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Operation.BindingVersionEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetMethod(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Operation.MethodEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Operation" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsType020Operation(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Operation result)
                    {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.HttpEntity.AllOf1Entity.RequiredBindingVersion" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredBindingVersion(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.HttpEntity.AllOf1Entity.RequiredBindingVersion result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.HttpEntity.AllOf1Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                        {
