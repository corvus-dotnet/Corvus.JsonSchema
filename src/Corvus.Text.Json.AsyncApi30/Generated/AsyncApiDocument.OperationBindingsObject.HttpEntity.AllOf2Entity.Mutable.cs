        ...
        public readonly partial struct HttpEntity
        {
            ...
            public readonly partial struct AllOf2Entity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.HttpEntity.AllOf2Entity.RequiredBindingVersion" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredBindingVersion(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.HttpEntity.AllOf2Entity.RequiredBindingVersion result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.HttpEntity.AllOf2Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                        {
