                ...
                public readonly partial struct IfEntity
                {
                    ...
                    public readonly partial struct RequiredBindingVersion
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(RequiredBindingVersion instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="RequiredBindingVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredBindingVersion(Mutable instance)
                            {
                            ...
                            /// <summary>
                            /// Gets the <c>bindingVersion</c> property.
                            /// </summary>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Text.Json.JsonElement.Mutable BindingVersion
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BindingVersionUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new RequiredBindingVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            public void SetBindingVersion(scoped in Corvus.Text.Json.JsonElement.Source value)
                            {
                                CheckValidInstance();

                                if (value.IsUndefined)
                                {
                                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("bindingVersion");
                                }
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetBindingVersion<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredBindingVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="RequiredBindingVersion"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="RequiredBindingVersion"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredBindingVersion Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<RequiredBindingVersion>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="RequiredBindingVersion"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredBindingVersion Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<RequiredBindingVersion>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.KafkaEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.RequiredBindingVersion.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public static implicit operator Source(RequiredBindingVersion instance) => new(JsonElement.From(instance));
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.KafkaEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.RequiredBindingVersion.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// <summary>
                            /// Creates an instance of a <see cref="RequiredBindingVersion"/>.
                            /// </summary>
                            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.JsonElement.Source bindingVersion)
                            {
                            ...
                            /// Creates an instance of a <see cref="RequiredBindingVersion"/>.
                            /// </summary>
                            public void Create(in Corvus.Text.Json.JsonElement.Source bindingVersion)
                            {
                                Create(ref _builder, bindingVersion);
                            }
                            ...
                            internal static void Create<TContext>(
                                ...
                                in Corvus.Text.Json.JsonElement.Source<TContext> bindingVersion)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                            {
                            ...
                            /// Creates an instance of a <see cref="RequiredBindingVersion"/>.
                            /// </summary>
                            public void Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> bindingVersion)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                            {
                                Create(context, ref _builder, bindingVersion);
                            }
                        ...
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source bindingVersion)
                        {
                            return new Source(bindingVersion);
                        }
                        ...
                        /// <param name="bindingVersion">The value of the <c>"bindingVersion"</c> property.</param>
                        /// <returns>The source from which to build the value.</returns>
                        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> bindingVersion)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
                            return new Source<TContext>(context, bindingVersion);
                        }
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source bindingVersion, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(bindingVersion);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> bindingVersion, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
                            ...
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(context, bindingVersion);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        {
                            return workspace.CreateBuilder<RequiredBindingVersion, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<RequiredBindingVersion> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RequiredBindingVersion>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredBindingVersion> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<RequiredBindingVersion> Create(in Corvus.Text.Json.JsonElement.Source bindingVersion, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredBindingVersion> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> bindingVersion, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
