        ...
        public readonly partial struct NatsEntity
        {
            ...
            public readonly partial struct IfNoBindingVersionSpecifiedUseTheLatestBinding
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.NatsEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsIfEntity(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.NatsEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.NatsEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.NatsEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.NatsEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationBindingsObject.NatsEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static ParsedJsonDocument<IfNoBindingVersionSpecifiedUseTheLatestBinding> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Operation.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Operation.QueueEntity.Source queue = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
