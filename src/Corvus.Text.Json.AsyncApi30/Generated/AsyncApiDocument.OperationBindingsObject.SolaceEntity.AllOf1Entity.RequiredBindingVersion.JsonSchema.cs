            ...
            public readonly partial struct AllOf1Entity
            {
                    ...
                    : IJsonElement<RequiredBindingVersion>
                {
                    public static partial class JsonSchema
                    {
                        ...
                        private static void MatchBindingVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                        {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1operationBindingsObject.json/properties/solace/allOf/1/if"u8, buffer, out written);
