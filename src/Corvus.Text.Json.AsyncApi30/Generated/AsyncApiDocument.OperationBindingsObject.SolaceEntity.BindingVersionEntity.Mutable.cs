        ...
        public readonly partial struct SolaceEntity
        {
            ...
            public readonly partial struct BindingVersionEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(BindingVersionEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="BindingVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator BindingVersionEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"BindingVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="BindingVersionEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="BindingVersionEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BindingVersionEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="BindingVersionEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BindingVersionEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<BindingVersionEntity>(_idx);
                    }
                    ...
                    /// <param name="match040">Match 1st item.</param>
                    /// <param name="match030">Match 2nd item.</param>
                    /// <param name="match020">Match 3rd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> match040,
                        Func<TContext, TResult> match030,
                        Func<TContext, TResult> match020,
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> match040,
                        Func<TResult> match030,
                        Func<TResult> match020,
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(BindingVersionEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (BindingVersionEntity)value;
                ...
                {
                    return workspace.CreateBuilder<BindingVersionEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<BindingVersionEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<BindingVersionEntity>();
                    }
                    finally
                    {
