...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OperationReply
    {
...
#endif
        {
            ...
            public void SetAddress(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReply.AddressEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMessages(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReply.ReferenceArray.Source value)
            {
                CheckValidInstance();
