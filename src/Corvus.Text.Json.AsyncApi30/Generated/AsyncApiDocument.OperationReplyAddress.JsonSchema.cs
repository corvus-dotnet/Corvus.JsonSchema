...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<OperationReplyAddress>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchLocation(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1operationReplyAddress.json"u8, buffer, out written);
