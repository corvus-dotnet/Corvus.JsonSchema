...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<OperationReplyAddress>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLocationPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("location"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLocationNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("location"u8, buffer, out written);

            private const int RequiredOffsetForLocation = 0;
            private const uint RequiredBitForLocation = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForLocation;
            ...
            private static readonly JsonSchemaPathProvider LocationSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/location"u8, buffer, out written);
            ...
            private static void MatchLocation(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.LocationUtf8,
                        evaluationPath: LocationSchemaEvaluationPath);

                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                requiredBitBuffer[RequiredOffsetForLocation] |= RequiredBitForLocation;
            }
            ...
            private static PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator>([
                    ...
                    (static () => JsonPropertyNames.LocationUtf8, MatchLocation),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1operationReplyAddress.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1operationReplyAddress.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1operationReplyAddress.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyLocationPresent, "location"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForLocation] & RequiredBitForLocation) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyLocationNotPresent, "location"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyLocationPresent, "location"u8, "required"u8);
