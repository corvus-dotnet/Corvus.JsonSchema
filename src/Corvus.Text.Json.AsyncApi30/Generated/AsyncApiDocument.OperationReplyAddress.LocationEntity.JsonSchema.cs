    ...
    public readonly partial struct OperationReplyAddress
    {
            ...
            : IJsonElement<LocationEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1operationReplyAddress.json/properties/location"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1operationReplyAddress.json/properties/location";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1definitions~13.0.0~1operationReplyAddress.json/properties/location"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^\\$message\\.(header|payload)#(\\/(([^\\/~])|(~[01]))*)*", "pattern"u8, ref context);
                    }
                }
                ...
                [GeneratedRegex("^\\$message\\.(header|payload)#(\\/(([^\\/~])|(~[01]))*)*")]
                private static partial Regex CreatePattern();
#else
                private static Regex CreatePattern() => new("^\\$message\\.(header|payload)#(\\/(([^\\/~])|(~[01]))*)*", RegexOptions.Compiled);
#endif
