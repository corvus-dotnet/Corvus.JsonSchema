    ...
    public readonly partial struct OperationReplyAddress
    {
        ...
        public readonly partial struct LocationEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LocationEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LocationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LocationEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LocationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LocationEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LocationEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LocationEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LocationEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LocationEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LocationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LocationEntity>();
                }
                finally
                {
