...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OperationReplyAddress
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(OperationReplyAddress instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="OperationReplyAddress"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OperationReplyAddress(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Mutable Location
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LocationUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLocation(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OperationReplyAddress.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly OperationReplyAddress Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly OperationReplyAddress Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<OperationReplyAddress>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Source _createArg1;
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(OperationReplyAddress instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="OperationReplyAddress"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Source location,
            ...
            /// Creates an instance of a <see cref="OperationReplyAddress"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Source location, in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default)
            {
                Create(ref _builder, location, description);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Source location, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default)
        {
            return new Source(location, description);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Source location, in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(location, description);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<OperationReplyAddress, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<OperationReplyAddress> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<OperationReplyAddress>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<OperationReplyAddress> Create<TContext>(
        ...
        public static ParsedJsonDocument<OperationReplyAddress> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity.Source location, in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
