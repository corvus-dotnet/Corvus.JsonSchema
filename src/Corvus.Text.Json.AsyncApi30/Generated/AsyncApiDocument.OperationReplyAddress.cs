...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct OperationReplyAddress
#if NET8_0_OR_GREATER
        : IJsonElement<OperationReplyAddress>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationReplyAddress"/> struct.
        /// </summary>
        ...
        internal OperationReplyAddress(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OperationReplyAddress DefaultInstance { get; }
        ...
        /// <summary>
        /// Gets the <c>location</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity Location
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LocationUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationReplyAddress.LocationEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in OperationReplyAddress left, in OperationReplyAddress right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OperationReplyAddress left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OperationReplyAddress instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OperationReplyAddress(JsonElement instance)
        {
            return OperationReplyAddress.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OperationReplyAddress From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OperationReplyAddress ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OperationReplyAddress>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OperationReplyAddress ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OperationReplyAddress>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OperationReplyAddress ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OperationReplyAddress>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static OperationReplyAddress ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OperationReplyAddress>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OperationReplyAddress? result)
        {
            return JsonElementHelpers.TryParseValue<OperationReplyAddress>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OperationReplyAddress(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static OperationReplyAddress IJsonElement<OperationReplyAddress>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OperationReplyAddress: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OperationReplyAddress"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OperationReplyAddress"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public OperationReplyAddress Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OperationReplyAddress>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OperationReplyAddress"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public OperationReplyAddress Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<OperationReplyAddress>(_idx);
            }
