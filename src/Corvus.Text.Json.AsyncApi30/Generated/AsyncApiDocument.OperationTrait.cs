...
public readonly partial struct AsyncApiDocument
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationTrait.BindingsEntity Bindings
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BindingsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.OperationTrait.BindingsEntity value))
                {
                    return value;
                }
