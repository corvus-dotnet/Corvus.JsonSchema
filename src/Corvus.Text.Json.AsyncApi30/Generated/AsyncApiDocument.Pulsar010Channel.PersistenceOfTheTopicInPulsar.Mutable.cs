    ...
    public readonly partial struct Pulsar010Channel
    {
        ...
        public readonly partial struct PersistenceOfTheTopicInPulsar
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PersistenceOfTheTopicInPulsar instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PersistenceOfTheTopicInPulsar"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PersistenceOfTheTopicInPulsar(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PersistenceOfTheTopicInPulsar.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PersistenceOfTheTopicInPulsar Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PersistenceOfTheTopicInPulsar Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PersistenceOfTheTopicInPulsar>(_idx);
                }
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        result = KnownValues.Persistent;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.NonPersistent;
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PersistenceOfTheTopicInPulsar instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (PersistenceOfTheTopicInPulsar)value;
            ...
            {
                return workspace.CreateBuilder<PersistenceOfTheTopicInPulsar, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PersistenceOfTheTopicInPulsar> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PersistenceOfTheTopicInPulsar>();
                }
                finally
                {
