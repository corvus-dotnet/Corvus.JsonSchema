    ...
    public readonly partial struct Pulsar010Channel
    {
            ...
            : IJsonElement<RetentionEntity>
        {
            public static partial class JsonSchema
            {
                ...
                private static readonly JsonSchemaPathProvider TimeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/time"u8, buffer, out written);

                private static void MatchSize(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                }

                private static void MatchTime(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.TimeUtf8,
                            evaluationPath: TimeSchemaEvaluationPath);

                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator1>([
                        ...
                        (static () => JsonPropertyNames.TimeUtf8, MatchTime),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1pulsar~10.1.0~1channel.json/properties/retention"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1pulsar~10.1.0~1channel.json/properties/retention";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1pulsar~10.1.0~1channel.json/properties/retention"u8;
