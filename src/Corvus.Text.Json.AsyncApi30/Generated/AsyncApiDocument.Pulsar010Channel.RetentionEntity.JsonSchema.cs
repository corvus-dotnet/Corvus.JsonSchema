    ...
    public readonly partial struct Pulsar010Channel
    {
            ...
            : IJsonElement<RetentionEntity>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchTime(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1pulsar~10.1.0~1channel.json/properties/retention"u8, buffer, out written);
