...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Pulsar010Channel
    {
        ...
        public readonly partial struct RetentionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RetentionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RetentionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RetentionEntity(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Mutable Size
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SizeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>time</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Mutable Time
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RetentionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetSize(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source value)
                {
                    CheckValidInstance();
                ...
                /// <summary>
                /// Set the <c>time</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTime(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TimeUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimeUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Time, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>time</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveTime()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TimeUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RetentionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RetentionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RetentionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RetentionEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RetentionEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RetentionEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RetentionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RetentionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source _createArg1;
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source _createArg2;
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                public static implicit operator Source(RetentionEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RetentionEntity"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source size = default,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source time = default)
                {
                    size.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Size, ref builder);
                    time.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Time, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RetentionEntity"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source size = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source time = default)
                {
                    Create(ref _builder, size, time);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <param name="time">The value of the <c>"time"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source size = default, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source time = default)
            {
                return new Source(size, time);
            }
            ...
            /// <param name="time">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source size = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source time = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(size, time);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RetentionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RetentionEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RetentionEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RetentionEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<RetentionEntity> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source size = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source time = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
