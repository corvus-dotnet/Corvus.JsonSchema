    ...
    public readonly partial struct Pulsar010Channel
    {
        ...
        public readonly partial struct RetentionEntity
        {
...
#endif
            {
                ...
                public void SetSize(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTime(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention.Source value)
                {
                    CheckValidInstance();
