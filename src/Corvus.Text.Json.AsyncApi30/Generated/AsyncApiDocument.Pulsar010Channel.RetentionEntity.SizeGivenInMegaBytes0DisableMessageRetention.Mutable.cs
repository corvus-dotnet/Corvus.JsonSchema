        ...
        public readonly partial struct RetentionEntity
        {
            ...
            public readonly partial struct SizeGivenInMegaBytes0DisableMessageRetention
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SizeGivenInMegaBytes0DisableMessageRetention instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SizeGivenInMegaBytes0DisableMessageRetention"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SizeGivenInMegaBytes0DisableMessageRetention(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SizeGivenInMegaBytes0DisableMessageRetention.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SizeGivenInMegaBytes0DisableMessageRetention Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SizeGivenInMegaBytes0DisableMessageRetention Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SizeGivenInMegaBytes0DisableMessageRetention>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SizeGivenInMegaBytes0DisableMessageRetention instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SizeGivenInMegaBytes0DisableMessageRetention, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SizeGivenInMegaBytes0DisableMessageRetention> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SizeGivenInMegaBytes0DisableMessageRetention>();
                    }
                    finally
                    {
