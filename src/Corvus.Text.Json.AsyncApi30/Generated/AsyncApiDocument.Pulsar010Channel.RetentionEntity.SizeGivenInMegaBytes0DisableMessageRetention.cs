    ...
    public readonly partial struct Pulsar010Channel
    {
        ...
        public readonly partial struct RetentionEntity
        {
...
#endif
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator long(SizeGivenInMegaBytes0DisableMessageRetention value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator double(SizeGivenInMegaBytes0DisableMessageRetention value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();
