        ...
        public readonly partial struct RetentionEntity
        {
            ...
            public readonly partial struct TimeGivenInMinutes0DisableMessageRetention
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TimeGivenInMinutes0DisableMessageRetention instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TimeGivenInMinutes0DisableMessageRetention"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TimeGivenInMinutes0DisableMessageRetention(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TimeGivenInMinutes0DisableMessageRetention.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TimeGivenInMinutes0DisableMessageRetention Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TimeGivenInMinutes0DisableMessageRetention Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TimeGivenInMinutes0DisableMessageRetention>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TimeGivenInMinutes0DisableMessageRetention instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TimeGivenInMinutes0DisableMessageRetention, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TimeGivenInMinutes0DisableMessageRetention> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TimeGivenInMinutes0DisableMessageRetention>();
                    }
                    finally
                    {
