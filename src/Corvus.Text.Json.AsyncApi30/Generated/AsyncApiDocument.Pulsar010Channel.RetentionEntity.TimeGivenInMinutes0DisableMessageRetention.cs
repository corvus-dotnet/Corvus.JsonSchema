    ...
    public readonly partial struct Pulsar010Channel
    {
        ...
        public readonly partial struct RetentionEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public static TimeGivenInMinutes0DisableMessageRetention DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator System.Numerics.BigInteger(TimeGivenInMinutes0DisableMessageRetention value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TimeGivenInMinutes0DisableMessageRetention left, in TimeGivenInMinutes0DisableMessageRetention right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TimeGivenInMinutes0DisableMessageRetention left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                {
                    return TimeGivenInMinutes0DisableMessageRetention.From(instance);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TimeGivenInMinutes0DisableMessageRetention? result)
                {
                    return JsonElementHelpers.TryParseValue<TimeGivenInMinutes0DisableMessageRetention>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TimeGivenInMinutes0DisableMessageRetention(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TimeGivenInMinutes0DisableMessageRetention IJsonElement<TimeGivenInMinutes0DisableMessageRetention>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TimeGivenInMinutes0DisableMessageRetention: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TimeGivenInMinutes0DisableMessageRetention"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TimeGivenInMinutes0DisableMessageRetention"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TimeGivenInMinutes0DisableMessageRetention Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TimeGivenInMinutes0DisableMessageRetention>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TimeGivenInMinutes0DisableMessageRetention"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TimeGivenInMinutes0DisableMessageRetention Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TimeGivenInMinutes0DisableMessageRetention>(_idx);
                    }
