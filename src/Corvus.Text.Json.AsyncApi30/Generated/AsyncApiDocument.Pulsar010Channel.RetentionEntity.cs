...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Pulsar010Channel
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RetentionEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RetentionEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RetentionEntity DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention Size
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SizeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.SizeGivenInMegaBytes0DisableMessageRetention value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention Time
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Pulsar010Channel.RetentionEntity.TimeGivenInMinutes0DisableMessageRetention value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RetentionEntity left, in RetentionEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RetentionEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RetentionEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RetentionEntity(JsonElement instance)
            {
                return RetentionEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RetentionEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RetentionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RetentionEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RetentionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RetentionEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RetentionEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RetentionEntity>(json, options);
            }
            ...
            /// </exception>
            public static RetentionEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RetentionEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RetentionEntity? result)
            {
                return JsonElementHelpers.TryParseValue<RetentionEntity>(ref reader, out result);
            }
...
#if NET
            static RetentionEntity IJsonElement<RetentionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RetentionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RetentionEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RetentionEntity>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="Time"/>.
                /// </summary>
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Time"/>.
                /// </summary>
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Time"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Time => [0x65, 0x00, 0x00, 0x00, 0x22, 0x74, 0x69, 0x6D, 0x65, 0x22];
            }
        }
    }
}
