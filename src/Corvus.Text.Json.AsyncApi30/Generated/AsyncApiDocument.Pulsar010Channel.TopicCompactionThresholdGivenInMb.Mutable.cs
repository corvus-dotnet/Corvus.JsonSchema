    ...
    public readonly partial struct Pulsar010Channel
    {
        ...
        public readonly partial struct TopicCompactionThresholdGivenInMb
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TopicCompactionThresholdGivenInMb instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TopicCompactionThresholdGivenInMb"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TopicCompactionThresholdGivenInMb(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TopicCompactionThresholdGivenInMb.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TopicCompactionThresholdGivenInMb Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TopicCompactionThresholdGivenInMb Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TopicCompactionThresholdGivenInMb>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TopicCompactionThresholdGivenInMb instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TopicCompactionThresholdGivenInMb, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TopicCompactionThresholdGivenInMb> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TopicCompactionThresholdGivenInMb>();
                }
                finally
                {
