...
public readonly partial struct AsyncApiDocument
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SaslGssapiSecurityScheme.TheTypeOfTheSecurityScheme Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SaslGssapiSecurityScheme.TheTypeOfTheSecurityScheme value))
                {
                    return value;
                }
