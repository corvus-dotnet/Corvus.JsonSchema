...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct SaslPlainSecurityScheme
    {
        ...
        public readonly partial struct TheTypeOfTheSecuritySchemeValidValues
#if NET8_0_OR_GREATER
            : IJsonElement<TheTypeOfTheSecuritySchemeValidValues>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TheTypeOfTheSecuritySchemeValidValues"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TheTypeOfTheSecuritySchemeValidValues(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TheTypeOfTheSecuritySchemeValidValues DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(TheTypeOfTheSecuritySchemeValidValues value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in TheTypeOfTheSecuritySchemeValidValues left, in TheTypeOfTheSecuritySchemeValidValues right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TheTypeOfTheSecuritySchemeValidValues left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TheTypeOfTheSecuritySchemeValidValues instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheTypeOfTheSecuritySchemeValidValues(JsonElement instance)
            {
                return TheTypeOfTheSecuritySchemeValidValues.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheSecuritySchemeValidValues From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheSecuritySchemeValidValues ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheSecuritySchemeValidValues>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheSecuritySchemeValidValues ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheSecuritySchemeValidValues>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheSecuritySchemeValidValues ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheSecuritySchemeValidValues>(json, options);
            }
            ...
            /// </exception>
            public static TheTypeOfTheSecuritySchemeValidValues ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheSecuritySchemeValidValues>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TheTypeOfTheSecuritySchemeValidValues? result)
            {
                return JsonElementHelpers.TryParseValue<TheTypeOfTheSecuritySchemeValidValues>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheTypeOfTheSecuritySchemeValidValues(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TheTypeOfTheSecuritySchemeValidValues IJsonElement<TheTypeOfTheSecuritySchemeValidValues>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheTypeOfTheSecuritySchemeValidValues: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheTypeOfTheSecuritySchemeValidValues"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheTypeOfTheSecuritySchemeValidValues"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TheTypeOfTheSecuritySchemeValidValues Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheTypeOfTheSecuritySchemeValidValues>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheTypeOfTheSecuritySchemeValidValues"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TheTypeOfTheSecuritySchemeValidValues Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TheTypeOfTheSecuritySchemeValidValues>(_idx);
                }
