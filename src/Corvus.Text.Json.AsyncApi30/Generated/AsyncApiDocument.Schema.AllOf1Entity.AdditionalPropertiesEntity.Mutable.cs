            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
...
#endif
                {
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.AllOf1Entity.AdditionalPropertiesEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                    {
                        ...
                        {
                            return matchJsonBoolean(Corvus.Text.Json.AsyncApi30.JsonBoolean.Mutable.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.AllOf1Entity.AdditionalPropertiesEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.JsonSchema.Evaluate(_parent, _idx))
                        {
                        ...
                        if (Corvus.Text.Json.AsyncApi30.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchJsonBoolean(Corvus.Text.Json.AsyncApi30.JsonBoolean.Mutable.From(this));
                        }
                    ...
                    public TAccumulator MatchEvery<TAccumulator>(
                        ...
                        Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.AllOf1Entity.AdditionalPropertiesEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                    {
                        bool matched = false;
                        ...
                        {
                            matched = true;
                            accumulator = matchJsonBoolean(Corvus.Text.Json.AsyncApi30.JsonBoolean.Mutable.From(this), accumulator);
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.JsonBoolean.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsJsonBoolean(out Corvus.Text.Json.AsyncApi30.JsonBoolean.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi30.JsonBoolean.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.Text.Json.AsyncApi30.JsonBoolean instance) => new(JsonElement.From(instance));
