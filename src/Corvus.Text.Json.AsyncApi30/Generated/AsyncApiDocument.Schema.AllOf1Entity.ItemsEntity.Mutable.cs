        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct ItemsEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsSchemaArray(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.AllOf1Entity.ItemsEntity.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                        {
