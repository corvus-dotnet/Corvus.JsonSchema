    ...
    public readonly partial struct Schema
    {
        ...
        public readonly partial struct AllOf1Entity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="OneOfSArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal OneOfSArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static OneOfSArray DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in OneOfSArray left, in OneOfSArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in OneOfSArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(OneOfSArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OneOfSArray(JsonElement instance)
                {
                    return OneOfSArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOfSArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOfSArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOfSArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOfSArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOfSArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOfSArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOfSArray>(json, options);
                }
                ...
                /// </exception>
                public static OneOfSArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<OneOfSArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out OneOfSArray? result)
                {
                    return JsonElementHelpers.TryParseValue<OneOfSArray>(ref reader, out result);
                }
...
#if NET
                static OneOfSArray IJsonElement<OneOfSArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OneOfSArray: ValueKind = {ValueKind} : \"{ToString()}\"";
