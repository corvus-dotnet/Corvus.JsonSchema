...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct SecurityRequirements
#if NET8_0_OR_GREATER
        : IJsonElement<SecurityRequirements>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityRequirements"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SecurityRequirements(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SecurityRequirements DefaultInstance { get; }
        ...
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SecurityRequirements.ItemsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SecurityRequirements.ItemsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SecurityRequirements.ItemsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SecurityRequirements.ItemsEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in SecurityRequirements left, in SecurityRequirements right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SecurityRequirements left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SecurityRequirements instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SecurityRequirements(JsonElement instance)
        {
            return SecurityRequirements.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SecurityRequirements From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SecurityRequirements ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SecurityRequirements>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SecurityRequirements ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SecurityRequirements>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SecurityRequirements ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SecurityRequirements>(json, options);
        }
        ...
        /// </exception>
        public static SecurityRequirements ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SecurityRequirements>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SecurityRequirements? result)
        {
            return JsonElementHelpers.TryParseValue<SecurityRequirements>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SecurityRequirements(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SecurityRequirements IJsonElement<SecurityRequirements>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SecurityRequirements: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SecurityRequirements"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SecurityRequirements"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SecurityRequirements Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SecurityRequirements>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SecurityRequirements"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SecurityRequirements Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SecurityRequirements>(_idx);
            }
