    ...
    public readonly partial struct Server
    {
            ...
            : IJsonElement<CcdtQueueManagerNameEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1ibmmq~10.1.0~1server.json/properties/ccdtQueueManagerName"u8, buffer, out written);
