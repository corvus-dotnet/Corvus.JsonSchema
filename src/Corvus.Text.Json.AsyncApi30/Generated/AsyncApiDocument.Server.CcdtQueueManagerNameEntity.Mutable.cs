    ...
    public readonly partial struct Server
    {
        ...
        public readonly partial struct CcdtQueueManagerNameEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CcdtQueueManagerNameEntity, Mutable>(CcdtQueueManagerNameEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(CcdtQueueManagerNameEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CcdtQueueManagerNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CcdtQueueManagerNameEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CcdtQueueManagerNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CcdtQueueManagerNameEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CcdtQueueManagerNameEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CcdtQueueManagerNameEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CcdtQueueManagerNameEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CcdtQueueManagerNameEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CcdtQueueManagerNameEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CcdtQueueManagerNameEntity>();
                }
                finally
                {
