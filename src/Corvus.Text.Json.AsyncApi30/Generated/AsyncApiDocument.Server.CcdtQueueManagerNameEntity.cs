...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Server
    {
        ...
        public readonly partial struct CcdtQueueManagerNameEntity
#if NET8_0_OR_GREATER
            : IJsonElement<CcdtQueueManagerNameEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CcdtQueueManagerNameEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CcdtQueueManagerNameEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CcdtQueueManagerNameEntity DefaultInstance { get; } = ParsedJsonDocument<CcdtQueueManagerNameEntity>.StringConstant([.."\"*\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(CcdtQueueManagerNameEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in CcdtQueueManagerNameEntity left, in CcdtQueueManagerNameEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CcdtQueueManagerNameEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(CcdtQueueManagerNameEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CcdtQueueManagerNameEntity(JsonElement instance)
            {
                return CcdtQueueManagerNameEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CcdtQueueManagerNameEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CcdtQueueManagerNameEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CcdtQueueManagerNameEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CcdtQueueManagerNameEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CcdtQueueManagerNameEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CcdtQueueManagerNameEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CcdtQueueManagerNameEntity>(json, options);
            }
            ...
            /// </exception>
            public static CcdtQueueManagerNameEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CcdtQueueManagerNameEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CcdtQueueManagerNameEntity? result)
            {
                return JsonElementHelpers.TryParseValue<CcdtQueueManagerNameEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CcdtQueueManagerNameEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CcdtQueueManagerNameEntity IJsonElement<CcdtQueueManagerNameEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CcdtQueueManagerNameEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CcdtQueueManagerNameEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CcdtQueueManagerNameEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CcdtQueueManagerNameEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CcdtQueueManagerNameEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CcdtQueueManagerNameEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CcdtQueueManagerNameEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CcdtQueueManagerNameEntity>(_idx);
                }
