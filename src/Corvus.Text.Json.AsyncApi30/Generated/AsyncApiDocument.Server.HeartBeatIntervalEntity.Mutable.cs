    ...
    public readonly partial struct Server
    {
        ...
        public readonly partial struct HeartBeatIntervalEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HeartBeatIntervalEntity, Mutable>(HeartBeatIntervalEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(HeartBeatIntervalEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HeartBeatIntervalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HeartBeatIntervalEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HeartBeatIntervalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HeartBeatIntervalEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HeartBeatIntervalEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HeartBeatIntervalEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HeartBeatIntervalEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HeartBeatIntervalEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HeartBeatIntervalEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HeartBeatIntervalEntity>();
                }
                finally
                {
