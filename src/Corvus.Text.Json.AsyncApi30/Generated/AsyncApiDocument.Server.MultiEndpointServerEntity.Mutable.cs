...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Server
    {
        ...
        public readonly partial struct MultiEndpointServerEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MultiEndpointServerEntity, Mutable>(MultiEndpointServerEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(MultiEndpointServerEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MultiEndpointServerEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MultiEndpointServerEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MultiEndpointServerEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MultiEndpointServerEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MultiEndpointServerEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MultiEndpointServerEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MultiEndpointServerEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MultiEndpointServerEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MultiEndpointServerEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MultiEndpointServerEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MultiEndpointServerEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MultiEndpointServerEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MultiEndpointServerEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MultiEndpointServerEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MultiEndpointServerEntity>();
                }
                finally
                {
