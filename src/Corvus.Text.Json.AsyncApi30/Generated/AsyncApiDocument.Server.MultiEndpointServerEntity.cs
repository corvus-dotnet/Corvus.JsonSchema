...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Server
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MultiEndpointServerEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MultiEndpointServerEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MultiEndpointServerEntity DefaultInstance { get; } = ParsedJsonDocument<MultiEndpointServerEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(MultiEndpointServerEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in MultiEndpointServerEntity left, in MultiEndpointServerEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MultiEndpointServerEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MultiEndpointServerEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MultiEndpointServerEntity(JsonElement instance)
            {
                return MultiEndpointServerEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MultiEndpointServerEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MultiEndpointServerEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MultiEndpointServerEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MultiEndpointServerEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MultiEndpointServerEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MultiEndpointServerEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MultiEndpointServerEntity>(json, options);
            }
            ...
            /// </exception>
            public static MultiEndpointServerEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MultiEndpointServerEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MultiEndpointServerEntity? result)
            {
                return JsonElementHelpers.TryParseValue<MultiEndpointServerEntity>(ref reader, out result);
            }
...
#if NET
            static MultiEndpointServerEntity IJsonElement<MultiEndpointServerEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MultiEndpointServerEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public MultiEndpointServerEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public MultiEndpointServerEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MultiEndpointServerEntity>(_idx);
                }
