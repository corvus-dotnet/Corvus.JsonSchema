        ...
        public readonly partial struct PulsarEntity
        {
            ...
            public readonly partial struct IfNoBindingVersionSpecifiedUseTheLatestBinding
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Mutable BindingVersion
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BindingVersionUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>tenant</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.AsyncApi30.JsonString.Mutable Tenant
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TenantUtf8, out Corvus.Text.Json.AsyncApi30.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetBindingVersion(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// <summary>
                    /// Set the <c>tenant</c> property.
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetTenant(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TenantUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TenantUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Tenant, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>tenant</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveTenant()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TenantUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    /// <param name="matchCorvusTextJsonAsyncApi30AsyncApiDocumentType010Server">Match a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server"/>.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server, TContext, TResult> matchCorvusTextJsonAsyncApi30AsyncApiDocumentType010Server,
                        Matcher<IfNoBindingVersionSpecifiedUseTheLatestBinding, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.PulsarEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusTextJsonAsyncApi30AsyncApiDocumentType010Server(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server, TResult> matchCorvusTextJsonAsyncApi30AsyncApiDocumentType010Server,
                        Matcher<IfNoBindingVersionSpecifiedUseTheLatestBinding, TResult> defaultMatch)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.PulsarEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusTextJsonAsyncApi30AsyncApiDocumentType010Server(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.From(this));
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsType010Server(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.Mutable.From(this);
                            return true;
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.PulsarEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsIfEntity(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.PulsarEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.PulsarEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.PulsarEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.IfEntity.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source _createArg1;
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.PulsarEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.PulsarEntity.IfNoBindingVersionSpecifiedUseTheLatestBinding.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source bindingVersion = default,
                        in Corvus.Text.Json.AsyncApi30.JsonString.Source tenant = default)
                    {
                        bindingVersion.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BindingVersion, ref builder);
                        tenant.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Tenant, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="IfNoBindingVersionSpecifiedUseTheLatestBinding"/>.
                    /// </summary>
                    public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source tenant = default)
                    {
                        Create(ref _builder, bindingVersion, tenant);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <param name="tenant">The value of the <c>"tenant"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source bindingVersion = default, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source tenant = default)
                {
                    return new Source(bindingVersion, tenant);
                }
                ...
                /// <param name="tenant">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source tenant = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(bindingVersion, tenant);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                public static ParsedJsonDocument<IfNoBindingVersionSpecifiedUseTheLatestBinding> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source tenant = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
