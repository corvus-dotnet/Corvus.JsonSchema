    ...
    public readonly partial struct ServerBindingsObject
    {
        ...
        public readonly partial struct SolaceEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Server" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsSolace020Server(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Server result)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Server.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Server.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.SolaceEntity.AllOf3Entity.RequiredBindingVersion" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredBindingVersion(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.SolaceEntity.AllOf3Entity.RequiredBindingVersion result)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.SolaceEntity.AllOf3Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.SolaceEntity.AllOf3Entity.RequiredBindingVersion.From(this);
                        return true;
                    }
                ...
                /// <param name="matchCorvusTextJsonAsyncApi30AsyncApiDocumentSolace020Server">Match a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Server"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Server, TContext, TResult> matchCorvusTextJsonAsyncApi30AsyncApiDocumentSolace020Server,
...
#endif
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.SolaceEntity.AllOf3Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusTextJsonAsyncApi30AsyncApiDocumentSolace020Server(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Server.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Server, TResult> matchCorvusTextJsonAsyncApi30AsyncApiDocumentSolace020Server,
                    Matcher<AllOf3Entity, TResult> defaultMatch)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerBindingsObject.SolaceEntity.AllOf3Entity.RequiredBindingVersion.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusTextJsonAsyncApi30AsyncApiDocumentSolace020Server(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Server.From(this));
                    }
