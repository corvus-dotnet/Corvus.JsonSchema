...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct ServerVariable
    {
...
#endif
        {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnum(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerVariable.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExamples(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.ServerVariable.AnArrayOfEArray.Source value)
            {
                CheckValidInstance();
