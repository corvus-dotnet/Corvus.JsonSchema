        ...
        public readonly partial struct Ordering
        {
            ...
            public readonly partial struct DefinesTheTypeOfSnsTopic
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DefinesTheTypeOfSnsTopic instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DefinesTheTypeOfSnsTopic"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DefinesTheTypeOfSnsTopic(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DefinesTheTypeOfSnsTopic.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefinesTheTypeOfSnsTopic Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefinesTheTypeOfSnsTopic Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DefinesTheTypeOfSnsTopic>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DefinesTheTypeOfSnsTopic instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (DefinesTheTypeOfSnsTopic)value;
                ...
                {
                    return workspace.CreateBuilder<DefinesTheTypeOfSnsTopic, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DefinesTheTypeOfSnsTopic> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DefinesTheTypeOfSnsTopic>();
                    }
                    finally
                    {
