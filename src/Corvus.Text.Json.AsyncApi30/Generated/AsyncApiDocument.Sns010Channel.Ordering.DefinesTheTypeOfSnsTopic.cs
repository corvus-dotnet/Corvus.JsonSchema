    ...
    public readonly partial struct Sns010Channel
    {
        ...
        public readonly partial struct Ordering
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DefinesTheTypeOfSnsTopic"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DefinesTheTypeOfSnsTopic(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DefinesTheTypeOfSnsTopic DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(DefinesTheTypeOfSnsTopic value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in DefinesTheTypeOfSnsTopic left, in DefinesTheTypeOfSnsTopic right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DefinesTheTypeOfSnsTopic left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DefinesTheTypeOfSnsTopic instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesTheTypeOfSnsTopic(JsonElement instance)
                {
                    return DefinesTheTypeOfSnsTopic.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefinesTheTypeOfSnsTopic From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefinesTheTypeOfSnsTopic ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefinesTheTypeOfSnsTopic>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefinesTheTypeOfSnsTopic ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefinesTheTypeOfSnsTopic>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefinesTheTypeOfSnsTopic ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefinesTheTypeOfSnsTopic>(json, options);
                }
                ...
                /// </exception>
                public static DefinesTheTypeOfSnsTopic ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DefinesTheTypeOfSnsTopic>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DefinesTheTypeOfSnsTopic? result)
                {
                    return JsonElementHelpers.TryParseValue<DefinesTheTypeOfSnsTopic>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DefinesTheTypeOfSnsTopic(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static DefinesTheTypeOfSnsTopic IJsonElement<DefinesTheTypeOfSnsTopic>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesTheTypeOfSnsTopic: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DefinesTheTypeOfSnsTopic"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DefinesTheTypeOfSnsTopic"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public DefinesTheTypeOfSnsTopic Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DefinesTheTypeOfSnsTopic>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DefinesTheTypeOfSnsTopic"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public DefinesTheTypeOfSnsTopic Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DefinesTheTypeOfSnsTopic>(_idx);
                    }
