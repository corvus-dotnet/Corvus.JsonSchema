    ...
    public readonly partial struct Sns010Channel
    {
            ...
            : IJsonElement<Ordering>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchContentBasedDeduplication(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1sns~10.1.0~1channel.json/definitions/ordering"u8, buffer, out written);
