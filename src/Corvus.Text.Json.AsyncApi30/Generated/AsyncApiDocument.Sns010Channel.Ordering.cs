...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sns010Channel
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Ordering"/> struct.
            /// </summary>
            ...
            internal Ordering(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Ordering DefaultInstance { get; }
            ...
            /// <summary>
            /// Gets the (optional) <c>contentBasedDeduplication</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonBoolean ContentBasedDeduplication
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentBasedDeduplicationUtf8, out Corvus.Text.Json.AsyncApi30.JsonBoolean value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Ordering.DefinesTheTypeOfSnsTopic Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Ordering.DefinesTheTypeOfSnsTopic value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in Ordering left, in Ordering right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Ordering left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Ordering instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Ordering(JsonElement instance)
            {
                return Ordering.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Ordering From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Ordering ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<Ordering>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Ordering ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<Ordering>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Ordering ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<Ordering>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static Ordering ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<Ordering>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Ordering? result)
            {
                return JsonElementHelpers.TryParseValue<Ordering>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Ordering(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Ordering IJsonElement<Ordering>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Ordering: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Ordering"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Ordering"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Ordering>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Ordering"/> that lives for the lifetime of its
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="ContentBasedDeduplication"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="ContentBasedDeduplication"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ContentBasedDeduplicationUtf8 => "contentBasedDeduplication"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="ContentBasedDeduplication"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ContentBasedDeduplication => "contentBasedDeduplication"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="ContentBasedDeduplication"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ContentBasedDeduplication => [0xB5, 0x01, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x6E, 0x74, 0x65, 0x6E, 0x74, 0x42, 0x61, 0x73, 0x65, 0x64, 0x44, 0x65, 0x64, 0x75, 0x70, 0x6C, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x22];
