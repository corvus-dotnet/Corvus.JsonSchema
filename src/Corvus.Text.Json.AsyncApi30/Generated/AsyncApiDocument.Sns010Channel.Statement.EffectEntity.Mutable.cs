        ...
        public readonly partial struct Statement
        {
            ...
            public readonly partial struct EffectEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EffectEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EffectEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EffectEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EffectEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EffectEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EffectEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EffectEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EffectEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (EffectEntity)value;
                ...
                {
                    return workspace.CreateBuilder<EffectEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<EffectEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<EffectEntity>();
                    }
                    finally
                    {
