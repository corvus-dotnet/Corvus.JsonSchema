    ...
    public readonly partial struct Sns010Channel
    {
            ...
            : IJsonElement<Statement>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchEffect(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                ...
                private static void MatchPrincipal(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1sns~10.1.0~1channel.json/definitions/statement"u8, buffer, out written);
