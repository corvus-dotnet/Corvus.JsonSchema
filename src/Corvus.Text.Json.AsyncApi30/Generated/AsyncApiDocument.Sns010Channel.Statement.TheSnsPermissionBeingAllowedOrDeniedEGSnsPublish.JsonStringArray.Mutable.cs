            ...
            public readonly partial struct TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish
            {
                ...
                public readonly partial struct JsonStringArray
                {
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
