        ...
        public readonly partial struct Statement
        {
            ...
            public readonly partial struct TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish
            {
...
#endif
                {
                    ...
                    public static explicit operator Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Mutable(Mutable value)
                    {
                        return Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Mutable.From(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    public static explicit operator Mutable(TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish>(_idx);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        ...
                        {
                            return matchJsonStringArray(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Mutable.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.Text.Json.AsyncApi30.JsonString.JsonSchema.Evaluate(_parent, _idx))
                        {
                        ...
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchJsonStringArray(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Mutable.From(this));
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsJsonStringArray(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Mutable result)
                    {
                        if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.JsonStringArray.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish>();
                    }
                    finally
                    {
