...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sns010Channel
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Statement"/> struct.
            /// </summary>
            ...
            internal Statement(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Statement DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish Action
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActionUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheSnsPermissionBeingAllowedOrDeniedEGSnsPublish value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.EffectEntity Effect
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EffectUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.EffectEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo Principal
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrincipalUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in Statement left, in Statement right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Statement left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Statement instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Statement(JsonElement instance)
            {
                return Statement.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Statement From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Statement ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<Statement>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Statement ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<Statement>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Statement ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<Statement>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static Statement ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<Statement>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Statement? result)
            {
                return JsonElementHelpers.TryParseValue<Statement>(ref reader, out result);
            }
...
#if NET
            static Statement IJsonElement<Statement>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Statement: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="Effect"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Effect"/>.
                /// </summary>
                public static ReadOnlySpan<byte> EffectUtf8 => "effect"u8;
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Effect"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Effect => "effect"u8;
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Effect"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Effect => [0x85, 0x00, 0x00, 0x00, 0x22, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74, 0x22];
