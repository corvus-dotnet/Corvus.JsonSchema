...
public readonly partial struct AsyncApiDocument
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Sns010Channel"/> struct.
        /// </summary>
        ...
        internal Sns010Channel(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Sns010Channel DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Ordering OrderingValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderingValueUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Ordering value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Policy PolicyValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PolicyValueUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Channel.Policy value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Sns010Channel left, in Sns010Channel right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Sns010Channel left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Sns010Channel instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Sns010Channel(JsonElement instance)
        {
            return Sns010Channel.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Sns010Channel From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Sns010Channel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Sns010Channel>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Sns010Channel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Sns010Channel>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Sns010Channel ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Sns010Channel>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Sns010Channel ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Sns010Channel>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Sns010Channel? result)
        {
            return JsonElementHelpers.TryParseValue<Sns010Channel>(ref reader, out result);
        }
...
#if NET
        static Sns010Channel IJsonElement<Sns010Channel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Sns010Channel: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="OrderingValue"/>.
            /// </summary>
            public const string OrderingValue = "ordering";
            ...
            /// Gets the JSON property name for <see cref="OrderingValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> OrderingValueUtf8 => "ordering"u8;
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="OrderingValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> OrderingValue => "ordering"u8;
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="OrderingValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> OrderingValue => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x72, 0x64, 0x65, 0x72, 0x69, 0x6E, 0x67, 0x22];
