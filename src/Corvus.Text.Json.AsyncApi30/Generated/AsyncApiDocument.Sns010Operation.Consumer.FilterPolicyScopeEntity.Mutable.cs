        ...
        public readonly partial struct Consumer
        {
            ...
            public readonly partial struct FilterPolicyScopeEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FilterPolicyScopeEntity, Mutable>(FilterPolicyScopeEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(FilterPolicyScopeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FilterPolicyScopeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FilterPolicyScopeEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new FilterPolicyScopeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FilterPolicyScopeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="FilterPolicyScopeEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="FilterPolicyScopeEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FilterPolicyScopeEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<FilterPolicyScopeEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="FilterPolicyScopeEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FilterPolicyScopeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FilterPolicyScopeEntity>(_idx);
                    }
                    ...
                    /// <param name="matchMessageAttributes">Match 1st item.</param>
                    /// <param name="matchMessageBody">Match 2nd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchMessageAttributes,
                        Func<TContext, TResult> matchMessageBody,
...
#endif
                    {
                        ...
                        {
                            return matchMessageAttributes(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchMessageBody(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchMessageAttributes,
                        Func<TResult> matchMessageBody,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchMessageAttributes();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchMessageBody();
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FilterPolicyScopeEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (FilterPolicyScopeEntity)value;
                ...
                {
                    return workspace.CreateBuilder<FilterPolicyScopeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<FilterPolicyScopeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<FilterPolicyScopeEntity>();
                    }
                    finally
                    {
