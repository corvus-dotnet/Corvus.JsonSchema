    ...
    public readonly partial struct Sns010Operation
    {
        ...
        public readonly partial struct Consumer
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheProtocolThatThisEndpointReceivesMessagesBy"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheProtocolThatThisEndpointReceivesMessagesBy(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheProtocolThatThisEndpointReceivesMessagesBy DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheProtocolThatThisEndpointReceivesMessagesBy value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheProtocolThatThisEndpointReceivesMessagesBy left, in TheProtocolThatThisEndpointReceivesMessagesBy right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheProtocolThatThisEndpointReceivesMessagesBy left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheProtocolThatThisEndpointReceivesMessagesBy instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheProtocolThatThisEndpointReceivesMessagesBy(JsonElement instance)
                {
                    return TheProtocolThatThisEndpointReceivesMessagesBy.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheProtocolThatThisEndpointReceivesMessagesBy From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheProtocolThatThisEndpointReceivesMessagesBy ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheProtocolThatThisEndpointReceivesMessagesBy>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheProtocolThatThisEndpointReceivesMessagesBy ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheProtocolThatThisEndpointReceivesMessagesBy>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheProtocolThatThisEndpointReceivesMessagesBy ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheProtocolThatThisEndpointReceivesMessagesBy>(json, options);
                }
                ...
                /// </exception>
                public static TheProtocolThatThisEndpointReceivesMessagesBy ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheProtocolThatThisEndpointReceivesMessagesBy>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheProtocolThatThisEndpointReceivesMessagesBy? result)
                {
                    return JsonElementHelpers.TryParseValue<TheProtocolThatThisEndpointReceivesMessagesBy>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheProtocolThatThisEndpointReceivesMessagesBy(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheProtocolThatThisEndpointReceivesMessagesBy IJsonElement<TheProtocolThatThisEndpointReceivesMessagesBy>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheProtocolThatThisEndpointReceivesMessagesBy: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheProtocolThatThisEndpointReceivesMessagesBy"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheProtocolThatThisEndpointReceivesMessagesBy"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheProtocolThatThisEndpointReceivesMessagesBy Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheProtocolThatThisEndpointReceivesMessagesBy>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheProtocolThatThisEndpointReceivesMessagesBy"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheProtocolThatThisEndpointReceivesMessagesBy Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheProtocolThatThisEndpointReceivesMessagesBy>(_idx);
                    }
                ...
                /// <param name="matchEmail">Match 3rd item.</param>
                /// <param name="matchEmailJson">Match 4th item.</param>
                /// <param name="matchSms">Match 5th item.</param>
                /// <param name="matchSqs">Match 6th item.</param>
                /// <param name="matchApplication">Match 7th item.</param>
                /// <param name="matchLambda">Match 8th item.</param>
                /// <param name="matchFirehose">Match 9th item.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Func<TContext, TResult> matchEmailJson,
                    Func<TContext, TResult> matchSms,
                    Func<TContext, TResult> matchSqs,
                    Func<TContext, TResult> matchApplication,
                    Func<TContext, TResult> matchLambda,
                    Func<TContext, TResult> matchFirehose,
...
#endif
                {
                    ...
                    {
                        return matchEmailJson(context);
                    }

                    if (this.ValueEquals(Constants.Enum5))
                    {
                        return matchSms(context);
                    }

                    if (this.ValueEquals(Constants.Enum6))
                    {
                        return matchSqs(context);
                    }
                    ...
                    {
                        return matchLambda(context);
                    }

                    if (this.ValueEquals(Constants.Enum9))
                    {
                        return matchFirehose(context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> matchEmailJson,
                    Func<TResult> matchSms,
                    Func<TResult> matchSqs,
                    Func<TResult> matchApplication,
                    Func<TResult> matchLambda,
                    Func<TResult> matchFirehose,
