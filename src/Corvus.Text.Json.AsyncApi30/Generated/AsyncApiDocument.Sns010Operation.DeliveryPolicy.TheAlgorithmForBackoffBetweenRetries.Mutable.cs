        ...
        public readonly partial struct DeliveryPolicy
        {
            ...
            public readonly partial struct TheAlgorithmForBackoffBetweenRetries
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TheAlgorithmForBackoffBetweenRetries instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheAlgorithmForBackoffBetweenRetries"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheAlgorithmForBackoffBetweenRetries(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheAlgorithmForBackoffBetweenRetries.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheAlgorithmForBackoffBetweenRetries Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheAlgorithmForBackoffBetweenRetries Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheAlgorithmForBackoffBetweenRetries>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheAlgorithmForBackoffBetweenRetries instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (TheAlgorithmForBackoffBetweenRetries)value;
                ...
                {
                    return workspace.CreateBuilder<TheAlgorithmForBackoffBetweenRetries, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheAlgorithmForBackoffBetweenRetries> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheAlgorithmForBackoffBetweenRetries>();
                    }
                    finally
                    {
