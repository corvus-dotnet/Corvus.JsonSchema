    ...
    public readonly partial struct Sns010Operation
    {
        ...
        public readonly partial struct DeliveryPolicy
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheAlgorithmForBackoffBetweenRetries"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheAlgorithmForBackoffBetweenRetries(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheAlgorithmForBackoffBetweenRetries DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheAlgorithmForBackoffBetweenRetries value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheAlgorithmForBackoffBetweenRetries left, in TheAlgorithmForBackoffBetweenRetries right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheAlgorithmForBackoffBetweenRetries left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheAlgorithmForBackoffBetweenRetries instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheAlgorithmForBackoffBetweenRetries(JsonElement instance)
                {
                    return TheAlgorithmForBackoffBetweenRetries.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheAlgorithmForBackoffBetweenRetries From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheAlgorithmForBackoffBetweenRetries ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheAlgorithmForBackoffBetweenRetries>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheAlgorithmForBackoffBetweenRetries ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheAlgorithmForBackoffBetweenRetries>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheAlgorithmForBackoffBetweenRetries ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheAlgorithmForBackoffBetweenRetries>(json, options);
                }
                ...
                /// </exception>
                public static TheAlgorithmForBackoffBetweenRetries ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheAlgorithmForBackoffBetweenRetries>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheAlgorithmForBackoffBetweenRetries? result)
                {
                    return JsonElementHelpers.TryParseValue<TheAlgorithmForBackoffBetweenRetries>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheAlgorithmForBackoffBetweenRetries(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheAlgorithmForBackoffBetweenRetries IJsonElement<TheAlgorithmForBackoffBetweenRetries>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheAlgorithmForBackoffBetweenRetries: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheAlgorithmForBackoffBetweenRetries"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheAlgorithmForBackoffBetweenRetries"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheAlgorithmForBackoffBetweenRetries Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheAlgorithmForBackoffBetweenRetries>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheAlgorithmForBackoffBetweenRetries"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheAlgorithmForBackoffBetweenRetries Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheAlgorithmForBackoffBetweenRetries>(_idx);
                    }
                ...
                /// <param name="matchArithmetic">Match 1st item.</param>
                /// <param name="matchExponential">Match 2nd item.</param>
                /// <param name="matchGeometric">Match 3rd item.</param>
                /// <param name="matchLinear">Match 4th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchArithmetic,
                    Func<TContext, TResult> matchExponential,
                    Func<TContext, TResult> matchGeometric,
...
#endif
                {
                    ...
                    {
                        return matchArithmetic(context);
                    }
