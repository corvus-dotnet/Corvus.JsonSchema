    ...
    public readonly partial struct Sns010Operation
    {
            ...
            : IJsonElement<Identifier>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchArn(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1sns~10.1.0~1operation.json/definitions/identifier"u8, buffer, out written);
