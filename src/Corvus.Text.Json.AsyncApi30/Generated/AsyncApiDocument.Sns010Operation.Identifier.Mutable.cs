    ...
    public readonly partial struct Sns010Operation
    {
        ...
        public readonly partial struct Identifier
        {
...
#endif
            {
                ...
                public void SetArn(in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetEmail(in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPhone(in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetUrl(in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();
