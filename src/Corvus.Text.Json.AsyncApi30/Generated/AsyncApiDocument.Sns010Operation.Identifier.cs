...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sns010Operation
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonString Arn
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArnUtf8, out Corvus.Text.Json.AsyncApi30.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonString Email
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.Text.Json.AsyncApi30.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonString Phone
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhoneUtf8, out Corvus.Text.Json.AsyncApi30.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonString Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.Text.Json.AsyncApi30.JsonString value))
                    {
                        return value;
                    }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Arn"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Arn"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ArnUtf8 => "arn"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Arn"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Arn => "arn"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Arn"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Arn => [0x55, 0x00, 0x00, 0x00, 0x22, 0x61, 0x72, 0x6E, 0x22];
