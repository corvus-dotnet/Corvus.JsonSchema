...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Sns010Operation>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyConsumersPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("consumers"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyConsumersNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("consumers"u8, buffer, out written);

            private const int RequiredOffsetForConsumers = 0;
            private const uint RequiredBitForConsumers = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForConsumers;
            ...
            private static readonly JsonSchemaPathProvider ConsumersSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/consumers"u8, buffer, out written);
            ...
            private static readonly JsonSchemaPathProvider TopicSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/topic/$ref"u8, buffer, out written);
            ...
            private static void MatchBindingVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.TheVersionOfThisBinding.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.TheVersionOfThisBinding.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchConsumers(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.ConsumerArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ConsumersUtf8,
                        evaluationPath: ConsumersSchemaEvaluationPath);

                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.ConsumerArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                requiredBitBuffer[RequiredOffsetForConsumers] |= RequiredBitForConsumers;
            }
            ...
            private static void MatchDeliveryPolicyValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.DeliveryPolicy.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static void MatchTopic(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator>([
                    ...
                    (static () => JsonPropertyNames.ConsumersUtf8, MatchConsumers),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1sns~10.1.0~1operation.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1sns~10.1.0~1operation.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1sns~10.1.0~1operation.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyConsumersPresent, "consumers"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForConsumers] & RequiredBitForConsumers) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyConsumersNotPresent, "consumers"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyConsumersPresent, "consumers"u8, "required"u8);
