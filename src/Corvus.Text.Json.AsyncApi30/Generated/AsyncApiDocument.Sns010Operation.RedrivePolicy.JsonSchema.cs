    ...
    public readonly partial struct Sns010Operation
    {
            ...
            : IJsonElement<RedrivePolicy>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchDeadLetterQueue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                ...
                private static void MatchMaxReceiveCount(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1sns~10.1.0~1operation.json/definitions/redrivePolicy"u8, buffer, out written);
