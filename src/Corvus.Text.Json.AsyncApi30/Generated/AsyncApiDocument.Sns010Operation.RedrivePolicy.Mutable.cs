    ...
    public readonly partial struct Sns010Operation
    {
        ...
        public readonly partial struct RedrivePolicy
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RedrivePolicy instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RedrivePolicy"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RedrivePolicy(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Mutable DeadLetterQueue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeadLetterQueueUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Mutable MaxReceiveCount
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxReceiveCountUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Mutable.DefaultInstance;
                    }
                }
                ...
                public void SetDeadLetterQueue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("deadLetterQueue");
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetDeadLetterQueue<TContext>(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source<TContext> value)
                ...
                /// <summary>
                /// Set the <c>maxReceiveCount</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetMaxReceiveCount(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MaxReceiveCountUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxReceiveCountUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MaxReceiveCount, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>maxReceiveCount</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveMaxReceiveCount()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MaxReceiveCountUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RedrivePolicy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RedrivePolicy"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RedrivePolicy"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RedrivePolicy Clone()
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RedrivePolicy"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RedrivePolicy Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RedrivePolicy>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source _createArg1;
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source _createArg2;
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                public static implicit operator Source(RedrivePolicy instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source<TContext> _createArg1;
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source _createArg2;
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source<TContext> arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RedrivePolicy"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source deadLetterQueue,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source maxReceiveCount = default)
                {
                    deadLetterQueue.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DeadLetterQueue, ref builder);
                    maxReceiveCount.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MaxReceiveCount, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RedrivePolicy"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source deadLetterQueue, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source maxReceiveCount = default)
                {
                    Create(ref _builder, deadLetterQueue, maxReceiveCount);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source<TContext> deadLetterQueue,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source maxReceiveCount = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                ...
                #endif
                {
                    Create(context, ref _builder, deadLetterQueue, maxReceiveCount);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source<TContext> arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// </summary>
            /// <param name="deadLetterQueue">The value of the <c>"deadLetterQueue"</c> property.</param>
            /// <param name="maxReceiveCount">The value of the <c>"maxReceiveCount"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source deadLetterQueue, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source maxReceiveCount = default)
            {
                return new Source(deadLetterQueue, maxReceiveCount);
            }
            ...
            /// <param name="maxReceiveCount">The value of the <c>"maxReceiveCount"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source<TContext> deadLetterQueue, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source maxReceiveCount = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, deadLetterQueue, maxReceiveCount);
            }
            ...
            /// <param name="maxReceiveCount">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source deadLetterQueue, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source maxReceiveCount = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(deadLetterQueue, maxReceiveCount);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source<TContext> deadLetterQueue, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source maxReceiveCount = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, deadLetterQueue, maxReceiveCount);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RedrivePolicy, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RedrivePolicy> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RedrivePolicy>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RedrivePolicy> Create<TContext>(
            ...
            public static ParsedJsonDocument<RedrivePolicy> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source deadLetterQueue, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source maxReceiveCount = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RedrivePolicy> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.Identifier.Source<TContext> deadLetterQueue, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sns010Operation.RedrivePolicy.MaxReceiveCountEntity.Source maxReceiveCount = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
