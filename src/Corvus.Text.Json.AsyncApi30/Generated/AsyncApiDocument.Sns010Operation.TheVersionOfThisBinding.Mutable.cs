    ...
    public readonly partial struct Sns010Operation
    {
        ...
        public readonly partial struct TheVersionOfThisBinding
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheVersionOfThisBinding, Mutable>(TheVersionOfThisBinding.DefaultInstance);
                ...
                public static explicit operator Mutable(TheVersionOfThisBinding instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheVersionOfThisBinding"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheVersionOfThisBinding(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheVersionOfThisBinding.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheVersionOfThisBinding Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheVersionOfThisBinding Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheVersionOfThisBinding>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheVersionOfThisBinding instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheVersionOfThisBinding, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheVersionOfThisBinding> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheVersionOfThisBinding>();
                }
                finally
                {
