...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sns010Operation
    {
        ...
        public readonly partial struct TheVersionOfThisBinding
#if NET8_0_OR_GREATER
            : IJsonElement<TheVersionOfThisBinding>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TheVersionOfThisBinding"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TheVersionOfThisBinding(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TheVersionOfThisBinding DefaultInstance { get; } = ParsedJsonDocument<TheVersionOfThisBinding>.StringConstant([.."\"latest\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(TheVersionOfThisBinding value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in TheVersionOfThisBinding left, in TheVersionOfThisBinding right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TheVersionOfThisBinding left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TheVersionOfThisBinding instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheVersionOfThisBinding(JsonElement instance)
            {
                return TheVersionOfThisBinding.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheVersionOfThisBinding From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheVersionOfThisBinding ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheVersionOfThisBinding>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheVersionOfThisBinding ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheVersionOfThisBinding>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheVersionOfThisBinding ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheVersionOfThisBinding>(json, options);
            }
            ...
            /// </exception>
            public static TheVersionOfThisBinding ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TheVersionOfThisBinding>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TheVersionOfThisBinding? result)
            {
                return JsonElementHelpers.TryParseValue<TheVersionOfThisBinding>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheVersionOfThisBinding(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TheVersionOfThisBinding IJsonElement<TheVersionOfThisBinding>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheVersionOfThisBinding: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheVersionOfThisBinding"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheVersionOfThisBinding"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TheVersionOfThisBinding Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheVersionOfThisBinding>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheVersionOfThisBinding"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TheVersionOfThisBinding Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TheVersionOfThisBinding>(_idx);
                }
