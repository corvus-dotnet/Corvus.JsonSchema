        ...
        public readonly partial struct DestinationsEntityArray
        {
            ...
            public readonly partial struct DestinationsEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="DeliveryModeEntity"/> struct.
                    /// </summary>
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(DeliveryModeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// <summary>
                    /// Gets a <see cref="DeliveryModeEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DeliveryModeEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DeliveryModeEntity"/> that lives for the lifetime of its
                    ...
                    /// <param name="matchDirect">Match 1st item.</param>
                    /// <param name="matchPersistent">Match 2nd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchDirect,
