            ...
            public readonly partial struct DestinationsEntity
            {
                ...
                public readonly partial struct WithDestinationTypeQueue
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="QueueEntity"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal QueueEntity(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static QueueEntity DefaultInstance { get; }
                        ...
                        /// <summary>
                        /// Gets the (optional) <c>accessType</c> property.
                        /// </summary>
                        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.WithDestinationTypeQueue.QueueEntity.AccessTypeEntity AccessType
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AccessTypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.WithDestinationTypeQueue.QueueEntity.AccessTypeEntity value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.WithDestinationTypeQueue.QueueEntity.JsonStringArray TopicSubscriptions
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TopicSubscriptionsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.WithDestinationTypeQueue.QueueEntity.JsonStringArray value))
                                {
                                    return value;
                                }
                        ...
                        /// </returns>
                        public static bool operator ==(in QueueEntity left, in QueueEntity right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in QueueEntity left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(QueueEntity instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator QueueEntity(JsonElement instance)
                        {
                            return QueueEntity.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static QueueEntity From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static QueueEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<QueueEntity>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static QueueEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<QueueEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static QueueEntity ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<QueueEntity>(json, options);
                        }
                        ...
                        /// </exception>
                        public static QueueEntity ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<QueueEntity>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out QueueEntity? result)
                        {
                            return JsonElementHelpers.TryParseValue<QueueEntity>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new QueueEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static QueueEntity IJsonElement<QueueEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"QueueEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="QueueEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="QueueEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<QueueEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="QueueEntity"/> that lives for the lifetime of its
                        ...
                        {
                            /// <summary>
                            /// Gets the JSON property name for <see cref="AccessType"/>.
                            /// </summary>
                            ...
                            /// Gets the JSON property name for <see cref="AccessType"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> AccessTypeUtf8 => "accessType"u8;
                        ...
                        {
                            /// <summary>
                            /// Gets the escaped UTF-8 JSON property name for <see cref="AccessType"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> AccessType => "accessType"u8;
                        ...
                        {
                            /// <summary>
                            /// Gets the pre-baked property name blob for <see cref="AccessType"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> AccessType => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x79, 0x70, 0x65, 0x22];
