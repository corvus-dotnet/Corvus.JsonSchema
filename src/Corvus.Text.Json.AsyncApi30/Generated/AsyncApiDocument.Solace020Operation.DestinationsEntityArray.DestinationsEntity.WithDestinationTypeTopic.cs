        ...
        public readonly partial struct DestinationsEntityArray
        {
            ...
            public readonly partial struct DestinationsEntity
            {
                ...
                public readonly partial struct WithDestinationTypeTopic
                    ...
                    : IJsonElement<WithDestinationTypeTopic>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="WithDestinationTypeTopic"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal WithDestinationTypeTopic(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static WithDestinationTypeTopic DefaultInstance { get; }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.WithDestinationTypeTopic.DestinationTypeEntity DestinationType
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DestinationTypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.WithDestinationTypeTopic.DestinationTypeEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.WithDestinationTypeTopic.JsonStringArray TopicSubscriptions
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TopicSubscriptionsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.WithDestinationTypeTopic.JsonStringArray value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in WithDestinationTypeTopic left, in WithDestinationTypeTopic right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in WithDestinationTypeTopic left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(WithDestinationTypeTopic instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WithDestinationTypeTopic(JsonElement instance)
                    {
                        return WithDestinationTypeTopic.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithDestinationTypeTopic From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithDestinationTypeTopic ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<WithDestinationTypeTopic>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithDestinationTypeTopic ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<WithDestinationTypeTopic>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithDestinationTypeTopic ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<WithDestinationTypeTopic>(json, options);
                    }
                    ...
                    /// </exception>
                    public static WithDestinationTypeTopic ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<WithDestinationTypeTopic>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out WithDestinationTypeTopic? result)
                    {
                        return JsonElementHelpers.TryParseValue<WithDestinationTypeTopic>(ref reader, out result);
                    }
...
#if NET
                    static WithDestinationTypeTopic IJsonElement<WithDestinationTypeTopic>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WithDestinationTypeTopic: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public WithDestinationTypeTopic Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public WithDestinationTypeTopic Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<WithDestinationTypeTopic>(_idx);
                        }
                    ...
                    public static class JsonPropertyNames
                    {
                        ...
                        /// <summary>
                        /// Gets the JSON property name for <see cref="TopicSubscriptions"/>.
                        /// </summary>
                        public const string TopicSubscriptions = "topicSubscriptions";
                        ...
                        /// Gets the JSON property name for <see cref="TopicSubscriptions"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> TopicSubscriptionsUtf8 => "topicSubscriptions"u8;
                    }
                    ...
                    private static class JsonPropertyNamesEscaped
                    {
                        ...
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="TopicSubscriptions"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> TopicSubscriptions => "topicSubscriptions"u8;
                    }
                    ...
                    private static class JsonPropertyNamesPrebaked
                    {
                        ...
                        /// <summary>
                        /// Gets the pre-baked property name blob for <see cref="TopicSubscriptions"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> TopicSubscriptions => [0x45, 0x01, 0x00, 0x00, 0x22, 0x74, 0x6F, 0x70, 0x69, 0x63, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6F, 0x6E, 0x73, 0x22];
                    }
                }
            }
        }
