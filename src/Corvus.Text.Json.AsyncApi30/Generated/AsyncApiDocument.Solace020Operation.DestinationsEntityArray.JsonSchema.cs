    ...
    public readonly partial struct Solace020Operation
    {
            ...
            : IJsonElement<DestinationsEntityArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1solace~10.2.0~1operation.json/properties/destinations"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1solace~10.2.0~1operation.json/properties/destinations";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1solace~10.2.0~1operation.json/properties/destinations"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace020Operation.DestinationsEntityArray.DestinationsEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
