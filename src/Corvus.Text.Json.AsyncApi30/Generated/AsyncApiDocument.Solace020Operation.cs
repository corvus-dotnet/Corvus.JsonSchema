...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Solace020Operation
        ...
        : IJsonElement<Solace020Operation>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Solace020Operation"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Solace020Operation(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Solace020Operation DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in Solace020Operation left, in Solace020Operation right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Solace020Operation left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Solace020Operation instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Solace020Operation(JsonElement instance)
        {
            return Solace020Operation.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Solace020Operation From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Solace020Operation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Solace020Operation>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Solace020Operation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Solace020Operation>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Solace020Operation ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Solace020Operation>(json, options);
        }
        ...
        /// </exception>
        public static Solace020Operation ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Solace020Operation>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Solace020Operation? result)
        {
            return JsonElementHelpers.TryParseValue<Solace020Operation>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Solace020Operation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Solace020Operation IJsonElement<Solace020Operation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Solace020Operation: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Solace020Operation"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Solace020Operation"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Solace020Operation Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Solace020Operation>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Solace020Operation"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public Solace020Operation Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<Solace020Operation>(_idx);
            }
