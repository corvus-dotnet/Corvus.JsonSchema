...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Solace020Server>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchMsvVpn(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1solace~10.2.0~1server.json"u8, buffer, out written);
