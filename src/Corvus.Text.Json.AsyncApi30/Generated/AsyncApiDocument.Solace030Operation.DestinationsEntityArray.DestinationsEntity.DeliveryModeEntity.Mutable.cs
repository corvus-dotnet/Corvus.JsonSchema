            ...
            public readonly partial struct DestinationsEntity
            {
                ...
                public readonly partial struct DeliveryModeEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(DeliveryModeEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="DeliveryModeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DeliveryModeEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DeliveryModeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DeliveryModeEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DeliveryModeEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<DeliveryModeEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(DeliveryModeEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (DeliveryModeEntity)value;
                    ...
                    {
                        return workspace.CreateBuilder<DeliveryModeEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<DeliveryModeEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<DeliveryModeEntity>();
                        }
                        finally
                        {
