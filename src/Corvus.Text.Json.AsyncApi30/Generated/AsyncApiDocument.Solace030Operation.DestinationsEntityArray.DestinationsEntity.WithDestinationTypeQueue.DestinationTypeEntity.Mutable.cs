                ...
                public readonly partial struct WithDestinationTypeQueue
                {
                    ...
                    public readonly partial struct DestinationTypeEntity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(DestinationTypeEntity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="DestinationTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator DestinationTypeEntity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"DestinationTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly DestinationTypeEntity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly DestinationTypeEntity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<DestinationTypeEntity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(DestinationTypeEntity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<DestinationTypeEntity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<DestinationTypeEntity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<DestinationTypeEntity>();
                            }
                            finally
                            {
