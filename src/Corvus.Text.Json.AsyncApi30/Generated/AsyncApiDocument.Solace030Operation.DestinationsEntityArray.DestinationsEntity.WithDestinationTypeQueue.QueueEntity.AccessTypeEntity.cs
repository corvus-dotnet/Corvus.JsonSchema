                ...
                public readonly partial struct WithDestinationTypeQueue
                {
                    ...
                    public readonly partial struct QueueEntity
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="AccessTypeEntity"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal AccessTypeEntity(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static AccessTypeEntity DefaultInstance { get; }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static explicit operator string(AccessTypeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                            ...
                            /// </returns>
                            public static bool operator ==(in AccessTypeEntity left, in AccessTypeEntity right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in AccessTypeEntity left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator JsonElement(AccessTypeEntity instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator AccessTypeEntity(JsonElement instance)
                            {
                                return AccessTypeEntity.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static AccessTypeEntity From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static AccessTypeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<AccessTypeEntity>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static AccessTypeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<AccessTypeEntity>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static AccessTypeEntity ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<AccessTypeEntity>(json, options);
                            }
                            ...
                            /// </exception>
                            public static AccessTypeEntity ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<AccessTypeEntity>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out AccessTypeEntity? result)
                            {
                                return JsonElementHelpers.TryParseValue<AccessTypeEntity>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new AccessTypeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static AccessTypeEntity IJsonElement<AccessTypeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"AccessTypeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="AccessTypeEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="AccessTypeEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public AccessTypeEntity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<AccessTypeEntity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="AccessTypeEntity"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public AccessTypeEntity Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<AccessTypeEntity>(_idx);
                                }
                            ...
                            /// <param name="matchExclusive">Match 1st item.</param>
                            /// <param name="matchNonexclusive">Match 2nd item.</param>
                            /// <param name="defaultMatch">Match any other value.</param>
                            /// <returns>An instance of the value returned by the match function.</returns>
                            public TResult Match<TContext, TResult>(
                                in TContext context,
                                Func<TContext, TResult> matchExclusive,
                                Func<TContext, TResult> matchNonexclusive,
...
#endif
                            {
                                ...
                                {
                                    return matchExclusive(context);
                                }

                                if (this.ValueEquals(Constants.Enum2))
                                {
                                    return matchNonexclusive(context);
                                }
                            ...
                            public TResult Match<TResult>(
                                Func<TResult> matchExclusive,
                                Func<TResult> matchNonexclusive,
                                Func<TResult> defaultMatch)
                            {
                                if (this.ValueEquals(Constants.Enum1))
                                {
                                    return matchExclusive();
                                }

                                if (this.ValueEquals(Constants.Enum2))
                                {
                                    return matchNonexclusive();
                                }
