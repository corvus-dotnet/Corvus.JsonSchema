...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Solace030Operation
        ...
        : IJsonElement<Solace030Operation>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Solace030Operation"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Solace030Operation(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Solace030Operation DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Operation.BindingVersionEntity BindingVersion
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BindingVersionUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Operation.BindingVersionEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Operation.DestinationsEntityArray Destinations
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DestinationsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Operation.DestinationsEntityArray value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Solace030Operation left, in Solace030Operation right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Solace030Operation left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Solace030Operation instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Solace030Operation(JsonElement instance)
        {
            return Solace030Operation.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Solace030Operation From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Solace030Operation ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Solace030Operation>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Solace030Operation ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Solace030Operation>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Solace030Operation ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Solace030Operation>(json, options);
        }
        ...
        /// </exception>
        public static Solace030Operation ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Solace030Operation>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Solace030Operation? result)
        {
            return JsonElementHelpers.TryParseValue<Solace030Operation>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Solace030Operation(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Solace030Operation IJsonElement<Solace030Operation>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Solace030Operation: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Solace030Operation"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Solace030Operation"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Solace030Operation Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Solace030Operation>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Solace030Operation"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public Solace030Operation Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<Solace030Operation>(_idx);
            }
