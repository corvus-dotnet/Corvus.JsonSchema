...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Solace030Server
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Solace030Server instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Solace030Server"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Solace030Server(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Mutable BindingVersion
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BindingVersionUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Solace030Server(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetBindingVersion(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Solace030Server.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Solace030Server"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Solace030Server"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Solace030Server Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Solace030Server>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Solace030Server"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Solace030Server Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Solace030Server>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Source _createArg1;
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(Solace030Server instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Solace030Server"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Source bindingVersion = default,
            ...
            /// Creates an instance of a <see cref="Solace030Server"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source msgVpn = default)
            {
                Create(ref _builder, bindingVersion, msgVpn);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Source bindingVersion = default, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source msgVpn = default)
        {
            return new Source(bindingVersion, msgVpn);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source msgVpn = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(bindingVersion, msgVpn);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Solace030Server, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Solace030Server> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Solace030Server>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Solace030Server> Create<TContext>(
        ...
        public static ParsedJsonDocument<Solace030Server> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace030Server.TheVersionOfThisBinding.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source msgVpn = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
