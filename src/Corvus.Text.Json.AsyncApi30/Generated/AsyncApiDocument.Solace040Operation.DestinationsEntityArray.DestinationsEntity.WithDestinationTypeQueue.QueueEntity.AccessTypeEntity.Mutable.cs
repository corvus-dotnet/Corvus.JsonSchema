                    ...
                    public readonly partial struct QueueEntity
                    {
                        ...
                        public readonly partial struct AccessTypeEntity
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(AccessTypeEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="AccessTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator AccessTypeEntity(Mutable instance)
                                {
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"AccessTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly AccessTypeEntity Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly AccessTypeEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<AccessTypeEntity>(_idx);
                                }
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(AccessTypeEntity instance) => new(JsonElement.From(instance));
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator Source(KnownValues value) => (AccessTypeEntity)value;
                            ...
                            {
                                return workspace.CreateBuilder<AccessTypeEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<AccessTypeEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<AccessTypeEntity>();
                                }
                                finally
                                {
