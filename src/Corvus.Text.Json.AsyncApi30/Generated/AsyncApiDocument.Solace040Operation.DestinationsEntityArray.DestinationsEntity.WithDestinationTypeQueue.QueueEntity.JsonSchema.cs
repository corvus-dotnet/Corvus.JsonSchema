                ...
                public readonly partial struct WithDestinationTypeQueue
                {
                        ...
                        : IJsonElement<QueueEntity>
                    {
                        public static partial class JsonSchema
                        {
                            ...
                            private static void MatchAccessType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                            {
                            ...
                            private static void MatchMaxMsgSpoolUsage(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                            {
                                context.AddLocalEvaluatedProperty(propertyCount);
                            ...
                            private static void MatchMaxTtl(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                            {
                                context.AddLocalEvaluatedProperty(propertyCount);
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1solace~10.4.0~1operation.json/properties/destinations/items/oneOf/0/properties/queue"u8, buffer, out written);
