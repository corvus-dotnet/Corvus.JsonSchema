...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Solace040Operation
    {
...
#endif
        {
            ...
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Operation.DestinationsEntityArray.DestinationsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Operation.DestinationsEntityArray.DestinationsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Operation.DestinationsEntityArray.DestinationsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Operation.DestinationsEntityArray.DestinationsEntity>(_parent, _idx);
            }
