    ...
    public readonly partial struct Solace040Operation
    {
        ...
        public readonly partial struct PriorityEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PriorityEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PriorityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PriorityEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PriorityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PriorityEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PriorityEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PriorityEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PriorityEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PriorityEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PriorityEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PriorityEntity>();
                }
                finally
                {
