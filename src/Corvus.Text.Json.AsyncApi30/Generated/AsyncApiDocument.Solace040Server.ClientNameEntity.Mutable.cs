    ...
    public readonly partial struct Solace040Server
    {
        ...
        public readonly partial struct ClientNameEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClientNameEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClientNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClientNameEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClientNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClientNameEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClientNameEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClientNameEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClientNameEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ClientNameEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ClientNameEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClientNameEntity>();
                }
                finally
                {
