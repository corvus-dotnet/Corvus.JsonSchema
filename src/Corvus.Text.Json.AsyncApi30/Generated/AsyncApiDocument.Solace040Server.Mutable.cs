...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Solace040Server
    {
...
#endif
        {
            ...
            public void SetBindingVersion(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetClientName(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMsgVpn(in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
            {
                CheckValidInstance();
