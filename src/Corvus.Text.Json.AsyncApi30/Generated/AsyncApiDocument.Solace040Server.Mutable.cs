...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Solace040Server
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Solace040Server instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Solace040Server"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Solace040Server(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Mutable BindingVersion
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BindingVersionUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>clientName</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Mutable ClientName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ClientNameUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>msgVpn</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonString.Mutable MsgVpn
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MsgVpnUtf8, out Corvus.Text.Json.AsyncApi30.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Solace040Server(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetBindingVersion(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Set the <c>clientName</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetClientName(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ClientNameUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ClientNameUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ClientName, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>clientName</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveClientName()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ClientNameUtf8);
                _documentVersion = _parent.Version;
                return result;
            }

            /// <summary>
            /// Set the <c>msgVpn</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMsgVpn(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MsgVpnUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MsgVpnUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MsgVpn, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>msgVpn</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveMsgVpn()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MsgVpnUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Solace040Server.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Solace040Server"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Solace040Server"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Solace040Server Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Solace040Server>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Solace040Server"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Solace040Server Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Solace040Server>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Source _createArg1;
            private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Source _createArg2;
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Source arg2, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(Solace040Server instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Solace040Server"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Source bindingVersion = default,
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Source clientName = default,
                in Corvus.Text.Json.AsyncApi30.JsonString.Source msgVpn = default)
            {
                bindingVersion.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BindingVersion, ref builder);
                clientName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ClientName, ref builder);
                msgVpn.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MsgVpn, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.Text.Json.AsyncApi30.JsonString.Source msgVpn = default)
            {
                Create(ref _builder, bindingVersion, clientName, msgVpn);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Source arg2, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <param name="clientName">The value of the <c>"clientName"</c> property.</param>
        /// <param name="msgVpn">The value of the <c>"msgVpn"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Source bindingVersion = default, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Source clientName = default, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source msgVpn = default)
        {
            return new Source(bindingVersion, clientName, msgVpn);
        }
        ...
        /// <param name="clientName">The value of the property.</param>
        /// <param name="msgVpn">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Source clientName = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source msgVpn = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(bindingVersion, clientName, msgVpn);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Solace040Server, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Solace040Server> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Solace040Server>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Solace040Server> Create<TContext>(
        ...
        public static ParsedJsonDocument<Solace040Server> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.TheVersionOfThisBinding.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Solace040Server.ClientNameEntity.Source clientName = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source msgVpn = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
