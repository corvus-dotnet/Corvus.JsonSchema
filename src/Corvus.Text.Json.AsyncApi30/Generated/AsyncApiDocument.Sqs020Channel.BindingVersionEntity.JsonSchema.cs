    ...
    public readonly partial struct Sqs020Channel
    {
            ...
            : IJsonElement<BindingVersionEntity>
        {
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "0.1.0"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly BindingVersionEntity EnumJson1 = ParsedJsonDocument<BindingVersionEntity>.StringConstant([.."\"0.1.0\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "0.2.0"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly BindingVersionEntity EnumJson2 = ParsedJsonDocument<BindingVersionEntity>.StringConstant([.."\"0.2.0\""u8]);
            }
            ...
            public static class EnumValues
            {
                ...
                /// </summary>
                public static BindingVersionEntity Value010 { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "0.1.0"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> Value010Utf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "0.2.0"
                /// as a <see cref="BindingVersionEntity"/>.
                /// </summary>
                public static BindingVersionEntity Value020 { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "0.2.0"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> Value020Utf8 => Constants.Enum2;
            }
            ...
            {
                /// <summary>
                /// Corresponds to the JSON string "0.1.0".
                /// </summary>
                Value010 = 0,
                /// <summary>
            ...
            public static implicit operator BindingVersionEntity(KnownValues value)
            {
                return value switch
                {
                    KnownValues.Value010 => Constants.EnumJson1,
                    KnownValues.Value020 => Constants.EnumJson2,
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1channel.json/properties/bindingVersion"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1channel.json/properties/bindingVersion";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1channel.json/properties/bindingVersion"u8;
                ...
                private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.AsyncApi30.CorvusJsonSchemaProgram.Entry(234);
