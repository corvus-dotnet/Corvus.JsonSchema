...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Sqs020Channel>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchQueueValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1channel.json"u8, buffer, out written);
