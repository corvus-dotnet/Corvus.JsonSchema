...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sqs020Channel
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Sqs020Channel instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Sqs020Channel"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Sqs020Channel(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Mutable QueueValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QueueValueUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Sqs020Channel(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetQueueValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source value)
            {
                CheckValidInstance();
                ...
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QueueValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.QueueValue, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetQueueValue<TContext>(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Sqs020Channel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Sqs020Channel"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Sqs020Channel"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Sqs020Channel Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Sqs020Channel>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Sqs020Channel"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Sqs020Channel Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Sqs020Channel>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Sqs020Channel instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Sqs020Channel"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source queue,
            ...
            {
                queue.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.QueueValue, ref builder);
            ...
            public void Create(
                ...
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source deadLetterQueue = default)
            {
                Create(ref _builder, queue, bindingVersion, deadLetterQueue);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source<TContext> queue,
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.BindingVersionEntity.Source bindingVersion = default,
            ...
            #endif
            {
                Create(context, ref _builder, queue, bindingVersion, deadLetterQueue);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source queue, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source deadLetterQueue = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(queue, bindingVersion, deadLetterQueue);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source<TContext> queue, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source<TContext> deadLetterQueue = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, queue, bindingVersion, deadLetterQueue);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Sqs020Channel, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Sqs020Channel> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Sqs020Channel>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Sqs020Channel> Create<TContext>(
        ...
        public static ParsedJsonDocument<Sqs020Channel> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source queue, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source deadLetterQueue = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Sqs020Channel> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source<TContext> queue, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Channel.Queue.Source<TContext> deadLetterQueue = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
