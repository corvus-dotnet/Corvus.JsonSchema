        ...
        public readonly partial struct Queue
        {
            ...
            public readonly partial struct DeliveryDelayEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DeliveryDelayEntity, Mutable>(DeliveryDelayEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DeliveryDelayEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DeliveryDelayEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DeliveryDelayEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DeliveryDelayEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeliveryDelayEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeliveryDelayEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DeliveryDelayEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DeliveryDelayEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DeliveryDelayEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DeliveryDelayEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DeliveryDelayEntity>();
                    }
                    finally
                    {
