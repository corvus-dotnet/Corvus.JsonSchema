        ...
        public readonly partial struct Queue
        {
            ...
            public readonly partial struct FifoThroughputLimitEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FifoThroughputLimitEntity, Mutable>(FifoThroughputLimitEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(FifoThroughputLimitEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FifoThroughputLimitEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FifoThroughputLimitEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FifoThroughputLimitEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FifoThroughputLimitEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FifoThroughputLimitEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FifoThroughputLimitEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FifoThroughputLimitEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (FifoThroughputLimitEntity)value;
                ...
                {
                    return workspace.CreateBuilder<FifoThroughputLimitEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<FifoThroughputLimitEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<FifoThroughputLimitEntity>();
                    }
                    finally
                    {
