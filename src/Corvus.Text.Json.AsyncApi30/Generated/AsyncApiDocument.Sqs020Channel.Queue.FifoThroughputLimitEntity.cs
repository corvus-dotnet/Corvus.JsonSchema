    ...
    public readonly partial struct Sqs020Channel
    {
        ...
        public readonly partial struct Queue
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="FifoThroughputLimitEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal FifoThroughputLimitEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static FifoThroughputLimitEntity DefaultInstance { get; } = ParsedJsonDocument<FifoThroughputLimitEntity>.StringConstant([.."\"perQueue\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(FifoThroughputLimitEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in FifoThroughputLimitEntity left, in FifoThroughputLimitEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in FifoThroughputLimitEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(FifoThroughputLimitEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FifoThroughputLimitEntity(JsonElement instance)
                {
                    return FifoThroughputLimitEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FifoThroughputLimitEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FifoThroughputLimitEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FifoThroughputLimitEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FifoThroughputLimitEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FifoThroughputLimitEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FifoThroughputLimitEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FifoThroughputLimitEntity>(json, options);
                }
                ...
                /// </exception>
                public static FifoThroughputLimitEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<FifoThroughputLimitEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out FifoThroughputLimitEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<FifoThroughputLimitEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FifoThroughputLimitEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static FifoThroughputLimitEntity IJsonElement<FifoThroughputLimitEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FifoThroughputLimitEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FifoThroughputLimitEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FifoThroughputLimitEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public FifoThroughputLimitEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FifoThroughputLimitEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FifoThroughputLimitEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public FifoThroughputLimitEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<FifoThroughputLimitEntity>(_idx);
                    }
                ...
                /// <param name="matchPerQueue">Match 1st item.</param>
                /// <param name="matchPerMessageGroupId">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchPerQueue,
                    Func<TContext, TResult> matchPerMessageGroupId,
...
#endif
                {
                    ...
                    {
                        return matchPerQueue(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchPerMessageGroupId(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchPerQueue,
                    Func<TResult> matchPerMessageGroupId,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchPerQueue();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchPerMessageGroupId();
                    }
