...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sqs020Channel
    {
        ...
        public readonly partial struct Queue
        {
            ...
            public readonly partial struct IsThisAFifoQueue
#if NET8_0_OR_GREATER
                : IJsonElement<IsThisAFifoQueue>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="IsThisAFifoQueue"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal IsThisAFifoQueue(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static IsThisAFifoQueue DefaultInstance { get; } = ParsedJsonDocument<IsThisAFifoQueue>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(IsThisAFifoQueue value)
                {
                ...
                /// </returns>
                public static bool operator ==(in IsThisAFifoQueue left, in IsThisAFifoQueue right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in IsThisAFifoQueue left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(IsThisAFifoQueue instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IsThisAFifoQueue(JsonElement instance)
                {
                    return IsThisAFifoQueue.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsThisAFifoQueue From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsThisAFifoQueue ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IsThisAFifoQueue>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsThisAFifoQueue ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IsThisAFifoQueue>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsThisAFifoQueue ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IsThisAFifoQueue>(json, options);
                }
                ...
                /// </exception>
                public static IsThisAFifoQueue ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<IsThisAFifoQueue>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out IsThisAFifoQueue? result)
                {
                    return JsonElementHelpers.TryParseValue<IsThisAFifoQueue>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IsThisAFifoQueue(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static IsThisAFifoQueue IJsonElement<IsThisAFifoQueue>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IsThisAFifoQueue: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IsThisAFifoQueue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IsThisAFifoQueue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public IsThisAFifoQueue Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IsThisAFifoQueue>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IsThisAFifoQueue"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public IsThisAFifoQueue Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<IsThisAFifoQueue>(_idx);
                    }
