...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sqs020Channel
    {
        ...
        public readonly partial struct Queue
        {
            ...
            public readonly partial struct MessageRetentionPeriodEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MessageRetentionPeriodEntity, Mutable>(MessageRetentionPeriodEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(MessageRetentionPeriodEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MessageRetentionPeriodEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MessageRetentionPeriodEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new MessageRetentionPeriodEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MessageRetentionPeriodEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="MessageRetentionPeriodEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="MessageRetentionPeriodEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MessageRetentionPeriodEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<MessageRetentionPeriodEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="MessageRetentionPeriodEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MessageRetentionPeriodEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MessageRetentionPeriodEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MessageRetentionPeriodEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MessageRetentionPeriodEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MessageRetentionPeriodEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MessageRetentionPeriodEntity>();
                    }
                    finally
                    {
