        ...
        public readonly partial struct Queue
        {
            ...
            public readonly partial struct VisibilityTimeoutEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<VisibilityTimeoutEntity, Mutable>(VisibilityTimeoutEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(VisibilityTimeoutEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="VisibilityTimeoutEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator VisibilityTimeoutEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"VisibilityTimeoutEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly VisibilityTimeoutEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly VisibilityTimeoutEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<VisibilityTimeoutEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(VisibilityTimeoutEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<VisibilityTimeoutEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<VisibilityTimeoutEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<VisibilityTimeoutEntity>();
                    }
                    finally
                    {
