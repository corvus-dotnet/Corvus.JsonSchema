        ...
        public readonly partial struct Statement
        {
                ...
                : IJsonElement<EffectEntity>
            {
                private static class Constants
                {
                    ...
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly EffectEntity EnumJson1 = ParsedJsonDocument<EffectEntity>.StringConstant([.."\"Allow\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "Deny"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly EffectEntity EnumJson2 = ParsedJsonDocument<EffectEntity>.StringConstant([.."\"Deny\""u8]);
                }
                ...
                public static class EnumValues
                {
                    ...
                    /// as a <see cref="EffectEntity"/>.
                    /// </summary>
                    public static EffectEntity Allow { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "Allow"
                    ...
                    /// <summary>
                    /// Gets the string "Deny"
                    /// as a <see cref="EffectEntity"/>.
                    /// </summary>
                    public static EffectEntity Deny { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "Deny"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> DenyUtf8 => Constants.Enum2;
                }
                ...
                public enum KnownValues
                {
                    ...
                    Allow = 0,
                    /// <summary>
                    /// Corresponds to the JSON string "Deny".
                    /// </summary>
                    Deny = 1,
                }
                ...
                public static implicit operator EffectEntity(KnownValues value)
                {
                    return value switch
                    {
                        KnownValues.Allow => Constants.EnumJson1,
                        KnownValues.Deny => Constants.EnumJson2,
                ...
                public static implicit operator KnownValues(EffectEntity value)
                {
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1channel.json/definitions/statement/properties/effect"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                    /// </summary>
                    public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1channel.json/definitions/statement/properties/effect";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1channel.json/definitions/statement/properties/effect"u8;
                    ...
                    private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.AsyncApi30.CorvusJsonSchemaProgram.Entry(231);
