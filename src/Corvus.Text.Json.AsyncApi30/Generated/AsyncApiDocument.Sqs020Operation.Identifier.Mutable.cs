    ...
    public readonly partial struct Sqs020Operation
    {
        ...
        public readonly partial struct Identifier
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Identifier.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Identifier.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// Creates an instance of a <see cref="Identifier"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.AsyncApi30.JsonString.Source arn = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source name = default)
                {
                    Create(ref _builder, arn, name);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arn = default, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source name = default)
            {
                return new Source(arn, name);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.JsonString.Source arn = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source name = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<Identifier> Create(in Corvus.Text.Json.AsyncApi30.JsonString.Source arn = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source name = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
