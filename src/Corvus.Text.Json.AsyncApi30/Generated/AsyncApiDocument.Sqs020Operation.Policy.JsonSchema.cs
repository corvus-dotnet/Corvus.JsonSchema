...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sqs020Operation
    {
            ...
            : IJsonElement<Policy>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyStatementsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("statements"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyStatementsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("statements"u8, buffer, out written);

                private const int RequiredOffsetForStatements = 0;
                private const uint RequiredBitForStatements = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForStatements;
                private static readonly JsonSchemaPathProvider StatementsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/statements"u8, buffer, out written);

                private static void MatchStatements(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Policy.StatementArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.StatementsUtf8,
                            evaluationPath: StatementsSchemaEvaluationPath);

                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Policy.StatementArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForStatements] |= RequiredBitForStatements;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.StatementsUtf8))
                    {
                        matcher = MatchStatements;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1operation.json/definitions/policy"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1operation.json/definitions/policy";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1operation.json/definitions/policy"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyStatementsPresent, "statements"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForStatements] & RequiredBitForStatements) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyStatementsNotPresent, "statements"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyStatementsPresent, "statements"u8, "required"u8);
