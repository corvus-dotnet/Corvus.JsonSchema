...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sqs020Operation
    {
        ...
        public readonly partial struct Policy
        {
            ...
            public readonly partial struct StatementArray
#if NET8_0_OR_GREATER
                : IJsonElement<StatementArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="StatementArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal StatementArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static StatementArray DefaultInstance { get; }
                ...
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in StatementArray left, in StatementArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in StatementArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(StatementArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StatementArray(JsonElement instance)
                {
                    return StatementArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StatementArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StatementArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<StatementArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StatementArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<StatementArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StatementArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<StatementArray>(json, options);
                }
                ...
                /// </exception>
                public static StatementArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<StatementArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out StatementArray? result)
                {
                    return JsonElementHelpers.TryParseValue<StatementArray>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new StatementArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static StatementArray IJsonElement<StatementArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StatementArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="StatementArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="StatementArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public StatementArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<StatementArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="StatementArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public StatementArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<StatementArray>(_idx);
                    }
