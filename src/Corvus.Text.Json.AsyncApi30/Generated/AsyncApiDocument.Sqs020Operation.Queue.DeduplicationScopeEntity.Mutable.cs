        ...
        public readonly partial struct Queue
        {
            ...
            public readonly partial struct DeduplicationScopeEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DeduplicationScopeEntity, Mutable>(DeduplicationScopeEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DeduplicationScopeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DeduplicationScopeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DeduplicationScopeEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DeduplicationScopeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DeduplicationScopeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DeduplicationScopeEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DeduplicationScopeEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeduplicationScopeEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DeduplicationScopeEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DeduplicationScopeEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeduplicationScopeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DeduplicationScopeEntity>(_idx);
                    }
                    ...
                    /// <param name="matchQueue">Match 1st item.</param>
                    /// <param name="matchMessageGroup">Match 2nd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchQueue,
                        Func<TContext, TResult> matchMessageGroup,
...
#endif
                    {
                        ...
                        {
                            return matchMessageGroup(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Func<TResult> matchMessageGroup,
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DeduplicationScopeEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (DeduplicationScopeEntity)value;
                ...
                {
                    return workspace.CreateBuilder<DeduplicationScopeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DeduplicationScopeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DeduplicationScopeEntity>();
                    }
                    finally
                    {
