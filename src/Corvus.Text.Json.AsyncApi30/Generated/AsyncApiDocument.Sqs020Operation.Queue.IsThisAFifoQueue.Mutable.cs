        ...
        public readonly partial struct Queue
        {
            ...
            public readonly partial struct IsThisAFifoQueue
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IsThisAFifoQueue, Mutable>(IsThisAFifoQueue.DefaultInstance);
                    ...
                    public static explicit operator Mutable(IsThisAFifoQueue instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IsThisAFifoQueue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IsThisAFifoQueue(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IsThisAFifoQueue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsThisAFifoQueue Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsThisAFifoQueue Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IsThisAFifoQueue>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IsThisAFifoQueue instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IsThisAFifoQueue, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<IsThisAFifoQueue> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IsThisAFifoQueue>();
                    }
                    finally
                    {
