        ...
        public readonly partial struct Queue
        {
            ...
            public readonly partial struct ReceiveMessageWaitTimeEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReceiveMessageWaitTimeEntity, Mutable>(ReceiveMessageWaitTimeEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ReceiveMessageWaitTimeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ReceiveMessageWaitTimeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ReceiveMessageWaitTimeEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ReceiveMessageWaitTimeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReceiveMessageWaitTimeEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ReceiveMessageWaitTimeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ReceiveMessageWaitTimeEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ReceiveMessageWaitTimeEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ReceiveMessageWaitTimeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ReceiveMessageWaitTimeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ReceiveMessageWaitTimeEntity>();
                    }
                    finally
                    {
