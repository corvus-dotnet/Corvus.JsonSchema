    ...
    public readonly partial struct Sqs020Operation
    {
            ...
            : IJsonElement<QueueArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1operation.json/properties/queues"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1operation.json/properties/queues";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1sqs~10.2.0~1operation.json/properties/queues"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
