    ...
    public readonly partial struct Sqs020Operation
    {
        ...
        public readonly partial struct QueueArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(QueueArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="QueueArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator QueueArray(Mutable instance)
                {
                ...
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Mutable>(_parent, _idx);
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"QueueArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue oldItem, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue current = enumerator.Current;
                ...
                /// </para>
                /// </remarks>
                public readonly QueueArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly QueueArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<QueueArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.QueueArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(QueueArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.QueueArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Source value)
                {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Queue.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            {
                return workspace.CreateBuilder<QueueArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<QueueArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<QueueArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<QueueArray> Create<TContext>(
