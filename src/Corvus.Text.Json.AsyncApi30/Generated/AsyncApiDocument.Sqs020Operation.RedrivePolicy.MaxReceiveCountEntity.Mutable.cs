...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Sqs020Operation
    {
        ...
        public readonly partial struct RedrivePolicy
        {
            ...
            public readonly partial struct MaxReceiveCountEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxReceiveCountEntity, Mutable>(MaxReceiveCountEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(MaxReceiveCountEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MaxReceiveCountEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MaxReceiveCountEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new MaxReceiveCountEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MaxReceiveCountEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="MaxReceiveCountEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="MaxReceiveCountEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxReceiveCountEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<MaxReceiveCountEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="MaxReceiveCountEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxReceiveCountEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MaxReceiveCountEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MaxReceiveCountEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MaxReceiveCountEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MaxReceiveCountEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MaxReceiveCountEntity>();
                    }
                    finally
                    {
