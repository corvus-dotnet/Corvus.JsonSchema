    ...
    public readonly partial struct Sqs020Operation
    {
        ...
        public readonly partial struct Statement
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Statement instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Statement"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Statement(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Mutable Action
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActionUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Mutable Effect
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EffectUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the <c>principal</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Mutable Principal
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrincipalUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Statement(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetAction(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetAction<TContext>(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source<TContext> value)
                ...
                /// <summary>
                /// Set the <c>effect</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetEffect(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("effect");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EffectUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Effect, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Set the <c>principal</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPrincipal(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("principal");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrincipalUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Principal, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPrincipal<TContext>(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Statement.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Statement"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Statement"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Statement Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Statement>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Statement"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Statement Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Statement>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source _createArg1;
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source _createArg2;
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source _createArg3;
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source arg2, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source arg3)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                public static implicit operator Source(Statement instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source<TContext> _createArg1;
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source _createArg2;
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source<TContext> _createArg3;
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source<TContext> arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source arg2, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source<TContext> arg3)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="Statement"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source action,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source effect,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source principal)
                {
                    action.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Action, ref builder);
                    effect.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Effect, ref builder);
                    principal.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Principal, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source principal)
                {
                    Create(ref _builder, action, effect, principal);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source<TContext> action,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source effect,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source<TContext> principal)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, action, effect, principal);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source arg2, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source arg3, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <param name="effect">The value of the <c>"effect"</c> property.</param>
            /// <param name="principal">The value of the <c>"principal"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source action, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source effect, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source principal)
            {
                return new Source(action, effect, principal);
            }
            ...
            /// <param name="principal">The value of the <c>"principal"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source<TContext> action, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source effect, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source<TContext> principal)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, action, effect, principal);
            }
            ...
            /// <param name="effect">The value of the property.</param>
            /// <param name="principal">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source action, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source effect, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source principal, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(action, effect, principal);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
                ...
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, action, effect, principal);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<Statement, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Statement> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Statement>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Statement> Create<TContext>(
            ...
            public static ParsedJsonDocument<Statement> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source action, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source effect, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source principal, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Statement> Create<TContext>(in TContext context, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.ActionEntity.Source<TContext> action, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.EffectEntity.Source effect, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Sqs020Operation.Statement.TheAwsAccountOrResourceArnThatThisStatementAppliesTo.Source<TContext> principal, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
