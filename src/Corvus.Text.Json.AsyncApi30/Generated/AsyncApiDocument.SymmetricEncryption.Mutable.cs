...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct SymmetricEncryption
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SymmetricEncryption instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SymmetricEncryption"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SymmetricEncryption(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SymmetricEncryption.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SymmetricEncryption Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SymmetricEncryption Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SymmetricEncryption>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Source _createArg1;
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(SymmetricEncryption instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="SymmetricEncryption"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Source type,
            ...
            /// Creates an instance of a <see cref="SymmetricEncryption"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Source type, in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Source type, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Source type, in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<SymmetricEncryption, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SymmetricEncryption> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SymmetricEncryption>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<SymmetricEncryption> Create<TContext>(
        ...
        public static ParsedJsonDocument<SymmetricEncryption> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.SymmetricEncryption.TypeEntity.Source type, in Corvus.Text.Json.AsyncApi30.JsonString.Source description = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
