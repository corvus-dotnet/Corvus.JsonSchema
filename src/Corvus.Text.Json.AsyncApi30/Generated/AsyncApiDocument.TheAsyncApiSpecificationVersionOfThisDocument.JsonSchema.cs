        ...
        public static partial class JsonSchema
        {
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "3.0.0"u8, "3.0.0", "const"u8, ref context);
                }
                else
                {
                    context.EvaluatedKeyword(false, "3.0.0", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                }
            }
