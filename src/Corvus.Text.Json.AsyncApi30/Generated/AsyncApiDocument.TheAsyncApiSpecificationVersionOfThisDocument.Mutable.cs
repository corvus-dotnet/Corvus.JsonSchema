...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct TheAsyncApiSpecificationVersionOfThisDocument
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheAsyncApiSpecificationVersionOfThisDocument instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheAsyncApiSpecificationVersionOfThisDocument"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheAsyncApiSpecificationVersionOfThisDocument(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheAsyncApiSpecificationVersionOfThisDocument.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheAsyncApiSpecificationVersionOfThisDocument Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheAsyncApiSpecificationVersionOfThisDocument Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheAsyncApiSpecificationVersionOfThisDocument>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheAsyncApiSpecificationVersionOfThisDocument instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheAsyncApiSpecificationVersionOfThisDocument, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheAsyncApiSpecificationVersionOfThisDocument> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheAsyncApiSpecificationVersionOfThisDocument>();
            }
            finally
            {
