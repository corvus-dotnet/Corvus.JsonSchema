...
public readonly partial struct AsyncApiDocument
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheAsyncApiSpecificationVersionOfThisDocument"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheAsyncApiSpecificationVersionOfThisDocument(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheAsyncApiSpecificationVersionOfThisDocument DefaultInstance { get; }

        /// <summary>
        /// Gets the const instance.
        /// </summary>
        public static TheAsyncApiSpecificationVersionOfThisDocument ConstInstance => Constants.ConstJson;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheAsyncApiSpecificationVersionOfThisDocument value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheAsyncApiSpecificationVersionOfThisDocument left, in TheAsyncApiSpecificationVersionOfThisDocument right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheAsyncApiSpecificationVersionOfThisDocument left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheAsyncApiSpecificationVersionOfThisDocument instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheAsyncApiSpecificationVersionOfThisDocument(JsonElement instance)
        {
            return TheAsyncApiSpecificationVersionOfThisDocument.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheAsyncApiSpecificationVersionOfThisDocument From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheAsyncApiSpecificationVersionOfThisDocument ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheAsyncApiSpecificationVersionOfThisDocument>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheAsyncApiSpecificationVersionOfThisDocument ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheAsyncApiSpecificationVersionOfThisDocument>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheAsyncApiSpecificationVersionOfThisDocument ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheAsyncApiSpecificationVersionOfThisDocument>(json, options);
        }
        ...
        /// </exception>
        public static TheAsyncApiSpecificationVersionOfThisDocument ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TheAsyncApiSpecificationVersionOfThisDocument>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheAsyncApiSpecificationVersionOfThisDocument? result)
        {
            return JsonElementHelpers.TryParseValue<TheAsyncApiSpecificationVersionOfThisDocument>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheAsyncApiSpecificationVersionOfThisDocument(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheAsyncApiSpecificationVersionOfThisDocument IJsonElement<TheAsyncApiSpecificationVersionOfThisDocument>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheAsyncApiSpecificationVersionOfThisDocument: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheAsyncApiSpecificationVersionOfThisDocument"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheAsyncApiSpecificationVersionOfThisDocument"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheAsyncApiSpecificationVersionOfThisDocument Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheAsyncApiSpecificationVersionOfThisDocument>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheAsyncApiSpecificationVersionOfThisDocument"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheAsyncApiSpecificationVersionOfThisDocument Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheAsyncApiSpecificationVersionOfThisDocument>(_idx);
            }
