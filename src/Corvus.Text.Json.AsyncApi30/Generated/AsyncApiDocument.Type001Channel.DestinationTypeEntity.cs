...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type001Channel
    {
        ...
        public readonly partial struct DestinationTypeEntity
#if NET8_0_OR_GREATER
            : IJsonElement<DestinationTypeEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DestinationTypeEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DestinationTypeEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DestinationTypeEntity DefaultInstance { get; } = ParsedJsonDocument<DestinationTypeEntity>.StringConstant([.."\"queue\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(DestinationTypeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in DestinationTypeEntity left, in DestinationTypeEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DestinationTypeEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DestinationTypeEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DestinationTypeEntity(JsonElement instance)
            {
                return DestinationTypeEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DestinationTypeEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DestinationTypeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DestinationTypeEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DestinationTypeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DestinationTypeEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DestinationTypeEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DestinationTypeEntity>(json, options);
            }
            ...
            /// </exception>
            public static DestinationTypeEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DestinationTypeEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DestinationTypeEntity? result)
            {
                return JsonElementHelpers.TryParseValue<DestinationTypeEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DestinationTypeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DestinationTypeEntity IJsonElement<DestinationTypeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DestinationTypeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DestinationTypeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DestinationTypeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DestinationTypeEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DestinationTypeEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DestinationTypeEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DestinationTypeEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DestinationTypeEntity>(_idx);
                }
            ...
            /// <param name="matchExchange">Match 1st item.</param>
            /// <param name="matchQueue">Match 2nd item.</param>
            /// <param name="matchFifoQueue">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchExchange,
                Func<TContext, TResult> matchQueue,
                Func<TContext, TResult> matchFifoQueue,
            ...
            public TResult Match<TResult>(
                Func<TResult> matchExchange,
                Func<TResult> matchQueue,
                Func<TResult> matchFifoQueue,
