...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Type001Channel>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchDestination(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1anypointmq~10.0.1~1channel.json"u8, buffer, out written);
