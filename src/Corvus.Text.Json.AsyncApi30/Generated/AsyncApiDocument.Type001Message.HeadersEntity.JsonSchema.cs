    ...
    public readonly partial struct Type001Message
    {
            ...
            : IJsonElement<HeadersEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1anypointmq~10.0.1~1message.json/properties/headers"u8, buffer, out written);
