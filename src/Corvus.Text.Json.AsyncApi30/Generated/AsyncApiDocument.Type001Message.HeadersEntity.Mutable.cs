...
{
    /// <summary>
    /// Anypoint MQ message bindings object
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct Type001Message
    {
        /// <summary>
        ...
        public readonly partial struct HeadersEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HeadersEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HeadersEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HeadersEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new HeadersEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HeadersEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="HeadersEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="HeadersEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly HeadersEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<HeadersEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="HeadersEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly HeadersEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HeadersEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Message.HeadersEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Message.HeadersEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HeadersEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HeadersEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HeadersEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HeadersEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<HeadersEntity> Create<TContext>(
