...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type001Message
    {
...
#endif
        {
            ...
            public void SetBindingVersion(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Message.BindingVersionEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetHeaders(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Message.HeadersEntity.Source value)
            {
                CheckValidInstance();
