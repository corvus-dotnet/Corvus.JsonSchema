...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Type001Server>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyJmsConnectionFactoryPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("jmsConnectionFactory"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyJmsConnectionFactoryNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("jmsConnectionFactory"u8, buffer, out written);

            private const int RequiredOffsetForJmsConnectionFactory = 0;
            private const uint RequiredBitForJmsConnectionFactory = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForJmsConnectionFactory;
            ...
            private static readonly JsonSchemaPathProvider JmsConnectionFactorySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/jmsConnectionFactory"u8, buffer, out written);
            ...
            private static void MatchBindingVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Server.BindingVersionEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Server.BindingVersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchJmsConnectionFactory(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Corvus.Text.Json.AsyncApi30.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.JmsConnectionFactoryUtf8,
                        evaluationPath: JmsConnectionFactorySchemaEvaluationPath);
                ...
                requiredBitBuffer[RequiredOffsetForJmsConnectionFactory] |= RequiredBitForJmsConnectionFactory;
            }
            ...
            private static void MatchProperties(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext3 =
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Server.PropertyArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Server.PropertyArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator>([
                    ...
                    (static () => JsonPropertyNames.JmsConnectionFactoryUtf8, MatchJmsConnectionFactory),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1jms~10.0.1~1server.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1jms~10.0.1~1server.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1jms~10.0.1~1server.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyJmsConnectionFactoryPresent, "jmsConnectionFactory"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForJmsConnectionFactory] & RequiredBitForJmsConnectionFactory) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyJmsConnectionFactoryNotPresent, "jmsConnectionFactory"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyJmsConnectionFactoryPresent, "jmsConnectionFactory"u8, "required"u8);
