...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Type001Server>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchJmsConnectionFactory(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1jms~10.0.1~1server.json"u8, buffer, out written);
