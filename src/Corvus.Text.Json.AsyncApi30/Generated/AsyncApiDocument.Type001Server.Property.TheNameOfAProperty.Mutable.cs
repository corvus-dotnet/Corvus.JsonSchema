        ...
        public readonly partial struct Property
        {
            ...
            public readonly partial struct TheNameOfAProperty
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TheNameOfAProperty instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheNameOfAProperty"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheNameOfAProperty(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheNameOfAProperty.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheNameOfAProperty Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheNameOfAProperty Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheNameOfAProperty>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheNameOfAProperty instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TheNameOfAProperty, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheNameOfAProperty> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheNameOfAProperty>();
                    }
                    finally
                    {
