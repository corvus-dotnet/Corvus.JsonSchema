...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type001Server
    {
...
#endif
        {
            ...
            internal Property(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Property DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Server.Property.TheNameOfAProperty Value
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type001Server.Property.TheNameOfAProperty value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in Property left, in Property right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Property left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Property instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Property(JsonElement instance)
            {
                return Property.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Property From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Property ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Property>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Property ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Property>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Property ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Property>(json, options);
            }
            ...
            /// </exception>
            public static Property ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Property>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Property? result)
            {
                return JsonElementHelpers.TryParseValue<Property>(ref reader, out result);
            }
...
#if NET
            static Property IJsonElement<Property>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Property: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public Property Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Property>(_idx);
                }
