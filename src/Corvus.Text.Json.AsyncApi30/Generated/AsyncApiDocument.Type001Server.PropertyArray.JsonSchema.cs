    ...
    public readonly partial struct Type001Server
    {
            ...
            : IJsonElement<PropertyArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1jms~10.0.1~1server.json/properties/properties"u8, buffer, out written);
