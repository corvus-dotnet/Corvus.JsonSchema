        ...
        public readonly partial struct DefinesThePropertiesOfAQueue
        {
            ...
            public readonly partial struct IsPartitionedEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IsPartitionedEntity, Mutable>(IsPartitionedEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(IsPartitionedEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IsPartitionedEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IsPartitionedEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IsPartitionedEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsPartitionedEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsPartitionedEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IsPartitionedEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IsPartitionedEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IsPartitionedEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<IsPartitionedEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IsPartitionedEntity>();
                    }
                    finally
                    {
