    ...
    public readonly partial struct Type010Channel
    {
        ...
        public readonly partial struct DefinesThePropertiesOfAQueue
        {
...
#endif
            {
                ...
                public void SetExclusive(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetIsPartitioned(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetObjectName(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Source value)
                {
                    CheckValidInstance();
