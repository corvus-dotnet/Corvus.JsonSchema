    ...
    public readonly partial struct Type010Channel
    {
        ...
        public readonly partial struct DefinesThePropertiesOfAQueue
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DefinesThePropertiesOfAQueue instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefinesThePropertiesOfAQueue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesThePropertiesOfAQueue(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Mutable Exclusive
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExclusiveUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Mutable.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Mutable IsPartitioned
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsPartitionedUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Mutable.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Mutable ObjectName
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ObjectNameUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetExclusive(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Source value)
                {
                    CheckValidInstance();
                ...
                /// <summary>
                /// Set the <c>isPartitioned</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetIsPartitioned(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IsPartitionedUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsPartitionedUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IsPartitioned, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>isPartitioned</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveIsPartitioned()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IsPartitionedUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetObjectName(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("objectName");
                    }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesThePropertiesOfAQueue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DefinesThePropertiesOfAQueue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DefinesThePropertiesOfAQueue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesThePropertiesOfAQueue Clone()
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DefinesThePropertiesOfAQueue"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesThePropertiesOfAQueue Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefinesThePropertiesOfAQueue>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Source _createArg1;
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Source _createArg2;
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source _createArg3;
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Source arg2, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source arg3)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                public static implicit operator Source(DefinesThePropertiesOfAQueue instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="DefinesThePropertiesOfAQueue"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Source objectName,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Source exclusive = default,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source isPartitioned = default)
                {
                    ...
                    isPartitioned.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IsPartitioned, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source isPartitioned = default)
                {
                    Create(ref _builder, objectName, exclusive, isPartitioned);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Source arg2, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source arg3, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <param name="isPartitioned">The value of the <c>"isPartitioned"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Source objectName, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Source exclusive = default, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source isPartitioned = default)
            {
                return new Source(objectName, exclusive, isPartitioned);
            }
            ...
            /// <param name="isPartitioned">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Source objectName, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Source exclusive = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source isPartitioned = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(objectName, exclusive, isPartitioned);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<DefinesThePropertiesOfAQueue, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DefinesThePropertiesOfAQueue> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DefinesThePropertiesOfAQueue>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<DefinesThePropertiesOfAQueue> Create<TContext>(
            ...
            public static ParsedJsonDocument<DefinesThePropertiesOfAQueue> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.ObjectNameEntity.Source objectName, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Source exclusive = default, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Channel.DefinesThePropertiesOfAQueue.IsPartitionedEntity.Source isPartitioned = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
