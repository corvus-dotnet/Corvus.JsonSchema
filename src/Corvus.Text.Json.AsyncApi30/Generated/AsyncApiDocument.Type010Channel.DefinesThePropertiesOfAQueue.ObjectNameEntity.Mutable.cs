        ...
        public readonly partial struct DefinesThePropertiesOfAQueue
        {
            ...
            public readonly partial struct ObjectNameEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ObjectNameEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ObjectNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ObjectNameEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ObjectNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ObjectNameEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ObjectNameEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ObjectNameEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ObjectNameEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ObjectNameEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ObjectNameEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ObjectNameEntity>();
                    }
                    finally
                    {
