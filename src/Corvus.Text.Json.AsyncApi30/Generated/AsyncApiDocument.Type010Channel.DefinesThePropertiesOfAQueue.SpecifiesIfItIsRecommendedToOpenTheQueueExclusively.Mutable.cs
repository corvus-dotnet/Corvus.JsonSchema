        ...
        public readonly partial struct DefinesThePropertiesOfAQueue
        {
            ...
            public readonly partial struct SpecifiesIfItIsRecommendedToOpenTheQueueExclusively
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively, Mutable>(SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SpecifiesIfItIsRecommendedToOpenTheQueueExclusively instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SpecifiesIfItIsRecommendedToOpenTheQueueExclusively"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SpecifiesIfItIsRecommendedToOpenTheQueueExclusively(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SpecifiesIfItIsRecommendedToOpenTheQueueExclusively(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SpecifiesIfItIsRecommendedToOpenTheQueueExclusively"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SpecifiesIfItIsRecommendedToOpenTheQueueExclusively"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesIfItIsRecommendedToOpenTheQueueExclusively Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SpecifiesIfItIsRecommendedToOpenTheQueueExclusively"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesIfItIsRecommendedToOpenTheQueueExclusively Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SpecifiesIfItIsRecommendedToOpenTheQueueExclusively instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>();
                    }
                    finally
                    {
