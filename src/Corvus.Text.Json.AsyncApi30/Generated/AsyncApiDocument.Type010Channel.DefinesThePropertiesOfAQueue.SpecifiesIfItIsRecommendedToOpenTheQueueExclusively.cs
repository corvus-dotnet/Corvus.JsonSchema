    ...
    public readonly partial struct Type010Channel
    {
        ...
        public readonly partial struct DefinesThePropertiesOfAQueue
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SpecifiesIfItIsRecommendedToOpenTheQueueExclusively"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SpecifiesIfItIsRecommendedToOpenTheQueueExclusively(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SpecifiesIfItIsRecommendedToOpenTheQueueExclusively DefaultInstance { get; } = ParsedJsonDocument<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(SpecifiesIfItIsRecommendedToOpenTheQueueExclusively value)
                {
                ...
                /// </returns>
                public static bool operator ==(in SpecifiesIfItIsRecommendedToOpenTheQueueExclusively left, in SpecifiesIfItIsRecommendedToOpenTheQueueExclusively right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SpecifiesIfItIsRecommendedToOpenTheQueueExclusively left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SpecifiesIfItIsRecommendedToOpenTheQueueExclusively instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpecifiesIfItIsRecommendedToOpenTheQueueExclusively(JsonElement instance)
                {
                    return SpecifiesIfItIsRecommendedToOpenTheQueueExclusively.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesIfItIsRecommendedToOpenTheQueueExclusively From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesIfItIsRecommendedToOpenTheQueueExclusively ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesIfItIsRecommendedToOpenTheQueueExclusively ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesIfItIsRecommendedToOpenTheQueueExclusively ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>(json, options);
                }
                ...
                /// </exception>
                public static SpecifiesIfItIsRecommendedToOpenTheQueueExclusively ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SpecifiesIfItIsRecommendedToOpenTheQueueExclusively? result)
                {
                    return JsonElementHelpers.TryParseValue<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>(ref reader, out result);
                }
...
#if NET
                static SpecifiesIfItIsRecommendedToOpenTheQueueExclusively IJsonElement<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpecifiesIfItIsRecommendedToOpenTheQueueExclusively: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public SpecifiesIfItIsRecommendedToOpenTheQueueExclusively Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public SpecifiesIfItIsRecommendedToOpenTheQueueExclusively Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SpecifiesIfItIsRecommendedToOpenTheQueueExclusively>(_idx);
                    }
