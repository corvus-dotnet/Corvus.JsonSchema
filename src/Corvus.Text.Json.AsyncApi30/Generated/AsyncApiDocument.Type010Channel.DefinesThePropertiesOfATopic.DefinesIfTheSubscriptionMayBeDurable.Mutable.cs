...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type010Channel
    {
        ...
        public readonly partial struct DefinesThePropertiesOfATopic
        {
            ...
            public readonly partial struct DefinesIfTheSubscriptionMayBeDurable
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DefinesIfTheSubscriptionMayBeDurable, Mutable>(DefinesIfTheSubscriptionMayBeDurable.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DefinesIfTheSubscriptionMayBeDurable instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DefinesIfTheSubscriptionMayBeDurable"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DefinesIfTheSubscriptionMayBeDurable(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DefinesIfTheSubscriptionMayBeDurable(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DefinesIfTheSubscriptionMayBeDurable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DefinesIfTheSubscriptionMayBeDurable"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DefinesIfTheSubscriptionMayBeDurable"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefinesIfTheSubscriptionMayBeDurable Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DefinesIfTheSubscriptionMayBeDurable>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DefinesIfTheSubscriptionMayBeDurable"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefinesIfTheSubscriptionMayBeDurable Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DefinesIfTheSubscriptionMayBeDurable>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DefinesIfTheSubscriptionMayBeDurable instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DefinesIfTheSubscriptionMayBeDurable, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DefinesIfTheSubscriptionMayBeDurable> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DefinesIfTheSubscriptionMayBeDurable>();
                    }
                    finally
                    {
