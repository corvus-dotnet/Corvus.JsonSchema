    ...
    public readonly partial struct Type010Channel
    {
        ...
        public readonly partial struct DefinesThePropertiesOfATopic
        {
            ...
            public readonly partial struct DefinesIfTheSubscriptionMayBeDurable
                ...
                : IJsonElement<DefinesIfTheSubscriptionMayBeDurable>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DefinesIfTheSubscriptionMayBeDurable"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DefinesIfTheSubscriptionMayBeDurable(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DefinesIfTheSubscriptionMayBeDurable DefaultInstance { get; } = ParsedJsonDocument<DefinesIfTheSubscriptionMayBeDurable>.True;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(DefinesIfTheSubscriptionMayBeDurable value)
                {
                ...
                /// </returns>
                public static bool operator ==(in DefinesIfTheSubscriptionMayBeDurable left, in DefinesIfTheSubscriptionMayBeDurable right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DefinesIfTheSubscriptionMayBeDurable left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DefinesIfTheSubscriptionMayBeDurable instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesIfTheSubscriptionMayBeDurable(JsonElement instance)
                {
                    return DefinesIfTheSubscriptionMayBeDurable.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefinesIfTheSubscriptionMayBeDurable From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefinesIfTheSubscriptionMayBeDurable ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefinesIfTheSubscriptionMayBeDurable>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefinesIfTheSubscriptionMayBeDurable ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefinesIfTheSubscriptionMayBeDurable>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefinesIfTheSubscriptionMayBeDurable ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefinesIfTheSubscriptionMayBeDurable>(json, options);
                }
                ...
                /// </exception>
                public static DefinesIfTheSubscriptionMayBeDurable ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DefinesIfTheSubscriptionMayBeDurable>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DefinesIfTheSubscriptionMayBeDurable? result)
                {
                    return JsonElementHelpers.TryParseValue<DefinesIfTheSubscriptionMayBeDurable>(ref reader, out result);
                }
...
#if NET
                static DefinesIfTheSubscriptionMayBeDurable IJsonElement<DefinesIfTheSubscriptionMayBeDurable>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesIfTheSubscriptionMayBeDurable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public DefinesIfTheSubscriptionMayBeDurable Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public DefinesIfTheSubscriptionMayBeDurable Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DefinesIfTheSubscriptionMayBeDurable>(_idx);
                    }
