...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type010Channel
    {
        ...
        public readonly partial struct DefinesThePropertiesOfATopic
        {
            ...
            public readonly partial struct LastMsgRetainedEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LastMsgRetainedEntity, Mutable>(LastMsgRetainedEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(LastMsgRetainedEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="LastMsgRetainedEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator LastMsgRetainedEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new LastMsgRetainedEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"LastMsgRetainedEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="LastMsgRetainedEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="LastMsgRetainedEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly LastMsgRetainedEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<LastMsgRetainedEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="LastMsgRetainedEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly LastMsgRetainedEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<LastMsgRetainedEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(LastMsgRetainedEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<LastMsgRetainedEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<LastMsgRetainedEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<LastMsgRetainedEntity>();
                    }
                    finally
                    {
