    ...
    public readonly partial struct Type010Channel
    {
        ...
        public readonly partial struct DefinesThePropertiesOfATopic
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="LastMsgRetainedEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal LastMsgRetainedEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static LastMsgRetainedEntity DefaultInstance { get; } = ParsedJsonDocument<LastMsgRetainedEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(LastMsgRetainedEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in LastMsgRetainedEntity left, in LastMsgRetainedEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in LastMsgRetainedEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(LastMsgRetainedEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LastMsgRetainedEntity(JsonElement instance)
                {
                    return LastMsgRetainedEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LastMsgRetainedEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LastMsgRetainedEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<LastMsgRetainedEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LastMsgRetainedEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<LastMsgRetainedEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LastMsgRetainedEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<LastMsgRetainedEntity>(json, options);
                }
                ...
                /// </exception>
                public static LastMsgRetainedEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<LastMsgRetainedEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out LastMsgRetainedEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<LastMsgRetainedEntity>(ref reader, out result);
                }
...
#if NET
                static LastMsgRetainedEntity IJsonElement<LastMsgRetainedEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LastMsgRetainedEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public LastMsgRetainedEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public LastMsgRetainedEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<LastMsgRetainedEntity>(_idx);
                    }
