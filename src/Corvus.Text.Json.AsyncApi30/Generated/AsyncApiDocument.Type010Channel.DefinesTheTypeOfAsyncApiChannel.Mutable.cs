    ...
    public readonly partial struct Type010Channel
    {
        ...
        public readonly partial struct DefinesTheTypeOfAsyncApiChannel
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DefinesTheTypeOfAsyncApiChannel, Mutable>(DefinesTheTypeOfAsyncApiChannel.DefaultInstance);
                ...
                public static explicit operator Mutable(DefinesTheTypeOfAsyncApiChannel instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefinesTheTypeOfAsyncApiChannel"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesTheTypeOfAsyncApiChannel(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesTheTypeOfAsyncApiChannel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DefinesTheTypeOfAsyncApiChannel"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DefinesTheTypeOfAsyncApiChannel"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesTheTypeOfAsyncApiChannel Clone()
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DefinesTheTypeOfAsyncApiChannel"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesTheTypeOfAsyncApiChannel Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefinesTheTypeOfAsyncApiChannel>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DefinesTheTypeOfAsyncApiChannel instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (DefinesTheTypeOfAsyncApiChannel)value;
            ...
            {
                return workspace.CreateBuilder<DefinesTheTypeOfAsyncApiChannel, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DefinesTheTypeOfAsyncApiChannel> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DefinesTheTypeOfAsyncApiChannel>();
                }
                finally
                {
