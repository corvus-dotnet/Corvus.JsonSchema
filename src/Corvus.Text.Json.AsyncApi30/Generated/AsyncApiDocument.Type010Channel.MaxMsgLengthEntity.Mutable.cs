    ...
    public readonly partial struct Type010Channel
    {
        ...
        public readonly partial struct MaxMsgLengthEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaxMsgLengthEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaxMsgLengthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaxMsgLengthEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaxMsgLengthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaxMsgLengthEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaxMsgLengthEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaxMsgLengthEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaxMsgLengthEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaxMsgLengthEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaxMsgLengthEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaxMsgLengthEntity>();
                }
                finally
                {
