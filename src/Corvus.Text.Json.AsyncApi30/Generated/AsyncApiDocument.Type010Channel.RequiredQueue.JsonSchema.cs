    ...
    public readonly partial struct Type010Channel
    {
            ...
            : IJsonElement<RequiredQueue>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchDestinationType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1ibmmq~10.1.0~1channel.json/oneOf/1"u8, buffer, out written);
