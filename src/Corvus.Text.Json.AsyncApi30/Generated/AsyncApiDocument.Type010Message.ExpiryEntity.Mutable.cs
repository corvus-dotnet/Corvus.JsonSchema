...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type010Message
    {
        ...
        public readonly partial struct ExpiryEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExpiryEntity, Mutable>(ExpiryEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ExpiryEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExpiryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExpiryEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExpiryEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExpiryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExpiryEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExpiryEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExpiryEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExpiryEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExpiryEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExpiryEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExpiryEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExpiryEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExpiryEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExpiryEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExpiryEntity>();
                }
                finally
                {
