    ...
    public readonly partial struct Type010Message
    {
        ...
        public readonly partial struct TheTypeOfTheMessage
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheTypeOfTheMessage, Mutable>(TheTypeOfTheMessage.DefaultInstance);
                ...
                public static explicit operator Mutable(TheTypeOfTheMessage instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheTypeOfTheMessage"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTypeOfTheMessage(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTypeOfTheMessage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheMessage Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheMessage Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheTypeOfTheMessage>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheTypeOfTheMessage instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (TheTypeOfTheMessage)value;
            ...
            {
                return workspace.CreateBuilder<TheTypeOfTheMessage, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheTypeOfTheMessage> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheTypeOfTheMessage>();
                }
                finally
                {
