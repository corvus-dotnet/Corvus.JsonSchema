...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type010Message
    {
        ...
        public readonly partial struct TheTypeOfTheMessage
#if NET8_0_OR_GREATER
            : IJsonElement<TheTypeOfTheMessage>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TheTypeOfTheMessage"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TheTypeOfTheMessage(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TheTypeOfTheMessage DefaultInstance { get; } = ParsedJsonDocument<TheTypeOfTheMessage>.StringConstant([.."\"string\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(TheTypeOfTheMessage value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in TheTypeOfTheMessage left, in TheTypeOfTheMessage right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TheTypeOfTheMessage left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TheTypeOfTheMessage instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheTypeOfTheMessage(JsonElement instance)
            {
                return TheTypeOfTheMessage.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheMessage From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheMessage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheMessage>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheMessage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheMessage>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheTypeOfTheMessage ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheMessage>(json, options);
            }
            ...
            /// </exception>
            public static TheTypeOfTheMessage ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TheTypeOfTheMessage>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TheTypeOfTheMessage? result)
            {
                return JsonElementHelpers.TryParseValue<TheTypeOfTheMessage>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheTypeOfTheMessage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TheTypeOfTheMessage IJsonElement<TheTypeOfTheMessage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheTypeOfTheMessage: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheTypeOfTheMessage"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheTypeOfTheMessage"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TheTypeOfTheMessage Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheTypeOfTheMessage>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheTypeOfTheMessage"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TheTypeOfTheMessage Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TheTypeOfTheMessage>(_idx);
                }
            ...
            /// <param name="matchJms">Match 2nd item.</param>
            /// <param name="matchBinary">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchString,
                Func<TContext, TResult> matchJms,
