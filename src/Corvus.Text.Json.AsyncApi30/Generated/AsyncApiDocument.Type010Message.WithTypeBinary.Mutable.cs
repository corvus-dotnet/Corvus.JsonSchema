    ...
    public readonly partial struct Type010Message
    {
        ...
        public readonly partial struct WithTypeBinary
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WithTypeBinary instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WithTypeBinary"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WithTypeBinary(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WithTypeBinary(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetType(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WithTypeBinary.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WithTypeBinary"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WithTypeBinary"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WithTypeBinary Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WithTypeBinary>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WithTypeBinary"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WithTypeBinary Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WithTypeBinary>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Source _createArg1;
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(WithTypeBinary instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="WithTypeBinary"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Source type = default)
                {
                ...
                /// Creates an instance of a <see cref="WithTypeBinary"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Source type = default)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Source type = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Source type = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<WithTypeBinary, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WithTypeBinary> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WithTypeBinary>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<WithTypeBinary> Create<TContext>(
            ...
            public static ParsedJsonDocument<WithTypeBinary> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeBinary.TypeEntity.Source type = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
