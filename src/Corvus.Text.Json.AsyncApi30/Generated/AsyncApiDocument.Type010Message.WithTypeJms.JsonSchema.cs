            ...
            public static partial class JsonSchema
            {
                ...
                private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeJms.TypeEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeJms.TypeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1ibmmq~10.1.0~1message.json/oneOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1ibmmq~10.1.0~1message.json/oneOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1ibmmq~10.1.0~1message.json/oneOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext notContext =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeJms.RequiredHeaders.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: NotSchemaEvaluationPath);
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeJms.RequiredHeaders.JsonSchema.Evaluate(parentDocument, parentIndex, ref notContext);
