    ...
    public readonly partial struct Type010Message
    {
        ...
        public readonly partial struct WithTypeJms
        {
                ...
                : IJsonElement<RequiredHeaders>
            {
                ...
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyHeadersPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("headers"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyHeadersNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("headers"u8, buffer, out written);

                    private const int RequiredOffsetForHeaders = 0;
                    private const uint RequiredBitForHeaders = 0b00000000000000000000000000000001;
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.HeadersUtf8))
                        {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1ibmmq~10.1.0~1message.json/oneOf/1/not"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                    /// </summary>
                    public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1ibmmq~10.1.0~1message.json/oneOf/1/not";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1ibmmq~10.1.0~1message.json/oneOf/1/not"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.StartObject)
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyHeadersPresent, "headers"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForHeaders] & RequiredBitForHeaders) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyHeadersNotPresent, "headers"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyHeadersPresent, "headers"u8, "required"u8);
