...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type010Message
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WithTypeJms"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WithTypeJms(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WithTypeJms DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeJms.TypeEntity Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeJms.TypeEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in WithTypeJms left, in WithTypeJms right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WithTypeJms left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(WithTypeJms instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WithTypeJms(JsonElement instance)
            {
                return WithTypeJms.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WithTypeJms From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WithTypeJms ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WithTypeJms>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WithTypeJms ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WithTypeJms>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WithTypeJms ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WithTypeJms>(json, options);
            }
            ...
            /// </exception>
            public static WithTypeJms ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WithTypeJms>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WithTypeJms? result)
            {
                return JsonElementHelpers.TryParseValue<WithTypeJms>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WithTypeJms(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static WithTypeJms IJsonElement<WithTypeJms>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WithTypeJms: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WithTypeJms"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WithTypeJms"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public WithTypeJms Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WithTypeJms>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WithTypeJms"/> that lives for the lifetime of its
