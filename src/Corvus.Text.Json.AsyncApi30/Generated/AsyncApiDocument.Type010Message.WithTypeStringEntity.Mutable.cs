    ...
    public readonly partial struct Type010Message
    {
        ...
        public readonly partial struct WithTypeStringEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WithTypeStringEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WithTypeStringEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WithTypeStringEntity(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetType(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WithTypeStringEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WithTypeStringEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WithTypeStringEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WithTypeStringEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Source _createArg1;
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(WithTypeStringEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="WithTypeStringEntity"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Source type = default)
                {
                ...
                /// Creates an instance of a <see cref="WithTypeStringEntity"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Source type = default)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Source type = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Source type = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<WithTypeStringEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WithTypeStringEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WithTypeStringEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<WithTypeStringEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<WithTypeStringEntity> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Message.WithTypeStringEntity.TypeEntity.Source type = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
