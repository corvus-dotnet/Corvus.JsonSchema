...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Type010Schema>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1extensions~1linkedin~10.1.0~1schema.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
            /// </summary>
            public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1extensions~1linkedin~10.1.0~1schema.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1extensions~1linkedin~10.1.0~1schema.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^http(s)?://(www\\.)?linkedin\\.com.*$", "pattern"u8, ref context);
                }
            }
            ...
            [GeneratedRegex("^http(s)?://(www\\.)?linkedin\\.com[^\\n\\r\\u2028\\u2029]*$")]
            private static partial Regex CreatePattern();
#else
            private static Regex CreatePattern() => new("^http(s)?://(www\\.)?linkedin\\.com[^\\n\\r\\u2028\\u2029]*$", RegexOptions.Compiled);
#endif
