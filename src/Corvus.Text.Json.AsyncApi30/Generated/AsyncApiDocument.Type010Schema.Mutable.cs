...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type010Schema
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Type010Schema instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Type010Schema"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Type010Schema(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Type010Schema(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Type010Schema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Type010Schema"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Type010Schema"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Type010Schema Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Type010Schema>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Type010Schema"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Type010Schema Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Type010Schema>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Type010Schema instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Type010Schema, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Type010Schema> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Type010Schema>();
            }
            finally
            {
