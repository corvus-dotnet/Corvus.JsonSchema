...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Type010Server>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchTenant(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1pulsar~10.1.0~1server.json"u8, buffer, out written);
