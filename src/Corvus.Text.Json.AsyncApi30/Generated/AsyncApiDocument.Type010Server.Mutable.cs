...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type010Server
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Type010Server instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Type010Server"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Type010Server(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Type010Server.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Type010Server Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Type010Server Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Type010Server>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(Type010Server instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Type010Server"/>.
            /// </summary>
        ...
        {
            return workspace.CreateBuilder<Type010Server, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Type010Server> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Type010Server>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Type010Server> Create<TContext>(
        ...
        public static ParsedJsonDocument<Type010Server> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type010Server.BindingVersionEntity.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source tenant = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
