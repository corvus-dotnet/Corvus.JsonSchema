...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type020Channel
    {
            ...
            : IJsonElement<MessageStoragePolicyEntity>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider AllowedPersistenceRegionsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/allowedPersistenceRegions"u8, buffer, out written);

                private static void MatchAllowedPersistenceRegions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Channel.MessageStoragePolicyEntity.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.AllowedPersistenceRegionsUtf8,
                            evaluationPath: AllowedPersistenceRegionsSchemaEvaluationPath);

                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Channel.MessageStoragePolicyEntity.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.AllowedPersistenceRegionsUtf8))
                    {
                        matcher = MatchAllowedPersistenceRegions;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1googlepubsub~10.2.0~1channel.json/properties/messageStoragePolicy"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1googlepubsub~10.2.0~1channel.json/properties/messageStoragePolicy";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1googlepubsub~10.2.0~1channel.json/properties/messageStoragePolicy"u8;
