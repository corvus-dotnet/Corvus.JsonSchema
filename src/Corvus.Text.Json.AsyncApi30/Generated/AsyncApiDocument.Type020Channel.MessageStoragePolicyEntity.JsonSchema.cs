    ...
    public readonly partial struct Type020Channel
    {
            ...
            : IJsonElement<MessageStoragePolicyEntity>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchAllowedPersistenceRegions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1googlepubsub~10.2.0~1channel.json/properties/messageStoragePolicy"u8, buffer, out written);
