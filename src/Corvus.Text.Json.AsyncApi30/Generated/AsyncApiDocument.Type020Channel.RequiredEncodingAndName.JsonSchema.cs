...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type020Channel
    {
        ...
        public readonly partial struct RequiredEncodingAndName
            : IJsonElement<RequiredEncodingAndName>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEncodingPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("encoding"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEncodingNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("encoding"u8, buffer, out written);

                private const int RequiredOffsetForEncoding = 0;
                private const uint RequiredBitForEncoding = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForEncoding | RequiredBitForName;
                ...
                private static readonly JsonSchemaPathProvider FirstRevisionIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/firstRevisionId"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider LastRevisionIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/lastRevisionId"u8, buffer, out written);
                ...
                private static void MatchEncoding(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    ...
                    requiredBitBuffer[RequiredOffsetForEncoding] |= RequiredBitForEncoding;
                }

                private static void MatchFirstRevisionId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.Text.Json.AsyncApi30.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.FirstRevisionIdUtf8,
                            evaluationPath: FirstRevisionIdSchemaEvaluationPath);
                ...
                private static void MatchLastRevisionId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext2 =
                        Corvus.Text.Json.AsyncApi30.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.LastRevisionIdUtf8,
                            evaluationPath: LastRevisionIdSchemaEvaluationPath);
                ...
                private static PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator>([
                        ...
                        (static () => JsonPropertyNames.FirstRevisionIdUtf8, MatchFirstRevisionId),
                        (static () => JsonPropertyNames.LastRevisionIdUtf8, MatchLastRevisionId),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1googlepubsub~10.2.0~1channel.json/properties/schemaSettings"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1googlepubsub~10.2.0~1channel.json/properties/schemaSettings";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1googlepubsub~10.2.0~1channel.json/properties/schemaSettings"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEncodingPresent, "encoding"u8, "required"u8);
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForEncoding] & RequiredBitForEncoding) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyEncodingNotPresent, "encoding"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEncodingPresent, "encoding"u8, "required"u8);
