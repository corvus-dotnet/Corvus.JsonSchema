    ...
    public readonly partial struct Type020Channel
    {
        ...
        public readonly partial struct RequiredEncodingAndName
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredEncodingAndName instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredEncodingAndName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredEncodingAndName(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.AsyncApi30.JsonString.Mutable Encoding
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EncodingUtf8, out Corvus.Text.Json.AsyncApi30.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>firstRevisionId</c> property.
                /// </summary>
                public Corvus.Text.Json.AsyncApi30.JsonString.Mutable FirstRevisionId
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FirstRevisionIdUtf8, out Corvus.Text.Json.AsyncApi30.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>lastRevisionId</c> property.
                /// </summary>
                public Corvus.Text.Json.AsyncApi30.JsonString.Mutable LastRevisionId
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LastRevisionIdUtf8, out Corvus.Text.Json.AsyncApi30.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredEncodingAndName(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetEncoding(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("encoding");
                    }
                ...
                /// <summary>
                /// Set the <c>firstRevisionId</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetFirstRevisionId(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FirstRevisionIdUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FirstRevisionIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FirstRevisionId, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>firstRevisionId</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveFirstRevisionId()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FirstRevisionIdUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }

                /// <summary>
                /// Set the <c>lastRevisionId</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetLastRevisionId(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LastRevisionIdUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LastRevisionIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LastRevisionId, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>lastRevisionId</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveLastRevisionId()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LastRevisionIdUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredEncodingAndName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredEncodingAndName"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredEncodingAndName"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredEncodingAndName Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredEncodingAndName>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredEncodingAndName"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredEncodingAndName Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredEncodingAndName>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Channel.RequiredEncodingAndName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(RequiredEncodingAndName instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Channel.RequiredEncodingAndName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredEncodingAndName"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.AsyncApi30.JsonString.Source encoding,
                    in Corvus.Text.Json.AsyncApi30.JsonString.Source name,
                    in Corvus.Text.Json.AsyncApi30.JsonString.Source firstRevisionId = default,
                    in Corvus.Text.Json.AsyncApi30.JsonString.Source lastRevisionId = default)
                {
                    ...
                    firstRevisionId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FirstRevisionId, ref builder);
                    lastRevisionId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LastRevisionId, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.Text.Json.AsyncApi30.JsonString.Source lastRevisionId = default)
                {
                    Create(ref _builder, encoding, name, firstRevisionId, lastRevisionId);
                }
            ...
            /// <param name="firstRevisionId">The value of the <c>"firstRevisionId"</c> property.</param>
            /// <param name="lastRevisionId">The value of the <c>"lastRevisionId"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source encoding, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source name, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source firstRevisionId = default, scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source lastRevisionId = default)
            {
                return new Source(encoding, name, firstRevisionId, lastRevisionId);
            }
            ...
            /// <param name="firstRevisionId">The value of the property.</param>
            /// <param name="lastRevisionId">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.JsonString.Source encoding, in Corvus.Text.Json.AsyncApi30.JsonString.Source name, in Corvus.Text.Json.AsyncApi30.JsonString.Source firstRevisionId = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source lastRevisionId = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(encoding, name, firstRevisionId, lastRevisionId);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredEncodingAndName, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredEncodingAndName> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredEncodingAndName>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredEncodingAndName> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredEncodingAndName> Create(in Corvus.Text.Json.AsyncApi30.JsonString.Source encoding, in Corvus.Text.Json.AsyncApi30.JsonString.Source name, in Corvus.Text.Json.AsyncApi30.JsonString.Source firstRevisionId = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source lastRevisionId = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
