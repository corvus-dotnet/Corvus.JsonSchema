...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type020Channel
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredEncodingAndName"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredEncodingAndName(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredEncodingAndName DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.AsyncApi30.JsonString Encoding
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EncodingUtf8, out Corvus.Text.Json.AsyncApi30.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.JsonString FirstRevisionId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FirstRevisionIdUtf8, out Corvus.Text.Json.AsyncApi30.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.JsonString LastRevisionId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LastRevisionIdUtf8, out Corvus.Text.Json.AsyncApi30.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredEncodingAndName left, in RequiredEncodingAndName right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredEncodingAndName left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredEncodingAndName instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredEncodingAndName(JsonElement instance)
            {
                return RequiredEncodingAndName.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredEncodingAndName From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredEncodingAndName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredEncodingAndName>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredEncodingAndName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredEncodingAndName>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredEncodingAndName ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredEncodingAndName>(json, options);
            }
            ...
            /// </exception>
            public static RequiredEncodingAndName ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredEncodingAndName>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredEncodingAndName? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredEncodingAndName>(ref reader, out result);
            }
...
#if NET
            static RequiredEncodingAndName IJsonElement<RequiredEncodingAndName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredEncodingAndName: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredEncodingAndName Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredEncodingAndName Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredEncodingAndName>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="FirstRevisionId"/>.
                /// </summary>
                public const string FirstRevisionId = "firstRevisionId";

                /// <summary>
                /// Gets the JSON property name for <see cref="LastRevisionId"/>.
                /// </summary>
                public const string LastRevisionId = "lastRevisionId";
                ...
                /// Gets the JSON property name for <see cref="FirstRevisionId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> FirstRevisionIdUtf8 => "firstRevisionId"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="LastRevisionId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> LastRevisionIdUtf8 => "lastRevisionId"u8;
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="FirstRevisionId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> FirstRevisionId => "firstRevisionId"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="LastRevisionId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> LastRevisionId => "lastRevisionId"u8;
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="FirstRevisionId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> FirstRevisionId => [0x15, 0x01, 0x00, 0x00, 0x22, 0x66, 0x69, 0x72, 0x73, 0x74, 0x52, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6F, 0x6E, 0x49, 0x64, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="LastRevisionId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> LastRevisionId => [0x05, 0x01, 0x00, 0x00, 0x22, 0x6C, 0x61, 0x73, 0x74, 0x52, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6F, 0x6E, 0x49, 0x64, 0x22];
