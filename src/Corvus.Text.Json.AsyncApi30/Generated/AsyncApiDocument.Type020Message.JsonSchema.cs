...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Type020Message>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchOrderingKey(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1googlepubsub~10.2.0~1message.json"u8, buffer, out written);
