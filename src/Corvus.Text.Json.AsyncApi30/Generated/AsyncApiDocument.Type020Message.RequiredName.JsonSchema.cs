    ...
    public readonly partial struct Type020Message
    {
            ...
            : IJsonElement<RequiredName>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1googlepubsub~10.2.0~1message.json/properties/schema"u8, buffer, out written);
