    ...
    public readonly partial struct Type020Message
    {
        ...
        public readonly partial struct RequiredName
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Message.RequiredName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Message.RequiredName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.AsyncApi30.JsonString.Source name)
                {
                ...
                /// Creates an instance of a <see cref="RequiredName"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.AsyncApi30.JsonString.Source name)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.AsyncApi30.JsonString.Source name)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.AsyncApi30.JsonString.Source name, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<RequiredName> Create(in Corvus.Text.Json.AsyncApi30.JsonString.Source name, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
