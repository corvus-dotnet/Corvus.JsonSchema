    ...
    public readonly partial struct Type020Server
    {
            ...
            : IJsonElement<LastWillAndTestamentConfiguration>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1mqtt~10.2.0~1server.json/properties/lastWill"u8, buffer, out written);
