        ...
        public readonly partial struct LastWillAndTestamentConfiguration
        {
            ...
            public readonly partial struct QosEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(QosEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="QosEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator QosEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"QosEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="QosEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="QosEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly QosEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="QosEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly QosEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<QosEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(QosEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<QosEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<QosEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<QosEntity>();
                    }
                    finally
                    {
