    ...
    public readonly partial struct Type020Server
    {
        ...
        public readonly partial struct SessionExpiryIntervalEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(SessionExpiryIntervalEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SessionExpiryIntervalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SessionExpiryIntervalEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SessionExpiryIntervalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SessionExpiryIntervalEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SessionExpiryIntervalEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SessionExpiryIntervalEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchOneOf0Entity(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf0Entity(out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.Mutable result)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SessionExpiryIntervalEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type020Server.SessionExpiryIntervalEntity.OneOf0Entity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SessionExpiryIntervalEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SessionExpiryIntervalEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SessionExpiryIntervalEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<SessionExpiryIntervalEntity> Create<TContext>(
