    ...
    public readonly partial struct Type030Channel
    {
        ...
        public readonly partial struct ExchangeEntity
        {
...
#endif
            {
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetName(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.ExchangeEntity.NameEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetType(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.ExchangeEntity.TypeEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetVhost(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.ExchangeEntity.TheVirtualHostOfTheExchangeDefaultsTo.Source value)
                {
                    CheckValidInstance();
