        ...
        public readonly partial struct ExchangeEntity
        {
            ...
            public readonly partial struct TheVirtualHostOfTheExchangeDefaultsTo
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheVirtualHostOfTheExchangeDefaultsTo, Mutable>(TheVirtualHostOfTheExchangeDefaultsTo.DefaultInstance);
                    ...
                    public static explicit operator Mutable(TheVirtualHostOfTheExchangeDefaultsTo instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheVirtualHostOfTheExchangeDefaultsTo"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheVirtualHostOfTheExchangeDefaultsTo(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheVirtualHostOfTheExchangeDefaultsTo.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheVirtualHostOfTheExchangeDefaultsTo Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheVirtualHostOfTheExchangeDefaultsTo Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheVirtualHostOfTheExchangeDefaultsTo>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheVirtualHostOfTheExchangeDefaultsTo instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TheVirtualHostOfTheExchangeDefaultsTo, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheVirtualHostOfTheExchangeDefaultsTo> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheVirtualHostOfTheExchangeDefaultsTo>();
                    }
                    finally
                    {
