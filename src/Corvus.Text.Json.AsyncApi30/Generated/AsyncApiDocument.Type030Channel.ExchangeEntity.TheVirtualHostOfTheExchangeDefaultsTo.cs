    ...
    public readonly partial struct Type030Channel
    {
        ...
        public readonly partial struct ExchangeEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheVirtualHostOfTheExchangeDefaultsTo"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheVirtualHostOfTheExchangeDefaultsTo(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheVirtualHostOfTheExchangeDefaultsTo DefaultInstance { get; } = ParsedJsonDocument<TheVirtualHostOfTheExchangeDefaultsTo>.StringConstant([.."\"/\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheVirtualHostOfTheExchangeDefaultsTo value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheVirtualHostOfTheExchangeDefaultsTo left, in TheVirtualHostOfTheExchangeDefaultsTo right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheVirtualHostOfTheExchangeDefaultsTo left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheVirtualHostOfTheExchangeDefaultsTo instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheVirtualHostOfTheExchangeDefaultsTo(JsonElement instance)
                {
                    return TheVirtualHostOfTheExchangeDefaultsTo.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheVirtualHostOfTheExchangeDefaultsTo From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheVirtualHostOfTheExchangeDefaultsTo ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheVirtualHostOfTheExchangeDefaultsTo>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheVirtualHostOfTheExchangeDefaultsTo ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheVirtualHostOfTheExchangeDefaultsTo>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheVirtualHostOfTheExchangeDefaultsTo ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheVirtualHostOfTheExchangeDefaultsTo>(json, options);
                }
                ...
                /// </exception>
                public static TheVirtualHostOfTheExchangeDefaultsTo ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheVirtualHostOfTheExchangeDefaultsTo>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheVirtualHostOfTheExchangeDefaultsTo? result)
                {
                    return JsonElementHelpers.TryParseValue<TheVirtualHostOfTheExchangeDefaultsTo>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheVirtualHostOfTheExchangeDefaultsTo(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheVirtualHostOfTheExchangeDefaultsTo IJsonElement<TheVirtualHostOfTheExchangeDefaultsTo>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheVirtualHostOfTheExchangeDefaultsTo: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheVirtualHostOfTheExchangeDefaultsTo"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheVirtualHostOfTheExchangeDefaultsTo"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheVirtualHostOfTheExchangeDefaultsTo Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheVirtualHostOfTheExchangeDefaultsTo>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheVirtualHostOfTheExchangeDefaultsTo"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheVirtualHostOfTheExchangeDefaultsTo Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheVirtualHostOfTheExchangeDefaultsTo>(_idx);
                    }
