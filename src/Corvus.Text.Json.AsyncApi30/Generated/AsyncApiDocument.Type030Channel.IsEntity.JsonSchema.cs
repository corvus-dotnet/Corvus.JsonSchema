    ...
    public readonly partial struct Type030Channel
    {
            ...
            : IJsonElement<IsEntity>
        {
            private static class Constants
            {
                ...
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly IsEntity EnumJson1 = ParsedJsonDocument<IsEntity>.StringConstant([.."\"queue\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "routingKey"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly IsEntity EnumJson2 = ParsedJsonDocument<IsEntity>.StringConstant([.."\"routingKey\""u8]);
            }
            ...
            public static class EnumValues
            {
                ...
                /// as a <see cref="IsEntity"/>.
                /// </summary>
                public static IsEntity Queue { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "queue"
                ...
                /// <summary>
                /// Gets the string "routingKey"
                /// as a <see cref="IsEntity"/>.
                /// </summary>
                public static IsEntity RoutingKey { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "routingKey"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> RoutingKeyUtf8 => Constants.Enum2;
            }
            ...
            public enum KnownValues
            {
                ...
                Queue = 0,
                /// <summary>
                /// Corresponds to the JSON string "routingKey".
                /// </summary>
                RoutingKey = 1,
            }
            ...
            public static implicit operator IsEntity(KnownValues value)
            {
                return value switch
                {
                    KnownValues.Queue => Constants.EnumJson1,
                    KnownValues.RoutingKey => Constants.EnumJson2,
            ...
            public static implicit operator KnownValues(IsEntity value)
            {
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1amqp~10.3.0~1channel.json/properties/is"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1amqp~10.3.0~1channel.json/properties/is";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1amqp~10.3.0~1channel.json/properties/is"u8;
                ...
                private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.AsyncApi30.CorvusJsonSchemaProgram.Entry(21);
