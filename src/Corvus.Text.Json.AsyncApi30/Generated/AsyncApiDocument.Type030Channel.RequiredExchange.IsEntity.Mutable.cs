        ...
        public readonly partial struct RequiredExchange
        {
            ...
            public readonly partial struct IsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(IsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<IsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IsEntity>();
                    }
                    finally
                    {
