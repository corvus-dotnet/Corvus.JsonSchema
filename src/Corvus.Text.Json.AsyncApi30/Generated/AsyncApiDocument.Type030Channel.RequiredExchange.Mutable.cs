    ...
    public readonly partial struct Type030Channel
    {
        ...
        public readonly partial struct RequiredExchange
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Mutable Is
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetIs(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source _createArg2;
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Text.Json.JsonElement.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Text.Json.JsonElement.Source exchange,
                    in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source isValue = default)
                {
                ...
                /// Creates an instance of a <see cref="RequiredExchange"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.JsonElement.Source exchange, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source isValue = default)
                {
                    Create(ref _builder, exchange, isValue);
                }
                ...
                #endif
                {
                    Create(context, ref _builder, exchange, isValue);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.JsonElement.Source arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg1, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source exchange, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source isValue = default)
            {
                return new Source(exchange, isValue);
            }
            ...
            /// <param name="isValue">The value of the <c>"is"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> exchange, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source isValue = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, exchange, isValue);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source exchange, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source isValue = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(exchange, isValue);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> exchange, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source isValue = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, exchange, isValue);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            public static ParsedJsonDocument<RequiredExchange> Create(in Corvus.Text.Json.JsonElement.Source exchange, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source isValue = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredExchange> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> exchange, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity.Source isValue = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
