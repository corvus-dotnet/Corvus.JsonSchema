...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type030Channel
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredExchange"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredExchange(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredExchange DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement Exchange
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExchangeUtf8, out Corvus.Text.Json.JsonElement value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity Is
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredExchange.IsEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredExchange left, in RequiredExchange right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredExchange left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredExchange instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredExchange(JsonElement instance)
            {
                return RequiredExchange.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredExchange From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredExchange ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredExchange>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredExchange ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredExchange>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredExchange ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredExchange>(json, options);
            }
            ...
            /// </exception>
            public static RequiredExchange ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredExchange>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredExchange? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredExchange>(ref reader, out result);
            }
...
#if NET
            static RequiredExchange IJsonElement<RequiredExchange>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredExchange: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredExchange Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredExchange>(_idx);
                }
