...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type030Channel
    {
        ...
        public readonly partial struct RequiredQueue
            : IJsonElement<RequiredQueue>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyQueuePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("queue"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyQueueNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("queue"u8, buffer, out written);

                private const int RequiredOffsetForQueue = 0;
                private const uint RequiredBitForQueue = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForQueue;
                private static readonly JsonSchemaPathProvider IsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/is"u8, buffer, out written);

                private static void MatchIs(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredQueue.IsEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.IsUtf8,
                            evaluationPath: IsSchemaEvaluationPath);

                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredQueue.IsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                }

                private static void MatchQueue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    requiredBitBuffer[RequiredOffsetForQueue] |= RequiredBitForQueue;
                }
                ...
                private static PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.IsUtf8, MatchIs),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1amqp~10.3.0~1channel.json/oneOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/definitions/http:~1~1asyncapi.com~1bindings~1amqp~10.3.0~1channel.json/oneOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/http:~1~1asyncapi.com~1bindings~1amqp~10.3.0~1channel.json/oneOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext notContext =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredQueue.RequiredExchange.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: NotSchemaEvaluationPath);
                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredQueue.RequiredExchange.JsonSchema.Evaluate(parentDocument, parentIndex, ref notContext);
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyQueuePresent, "queue"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForQueue] & RequiredBitForQueue) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyQueueNotPresent, "queue"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyQueuePresent, "queue"u8, "required"u8);
