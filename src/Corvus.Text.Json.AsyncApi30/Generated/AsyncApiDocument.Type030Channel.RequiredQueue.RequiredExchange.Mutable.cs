        ...
        public readonly partial struct RequiredQueue
        {
            ...
            public readonly partial struct RequiredExchange
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredExchange instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredExchange"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredExchange(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Text.Json.JsonElement.Mutable Exchange
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExchangeUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredExchange(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetExchange(scoped in Corvus.Text.Json.JsonElement.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetExchange<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredExchange.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredExchange"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredExchange"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredExchange Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredExchange>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredExchange"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredExchange Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredExchange>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredQueue.RequiredExchange.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public static implicit operator Source(RequiredExchange instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredQueue.RequiredExchange.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredExchange"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.JsonElement.Source exchange)
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredExchange"/>.
                    /// </summary>
                    public void Create(in Corvus.Text.Json.JsonElement.Source exchange)
                    {
                        Create(ref _builder, exchange);
                    }
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.Text.Json.JsonElement.Source<TContext> exchange)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredExchange"/>.
                    /// </summary>
                    public void Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> exchange)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                        Create(context, ref _builder, exchange);
                    }
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source exchange)
                {
                    return new Source(exchange);
                }
                ...
                /// <param name="exchange">The value of the <c>"exchange"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> exchange)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, exchange);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source exchange, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> exchange, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                {
                    return workspace.CreateBuilder<RequiredExchange, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredExchange> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredExchange>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredExchange> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredExchange> Create(in Corvus.Text.Json.JsonElement.Source exchange, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredExchange> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> exchange, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
