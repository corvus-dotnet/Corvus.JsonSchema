...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type030Channel
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredQueue.IsEntity Is
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsUtf8, out Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.RequiredQueue.IsEntity value))
                    {
                        return value;
                    }
