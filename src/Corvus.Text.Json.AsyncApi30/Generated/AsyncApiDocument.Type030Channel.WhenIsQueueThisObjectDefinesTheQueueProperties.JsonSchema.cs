...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type030Channel
    {
            ...
            : IJsonElement<WhenIsQueueThisObjectDefinesTheQueueProperties>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider AutoDeleteSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/autoDelete"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider DurableSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/durable"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider ExclusiveSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/exclusive"u8, buffer, out written);
                ...
                private static void MatchAutoDelete(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.Text.Json.AsyncApi30.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.AutoDeleteUtf8,
                            evaluationPath: AutoDeleteSchemaEvaluationPath);
                ...
                private static void MatchDurable(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.Text.Json.AsyncApi30.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.DurableUtf8,
                            evaluationPath: DurableSchemaEvaluationPath);
                ...
                private static void MatchExclusive(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Corvus.Text.Json.AsyncApi30.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ExclusiveUtf8,
                            evaluationPath: ExclusiveSchemaEvaluationPath);
                ...
                private static void MatchVhost(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext4 =
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.WhenIsQueueThisObjectDefinesTheQueueProperties.TheVirtualHostOfTheQueueDefaultsTo.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.VhostUtf8,
                            evaluationPath: VhostSchemaEvaluationPath);

                    Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type030Channel.WhenIsQueueThisObjectDefinesTheQueueProperties.TheVirtualHostOfTheQueueDefaultsTo.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
                ...
                private static PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Text.Json.AsyncApi30.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.AutoDeleteUtf8, MatchAutoDelete),
                        (static () => JsonPropertyNames.DurableUtf8, MatchDurable),
                        (static () => JsonPropertyNames.ExclusiveUtf8, MatchExclusive),
                        (static () => JsonPropertyNames.NameUtf8, MatchName),
                        (static () => JsonPropertyNames.VhostUtf8, MatchVhost),
                    ]);
                }
