        ...
        public readonly partial struct WhenIsQueueThisObjectDefinesTheQueueProperties
        {
            ...
            public readonly partial struct TheVirtualHostOfTheQueueDefaultsTo
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheVirtualHostOfTheQueueDefaultsTo, Mutable>(TheVirtualHostOfTheQueueDefaultsTo.DefaultInstance);
                    ...
                    public static explicit operator Mutable(TheVirtualHostOfTheQueueDefaultsTo instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheVirtualHostOfTheQueueDefaultsTo"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheVirtualHostOfTheQueueDefaultsTo(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheVirtualHostOfTheQueueDefaultsTo.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheVirtualHostOfTheQueueDefaultsTo Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheVirtualHostOfTheQueueDefaultsTo Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheVirtualHostOfTheQueueDefaultsTo>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheVirtualHostOfTheQueueDefaultsTo instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TheVirtualHostOfTheQueueDefaultsTo, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheVirtualHostOfTheQueueDefaultsTo> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheVirtualHostOfTheQueueDefaultsTo>();
                    }
                    finally
                    {
