...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type030Channel
    {
        ...
        public readonly partial struct WhenIsQueueThisObjectDefinesTheQueueProperties
        {
            ...
            public readonly partial struct TheVirtualHostOfTheQueueDefaultsTo
#if NET8_0_OR_GREATER
                : IJsonElement<TheVirtualHostOfTheQueueDefaultsTo>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheVirtualHostOfTheQueueDefaultsTo"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheVirtualHostOfTheQueueDefaultsTo(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheVirtualHostOfTheQueueDefaultsTo DefaultInstance { get; } = ParsedJsonDocument<TheVirtualHostOfTheQueueDefaultsTo>.StringConstant([.."\"/\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheVirtualHostOfTheQueueDefaultsTo value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheVirtualHostOfTheQueueDefaultsTo left, in TheVirtualHostOfTheQueueDefaultsTo right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheVirtualHostOfTheQueueDefaultsTo left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheVirtualHostOfTheQueueDefaultsTo instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheVirtualHostOfTheQueueDefaultsTo(JsonElement instance)
                {
                    return TheVirtualHostOfTheQueueDefaultsTo.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheVirtualHostOfTheQueueDefaultsTo From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheVirtualHostOfTheQueueDefaultsTo ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheVirtualHostOfTheQueueDefaultsTo>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheVirtualHostOfTheQueueDefaultsTo ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheVirtualHostOfTheQueueDefaultsTo>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheVirtualHostOfTheQueueDefaultsTo ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheVirtualHostOfTheQueueDefaultsTo>(json, options);
                }
                ...
                /// </exception>
                public static TheVirtualHostOfTheQueueDefaultsTo ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheVirtualHostOfTheQueueDefaultsTo>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheVirtualHostOfTheQueueDefaultsTo? result)
                {
                    return JsonElementHelpers.TryParseValue<TheVirtualHostOfTheQueueDefaultsTo>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheVirtualHostOfTheQueueDefaultsTo(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheVirtualHostOfTheQueueDefaultsTo IJsonElement<TheVirtualHostOfTheQueueDefaultsTo>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheVirtualHostOfTheQueueDefaultsTo: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheVirtualHostOfTheQueueDefaultsTo"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheVirtualHostOfTheQueueDefaultsTo"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheVirtualHostOfTheQueueDefaultsTo Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheVirtualHostOfTheQueueDefaultsTo>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheVirtualHostOfTheQueueDefaultsTo"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheVirtualHostOfTheQueueDefaultsTo Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheVirtualHostOfTheQueueDefaultsTo>(_idx);
                    }
