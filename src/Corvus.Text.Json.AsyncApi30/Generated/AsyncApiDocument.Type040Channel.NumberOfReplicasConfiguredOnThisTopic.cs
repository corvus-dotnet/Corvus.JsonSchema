...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type040Channel
    {
        ...
        public readonly partial struct NumberOfReplicasConfiguredOnThisTopic
#if NET8_0_OR_GREATER
            : IJsonElement<NumberOfReplicasConfiguredOnThisTopic>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NumberOfReplicasConfiguredOnThisTopic"/> struct.
            /// </summary>
            ...
            internal NumberOfReplicasConfiguredOnThisTopic(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NumberOfReplicasConfiguredOnThisTopic DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator double(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator sbyte(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out sbyte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator byte(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator short(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out short result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ushort(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out ushort result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator int(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator uint(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out uint result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator ulong(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out ulong result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator float(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Int128(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out Int128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator UInt128(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out UInt128 result) ? result : throw new FormatException();
#endif

#if NET
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Half(NumberOfReplicasConfiguredOnThisTopic value) => value._parent.TryGetValue(value._idx, out Half result) ? result : throw new FormatException();
#endif
            ...
            /// </returns>
            public static bool operator ==(in NumberOfReplicasConfiguredOnThisTopic left, in NumberOfReplicasConfiguredOnThisTopic right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NumberOfReplicasConfiguredOnThisTopic left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NumberOfReplicasConfiguredOnThisTopic instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NumberOfReplicasConfiguredOnThisTopic(JsonElement instance)
            {
                return NumberOfReplicasConfiguredOnThisTopic.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NumberOfReplicasConfiguredOnThisTopic From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NumberOfReplicasConfiguredOnThisTopic ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<NumberOfReplicasConfiguredOnThisTopic>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NumberOfReplicasConfiguredOnThisTopic ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<NumberOfReplicasConfiguredOnThisTopic>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NumberOfReplicasConfiguredOnThisTopic ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<NumberOfReplicasConfiguredOnThisTopic>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static NumberOfReplicasConfiguredOnThisTopic ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<NumberOfReplicasConfiguredOnThisTopic>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NumberOfReplicasConfiguredOnThisTopic? result)
            {
                return JsonElementHelpers.TryParseValue<NumberOfReplicasConfiguredOnThisTopic>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NumberOfReplicasConfiguredOnThisTopic(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static NumberOfReplicasConfiguredOnThisTopic IJsonElement<NumberOfReplicasConfiguredOnThisTopic>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NumberOfReplicasConfiguredOnThisTopic: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NumberOfReplicasConfiguredOnThisTopic"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NumberOfReplicasConfiguredOnThisTopic"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public NumberOfReplicasConfiguredOnThisTopic Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NumberOfReplicasConfiguredOnThisTopic>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NumberOfReplicasConfiguredOnThisTopic"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public NumberOfReplicasConfiguredOnThisTopic Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NumberOfReplicasConfiguredOnThisTopic>(_idx);
                }
