        ...
        public readonly partial struct TopicConfigurationPropertiesThatAreRelevantForTheApi
        {
            ...
            public readonly partial struct MaxMessageBytesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MaxMessageBytesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MaxMessageBytesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MaxMessageBytesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MaxMessageBytesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxMessageBytesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxMessageBytesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MaxMessageBytesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MaxMessageBytesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MaxMessageBytesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MaxMessageBytesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MaxMessageBytesEntity>();
                    }
                    finally
                    {
