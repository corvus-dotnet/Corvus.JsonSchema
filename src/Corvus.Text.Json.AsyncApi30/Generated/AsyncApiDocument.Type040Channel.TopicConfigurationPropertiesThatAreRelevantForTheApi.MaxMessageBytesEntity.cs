    ...
    public readonly partial struct Type040Channel
    {
        ...
        public readonly partial struct TopicConfigurationPropertiesThatAreRelevantForTheApi
        {
...
#endif
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator long(MaxMessageBytesEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator double(MaxMessageBytesEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();
