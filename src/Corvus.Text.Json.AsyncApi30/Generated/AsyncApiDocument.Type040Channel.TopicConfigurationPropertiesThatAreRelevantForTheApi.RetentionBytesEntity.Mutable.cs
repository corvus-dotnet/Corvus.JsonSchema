        ...
        public readonly partial struct TopicConfigurationPropertiesThatAreRelevantForTheApi
        {
            ...
            public readonly partial struct RetentionBytesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RetentionBytesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RetentionBytesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RetentionBytesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RetentionBytesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RetentionBytesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RetentionBytesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RetentionBytesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(RetentionBytesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<RetentionBytesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RetentionBytesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RetentionBytesEntity>();
                    }
                    finally
                    {
