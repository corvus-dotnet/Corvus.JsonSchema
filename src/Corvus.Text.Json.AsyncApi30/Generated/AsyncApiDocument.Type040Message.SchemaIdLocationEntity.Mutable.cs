    ...
    public readonly partial struct Type040Message
    {
        ...
        public readonly partial struct SchemaIdLocationEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SchemaIdLocationEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SchemaIdLocationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SchemaIdLocationEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SchemaIdLocationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SchemaIdLocationEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SchemaIdLocationEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SchemaIdLocationEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SchemaIdLocationEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (SchemaIdLocationEntity)value;
            ...
            {
                return workspace.CreateBuilder<SchemaIdLocationEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SchemaIdLocationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SchemaIdLocationEntity>();
                }
                finally
                {
