    ...
    public readonly partial struct Type050Channel
    {
        ...
        public readonly partial struct NumberOfReplicasConfiguredOnThisTopic
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NumberOfReplicasConfiguredOnThisTopic instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NumberOfReplicasConfiguredOnThisTopic"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NumberOfReplicasConfiguredOnThisTopic(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NumberOfReplicasConfiguredOnThisTopic.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NumberOfReplicasConfiguredOnThisTopic Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NumberOfReplicasConfiguredOnThisTopic Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NumberOfReplicasConfiguredOnThisTopic>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NumberOfReplicasConfiguredOnThisTopic instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NumberOfReplicasConfiguredOnThisTopic, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NumberOfReplicasConfiguredOnThisTopic> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NumberOfReplicasConfiguredOnThisTopic>();
                }
                finally
                {
