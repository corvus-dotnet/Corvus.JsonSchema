            ...
            public readonly partial struct CleanupPolicyEntityArray
            {
                ...
                public readonly partial struct CleanupPolicyEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(CleanupPolicyEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="CleanupPolicyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator CleanupPolicyEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"CleanupPolicyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CleanupPolicyEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CleanupPolicyEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<CleanupPolicyEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(CleanupPolicyEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (CleanupPolicyEntity)value;
                    ...
                    {
                        return workspace.CreateBuilder<CleanupPolicyEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<CleanupPolicyEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<CleanupPolicyEntity>();
                        }
                        finally
                        {
