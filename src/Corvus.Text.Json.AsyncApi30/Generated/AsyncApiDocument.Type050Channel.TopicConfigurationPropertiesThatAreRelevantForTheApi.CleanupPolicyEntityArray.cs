    ...
    public readonly partial struct Type050Channel
    {
        ...
        public readonly partial struct TopicConfigurationPropertiesThatAreRelevantForTheApi
        {
            ...
            public readonly partial struct CleanupPolicyEntityArray
                ...
                : IJsonElement<CleanupPolicyEntityArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="CleanupPolicyEntityArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal CleanupPolicyEntityArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static CleanupPolicyEntityArray DefaultInstance { get; }
                ...
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type050Channel.TopicConfigurationPropertiesThatAreRelevantForTheApi.CleanupPolicyEntityArray.CleanupPolicyEntity this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type050Channel.TopicConfigurationPropertiesThatAreRelevantForTheApi.CleanupPolicyEntityArray.CleanupPolicyEntity>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type050Channel.TopicConfigurationPropertiesThatAreRelevantForTheApi.CleanupPolicyEntityArray.CleanupPolicyEntity> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type050Channel.TopicConfigurationPropertiesThatAreRelevantForTheApi.CleanupPolicyEntityArray.CleanupPolicyEntity>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in CleanupPolicyEntityArray left, in CleanupPolicyEntityArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in CleanupPolicyEntityArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(CleanupPolicyEntityArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CleanupPolicyEntityArray(JsonElement instance)
                {
                    return CleanupPolicyEntityArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CleanupPolicyEntityArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CleanupPolicyEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CleanupPolicyEntityArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CleanupPolicyEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CleanupPolicyEntityArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static CleanupPolicyEntityArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<CleanupPolicyEntityArray>(json, options);
                }
                ...
                /// </exception>
                public static CleanupPolicyEntityArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<CleanupPolicyEntityArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out CleanupPolicyEntityArray? result)
                {
                    return JsonElementHelpers.TryParseValue<CleanupPolicyEntityArray>(ref reader, out result);
                }
...
#if NET
                static CleanupPolicyEntityArray IJsonElement<CleanupPolicyEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CleanupPolicyEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public CleanupPolicyEntityArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public CleanupPolicyEntityArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<CleanupPolicyEntityArray>(_idx);
                    }
