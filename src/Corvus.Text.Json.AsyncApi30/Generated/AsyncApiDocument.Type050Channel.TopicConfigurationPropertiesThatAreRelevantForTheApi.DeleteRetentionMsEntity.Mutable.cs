        ...
        public readonly partial struct TopicConfigurationPropertiesThatAreRelevantForTheApi
        {
            ...
            public readonly partial struct DeleteRetentionMsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DeleteRetentionMsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DeleteRetentionMsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DeleteRetentionMsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DeleteRetentionMsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeleteRetentionMsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeleteRetentionMsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DeleteRetentionMsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DeleteRetentionMsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DeleteRetentionMsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DeleteRetentionMsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DeleteRetentionMsEntity>();
                    }
                    finally
                    {
