        ...
        public readonly partial struct TopicConfigurationPropertiesThatAreRelevantForTheApi
        {
            ...
            public readonly partial struct RetentionMsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RetentionMsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RetentionMsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RetentionMsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RetentionMsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RetentionMsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RetentionMsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RetentionMsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(RetentionMsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<RetentionMsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RetentionMsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RetentionMsEntity>();
                    }
                    finally
                    {
