    ...
    public readonly partial struct Type050Message
    {
            ...
            : IJsonElement<TheMessageKey>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/http:~1~1asyncapi.com~1bindings~1kafka~10.5.0~1message.json/properties/key"u8, buffer, out written);
