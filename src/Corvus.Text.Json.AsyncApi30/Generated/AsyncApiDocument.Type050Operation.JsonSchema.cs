...
public readonly partial struct AsyncApiDocument
{
        ...
        : IJsonElement<Type050Operation>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchGroupId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/http:~1~1asyncapi.com~1bindings~1kafka~10.5.0~1operation.json"u8, buffer, out written);
