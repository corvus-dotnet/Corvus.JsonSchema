...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type050Server
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Type050Server instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Type050Server"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Type050Server(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Type050Server.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Type050Server Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Type050Server Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Type050Server>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type050Server.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(Type050Server instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type050Server.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Type050Server"/>.
            /// </summary>
        ...
        {
            return workspace.CreateBuilder<Type050Server, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Type050Server> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Type050Server>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Type050Server> Create<TContext>(
        ...
        public static ParsedJsonDocument<Type050Server> Create(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type050Server.TheVersionOfThisBinding.Source bindingVersion = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source schemaRegistryUrl = default, in Corvus.Text.Json.AsyncApi30.JsonString.Source schemaRegistryVendor = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
