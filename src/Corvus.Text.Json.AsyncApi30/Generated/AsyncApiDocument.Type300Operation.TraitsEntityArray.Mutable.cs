    ...
    public readonly partial struct Type300Operation
    {
        ...
        public readonly partial struct TraitsEntityArray
        {
...
#endif
            {
                ...
                public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TraitsEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TraitsEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity oldItem, in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="TraitsEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TraitsEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TraitsEntityArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TraitsEntityArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TraitsEntityArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TraitsEntityArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TraitsEntityArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TraitsEntityArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Source value)
                {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Operation.TraitsEntityArray.TraitsEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
