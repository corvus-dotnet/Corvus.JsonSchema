...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Type300Server
    {
...
#endif
        {
            ...
            public Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Server.TagsEntityArray.TagsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Server.TagsEntityArray.TagsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Server.TagsEntityArray.TagsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Type300Server.TagsEntityArray.TagsEntity>(_parent, _idx);
            }
