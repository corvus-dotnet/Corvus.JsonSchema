...
public readonly partial struct AsyncApiDocument
{
    ...
    public readonly partial struct Websockets010Channel
    {
        ...
        public readonly partial struct QueryEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(QueryEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="QueryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator QueryEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new QueryEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"QueryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="QueryEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="QueryEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly QueryEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<QueryEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="QueryEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly QueryEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<QueryEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.QueryEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Websockets010Channel.QueryEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Text.Json.AsyncApi30.AsyncApiDocument.Schema.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(QueryEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<QueryEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<QueryEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<QueryEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<QueryEntity> Create<TContext>(
