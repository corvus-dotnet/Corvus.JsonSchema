...
public readonly partial struct JsonRegex
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonRegex instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonRegex"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonRegex(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonRegex.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonRegex Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonRegex Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonRegex>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonRegex instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonRegex, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonRegex> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonRegex>();
        }
        finally
        {
