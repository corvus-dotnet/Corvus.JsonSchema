...
public readonly partial struct JsonUriReference
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonUriReference instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonUriReference"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonUriReference(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonUriReference.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonUriReference"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonUriReference"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUriReference Clone()
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonUriReference"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUriReference Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonUriReference>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonUriReference instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonUriReference, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonUriReference> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonUriReference>();
        }
        finally
        {
