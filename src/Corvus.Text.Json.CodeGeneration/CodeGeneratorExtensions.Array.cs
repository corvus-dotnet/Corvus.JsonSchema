...
internal static partial class CodeGeneratorExtensions
{
    ...
    public static CodeGenerator AppendArrayMutators(this CodeGenerator generator, TypeDeclaration typeDeclaration)
    {
        ...
        generator
            ...
            .AppendLineIndent("/// </remarks>")
            .AppendLineIndent("[MethodImpl(MethodImplOptions.AggressiveInlining)]")
            .AppendLineIndent("public void InsertItem(int itemIndex, scoped in ", fqdtn, ".", generator.SourceClassName(fqdtn), " value)")
            .AppendLineIndent("{")
            .PushIndent()
                .AppendLineIndent("CheckValidInstance();")
                .AppendSeparatorLine()
        ...
        generator
            ...
            .AppendLineIndent("/// </exception>")
            .AppendLineIndent("[MethodImpl(MethodImplOptions.AggressiveInlining)]")
            .AppendLineIndent("public void AddItem(scoped in ", fqdtn, ".", generator.SourceClassName(fqdtn), " value)")
            .AppendLineIndent("{")
            .PushIndent()
