...
/// <summary>
/// The C# <see cref="IClientEmitter"/> for OpenAPI 3.0: turns the shared intermediate
/// representation into C# client and server source files.
/// </summary>
/// <remarks>
/// <para>
/// This holds the emit phase that was previously inlined in <see cref="OpenApi30CodeGenerator"/>.
/// It lives in the version project because a few emit-support extractors still read the
/// strongly-typed <see cref="OpenApiDocument"/> for metadata that the shared intermediate
/// representation does not carry.
/// </para>
/// </remarks>
internal sealed class OpenApi30CSharpEmitter : IClientEmitter
{
    ...
    public GeneratedFile EmitClientInterface(
        ...
        => this.EmitInterface(this.walker.GetClientName(tag), tagOperations, context.RootServer);
    ...
    public GeneratedFile? EmitServerRegistrationModule(
        ...
        ClientEmitContext context)
        => this.EmitServerEndpointRegistration((Dictionary<string, List<OperationInfo>>)groups, operations, isCallbackServer);
