...
/// <summary>
/// The C# <see cref="IClientEmitter"/> for OpenAPI 3.2: turns the shared intermediate
/// representation into C# client and server source files.
/// </summary>
/// <remarks>
/// <para>
/// This holds the emit phase that was previously inlined in <see cref="OpenApi32CodeGenerator"/>.
/// It lives in the version project because the security-scheme and document-identity extractors
/// it calls from <see cref="PrepareContext"/> read the strongly-typed <see cref="OpenApiDocument"/>
/// for metadata that the shared intermediate representation does not carry.
/// </para>
/// </remarks>
internal sealed class OpenApi32CSharpEmitter : IClientEmitter
{
