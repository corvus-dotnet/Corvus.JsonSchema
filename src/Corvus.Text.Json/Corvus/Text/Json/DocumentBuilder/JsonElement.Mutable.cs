...
#pragma warning restore CA2265
        ...
        {
            CheckValidInstance();
            _parent.CopyValueToProperty(source._idx, _idx, propertyName);
            _documentVersion = _parent.Version;
        }
        ...
        {
            CheckValidInstance();
            _parent.CopyValueToArrayIndex(source._idx, _idx, itemIndex);
            _documentVersion = _parent.Version;
        }
        ...
        {
            CheckValidInstance();
            _parent.CopyValueToArrayEnd(source._idx, _idx);
            _documentVersion = _parent.Version;
        }

        /// <summary>
        /// Moves a property from this object to a destination array, inserting at the given index.
        /// </summary>
        /// <param name="srcPropertyName">The name of the property to move.</param>
        /// <param name="destArray">The destination array element.</param>
        ...
        public bool MovePropertyToArray(ReadOnlySpan<byte> srcPropertyName, in Mutable destArray, int destIndex)
        {
            CheckValidInstance();
            bool result = _parent.MovePropertyToArray(_idx, srcPropertyName, destArray._idx, destIndex);
            _documentVersion = _parent.Version;
            return result;
        }

        /// <summary>
        /// Moves a property from this object to a destination array, appending at the end.
        /// </summary>
        /// <param name="srcPropertyName">The name of the property to move.</param>
        /// <param name="destArray">The destination array element.</param>
        /// <returns><see langword="true"/> if the property was found and moved; otherwise, <see langword="false"/>.</returns>
        public bool MovePropertyToArrayEnd(ReadOnlySpan<byte> srcPropertyName, in Mutable destArray)
        {
            CheckValidInstance();
            bool result = _parent.MovePropertyToArrayEnd(_idx, srcPropertyName, destArray._idx);
            _documentVersion = _parent.Version;
            return result;
        }

        /// <summary>
        /// Moves a property from this object to a destination object as a new property.
        /// </summary>
        /// <param name="srcPropertyName">The name of the property to move.</param>
        /// <param name="destObject">The destination object element.</param>
        /// <param name="destPropertyName">The property name in the destination object.</param>
        /// <returns><see langword="true"/> if the property was found and moved; otherwise, <see langword="false"/>.</returns>
        public bool MovePropertyToProperty(ReadOnlySpan<byte> srcPropertyName, in Mutable destObject, ReadOnlySpan<byte> destPropertyName)
        {
            CheckValidInstance();
            bool result = _parent.MovePropertyToProperty(_idx, srcPropertyName, destObject._idx, destPropertyName);
            _documentVersion = _parent.Version;
            return result;
        }

        /// <summary>
        /// Moves an array item from this array to a destination array, inserting at the given index.
        /// </summary>
        /// <param name="srcIndex">The zero-based index of the item to move.</param>
        /// <param name="destArray">The destination array element.</param>
        ...
        public void MoveItemToArray(int srcIndex, in Mutable destArray, int destIndex)
        {
            CheckValidInstance();
            _parent.MoveItemToArray(_idx, srcIndex, destArray._idx, destIndex);
            _documentVersion = _parent.Version;
        }

        /// <summary>
        /// Moves an array item from this array to a destination array, appending at the end.
        /// </summary>
        /// <param name="srcIndex">The zero-based index of the item to move.</param>
        /// <param name="destArray">The destination array element.</param>
        public void MoveItemToArrayEnd(int srcIndex, in Mutable destArray)
        {
            CheckValidInstance();
            _parent.MoveItemToArrayEnd(_idx, srcIndex, destArray._idx);
            _documentVersion = _parent.Version;
        }

        /// <summary>
        /// Moves an array item from this array to a destination object as a new property.
        /// </summary>
        /// <param name="srcIndex">The zero-based index of the item to move.</param>
        /// <param name="destObject">The destination object element.</param>
        /// <param name="destPropertyName">The property name in the destination object.</param>
        public void MoveItemToProperty(int srcIndex, in Mutable destObject, ReadOnlySpan<byte> destPropertyName)
        {
            CheckValidInstance();
            _parent.MoveItemToProperty(_idx, srcIndex, destObject._idx, destPropertyName);
            _documentVersion = _parent.Version;
        }
