...
public class BinaryJsonNumberMaxMagnitudeNumberTests
{
    [Fact]
    ...
    public void TestMaxMagnitudeNumber_ByteAndInt16()
    {
        ...
        Assert.Equal(new BinaryJsonNumber((short)10), result);
    }
    ...
    public void TestMaxMagnitudeNumber_HalfAndSByte()
    {
        ...
        Assert.Equal(new BinaryJsonNumber((sbyte)10), result);
    }
    ...
    public void TestMaxMagnitudeNumber_Int16AndByte()
    {
        ...
        Assert.Equal(new BinaryJsonNumber((byte)10), result);
    }
    ...
    public void TestMaxMagnitudeNumber_SByteAndHalf()
    {
        ...
        Assert.Equal(new BinaryJsonNumber((Half)10), result);
    }
}
#endif