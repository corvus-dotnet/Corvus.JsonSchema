...
public class BinaryJsonNumberMinMagnitudeNumberTests
{
    [Fact]
    ...
    public void TestMinMagnitudeNumber_ByteAndInt16()
    {
        ...
        Assert.Equal(new BinaryJsonNumber((byte)5), result);
    }
    ...
    public void TestMinMagnitudeNumber_HalfAndSByte()
    {
        ...
        Assert.Equal(new BinaryJsonNumber((Half)5), result);
    }
#endif
    ...
    public void TestMinMagnitudeNumber_Int16AndByte()
    {
        ...
        Assert.Equal(new BinaryJsonNumber((short)5), result);
    }
    ...
    public void TestMinMagnitudeNumber_SByteAndHalf()
    {
        ...
        Assert.Equal(new BinaryJsonNumber((sbyte)5), result);
    }
}
#endif