// <copyright file="JsonIriCastTests.cs" company="Endjin Limited">
...
/// <summary>
/// Tests for JsonIriCast.
/// </summary>
[TestClass]
public class JsonIriCastTests
{
    [TestMethod]
    ...
    public void Cast_from_JsonString_for_json_element_backed_value_as_an_iri()
    {
        ...
        var result = (JsonIri)sut;
        Assert.AreEqual(JsonIri.ParseValue("\"http://foo.bar/?baz=qux#quux\"".AsSpan()), result);
    }
