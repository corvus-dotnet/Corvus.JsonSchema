// <copyright file="JsonUriReferenceCastTests.cs" company="Endjin Limited">
...
/// <summary>
/// Tests for JsonUriReferenceCast.
/// </summary>
[TestClass]
public class JsonUriReferenceCastTests
{
    [TestMethod]
    ...
    public void Cast_from_JsonString_for_json_element_backed_value_as_an_uri()
    {
        ...
        var result = (JsonUriReference)sut;
        Assert.AreEqual(JsonUriReference.ParseValue("\"http://foo.bar/?baz=qux#quux\"".AsSpan()), result);
    }
