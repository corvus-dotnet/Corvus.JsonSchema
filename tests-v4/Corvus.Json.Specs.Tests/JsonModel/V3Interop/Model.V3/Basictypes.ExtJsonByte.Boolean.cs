...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonByte : IJsonBoolean<ExtJsonByte>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonByte"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonByte(bool value)
        {
        ...
        public static implicit operator ExtJsonByte(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonByte(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonByte value)
        {
