...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonDouble : IJsonBoolean<ExtJsonDouble>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonDouble"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonDouble(bool value)
        {
        ...
        public static implicit operator ExtJsonDouble(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonDouble(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonDouble value)
        {
