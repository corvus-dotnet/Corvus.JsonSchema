...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonIdnEmail : IJsonBoolean<ExtJsonIdnEmail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonIdnEmail"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonIdnEmail(bool value)
        {
        ...
        public static implicit operator ExtJsonIdnEmail(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonIdnEmail(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonIdnEmail value)
        {
