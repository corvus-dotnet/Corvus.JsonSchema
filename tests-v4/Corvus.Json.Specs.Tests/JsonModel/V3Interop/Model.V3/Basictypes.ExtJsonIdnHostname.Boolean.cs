...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonIdnHostname : IJsonBoolean<ExtJsonIdnHostname>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonIdnHostname"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonIdnHostname(bool value)
        {
        ...
        public static implicit operator ExtJsonIdnHostname(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonIdnHostname(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonIdnHostname value)
        {
