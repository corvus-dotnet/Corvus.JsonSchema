...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonIri : IJsonBoolean<ExtJsonIri>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonIri"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonIri(bool value)
        {
        ...
        public static implicit operator ExtJsonIri(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonIri(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonIri value)
        {
