...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonIriReference : IJsonBoolean<ExtJsonIriReference>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonIriReference"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonIriReference(bool value)
        {
        ...
        public static implicit operator ExtJsonIriReference(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonIriReference(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonIriReference value)
        {
