...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonSingle : IJsonBoolean<ExtJsonSingle>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonSingle"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonSingle(bool value)
        {
        ...
        public static implicit operator ExtJsonSingle(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonSingle(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonSingle value)
        {
