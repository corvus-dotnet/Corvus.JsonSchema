...
: IJsonNumber<ExtJsonSingle>,
  IAdditionOperators<ExtJsonSingle, ExtJsonSingle, ExtJsonSingle>,
  ISubtractionOperators<ExtJsonSingle, ExtJsonSingle, ExtJsonSingle>,
  IMultiplyOperators<ExtJsonSingle, ExtJsonSingle, ExtJsonSingle>,
  IDivisionOperators<ExtJsonSingle, ExtJsonSingle, ExtJsonSingle>,
  IIncrementOperators<ExtJsonSingle>,
  IDecrementOperators<ExtJsonSingle>
#else
    : IJsonNumber<ExtJsonSingle>
#endif
    {
        ...
        public ExtJsonSingle(in BinaryJsonNumber value)
        {
        ...
        public ExtJsonSingle(float value) : this(new BinaryJsonNumber(value))
        {
        }
        ...
        public static implicit operator ExtJsonSingle(JsonNumber value)
        {
        ...
        public static explicit operator byte (ExtJsonSingle value)
        {
        ...
        public static explicit operator decimal (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator double (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator short (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator int (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator long (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an Int64.</exception>
    public static explicit operator Int128(ExtJsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        public static explicit operator sbyte (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    public static explicit operator Half(ExtJsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value was not a number.</exception>
        /// <exception cref = "FormatException">The value was not formatted as a Single.</exception>
        public static implicit operator float (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ushort (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator uint (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator ulong (ExtJsonSingle value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
    ...
    /// <exception cref="InvalidOperationException">The value was not a number.</exception>
    /// <exception cref="FormatException">The value was not formatted as an UInt64.</exception>
    public static explicit operator UInt128(ExtJsonSingle value)
    {
        if ((value.backing & Backing.JsonElement) != 0)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(decimal value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ExtJsonSingle(Half value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator ExtJsonSingle(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(byte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator ExtJsonSingle(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ExtJsonSingle(Int128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
    ...
    /// </summary>
    /// <param name="value">The value to convert.</param>
    public static explicit operator ExtJsonSingle(UInt128 value)
    {
        return new(new BinaryJsonNumber(value));
    }
#endif
        ...
        public static ExtJsonSingle operator +(ExtJsonSingle left, ExtJsonSingle right)
        {
        ...
        /// <returns>The resulting value.</returns>
        public static ExtJsonSingle operator ++(ExtJsonSingle value)
        {
        ...
        public static int Compare(in ExtJsonSingle lhs, in ExtJsonSingle rhs)
        {
