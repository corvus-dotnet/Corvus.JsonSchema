...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString : IJsonBoolean<ExtJsonString>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString(bool value)
        {
        ...
        public static implicit operator ExtJsonString(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString value)
        {
