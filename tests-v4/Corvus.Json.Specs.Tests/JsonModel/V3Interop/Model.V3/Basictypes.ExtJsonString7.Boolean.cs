...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString7 : IJsonBoolean<ExtJsonString7>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString7"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString7(bool value)
        {
        ...
        public static implicit operator ExtJsonString7(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString7(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString7 value)
        {
