...
public readonly partial struct Basictypes
{
    ...
    /// </summary>
    public readonly partial struct ExtJsonString8 : IJsonBoolean<ExtJsonString8>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ExtJsonString8"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ExtJsonString8(bool value)
        {
        ...
        public static implicit operator ExtJsonString8(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ExtJsonString8(bool value)
        {
            return new(value);
        }
        ...
        public static implicit operator bool (ExtJsonString8 value)
        {
