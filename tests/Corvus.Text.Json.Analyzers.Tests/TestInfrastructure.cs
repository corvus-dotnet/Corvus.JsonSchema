...
/// which include <c>System.Memory</c> types natively.
/// </para>
/// <para>
/// On .NET Framework (net481), we use the .NET Framework 4.8.1 reference assemblies
/// augmented with the <c>System.Memory</c> NuGet package so that types such as
/// <see cref="System.ReadOnlySpan{T}"/> are available to the test code under analysis.
/// This mirrors the real-world scenario where .NET Framework consumers install
/// <c>System.Memory</c> via NuGet.
/// </para>
/// </remarks>
