// <copyright file="CosmosCatalogStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared catalog-conformance suite against <see cref="CosmosWorkflowCatalogStore"/> over the Azure
/// Cosmos DB emulator in a container. Each test gets an empty store (the database is dropped and recreated).
/// </summary>
/// <remarks>
...
[TestCategory("docker")]
[TestCategory("cosmos")]
public sealed class CosmosCatalogStoreConformanceTests : WorkflowCatalogStoreConformance
{
    ...
    public static async Task ClassInitAsync(TestContext context)
    {
        ...
        CosmosClientOptions options = CosmosWorkflowCatalogStore.CreateClientOptions();
    ...
    protected override async ValueTask<IWorkflowCatalogStore> CreateStoreAsync(TimeProvider timeProvider)
    {
        ...
        await CosmosWorkflowCatalogStore.PrepareAsync(client, DatabaseName);
        return await CosmosWorkflowCatalogStore.ConnectAsync(client, DatabaseName, timeProvider);
    }
}