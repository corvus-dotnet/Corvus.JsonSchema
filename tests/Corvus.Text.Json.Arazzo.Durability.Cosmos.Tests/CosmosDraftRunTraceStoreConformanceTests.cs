// <copyright file="CosmosDraftRunTraceStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared draft-run-trace-store conformance suite against <see cref="CosmosDraftRunTraceStore"/> over the
...
[TestCategory("docker")]
[TestCategory("cosmos")]
public sealed class CosmosDraftRunTraceStoreConformanceTests : DraftRunTraceStoreConformance
{
    ...
    public static async Task ClassInitAsync(TestContext context)
    {
        ...
        CosmosClientOptions options = CosmosDraftRunTraceStore.CreateClientOptions();
    ...
    protected override async ValueTask<IDraftRunTraceStore> CreateStoreAsync()
    {
        ...
        await CosmosDraftRunTraceStore.PrepareAsync(client, DatabaseName);
        return await CosmosDraftRunTraceStore.ConnectAsync(client, DatabaseName);
    }
}