// <copyright file="CosmosNativeBuildJobStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared <see cref="NativeBuildJobStoreConformance"/> suite against <see cref="CosmosNativeBuildJobStore"/> over the
...
[TestCategory("docker")]
[TestCategory("cosmos")]
public sealed class CosmosNativeBuildJobStoreConformanceTests : NativeBuildJobStoreConformance
{
    ...
    public static async Task ClassInitAsync(TestContext context)
    {
        ...
        CosmosClientOptions options = CosmosNativeBuildJobStore.CreateClientOptions();
    ...
    protected override async ValueTask<INativeBuildJobStore> CreateStoreAsync(TimeProvider timeProvider)
    {
        ...
        await CosmosNativeBuildJobStore.PrepareAsync(client, DatabaseName);
        return await CosmosNativeBuildJobStore.ConnectAsync(client, DatabaseName, timeProvider);
    }
}