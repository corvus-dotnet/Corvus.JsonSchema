// <copyright file="CosmosResumeClaimTests.cs" company="Endjin Limited">
...
/// <see cref="CosmosWorkflowStateStore"/> over the Azure Cosmos DB emulator in a container. Each test gets an
...
[TestCategory("docker")]
[TestCategory("cosmos")]
public sealed class CosmosResumeClaimTests
{
    ...
    private static async ValueTask<IWorkflowStateStore> CreateStoreAsync()
    {
        ...
        return await CosmosWorkflowStateStore.ConnectAsync(client, DatabaseName);
    }
}