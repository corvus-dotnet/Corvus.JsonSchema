// <copyright file="CosmosRunnerRegistryConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared registry-conformance suite against <see cref="CosmosRunnerRegistry"/> over the Azure Cosmos DB
/// emulator in a container. Each test gets an empty registry (the database is dropped and recreated).
/// </summary>
/// <remarks>
...
[TestCategory("docker")]
[TestCategory("cosmos")]
public sealed class CosmosRunnerRegistryConformanceTests : RunnerRegistryConformance
{
    ...
    public static async Task ClassInitAsync(TestContext context)
    {
        ...
        CosmosClientOptions options = CosmosRunnerRegistry.CreateClientOptions();
    ...
    protected override async ValueTask<IRunnerRegistry> CreateRegistryAsync()
    {
        ...
        await CosmosRunnerRegistry.PrepareAsync(client, DatabaseName);
        return await CosmosRunnerRegistry.ConnectAsync(client, DatabaseName);
    }
}