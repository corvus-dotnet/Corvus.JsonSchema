// <copyright file="CosmosWorkspaceWorkflowStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared <see cref="WorkspaceWorkflowStoreConformance"/> suite against <see cref="CosmosWorkspaceWorkflowStore"/>
...
[TestCategory("docker")]
[TestCategory("cosmos")]
public sealed class CosmosWorkspaceWorkflowStoreConformanceTests : WorkspaceWorkflowStoreConformance
{
    ...
    public static async Task ClassInitAsync(TestContext context)
    {
        ...
        CosmosClientOptions options = CosmosWorkspaceWorkflowStore.CreateClientOptions();
    ...
    protected override async ValueTask<IWorkspaceWorkflowStore> CreateStoreAsync(TimeProvider timeProvider)
    {
        ...
        return await CosmosWorkspaceWorkflowStore.ConnectAsync(client, DatabaseName, timeProvider);
    }
}