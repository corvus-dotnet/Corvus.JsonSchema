// <copyright file="MongoCatalogStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared catalog-conformance suite against <see cref="MongoWorkflowCatalogStore"/> over a real MongoDB
...
[TestCategory("docker")]
public sealed class MongoCatalogStoreConformanceTests : WorkflowCatalogStoreConformance
{
    ...
    protected override async ValueTask<IWorkflowCatalogStore> CreateStoreAsync(TimeProvider timeProvider)
    {
        ...
        return await MongoWorkflowCatalogStore.ConnectAsync(client, DatabaseName, timeProvider);
    }
}