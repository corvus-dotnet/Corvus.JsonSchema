// <copyright file="MongoDraftRunStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared draft-run-store conformance suite against <see cref="MongoDraftRunStore"/> over a real MongoDB
...
[TestCategory("docker")]
public sealed class MongoDraftRunStoreConformanceTests : DraftRunStoreConformance
{
    ...
    protected override async ValueTask<IDraftRunStore> CreateStoreAsync()
    {
        ...
        return await MongoDraftRunStore.ConnectAsync(client, DatabaseName);
    }
}