// <copyright file="MySqlEnvironmentRunnerAuthorizationStoreConformanceTests.cs" company="Endjin Limited">
...
/// <see cref="MySqlEnvironmentRunnerAuthorizationStore"/> over a real MySQL server in a container. Each test gets an empty
/// store (the table is dropped and re-provisioned).
/// </summary>
[TestClass]
[TestCategory("integration")]
[TestCategory("docker")]
public sealed class MySqlEnvironmentRunnerAuthorizationStoreConformanceTests : EnvironmentRunnerAuthorizationStoreConformance
{
    ...
    protected override async ValueTask<IEnvironmentRunnerAuthorizationStore> CreateStoreAsync()
    {
        ...
        await MySqlEnvironmentRunnerAuthorizationStore.PrepareAsync(dataSource);
        return await MySqlEnvironmentRunnerAuthorizationStore.ConnectAsync(dataSource);
    }
}