// <copyright file="MySqlSourceCredentialStoreConformanceTests.cs" company="Endjin Limited">
...
/// <see cref="MySqlSourceCredentialStore"/> over a real MySQL server in a container. Each test gets an empty store
/// (the table is dropped and re-provisioned).
/// </summary>
[TestClass]
[TestCategory("integration")]
[TestCategory("docker")]
public sealed class MySqlSourceCredentialStoreConformanceTests : SourceCredentialStoreConformance
{
    ...
    protected override async ValueTask<ISourceCredentialStore> CreateStoreAsync(TimeProvider timeProvider)
    {
        ...
        await MySqlSourceCredentialStore.PrepareAsync(dataSource);
        return await MySqlSourceCredentialStore.ConnectAsync(dataSource, timeProvider);
    }
}