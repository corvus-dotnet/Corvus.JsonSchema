// <copyright file="NatsJetStreamDraftRunTraceStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared draft-run-trace-store conformance suite against <see cref="NatsJetStreamDraftRunTraceStore"/> over
/// a real NATS server (with JetStream) in a container, exercising the connection (caller-owned) overloads. Each test
/// gets an empty store (the bucket is dropped and re-provisioned).
/// </summary>
[TestClass]
[TestCategory("integration")]
[TestCategory("docker")]
public sealed class NatsJetStreamDraftRunTraceStoreConformanceTests : DraftRunTraceStoreConformance
{
