// <copyright file="NatsJetStreamObservedIdentityStoreConformanceTests.cs" company="Endjin Limited">
...
/// <see cref="NatsJetStreamObservedIdentityStore"/> over a real NATS server (with JetStream) in a container. Each
/// test gets an empty store (the KV bucket is dropped and re-provisioned).
/// </summary>
[TestClass]
[TestCategory("integration")]
[TestCategory("docker")]
public sealed class NatsJetStreamObservedIdentityStoreConformanceTests : ObservedIdentityStoreConformance
{
