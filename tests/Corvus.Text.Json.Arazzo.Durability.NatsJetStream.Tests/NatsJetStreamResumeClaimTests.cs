// <copyright file="NatsJetStreamResumeClaimTests.cs" company="Endjin Limited">
...
/// <see cref="NatsJetStreamWorkflowStateStore"/> over a real NATS server (with JetStream) in a container. Each
/// test gets an empty store (the buckets are dropped and re-provisioned).
/// </summary>
[TestClass]
[TestCategory("integration")]
[TestCategory("docker")]
public sealed class NatsJetStreamResumeClaimTests
{
