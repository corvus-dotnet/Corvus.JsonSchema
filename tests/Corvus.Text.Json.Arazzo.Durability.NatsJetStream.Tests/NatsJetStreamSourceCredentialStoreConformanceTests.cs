// <copyright file="NatsJetStreamSourceCredentialStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared <see cref="SourceCredentialStoreConformance"/> suite against
/// <see cref="NatsJetStreamSourceCredentialStore"/> over a real NATS server (with JetStream) in a container. Each
/// test gets an empty store (the KV bucket is dropped and re-provisioned).
/// </summary>
[TestClass]
[TestCategory("integration")]
[TestCategory("docker")]
public sealed class NatsJetStreamSourceCredentialStoreConformanceTests : SourceCredentialStoreConformance
{
