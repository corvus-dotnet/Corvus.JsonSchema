// <copyright file="PostgresCatalogStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared catalog-conformance suite against <see cref="PostgresWorkflowCatalogStore"/> over a real
...
[TestCategory("docker")]
public sealed class PostgresCatalogStoreConformanceTests : WorkflowCatalogStoreConformance
{
    ...
    protected override async ValueTask<IWorkflowCatalogStore> CreateStoreAsync(TimeProvider timeProvider)
    {
        ...
        return await PostgresWorkflowCatalogStore.ConnectAsync(dataSource, timeProvider);
    }
}