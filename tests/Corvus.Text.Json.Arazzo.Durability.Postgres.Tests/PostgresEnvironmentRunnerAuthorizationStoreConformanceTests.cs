// <copyright file="PostgresEnvironmentRunnerAuthorizationStoreConformanceTests.cs" company="Endjin Limited">
...
/// <see cref="PostgresEnvironmentRunnerAuthorizationStore"/> over a real PostgreSQL server in a container. Each test gets an
/// empty store (the table is dropped and re-provisioned).
/// </summary>
[TestClass]
[TestCategory("integration")]
[TestCategory("docker")]
public sealed class PostgresEnvironmentRunnerAuthorizationStoreConformanceTests : EnvironmentRunnerAuthorizationStoreConformance
{
    ...
    protected override async ValueTask<IEnvironmentRunnerAuthorizationStore> CreateStoreAsync()
    {
        ...
        return await PostgresEnvironmentRunnerAuthorizationStore.ConnectAsync(dataSource);
    }
}