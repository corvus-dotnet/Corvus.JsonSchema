// <copyright file="PostgresWorkflowDeploymentStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared <see cref="WorkflowDeploymentStoreConformance"/> suite against <see cref="PostgresWorkflowDeploymentStore"/>
/// over a real PostgreSQL server in a container. Each test gets an empty store (the table is dropped and re-provisioned).
/// </summary>
[TestClass]
[TestCategory("integration")]
[TestCategory("docker")]
public sealed class PostgresWorkflowDeploymentStoreConformanceTests : WorkflowDeploymentStoreConformance
{
    ...
    protected override async ValueTask<IWorkflowDeploymentStore> CreateStoreAsync(TimeProvider timeProvider)
    {
        ...
        await PostgresWorkflowDeploymentStore.PrepareAsync(dataSource);
        return await PostgresWorkflowDeploymentStore.ConnectAsync(dataSource, timeProvider);
    }
}