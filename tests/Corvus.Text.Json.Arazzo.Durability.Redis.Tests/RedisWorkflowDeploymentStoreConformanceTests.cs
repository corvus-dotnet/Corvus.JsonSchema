// <copyright file="RedisWorkflowDeploymentStoreConformanceTests.cs" company="Endjin Limited">
...
/// <summary>
/// Runs the shared <see cref="WorkflowDeploymentStoreConformance"/> suite against <see cref="RedisWorkflowDeploymentStore"/>
/// over a real Redis server in a container. Each test gets an empty store (the database is flushed).
/// </summary>
[TestClass]
[TestCategory("integration")]
[TestCategory("docker")]
public sealed class RedisWorkflowDeploymentStoreConformanceTests : WorkflowDeploymentStoreConformance
{
    ...
    protected override async ValueTask<IWorkflowDeploymentStore> CreateStoreAsync(TimeProvider timeProvider)
    {
        ...
        await RedisWorkflowDeploymentStore.PrepareAsync(configuration);
        return await RedisWorkflowDeploymentStore.ConnectAsync(configuration, timeProvider);
    }
}