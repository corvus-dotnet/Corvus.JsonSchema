...
public readonly partial struct LightMeasuredPayload
{
...
#endif
    {
        ...
        public static explicit operator Mutable(LightMeasuredPayload instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="LightMeasuredPayload"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LightMeasuredPayload(Mutable instance)
        {
        ...
        public void SetLumens(in Streetlights.Client.Models.LightMeasuredPayload.LightIntensityMeasuredInLumens.Source value)
        {
            ...
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LumensUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LumensUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Lumens, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>lumens</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveLumens()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LumensUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LightMeasuredPayload.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly LightMeasuredPayload Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly LightMeasuredPayload Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<LightMeasuredPayload>(_idx);
        }
    }
