    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchLumens(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                Streetlights.Client.V26.LightMeasuredPayload.LumensEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Streetlights.Client.V26.LightMeasuredPayload.LumensEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
