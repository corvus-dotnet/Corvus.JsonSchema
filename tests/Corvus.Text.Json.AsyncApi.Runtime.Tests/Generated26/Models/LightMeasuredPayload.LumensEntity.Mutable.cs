...
public readonly partial struct LightMeasuredPayload
{
    ...
    public readonly partial struct LumensEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LumensEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LumensEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LumensEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LumensEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LumensEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LumensEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LumensEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LumensEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LumensEntity, Mutable>(this);
        }
    }
}
