...
#endif
{
    ...
    /// </summary>
    public Streetlights.Client.V26.Models.LightMeasuredPayload.LumensEntity Lumens
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LumensUtf8, out Streetlights.Client.V26.Models.LightMeasuredPayload.LumensEntity value))
            {
                return value;
            }
