...
public readonly partial struct TurnOnOffPayload
{
    ...
    public readonly partial struct CommandEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CommandEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CommandEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommandEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CommandEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommandEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CommandEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CommandEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CommandEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CommandEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CommandEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CommandEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CommandEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CommandEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CommandEntity, Mutable>(this);
        }
    }
}
