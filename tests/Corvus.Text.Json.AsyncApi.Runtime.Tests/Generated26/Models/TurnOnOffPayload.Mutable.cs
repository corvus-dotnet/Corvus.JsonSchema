...
public readonly partial struct TurnOnOffPayload
{
    ...
    public ref struct Source
    {
        ...
        private readonly Streetlights.Client.V26.Models.TurnOnOffPayload.CommandEntity.Source _createArg1;
        ...
        internal Source(in Streetlights.Client.V26.Models.TurnOnOffPayload.CommandEntity.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in Streetlights.Client.V26.Models.TurnOnOffPayload.CommandEntity.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Streetlights.Client.V26.Models.TurnOnOffPayload.CommandEntity.Source command = default)
    {
