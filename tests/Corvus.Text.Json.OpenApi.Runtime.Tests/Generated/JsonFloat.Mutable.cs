...
public readonly partial struct JsonFloat
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonFloat instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonFloat"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonFloat(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonFloat(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonFloat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonFloat"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonFloat"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonFloat Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonFloat>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonFloat"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonFloat Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonFloat>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonFloat instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonFloat, Mutable>(this);
    }
}
