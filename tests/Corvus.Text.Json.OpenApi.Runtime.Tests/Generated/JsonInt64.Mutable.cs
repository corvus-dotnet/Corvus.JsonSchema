...
public readonly partial struct JsonInt64
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonInt64 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonInt64"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonInt64(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonInt64.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonInt64>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonInt64 instance) => new(JsonElement.From(instance));
