...
public readonly partial struct Error
{
    ...
    public readonly partial struct MessageEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MessageEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MessageEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MessageEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MessageEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MessageEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MessageEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MessageEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MessageEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MessageEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MessageEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MessageEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MessageEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MessageEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MessageEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MessageEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MessageEntity>();
            }
            finally
            {
