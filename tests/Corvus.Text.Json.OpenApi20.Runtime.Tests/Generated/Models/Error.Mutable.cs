...
public readonly partial struct Error
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests20.Client.Models.JsonInteger.Mutable Code
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out CanonTests20.Client.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests20.Client.Models.Error.MessageEntity.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out CanonTests20.Client.Models.Error.MessageEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCode(scoped in CanonTests20.Client.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(scoped in CanonTests20.Client.Models.Error.MessageEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests20.Client.Models.JsonInteger.Source _createArg1;
        private readonly CanonTests20.Client.Models.Error.MessageEntity.Source _createArg2;
        ...
        internal Source(CanonTests20.Client.Models.Error.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in CanonTests20.Client.Models.JsonInteger.Source arg1, scoped in CanonTests20.Client.Models.Error.MessageEntity.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests20.Client.Models.Error.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests20.Client.Models.JsonInteger.Source code = default,
            in CanonTests20.Client.Models.Error.MessageEntity.Source message = default)
        {
        ...
        /// Creates an instance of a <see cref="Error"/>.
        /// </summary>
        public void Create(in CanonTests20.Client.Models.JsonInteger.Source code = default, in CanonTests20.Client.Models.Error.MessageEntity.Source message = default)
        {
        ...
        internal static void BuildCreateValue(scoped in CanonTests20.Client.Models.JsonInteger.Source arg1, scoped in CanonTests20.Client.Models.Error.MessageEntity.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in CanonTests20.Client.Models.JsonInteger.Source code = default, scoped in CanonTests20.Client.Models.Error.MessageEntity.Source message = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests20.Client.Models.JsonInteger.Source code = default, in CanonTests20.Client.Models.Error.MessageEntity.Source message = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<Error> Create(in CanonTests20.Client.Models.JsonInteger.Source code = default, in CanonTests20.Client.Models.Error.MessageEntity.Source message = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
