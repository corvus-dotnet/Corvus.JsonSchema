...
#endif
{
    ...
    /// </summary>
    public CanonTests20.Client.Models.JsonInteger Code
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out CanonTests20.Client.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests20.Client.Models.Error.MessageEntity Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out CanonTests20.Client.Models.Error.MessageEntity value))
            {
                return value;
            }
