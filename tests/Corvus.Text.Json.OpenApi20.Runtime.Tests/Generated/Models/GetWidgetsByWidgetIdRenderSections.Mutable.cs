...
public readonly partial struct GetWidgetsByWidgetIdRenderSections
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetWidgetsByWidgetIdRenderSections instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetWidgetsByWidgetIdRenderSections"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetWidgetsByWidgetIdRenderSections(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetWidgetsByWidgetIdRenderSections.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsByWidgetIdRenderSections Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsByWidgetIdRenderSections Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetWidgetsByWidgetIdRenderSections>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests20.Client.Models.GetWidgetsByWidgetIdRenderSections.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetWidgetsByWidgetIdRenderSections instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests20.Client.Models.GetWidgetsByWidgetIdRenderSections.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetWidgetsByWidgetIdRenderSections, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetWidgetsByWidgetIdRenderSections> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetWidgetsByWidgetIdRenderSections>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetWidgetsByWidgetIdRenderSections> Create<TContext>(
