...
public readonly partial struct GetWidgetsByWidgetIdRenderSections
#if NET8_0_OR_GREATER
    : IJsonElement<GetWidgetsByWidgetIdRenderSections>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetWidgetsByWidgetIdRenderSections"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetWidgetsByWidgetIdRenderSections(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetWidgetsByWidgetIdRenderSections DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetWidgetsByWidgetIdRenderSections left, in GetWidgetsByWidgetIdRenderSections right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetWidgetsByWidgetIdRenderSections left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetWidgetsByWidgetIdRenderSections instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetWidgetsByWidgetIdRenderSections(JsonElement instance)
    {
        return GetWidgetsByWidgetIdRenderSections.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetWidgetsByWidgetIdRenderSections From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetWidgetsByWidgetIdRenderSections ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetWidgetsByWidgetIdRenderSections>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetWidgetsByWidgetIdRenderSections ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetWidgetsByWidgetIdRenderSections>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetWidgetsByWidgetIdRenderSections ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetWidgetsByWidgetIdRenderSections>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetWidgetsByWidgetIdRenderSections ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetWidgetsByWidgetIdRenderSections>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetWidgetsByWidgetIdRenderSections? result)
    {
        return JsonElementHelpers.TryParseValue<GetWidgetsByWidgetIdRenderSections>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetWidgetsByWidgetIdRenderSections(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetWidgetsByWidgetIdRenderSections IJsonElement<GetWidgetsByWidgetIdRenderSections>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetWidgetsByWidgetIdRenderSections: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetWidgetsByWidgetIdRenderSections"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetWidgetsByWidgetIdRenderSections"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetWidgetsByWidgetIdRenderSections Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetWidgetsByWidgetIdRenderSections>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetWidgetsByWidgetIdRenderSections"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetWidgetsByWidgetIdRenderSections Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetWidgetsByWidgetIdRenderSections>(_idx);
        }
