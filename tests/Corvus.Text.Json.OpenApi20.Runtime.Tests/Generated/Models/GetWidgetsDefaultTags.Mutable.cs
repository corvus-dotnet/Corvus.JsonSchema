...
public readonly partial struct GetWidgetsDefaultTags
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetWidgetsDefaultTags instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetWidgetsDefaultTags"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetWidgetsDefaultTags(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetWidgetsDefaultTags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsDefaultTags Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsDefaultTags Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetWidgetsDefaultTags>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests20.Client.Models.GetWidgetsDefaultTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetWidgetsDefaultTags instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests20.Client.Models.GetWidgetsDefaultTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetWidgetsDefaultTags, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetWidgetsDefaultTags> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetWidgetsDefaultTags>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetWidgetsDefaultTags> Create<TContext>(
