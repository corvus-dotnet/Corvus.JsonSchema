...
public readonly partial struct GetWidgetsMultiTags
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetWidgetsMultiTags instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetWidgetsMultiTags"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetWidgetsMultiTags(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetWidgetsMultiTags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsMultiTags Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsMultiTags Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetWidgetsMultiTags>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests20.Client.Models.GetWidgetsMultiTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetWidgetsMultiTags instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests20.Client.Models.GetWidgetsMultiTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetWidgetsMultiTags, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetWidgetsMultiTags> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetWidgetsMultiTags>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetWidgetsMultiTags> Create<TContext>(
