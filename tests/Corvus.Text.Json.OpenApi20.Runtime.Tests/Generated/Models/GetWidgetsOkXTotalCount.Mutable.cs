...
public readonly partial struct GetWidgetsOkXTotalCount
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetWidgetsOkXTotalCount instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetWidgetsOkXTotalCount"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetWidgetsOkXTotalCount(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetWidgetsOkXTotalCount.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsOkXTotalCount Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsOkXTotalCount Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetWidgetsOkXTotalCount>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetWidgetsOkXTotalCount instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetWidgetsOkXTotalCount, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetWidgetsOkXTotalCount> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetWidgetsOkXTotalCount>();
        }
        finally
        {
