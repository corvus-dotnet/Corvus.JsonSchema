...
public readonly partial struct GetWidgetsSsvTags
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetWidgetsSsvTags instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetWidgetsSsvTags"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetWidgetsSsvTags(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetWidgetsSsvTags(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetWidgetsSsvTags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="GetWidgetsSsvTags"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetWidgetsSsvTags"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsSsvTags Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetWidgetsSsvTags>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetWidgetsSsvTags"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetWidgetsSsvTags Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetWidgetsSsvTags>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests20.Client.Models.GetWidgetsSsvTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetWidgetsSsvTags instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests20.Client.Models.GetWidgetsSsvTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetWidgetsSsvTags, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<GetWidgetsSsvTags> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<GetWidgetsSsvTags>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<GetWidgetsSsvTags> Create<TContext>(
