...
public readonly partial struct PostLegacyFormBody
    : IJsonElement<PostLegacyFormBody>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchFlags(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        [NotNullWhen(true)]
#endif
        out CanonTests20.Client.Models.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
            if (span.SequenceEqual(JsonPropertyNames.FlagsUtf8))
            {
                matcher = MatchFlags;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/schemas/PostLegacyFormBody"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/schemas/PostLegacyFormBody";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/schemas/PostLegacyFormBody"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out CanonTests20.Client.Models.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
