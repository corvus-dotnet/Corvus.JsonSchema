...
public readonly partial struct PostLegacyFormBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostLegacyFormBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostLegacyFormBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostLegacyFormBody(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Mutable Flags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlagsUtf8, out CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostLegacyFormBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetFlags(scoped in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFlags<TContext>(in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostLegacyFormBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostLegacyFormBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostLegacyFormBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostLegacyFormBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostLegacyFormBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostLegacyFormBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostLegacyFormBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostLegacyFormBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source _createArg1;
        ...
        internal Source(CanonTests20.Client.Models.PostLegacyFormBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(PostLegacyFormBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, CanonTests20.Client.Models.PostLegacyFormBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostLegacyFormBody"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source flags = default)
        {
        ...
        /// Creates an instance of a <see cref="PostLegacyFormBody"/>.
        /// </summary>
        public void Create(in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source flags = default)
        {
            Create(ref _builder, flags);
        }
        ...
        internal static void Create<TContext>(
            ...
            in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source<TContext> flags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="PostLegacyFormBody"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source<TContext> flags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
            Create(context, ref _builder, flags);
        }
        ...
        internal static void BuildCreateValue(scoped in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source flags = default)
    {
        return new Source(flags);
    }
    ...
    /// <param name="flags">The value of the <c>"flags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source<TContext> flags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, flags);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source flags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source<TContext> flags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<PostLegacyFormBody, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<PostLegacyFormBody> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<PostLegacyFormBody>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostLegacyFormBody> Create<TContext>(
    ...
    public static ParsedJsonDocument<PostLegacyFormBody> Create(in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source flags = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<PostLegacyFormBody> Create<TContext>(in TContext context, in CanonTests20.Client.Models.PostLegacyFormBody.JsonStringArray.Source<TContext> flags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
