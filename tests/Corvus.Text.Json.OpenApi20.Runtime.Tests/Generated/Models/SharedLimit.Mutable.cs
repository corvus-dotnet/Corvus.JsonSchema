...
public readonly partial struct SharedLimit
{
...
#endif
    {
        ...
        public static explicit operator Mutable(SharedLimit instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="SharedLimit"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SharedLimit(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SharedLimit(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SharedLimit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SharedLimit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SharedLimit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly SharedLimit Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SharedLimit>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SharedLimit"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly SharedLimit Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<SharedLimit>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(SharedLimit instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<SharedLimit, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<SharedLimit> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<SharedLimit>();
        }
        finally
        {
