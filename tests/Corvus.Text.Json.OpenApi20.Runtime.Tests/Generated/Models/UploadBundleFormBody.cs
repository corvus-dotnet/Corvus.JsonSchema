...
namespace CanonTests20.Client.Models;
/// <summary>
/// Generated from JSON Schema.
/// </summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct UploadBundleFormBody
#if NET8_0_OR_GREATER
    : IJsonElement<UploadBundleFormBody>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UploadBundleFormBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal UploadBundleFormBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static UploadBundleFormBody DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests20.Client.Models.JsonBinary Archive
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArchiveUtf8, out CanonTests20.Client.Models.JsonBinary value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests20.Client.Models.UploadBundleFormBody.JsonStringArray Labels
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelsUtf8, out CanonTests20.Client.Models.UploadBundleFormBody.JsonStringArray value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets the (optional) <c>notes</c> property.
    /// </summary>
    public CanonTests20.Client.Models.JsonString Notes
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NotesUtf8, out CanonTests20.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in UploadBundleFormBody left, in UploadBundleFormBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in UploadBundleFormBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(UploadBundleFormBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator UploadBundleFormBody(JsonElement instance)
    {
        return UploadBundleFormBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UploadBundleFormBody From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UploadBundleFormBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UploadBundleFormBody>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UploadBundleFormBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UploadBundleFormBody>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UploadBundleFormBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UploadBundleFormBody>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static UploadBundleFormBody ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UploadBundleFormBody>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out UploadBundleFormBody? result)
    {
        return JsonElementHelpers.TryParseValue<UploadBundleFormBody>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new UploadBundleFormBody(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static UploadBundleFormBody IJsonElement<UploadBundleFormBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"UploadBundleFormBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="UploadBundleFormBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="UploadBundleFormBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public UploadBundleFormBody Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<UploadBundleFormBody>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="UploadBundleFormBody"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public UploadBundleFormBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<UploadBundleFormBody>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Archive"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Notes"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Archive"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ArchiveUtf8 => "archive"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Archive"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Archive => "archive"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Notes"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Notes => "notes"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Archive"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Archive => [0x95, 0x00, 0x00, 0x00, 0x22, 0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Notes"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Notes => [0x75, 0x00, 0x00, 0x00, 0x22, 0x6E, 0x6F, 0x74, 0x65, 0x73, 0x22];
    }
}
