    ...
    : IJsonElement<WeirdKey0x>
{
    ...
    private static class Constants
    {
        ...
        /// </summary>
        public static readonly byte[] Enum1 = "alpha"u8.ToArray();
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly WeirdKey0x EnumJson1 = ParsedJsonDocument<WeirdKey0x>.StringConstant([.."\"alpha\""u8]);
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly byte[] Enum2 = "beta"u8.ToArray();
        /// <summary>
        /// A constant for the <c>enum</c> keyword.
        /// </summary>
        public static readonly WeirdKey0x EnumJson2 = ParsedJsonDocument<WeirdKey0x>.StringConstant([.."\"beta\""u8]);
    }
    ...
    {
        /// <summary>
        /// Gets the string "alpha"
        /// as a <see cref="WeirdKey0x"/>.
        /// </summary>
        public static WeirdKey0x Alpha { get; } = Constants.EnumJson1;
        /// <summary>
        /// Gets the string "alpha"
        /// as a UTF8 byte array.
        /// </summary>
        public static ReadOnlySpan<byte> AlphaUtf8 => Constants.Enum1;

        /// <summary>
        /// Gets the string "beta"
        /// as a <see cref="WeirdKey0x"/>.
        /// </summary>
        public static WeirdKey0x Beta { get; } = Constants.EnumJson2;
        /// <summary>
        /// Gets the string "beta"
        /// as a UTF8 byte array.
        /// </summary>
        public static ReadOnlySpan<byte> BetaUtf8 => Constants.Enum2;
    }
    ...
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/weird key!~0x"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/definitions/weird key!~0x";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/weird key!~0x"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if (unescapedUtf8JsonString.Span.SequenceEqual("alpha"u8))
                {
                    goto enumShortCircuitSuccess;
                }

                if (unescapedUtf8JsonString.Span.SequenceEqual("beta"u8))
                {
                    goto enumShortCircuitSuccess;
                }
