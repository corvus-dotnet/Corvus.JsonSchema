...
public readonly partial struct WeirdKey0x
{
...
#endif
    {
        ...
        public static explicit operator Mutable(WeirdKey0x instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="WeirdKey0x"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WeirdKey0x(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WeirdKey0x.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly WeirdKey0x Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly WeirdKey0x Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<WeirdKey0x>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(WeirdKey0x instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<WeirdKey0x, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<WeirdKey0x> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<WeirdKey0x>();
        }
        finally
        {
