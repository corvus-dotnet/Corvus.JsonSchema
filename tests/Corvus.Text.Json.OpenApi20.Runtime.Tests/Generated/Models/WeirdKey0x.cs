...
public readonly partial struct WeirdKey0x
#if NET8_0_OR_GREATER
    : IJsonElement<WeirdKey0x>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WeirdKey0x"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal WeirdKey0x(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static WeirdKey0x DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(WeirdKey0x value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in WeirdKey0x left, in WeirdKey0x right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in WeirdKey0x left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(WeirdKey0x instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator WeirdKey0x(JsonElement instance)
    {
        return WeirdKey0x.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WeirdKey0x From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WeirdKey0x ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WeirdKey0x>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WeirdKey0x ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WeirdKey0x>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WeirdKey0x ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WeirdKey0x>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static WeirdKey0x ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<WeirdKey0x>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out WeirdKey0x? result)
    {
        return JsonElementHelpers.TryParseValue<WeirdKey0x>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new WeirdKey0x(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static WeirdKey0x IJsonElement<WeirdKey0x>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"WeirdKey0x: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="WeirdKey0x"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="WeirdKey0x"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public WeirdKey0x Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<WeirdKey0x>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="WeirdKey0x"/> that lives for the lifetime of its
    ...
    /// <param name="matchAlpha">Match 1st item.</param>
    /// <param name="matchBeta">Match 2nd item.</param>
    /// <param name="defaultMatch">Match any other value.</param>
    /// <returns>An instance of the value returned by the match function.</returns>
    public TResult Match<TContext, TResult>(
        in TContext context,
        Func<TContext, TResult> matchAlpha,
        Func<TContext, TResult> matchBeta,
...
#endif
    {
        ...
        {
            return matchAlpha(context);
        }

        if (this.ValueEquals(Constants.Enum2))
        {
            return matchBeta(context);
        }
    ...
    public TResult Match<TResult>(
        Func<TResult> matchAlpha,
        Func<TResult> matchBeta,
