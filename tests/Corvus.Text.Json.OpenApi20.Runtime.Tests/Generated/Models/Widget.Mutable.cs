...
public readonly partial struct Widget
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Widget instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Widget"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Widget(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests20.Client.Models.JsonString.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out CanonTests20.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests20.Client.Models.WeirdKey0x.Mutable Kind
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out CanonTests20.Client.Models.WeirdKey0x.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests20.Client.Models.Widget.SizeEntity.Mutable Size
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SizeUtf8, out CanonTests20.Client.Models.Widget.SizeEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Widget(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetId(scoped in CanonTests20.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetKind(scoped in CanonTests20.Client.Models.WeirdKey0x.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSize(scoped in CanonTests20.Client.Models.Widget.SizeEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Widget.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Widget"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Widget"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Widget Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Widget>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Widget"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Widget Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Widget>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests20.Client.Models.JsonString.Source _createArg1;
        private readonly CanonTests20.Client.Models.WeirdKey0x.Source _createArg2;
        private readonly CanonTests20.Client.Models.Widget.SizeEntity.Source _createArg3;
        ...
        internal Source(CanonTests20.Client.Models.Widget.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in CanonTests20.Client.Models.JsonString.Source arg1, scoped in CanonTests20.Client.Models.WeirdKey0x.Source arg2, scoped in CanonTests20.Client.Models.Widget.SizeEntity.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(Widget instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests20.Client.Models.Widget.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Widget"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests20.Client.Models.JsonString.Source id,
            in CanonTests20.Client.Models.WeirdKey0x.Source kind = default,
            in CanonTests20.Client.Models.Widget.SizeEntity.Source size = default)
        {
        ...
        public void Create(
            ...
            in CanonTests20.Client.Models.Widget.SizeEntity.Source size = default)
        {
            Create(ref _builder, id, kind, size);
        }
        ...
        internal static void BuildCreateValue(scoped in CanonTests20.Client.Models.JsonString.Source arg1, scoped in CanonTests20.Client.Models.WeirdKey0x.Source arg2, scoped in CanonTests20.Client.Models.Widget.SizeEntity.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in CanonTests20.Client.Models.JsonString.Source id, scoped in CanonTests20.Client.Models.WeirdKey0x.Source kind = default, scoped in CanonTests20.Client.Models.Widget.SizeEntity.Source size = default)
    {
        return new Source(id, kind, size);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests20.Client.Models.JsonString.Source id, in CanonTests20.Client.Models.WeirdKey0x.Source kind = default, in CanonTests20.Client.Models.Widget.SizeEntity.Source size = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(id, kind, size);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<Widget, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<Widget> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<Widget>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Widget> Create<TContext>(
    ...
    public static ParsedJsonDocument<Widget> Create(in CanonTests20.Client.Models.JsonString.Source id, in CanonTests20.Client.Models.WeirdKey0x.Source kind = default, in CanonTests20.Client.Models.Widget.SizeEntity.Source size = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
