    ...
    : IJsonElement<WidgetsTenant>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1widgets/parameters/0"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1widgets/parameters/0";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1widgets/parameters/0"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[a-z]+$", "pattern"u8, ref context);
            }
        }
...
#else
        private static Regex CreatePattern() => new("^[a-z]+$", RegexOptions.Compiled);
#endif
