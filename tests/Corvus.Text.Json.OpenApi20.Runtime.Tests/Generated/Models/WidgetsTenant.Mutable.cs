...
public readonly partial struct WidgetsTenant
{
...
#endif
    {
        ...
        public static explicit operator Mutable(WidgetsTenant instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="WidgetsTenant"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator WidgetsTenant(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new WidgetsTenant(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"WidgetsTenant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="WidgetsTenant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="WidgetsTenant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly WidgetsTenant Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<WidgetsTenant>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="WidgetsTenant"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly WidgetsTenant Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<WidgetsTenant>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(WidgetsTenant instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<WidgetsTenant, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<WidgetsTenant> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<WidgetsTenant>();
        }
        finally
        {
