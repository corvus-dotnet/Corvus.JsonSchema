...
/// <summary>
/// Response type for the RenderWidget operation.
/// </summary>
public struct RenderWidgetResponse : IApiResponse<RenderWidgetResponse>
{
    ...
    /// <inheritdoc/>
    public static ValueTask<RenderWidgetResponse> CreateAsync(
        int statusCode,
    ...
    {
        RenderWidgetResponse response = default;
