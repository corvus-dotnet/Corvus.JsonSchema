...
/// <summary>
/// Response type for the CookieArrayNonexplode operation.
/// </summary>
public struct CookieArrayNonexplodeResponse : IApiResponse<CookieArrayNonexplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CookieArrayNonexplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        CookieArrayNonexplodeResponse response = default;
