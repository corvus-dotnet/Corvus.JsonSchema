...
/// <summary>
/// Response type for the CookieObject operation.
/// </summary>
public struct CookieObjectResponse : IApiResponse<CookieObjectResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CookieObjectResponse> CreateAsync(
        int statusCode,
    ...
    {
        CookieObjectResponse response = default;
