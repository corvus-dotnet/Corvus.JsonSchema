...
public struct CreateItemResponse : IApiResponse<CreateItemResponse>
{
    ...
    internal CanonTests30.Client.PostItemsBody sourceBody;
    ...
    /// </summary>
    public CanonTests30.Client.PostItemsCreated CreatedBody { get; private set; }

    /// <summary>
    /// Gets the 422 response body.
    /// </summary>
    public CanonTests30.Client.PostItemsUnprocessableEntity UnprocessableEntityBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<CanonTests30.Client.PostItemsCreated>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
        ...
        if (statusCode == 422)
        {
            var unprocessableEntityDoc = await ParsedJsonDocument<CanonTests30.Client.PostItemsUnprocessableEntity>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out CanonTests30.Client.PostItemsCreated result)
    {
    ...
    public bool TryGetUnprocessableEntity(out CanonTests30.Client.PostItemsUnprocessableEntity result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.PostItemsCreated, TResult> matchCreated,
        ResponseMatcher<CanonTests30.Client.PostItemsUnprocessableEntity, TResult> matchUnprocessableEntity,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.PostItemsCreated, TContext, TResult> matchCreated,
        ResponseMatcher<CanonTests30.Client.PostItemsUnprocessableEntity, TContext, TResult> matchUnprocessableEntity,
    ...
    public readonly struct CreateItemResponseLinksAccessor
    {
        ...
        /// </summary>
        public ValueTask<GetItemResponse> GetCreatedItemAsync(CanonTests30.Client.JsonString.Source filter = default, CanonTests30.Client.JsonInt32.Source limit = default, CanonTests30.Client.JsonBoolean.Source verbose = default, CanonTests30.Client.JsonString.Source xRequestId = default, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public ValueTask<SearchResponse> SearchByNameAsync(CanonTests30.Client.JsonInt32.Source page = default, CanonTests30.Client.JsonSingle.Source rating = default, CancellationToken cancellationToken = default)
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
