...
/// <summary>
/// Request type for the DownloadFile operation.
/// </summary>
/// <remarks>Download a binary file</remarks>
public readonly struct DownloadFileRequest : IApiRequest<DownloadFileRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/files/download"u8;
