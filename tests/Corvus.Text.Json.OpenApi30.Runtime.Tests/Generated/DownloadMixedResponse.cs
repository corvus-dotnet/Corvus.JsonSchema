...
public struct DownloadMixedResponse : IApiResponse<DownloadMixedResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.GetFilesDownloadMixedNotFound NotFoundBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests30.Client.GetFilesDownloadMixedNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetNotFound(out CanonTests30.Client.GetFilesDownloadMixedNotFound result)
    {
    ...
    public TResult MatchResult<TResult>(
        ...
        ResponseMatcher<CanonTests30.Client.GetFilesDownloadMixedNotFound, TResult> matchNotFound,
    ...
    public TResult MatchResult<TContext, TResult>(
        ...
        ResponseMatcher<CanonTests30.Client.GetFilesDownloadMixedNotFound, TContext, TResult> matchNotFound,
