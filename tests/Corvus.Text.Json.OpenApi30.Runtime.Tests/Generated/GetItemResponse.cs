...
public struct GetItemResponse : IApiResponse<GetItemResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.Models.GetItemsByItemIdOk OkBody { get; private set; }

    /// <summary>
    /// Gets the 404 response body.
    /// </summary>
    public CanonTests30.Client.Models.GetItemsByItemIdNotFound NotFoundBody { get; private set; }

    /// <summary>
    /// Gets the default response body.
    /// </summary>
    public CanonTests30.Client.Models.GetItemsByItemIdDefault DefaultBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests30.Client.Models.GetItemsByItemIdOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests30.Client.Models.GetItemsByItemIdNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
            response.parsedDocument = notFoundDoc;
            response.NotFoundBody = notFoundDoc.RootElement;
            return response;
        }

        var defaultDoc = await ParsedJsonDocument<CanonTests30.Client.Models.GetItemsByItemIdDefault>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests30.Client.Models.GetItemsByItemIdOk result)
    {
    ...
    public bool TryGetNotFound(out CanonTests30.Client.Models.GetItemsByItemIdNotFound result)
    {
    ...
    public bool TryGetDefault(out CanonTests30.Client.Models.GetItemsByItemIdDefault result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.Models.GetItemsByItemIdOk, TResult> matchOk,
        ResponseMatcher<CanonTests30.Client.Models.GetItemsByItemIdNotFound, TResult> matchNotFound,
        ResponseMatcher<CanonTests30.Client.Models.GetItemsByItemIdDefault, TResult> matchDefault)
    {
        if (this.StatusCode == 200)
        {
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.Models.GetItemsByItemIdOk, TContext, TResult> matchOk,
        ResponseMatcher<CanonTests30.Client.Models.GetItemsByItemIdNotFound, TContext, TResult> matchNotFound,
        ResponseMatcher<CanonTests30.Client.Models.GetItemsByItemIdDefault, TContext, TResult> matchDefault)
