...
public struct GetItemResponse : IApiResponse<GetItemResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.GetItemsByItemIdOk OkBody { get; private set; }

    /// <summary>
    /// Gets the 404 response body.
    /// </summary>
    public CanonTests30.Client.GetItemsByItemIdNotFound NotFoundBody { get; private set; }

    /// <summary>
    /// Gets the default response body.
    /// </summary>
    public CanonTests30.Client.GetItemsByItemIdDefault DefaultBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests30.Client.GetItemsByItemIdOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests30.Client.GetItemsByItemIdNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
            response.parsedDocument = notFoundDoc;
            response.NotFoundBody = notFoundDoc.RootElement;
            return response;
        }

        var defaultDoc = await ParsedJsonDocument<CanonTests30.Client.GetItemsByItemIdDefault>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests30.Client.GetItemsByItemIdOk result)
    {
    ...
    public bool TryGetNotFound(out CanonTests30.Client.GetItemsByItemIdNotFound result)
    {
    ...
    public bool TryGetDefault(out CanonTests30.Client.GetItemsByItemIdDefault result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.GetItemsByItemIdOk, TResult> matchOk,
        ResponseMatcher<CanonTests30.Client.GetItemsByItemIdNotFound, TResult> matchNotFound,
        ResponseMatcher<CanonTests30.Client.GetItemsByItemIdDefault, TResult> matchDefault)
    {
        if (this.StatusCode == 200)
        {
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.GetItemsByItemIdOk, TContext, TResult> matchOk,
        ResponseMatcher<CanonTests30.Client.GetItemsByItemIdNotFound, TContext, TResult> matchNotFound,
        ResponseMatcher<CanonTests30.Client.GetItemsByItemIdDefault, TContext, TResult> matchDefault)
