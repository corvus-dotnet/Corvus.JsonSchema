...
/// <summary>
/// Response type for the GetPage operation.
/// </summary>
public struct GetPageResponse : IApiResponse<GetPageResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetPageResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetPageResponse response = default;
