...
public struct GetTextOrJsonResponse : IApiResponse<GetTextOrJsonResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.GetTextMixedOk OkBody { get; private set; }
    ...
    /// </summary>
    public CanonTests30.Client.GetTextMixedNotFound NotFoundBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            ...
            {
                var okDoc = await ParsedJsonDocument<CanonTests30.Client.GetTextMixedOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests30.Client.GetTextMixedNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests30.Client.GetTextMixedOk result)
    {
    ...
    public bool TryGetNotFound(out CanonTests30.Client.GetTextMixedNotFound result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.GetTextMixedOk, TResult> matchOk,
        ResponseMatcher<string?, TResult> matchOkString,
        ResponseMatcher<CanonTests30.Client.GetTextMixedNotFound, TResult> matchNotFound,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.GetTextMixedOk, TContext, TResult> matchOk,
        ResponseMatcher<string?, TContext, TResult> matchOkString,
        ResponseMatcher<CanonTests30.Client.GetTextMixedNotFound, TContext, TResult> matchNotFound,
