...
/// <summary>
/// Request type for the HeadItem operation.
/// </summary>
/// <remarks>Check item existence</remarks>
public readonly struct HeadItemRequest : IApiRequest<HeadItemRequest>
{
    ...
    public HeadItemRequest(CanonTests30.Client.Models.JsonString itemId)
    {
        this.ItemId = itemId;
    }
