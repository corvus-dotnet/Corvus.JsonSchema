...
/// <summary>
/// Response type for the HeaderObject operation.
/// </summary>
public struct HeaderObjectResponse : IApiResponse<HeaderObjectResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<HeaderObjectResponse> CreateAsync(
        int statusCode,
    ...
    {
        HeaderObjectResponse response = default;
