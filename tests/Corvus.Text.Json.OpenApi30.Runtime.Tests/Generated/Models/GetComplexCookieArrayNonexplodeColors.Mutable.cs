...
public readonly partial struct GetComplexCookieArrayNonexplodeColors
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.GetComplexCookieArrayNonexplodeColors.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.GetComplexCookieArrayNonexplodeColors.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
