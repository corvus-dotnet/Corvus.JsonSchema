...
public readonly partial struct GetComplexCookieObjectNonexplodePrefs
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexCookieObjectNonexplodePrefs instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexCookieObjectNonexplodePrefs"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexCookieObjectNonexplodePrefs(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexCookieObjectNonexplodePrefs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexCookieObjectNonexplodePrefs Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexCookieObjectNonexplodePrefs Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexCookieObjectNonexplodePrefs>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.GetComplexCookieObjectNonexplodePrefs.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexCookieObjectNonexplodePrefs instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.GetComplexCookieObjectNonexplodePrefs.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetComplexCookieObjectNonexplodePrefs"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<GetComplexCookieObjectNonexplodePrefs, Mutable>(this);
    }
}
