...
public readonly partial struct GetComplexCookieObjectPrefs
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexCookieObjectPrefs instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexCookieObjectPrefs"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexCookieObjectPrefs(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexCookieObjectPrefs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexCookieObjectPrefs Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexCookieObjectPrefs Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexCookieObjectPrefs>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.GetComplexCookieObjectPrefs.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetComplexCookieObjectPrefs instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.GetComplexCookieObjectPrefs.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetComplexCookieObjectPrefs"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<GetComplexCookieObjectPrefs, Mutable>(this);
    }
}
