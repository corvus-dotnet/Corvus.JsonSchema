...
public readonly partial struct GetComplexPathArraySimpleByIdsIds
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexPathArraySimpleByIdsIds instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexPathArraySimpleByIdsIds"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexPathArraySimpleByIdsIds(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexPathArraySimpleByIdsIds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathArraySimpleByIdsIds Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathArraySimpleByIdsIds Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexPathArraySimpleByIdsIds>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.GetComplexPathArraySimpleByIdsIds.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexPathArraySimpleByIdsIds instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.GetComplexPathArraySimpleByIdsIds.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexPathArraySimpleByIdsIds, Mutable>(this);
    }
}
