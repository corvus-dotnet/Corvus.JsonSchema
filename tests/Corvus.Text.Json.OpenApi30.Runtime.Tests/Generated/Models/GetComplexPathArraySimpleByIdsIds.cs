...
public readonly partial struct GetComplexPathArraySimpleByIdsIds
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexPathArraySimpleByIdsIds>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexPathArraySimpleByIdsIds"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexPathArraySimpleByIdsIds(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexPathArraySimpleByIdsIds DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexPathArraySimpleByIdsIds left, in GetComplexPathArraySimpleByIdsIds right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexPathArraySimpleByIdsIds left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexPathArraySimpleByIdsIds instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexPathArraySimpleByIdsIds(JsonElement instance)
    {
        return GetComplexPathArraySimpleByIdsIds.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathArraySimpleByIdsIds From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathArraySimpleByIdsIds ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexPathArraySimpleByIdsIds>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathArraySimpleByIdsIds ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexPathArraySimpleByIdsIds>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathArraySimpleByIdsIds ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexPathArraySimpleByIdsIds>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetComplexPathArraySimpleByIdsIds ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexPathArraySimpleByIdsIds>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexPathArraySimpleByIdsIds? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexPathArraySimpleByIdsIds>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexPathArraySimpleByIdsIds(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexPathArraySimpleByIdsIds IJsonElement<GetComplexPathArraySimpleByIdsIds>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexPathArraySimpleByIdsIds: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexPathArraySimpleByIdsIds"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexPathArraySimpleByIdsIds"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathArraySimpleByIdsIds Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexPathArraySimpleByIdsIds>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexPathArraySimpleByIdsIds"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathArraySimpleByIdsIds Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexPathArraySimpleByIdsIds>(_idx);
        }
