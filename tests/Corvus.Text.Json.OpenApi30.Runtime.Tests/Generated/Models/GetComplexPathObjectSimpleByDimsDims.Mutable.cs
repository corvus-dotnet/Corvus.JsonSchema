...
public readonly partial struct GetComplexPathObjectSimpleByDimsDims
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexPathObjectSimpleByDimsDims instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexPathObjectSimpleByDimsDims"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexPathObjectSimpleByDimsDims(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexPathObjectSimpleByDimsDims.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathObjectSimpleByDimsDims Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathObjectSimpleByDimsDims Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexPathObjectSimpleByDimsDims>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.GetComplexPathObjectSimpleByDimsDims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexPathObjectSimpleByDimsDims instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.GetComplexPathObjectSimpleByDimsDims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetComplexPathObjectSimpleByDimsDims"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<GetComplexPathObjectSimpleByDimsDims, Mutable>(this);
    }
}
