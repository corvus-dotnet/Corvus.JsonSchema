...
public readonly partial struct GetComplexPathObjectSimpleExplodeByDimsDims
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexPathObjectSimpleExplodeByDimsDims instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexPathObjectSimpleExplodeByDimsDims"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexPathObjectSimpleExplodeByDimsDims(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexPathObjectSimpleExplodeByDimsDims.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathObjectSimpleExplodeByDimsDims Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathObjectSimpleExplodeByDimsDims Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexPathObjectSimpleExplodeByDimsDims>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.GetComplexPathObjectSimpleExplodeByDimsDims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexPathObjectSimpleExplodeByDimsDims instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.GetComplexPathObjectSimpleExplodeByDimsDims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetComplexPathObjectSimpleExplodeByDimsDims"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<GetComplexPathObjectSimpleExplodeByDimsDims, Mutable>(this);
    }
}
