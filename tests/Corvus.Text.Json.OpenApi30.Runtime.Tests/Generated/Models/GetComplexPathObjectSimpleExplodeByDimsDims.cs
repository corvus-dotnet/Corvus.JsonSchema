...
public readonly partial struct GetComplexPathObjectSimpleExplodeByDimsDims
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexPathObjectSimpleExplodeByDimsDims>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexPathObjectSimpleExplodeByDimsDims"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexPathObjectSimpleExplodeByDimsDims(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexPathObjectSimpleExplodeByDimsDims DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexPathObjectSimpleExplodeByDimsDims left, in GetComplexPathObjectSimpleExplodeByDimsDims right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexPathObjectSimpleExplodeByDimsDims left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexPathObjectSimpleExplodeByDimsDims instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexPathObjectSimpleExplodeByDimsDims(JsonElement instance)
    {
        return GetComplexPathObjectSimpleExplodeByDimsDims.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectSimpleExplodeByDimsDims From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectSimpleExplodeByDimsDims ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectSimpleExplodeByDimsDims>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectSimpleExplodeByDimsDims ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectSimpleExplodeByDimsDims>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectSimpleExplodeByDimsDims ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectSimpleExplodeByDimsDims>(json, options);
    }
    ...
    /// </exception>
    public static GetComplexPathObjectSimpleExplodeByDimsDims ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectSimpleExplodeByDimsDims>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexPathObjectSimpleExplodeByDimsDims? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexPathObjectSimpleExplodeByDimsDims>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexPathObjectSimpleExplodeByDimsDims(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexPathObjectSimpleExplodeByDimsDims IJsonElement<GetComplexPathObjectSimpleExplodeByDimsDims>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexPathObjectSimpleExplodeByDimsDims: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexPathObjectSimpleExplodeByDimsDims"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexPathObjectSimpleExplodeByDimsDims"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathObjectSimpleExplodeByDimsDims Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexPathObjectSimpleExplodeByDimsDims>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexPathObjectSimpleExplodeByDimsDims"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathObjectSimpleExplodeByDimsDims Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexPathObjectSimpleExplodeByDimsDims>(_idx);
        }
