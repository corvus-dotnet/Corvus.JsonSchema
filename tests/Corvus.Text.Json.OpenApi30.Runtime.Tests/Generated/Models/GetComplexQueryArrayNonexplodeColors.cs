...
public readonly partial struct GetComplexQueryArrayNonexplodeColors
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexQueryArrayNonexplodeColors>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexQueryArrayNonexplodeColors"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexQueryArrayNonexplodeColors(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexQueryArrayNonexplodeColors DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexQueryArrayNonexplodeColors left, in GetComplexQueryArrayNonexplodeColors right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexQueryArrayNonexplodeColors left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexQueryArrayNonexplodeColors instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexQueryArrayNonexplodeColors(JsonElement instance)
    {
        return GetComplexQueryArrayNonexplodeColors.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryArrayNonexplodeColors From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryArrayNonexplodeColors ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexQueryArrayNonexplodeColors>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryArrayNonexplodeColors ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexQueryArrayNonexplodeColors>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryArrayNonexplodeColors ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexQueryArrayNonexplodeColors>(json, options);
    }
    ...
    /// </exception>
    public static GetComplexQueryArrayNonexplodeColors ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetComplexQueryArrayNonexplodeColors>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexQueryArrayNonexplodeColors? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexQueryArrayNonexplodeColors>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexQueryArrayNonexplodeColors(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexQueryArrayNonexplodeColors IJsonElement<GetComplexQueryArrayNonexplodeColors>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexQueryArrayNonexplodeColors: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexQueryArrayNonexplodeColors"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexQueryArrayNonexplodeColors"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexQueryArrayNonexplodeColors Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexQueryArrayNonexplodeColors>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexQueryArrayNonexplodeColors"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexQueryArrayNonexplodeColors Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexQueryArrayNonexplodeColors>(_idx);
        }
