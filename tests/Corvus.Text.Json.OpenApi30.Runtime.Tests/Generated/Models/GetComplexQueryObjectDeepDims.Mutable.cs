...
public readonly partial struct GetComplexQueryObjectDeepDims
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexQueryObjectDeepDims instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexQueryObjectDeepDims"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexQueryObjectDeepDims(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetComplexQueryObjectDeepDims(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexQueryObjectDeepDims.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetComplexQueryObjectDeepDims"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetComplexQueryObjectDeepDims"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryObjectDeepDims Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetComplexQueryObjectDeepDims>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetComplexQueryObjectDeepDims"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryObjectDeepDims Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexQueryObjectDeepDims>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.GetComplexQueryObjectDeepDims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetComplexQueryObjectDeepDims instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.GetComplexQueryObjectDeepDims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetComplexQueryObjectDeepDims"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<GetComplexQueryObjectDeepDims, Mutable>(this);
    }
}
