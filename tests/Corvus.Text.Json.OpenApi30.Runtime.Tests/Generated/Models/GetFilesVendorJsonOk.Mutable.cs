...
public readonly partial struct GetFilesVendorJsonOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetFilesVendorJsonOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetFilesVendorJsonOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetFilesVendorJsonOk(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests30.Client.Models.JsonString.Mutable Data
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataUtf8, out CanonTests30.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetFilesVendorJsonOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetData(in CanonTests30.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetFilesVendorJsonOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetFilesVendorJsonOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetFilesVendorJsonOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetFilesVendorJsonOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetFilesVendorJsonOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetFilesVendorJsonOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetFilesVendorJsonOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetFilesVendorJsonOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.GetFilesVendorJsonOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetFilesVendorJsonOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.GetFilesVendorJsonOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetFilesVendorJsonOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests30.Client.Models.JsonString.Source data = default)
        {
        ...
        /// Creates an instance of a <see cref="GetFilesVendorJsonOk"/>.
        /// </summary>
        public void Create(in CanonTests30.Client.Models.JsonString.Source data = default)
        {
            Create(ref _builder, data);
        }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonString.Source data = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.Models.JsonString.Source data = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetFilesVendorJsonOk, Mutable>(this);
    }
}
