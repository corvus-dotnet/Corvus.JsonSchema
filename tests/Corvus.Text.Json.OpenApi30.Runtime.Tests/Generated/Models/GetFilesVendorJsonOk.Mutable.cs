...
public readonly partial struct GetFilesVendorJsonOk
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests30.Client.JsonString.Mutable Data
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataUtf8, out CanonTests30.Client.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetData(in CanonTests30.Client.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.GetFilesVendorJsonOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.GetFilesVendorJsonOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests30.Client.JsonString.Source data = default)
        {
        ...
        /// Creates an instance of a <see cref="GetFilesVendorJsonOk"/>.
        /// </summary>
        public void Create(in CanonTests30.Client.JsonString.Source data = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.JsonString.Source data = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
