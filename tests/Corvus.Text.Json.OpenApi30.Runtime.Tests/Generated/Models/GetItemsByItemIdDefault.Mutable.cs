...
public readonly partial struct GetItemsByItemIdDefault
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.GetItemsByItemIdDefault.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.GetItemsByItemIdDefault.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests30.Client.JsonString.Source error)
        {
        ...
        /// Creates an instance of a <see cref="GetItemsByItemIdDefault"/>.
        /// </summary>
        public void Create(in CanonTests30.Client.JsonString.Source error)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.JsonString.Source error, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
