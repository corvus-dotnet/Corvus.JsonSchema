...
public readonly partial struct GetItemsByItemIdNotFound
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests30.Client.JsonInt32.Mutable Code
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out CanonTests30.Client.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests30.Client.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out CanonTests30.Client.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCode(in CanonTests30.Client.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(in CanonTests30.Client.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.GetItemsByItemIdNotFound.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.GetItemsByItemIdNotFound.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Client.JsonInt32.Source code,
            in CanonTests30.Client.JsonString.Source message)
        {
        ...
        /// Creates an instance of a <see cref="GetItemsByItemIdNotFound"/>.
        /// </summary>
        public void Create(in CanonTests30.Client.JsonInt32.Source code, in CanonTests30.Client.JsonString.Source message)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.JsonInt32.Source code, in CanonTests30.Client.JsonString.Source message, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
