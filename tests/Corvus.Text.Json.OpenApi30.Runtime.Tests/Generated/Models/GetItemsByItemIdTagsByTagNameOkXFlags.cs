...
#endif
{
    ...
    public CanonTests30.Client.JsonBoolean this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests30.Client.JsonBoolean>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests30.Client.JsonBoolean> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests30.Client.JsonBoolean>(_parent, _idx);
    }
