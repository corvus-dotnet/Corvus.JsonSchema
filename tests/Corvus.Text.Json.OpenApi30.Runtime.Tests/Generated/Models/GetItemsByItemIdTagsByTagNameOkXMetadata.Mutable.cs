...
public readonly partial struct GetItemsByItemIdTagsByTagNameOkXMetadata
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsByItemIdTagsByTagNameOkXMetadata instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsByItemIdTagsByTagNameOkXMetadata"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsByItemIdTagsByTagNameOkXMetadata(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetItemsByItemIdTagsByTagNameOkXMetadata(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsByItemIdTagsByTagNameOkXMetadata.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetItemsByItemIdTagsByTagNameOkXMetadata"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetItemsByItemIdTagsByTagNameOkXMetadata"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdTagsByTagNameOkXMetadata Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetItemsByItemIdTagsByTagNameOkXMetadata>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetItemsByItemIdTagsByTagNameOkXMetadata"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdTagsByTagNameOkXMetadata Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsByItemIdTagsByTagNameOkXMetadata>(_idx);
        }
    }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonString.Source region = default, in CanonTests30.Client.Models.JsonString.Source version = default)
    {
        return new Source(region, version);
    }
    ...
    {
        return workspace.CreateBuilder<GetItemsByItemIdTagsByTagNameOkXMetadata, Mutable>(this);
    }
}
