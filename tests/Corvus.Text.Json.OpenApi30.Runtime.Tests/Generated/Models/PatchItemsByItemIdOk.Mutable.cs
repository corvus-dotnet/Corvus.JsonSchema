...
public readonly partial struct PatchItemsByItemIdOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PatchItemsByItemIdOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PatchItemsByItemIdOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PatchItemsByItemIdOk(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests30.Client.Models.JsonString.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out CanonTests30.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PatchItemsByItemIdOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetId(in CanonTests30.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PatchItemsByItemIdOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PatchItemsByItemIdOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PatchItemsByItemIdOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PatchItemsByItemIdOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PatchItemsByItemIdOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PatchItemsByItemIdOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PatchItemsByItemIdOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PatchItemsByItemIdOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.PatchItemsByItemIdOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(PatchItemsByItemIdOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.PatchItemsByItemIdOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PatchItemsByItemIdOk"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests30.Client.Models.JsonString.Source id,
        ...
        /// Creates an instance of a <see cref="PatchItemsByItemIdOk"/>.
        /// </summary>
        public void Create(in CanonTests30.Client.Models.JsonString.Source id, in CanonTests30.Client.Models.JsonString.Source name)
        {
        ...
        internal static void BuildCreateValue(in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonString.Source id, in CanonTests30.Client.Models.JsonString.Source name)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.Models.JsonString.Source id, in CanonTests30.Client.Models.JsonString.Source name, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PatchItemsByItemIdOk, Mutable>(this);
    }
}
