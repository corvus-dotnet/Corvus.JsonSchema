...
public readonly partial struct PostFilesUploadCreated
    : IJsonElement<PostFilesUploadCreated>
{
    public static partial class JsonSchema
    {
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.IdUtf8))
            {
                matcher = MatchId;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1files~1upload/post/responses/201/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1files~1upload/post/responses/201/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1files~1upload/post/responses/201/content/application~1json/schema"u8;
