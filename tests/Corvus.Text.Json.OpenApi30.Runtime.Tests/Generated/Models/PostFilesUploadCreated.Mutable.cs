...
public readonly partial struct PostFilesUploadCreated
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.PostFilesUploadCreated.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.PostFilesUploadCreated.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests30.Client.Models.JsonString.Source id = default)
        {
        ...
        /// Creates an instance of a <see cref="PostFilesUploadCreated"/>.
        /// </summary>
        public void Create(in CanonTests30.Client.Models.JsonString.Source id = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonString.Source id = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.Models.JsonString.Source id = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
