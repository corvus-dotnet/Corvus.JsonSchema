...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostFilesUploadCreated"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostFilesUploadCreated(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostFilesUploadCreated DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PostFilesUploadCreated left, in PostFilesUploadCreated right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostFilesUploadCreated left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostFilesUploadCreated instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostFilesUploadCreated(JsonElement instance)
    {
        return PostFilesUploadCreated.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFilesUploadCreated From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFilesUploadCreated ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostFilesUploadCreated>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFilesUploadCreated ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostFilesUploadCreated>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFilesUploadCreated ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostFilesUploadCreated>(json, options);
    }
    ...
    /// </exception>
    public static PostFilesUploadCreated ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostFilesUploadCreated>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostFilesUploadCreated? result)
    {
        return JsonElementHelpers.TryParseValue<PostFilesUploadCreated>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PostFilesUploadCreated(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PostFilesUploadCreated IJsonElement<PostFilesUploadCreated>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostFilesUploadCreated: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PostFilesUploadCreated"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PostFilesUploadCreated"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PostFilesUploadCreated Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PostFilesUploadCreated>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PostFilesUploadCreated"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PostFilesUploadCreated Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostFilesUploadCreated>(_idx);
        }
