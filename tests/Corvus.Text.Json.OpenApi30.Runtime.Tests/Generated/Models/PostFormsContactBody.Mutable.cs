...
public readonly partial struct PostFormsContactBody
{
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Client.Models.JsonString.Source _createArg3;
        ...
        internal Source(CanonTests30.Client.Models.PostFormsContactBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Client.Models.JsonEmail.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.PostFormsContactBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Client.Models.JsonString.Source message = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests30.Client.Models.JsonEmail.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonEmail.Source email, in CanonTests30.Client.Models.JsonString.Source name, in CanonTests30.Client.Models.JsonString.Source message = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.Models.JsonEmail.Source email, in CanonTests30.Client.Models.JsonString.Source name, in CanonTests30.Client.Models.JsonString.Source message = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
