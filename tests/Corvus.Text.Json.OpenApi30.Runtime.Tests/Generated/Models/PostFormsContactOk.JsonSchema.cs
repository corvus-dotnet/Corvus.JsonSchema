...
public readonly partial struct PostFormsContactOk
    : IJsonElement<PostFormsContactOk>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReceivedPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("received"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReceivedNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("received"u8, buffer, out written);

        private const int RequiredOffsetForReceived = 0;
        private const uint RequiredBitForReceived = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForReceived;
        private static readonly JsonSchemaPathProvider ReceivedSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/received"u8, buffer, out written);

        private static void MatchReceived(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            requiredBitBuffer[RequiredOffsetForReceived] |= RequiredBitForReceived;
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1forms~1contact/post/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1forms~1contact/post/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1forms~1contact/post/responses/200/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReceivedPresent, "received"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForReceived] & RequiredBitForReceived) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyReceivedNotPresent, "received"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReceivedPresent, "received"u8, "required"u8);
