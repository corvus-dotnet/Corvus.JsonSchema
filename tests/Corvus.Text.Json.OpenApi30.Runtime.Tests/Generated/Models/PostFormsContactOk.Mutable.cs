...
public readonly partial struct PostFormsContactOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsContactOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsContactOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsContactOk(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests30.Client.Models.JsonBoolean.Mutable Received
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReceivedUtf8, out CanonTests30.Client.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostFormsContactOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetReceived(in CanonTests30.Client.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsContactOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostFormsContactOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostFormsContactOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsContactOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostFormsContactOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostFormsContactOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsContactOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsContactOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.PostFormsContactOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(PostFormsContactOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.PostFormsContactOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostFormsContactOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests30.Client.Models.JsonBoolean.Source received)
        {
        ...
        /// Creates an instance of a <see cref="PostFormsContactOk"/>.
        /// </summary>
        public void Create(in CanonTests30.Client.Models.JsonBoolean.Source received)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonBoolean.Source received)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.Models.JsonBoolean.Source received, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PostFormsContactOk, Mutable>(this);
    }
}
