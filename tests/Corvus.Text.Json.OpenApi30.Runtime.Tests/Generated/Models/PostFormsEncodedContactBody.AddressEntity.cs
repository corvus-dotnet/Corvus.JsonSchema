...
public readonly partial struct PostFormsEncodedContactBody
{
...
#endif
    {
        ...
        /// </summary>
        public static AddressEntity DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in AddressEntity left, in AddressEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AddressEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        {
            return AddressEntity.From(instance);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AddressEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AddressEntity>(ref reader, out result);
        }
...
#if NET
        static AddressEntity IJsonElement<AddressEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AddressEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="City"/>.
            /// </summary>
            public static ReadOnlySpan<byte> City => [0x65, 0x00, 0x00, 0x00, 0x22, 0x63, 0x69, 0x74, 0x79, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Street"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Street => [0x85, 0x00, 0x00, 0x00, 0x22, 0x73, 0x74, 0x72, 0x65, 0x65, 0x74, 0x22];
        }
    }
}
