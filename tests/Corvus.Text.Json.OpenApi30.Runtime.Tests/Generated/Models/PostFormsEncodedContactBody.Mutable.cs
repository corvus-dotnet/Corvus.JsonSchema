...
public readonly partial struct PostFormsEncodedContactBody
{
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Client.Models.JsonEmail.Source _createArg1;
        private readonly CanonTests30.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests30.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source _createArg3;
        private readonly CanonTests30.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source _createArg4;
        ...
        internal Source(in CanonTests30.Client.Models.JsonEmail.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source arg3, in CanonTests30.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly CanonTests30.Client.Models.JsonEmail.Source _createArg1;
        private readonly CanonTests30.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests30.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> _createArg3;
        private readonly CanonTests30.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> _createArg4;
        ...
        internal Source(scoped in TContext context, in CanonTests30.Client.Models.JsonEmail.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> arg3, in CanonTests30.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> arg4)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests30.Client.Models.JsonEmail.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source arg3, in CanonTests30.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg4">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests30.Client.Models.JsonEmail.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> arg3, in CanonTests30.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> arg4, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonEmail.Source email, in CanonTests30.Client.Models.JsonString.Source name, in CanonTests30.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source address = default, in CanonTests30.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source tags = default)
    {
    ...
    /// <param name="tags">The value of the <c>"tags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests30.Client.Models.JsonEmail.Source email, in CanonTests30.Client.Models.JsonString.Source name, in CanonTests30.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> address = default, in CanonTests30.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
