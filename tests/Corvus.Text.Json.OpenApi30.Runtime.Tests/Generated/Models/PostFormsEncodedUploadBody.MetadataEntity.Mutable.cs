...
/// </summary>
public readonly partial struct PostFormsEncodedUploadBody
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly partial struct MetadataEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MetadataEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MetadataEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MetadataEntity(Mutable instance)
            {
            ...
            /// </summary>
            public CanonTests30.Client.Models.JsonString.Mutable Author
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorUtf8, out CanonTests30.Client.Models.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public CanonTests30.Client.Models.JsonInteger.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out CanonTests30.Client.Models.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MetadataEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetAuthor(in CanonTests30.Client.Models.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersion(in CanonTests30.Client.Models.JsonInteger.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MetadataEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MetadataEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MetadataEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MetadataEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MetadataEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MetadataEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MetadataEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MetadataEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly CanonTests30.Client.Models.JsonInteger.Source _createArg2;
            ...
            internal Source(CanonTests30.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonInteger.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests30.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in CanonTests30.Client.Models.JsonString.Source author = default,
                in CanonTests30.Client.Models.JsonInteger.Source version = default)
            {
            ...
            /// Creates an instance of a <see cref="MetadataEntity"/>.
            /// </summary>
            public void Create(in CanonTests30.Client.Models.JsonString.Source author = default, in CanonTests30.Client.Models.JsonInteger.Source version = default)
            {
                Create(ref _builder, author, version);
            }
            ...
            internal static void BuildCreateValue(in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in CanonTests30.Client.Models.JsonString.Source author = default, in CanonTests30.Client.Models.JsonInteger.Source version = default)
        {
            return new Source(author, version);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.Models.JsonString.Source author = default, in CanonTests30.Client.Models.JsonInteger.Source version = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(author, version);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<MetadataEntity, Mutable>(this);
        }
    }
}
