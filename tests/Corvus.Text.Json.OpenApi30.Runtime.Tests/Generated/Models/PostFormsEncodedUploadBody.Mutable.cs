...
public readonly partial struct PostFormsEncodedUploadBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests30.Client.PostFormsEncodedUploadBody.MetadataEntity.Mutable Metadata
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests30.Client.PostFormsEncodedUploadBody.MetadataEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests30.Client.PostFormsEncodedUploadBody.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests30.Client.PostFormsEncodedUploadBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMetadata(in CanonTests30.Client.PostFormsEncodedUploadBody.MetadataEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMetadata<TContext>(in CanonTests30.Client.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in CanonTests30.Client.PostFormsEncodedUploadBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in CanonTests30.Client.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.PostFormsEncodedUploadBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.PostFormsEncodedUploadBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Client.PostFormsEncodedUploadBody.MetadataEntity.Source metadata = default,
            in CanonTests30.Client.PostFormsEncodedUploadBody.JsonStringArray.Source tags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in CanonTests30.Client.JsonString.Source title,
            in CanonTests30.Client.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> metadata = default,
            in CanonTests30.Client.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.JsonString.Source title, in CanonTests30.Client.PostFormsEncodedUploadBody.MetadataEntity.Source metadata = default, in CanonTests30.Client.PostFormsEncodedUploadBody.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests30.Client.JsonString.Source title, in CanonTests30.Client.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests30.Client.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
