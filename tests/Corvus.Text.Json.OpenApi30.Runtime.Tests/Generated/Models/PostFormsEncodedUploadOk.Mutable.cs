...
public readonly partial struct PostFormsEncodedUploadOk
{
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Client.Models.JsonBoolean.Source _createArg1;
        ...
        internal Source(CanonTests30.Client.Models.PostFormsEncodedUploadOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Client.Models.JsonBoolean.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.PostFormsEncodedUploadOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests30.Client.Models.JsonBoolean.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonBoolean.Source uploaded)
    {
