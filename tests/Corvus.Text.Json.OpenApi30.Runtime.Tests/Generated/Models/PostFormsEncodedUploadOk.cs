...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Client.JsonBoolean Uploaded
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedUtf8, out CanonTests30.Client.JsonBoolean value))
            {
                return value;
            }
