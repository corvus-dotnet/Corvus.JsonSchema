...
public readonly partial struct PostFormsUploadBody
{
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Client.Models.JsonString.Source _createArg1;
        private readonly CanonTests30.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests30.Client.Models.PostFormsUploadBody.JsonStringArray.Source _createArg3;
        ...
        internal Source(in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.PostFormsUploadBody.JsonStringArray.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly CanonTests30.Client.Models.JsonString.Source _createArg1;
        private readonly CanonTests30.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests30.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> _createArg3;
        ...
        internal Source(scoped in TContext context, in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.PostFormsUploadBody.JsonStringArray.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonString.Source title, in CanonTests30.Client.Models.JsonString.Source category = default, in CanonTests30.Client.Models.PostFormsUploadBody.JsonStringArray.Source tags = default)
    {
    ...
    /// <param name="tags">The value of the <c>"tags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests30.Client.Models.JsonString.Source title, in CanonTests30.Client.Models.JsonString.Source category = default, in CanonTests30.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
