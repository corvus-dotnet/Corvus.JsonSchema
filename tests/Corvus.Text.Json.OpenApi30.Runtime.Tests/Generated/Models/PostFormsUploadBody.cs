...
#endif
{
    ...
    /// </summary>
    public CanonTests30.Client.JsonString Category
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CategoryUtf8, out CanonTests30.Client.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests30.Client.PostFormsUploadBody.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests30.Client.PostFormsUploadBody.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Client.JsonString Title
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out CanonTests30.Client.JsonString value))
            {
                return value;
            }
