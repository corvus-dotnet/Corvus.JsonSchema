...
public readonly partial struct PostFormsUploadOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsUploadOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsUploadOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsUploadOk(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostFormsUploadOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsUploadOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostFormsUploadOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostFormsUploadOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsUploadOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostFormsUploadOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostFormsUploadOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsUploadOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsUploadOk>(_idx);
        }
    }
    ...
    {
        return workspace.CreateBuilder<PostFormsUploadOk, Mutable>(this);
    }
}
