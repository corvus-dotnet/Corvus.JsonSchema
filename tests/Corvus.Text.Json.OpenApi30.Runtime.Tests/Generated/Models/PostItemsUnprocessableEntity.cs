...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Client.PostItemsUnprocessableEntity.JsonStringArray Errors
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorsUtf8, out CanonTests30.Client.PostItemsUnprocessableEntity.JsonStringArray value))
            {
                return value;
            }
