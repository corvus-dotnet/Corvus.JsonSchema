...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Client.Models.JsonString Parsed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParsedUtf8, out CanonTests30.Client.Models.JsonString value))
            {
                return value;
            }
