...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Client.JsonString Parsed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParsedUtf8, out CanonTests30.Client.JsonString value))
            {
                return value;
            }
