...
public readonly partial struct PutItemsOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PutItemsOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PutItemsOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PutItemsOk(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PutItemsOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PutItemsOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PutItemsOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PutItemsOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.Models.PutItemsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(PutItemsOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.PutItemsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PutItemsOk"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<PutItemsOk, Mutable>(this);
    }
}
