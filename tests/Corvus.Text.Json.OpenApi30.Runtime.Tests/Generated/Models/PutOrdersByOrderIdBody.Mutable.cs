...
public readonly partial struct PutOrdersByOrderIdBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PutOrdersByOrderIdBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PutOrdersByOrderIdBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PutOrdersByOrderIdBody(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PutOrdersByOrderIdBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PutOrdersByOrderIdBody Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PutOrdersByOrderIdBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PutOrdersByOrderIdBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Client.Models.JsonNumber.Source _createArg2;
        ...
        internal Source(in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonNumber.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests30.Client.Models.JsonString.Source arg1, in CanonTests30.Client.Models.JsonNumber.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonString.Source status, in CanonTests30.Client.Models.JsonNumber.Source total = default)
    {
        return new Source(status, total);
    }
    ...
    {
        return workspace.CreateBuilder<PutOrdersByOrderIdBody, Mutable>(this);
    }
}
