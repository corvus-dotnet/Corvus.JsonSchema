...
public readonly partial struct PutOrdersByOrderIdBody
#if NET8_0_OR_GREATER
    : IJsonElement<PutOrdersByOrderIdBody>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PutOrdersByOrderIdBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PutOrdersByOrderIdBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PutOrdersByOrderIdBody DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PutOrdersByOrderIdBody left, in PutOrdersByOrderIdBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PutOrdersByOrderIdBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PutOrdersByOrderIdBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PutOrdersByOrderIdBody(JsonElement instance)
    {
        return PutOrdersByOrderIdBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutOrdersByOrderIdBody From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutOrdersByOrderIdBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PutOrdersByOrderIdBody>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutOrdersByOrderIdBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PutOrdersByOrderIdBody>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutOrdersByOrderIdBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PutOrdersByOrderIdBody>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static PutOrdersByOrderIdBody ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PutOrdersByOrderIdBody>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PutOrdersByOrderIdBody? result)
    {
        return JsonElementHelpers.TryParseValue<PutOrdersByOrderIdBody>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PutOrdersByOrderIdBody(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PutOrdersByOrderIdBody IJsonElement<PutOrdersByOrderIdBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PutOrdersByOrderIdBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PutOrdersByOrderIdBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PutOrdersByOrderIdBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PutOrdersByOrderIdBody Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PutOrdersByOrderIdBody>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PutOrdersByOrderIdBody"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PutOrdersByOrderIdBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PutOrdersByOrderIdBody>(_idx);
        }
