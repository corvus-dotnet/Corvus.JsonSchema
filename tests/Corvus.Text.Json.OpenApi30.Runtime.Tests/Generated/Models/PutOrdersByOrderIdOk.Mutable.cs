...
public readonly partial struct PutOrdersByOrderIdOk
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests30.Client.JsonUuid.Mutable OrderId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderIdUtf8, out CanonTests30.Client.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        public void SetOrderId(in CanonTests30.Client.JsonUuid.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Client.PutOrdersByOrderIdOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.PutOrdersByOrderIdOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Client.JsonUuid.Source orderId,
            in CanonTests30.Client.JsonString.Source status,
            in CanonTests30.Client.JsonNumber.Source total)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.JsonUuid.Source orderId, in CanonTests30.Client.JsonString.Source status, in CanonTests30.Client.JsonNumber.Source total, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
