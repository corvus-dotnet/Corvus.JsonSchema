...
public readonly partial struct PutOrdersByOrderIdOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PutOrdersByOrderIdOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PutOrdersByOrderIdOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PutOrdersByOrderIdOk(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests30.Client.Models.JsonUuid.Mutable OrderId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderIdUtf8, out CanonTests30.Client.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        public void SetOrderId(in CanonTests30.Client.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PutOrdersByOrderIdOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PutOrdersByOrderIdOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PutOrdersByOrderIdOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PutOrdersByOrderIdOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Client.Models.JsonUuid.Source _createArg1;
        private readonly CanonTests30.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests30.Client.Models.JsonNumber.Source _createArg3;
        ...
        internal Source(CanonTests30.Client.Models.PutOrdersByOrderIdOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Client.Models.JsonUuid.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.JsonNumber.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Client.Models.PutOrdersByOrderIdOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Client.Models.JsonUuid.Source orderId,
            in CanonTests30.Client.Models.JsonString.Source status,
            in CanonTests30.Client.Models.JsonNumber.Source total)
        {
        ...
        internal static void BuildCreateValue(in CanonTests30.Client.Models.JsonUuid.Source arg1, in CanonTests30.Client.Models.JsonString.Source arg2, in CanonTests30.Client.Models.JsonNumber.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Client.Models.JsonUuid.Source orderId, in CanonTests30.Client.Models.JsonString.Source status, in CanonTests30.Client.Models.JsonNumber.Source total)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Client.Models.JsonUuid.Source orderId, in CanonTests30.Client.Models.JsonString.Source status, in CanonTests30.Client.Models.JsonNumber.Source total, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PutOrdersByOrderIdOk, Mutable>(this);
    }
}
