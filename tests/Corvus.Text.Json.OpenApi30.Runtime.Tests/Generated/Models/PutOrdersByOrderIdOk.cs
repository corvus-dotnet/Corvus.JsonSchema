...
public readonly partial struct PutOrdersByOrderIdOk
#if NET8_0_OR_GREATER
    : IJsonElement<PutOrdersByOrderIdOk>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PutOrdersByOrderIdOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PutOrdersByOrderIdOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PutOrdersByOrderIdOk DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Client.Models.JsonUuid OrderId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderIdUtf8, out CanonTests30.Client.Models.JsonUuid value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Client.Models.JsonString Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out CanonTests30.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Client.Models.JsonNumber Total
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalUtf8, out CanonTests30.Client.Models.JsonNumber value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PutOrdersByOrderIdOk left, in PutOrdersByOrderIdOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PutOrdersByOrderIdOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PutOrdersByOrderIdOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PutOrdersByOrderIdOk(JsonElement instance)
    {
        return PutOrdersByOrderIdOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutOrdersByOrderIdOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutOrdersByOrderIdOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutOrdersByOrderIdOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutOrdersByOrderIdOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutOrdersByOrderIdOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutOrdersByOrderIdOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutOrdersByOrderIdOk>(json, options);
    }
    ...
    /// </exception>
    public static PutOrdersByOrderIdOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PutOrdersByOrderIdOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PutOrdersByOrderIdOk? result)
    {
        return JsonElementHelpers.TryParseValue<PutOrdersByOrderIdOk>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PutOrdersByOrderIdOk(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PutOrdersByOrderIdOk IJsonElement<PutOrdersByOrderIdOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PutOrdersByOrderIdOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PutOrdersByOrderIdOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PutOrdersByOrderIdOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PutOrdersByOrderIdOk Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PutOrdersByOrderIdOk>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PutOrdersByOrderIdOk"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PutOrdersByOrderIdOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PutOrdersByOrderIdOk>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="OrderId"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="OrderId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> OrderIdUtf8 => "orderId"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="OrderId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> OrderId => "orderId"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="OrderId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> OrderId => [0x95, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22];
