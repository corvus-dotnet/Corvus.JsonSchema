...
/// <summary>
/// Response type for the PathArrayMatrix operation.
/// </summary>
public struct PathArrayMatrixResponse : IApiResponse<PathArrayMatrixResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PathArrayMatrixResponse> CreateAsync(
        int statusCode,
    ...
    {
        PathArrayMatrixResponse response = default;
