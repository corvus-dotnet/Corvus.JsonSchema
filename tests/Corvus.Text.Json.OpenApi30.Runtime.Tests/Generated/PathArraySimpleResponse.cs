...
/// <summary>
/// Response type for the PathArraySimple operation.
/// </summary>
public struct PathArraySimpleResponse : IApiResponse<PathArraySimpleResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PathArraySimpleResponse> CreateAsync(
        int statusCode,
    ...
    {
        PathArraySimpleResponse response = default;
