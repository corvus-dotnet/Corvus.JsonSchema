...
public struct PathObjectLabelExplodeResponse : IApiResponse<PathObjectLabelExplodeResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.JsonObject OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests30.Client.JsonObject>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests30.Client.JsonObject result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.JsonObject, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.JsonObject, TContext, TResult> matchOk,
