...
/// <summary>
/// Response type for the PathObjectLabel operation.
/// </summary>
public struct PathObjectLabelResponse : IApiResponse<PathObjectLabelResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PathObjectLabelResponse> CreateAsync(
        int statusCode,
    ...
    {
        PathObjectLabelResponse response = default;
