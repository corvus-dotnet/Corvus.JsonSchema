...
/// <summary>
/// Response type for the PathObjectSimple operation.
/// </summary>
public struct PathObjectSimpleResponse : IApiResponse<PathObjectSimpleResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PathObjectSimpleResponse> CreateAsync(
        int statusCode,
    ...
    {
        PathObjectSimpleResponse response = default;
