...
public struct SubmitContactFormResponse : IApiResponse<SubmitContactFormResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.Models.PostFormsContactOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests30.Client.Models.PostFormsContactOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests30.Client.Models.PostFormsContactOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.Models.PostFormsContactOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.Models.PostFormsContactOk, TContext, TResult> matchOk,
