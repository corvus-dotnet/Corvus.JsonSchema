...
/// <summary>
/// Response type for the SubmitEncodedContactForm operation.
/// </summary>
public struct SubmitEncodedContactFormResponse : IApiResponse<SubmitEncodedContactFormResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.Models.PostFormsEncodedContactOk OkBody { get; private set; }
    ...
    {
        SubmitEncodedContactFormResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests30.Client.Models.PostFormsEncodedContactOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests30.Client.Models.PostFormsEncodedContactOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.Models.PostFormsEncodedContactOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.Models.PostFormsEncodedContactOk, TContext, TResult> matchOk,
