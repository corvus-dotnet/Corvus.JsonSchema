...
/// <summary>
/// Request type for the TextToJson operation.
/// </summary>
/// <remarks>Accept text/plain, return JSON</remarks>
public readonly struct TextToJsonRequest : IApiRequest<TextToJsonRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/text/to-json"u8;
