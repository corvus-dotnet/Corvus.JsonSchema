...
public struct TextToJsonResponse : IApiResponse<TextToJsonResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.Models.PostTextToJsonOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests30.Client.Models.PostTextToJsonOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests30.Client.Models.PostTextToJsonOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.Models.PostTextToJsonOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.Models.PostTextToJsonOk, TContext, TResult> matchOk,
