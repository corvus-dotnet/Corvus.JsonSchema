...
/// <summary>
/// Response type for the TraceItem operation.
/// </summary>
public struct TraceItemResponse : IApiResponse<TraceItemResponse>
{
    ...
    /// <inheritdoc/>
    public static ValueTask<TraceItemResponse> CreateAsync(
        int statusCode,
    ...
    {
        TraceItemResponse response = default;
