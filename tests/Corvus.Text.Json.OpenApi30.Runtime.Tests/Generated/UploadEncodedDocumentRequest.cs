...
/// <summary>
/// Request type for the UploadEncodedDocument operation.
/// </summary>
/// <remarks>Upload a document with encoding overrides</remarks>
public readonly struct UploadEncodedDocumentRequest : IApiRequest<UploadEncodedDocumentRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/forms/encoded-upload"u8;
