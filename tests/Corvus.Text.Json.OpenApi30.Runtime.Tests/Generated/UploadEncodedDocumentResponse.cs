...
public struct UploadEncodedDocumentResponse : IApiResponse<UploadEncodedDocumentResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.Models.PostFormsEncodedUploadOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests30.Client.Models.PostFormsEncodedUploadOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests30.Client.Models.PostFormsEncodedUploadOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.Models.PostFormsEncodedUploadOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.Models.PostFormsEncodedUploadOk, TContext, TResult> matchOk,
