...
public struct UploadFileResponse : IApiResponse<UploadFileResponse>
{
    ...
    /// </summary>
    public CanonTests30.Client.Models.PostFilesUploadCreated CreatedBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<CanonTests30.Client.Models.PostFilesUploadCreated>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out CanonTests30.Client.Models.PostFilesUploadCreated result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests30.Client.Models.PostFilesUploadCreated, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests30.Client.Models.PostFilesUploadCreated, TContext, TResult> matchCreated,
