...
public readonly struct GetItemResult
{
    ...
    public static GetItemResult Ok(CanonTests30.Server.Models.ItemEntity.Source body, JsonWorkspace workspace, CanonTests30.Server.Models.JsonInt32.Source xRateLimit = default, CanonTests30.Server.Models.JsonBoolean.Source xActive = default, CanonTests30.Server.Models.GetItemsByItemIdOkXTags.Source xTags = default, CanonTests30.Server.Models.GetItemsByItemIdOkXPageSizes.Source xPageSizes = default, CanonTests30.Server.Models.GetItemsByItemIdOkXFlags.Source xFlags = default, JsonElement.Source xRequestId = default) => new(200, CanonTests30.Server.Models.ItemEntity.CreateBuilder(workspace, body, 30).RootElement, "application/json", xRateLimit: CanonTests30.Server.Models.JsonInt32.CreateBuilder(workspace, xRateLimit, 30).RootElement, xActive: CanonTests30.Server.Models.JsonBoolean.CreateBuilder(workspace, xActive, 30).RootElement, xTags: CanonTests30.Server.Models.GetItemsByItemIdOkXTags.CreateBuilder(workspace, xTags, 30).RootElement, xPageSizes: CanonTests30.Server.Models.GetItemsByItemIdOkXPageSizes.CreateBuilder(workspace, xPageSizes, 30).RootElement, xFlags: CanonTests30.Server.Models.GetItemsByItemIdOkXFlags.CreateBuilder(workspace, xFlags, 30).RootElement, xRequestId: JsonElement.CreateBuilder(workspace, xRequestId, 30).RootElement);
