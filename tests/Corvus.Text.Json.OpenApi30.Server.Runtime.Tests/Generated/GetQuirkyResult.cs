...
public readonly struct GetQuirkyResult
{
    ...
    public static GetQuirkyResult Ok(CanonTests30.Server.ItemEntity.Source body, JsonWorkspace workspace) => new(200, CanonTests30.Server.ItemEntity.CreateBuilder(workspace, body, 30).RootElement, "application/json");
