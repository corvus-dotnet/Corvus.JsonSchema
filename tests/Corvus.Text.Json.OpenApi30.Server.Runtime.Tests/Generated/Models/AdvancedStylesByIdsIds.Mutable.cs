...
public readonly partial struct AdvancedStylesByIdsIds
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AdvancedStylesByIdsIds instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AdvancedStylesByIdsIds"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AdvancedStylesByIdsIds(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AdvancedStylesByIdsIds(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AdvancedStylesByIdsIds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="AdvancedStylesByIdsIds"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AdvancedStylesByIdsIds"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AdvancedStylesByIdsIds Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AdvancedStylesByIdsIds>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AdvancedStylesByIdsIds"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AdvancedStylesByIdsIds Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AdvancedStylesByIdsIds>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.Models.AdvancedStylesByIdsIds.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(AdvancedStylesByIdsIds instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.AdvancedStylesByIdsIds.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<AdvancedStylesByIdsIds, Mutable>(this);
    }
}
