...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Server.Models.JsonInt32 Code
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out CanonTests30.Server.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Server.Models.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out CanonTests30.Server.Models.JsonString value))
            {
                return value;
            }
