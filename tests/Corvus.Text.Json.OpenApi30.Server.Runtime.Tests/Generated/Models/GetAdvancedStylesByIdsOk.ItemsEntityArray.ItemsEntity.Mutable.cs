    ...
    public readonly partial struct ItemsEntityArray
    {
        ...
        public readonly partial struct ItemsEntity
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(CanonTests30.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, CanonTests30.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in CanonTests30.Server.Models.JsonString.Source name = default)
                {
                ...
                /// Creates an instance of a <see cref="ItemsEntity"/>.
                /// </summary>
                public void Create(in CanonTests30.Server.Models.JsonString.Source id = default, in CanonTests30.Server.Models.JsonString.Source name = default)
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in CanonTests30.Server.Models.JsonString.Source id = default, in CanonTests30.Server.Models.JsonString.Source name = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonString.Source id = default, in CanonTests30.Server.Models.JsonString.Source name = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
