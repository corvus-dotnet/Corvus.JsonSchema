...
#endif
{
    ...
    /// </summary>
    public CanonTests30.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray Items
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out CanonTests30.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests30.Server.JsonInteger Total
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalUtf8, out CanonTests30.Server.JsonInteger value))
            {
                return value;
            }
