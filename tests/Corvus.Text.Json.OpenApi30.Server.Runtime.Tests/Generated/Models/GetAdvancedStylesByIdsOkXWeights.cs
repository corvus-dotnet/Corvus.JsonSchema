...
public readonly partial struct GetAdvancedStylesByIdsOkXWeights
    ...
    : IJsonElement<GetAdvancedStylesByIdsOkXWeights>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAdvancedStylesByIdsOkXWeights"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetAdvancedStylesByIdsOkXWeights(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetAdvancedStylesByIdsOkXWeights DefaultInstance { get; }
    ...
    public bool TryGetNumericValues(Span<float> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (CanonTests30.Server.Models.JsonSingle item in EnumerateArray())
        {
    ...
    public CanonTests30.Server.Models.JsonSingle this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests30.Server.Models.JsonSingle>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests30.Server.Models.JsonSingle> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests30.Server.Models.JsonSingle>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsOkXWeights left, in GetAdvancedStylesByIdsOkXWeights right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsOkXWeights left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetAdvancedStylesByIdsOkXWeights instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetAdvancedStylesByIdsOkXWeights(JsonElement instance)
    {
        return GetAdvancedStylesByIdsOkXWeights.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXWeights From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXWeights ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXWeights>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXWeights ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXWeights>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXWeights ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXWeights>(json, options);
    }
    ...
    /// </exception>
    public static GetAdvancedStylesByIdsOkXWeights ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXWeights>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetAdvancedStylesByIdsOkXWeights? result)
    {
        return JsonElementHelpers.TryParseValue<GetAdvancedStylesByIdsOkXWeights>(ref reader, out result);
    }
...
#if NET
    static GetAdvancedStylesByIdsOkXWeights IJsonElement<GetAdvancedStylesByIdsOkXWeights>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetAdvancedStylesByIdsOkXWeights: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsOkXWeights Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsOkXWeights Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetAdvancedStylesByIdsOkXWeights>(_idx);
        }
