...
public readonly partial struct GetHealthOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetHealthOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetHealthOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetHealthOk(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetHealthOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetHealthOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetHealthOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetHealthOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetHealthOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetHealthOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetHealthOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetHealthOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetHealthOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.Models.GetHealthOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetHealthOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.GetHealthOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetHealthOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests30.Server.Models.JsonString.Source status = default)
        {
        ...
        /// Creates an instance of a <see cref="GetHealthOk"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.JsonString.Source status = default)
        {
            Create(ref _builder, status);
        }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonString.Source status = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonString.Source status = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetHealthOk, Mutable>(this);
    }
}
