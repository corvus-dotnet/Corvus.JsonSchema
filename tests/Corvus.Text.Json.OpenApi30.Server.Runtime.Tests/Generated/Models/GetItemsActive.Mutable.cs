...
public readonly partial struct GetItemsActive
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsActive instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsActive"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsActive(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsActive.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsActive Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsActive Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsActive>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetItemsActive instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetItemsActive, Mutable>(this);
    }
}
