...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetItemsActive"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetItemsActive(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetItemsActive DefaultInstance { get; } = ParsedJsonDocument<GetItemsActive>.True;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator bool(GetItemsActive value)
    {
    ...
    /// </returns>
    public static bool operator ==(in GetItemsActive left, in GetItemsActive right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetItemsActive left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(GetItemsActive instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetItemsActive(JsonElement instance)
    {
        return GetItemsActive.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsActive From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsActive ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetItemsActive>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsActive ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetItemsActive>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsActive ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetItemsActive>(json, options);
    }
    ...
    /// </exception>
    public static GetItemsActive ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetItemsActive>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetItemsActive? result)
    {
        return JsonElementHelpers.TryParseValue<GetItemsActive>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetItemsActive(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetItemsActive IJsonElement<GetItemsActive>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetItemsActive: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetItemsActive"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetItemsActive"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetItemsActive Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetItemsActive>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetItemsActive"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetItemsActive Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetItemsActive>(_idx);
        }
