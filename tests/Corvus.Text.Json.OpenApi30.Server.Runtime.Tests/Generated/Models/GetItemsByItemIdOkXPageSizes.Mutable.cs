...
public readonly partial struct GetItemsByItemIdOkXPageSizes
{
...
#endif
    {
        ...
        public CanonTests30.Server.JsonInt32.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests30.Server.JsonInt32.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests30.Server.JsonInt32.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests30.Server.JsonInt32.Mutable>(_parent, _idx);
        }
        ...
        public bool TryGetNumericValues(Span<int> items, out int written)
        {
            CheckValidInstance();
            written = 0;
            foreach (CanonTests30.Server.JsonInt32.Mutable item in EnumerateArray())
            {
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in CanonTests30.Server.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in CanonTests30.Server.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in CanonTests30.Server.JsonInt32.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in CanonTests30.Server.JsonInt32 item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests30.Server.JsonInt32>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<CanonTests30.Server.JsonInt32> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests30.Server.JsonInt32>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in CanonTests30.Server.JsonInt32 oldItem, in CanonTests30.Server.JsonInt32.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests30.Server.JsonInt32>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                CanonTests30.Server.JsonInt32 current = enumerator.Current;
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.GetItemsByItemIdOkXPageSizes.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.GetItemsByItemIdOkXPageSizes.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
