...
#endif
{
    ...
    public bool TryGetNumericValues(Span<int> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (CanonTests30.Server.JsonInt32 item in EnumerateArray())
        {
    ...
    public CanonTests30.Server.JsonInt32 this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests30.Server.JsonInt32>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests30.Server.JsonInt32> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests30.Server.JsonInt32>(_parent, _idx);
    }
