...
public readonly partial struct GetItemsByItemIdOkXPageSizes
#if NET8_0_OR_GREATER
    : IJsonElement<GetItemsByItemIdOkXPageSizes>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetItemsByItemIdOkXPageSizes"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetItemsByItemIdOkXPageSizes(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetItemsByItemIdOkXPageSizes DefaultInstance { get; }
    ...
    public bool TryGetNumericValues(Span<int> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (CanonTests30.Server.Models.JsonInt32 item in EnumerateArray())
        {
    ...
    public CanonTests30.Server.Models.JsonInt32 this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests30.Server.Models.JsonInt32>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests30.Server.Models.JsonInt32> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests30.Server.Models.JsonInt32>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdOkXPageSizes left, in GetItemsByItemIdOkXPageSizes right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdOkXPageSizes left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetItemsByItemIdOkXPageSizes instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetItemsByItemIdOkXPageSizes(JsonElement instance)
    {
        return GetItemsByItemIdOkXPageSizes.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXPageSizes From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXPageSizes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXPageSizes>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXPageSizes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXPageSizes>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXPageSizes ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXPageSizes>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetItemsByItemIdOkXPageSizes ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXPageSizes>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetItemsByItemIdOkXPageSizes? result)
    {
        return JsonElementHelpers.TryParseValue<GetItemsByItemIdOkXPageSizes>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetItemsByItemIdOkXPageSizes(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetItemsByItemIdOkXPageSizes IJsonElement<GetItemsByItemIdOkXPageSizes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetItemsByItemIdOkXPageSizes: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetItemsByItemIdOkXPageSizes"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetItemsByItemIdOkXPageSizes"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdOkXPageSizes Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetItemsByItemIdOkXPageSizes>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetItemsByItemIdOkXPageSizes"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdOkXPageSizes Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetItemsByItemIdOkXPageSizes>(_idx);
        }
