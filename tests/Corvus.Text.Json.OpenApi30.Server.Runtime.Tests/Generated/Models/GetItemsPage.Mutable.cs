...
public readonly partial struct GetItemsPage
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsPage instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsPage"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsPage(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetItemsPage(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsPage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetItemsPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetItemsPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsPage Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetItemsPage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetItemsPage"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsPage Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsPage>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetItemsPage instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetItemsPage, Mutable>(this);
    }
}
