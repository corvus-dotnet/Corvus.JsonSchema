...
public readonly partial struct GetItemsSort
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsSort instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsSort"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsSort(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsSort.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsSort Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsSort Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsSort>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetItemsSort instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetItemsSort, Mutable>(this);
    }
}
