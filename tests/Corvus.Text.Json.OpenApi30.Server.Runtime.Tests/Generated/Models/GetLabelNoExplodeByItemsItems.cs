...
public readonly partial struct GetLabelNoExplodeByItemsItems
#if NET8_0_OR_GREATER
    : IJsonElement<GetLabelNoExplodeByItemsItems>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetLabelNoExplodeByItemsItems"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetLabelNoExplodeByItemsItems(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetLabelNoExplodeByItemsItems DefaultInstance { get; }
    ...
    public CanonTests30.Server.Models.JsonString this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests30.Server.Models.JsonString>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests30.Server.Models.JsonString> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests30.Server.Models.JsonString>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetLabelNoExplodeByItemsItems left, in GetLabelNoExplodeByItemsItems right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetLabelNoExplodeByItemsItems left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetLabelNoExplodeByItemsItems instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetLabelNoExplodeByItemsItems(JsonElement instance)
    {
        return GetLabelNoExplodeByItemsItems.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetLabelNoExplodeByItemsItems From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetLabelNoExplodeByItemsItems ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetLabelNoExplodeByItemsItems>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetLabelNoExplodeByItemsItems ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetLabelNoExplodeByItemsItems>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetLabelNoExplodeByItemsItems ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetLabelNoExplodeByItemsItems>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetLabelNoExplodeByItemsItems ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetLabelNoExplodeByItemsItems>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetLabelNoExplodeByItemsItems? result)
    {
        return JsonElementHelpers.TryParseValue<GetLabelNoExplodeByItemsItems>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetLabelNoExplodeByItemsItems(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetLabelNoExplodeByItemsItems IJsonElement<GetLabelNoExplodeByItemsItems>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetLabelNoExplodeByItemsItems: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetLabelNoExplodeByItemsItems"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetLabelNoExplodeByItemsItems"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetLabelNoExplodeByItemsItems Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetLabelNoExplodeByItemsItems>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetLabelNoExplodeByItemsItems"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetLabelNoExplodeByItemsItems Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetLabelNoExplodeByItemsItems>(_idx);
        }
