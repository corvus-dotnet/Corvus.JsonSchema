...
public readonly partial struct GetMatrixNoExplodeByTagsOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetMatrixNoExplodeByTagsOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetMatrixNoExplodeByTagsOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetMatrixNoExplodeByTagsOk(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonInteger.Mutable Count
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out CanonTests30.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetMatrixNoExplodeByTagsOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCount(in CanonTests30.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetMatrixNoExplodeByTagsOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetMatrixNoExplodeByTagsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetMatrixNoExplodeByTagsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetMatrixNoExplodeByTagsOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetMatrixNoExplodeByTagsOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetMatrixNoExplodeByTagsOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetMatrixNoExplodeByTagsOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetMatrixNoExplodeByTagsOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.Models.GetMatrixNoExplodeByTagsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetMatrixNoExplodeByTagsOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.GetMatrixNoExplodeByTagsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetMatrixNoExplodeByTagsOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests30.Server.Models.JsonInteger.Source count = default)
        {
        ...
        /// Creates an instance of a <see cref="GetMatrixNoExplodeByTagsOk"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.JsonInteger.Source count = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonInteger.Source count = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonInteger.Source count = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetMatrixNoExplodeByTagsOk, Mutable>(this);
    }
}
