...
public readonly partial struct GetMatrixNoExplodeByTagsOk
    ...
    : IJsonElement<GetMatrixNoExplodeByTagsOk>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetMatrixNoExplodeByTagsOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetMatrixNoExplodeByTagsOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetMatrixNoExplodeByTagsOk DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests30.Server.Models.JsonInteger Count
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out CanonTests30.Server.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetMatrixNoExplodeByTagsOk left, in GetMatrixNoExplodeByTagsOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetMatrixNoExplodeByTagsOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetMatrixNoExplodeByTagsOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetMatrixNoExplodeByTagsOk(JsonElement instance)
    {
        return GetMatrixNoExplodeByTagsOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixNoExplodeByTagsOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixNoExplodeByTagsOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetMatrixNoExplodeByTagsOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixNoExplodeByTagsOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetMatrixNoExplodeByTagsOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixNoExplodeByTagsOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetMatrixNoExplodeByTagsOk>(json, options);
    }
    ...
    /// </exception>
    public static GetMatrixNoExplodeByTagsOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetMatrixNoExplodeByTagsOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetMatrixNoExplodeByTagsOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetMatrixNoExplodeByTagsOk>(ref reader, out result);
    }
...
#if NET
    static GetMatrixNoExplodeByTagsOk IJsonElement<GetMatrixNoExplodeByTagsOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetMatrixNoExplodeByTagsOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetMatrixNoExplodeByTagsOk Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetMatrixNoExplodeByTagsOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetMatrixNoExplodeByTagsOk>(_idx);
        }
