...
public readonly partial struct GetMatrixNoExplodeByTagsTags
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetMatrixNoExplodeByTagsTags instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetMatrixNoExplodeByTagsTags"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetMatrixNoExplodeByTagsTags(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetMatrixNoExplodeByTagsTags(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetMatrixNoExplodeByTagsTags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="GetMatrixNoExplodeByTagsTags"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetMatrixNoExplodeByTagsTags"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetMatrixNoExplodeByTagsTags Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetMatrixNoExplodeByTagsTags>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetMatrixNoExplodeByTagsTags"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetMatrixNoExplodeByTagsTags Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetMatrixNoExplodeByTagsTags>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.Models.GetMatrixNoExplodeByTagsTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetMatrixNoExplodeByTagsTags instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.GetMatrixNoExplodeByTagsTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetMatrixNoExplodeByTagsTags, Mutable>(this);
    }
}
