...
public readonly partial struct GetMatrixNoExplodeByTagsTags
    ...
    : IJsonElement<GetMatrixNoExplodeByTagsTags>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetMatrixNoExplodeByTagsTags"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetMatrixNoExplodeByTagsTags(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetMatrixNoExplodeByTagsTags DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetMatrixNoExplodeByTagsTags left, in GetMatrixNoExplodeByTagsTags right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetMatrixNoExplodeByTagsTags left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetMatrixNoExplodeByTagsTags instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetMatrixNoExplodeByTagsTags(JsonElement instance)
    {
        return GetMatrixNoExplodeByTagsTags.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixNoExplodeByTagsTags From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixNoExplodeByTagsTags ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetMatrixNoExplodeByTagsTags>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixNoExplodeByTagsTags ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetMatrixNoExplodeByTagsTags>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixNoExplodeByTagsTags ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetMatrixNoExplodeByTagsTags>(json, options);
    }
    ...
    /// </exception>
    public static GetMatrixNoExplodeByTagsTags ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetMatrixNoExplodeByTagsTags>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetMatrixNoExplodeByTagsTags? result)
    {
        return JsonElementHelpers.TryParseValue<GetMatrixNoExplodeByTagsTags>(ref reader, out result);
    }
...
#if NET
    static GetMatrixNoExplodeByTagsTags IJsonElement<GetMatrixNoExplodeByTagsTags>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetMatrixNoExplodeByTagsTags: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetMatrixNoExplodeByTagsTags Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetMatrixNoExplodeByTagsTags Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetMatrixNoExplodeByTagsTags>(_idx);
        }
