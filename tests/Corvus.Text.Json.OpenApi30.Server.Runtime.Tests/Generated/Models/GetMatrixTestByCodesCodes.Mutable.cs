...
public readonly partial struct GetMatrixTestByCodesCodes
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetMatrixTestByCodesCodes instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetMatrixTestByCodesCodes"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetMatrixTestByCodesCodes(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetMatrixTestByCodesCodes(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetMatrixTestByCodesCodes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="GetMatrixTestByCodesCodes"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetMatrixTestByCodesCodes"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetMatrixTestByCodesCodes Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetMatrixTestByCodesCodes>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetMatrixTestByCodesCodes"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetMatrixTestByCodesCodes Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetMatrixTestByCodesCodes>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.Models.GetMatrixTestByCodesCodes.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetMatrixTestByCodesCodes instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.GetMatrixTestByCodesCodes.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetMatrixTestByCodesCodes, Mutable>(this);
    }
}
