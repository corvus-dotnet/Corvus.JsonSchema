...
public readonly partial struct GetSearchOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetSearchOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetSearchOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetSearchOk(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonInteger.Mutable NextPage
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NextPageUtf8, out CanonTests30.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetSearchOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetNextPage(in CanonTests30.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetSearchOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="GetSearchOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetSearchOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetSearchOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetSearchOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetSearchOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.Models.GetSearchOk.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

        internal Source(in CanonTests30.Server.Models.JsonInteger.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        internal Source(CanonTests30.Server.Models.GetSearchOk.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.GetSearchOk.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

        internal Source(scoped in TContext context, CanonTests30.Server.Models.GetSearchOk.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
    ...
    public ref struct ObjectBuilder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests30.Server.Models.JsonInteger.Source nextPage = default)
        {
        ...
        /// Creates an instance of a <see cref="GetSearchOk"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.JsonInteger.Source nextPage = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonInteger.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonInteger.Source nextPage = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonInteger.Source nextPage = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetSearchOk, Mutable>(this);
    }
}
