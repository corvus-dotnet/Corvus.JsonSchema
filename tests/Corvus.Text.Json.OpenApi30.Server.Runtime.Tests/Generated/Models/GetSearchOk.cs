...
#endif
{
    ...
    /// </summary>
    public CanonTests30.Server.JsonInteger NextPage
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NextPageUtf8, out CanonTests30.Server.JsonInteger value))
            {
                return value;
            }
