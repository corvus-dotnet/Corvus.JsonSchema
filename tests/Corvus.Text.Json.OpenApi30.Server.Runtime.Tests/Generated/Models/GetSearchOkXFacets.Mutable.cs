...
public readonly partial struct GetSearchOkXFacets
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests30.Server.JsonString.Mutable Category
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CategoryUtf8, out CanonTests30.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests30.Server.JsonString.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out CanonTests30.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCategory(in CanonTests30.Server.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in CanonTests30.Server.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.GetSearchOkXFacets.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.GetSearchOkXFacets.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Server.JsonString.Source category = default,
            in CanonTests30.Server.JsonString.Source status = default)
        {
        ...
        /// Creates an instance of a <see cref="GetSearchOkXFacets"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.JsonString.Source category = default, in CanonTests30.Server.JsonString.Source status = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.JsonString.Source category = default, in CanonTests30.Server.JsonString.Source status = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
