...
public readonly partial struct GetSearchOkXFacets
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetSearchOkXFacets instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetSearchOkXFacets"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetSearchOkXFacets(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonString.Mutable Category
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CategoryUtf8, out CanonTests30.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonString.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out CanonTests30.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetSearchOkXFacets(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCategory(in CanonTests30.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in CanonTests30.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetSearchOkXFacets.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetSearchOkXFacets"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetSearchOkXFacets"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchOkXFacets Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetSearchOkXFacets>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetSearchOkXFacets"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchOkXFacets Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetSearchOkXFacets>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Server.Models.JsonString.Source _createArg1;
        private readonly CanonTests30.Server.Models.JsonString.Source _createArg2;
        ...
        internal Source(CanonTests30.Server.Models.GetSearchOkXFacets.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.GetSearchOkXFacets.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Server.Models.JsonString.Source category = default,
            in CanonTests30.Server.Models.JsonString.Source status = default)
        {
        ...
        /// Creates an instance of a <see cref="GetSearchOkXFacets"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.JsonString.Source category = default, in CanonTests30.Server.Models.JsonString.Source status = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonString.Source category = default, in CanonTests30.Server.Models.JsonString.Source status = default)
    {
        return new Source(category, status);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonString.Source category = default, in CanonTests30.Server.Models.JsonString.Source status = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(category, status);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<GetSearchOkXFacets, Mutable>(this);
    }
}
