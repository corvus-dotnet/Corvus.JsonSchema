...
public readonly partial struct GetSearchTags
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.GetSearchTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.GetSearchTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
