...
public readonly partial struct GetStyledObjectByObjObj
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonInteger.Mutable Size
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SizeUtf8, out CanonTests30.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSize(in CanonTests30.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.Models.GetStyledObjectByObjObj.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.JsonInteger.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.GetStyledObjectByObjObj.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Server.Models.JsonInteger.Source size = default)
        {
        ...
        /// Creates an instance of a <see cref="GetStyledObjectByObjObj"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.JsonString.Source color = default, in CanonTests30.Server.Models.JsonInteger.Source size = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonString.Source color = default, in CanonTests30.Server.Models.JsonInteger.Source size = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonString.Source color = default, in CanonTests30.Server.Models.JsonInteger.Source size = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
