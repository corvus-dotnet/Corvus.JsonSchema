...
public readonly partial struct GetStyledObjectByObjObj
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests30.Server.JsonInteger.Mutable Size
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SizeUtf8, out CanonTests30.Server.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSize(in CanonTests30.Server.JsonInteger.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.GetStyledObjectByObjObj.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.GetStyledObjectByObjObj.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Server.JsonInteger.Source size = default)
        {
        ...
        /// Creates an instance of a <see cref="GetStyledObjectByObjObj"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.JsonString.Source color = default, in CanonTests30.Server.JsonInteger.Source size = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.JsonString.Source color = default, in CanonTests30.Server.JsonInteger.Source size = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
