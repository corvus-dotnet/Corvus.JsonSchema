...
#endif
{
    ...
    /// </summary>
    public CanonTests30.Server.Models.JsonString Color
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ColorUtf8, out CanonTests30.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests30.Server.Models.JsonInteger Size
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SizeUtf8, out CanonTests30.Server.Models.JsonInteger value))
            {
                return value;
            }
