...
public readonly partial struct GetStyledObjectByObjOk
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonBoolean.Mutable Found
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FoundUtf8, out CanonTests30.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        public void SetFound(in CanonTests30.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.Models.GetStyledObjectByObjOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.GetStyledObjectByObjOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests30.Server.Models.JsonBoolean.Source found = default)
        {
        ...
        /// Creates an instance of a <see cref="GetStyledObjectByObjOk"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.JsonBoolean.Source found = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonBoolean.Source found = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonBoolean.Source found = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
