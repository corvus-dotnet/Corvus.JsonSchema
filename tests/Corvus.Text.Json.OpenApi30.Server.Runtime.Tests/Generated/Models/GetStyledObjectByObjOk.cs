...
#endif
{
    ...
    /// </summary>
    public CanonTests30.Server.JsonBoolean Found
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FoundUtf8, out CanonTests30.Server.JsonBoolean value))
            {
                return value;
            }
