...
public readonly partial struct ItemEntity
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ItemEntity instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ItemEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ItemEntity(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonBoolean.Mutable Active
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActiveUtf8, out CanonTests30.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests30.Server.Models.JsonInt64.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out CanonTests30.Server.Models.JsonInt64.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ItemEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetActive(in CanonTests30.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ActiveUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActiveUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Active, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>active</c> property, if present.
        /// </summary>
        ...
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ActiveUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetId(in CanonTests30.Server.Models.JsonInt64.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ItemEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ItemEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ItemEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ItemEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ItemEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ItemEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ItemEntity Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ItemEntity>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Server.Models.JsonInt64.Source _createArg1;
        private readonly CanonTests30.Server.Models.JsonString.Source _createArg2;
        private readonly CanonTests30.Server.Models.JsonBoolean.Source _createArg3;
        ...
        internal Source(CanonTests30.Server.Models.ItemEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Server.Models.JsonInt64.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2, in CanonTests30.Server.Models.JsonBoolean.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(ItemEntity instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.ItemEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ItemEntity"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests30.Server.Models.JsonInt64.Source id,
            in CanonTests30.Server.Models.JsonString.Source name,
            in CanonTests30.Server.Models.JsonBoolean.Source active = default)
        {
        ...
        public void Create(
            ...
            in CanonTests30.Server.Models.JsonBoolean.Source active = default)
        {
            Create(ref _builder, id, name, active);
        }
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonInt64.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2, in CanonTests30.Server.Models.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonInt64.Source id, in CanonTests30.Server.Models.JsonString.Source name, in CanonTests30.Server.Models.JsonBoolean.Source active = default)
    {
        return new Source(id, name, active);
    }
    ...
    /// <param name="active">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonInt64.Source id, in CanonTests30.Server.Models.JsonString.Source name, in CanonTests30.Server.Models.JsonBoolean.Source active = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(id, name, active);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ItemEntity, Mutable>(this);
    }
}
