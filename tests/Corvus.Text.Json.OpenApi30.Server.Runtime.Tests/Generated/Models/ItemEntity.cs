...
#endif
{
    ...
    /// </summary>
    public CanonTests30.Server.JsonBoolean Active
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActiveUtf8, out CanonTests30.Server.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests30.Server.JsonInt64 Id
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out CanonTests30.Server.JsonInt64 value))
            {
                return value;
            }
