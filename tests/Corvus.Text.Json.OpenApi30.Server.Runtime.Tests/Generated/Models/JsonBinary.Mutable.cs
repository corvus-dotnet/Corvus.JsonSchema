...
public readonly partial struct JsonBinary
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonBinary instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonBinary"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonBinary(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonBinary.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonBinary Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonBinary Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonBinary>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonBinary instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonBinary, Mutable>(this);
    }
}
