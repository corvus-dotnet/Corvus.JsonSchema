...
public readonly partial struct JsonDouble
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonDouble instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonDouble"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonDouble(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonDouble.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonDouble Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonDouble Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonDouble>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private Source(double value) { SimpleTypesBacking.Initialize(ref _simpleTypeBacking, value, static (v, buffer, out written) => Utf8Formatter.TryFormat(v, buffer, out written)); _kind = Kind.NumericSimpleType; }

        public static implicit operator Source(JsonDouble instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonDouble, Mutable>(this);
    }
}
