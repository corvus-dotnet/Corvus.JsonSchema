...
public readonly partial struct PostAttachmentsBody
    : IJsonElement<PostAttachmentsBody>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchFile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            CanonTests30.Server.Models.JsonBinary.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1attachments/post/requestBody/content/multipart~1form-data/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1attachments/post/requestBody/content/multipart~1form-data/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1attachments/post/requestBody/content/multipart~1form-data/schema"u8;
