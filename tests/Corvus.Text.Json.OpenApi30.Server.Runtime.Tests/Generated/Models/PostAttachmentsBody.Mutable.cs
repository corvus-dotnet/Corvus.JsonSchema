...
public readonly partial struct PostAttachmentsBody
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.PostAttachmentsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.PostAttachmentsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// Creates an instance of a <see cref="PostAttachmentsBody"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.JsonBinary.Source file, in CanonTests30.Server.JsonString.Source description = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.JsonBinary.Source file, in CanonTests30.Server.JsonString.Source description = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
