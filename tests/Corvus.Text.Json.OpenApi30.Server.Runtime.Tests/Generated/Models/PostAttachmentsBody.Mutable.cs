...
public readonly partial struct PostAttachmentsBody
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.Models.PostAttachmentsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Server.Models.JsonBinary.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.PostAttachmentsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// Creates an instance of a <see cref="PostAttachmentsBody"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.JsonBinary.Source file, in CanonTests30.Server.Models.JsonString.Source description = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonBinary.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonBinary.Source file, in CanonTests30.Server.Models.JsonString.Source description = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonBinary.Source file, in CanonTests30.Server.Models.JsonString.Source description = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
