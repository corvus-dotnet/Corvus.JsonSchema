...
public readonly partial struct PostAttachmentsEncodedBody
{
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Server.Models.JsonBinary.Source _createArg1;
        private readonly CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source _createArg2;
        ...
        internal Source(in CanonTests30.Server.Models.JsonBinary.Source arg1, in CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        private readonly CanonTests30.Server.Models.JsonBinary.Source _createArg1;
        private readonly CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> _createArg2;
        ...
        internal Source(scoped in TContext context, in CanonTests30.Server.Models.JsonBinary.Source arg1, in CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonBinary.Source arg1, in CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests30.Server.Models.JsonBinary.Source arg1, in CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonBinary.Source file, in CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source metadata = default)
    {
    ...
    /// <param name="metadata">The value of the <c>"metadata"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests30.Server.Models.JsonBinary.Source file, in CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> metadata = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
