...
#endif
{
    ...
    /// </summary>
    public CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity Metadata
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests30.Server.Models.PostAttachmentsEncodedBody.MetadataEntity value))
            {
                return value;
            }
