...
public readonly partial struct PostFeedbackBody
    : IJsonElement<PostFeedbackBody>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRatingPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("rating"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRatingNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("rating"u8, buffer, out written);

        private const int RequiredOffsetForRating = 0;
        private const uint RequiredBitForRating = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForRating;
        ...
        private static readonly JsonSchemaPathProvider RatingSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/rating"u8, buffer, out written);

        private static void MatchComment(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
        ...
        private static void MatchRating(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                CanonTests30.Server.Models.JsonInteger.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.RatingUtf8,
                    evaluationPath: RatingSchemaEvaluationPath);

            CanonTests30.Server.Models.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            requiredBitBuffer[RequiredOffsetForRating] |= RequiredBitForRating;
        }
        ...
        private static PropertySchemaMatchers<CanonTests30.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<CanonTests30.Server.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.RatingUtf8, MatchRating),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1feedback/post/requestBody/content/application~1x-www-form-urlencoded/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1feedback/post/requestBody/content/application~1x-www-form-urlencoded/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1feedback/post/requestBody/content/application~1x-www-form-urlencoded/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRatingPresent, "rating"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForRating] & RequiredBitForRating) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyRatingNotPresent, "rating"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRatingPresent, "rating"u8, "required"u8);
