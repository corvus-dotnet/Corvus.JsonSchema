...
public readonly partial struct PostFeedbackEncodedBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonString.Mutable Comment
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CommentUtf8, out CanonTests30.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetComment(in CanonTests30.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source _createArg1;
        ...
        internal Source(CanonTests30.Server.Models.PostFeedbackEncodedBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        private readonly CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> _createArg1;
        private readonly CanonTests30.Server.Models.JsonString.Source _createArg2;
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.PostFeedbackEncodedBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> arg1, in CanonTests30.Server.Models.JsonString.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source tags,
            in CanonTests30.Server.Models.JsonString.Source comment = default)
        {
        ...
        /// Creates an instance of a <see cref="PostFeedbackEncodedBody"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source tags, in CanonTests30.Server.Models.JsonString.Source comment = default)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> tags,
            in CanonTests30.Server.Models.JsonString.Source comment = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> arg1, in CanonTests30.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <param name="comment">The value of the <c>"comment"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source tags, in CanonTests30.Server.Models.JsonString.Source comment = default)
    {
        return new Source(tags, comment);
    }
    ...
    /// <param name="comment">The value of the <c>"comment"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> tags, in CanonTests30.Server.Models.JsonString.Source comment = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, tags, comment);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source tags, in CanonTests30.Server.Models.JsonString.Source comment = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests30.Server.Models.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> tags, in CanonTests30.Server.Models.JsonString.Source comment = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
