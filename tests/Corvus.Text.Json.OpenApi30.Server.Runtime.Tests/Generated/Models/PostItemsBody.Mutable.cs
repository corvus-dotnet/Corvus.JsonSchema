...
public readonly partial struct PostItemsBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Mutable Metadata
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMetadata(in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMetadata<TContext>(in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source _createArg2;
        ...
        internal Source(CanonTests30.Server.Models.PostItemsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source arg2, in CanonTests30.Server.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly CanonTests30.Server.Models.JsonString.Source _createArg1;
        private readonly CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> _createArg2;
        private readonly CanonTests30.Server.Models.JsonString.Source _createArg3;
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.PostItemsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> arg2, in CanonTests30.Server.Models.JsonString.Source arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source metadata = default,
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in CanonTests30.Server.Models.JsonString.Source name,
            in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> metadata = default,
            in CanonTests30.Server.Models.JsonString.Source tag = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, name, metadata, tag);
        }
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source arg2, in CanonTests30.Server.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> arg2, in CanonTests30.Server.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonString.Source name, in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source metadata = default, in CanonTests30.Server.Models.JsonString.Source tag = default)
    {
        return new Source(name, metadata, tag);
    }
    ...
    /// <param name="tag">The value of the <c>"tag"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests30.Server.Models.JsonString.Source name, in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests30.Server.Models.JsonString.Source tag = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, name, metadata, tag);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonString.Source name, in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source metadata = default, in CanonTests30.Server.Models.JsonString.Source tag = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(name, metadata, tag);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests30.Server.Models.JsonString.Source name, in CanonTests30.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests30.Server.Models.JsonString.Source tag = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, name, metadata, tag);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
