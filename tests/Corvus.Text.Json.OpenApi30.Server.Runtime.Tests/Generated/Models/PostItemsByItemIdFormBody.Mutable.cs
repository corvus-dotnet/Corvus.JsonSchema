...
public readonly partial struct PostItemsByItemIdFormBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostItemsByItemIdFormBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostItemsByItemIdFormBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostItemsByItemIdFormBody(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Mutable Metadata
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMetadata(in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMetadata<TContext>(in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostItemsByItemIdFormBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostItemsByItemIdFormBody Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostItemsByItemIdFormBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostItemsByItemIdFormBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source _createArg1;
        private readonly CanonTests30.Server.Models.JsonString.Source _createArg2;
        private readonly CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source _createArg3;
        ...
        internal Source(CanonTests30.Server.Models.PostItemsByItemIdFormBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(PostItemsByItemIdFormBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source<TContext> _createArg1;
        private readonly CanonTests30.Server.Models.JsonString.Source _createArg2;
        private readonly CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source<TContext> _createArg3;
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.PostItemsByItemIdFormBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source<TContext> arg1, in CanonTests30.Server.Models.JsonString.Source arg2, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source<TContext> arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostItemsByItemIdFormBody"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source metadata = default,
            in CanonTests30.Server.Models.JsonString.Source name = default,
            in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source tags = default)
        {
        ...
        public void Create(
            ...
            in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source tags = default)
        {
            Create(ref _builder, metadata, name, tags);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source<TContext> metadata = default,
            in CanonTests30.Server.Models.JsonString.Source name = default,
            in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, metadata, name, tags);
        }
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source<TContext> arg1, in CanonTests30.Server.Models.JsonString.Source arg2, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source metadata = default, in CanonTests30.Server.Models.JsonString.Source name = default, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source tags = default)
    {
        return new Source(metadata, name, tags);
    }
    ...
    /// <param name="tags">The value of the <c>"tags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests30.Server.Models.JsonString.Source name = default, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, metadata, name, tags);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source metadata = default, in CanonTests30.Server.Models.JsonString.Source name = default, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(metadata, name, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests30.Server.Models.JsonString.Source name = default, in CanonTests30.Server.Models.PostItemsByItemIdFormBody.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, metadata, name, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostItemsByItemIdFormBody, Mutable>(this);
    }
}
