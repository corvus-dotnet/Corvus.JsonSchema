...
public readonly partial struct PostItemsByItemIdUploadBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests30.Server.JsonString.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out CanonTests30.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDescription(in CanonTests30.Server.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests30.Server.PostItemsByItemIdUploadBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.PostItemsByItemIdUploadBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests30.Server.JsonString.Source description = default,
            in CanonTests30.Server.JsonBinary.Source file = default)
        {
        ...
        /// Creates an instance of a <see cref="PostItemsByItemIdUploadBody"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.JsonString.Source description = default, in CanonTests30.Server.JsonBinary.Source file = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.JsonString.Source description = default, in CanonTests30.Server.JsonBinary.Source file = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
