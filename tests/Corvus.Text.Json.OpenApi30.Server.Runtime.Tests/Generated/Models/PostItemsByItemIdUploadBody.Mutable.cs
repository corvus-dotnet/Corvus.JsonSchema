...
public readonly partial struct PostItemsByItemIdUploadBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostItemsByItemIdUploadBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostItemsByItemIdUploadBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostItemsByItemIdUploadBody(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonString.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out CanonTests30.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostItemsByItemIdUploadBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDescription(in CanonTests30.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostItemsByItemIdUploadBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostItemsByItemIdUploadBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostItemsByItemIdUploadBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostItemsByItemIdUploadBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostItemsByItemIdUploadBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostItemsByItemIdUploadBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostItemsByItemIdUploadBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostItemsByItemIdUploadBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Server.Models.JsonBinary.Source _createArg2;
        ...
        internal Source(CanonTests30.Server.Models.PostItemsByItemIdUploadBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.JsonBinary.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(PostItemsByItemIdUploadBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.PostItemsByItemIdUploadBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostItemsByItemIdUploadBody"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests30.Server.Models.JsonString.Source description = default,
            in CanonTests30.Server.Models.JsonBinary.Source file = default)
        {
        ...
        /// Creates an instance of a <see cref="PostItemsByItemIdUploadBody"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.JsonString.Source description = default, in CanonTests30.Server.Models.JsonBinary.Source file = default)
        {
            Create(ref _builder, description, file);
        }
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.JsonBinary.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonString.Source description = default, in CanonTests30.Server.Models.JsonBinary.Source file = default)
    {
        return new Source(description, file);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonString.Source description = default, in CanonTests30.Server.Models.JsonBinary.Source file = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(description, file);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostItemsByItemIdUploadBody, Mutable>(this);
    }
}
