...
public readonly partial struct PostSearchBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostSearchBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostSearchBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostSearchBody(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonInteger.Mutable Limit
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LimitUtf8, out CanonTests30.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests30.Server.Models.JsonString.Mutable Query
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QueryUtf8, out CanonTests30.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostSearchBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetLimit(in CanonTests30.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetQuery(in CanonTests30.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostSearchBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostSearchBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostSearchBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostSearchBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostSearchBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostSearchBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostSearchBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostSearchBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Server.Models.JsonInteger.Source _createArg1;
        ...
        internal Source(CanonTests30.Server.Models.PostSearchBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests30.Server.Models.JsonInteger.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(PostSearchBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests30.Server.Models.PostSearchBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostSearchBody"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests30.Server.Models.JsonInteger.Source limit = default,
            in CanonTests30.Server.Models.JsonString.Source query = default)
        {
        ...
        /// Creates an instance of a <see cref="PostSearchBody"/>.
        /// </summary>
        public void Create(in CanonTests30.Server.Models.JsonInteger.Source limit = default, in CanonTests30.Server.Models.JsonString.Source query = default)
        {
            Create(ref _builder, limit, query);
        }
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonInteger.Source arg1, in CanonTests30.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonInteger.Source limit = default, in CanonTests30.Server.Models.JsonString.Source query = default)
    {
        return new Source(limit, query);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests30.Server.Models.JsonInteger.Source limit = default, in CanonTests30.Server.Models.JsonString.Source query = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(limit, query);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostSearchBody, Mutable>(this);
    }
}
