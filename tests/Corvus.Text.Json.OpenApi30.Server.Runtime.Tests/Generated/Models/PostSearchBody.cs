...
#endif
{
    ...
    /// </summary>
    public CanonTests30.Server.JsonInteger Limit
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LimitUtf8, out CanonTests30.Server.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests30.Server.JsonString Query
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QueryUtf8, out CanonTests30.Server.JsonString value))
            {
                return value;
            }
