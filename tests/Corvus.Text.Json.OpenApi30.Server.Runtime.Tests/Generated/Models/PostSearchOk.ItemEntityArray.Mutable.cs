...
public readonly partial struct PostSearchOk
{
    ...
    public readonly partial struct ItemEntityArray
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(CanonTests30.Server.PostSearchOk.ItemEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests30.Server.PostSearchOk.ItemEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
