...
public readonly partial struct PostSearchOk
{
...
#endif
    {
        ...
        public CanonTests30.Server.ItemEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests30.Server.ItemEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests30.Server.ItemEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests30.Server.ItemEntity>(_parent, _idx);
        }
