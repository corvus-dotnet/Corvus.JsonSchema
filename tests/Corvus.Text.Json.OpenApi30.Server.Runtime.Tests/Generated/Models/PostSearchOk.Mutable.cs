...
public readonly partial struct PostSearchOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostSearchOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostSearchOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostSearchOk(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostSearchOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostSearchOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostSearchOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostSearchOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests30.Server.Models.PostSearchOk.ItemEntityArray.Source _createArg2;
        ...
        internal Source(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.PostSearchOk.ItemEntityArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        private readonly CanonTests30.Server.Models.JsonString.Source _createArg1;
        private readonly CanonTests30.Server.Models.PostSearchOk.ItemEntityArray.Source<TContext> _createArg2;
        ...
        internal Source(scoped in TContext context, in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.PostSearchOk.ItemEntityArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        #endif
        {
            Create(context, ref _builder, id, results);
        }
        ...
        internal static void BuildCreateValue(in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.PostSearchOk.ItemEntityArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests30.Server.Models.JsonString.Source arg1, in CanonTests30.Server.Models.PostSearchOk.ItemEntityArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests30.Server.Models.JsonString.Source id = default, in CanonTests30.Server.Models.PostSearchOk.ItemEntityArray.Source results = default)
    {
        return new Source(id, results);
    }
    ...
    /// <param name="results">The value of the <c>"results"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests30.Server.Models.JsonString.Source id = default, in CanonTests30.Server.Models.PostSearchOk.ItemEntityArray.Source<TContext> results = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, id, results);
    }
    ...
    {
        return workspace.CreateBuilder<PostSearchOk, Mutable>(this);
    }
}
