...
public readonly struct SearchItemsResult
{
    ...
    public static SearchItemsResult Ok(CanonTests30.Server.GetSearchOk.Source body, JsonWorkspace workspace, CanonTests30.Server.GetSearchOkXFacets xFacets = default) => new(200, CanonTests30.Server.GetSearchOk.CreateBuilder(workspace, body, 0).RootElement, "application/json", xFacets: xFacets);
