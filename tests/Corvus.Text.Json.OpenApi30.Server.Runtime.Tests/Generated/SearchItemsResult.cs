...
{
    private SearchItemsResult(int statusCode, JsonElement body, string? contentType, CanonTests30.Server.Models.GetSearchOkXFacets xFacets = default)
    {
    ...
    /// </summary>
    public CanonTests30.Server.Models.GetSearchOkXFacets XFacets { get; }
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => CanonTests30.Server.Models.GetSearchOk.From(this.Body).EvaluateSchema(),
            _ => true,
        };
    }
