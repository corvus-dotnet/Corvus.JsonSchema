...
{
    private SearchItemsResult(int statusCode, JsonElement body, string? contentType, CanonTests30.Server.GetSearchOkXFacets xFacets = default)
    {
    ...
    /// </summary>
    public CanonTests30.Server.GetSearchOkXFacets XFacets { get; }
    ...
    public static SearchItemsResult Ok(CanonTests30.Server.GetSearchOk.Source body, JsonWorkspace workspace, CanonTests30.Server.GetSearchOkXFacets xFacets = default) => new(200, CanonTests30.Server.GetSearchOk.CreateBuilder(workspace, body, 30).RootElement, "application/json", xFacets: xFacets);
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => CanonTests30.Server.GetSearchOk.From(this.Body).EvaluateSchema(),
            _ => true,
        };
    }
