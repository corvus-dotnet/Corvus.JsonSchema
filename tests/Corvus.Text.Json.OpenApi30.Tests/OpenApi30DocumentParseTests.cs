// <copyright file="OpenApi30DocumentParseTests.cs" company="Endjin Limited">
...
namespace Corvus.Text.Json.OpenApi30.Tests;

/// <summary>
/// Tests for parsing OpenAPI 3.0 documents into V5 generated types.
/// </summary>
[TestClass]
public class OpenApi30DocumentParseTests
{
    private static readonly Lazy<byte[]> PetstoreBytes = new(
        () => File.ReadAllBytes(Path.Combine(AppContext.BaseDirectory, "TestData", "petstore-3.0.json")));
    ...
    public void PetstoreOpenapiVersion()
    {
        ...
        Assert.AreEqual("3.0.3", (string)api.Openapi);
    }
    ...
    public void PetstoreRoundTrip()
    {
        ...
        Assert.AreEqual("3.0.3", (string)api2.Openapi);
