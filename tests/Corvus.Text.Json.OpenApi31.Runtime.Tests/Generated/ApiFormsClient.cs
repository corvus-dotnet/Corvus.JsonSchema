...
public sealed class ApiFormsClient : IApiFormsClient
{
    ...
    public ValueTask<SubmitContactFormResponse> SubmitContactFormAsync(CanonTests31.Client.PostFormsContactBody.Source body, CancellationToken cancellationToken = default, ValidationMode validationMode = ValidationMode.Basic, ValidationMode responseValidationMode = ValidationMode.None)
    {
        ...
        CanonTests31.Client.PostFormsContactBody bodyValue = CanonTests31.Client.PostFormsContactBody.CreateBuilder(workspace, body, 0).RootElement;
    ...
    {
        JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
        CanonTests31.Client.PostFormsUploadBody bodyValue = CanonTests31.Client.PostFormsUploadBody.CreateBuilder(workspace, body, 0).RootElement;
    ...
    {
        JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
        CanonTests31.Client.PostFormsEncodedContactBody bodyValue = CanonTests31.Client.PostFormsEncodedContactBody.CreateBuilder(workspace, body, 0).RootElement;
    ...
    {
        JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
        CanonTests31.Client.PostFormsEncodedUploadBody bodyValue = CanonTests31.Client.PostFormsEncodedUploadBody.CreateBuilder(workspace, body, 0).RootElement;
