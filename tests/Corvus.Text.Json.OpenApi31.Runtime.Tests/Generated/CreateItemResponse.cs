...
public struct CreateItemResponse : IApiResponse<CreateItemResponse>
{
    ...
    internal CanonTests31.Client.PostItemsBody sourceBody;
    ...
    /// </summary>
    public CanonTests31.Client.PostItemsCreated CreatedBody { get; private set; }

    /// <summary>
    /// Gets the 422 response body.
    /// </summary>
    public CanonTests31.Client.PostItemsUnprocessableEntity UnprocessableEntityBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<CanonTests31.Client.PostItemsCreated>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
        ...
        if (statusCode == 422)
        {
            var unprocessableEntityDoc = await ParsedJsonDocument<CanonTests31.Client.PostItemsUnprocessableEntity>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out CanonTests31.Client.PostItemsCreated result)
    {
    ...
    public bool TryGetUnprocessableEntity(out CanonTests31.Client.PostItemsUnprocessableEntity result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.PostItemsCreated, TResult> matchCreated,
        ResponseMatcher<CanonTests31.Client.PostItemsUnprocessableEntity, TResult> matchUnprocessableEntity,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.PostItemsCreated, TContext, TResult> matchCreated,
        ResponseMatcher<CanonTests31.Client.PostItemsUnprocessableEntity, TContext, TResult> matchUnprocessableEntity,
    ...
    public readonly struct CreateItemResponseLinksAccessor
    {
        ...
        /// </summary>
        public ValueTask<GetItemResponse> GetCreatedItemAsync(CanonTests31.Client.JsonString.Source filter = default, CanonTests31.Client.JsonInt32.Source limit = default, CanonTests31.Client.JsonBoolean.Source verbose = default, CanonTests31.Client.JsonString.Source xRequestId = default, CancellationToken cancellationToken = default)
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            GetItemRequest request = new()
            {
                ItemId = CanonTests31.Client.JsonString.From(this.response.CreatedBody.Id),
        ...
        /// </summary>
        public ValueTask<SearchResponse> SearchByNameAsync(CanonTests31.Client.JsonInt32.Source page = default, CanonTests31.Client.JsonSingle.Source rating = default, CancellationToken cancellationToken = default)
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            SearchRequest request = new()
            {
                Q = CanonTests31.Client.JsonString.From(this.response.sourceBody.Name),
