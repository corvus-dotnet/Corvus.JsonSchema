...
public struct DeleteItemResponse : IApiResponse<DeleteItemResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.DeleteItemsByItemIdNotFound NotFoundBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests31.Client.Models.DeleteItemsByItemIdNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetNotFound(out CanonTests31.Client.Models.DeleteItemsByItemIdNotFound result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.Models.DeleteItemsByItemIdNotFound, TResult> matchNotFound,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.Models.DeleteItemsByItemIdNotFound, TContext, TResult> matchNotFound,
