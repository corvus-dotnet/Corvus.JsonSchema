...
/// <summary>
/// Response type for the DownloadMixed operation.
/// </summary>
public struct DownloadMixedResponse : IApiResponse<DownloadMixedResponse>
{
    ...
    {
        DownloadMixedResponse response = default;
