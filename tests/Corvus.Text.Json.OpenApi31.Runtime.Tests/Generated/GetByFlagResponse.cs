...
/// <summary>
/// Response type for the GetByFlag operation.
/// </summary>
public struct GetByFlagResponse : IApiResponse<GetByFlagResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetByFlagResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetByFlagResponse response = default;
