...
public struct GetOrderResponse : IApiResponse<GetOrderResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.GetOrdersByOrderIdOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.Models.GetOrdersByOrderIdOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.Models.GetOrdersByOrderIdOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.Models.GetOrdersByOrderIdOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.Models.GetOrdersByOrderIdOk, TContext, TResult> matchOk,
