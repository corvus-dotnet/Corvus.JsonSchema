...
/// <summary>
/// Response type for the GetSessionProfile operation.
/// </summary>
public struct GetSessionProfileResponse : IApiResponse<GetSessionProfileResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<GetSessionProfileResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetSessionProfileResponse response = default;
