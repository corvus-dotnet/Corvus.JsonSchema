...
/// <summary>
/// Response type for the GetVendorJson operation.
/// </summary>
public struct GetVendorJsonResponse : IApiResponse<GetVendorJsonResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.GetFilesVendorJsonOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<GetVendorJsonResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetVendorJsonResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.Models.GetFilesVendorJsonOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.Models.GetFilesVendorJsonOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.Models.GetFilesVendorJsonOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.Models.GetFilesVendorJsonOk, TContext, TResult> matchOk,
