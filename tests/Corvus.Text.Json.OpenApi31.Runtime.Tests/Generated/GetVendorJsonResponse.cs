...
public struct GetVendorJsonResponse : IApiResponse<GetVendorJsonResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.GetFilesVendorJsonOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.GetFilesVendorJsonOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.GetFilesVendorJsonOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.GetFilesVendorJsonOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.GetFilesVendorJsonOk, TContext, TResult> matchOk,
