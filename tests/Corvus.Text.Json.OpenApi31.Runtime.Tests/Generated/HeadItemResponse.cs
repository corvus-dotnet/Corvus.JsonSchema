...
/// <summary>
/// Response type for the HeadItem operation.
/// </summary>
public struct HeadItemResponse : IApiResponse<HeadItemResponse>
{
    ...
    /// <inheritdoc/>
    public static ValueTask<HeadItemResponse> CreateAsync(
        int statusCode,
    ...
    {
        HeadItemResponse response = default;
