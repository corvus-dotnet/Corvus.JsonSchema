...
/// <summary>
/// Response type for the HeaderArray operation.
/// </summary>
public struct HeaderArrayResponse : IApiResponse<HeaderArrayResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<HeaderArrayResponse> CreateAsync(
        int statusCode,
    ...
    {
        HeaderArrayResponse response = default;
