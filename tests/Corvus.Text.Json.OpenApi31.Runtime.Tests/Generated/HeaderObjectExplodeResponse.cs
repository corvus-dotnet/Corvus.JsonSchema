...
/// <summary>
/// Response type for the HeaderObjectExplode operation.
/// </summary>
public struct HeaderObjectExplodeResponse : IApiResponse<HeaderObjectExplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<HeaderObjectExplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        HeaderObjectExplodeResponse response = default;
