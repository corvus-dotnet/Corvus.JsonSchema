...
public readonly partial struct DeleteItemsByItemIdNotFound
    ...
    : IJsonElement<DeleteItemsByItemIdNotFound>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DeleteItemsByItemIdNotFound"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal DeleteItemsByItemIdNotFound(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static DeleteItemsByItemIdNotFound DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.Models.JsonInt32 Code
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out CanonTests31.Client.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.Models.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out CanonTests31.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in DeleteItemsByItemIdNotFound left, in DeleteItemsByItemIdNotFound right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in DeleteItemsByItemIdNotFound left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(DeleteItemsByItemIdNotFound instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator DeleteItemsByItemIdNotFound(JsonElement instance)
    {
        return DeleteItemsByItemIdNotFound.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeleteItemsByItemIdNotFound From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeleteItemsByItemIdNotFound ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeleteItemsByItemIdNotFound>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeleteItemsByItemIdNotFound ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeleteItemsByItemIdNotFound>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DeleteItemsByItemIdNotFound ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeleteItemsByItemIdNotFound>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static DeleteItemsByItemIdNotFound ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<DeleteItemsByItemIdNotFound>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out DeleteItemsByItemIdNotFound? result)
    {
        return JsonElementHelpers.TryParseValue<DeleteItemsByItemIdNotFound>(ref reader, out result);
    }
...
#if NET
    static DeleteItemsByItemIdNotFound IJsonElement<DeleteItemsByItemIdNotFound>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"DeleteItemsByItemIdNotFound: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public DeleteItemsByItemIdNotFound Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public DeleteItemsByItemIdNotFound Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<DeleteItemsByItemIdNotFound>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Code"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Code => [0x65, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x64, 0x65, 0x22];
