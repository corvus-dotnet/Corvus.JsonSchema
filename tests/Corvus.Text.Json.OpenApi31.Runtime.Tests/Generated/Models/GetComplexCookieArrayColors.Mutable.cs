...
public readonly partial struct GetComplexCookieArrayColors
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexCookieArrayColors instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexCookieArrayColors"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexCookieArrayColors(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexCookieArrayColors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexCookieArrayColors Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexCookieArrayColors Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexCookieArrayColors>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.Models.GetComplexCookieArrayColors.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexCookieArrayColors instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.GetComplexCookieArrayColors.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexCookieArrayColors, Mutable>(this);
    }
}
