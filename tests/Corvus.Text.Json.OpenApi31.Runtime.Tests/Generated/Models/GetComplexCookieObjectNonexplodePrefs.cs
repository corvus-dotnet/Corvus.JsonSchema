...
public readonly partial struct GetComplexCookieObjectNonexplodePrefs
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexCookieObjectNonexplodePrefs>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexCookieObjectNonexplodePrefs"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexCookieObjectNonexplodePrefs(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexCookieObjectNonexplodePrefs DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexCookieObjectNonexplodePrefs left, in GetComplexCookieObjectNonexplodePrefs right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexCookieObjectNonexplodePrefs left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexCookieObjectNonexplodePrefs instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexCookieObjectNonexplodePrefs(JsonElement instance)
    {
        return GetComplexCookieObjectNonexplodePrefs.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexCookieObjectNonexplodePrefs From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexCookieObjectNonexplodePrefs ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexCookieObjectNonexplodePrefs>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexCookieObjectNonexplodePrefs ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexCookieObjectNonexplodePrefs>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexCookieObjectNonexplodePrefs ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexCookieObjectNonexplodePrefs>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetComplexCookieObjectNonexplodePrefs ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexCookieObjectNonexplodePrefs>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexCookieObjectNonexplodePrefs? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexCookieObjectNonexplodePrefs>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexCookieObjectNonexplodePrefs(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexCookieObjectNonexplodePrefs IJsonElement<GetComplexCookieObjectNonexplodePrefs>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexCookieObjectNonexplodePrefs: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexCookieObjectNonexplodePrefs"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexCookieObjectNonexplodePrefs"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexCookieObjectNonexplodePrefs Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexCookieObjectNonexplodePrefs>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexCookieObjectNonexplodePrefs"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexCookieObjectNonexplodePrefs Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexCookieObjectNonexplodePrefs>(_idx);
        }
