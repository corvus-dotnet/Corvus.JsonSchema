...
public readonly partial struct GetComplexHeaderArrayXTags
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexHeaderArrayXTags instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexHeaderArrayXTags"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexHeaderArrayXTags(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexHeaderArrayXTags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexHeaderArrayXTags Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexHeaderArrayXTags Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexHeaderArrayXTags>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.Models.GetComplexHeaderArrayXTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexHeaderArrayXTags instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.GetComplexHeaderArrayXTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexHeaderArrayXTags, Mutable>(this);
    }
}
