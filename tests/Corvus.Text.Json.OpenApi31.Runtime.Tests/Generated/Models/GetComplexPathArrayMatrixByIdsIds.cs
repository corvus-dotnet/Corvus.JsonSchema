...
public readonly partial struct GetComplexPathArrayMatrixByIdsIds
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexPathArrayMatrixByIdsIds>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexPathArrayMatrixByIdsIds"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexPathArrayMatrixByIdsIds(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexPathArrayMatrixByIdsIds DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexPathArrayMatrixByIdsIds left, in GetComplexPathArrayMatrixByIdsIds right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexPathArrayMatrixByIdsIds left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexPathArrayMatrixByIdsIds instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexPathArrayMatrixByIdsIds(JsonElement instance)
    {
        return GetComplexPathArrayMatrixByIdsIds.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathArrayMatrixByIdsIds From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathArrayMatrixByIdsIds ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathArrayMatrixByIdsIds>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathArrayMatrixByIdsIds ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathArrayMatrixByIdsIds>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathArrayMatrixByIdsIds ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathArrayMatrixByIdsIds>(json, options);
    }
    ...
    /// </exception>
    public static GetComplexPathArrayMatrixByIdsIds ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathArrayMatrixByIdsIds>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexPathArrayMatrixByIdsIds? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexPathArrayMatrixByIdsIds>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexPathArrayMatrixByIdsIds(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexPathArrayMatrixByIdsIds IJsonElement<GetComplexPathArrayMatrixByIdsIds>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexPathArrayMatrixByIdsIds: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexPathArrayMatrixByIdsIds"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexPathArrayMatrixByIdsIds"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathArrayMatrixByIdsIds Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexPathArrayMatrixByIdsIds>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexPathArrayMatrixByIdsIds"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathArrayMatrixByIdsIds Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexPathArrayMatrixByIdsIds>(_idx);
        }
