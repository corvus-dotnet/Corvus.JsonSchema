...
public readonly partial struct GetComplexPathArraySimpleByIdsIds
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.GetComplexPathArraySimpleByIdsIds.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.GetComplexPathArraySimpleByIdsIds.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
