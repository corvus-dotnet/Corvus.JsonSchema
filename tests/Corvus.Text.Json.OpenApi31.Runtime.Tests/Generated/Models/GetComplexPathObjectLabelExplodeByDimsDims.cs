...
public readonly partial struct GetComplexPathObjectLabelExplodeByDimsDims
    ...
    : IJsonElement<GetComplexPathObjectLabelExplodeByDimsDims>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexPathObjectLabelExplodeByDimsDims"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexPathObjectLabelExplodeByDimsDims(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexPathObjectLabelExplodeByDimsDims DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexPathObjectLabelExplodeByDimsDims left, in GetComplexPathObjectLabelExplodeByDimsDims right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexPathObjectLabelExplodeByDimsDims left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexPathObjectLabelExplodeByDimsDims instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexPathObjectLabelExplodeByDimsDims(JsonElement instance)
    {
        return GetComplexPathObjectLabelExplodeByDimsDims.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectLabelExplodeByDimsDims From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectLabelExplodeByDimsDims ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexPathObjectLabelExplodeByDimsDims>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectLabelExplodeByDimsDims ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexPathObjectLabelExplodeByDimsDims>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectLabelExplodeByDimsDims ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexPathObjectLabelExplodeByDimsDims>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetComplexPathObjectLabelExplodeByDimsDims ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexPathObjectLabelExplodeByDimsDims>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexPathObjectLabelExplodeByDimsDims? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexPathObjectLabelExplodeByDimsDims>(ref reader, out result);
    }
...
#if NET
    static GetComplexPathObjectLabelExplodeByDimsDims IJsonElement<GetComplexPathObjectLabelExplodeByDimsDims>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexPathObjectLabelExplodeByDimsDims: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathObjectLabelExplodeByDimsDims Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathObjectLabelExplodeByDimsDims Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexPathObjectLabelExplodeByDimsDims>(_idx);
        }
