...
public readonly partial struct GetComplexPathObjectMatrixByDimsDims
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexPathObjectMatrixByDimsDims instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexPathObjectMatrixByDimsDims"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexPathObjectMatrixByDimsDims(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexPathObjectMatrixByDimsDims.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathObjectMatrixByDimsDims Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathObjectMatrixByDimsDims Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexPathObjectMatrixByDimsDims>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.Models.GetComplexPathObjectMatrixByDimsDims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetComplexPathObjectMatrixByDimsDims instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.GetComplexPathObjectMatrixByDimsDims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetComplexPathObjectMatrixByDimsDims"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<GetComplexPathObjectMatrixByDimsDims, Mutable>(this);
    }
}
