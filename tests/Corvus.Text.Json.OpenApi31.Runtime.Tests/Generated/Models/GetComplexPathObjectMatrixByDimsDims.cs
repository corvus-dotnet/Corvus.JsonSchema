...
public readonly partial struct GetComplexPathObjectMatrixByDimsDims
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexPathObjectMatrixByDimsDims>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexPathObjectMatrixByDimsDims"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexPathObjectMatrixByDimsDims(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexPathObjectMatrixByDimsDims DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexPathObjectMatrixByDimsDims left, in GetComplexPathObjectMatrixByDimsDims right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexPathObjectMatrixByDimsDims left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexPathObjectMatrixByDimsDims instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexPathObjectMatrixByDimsDims(JsonElement instance)
    {
        return GetComplexPathObjectMatrixByDimsDims.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectMatrixByDimsDims From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectMatrixByDimsDims ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectMatrixByDimsDims>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectMatrixByDimsDims ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectMatrixByDimsDims>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectMatrixByDimsDims ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectMatrixByDimsDims>(json, options);
    }
    ...
    /// </exception>
    public static GetComplexPathObjectMatrixByDimsDims ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectMatrixByDimsDims>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexPathObjectMatrixByDimsDims? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexPathObjectMatrixByDimsDims>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexPathObjectMatrixByDimsDims(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexPathObjectMatrixByDimsDims IJsonElement<GetComplexPathObjectMatrixByDimsDims>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexPathObjectMatrixByDimsDims: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexPathObjectMatrixByDimsDims"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexPathObjectMatrixByDimsDims"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathObjectMatrixByDimsDims Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexPathObjectMatrixByDimsDims>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexPathObjectMatrixByDimsDims"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathObjectMatrixByDimsDims Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexPathObjectMatrixByDimsDims>(_idx);
        }
