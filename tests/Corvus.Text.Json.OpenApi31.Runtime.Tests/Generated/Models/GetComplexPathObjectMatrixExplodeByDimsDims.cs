...
public readonly partial struct GetComplexPathObjectMatrixExplodeByDimsDims
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexPathObjectMatrixExplodeByDimsDims>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexPathObjectMatrixExplodeByDimsDims"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexPathObjectMatrixExplodeByDimsDims(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexPathObjectMatrixExplodeByDimsDims DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests31.Client.Models.JsonInt32 Height
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeightUtf8, out CanonTests31.Client.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests31.Client.Models.JsonInt32 Width
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WidthUtf8, out CanonTests31.Client.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexPathObjectMatrixExplodeByDimsDims left, in GetComplexPathObjectMatrixExplodeByDimsDims right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexPathObjectMatrixExplodeByDimsDims left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexPathObjectMatrixExplodeByDimsDims instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexPathObjectMatrixExplodeByDimsDims(JsonElement instance)
    {
        return GetComplexPathObjectMatrixExplodeByDimsDims.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectMatrixExplodeByDimsDims From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectMatrixExplodeByDimsDims ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectMatrixExplodeByDimsDims>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectMatrixExplodeByDimsDims ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectMatrixExplodeByDimsDims>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexPathObjectMatrixExplodeByDimsDims ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectMatrixExplodeByDimsDims>(json, options);
    }
    ...
    /// </exception>
    public static GetComplexPathObjectMatrixExplodeByDimsDims ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetComplexPathObjectMatrixExplodeByDimsDims>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexPathObjectMatrixExplodeByDimsDims? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexPathObjectMatrixExplodeByDimsDims>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexPathObjectMatrixExplodeByDimsDims(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexPathObjectMatrixExplodeByDimsDims IJsonElement<GetComplexPathObjectMatrixExplodeByDimsDims>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexPathObjectMatrixExplodeByDimsDims: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexPathObjectMatrixExplodeByDimsDims"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexPathObjectMatrixExplodeByDimsDims"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathObjectMatrixExplodeByDimsDims Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexPathObjectMatrixExplodeByDimsDims>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexPathObjectMatrixExplodeByDimsDims"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexPathObjectMatrixExplodeByDimsDims Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexPathObjectMatrixExplodeByDimsDims>(_idx);
        }
