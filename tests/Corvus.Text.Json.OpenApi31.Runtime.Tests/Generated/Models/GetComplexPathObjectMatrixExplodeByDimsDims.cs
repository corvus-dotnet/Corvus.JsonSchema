...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Client.JsonInt32 Height
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeightUtf8, out CanonTests31.Client.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests31.Client.JsonInt32 Width
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WidthUtf8, out CanonTests31.Client.JsonInt32 value))
            {
                return value;
            }
