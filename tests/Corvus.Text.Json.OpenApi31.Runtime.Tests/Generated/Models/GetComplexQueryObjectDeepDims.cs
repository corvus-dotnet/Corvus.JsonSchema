...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexQueryObjectDeepDims"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexQueryObjectDeepDims(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexQueryObjectDeepDims DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexQueryObjectDeepDims left, in GetComplexQueryObjectDeepDims right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexQueryObjectDeepDims left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexQueryObjectDeepDims instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexQueryObjectDeepDims(JsonElement instance)
    {
        return GetComplexQueryObjectDeepDims.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryObjectDeepDims From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryObjectDeepDims ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexQueryObjectDeepDims>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryObjectDeepDims ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexQueryObjectDeepDims>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryObjectDeepDims ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexQueryObjectDeepDims>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetComplexQueryObjectDeepDims ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexQueryObjectDeepDims>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexQueryObjectDeepDims? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexQueryObjectDeepDims>(ref reader, out result);
    }
...
#if NET
    static GetComplexQueryObjectDeepDims IJsonElement<GetComplexQueryObjectDeepDims>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexQueryObjectDeepDims: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetComplexQueryObjectDeepDims Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetComplexQueryObjectDeepDims Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexQueryObjectDeepDims>(_idx);
        }
