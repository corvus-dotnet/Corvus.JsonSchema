...
public readonly partial struct GetComplexQueryObjectExplodeDims
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests31.Client.JsonInt32.Mutable Height
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeightUtf8, out CanonTests31.Client.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests31.Client.JsonInt32.Mutable Width
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WidthUtf8, out CanonTests31.Client.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        public void SetHeight(in CanonTests31.Client.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWidth(in CanonTests31.Client.JsonInt32.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.GetComplexQueryObjectExplodeDims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.GetComplexQueryObjectExplodeDims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests31.Client.JsonInt32.Source height = default,
            in CanonTests31.Client.JsonInt32.Source width = default)
        {
        ...
        /// Creates an instance of a <see cref="GetComplexQueryObjectExplodeDims"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.JsonInt32.Source height = default, in CanonTests31.Client.JsonInt32.Source width = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.JsonInt32.Source height = default, in CanonTests31.Client.JsonInt32.Source width = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
