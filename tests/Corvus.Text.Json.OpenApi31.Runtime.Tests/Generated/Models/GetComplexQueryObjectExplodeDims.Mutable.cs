...
public readonly partial struct GetComplexQueryObjectExplodeDims
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexQueryObjectExplodeDims instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexQueryObjectExplodeDims"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexQueryObjectExplodeDims(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests31.Client.Models.JsonInt32.Mutable Height
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeightUtf8, out CanonTests31.Client.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests31.Client.Models.JsonInt32.Mutable Width
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WidthUtf8, out CanonTests31.Client.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetComplexQueryObjectExplodeDims(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetHeight(in CanonTests31.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWidth(in CanonTests31.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexQueryObjectExplodeDims.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetComplexQueryObjectExplodeDims"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetComplexQueryObjectExplodeDims"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryObjectExplodeDims Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetComplexQueryObjectExplodeDims>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetComplexQueryObjectExplodeDims"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryObjectExplodeDims Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexQueryObjectExplodeDims>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests31.Client.Models.JsonInt32.Source _createArg2;
        ...
        internal Source(CanonTests31.Client.Models.GetComplexQueryObjectExplodeDims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests31.Client.Models.JsonInt32.Source arg1, in CanonTests31.Client.Models.JsonInt32.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(GetComplexQueryObjectExplodeDims instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.GetComplexQueryObjectExplodeDims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetComplexQueryObjectExplodeDims"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests31.Client.Models.JsonInt32.Source height = default,
            in CanonTests31.Client.Models.JsonInt32.Source width = default)
        {
        ...
        /// Creates an instance of a <see cref="GetComplexQueryObjectExplodeDims"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.Models.JsonInt32.Source height = default, in CanonTests31.Client.Models.JsonInt32.Source width = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests31.Client.Models.JsonInt32.Source arg1, in CanonTests31.Client.Models.JsonInt32.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.JsonInt32.Source height = default, in CanonTests31.Client.Models.JsonInt32.Source width = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.JsonInt32.Source height = default, in CanonTests31.Client.Models.JsonInt32.Source width = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetComplexQueryObjectExplodeDims, Mutable>(this);
    }
}
