...
public readonly partial struct GetFilesDownloadMixedNotFound
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.Models.GetFilesDownloadMixedNotFound.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.GetFilesDownloadMixedNotFound.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests31.Client.Models.JsonString.Source error = default)
        {
        ...
        /// Creates an instance of a <see cref="GetFilesDownloadMixedNotFound"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.Models.JsonString.Source error = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.JsonString.Source error = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.JsonString.Source error = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
