...
public readonly partial struct GetFilesVendorJsonOk
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests31.Client.Models.JsonString.Mutable Data
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataUtf8, out CanonTests31.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetData(in CanonTests31.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.Models.GetFilesVendorJsonOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.GetFilesVendorJsonOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests31.Client.Models.JsonString.Source data = default)
        {
        ...
        /// Creates an instance of a <see cref="GetFilesVendorJsonOk"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.Models.JsonString.Source data = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.JsonString.Source data = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.JsonString.Source data = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
