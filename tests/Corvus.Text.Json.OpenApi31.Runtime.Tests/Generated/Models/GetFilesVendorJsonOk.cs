...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Client.JsonString Data
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataUtf8, out CanonTests31.Client.JsonString value))
            {
                return value;
            }
