...
public readonly partial struct GetItemsByItemIdNotFound
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsByItemIdNotFound instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsByItemIdNotFound"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsByItemIdNotFound(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsByItemIdNotFound.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdNotFound Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdNotFound Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsByItemIdNotFound>(_idx);
        }
    }
    ...
    {
        return workspace.CreateBuilder<GetItemsByItemIdNotFound, Mutable>(this);
    }
}
