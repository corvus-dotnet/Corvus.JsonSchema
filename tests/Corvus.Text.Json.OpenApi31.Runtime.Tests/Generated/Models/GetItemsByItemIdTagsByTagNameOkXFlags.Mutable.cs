...
public readonly partial struct GetItemsByItemIdTagsByTagNameOkXFlags
{
...
#endif
    {
        ...
        public CanonTests31.Client.JsonBoolean.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests31.Client.JsonBoolean.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests31.Client.JsonBoolean.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Client.JsonBoolean.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in CanonTests31.Client.JsonBoolean.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in CanonTests31.Client.JsonBoolean.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in CanonTests31.Client.JsonBoolean.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in CanonTests31.Client.JsonBoolean item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests31.Client.JsonBoolean>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<CanonTests31.Client.JsonBoolean> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests31.Client.JsonBoolean>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in CanonTests31.Client.JsonBoolean oldItem, in CanonTests31.Client.JsonBoolean.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Client.JsonBoolean>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                CanonTests31.Client.JsonBoolean current = enumerator.Current;
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.GetItemsByItemIdTagsByTagNameOkXFlags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.GetItemsByItemIdTagsByTagNameOkXFlags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
