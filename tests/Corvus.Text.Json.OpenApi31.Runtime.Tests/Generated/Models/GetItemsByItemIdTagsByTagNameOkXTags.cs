...
public readonly partial struct GetItemsByItemIdTagsByTagNameOkXTags
#if NET8_0_OR_GREATER
    : IJsonElement<GetItemsByItemIdTagsByTagNameOkXTags>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetItemsByItemIdTagsByTagNameOkXTags"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetItemsByItemIdTagsByTagNameOkXTags(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetItemsByItemIdTagsByTagNameOkXTags DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdTagsByTagNameOkXTags left, in GetItemsByItemIdTagsByTagNameOkXTags right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdTagsByTagNameOkXTags left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetItemsByItemIdTagsByTagNameOkXTags instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetItemsByItemIdTagsByTagNameOkXTags(JsonElement instance)
    {
        return GetItemsByItemIdTagsByTagNameOkXTags.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXTags From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXTags ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXTags>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXTags ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXTags>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXTags ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXTags>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetItemsByItemIdTagsByTagNameOkXTags ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXTags>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetItemsByItemIdTagsByTagNameOkXTags? result)
    {
        return JsonElementHelpers.TryParseValue<GetItemsByItemIdTagsByTagNameOkXTags>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetItemsByItemIdTagsByTagNameOkXTags(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetItemsByItemIdTagsByTagNameOkXTags IJsonElement<GetItemsByItemIdTagsByTagNameOkXTags>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetItemsByItemIdTagsByTagNameOkXTags: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetItemsByItemIdTagsByTagNameOkXTags"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetItemsByItemIdTagsByTagNameOkXTags"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdTagsByTagNameOkXTags Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetItemsByItemIdTagsByTagNameOkXTags>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetItemsByItemIdTagsByTagNameOkXTags"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdTagsByTagNameOkXTags Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetItemsByItemIdTagsByTagNameOkXTags>(_idx);
        }
