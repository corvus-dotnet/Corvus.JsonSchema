...
public readonly partial struct GetOrdersByOrderIdOk
    : IJsonElement<GetOrdersByOrderIdOk>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOrderIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("orderId"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOrderIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("orderId"u8, buffer, out written);

        private const int RequiredOffsetForOrderId = 0;
        private const uint RequiredBitForOrderId = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForOrderId | RequiredBitForStatus | RequiredBitForTotal;
        private static readonly JsonSchemaPathProvider OrderIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/orderId"u8, buffer, out written);
        ...
        private static void MatchOrderId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                CanonTests31.Client.Models.JsonUuid.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.OrderIdUtf8,
                    evaluationPath: OrderIdSchemaEvaluationPath);

            CanonTests31.Client.Models.JsonUuid.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForOrderId] |= RequiredBitForOrderId;
        }
        ...
        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                CanonTests31.Client.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            CanonTests31.Client.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchTotal(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext2 =
                CanonTests31.Client.Models.JsonNumber.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            CanonTests31.Client.Models.JsonNumber.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static PropertySchemaMatchers<CanonTests31.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<CanonTests31.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
        ...
        private static PropertySchemaMatchers<CanonTests31.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out CanonTests31.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1? matcher)
        {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1orders~1{orderId}/get/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1orders~1{orderId}/get/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1orders~1{orderId}/get/responses/200/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out CanonTests31.Client.Models.PropertiesValidationHandler_NamedPropertyValidator1? validator))
                    {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOrderIdPresent, "orderId"u8, "required"u8);
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForOrderId] & RequiredBitForOrderId) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyOrderIdNotPresent, "orderId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOrderIdPresent, "orderId"u8, "required"u8);
