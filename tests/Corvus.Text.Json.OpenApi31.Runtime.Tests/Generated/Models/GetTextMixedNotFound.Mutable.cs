...
public readonly partial struct GetTextMixedNotFound
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetTextMixedNotFound instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetTextMixedNotFound"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetTextMixedNotFound(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests31.Client.Models.JsonString.Mutable Error
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out CanonTests31.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetError(in CanonTests31.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetTextMixedNotFound.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetTextMixedNotFound Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetTextMixedNotFound Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetTextMixedNotFound>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.Models.GetTextMixedNotFound.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetTextMixedNotFound instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.GetTextMixedNotFound.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetTextMixedNotFound"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests31.Client.Models.JsonString.Source error)
        {
        ...
        /// Creates an instance of a <see cref="GetTextMixedNotFound"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.Models.JsonString.Source error)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.JsonString.Source error)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.JsonString.Source error, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetTextMixedNotFound, Mutable>(this);
    }
}
