...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.JsonString Error
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out CanonTests31.Client.JsonString value))
            {
                return value;
            }
