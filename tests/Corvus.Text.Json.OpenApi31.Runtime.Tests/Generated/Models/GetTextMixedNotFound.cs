...
public readonly partial struct GetTextMixedNotFound
#if NET8_0_OR_GREATER
    : IJsonElement<GetTextMixedNotFound>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetTextMixedNotFound"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetTextMixedNotFound(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetTextMixedNotFound DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.Models.JsonString Error
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out CanonTests31.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetTextMixedNotFound left, in GetTextMixedNotFound right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetTextMixedNotFound left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetTextMixedNotFound instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetTextMixedNotFound(JsonElement instance)
    {
        return GetTextMixedNotFound.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetTextMixedNotFound From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetTextMixedNotFound ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetTextMixedNotFound>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetTextMixedNotFound ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetTextMixedNotFound>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetTextMixedNotFound ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetTextMixedNotFound>(json, options);
    }
    ...
    /// </exception>
    public static GetTextMixedNotFound ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetTextMixedNotFound>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetTextMixedNotFound? result)
    {
        return JsonElementHelpers.TryParseValue<GetTextMixedNotFound>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetTextMixedNotFound(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetTextMixedNotFound IJsonElement<GetTextMixedNotFound>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetTextMixedNotFound: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetTextMixedNotFound"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetTextMixedNotFound"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetTextMixedNotFound Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetTextMixedNotFound>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetTextMixedNotFound"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetTextMixedNotFound Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetTextMixedNotFound>(_idx);
        }
