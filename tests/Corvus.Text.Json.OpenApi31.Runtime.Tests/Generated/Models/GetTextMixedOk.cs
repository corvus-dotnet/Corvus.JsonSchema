...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.Models.JsonString Value
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out CanonTests31.Client.Models.JsonString value))
            {
                return value;
            }
