...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.JsonString Value
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out CanonTests31.Client.JsonString value))
            {
                return value;
            }
