...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.Models.JsonBoolean Received
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReceivedUtf8, out CanonTests31.Client.Models.JsonBoolean value))
            {
                return value;
            }
