...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.JsonBoolean Received
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReceivedUtf8, out CanonTests31.Client.JsonBoolean value))
            {
                return value;
            }
