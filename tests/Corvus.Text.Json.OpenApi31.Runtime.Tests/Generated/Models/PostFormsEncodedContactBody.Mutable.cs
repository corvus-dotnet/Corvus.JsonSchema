...
public readonly partial struct PostFormsEncodedContactBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests31.Client.PostFormsEncodedContactBody.AddressEntity.Mutable Address
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AddressUtf8, out CanonTests31.Client.PostFormsEncodedContactBody.AddressEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests31.Client.PostFormsEncodedContactBody.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests31.Client.PostFormsEncodedContactBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetAddress(in CanonTests31.Client.PostFormsEncodedContactBody.AddressEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAddress<TContext>(in CanonTests31.Client.PostFormsEncodedContactBody.AddressEntity.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in CanonTests31.Client.PostFormsEncodedContactBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in CanonTests31.Client.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.PostFormsEncodedContactBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.PostFormsEncodedContactBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests31.Client.PostFormsEncodedContactBody.AddressEntity.Source address = default,
            in CanonTests31.Client.PostFormsEncodedContactBody.JsonStringArray.Source tags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in CanonTests31.Client.JsonEmail.Source email,
            in CanonTests31.Client.JsonString.Source name,
            in CanonTests31.Client.PostFormsEncodedContactBody.AddressEntity.Source<TContext> address = default,
            in CanonTests31.Client.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.JsonEmail.Source email, in CanonTests31.Client.JsonString.Source name, in CanonTests31.Client.PostFormsEncodedContactBody.AddressEntity.Source address = default, in CanonTests31.Client.PostFormsEncodedContactBody.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests31.Client.JsonEmail.Source email, in CanonTests31.Client.JsonString.Source name, in CanonTests31.Client.PostFormsEncodedContactBody.AddressEntity.Source<TContext> address = default, in CanonTests31.Client.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
