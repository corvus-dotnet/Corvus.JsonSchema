...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.PostFormsEncodedContactBody.AddressEntity Address
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AddressUtf8, out CanonTests31.Client.Models.PostFormsEncodedContactBody.AddressEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests31.Client.Models.PostFormsEncodedContactBody.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests31.Client.Models.PostFormsEncodedContactBody.JsonStringArray value))
            {
                return value;
            }
