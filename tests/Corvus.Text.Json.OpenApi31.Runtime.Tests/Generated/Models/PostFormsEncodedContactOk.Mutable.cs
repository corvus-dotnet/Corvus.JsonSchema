...
public readonly partial struct PostFormsEncodedContactOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsEncodedContactOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsEncodedContactOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsEncodedContactOk(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>received</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CanonTests31.Client.Models.JsonBoolean.Mutable Received
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReceivedUtf8, out CanonTests31.Client.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostFormsEncodedContactOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>received</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetReceived(in CanonTests31.Client.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("received");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReceivedUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Received, ref cvb);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsEncodedContactOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostFormsEncodedContactOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostFormsEncodedContactOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsEncodedContactOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostFormsEncodedContactOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostFormsEncodedContactOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsEncodedContactOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsEncodedContactOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests31.Client.Models.JsonBoolean.Source _createArg1;
        ...
        internal Source(CanonTests31.Client.Models.PostFormsEncodedContactOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests31.Client.Models.JsonBoolean.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(PostFormsEncodedContactOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.PostFormsEncodedContactOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostFormsEncodedContactOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests31.Client.Models.JsonBoolean.Source received)
        {
            received.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Received, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="PostFormsEncodedContactOk"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.Models.JsonBoolean.Source received)
        {
            Create(ref _builder, received);
        }
        ...
        internal static void BuildCreateValue(in CanonTests31.Client.Models.JsonBoolean.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// </summary>
    /// <param name="received">The value of the <c>"received"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.JsonBoolean.Source received)
    {
        return new Source(received);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="received">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.JsonBoolean.Source received, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PostFormsEncodedContactOk, Mutable>(this);
    }
}
