...
public readonly partial struct PostFormsEncodedUploadBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests31.Client.Models.JsonString Author
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorUtf8, out CanonTests31.Client.Models.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests31.Client.Models.JsonInteger Version
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out CanonTests31.Client.Models.JsonInteger value))
                {
                    return value;
                }
