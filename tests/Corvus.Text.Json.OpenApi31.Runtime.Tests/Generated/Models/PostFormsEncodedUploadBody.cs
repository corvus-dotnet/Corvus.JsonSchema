...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Client.PostFormsEncodedUploadBody.MetadataEntity Metadata
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests31.Client.PostFormsEncodedUploadBody.MetadataEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests31.Client.PostFormsEncodedUploadBody.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests31.Client.PostFormsEncodedUploadBody.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.JsonString Title
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out CanonTests31.Client.JsonString value))
            {
                return value;
            }
