...
public readonly partial struct PostFormsEncodedUploadOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsEncodedUploadOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsEncodedUploadOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsEncodedUploadOk(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests31.Client.Models.JsonBoolean.Mutable Uploaded
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedUtf8, out CanonTests31.Client.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostFormsEncodedUploadOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetUploaded(in CanonTests31.Client.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsEncodedUploadOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostFormsEncodedUploadOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostFormsEncodedUploadOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsEncodedUploadOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostFormsEncodedUploadOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostFormsEncodedUploadOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsEncodedUploadOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsEncodedUploadOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.Models.PostFormsEncodedUploadOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(PostFormsEncodedUploadOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.PostFormsEncodedUploadOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostFormsEncodedUploadOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests31.Client.Models.JsonBoolean.Source uploaded)
        {
        ...
        /// Creates an instance of a <see cref="PostFormsEncodedUploadOk"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.Models.JsonBoolean.Source uploaded)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.JsonBoolean.Source uploaded)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.JsonBoolean.Source uploaded, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PostFormsEncodedUploadOk, Mutable>(this);
    }
}
