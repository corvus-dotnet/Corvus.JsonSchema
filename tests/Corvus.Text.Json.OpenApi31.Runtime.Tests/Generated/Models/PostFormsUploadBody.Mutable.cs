...
public readonly partial struct PostFormsUploadBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsUploadBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsUploadBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsUploadBody(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests31.Client.Models.JsonString.Mutable Category
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CategoryUtf8, out CanonTests31.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests31.Client.Models.JsonString.Mutable Title
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out CanonTests31.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostFormsUploadBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCategory(in CanonTests31.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTitle(in CanonTests31.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsUploadBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostFormsUploadBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostFormsUploadBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsUploadBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostFormsUploadBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostFormsUploadBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsUploadBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsUploadBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests31.Client.Models.JsonString.Source _createArg1;
        private readonly CanonTests31.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source _createArg3;
        ...
        internal Source(CanonTests31.Client.Models.PostFormsUploadBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests31.Client.Models.JsonString.Source arg1, in CanonTests31.Client.Models.JsonString.Source arg2, in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly CanonTests31.Client.Models.JsonString.Source _createArg1;
        private readonly CanonTests31.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> _createArg3;
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.PostFormsUploadBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests31.Client.Models.JsonString.Source arg1, in CanonTests31.Client.Models.JsonString.Source arg2, in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests31.Client.Models.JsonString.Source title,
            in CanonTests31.Client.Models.JsonString.Source category = default,
            in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source tags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in CanonTests31.Client.Models.JsonString.Source title,
            in CanonTests31.Client.Models.JsonString.Source category = default,
            in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, title, category, tags);
        }
        ...
        internal static void BuildCreateValue(in CanonTests31.Client.Models.JsonString.Source arg1, in CanonTests31.Client.Models.JsonString.Source arg2, in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests31.Client.Models.JsonString.Source arg1, in CanonTests31.Client.Models.JsonString.Source arg2, in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.JsonString.Source title, in CanonTests31.Client.Models.JsonString.Source category = default, in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source tags = default)
    {
        return new Source(title, category, tags);
    }
    ...
    /// <param name="tags">The value of the <c>"tags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests31.Client.Models.JsonString.Source title, in CanonTests31.Client.Models.JsonString.Source category = default, in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, title, category, tags);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.JsonString.Source title, in CanonTests31.Client.Models.JsonString.Source category = default, in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(title, category, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests31.Client.Models.JsonString.Source title, in CanonTests31.Client.Models.JsonString.Source category = default, in CanonTests31.Client.Models.PostFormsUploadBody.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, title, category, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostFormsUploadBody, Mutable>(this);
    }
}
