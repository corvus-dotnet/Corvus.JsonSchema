...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.JsonBoolean Uploaded
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedUtf8, out CanonTests31.Client.JsonBoolean value))
            {
                return value;
            }
