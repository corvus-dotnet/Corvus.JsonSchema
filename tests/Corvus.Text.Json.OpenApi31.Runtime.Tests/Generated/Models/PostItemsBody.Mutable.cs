...
public readonly partial struct PostItemsBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests31.Client.Models.JsonDouble.Mutable Price
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriceUtf8, out CanonTests31.Client.Models.JsonDouble.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPrice(in CanonTests31.Client.Models.JsonDouble.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests31.Client.Models.JsonDouble.Source _createArg2;
        ...
        internal Source(CanonTests31.Client.Models.PostItemsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests31.Client.Models.JsonString.Source arg1, in CanonTests31.Client.Models.JsonDouble.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.PostItemsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests31.Client.Models.JsonDouble.Source price = default)
        {
        ...
        /// Creates an instance of a <see cref="PostItemsBody"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.Models.JsonString.Source name, in CanonTests31.Client.Models.JsonDouble.Source price = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests31.Client.Models.JsonString.Source arg1, in CanonTests31.Client.Models.JsonDouble.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.JsonString.Source name, in CanonTests31.Client.Models.JsonDouble.Source price = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.JsonString.Source name, in CanonTests31.Client.Models.JsonDouble.Source price = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
