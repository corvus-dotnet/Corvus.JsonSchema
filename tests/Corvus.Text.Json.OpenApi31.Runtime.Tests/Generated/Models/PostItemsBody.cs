...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.JsonDouble Price
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriceUtf8, out CanonTests31.Client.Models.JsonDouble value))
            {
                return value;
            }
