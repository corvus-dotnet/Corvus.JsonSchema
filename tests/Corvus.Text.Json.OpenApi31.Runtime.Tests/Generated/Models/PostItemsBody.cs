...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Client.JsonDouble Price
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriceUtf8, out CanonTests31.Client.JsonDouble value))
            {
                return value;
            }
