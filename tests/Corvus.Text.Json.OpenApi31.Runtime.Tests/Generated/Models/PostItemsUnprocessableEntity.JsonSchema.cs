...
public readonly partial struct PostItemsUnprocessableEntity
    : IJsonElement<PostItemsUnprocessableEntity>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyErrorsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("errors"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyErrorsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("errors"u8, buffer, out written);

        private const int RequiredOffsetForErrors = 0;
        private const uint RequiredBitForErrors = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForErrors;
        ...
        private static void MatchErrors(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForErrors] |= RequiredBitForErrors;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.ErrorsUtf8))
            {
                matcher = MatchErrors;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1items/post/responses/422/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1items/post/responses/422/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1items/post/responses/422/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyErrorsPresent, "errors"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForErrors] & RequiredBitForErrors) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyErrorsNotPresent, "errors"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyErrorsPresent, "errors"u8, "required"u8);
