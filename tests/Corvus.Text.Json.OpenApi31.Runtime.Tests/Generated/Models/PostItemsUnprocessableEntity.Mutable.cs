...
public readonly partial struct PostItemsUnprocessableEntity
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Mutable Errors
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorsUtf8, out CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetErrors(in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetErrors<TContext>(in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source _createArg1;
        ...
        internal Source(CanonTests31.Client.Models.PostItemsUnprocessableEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
        ...
        #endif
    {
        ...
        private readonly CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.PostItemsUnprocessableEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source errors)
        {
        ...
        /// Creates an instance of a <see cref="PostItemsUnprocessableEntity"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source errors)
        {
        ...
        internal static void Create<TContext>(
            ...
            in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> errors)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="PostItemsUnprocessableEntity"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> errors)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source errors)
    {
    ...
    /// <param name="errors">The value of the <c>"errors"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> errors)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source errors, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests31.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> errors, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
