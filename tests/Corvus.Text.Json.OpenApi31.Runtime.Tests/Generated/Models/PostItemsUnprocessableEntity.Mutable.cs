...
public readonly partial struct PostItemsUnprocessableEntity
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Mutable Errors
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorsUtf8, out CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetErrors(in CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetErrors<TContext>(in CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.PostItemsUnprocessableEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.PostItemsUnprocessableEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Source errors)
        {
        ...
        /// Creates an instance of a <see cref="PostItemsUnprocessableEntity"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Source errors)
        {
        ...
        internal static void Create<TContext>(
            ...
            in CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> errors)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="PostItemsUnprocessableEntity"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> errors)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Source errors, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> errors, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
