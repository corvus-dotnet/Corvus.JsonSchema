...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray Errors
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorsUtf8, out CanonTests31.Client.PostItemsUnprocessableEntity.JsonStringArray value))
            {
                return value;
            }
