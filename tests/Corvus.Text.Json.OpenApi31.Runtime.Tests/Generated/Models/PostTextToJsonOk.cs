...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostTextToJsonOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostTextToJsonOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostTextToJsonOk DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.Models.JsonString Parsed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParsedUtf8, out CanonTests31.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostTextToJsonOk left, in PostTextToJsonOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostTextToJsonOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostTextToJsonOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostTextToJsonOk(JsonElement instance)
    {
        return PostTextToJsonOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostTextToJsonOk From<T>(in T instance)
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostTextToJsonOk? result)
    {
        return JsonElementHelpers.TryParseValue<PostTextToJsonOk>(ref reader, out result);
    }
...
#if NET
    static PostTextToJsonOk IJsonElement<PostTextToJsonOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostTextToJsonOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostTextToJsonOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostTextToJsonOk>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Parsed"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Parsed"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ParsedUtf8 => "parsed"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Parsed"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Parsed => "parsed"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Parsed"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Parsed => [0x85, 0x00, 0x00, 0x00, 0x22, 0x70, 0x61, 0x72, 0x73, 0x65, 0x64, 0x22];
    }
}
