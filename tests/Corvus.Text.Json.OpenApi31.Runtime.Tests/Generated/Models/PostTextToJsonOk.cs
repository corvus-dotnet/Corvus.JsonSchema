...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests31.Client.JsonString Parsed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParsedUtf8, out CanonTests31.Client.JsonString value))
            {
                return value;
            }
