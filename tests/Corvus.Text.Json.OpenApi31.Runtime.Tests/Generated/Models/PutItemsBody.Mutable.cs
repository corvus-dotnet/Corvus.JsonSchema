...
public readonly partial struct PutItemsBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PutItemsBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PutItemsBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PutItemsBody(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PutItemsBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PutItemsBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PutItemsBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PutItemsBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PutItemsBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PutItemsBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PutItemsBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PutItemsBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PutItemsBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.Models.PutItemsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(PutItemsBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.PutItemsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PutItemsBody"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<PutItemsBody, Mutable>(this);
    }
}
