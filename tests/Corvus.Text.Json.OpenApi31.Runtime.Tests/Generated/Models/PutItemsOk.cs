...
public readonly partial struct PutItemsOk
#if NET8_0_OR_GREATER
    : IJsonElement<PutItemsOk>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PutItemsOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PutItemsOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PutItemsOk DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PutItemsOk left, in PutItemsOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PutItemsOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PutItemsOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PutItemsOk(JsonElement instance)
    {
        return PutItemsOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutItemsOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutItemsOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutItemsOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutItemsOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutItemsOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutItemsOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutItemsOk>(json, options);
    }
    ...
    /// </exception>
    public static PutItemsOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PutItemsOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PutItemsOk? result)
    {
        return JsonElementHelpers.TryParseValue<PutItemsOk>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PutItemsOk(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PutItemsOk IJsonElement<PutItemsOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PutItemsOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PutItemsOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PutItemsOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PutItemsOk Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PutItemsOk>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PutItemsOk"/> that lives for the lifetime of its
