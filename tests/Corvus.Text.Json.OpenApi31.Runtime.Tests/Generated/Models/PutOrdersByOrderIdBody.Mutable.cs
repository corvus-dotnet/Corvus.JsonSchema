...
public readonly partial struct PutOrdersByOrderIdBody
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Client.PutOrdersByOrderIdBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.PutOrdersByOrderIdBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests31.Client.JsonNumber.Source total = default)
        {
        ...
        /// Creates an instance of a <see cref="PutOrdersByOrderIdBody"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.JsonString.Source status, in CanonTests31.Client.JsonNumber.Source total = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.JsonString.Source status, in CanonTests31.Client.JsonNumber.Source total = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
