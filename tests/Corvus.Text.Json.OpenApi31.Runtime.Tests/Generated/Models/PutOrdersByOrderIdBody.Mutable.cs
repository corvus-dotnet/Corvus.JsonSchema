...
public readonly partial struct PutOrdersByOrderIdBody
{
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests31.Client.Models.JsonNumber.Source _createArg2;
        ...
        internal Source(CanonTests31.Client.Models.PutOrdersByOrderIdBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests31.Client.Models.JsonString.Source arg1, in CanonTests31.Client.Models.JsonNumber.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Client.Models.PutOrdersByOrderIdBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests31.Client.Models.JsonNumber.Source total = default)
        {
        ...
        /// Creates an instance of a <see cref="PutOrdersByOrderIdBody"/>.
        /// </summary>
        public void Create(in CanonTests31.Client.Models.JsonString.Source status, in CanonTests31.Client.Models.JsonNumber.Source total = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests31.Client.Models.JsonString.Source arg1, in CanonTests31.Client.Models.JsonNumber.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Client.Models.JsonString.Source status, in CanonTests31.Client.Models.JsonNumber.Source total = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Client.Models.JsonString.Source status, in CanonTests31.Client.Models.JsonNumber.Source total = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
