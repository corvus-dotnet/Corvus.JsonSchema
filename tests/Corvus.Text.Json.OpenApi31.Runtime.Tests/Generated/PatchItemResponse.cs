...
public struct PatchItemResponse : IApiResponse<PatchItemResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.PatchItemsByItemIdOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.PatchItemsByItemIdOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.PatchItemsByItemIdOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.PatchItemsByItemIdOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.PatchItemsByItemIdOk, TContext, TResult> matchOk,
