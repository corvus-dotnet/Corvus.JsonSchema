...
/// <summary>
/// Response type for the PatchItem operation.
/// </summary>
public struct PatchItemResponse : IApiResponse<PatchItemResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.PatchItemsByItemIdOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<PatchItemResponse> CreateAsync(
        int statusCode,
    ...
    {
        PatchItemResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.Models.PatchItemsByItemIdOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.Models.PatchItemsByItemIdOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.Models.PatchItemsByItemIdOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.Models.PatchItemsByItemIdOk, TContext, TResult> matchOk,
