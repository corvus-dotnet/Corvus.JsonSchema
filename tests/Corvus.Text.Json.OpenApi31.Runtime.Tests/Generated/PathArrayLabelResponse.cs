...
/// <summary>
/// Response type for the PathArrayLabel operation.
/// </summary>
public struct PathArrayLabelResponse : IApiResponse<PathArrayLabelResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PathArrayLabelResponse> CreateAsync(
        int statusCode,
    ...
    {
        PathArrayLabelResponse response = default;
