...
/// <summary>
/// Response type for the PathObjectLabelExplode operation.
/// </summary>
public struct PathObjectLabelExplodeResponse : IApiResponse<PathObjectLabelExplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PathObjectLabelExplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        PathObjectLabelExplodeResponse response = default;
