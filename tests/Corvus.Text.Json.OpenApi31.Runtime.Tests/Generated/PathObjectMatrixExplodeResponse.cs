...
/// <summary>
/// Response type for the PathObjectMatrixExplode operation.
/// </summary>
public struct PathObjectMatrixExplodeResponse : IApiResponse<PathObjectMatrixExplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PathObjectMatrixExplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        PathObjectMatrixExplodeResponse response = default;
