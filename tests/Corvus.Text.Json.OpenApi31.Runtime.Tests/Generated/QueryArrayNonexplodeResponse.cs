...
/// <summary>
/// Response type for the QueryArrayNonexplode operation.
/// </summary>
public struct QueryArrayNonexplodeResponse : IApiResponse<QueryArrayNonexplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<QueryArrayNonexplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        QueryArrayNonexplodeResponse response = default;
