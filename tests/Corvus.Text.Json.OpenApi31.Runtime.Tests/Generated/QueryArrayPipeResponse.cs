...
/// <summary>
/// Response type for the QueryArrayPipe operation.
/// </summary>
public struct QueryArrayPipeResponse : IApiResponse<QueryArrayPipeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<QueryArrayPipeResponse> CreateAsync(
        int statusCode,
    ...
    {
        QueryArrayPipeResponse response = default;
