...
/// <summary>
/// Response type for the Search operation.
/// </summary>
public struct SearchResponse : IApiResponse<SearchResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<SearchResponse> CreateAsync(
        int statusCode,
