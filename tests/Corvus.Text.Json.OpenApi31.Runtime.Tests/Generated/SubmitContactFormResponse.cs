...
/// <summary>
/// Response type for the SubmitContactForm operation.
/// </summary>
public struct SubmitContactFormResponse : IApiResponse<SubmitContactFormResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.PostFormsContactOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<SubmitContactFormResponse> CreateAsync(
        int statusCode,
    ...
    {
        SubmitContactFormResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.Models.PostFormsContactOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.Models.PostFormsContactOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.Models.PostFormsContactOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.Models.PostFormsContactOk, TContext, TResult> matchOk,
