...
public struct SubmitContactFormResponse : IApiResponse<SubmitContactFormResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.PostFormsContactOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.PostFormsContactOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.PostFormsContactOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.PostFormsContactOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.PostFormsContactOk, TContext, TResult> matchOk,
