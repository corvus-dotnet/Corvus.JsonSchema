...
public struct SubmitEncodedContactFormResponse : IApiResponse<SubmitEncodedContactFormResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.PostFormsEncodedContactOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.PostFormsEncodedContactOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.PostFormsEncodedContactOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.PostFormsEncodedContactOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.PostFormsEncodedContactOk, TContext, TResult> matchOk,
