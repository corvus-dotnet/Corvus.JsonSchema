...
/// <summary>
/// Response type for the UpdateItem operation.
/// </summary>
public struct UpdateItemResponse : IApiResponse<UpdateItemResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.PutItemsOk OkBody { get; private set; }
    ...
    {
        UpdateItemResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.Models.PutItemsOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.Models.PutItemsOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.Models.PutItemsOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.Models.PutItemsOk, TContext, TResult> matchOk,
