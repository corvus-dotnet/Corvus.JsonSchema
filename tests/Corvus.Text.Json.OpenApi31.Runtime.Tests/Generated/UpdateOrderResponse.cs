...
/// <summary>
/// Response type for the UpdateOrder operation.
/// </summary>
public struct UpdateOrderResponse : IApiResponse<UpdateOrderResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.PutOrdersByOrderIdOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<UpdateOrderResponse> CreateAsync(
        int statusCode,
    ...
    {
        UpdateOrderResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.Models.PutOrdersByOrderIdOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.Models.PutOrdersByOrderIdOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.Models.PutOrdersByOrderIdOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.Models.PutOrdersByOrderIdOk, TContext, TResult> matchOk,
