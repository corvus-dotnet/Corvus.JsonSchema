...
/// <summary>
/// Response type for the UploadEncodedDocument operation.
/// </summary>
public struct UploadEncodedDocumentResponse : IApiResponse<UploadEncodedDocumentResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.Models.PostFormsEncodedUploadOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<UploadEncodedDocumentResponse> CreateAsync(
        int statusCode,
    ...
    {
        UploadEncodedDocumentResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.Models.PostFormsEncodedUploadOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.Models.PostFormsEncodedUploadOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.Models.PostFormsEncodedUploadOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.Models.PostFormsEncodedUploadOk, TContext, TResult> matchOk,
