...
public struct UploadEncodedDocumentResponse : IApiResponse<UploadEncodedDocumentResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.PostFormsEncodedUploadOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests31.Client.PostFormsEncodedUploadOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests31.Client.PostFormsEncodedUploadOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.PostFormsEncodedUploadOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.PostFormsEncodedUploadOk, TContext, TResult> matchOk,
