...
public struct UploadFileResponse : IApiResponse<UploadFileResponse>
{
    ...
    /// </summary>
    public CanonTests31.Client.PostFilesUploadCreated CreatedBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 201)
        {
            var createdDoc = await ParsedJsonDocument<CanonTests31.Client.PostFilesUploadCreated>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetCreated(out CanonTests31.Client.PostFilesUploadCreated result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests31.Client.PostFilesUploadCreated, TResult> matchCreated,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests31.Client.PostFilesUploadCreated, TContext, TResult> matchCreated,
