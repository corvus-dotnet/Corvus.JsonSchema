...
public readonly struct ExportDataResult
{
    ...
    public static ExportDataResult Default(int statusCode, CanonTests31.Server.Error.Source body, JsonWorkspace workspace) => new(statusCode, CanonTests31.Server.Error.CreateBuilder(workspace, body, 0).RootElement, "application/json");
