...
public readonly struct ExportDataResult
{
    ...
    public static ExportDataResult Default(int statusCode, CanonTests31.Server.Models.Error.Source body, JsonWorkspace workspace) => new(statusCode, CanonTests31.Server.Models.Error.CreateBuilder(workspace, body, 30).RootElement, "application/json");
