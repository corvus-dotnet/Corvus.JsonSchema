...
public readonly struct GetByStyledObjectResult
{
    ...
    public static GetByStyledObjectResult Ok(CanonTests31.Server.GetStyledObjectByObjOk.Source body, JsonWorkspace workspace) => new(200, CanonTests31.Server.GetStyledObjectByObjOk.CreateBuilder(workspace, body, 0).RootElement, "application/json");
