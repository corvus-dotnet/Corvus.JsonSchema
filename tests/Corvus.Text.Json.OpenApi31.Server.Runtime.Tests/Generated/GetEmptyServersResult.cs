...
public readonly struct GetEmptyServersResult
{
    ...
    public static GetEmptyServersResult Ok(CanonTests31.Server.GetEmptyServersOk.Source body, JsonWorkspace workspace) => new(200, CanonTests31.Server.GetEmptyServersOk.CreateBuilder(workspace, body, 0).RootElement, "application/json");
