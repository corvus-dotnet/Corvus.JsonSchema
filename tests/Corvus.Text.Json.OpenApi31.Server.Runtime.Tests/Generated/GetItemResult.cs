...
public readonly struct GetItemResult
{
    ...
    public static GetItemResult Ok(CanonTests31.Server.Models.ItemEntity.Source body, JsonWorkspace workspace, CanonTests31.Server.Models.JsonInt32 xRateLimit = default, CanonTests31.Server.Models.JsonBoolean xActive = default, JsonElement xRequestId = default, CanonTests31.Server.Models.GetItemsByItemIdOkXTags xTags = default, CanonTests31.Server.Models.GetItemsByItemIdOkXPageSizes xPageSizes = default, CanonTests31.Server.Models.GetItemsByItemIdOkXFlags xFlags = default) => new(200, CanonTests31.Server.Models.ItemEntity.CreateBuilder(workspace, body, 30).RootElement, "application/json", xRateLimit: xRateLimit, xActive: xActive, xRequestId: xRequestId, xTags: xTags, xPageSizes: xPageSizes, xFlags: xFlags);
