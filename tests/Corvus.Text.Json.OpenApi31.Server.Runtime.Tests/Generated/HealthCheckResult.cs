...
public readonly struct HealthCheckResult
{
    ...
    public static HealthCheckResult Ok(CanonTests31.Server.Schema.Source body, JsonWorkspace workspace) => new(200, CanonTests31.Server.Schema.CreateBuilder(workspace, body, 0).RootElement, "application/json");
