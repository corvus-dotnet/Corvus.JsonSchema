...
public readonly partial struct GetAdvancedStylesByIdsMatrixTags
    ...
    : IJsonElement<GetAdvancedStylesByIdsMatrixTags>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAdvancedStylesByIdsMatrixTags"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetAdvancedStylesByIdsMatrixTags(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetAdvancedStylesByIdsMatrixTags DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsMatrixTags left, in GetAdvancedStylesByIdsMatrixTags right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsMatrixTags left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetAdvancedStylesByIdsMatrixTags instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetAdvancedStylesByIdsMatrixTags(JsonElement instance)
    {
        return GetAdvancedStylesByIdsMatrixTags.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsMatrixTags From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsMatrixTags ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsMatrixTags>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsMatrixTags ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsMatrixTags>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsMatrixTags ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsMatrixTags>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetAdvancedStylesByIdsMatrixTags ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsMatrixTags>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetAdvancedStylesByIdsMatrixTags? result)
    {
        return JsonElementHelpers.TryParseValue<GetAdvancedStylesByIdsMatrixTags>(ref reader, out result);
    }
...
#if NET
    static GetAdvancedStylesByIdsMatrixTags IJsonElement<GetAdvancedStylesByIdsMatrixTags>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetAdvancedStylesByIdsMatrixTags: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsMatrixTags Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsMatrixTags Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetAdvancedStylesByIdsMatrixTags>(_idx);
        }
