...
public readonly partial struct GetAdvancedStylesByIdsOk
{
    ...
    public readonly partial struct ItemsEntityArray
    {
...
#endif
        {
            ...
            public CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity oldItem, in CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
