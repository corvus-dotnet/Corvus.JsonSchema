...
public readonly partial struct GetAdvancedStylesByIdsOk
{
...
#endif
    {
        ...
        public CanonTests31.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests31.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests31.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity>(_parent, _idx);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ItemsEntityArray(JsonElement instance)
        {
            return ItemsEntityArray.From(instance);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ItemsEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ItemsEntityArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ItemsEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ItemsEntityArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ItemsEntityArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ItemsEntityArray>(json, options);
        }
        ...
        /// </exception>
        public static ItemsEntityArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ItemsEntityArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ItemsEntityArray? result)
        {
            return JsonElementHelpers.TryParseValue<ItemsEntityArray>(ref reader, out result);
        }
        ...
        /// <summary>
        /// Gets a <see cref="ItemsEntityArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ItemsEntityArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ItemsEntityArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ItemsEntityArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ItemsEntityArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ItemsEntityArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ItemsEntityArray>(_idx);
            }
