...
public readonly partial struct GetAdvancedStylesByIdsOk
{
...
#endif
    {
        ...
        public CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity>(_parent, _idx);
        }
