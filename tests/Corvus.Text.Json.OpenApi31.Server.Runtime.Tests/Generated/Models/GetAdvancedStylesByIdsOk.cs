...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAdvancedStylesByIdsOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetAdvancedStylesByIdsOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetAdvancedStylesByIdsOk DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests31.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray Items
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out CanonTests31.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests31.Server.Models.JsonInteger Total
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalUtf8, out CanonTests31.Server.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsOk left, in GetAdvancedStylesByIdsOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetAdvancedStylesByIdsOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetAdvancedStylesByIdsOk(JsonElement instance)
    {
        return GetAdvancedStylesByIdsOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOk From<T>(in T instance)
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetAdvancedStylesByIdsOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetAdvancedStylesByIdsOk>(ref reader, out result);
    }
...
#if NET
    static GetAdvancedStylesByIdsOk IJsonElement<GetAdvancedStylesByIdsOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetAdvancedStylesByIdsOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsOk Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetAdvancedStylesByIdsOk>(_idx);
        }
