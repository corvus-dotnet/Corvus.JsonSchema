...
public readonly partial struct GetAdvancedStylesByIdsOkXScores
    : IJsonElement<GetAdvancedStylesByIdsOkXScores>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1advanced-styles~1{ids}/get/responses/200/headers/X-Scores/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1advanced-styles~1{ids}/get/responses/200/headers/X-Scores/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1advanced-styles~1{ids}/get/responses/200/headers/X-Scores/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = CanonTests31.Server.Models.JsonDouble.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    CanonTests31.Server.Models.JsonDouble.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
