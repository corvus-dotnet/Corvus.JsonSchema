...
#endif
{
    ...
    public bool TryGetNumericValues(Span<double> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (CanonTests31.Server.JsonDouble item in EnumerateArray())
        {
    ...
    public CanonTests31.Server.JsonDouble this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests31.Server.JsonDouble>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests31.Server.JsonDouble> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.JsonDouble>(_parent, _idx);
    }
