...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAdvancedStylesByIdsOkXScores"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetAdvancedStylesByIdsOkXScores(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetAdvancedStylesByIdsOkXScores DefaultInstance { get; }
    ...
    public bool TryGetNumericValues(Span<double> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (CanonTests31.Server.Models.JsonDouble item in EnumerateArray())
        {
    ...
    public CanonTests31.Server.Models.JsonDouble this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests31.Server.Models.JsonDouble>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests31.Server.Models.JsonDouble> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.Models.JsonDouble>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsOkXScores left, in GetAdvancedStylesByIdsOkXScores right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsOkXScores left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetAdvancedStylesByIdsOkXScores instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetAdvancedStylesByIdsOkXScores(JsonElement instance)
    {
        return GetAdvancedStylesByIdsOkXScores.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXScores From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXScores ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXScores>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXScores ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXScores>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXScores ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXScores>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetAdvancedStylesByIdsOkXScores ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXScores>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetAdvancedStylesByIdsOkXScores? result)
    {
        return JsonElementHelpers.TryParseValue<GetAdvancedStylesByIdsOkXScores>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetAdvancedStylesByIdsOkXScores(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetAdvancedStylesByIdsOkXScores IJsonElement<GetAdvancedStylesByIdsOkXScores>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetAdvancedStylesByIdsOkXScores: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetAdvancedStylesByIdsOkXScores"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetAdvancedStylesByIdsOkXScores"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsOkXScores Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetAdvancedStylesByIdsOkXScores>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetAdvancedStylesByIdsOkXScores"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsOkXScores Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetAdvancedStylesByIdsOkXScores>(_idx);
        }
