...
#endif
{
    ...
    public CanonTests31.Server.JsonBoolean this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests31.Server.JsonBoolean>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests31.Server.JsonBoolean> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.JsonBoolean>(_parent, _idx);
    }
