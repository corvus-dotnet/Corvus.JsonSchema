...
public readonly partial struct GetItemsByItemIdOkXFlags
    ...
    : IJsonElement<GetItemsByItemIdOkXFlags>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetItemsByItemIdOkXFlags"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetItemsByItemIdOkXFlags(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetItemsByItemIdOkXFlags DefaultInstance { get; }
    ...
    public CanonTests31.Server.Models.JsonBoolean this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests31.Server.Models.JsonBoolean>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests31.Server.Models.JsonBoolean> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.Models.JsonBoolean>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdOkXFlags left, in GetItemsByItemIdOkXFlags right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdOkXFlags left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetItemsByItemIdOkXFlags instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetItemsByItemIdOkXFlags(JsonElement instance)
    {
        return GetItemsByItemIdOkXFlags.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXFlags From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXFlags ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXFlags>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXFlags ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXFlags>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXFlags ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXFlags>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetItemsByItemIdOkXFlags ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXFlags>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetItemsByItemIdOkXFlags? result)
    {
        return JsonElementHelpers.TryParseValue<GetItemsByItemIdOkXFlags>(ref reader, out result);
    }
...
#if NET
    static GetItemsByItemIdOkXFlags IJsonElement<GetItemsByItemIdOkXFlags>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetItemsByItemIdOkXFlags: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdOkXFlags Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdOkXFlags Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetItemsByItemIdOkXFlags>(_idx);
        }
