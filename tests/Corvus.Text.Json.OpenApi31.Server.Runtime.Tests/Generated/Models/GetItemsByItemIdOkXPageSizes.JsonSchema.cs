            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = CanonTests31.Server.Models.JsonInt32.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    CanonTests31.Server.Models.JsonInt32.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
