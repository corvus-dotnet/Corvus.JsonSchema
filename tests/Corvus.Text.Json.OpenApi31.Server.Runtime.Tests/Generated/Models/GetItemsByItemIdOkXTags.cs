...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetItemsByItemIdOkXTags"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetItemsByItemIdOkXTags(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetItemsByItemIdOkXTags DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdOkXTags left, in GetItemsByItemIdOkXTags right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdOkXTags left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetItemsByItemIdOkXTags instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetItemsByItemIdOkXTags(JsonElement instance)
    {
        return GetItemsByItemIdOkXTags.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXTags From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXTags ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXTags>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXTags ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXTags>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdOkXTags ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXTags>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetItemsByItemIdOkXTags ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdOkXTags>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetItemsByItemIdOkXTags? result)
    {
        return JsonElementHelpers.TryParseValue<GetItemsByItemIdOkXTags>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetItemsByItemIdOkXTags(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetItemsByItemIdOkXTags IJsonElement<GetItemsByItemIdOkXTags>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetItemsByItemIdOkXTags: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetItemsByItemIdOkXTags"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetItemsByItemIdOkXTags"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdOkXTags Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetItemsByItemIdOkXTags>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetItemsByItemIdOkXTags"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdOkXTags Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetItemsByItemIdOkXTags>(_idx);
        }
