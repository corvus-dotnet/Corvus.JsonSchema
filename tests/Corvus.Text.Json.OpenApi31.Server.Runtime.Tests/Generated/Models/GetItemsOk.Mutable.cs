...
public readonly partial struct GetItemsOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsOk(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetItemsOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="GetItemsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetItemsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetItemsOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetItemsOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Server.Models.GetItemsOk.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetItemsOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Server.Models.GetItemsOk.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetItemsOk, Mutable>(this);
    }
}
