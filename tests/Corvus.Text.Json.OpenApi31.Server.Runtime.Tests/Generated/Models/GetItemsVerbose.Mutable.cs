...
public readonly partial struct GetItemsVerbose
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsVerbose instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsVerbose"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsVerbose(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsVerbose.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsVerbose Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsVerbose Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsVerbose>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetItemsVerbose instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetItemsVerbose, Mutable>(this);
    }
}
