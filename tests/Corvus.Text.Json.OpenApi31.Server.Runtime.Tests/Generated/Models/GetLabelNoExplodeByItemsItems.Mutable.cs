...
public readonly partial struct GetLabelNoExplodeByItemsItems
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetLabelNoExplodeByItemsItems instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetLabelNoExplodeByItemsItems"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetLabelNoExplodeByItemsItems(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetLabelNoExplodeByItemsItems.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetLabelNoExplodeByItemsItems Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetLabelNoExplodeByItemsItems Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetLabelNoExplodeByItemsItems>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Server.Models.GetLabelNoExplodeByItemsItems.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetLabelNoExplodeByItemsItems instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Server.Models.GetLabelNoExplodeByItemsItems.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetLabelNoExplodeByItemsItems, Mutable>(this);
    }
}
