...
public readonly partial struct GetMatrixNoExplodeByTagsTags
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Server.Models.GetMatrixNoExplodeByTagsTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Server.Models.GetMatrixNoExplodeByTagsTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
