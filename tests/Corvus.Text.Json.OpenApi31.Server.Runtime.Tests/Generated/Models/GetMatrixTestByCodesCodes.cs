...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetMatrixTestByCodesCodes"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetMatrixTestByCodesCodes(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetMatrixTestByCodesCodes DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetMatrixTestByCodesCodes left, in GetMatrixTestByCodesCodes right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetMatrixTestByCodesCodes left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetMatrixTestByCodesCodes instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetMatrixTestByCodesCodes(JsonElement instance)
    {
        return GetMatrixTestByCodesCodes.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixTestByCodesCodes From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixTestByCodesCodes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetMatrixTestByCodesCodes>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixTestByCodesCodes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetMatrixTestByCodesCodes>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixTestByCodesCodes ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetMatrixTestByCodesCodes>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetMatrixTestByCodesCodes ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetMatrixTestByCodesCodes>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetMatrixTestByCodesCodes? result)
    {
        return JsonElementHelpers.TryParseValue<GetMatrixTestByCodesCodes>(ref reader, out result);
    }
...
#if NET
    static GetMatrixTestByCodesCodes IJsonElement<GetMatrixTestByCodesCodes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetMatrixTestByCodesCodes: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetMatrixTestByCodesCodes Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetMatrixTestByCodesCodes Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetMatrixTestByCodesCodes>(_idx);
        }
