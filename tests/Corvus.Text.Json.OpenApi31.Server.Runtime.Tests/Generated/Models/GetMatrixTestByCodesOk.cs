...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Server.JsonInteger Count
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out CanonTests31.Server.JsonInteger value))
            {
                return value;
            }
