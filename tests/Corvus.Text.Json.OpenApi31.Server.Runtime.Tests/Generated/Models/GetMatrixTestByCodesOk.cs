...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Server.Models.JsonInteger Count
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out CanonTests31.Server.Models.JsonInteger value))
            {
                return value;
            }
