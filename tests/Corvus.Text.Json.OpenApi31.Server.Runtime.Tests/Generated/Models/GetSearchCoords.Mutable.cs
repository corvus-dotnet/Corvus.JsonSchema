...
public readonly partial struct GetSearchCoords
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetSearchCoords instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetSearchCoords"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetSearchCoords(Mutable instance)
        {
        ...
        public CanonTests31.Server.Models.JsonNumber.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests31.Server.Models.JsonNumber.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests31.Server.Models.JsonNumber.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.Models.JsonNumber.Mutable>(_parent, _idx);
        }
        ...
        public bool TryGetNumericValues(Span<double> items, out int written)
        {
            CheckValidInstance();
            written = 0;
            foreach (CanonTests31.Server.Models.JsonNumber.Mutable item in EnumerateArray())
            {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetSearchCoords(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetSearchCoords.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in CanonTests31.Server.Models.JsonNumber.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in CanonTests31.Server.Models.JsonNumber.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in CanonTests31.Server.Models.JsonNumber.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in CanonTests31.Server.Models.JsonNumber item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests31.Server.Models.JsonNumber>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<CanonTests31.Server.Models.JsonNumber> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests31.Server.Models.JsonNumber>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in CanonTests31.Server.Models.JsonNumber oldItem, in CanonTests31.Server.Models.JsonNumber.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.Models.JsonNumber>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                CanonTests31.Server.Models.JsonNumber current = enumerator.Current;
        ...
        /// <summary>
        /// Gets a <see cref="GetSearchCoords"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetSearchCoords"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchCoords Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetSearchCoords>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetSearchCoords"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchCoords Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetSearchCoords>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Server.Models.GetSearchCoords.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetSearchCoords instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Server.Models.GetSearchCoords.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetSearchCoords, Mutable>(this);
    }
}
