    ...
    public static partial class JsonSchema
    {
        ...
        private static PropertySchemaMatchers<CanonTests31.Server.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<CanonTests31.Server.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.MaxUtf8, MatchMax),
                (static () => JsonPropertyNames.MinUtf8, MatchMin),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1search/get/parameters/3/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1search/get/parameters/3/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1search/get/parameters/3/schema"u8;
