...
public readonly partial struct GetSearchFilter
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetSearchFilter instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetSearchFilter"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetSearchFilter(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests31.Server.Models.JsonInteger.Mutable Max
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxUtf8, out CanonTests31.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests31.Server.Models.JsonInteger.Mutable Min
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinUtf8, out CanonTests31.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetSearchFilter(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetMax(in CanonTests31.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMin(in CanonTests31.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetSearchFilter.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetSearchFilter"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetSearchFilter"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchFilter Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetSearchFilter>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetSearchFilter"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchFilter Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetSearchFilter>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests31.Server.Models.JsonInteger.Source _createArg2;
        ...
        internal Source(CanonTests31.Server.Models.GetSearchFilter.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests31.Server.Models.JsonInteger.Source arg1, in CanonTests31.Server.Models.JsonInteger.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(GetSearchFilter instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Server.Models.GetSearchFilter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetSearchFilter"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests31.Server.Models.JsonInteger.Source max = default,
            in CanonTests31.Server.Models.JsonInteger.Source min = default)
        {
        ...
        /// Creates an instance of a <see cref="GetSearchFilter"/>.
        /// </summary>
        public void Create(in CanonTests31.Server.Models.JsonInteger.Source max = default, in CanonTests31.Server.Models.JsonInteger.Source min = default)
        {
            Create(ref _builder, max, min);
        }
        ...
        internal static void BuildCreateValue(in CanonTests31.Server.Models.JsonInteger.Source arg1, in CanonTests31.Server.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Server.Models.JsonInteger.Source max = default, in CanonTests31.Server.Models.JsonInteger.Source min = default)
    {
        return new Source(max, min);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Server.Models.JsonInteger.Source max = default, in CanonTests31.Server.Models.JsonInteger.Source min = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetSearchFilter, Mutable>(this);
    }
}
