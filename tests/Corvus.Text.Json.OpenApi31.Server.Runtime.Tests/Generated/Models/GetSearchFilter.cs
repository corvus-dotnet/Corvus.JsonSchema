...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Server.JsonInteger Max
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxUtf8, out CanonTests31.Server.JsonInteger value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests31.Server.JsonInteger Min
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinUtf8, out CanonTests31.Server.JsonInteger value))
            {
                return value;
            }
