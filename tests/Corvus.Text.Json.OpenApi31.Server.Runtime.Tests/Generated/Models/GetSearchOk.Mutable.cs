...
public readonly partial struct GetSearchOk
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests31.Server.Models.JsonInteger.Mutable NextPage
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NextPageUtf8, out CanonTests31.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        public void SetNextPage(in CanonTests31.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Server.Models.GetSearchOk.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

        internal Source(scoped in TContext context, CanonTests31.Server.Models.GetSearchOk.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
    ...
    public ref struct ObjectBuilder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests31.Server.Models.JsonInteger.Source nextPage = default)
        {
        ...
        /// Creates an instance of a <see cref="GetSearchOk"/>.
        /// </summary>
        public void Create(in CanonTests31.Server.Models.JsonInteger.Source nextPage = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Server.Models.JsonInteger.Source nextPage = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
