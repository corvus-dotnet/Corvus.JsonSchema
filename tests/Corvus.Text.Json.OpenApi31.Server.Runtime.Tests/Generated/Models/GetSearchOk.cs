...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetSearchOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetSearchOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetSearchOk DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetSearchOk left, in GetSearchOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetSearchOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetSearchOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetSearchOk(JsonElement instance)
    {
        return GetSearchOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchOk>(json, options);
    }
    ...
    /// </exception>
    public static GetSearchOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetSearchOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetSearchOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetSearchOk>(ref reader, out result);
    }
...
#if NET
    static GetSearchOk IJsonElement<GetSearchOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetSearchOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="NextPage"/>.
        /// </summary>
        public static ReadOnlySpan<byte> NextPage => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x6E, 0x65, 0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x22];
    }
}
