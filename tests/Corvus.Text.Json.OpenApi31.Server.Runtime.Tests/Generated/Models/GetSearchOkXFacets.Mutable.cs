...
public readonly partial struct GetSearchOkXFacets
{
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Server.Models.JsonString.Source category = default, in CanonTests31.Server.Models.JsonString.Source status = default)
    {
