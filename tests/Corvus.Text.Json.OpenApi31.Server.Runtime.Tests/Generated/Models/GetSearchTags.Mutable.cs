...
public readonly partial struct GetSearchTags
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetSearchTags instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetSearchTags"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetSearchTags(Mutable instance)
        {
        ...
        public CanonTests31.Server.Models.JsonString.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests31.Server.Models.JsonString.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests31.Server.Models.JsonString.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.Models.JsonString.Mutable>(_parent, _idx);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetSearchTags(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetSearchTags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in CanonTests31.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in CanonTests31.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in CanonTests31.Server.Models.JsonString.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in CanonTests31.Server.Models.JsonString item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests31.Server.Models.JsonString>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<CanonTests31.Server.Models.JsonString> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests31.Server.Models.JsonString>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in CanonTests31.Server.Models.JsonString oldItem, in CanonTests31.Server.Models.JsonString.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests31.Server.Models.JsonString>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                CanonTests31.Server.Models.JsonString current = enumerator.Current;
        ...
        /// <summary>
        /// Gets a <see cref="GetSearchTags"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetSearchTags"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchTags Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetSearchTags>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetSearchTags"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchTags Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetSearchTags>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Server.Models.GetSearchTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetSearchTags instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Server.Models.GetSearchTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetSearchTags, Mutable>(this);
    }
}
