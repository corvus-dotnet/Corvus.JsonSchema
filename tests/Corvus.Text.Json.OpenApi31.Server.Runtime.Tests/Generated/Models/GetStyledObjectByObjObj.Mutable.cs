...
public readonly partial struct GetStyledObjectByObjObj
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetStyledObjectByObjObj instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetStyledObjectByObjObj"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetStyledObjectByObjObj(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetStyledObjectByObjObj.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetStyledObjectByObjObj Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetStyledObjectByObjObj Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetStyledObjectByObjObj>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(in CanonTests31.Server.Models.JsonString.Source arg1, in CanonTests31.Server.Models.JsonInteger.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests31.Server.Models.JsonString.Source arg1, in CanonTests31.Server.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Server.Models.JsonString.Source color = default, in CanonTests31.Server.Models.JsonInteger.Source size = default)
    {
    ...
    {
        return workspace.CreateBuilder<GetStyledObjectByObjObj, Mutable>(this);
    }
}
