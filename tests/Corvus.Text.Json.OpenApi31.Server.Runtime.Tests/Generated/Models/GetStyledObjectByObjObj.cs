...
public readonly partial struct GetStyledObjectByObjObj
#if NET8_0_OR_GREATER
    : IJsonElement<GetStyledObjectByObjObj>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetStyledObjectByObjObj"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetStyledObjectByObjObj(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetStyledObjectByObjObj DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests31.Server.Models.JsonString Color
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ColorUtf8, out CanonTests31.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests31.Server.Models.JsonInteger Size
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SizeUtf8, out CanonTests31.Server.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetStyledObjectByObjObj left, in GetStyledObjectByObjObj right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetStyledObjectByObjObj left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetStyledObjectByObjObj instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetStyledObjectByObjObj(JsonElement instance)
    {
        return GetStyledObjectByObjObj.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetStyledObjectByObjObj From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetStyledObjectByObjObj ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetStyledObjectByObjObj>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetStyledObjectByObjObj ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetStyledObjectByObjObj>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetStyledObjectByObjObj ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetStyledObjectByObjObj>(json, options);
    }
    ...
    /// </exception>
    public static GetStyledObjectByObjObj ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetStyledObjectByObjObj>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetStyledObjectByObjObj? result)
    {
        return JsonElementHelpers.TryParseValue<GetStyledObjectByObjObj>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetStyledObjectByObjObj(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetStyledObjectByObjObj IJsonElement<GetStyledObjectByObjObj>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetStyledObjectByObjObj: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetStyledObjectByObjObj"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetStyledObjectByObjObj"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetStyledObjectByObjObj Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetStyledObjectByObjObj>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetStyledObjectByObjObj"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetStyledObjectByObjObj Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetStyledObjectByObjObj>(_idx);
        }
