...
public readonly partial struct JsonSingle
{
...
#endif
    {
        ...
        public static implicit operator float(Mutable value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();
        ...
        public static explicit operator Mutable(JsonSingle instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonSingle"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonSingle(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonSingle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonSingle Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonSingle Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonSingle>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private Source(float value) { SimpleTypesBacking.Initialize(ref _simpleTypeBacking, value, static (v, buffer, out written) => Utf8Formatter.TryFormat(v, buffer, out written)); _kind = Kind.NumericSimpleType; }

        public static implicit operator Source(JsonSingle instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(float value) => new (value);
    ...
    {
        return workspace.CreateBuilder<JsonSingle, Mutable>(this);
    }
}
