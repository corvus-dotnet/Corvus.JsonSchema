...
public readonly partial struct PostAttachmentsBody
{
    ...
    public ref struct Source
    {
        ...
        internal Source(in CanonTests31.Server.Models.JsonBinary.Source arg1, in CanonTests31.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests31.Server.Models.JsonBinary.Source arg1, in CanonTests31.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Server.Models.JsonBinary.Source file, in CanonTests31.Server.Models.JsonString.Source description = default)
    {
