...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Server.Models.JsonString Description
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out CanonTests31.Server.Models.JsonString value))
            {
                return value;
            }
