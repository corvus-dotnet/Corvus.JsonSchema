    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchFile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests31.Server.JsonBinary.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            CanonTests31.Server.JsonBinary.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchMetadata(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                CanonTests31.Server.PostAttachmentsEncodedBody.MetadataEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            CanonTests31.Server.PostAttachmentsEncodedBody.MetadataEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            context.CommitChildContext(childContext1.IsMatch, ref childContext1);
        }

        private static PropertySchemaMatchers<CanonTests31.Server.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<CanonTests31.Server.PropertiesValidationHandler_NamedPropertyValidator1>([
                (static () => JsonPropertyNames.FileUtf8, MatchFile),
                (static () => JsonPropertyNames.MetadataUtf8, MatchMetadata),
            ]);
        }

        private static PropertySchemaMatchers<CanonTests31.Server.PropertiesValidationHandler_NamedPropertyValidator1> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out CanonTests31.Server.PropertiesValidationHandler_NamedPropertyValidator1? matcher)
        {
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out CanonTests31.Server.PropertiesValidationHandler_NamedPropertyValidator1? validator))
                    {
