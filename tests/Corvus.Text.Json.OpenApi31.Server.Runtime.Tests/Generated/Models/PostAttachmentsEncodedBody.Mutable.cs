...
public readonly partial struct PostAttachmentsEncodedBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostAttachmentsEncodedBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostAttachmentsEncodedBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostAttachmentsEncodedBody(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Mutable Metadata
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostAttachmentsEncodedBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMetadata(in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMetadata<TContext>(in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostAttachmentsEncodedBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostAttachmentsEncodedBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostAttachmentsEncodedBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostAttachmentsEncodedBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostAttachmentsEncodedBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostAttachmentsEncodedBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostAttachmentsEncodedBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostAttachmentsEncodedBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests31.Server.Models.JsonBinary.Source _createArg1;
        private readonly CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source _createArg2;
        ...
        internal Source(CanonTests31.Server.Models.PostAttachmentsEncodedBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests31.Server.Models.JsonBinary.Source arg1, in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        private readonly CanonTests31.Server.Models.JsonBinary.Source _createArg1;
        private readonly CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> _createArg2;
        ...
        internal Source(scoped in TContext context, CanonTests31.Server.Models.PostAttachmentsEncodedBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests31.Server.Models.JsonBinary.Source arg1, in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source metadata = default)
        {
        ...
        /// Creates an instance of a <see cref="PostAttachmentsEncodedBody"/>.
        /// </summary>
        public void Create(in CanonTests31.Server.Models.JsonBinary.Source file, in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source metadata = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in CanonTests31.Server.Models.JsonBinary.Source file,
            in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> metadata = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, file, metadata);
        }
        ...
        internal static void BuildCreateValue(in CanonTests31.Server.Models.JsonBinary.Source arg1, in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests31.Server.Models.JsonBinary.Source arg1, in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Server.Models.JsonBinary.Source file, in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source metadata = default)
    {
        return new Source(file, metadata);
    }
    ...
    /// <param name="metadata">The value of the <c>"metadata"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests31.Server.Models.JsonBinary.Source file, in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> metadata = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, file, metadata);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Server.Models.JsonBinary.Source file, in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source metadata = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(file, metadata);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests31.Server.Models.JsonBinary.Source file, in CanonTests31.Server.Models.PostAttachmentsEncodedBody.MetadataEntity.Source<TContext> metadata = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, file, metadata);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostAttachmentsEncodedBody, Mutable>(this);
    }
}
