...
public readonly partial struct PostItemsBody
{
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests31.Server.Models.PostItemsBody.MetadataEntity.Source _createArg2;
        private readonly CanonTests31.Server.Models.JsonString.Source _createArg3;
        ...
        internal Source(in CanonTests31.Server.Models.JsonString.Source arg1, in CanonTests31.Server.Models.PostItemsBody.MetadataEntity.Source arg2, in CanonTests31.Server.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly CanonTests31.Server.Models.JsonString.Source _createArg1;
        private readonly CanonTests31.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> _createArg2;
        private readonly CanonTests31.Server.Models.JsonString.Source _createArg3;
        ...
        internal Source(scoped in TContext context, in CanonTests31.Server.Models.JsonString.Source arg1, in CanonTests31.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> arg2, in CanonTests31.Server.Models.JsonString.Source arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests31.Server.Models.JsonString.Source arg1, in CanonTests31.Server.Models.PostItemsBody.MetadataEntity.Source arg2, in CanonTests31.Server.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests31.Server.Models.JsonString.Source arg1, in CanonTests31.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> arg2, in CanonTests31.Server.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Server.Models.JsonString.Source name, in CanonTests31.Server.Models.PostItemsBody.MetadataEntity.Source metadata = default, in CanonTests31.Server.Models.JsonString.Source tag = default)
    {
    ...
    /// <param name="tag">The value of the <c>"tag"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests31.Server.Models.JsonString.Source name, in CanonTests31.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests31.Server.Models.JsonString.Source tag = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
