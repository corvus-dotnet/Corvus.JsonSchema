...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Server.PostItemsBody.MetadataEntity Metadata
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests31.Server.PostItemsBody.MetadataEntity value))
            {
                return value;
            }
