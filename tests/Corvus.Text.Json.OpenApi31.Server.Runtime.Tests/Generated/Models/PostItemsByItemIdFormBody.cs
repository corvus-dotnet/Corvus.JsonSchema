...
public readonly partial struct PostItemsByItemIdFormBody
#if NET8_0_OR_GREATER
    : IJsonElement<PostItemsByItemIdFormBody>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostItemsByItemIdFormBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostItemsByItemIdFormBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostItemsByItemIdFormBody DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests31.Server.Models.PostItemsByItemIdFormBody.MetadataEntity Metadata
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests31.Server.Models.PostItemsByItemIdFormBody.MetadataEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests31.Server.Models.PostItemsByItemIdFormBody.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests31.Server.Models.PostItemsByItemIdFormBody.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostItemsByItemIdFormBody left, in PostItemsByItemIdFormBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostItemsByItemIdFormBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostItemsByItemIdFormBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostItemsByItemIdFormBody(JsonElement instance)
    {
        return PostItemsByItemIdFormBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostItemsByItemIdFormBody From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostItemsByItemIdFormBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostItemsByItemIdFormBody>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostItemsByItemIdFormBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostItemsByItemIdFormBody>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostItemsByItemIdFormBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostItemsByItemIdFormBody>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static PostItemsByItemIdFormBody ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostItemsByItemIdFormBody>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostItemsByItemIdFormBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostItemsByItemIdFormBody>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PostItemsByItemIdFormBody(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PostItemsByItemIdFormBody IJsonElement<PostItemsByItemIdFormBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostItemsByItemIdFormBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PostItemsByItemIdFormBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PostItemsByItemIdFormBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PostItemsByItemIdFormBody Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PostItemsByItemIdFormBody>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PostItemsByItemIdFormBody"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PostItemsByItemIdFormBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostItemsByItemIdFormBody>(_idx);
        }
