...
public readonly partial struct PostItemsCreated
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests31.Server.Models.PostItemsCreated.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests31.Server.Models.JsonString.Source arg1, in CanonTests31.Server.Models.JsonString.Source arg2, in CanonTests31.Server.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests31.Server.Models.PostItemsCreated.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests31.Server.Models.JsonString.Source id,
        ...
        internal static void BuildCreateValue(in CanonTests31.Server.Models.JsonString.Source arg1, in CanonTests31.Server.Models.JsonString.Source arg2, in CanonTests31.Server.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests31.Server.Models.JsonString.Source id, in CanonTests31.Server.Models.JsonString.Source name, in CanonTests31.Server.Models.JsonString.Source tag = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests31.Server.Models.JsonString.Source id, in CanonTests31.Server.Models.JsonString.Source name, in CanonTests31.Server.Models.JsonString.Source tag = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
