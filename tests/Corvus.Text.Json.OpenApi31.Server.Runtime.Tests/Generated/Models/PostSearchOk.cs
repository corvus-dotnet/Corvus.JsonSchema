...
public readonly partial struct PostSearchOk
#if NET8_0_OR_GREATER
    : IJsonElement<PostSearchOk>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostSearchOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostSearchOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostSearchOk DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests31.Server.Models.PostSearchOk.ItemEntityArray Results
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResultsUtf8, out CanonTests31.Server.Models.PostSearchOk.ItemEntityArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostSearchOk left, in PostSearchOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostSearchOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostSearchOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostSearchOk(JsonElement instance)
    {
        return PostSearchOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostSearchOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostSearchOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostSearchOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostSearchOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostSearchOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostSearchOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostSearchOk>(json, options);
    }
    ...
    /// </exception>
    public static PostSearchOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostSearchOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostSearchOk? result)
    {
        return JsonElementHelpers.TryParseValue<PostSearchOk>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PostSearchOk(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PostSearchOk IJsonElement<PostSearchOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostSearchOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PostSearchOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PostSearchOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PostSearchOk Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PostSearchOk>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PostSearchOk"/> that lives for the lifetime of its
