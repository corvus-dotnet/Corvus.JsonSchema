...
#endif
{
    ...
    /// </summary>
    public CanonTests31.Server.PostSearchOk.ItemEntityArray Results
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResultsUtf8, out CanonTests31.Server.PostSearchOk.ItemEntityArray value))
            {
                return value;
            }
