...
public readonly struct SearchItemsResult
{
    ...
    public static SearchItemsResult Ok(CanonTests31.Server.GetSearchOk.Source body, JsonWorkspace workspace, CanonTests31.Server.GetSearchOkXFacets xFacets = default) => new(200, CanonTests31.Server.GetSearchOk.CreateBuilder(workspace, body, 0).RootElement, "application/json", xFacets: xFacets);
