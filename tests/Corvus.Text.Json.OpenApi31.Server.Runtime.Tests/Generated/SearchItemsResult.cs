...
public readonly struct SearchItemsResult
{
    ...
    public static SearchItemsResult Ok(CanonTests31.Server.Models.GetSearchOk.Source body, JsonWorkspace workspace, CanonTests31.Server.Models.GetSearchOkXFacets xFacets = default) => new(200, CanonTests31.Server.Models.GetSearchOk.CreateBuilder(workspace, body, 30).RootElement, "application/json", xFacets: xFacets);
