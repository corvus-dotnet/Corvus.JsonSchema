...
{
    private SearchItemsResult(int statusCode, JsonElement body, string? contentType, CanonTests31.Server.Models.GetSearchOkXFacets xFacets = default)
    {
    ...
    /// </summary>
    public CanonTests31.Server.Models.GetSearchOkXFacets XFacets { get; }
    ...
    public static SearchItemsResult Ok(CanonTests31.Server.Models.GetSearchOk.Source body, JsonWorkspace workspace, CanonTests31.Server.Models.GetSearchOkXFacets.Source xFacets = default) => new(200, CanonTests31.Server.Models.GetSearchOk.CreateBuilder(workspace, body, 30).RootElement, "application/json", xFacets: xFacets.IsUndefined ? default : CanonTests31.Server.Models.GetSearchOkXFacets.CreateBuilder(workspace, xFacets, 30).RootElement);
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => CanonTests31.Server.Models.GetSearchOk.From(this.Body).EvaluateSchema(),
            _ => true,
        };
    }
