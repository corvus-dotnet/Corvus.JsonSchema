...
/// <summary>
/// Request type for the ChatCompletions operation.
/// </summary>
/// <remarks>Chat completions with streaming response via SSE itemSchema</remarks>
public readonly struct ChatCompletionsRequest : IApiRequest<ChatCompletionsRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/chat/completions"u8;
