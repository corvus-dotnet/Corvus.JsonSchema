...
/// <summary>
/// Response type for the CookieArray operation.
/// </summary>
public struct CookieArrayResponse : IApiResponse<CookieArrayResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CookieArrayResponse> CreateAsync(
        int statusCode,
    ...
    {
        CookieArrayResponse response = default;
