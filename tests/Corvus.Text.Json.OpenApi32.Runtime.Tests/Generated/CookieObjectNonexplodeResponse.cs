...
/// <summary>
/// Response type for the CookieObjectNonexplode operation.
/// </summary>
public struct CookieObjectNonexplodeResponse : IApiResponse<CookieObjectNonexplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<CookieObjectNonexplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        CookieObjectNonexplodeResponse response = default;
