...
public struct DeleteItemResponse : IApiResponse<DeleteItemResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.DeleteItemsByItemIdNotFound NotFoundBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests32.Client.DeleteItemsByItemIdNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetNotFound(out CanonTests32.Client.DeleteItemsByItemIdNotFound result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.DeleteItemsByItemIdNotFound, TResult> matchNotFound,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.DeleteItemsByItemIdNotFound, TContext, TResult> matchNotFound,
