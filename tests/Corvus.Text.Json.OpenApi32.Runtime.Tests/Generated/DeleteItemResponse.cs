...
/// <summary>
/// Response type for the DeleteItem operation.
/// </summary>
public struct DeleteItemResponse : IApiResponse<DeleteItemResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.Models.DeleteItemsByItemIdNotFound NotFoundBody { get; private set; }
    ...
    {
        DeleteItemResponse response = default;
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests32.Client.Models.DeleteItemsByItemIdNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetNotFound(out CanonTests32.Client.Models.DeleteItemsByItemIdNotFound result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.Models.DeleteItemsByItemIdNotFound, TResult> matchNotFound,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.Models.DeleteItemsByItemIdNotFound, TContext, TResult> matchNotFound,
