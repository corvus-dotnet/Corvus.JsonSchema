...
/// <summary>
/// Request type for the DownloadMixed operation.
/// </summary>
/// <remarks>Download file with mixed content types (binary or JSON error)</remarks>
public readonly struct DownloadMixedRequest : IApiRequest<DownloadMixedRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/files/download-mixed"u8;
