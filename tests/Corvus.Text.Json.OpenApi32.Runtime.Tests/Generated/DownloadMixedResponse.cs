...
public struct DownloadMixedResponse : IApiResponse<DownloadMixedResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.GetFilesDownloadMixedNotFound NotFoundBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests32.Client.GetFilesDownloadMixedNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetNotFound(out CanonTests32.Client.GetFilesDownloadMixedNotFound result)
    {
    ...
    public TResult MatchResult<TResult>(
        ...
        ResponseMatcher<CanonTests32.Client.GetFilesDownloadMixedNotFound, TResult> matchNotFound,
    ...
    public TResult MatchResult<TContext, TResult>(
        ...
        ResponseMatcher<CanonTests32.Client.GetFilesDownloadMixedNotFound, TContext, TResult> matchNotFound,
