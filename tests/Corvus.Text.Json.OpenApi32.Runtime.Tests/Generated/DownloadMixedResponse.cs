...
public struct DownloadMixedResponse : IApiResponse<DownloadMixedResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.Models.GetFilesDownloadMixedNotFound NotFoundBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests32.Client.Models.GetFilesDownloadMixedNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetNotFound(out CanonTests32.Client.Models.GetFilesDownloadMixedNotFound result)
    {
    ...
    public TResult MatchResult<TResult>(
        ...
        ResponseMatcher<CanonTests32.Client.Models.GetFilesDownloadMixedNotFound, TResult> matchNotFound,
    ...
    public TResult MatchResult<TContext, TResult>(
        ...
        ResponseMatcher<CanonTests32.Client.Models.GetFilesDownloadMixedNotFound, TContext, TResult> matchNotFound,
