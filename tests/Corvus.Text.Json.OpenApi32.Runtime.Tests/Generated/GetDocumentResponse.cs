...
public struct GetDocumentResponse : IApiResponse<GetDocumentResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.GetDocumentsByDocPathOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.GetDocumentsByDocPathOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.GetDocumentsByDocPathOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.GetDocumentsByDocPathOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.GetDocumentsByDocPathOk, TContext, TResult> matchOk,
