...
/// <summary>
/// Response type for the GetDocument operation.
/// </summary>
public struct GetDocumentResponse : IApiResponse<GetDocumentResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.Models.GetDocumentsByDocPathOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<GetDocumentResponse> CreateAsync(
        int statusCode,
    ...
    {
        GetDocumentResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.Models.GetDocumentsByDocPathOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.Models.GetDocumentsByDocPathOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.Models.GetDocumentsByDocPathOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.Models.GetDocumentsByDocPathOk, TContext, TResult> matchOk,
