...
public struct GetItemResponse : IApiResponse<GetItemResponse>
{
    ...
    /// The requested item
    /// </summary>
    public CanonTests32.Client.Models.GetItemsByItemIdOk OkBody { get; private set; }

    /// <summary>
    /// Item not found
    /// </summary>
    public CanonTests32.Client.Models.GetItemsByItemIdNotFound NotFoundBody { get; private set; }

    /// <summary>
    /// Gets the default response body.
    /// </summary>
    public CanonTests32.Client.Models.GetItemsByItemIdDefault DefaultBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.Models.GetItemsByItemIdOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
        ...
        if (statusCode == 404)
        {
            var notFoundDoc = await ParsedJsonDocument<CanonTests32.Client.Models.GetItemsByItemIdNotFound>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
            response.parsedDocument = notFoundDoc;
            response.NotFoundBody = notFoundDoc.RootElement;
            return response;
        }

        var defaultDoc = await ParsedJsonDocument<CanonTests32.Client.Models.GetItemsByItemIdDefault>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.Models.GetItemsByItemIdOk result)
    {
    ...
    public bool TryGetNotFound(out CanonTests32.Client.Models.GetItemsByItemIdNotFound result)
    {
    ...
    public bool TryGetDefault(out CanonTests32.Client.Models.GetItemsByItemIdDefault result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.Models.GetItemsByItemIdOk, TResult> matchOk,
        ResponseMatcher<CanonTests32.Client.Models.GetItemsByItemIdNotFound, TResult> matchNotFound,
        ResponseMatcher<CanonTests32.Client.Models.GetItemsByItemIdDefault, TResult> matchDefault)
    {
        if (this.StatusCode == 200)
        {
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.Models.GetItemsByItemIdOk, TContext, TResult> matchOk,
        ResponseMatcher<CanonTests32.Client.Models.GetItemsByItemIdNotFound, TContext, TResult> matchNotFound,
        ResponseMatcher<CanonTests32.Client.Models.GetItemsByItemIdDefault, TContext, TResult> matchDefault)
    ...
    public readonly struct GetItemResponseLinksAccessor
    {
        ...
        /// </summary>
        public ValueTask<GetItemResponse> RefreshItemAsync(CanonTests32.Client.Models.JsonString.Source filter = default, CanonTests32.Client.Models.JsonInt32.Source limit = default, CanonTests32.Client.Models.JsonBoolean.Source verbose = default, CanonTests32.Client.Models.JsonString.Source xRequestId = default, CancellationToken cancellationToken = default)
        {
            JsonWorkspace workspace = JsonWorkspace.CreateUnrented();
            GetItemRequest request = new()
            {
                ItemId = CanonTests32.Client.Models.JsonString.From(this.response.sourceRequest.ItemId),
