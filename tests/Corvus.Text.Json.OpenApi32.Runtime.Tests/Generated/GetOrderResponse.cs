...
public struct GetOrderResponse : IApiResponse<GetOrderResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.GetOrdersByOrderIdOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.GetOrdersByOrderIdOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.GetOrdersByOrderIdOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.GetOrdersByOrderIdOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.GetOrdersByOrderIdOk, TContext, TResult> matchOk,
