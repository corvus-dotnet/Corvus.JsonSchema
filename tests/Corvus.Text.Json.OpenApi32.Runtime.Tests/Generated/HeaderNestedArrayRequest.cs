...
/// <summary>
/// Request type for the HeaderNestedArray operation.
/// </summary>
/// <remarks>Response with deeply nested array header (triggers StyleValueSplitter)</remarks>
public readonly struct HeaderNestedArrayRequest : IApiRequest<HeaderNestedArrayRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/complex/header-nested-array"u8;
