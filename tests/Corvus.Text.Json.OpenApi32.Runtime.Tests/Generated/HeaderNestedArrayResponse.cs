...
/// <summary>
/// Response type for the HeaderNestedArray operation.
/// </summary>
public struct HeaderNestedArrayResponse : IApiResponse<HeaderNestedArrayResponse>
{
    ...
    public CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems XNestedItemsHeader
    {
        get
        {
            if (this.xNestedItemsHeaderParsed)
            {
                return this.xNestedItemsHeaderValue;
            }

            this.xNestedItemsHeaderParsed = true;
                ...
                && rawValue is not null)
            {
                this.xNestedItemsHeaderValue = CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.CreateBuilder<string>(this.workspace, rawValue, static (in string ctx, ref CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.Builder arrayBuilder) =>
                {
                    ...
                    {
                        int commaIdx = Corvus.Text.Json.OpenApi.StyleValueSplitter.NextSeparator(remaining);
                        System.ReadOnlySpan<char> element = commaIdx >= 0 ? remaining.Slice(0, commaIdx).Trim() : remaining.Trim();
                        arrayBuilder._builder.AddItemFromJson(element);
    ...
    /// <inheritdoc/>
    public static async ValueTask<HeaderNestedArrayResponse> CreateAsync(
        int statusCode,
    ...
    {
        HeaderNestedArrayResponse response = default;
