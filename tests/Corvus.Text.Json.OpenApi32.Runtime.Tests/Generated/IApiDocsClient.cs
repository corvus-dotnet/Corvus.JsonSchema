...
public interface IApiDocsClient : IAsyncDisposable
{
    ...
    {
        /// <summary>
        /// Gets the scopes required by <c>UploadDocMixed</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] UploadDocMixedOauth2Scopes = ["read"];

        /// <summary>
        /// Gets the scopes required by <c>ProcessBatch</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] ProcessBatchOauth2Scopes = ["read"];
