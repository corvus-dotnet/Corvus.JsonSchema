...
public interface IApiFilesClient : IAsyncDisposable
{
    ...
    {
        /// <summary>
        /// Gets the scopes required by <c>DownloadFile</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] DownloadFileOauth2Scopes = ["read"];

        /// <summary>
        /// Gets the scopes required by <c>UploadFile</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] UploadFileOauth2Scopes = ["read"];

        /// <summary>
        /// Gets the scopes required by <c>DownloadMixed</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] DownloadMixedOauth2Scopes = ["read"];

        /// <summary>
        /// Gets the scopes required by <c>GetVendorJson</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] GetVendorJsonOauth2Scopes = ["read"];
