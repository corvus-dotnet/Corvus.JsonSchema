...
public interface IApiSearchClient : IAsyncDisposable
{
    ...
    {
        /// <summary>
        /// Gets the scopes required by <c>Search</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] SearchOauth2Scopes = ["read"];

        /// <summary>
        /// Gets the scopes required by <c>QuerySearch</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] QuerySearchOauth2Scopes = ["read"];

        /// <summary>
        /// Gets the scopes required by <c>SearchWithQuerystring</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] SearchWithQuerystringOauth2Scopes = ["read"];
