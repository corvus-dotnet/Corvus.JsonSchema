...
/// <summary>
/// Client interface for the ApiStreaming API operations.
/// </summary>
public interface IApiStreamingClient : IAsyncDisposable
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Gets the scopes required by <c>StreamEvents</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] StreamEventsOauth2Scopes = ["read"];

        /// <summary>
        /// Gets the scopes required by <c>ChatCompletions</c> for the <c>Oauth2</c> scheme.
        /// </summary>
        public static readonly string[] ChatCompletionsOauth2Scopes = ["read"];
    ...
    ValueTask<StreamEventsResponse> StreamEventsAsync(CancellationToken cancellationToken = default, ValidationMode validationMode = ValidationMode.Basic, ValidationMode responseValidationMode = ValidationMode.None);
