...
public readonly partial struct DeleteItemsByItemIdNotFound
{
...
#endif
    {
        ...
        public static explicit operator Mutable(DeleteItemsByItemIdNotFound instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="DeleteItemsByItemIdNotFound"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DeleteItemsByItemIdNotFound(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonInt32.Mutable Code
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out CanonTests32.Client.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DeleteItemsByItemIdNotFound(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCode(in CanonTests32.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("code");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(in CanonTests32.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DeleteItemsByItemIdNotFound.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DeleteItemsByItemIdNotFound"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DeleteItemsByItemIdNotFound"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly DeleteItemsByItemIdNotFound Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DeleteItemsByItemIdNotFound>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DeleteItemsByItemIdNotFound"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly DeleteItemsByItemIdNotFound Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<DeleteItemsByItemIdNotFound>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.DeleteItemsByItemIdNotFound.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.JsonInt32.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.DeleteItemsByItemIdNotFound.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="DeleteItemsByItemIdNotFound"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.JsonInt32.Source code,
            in CanonTests32.Client.Models.JsonString.Source message)
        {
        ...
        /// Creates an instance of a <see cref="DeleteItemsByItemIdNotFound"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonInt32.Source code, in CanonTests32.Client.Models.JsonString.Source message)
        {
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonInt32.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonInt32.Source code, in CanonTests32.Client.Models.JsonString.Source message)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonInt32.Source code, in CanonTests32.Client.Models.JsonString.Source message, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(code, message);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<DeleteItemsByItemIdNotFound, Mutable>(this);
    }
}
