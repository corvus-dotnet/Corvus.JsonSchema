...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonInt32 Code
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out CanonTests32.Client.Models.JsonInt32 value))
            {
                return value;
            }
