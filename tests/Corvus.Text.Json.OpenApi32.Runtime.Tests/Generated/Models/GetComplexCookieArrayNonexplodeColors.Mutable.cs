...
public readonly partial struct GetComplexCookieArrayNonexplodeColors
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexCookieArrayNonexplodeColors instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexCookieArrayNonexplodeColors"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexCookieArrayNonexplodeColors(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexCookieArrayNonexplodeColors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexCookieArrayNonexplodeColors Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexCookieArrayNonexplodeColors Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexCookieArrayNonexplodeColors>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetComplexCookieArrayNonexplodeColors.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexCookieArrayNonexplodeColors instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexCookieArrayNonexplodeColors.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexCookieArrayNonexplodeColors, Mutable>(this);
    }
}
