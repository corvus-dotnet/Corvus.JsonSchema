...
public readonly partial struct GetComplexHeaderNestedArrayOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexHeaderNestedArrayOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexHeaderNestedArrayOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexHeaderNestedArrayOk(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexHeaderNestedArrayOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexHeaderNestedArrayOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexHeaderNestedArrayOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexHeaderNestedArrayOk>(_idx);
        }
    }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonBoolean.Source ok = default)
    {
    ...
    {
        return workspace.CreateBuilder<GetComplexHeaderNestedArrayOk, Mutable>(this);
    }
}
