...
public readonly partial struct GetComplexHeaderNestedArrayOk
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexHeaderNestedArrayOk>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexHeaderNestedArrayOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexHeaderNestedArrayOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexHeaderNestedArrayOk DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexHeaderNestedArrayOk left, in GetComplexHeaderNestedArrayOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexHeaderNestedArrayOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexHeaderNestedArrayOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexHeaderNestedArrayOk(JsonElement instance)
    {
        return GetComplexHeaderNestedArrayOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderNestedArrayOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderNestedArrayOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderNestedArrayOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderNestedArrayOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderNestedArrayOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderNestedArrayOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderNestedArrayOk>(json, options);
    }
    ...
    /// </exception>
    public static GetComplexHeaderNestedArrayOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderNestedArrayOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexHeaderNestedArrayOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexHeaderNestedArrayOk>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexHeaderNestedArrayOk(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexHeaderNestedArrayOk IJsonElement<GetComplexHeaderNestedArrayOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexHeaderNestedArrayOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexHeaderNestedArrayOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexHeaderNestedArrayOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexHeaderNestedArrayOk Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexHeaderNestedArrayOk>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexHeaderNestedArrayOk"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexHeaderNestedArrayOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexHeaderNestedArrayOk>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Ok"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Ok"/>.
        /// </summary>
        public static ReadOnlySpan<byte> OkUtf8 => "ok"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Ok"/>.
        /// </summary>
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Ok"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Ok => [0x45, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x6B, 0x22];
    }
}
