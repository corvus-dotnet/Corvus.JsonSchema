    ...
    : IJsonElement<GetComplexHeaderNestedArrayOkXNestedItems>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1complex~1header-nested-array/get/responses/200/headers/X-Nested-Items/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1complex~1header-nested-array/get/responses/200/headers/X-Nested-Items/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1complex~1header-nested-array/get/responses/200/headers/X-Nested-Items/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
