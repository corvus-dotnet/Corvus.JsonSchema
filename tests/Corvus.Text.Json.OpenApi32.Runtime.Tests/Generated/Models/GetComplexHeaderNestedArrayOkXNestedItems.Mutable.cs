...
public readonly partial struct GetComplexHeaderNestedArrayOkXNestedItems
{
...
#endif
    {
        ...
        public CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity oldItem, in CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity current = enumerator.Current;
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
