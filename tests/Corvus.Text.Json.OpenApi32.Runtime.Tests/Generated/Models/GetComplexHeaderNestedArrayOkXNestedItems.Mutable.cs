...
public readonly partial struct GetComplexHeaderNestedArrayOkXNestedItems
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexHeaderNestedArrayOkXNestedItems instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexHeaderNestedArrayOkXNestedItems"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexHeaderNestedArrayOkXNestedItems(Mutable instance)
        {
        ...
        public CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Mutable>(_parent, _idx);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetComplexHeaderNestedArrayOkXNestedItems(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexHeaderNestedArrayOkXNestedItems.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity oldItem, in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity current = enumerator.Current;
        ...
        /// <summary>
        /// Gets a <see cref="GetComplexHeaderNestedArrayOkXNestedItems"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetComplexHeaderNestedArrayOkXNestedItems"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexHeaderNestedArrayOkXNestedItems Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetComplexHeaderNestedArrayOkXNestedItems>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetComplexHeaderNestedArrayOkXNestedItems"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexHeaderNestedArrayOkXNestedItems Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexHeaderNestedArrayOkXNestedItems>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexHeaderNestedArrayOkXNestedItems instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// Add an item to the array.
        /// </summary>
        public void AddItem<TContext>(in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    {
        return workspace.CreateBuilder<GetComplexHeaderNestedArrayOkXNestedItems, Mutable>(this);
    }
}
