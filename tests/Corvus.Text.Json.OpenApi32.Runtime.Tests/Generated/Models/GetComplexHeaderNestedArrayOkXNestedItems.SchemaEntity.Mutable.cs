...
public readonly partial struct GetComplexHeaderNestedArrayOkXNestedItems
{
    ...
    public readonly partial struct SchemaEntity
    {
        ...
        public ref struct Source
        {
            ...
            private readonly CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonStringArray.Source _createArg2;
            ...
            internal Source(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonStringArray.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            private readonly CanonTests32.Client.Models.JsonString.Source _createArg1;
            private readonly CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonStringArray.Source<TContext> _createArg2;
            ...
            internal Source(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonStringArray.Source<TContext> arg2)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            #endif
            {
                Create(context, ref _builder, id, tags);
            }
            ...
            internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonStringArray.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg2">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonStringArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in CanonTests32.Client.Models.JsonString.Source id = default, in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonStringArray.Source tags = default)
        {
            return new Source(id, tags);
        }
        ...
        /// <param name="tags">The value of the <c>"tags"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source id = default, in CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity.JsonStringArray.Source<TContext> tags = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, id, tags);
        }
