...
#endif
{
    ...
    public CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(_parent, _idx);
    }
