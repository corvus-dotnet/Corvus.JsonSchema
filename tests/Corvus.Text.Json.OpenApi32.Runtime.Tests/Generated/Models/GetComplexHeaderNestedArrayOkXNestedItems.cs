...
public readonly partial struct GetComplexHeaderNestedArrayOkXNestedItems
    ...
    : IJsonElement<GetComplexHeaderNestedArrayOkXNestedItems>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexHeaderNestedArrayOkXNestedItems"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexHeaderNestedArrayOkXNestedItems(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexHeaderNestedArrayOkXNestedItems DefaultInstance { get; }
    ...
    public CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.Models.GetComplexHeaderNestedArrayOkXNestedItems.SchemaEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexHeaderNestedArrayOkXNestedItems left, in GetComplexHeaderNestedArrayOkXNestedItems right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexHeaderNestedArrayOkXNestedItems left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexHeaderNestedArrayOkXNestedItems instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexHeaderNestedArrayOkXNestedItems(JsonElement instance)
    {
        return GetComplexHeaderNestedArrayOkXNestedItems.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderNestedArrayOkXNestedItems From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderNestedArrayOkXNestedItems ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderNestedArrayOkXNestedItems>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderNestedArrayOkXNestedItems ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderNestedArrayOkXNestedItems>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderNestedArrayOkXNestedItems ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderNestedArrayOkXNestedItems>(json, options);
    }
    ...
    /// </exception>
    public static GetComplexHeaderNestedArrayOkXNestedItems ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderNestedArrayOkXNestedItems>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexHeaderNestedArrayOkXNestedItems? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexHeaderNestedArrayOkXNestedItems>(ref reader, out result);
    }
...
#if NET
    static GetComplexHeaderNestedArrayOkXNestedItems IJsonElement<GetComplexHeaderNestedArrayOkXNestedItems>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexHeaderNestedArrayOkXNestedItems: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetComplexHeaderNestedArrayOkXNestedItems Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetComplexHeaderNestedArrayOkXNestedItems Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexHeaderNestedArrayOkXNestedItems>(_idx);
        }
