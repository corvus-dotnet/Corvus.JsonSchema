...
public readonly partial struct GetComplexHeaderObjectExplodeXDims
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexHeaderObjectExplodeXDims>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexHeaderObjectExplodeXDims"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexHeaderObjectExplodeXDims(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexHeaderObjectExplodeXDims DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexHeaderObjectExplodeXDims left, in GetComplexHeaderObjectExplodeXDims right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexHeaderObjectExplodeXDims left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexHeaderObjectExplodeXDims instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexHeaderObjectExplodeXDims(JsonElement instance)
    {
        return GetComplexHeaderObjectExplodeXDims.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderObjectExplodeXDims From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderObjectExplodeXDims ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderObjectExplodeXDims>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderObjectExplodeXDims ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderObjectExplodeXDims>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexHeaderObjectExplodeXDims ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderObjectExplodeXDims>(json, options);
    }
    ...
    /// </exception>
    public static GetComplexHeaderObjectExplodeXDims ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetComplexHeaderObjectExplodeXDims>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexHeaderObjectExplodeXDims? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexHeaderObjectExplodeXDims>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexHeaderObjectExplodeXDims(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexHeaderObjectExplodeXDims IJsonElement<GetComplexHeaderObjectExplodeXDims>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexHeaderObjectExplodeXDims: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexHeaderObjectExplodeXDims"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexHeaderObjectExplodeXDims"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexHeaderObjectExplodeXDims Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexHeaderObjectExplodeXDims>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexHeaderObjectExplodeXDims"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexHeaderObjectExplodeXDims Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexHeaderObjectExplodeXDims>(_idx);
        }
