...
public readonly partial struct GetComplexPathArrayLabelByIdsIds
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.GetComplexPathArrayLabelByIdsIds.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.GetComplexPathArrayLabelByIdsIds.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
