...
public readonly partial struct GetComplexPathArrayLabelByIdsIds
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexPathArrayLabelByIdsIds instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexPathArrayLabelByIdsIds"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexPathArrayLabelByIdsIds(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexPathArrayLabelByIdsIds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathArrayLabelByIdsIds Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathArrayLabelByIdsIds Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexPathArrayLabelByIdsIds>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetComplexPathArrayLabelByIdsIds.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexPathArrayLabelByIdsIds instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexPathArrayLabelByIdsIds.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexPathArrayLabelByIdsIds, Mutable>(this);
    }
}
