...
public readonly partial struct GetComplexPathArrayMatrixByIdsIds
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexPathArrayMatrixByIdsIds instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexPathArrayMatrixByIdsIds"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexPathArrayMatrixByIdsIds(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexPathArrayMatrixByIdsIds.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathArrayMatrixByIdsIds Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathArrayMatrixByIdsIds Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexPathArrayMatrixByIdsIds>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetComplexPathArrayMatrixByIdsIds.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexPathArrayMatrixByIdsIds instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexPathArrayMatrixByIdsIds.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexPathArrayMatrixByIdsIds, Mutable>(this);
    }
}
