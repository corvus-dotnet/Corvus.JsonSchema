...
public readonly partial struct GetComplexPathObjectLabelExplodeByDimsDims
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexPathObjectLabelExplodeByDimsDims instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexPathObjectLabelExplodeByDimsDims"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexPathObjectLabelExplodeByDimsDims(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetComplexPathObjectLabelExplodeByDimsDims(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexPathObjectLabelExplodeByDimsDims.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetComplexPathObjectLabelExplodeByDimsDims"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetComplexPathObjectLabelExplodeByDimsDims"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathObjectLabelExplodeByDimsDims Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetComplexPathObjectLabelExplodeByDimsDims>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetComplexPathObjectLabelExplodeByDimsDims"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexPathObjectLabelExplodeByDimsDims Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexPathObjectLabelExplodeByDimsDims>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetComplexPathObjectLabelExplodeByDimsDims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexPathObjectLabelExplodeByDimsDims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexPathObjectLabelExplodeByDimsDims, Mutable>(this);
    }
}
