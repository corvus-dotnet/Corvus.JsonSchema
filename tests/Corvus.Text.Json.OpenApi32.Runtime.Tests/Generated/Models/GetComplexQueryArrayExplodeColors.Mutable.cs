...
public readonly partial struct GetComplexQueryArrayExplodeColors
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexQueryArrayExplodeColors instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexQueryArrayExplodeColors"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexQueryArrayExplodeColors(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexQueryArrayExplodeColors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryArrayExplodeColors Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryArrayExplodeColors Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexQueryArrayExplodeColors>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetComplexQueryArrayExplodeColors.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexQueryArrayExplodeColors instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexQueryArrayExplodeColors.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexQueryArrayExplodeColors, Mutable>(this);
    }
}
