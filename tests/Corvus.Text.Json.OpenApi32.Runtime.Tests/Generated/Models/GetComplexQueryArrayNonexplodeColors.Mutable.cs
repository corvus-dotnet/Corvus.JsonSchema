...
public readonly partial struct GetComplexQueryArrayNonexplodeColors
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexQueryArrayNonexplodeColors instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexQueryArrayNonexplodeColors"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexQueryArrayNonexplodeColors(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexQueryArrayNonexplodeColors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryArrayNonexplodeColors Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryArrayNonexplodeColors Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexQueryArrayNonexplodeColors>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetComplexQueryArrayNonexplodeColors.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexQueryArrayNonexplodeColors instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexQueryArrayNonexplodeColors.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexQueryArrayNonexplodeColors, Mutable>(this);
    }
}
