...
public readonly partial struct GetComplexQueryArrayPipeColors
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexQueryArrayPipeColors instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexQueryArrayPipeColors"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexQueryArrayPipeColors(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexQueryArrayPipeColors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryArrayPipeColors Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryArrayPipeColors Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexQueryArrayPipeColors>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetComplexQueryArrayPipeColors.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexQueryArrayPipeColors instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexQueryArrayPipeColors.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexQueryArrayPipeColors, Mutable>(this);
    }
}
