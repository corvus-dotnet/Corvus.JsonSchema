...
public readonly partial struct GetComplexQueryArrayPipeColors
#if NET8_0_OR_GREATER
    : IJsonElement<GetComplexQueryArrayPipeColors>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexQueryArrayPipeColors"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexQueryArrayPipeColors(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexQueryArrayPipeColors DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexQueryArrayPipeColors left, in GetComplexQueryArrayPipeColors right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexQueryArrayPipeColors left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexQueryArrayPipeColors instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexQueryArrayPipeColors(JsonElement instance)
    {
        return GetComplexQueryArrayPipeColors.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryArrayPipeColors From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryArrayPipeColors ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexQueryArrayPipeColors>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryArrayPipeColors ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexQueryArrayPipeColors>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryArrayPipeColors ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetComplexQueryArrayPipeColors>(json, options);
    }
    ...
    /// </exception>
    public static GetComplexQueryArrayPipeColors ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetComplexQueryArrayPipeColors>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexQueryArrayPipeColors? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexQueryArrayPipeColors>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetComplexQueryArrayPipeColors(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetComplexQueryArrayPipeColors IJsonElement<GetComplexQueryArrayPipeColors>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexQueryArrayPipeColors: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetComplexQueryArrayPipeColors"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetComplexQueryArrayPipeColors"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetComplexQueryArrayPipeColors Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetComplexQueryArrayPipeColors>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetComplexQueryArrayPipeColors"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetComplexQueryArrayPipeColors Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexQueryArrayPipeColors>(_idx);
        }
