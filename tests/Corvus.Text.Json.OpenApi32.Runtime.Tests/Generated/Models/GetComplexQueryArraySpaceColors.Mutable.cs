...
public readonly partial struct GetComplexQueryArraySpaceColors
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexQueryArraySpaceColors instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexQueryArraySpaceColors"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexQueryArraySpaceColors(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexQueryArraySpaceColors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryArraySpaceColors Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryArraySpaceColors Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexQueryArraySpaceColors>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetComplexQueryArraySpaceColors.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetComplexQueryArraySpaceColors instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexQueryArraySpaceColors.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetComplexQueryArraySpaceColors, Mutable>(this);
    }
}
