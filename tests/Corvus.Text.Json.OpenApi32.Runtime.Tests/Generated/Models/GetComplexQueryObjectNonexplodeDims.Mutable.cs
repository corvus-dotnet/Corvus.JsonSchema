...
public readonly partial struct GetComplexQueryObjectNonexplodeDims
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetComplexQueryObjectNonexplodeDims instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetComplexQueryObjectNonexplodeDims"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetComplexQueryObjectNonexplodeDims(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Client.Models.JsonInt32.Mutable Height
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeightUtf8, out CanonTests32.Client.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Client.Models.JsonInt32.Mutable Width
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WidthUtf8, out CanonTests32.Client.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetComplexQueryObjectNonexplodeDims(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetHeight(in CanonTests32.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetWidth(in CanonTests32.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetComplexQueryObjectNonexplodeDims.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetComplexQueryObjectNonexplodeDims"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetComplexQueryObjectNonexplodeDims"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryObjectNonexplodeDims Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetComplexQueryObjectNonexplodeDims>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetComplexQueryObjectNonexplodeDims"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetComplexQueryObjectNonexplodeDims Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetComplexQueryObjectNonexplodeDims>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.JsonInt32.Source _createArg1;
        ...
        internal Source(CanonTests32.Client.Models.GetComplexQueryObjectNonexplodeDims.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.JsonInt32.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(GetComplexQueryObjectNonexplodeDims instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetComplexQueryObjectNonexplodeDims.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetComplexQueryObjectNonexplodeDims"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.JsonInt32.Source height = default,
            in CanonTests32.Client.Models.JsonInt32.Source width = default)
        {
        ...
        /// Creates an instance of a <see cref="GetComplexQueryObjectNonexplodeDims"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonInt32.Source height = default, in CanonTests32.Client.Models.JsonInt32.Source width = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonInt32.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonInt32.Source height = default, in CanonTests32.Client.Models.JsonInt32.Source width = default)
    {
        return new Source(height, width);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonInt32.Source height = default, in CanonTests32.Client.Models.JsonInt32.Source width = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(height, width);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<GetComplexQueryObjectNonexplodeDims, Mutable>(this);
    }
}
