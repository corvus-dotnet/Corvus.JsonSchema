...
public readonly partial struct GetComplexQueryObjectNonexplodeDims
    ...
    : IJsonElement<GetComplexQueryObjectNonexplodeDims>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetComplexQueryObjectNonexplodeDims"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetComplexQueryObjectNonexplodeDims(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetComplexQueryObjectNonexplodeDims DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetComplexQueryObjectNonexplodeDims left, in GetComplexQueryObjectNonexplodeDims right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetComplexQueryObjectNonexplodeDims left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetComplexQueryObjectNonexplodeDims instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetComplexQueryObjectNonexplodeDims(JsonElement instance)
    {
        return GetComplexQueryObjectNonexplodeDims.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryObjectNonexplodeDims From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryObjectNonexplodeDims ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexQueryObjectNonexplodeDims>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryObjectNonexplodeDims ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexQueryObjectNonexplodeDims>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetComplexQueryObjectNonexplodeDims ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexQueryObjectNonexplodeDims>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetComplexQueryObjectNonexplodeDims ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetComplexQueryObjectNonexplodeDims>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetComplexQueryObjectNonexplodeDims? result)
    {
        return JsonElementHelpers.TryParseValue<GetComplexQueryObjectNonexplodeDims>(ref reader, out result);
    }
...
#if NET
    static GetComplexQueryObjectNonexplodeDims IJsonElement<GetComplexQueryObjectNonexplodeDims>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetComplexQueryObjectNonexplodeDims: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetComplexQueryObjectNonexplodeDims Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetComplexQueryObjectNonexplodeDims Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetComplexQueryObjectNonexplodeDims>(_idx);
        }
