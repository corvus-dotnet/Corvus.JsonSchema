...
public readonly partial struct GetDocumentsByDocPathOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetDocumentsByDocPathOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetDocumentsByDocPathOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetDocumentsByDocPathOk(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetDocumentsByDocPathOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetDocumentsByDocPathOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetDocumentsByDocPathOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetDocumentsByDocPathOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetDocumentsByDocPathOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetDocumentsByDocPathOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetDocumentsByDocPathOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetDocumentsByDocPathOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetDocumentsByDocPathOk>(_idx);
        }
    }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source content, in CanonTests32.Client.Models.JsonString.Source path)
    {
    ...
    {
        return workspace.CreateBuilder<GetDocumentsByDocPathOk, Mutable>(this);
    }
}
