...
public readonly partial struct GetEventsStreamUnauthorized
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetEventsStreamUnauthorized instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetEventsStreamUnauthorized"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetEventsStreamUnauthorized(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetEventsStreamUnauthorized.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetEventsStreamUnauthorized Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetEventsStreamUnauthorized Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetEventsStreamUnauthorized>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetEventsStreamUnauthorized.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetEventsStreamUnauthorized instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetEventsStreamUnauthorized.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetEventsStreamUnauthorized"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.Models.JsonString.Source message)
        {
        ...
        /// Creates an instance of a <see cref="GetEventsStreamUnauthorized"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonString.Source message)
        {
            Create(ref _builder, message);
        }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source message)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source message, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetEventsStreamUnauthorized, Mutable>(this);
    }
}
