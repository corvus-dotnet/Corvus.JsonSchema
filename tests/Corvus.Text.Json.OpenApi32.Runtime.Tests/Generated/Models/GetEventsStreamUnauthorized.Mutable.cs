...
public readonly partial struct GetEventsStreamUnauthorized
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.GetEventsStreamUnauthorized.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.GetEventsStreamUnauthorized.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.JsonString.Source message)
        {
        ...
        /// Creates an instance of a <see cref="GetEventsStreamUnauthorized"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.JsonString.Source message)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.JsonString.Source message, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
