...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetEventsStreamUnauthorized"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetEventsStreamUnauthorized(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetEventsStreamUnauthorized DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetEventsStreamUnauthorized left, in GetEventsStreamUnauthorized right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetEventsStreamUnauthorized left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetEventsStreamUnauthorized instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetEventsStreamUnauthorized(JsonElement instance)
    {
        return GetEventsStreamUnauthorized.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEventsStreamUnauthorized From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEventsStreamUnauthorized ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetEventsStreamUnauthorized>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEventsStreamUnauthorized ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetEventsStreamUnauthorized>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetEventsStreamUnauthorized ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetEventsStreamUnauthorized>(json, options);
    }
    ...
    /// </exception>
    public static GetEventsStreamUnauthorized ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetEventsStreamUnauthorized>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetEventsStreamUnauthorized? result)
    {
        return JsonElementHelpers.TryParseValue<GetEventsStreamUnauthorized>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetEventsStreamUnauthorized(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetEventsStreamUnauthorized IJsonElement<GetEventsStreamUnauthorized>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetEventsStreamUnauthorized: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetEventsStreamUnauthorized"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetEventsStreamUnauthorized"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetEventsStreamUnauthorized Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetEventsStreamUnauthorized>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetEventsStreamUnauthorized"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetEventsStreamUnauthorized Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetEventsStreamUnauthorized>(_idx);
        }
