...
public readonly partial struct GetFilesDownloadMixedNotFound
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetFilesDownloadMixedNotFound instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetFilesDownloadMixedNotFound"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetFilesDownloadMixedNotFound(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Client.Models.JsonString.Mutable Error
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetFilesDownloadMixedNotFound(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetError(in CanonTests32.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetFilesDownloadMixedNotFound.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetFilesDownloadMixedNotFound"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetFilesDownloadMixedNotFound"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetFilesDownloadMixedNotFound Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetFilesDownloadMixedNotFound>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetFilesDownloadMixedNotFound"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetFilesDownloadMixedNotFound Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetFilesDownloadMixedNotFound>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetFilesDownloadMixedNotFound.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.JsonString.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(GetFilesDownloadMixedNotFound instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetFilesDownloadMixedNotFound.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetFilesDownloadMixedNotFound"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.Models.JsonString.Source error = default)
        {
        ...
        /// Creates an instance of a <see cref="GetFilesDownloadMixedNotFound"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonString.Source error = default)
        {
            Create(ref _builder, error);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonString.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source error = default)
    {
        return new Source(error);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source error = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetFilesDownloadMixedNotFound, Mutable>(this);
    }
}
