...
public readonly partial struct GetFilesDownloadMixedNotFound
    ...
    : IJsonElement<GetFilesDownloadMixedNotFound>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetFilesDownloadMixedNotFound"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetFilesDownloadMixedNotFound(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetFilesDownloadMixedNotFound DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetFilesDownloadMixedNotFound left, in GetFilesDownloadMixedNotFound right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetFilesDownloadMixedNotFound left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetFilesDownloadMixedNotFound instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetFilesDownloadMixedNotFound(JsonElement instance)
    {
        return GetFilesDownloadMixedNotFound.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetFilesDownloadMixedNotFound From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetFilesDownloadMixedNotFound ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetFilesDownloadMixedNotFound>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetFilesDownloadMixedNotFound ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetFilesDownloadMixedNotFound>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetFilesDownloadMixedNotFound ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetFilesDownloadMixedNotFound>(json, options);
    }
    ...
    /// </exception>
    public static GetFilesDownloadMixedNotFound ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetFilesDownloadMixedNotFound>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetFilesDownloadMixedNotFound? result)
    {
        return JsonElementHelpers.TryParseValue<GetFilesDownloadMixedNotFound>(ref reader, out result);
    }
...
#if NET
    static GetFilesDownloadMixedNotFound IJsonElement<GetFilesDownloadMixedNotFound>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetFilesDownloadMixedNotFound: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetFilesDownloadMixedNotFound Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetFilesDownloadMixedNotFound Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetFilesDownloadMixedNotFound>(_idx);
        }
