...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetFilesVendorJsonOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetFilesVendorJsonOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetFilesVendorJsonOk DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests32.Client.Models.JsonString Data
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataUtf8, out CanonTests32.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetFilesVendorJsonOk left, in GetFilesVendorJsonOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetFilesVendorJsonOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetFilesVendorJsonOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetFilesVendorJsonOk(JsonElement instance)
    {
        return GetFilesVendorJsonOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetFilesVendorJsonOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetFilesVendorJsonOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetFilesVendorJsonOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetFilesVendorJsonOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetFilesVendorJsonOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetFilesVendorJsonOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetFilesVendorJsonOk>(json, options);
    }
    ...
    /// </exception>
    public static GetFilesVendorJsonOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetFilesVendorJsonOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetFilesVendorJsonOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetFilesVendorJsonOk>(ref reader, out result);
    }
...
#if NET
    static GetFilesVendorJsonOk IJsonElement<GetFilesVendorJsonOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetFilesVendorJsonOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetFilesVendorJsonOk Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetFilesVendorJsonOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetFilesVendorJsonOk>(_idx);
        }
