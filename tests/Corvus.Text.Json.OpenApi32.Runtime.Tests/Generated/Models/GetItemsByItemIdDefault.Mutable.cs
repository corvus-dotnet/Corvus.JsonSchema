...
public readonly partial struct GetItemsByItemIdDefault
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsByItemIdDefault instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsByItemIdDefault"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsByItemIdDefault(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetItemsByItemIdDefault(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetError(in CanonTests32.Client.Models.JsonString.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("error");
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsByItemIdDefault.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetItemsByItemIdDefault"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetItemsByItemIdDefault"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdDefault Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetItemsByItemIdDefault>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetItemsByItemIdDefault"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdDefault Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsByItemIdDefault>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetItemsByItemIdDefault.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetItemsByItemIdDefault instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetItemsByItemIdDefault.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetItemsByItemIdDefault"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.Models.JsonString.Source error)
        {
        ...
        /// Creates an instance of a <see cref="GetItemsByItemIdDefault"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonString.Source error)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source error)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source error, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetItemsByItemIdDefault, Mutable>(this);
    }
}
