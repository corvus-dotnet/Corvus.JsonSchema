...
public readonly partial struct GetItemsByItemIdOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsByItemIdOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsByItemIdOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsByItemIdOk(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsByItemIdOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsByItemIdOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetItemsByItemIdOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetItemsByItemIdOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetItemsByItemIdOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetItemsByItemIdOk"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<GetItemsByItemIdOk, Mutable>(this);
    }
}
