            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = CanonTests32.Client.JsonBoolean.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    CanonTests32.Client.JsonBoolean.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
