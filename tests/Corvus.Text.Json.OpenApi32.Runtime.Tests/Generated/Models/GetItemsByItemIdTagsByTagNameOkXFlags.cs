...
public readonly partial struct GetItemsByItemIdTagsByTagNameOkXFlags
#if NET8_0_OR_GREATER
    : IJsonElement<GetItemsByItemIdTagsByTagNameOkXFlags>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetItemsByItemIdTagsByTagNameOkXFlags"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetItemsByItemIdTagsByTagNameOkXFlags(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetItemsByItemIdTagsByTagNameOkXFlags DefaultInstance { get; }
    ...
    public CanonTests32.Client.Models.JsonBoolean this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests32.Client.Models.JsonBoolean>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests32.Client.Models.JsonBoolean> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.Models.JsonBoolean>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdTagsByTagNameOkXFlags left, in GetItemsByItemIdTagsByTagNameOkXFlags right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdTagsByTagNameOkXFlags left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetItemsByItemIdTagsByTagNameOkXFlags instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetItemsByItemIdTagsByTagNameOkXFlags(JsonElement instance)
    {
        return GetItemsByItemIdTagsByTagNameOkXFlags.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXFlags From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXFlags ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXFlags>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXFlags ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXFlags>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXFlags ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXFlags>(json, options);
    }
    ...
    /// </exception>
    public static GetItemsByItemIdTagsByTagNameOkXFlags ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXFlags>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetItemsByItemIdTagsByTagNameOkXFlags? result)
    {
        return JsonElementHelpers.TryParseValue<GetItemsByItemIdTagsByTagNameOkXFlags>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetItemsByItemIdTagsByTagNameOkXFlags(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetItemsByItemIdTagsByTagNameOkXFlags IJsonElement<GetItemsByItemIdTagsByTagNameOkXFlags>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetItemsByItemIdTagsByTagNameOkXFlags: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetItemsByItemIdTagsByTagNameOkXFlags"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetItemsByItemIdTagsByTagNameOkXFlags"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdTagsByTagNameOkXFlags Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetItemsByItemIdTagsByTagNameOkXFlags>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetItemsByItemIdTagsByTagNameOkXFlags"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdTagsByTagNameOkXFlags Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetItemsByItemIdTagsByTagNameOkXFlags>(_idx);
        }
