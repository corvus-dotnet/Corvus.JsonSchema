...
public readonly partial struct GetItemsByItemIdTagsByTagNameOkXPageSizes
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsByItemIdTagsByTagNameOkXPageSizes instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsByItemIdTagsByTagNameOkXPageSizes"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsByItemIdTagsByTagNameOkXPageSizes(Mutable instance)
        {
        ...
        public CanonTests32.Client.Models.JsonInt32.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests32.Client.Models.JsonInt32.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests32.Client.Models.JsonInt32.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.Models.JsonInt32.Mutable>(_parent, _idx);
        }
        ...
        public bool TryGetNumericValues(Span<int> items, out int written)
        {
            CheckValidInstance();
            written = 0;
            foreach (CanonTests32.Client.Models.JsonInt32.Mutable item in EnumerateArray())
            {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetItemsByItemIdTagsByTagNameOkXPageSizes(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsByItemIdTagsByTagNameOkXPageSizes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in CanonTests32.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in CanonTests32.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in CanonTests32.Client.Models.JsonInt32.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in CanonTests32.Client.Models.JsonInt32 item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests32.Client.Models.JsonInt32>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<CanonTests32.Client.Models.JsonInt32> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests32.Client.Models.JsonInt32>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in CanonTests32.Client.Models.JsonInt32 oldItem, in CanonTests32.Client.Models.JsonInt32.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.Models.JsonInt32>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                CanonTests32.Client.Models.JsonInt32 current = enumerator.Current;
        ...
        /// <summary>
        /// Gets a <see cref="GetItemsByItemIdTagsByTagNameOkXPageSizes"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetItemsByItemIdTagsByTagNameOkXPageSizes"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdTagsByTagNameOkXPageSizes Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetItemsByItemIdTagsByTagNameOkXPageSizes>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetItemsByItemIdTagsByTagNameOkXPageSizes"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdTagsByTagNameOkXPageSizes Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsByItemIdTagsByTagNameOkXPageSizes>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetItemsByItemIdTagsByTagNameOkXPageSizes.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetItemsByItemIdTagsByTagNameOkXPageSizes instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetItemsByItemIdTagsByTagNameOkXPageSizes.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(ReadOnlySpan<int> values)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(
        JsonWorkspace workspace, ReadOnlySpan<int> values, int initialCapacity = 30)
    {
    ...
    {
        return workspace.CreateBuilder<GetItemsByItemIdTagsByTagNameOkXPageSizes, Mutable>(this);
    }
}
