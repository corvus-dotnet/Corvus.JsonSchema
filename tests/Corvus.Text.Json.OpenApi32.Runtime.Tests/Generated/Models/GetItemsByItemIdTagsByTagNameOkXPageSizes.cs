...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetItemsByItemIdTagsByTagNameOkXPageSizes"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetItemsByItemIdTagsByTagNameOkXPageSizes(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetItemsByItemIdTagsByTagNameOkXPageSizes DefaultInstance { get; }
    ...
    public bool TryGetNumericValues(Span<int> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (CanonTests32.Client.Models.JsonInt32 item in EnumerateArray())
        {
    ...
    public CanonTests32.Client.Models.JsonInt32 this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests32.Client.Models.JsonInt32>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests32.Client.Models.JsonInt32> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.Models.JsonInt32>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdTagsByTagNameOkXPageSizes left, in GetItemsByItemIdTagsByTagNameOkXPageSizes right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetItemsByItemIdTagsByTagNameOkXPageSizes left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetItemsByItemIdTagsByTagNameOkXPageSizes instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetItemsByItemIdTagsByTagNameOkXPageSizes(JsonElement instance)
    {
        return GetItemsByItemIdTagsByTagNameOkXPageSizes.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXPageSizes From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXPageSizes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXPageSizes>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXPageSizes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXPageSizes>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetItemsByItemIdTagsByTagNameOkXPageSizes ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXPageSizes>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetItemsByItemIdTagsByTagNameOkXPageSizes ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetItemsByItemIdTagsByTagNameOkXPageSizes>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetItemsByItemIdTagsByTagNameOkXPageSizes? result)
    {
        return JsonElementHelpers.TryParseValue<GetItemsByItemIdTagsByTagNameOkXPageSizes>(ref reader, out result);
    }
...
#if NET
    static GetItemsByItemIdTagsByTagNameOkXPageSizes IJsonElement<GetItemsByItemIdTagsByTagNameOkXPageSizes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetItemsByItemIdTagsByTagNameOkXPageSizes: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdTagsByTagNameOkXPageSizes Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetItemsByItemIdTagsByTagNameOkXPageSizes Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetItemsByItemIdTagsByTagNameOkXPageSizes>(_idx);
        }
