...
public readonly partial struct GetItemsByItemIdTagsByTagNameOkXTags
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsByItemIdTagsByTagNameOkXTags instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsByItemIdTagsByTagNameOkXTags"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsByItemIdTagsByTagNameOkXTags(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsByItemIdTagsByTagNameOkXTags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdTagsByTagNameOkXTags Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdTagsByTagNameOkXTags Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsByItemIdTagsByTagNameOkXTags>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetItemsByItemIdTagsByTagNameOkXTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetItemsByItemIdTagsByTagNameOkXTags instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetItemsByItemIdTagsByTagNameOkXTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetItemsByItemIdTagsByTagNameOkXTags, Mutable>(this);
    }
}
