...
public readonly partial struct GetOrdersByOrderIdOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetOrdersByOrderIdOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetOrdersByOrderIdOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetOrdersByOrderIdOk(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetOrdersByOrderIdOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetOrderId(in CanonTests32.Client.Models.JsonUuid.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("orderId");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OrderId, ref cvb);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetOrdersByOrderIdOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetOrdersByOrderIdOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetOrdersByOrderIdOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetOrdersByOrderIdOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetOrdersByOrderIdOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetOrdersByOrderIdOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetOrdersByOrderIdOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetOrdersByOrderIdOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetOrdersByOrderIdOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetOrdersByOrderIdOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetOrdersByOrderIdOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetOrdersByOrderIdOk"/>.
        /// </summary>
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="orderId">The value of the property.</param>
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonUuid.Source orderId, in CanonTests32.Client.Models.JsonString.Source status, in CanonTests32.Client.Models.JsonNumber.Source total, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(orderId, status, total);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<GetOrdersByOrderIdOk, Mutable>(this);
    }
}
