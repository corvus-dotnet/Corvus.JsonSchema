...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetOrdersByOrderIdOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetOrdersByOrderIdOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetOrdersByOrderIdOk DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonUuid OrderId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderIdUtf8, out CanonTests32.Client.Models.JsonUuid value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonString Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out CanonTests32.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonNumber Total
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalUtf8, out CanonTests32.Client.Models.JsonNumber value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetOrdersByOrderIdOk left, in GetOrdersByOrderIdOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetOrdersByOrderIdOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetOrdersByOrderIdOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetOrdersByOrderIdOk(JsonElement instance)
    {
        return GetOrdersByOrderIdOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetOrdersByOrderIdOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetOrdersByOrderIdOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetOrdersByOrderIdOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetOrdersByOrderIdOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetOrdersByOrderIdOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetOrdersByOrderIdOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetOrdersByOrderIdOk>(json, options);
    }
    ...
    /// </exception>
    public static GetOrdersByOrderIdOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetOrdersByOrderIdOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetOrdersByOrderIdOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetOrdersByOrderIdOk>(ref reader, out result);
    }
...
#if NET
    static GetOrdersByOrderIdOk IJsonElement<GetOrdersByOrderIdOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetOrdersByOrderIdOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetOrdersByOrderIdOk Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetOrdersByOrderIdOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetOrdersByOrderIdOk>(_idx);
        }
