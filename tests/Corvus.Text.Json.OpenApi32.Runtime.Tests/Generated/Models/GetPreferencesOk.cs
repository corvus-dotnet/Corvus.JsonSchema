...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.JsonString Language
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LanguageUtf8, out CanonTests32.Client.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.JsonString Theme
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ThemeUtf8, out CanonTests32.Client.JsonString value))
            {
                return value;
            }
