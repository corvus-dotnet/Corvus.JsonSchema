...
public readonly partial struct GetSearchWithQuerystringOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetSearchWithQuerystringOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetSearchWithQuerystringOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetSearchWithQuerystringOk(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetSearchWithQuerystringOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchWithQuerystringOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchWithQuerystringOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetSearchWithQuerystringOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.Source _createArg2;
        ...
        internal Source(in CanonTests32.Client.Models.JsonInt32.Source arg1, in CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.JsonInt32.Source _createArg1;
        private readonly CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.Source<TContext> _createArg2;
        ...
        internal Source(scoped in TContext context, in CanonTests32.Client.Models.JsonInt32.Source arg1, in CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        #endif
        {
            Create(context, ref _builder, count, results);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonInt32.Source arg1, in CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonInt32.Source arg1, in CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonInt32.Source count, in CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.Source results)
    {
        return new Source(count, results);
    }
    ...
    /// <param name="results">The value of the <c>"results"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonInt32.Source count, in CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.Source<TContext> results)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, count, results);
    }
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, count, results);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<GetSearchWithQuerystringOk, Mutable>(this);
    }
}
