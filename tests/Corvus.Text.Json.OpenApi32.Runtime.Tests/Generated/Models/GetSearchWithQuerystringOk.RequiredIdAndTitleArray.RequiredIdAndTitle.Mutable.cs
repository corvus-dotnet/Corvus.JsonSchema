    ...
    public readonly partial struct RequiredIdAndTitleArray
    {
        ...
        public readonly partial struct RequiredIdAndTitle
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(CanonTests32.Client.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.RequiredIdAndTitle.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, CanonTests32.Client.GetSearchWithQuerystringOk.RequiredIdAndTitleArray.RequiredIdAndTitle.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// Creates an instance of a <see cref="RequiredIdAndTitle"/>.
                /// </summary>
                public void Create(in CanonTests32.Client.JsonString.Source id, in CanonTests32.Client.JsonString.Source title)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.JsonString.Source id, in CanonTests32.Client.JsonString.Source title, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
