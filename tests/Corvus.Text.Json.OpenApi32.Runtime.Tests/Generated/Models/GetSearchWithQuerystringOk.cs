...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetSearchWithQuerystringOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetSearchWithQuerystringOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetSearchWithQuerystringOk DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonInt32 Count
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out CanonTests32.Client.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray Results
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResultsUtf8, out CanonTests32.Client.Models.GetSearchWithQuerystringOk.RequiredIdAndTitleArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetSearchWithQuerystringOk left, in GetSearchWithQuerystringOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetSearchWithQuerystringOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetSearchWithQuerystringOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetSearchWithQuerystringOk(JsonElement instance)
    {
        return GetSearchWithQuerystringOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchWithQuerystringOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchWithQuerystringOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchWithQuerystringOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchWithQuerystringOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchWithQuerystringOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchWithQuerystringOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchWithQuerystringOk>(json, options);
    }
    ...
    /// </exception>
    public static GetSearchWithQuerystringOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetSearchWithQuerystringOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetSearchWithQuerystringOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetSearchWithQuerystringOk>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetSearchWithQuerystringOk(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetSearchWithQuerystringOk IJsonElement<GetSearchWithQuerystringOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetSearchWithQuerystringOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetSearchWithQuerystringOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetSearchWithQuerystringOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetSearchWithQuerystringOk Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetSearchWithQuerystringOk>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetSearchWithQuerystringOk"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetSearchWithQuerystringOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetSearchWithQuerystringOk>(_idx);
        }
