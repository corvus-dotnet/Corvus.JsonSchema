...
public readonly partial struct GetSearchWithQuerystringQs
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetSearchWithQuerystringQs instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetSearchWithQuerystringQs"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetSearchWithQuerystringQs(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Client.Models.JsonInt32.Mutable Page
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PageUtf8, out CanonTests32.Client.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonString.Mutable Q
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetSearchWithQuerystringQs(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetPage(in CanonTests32.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetQ(in CanonTests32.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetSearchWithQuerystringQs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetSearchWithQuerystringQs"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetSearchWithQuerystringQs"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchWithQuerystringQs Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetSearchWithQuerystringQs>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetSearchWithQuerystringQs"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchWithQuerystringQs Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetSearchWithQuerystringQs>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source _createArg3;
        ...
        internal Source(CanonTests32.Client.Models.GetSearchWithQuerystringQs.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(GetSearchWithQuerystringQs instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg1;
        private readonly CanonTests32.Client.Models.JsonInt32.Source _createArg2;
        private readonly CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source<TContext> _createArg3;
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetSearchWithQuerystringQs.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source<TContext> arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetSearchWithQuerystringQs"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.JsonString.Source q,
            in CanonTests32.Client.Models.JsonInt32.Source page = default,
            in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source tags = default)
        {
        ...
        public void Create(
            ...
            in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source tags = default)
        {
            Create(ref _builder, q, page, tags);
        }
        ...
        internal static void Create<TContext>(
            ...
            in CanonTests32.Client.Models.JsonString.Source q,
            in CanonTests32.Client.Models.JsonInt32.Source page = default,
            in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, q, page, tags);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source q, in CanonTests32.Client.Models.JsonInt32.Source page = default, in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source tags = default)
    {
        return new Source(q, page, tags);
    }
    ...
    /// <param name="tags">The value of the <c>"tags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source q, in CanonTests32.Client.Models.JsonInt32.Source page = default, in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, q, page, tags);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source q, in CanonTests32.Client.Models.JsonInt32.Source page = default, in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(q, page, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Client.Models.JsonString.Source q, in CanonTests32.Client.Models.JsonInt32.Source page = default, in CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, q, page, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<GetSearchWithQuerystringQs, Mutable>(this);
    }
}
