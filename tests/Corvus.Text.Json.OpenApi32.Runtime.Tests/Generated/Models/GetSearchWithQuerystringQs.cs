...
public readonly partial struct GetSearchWithQuerystringQs
    ...
    : IJsonElement<GetSearchWithQuerystringQs>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetSearchWithQuerystringQs"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetSearchWithQuerystringQs(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetSearchWithQuerystringQs DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests32.Client.Models.JsonInt32 Page
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PageUtf8, out CanonTests32.Client.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonString Q
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QUtf8, out CanonTests32.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests32.Client.Models.GetSearchWithQuerystringQs.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetSearchWithQuerystringQs left, in GetSearchWithQuerystringQs right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetSearchWithQuerystringQs left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetSearchWithQuerystringQs instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetSearchWithQuerystringQs(JsonElement instance)
    {
        return GetSearchWithQuerystringQs.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchWithQuerystringQs From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchWithQuerystringQs ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchWithQuerystringQs>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchWithQuerystringQs ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchWithQuerystringQs>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchWithQuerystringQs ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchWithQuerystringQs>(json, options);
    }
    ...
    /// </exception>
    public static GetSearchWithQuerystringQs ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetSearchWithQuerystringQs>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetSearchWithQuerystringQs? result)
    {
        return JsonElementHelpers.TryParseValue<GetSearchWithQuerystringQs>(ref reader, out result);
    }
...
#if NET
    static GetSearchWithQuerystringQs IJsonElement<GetSearchWithQuerystringQs>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetSearchWithQuerystringQs: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetSearchWithQuerystringQs Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetSearchWithQuerystringQs Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetSearchWithQuerystringQs>(_idx);
        }
