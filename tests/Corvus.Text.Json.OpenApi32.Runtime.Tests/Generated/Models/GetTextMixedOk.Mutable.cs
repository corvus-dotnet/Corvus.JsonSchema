...
public readonly partial struct GetTextMixedOk
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.JsonString.Mutable Value
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out CanonTests32.Client.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetValue(in CanonTests32.Client.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.GetTextMixedOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.GetTextMixedOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.JsonString.Source value)
        {
        ...
        /// Creates an instance of a <see cref="GetTextMixedOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.JsonString.Source value)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.JsonString.Source value, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
