...
public readonly partial struct GetTextMixedOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetTextMixedOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetTextMixedOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetTextMixedOk(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonString.Mutable Value
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetTextMixedOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetValue(in CanonTests32.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetTextMixedOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetTextMixedOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetTextMixedOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetTextMixedOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetTextMixedOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetTextMixedOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetTextMixedOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetTextMixedOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.GetTextMixedOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.GetTextMixedOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.Models.JsonString.Source value)
        {
        ...
        /// Creates an instance of a <see cref="GetTextMixedOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonString.Source value)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source value)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source value, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetTextMixedOk, Mutable>(this);
    }
}
