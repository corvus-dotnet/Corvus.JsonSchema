...
public readonly partial struct ItemSchema
{
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.JsonDateTime.Source _createArg3;
        private readonly CanonTests32.Client.Models.JsonObject.Source _createArg4;
        ...
        internal Source(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonDateTime.Source arg3, in CanonTests32.Client.Models.JsonObject.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests32.Client.Models.JsonDateTime.Source _createArg3;
        private readonly CanonTests32.Client.Models.JsonObject.Source<TContext> _createArg4;
        ...
        internal Source(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonDateTime.Source arg3, in CanonTests32.Client.Models.JsonObject.Source<TContext> arg4)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonDateTime.Source arg3, in CanonTests32.Client.Models.JsonObject.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg4">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonDateTime.Source arg3, in CanonTests32.Client.Models.JsonObject.Source<TContext> arg4, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source eventId, in CanonTests32.Client.Models.JsonString.Source eventType, in CanonTests32.Client.Models.JsonDateTime.Source timestamp, in CanonTests32.Client.Models.JsonObject.Source payload = default)
    {
    ...
    /// <param name="payload">The value of the <c>"payload"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source eventId, in CanonTests32.Client.Models.JsonString.Source eventType, in CanonTests32.Client.Models.JsonDateTime.Source timestamp, in CanonTests32.Client.Models.JsonObject.Source<TContext> payload = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
