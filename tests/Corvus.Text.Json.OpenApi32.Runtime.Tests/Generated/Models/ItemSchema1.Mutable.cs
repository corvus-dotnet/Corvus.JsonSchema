...
public readonly partial struct ItemSchema1
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Mutable Choices
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChoicesUtf8, out CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Client.Models.JsonString.Mutable ObjectValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ObjectValueUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetChoices(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("choices");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetChoices<TContext>(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source<TContext> value)
        ...
        /// <summary>
        /// Set the <c>object</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetObjectValue(in CanonTests32.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ObjectValueUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ObjectValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ObjectValue, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>object</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveObjectValue()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ObjectValueUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source _createArg1;
        ...
        internal Source(CanonTests32.Client.Models.ItemSchema1.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source<TContext> _createArg1;
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg3;
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.ItemSchema1.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source<TContext> arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source choices,
            in CanonTests32.Client.Models.JsonString.Source id,
            in CanonTests32.Client.Models.JsonString.Source objectValue = default)
        {
            ...
            objectValue.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ObjectValue, ref builder);
        }
        ...
        public void Create(
            ...
            in CanonTests32.Client.Models.JsonString.Source objectValue = default)
        {
            Create(ref _builder, choices, id, objectValue);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source<TContext> choices,
            in CanonTests32.Client.Models.JsonString.Source id,
            in CanonTests32.Client.Models.JsonString.Source objectValue = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        ...
        #endif
        {
            Create(context, ref _builder, choices, id, objectValue);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source<TContext> arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <param name="objectValue">The value of the <c>"object"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source choices, in CanonTests32.Client.Models.JsonString.Source id, in CanonTests32.Client.Models.JsonString.Source objectValue = default)
    {
        return new Source(choices, id, objectValue);
    }
    ...
    /// <param name="objectValue">The value of the <c>"object"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source<TContext> choices, in CanonTests32.Client.Models.JsonString.Source id, in CanonTests32.Client.Models.JsonString.Source objectValue = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, choices, id, objectValue);
    }
    ...
    /// <param name="objectValue">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source choices, in CanonTests32.Client.Models.JsonString.Source id, in CanonTests32.Client.Models.JsonString.Source objectValue = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(choices, id, objectValue);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Source<TContext> choices, in CanonTests32.Client.Models.JsonString.Source id, in CanonTests32.Client.Models.JsonString.Source objectValue = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, choices, id, objectValue);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
