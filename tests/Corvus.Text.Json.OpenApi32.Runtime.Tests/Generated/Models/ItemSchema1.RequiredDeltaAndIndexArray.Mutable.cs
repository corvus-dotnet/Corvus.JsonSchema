...
public readonly partial struct ItemSchema1
{
    ...
    public readonly partial struct RequiredDeltaAndIndexArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiredDeltaAndIndexArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiredDeltaAndIndexArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredDeltaAndIndexArray(Mutable instance)
            {
            ...
            public CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredDeltaAndIndexArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredDeltaAndIndexArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex oldItem, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="RequiredDeltaAndIndexArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredDeltaAndIndexArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredDeltaAndIndexArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredDeltaAndIndexArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredDeltaAndIndexArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredDeltaAndIndexArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiredDeltaAndIndexArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RequiredDeltaAndIndexArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<RequiredDeltaAndIndexArray, Mutable>(this);
        }
    }
}
