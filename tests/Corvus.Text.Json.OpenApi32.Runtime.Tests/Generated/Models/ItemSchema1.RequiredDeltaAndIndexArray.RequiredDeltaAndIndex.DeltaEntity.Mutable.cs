        ...
        public readonly partial struct RequiredDeltaAndIndex
        {
            ...
            public readonly partial struct DeltaEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DeltaEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DeltaEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DeltaEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DeltaEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeltaEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DeltaEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DeltaEntity>(_idx);
                    }
                }
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in CanonTests32.Client.Models.JsonString.Source content = default)
                {
                ...
                {
                    return workspace.CreateBuilder<DeltaEntity, Mutable>(this);
                }
            }
        }
    }
