    ...
    public readonly partial struct RequiredDeltaAndIndexArray
    {
        ...
        public readonly partial struct RequiredDeltaAndIndex
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredDeltaAndIndex instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredDeltaAndIndex"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredDeltaAndIndex(Mutable instance)
                {
                ...
                public void SetFinishReason(in CanonTests32.Client.Models.JsonString.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FinishReasonUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FinishReasonUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FinishReason, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>finishReason</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveFinishReason()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FinishReasonUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetIndex(in CanonTests32.Client.Models.JsonInt32.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("index");
                    }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredDeltaAndIndex.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredDeltaAndIndex Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredDeltaAndIndex Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredDeltaAndIndex>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.DeltaEntity.Source _createArg1;
                ...
                internal Source(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.DeltaEntity.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                #endif
            {
                ...
                private readonly CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.DeltaEntity.Source<TContext> _createArg1;
                private readonly CanonTests32.Client.Models.JsonInt32.Source _createArg2;
                private readonly CanonTests32.Client.Models.JsonString.Source _createArg3;
                ...
                internal Source(scoped in TContext context, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.DeltaEntity.Source<TContext> arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                    ...
                    in CanonTests32.Client.Models.JsonString.Source finishReason = default)
                {
                    ...
                    finishReason.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FinishReason, ref builder);
                }
                ...
                #endif
                {
                    Create(context, ref _builder, delta, index, finishReason);
                }
                ...
                internal static void BuildCreateValue(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.DeltaEntity.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg3">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.DeltaEntity.Source<TContext> arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <param name="finishReason">The value of the <c>"finishReason"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.DeltaEntity.Source delta, in CanonTests32.Client.Models.JsonInt32.Source index, in CanonTests32.Client.Models.JsonString.Source finishReason = default)
            {
                return new Source(delta, index, finishReason);
            }
            ...
            /// <param name="finishReason">The value of the <c>"finishReason"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.DeltaEntity.Source<TContext> delta, in CanonTests32.Client.Models.JsonInt32.Source index, in CanonTests32.Client.Models.JsonString.Source finishReason = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, delta, index, finishReason);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray.RequiredDeltaAndIndex.DeltaEntity.Source delta, in CanonTests32.Client.Models.JsonInt32.Source index, in CanonTests32.Client.Models.JsonString.Source finishReason = default, int initialCapacity = 30)
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(delta, index, finishReason);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
                ...
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, delta, index, finishReason);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredDeltaAndIndex, Mutable>(this);
            }
        }
    }
}
