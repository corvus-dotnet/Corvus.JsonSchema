...
public readonly partial struct ItemSchema1
{
    ...
    public readonly partial struct RequiredDeltaAndIndexArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredDeltaAndIndex"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredDeltaAndIndex(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredDeltaAndIndex DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in RequiredDeltaAndIndex left, in RequiredDeltaAndIndex right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredDeltaAndIndex left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredDeltaAndIndex instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredDeltaAndIndex(JsonElement instance)
            {
                return RequiredDeltaAndIndex.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDeltaAndIndex From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDeltaAndIndex ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RequiredDeltaAndIndex>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDeltaAndIndex ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RequiredDeltaAndIndex>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDeltaAndIndex ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RequiredDeltaAndIndex>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static RequiredDeltaAndIndex ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RequiredDeltaAndIndex>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredDeltaAndIndex? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredDeltaAndIndex>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredDeltaAndIndex(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RequiredDeltaAndIndex IJsonElement<RequiredDeltaAndIndex>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredDeltaAndIndex: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredDeltaAndIndex"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredDeltaAndIndex"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RequiredDeltaAndIndex Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredDeltaAndIndex>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredDeltaAndIndex"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RequiredDeltaAndIndex Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredDeltaAndIndex>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="FinishReason"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="FinishReason"/>.
                /// </summary>
                public static ReadOnlySpan<byte> FinishReasonUtf8 => "finishReason"u8;
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="FinishReason"/>.
                /// </summary>
                public static ReadOnlySpan<byte> FinishReason => "finishReason"u8;
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="FinishReason"/>.
                /// </summary>
                public static ReadOnlySpan<byte> FinishReason => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x66, 0x69, 0x6E, 0x69, 0x73, 0x68, 0x52, 0x65, 0x61, 0x73, 0x6F, 0x6E, 0x22];
