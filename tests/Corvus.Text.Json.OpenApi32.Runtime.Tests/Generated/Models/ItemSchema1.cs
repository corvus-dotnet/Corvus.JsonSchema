...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray Choices
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChoicesUtf8, out CanonTests32.Client.Models.ItemSchema1.RequiredDeltaAndIndexArray value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets the (optional) <c>object</c> property.
    /// </summary>
    public CanonTests32.Client.Models.JsonString ObjectValue
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ObjectValueUtf8, out CanonTests32.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="ObjectValue"/>.
        /// </summary>
        public const string ObjectValue = "object";
        ...
        /// Gets the JSON property name for <see cref="ObjectValue"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ObjectValueUtf8 => "object"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="ObjectValue"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ObjectValue => "object"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Choices"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Choices => [0x95, 0x00, 0x00, 0x00, 0x22, 0x63, 0x68, 0x6F, 0x69, 0x63, 0x65, 0x73, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="ObjectValue"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ObjectValue => [0x85, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x62, 0x6A, 0x65, 0x63, 0x74, 0x22];
    }
}
