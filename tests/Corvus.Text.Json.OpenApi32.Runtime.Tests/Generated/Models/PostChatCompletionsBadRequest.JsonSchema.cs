    ...
    : IJsonElement<PostChatCompletionsBadRequest>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyErrorPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("error"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyErrorNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("error"u8, buffer, out written);

        private const int RequiredOffsetForError = 0;
        private const uint RequiredBitForError = 0b00000000000000000000000000000001;
        ...
        private static void MatchError(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            requiredBitBuffer[RequiredOffsetForError] |= RequiredBitForError;
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1chat~1completions/post/responses/400/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1chat~1completions/post/responses/400/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1chat~1completions/post/responses/400/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyErrorPresent, "error"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForError] & RequiredBitForError) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyErrorNotPresent, "error"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyErrorPresent, "error"u8, "required"u8);
