...
public readonly partial struct PostChatCompletionsBadRequest
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostChatCompletionsBadRequest instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostChatCompletionsBadRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostChatCompletionsBadRequest(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostChatCompletionsBadRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostChatCompletionsBadRequest Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostChatCompletionsBadRequest Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostChatCompletionsBadRequest>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.PostChatCompletionsBadRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(PostChatCompletionsBadRequest instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostChatCompletionsBadRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostChatCompletionsBadRequest"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<PostChatCompletionsBadRequest, Mutable>(this);
    }
}
