...
public readonly partial struct PostChatCompletionsBadRequest
#if NET8_0_OR_GREATER
    : IJsonElement<PostChatCompletionsBadRequest>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostChatCompletionsBadRequest"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostChatCompletionsBadRequest(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostChatCompletionsBadRequest DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonString Error
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out CanonTests32.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostChatCompletionsBadRequest left, in PostChatCompletionsBadRequest right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostChatCompletionsBadRequest left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostChatCompletionsBadRequest instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostChatCompletionsBadRequest(JsonElement instance)
    {
        return PostChatCompletionsBadRequest.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostChatCompletionsBadRequest From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostChatCompletionsBadRequest ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostChatCompletionsBadRequest>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostChatCompletionsBadRequest ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostChatCompletionsBadRequest>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostChatCompletionsBadRequest ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostChatCompletionsBadRequest>(json, options);
    }
    ...
    /// </exception>
    public static PostChatCompletionsBadRequest ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostChatCompletionsBadRequest>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostChatCompletionsBadRequest? result)
    {
        return JsonElementHelpers.TryParseValue<PostChatCompletionsBadRequest>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PostChatCompletionsBadRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PostChatCompletionsBadRequest IJsonElement<PostChatCompletionsBadRequest>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostChatCompletionsBadRequest: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PostChatCompletionsBadRequest"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PostChatCompletionsBadRequest"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PostChatCompletionsBadRequest Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PostChatCompletionsBadRequest>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PostChatCompletionsBadRequest"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PostChatCompletionsBadRequest Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostChatCompletionsBadRequest>(_idx);
        }
