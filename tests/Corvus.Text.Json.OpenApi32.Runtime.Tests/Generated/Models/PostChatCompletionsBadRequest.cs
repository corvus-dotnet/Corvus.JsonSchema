...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.JsonString Error
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out CanonTests32.Client.JsonString value))
            {
                return value;
            }
