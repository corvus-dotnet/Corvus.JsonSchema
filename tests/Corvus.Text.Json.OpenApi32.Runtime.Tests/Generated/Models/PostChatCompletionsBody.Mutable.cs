...
public readonly partial struct PostChatCompletionsBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostChatCompletionsBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostChatCompletionsBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostChatCompletionsBody(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>messages</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Mutable Messages
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessagesUtf8, out CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonString.Mutable Model
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModelUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Client.Models.JsonBoolean.Mutable Stream
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreamUtf8, out CanonTests32.Client.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostChatCompletionsBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetMessages(in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("messages");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessages<TContext>(in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetModel(in CanonTests32.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("model");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModelUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Model, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStream(in CanonTests32.Client.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StreamUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreamUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Stream, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StreamUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostChatCompletionsBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostChatCompletionsBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostChatCompletionsBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostChatCompletionsBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostChatCompletionsBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostChatCompletionsBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostChatCompletionsBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostChatCompletionsBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source _createArg1;
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests32.Client.Models.JsonBoolean.Source _createArg3;
        ...
        internal Source(CanonTests32.Client.Models.PostChatCompletionsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonBoolean.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(PostChatCompletionsBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source<TContext> _createArg1;
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests32.Client.Models.JsonBoolean.Source _createArg3;
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostChatCompletionsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source<TContext> arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonBoolean.Source arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostChatCompletionsBody"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source messages,
            in CanonTests32.Client.Models.JsonString.Source model,
            in CanonTests32.Client.Models.JsonBoolean.Source stream = default)
        {
            messages.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Messages, ref builder);
            model.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Model, ref builder);
            stream.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Stream, ref builder);
        }
        ...
        public void Create(
            ...
            in CanonTests32.Client.Models.JsonBoolean.Source stream = default)
        {
            Create(ref _builder, messages, model, stream);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source<TContext> messages,
            in CanonTests32.Client.Models.JsonString.Source model,
            in CanonTests32.Client.Models.JsonBoolean.Source stream = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        ...
        #endif
        {
            Create(context, ref _builder, messages, model, stream);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source<TContext> arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonBoolean.Source arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <param name="model">The value of the <c>"model"</c> property.</param>
    /// <param name="stream">The value of the <c>"stream"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source messages, in CanonTests32.Client.Models.JsonString.Source model, in CanonTests32.Client.Models.JsonBoolean.Source stream = default)
    {
        return new Source(messages, model, stream);
    }
    ...
    /// <param name="stream">The value of the <c>"stream"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source<TContext> messages, in CanonTests32.Client.Models.JsonString.Source model, in CanonTests32.Client.Models.JsonBoolean.Source stream = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, messages, model, stream);
    }
    ...
    /// <param name="model">The value of the property.</param>
    /// <param name="stream">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source messages, in CanonTests32.Client.Models.JsonString.Source model, in CanonTests32.Client.Models.JsonBoolean.Source stream = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(messages, model, stream);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray.Source<TContext> messages, in CanonTests32.Client.Models.JsonString.Source model, in CanonTests32.Client.Models.JsonBoolean.Source stream = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, messages, model, stream);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostChatCompletionsBody, Mutable>(this);
    }
}
