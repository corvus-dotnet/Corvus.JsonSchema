    ...
    public readonly partial struct RequiredContentAndRoleArray
    {
        ...
        public readonly partial struct RequiredContentAndRole
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredContentAndRole instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredContentAndRole"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredContentAndRole(Mutable instance)
                {
                ...
                public void SetRole(in CanonTests32.Client.Models.JsonString.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("role");
                    }
                ...
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredContentAndRole>(_idx);
                }
            }
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in CanonTests32.Client.Models.JsonString.Source content, in CanonTests32.Client.Models.JsonString.Source role)
            {
