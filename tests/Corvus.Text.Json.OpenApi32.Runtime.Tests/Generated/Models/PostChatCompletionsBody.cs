...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.PostChatCompletionsBody.RequiredContentAndRoleArray Messages
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessagesUtf8, out CanonTests32.Client.PostChatCompletionsBody.RequiredContentAndRoleArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.JsonString Model
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModelUtf8, out CanonTests32.Client.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests32.Client.JsonBoolean Stream
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreamUtf8, out CanonTests32.Client.JsonBoolean value))
            {
                return value;
            }
