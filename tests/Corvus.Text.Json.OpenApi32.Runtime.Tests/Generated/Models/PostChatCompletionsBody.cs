...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostChatCompletionsBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostChatCompletionsBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostChatCompletionsBody DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray Messages
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessagesUtf8, out CanonTests32.Client.Models.PostChatCompletionsBody.RequiredContentAndRoleArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonString Model
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModelUtf8, out CanonTests32.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests32.Client.Models.JsonBoolean Stream
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreamUtf8, out CanonTests32.Client.Models.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostChatCompletionsBody left, in PostChatCompletionsBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostChatCompletionsBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostChatCompletionsBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostChatCompletionsBody(JsonElement instance)
    {
        return PostChatCompletionsBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostChatCompletionsBody From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostChatCompletionsBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostChatCompletionsBody>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostChatCompletionsBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostChatCompletionsBody>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostChatCompletionsBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostChatCompletionsBody>(json, options);
    }
    ...
    /// </exception>
    public static PostChatCompletionsBody ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostChatCompletionsBody>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostChatCompletionsBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostChatCompletionsBody>(ref reader, out result);
    }
...
#if NET
    static PostChatCompletionsBody IJsonElement<PostChatCompletionsBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostChatCompletionsBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostChatCompletionsBody Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostChatCompletionsBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostChatCompletionsBody>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Stream"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Stream"/>.
        /// </summary>
        public static ReadOnlySpan<byte> StreamUtf8 => "stream"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Stream"/>.
        /// </summary>
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Model"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Model => [0x75, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x6F, 0x64, 0x65, 0x6C, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Stream"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Stream => [0x85, 0x00, 0x00, 0x00, 0x22, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6D, 0x22];
    }
}
