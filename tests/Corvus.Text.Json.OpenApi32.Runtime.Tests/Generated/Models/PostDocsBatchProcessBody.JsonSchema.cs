...
public readonly partial struct PostDocsBatchProcessBody
    : IJsonElement<PostDocsBatchProcessBody>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1docs~1batch-process/post/requestBody/content/multipart~1mixed/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1docs~1batch-process/post/requestBody/content/multipart~1mixed/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1docs~1batch-process/post/requestBody/content/multipart~1mixed/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = CanonTests32.Client.Models.PostDocsBatchProcessBody.RequiredAction.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    CanonTests32.Client.Models.PostDocsBatchProcessBody.RequiredAction.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
