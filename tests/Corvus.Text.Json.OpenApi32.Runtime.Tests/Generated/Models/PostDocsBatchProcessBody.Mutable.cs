...
public readonly partial struct PostDocsBatchProcessBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostDocsBatchProcessBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostDocsBatchProcessBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostDocsBatchProcessBody(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostDocsBatchProcessBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostDocsBatchProcessBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="PostDocsBatchProcessBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostDocsBatchProcessBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostDocsBatchProcessBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostDocsBatchProcessBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostDocsBatchProcessBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostDocsBatchProcessBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostDocsBatchProcessBody>(_idx);
        }
    }
    ...
    public ref struct Builder
    {
        ...
        /// Add an item to the array.
        /// </summary>
        public void AddItem<TContext>(in CanonTests32.Client.Models.PostDocsBatchProcessBody.RequiredAction.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    {
        return workspace.CreateBuilder<PostDocsBatchProcessBody, Mutable>(this);
    }
}
