...
public readonly partial struct PostDocsBatchProcessOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostDocsBatchProcessOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostDocsBatchProcessOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostDocsBatchProcessOk(Mutable instance)
        {
        ...
        public void SetProcessed(in CanonTests32.Client.Models.JsonInteger.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("processed");
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostDocsBatchProcessOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostDocsBatchProcessOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostDocsBatchProcessOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostDocsBatchProcessOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.JsonInteger.Source _createArg1;
        private readonly CanonTests32.Client.Models.JsonInteger.Source _createArg2;
        ...
        internal Source(in CanonTests32.Client.Models.JsonInteger.Source arg1, in CanonTests32.Client.Models.JsonInteger.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonInteger.Source arg1, in CanonTests32.Client.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <param name="processed">The value of the <c>"processed"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonInteger.Source failed, in CanonTests32.Client.Models.JsonInteger.Source processed)
    {
        return new Source(failed, processed);
    }
    ...
    {
        return workspace.CreateBuilder<PostDocsBatchProcessOk, Mutable>(this);
    }
}
