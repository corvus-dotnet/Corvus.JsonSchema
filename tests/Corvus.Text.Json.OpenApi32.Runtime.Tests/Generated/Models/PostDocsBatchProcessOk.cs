...
public readonly partial struct PostDocsBatchProcessOk
#if NET8_0_OR_GREATER
    : IJsonElement<PostDocsBatchProcessOk>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostDocsBatchProcessOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostDocsBatchProcessOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostDocsBatchProcessOk DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonInteger Failed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FailedUtf8, out CanonTests32.Client.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets the <c>processed</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonInteger Processed
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProcessedUtf8, out CanonTests32.Client.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostDocsBatchProcessOk left, in PostDocsBatchProcessOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostDocsBatchProcessOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostDocsBatchProcessOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostDocsBatchProcessOk(JsonElement instance)
    {
        return PostDocsBatchProcessOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostDocsBatchProcessOk From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostDocsBatchProcessOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostDocsBatchProcessOk>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostDocsBatchProcessOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostDocsBatchProcessOk>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostDocsBatchProcessOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostDocsBatchProcessOk>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static PostDocsBatchProcessOk ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostDocsBatchProcessOk>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostDocsBatchProcessOk? result)
    {
        return JsonElementHelpers.TryParseValue<PostDocsBatchProcessOk>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PostDocsBatchProcessOk(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PostDocsBatchProcessOk IJsonElement<PostDocsBatchProcessOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostDocsBatchProcessOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PostDocsBatchProcessOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PostDocsBatchProcessOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PostDocsBatchProcessOk Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PostDocsBatchProcessOk>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PostDocsBatchProcessOk"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PostDocsBatchProcessOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostDocsBatchProcessOk>(_idx);
        }
