...
public readonly partial struct PostDocsUploadMixedBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostDocsUploadMixedBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostDocsUploadMixedBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostDocsUploadMixedBody(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostDocsUploadMixedBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostDocsUploadMixedBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="PostDocsUploadMixedBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostDocsUploadMixedBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostDocsUploadMixedBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostDocsUploadMixedBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostDocsUploadMixedBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostDocsUploadMixedBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostDocsUploadMixedBody>(_idx);
        }
    }
    ...
    {
        return workspace.CreateBuilder<PostDocsUploadMixedBody, Mutable>(this);
    }
}
