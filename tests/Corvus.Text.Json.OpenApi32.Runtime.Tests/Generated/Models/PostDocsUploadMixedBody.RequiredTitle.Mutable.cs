...
/// </summary>
public readonly partial struct PostDocsUploadMixedBody
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly partial struct RequiredTitle
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiredTitle instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiredTitle"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredTitle(Mutable instance)
            {
            ...
            /// </summary>
            public CanonTests32.Client.Models.JsonString.Mutable Category
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CategoryUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredTitle(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetCategory(in CanonTests32.Client.Models.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredTitle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredTitle"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredTitle"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredTitle Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredTitle>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredTitle"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredTitle Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiredTitle>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(CanonTests32.Client.Models.PostDocsUploadMixedBody.RequiredTitle.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(RequiredTitle instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests32.Client.Models.PostDocsUploadMixedBody.RequiredTitle.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RequiredTitle"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in CanonTests32.Client.Models.JsonString.Source title,
                in CanonTests32.Client.Models.JsonString.Source category = default)
            {
            ...
            /// Creates an instance of a <see cref="RequiredTitle"/>.
            /// </summary>
            public void Create(in CanonTests32.Client.Models.JsonString.Source title, in CanonTests32.Client.Models.JsonString.Source category = default)
            {
                Create(ref _builder, title, category);
            }
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in CanonTests32.Client.Models.JsonString.Source title, in CanonTests32.Client.Models.JsonString.Source category = default)
        {
            return new Source(title, category);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source title, in CanonTests32.Client.Models.JsonString.Source category = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(title, category);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RequiredTitle, Mutable>(this);
        }
    }
}
