    ...
    : IJsonElement<PostDocsUploadMixedCreated>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDocumentIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("documentId"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDocumentIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("documentId"u8, buffer, out written);

        private const int RequiredOffsetForDocumentId = 0;
        private const uint RequiredBitForDocumentId = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForDocumentId | RequiredBitForUrl;
        private static readonly JsonSchemaPathProvider DocumentIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/documentId"u8, buffer, out written);
        ...
        private static void MatchDocumentId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Client.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.DocumentIdUtf8,
                    evaluationPath: DocumentIdSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForDocumentId] |= RequiredBitForDocumentId;
        }
        ...
        private static void MatchUrl(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                CanonTests32.Client.Models.JsonUri.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            CanonTests32.Client.Models.JsonUri.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static PropertySchemaMatchers<CanonTests32.Client.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<CanonTests32.Client.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.DocumentIdUtf8, MatchDocumentId),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1docs~1upload-mixed/post/responses/201/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1docs~1upload-mixed/post/responses/201/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1docs~1upload-mixed/post/responses/201/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDocumentIdPresent, "documentId"u8, "required"u8);
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDocumentId] & RequiredBitForDocumentId) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDocumentIdNotPresent, "documentId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDocumentIdPresent, "documentId"u8, "required"u8);
