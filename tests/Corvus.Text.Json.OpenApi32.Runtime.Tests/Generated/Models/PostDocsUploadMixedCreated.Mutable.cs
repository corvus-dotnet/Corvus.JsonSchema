...
public readonly partial struct PostDocsUploadMixedCreated
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostDocsUploadMixedCreated instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostDocsUploadMixedCreated"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostDocsUploadMixedCreated(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>documentId</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostDocsUploadMixedCreated(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDocumentId(in CanonTests32.Client.Models.JsonString.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("documentId");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DocumentId, ref cvb);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostDocsUploadMixedCreated.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostDocsUploadMixedCreated"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostDocsUploadMixedCreated"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostDocsUploadMixedCreated Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostDocsUploadMixedCreated>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostDocsUploadMixedCreated"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostDocsUploadMixedCreated Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostDocsUploadMixedCreated>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.JsonUri.Source _createArg2;
        ...
        internal Source(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonUri.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonUri.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="documentId">The value of the <c>"documentId"</c> property.</param>
    /// <param name="url">The value of the <c>"url"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source documentId, in CanonTests32.Client.Models.JsonUri.Source url)
    {
        return new Source(documentId, url);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="documentId">The value of the property.</param>
    ...
    {
        return workspace.CreateBuilder<PostDocsUploadMixedCreated, Mutable>(this);
    }
}
