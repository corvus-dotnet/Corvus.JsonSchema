...
public readonly partial struct PostDocsUploadMixedCreated
    ...
    : IJsonElement<PostDocsUploadMixedCreated>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostDocsUploadMixedCreated"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostDocsUploadMixedCreated(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostDocsUploadMixedCreated DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonString DocumentId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DocumentIdUtf8, out CanonTests32.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonUri Url
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out CanonTests32.Client.Models.JsonUri value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostDocsUploadMixedCreated left, in PostDocsUploadMixedCreated right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostDocsUploadMixedCreated left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostDocsUploadMixedCreated instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostDocsUploadMixedCreated(JsonElement instance)
    {
        return PostDocsUploadMixedCreated.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostDocsUploadMixedCreated From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostDocsUploadMixedCreated ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostDocsUploadMixedCreated>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostDocsUploadMixedCreated ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostDocsUploadMixedCreated>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostDocsUploadMixedCreated ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostDocsUploadMixedCreated>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static PostDocsUploadMixedCreated ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostDocsUploadMixedCreated>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostDocsUploadMixedCreated? result)
    {
        return JsonElementHelpers.TryParseValue<PostDocsUploadMixedCreated>(ref reader, out result);
    }
...
#if NET
    static PostDocsUploadMixedCreated IJsonElement<PostDocsUploadMixedCreated>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostDocsUploadMixedCreated: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostDocsUploadMixedCreated Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostDocsUploadMixedCreated Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostDocsUploadMixedCreated>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="DocumentId"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="DocumentId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DocumentIdUtf8 => "documentId"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="DocumentId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DocumentId => "documentId"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="DocumentId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DocumentId => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x64, 0x6F, 0x63, 0x75, 0x6D, 0x65, 0x6E, 0x74, 0x49, 0x64, 0x22];
