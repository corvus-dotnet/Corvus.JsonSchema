...
public readonly partial struct PostFormsContactBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsContactBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsContactBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsContactBody(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonEmail.Mutable Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out CanonTests32.Client.Models.JsonEmail.Mutable value))
                {
                    return value;
                }
        ...
        public void SetEmail(in CanonTests32.Client.Models.JsonEmail.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsContactBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsContactBody Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsContactBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsContactBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.JsonEmail.Source _createArg1;
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg3;
        ...
        internal Source(CanonTests32.Client.Models.PostFormsContactBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.JsonEmail.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostFormsContactBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Client.Models.JsonEmail.Source email,
            in CanonTests32.Client.Models.JsonString.Source name,
            in CanonTests32.Client.Models.JsonString.Source message = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonEmail.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonEmail.Source email, in CanonTests32.Client.Models.JsonString.Source name, in CanonTests32.Client.Models.JsonString.Source message = default)
    {
        return new Source(email, name, message);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonEmail.Source email, in CanonTests32.Client.Models.JsonString.Source name, in CanonTests32.Client.Models.JsonString.Source message = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(email, name, message);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostFormsContactBody, Mutable>(this);
    }
}
