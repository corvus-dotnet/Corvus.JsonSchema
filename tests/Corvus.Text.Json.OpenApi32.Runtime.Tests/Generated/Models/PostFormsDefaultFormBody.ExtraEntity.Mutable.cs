...
public readonly partial struct PostFormsDefaultFormBody
{
    ...
    public readonly partial struct ExtraEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ExtraEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExtraEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExtraEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExtraEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ExtraEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ExtraEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExtraEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ExtraEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ExtraEntity, Mutable>(this);
        }
    }
}
