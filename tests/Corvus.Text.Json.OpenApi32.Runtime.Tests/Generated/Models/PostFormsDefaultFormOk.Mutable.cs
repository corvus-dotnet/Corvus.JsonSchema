...
public readonly partial struct PostFormsDefaultFormOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsDefaultFormOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsDefaultFormOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsDefaultFormOk(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsDefaultFormOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsDefaultFormOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsDefaultFormOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsDefaultFormOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.PostFormsDefaultFormOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(PostFormsDefaultFormOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostFormsDefaultFormOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostFormsDefaultFormOk"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<PostFormsDefaultFormOk, Mutable>(this);
    }
}
