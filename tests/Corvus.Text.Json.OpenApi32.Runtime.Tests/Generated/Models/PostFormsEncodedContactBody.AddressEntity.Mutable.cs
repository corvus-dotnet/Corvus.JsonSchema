...
public readonly partial struct PostFormsEncodedContactBody
{
    ...
    public readonly partial struct AddressEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public CanonTests32.Client.Models.JsonString.Mutable City
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CityUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public CanonTests32.Client.Models.JsonString.Mutable Street
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreetUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetCity(in CanonTests32.Client.Models.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CityUtf8);
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.City, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>city</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveCity()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CityUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetStreet(in CanonTests32.Client.Models.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StreetUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Street, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>street</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveStreet()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StreetUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
        ...
        public ref struct Source
        {
            ...
            internal Source(CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="AddressEntity"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in CanonTests32.Client.Models.JsonString.Source city = default,
                in CanonTests32.Client.Models.JsonString.Source street = default)
            {
                city.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.City, ref builder);
                street.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Street, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="AddressEntity"/>.
            /// </summary>
            public void Create(in CanonTests32.Client.Models.JsonString.Source city = default, in CanonTests32.Client.Models.JsonString.Source street = default)
            {
                Create(ref _builder, city, street);
            }
        ...
        /// </summary>
        /// <param name="city">The value of the <c>"city"</c> property.</param>
        /// <param name="street">The value of the <c>"street"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in CanonTests32.Client.Models.JsonString.Source city = default, in CanonTests32.Client.Models.JsonString.Source street = default)
        {
            return new Source(city, street);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source city = default, in CanonTests32.Client.Models.JsonString.Source street = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(city, street);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
