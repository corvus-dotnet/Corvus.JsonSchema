...
public readonly partial struct PostFormsEncodedContactBody
{
    ...
    public readonly partial struct AddressEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public CanonTests32.Client.JsonString.Mutable City
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CityUtf8, out CanonTests32.Client.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public CanonTests32.Client.JsonString.Mutable Street
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreetUtf8, out CanonTests32.Client.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetCity(in CanonTests32.Client.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetStreet(in CanonTests32.Client.JsonString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(CanonTests32.Client.PostFormsEncodedContactBody.AddressEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests32.Client.PostFormsEncodedContactBody.AddressEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in CanonTests32.Client.JsonString.Source city = default,
                in CanonTests32.Client.JsonString.Source street = default)
            {
            ...
            /// Creates an instance of a <see cref="AddressEntity"/>.
            /// </summary>
            public void Create(in CanonTests32.Client.JsonString.Source city = default, in CanonTests32.Client.JsonString.Source street = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.JsonString.Source city = default, in CanonTests32.Client.JsonString.Source street = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
