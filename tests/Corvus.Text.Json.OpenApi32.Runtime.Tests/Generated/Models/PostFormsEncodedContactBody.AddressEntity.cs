...
public readonly partial struct PostFormsEncodedContactBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Client.JsonString City
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CityUtf8, out CanonTests32.Client.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Client.JsonString Street
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreetUtf8, out CanonTests32.Client.JsonString value))
                {
                    return value;
                }
