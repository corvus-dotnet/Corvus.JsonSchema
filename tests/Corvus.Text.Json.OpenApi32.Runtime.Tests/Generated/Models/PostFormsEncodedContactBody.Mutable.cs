...
public readonly partial struct PostFormsEncodedContactBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Mutable Address
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AddressUtf8, out CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetAddress(in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAddress<TContext>(in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source _createArg3;
        private readonly CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source _createArg4;
        ...
        internal Source(CanonTests32.Client.Models.PostFormsEncodedContactBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.JsonEmail.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source arg3, in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.JsonEmail.Source _createArg1;
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg2;
        private readonly CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> _createArg3;
        private readonly CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> _createArg4;
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostFormsEncodedContactBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Client.Models.JsonEmail.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> arg3, in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> arg4)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source address = default,
            in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source tags = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in CanonTests32.Client.Models.JsonEmail.Source email,
            in CanonTests32.Client.Models.JsonString.Source name,
            in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> address = default,
            in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonEmail.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source arg3, in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg4">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonEmail.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> arg3, in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> arg4, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonEmail.Source email, in CanonTests32.Client.Models.JsonString.Source name, in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source address = default, in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source tags = default)
    {
    ...
    /// <param name="tags">The value of the <c>"tags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonEmail.Source email, in CanonTests32.Client.Models.JsonString.Source name, in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> address = default, in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonEmail.Source email, in CanonTests32.Client.Models.JsonString.Source name, in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source address = default, in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Client.Models.JsonEmail.Source email, in CanonTests32.Client.Models.JsonString.Source name, in CanonTests32.Client.Models.PostFormsEncodedContactBody.AddressEntity.Source<TContext> address = default, in CanonTests32.Client.Models.PostFormsEncodedContactBody.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
