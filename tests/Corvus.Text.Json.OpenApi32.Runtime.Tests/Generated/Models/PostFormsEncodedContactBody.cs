...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Client.PostFormsEncodedContactBody.AddressEntity Address
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AddressUtf8, out CanonTests32.Client.PostFormsEncodedContactBody.AddressEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.JsonEmail Email
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out CanonTests32.Client.JsonEmail value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests32.Client.PostFormsEncodedContactBody.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests32.Client.PostFormsEncodedContactBody.JsonStringArray value))
            {
                return value;
            }
