...
public readonly partial struct PostFormsEncodedUploadBody
{
    ...
    public readonly partial struct MetadataEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public CanonTests32.Client.Models.JsonString.Mutable Author
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public CanonTests32.Client.Models.JsonInteger.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out CanonTests32.Client.Models.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetAuthor(in CanonTests32.Client.Models.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersion(in CanonTests32.Client.Models.JsonInteger.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonInteger.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in CanonTests32.Client.Models.JsonString.Source author = default,
                in CanonTests32.Client.Models.JsonInteger.Source version = default)
            {
            ...
            /// Creates an instance of a <see cref="MetadataEntity"/>.
            /// </summary>
            public void Create(in CanonTests32.Client.Models.JsonString.Source author = default, in CanonTests32.Client.Models.JsonInteger.Source version = default)
            {
            ...
            internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in CanonTests32.Client.Models.JsonString.Source author = default, in CanonTests32.Client.Models.JsonInteger.Source version = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source author = default, in CanonTests32.Client.Models.JsonInteger.Source version = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
