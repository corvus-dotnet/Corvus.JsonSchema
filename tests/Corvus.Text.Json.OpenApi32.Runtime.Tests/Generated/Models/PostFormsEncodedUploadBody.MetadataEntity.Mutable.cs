...
public readonly partial struct PostFormsEncodedUploadBody
{
    ...
    public readonly partial struct MetadataEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public CanonTests32.Client.JsonString.Mutable Author
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorUtf8, out CanonTests32.Client.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public CanonTests32.Client.JsonInteger.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out CanonTests32.Client.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetAuthor(in CanonTests32.Client.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVersion(in CanonTests32.Client.JsonInteger.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(CanonTests32.Client.PostFormsEncodedUploadBody.MetadataEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests32.Client.PostFormsEncodedUploadBody.MetadataEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in CanonTests32.Client.JsonString.Source author = default,
                in CanonTests32.Client.JsonInteger.Source version = default)
            {
            ...
            /// Creates an instance of a <see cref="MetadataEntity"/>.
            /// </summary>
            public void Create(in CanonTests32.Client.JsonString.Source author = default, in CanonTests32.Client.JsonInteger.Source version = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.JsonString.Source author = default, in CanonTests32.Client.JsonInteger.Source version = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
