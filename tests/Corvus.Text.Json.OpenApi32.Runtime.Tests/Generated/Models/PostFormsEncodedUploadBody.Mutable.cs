...
public readonly partial struct PostFormsEncodedUploadBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsEncodedUploadBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsEncodedUploadBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsEncodedUploadBody(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Mutable Metadata
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMetadata(in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMetadata<TContext>(in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsEncodedUploadBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsEncodedUploadBody Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsEncodedUploadBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsEncodedUploadBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source _createArg2;
        private readonly CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source _createArg3;
        ...
        internal Source(CanonTests32.Client.Models.PostFormsEncodedUploadBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source arg2, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(PostFormsEncodedUploadBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.JsonString.Source _createArg1;
        private readonly CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> _createArg2;
        private readonly CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> _createArg3;
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostFormsEncodedUploadBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> arg2, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostFormsEncodedUploadBody"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.JsonString.Source title,
            in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source metadata = default,
            in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source tags = default)
        {
        ...
        public void Create(
            ...
            in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source tags = default)
        {
            Create(ref _builder, title, metadata, tags);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.JsonString.Source title,
            in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> metadata = default,
            in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, title, metadata, tags);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source arg2, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> arg2, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source title, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source metadata = default, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source tags = default)
    {
        return new Source(title, metadata, tags);
    }
    ...
    /// <param name="tags">The value of the <c>"tags"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.JsonString.Source title, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, title, metadata, tags);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source title, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source metadata = default, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(title, metadata, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Client.Models.JsonString.Source title, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, title, metadata, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostFormsEncodedUploadBody, Mutable>(this);
    }
}
