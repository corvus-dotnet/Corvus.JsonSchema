...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity Metadata
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests32.Client.Models.PostFormsEncodedUploadBody.MetadataEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests32.Client.Models.PostFormsEncodedUploadBody.JsonStringArray value))
            {
                return value;
            }
