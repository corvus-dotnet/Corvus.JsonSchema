...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.JsonBoolean Uploaded
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedUtf8, out CanonTests32.Client.JsonBoolean value))
            {
                return value;
            }
