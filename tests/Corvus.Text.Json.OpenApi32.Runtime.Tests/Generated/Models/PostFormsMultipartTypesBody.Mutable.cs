...
public readonly partial struct PostFormsMultipartTypesBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsMultipartTypesBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsMultipartTypesBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsMultipartTypesBody(Mutable instance)
        {
        ...
        public void SetActive(in CanonTests32.Client.Models.JsonBoolean.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("active");
            }
        ...
        public void SetNote(in CanonTests32.Client.Models.PostFormsMultipartTypesBody.NoteEntity.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.NoteUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NoteUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Note, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>note</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveNote()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.NoteUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsMultipartTypesBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsMultipartTypesBody Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsMultipartTypesBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsMultipartTypesBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.JsonBinary.Source _createArg4;
        private readonly CanonTests32.Client.Models.PostFormsMultipartTypesBody.NoteEntity.Source _createArg5;
        ...
        internal Source(in CanonTests32.Client.Models.JsonBoolean.Source arg1, in CanonTests32.Client.Models.JsonInteger.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3, in CanonTests32.Client.Models.JsonBinary.Source arg4, in CanonTests32.Client.Models.PostFormsMultipartTypesBody.NoteEntity.Source arg5)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
    ...
    public ref struct Builder
    {
            ...
            in CanonTests32.Client.Models.PostFormsMultipartTypesBody.NoteEntity.Source note = default)
        {
            ...
            note.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Note, ref builder);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonBoolean.Source arg1, in CanonTests32.Client.Models.JsonInteger.Source arg2, in CanonTests32.Client.Models.JsonString.Source arg3, in CanonTests32.Client.Models.JsonBinary.Source arg4, in CanonTests32.Client.Models.PostFormsMultipartTypesBody.NoteEntity.Source arg5, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <param name="note">The value of the <c>"note"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonBoolean.Source active, in CanonTests32.Client.Models.JsonInteger.Source count, in CanonTests32.Client.Models.JsonString.Source title, in CanonTests32.Client.Models.JsonBinary.Source file = default, in CanonTests32.Client.Models.PostFormsMultipartTypesBody.NoteEntity.Source note = default)
    {
        return new Source(active, count, title, file, note);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonBoolean.Source active, in CanonTests32.Client.Models.JsonInteger.Source count, in CanonTests32.Client.Models.JsonString.Source title, in CanonTests32.Client.Models.JsonBinary.Source file = default, in CanonTests32.Client.Models.PostFormsMultipartTypesBody.NoteEntity.Source note = default, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(active, count, title, file, note);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostFormsMultipartTypesBody, Mutable>(this);
    }
}
