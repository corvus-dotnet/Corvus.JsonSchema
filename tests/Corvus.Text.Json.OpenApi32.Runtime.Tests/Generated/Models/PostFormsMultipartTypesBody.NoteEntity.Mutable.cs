...
public readonly partial struct PostFormsMultipartTypesBody
{
    ...
    public readonly partial struct NoteEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NoteEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NoteEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NoteEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NoteEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NoteEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NoteEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NoteEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly NoteEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NoteEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NoteEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly NoteEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NoteEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(NoteEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<NoteEntity, Mutable>(this);
        }
    }
}
