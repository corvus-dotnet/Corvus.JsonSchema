...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostFormsMultipartTypesBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostFormsMultipartTypesBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostFormsMultipartTypesBody DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PostFormsMultipartTypesBody left, in PostFormsMultipartTypesBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostFormsMultipartTypesBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostFormsMultipartTypesBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostFormsMultipartTypesBody(JsonElement instance)
    {
        return PostFormsMultipartTypesBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFormsMultipartTypesBody From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFormsMultipartTypesBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostFormsMultipartTypesBody>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFormsMultipartTypesBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostFormsMultipartTypesBody>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFormsMultipartTypesBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostFormsMultipartTypesBody>(json, options);
    }
    ...
    /// </exception>
    public static PostFormsMultipartTypesBody ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostFormsMultipartTypesBody>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostFormsMultipartTypesBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostFormsMultipartTypesBody>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PostFormsMultipartTypesBody(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PostFormsMultipartTypesBody IJsonElement<PostFormsMultipartTypesBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostFormsMultipartTypesBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PostFormsMultipartTypesBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PostFormsMultipartTypesBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PostFormsMultipartTypesBody Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PostFormsMultipartTypesBody>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PostFormsMultipartTypesBody"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PostFormsMultipartTypesBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostFormsMultipartTypesBody>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Active"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Note"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Active"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ActiveUtf8 => "active"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Active"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Note"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Note => "note"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Active"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Active => [0x85, 0x00, 0x00, 0x00, 0x22, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Note"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Note => [0x65, 0x00, 0x00, 0x00, 0x22, 0x6E, 0x6F, 0x74, 0x65, 0x22];
