...
public readonly partial struct PostFormsMultipartTypesOk
    : IJsonElement<PostFormsMultipartTypesOk>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUploadedPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("uploaded"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUploadedNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("uploaded"u8, buffer, out written);

        private const int RequiredOffsetForUploaded = 0;
        private const uint RequiredBitForUploaded = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForUploaded;
        private static readonly JsonSchemaPathProvider UploadedSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/uploaded"u8, buffer, out written);

        private static void MatchUploaded(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Client.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.UploadedUtf8,
                    evaluationPath: UploadedSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForUploaded] |= RequiredBitForUploaded;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.UploadedUtf8))
            {
                matcher = MatchUploaded;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1forms~1multipart-types/post/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1forms~1multipart-types/post/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1forms~1multipart-types/post/responses/200/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUploadedPresent, "uploaded"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForUploaded] & RequiredBitForUploaded) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyUploadedNotPresent, "uploaded"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUploadedPresent, "uploaded"u8, "required"u8);
