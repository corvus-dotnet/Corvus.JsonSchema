...
public readonly partial struct PostFormsMultipartTypesOk
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.JsonBoolean.Mutable Uploaded
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedUtf8, out CanonTests32.Client.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        public void SetUploaded(in CanonTests32.Client.JsonBoolean.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.PostFormsMultipartTypesOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.PostFormsMultipartTypesOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.JsonBoolean.Source uploaded)
        {
        ...
        /// Creates an instance of a <see cref="PostFormsMultipartTypesOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.JsonBoolean.Source uploaded)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.JsonBoolean.Source uploaded, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
