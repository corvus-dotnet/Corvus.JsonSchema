...
public readonly partial struct PostFormsMultipartTypesOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsMultipartTypesOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsMultipartTypesOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsMultipartTypesOk(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>uploaded</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonBoolean.Mutable Uploaded
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedUtf8, out CanonTests32.Client.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostFormsMultipartTypesOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetUploaded(in CanonTests32.Client.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("uploaded");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UploadedUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Uploaded, ref cvb);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsMultipartTypesOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostFormsMultipartTypesOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostFormsMultipartTypesOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsMultipartTypesOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostFormsMultipartTypesOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostFormsMultipartTypesOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsMultipartTypesOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsMultipartTypesOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.JsonBoolean.Source _createArg1;
        ...
        internal Source(CanonTests32.Client.Models.PostFormsMultipartTypesOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.JsonBoolean.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(PostFormsMultipartTypesOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostFormsMultipartTypesOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostFormsMultipartTypesOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.Models.JsonBoolean.Source uploaded)
        {
        ...
        /// Creates an instance of a <see cref="PostFormsMultipartTypesOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonBoolean.Source uploaded)
        {
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonBoolean.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// </summary>
    /// <param name="uploaded">The value of the <c>"uploaded"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonBoolean.Source uploaded)
    {
        return new Source(uploaded);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonBoolean.Source uploaded, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PostFormsMultipartTypesOk, Mutable>(this);
    }
}
