...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostFormsMultipartTypesOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostFormsMultipartTypesOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostFormsMultipartTypesOk DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PostFormsMultipartTypesOk left, in PostFormsMultipartTypesOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostFormsMultipartTypesOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostFormsMultipartTypesOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostFormsMultipartTypesOk(JsonElement instance)
    {
        return PostFormsMultipartTypesOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFormsMultipartTypesOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFormsMultipartTypesOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostFormsMultipartTypesOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFormsMultipartTypesOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostFormsMultipartTypesOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostFormsMultipartTypesOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostFormsMultipartTypesOk>(json, options);
    }
    ...
    /// </exception>
    public static PostFormsMultipartTypesOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostFormsMultipartTypesOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostFormsMultipartTypesOk? result)
    {
        return JsonElementHelpers.TryParseValue<PostFormsMultipartTypesOk>(ref reader, out result);
    }
...
#if NET
    static PostFormsMultipartTypesOk IJsonElement<PostFormsMultipartTypesOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostFormsMultipartTypesOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostFormsMultipartTypesOk Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostFormsMultipartTypesOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostFormsMultipartTypesOk>(_idx);
        }
