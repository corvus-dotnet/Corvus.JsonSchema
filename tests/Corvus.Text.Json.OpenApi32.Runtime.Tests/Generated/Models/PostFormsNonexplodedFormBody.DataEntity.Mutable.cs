    ...
    public readonly partial struct DataEntity
    {
...
#endif
        {
            ...
            public void SetX(in CanonTests32.Client.Models.JsonString.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.XUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.XUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.X, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>x</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveX()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.XUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetY(in CanonTests32.Client.Models.JsonString.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.YUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.YUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Y, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>y</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveY()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.YUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
        ...
        public ref struct Source
        {
            ...
            internal Source(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in CanonTests32.Client.Models.JsonString.Source arg1, in CanonTests32.Client.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// </summary>
        /// <param name="x">The value of the <c>"x"</c> property.</param>
        /// <param name="y">The value of the <c>"y"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in CanonTests32.Client.Models.JsonString.Source x = default, in CanonTests32.Client.Models.JsonString.Source y = default)
        {
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="x">The value of the property.</param>
