...
public readonly partial struct PostFormsNonexplodedFormBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Client.Models.JsonString X
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.XUtf8, out CanonTests32.Client.Models.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Client.Models.JsonString Y
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.YUtf8, out CanonTests32.Client.Models.JsonString value))
                {
                    return value;
                }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="X"/>.
            /// </summary>
            public const string X = "x";

            /// <summary>
            /// Gets the JSON property name for <see cref="Y"/>.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="X"/>.
            /// </summary>
            public static ReadOnlySpan<byte> X => "x"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Y"/>.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="X"/>.
            /// </summary>
            public static ReadOnlySpan<byte> X => [0x35, 0x00, 0x00, 0x00, 0x22, 0x78, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Y"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Y => [0x35, 0x00, 0x00, 0x00, 0x22, 0x79, 0x22];
        }
    }
}
