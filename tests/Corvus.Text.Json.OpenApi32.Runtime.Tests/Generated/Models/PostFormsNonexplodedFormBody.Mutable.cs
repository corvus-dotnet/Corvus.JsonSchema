...
public readonly partial struct PostFormsNonexplodedFormBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsNonexplodedFormBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsNonexplodedFormBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsNonexplodedFormBody(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostFormsNonexplodedFormBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsNonexplodedFormBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostFormsNonexplodedFormBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostFormsNonexplodedFormBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsNonexplodedFormBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostFormsNonexplodedFormBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostFormsNonexplodedFormBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsNonexplodedFormBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsNonexplodedFormBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.PostFormsNonexplodedFormBody.DataEntity.Source _createArg1;
        private readonly CanonTests32.Client.Models.PostFormsNonexplodedFormBody.JsonStringArray.Source _createArg2;
        ...
        internal Source(in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.DataEntity.Source arg1, in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.JsonStringArray.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.PostFormsNonexplodedFormBody.DataEntity.Source<TContext> _createArg1;
        private readonly CanonTests32.Client.Models.PostFormsNonexplodedFormBody.JsonStringArray.Source<TContext> _createArg2;
        ...
        internal Source(scoped in TContext context, in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.DataEntity.Source<TContext> arg1, in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.JsonStringArray.Source<TContext> arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        #endif
        {
            Create(context, ref _builder, data, keywords);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.DataEntity.Source arg1, in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.JsonStringArray.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.DataEntity.Source<TContext> arg1, in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.JsonStringArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.DataEntity.Source data, in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.JsonStringArray.Source keywords)
    {
        return new Source(data, keywords);
    }
    ...
    /// <param name="keywords">The value of the <c>"keywords"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.DataEntity.Source<TContext> data, in CanonTests32.Client.Models.PostFormsNonexplodedFormBody.JsonStringArray.Source<TContext> keywords)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, data, keywords);
    }
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, data, keywords);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostFormsNonexplodedFormBody, Mutable>(this);
    }
}
