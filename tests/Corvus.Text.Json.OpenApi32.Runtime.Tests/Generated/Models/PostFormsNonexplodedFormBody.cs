...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.PostFormsNonexplodedFormBody.DataEntity Data
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataUtf8, out CanonTests32.Client.PostFormsNonexplodedFormBody.DataEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.PostFormsNonexplodedFormBody.JsonStringArray Keywords
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeywordsUtf8, out CanonTests32.Client.PostFormsNonexplodedFormBody.JsonStringArray value))
            {
                return value;
            }
