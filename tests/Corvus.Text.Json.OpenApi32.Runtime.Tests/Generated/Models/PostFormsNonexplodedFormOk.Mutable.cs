...
public readonly partial struct PostFormsNonexplodedFormOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFormsNonexplodedFormOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFormsNonexplodedFormOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFormsNonexplodedFormOk(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonBoolean.Mutable Received
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReceivedUtf8, out CanonTests32.Client.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        public void SetReceived(in CanonTests32.Client.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFormsNonexplodedFormOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsNonexplodedFormOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostFormsNonexplodedFormOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFormsNonexplodedFormOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.PostFormsNonexplodedFormOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(PostFormsNonexplodedFormOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostFormsNonexplodedFormOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostFormsNonexplodedFormOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.Models.JsonBoolean.Source received)
        {
        ...
        /// Creates an instance of a <see cref="PostFormsNonexplodedFormOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonBoolean.Source received)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonBoolean.Source received)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonBoolean.Source received, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PostFormsNonexplodedFormOk, Mutable>(this);
    }
}
