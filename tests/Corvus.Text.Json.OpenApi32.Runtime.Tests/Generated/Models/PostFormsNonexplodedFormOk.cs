...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.JsonBoolean Received
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReceivedUtf8, out CanonTests32.Client.JsonBoolean value))
            {
                return value;
            }
