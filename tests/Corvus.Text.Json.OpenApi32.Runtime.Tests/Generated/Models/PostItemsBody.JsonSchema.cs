    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchPrice(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                CanonTests32.Client.JsonDouble.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            CanonTests32.Client.JsonDouble.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
