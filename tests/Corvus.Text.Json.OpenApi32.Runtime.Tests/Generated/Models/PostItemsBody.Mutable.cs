...
public readonly partial struct PostItemsBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Client.JsonDouble.Mutable Price
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriceUtf8, out CanonTests32.Client.JsonDouble.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPrice(in CanonTests32.Client.JsonDouble.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.PostItemsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.PostItemsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Client.JsonDouble.Source price = default)
        {
        ...
        /// Creates an instance of a <see cref="PostItemsBody"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.JsonString.Source name, in CanonTests32.Client.JsonDouble.Source price = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.JsonString.Source name, in CanonTests32.Client.JsonDouble.Source price = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
