...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostItemsBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostItemsBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostItemsBody DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests32.Client.Models.JsonDouble Price
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriceUtf8, out CanonTests32.Client.Models.JsonDouble value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostItemsBody left, in PostItemsBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostItemsBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostItemsBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostItemsBody(JsonElement instance)
    {
        return PostItemsBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostItemsBody From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostItemsBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostItemsBody>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostItemsBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostItemsBody>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostItemsBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostItemsBody>(json, options);
    }
    ...
    /// </exception>
    public static PostItemsBody ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostItemsBody>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostItemsBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostItemsBody>(ref reader, out result);
    }
...
#if NET
    static PostItemsBody IJsonElement<PostItemsBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostItemsBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Price"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Price"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PriceUtf8 => "price"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Price"/>.
        /// </summary>
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Price"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Price => [0x75, 0x00, 0x00, 0x00, 0x22, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22];
    }
}
