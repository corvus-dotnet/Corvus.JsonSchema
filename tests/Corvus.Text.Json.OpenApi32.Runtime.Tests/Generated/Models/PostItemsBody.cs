...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Client.JsonDouble Price
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriceUtf8, out CanonTests32.Client.JsonDouble value))
            {
                return value;
            }
