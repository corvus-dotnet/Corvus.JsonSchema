...
public readonly partial struct PostItemsCreated
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.PostItemsCreated.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostItemsCreated.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Client.Models.JsonString.Source id,
        ...
        /// Creates an instance of a <see cref="PostItemsCreated"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonString.Source id, in CanonTests32.Client.Models.JsonString.Source name)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source id, in CanonTests32.Client.Models.JsonString.Source name)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source id, in CanonTests32.Client.Models.JsonString.Source name, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
