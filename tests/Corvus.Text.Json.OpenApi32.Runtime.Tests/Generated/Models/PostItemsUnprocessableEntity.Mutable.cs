...
public readonly partial struct PostItemsUnprocessableEntity
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostItemsUnprocessableEntity instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostItemsUnprocessableEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostItemsUnprocessableEntity(Mutable instance)
        {
        ...
        public void SetErrors(in CanonTests32.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("errors");
            }
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Errors, ref cvb);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostItemsUnprocessableEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostItemsUnprocessableEntity Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostItemsUnprocessableEntity Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostItemsUnprocessableEntity>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source _createArg1;
        ...
        internal Source(in CanonTests32.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, in CanonTests32.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        #endif
        {
            Create(context, ref _builder, errors);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source errors)
    {
    ...
    /// <param name="errors">The value of the <c>"errors"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.PostItemsUnprocessableEntity.JsonStringArray.Source<TContext> errors)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<PostItemsUnprocessableEntity, Mutable>(this);
    }
}
