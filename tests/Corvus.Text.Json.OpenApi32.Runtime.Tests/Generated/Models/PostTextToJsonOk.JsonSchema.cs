    ...
    : IJsonElement<PostTextToJsonOk>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyParsedPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("parsed"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyParsedNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("parsed"u8, buffer, out written);

        private const int RequiredOffsetForParsed = 0;
        private const uint RequiredBitForParsed = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForParsed;
        private static readonly JsonSchemaPathProvider ParsedSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/parsed"u8, buffer, out written);

        private static void MatchParsed(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Client.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ParsedUtf8,
                    evaluationPath: ParsedSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForParsed] |= RequiredBitForParsed;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.ParsedUtf8))
            {
                matcher = MatchParsed;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1text~1to-json/post/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1text~1to-json/post/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1text~1to-json/post/responses/200/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyParsedPresent, "parsed"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForParsed] & RequiredBitForParsed) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyParsedNotPresent, "parsed"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyParsedPresent, "parsed"u8, "required"u8);
