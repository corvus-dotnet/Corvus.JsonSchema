...
public readonly partial struct PostTextToJsonOk
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonString.Mutable Parsed
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParsedUtf8, out CanonTests32.Client.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetParsed(in CanonTests32.Client.Models.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Models.PostTextToJsonOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.PostTextToJsonOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Client.Models.JsonString.Source parsed)
        {
        ...
        /// Creates an instance of a <see cref="PostTextToJsonOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.JsonString.Source parsed)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source parsed)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.JsonString.Source parsed, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
