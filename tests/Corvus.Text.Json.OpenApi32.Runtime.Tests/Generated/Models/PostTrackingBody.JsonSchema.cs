    ...
    : IJsonElement<PostTrackingBody>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEventPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("event"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEventNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("event"u8, buffer, out written);

        private const int RequiredOffsetForEvent = 0;
        private const uint RequiredBitForEvent = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForEvent;
        private static readonly JsonSchemaPathProvider EventSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/event"u8, buffer, out written);

        private static void MatchEvent(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Client.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.EventUtf8,
                    evaluationPath: EventSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForEvent] |= RequiredBitForEvent;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.EventUtf8))
            {
                matcher = MatchEvent;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1tracking/post/requestBody/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1tracking/post/requestBody/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1tracking/post/requestBody/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEventPresent, "event"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForEvent] & RequiredBitForEvent) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyEventNotPresent, "event"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEventPresent, "event"u8, "required"u8);
