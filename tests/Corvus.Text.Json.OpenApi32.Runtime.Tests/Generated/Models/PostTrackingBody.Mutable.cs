...
public readonly partial struct PostTrackingBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostTrackingBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostTrackingBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostTrackingBody(Mutable instance)
        {
        ...
        public void SetEvent(in CanonTests32.Client.Models.JsonString.Source value)
        {
            ...
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("event");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Event, ref cvb);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostTrackingBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostTrackingBody Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostTrackingBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostTrackingBody>(_idx);
        }
    }
    ...
    /// </summary>
    /// <param name="eventValue">The value of the <c>"event"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.JsonString.Source eventValue)
    {
        return new Source(eventValue);
    }
    ...
    {
        return workspace.CreateBuilder<PostTrackingBody, Mutable>(this);
    }
}
