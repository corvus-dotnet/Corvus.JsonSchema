...
public readonly partial struct PostTrackingBody
#if NET8_0_OR_GREATER
    : IJsonElement<PostTrackingBody>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostTrackingBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostTrackingBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostTrackingBody DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonString Event
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventUtf8, out CanonTests32.Client.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostTrackingBody left, in PostTrackingBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostTrackingBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostTrackingBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostTrackingBody(JsonElement instance)
    {
        return PostTrackingBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostTrackingBody From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostTrackingBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostTrackingBody>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostTrackingBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostTrackingBody>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostTrackingBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostTrackingBody>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static PostTrackingBody ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<PostTrackingBody>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostTrackingBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostTrackingBody>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PostTrackingBody(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PostTrackingBody IJsonElement<PostTrackingBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostTrackingBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PostTrackingBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PostTrackingBody"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PostTrackingBody Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PostTrackingBody>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PostTrackingBody"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PostTrackingBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostTrackingBody>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Event"/>.
        /// </summary>
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Event"/>.
        /// </summary>
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Event"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Event => [0x75, 0x00, 0x00, 0x00, 0x22, 0x65, 0x76, 0x65, 0x6E, 0x74, 0x22];
    }
}
