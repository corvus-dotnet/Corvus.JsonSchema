...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.JsonString Event
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventUtf8, out CanonTests32.Client.JsonString value))
            {
                return value;
            }
