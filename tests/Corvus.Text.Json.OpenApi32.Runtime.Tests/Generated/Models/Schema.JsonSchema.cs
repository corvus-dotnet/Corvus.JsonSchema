    ...
    : IJsonElement<Schema>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForLocation = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForId | RequiredBitForLocation;
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1items~1{itemId}/additionalOperations/COPY/responses/201/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1items~1{itemId}/additionalOperations/COPY/responses/201/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1items~1{itemId}/additionalOperations/COPY/responses/201/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    ...
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLocationPresent, "location"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyLocationNotPresent, "location"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLocationPresent, "location"u8, "required"u8);
