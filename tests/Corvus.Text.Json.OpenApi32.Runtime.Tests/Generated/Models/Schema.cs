...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Client.Models.JsonString Location
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LocationUtf8, out CanonTests32.Client.Models.JsonString value))
            {
                return value;
            }
