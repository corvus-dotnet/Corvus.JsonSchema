...
public readonly partial struct Schema2
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Schema2 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Schema2"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Schema2(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Mutable Results
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResultsUtf8, out CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Models.JsonInt32.Mutable Total
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalUtf8, out CanonTests32.Client.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Schema2(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetResults(in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetResults<TContext>(in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTotal(in CanonTests32.Client.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Schema2.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Schema2"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Schema2"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Schema2 Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Schema2>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Schema2"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Schema2 Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Schema2>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source _createArg1;
        private readonly CanonTests32.Client.Models.JsonInt32.Source _createArg2;
        ...
        internal Source(CanonTests32.Client.Models.Schema2.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(Schema2 instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source<TContext> _createArg1;
        private readonly CanonTests32.Client.Models.JsonInt32.Source _createArg2;
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Models.Schema2.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source<TContext> arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Schema2"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source results,
            in CanonTests32.Client.Models.JsonInt32.Source total)
        {
        ...
        /// Creates an instance of a <see cref="Schema2"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source results, in CanonTests32.Client.Models.JsonInt32.Source total)
        {
            Create(ref _builder, results, total);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source<TContext> results,
            in CanonTests32.Client.Models.JsonInt32.Source total)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, results, total);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source<TContext> arg1, in CanonTests32.Client.Models.JsonInt32.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source results, in CanonTests32.Client.Models.JsonInt32.Source total)
    {
        return new Source(results, total);
    }
    ...
    /// <param name="total">The value of the <c>"total"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source<TContext> results, in CanonTests32.Client.Models.JsonInt32.Source total)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, results, total);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source results, in CanonTests32.Client.Models.JsonInt32.Source total, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(results, total);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Client.Models.Schema2.RequiredIdAndTitleArray.Source<TContext> results, in CanonTests32.Client.Models.JsonInt32.Source total, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, results, total);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<Schema2, Mutable>(this);
    }
}
