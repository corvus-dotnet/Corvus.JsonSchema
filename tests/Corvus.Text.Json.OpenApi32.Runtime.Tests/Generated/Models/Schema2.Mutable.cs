...
public readonly partial struct Schema2
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.Schema2.RequiredIdAndTitleArray.Mutable Results
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResultsUtf8, out CanonTests32.Client.Schema2.RequiredIdAndTitleArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Client.JsonInt32.Mutable Total
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalUtf8, out CanonTests32.Client.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        public void SetResults(in CanonTests32.Client.Schema2.RequiredIdAndTitleArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetResults<TContext>(in CanonTests32.Client.Schema2.RequiredIdAndTitleArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTotal(in CanonTests32.Client.JsonInt32.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Client.Schema2.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Client.Schema2.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Client.Schema2.RequiredIdAndTitleArray.Source results,
            in CanonTests32.Client.JsonInt32.Source total)
        {
        ...
        /// Creates an instance of a <see cref="Schema2"/>.
        /// </summary>
        public void Create(in CanonTests32.Client.Schema2.RequiredIdAndTitleArray.Source results, in CanonTests32.Client.JsonInt32.Source total)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in CanonTests32.Client.Schema2.RequiredIdAndTitleArray.Source<TContext> results,
            in CanonTests32.Client.JsonInt32.Source total)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Client.Schema2.RequiredIdAndTitleArray.Source results, in CanonTests32.Client.JsonInt32.Source total, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Client.Schema2.RequiredIdAndTitleArray.Source<TContext> results, in CanonTests32.Client.JsonInt32.Source total, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
