...
/// <summary>
/// Response type for the OptionsItems operation.
/// </summary>
public struct OptionsItemsResponse : IApiResponse<OptionsItemsResponse>
{
    ...
    /// <inheritdoc/>
    public static ValueTask<OptionsItemsResponse> CreateAsync(
        int statusCode,
    ...
    {
        OptionsItemsResponse response = default;
