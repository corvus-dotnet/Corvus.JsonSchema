...
/// <summary>
/// Request type for the PatchItem operation.
/// </summary>
/// <remarks>Partially update an item</remarks>
public readonly struct PatchItemRequest : IApiRequest<PatchItemRequest>
{
    ...
    public PatchItemRequest(CanonTests32.Client.Models.JsonString itemId)
    {
        this.ItemId = itemId;
    }
