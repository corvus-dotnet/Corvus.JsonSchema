...
/// <summary>
/// Request type for the PathArrayLabel operation.
/// </summary>
/// <remarks>Path array param, label style</remarks>
public readonly struct PathArrayLabelRequest : IApiRequest<PathArrayLabelRequest>
{

    /// <summary>
    /// Gets the ids parameter.
    /// </summary>
    public CanonTests32.Client.Models.GetComplexPathArrayLabelByIdsIds Ids { get; init; }

    /// <summary>
    /// Initializes a new instance of the <see cref="PathArrayLabelRequest"/> struct.
    /// </summary>
    /// <param name="ids">The ids parameter.</param>
    public PathArrayLabelRequest(CanonTests32.Client.Models.GetComplexPathArrayLabelByIdsIds ids)
    {
        this.Ids = ids;
    }

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/complex/path-array-label/{ids}"u8;
    ...
    {
        writer.Write("/complex/path-array-label/"u8);
        writer.Write("."u8);
