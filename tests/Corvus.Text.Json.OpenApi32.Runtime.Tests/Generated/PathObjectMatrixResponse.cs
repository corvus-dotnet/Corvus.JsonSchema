...
/// <summary>
/// Response type for the PathObjectMatrix operation.
/// </summary>
public struct PathObjectMatrixResponse : IApiResponse<PathObjectMatrixResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PathObjectMatrixResponse> CreateAsync(
        int statusCode,
    ...
    {
        PathObjectMatrixResponse response = default;
