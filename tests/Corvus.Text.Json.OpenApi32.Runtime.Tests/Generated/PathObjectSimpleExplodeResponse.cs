...
/// <summary>
/// Response type for the PathObjectSimpleExplode operation.
/// </summary>
public struct PathObjectSimpleExplodeResponse : IApiResponse<PathObjectSimpleExplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<PathObjectSimpleExplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        PathObjectSimpleExplodeResponse response = default;
