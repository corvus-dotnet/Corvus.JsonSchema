...
/// <summary>
/// Request type for the ProcessBatch operation.
/// </summary>
/// <remarks>Process a batch of items via multipart/mixed (itemEncoding)</remarks>
public readonly struct ProcessBatchRequest : IApiRequest<ProcessBatchRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/docs/batch-process"u8;
