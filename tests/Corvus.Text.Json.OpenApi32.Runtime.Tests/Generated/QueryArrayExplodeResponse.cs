...
/// <summary>
/// Response type for the QueryArrayExplode operation.
/// </summary>
public struct QueryArrayExplodeResponse : IApiResponse<QueryArrayExplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<QueryArrayExplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        QueryArrayExplodeResponse response = default;
