...
/// <summary>
/// Response type for the QueryArraySpace operation.
/// </summary>
public struct QueryArraySpaceResponse : IApiResponse<QueryArraySpaceResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<QueryArraySpaceResponse> CreateAsync(
        int statusCode,
    ...
    {
        QueryArraySpaceResponse response = default;
