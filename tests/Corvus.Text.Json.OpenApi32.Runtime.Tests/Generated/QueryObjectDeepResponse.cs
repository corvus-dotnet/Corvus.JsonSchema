...
/// <summary>
/// Response type for the QueryObjectDeep operation.
/// </summary>
public struct QueryObjectDeepResponse : IApiResponse<QueryObjectDeepResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<QueryObjectDeepResponse> CreateAsync(
        int statusCode,
    ...
    {
        QueryObjectDeepResponse response = default;
