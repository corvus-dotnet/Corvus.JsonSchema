...
/// <summary>
/// Response type for the QueryObjectExplode operation.
/// </summary>
public struct QueryObjectExplodeResponse : IApiResponse<QueryObjectExplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<QueryObjectExplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        QueryObjectExplodeResponse response = default;
