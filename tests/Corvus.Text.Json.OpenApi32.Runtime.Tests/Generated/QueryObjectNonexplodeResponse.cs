...
/// <summary>
/// Response type for the QueryObjectNonexplode operation.
/// </summary>
public struct QueryObjectNonexplodeResponse : IApiResponse<QueryObjectNonexplodeResponse>
{
    ...
    /// <inheritdoc/>
    public static async ValueTask<QueryObjectNonexplodeResponse> CreateAsync(
        int statusCode,
    ...
    {
        QueryObjectNonexplodeResponse response = default;
