...
/// <summary>
/// Request type for the StreamEvents operation.
/// </summary>
/// <remarks>Stream events as NDJSON using itemSchema</remarks>
public readonly struct StreamEventsRequest : IApiRequest<StreamEventsRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/events/stream"u8;
    ...
    {
        callback("Accept"u8, "application/json, application/x-ndjson"u8, state);
