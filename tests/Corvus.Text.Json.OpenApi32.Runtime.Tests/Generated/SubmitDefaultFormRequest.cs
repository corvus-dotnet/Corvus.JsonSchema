...
/// <summary>
/// Request type for the SubmitDefaultForm operation.
/// </summary>
/// <remarks>Submit form with default encoding (explode=true for arrays and objects)</remarks>
public readonly struct SubmitDefaultFormRequest : IApiRequest<SubmitDefaultFormRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/forms/default-form"u8;
