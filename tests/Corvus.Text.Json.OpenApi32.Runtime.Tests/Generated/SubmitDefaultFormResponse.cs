...
/// <summary>
/// Response type for the SubmitDefaultForm operation.
/// </summary>
public struct SubmitDefaultFormResponse : IApiResponse<SubmitDefaultFormResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.Models.PostFormsDefaultFormOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<SubmitDefaultFormResponse> CreateAsync(
        int statusCode,
    ...
    {
        SubmitDefaultFormResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.Models.PostFormsDefaultFormOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.Models.PostFormsDefaultFormOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.Models.PostFormsDefaultFormOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.Models.PostFormsDefaultFormOk, TContext, TResult> matchOk,
