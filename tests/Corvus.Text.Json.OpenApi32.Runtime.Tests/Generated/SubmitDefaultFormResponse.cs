...
public struct SubmitDefaultFormResponse : IApiResponse<SubmitDefaultFormResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.PostFormsDefaultFormOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.PostFormsDefaultFormOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.PostFormsDefaultFormOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.PostFormsDefaultFormOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.PostFormsDefaultFormOk, TContext, TResult> matchOk,
