...
/// <summary>
/// Request type for the SubmitMultipartTypes operation.
/// </summary>
/// <remarks>Submit multipart form with various value types</remarks>
public readonly struct SubmitMultipartTypesRequest : IApiRequest<SubmitMultipartTypesRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/forms/multipart-types"u8;
