...
/// <summary>
/// Response type for the SubmitMultipartTypes operation.
/// </summary>
public struct SubmitMultipartTypesResponse : IApiResponse<SubmitMultipartTypesResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.Models.PostFormsMultipartTypesOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<SubmitMultipartTypesResponse> CreateAsync(
        int statusCode,
    ...
    {
        SubmitMultipartTypesResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.Models.PostFormsMultipartTypesOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.Models.PostFormsMultipartTypesOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.Models.PostFormsMultipartTypesOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.Models.PostFormsMultipartTypesOk, TContext, TResult> matchOk,
