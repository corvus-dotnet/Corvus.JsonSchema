...
public struct SubmitMultipartTypesResponse : IApiResponse<SubmitMultipartTypesResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.PostFormsMultipartTypesOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.PostFormsMultipartTypesOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.PostFormsMultipartTypesOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.PostFormsMultipartTypesOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.PostFormsMultipartTypesOk, TContext, TResult> matchOk,
