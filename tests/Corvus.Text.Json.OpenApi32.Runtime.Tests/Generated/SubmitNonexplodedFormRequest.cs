...
/// <summary>
/// Request type for the SubmitNonexplodedForm operation.
/// </summary>
/// <remarks>Submit form with non-exploded object and spaceDelimited array</remarks>
public readonly struct SubmitNonexplodedFormRequest : IApiRequest<SubmitNonexplodedFormRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/forms/nonexploded-form"u8;
