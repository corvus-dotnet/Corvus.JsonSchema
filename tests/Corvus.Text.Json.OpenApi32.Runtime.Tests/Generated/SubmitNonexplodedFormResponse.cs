...
/// <summary>
/// Response type for the SubmitNonexplodedForm operation.
/// </summary>
public struct SubmitNonexplodedFormResponse : IApiResponse<SubmitNonexplodedFormResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.Models.PostFormsNonexplodedFormOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<SubmitNonexplodedFormResponse> CreateAsync(
        int statusCode,
    ...
    {
        SubmitNonexplodedFormResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.Models.PostFormsNonexplodedFormOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.Models.PostFormsNonexplodedFormOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.Models.PostFormsNonexplodedFormOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.Models.PostFormsNonexplodedFormOk, TContext, TResult> matchOk,
