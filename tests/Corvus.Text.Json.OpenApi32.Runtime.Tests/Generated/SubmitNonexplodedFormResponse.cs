...
public struct SubmitNonexplodedFormResponse : IApiResponse<SubmitNonexplodedFormResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.PostFormsNonexplodedFormOk OkBody { get; private set; }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.PostFormsNonexplodedFormOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.PostFormsNonexplodedFormOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.PostFormsNonexplodedFormOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.PostFormsNonexplodedFormOk, TContext, TResult> matchOk,
