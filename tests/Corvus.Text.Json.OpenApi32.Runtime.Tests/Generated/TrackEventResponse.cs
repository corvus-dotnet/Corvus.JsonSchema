...
/// <summary>
/// Response type for the TrackEvent operation.
/// </summary>
public struct TrackEventResponse : IApiResponse<TrackEventResponse>
{
    ...
    /// <inheritdoc/>
    public static ValueTask<TrackEventResponse> CreateAsync(
        int statusCode,
    ...
    {
        TrackEventResponse response = default;
