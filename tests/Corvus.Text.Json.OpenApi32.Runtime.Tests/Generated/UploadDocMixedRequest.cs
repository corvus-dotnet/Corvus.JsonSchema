...
/// <summary>
/// Request type for the UploadDocMixed operation.
/// </summary>
/// <remarks>Upload a document with metadata via multipart/mixed (prefixEncoding)</remarks>
public readonly struct UploadDocMixedRequest : IApiRequest<UploadDocMixedRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/docs/upload-mixed"u8;
