...
/// <summary>
/// Response type for the UploadDocument operation.
/// </summary>
public struct UploadDocumentResponse : IApiResponse<UploadDocumentResponse>
{
    ...
    /// </summary>
    public CanonTests32.Client.Models.PostFormsUploadOk OkBody { get; private set; }

    /// <inheritdoc/>
    public static async ValueTask<UploadDocumentResponse> CreateAsync(
        int statusCode,
    ...
    {
        UploadDocumentResponse response = default;
        response.StatusCode = statusCode;
        response.owner = owner;

        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<CanonTests32.Client.Models.PostFormsUploadOk>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out CanonTests32.Client.Models.PostFormsUploadOk result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<CanonTests32.Client.Models.PostFormsUploadOk, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<CanonTests32.Client.Models.PostFormsUploadOk, TContext, TResult> matchOk,
