...
/// <summary>
/// Result type for the DeleteMonitoringStatus operation.
/// </summary>
public readonly struct DeleteMonitoringStatusResult
{
    private DeleteMonitoringStatusResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
