...
public readonly struct GetAdvancedStylesResult
{
    ...
    public static GetAdvancedStylesResult Ok(CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.Source body, JsonWorkspace workspace, CanonTests32.Server.Models.JsonString.Source xRequestId = default, CanonTests32.Server.Models.GetAdvancedStylesByIdsOkXCounts.Source xCounts = default, CanonTests32.Server.Models.GetAdvancedStylesByIdsOkXScores.Source xScores = default, CanonTests32.Server.Models.GetAdvancedStylesByIdsOkXWeights.Source xWeights = default) => new(200, CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.CreateBuilder(workspace, body, 30).RootElement, "application/json", xRequestId: xRequestId.IsUndefined ? default : CanonTests32.Server.Models.JsonString.CreateBuilder(workspace, xRequestId, 30).RootElement, xCounts: xCounts.IsUndefined ? default : CanonTests32.Server.Models.GetAdvancedStylesByIdsOkXCounts.CreateBuilder(workspace, xCounts, 30).RootElement, xScores: xScores.IsUndefined ? default : CanonTests32.Server.Models.GetAdvancedStylesByIdsOkXScores.CreateBuilder(workspace, xScores, 30).RootElement, xWeights: xWeights.IsUndefined ? default : CanonTests32.Server.Models.GetAdvancedStylesByIdsOkXWeights.CreateBuilder(workspace, xWeights, 30).RootElement);
