...
public readonly struct GetItemResult
{
    ...
    public static GetItemResult Ok(CanonTests32.Server.Models.ItemEntity.Source body, JsonWorkspace workspace, CanonTests32.Server.Models.JsonInt32.Source xRateLimit = default, CanonTests32.Server.Models.JsonBoolean.Source xActive = default, JsonElement.Source xRequestId = default, CanonTests32.Server.Models.GetItemsByItemIdOkXTags.Source xTags = default, CanonTests32.Server.Models.GetItemsByItemIdOkXPageSizes.Source xPageSizes = default, CanonTests32.Server.Models.GetItemsByItemIdOkXFlags.Source xFlags = default) => new(200, CanonTests32.Server.Models.ItemEntity.CreateBuilder(workspace, body, 30).RootElement, "application/json", xRateLimit: CanonTests32.Server.Models.JsonInt32.CreateBuilder(workspace, xRateLimit, 30).RootElement, xActive: CanonTests32.Server.Models.JsonBoolean.CreateBuilder(workspace, xActive, 30).RootElement, xRequestId: JsonElement.CreateBuilder(workspace, xRequestId, 30).RootElement, xTags: CanonTests32.Server.Models.GetItemsByItemIdOkXTags.CreateBuilder(workspace, xTags, 30).RootElement, xPageSizes: CanonTests32.Server.Models.GetItemsByItemIdOkXPageSizes.CreateBuilder(workspace, xPageSizes, 30).RootElement, xFlags: CanonTests32.Server.Models.GetItemsByItemIdOkXFlags.CreateBuilder(workspace, xFlags, 30).RootElement);
