...
{
    private GetItemResult(int statusCode, JsonElement body, string? contentType, CanonTests32.Server.Models.JsonInt32 xRateLimit = default, CanonTests32.Server.Models.JsonBoolean xActive = default, JsonElement xRequestId = default, CanonTests32.Server.Models.GetItemsByItemIdOkXTags xTags = default, CanonTests32.Server.Models.GetItemsByItemIdOkXPageSizes xPageSizes = default, CanonTests32.Server.Models.GetItemsByItemIdOkXFlags xFlags = default)
    {
    ...
    /// </summary>
    public CanonTests32.Server.Models.JsonInt32 XRateLimit { get; }

    /// <summary>
    /// Gets the value of the <c>X-Active</c> response header.
    /// </summary>
    public CanonTests32.Server.Models.JsonBoolean XActive { get; }
    ...
    /// </summary>
    public CanonTests32.Server.Models.GetItemsByItemIdOkXTags XTags { get; }

    /// <summary>
    /// Gets the value of the <c>X-Page-Sizes</c> response header.
    /// </summary>
    public CanonTests32.Server.Models.GetItemsByItemIdOkXPageSizes XPageSizes { get; }

    /// <summary>
    /// Gets the value of the <c>X-Flags</c> response header.
    /// </summary>
    public CanonTests32.Server.Models.GetItemsByItemIdOkXFlags XFlags { get; }
    ...
    public static GetItemResult Ok(CanonTests32.Server.Models.ItemEntity.Source body, JsonWorkspace workspace, CanonTests32.Server.Models.JsonInt32.Source xRateLimit = default, CanonTests32.Server.Models.JsonBoolean.Source xActive = default, JsonElement.Source xRequestId = default, CanonTests32.Server.Models.GetItemsByItemIdOkXTags.Source xTags = default, CanonTests32.Server.Models.GetItemsByItemIdOkXPageSizes.Source xPageSizes = default, CanonTests32.Server.Models.GetItemsByItemIdOkXFlags.Source xFlags = default) => new(200, CanonTests32.Server.Models.ItemEntity.CreateBuilder(workspace, body, 30).RootElement, "application/json", xRateLimit: xRateLimit.IsUndefined ? default : CanonTests32.Server.Models.JsonInt32.CreateBuilder(workspace, xRateLimit, 30).RootElement, xActive: xActive.IsUndefined ? default : CanonTests32.Server.Models.JsonBoolean.CreateBuilder(workspace, xActive, 30).RootElement, xRequestId: xRequestId.IsUndefined ? default : JsonElement.CreateBuilder(workspace, xRequestId, 30).RootElement, xTags: xTags.IsUndefined ? default : CanonTests32.Server.Models.GetItemsByItemIdOkXTags.CreateBuilder(workspace, xTags, 30).RootElement, xPageSizes: xPageSizes.IsUndefined ? default : CanonTests32.Server.Models.GetItemsByItemIdOkXPageSizes.CreateBuilder(workspace, xPageSizes, 30).RootElement, xFlags: xFlags.IsUndefined ? default : CanonTests32.Server.Models.GetItemsByItemIdOkXFlags.CreateBuilder(workspace, xFlags, 30).RootElement);
    ...
    public bool ValidateBody()
    {
        ...
        {
            200 => CanonTests32.Server.Models.ItemEntity.From(this.Body).EvaluateSchema(),
            _ => true,
        };
    }
