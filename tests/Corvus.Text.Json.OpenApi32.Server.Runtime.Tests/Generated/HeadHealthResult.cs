...
/// <summary>
/// Result type for the HeadHealth operation.
/// </summary>
public readonly struct HeadHealthResult
{
    private HeadHealthResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
