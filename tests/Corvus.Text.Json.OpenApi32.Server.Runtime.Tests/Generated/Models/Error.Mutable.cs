...
public readonly partial struct Error
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.Models.JsonInt32.Mutable Code
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out CanonTests32.Server.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out CanonTests32.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCode(in CanonTests32.Server.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(in CanonTests32.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.JsonInt32.Source _createArg1;
        ...
        internal Source(CanonTests32.Server.Models.Error.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.JsonInt32.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.Error.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.Models.JsonInt32.Source code,
            in CanonTests32.Server.Models.JsonString.Source message)
        {
        ...
        /// Creates an instance of a <see cref="Error"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonInt32.Source code, in CanonTests32.Server.Models.JsonString.Source message)
        {
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonInt32.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonInt32.Source code, in CanonTests32.Server.Models.JsonString.Source message)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonInt32.Source code, in CanonTests32.Server.Models.JsonString.Source message, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
