    ...
    public readonly partial struct ItemsEntityArray
    {
        ...
        public readonly partial struct ItemsEntity
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in CanonTests32.Server.JsonString.Source id = default,
                    in CanonTests32.Server.JsonString.Source name = default)
                {
                ...
                /// Creates an instance of a <see cref="ItemsEntity"/>.
                /// </summary>
                public void Create(in CanonTests32.Server.JsonString.Source id = default, in CanonTests32.Server.JsonString.Source name = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.JsonString.Source id = default, in CanonTests32.Server.JsonString.Source name = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
