...
public readonly partial struct GetAdvancedStylesByIdsOk
{
...
#endif
    {
        ...
        public CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.ItemsEntity>(_parent, _idx);
        }
