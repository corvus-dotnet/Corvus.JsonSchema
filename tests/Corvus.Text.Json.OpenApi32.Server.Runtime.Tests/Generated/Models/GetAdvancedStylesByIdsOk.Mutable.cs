...
public readonly partial struct GetAdvancedStylesByIdsOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAdvancedStylesByIdsOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAdvancedStylesByIdsOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAdvancedStylesByIdsOk(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Mutable Items
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Server.Models.JsonInteger.Mutable Total
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalUtf8, out CanonTests32.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetAdvancedStylesByIdsOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetItems(in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetItems<TContext>(in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTotal(in CanonTests32.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TotalUtf8);
                _documentVersion = _parent.Version;
                return;
            }
        ...
        /// <summary>
        /// Remove the <c>total</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveTotal()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TotalUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAdvancedStylesByIdsOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetAdvancedStylesByIdsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetAdvancedStylesByIdsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetAdvancedStylesByIdsOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetAdvancedStylesByIdsOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetAdvancedStylesByIdsOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetAdvancedStylesByIdsOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAdvancedStylesByIdsOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source _createArg1;
        ...
        internal Source(CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source arg1, in CanonTests32.Server.Models.JsonInteger.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(GetAdvancedStylesByIdsOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> _createArg1;
        private readonly CanonTests32.Server.Models.JsonInteger.Source _createArg2;
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> arg1, in CanonTests32.Server.Models.JsonInteger.Source arg2)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetAdvancedStylesByIdsOk"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source items = default,
            in CanonTests32.Server.Models.JsonInteger.Source total = default)
        {
        ...
        /// Creates an instance of a <see cref="GetAdvancedStylesByIdsOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source items = default, in CanonTests32.Server.Models.JsonInteger.Source total = default)
        {
            Create(ref _builder, items, total);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> items = default,
            in CanonTests32.Server.Models.JsonInteger.Source total = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, items, total);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source arg1, in CanonTests32.Server.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg2">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> arg1, in CanonTests32.Server.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source items = default, in CanonTests32.Server.Models.JsonInteger.Source total = default)
    {
        return new Source(items, total);
    }
    ...
    /// <param name="total">The value of the <c>"total"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> items = default, in CanonTests32.Server.Models.JsonInteger.Source total = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, items, total);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source items = default, in CanonTests32.Server.Models.JsonInteger.Source total = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(items, total);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Server.Models.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> items = default, in CanonTests32.Server.Models.JsonInteger.Source total = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, items, total);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<GetAdvancedStylesByIdsOk, Mutable>(this);
    }
}
