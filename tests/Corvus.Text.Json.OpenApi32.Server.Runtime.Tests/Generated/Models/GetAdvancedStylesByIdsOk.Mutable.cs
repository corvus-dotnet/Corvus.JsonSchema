...
public readonly partial struct GetAdvancedStylesByIdsOk
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Mutable Items
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Server.JsonInteger.Mutable Total
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalUtf8, out CanonTests32.Server.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        public void SetItems(in CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetItems<TContext>(in CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTotal(in CanonTests32.Server.JsonInteger.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.GetAdvancedStylesByIdsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.GetAdvancedStylesByIdsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source items = default,
            in CanonTests32.Server.JsonInteger.Source total = default)
        {
        ...
        /// Creates an instance of a <see cref="GetAdvancedStylesByIdsOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source items = default, in CanonTests32.Server.JsonInteger.Source total = default)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> items = default,
            in CanonTests32.Server.JsonInteger.Source total = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source items = default, in CanonTests32.Server.JsonInteger.Source total = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Server.GetAdvancedStylesByIdsOk.ItemsEntityArray.Source<TContext> items = default, in CanonTests32.Server.JsonInteger.Source total = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
