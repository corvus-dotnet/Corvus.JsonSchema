...
public readonly partial struct GetAdvancedStylesByIdsOkXCounts
#if NET8_0_OR_GREATER
    : IJsonElement<GetAdvancedStylesByIdsOkXCounts>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAdvancedStylesByIdsOkXCounts"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetAdvancedStylesByIdsOkXCounts(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetAdvancedStylesByIdsOkXCounts DefaultInstance { get; }
    ...
    public bool TryGetNumericValues(Span<long> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (CanonTests32.Server.Models.JsonInt64 item in EnumerateArray())
        {
    ...
    public CanonTests32.Server.Models.JsonInt64 this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests32.Server.Models.JsonInt64>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests32.Server.Models.JsonInt64> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Server.Models.JsonInt64>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsOkXCounts left, in GetAdvancedStylesByIdsOkXCounts right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetAdvancedStylesByIdsOkXCounts left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetAdvancedStylesByIdsOkXCounts instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetAdvancedStylesByIdsOkXCounts(JsonElement instance)
    {
        return GetAdvancedStylesByIdsOkXCounts.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXCounts From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXCounts ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXCounts>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXCounts ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXCounts>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetAdvancedStylesByIdsOkXCounts ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXCounts>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetAdvancedStylesByIdsOkXCounts ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetAdvancedStylesByIdsOkXCounts>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetAdvancedStylesByIdsOkXCounts? result)
    {
        return JsonElementHelpers.TryParseValue<GetAdvancedStylesByIdsOkXCounts>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetAdvancedStylesByIdsOkXCounts(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetAdvancedStylesByIdsOkXCounts IJsonElement<GetAdvancedStylesByIdsOkXCounts>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetAdvancedStylesByIdsOkXCounts: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetAdvancedStylesByIdsOkXCounts"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetAdvancedStylesByIdsOkXCounts"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsOkXCounts Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetAdvancedStylesByIdsOkXCounts>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetAdvancedStylesByIdsOkXCounts"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetAdvancedStylesByIdsOkXCounts Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetAdvancedStylesByIdsOkXCounts>(_idx);
        }
