...
public readonly partial struct GetAdvancedStylesByIdsOkXWeights
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetAdvancedStylesByIdsOkXWeights instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetAdvancedStylesByIdsOkXWeights"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetAdvancedStylesByIdsOkXWeights(Mutable instance)
        {
        ...
        public CanonTests32.Server.Models.JsonSingle.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests32.Server.Models.JsonSingle.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests32.Server.Models.JsonSingle.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Server.Models.JsonSingle.Mutable>(_parent, _idx);
        }
        ...
        public bool TryGetNumericValues(Span<float> items, out int written)
        {
            CheckValidInstance();
            written = 0;
            foreach (CanonTests32.Server.Models.JsonSingle.Mutable item in EnumerateArray())
            {
                ...
                if (!item.TryGetValue(out float value))
                {
                    return false;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetAdvancedStylesByIdsOkXWeights(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetAdvancedStylesByIdsOkXWeights.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in CanonTests32.Server.Models.JsonSingle.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in CanonTests32.Server.Models.JsonSingle.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in CanonTests32.Server.Models.JsonSingle.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in CanonTests32.Server.Models.JsonSingle item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, CanonTests32.Server.Models.JsonSingle>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<CanonTests32.Server.Models.JsonSingle> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, CanonTests32.Server.Models.JsonSingle>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in CanonTests32.Server.Models.JsonSingle oldItem, in CanonTests32.Server.Models.JsonSingle.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Server.Models.JsonSingle>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                CanonTests32.Server.Models.JsonSingle current = enumerator.Current;
        ...
        /// <summary>
        /// Gets a <see cref="GetAdvancedStylesByIdsOkXWeights"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetAdvancedStylesByIdsOkXWeights"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetAdvancedStylesByIdsOkXWeights Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetAdvancedStylesByIdsOkXWeights>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetAdvancedStylesByIdsOkXWeights"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetAdvancedStylesByIdsOkXWeights Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetAdvancedStylesByIdsOkXWeights>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(ReadOnlySpan<float> value)
        {
            _floatArray = value;
            _kind = Kind.FloatArray;
        }

        internal Source(CanonTests32.Server.Models.GetAdvancedStylesByIdsOkXWeights.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetAdvancedStylesByIdsOkXWeights instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(ReadOnlySpan<float> value) => new(value);
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetAdvancedStylesByIdsOkXWeights.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(ReadOnlySpan<float> values)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(
        JsonWorkspace workspace, ReadOnlySpan<float> values, int initialCapacity = 30)
    {
    ...
    {
        return workspace.CreateBuilder<GetAdvancedStylesByIdsOkXWeights, Mutable>(this);
    }
}
