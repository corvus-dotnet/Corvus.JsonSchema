...
#endif
{
    ...
    public CanonTests32.Server.JsonBoolean this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests32.Server.JsonBoolean>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests32.Server.JsonBoolean> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Server.JsonBoolean>(_parent, _idx);
    }
