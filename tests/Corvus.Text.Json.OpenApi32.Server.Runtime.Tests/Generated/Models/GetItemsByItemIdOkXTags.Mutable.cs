...
public readonly partial struct GetItemsByItemIdOkXTags
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsByItemIdOkXTags instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsByItemIdOkXTags"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsByItemIdOkXTags(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsByItemIdOkXTags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdOkXTags Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsByItemIdOkXTags Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsByItemIdOkXTags>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.GetItemsByItemIdOkXTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetItemsByItemIdOkXTags instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetItemsByItemIdOkXTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<GetItemsByItemIdOkXTags, Mutable>(this);
    }
}
