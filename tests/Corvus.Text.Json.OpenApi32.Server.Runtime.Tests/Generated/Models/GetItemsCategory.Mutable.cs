...
public readonly partial struct GetItemsCategory
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetItemsCategory instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetItemsCategory"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetItemsCategory(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetItemsCategory.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsCategory Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetItemsCategory Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetItemsCategory>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(GetItemsCategory instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<GetItemsCategory, Mutable>(this);
    }
}
