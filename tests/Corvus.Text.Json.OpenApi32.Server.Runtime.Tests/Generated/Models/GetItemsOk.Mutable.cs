...
public readonly partial struct GetItemsOk
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.GetItemsOk.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetItemsOk.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
