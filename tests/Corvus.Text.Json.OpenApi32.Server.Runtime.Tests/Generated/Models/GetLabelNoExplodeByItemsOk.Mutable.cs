...
public readonly partial struct GetLabelNoExplodeByItemsOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetLabelNoExplodeByItemsOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetLabelNoExplodeByItemsOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetLabelNoExplodeByItemsOk(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetLabelNoExplodeByItemsOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly GetLabelNoExplodeByItemsOk Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly GetLabelNoExplodeByItemsOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetLabelNoExplodeByItemsOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.GetLabelNoExplodeByItemsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(GetLabelNoExplodeByItemsOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetLabelNoExplodeByItemsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetLabelNoExplodeByItemsOk"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<GetLabelNoExplodeByItemsOk, Mutable>(this);
    }
}
