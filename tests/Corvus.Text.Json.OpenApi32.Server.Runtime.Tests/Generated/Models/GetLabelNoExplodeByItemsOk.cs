...
public readonly partial struct GetLabelNoExplodeByItemsOk
#if NET8_0_OR_GREATER
    : IJsonElement<GetLabelNoExplodeByItemsOk>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetLabelNoExplodeByItemsOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetLabelNoExplodeByItemsOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetLabelNoExplodeByItemsOk DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests32.Server.Models.JsonInteger Count
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out CanonTests32.Server.Models.JsonInteger value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetLabelNoExplodeByItemsOk left, in GetLabelNoExplodeByItemsOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetLabelNoExplodeByItemsOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetLabelNoExplodeByItemsOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetLabelNoExplodeByItemsOk(JsonElement instance)
    {
        return GetLabelNoExplodeByItemsOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetLabelNoExplodeByItemsOk From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetLabelNoExplodeByItemsOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetLabelNoExplodeByItemsOk>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetLabelNoExplodeByItemsOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetLabelNoExplodeByItemsOk>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetLabelNoExplodeByItemsOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetLabelNoExplodeByItemsOk>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static GetLabelNoExplodeByItemsOk ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<GetLabelNoExplodeByItemsOk>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetLabelNoExplodeByItemsOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetLabelNoExplodeByItemsOk>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetLabelNoExplodeByItemsOk(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetLabelNoExplodeByItemsOk IJsonElement<GetLabelNoExplodeByItemsOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetLabelNoExplodeByItemsOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetLabelNoExplodeByItemsOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetLabelNoExplodeByItemsOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetLabelNoExplodeByItemsOk Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetLabelNoExplodeByItemsOk>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetLabelNoExplodeByItemsOk"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetLabelNoExplodeByItemsOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetLabelNoExplodeByItemsOk>(_idx);
        }
