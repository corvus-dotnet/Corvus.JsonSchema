...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Server.JsonInteger Count
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out CanonTests32.Server.JsonInteger value))
            {
                return value;
            }
