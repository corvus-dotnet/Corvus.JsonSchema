    ...
    : IJsonElement<GetMatrixTestByCodesOk>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchCount(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.CountUtf8))
            {
                matcher = MatchCount;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1matrix-test~1{codes}/get/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1matrix-test~1{codes}/get/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1matrix-test~1{codes}/get/responses/200/content/application~1json/schema"u8;
