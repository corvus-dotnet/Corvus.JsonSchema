...
public readonly partial struct GetMatrixTestByCodesOk
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Server.JsonInteger.Mutable Count
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out CanonTests32.Server.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCount(in CanonTests32.Server.JsonInteger.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.GetMatrixTestByCodesOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.GetMatrixTestByCodesOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Server.JsonInteger.Source count = default)
        {
        ...
        /// Creates an instance of a <see cref="GetMatrixTestByCodesOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.JsonInteger.Source count = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.JsonInteger.Source count = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
