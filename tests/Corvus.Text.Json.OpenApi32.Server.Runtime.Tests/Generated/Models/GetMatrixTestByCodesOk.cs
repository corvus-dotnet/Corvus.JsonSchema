...
public readonly partial struct GetMatrixTestByCodesOk
#if NET8_0_OR_GREATER
    : IJsonElement<GetMatrixTestByCodesOk>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetMatrixTestByCodesOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetMatrixTestByCodesOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetMatrixTestByCodesOk DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetMatrixTestByCodesOk left, in GetMatrixTestByCodesOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetMatrixTestByCodesOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetMatrixTestByCodesOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetMatrixTestByCodesOk(JsonElement instance)
    {
        return GetMatrixTestByCodesOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixTestByCodesOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixTestByCodesOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetMatrixTestByCodesOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixTestByCodesOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetMatrixTestByCodesOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetMatrixTestByCodesOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetMatrixTestByCodesOk>(json, options);
    }
    ...
    /// </exception>
    public static GetMatrixTestByCodesOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetMatrixTestByCodesOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetMatrixTestByCodesOk? result)
    {
        return JsonElementHelpers.TryParseValue<GetMatrixTestByCodesOk>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new GetMatrixTestByCodesOk(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static GetMatrixTestByCodesOk IJsonElement<GetMatrixTestByCodesOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetMatrixTestByCodesOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="GetMatrixTestByCodesOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="GetMatrixTestByCodesOk"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GetMatrixTestByCodesOk Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<GetMatrixTestByCodesOk>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="GetMatrixTestByCodesOk"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public GetMatrixTestByCodesOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetMatrixTestByCodesOk>(_idx);
        }
