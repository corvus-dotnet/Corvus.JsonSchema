    ...
    : IJsonElement<GetMonitoringStatusOk>
{
    ...
    {
        private static readonly JsonSchemaPathProvider UpSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/up"u8, buffer, out written);

        private static void MatchUp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Server.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.UpUtf8,
                    evaluationPath: UpSchemaEvaluationPath);
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.UpUtf8))
            {
                matcher = MatchUp;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1monitoring~1status/get/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1monitoring~1status/get/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1monitoring~1status/get/responses/200/content/application~1json/schema"u8;
