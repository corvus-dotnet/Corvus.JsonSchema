...
public readonly partial struct GetMonitoringStatusOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetMonitoringStatusOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetMonitoringStatusOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetMonitoringStatusOk(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>up</c> property.
        /// </summary>
        public CanonTests32.Server.Models.JsonBoolean.Mutable Up
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpUtf8, out CanonTests32.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetMonitoringStatusOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>up</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUp(in CanonTests32.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UpUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Up, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>up</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveUp()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UpUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetMonitoringStatusOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetMonitoringStatusOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetMonitoringStatusOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetMonitoringStatusOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetMonitoringStatusOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetMonitoringStatusOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetMonitoringStatusOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetMonitoringStatusOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.GetMonitoringStatusOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(GetMonitoringStatusOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetMonitoringStatusOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetMonitoringStatusOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Server.Models.JsonBoolean.Source up = default)
        {
            up.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Up, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="GetMonitoringStatusOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonBoolean.Source up = default)
        {
            Create(ref _builder, up);
        }
    ...
    /// </summary>
    /// <param name="up">The value of the <c>"up"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonBoolean.Source up = default)
    {
        return new Source(up);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="up">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonBoolean.Source up = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetMonitoringStatusOk, Mutable>(this);
    }
}
