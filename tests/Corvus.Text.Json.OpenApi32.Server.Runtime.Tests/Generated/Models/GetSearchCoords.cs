...
#endif
{
    ...
    public bool TryGetNumericValues(Span<double> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (CanonTests32.Server.JsonNumber item in EnumerateArray())
        {
    ...
    public CanonTests32.Server.JsonNumber this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<CanonTests32.Server.JsonNumber>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<CanonTests32.Server.JsonNumber> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Server.JsonNumber>(_parent, _idx);
    }
