...
public readonly partial struct GetSearchFilter
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Server.Models.JsonInteger.Mutable Max
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxUtf8, out CanonTests32.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public CanonTests32.Server.Models.JsonInteger.Mutable Min
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinUtf8, out CanonTests32.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMax(in CanonTests32.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMin(in CanonTests32.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.GetSearchFilter.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.JsonInteger.Source arg1, in CanonTests32.Server.Models.JsonInteger.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetSearchFilter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.Models.JsonInteger.Source max = default,
            in CanonTests32.Server.Models.JsonInteger.Source min = default)
        {
        ...
        /// Creates an instance of a <see cref="GetSearchFilter"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonInteger.Source max = default, in CanonTests32.Server.Models.JsonInteger.Source min = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonInteger.Source arg1, in CanonTests32.Server.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonInteger.Source max = default, in CanonTests32.Server.Models.JsonInteger.Source min = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonInteger.Source max = default, in CanonTests32.Server.Models.JsonInteger.Source min = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
