...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Server.JsonString Category
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CategoryUtf8, out CanonTests32.Server.JsonString value))
            {
                return value;
            }
