...
public readonly partial struct GetSearchOkXFacets
    ...
    : IJsonElement<GetSearchOkXFacets>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetSearchOkXFacets"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetSearchOkXFacets(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetSearchOkXFacets DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests32.Server.Models.JsonString Category
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CategoryUtf8, out CanonTests32.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in GetSearchOkXFacets left, in GetSearchOkXFacets right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetSearchOkXFacets left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetSearchOkXFacets instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetSearchOkXFacets(JsonElement instance)
    {
        return GetSearchOkXFacets.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchOkXFacets From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchOkXFacets ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchOkXFacets>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchOkXFacets ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchOkXFacets>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchOkXFacets ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchOkXFacets>(json, options);
    }
    ...
    /// </exception>
    public static GetSearchOkXFacets ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetSearchOkXFacets>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetSearchOkXFacets? result)
    {
        return JsonElementHelpers.TryParseValue<GetSearchOkXFacets>(ref reader, out result);
    }
...
#if NET
    static GetSearchOkXFacets IJsonElement<GetSearchOkXFacets>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetSearchOkXFacets: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public GetSearchOkXFacets Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public GetSearchOkXFacets Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<GetSearchOkXFacets>(_idx);
        }
