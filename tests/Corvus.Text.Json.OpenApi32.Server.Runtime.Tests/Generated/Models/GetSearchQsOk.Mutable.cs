...
public readonly partial struct GetSearchQsOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetSearchQsOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetSearchQsOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetSearchQsOk(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Mutable Results
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResultsUtf8, out CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetSearchQsOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetResults(in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ResultsUtf8);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetResults<TContext>(in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source<TContext> value)
        ...
        /// <summary>
        /// Remove the <c>results</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveResults()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ResultsUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetSearchQsOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetSearchQsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetSearchQsOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchQsOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetSearchQsOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetSearchQsOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetSearchQsOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetSearchQsOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source _createArg1;
        ...
        internal Source(CanonTests32.Server.Models.GetSearchQsOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(GetSearchQsOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetSearchQsOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="GetSearchQsOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source results = default)
        {
        ...
        /// Creates an instance of a <see cref="GetSearchQsOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source results = default)
        {
            Create(ref _builder, results);
        }
        ...
        internal static void Create<TContext>(
            ...
            in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source<TContext> results = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="GetSearchQsOk"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source<TContext> results = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
            Create(context, ref _builder, results);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source results = default)
    {
    ...
    /// <param name="results">The value of the <c>"results"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source<TContext> results = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, results);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source results = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Server.Models.GetSearchQsOk.ItemEntityArray.Source<TContext> results = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<GetSearchQsOk, Mutable>(this);
    }
}
