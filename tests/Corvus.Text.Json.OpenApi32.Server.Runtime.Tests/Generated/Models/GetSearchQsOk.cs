...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Server.GetSearchQsOk.ItemEntityArray Results
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResultsUtf8, out CanonTests32.Server.GetSearchQsOk.ItemEntityArray value))
            {
                return value;
            }
