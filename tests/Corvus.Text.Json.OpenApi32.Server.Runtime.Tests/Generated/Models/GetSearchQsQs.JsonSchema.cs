    ...
    : IJsonElement<GetSearchQsQs>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyQPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("q"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyQNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("q"u8, buffer, out written);

        private const int RequiredOffsetForQ = 0;
        private const uint RequiredBitForQ = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForQ;
        private static readonly JsonSchemaPathProvider PageSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/page"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider QSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/q"u8, buffer, out written);

        private static void MatchPage(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                CanonTests32.Server.Models.JsonInt32.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.PageUtf8,
                    evaluationPath: PageSchemaEvaluationPath);

            CanonTests32.Server.Models.JsonInt32.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            context.CommitChildContext(childContext.IsMatch, ref childContext);
        }

        private static void MatchQ(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                CanonTests32.Server.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.QUtf8,
                    evaluationPath: QSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForQ] |= RequiredBitForQ;
        }
        ...
        private static PropertySchemaMatchers<CanonTests32.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<CanonTests32.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                (static () => JsonPropertyNames.PageUtf8, MatchPage),
                (static () => JsonPropertyNames.QUtf8, MatchQ),
            ]);
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1search-qs/get/parameters/0/content/application~1x-www-form-urlencoded/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1search-qs/get/parameters/0/content/application~1x-www-form-urlencoded/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1search-qs/get/parameters/0/content/application~1x-www-form-urlencoded/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyQPresent, "q"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForQ] & RequiredBitForQ) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyQNotPresent, "q"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyQPresent, "q"u8, "required"u8);
