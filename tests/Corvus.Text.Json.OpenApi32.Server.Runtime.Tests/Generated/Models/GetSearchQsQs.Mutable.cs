...
public readonly partial struct GetSearchQsQs
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Server.JsonInt32.Mutable Page
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PageUtf8, out CanonTests32.Server.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.JsonString.Mutable Q
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QUtf8, out CanonTests32.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetPage(in CanonTests32.Server.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetQ(in CanonTests32.Server.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.GetSearchQsQs.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.GetSearchQsQs.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.JsonString.Source q,
            in CanonTests32.Server.JsonInt32.Source page = default)
        {
        ...
        /// Creates an instance of a <see cref="GetSearchQsQs"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.JsonString.Source q, in CanonTests32.Server.JsonInt32.Source page = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.JsonString.Source q, in CanonTests32.Server.JsonInt32.Source page = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
