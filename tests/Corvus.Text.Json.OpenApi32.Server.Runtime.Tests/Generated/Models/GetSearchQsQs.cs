...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GetSearchQsQs"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal GetSearchQsQs(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static GetSearchQsQs DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in GetSearchQsQs left, in GetSearchQsQs right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in GetSearchQsQs left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(GetSearchQsQs instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GetSearchQsQs(JsonElement instance)
    {
        return GetSearchQsQs.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchQsQs From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchQsQs ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchQsQs>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchQsQs ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchQsQs>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GetSearchQsQs ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<GetSearchQsQs>(json, options);
    }
    ...
    /// </exception>
    public static GetSearchQsQs ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<GetSearchQsQs>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out GetSearchQsQs? result)
    {
        return JsonElementHelpers.TryParseValue<GetSearchQsQs>(ref reader, out result);
    }
...
#if NET
    static GetSearchQsQs IJsonElement<GetSearchQsQs>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"GetSearchQsQs: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Page"/>.
        /// </summary>
        public const string Page = "page";

        /// <summary>
        /// Gets the JSON property name for <see cref="Q"/>.
        /// </summary>
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Page"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Page => "page"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Q"/>.
        /// </summary>
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Page"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Page => [0x65, 0x00, 0x00, 0x00, 0x22, 0x70, 0x61, 0x67, 0x65, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Q"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Q => [0x35, 0x00, 0x00, 0x00, 0x22, 0x71, 0x22];
    }
}
