...
public readonly partial struct GetStyledObjectByObjObj
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Server.Models.JsonString.Mutable Color
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ColorUtf8, out CanonTests32.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetColor(in CanonTests32.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.GetStyledObjectByObjObj.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetStyledObjectByObjObj.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.Models.JsonString.Source color = default,
        ...
        /// Creates an instance of a <see cref="GetStyledObjectByObjObj"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonString.Source color = default, in CanonTests32.Server.Models.JsonInteger.Source size = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source color = default, in CanonTests32.Server.Models.JsonInteger.Source size = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonString.Source color = default, in CanonTests32.Server.Models.JsonInteger.Source size = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
