...
public readonly partial struct GetStyledObjectByObjObj
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.GetStyledObjectByObjObj.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.GetStyledObjectByObjObj.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// Creates an instance of a <see cref="GetStyledObjectByObjObj"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.JsonString.Source color = default, in CanonTests32.Server.JsonInteger.Source size = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.JsonString.Source color = default, in CanonTests32.Server.JsonInteger.Source size = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
