    ...
    : IJsonElement<GetStyledObjectByObjOk>
{
    ...
    {
        private static readonly JsonSchemaPathProvider FoundSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/found"u8, buffer, out written);

        private static void MatchFound(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Server.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.FoundUtf8,
                    evaluationPath: FoundSchemaEvaluationPath);
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.FoundUtf8))
            {
                matcher = MatchFound;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1styled-object~1{obj}/get/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1styled-object~1{obj}/get/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1styled-object~1{obj}/get/responses/200/content/application~1json/schema"u8;
