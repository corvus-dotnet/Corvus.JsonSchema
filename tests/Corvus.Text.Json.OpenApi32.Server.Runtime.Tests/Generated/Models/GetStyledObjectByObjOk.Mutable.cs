...
public readonly partial struct GetStyledObjectByObjOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(GetStyledObjectByObjOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="GetStyledObjectByObjOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GetStyledObjectByObjOk(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Server.Models.JsonBoolean.Mutable Found
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FoundUtf8, out CanonTests32.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GetStyledObjectByObjOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetFound(in CanonTests32.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FoundUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FoundUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Found, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>found</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveFound()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FoundUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GetStyledObjectByObjOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GetStyledObjectByObjOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GetStyledObjectByObjOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly GetStyledObjectByObjOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GetStyledObjectByObjOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GetStyledObjectByObjOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly GetStyledObjectByObjOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<GetStyledObjectByObjOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.GetStyledObjectByObjOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.GetStyledObjectByObjOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Server.Models.JsonBoolean.Source found = default)
        {
        ...
        /// Creates an instance of a <see cref="GetStyledObjectByObjOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonBoolean.Source found = default)
        {
    ...
    /// </summary>
    /// <param name="found">The value of the <c>"found"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonBoolean.Source found = default)
    {
        return new Source(found);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonBoolean.Source found = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<GetStyledObjectByObjOk, Mutable>(this);
    }
}
