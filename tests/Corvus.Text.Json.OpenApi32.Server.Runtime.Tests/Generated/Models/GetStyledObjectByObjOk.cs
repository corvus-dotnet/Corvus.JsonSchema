...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Server.JsonBoolean Found
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FoundUtf8, out CanonTests32.Server.JsonBoolean value))
            {
                return value;
            }
