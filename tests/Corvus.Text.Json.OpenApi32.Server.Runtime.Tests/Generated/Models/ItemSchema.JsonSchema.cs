    ...
    : IJsonElement<ItemSchema>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyProgressPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("progress"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyProgressNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("progress"u8, buffer, out written);

        private const int RequiredOffsetForProgress = 0;
        private const uint RequiredBitForProgress = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForProgress | RequiredBitForStatus;
        private static readonly JsonSchemaPathProvider ProgressSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/progress"u8, buffer, out written);
        ...
        private static void MatchProgress(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Server.Models.JsonInteger.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ProgressUtf8,
                    evaluationPath: ProgressSchemaEvaluationPath);
            ...
            requiredBitBuffer[RequiredOffsetForProgress] |= RequiredBitForProgress;
        }
        ...
        private static PropertySchemaMatchers<CanonTests32.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<CanonTests32.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
                (static () => JsonPropertyNames.ProgressUtf8, MatchProgress),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1resources~1{resourceId}/additionalOperations/MOVE/responses/200/content/application~1x-ndjson/itemSchema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1resources~1{resourceId}/additionalOperations/MOVE/responses/200/content/application~1x-ndjson/itemSchema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1resources~1{resourceId}/additionalOperations/MOVE/responses/200/content/application~1x-ndjson/itemSchema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyProgressPresent, "progress"u8, "required"u8);
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForProgress] & RequiredBitForProgress) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyProgressNotPresent, "progress"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyProgressPresent, "progress"u8, "required"u8);
