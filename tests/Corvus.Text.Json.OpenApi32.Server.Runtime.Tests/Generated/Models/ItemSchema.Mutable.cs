...
public readonly partial struct ItemSchema
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ItemSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ItemSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ItemSchema(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>progress</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.Models.JsonInteger.Mutable Progress
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProgressUtf8, out CanonTests32.Server.Models.JsonInteger.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.Models.JsonString.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out CanonTests32.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ItemSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>progress</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetProgress(in CanonTests32.Server.Models.JsonInteger.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("progress");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProgressUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Progress, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in CanonTests32.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ItemSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ItemSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ItemSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ItemSchema Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ItemSchema>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ItemSchema"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ItemSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ItemSchema>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.JsonInteger.Source _createArg1;
        ...
        internal Source(CanonTests32.Server.Models.ItemSchema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.JsonInteger.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.ItemSchema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.Models.JsonInteger.Source progress,
            in CanonTests32.Server.Models.JsonString.Source status)
        {
            progress.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Progress, ref builder);
        ...
        /// Creates an instance of a <see cref="ItemSchema"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonInteger.Source progress, in CanonTests32.Server.Models.JsonString.Source status)
        {
            Create(ref _builder, progress, status);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonInteger.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="progress">The value of the <c>"progress"</c> property.</param>
    /// <param name="status">The value of the <c>"status"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonInteger.Source progress, in CanonTests32.Server.Models.JsonString.Source status)
    {
        return new Source(progress, status);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="progress">The value of the property.</param>
    /// <param name="status">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonInteger.Source progress, in CanonTests32.Server.Models.JsonString.Source status, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(progress, status);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ItemSchema, Mutable>(this);
    }
}
