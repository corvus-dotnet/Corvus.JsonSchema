...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Server.JsonInteger Progress
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProgressUtf8, out CanonTests32.Server.JsonInteger value))
            {
                return value;
            }
