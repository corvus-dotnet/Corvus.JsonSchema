...
public readonly partial struct ItemSchema1
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ItemSchema1 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ItemSchema1"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ItemSchema1(Mutable instance)
        {
        ...
        /// </summary>
        public Corvus.Text.Json.JsonElement.Mutable Data
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ItemSchema1(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetData(in Corvus.Text.Json.JsonElement.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetData<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
        ...
        public void SetEventType(in CanonTests32.Server.Models.JsonString.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("eventType");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EventTypeUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EventType, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ItemSchema1.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ItemSchema1"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ItemSchema1"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ItemSchema1 Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ItemSchema1>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ItemSchema1"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ItemSchema1 Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ItemSchema1>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.JsonString.Source _createArg2;
        ...
        internal Source(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, in Corvus.Text.Json.JsonElement.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, in Corvus.Text.Json.JsonElement.Source<TContext> arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        #endif
        {
            Create(context, ref _builder, eventId, eventType, data);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, in Corvus.Text.Json.JsonElement.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, in Corvus.Text.Json.JsonElement.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source eventId, in CanonTests32.Server.Models.JsonString.Source eventType, in Corvus.Text.Json.JsonElement.Source data = default)
    {
        return new Source(eventId, eventType, data);
    }
    ...
    /// <param name="data">The value of the <c>"data"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Server.Models.JsonString.Source eventId, in CanonTests32.Server.Models.JsonString.Source eventType, in Corvus.Text.Json.JsonElement.Source<TContext> data = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Source<TContext>(context, eventId, eventType, data);
    }
    ...
    /// <param name="eventType">The value of the property.</param>
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonString.Source eventId, in CanonTests32.Server.Models.JsonString.Source eventType, in Corvus.Text.Json.JsonElement.Source data = default, int initialCapacity = 30)
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(eventId, eventType, data);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
        ...
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, eventId, eventType, data);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ItemSchema1, Mutable>(this);
    }
}
