...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ItemSchema1"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ItemSchema1(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ItemSchema1 DefaultInstance { get; }
    ...
    /// </summary>
    public Corvus.Text.Json.JsonElement Data
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataUtf8, out Corvus.Text.Json.JsonElement value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in ItemSchema1 left, in ItemSchema1 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ItemSchema1 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ItemSchema1 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ItemSchema1(JsonElement instance)
    {
        return ItemSchema1.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ItemSchema1 From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ItemSchema1 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ItemSchema1>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ItemSchema1 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ItemSchema1>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ItemSchema1 ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ItemSchema1>(json, options);
    }
    ...
    /// </exception>
    public static ItemSchema1 ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<ItemSchema1>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ItemSchema1? result)
    {
        return JsonElementHelpers.TryParseValue<ItemSchema1>(ref reader, out result);
    }
...
#if NET
    static ItemSchema1 IJsonElement<ItemSchema1>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ItemSchema1: ValueKind = {ValueKind} : \"{ToString()}\"";
