...
public readonly partial struct PatchItemsByItemIdBody
    : IJsonElement<PatchItemsByItemIdBody>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            CanonTests32.Server.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1items~1{itemId}/patch/requestBody/content/application~1merge-patch+json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1items~1{itemId}/patch/requestBody/content/application~1merge-patch+json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1items~1{itemId}/patch/requestBody/content/application~1merge-patch+json/schema"u8;
