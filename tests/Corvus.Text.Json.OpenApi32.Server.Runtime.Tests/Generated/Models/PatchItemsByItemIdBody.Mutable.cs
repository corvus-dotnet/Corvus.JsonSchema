...
public readonly partial struct PatchItemsByItemIdBody
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.PatchItemsByItemIdBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.PatchItemsByItemIdBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.Models.JsonString.Source status = default)
        {
        ...
        /// Creates an instance of a <see cref="PatchItemsByItemIdBody"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonString.Source name = default, in CanonTests32.Server.Models.JsonString.Source status = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source name = default, in CanonTests32.Server.Models.JsonString.Source status = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonString.Source name = default, in CanonTests32.Server.Models.JsonString.Source status = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
