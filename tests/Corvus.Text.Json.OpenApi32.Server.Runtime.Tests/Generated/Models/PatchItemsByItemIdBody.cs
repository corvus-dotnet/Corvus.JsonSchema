...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PatchItemsByItemIdBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PatchItemsByItemIdBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PatchItemsByItemIdBody DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PatchItemsByItemIdBody left, in PatchItemsByItemIdBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PatchItemsByItemIdBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PatchItemsByItemIdBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PatchItemsByItemIdBody(JsonElement instance)
    {
        return PatchItemsByItemIdBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PatchItemsByItemIdBody From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PatchItemsByItemIdBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PatchItemsByItemIdBody>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PatchItemsByItemIdBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PatchItemsByItemIdBody>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PatchItemsByItemIdBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PatchItemsByItemIdBody>(json, options);
    }
    ...
    /// </exception>
    public static PatchItemsByItemIdBody ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PatchItemsByItemIdBody>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PatchItemsByItemIdBody? result)
    {
        return JsonElementHelpers.TryParseValue<PatchItemsByItemIdBody>(ref reader, out result);
    }
...
#if NET
    static PatchItemsByItemIdBody IJsonElement<PatchItemsByItemIdBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PatchItemsByItemIdBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PatchItemsByItemIdBody Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PatchItemsByItemIdBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PatchItemsByItemIdBody>(_idx);
        }
