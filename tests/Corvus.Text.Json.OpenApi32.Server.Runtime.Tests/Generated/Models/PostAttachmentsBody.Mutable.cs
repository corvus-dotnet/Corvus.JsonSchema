...
public readonly partial struct PostAttachmentsBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostAttachmentsBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostAttachmentsBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostAttachmentsBody(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Server.Models.JsonString.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out CanonTests32.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.Models.JsonBinary.Mutable File
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileUtf8, out CanonTests32.Server.Models.JsonBinary.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostAttachmentsBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDescription(in CanonTests32.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFile(in CanonTests32.Server.Models.JsonBinary.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostAttachmentsBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostAttachmentsBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostAttachmentsBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostAttachmentsBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostAttachmentsBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostAttachmentsBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostAttachmentsBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostAttachmentsBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.JsonBinary.Source _createArg1;
        ...
        internal Source(CanonTests32.Server.Models.PostAttachmentsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.JsonBinary.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.PostAttachmentsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.Models.JsonBinary.Source file,
            in CanonTests32.Server.Models.JsonString.Source description = default)
        {
        ...
        /// Creates an instance of a <see cref="PostAttachmentsBody"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonBinary.Source file, in CanonTests32.Server.Models.JsonString.Source description = default)
        {
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonBinary.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonBinary.Source file, in CanonTests32.Server.Models.JsonString.Source description = default)
    {
        return new Source(file, description);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonBinary.Source file, in CanonTests32.Server.Models.JsonString.Source description = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(file, description);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostAttachmentsBody, Mutable>(this);
    }
}
