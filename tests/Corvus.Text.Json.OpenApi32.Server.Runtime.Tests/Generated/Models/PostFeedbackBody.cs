...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Server.JsonString Comment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CommentUtf8, out CanonTests32.Server.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Server.JsonInteger Rating
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RatingUtf8, out CanonTests32.Server.JsonInteger value))
            {
                return value;
            }
