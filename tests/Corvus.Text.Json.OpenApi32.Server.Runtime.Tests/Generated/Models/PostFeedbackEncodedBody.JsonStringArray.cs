...
public readonly partial struct PostFeedbackEncodedBody
{
...
#endif
    {
        ...
        public CanonTests32.Server.JsonString this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests32.Server.JsonString>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests32.Server.JsonString> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Server.JsonString>(_parent, _idx);
        }
