...
public readonly partial struct PostFeedbackEncodedBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostFeedbackEncodedBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostFeedbackEncodedBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostFeedbackEncodedBody(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Server.JsonString.Mutable Comment
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CommentUtf8, out CanonTests32.Server.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostFeedbackEncodedBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetComment(in CanonTests32.Server.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostFeedbackEncodedBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostFeedbackEncodedBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostFeedbackEncodedBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostFeedbackEncodedBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostFeedbackEncodedBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostFeedbackEncodedBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostFeedbackEncodedBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostFeedbackEncodedBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.PostFeedbackEncodedBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(PostFeedbackEncodedBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.PostFeedbackEncodedBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostFeedbackEncodedBody"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray.Source tags,
            in CanonTests32.Server.JsonString.Source comment = default)
        {
        ...
        /// Creates an instance of a <see cref="PostFeedbackEncodedBody"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray.Source tags, in CanonTests32.Server.JsonString.Source comment = default)
        {
            Create(ref _builder, tags, comment);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> tags,
            in CanonTests32.Server.JsonString.Source comment = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, tags, comment);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray.Source tags, in CanonTests32.Server.JsonString.Source comment = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(tags, comment);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray.Source<TContext> tags, in CanonTests32.Server.JsonString.Source comment = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, tags, comment);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostFeedbackEncodedBody, Mutable>(this);
    }
}
