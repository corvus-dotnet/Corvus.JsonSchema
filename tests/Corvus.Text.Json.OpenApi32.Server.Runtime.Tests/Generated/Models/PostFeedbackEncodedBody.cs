...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out CanonTests32.Server.PostFeedbackEncodedBody.JsonStringArray value))
            {
                return value;
            }
