...
public readonly partial struct PostItemsBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Server.PostItemsBody.MetadataEntity.Mutable Metadata
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests32.Server.PostItemsBody.MetadataEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMetadata(in CanonTests32.Server.PostItemsBody.MetadataEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMetadata<TContext>(in CanonTests32.Server.PostItemsBody.MetadataEntity.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.PostItemsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.PostItemsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.PostItemsBody.MetadataEntity.Source metadata = default,
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in CanonTests32.Server.JsonString.Source name,
            in CanonTests32.Server.PostItemsBody.MetadataEntity.Source<TContext> metadata = default,
            in CanonTests32.Server.JsonString.Source tag = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.JsonString.Source name, in CanonTests32.Server.PostItemsBody.MetadataEntity.Source metadata = default, in CanonTests32.Server.JsonString.Source tag = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Server.JsonString.Source name, in CanonTests32.Server.PostItemsBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests32.Server.JsonString.Source tag = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
