...
public readonly partial struct PostItemsBody
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Mutable Metadata
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetadataUtf8, out CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMetadata(in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMetadata<TContext>(in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source _createArg2;
        ...
        internal Source(CanonTests32.Server.Models.PostItemsBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source arg2, in CanonTests32.Server.Models.JsonString.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Server.Models.JsonString.Source _createArg1;
        private readonly CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> _createArg2;
        private readonly CanonTests32.Server.Models.JsonString.Source _createArg3;
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.PostItemsBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> arg2, in CanonTests32.Server.Models.JsonString.Source arg3)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source metadata = default,
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in CanonTests32.Server.Models.JsonString.Source name,
            in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> metadata = default,
            in CanonTests32.Server.Models.JsonString.Source tag = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source arg2, in CanonTests32.Server.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
        ...
        /// <param name="arg3">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> arg2, in CanonTests32.Server.Models.JsonString.Source arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source name, in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source metadata = default, in CanonTests32.Server.Models.JsonString.Source tag = default)
    {
    ...
    /// <param name="tag">The value of the <c>"tag"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Server.Models.JsonString.Source name, in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests32.Server.Models.JsonString.Source tag = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonString.Source name, in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source metadata = default, in CanonTests32.Server.Models.JsonString.Source tag = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Server.Models.JsonString.Source name, in CanonTests32.Server.Models.PostItemsBody.MetadataEntity.Source<TContext> metadata = default, in CanonTests32.Server.Models.JsonString.Source tag = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
