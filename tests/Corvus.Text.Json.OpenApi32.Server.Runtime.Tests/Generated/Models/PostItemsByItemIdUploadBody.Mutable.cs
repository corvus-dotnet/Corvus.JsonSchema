...
public readonly partial struct PostItemsByItemIdUploadBody
{
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.PostItemsByItemIdUploadBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.PostItemsByItemIdUploadBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.JsonBinary.Source file = default)
        {
        ...
        /// Creates an instance of a <see cref="PostItemsByItemIdUploadBody"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.JsonString.Source description = default, in CanonTests32.Server.JsonBinary.Source file = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.JsonString.Source description = default, in CanonTests32.Server.JsonBinary.Source file = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
