...
public readonly partial struct PostMonitoringStatusBody
    : IJsonElement<PostMonitoringStatusBody>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchRule(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.RuleUtf8))
            {
                matcher = MatchRule;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1monitoring~1status/post/requestBody/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1monitoring~1status/post/requestBody/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1monitoring~1status/post/requestBody/content/application~1json/schema"u8;
