...
public readonly partial struct PostMonitoringStatusBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostMonitoringStatusBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostMonitoringStatusBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostMonitoringStatusBody(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>rule</c> property.
        /// </summary>
        public CanonTests32.Server.Models.JsonString.Mutable Rule
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RuleUtf8, out CanonTests32.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostMonitoringStatusBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>rule</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRule(in CanonTests32.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RuleUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RuleUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Rule, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>rule</c> property, if present.
        /// </summary>
        ...
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RuleUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostMonitoringStatusBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostMonitoringStatusBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostMonitoringStatusBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostMonitoringStatusBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostMonitoringStatusBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostMonitoringStatusBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostMonitoringStatusBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostMonitoringStatusBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.PostMonitoringStatusBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.JsonString.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(PostMonitoringStatusBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.PostMonitoringStatusBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostMonitoringStatusBody"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Server.Models.JsonString.Source rule = default)
        {
            rule.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Rule, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="PostMonitoringStatusBody"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonString.Source rule = default)
        {
            Create(ref _builder, rule);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonString.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// </summary>
    /// <param name="rule">The value of the <c>"rule"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source rule = default)
    {
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="rule">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonString.Source rule = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PostMonitoringStatusBody, Mutable>(this);
    }
}
