...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostMonitoringStatusBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostMonitoringStatusBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostMonitoringStatusBody DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests32.Server.Models.JsonString Rule
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RuleUtf8, out CanonTests32.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostMonitoringStatusBody left, in PostMonitoringStatusBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostMonitoringStatusBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostMonitoringStatusBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostMonitoringStatusBody(JsonElement instance)
    {
        return PostMonitoringStatusBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostMonitoringStatusBody From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostMonitoringStatusBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostMonitoringStatusBody>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostMonitoringStatusBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostMonitoringStatusBody>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostMonitoringStatusBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostMonitoringStatusBody>(json, options);
    }
    ...
    /// </exception>
    public static PostMonitoringStatusBody ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostMonitoringStatusBody>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostMonitoringStatusBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostMonitoringStatusBody>(ref reader, out result);
    }
...
#if NET
    static PostMonitoringStatusBody IJsonElement<PostMonitoringStatusBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostMonitoringStatusBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostMonitoringStatusBody Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostMonitoringStatusBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostMonitoringStatusBody>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Rule"/>.
        /// </summary>
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Rule"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Rule => "rule"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Rule"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Rule => [0x65, 0x00, 0x00, 0x00, 0x22, 0x72, 0x75, 0x6C, 0x65, 0x22];
    }
}
