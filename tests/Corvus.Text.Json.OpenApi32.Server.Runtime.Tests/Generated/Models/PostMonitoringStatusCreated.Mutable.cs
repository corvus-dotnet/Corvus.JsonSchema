...
public readonly partial struct PostMonitoringStatusCreated
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostMonitoringStatusCreated instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostMonitoringStatusCreated"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostMonitoringStatusCreated(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostMonitoringStatusCreated.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly PostMonitoringStatusCreated Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly PostMonitoringStatusCreated Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostMonitoringStatusCreated>(_idx);
        }
    }
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source id = default)
    {
    ...
    {
        return workspace.CreateBuilder<PostMonitoringStatusCreated, Mutable>(this);
    }
}
