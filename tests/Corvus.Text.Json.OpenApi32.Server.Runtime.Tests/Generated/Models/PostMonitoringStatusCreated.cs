...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostMonitoringStatusCreated"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostMonitoringStatusCreated(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostMonitoringStatusCreated DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PostMonitoringStatusCreated left, in PostMonitoringStatusCreated right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostMonitoringStatusCreated left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostMonitoringStatusCreated instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostMonitoringStatusCreated(JsonElement instance)
    {
        return PostMonitoringStatusCreated.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostMonitoringStatusCreated From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostMonitoringStatusCreated ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostMonitoringStatusCreated>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostMonitoringStatusCreated ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostMonitoringStatusCreated>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostMonitoringStatusCreated ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostMonitoringStatusCreated>(json, options);
    }
    ...
    /// </exception>
    public static PostMonitoringStatusCreated ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostMonitoringStatusCreated>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostMonitoringStatusCreated? result)
    {
        return JsonElementHelpers.TryParseValue<PostMonitoringStatusCreated>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PostMonitoringStatusCreated(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PostMonitoringStatusCreated IJsonElement<PostMonitoringStatusCreated>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostMonitoringStatusCreated: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PostMonitoringStatusCreated"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PostMonitoringStatusCreated"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PostMonitoringStatusCreated Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PostMonitoringStatusCreated>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PostMonitoringStatusCreated"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PostMonitoringStatusCreated Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostMonitoringStatusCreated>(_idx);
        }
