...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Server.Models.JsonString Query
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QueryUtf8, out CanonTests32.Server.Models.JsonString value))
            {
                return value;
            }
