...
public readonly partial struct PostUploadRawCreated
    : IJsonElement<PostUploadRawCreated>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaPathProvider FileIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/fileId"u8, buffer, out written);
        ...
        private static void MatchFileId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Server.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.FileIdUtf8,
                    evaluationPath: FileIdSchemaEvaluationPath);
        ...
        private static void MatchSize(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            CanonTests32.Server.Models.JsonInteger.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            context.CommitChildContext(childContext1.IsMatch, ref childContext1);
        }

        private static PropertySchemaMatchers<CanonTests32.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<CanonTests32.Server.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.FileIdUtf8, MatchFileId),
                (static () => JsonPropertyNames.SizeUtf8, MatchSize),
            ]);
        }

        private static PropertySchemaMatchers<CanonTests32.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out CanonTests32.Server.Models.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1upload-raw/post/responses/201/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1upload-raw/post/responses/201/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1upload-raw/post/responses/201/content/application~1json/schema"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out CanonTests32.Server.Models.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
