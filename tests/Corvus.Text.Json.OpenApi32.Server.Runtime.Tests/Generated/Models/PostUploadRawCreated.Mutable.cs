...
public readonly partial struct PostUploadRawCreated
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostUploadRawCreated instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostUploadRawCreated"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostUploadRawCreated(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostUploadRawCreated(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetFileId(in CanonTests32.Server.Models.JsonString.Source value)
        {
            ...
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FileIdUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FileId, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>fileId</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveFileId()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FileIdUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostUploadRawCreated.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostUploadRawCreated"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostUploadRawCreated"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostUploadRawCreated Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostUploadRawCreated>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostUploadRawCreated"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostUploadRawCreated Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostUploadRawCreated>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonInteger.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonInteger.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// </summary>
    /// <param name="fileId">The value of the <c>"fileId"</c> property.</param>
    /// <param name="size">The value of the <c>"size"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source fileId = default, in CanonTests32.Server.Models.JsonInteger.Source size = default)
    {
        return new Source(fileId, size);
    }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="fileId">The value of the property.</param>
    ...
    {
        return workspace.CreateBuilder<PostUploadRawCreated, Mutable>(this);
    }
}
