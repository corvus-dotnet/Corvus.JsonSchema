...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Server.JsonString FileId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileIdUtf8, out CanonTests32.Server.JsonString value))
            {
                return value;
            }
