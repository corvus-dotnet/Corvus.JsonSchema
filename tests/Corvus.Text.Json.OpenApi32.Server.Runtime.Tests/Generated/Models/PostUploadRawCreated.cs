...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostUploadRawCreated"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostUploadRawCreated(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostUploadRawCreated DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests32.Server.Models.JsonString FileId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileIdUtf8, out CanonTests32.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostUploadRawCreated left, in PostUploadRawCreated right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostUploadRawCreated left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostUploadRawCreated instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostUploadRawCreated(JsonElement instance)
    {
        return PostUploadRawCreated.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostUploadRawCreated From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostUploadRawCreated ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostUploadRawCreated>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostUploadRawCreated ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostUploadRawCreated>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostUploadRawCreated ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostUploadRawCreated>(json, options);
    }
    ...
    /// </exception>
    public static PostUploadRawCreated ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostUploadRawCreated>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostUploadRawCreated? result)
    {
        return JsonElementHelpers.TryParseValue<PostUploadRawCreated>(ref reader, out result);
    }
...
#if NET
    static PostUploadRawCreated IJsonElement<PostUploadRawCreated>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostUploadRawCreated: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostUploadRawCreated Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostUploadRawCreated Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostUploadRawCreated>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="FileId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> FileId => "fileId"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="FileId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> FileId => [0x85, 0x00, 0x00, 0x00, 0x22, 0x66, 0x69, 0x6C, 0x65, 0x49, 0x64, 0x22];
