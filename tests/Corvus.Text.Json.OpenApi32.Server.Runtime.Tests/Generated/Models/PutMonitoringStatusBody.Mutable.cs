...
public readonly partial struct PutMonitoringStatusBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PutMonitoringStatusBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PutMonitoringStatusBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PutMonitoringStatusBody(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PutMonitoringStatusBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PutMonitoringStatusBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PutMonitoringStatusBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PutMonitoringStatusBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PutMonitoringStatusBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PutMonitoringStatusBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PutMonitoringStatusBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PutMonitoringStatusBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PutMonitoringStatusBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.PutMonitoringStatusBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(PutMonitoringStatusBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.PutMonitoringStatusBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PutMonitoringStatusBody"/>.
        /// </summary>
    ...
    {
        return workspace.CreateBuilder<PutMonitoringStatusBody, Mutable>(this);
    }
}
