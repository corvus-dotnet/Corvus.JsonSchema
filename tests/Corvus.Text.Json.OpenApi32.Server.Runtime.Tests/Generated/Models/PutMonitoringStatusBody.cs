...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PutMonitoringStatusBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PutMonitoringStatusBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PutMonitoringStatusBody DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in PutMonitoringStatusBody left, in PutMonitoringStatusBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PutMonitoringStatusBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PutMonitoringStatusBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PutMonitoringStatusBody(JsonElement instance)
    {
        return PutMonitoringStatusBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutMonitoringStatusBody From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutMonitoringStatusBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutMonitoringStatusBody>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutMonitoringStatusBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutMonitoringStatusBody>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutMonitoringStatusBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutMonitoringStatusBody>(json, options);
    }
    ...
    /// </exception>
    public static PutMonitoringStatusBody ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PutMonitoringStatusBody>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PutMonitoringStatusBody? result)
    {
        return JsonElementHelpers.TryParseValue<PutMonitoringStatusBody>(ref reader, out result);
    }
...
#if NET
    static PutMonitoringStatusBody IJsonElement<PutMonitoringStatusBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PutMonitoringStatusBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PutMonitoringStatusBody Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PutMonitoringStatusBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PutMonitoringStatusBody>(_idx);
        }
