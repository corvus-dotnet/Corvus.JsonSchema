...
public readonly partial struct PutMonitoringStatusOk
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PutMonitoringStatusOk instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PutMonitoringStatusOk"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PutMonitoringStatusOk(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Server.Models.JsonBoolean.Mutable Enabled
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out CanonTests32.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PutMonitoringStatusOk(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetEnabled(in CanonTests32.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PutMonitoringStatusOk.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PutMonitoringStatusOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PutMonitoringStatusOk"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PutMonitoringStatusOk Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PutMonitoringStatusOk>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PutMonitoringStatusOk"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PutMonitoringStatusOk Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PutMonitoringStatusOk>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.JsonBoolean.Source _createArg1;
        ...
        internal Source(CanonTests32.Server.Models.PutMonitoringStatusOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.JsonBoolean.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(PutMonitoringStatusOk instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.PutMonitoringStatusOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PutMonitoringStatusOk"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Server.Models.JsonBoolean.Source enabled = default)
        {
        ...
        /// Creates an instance of a <see cref="PutMonitoringStatusOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonBoolean.Source enabled = default)
        {
            Create(ref _builder, enabled);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonBoolean.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonBoolean.Source enabled = default)
    {
        return new Source(enabled);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonBoolean.Source enabled = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<PutMonitoringStatusOk, Mutable>(this);
    }
}
