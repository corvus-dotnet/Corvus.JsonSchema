...
public readonly partial struct PutMonitoringStatusOk
{
...
#endif
    {
        ...
        /// </summary>
        public CanonTests32.Server.JsonBoolean.Mutable Enabled
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out CanonTests32.Server.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        public void SetEnabled(in CanonTests32.Server.JsonBoolean.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.PutMonitoringStatusOk.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.PutMonitoringStatusOk.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Server.JsonBoolean.Source enabled = default)
        {
        ...
        /// Creates an instance of a <see cref="PutMonitoringStatusOk"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.JsonBoolean.Source enabled = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.JsonBoolean.Source enabled = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
