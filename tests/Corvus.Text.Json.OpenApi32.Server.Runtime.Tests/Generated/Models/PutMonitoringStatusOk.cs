...
public readonly partial struct PutMonitoringStatusOk
    ...
    : IJsonElement<PutMonitoringStatusOk>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PutMonitoringStatusOk"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PutMonitoringStatusOk(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PutMonitoringStatusOk DefaultInstance { get; }
    ...
    /// </summary>
    public CanonTests32.Server.Models.JsonBoolean Enabled
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out CanonTests32.Server.Models.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PutMonitoringStatusOk left, in PutMonitoringStatusOk right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PutMonitoringStatusOk left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PutMonitoringStatusOk instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PutMonitoringStatusOk(JsonElement instance)
    {
        return PutMonitoringStatusOk.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutMonitoringStatusOk From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutMonitoringStatusOk ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutMonitoringStatusOk>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutMonitoringStatusOk ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutMonitoringStatusOk>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PutMonitoringStatusOk ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PutMonitoringStatusOk>(json, options);
    }
    ...
    /// </exception>
    public static PutMonitoringStatusOk ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PutMonitoringStatusOk>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PutMonitoringStatusOk? result)
    {
        return JsonElementHelpers.TryParseValue<PutMonitoringStatusOk>(ref reader, out result);
    }
...
#if NET
    static PutMonitoringStatusOk IJsonElement<PutMonitoringStatusOk>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PutMonitoringStatusOk: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PutMonitoringStatusOk Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PutMonitoringStatusOk Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PutMonitoringStatusOk>(_idx);
        }
