...
public readonly partial struct QueryEndpointQueryFormat
{
...
#endif
    {
        ...
        public static explicit operator Mutable(QueryEndpointQueryFormat instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="QueryEndpointQueryFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QueryEndpointQueryFormat(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new QueryEndpointQueryFormat(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"QueryEndpointQueryFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="QueryEndpointQueryFormat"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="QueryEndpointQueryFormat"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly QueryEndpointQueryFormat Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<QueryEndpointQueryFormat>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="QueryEndpointQueryFormat"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly QueryEndpointQueryFormat Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<QueryEndpointQueryFormat>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(QueryEndpointQueryFormat instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<QueryEndpointQueryFormat, Mutable>(this);
    }
}
