...
public readonly partial struct QueryEndpointQueryFormat
    ...
    : IJsonElement<QueryEndpointQueryFormat>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QueryEndpointQueryFormat"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal QueryEndpointQueryFormat(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static QueryEndpointQueryFormat DefaultInstance { get; } = ParsedJsonDocument<QueryEndpointQueryFormat>.StringConstant([.."\"json\""u8]);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(QueryEndpointQueryFormat value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in QueryEndpointQueryFormat left, in QueryEndpointQueryFormat right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in QueryEndpointQueryFormat left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(QueryEndpointQueryFormat instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator QueryEndpointQueryFormat(JsonElement instance)
    {
        return QueryEndpointQueryFormat.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static QueryEndpointQueryFormat From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static QueryEndpointQueryFormat ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<QueryEndpointQueryFormat>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static QueryEndpointQueryFormat ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<QueryEndpointQueryFormat>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static QueryEndpointQueryFormat ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<QueryEndpointQueryFormat>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static QueryEndpointQueryFormat ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<QueryEndpointQueryFormat>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out QueryEndpointQueryFormat? result)
    {
        return JsonElementHelpers.TryParseValue<QueryEndpointQueryFormat>(ref reader, out result);
    }
...
#if NET
    static QueryEndpointQueryFormat IJsonElement<QueryEndpointQueryFormat>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"QueryEndpointQueryFormat: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public QueryEndpointQueryFormat Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public QueryEndpointQueryFormat Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<QueryEndpointQueryFormat>(_idx);
        }
