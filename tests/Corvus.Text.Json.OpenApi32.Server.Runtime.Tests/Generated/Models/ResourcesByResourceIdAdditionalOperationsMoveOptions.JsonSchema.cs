    ...
    : IJsonElement<ResourcesByResourceIdAdditionalOperationsMoveOptions>
{
    public static partial class JsonSchema
    {
        ...
        private static readonly JsonSchemaPathProvider MergeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/merge"u8, buffer, out written);
        ...
        private static void MatchMerge(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Server.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.MergeUtf8,
                    evaluationPath: MergeSchemaEvaluationPath);
        ...
        private static PropertySchemaMatchers<CanonTests32.Server.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<CanonTests32.Server.PropertiesValidationHandler_NamedPropertyValidator1>([
                (static () => JsonPropertyNames.MergeUtf8, MatchMerge),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1resources~1{resourceId}/additionalOperations/MOVE/parameters/1/content/application~1x-www-form-urlencoded/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1resources~1{resourceId}/additionalOperations/MOVE/parameters/1/content/application~1x-www-form-urlencoded/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1resources~1{resourceId}/additionalOperations/MOVE/parameters/1/content/application~1x-www-form-urlencoded/schema"u8;
