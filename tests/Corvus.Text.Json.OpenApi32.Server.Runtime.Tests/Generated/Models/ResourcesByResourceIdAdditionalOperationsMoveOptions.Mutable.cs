...
public readonly partial struct ResourcesByResourceIdAdditionalOperationsMoveOptions
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ResourcesByResourceIdAdditionalOperationsMoveOptions instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ResourcesByResourceIdAdditionalOperationsMoveOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ResourcesByResourceIdAdditionalOperationsMoveOptions(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Server.Models.JsonBoolean.Mutable Merge
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MergeUtf8, out CanonTests32.Server.Models.JsonBoolean.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.Models.JsonString.Mutable Target
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetUtf8, out CanonTests32.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Set the <c>merge</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMerge(in CanonTests32.Server.Models.JsonBoolean.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MergeUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MergeUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Merge, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>merge</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveMerge()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MergeUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTarget(in CanonTests32.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ResourcesByResourceIdAdditionalOperationsMoveOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly ResourcesByResourceIdAdditionalOperationsMoveOptions Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly ResourcesByResourceIdAdditionalOperationsMoveOptions Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ResourcesByResourceIdAdditionalOperationsMoveOptions>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.JsonBoolean.Source _createArg2;
        ...
        internal Source(CanonTests32.Server.Models.ResourcesByResourceIdAdditionalOperationsMoveOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonBoolean.Source arg2)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _kind = Kind.Create;
        ...
        public static implicit operator Source(ResourcesByResourceIdAdditionalOperationsMoveOptions instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.ResourcesByResourceIdAdditionalOperationsMoveOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ResourcesByResourceIdAdditionalOperationsMoveOptions"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Server.Models.JsonString.Source target,
            in CanonTests32.Server.Models.JsonBoolean.Source merge = default)
        {
            target.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Target, ref builder);
            merge.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Merge, ref builder);
        }

        /// <summary>
        /// Creates an instance of a <see cref="ResourcesByResourceIdAdditionalOperationsMoveOptions"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonString.Source target, in CanonTests32.Server.Models.JsonBoolean.Source merge = default)
        {
            Create(ref _builder, target, merge);
        }
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonBoolean.Source arg2, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <param name="merge">The value of the <c>"merge"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source target, in CanonTests32.Server.Models.JsonBoolean.Source merge = default)
    {
        return new Source(target, merge);
    }
    ...
    /// <param name="merge">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonString.Source target, in CanonTests32.Server.Models.JsonBoolean.Source merge = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(target, merge);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ResourcesByResourceIdAdditionalOperationsMoveOptions, Mutable>(this);
    }
}
