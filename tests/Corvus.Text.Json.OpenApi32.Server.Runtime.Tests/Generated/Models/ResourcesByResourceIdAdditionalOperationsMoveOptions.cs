...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Server.JsonBoolean Merge
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MergeUtf8, out CanonTests32.Server.JsonBoolean value))
            {
                return value;
            }
