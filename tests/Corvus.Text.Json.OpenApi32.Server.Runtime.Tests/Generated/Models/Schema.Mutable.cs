...
public readonly partial struct Schema
{
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source filter = default, in CanonTests32.Server.Models.JsonInteger.Source limit = default)
    {
        return new Source(filter, limit);
    }
