    ...
    : IJsonElement<Schema2>
{
    ...
    {
        private static readonly JsonSchemaPathProvider OverwriteSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/overwrite"u8, buffer, out written);

        private static void MatchOverwrite(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                CanonTests32.Server.Models.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.OverwriteUtf8,
                    evaluationPath: OverwriteSchemaEvaluationPath);

            CanonTests32.Server.Models.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.OverwriteUtf8))
            {
                matcher = MatchOverwrite;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1resources~1{resourceId}/additionalOperations/COPY/requestBody/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1resources~1{resourceId}/additionalOperations/COPY/requestBody/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1resources~1{resourceId}/additionalOperations/COPY/requestBody/content/application~1json/schema"u8;
