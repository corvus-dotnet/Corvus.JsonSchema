...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Schema2"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal Schema2(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static Schema2 DefaultInstance { get; }
    ...
    /// <summary>
    /// Gets the (optional) <c>overwrite</c> property.
    /// </summary>
    public CanonTests32.Server.Models.JsonBoolean Overwrite
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OverwriteUtf8, out CanonTests32.Server.Models.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in Schema2 left, in Schema2 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in Schema2 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(Schema2 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Schema2(JsonElement instance)
    {
        return Schema2.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Schema2 From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Schema2 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Schema2>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Schema2 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Schema2>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Schema2 ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Schema2>(json, options);
    }
    ...
    /// </exception>
    public static Schema2 ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<Schema2>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out Schema2? result)
    {
        return JsonElementHelpers.TryParseValue<Schema2>(ref reader, out result);
    }
...
#if NET
    static Schema2 IJsonElement<Schema2>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"Schema2: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Overwrite"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Overwrite"/>.
        /// </summary>
        public static ReadOnlySpan<byte> OverwriteUtf8 => "overwrite"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Overwrite"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Overwrite => "overwrite"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Overwrite"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Overwrite => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x76, 0x65, 0x72, 0x77, 0x72, 0x69, 0x74, 0x65, 0x22];
    }
}
