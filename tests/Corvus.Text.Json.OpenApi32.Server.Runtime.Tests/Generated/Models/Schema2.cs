...
#endif
{
    ...
    /// </summary>
    public CanonTests32.Server.JsonBoolean Overwrite
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OverwriteUtf8, out CanonTests32.Server.JsonBoolean value))
            {
                return value;
            }
