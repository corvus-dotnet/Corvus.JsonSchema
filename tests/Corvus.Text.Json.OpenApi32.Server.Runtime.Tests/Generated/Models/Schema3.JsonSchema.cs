    ...
    : IJsonElement<Schema3>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1resources~1{resourceId}/additionalOperations/BATCH/requestBody/content/multipart~1mixed/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1resources~1{resourceId}/additionalOperations/BATCH/requestBody/content/multipart~1mixed/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1resources~1{resourceId}/additionalOperations/BATCH/requestBody/content/multipart~1mixed/schema"u8;
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    switch (arrayValidation_itemCount)
                    {
                        case 0:
                        {
                            JsonSchemaContext childContext = CanonTests32.Server.Models.Schema3.RequiredAction.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            CanonTests32.Server.Models.Schema3.RequiredAction.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
                        ...
                        case 1:
                        {
                            JsonSchemaContext childContext1 = CanonTests32.Server.Models.JsonBinary.JsonSchema.PushChildContext(
                                parentDocument,
                                arrayValidation_currentIndex,
                                ref context,
                                itemIndex: arrayValidation_itemCount,
                            ...
                            CanonTests32.Server.Models.JsonBinary.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext1);
