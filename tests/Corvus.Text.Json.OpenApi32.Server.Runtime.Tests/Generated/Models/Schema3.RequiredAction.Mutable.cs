...
public readonly partial struct Schema3
{
    ...
    public readonly partial struct RequiredAction
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiredAction instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiredAction"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredAction(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public CanonTests32.Server.Models.JsonString.Mutable Action
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActionUtf8, out CanonTests32.Server.Models.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetAction(in CanonTests32.Server.Models.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredAction.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredAction Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredAction Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiredAction>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(CanonTests32.Server.Models.Schema3.RequiredAction.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, CanonTests32.Server.Models.Schema3.RequiredAction.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in CanonTests32.Server.Models.JsonString.Source action,
                in CanonTests32.Server.Models.JsonString.Source target = default)
            {
            ...
            /// Creates an instance of a <see cref="RequiredAction"/>.
            /// </summary>
            public void Create(in CanonTests32.Server.Models.JsonString.Source action, in CanonTests32.Server.Models.JsonString.Source target = default)
            {
                Create(ref _builder, action, target);
            }
            ...
            internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonString.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in CanonTests32.Server.Models.JsonString.Source action, in CanonTests32.Server.Models.JsonString.Source target = default)
        {
            return new Source(action, target);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonString.Source action, in CanonTests32.Server.Models.JsonString.Source target = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(action, target);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RequiredAction, Mutable>(this);
        }
    }
}
