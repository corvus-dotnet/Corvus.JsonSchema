    ...
    : IJsonElement<Schema4>
{
    ...
    {
        private static readonly JsonSchemaPathProvider ProcessedSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/processed"u8, buffer, out written);

        private static void MatchProcessed(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Server.JsonInteger.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ProcessedUtf8,
                    evaluationPath: ProcessedSchemaEvaluationPath);
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.ProcessedUtf8))
            {
                matcher = MatchProcessed;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1resources~1{resourceId}/additionalOperations/BATCH/responses/200/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1resources~1{resourceId}/additionalOperations/BATCH/responses/200/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1resources~1{resourceId}/additionalOperations/BATCH/responses/200/content/application~1json/schema"u8;
