...
public readonly partial struct Schema5
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Schema5 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Schema5"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Schema5(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.Models.JsonUuid.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out CanonTests32.Server.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetId(in CanonTests32.Server.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Schema5.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly Schema5 Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Schema5>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.JsonUuid.Source _createArg1;
        private readonly CanonTests32.Server.Models.JsonString.Source _createArg2;
        private readonly CanonTests32.Server.Models.JsonInteger.Source _createArg3;
        private readonly CanonTests32.Server.Models.JsonString.Source _createArg4;
        ...
        internal Source(CanonTests32.Server.Models.Schema5.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.JsonUuid.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, in CanonTests32.Server.Models.JsonInteger.Source arg3, in CanonTests32.Server.Models.JsonString.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(Schema5 instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.Schema5.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Schema5"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in CanonTests32.Server.Models.JsonUuid.Source id,
            in CanonTests32.Server.Models.JsonString.Source title,
            in CanonTests32.Server.Models.JsonInteger.Source version,
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.JsonUuid.Source arg1, in CanonTests32.Server.Models.JsonString.Source arg2, in CanonTests32.Server.Models.JsonInteger.Source arg3, in CanonTests32.Server.Models.JsonString.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonUuid.Source id, in CanonTests32.Server.Models.JsonString.Source title, in CanonTests32.Server.Models.JsonInteger.Source version, in CanonTests32.Server.Models.JsonString.Source content = default)
    {
        return new Source(id, title, version, content);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonUuid.Source id, in CanonTests32.Server.Models.JsonString.Source title, in CanonTests32.Server.Models.JsonInteger.Source version, in CanonTests32.Server.Models.JsonString.Source content = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<Schema5, Mutable>(this);
    }
}
