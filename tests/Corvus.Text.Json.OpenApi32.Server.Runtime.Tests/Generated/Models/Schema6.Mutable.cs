...
public readonly partial struct Schema6
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Schema6 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Schema6"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Schema6(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Server.Models.JsonString.Mutable Content
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out CanonTests32.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public CanonTests32.Server.Models.JsonString.Mutable Title
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out CanonTests32.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Schema6(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetContent(in CanonTests32.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTitle(in CanonTests32.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Schema6.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Schema6"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Schema6"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Schema6 Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Schema6>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Schema6"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Schema6 Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Schema6>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(CanonTests32.Server.Models.Schema6.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static implicit operator Source(Schema6 instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.Schema6.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in CanonTests32.Server.Models.JsonString.Source title,
            in CanonTests32.Server.Models.JsonString.Source content = default)
        {
        ...
        /// Creates an instance of a <see cref="Schema6"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.JsonString.Source title, in CanonTests32.Server.Models.JsonString.Source content = default)
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.JsonString.Source title, in CanonTests32.Server.Models.JsonString.Source content = default)
    {
        return new Source(title, content);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.JsonString.Source title, in CanonTests32.Server.Models.JsonString.Source content = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<Schema6, Mutable>(this);
    }
}
