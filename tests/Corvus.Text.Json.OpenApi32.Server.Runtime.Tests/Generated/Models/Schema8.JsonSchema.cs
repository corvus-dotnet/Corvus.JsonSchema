    ...
    : IJsonElement<Schema8>
{
    public static partial class JsonSchema
    {
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.FilterUtf8))
            {
                matcher = MatchFilter;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/paths/~1monitoring~1status/query/requestBody/content/application~1json/schema"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/paths/~1monitoring~1status/query/requestBody/content/application~1json/schema";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/paths/~1monitoring~1status/query/requestBody/content/application~1json/schema"u8;
