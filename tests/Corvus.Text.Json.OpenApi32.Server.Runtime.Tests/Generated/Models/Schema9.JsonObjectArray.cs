...
public readonly partial struct Schema9
{
...
#endif
    {
        ...
        public CanonTests32.Server.Models.JsonObject this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<CanonTests32.Server.Models.JsonObject>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<CanonTests32.Server.Models.JsonObject> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<CanonTests32.Server.Models.JsonObject>(_parent, _idx);
        }
