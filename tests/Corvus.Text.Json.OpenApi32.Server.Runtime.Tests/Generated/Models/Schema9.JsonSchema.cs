    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchResults(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                CanonTests32.Server.Models.Schema9.JsonObjectArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            CanonTests32.Server.Models.Schema9.JsonObjectArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
