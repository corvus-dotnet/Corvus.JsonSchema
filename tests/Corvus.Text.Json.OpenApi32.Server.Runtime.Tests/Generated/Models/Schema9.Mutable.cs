...
public readonly partial struct Schema9
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Schema9 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Schema9"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Schema9(Mutable instance)
        {
        ...
        /// </summary>
        public CanonTests32.Server.Models.Schema9.JsonObjectArray.Mutable Results
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ResultsUtf8, out CanonTests32.Server.Models.Schema9.JsonObjectArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetResults(in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetResults<TContext>(in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Schema9.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly Schema9 Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Schema9>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly CanonTests32.Server.Models.Schema9.JsonObjectArray.Source _createArg1;
        ...
        internal Source(CanonTests32.Server.Models.Schema9.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(Schema9 instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly CanonTests32.Server.Models.Schema9.JsonObjectArray.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, CanonTests32.Server.Models.Schema9.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Schema9"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source results = default)
        {
        ...
        /// Creates an instance of a <see cref="Schema9"/>.
        /// </summary>
        public void Create(in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source results = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source<TContext> results = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="Schema9"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source<TContext> results = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source results = default)
    {
    ...
    /// <param name="results">The value of the <c>"results"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source<TContext> results = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source results = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in CanonTests32.Server.Models.Schema9.JsonObjectArray.Source<TContext> results = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<Schema9, Mutable>(this);
    }
}
