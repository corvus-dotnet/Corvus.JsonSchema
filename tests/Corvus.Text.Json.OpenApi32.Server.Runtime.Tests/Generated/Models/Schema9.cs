...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Schema9"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal Schema9(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static Schema9 DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in Schema9 left, in Schema9 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in Schema9 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(Schema9 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Schema9(JsonElement instance)
    {
        return Schema9.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Schema9 From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Schema9 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Schema9>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Schema9 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Schema9>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Schema9 ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Schema9>(json, options);
    }
    ...
    /// </exception>
    public static Schema9 ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<Schema9>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out Schema9? result)
    {
        return JsonElementHelpers.TryParseValue<Schema9>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new Schema9(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static Schema9 IJsonElement<Schema9>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"Schema9: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="Schema9"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="Schema9"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Schema9 Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<Schema9>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="Schema9"/> that lives for the lifetime of its
