...
public readonly struct OptionsItemsResult
{
    ...
    public static OptionsItemsResult NoContent(JsonWorkspace workspace, CanonTests32.Server.Models.JsonString.Source accessControlAllowMethods = default) => new(204, default, null, accessControlAllowMethods: CanonTests32.Server.Models.JsonString.CreateBuilder(workspace, accessControlAllowMethods, 30).RootElement);
