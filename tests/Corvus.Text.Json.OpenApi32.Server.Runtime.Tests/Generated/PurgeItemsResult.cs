...
/// <summary>
/// Result type for the PurgeItems operation.
/// </summary>
public readonly struct PurgeItemsResult
{
    private PurgeItemsResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="PurgeItemsResult"/> with status 204.</returns>
    public static PurgeItemsResult NoContent() => new(204, default, null);
