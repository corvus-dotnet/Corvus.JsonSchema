...
public readonly struct SearchItemsResult
{
    ...
    public static SearchItemsResult Ok(CanonTests32.Server.Models.GetSearchOk.Source body, JsonWorkspace workspace, CanonTests32.Server.Models.GetSearchOkXFacets.Source xFacets = default) => new(200, CanonTests32.Server.Models.GetSearchOk.CreateBuilder(workspace, body, 30).RootElement, "application/json", xFacets: xFacets.IsUndefined ? default : CanonTests32.Server.Models.GetSearchOkXFacets.CreateBuilder(workspace, xFacets, 30).RootElement);
