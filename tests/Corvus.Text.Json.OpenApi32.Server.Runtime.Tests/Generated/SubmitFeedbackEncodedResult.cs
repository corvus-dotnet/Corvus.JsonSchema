...
public readonly struct SubmitFeedbackEncodedResult
{
    ...
    public static SubmitFeedbackEncodedResult Created(Corvus.Text.Json.JsonElement.Source body, JsonWorkspace workspace) => new(201, Corvus.Text.Json.JsonElement.CreateBuilder(workspace, body, 30).RootElement, "application/json");
