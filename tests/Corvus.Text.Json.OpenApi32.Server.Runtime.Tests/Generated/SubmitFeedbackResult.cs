...
public readonly struct SubmitFeedbackResult
{
    ...
    public static SubmitFeedbackResult Created(Corvus.Text.Json.JsonElement.Source body, JsonWorkspace workspace) => new(201, Corvus.Text.Json.JsonElement.CreateBuilder(workspace, body, 0).RootElement, "application/json");
