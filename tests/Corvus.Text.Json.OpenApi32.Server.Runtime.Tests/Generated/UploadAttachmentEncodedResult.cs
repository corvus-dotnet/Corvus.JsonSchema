...
public readonly struct UploadAttachmentEncodedResult
{
    ...
    public static UploadAttachmentEncodedResult Created(CanonTests32.Server.ItemEntity.Source body, JsonWorkspace workspace) => new(201, CanonTests32.Server.ItemEntity.CreateBuilder(workspace, body, 0).RootElement, "application/json");
