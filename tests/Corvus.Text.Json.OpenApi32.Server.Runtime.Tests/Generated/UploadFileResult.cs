...
public readonly struct UploadFileResult
{
    ...
    public static UploadFileResult Created(CanonTests32.Server.Models.ItemEntity.Source body, JsonWorkspace workspace) => new(201, CanonTests32.Server.Models.ItemEntity.CreateBuilder(workspace, body, 30).RootElement, "application/json");
