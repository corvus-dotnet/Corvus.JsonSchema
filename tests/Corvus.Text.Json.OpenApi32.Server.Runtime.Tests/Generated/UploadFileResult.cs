...
public readonly struct UploadFileResult
{
    ...
    public static UploadFileResult Created(CanonTests32.Server.ItemEntity.Source body, JsonWorkspace workspace) => new(201, CanonTests32.Server.ItemEntity.CreateBuilder(workspace, body, 0).RootElement, "application/json");
