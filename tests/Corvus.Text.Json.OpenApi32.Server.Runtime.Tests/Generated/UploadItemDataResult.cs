...
/// <summary>
/// Result type for the UploadItemData operation.
/// </summary>
public readonly struct UploadItemDataResult
{
    private UploadItemDataResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
    ...
    public static UploadItemDataResult Created(CanonTests32.Server.Models.ItemEntity.Source body, JsonWorkspace workspace) => new(201, CanonTests32.Server.Models.ItemEntity.CreateBuilder(workspace, body, 30).RootElement, "application/json");
