...
/// <summary>
/// Result type for the UploadRawFile operation.
/// </summary>
public readonly struct UploadRawFileResult
{
    private UploadRawFileResult(int statusCode, JsonElement body = default, string? contentType = null)
    {
