...
public readonly partial struct MigrationItemArray
{
    ...
    public readonly partial struct RequiredId
    {
...

        {
            ...
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public IdEntity(BinaryJsonNumber value)
            {
            ...
            /// </summary>
            public static string SchemaLocation { get; } = "migration-item-array.json#/items/properties/id";
            ...
            /// <returns>An instance of this type, initialized from the provided value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            static IdEntity IJsonValue<IdEntity>.FromString<TValue>(in TValue value)
            {
                if (value.HasJsonElementBacking)
                {
                    return new(value.AsJsonElement);
