...
public readonly partial struct MigrationPerson
{
    ...
    /// Generated from JSON Schema.
    /// </summary>
    public readonly partial struct AgeEntity
#if NET8_0_OR_GREATER
        : IJsonNumber<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity>,
          IAdditionOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity>,
          ISubtractionOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity>,
          IMultiplyOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity>,
          IDivisionOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity>,
          IIncrementOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity>,
          IDecrementOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity>
#else
        : IJsonNumber<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationPerson.AgeEntity>
#endif
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "AgeEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        public AgeEntity(int value)
        ...
        public static implicit operator AgeEntity(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(AgeEntity value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(AgeEntity value)
        {
            return
        ...
        public static explicit operator byte(AgeEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(byte value)
        {
        ...
        public static explicit operator decimal(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator int(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static implicit operator AgeEntity(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator long(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(AgeEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="AgeEntity"/>.</returns>
        public static explicit operator AgeEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(AgeEntity left, AgeEntity right)
        {
        ...
        public static AgeEntity operator +(AgeEntity left, AgeEntity right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static AgeEntity operator ++(AgeEntity value)
        {
        ...
        /// </returns>
        public static int Compare(in AgeEntity lhs, in AgeEntity rhs)
        {
