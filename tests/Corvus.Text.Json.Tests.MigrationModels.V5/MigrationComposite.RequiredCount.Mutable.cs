...
public readonly partial struct MigrationComposite
{
    public readonly partial struct RequiredCount
    {
...
#endif
        {
            ...
            public void SetCount(scoped in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInteger.Source value)
            {
                CheckValidInstance();
            ...
            public readonly RequiredCount Clone()
            {
                CheckValidInstance();
            ...
            public readonly RequiredCount Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiredCount>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Text.Json.Tests.MigrationModels.V5.JsonInteger.Source _createArg1;
            ...
            internal Source(scoped in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInteger.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(scoped in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInteger.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInteger.Source count)
        {
        ...
        public static ParsedJsonDocument<RequiredCount> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RequiredCount>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RequiredCount> Create<TContext>(
        ...
        public static ParsedJsonDocument<RequiredCount> Create(in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInteger.Source count, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
