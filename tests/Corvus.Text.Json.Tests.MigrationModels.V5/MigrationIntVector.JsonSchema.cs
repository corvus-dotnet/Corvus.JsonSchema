    ...
    : IJsonElement<MigrationIntVector>
{
    public static partial class JsonSchema
    {
        ...
        /// </remarks>
        public const string SchemaDocument = "migration-int-vector.json";

        /// <summary>
        /// Gets the schema document from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaDocumentUtf8 => "migration-int-vector.json"u8;

        private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.Tests.MigrationModels.V5.CorvusJsonSchemaProgram.Entry(10);
