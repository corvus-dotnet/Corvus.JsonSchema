...
public readonly partial struct MigrationItemArray
{
...
#endif
    {
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, scoped in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(scoped in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.Source value)
        {
        ...
        public readonly MigrationItemArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<MigrationItemArray>(_idx);
        }

        /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
        public readonly MigrationItemArray Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<MigrationItemArray>(_idx);
        }
    }
    ...
    public ref struct Builder
    {
        ...
        /// Add an item to the array.
        /// </summary>
        public void AddItem<TContext>(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    public static ParsedJsonDocument<MigrationItemArray> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<MigrationItemArray>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<MigrationItemArray> Create<TContext>(
