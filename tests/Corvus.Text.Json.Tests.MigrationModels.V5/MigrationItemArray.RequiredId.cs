...
public readonly partial struct MigrationItemArray
{
...
#endif
    {
        ...
        internal RequiredId(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiredId DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32 Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32 value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Tests.MigrationModels.V5.JsonString Label
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.JsonString value))
                {
                    return value;
                }
        ...
        public static bool operator ==(in RequiredId left, in RequiredId right)
        {
        ...
        /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.operator ==(JsonElement, JsonElement)"/>
        public static bool operator ==(in RequiredId left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredId instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredId(JsonElement instance)
        {
            return RequiredId.From(instance);
        }

        /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.From{T}(in T)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredId From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredId ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RequiredId>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredId ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RequiredId>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredId ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RequiredId>(json, options);
            #pragma warning restore CS0618
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static RequiredId ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RequiredId>(ref reader);
            #pragma warning restore CS0618
        }

        /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.TryParseValue(ref Utf8JsonReader, out JsonElement?)"/>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredId? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredId>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RequiredId(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RequiredId IJsonElement<RequiredId>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredId: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public RequiredId Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RequiredId>(_idx);
        }

        /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Freeze()"/>
        public RequiredId Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiredId>(_idx);
            }
