    ...
    public readonly partial struct RequiredCityAndStreet
    {
        public readonly partial struct ZipCodeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ZipCodeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ZipCodeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ZipCodeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ZipCodeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public readonly ZipCodeEntity Clone()
                {
                    CheckValidInstance();
                ...
                public readonly ZipCodeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ZipCodeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ZipCodeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ZipCodeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ZipCodeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ZipCodeEntity>();
                }
                finally
                {
