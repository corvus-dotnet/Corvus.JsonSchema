...
public readonly partial struct MigrationPatternUnion
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.Mutable(Mutable value)
        {
            return Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(MigrationPatternUnion instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MigrationPatternUnion"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MigrationPatternUnion(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new MigrationPatternUnion(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MigrationPatternUnion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="MigrationPatternUnion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="MigrationPatternUnion"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly MigrationPatternUnion Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<MigrationPatternUnion>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="MigrationPatternUnion"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly MigrationPatternUnion Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<MigrationPatternUnion>(_idx);
        }
        ...
        /// <param name="matchPatternValue">Match a <see cref="Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue, TContext, TResult> matchPatternValue,
            Matcher<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.Mutable, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchPatternValue(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue, TResult> matchPatternValue,
            Matcher<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Text.Json.Tests.MigrationModels.V5.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchPatternValue(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.Mutable.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Text.Json.Tests.MigrationModels.V5.JsonString, TAccumulator, TAccumulator> matchJsonString,
            Matcher<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue, TAccumulator, TAccumulator> matchPatternValue,
            Matcher<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.Mutable, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchJsonString(Corvus.Text.Json.Tests.MigrationModels.V5.JsonString.Mutable.From(this), accumulator);
            }

            if (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchPatternValue(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.Mutable.From(this), accumulator);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsPatternValue(out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.Mutable result)
        {
            if (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(MigrationPatternUnion instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPatternUnion.PatternValue instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<MigrationPatternUnion, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<MigrationPatternUnion> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<MigrationPatternUnion>();
        }
        finally
        {
