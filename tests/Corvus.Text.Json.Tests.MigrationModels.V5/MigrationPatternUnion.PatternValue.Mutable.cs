...
public readonly partial struct MigrationPatternUnion
{
    ...
    public readonly partial struct PatternValue
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PatternValue instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PatternValue"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PatternValue(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PatternValue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PatternValue Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PatternValue Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PatternValue>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PatternValue instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PatternValue, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PatternValue> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PatternValue>();
            }
            finally
            {
