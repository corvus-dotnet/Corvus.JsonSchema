...
public readonly partial struct MigrationPerson
{
    public readonly partial struct AgeEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AgeEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AgeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AgeEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AgeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AgeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public readonly AgeEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AgeEntity>(_idx);
            }

            /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Mutable.Freeze()"/>
            public readonly AgeEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AgeEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AgeEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AgeEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AgeEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AgeEntity>();
            }
            finally
            {
