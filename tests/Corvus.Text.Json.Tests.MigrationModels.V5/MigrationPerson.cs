...
#endif
{
    ...
    public MigrationPerson Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<MigrationPerson>(_idx);
    }

    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Freeze()"/>
    public MigrationPerson Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<MigrationPerson>(_idx);
        }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="IsActive"/>.
        /// </summary>
        public static ReadOnlySpan<byte> IsActive => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x69, 0x73, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x22];
