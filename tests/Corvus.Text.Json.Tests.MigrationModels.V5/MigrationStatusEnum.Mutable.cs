...
public readonly partial struct MigrationStatusEnum
{
...
#endif
    {
        ...
        public readonly MigrationStatusEnum Clone()
        {
            CheckValidInstance();
        ...
        public readonly MigrationStatusEnum Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<MigrationStatusEnum>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(KnownValues value) => (MigrationStatusEnum)value;
    ...
    public static ParsedJsonDocument<MigrationStatusEnum> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<MigrationStatusEnum>();
        }
        finally
        {
