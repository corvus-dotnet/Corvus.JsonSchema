...
#endif
{
    ...
    public MigrationStatusEnum Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<MigrationStatusEnum>(_idx);
    }

    /// <inheritdoc cref="global::Corvus.Text.Json.JsonElement.Freeze()"/>
    public MigrationStatusEnum Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<MigrationStatusEnum>(_idx);
        }
