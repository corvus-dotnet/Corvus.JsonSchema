    ...
    : IJsonElement<MigrationUnion>
{
    public static partial class JsonSchema
    {
        ...
        /// </remarks>
        public const string SchemaDocument = "migration-union.json";

        /// <summary>
        /// Gets the schema document from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaDocumentUtf8 => "migration-union.json"u8;

        private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Text.Json.Tests.MigrationModels.V5.CorvusJsonSchemaProgram.Entry(23);
