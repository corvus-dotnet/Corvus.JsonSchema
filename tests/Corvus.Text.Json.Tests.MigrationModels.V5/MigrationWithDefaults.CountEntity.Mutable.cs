...
public readonly partial struct MigrationWithDefaults
{
    public readonly partial struct CountEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CountEntity, Mutable>(CountEntity.DefaultInstance);
            ...
            public readonly CountEntity Clone()
            {
                CheckValidInstance();
            ...
            public readonly CountEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CountEntity>(_idx);
            }
        }
        ...
        public static ParsedJsonDocument<CountEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CountEntity>();
            }
            finally
            {
