...
namespace AnnotationTestSuite.Draft202012.Applicators;
...
[Trait("AnnotationTestSuite", "Draft202012")]
public class SuitePrefixItemsAndItems : IClassFixture<SuitePrefixItemsAndItems.Fixture>
{
    private readonly Fixture _fixture;
    public SuitePrefixItemsAndItems(Fixture fixture)
    {
        _fixture = fixture;
    }
