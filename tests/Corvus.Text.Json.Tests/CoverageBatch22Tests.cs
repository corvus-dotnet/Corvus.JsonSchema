...
/// </summary>
[TestClass]
public class CoverageBatch22Tests
{
    ...
    public void TryGetUtf8FromText_UnpairedHighSurrogate_ReturnsFalse()
    {
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void TryGetUtf8FromText_UnpairedLowSurrogate_ReturnsFalse()
    {
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void TryGetTextFromUtf8_InvalidContinuationByte_ReturnsFalse()
    {
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void TryGetTextFromUtf8_TruncatedSequence_ReturnsFalse()
    {
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void GetUtf16CharCount_EmptySpan_ReturnsZero()
    {
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void Writer_UlongValue_TriggerGrow()
    {
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void TranscodeHelper_EmptyInput_ReturnsEmptyString()
    {
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void TranscodeHelper_AsciiBytes_ReturnsCorrectString()
    {
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void TranscodeHelper_MultiBytUtf8_ReturnsCorrectString()
    {
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void WriterCache_RecursiveRent_AllocatesFreshInstances()
    {
        ...
        CollectionAssert.AreEqual("{}"u8.ToArray(), buffer1.WrittenMemory.ToArray());
        CollectionAssert.AreEqual("[]"u8.ToArray(), buffer2.WrittenMemory.ToArray());
    ...
    [TestMethod]
    [TestCategory("coverage")]
    public void WriterCache_RecursiveRentWriter_AllocatesFreshInstance()
    {
        using JsonWorkspace workspace = JsonWorkspace.Create();
        ...
        CollectionAssert.AreEqual("{}"u8.ToArray(), bufferWriter1.WrittenSpan.ToArray());
        CollectionAssert.AreEqual("42"u8.ToArray(), bufferWriter2.WrittenSpan.ToArray());
