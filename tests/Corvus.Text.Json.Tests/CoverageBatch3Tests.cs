...
/// </summary>
[TestClass]
public class CoverageBatch3Tests
{
    /// <summary>
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_NamedCaptureGroup_IsValid()
    {
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_MultipleNamedCaptures_IsValid()
    {
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_ExpressionConditional_IsValid()
    {
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_ExpressionConditional_NonLookahead()
    {
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_IncompleteBraceQuantifier_TreatedAsLiteral()
    {
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_BraceAtEnd_TreatedAsLiteral()
    {
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_BraceWithDigitsNoClose_TreatedAsLiteral()
    {
    ...
    /// </summary>
    [TestMethod]
    public void Unescaping_LargeEscapedPropertyNames_HitsArrayPoolPaths()
    {
    ...
    /// </summary>
    [TestMethod]
    public void Unescaping_LargeEscapedPropertyNames_UnequalValues()
    {
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_NamedAndUnnamedGroups_AssignNameSlotsLoop()
    {
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_ConditionalWithAlternation()
    {
    ...
    /// </summary>
    [TestMethod]
    public void RegexValidator_BackreferenceConditional()
    {
    ...
    /// </summary>
    [TestMethod]
    public void NumericCore_CompareNormalizedJsonNumbers_DifferentSigns()
    {
    ...
    /// </summary>
    [TestMethod]
    public void NumericCore_CompareNormalizedJsonNumbers_Equal()
    {
    ...
    /// </summary>
    [TestMethod]
    public void NumericCore_CompareNormalizedJsonNumbers_FractionalDifference()
    {
        ...
        Assert.AreEqual(-1, result); // 1.25 < 1.3
    }
    ...
    /// </summary>
    [TestMethod]
    public void NumericCore_ParseNumber_FractionalAndExponent()
    {
    ...
    /// </summary>
    [TestMethod]
    public void NumericCore_ParseNumber_NegativeExponent()
    {
        // 15e-1 = 1.5
    ...
    /// </summary>
    [TestMethod]
    public void NumericCore_CompareNormalizedJsonNumbers_DifferentMagnitudes()
    {
        ...
        Assert.AreEqual(1, result); // 100 > 99
    }
    ...
    /// </summary>
    [TestMethod]
    public void BuilderParseValue_SingleSpan_Number()
    {
        ...
        Assert.AreEqual(42, builder.RootElement.GetInt32());
    }
    ...
    /// </summary>
    [TestMethod]
    public void BuilderParseValue_SingleSpan_True()
    {
    ...
    /// </summary>
    [TestMethod]
    public void BuilderParseValue_SingleSpan_String()
    {
        ...
        Assert.AreEqual("hello world", builder.RootElement.GetString());
    }
    ...
    /// </summary>
    [TestMethod]
    public void BuilderParseValue_SingleSpan_Null()
    {
        ...
        Assert.AreEqual(JsonValueKind.Null, builder.RootElement.ValueKind);
    }
    ...
    /// </summary>
    [TestMethod]
    public void BuilderParseValue_SingleSpan_Object()
    {
        ...
        Assert.AreEqual(1, builder.RootElement.GetProperty("a"u8).GetInt32());
    }
    ...
    /// </summary>
    [TestMethod]
    public void BuilderParseValue_MultiSegment_StringInOneSegment()
    {
        ...
        Assert.AreEqual("hi", builder.RootElement.GetString());
    }
    ...
    /// </summary>
    [TestMethod]
    public void ParsedDocument_ParseFromStreamWithBom()
    {
    ...
    /// </summary>
    [TestMethod]
    public void ParsedDocument_ParseValue_MultiSegment_NumberSpansSegments()
    {
        ...
        Assert.AreEqual(123456, result.GetInt32());
    }
    ...
    /// </summary>
    [TestMethod]
    public void ParsedDocument_ParseValue_MultiSegment_EscapedStringSpansSegments()
    {
    ...
    /// </summary>
    [TestMethod]
    public void ParsedDocument_ParseValueFromStream()
    {
    ...
    /// </summary>
    [TestMethod]
    public void ParsedDocument_StringConstant_WithEscape()
    {
