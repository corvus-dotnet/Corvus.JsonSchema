...
/// </summary>
public static class CoverageBatch4Tests
{
    ...
    /// </summary>
    [Fact]
    public static void DateTime_ParsePeriod_Success()
    {
    ...
    /// </summary>
    [Fact]
    public static void DateTime_ParseLocalDate_Success()
    {
    ...
    /// </summary>
    [Fact]
    public static void DateTime_ParseOffsetTime_Success()
    {
    ...
    /// </summary>
    [Fact]
    public static void DateTime_ParseOffsetDateTime_Success()
    {
    ...
    /// </summary>
    [Fact]
    public static void DateTime_ParseOffsetDate_Success()
    {
    ...
    /// </summary>
    [Fact]
    public static void Writer_Float_GrowPath()
    {
    ...
    /// </summary>
    [Fact]
    public static void Writer_Double_GrowPath()
    {
        using var stream = new System.IO.MemoryStream();
        using var writer = new Utf8JsonWriter(stream);
    ...
    /// </summary>
    [Fact]
    public static void JsonElement_TryGetBoolean_True()
    {
    ...
    /// </summary>
    [Fact]
    public static void JsonElement_TryGetBoolean_False()
    {
