...
public class GeneratedNumericArrayTests
{
    ...
    {
        Assert.AreEqual(1, Rank1DoubleVector.Rank);
        Assert.AreEqual(3, Rank1DoubleVector.Dimension);
        Assert.AreEqual(3, Rank1DoubleVector.ValueBufferSize);
    }

    [TestMethod]
    public void Rank1Int32Vector_StaticProperties()
    {
        Assert.AreEqual(1, Rank1Int32Vector.Rank);
        Assert.AreEqual(4, Rank1Int32Vector.Dimension);
        Assert.AreEqual(4, Rank1Int32Vector.ValueBufferSize);
    }

    [TestMethod]
    public void Rank2DoubleMatrix_StaticProperties()
    {
        Assert.AreEqual(2, Rank2DoubleMatrix.Rank);
        Assert.AreEqual(2, Rank2DoubleMatrix.Dimension);
        Assert.AreEqual(6, Rank2DoubleMatrix.ValueBufferSize);
    }

    [TestMethod]
    public void Rank3Int32Cube_StaticProperties()
    {
        Assert.AreEqual(3, Rank3Int32Cube.Rank);
        Assert.AreEqual(2, Rank3Int32Cube.Dimension);
        Assert.AreEqual(12, Rank3Int32Cube.ValueBufferSize);
    }
    ...
    {
        Assert.AreEqual(1, Rank2DoubleMatrix.JsonDoubleArray.Rank);
        Assert.AreEqual(3, Rank2DoubleMatrix.JsonDoubleArray.Dimension);
        Assert.AreEqual(3, Rank2DoubleMatrix.JsonDoubleArray.ValueBufferSize);
    }
    ...
    public void Rank3Int32Cube_Build_CreateTensor()
    {
        ...
        Assert.AreEqual(2, plane0.GetArrayLength());
        Rank3Int32Cube.ItemsArray2Array.JsonInt32Array.Mutable row00 = plane0[0];
        Assert.AreEqual(3, row00.GetArrayLength());
        Assert.AreEqual(1, (int)row00[0]);
        Assert.AreEqual(2, (int)row00[1]);
        Assert.AreEqual(3, (int)row00[2]);
        Rank3Int32Cube.ItemsArray2Array.JsonInt32Array.Mutable row01 = plane0[1];
        Assert.AreEqual(3, row01.GetArrayLength());
        Assert.AreEqual(4, (int)row01[0]);
        Assert.AreEqual(5, (int)row01[1]);
        Assert.AreEqual(6, (int)row01[2]);

        // Second plane: [[7,8,9],[10,11,12]]
        Rank3Int32Cube.ItemsArray2Array.Mutable plane1 = root[1];
        Assert.AreEqual(2, plane1.GetArrayLength());
        Rank3Int32Cube.ItemsArray2Array.JsonInt32Array.Mutable row10 = plane1[0];
        Assert.AreEqual(3, row10.GetArrayLength());
        Assert.AreEqual(7, (int)row10[0]);
        Assert.AreEqual(8, (int)row10[1]);
        Assert.AreEqual(9, (int)row10[2]);
        Rank3Int32Cube.ItemsArray2Array.JsonInt32Array.Mutable row11 = plane1[1];
        Assert.AreEqual(3, row11.GetArrayLength());
        Assert.AreEqual(10, (int)row11[0]);
        Assert.AreEqual(11, (int)row11[1]);
        Assert.AreEqual(12, (int)row11[2]);
    }
    ...
    public void Rank3Int32Cube_InnerTypes_StaticProperties()
    {
        ...
        Assert.AreEqual(2, Rank3Int32Cube.ItemsArray2Array.Rank);
        Assert.AreEqual(2, Rank3Int32Cube.ItemsArray2Array.Dimension);
        Assert.AreEqual(6, Rank3Int32Cube.ItemsArray2Array.ValueBufferSize);

        // Innermost rank: 3-element vector
        Assert.AreEqual(1, Rank3Int32Cube.ItemsArray2Array.JsonInt32Array.Rank);
        Assert.AreEqual(3, Rank3Int32Cube.ItemsArray2Array.JsonInt32Array.Dimension);
        Assert.AreEqual(3, Rank3Int32Cube.ItemsArray2Array.JsonInt32Array.ValueBufferSize);
    }
    ...
    public void Rank1DoubleVector_TryGetNumericValues_BufferTooSmall_ReturnsFalse()
    {
        ...
        Assert.IsFalse(doc.RootElement.TryGetNumericValues(buffer, out int written));
    ...
    public void Rank2DoubleMatrix_TryGetNumericValues_FlattensValues()
    {
        ...
        Assert.AreEqual(4.0, buffer[3]);
        Assert.AreEqual(5.0, buffer[4]);
    ...
    public void Rank1Int32Vector_BuildFromSpan()
    {
        ...
        Assert.AreEqual(4, root.GetArrayLength());
        Assert.AreEqual(1, (int)root[0]);
        Assert.AreEqual(2, (int)root[1]);
        Assert.AreEqual(3, (int)root[2]);
        Assert.AreEqual(4, (int)root[3]);
    }
    ...
    public void Rank3Int32Cube_CreateBuilderFromSpan_RoundTrip()
    {
        ...
        Assert.IsTrue(reparsed.RootElement.TryGetNumericValues(roundTripped, out int written));
        Assert.AreEqual(12, written);
        Assert.AreEqual(1, roundTripped[0]);
        Assert.AreEqual(12, roundTripped[11]);
    }
    ...
    public void Rank1Int32Vector_ImplicitConversion_FromSpan()
    {
        ...
        Assert.IsTrue(reparsed.RootElement.TryGetNumericValues(roundTripped, out int written));
        Assert.AreEqual(4, written);
        Assert.AreEqual(10, roundTripped[0]);
        Assert.AreEqual(40, roundTripped[3]);
    }
    ...
    public void Rank1DoubleVector_ImplicitConversion_FromSpan()
    {
        ...
        Assert.IsTrue(reparsed.RootElement.TryGetNumericValues(roundTripped, out int written));
        Assert.AreEqual(3, written);
        Assert.AreEqual(1.1, roundTripped[0]);
        Assert.AreEqual(3.3, roundTripped[2]);
    }
