...
internal static partial class JsonTestHelper
{
    ...
    private static JsonTokenType MapTokenType(JsonToken token)
    {
        return token switch
        {
            JsonToken.None => JsonTokenType.None,
            JsonToken.StartObject => JsonTokenType.StartObject,
            JsonToken.StartArray => JsonTokenType.StartArray,
            JsonToken.PropertyName => JsonTokenType.PropertyName,
            JsonToken.Comment => JsonTokenType.Comment,
            JsonToken.Integer or JsonToken.Float => JsonTokenType.Number,
            JsonToken.String => JsonTokenType.String,
            JsonToken.Boolean => JsonTokenType.True,
            JsonToken.Null => JsonTokenType.Null,
            JsonToken.EndObject => JsonTokenType.EndObject,
            JsonToken.EndArray => JsonTokenType.EndArray,
