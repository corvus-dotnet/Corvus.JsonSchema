...
public class ParsingEquivalenceTests
{
    ...
    public void V4_ParseArrayFromString()
    {
        ...
        Assert.AreEqual(System.Text.Json.JsonValueKind.Array, v4.ValueKind);
    ...
    public void V5_ParseArrayFromString()
    {
        ...
        Assert.AreEqual(Corvus.Text.Json.JsonValueKind.Array, v5.ValueKind);
        Assert.AreEqual(2, v5.GetArrayLength());
    }
    ...
    public void V4_ParseUnionFromString_IntVariant()
    {
        ...
        Assert.AreEqual(System.Text.Json.JsonValueKind.Number, v4.ValueKind);
    }
    ...
    public void V5_ParseUnionFromString_IntVariant()
    {
        ...
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.AreEqual(Corvus.Text.Json.JsonValueKind.Number, v5.ValueKind);
    }
    ...
    public void V4_ParseUnionFromString_BoolVariant()
    {
        ...
        Assert.AreEqual(System.Text.Json.JsonValueKind.True, v4.ValueKind);
    }
    ...
    public void V5_ParseUnionFromString_BoolVariant()
    {
        ...
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.AreEqual(Corvus.Text.Json.JsonValueKind.True, v5.ValueKind);
    }
    ...
    public void BothEngines_ParsePerson_SameResult()
    {
        ...
        Assert.AreEqual((int)v4.Age, (int)v5.Age);
    }
