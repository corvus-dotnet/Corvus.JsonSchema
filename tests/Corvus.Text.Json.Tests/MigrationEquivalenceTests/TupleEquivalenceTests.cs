...
public class TupleEquivalenceTests
{
    ...
    public void V5_AccessElement0_String()
    {
        ...
        Assert.IsTrue(v5.Item1.TryGetValue(out string? value));
        Assert.AreEqual("hello", value);
    }
    ...
    public void V5_AccessElement1_Int()
    {
        ...
        Assert.AreEqual(42, (int)v5.Item2);
    }
    ...
    public void V5_AccessElement2_Bool()
    {
        ...
        Assert.IsTrue(v5.Item3.TryGetValue(out bool value));
        Assert.IsTrue(value);
    }
    ...
    public void V5_AccessViaIndexer()
    {
        ...
        Assert.AreEqual(Corvus.Text.Json.JsonValueKind.String, v5[0].ValueKind);
        Assert.AreEqual(Corvus.Text.Json.JsonValueKind.Number, v5[1].ValueKind);
        Assert.AreEqual(Corvus.Text.Json.JsonValueKind.True, v5[2].ValueKind);
    }
    ...
    public void BothEngines_SameTupleElements()
    {
        ...
        Assert.AreEqual((string)v4.Item1, (string)v5.Item1);
        Assert.AreEqual((int)v4.Item2, (int)v5.Item2);
        Assert.AreEqual((bool)v4.Item3, (bool)v5.Item3);
    }
    ...
    public void V4_TupleCreate()
    {
        ...
        Assert.AreEqual("hello", (string)v4.Item1);
        Assert.AreEqual(42, (int)v4.Item2);
        Assert.IsTrue((bool)v4.Item3);
    }
    ...
    public void V5_TupleCreate()
    {
        ...
        Assert.IsTrue(result.Item1.TryGetValue(out string? s));
        Assert.AreEqual("hello", s);
        Assert.AreEqual(42, (int)result.Item2);
        Assert.IsTrue((bool)result.Item3);
    }
    ...
    public void V4_TupleToValueTuple()
    {
        ...
        Assert.AreEqual("hello", (string)first);
        Assert.AreEqual(42, (int)second);
        Assert.IsTrue((bool)third);
    }
    ...
    public void V5_TupleDestructure_ViaIndexer()
    {
        ...
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationTuple>.Parse(TupleJson);
        V5.MigrationTuple v5 = parsedV5.RootElement;
        Assert.AreEqual("hello", (string)v5.Item1);
        Assert.AreEqual(42, (int)v5.Item2);
        Assert.IsTrue((bool)v5.Item3);
    }
}