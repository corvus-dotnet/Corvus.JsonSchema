...
public class UnionEquivalenceTests
{
    ...
    public void V4_StringVariant_ValueKindAndExtract()
    {
        ...
        Assert.AreEqual("hello", (string)v4);
    }
    ...
    public void V5_StringVariant_ValueKindAndExtract()
    {
        ...
        Assert.AreEqual("hello", (string)v5);
    }
    ...
    public void V4_BoolVariant_False()
    {
        ...
        Assert.AreEqual(System.Text.Json.JsonValueKind.False, v4.ValueKind);
        Assert.IsFalse((bool)v4);
    }
    ...
    public void V5_BoolVariant_False()
    {
        ...
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.AreEqual(Corvus.Text.Json.JsonValueKind.False, v5.ValueKind);
        Assert.IsFalse((bool)v5);
    }
    ...
    public void V4_AsStringAccessor()
    {
        ...
        Assert.AreEqual("hello", (string)asString);
    }
    ...
    public void V4_AsNumberAccessor()
    {
        ...
        Assert.AreEqual(42, (int)asNumber);
    }
    ...
    public void BothEngines_TryGetAs_String_SamePattern()
    {
        ...
        using var parsedV4 = Corvus.Json.ParsedValue<V4.MigrationUnion>.Parse("\"hello\"");
        V4.MigrationUnion v4 = parsedV4.Instance;
        Assert.IsTrue(v4.TryGetAsJsonString(out Corvus.Json.JsonString v4Result));
        Assert.AreEqual("hello", (string)v4Result);

        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("\"hello\"");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetAsJsonString(out V5.JsonString v5Result));
        Assert.AreEqual("hello", (string)v5Result);

        Assert.AreEqual((string)v4Result, (string)v5Result);
    }
    ...
    public void BothEngines_TryGetAs_Number_DifferentNames()
    {
        ...
        using var parsedV4 = Corvus.Json.ParsedValue<V4.MigrationUnion>.Parse("42");
        V4.MigrationUnion v4 = parsedV4.Instance;
        Assert.IsTrue(v4.TryGetAsOneOf1Entity(out V4.MigrationUnion.OneOf1Entity v4Result));
        Assert.AreEqual(42, (int)v4Result);

        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("42");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetAsJsonInt32(out V5.JsonInt32 v5Result));
        Assert.AreEqual(42, (int)v5Result);

        Assert.AreEqual((int)v4Result, (int)v5Result);
    }
    ...
    public void BothEngines_TryGetAs_Boolean_SamePattern()
    {
        ...
        using var parsedV4 = Corvus.Json.ParsedValue<V4.MigrationUnion>.Parse("true");
        V4.MigrationUnion v4 = parsedV4.Instance;
        Assert.IsTrue(v4.TryGetAsJsonBoolean(out Corvus.Json.JsonBoolean v4Result));
        Assert.IsTrue((bool)v4Result);

        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("true");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetAsJsonBoolean(out V5.JsonBoolean v5Result));
        Assert.IsTrue((bool)v5Result);

        Assert.AreEqual((bool)v4Result, (bool)v5Result);
    }
    ...
    public void V4_MatchPatternWithContext_String()
    {
        ...
        Assert.AreEqual("prefix:string:hello", result);
    }
    ...
    public void V4_MatchPatternWithContext_Number()
    {
        ...
        string result = v4.Match(
            ...
            static (in b, in ctx) => $"{ctx}:bool:{(bool)b}",
            static (in v, in ctx) => $"{ctx}:none");
        Assert.AreEqual("prefix:number:42", result);
    }
    ...
    public void V4_MatchPatternWithContext_Boolean()
    {
        ...
        string result = v4.Match(
            ...
            static (in b, in ctx) => $"{ctx}:bool:{(bool)b}",
            static (in v, in ctx) => $"{ctx}:none");
        Assert.AreEqual("prefix:bool:True", result);
    }
    ...
    public void BothEngines_IntVariant_SameResult()
    {
        ...
        Assert.AreEqual((long)v4, (long)v5);
    }
    ...
    public void BothEngines_BoolVariant_SameResult()
    {
        ...
        Assert.AreEqual((bool)v4, (bool)v5);
    }
    ...
    public void V5_ExplicitCast_DoubleFromNumberVariant()
    {
        ...
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.AreEqual(3.14, (double)v5);
    }
    ...
    public void V5_ExplicitCast_DecimalFromNumberVariant()
    {
        ...
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.AreEqual(99.99m, (decimal)v5);
    }
    ...
    public void V5_ExplicitCast_ThrowsForWrongType()
    {
        ...
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("\"hello\"");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.ThrowsExactly<FormatException>(() => (bool)v5);
    }
    ...
    public void V5_ExplicitCast_IntThrowsForStringVariant()
    {
        ...
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("\"hello\"");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.ThrowsExactly<InvalidOperationException>(() => (int)v5);
    }
    ...
    public void V5_TryGetValue_SafeIntAccessor_MatchingVariant()
    {
        ...
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("42");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetValue(out int intResult));
    ...
    public void V5_TryGetValue_SafeIntAccessor_NonMatchingVariant()
    {
        ...
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("\"hello\"");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.AreNotEqual(Corvus.Text.Json.JsonValueKind.Number, v5.ValueKind);
    }
    ...
    public void V5_TryGetValue_SafeBoolAccessor()
    {
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("true");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetValue(out bool boolResult));
    ...
    public void V5_TryGetValue_SafeStringAccessor()
    {
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("\"hello\"");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetValue(out string? stringResult));
    ...
    {
        var v4 = V4.MigrationUnion.Parse("\"hello\"");
        Assert.IsTrue(v4.IsJsonString);
        Assert.IsFalse(v4.IsJsonBoolean);
    }
    ...
    {
        var v4 = V4.MigrationUnion.Parse("true");
        Assert.IsTrue(v4.IsJsonBoolean);
        Assert.IsFalse(v4.IsJsonString);
    }
    ...
    {
        var v4 = V4.MigrationUnion.Parse("\"hello\"");
        Assert.IsTrue(v4.TryGetAsJsonString(out Corvus.Json.JsonString result));
    ...
    public void V5_TryGetAsJsonString_StringResult()
    {
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("\"hello\"");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetAsJsonString(out V5.JsonString result));
        Assert.AreEqual("hello", (string)result);
    }
    ...
    {
        var v4 = V4.MigrationUnion.Parse("true");
        Assert.IsTrue(v4.TryGetAsJsonBoolean(out Corvus.Json.JsonBoolean result));
    ...
    public void V5_TryGetAsJsonBoolean_BooleanResult()
    {
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("true");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetAsJsonBoolean(out V5.JsonBoolean result));
        Assert.IsTrue((bool)result);
    }
    ...
    {
        var v4 = V4.MigrationUnion.Parse("42");
        Assert.IsTrue(v4.TryGetAsOneOf1Entity(out V4.MigrationUnion.OneOf1Entity result));
        Assert.AreEqual(System.Text.Json.JsonValueKind.Number, result.ValueKind);
    }
    ...
    public void V5_TryGetAsJsonInt32_NumberResult()
    {
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("42");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetAsJsonInt32(out V5.JsonInt32 result));
        Assert.AreEqual(Corvus.Text.Json.JsonValueKind.Number, result.ValueKind);
    }
    ...
    {
        var v4 = V4.MigrationUnion.Parse("true");
        Assert.IsTrue(v4.TryGetBoolean(out bool result));
    ...
    {
        var v4 = V4.MigrationUnion.Parse("\"hello\"");
        Assert.IsTrue(v4.EqualsString("hello"));
        Assert.IsFalse(v4.EqualsString("world"));
    }
    ...
    public void V5_DirectValueAccess_String_GetString()
    {
        ...
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("\"hello\"");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.AreEqual("hello", v5.GetString());
    }
    ...
    public void V5_DirectValueAccess_Number_TryGetValue()
    {
        ...
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("42");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetValue(out long value));
    ...
    public void V5_DirectValueAccess_Boolean_TryGetValue()
    {
        ...
        using var parsedV5 = Corvus.Text.Json.ParsedJsonDocument<V5.MigrationUnion>.Parse("true");
        V5.MigrationUnion v5 = parsedV5.RootElement;
        Assert.IsTrue(v5.TryGetValue(out bool value));
        Assert.IsTrue(value);
    }
    ...
    public void BothEngines_DirectValueAccess_SameResults()
    {
        ...
        Assert.AreEqual((string)parsedV4Str.Instance.AsString, (string)parsedV5Str.RootElement);
        ...
        Assert.AreEqual((int)parsedV4Num.Instance.AsNumber, (int)parsedV5Num.RootElement);
        ...
        Assert.AreEqual((bool)parsedV4Bool.Instance.AsBoolean, (bool)parsedV5Bool.RootElement);
    }
}