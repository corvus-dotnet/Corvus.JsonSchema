...
public class JsonToYamlCoverageTests
{
    ...
    public void ElementPath_EmptyObject()
    {
        ...
        StringAssert.Contains(yaml, "empty: {}");
    }
    ...
    public void ElementPath_EmptyArray()
    {
        ...
        var root = doc.RootElement;
        string yaml = YamlDocument.ConvertToYamlString(in root);
        StringAssert.Contains(yaml, "items: []");
    }
    ...
    public void ElementPath_ScalarValues()
    {
        ...
        var root = doc.RootElement;
        string yaml = YamlDocument.ConvertToYamlString(in root);
        StringAssert.Contains(yaml, "str: hi");
        StringAssert.Contains(yaml, "num: 42");
        StringAssert.Contains(yaml, "tr: true");
        StringAssert.Contains(yaml, "fl: false");
        StringAssert.Contains(yaml, "nu: null");
    }
}
