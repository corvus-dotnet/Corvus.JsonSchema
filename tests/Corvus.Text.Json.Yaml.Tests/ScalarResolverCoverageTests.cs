...
public class ScalarResolverCoverageTests
{
    ...
    public void JsonSchema_TrueLiteral()
    {
        ...
        var options = new YamlReaderOptions { Schema = YamlSchema.Json };
        using var doc = YamlTestHelper.Parse(yaml, options);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("key"u8).ValueKind);
    }
    ...
    public void JsonSchema_FalseLiteral()
    {
        ...
        var options = new YamlReaderOptions { Schema = YamlSchema.Json };
        using var doc = YamlTestHelper.Parse(yaml, options);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("key"u8).ValueKind);
    }
    ...
    public void JsonSchema_Number()
    {
        ...
        var options = new YamlReaderOptions { Schema = YamlSchema.Json };
        using var doc = YamlTestHelper.Parse(yaml, options);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("key"u8).ValueKind);
    }
    ...
    public void Yaml11_NullVariants()
    {
        ...
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("b"u8).ValueKind);
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("c"u8).ValueKind);
    }
    ...
    public void Yaml11_ExtendedBooleans_True()
    {
        ...
        var options = new YamlReaderOptions { Schema = YamlSchema.Yaml11 };
        using var doc = YamlTestHelper.Parse(yaml, options);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("a"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("b"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("c"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("d"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("e"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("f"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("g"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("h"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("i"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("j"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("k"u8).ValueKind);
    }
    ...
    public void Yaml11_ExtendedBooleans_False()
    {
        ...
        Assert.Equal(JsonValueKind.String, doc.RootElement.GetProperty("a"u8).ValueKind);
        Assert.Equal(JsonValueKind.String, doc.RootElement.GetProperty("b"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("c"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("d"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("e"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("f"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("g"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("h"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("i"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("j"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("k"u8).ValueKind);
    }
    ...
    public void Core_HexInteger()
    {
        ...
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("key"u8).ValueKind);
        Assert.Equal(255, doc.RootElement.GetProperty("key"u8).GetInt32());
    }
    ...
    public void Core_HexInteger_Uppercase()
    {
        ...
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("key"u8).ValueKind);
        Assert.Equal(171, doc.RootElement.GetProperty("key"u8).GetInt32());
    }
    ...
    public void Core_OctalInteger()
    {
        ...
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("key"u8).ValueKind);
        Assert.Equal(15, doc.RootElement.GetProperty("key"u8).GetInt32());
    }
    ...
    public void Core_OctalInteger_Uppercase()
    {
        ...
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("key"u8).ValueKind);
        Assert.Equal(63, doc.RootElement.GetProperty("key"u8).GetInt32());
    }
    ...
    public void Core_InfVariants()
    {
        ...
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("b"u8).ValueKind);
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("c"u8).ValueKind);
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("d"u8).ValueKind);
    }
    ...
    public void Core_LargeInteger_Overflow()
    {
        ...
        Assert.Contains("99999999999999999999", raw);
    }
    ...
    public void Failsafe_EverythingIsString()
    {
        ...
        Assert.Equal(JsonValueKind.String, doc.RootElement.GetProperty("a"u8).ValueKind);
        Assert.Equal(JsonValueKind.String, doc.RootElement.GetProperty("b"u8).ValueKind);
        Assert.Equal(JsonValueKind.String, doc.RootElement.GetProperty("c"u8).ValueKind);
        Assert.Equal(JsonValueKind.String, doc.RootElement.GetProperty("d"u8).ValueKind);
    }
    ...
    public void Core_NullVariants()
    {
        var yaml = "a: 'null'\nb: Null\nc: NULL\nd: ~"u8.ToArray();
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(JsonValueKind.String, doc.RootElement.GetProperty("a"u8).ValueKind); // quoted
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("b"u8).ValueKind);
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("c"u8).ValueKind);
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("d"u8).ValueKind);
    }
    ...
    public void WriteScalarProperty_AllTypes()
    {
        ...
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("nullval"u8).ValueKind);
        Assert.Equal(JsonValueKind.True, doc.RootElement.GetProperty("trueval"u8).ValueKind);
        Assert.Equal(JsonValueKind.False, doc.RootElement.GetProperty("falseval"u8).ValueKind);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("intval"u8).ValueKind);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("floatval"u8).ValueKind);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("hexval"u8).ValueKind);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("octalval"u8).ValueKind);
        Assert.Equal(JsonValueKind.Null, doc.RootElement.GetProperty("infval"u8).ValueKind);
        Assert.Equal(JsonValueKind.String, doc.RootElement.GetProperty("strval"u8).ValueKind);
    }
    ...
    public void WriteScalarProperty_NegativeHexOctal()
    {
        ...
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(-171, doc.RootElement.GetProperty("neghex"u8).GetInt32());
        Assert.Equal(205, doc.RootElement.GetProperty("poshex"u8).GetInt32());
        Assert.Equal(-63, doc.RootElement.GetProperty("negoct"u8).GetInt32());
        Assert.Equal(15, doc.RootElement.GetProperty("posoct"u8).GetInt32());
    }
    ...
    public void WriteScalarProperty_LargeIntegerOverflow()
    {
        ...
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("big"u8).ValueKind);
    }
    ...
    public void WriteScalarProperty_FloatInMapping()
    {
        ...
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("pi"u8).ValueKind);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("sci"u8).ValueKind);
    }
    ...
    public void Core_PositiveInteger()
    {
        ...
        using var doc = YamlTestHelper.Parse(yaml);
        Assert.Equal(JsonValueKind.Number, doc.RootElement.GetProperty("key"u8).ValueKind);
        Assert.Equal(42, doc.RootElement.GetProperty("key"u8).GetInt32());
    }
